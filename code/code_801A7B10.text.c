...
void func_801A7D84(u32 arg0, void *arg2) {
    ...
    case 0:
        ...
        sp34 = temp_t8;
        if ((temp_v1->unk210 == 0) && (temp_a2 = ((u32) (arg0 & 0xFF00) >> 8) & 0xFF, (D_801DB4C8 == 0))) {
            if (temp_a2 < 0x80) {
                func_801A7B10(sp37, arg0 & 0xFF, temp_a2, ((u32) (arg0 & 0xFF0000) >> 0xD) & 0xFFFF);
                return;
            }
            temp_a3 = arg0 & 0xFF;
            temp_v1->unk1FC = (s32) ((arg0 & 0xF7FF7FFF) + 0x8000000);
            temp_v1->unk210 = 1U;
            sp44 = temp_a3;
            sp40 = temp_v1;
            temp_v1->unk211 = (u8) *func_80193C04(temp_a3, &sp4C, temp_a2, temp_a3);
            func_801A7D04(sp37, 1);
            if (temp_v1->unk20C != 0xFFFF) {
                sp40 = temp_v1;
                sp44 = temp_a3;
                temp_s0 = func_80193C04(temp_a3, &sp4C);
                if (*temp_s0 != *func_80193C04(temp_v1->unk20C & 0xFF, &sp4C)) {
                    sp44 = temp_a3;
...
loop_13:
            if (temp_a3_2 == *((temp_t6 * 0xA) + &D_801FFD00 + (phi_v1 * 2))) {
                if (phi_v1 == 0) {
                    func_801A7B10(sp37, sp3B, ((u32) (arg0 & 0xFF00) >> 8) & 0xFF, ((u32) (arg0 & 0xFF0000) >> 0xD) & 0xFFFF);
                    return;
                }
...
block_18:
        ...
        if ((s32) temp_t2 > 0) {
            do {
                phi_v1_3 = phi_v1_2;
                if ((((u32) (arg0 & 0xFF00) >> 8) & 0xFF) >= (s32) (temp_a2_2 + (phi_v1_2 * 2))->unk1) {
        ...
        if (phi_t1 != temp_v1_4) {
            do {
                ...
                temp_a0->unk1 = (u8) temp_a1_2->unk-1;
                temp_v1_5 = (phi_v1_4 - 1) & 0xFF;
                temp_a0->unk0 = (u8) temp_a1_2->unk-2;
                phi_v0 = temp_v1_5;
                phi_v1_4 = temp_v1_5;
            } while (phi_t1 != temp_v1_5);
        }
        temp_v0 = temp_a2_2 + (phi_t1 * 2);
        temp_v0->unk1 = (s8) sp44;
        temp_v0->unk0 = (s8) sp38;
        if (phi_t1 == 0) {
            func_801A7B10(sp37, sp3B, (s32) sp47, ((u32) (arg0 & 0xFF0000) >> 0xD) & 0xFFFF);
            return;
        }
        // Duplicate return node #88. Try simplifying control flow for better match
        return;
    case 3:
        ...
        if (phi_t1_2 != temp_t2_2) {
            ...
            if (phi_t1_2 < temp_a3_3) {
                ...
                do {
                    ...
                    temp_a0_2->unk1 = (u8) temp_a1_3->unk3;
                    temp_v1_8 = (phi_v1_7 + 1) & 0xFF;
                    temp_a0_2->unk0 = (u8) temp_a1_3->unk2;
                    phi_v0_2 = temp_v1_8;
                    phi_v1_7 = temp_v1_8;
        ...
        if ((phi_t1_2 == 0) && (temp_a3_4 = ((u32) (arg0 & 0xFF0000) >> 0xD) & 0xFFFF, sp44 = temp_a3_4, sp2C = temp_t4_2, func_801A7D04(sp37, temp_a3_4 & 0xFFFF, phi_a2, temp_a3_4), (*temp_t4_2 != 0))) {
            temp_v0_2 = (sp34 * 0xA) + &D_801FFD00;
            func_801A7B10((u8) sp34, temp_v0_2->unk0, (s32) temp_v0_2->unk1, temp_a3_4);
            return;
        }
        // Duplicate return node #88. Try simplifying control flow for better match
        return;
    case 4:
        ...
        temp_f2 = temp_v1_10->unk1C0;
        temp_f0 = (f32) (arg0 & 0xFF) / 127.0f;
        temp_v1_10->unk1C4 = temp_f0;
        if (temp_f2 != temp_f0) {
            temp_f8 = (f32) phi_a1;
            phi_f8 = temp_f8;
            if (phi_a1 < 0) {
            ...
            temp_v1_10->unk200 = (s16) phi_a1;
            temp_v1_10->unk1C8 = (f32) ((temp_f2 - temp_v1_10->unk1C4) / phi_f8);
            return;
        }
        // Duplicate return node #88. Try simplifying control flow for better match
        return;
    case 5:
        ...
        do {
            ...
            temp_v0_5->unk10 = temp_f0_2;
            temp_v0_5->unk1A = (s16) phi_a1_2;
            temp_v0_5->unk14 = (f32) ((temp_v0_5->unkC - temp_f0_2) / (f32) phi_a1_2);
            phi_v1_8 = temp_v1_12;
        } while (temp_v1_12 < 0x10);
        (&D_80200140 + (temp_a3_5 * 0x21C))->unk206 = 0xFFFF;
        return;
    case 13:
        ...
        temp_v0_7->unk10 = temp_f0_3;
        phi_f10 = temp_f10;
        if (phi_a1_3 < 0) {
            phi_f10 = temp_f10 + 4294967296.0f;
        }
        temp_v0_7->unk1A = (s16) phi_a1_3;
        temp_v0_7->unk14 = (f32) ((temp_v0_7->unkC - temp_f0_3) / phi_f10);
        temp_v1_14->unk206 = (u16) (temp_v1_14->unk206 | (1 << temp_a0_3));
        return;
    case 6:
        ...
        if (temp_v0_9->unk0 != temp_f0_4) {
            ...
            temp_v0_10->unk18 = (s16) phi_a1_4;
            temp_v0_10->unk8 = (f32) ((temp_v0_10->unk0 - temp_v0_10->unk4) / phi_f6);
            temp_v1_16->unk208 = (u16) (temp_v1_16->unk208 | (1 << temp_a3_6));
            return;
        }
        // Duplicate return node #88. Try simplifying control flow for better match
        return;
    ...
    case 8:
        ...
        if (((&D_80200140 + (temp_v0_11 * 0x21C))->unk20E & (1 << temp_a3_7)) == 0) {
        ...
        return;
    case 9:
        (&D_80200140 + ((temp_t0_2 & 0xFF) * 0x21C))->unk20E = (s16) arg0;
        return;
    case 10:
        ...
        return;
    case 11:
        (&D_80200140 + ((temp_t0_2 & 0xFF) * 0x21C))->unk1CC = arg0;
        return;
    case 12:
        if ((((u32) (arg0 & 0xF00000) >> 0x14) & 0xFF) != 0xF) {
            temp_v1_17 = &D_80200140 + ((temp_t0_2 & 0xFF) * 0x21C);
            temp_v0_14 = temp_v1_17->unk219;
            temp_t1_3 = temp_v0_14 & 0xFF;
            if (((s32) temp_v0_14 < 7) && (temp_v1_17->unk219 = (u8) (temp_v0_14 + 1), ((temp_t1_3 < 8) != 0))) {
                (temp_v1_17 + (temp_t1_3 * 4))->unk1DC = arg0;
                temp_v1_17->unk218 = 2;
                return;
            }
            // Duplicate return node #88. Try simplifying control flow for better match
        ...
        (&D_80200140 + ((temp_t0_2 & 0xFF) * 0x21C))->unk219 = 0;
        return;
    case 14:
...
s32 func_801A8A50(s32 param1) {
    ...
    if (temp_v1->unk210 == 1) {
        return temp_v1->unk1FC & 0xFF & 0xFFFF;
    }
    temp_a0 = temp_v1->unk20A;
    if (temp_a0 != 0xFFFF) {
        return (s32) temp_a0;
    }
    return 0xFFFF;
...
void func_801A8B2C(s32 arg0, s32 arg1) {
    ...
    if ((s32) temp_a2 > 0) {
        do {
            ...
            phi_v0 = temp_v0;
            if ((arg1 & 0xFF) == (((u32) (temp_a3->unk1DC & 0xF00000) >> 0x14) & 0xFF)) {
                temp_a3->unk1DC = 0xFF000000;
                phi_a2 = (s32) temp_v1->unk219;
            }
...
void func_801A8BD0(u8 arg0, s32 arg1, s32 arg2, s32 arg3) {
    ...
    temp_a3 = arg3 & 0xFF;
    (temp_v1 + temp_a1)->unk212 = (s8) (arg2 & 0x7F);
    if (temp_a3 != 0) {
        temp_v0 = &D_80200140 + (arg0 * 0x21C);
        temp_v0->unk217 = 1;
        temp_v0->unk216 = temp_a3;
        return;
    }
    phi_v0 = 0;
    phi_f0 = 1.0f;
    do {
        temp_t6 = (temp_v1 + phi_v0)->unk212;
        temp_f6 = (f32) temp_t6;
        phi_f6 = temp_f6;
        if ((s32) temp_t6 < 0) {
            phi_f6 = temp_f6 + 4294967296.0f;
...
loop_1:
    ...
    if ((temp_s2->unk21B != 0) && (((u32) *(&D_802050D0 + (phi_s5 * 0x160)) >> 0x1F) != 0)) {
        temp_s2->unk21B = 0U;
    }
    if ((func_801A8A50(phi_s5 & 0xFF) != 0xFFFF) && (((u32) *(&D_802050D0 + (phi_s5 * 0x160)) >> 0x1F) == 0) && (temp_s2->unk21B == 0)) {
        temp_s2->unk20A = 0xFFFFU;
    }
    if (temp_s2->unk210 != 0) {
    ...
    if (temp_s2->unk217 != 0) {
        ...
        phi_f0 = 1.0f;
        do {
            temp_t7 = (&D_80200140 + (phi_s5 * 0x21C) + phi_s3)->unk212;
            temp_f6 = (f32) temp_t7;
            phi_f6 = temp_f6;
            if ((s32) temp_t7 < 0) {
                phi_f6 = temp_f6 + 4294967296.0f;
        ...
        func_801A89A8((temp_s2->unk216 << 0x10) | 0x40000000 | ((phi_s5 + 8) << 0x18) | ((u32) (temp_f0 * 127.0f) & 0xFF));
        temp_s2->unk217 = 0U;
    }
    temp_v0_2 = temp_s2->unk200;
    temp_t5 = temp_v0_2 - 1;
    if (temp_v0_2 != 0) {
        temp_s2->unk200 = temp_t5;
        if ((temp_t5 & 0xFFFF) != 0) {
            temp_s2->unk1C0 = (f32) (temp_s2->unk1C0 - temp_s2->unk1C8);
        } else {
            temp_s2->unk1C0 = (f32) temp_s2->unk1C4;
        }
        func_80193858(((phi_s5 & 0xFF) << 0x10) | 0x41000000, temp_s2->unk1C0);
    }
    temp_a2 = temp_s2->unk1CC;
    phi_a2 = temp_a2;
    if (temp_a2 != 0) {
        ...
        if (((u32) temp_a1->unk4460 >> 0x1F) != 0) {
            temp_lo = (s32) temp_a1->unk4468 / 0x30;
            ...
            temp_f2 = (f32) temp_lo;
            if (temp_s2->unk202 == 0) {
                temp_s2->unk202 = (u16) temp_a2_2;
            }
            temp_f0_2 = (f32) phi_t0;
            temp_s2->unk1D4 = temp_f0_2;
            temp_s2->unk1D0 = temp_f2;
            temp_f8 = (f32) phi_t2;
            phi_f8 = temp_f8;
            if (phi_t2 < 0) {
                phi_f8 = temp_f8 + 4294967296.0f;
            }
            temp_s2->unk204 = (u16) phi_t2;
            temp_s2->unk1CC = 0;
            temp_s2->unk1D8 = (f32) ((temp_f2 - temp_f0_2) / phi_f8);
        }
    }
    temp_v0_6 = temp_s2->unk204;
    temp_t5_2 = temp_v0_6 - 1;
    if (temp_v0_6 != 0) {
        temp_s2->unk204 = temp_t5_2;
        if ((temp_t5_2 & 0xFFFF) != 0) {
            temp_s2->unk1D0 = (f32) (temp_s2->unk1D0 - temp_s2->unk1D8);
        } else {
            temp_s2->unk1D0 = (f32) temp_s2->unk1D4;
        }
        func_8019387C(((phi_s5 & 0xFF) << 0x10) | 0x47000000, (s32) temp_s2->unk1D0, phi_a2);
    }
    if (temp_s2->unk208 != 0) {
        phi_s0 = 0;
        do {
            ...
            temp_v1_2 = temp_v0_7->unk18;
            temp_t7_2 = temp_v1_2 - 1;
            if (temp_v1_2 != 0) {
                temp_v0_7->unk18 = temp_t7_2;
                temp_a2_3 = ((phi_s5 & 0xFF) << 0x10) | 0x1000000;
                if ((temp_t7_2 & 0xFFFF) != 0) {
                    temp_v0_7->unk0 = (f32) (temp_v0_7->unk0 - temp_v0_7->unk8);
                } else {
                    temp_v1_3 = temp_s2 + temp_a0_2;
                    temp_v1_3->unk0 = (f32) temp_v1_3->unk4;
                    temp_s2->unk208 = (u16) (temp_s2->unk208 ^ (1 << phi_s0));
                }
                func_80193858(temp_a2_3 | ((phi_s0 & 0xFF) << 8), temp_v0_7->unk0, temp_a2_3);
            }
    ...
    if (temp_s2->unk206 != 0) {
        ...
        do {
            ...
            temp_v1_4 = temp_v0_8->unk1A;
            temp_t5_3 = temp_v1_4 - 1;
            if (temp_v1_4 != 0) {
                temp_v0_8->unk1A = temp_t5_3;
                temp_a2_4 = ((phi_s5 & 0xFF) << 0x10) | 0x4000000;
                if ((temp_t5_3 & 0xFFFF) != 0) {
                    temp_v0_8->unkC = (f32) (temp_v0_8->unkC - temp_v0_8->unk14);
                } else {
                    temp_v1_5 = temp_s2 + temp_a0_3;
                    temp_v1_5->unkC = (f32) temp_v1_5->unk10;
                    temp_s2->unk206 = (u16) (temp_s2->unk206 ^ (1 << phi_s0_2));
                }
                func_80193858(temp_a2_4 | ((phi_s0_2 & 0xFF) << 8), temp_v0_8->unkC, temp_a2_4);
            }
    ...
    if (temp_s2->unk219 != 0) {
        ...
        temp_v0_9 = temp_s2->unk218;
        if (temp_v0_9 != 0) {
            temp_s2->unk218 = (u8) (temp_v0_9 - 1);
        } else if (((u32) *(&D_802050D0 + (phi_s5 * 0x160)) >> 0x1F) == 0) {
            temp_v1_6 = temp_s2->unk219;
            phi_s3_2 = 0;
            phi_v1 = (s32) temp_v1_6;
            if ((s32) temp_v1_6 > 0) {
                do {
                    temp_v0_10 = (&D_80200140 + (phi_s5 * 0x21C) + (phi_s3_2 * 4))->unk1DC;
...
block_100:
                    ...
                    case 7: // switch 2
                        ...
                        break;
                    case 1: // switch 2
                        func_801A89A8(temp_s2->unk20A | 0x30000000 | ((phi_s5 + 8) << 0x18));
                        goto block_100;
                    case 2: // switch 2
                        temp_s0_4 = &D_80200140 + (temp_s1 * 0x21C);
                        func_801A89A8(temp_s0_4->unk20A | ((temp_s1 + 8) << 0x18) | 0x10000);
                        temp_s0_4->unk217 = 1;
                        temp_s0_4->unk213 = 0x7F;
                        goto block_100;
                    case 3: // switch 2
                    ...
                    case 5: // switch 2
                        ...
                        func_801A89A8((temp_s0_5->unk21A << 0x10) | ((temp_s1 + 8) << 0x18) | (temp_v0_10 & 0xFFFF));
                        func_801A8BD0(temp_s1 & 0xFF, 1, 0x7F, 0);
                        temp_s0_5->unk21A = 0U;
                        goto block_100;
                    case 6: // switch 2
                        temp_s2->unk21A = temp_s0_3;
                        goto block_100;
                    case 8: // switch 2
...
void func_801A99B8(void) {
    ...
    do {
        *(&D_801FFD34 + phi_v0) = 0;
        ...
        temp_v1->unk20A = 0xFFFF;
        temp_v1->unk20C = 0xFFFF;
        temp_v1->unk204 = 0;
        temp_v1->unk202 = 0;
        temp_v1->unk1CC = 0;
        temp_v1->unk20E = 0;
...
loop_2:
        ...
        (&D_80200140 + (phi_v0 * 0x21C) + phi_a0)->unk212 = 0x7F;
        phi_a0 = temp_a0;
        if (temp_a0 < 4) {
            goto loop_2;
        }
...
loop_2:
        temp_v0 = (phi_v0 + 1) & 0xFF;
        (&D_80200140 + (phi_a2 * 0x21C) + phi_v0)->unk212 = 0x7F;
        phi_v0 = temp_v0;
        if (temp_v0 < 4) {
            goto loop_2;
        }
        ...
        if ((s32) temp_a1->unk-1 > 0) {
            do {
                *(arg1 + phi_v1) = phi_v0;
                ...
                phi_a2 = temp_a2;
                phi_v1_2 = temp_v1;
            } while ((s32) temp_a1->unk-1 >= (s32) temp_a2);
        }
    ...
    do {
        ...
        if (*temp_a1 != 0) {
            *(arg1 + phi_v0) = phi_v1;
            ...
            temp_a2->unk10 = (u16) *(arg2 + (phi_v1 * 2));
            temp_t4 = ((phi_v1 + *temp_a1) - 1) & 0xFFFF;
            temp_a2->unk30 = (u16) *(arg2 + (temp_t4 * 2));
            phi_v1_2 = (temp_t4 + 1) & 0xFFFF;
        } else {
            (arg1 + (phi_v0 * 2))->unk30 = 0xFFFF;
        }
        temp_t2 = (phi_v0 + 1) & 0xFF;
        phi_v0 = temp_t2;
        phi_v1 = phi_v1_2;
...
void func_801A9EA4(void *arg0, s32 arg1, void *arg2, s32 arg3, s16 arg4, u8 arg5) {
    ...
    if ((s32) arg4 > 0) {
        do {
            temp_v1 = *(phi_v0 + arg0);
            if (arg5 != 0) {
                (arg1 + (temp_v1 * 2))->unk100 = (u16) *(arg3 + (phi_v0 * 2));
                *(arg1 + temp_v1) = *(phi_v0 + arg2);
            } else {
                (arg1 + (temp_v1 * 2))->unk10 = (u16) *(arg3 + (phi_v0 * 2));
                *(arg1 + temp_v1) = *(phi_v0 + arg2);
            }
            temp_v0 = phi_v0 + 1;
            phi_v0 = temp_v0;
