...
struct _mips2c_stack_func_800F470C {
    ...
    /* 0x048 */ char pad48[0x10];                   /* maybe part of sp44[5]? */
    /* 0x058 */ ? sp58;                             /* inferred */
    /* 0x058 */ char pad58[0x14];
    /* 0x06C */ s32 sp6C;                           /* inferred */
    /* 0x070 */ u8 sp70;                            /* inferred */
    /* 0x071 */ s8 sp71;                            /* inferred */
    /* 0x072 */ char pad72[0x2];                    /* maybe part of sp71[3]? */
    /* 0x074 */ ? *sp74;                            /* inferred */
    /* 0x078 */ ? *sp78;                            /* inferred */
    /* 0x07C */ ? *sp7C;                            /* inferred */
    /* 0x080 */ ? *sp80;                            /* inferred */
    /* 0x084 */ s8 sp84;                            /* inferred */
    /* 0x085 */ char pad85[0x3];                    /* maybe part of sp84[4]? */
    /* 0x088 */ ? sp88;                             /* inferred */
    /* 0x088 */ char pad88[0x54];
    /* 0x0DC */ ? spDC;                             /* inferred */
    /* 0x0DC */ char padDC[0x54];
    /* 0x130 */ ? sp130;                            /* inferred */
    /* 0x130 */ char pad130[0x54];
    /* 0x184 */ ? sp184;                            /* inferred */
    /* 0x184 */ char pad184[0x54];
    /* 0x1D8 */ u8 sp1D8;                           /* inferred */
    /* 0x1D9 */ char pad1D9[0x3];                   /* maybe part of sp1D8[4]? */
    /* 0x1DC */ s32 sp1DC;                          /* inferred */
    /* 0x1E0 */ s32 sp1E0;                          /* inferred */
    /* 0x1E4 */ s32 sp1E4;                          /* inferred */
    /* 0x1E8 */ u8 sp1E8;                           /* inferred */
    /* 0x1E9 */ char pad1E9[0x3];                   /* maybe part of sp1E8[4]? */
    ...
    /* 0x201 */ char pad201[0x5F];                  /* maybe part of sp200[96]? */
    /* 0x260 */ ? sp260;                            /* inferred */
    /* 0x260 */ char pad260[0x18];
    /* 0x278 */ void *sp278;                        /* inferred */
    /* 0x27C */ s32 sp27C;                          /* inferred */
    /* 0x280 */ char pad280[0x10];
};                                                  /* size = 0x290 */
