struct _mips2c_stack_SkinMatrix_Clear {};           /* size 0x0 */

struct _mips2c_stack_SkinMatrix_GetClear {};        /* size 0x0 */

struct _mips2c_stack_SkinMatrix_Invert {
    /* 0x00 */ char pad_0[0x78];
    /* 0x78 */ ? sp78;                              /* inferred */
    /* 0x78 */ char pad_78[0x40];
};                                                  /* size = 0xB8 */

struct _mips2c_stack_SkinMatrix_MtxFCopy {};        /* size 0x0 */

struct _mips2c_stack_SkinMatrix_MtxFMtxFMult {
    /* 0x00 */ char pad_0[0x8];
    /* 0x08 */ f64 sp8;                             /* inferred */
    /* 0x10 */ f64 sp10;                            /* inferred */
};                                                  /* size = 0x18 */

struct _mips2c_stack_SkinMatrix_MtxFToMtx {};       /* size 0x0 */

struct _mips2c_stack_SkinMatrix_MtxFToNewMtx {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ Gfx *sp18;                           /* inferred */
    /* 0x1C */ char pad_1C[0x4];
};                                                  /* size = 0x20 */

struct _mips2c_stack_SkinMatrix_MulXRotation {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ f32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_SkinMatrix_MulYRotation {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ f32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_SkinMatrix_SetRotateAroundVec {
...
struct _mips2c_stack_SkinMatrix_SetRotateRPY {
...
struct _mips2c_stack_SkinMatrix_SetRotateRPYTranslate {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ ? sp18;                              /* inferred */
    /* 0x18 */ char pad_18[0x40];
    /* 0x58 */ ? sp58;                              /* inferred */
    /* 0x58 */ char pad_58[0x40];
};                                                  /* size = 0x98 */

struct _mips2c_stack_SkinMatrix_SetRotateYRP {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ f32 sp24;                            /* inferred */
    /* 0x28 */ char pad_28[0x4];
    /* 0x2C */ f32 sp2C;                            /* inferred */
...
struct _mips2c_stack_SkinMatrix_SetScale {};        /* size 0x0 */

struct _mips2c_stack_SkinMatrix_SetScaleRotateRPYTranslate {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ ? sp18;                              /* inferred */
    /* 0x18 */ char pad_18[0x40];
    /* 0x58 */ ? sp58;                              /* inferred */
...
struct _mips2c_stack_SkinMatrix_SetScaleRotateYRPTranslate {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ ? sp18;                              /* inferred */
    /* 0x18 */ char pad_18[0x40];
    /* 0x58 */ ? sp58;                              /* inferred */
...
struct _mips2c_stack_SkinMatrix_SetTranslate {};    /* size 0x0 */

struct _mips2c_stack_SkinMatrix_SetXRotation {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ f32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_SkinMatrix_SetYRotation {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ f32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_SkinMatrix_SetZRotation {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ f32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_SkinMatrix_Vec3fMtxFMultXYZ {}; /* size 0x0 */

struct _mips2c_stack_SkinMatrix_Vec3fMtxFMultXYZW {}; /* size 0x0 */

struct _mips2c_stack_SkinMatrix_Vec3fToVec3s {};    /* size 0x0 */

struct _mips2c_stack_SkinMatrix_Vec3sToVec3f {};    /* size 0x0 */
...
s32 SkinMatrix_Invert(MtxF *src, MtxF *dest) {
    ...
    SkinMatrix_MtxFCopy(src, (MtxF *) &sp78);
...
loop_3:
    ...
    temp_a0 = &sp78 + temp_t5;
    temp_a1 = &dest->mf[0][phi_s0];
    if (phi_t1_2 != phi_s0) {
        phi_v1 = temp_t5 + &sp78;
        phi_v0 = (phi_t1_2 * 4) + &sp78;
        phi_a3 = &dest->mf[0][phi_s0];
        phi_a2 = &dest->mf[0][phi_t1_2];
        phi_t2 = 0;
        do {
            temp_f0 = phi_v0->unk_0;
            temp_t2 = phi_t2 + 2;
            phi_v0->unk_0 = (f32) phi_v1->unk_0;
            phi_v1->unk_0 = temp_f0;
            temp_f2 = phi_a2->unk_0;
            phi_a2->unk_0 = phi_a3->unk_0;
            phi_a3->unk_0 = temp_f2;
            temp_v0 = phi_v0 + 0x20;
    ...
    do {
        temp_t0 = phi_t1_3 * 4;
        if (phi_t1_3 != phi_s0) {
            temp_f0_3 = *(temp_t3_2 + temp_t0);
            temp_v0_2 = &sp78 + temp_t0;
...
void SkinMatrix_SetScaleRotateRPYTranslate(MtxF *mf, f32 scaleX, f32 scaleY, f32 scaleZ, s16 roll, s16 pitch, s16 yaw, f32 dx, f32 dy, f32 dz) {
    ...
    SkinMatrix_SetRotateRPY((MtxF *) &sp58, roll, pitch, yaw);
    SkinMatrix_MtxFMtxFMult(mf, (MtxF *) &sp58, (MtxF *) &sp18);
    SkinMatrix_SetScale((MtxF *) &sp58, scaleX, scaleY, scaleZ);
    SkinMatrix_MtxFMtxFMult((MtxF *) &sp18, (MtxF *) &sp58, mf);
}
...
void SkinMatrix_SetScaleRotateYRPTranslate(MtxF *mf, f32 scaleX, f32 scaleY, f32 scaleZ, s16 yaw, s16 roll, s16 pitch, f32 dx, f32 dy, f32 dz) {
    ...
    SkinMatrix_SetTranslate(mf, dx, dy, dz);
    SkinMatrix_SetRotateYRP((MtxF *) &sp58, yaw, roll, pitch);
    SkinMatrix_MtxFMtxFMult(mf, (MtxF *) &sp58, (MtxF *) &sp18);
    SkinMatrix_SetScale((MtxF *) &sp58, scaleX, scaleY, scaleZ);
    SkinMatrix_MtxFMtxFMult((MtxF *) &sp18, (MtxF *) &sp58, mf);
}
...
void SkinMatrix_SetRotateRPYTranslate(MtxF *mf, s16 roll, s16 pitch, s16 yaw, f32 dx, f32 dy, f32 dz) {
    ...
    SkinMatrix_SetTranslate((MtxF *) &sp18, dx, dy, dz);
    SkinMatrix_SetRotateRPY((MtxF *) &sp58, roll, pitch, yaw);
    SkinMatrix_MtxFMtxFMult((MtxF *) &sp18, (MtxF *) &sp58, mf);
}
...
void SkinMatrix_MtxFToMtx(MtxF *src, Mtx *dest) {
    ...
    dest->unk_0 = (s16) (temp_f8 >> 0x10);
    dest->unk_20 = (s16) temp_f8;
    temp_f18 = (s32) (src->mf[0][1] * 65536.0f);
    dest->unk_2 = (s16) (temp_f18 >> 0x10);
    dest->unk_22 = (s16) temp_f18;
    temp_f8_2 = (s32) (src->mf[0][2] * 65536.0f);
    dest->unk_4 = (s16) (temp_f8_2 >> 0x10);
    dest->unk_24 = (s16) temp_f8_2;
    temp_f18_2 = (s32) (src->mf[0][3] * 65536.0f);
    dest->unk_6 = (s16) (temp_f18_2 >> 0x10);
    dest->unk_26 = (s16) temp_f18_2;
    temp_f8_3 = (s32) (src->mf[1][0] * 65536.0f);
    dest->unk_8 = (s16) (temp_f8_3 >> 0x10);
    dest->unk_28 = (s16) temp_f8_3;
    temp_f18_3 = (s32) (src->mf[1][1] * 65536.0f);
    dest->unk_A = (s16) (temp_f18_3 >> 0x10);
    dest->unk_2A = (s16) temp_f18_3;
    temp_f8_4 = (s32) (src->mf[1][2] * 65536.0f);
    dest->unk_C = (s16) (temp_f8_4 >> 0x10);
    dest->unk_2C = (s16) temp_f8_4;
    temp_f18_4 = (s32) (src->mf[1][3] * 65536.0f);
    dest->unk_E = (s16) (temp_f18_4 >> 0x10);
    dest->unk_2E = (s16) temp_f18_4;
    temp_f8_5 = (s32) (src->mf[2][0] * 65536.0f);
    dest->unk_10 = (s16) (temp_f8_5 >> 0x10);
    dest->unk_30 = (s16) temp_f8_5;
    temp_f18_5 = (s32) (src->mf[2][1] * 65536.0f);
    dest->unk_12 = (s16) (temp_f18_5 >> 0x10);
    temp_v0->unk_12 = (s16) temp_f18_5;
    temp_f8_6 = (s32) (src->mf[2][2] * 65536.0f);
    dest->unk_14 = (s16) (temp_f8_6 >> 0x10);
    temp_v0->unk_14 = (s16) temp_f8_6;
    temp_f18_6 = (s32) (src->mf[2][3] * 65536.0f);
    dest->unk_16 = (s16) (temp_f18_6 >> 0x10);
    temp_v0->unk_16 = (s16) temp_f18_6;
    temp_f8_7 = (s32) (src->mf[3][0] * 65536.0f);
    dest->unk_18 = (s16) (temp_f8_7 >> 0x10);
    temp_v0->unk_18 = (s16) temp_f8_7;
    temp_f18_7 = (s32) (src->mf[3][1] * 65536.0f);
    dest->unk_1A = (s16) (temp_f18_7 >> 0x10);
    temp_v0->unk_1A = (s16) temp_f18_7;
    temp_f8_8 = (s32) (src->mf[3][2] * 65536.0f);
    dest->unk_1C = (s16) (temp_f8_8 >> 0x10);
    temp_v0->unk_1C = (s16) temp_f8_8;
    temp_f18_8 = (s32) (src->mf[3][3] * 65536.0f);
    dest->unk_1E = (s16) (temp_f18_8 >> 0x10);
    temp_v0->unk_1E = (s16) temp_f18_8;
}
