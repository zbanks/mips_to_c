...
void func_801822C4(void *arg0, void *arg1, s32 arg2) {
    ...
    temp_f20 = arg0->unk_0;
    temp_f2 = arg0->unk_4;
    arg1->unk_2 = Math_Atan2S(-arg0->unk_8, sqrtf((temp_f20 * temp_f20) + (temp_f2 * temp_f2)));
    temp_v1 = arg1->unk_2;
    if ((temp_v1 == 0x4000) || (temp_v1 == -0x4000)) {
        arg1->unk_0 = 0;
        arg1->unk_4 = Math_Atan2S(-arg0->unk_10, arg0->unk_14);
        return;
    }
    temp_f12 = arg0->unk_4;
    temp_f14 = arg0->unk_0;
    arg0 = arg0;
    arg1->unk_4 = Math_Atan2S(temp_f12, temp_f14);
    if (arg2 == 0) {
        phi_v0 = Math_Atan2S(arg0->unk_18, arg0->unk_28);
    } else {
        temp_f20_2 = arg0->unk_10;
        temp_f2_2 = arg0->unk_14;
        temp_f16 = arg0->unk_24;
        temp_f2_3 = arg0->unk_18;
        temp_f2_4 = arg0->unk_20;
        temp_f16_2 = arg0->unk_28;
        phi_v0 = Math_Atan2S(temp_f2_3 / sqrtf((temp_f20_2 * temp_f20_2) + (temp_f2_2 * temp_f2_2) + (temp_f2_3 * temp_f2_3)), temp_f16_2 / sqrtf((temp_f2_4 * temp_f2_4) + (temp_f16 * temp_f16) + (temp_f16_2 * temp_f16_2)));
    }
    arg1->unk_0 = phi_v0;
}
