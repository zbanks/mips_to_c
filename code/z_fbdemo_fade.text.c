...
void TransitionFade_Update(void *arg0, s32 arg1) {
    ...
    if (temp_v0 != 0) {
        ...
        if (arg0->unk2 != 0) {
            arg0->unk7 = (u8) (0xFF - temp_f8);
            return;
        }
        arg0->unk7 = (u8) temp_f8;
    }
}
...
void TransitionFade_Draw(void *arg0, void **arg1) {
    ...
    if (arg0->unk7 != 0) {
        ...
        temp_v1->unk4 = &D_801D0CB0;
        temp_v1_2 = temp_v1 + 8;
        temp_v1_2->unk0 = 0xFA000000;
        temp_v0 = arg0 + 4;
        temp_v1_2->unk4 = (s32) ((temp_v0->unk0 << 0x18) | (temp_v0->unk1 << 0x10) | (temp_v0->unk2 << 8) | temp_v0->unk3);
        temp_v1_3 = temp_v1_2 + 8;
        temp_v1_3->unk4 = &D_0E0002E0;
