struct _mips2c_stack_BcCheck3_BgActorInit {};       /* size 0x0 */

struct _mips2c_stack_BgCheck3_LoadMesh {
    /* 0x00 */ char pad0[0x1C];
    /* 0x1C */ CollisionHeader *sp1C;               /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_BgCheck3_ResetFlags {};        /* size 0x0 */

struct _mips2c_stack_func_800CAE88 {};              /* size 0x0 */

struct _mips2c_stack_func_800CAE9C {};              /* size 0x0 */

struct _mips2c_stack_func_800CAEB0 {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_800CAEE0 {};              /* size 0x0 */

struct _mips2c_stack_func_800CAEF4 {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_800CAF24 {};              /* size 0x0 */

struct _mips2c_stack_func_800CAF38 {};              /* size 0x0 */

struct _mips2c_stack_func_800CAF4C {};              /* size 0x0 */

struct _mips2c_stack_func_800CAF70 {};              /* size 0x0 */

struct _mips2c_stack_func_800CAF94 {};              /* size 0x0 */

struct _mips2c_stack_func_800CAFB8 {};              /* size 0x0 */

struct _mips2c_stack_func_800CAFDC {};              /* size 0x0 */
