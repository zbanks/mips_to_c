typedef struct {
    /* 0x000 */ u8 controllers;
    /* 0x001 */ char pad_1[0x3];                    /* maybe part of controllers[4]? */
    /* 0x004 */ ? (*unk_4)(s32, ?);                 /* inferred */
    /* 0x008 */ s32 unk_8;                          /* inferred */
    /* 0x00C */ ? (*unk_C)(s32);                    /* inferred */
    /* 0x010 */ s32 unk_10;                         /* inferred */
    /* 0x014 */ OSContStatus statuses[4];
    /* 0x024 */ void *unk_24;                       /* inferred */
    /* 0x028 */ void *lockMesg[1];
    /* 0x02C */ void *interrupts[8];
    ...
    /* 0x2C9 */ char pad_2C9[0x8];                  /* maybe part of maxNumControllers[9]? */
    /* 0x2D1 */ u8 unk_2D1;                         /* inferred */
    /* 0x2D2 */ u8 unk_2D2;                         /* inferred */
    /* 0x2D3 */ u8 unk_2D3;                         /* inferred */
    /* 0x2D4 */ u8 unk_2D4;                         /* inferred */
    /* 0x2D5 */ char pad_2D5[0x1A7];                /* maybe part of unk_2D4[424]? */
    /* 0x47C */ u8 unk47C;
    /* 0x47D */ u8 unk47D;
    /* 0x47E */ u8 hasStopped;
    /* 0x47F */ char pad_47F[0x1];
} PadMgr;                                           /* size = 0x480 */

struct _mips2c_stack_Padmgr_CalcStickEdges {
...
struct _mips2c_stack_Padmgr_GetControllerBitmask {}; /* size 0x0 */

struct _mips2c_stack_Padmgr_GetEventCallback {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ void *sp1C;                          /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_Padmgr_GetInput {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Padmgr_GetInput2 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Padmgr_Lock {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Padmgr_ParseState {
    /* 0x00 */ char pad_0[0x40];
};                                                  /* size = 0x40 */

struct _mips2c_stack_Padmgr_SetEventCallback {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Padmgr_Start {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_Padmgr_Stop {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Padmgr_ThreadEntry {
    /* 0x00 */ char pad_0[0x54];
    /* 0x54 */ void *sp54;                          /* inferred */
};                                                  /* size = 0x58 */

struct _mips2c_stack_Padmgr_Unlock {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Padmgr_Update {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ void *sp1C;                          /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80174F24 {};              /* size 0x0 */

struct _mips2c_stack_func_80174F44 {};              /* size 0x0 */

struct _mips2c_stack_func_80174F7C {};              /* size 0x0 */

struct _mips2c_stack_func_80174F9C {};              /* size 0x0 */

struct _mips2c_stack_func_80175008 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ void *sp1C;                          /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8017506C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_801750FC {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ void *sp34;                          /* inferred */
    /* 0x38 */ char pad_38[0x8];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80175364 {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80175434 {};              /* size 0x0 */

struct _mips2c_stack_func_8017544C {};              /* size 0x0 */

struct _mips2c_stack_func_80175474 {};              /* size 0x0 */

struct _mips2c_stack_func_801754C0 {};              /* size 0x0 */

struct _mips2c_stack_func_801759BC {
    /* 0x00 */ char pad_0[0x40];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80175AE0 {
    /* 0x00 */ char pad_0[0x54];
    /* 0x54 */ s8 sp54;                             /* inferred */
    /* 0x55 */ char pad_55[0x3B];
};                                                  /* size = 0x90 */

struct _mips2c_stack_func_80175E68 {
...
void func_80174F24(? (*arg0)(s32, ?), s32 arg1) {
    padmgrContext->unk_4 = arg0;
    padmgrContext->unk_8 = arg1;
}
...
void func_80174F44(s32 arg0, s32 arg1) {
    ...
    if ((arg0 == temp_v0->unk_4) && (arg1 == temp_v0->unk_8)) {
        temp_v0->unk_4 = NULL;
        padmgrContext->unk_8 = 0;
    }
}

void func_80174F7C(? (*arg0)(s32), s32 arg1) {
    padmgrContext->unk_C = arg0;
    padmgrContext->unk_10 = arg1;
}
...
void func_80174F9C(s32 arg0, s32 arg1) {
    ...
    temp_v0 = padmgrContext;
    if ((arg0 == temp_v0->unk_C) && (arg1 == temp_v0->unk_10)) {
        temp_v0->unk_C = NULL;
        padmgrContext->unk_10 = 0;
    }
}
...
void func_801750FC(void) {
    ...
    do {
        ...
        if (temp_v0->unk_2C9 == 1) {
            if ((temp_v1->statuses[phi_s0].status & 1) != 0) {
                if (temp_v0->unk_2CD == 1) {
                    if (temp_v0->unk_2D1 != 0) {
                        if ((s32) temp_v0->unk_2D5 < 3) {
                            if (osSetRumble(temp_v1 + (phi_s0 * 0x68) + 0x2DC, 1) != 0) {
                                (padmgrContext + phi_s0)->unk_2CD = 0;
                                phi_s2 = 1;
                            } else {
                                (padmgrContext + phi_s0)->unk_2D5 = 3;
                                phi_s2 = 1;
                            }
                        }
                    } else if (temp_v0->unk_2D5 != 0) {
                        if (osSetRumble(temp_v1 + (phi_s0 * 0x68) + 0x2DC, 0) != 0) {
                            (padmgrContext + phi_s0)->unk_2CD = 0;
                            phi_s2 = 1;
                        } else {
                            temp_v0_2 = padmgrContext + phi_s0;
                            temp_v0_2->unk_2D5 = (u8) (temp_v0_2->unk_2D5 - 1);
                            phi_s2 = 1;
                        }
                    }
                }
            } else if (temp_v0->unk_2CD != 0) {
                temp_v0->unk_2CD = 0U;
            }
        }
        temp_s0 = phi_s0 + 1;
    ...
    if (phi_s2 == 0) {
        ...
        if ((temp_v0_3->unk_2C9 == 1) && ((temp_v1_2->statuses[temp_s0_2].status & 1) != 0) && (temp_v0_3->unk_2CD != 1)) {
            temp_v0_4 = osProbeRumblePak(sp34, temp_v1_2 + (temp_s0_2 * 0x68) + 0x2DC, temp_s0_2);
            if (temp_v0_4 == 0) {
                (padmgrContext + temp_s0_2)->unk_2CD = 1;
                (padmgrContext + temp_s0_2)->unk_2D5 = 2;
            } else if (temp_v0_4 == 0xB) {
                temp_v0_5 = padmgrContext + temp_s0_2;
                if (temp_v0_5->unk_2CD != 2) {
                    temp_v0_5->unk_2CD = 2U;
                }
...
void func_8017544C(s32 arg0, s8 arg1) {
    (padmgrContext + arg0)->unk_2D1 = arg1;
    padmgrContext->unk47D = 0x18;
}

void func_80175474(void *arg0) {
    padmgrContext->unk_2D1 = arg0->unk_0;
    padmgrContext->unk_2D2 = arg0->unk_1;
    padmgrContext->unk_2D3 = arg0->unk_2;
    padmgrContext->unk_2D4 = arg0->unk_3;
    padmgrContext->unk47D = 0x18;
}

s32 func_801754C0(s32 arg0) {
    return (padmgrContext + arg0)->unk_2CD == 1;
}
...
void Padmgr_ParseState(void) {
    ...
    if ((s32) temp_v0->maxNumControllers > 0) {
        do {
            temp_v1 = phi_s0 + 6;
            temp_v1->unk_0 = (unaligned s32) phi_s0->unk_0;
            temp_v1->unk_4 = (u16) phi_s0->unk_4;
            if ((padmgrContext + phi_s1)->unk_2C9 == 1) {
                ...
                if (temp_v0_2 != 0) {
                    if (temp_v0_2 != 4) {
                        if (temp_v0_2 != 8) {
                            ...
                            if (temp_v0_3->unk_2C9 != 0) {
                                temp_v0_3->unk_2C9 = 0U;
                                (padmgrContext + phi_s1)->unk_2CD = 0;
                                (padmgrContext + phi_s1)->unk_2D5 = 0xFF;
                            }
                        }
                    } else {
                        phi_s0->unk_0 = (unaligned s32) temp_v1->unk_0;
                        phi_s0->unk_4 = (u16) temp_v1->unk_4;
                    }
                } else {
                    phi_s0->unk_0 = (unaligned s32) phi_s2->unk_0;
                    phi_s0->unk_4 = (u16) phi_s2->unk_4;
                }
            } else {
                phi_s0->cur.button = 0;
                phi_s0->cur.stick_x = 0;
        ...
        do {
            if ((phi_v0 + phi_s0)->unk_2C9 == 4) {
                ...
                if (temp_s2 != 0) {
                    ...
                    (padmgrContext + phi_s0)->unk_2C9 = 5;
                    D_801D1538 = 2;
                    func_801A4EB0();
                }
...
void func_80175AE0(void) {
    ...
    do {
        ...
        phi_s4 = phi_s4_2;
        if (temp_a0->unk_17 == 0) {
            temp_v1 = temp_a0->unk_14 & 0x1F07;
            if (temp_v1 != 2) {
                if (temp_v1 != 5) {
                    if (temp_v1 != 0x100) {
                        if (temp_v0->unk_2C9 == 0) {
                            temp_v0->unk_2C9 = 0xFFU;
                            sprintf(&sp54, "知らない種類のコントローラ(%04x)を認識しました", (padmgrContext + phi_s2)->unk_14);
                            goto block_16;
                        }
                    } else if (temp_v0->unk_2C9 == 0) {
                        temp_v0->unk_2C9 = 4U;
                        (padmgrContext + phi_s0)->unk_2CD = 0;
                        goto block_16;
                    }
            ...
            temp_v0->unk_2C9 = 0U;
            (padmgrContext + phi_s0)->unk_2CD = 0;
            (padmgrContext + phi_s0)->unk_2D5 = 0xFFU;
block_16:
...
void Padmgr_Update(void) {
    ...
    temp_v1 = padmgrContext;
    temp_a1 = temp_v1->unk_4;
    if (temp_a1 != 0) {
        temp_a1(temp_v1->unk_8, temp_a1);
    }
    ...
    temp_v0_2 = temp_v1_3->unk_C;
    if (temp_v0_2 != 0) {
        temp_v0_2(temp_v1_3->unk_10);
    }
    Padmgr_Unlock();
    if (D_801D1538 != 0) {
        func_801759BC();
...
void Padmgr_Start(OSMesgQueue *siEventCallbackQueue, IrqMgr *irqmgr, s32 threadId, s32 threadPri, void *stack) {
    ...
    osCreateMesgQueue(&temp_a3->siEventCallbackQueue, &temp_a3->unk_24, 1);
