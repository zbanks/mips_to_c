typedef struct {
    ...
    /* 0x001 */ char pad1[0x3];                     /* maybe part of controllers[4]? */
    /* 0x004 */ ? (*unk4)(s32, ?);                  /* inferred */
    /* 0x008 */ s32 unk8;                           /* inferred */
    /* 0x00C */ ? (*unkC)(s32);                     /* inferred */
    /* 0x010 */ s32 unk10;                          /* inferred */
    /* 0x014 */ OSContStatus statuses[4];
    /* 0x024 */ void *unk24;                        /* inferred */
    ...
    /* 0x2C9 */ char pad2C9[0x8];                   /* maybe part of maxNumControllers[9]? */
    /* 0x2D1 */ u8 unk2D1;                          /* inferred */
    /* 0x2D2 */ u8 unk2D2;                          /* inferred */
    /* 0x2D3 */ u8 unk2D3;                          /* inferred */
    /* 0x2D4 */ u8 unk2D4;                          /* inferred */
    /* 0x2D5 */ char pad2D5[0x1A7];                 /* maybe part of unk2D4[424]? */
    /* 0x47C */ u8 unk47C;
    /* 0x47D */ u8 unk47D;
    /* 0x47E */ u8 hasStopped;
    /* 0x47F */ char pad47F[0x1];
} PadMgr;                                           /* size = 0x480 */
