...
void GameState_Draw(GameState *gamestate, GraphicsContext *gfxCtx) {
    GameState *self = (GameState *) gamestate;
    Gfx *sp3C;
    Gfx *sp38;
    GameInfo *temp_v0;
    Gfx *temp_a0;
    ...
    if (gGameInfo->data[96] != 0) {
        ...
        SpeedMeter_DrawAllocEntries((void *) &D_801F7FF0, gfxCtx, self);
    }
}
...
s32 func_80173B48(GameState *gamestate) {
    ...
    temp_ret_2 = __ll_mul((s64) ((s32) temp_a1 >> 0x1F), (s64) temp_a1, (s64) sIrqMgrRetraceTime.unk0, (s64) sIrqMgrRetraceTime.unk4);
    ...
    sp18 = temp_ret_4;
    sp1C = temp_v1;
    temp_ret = __ll_mul((s64) D_801FBAF0.unk0, (s64) D_801FBAF0.unk4, 0, 0x40);
