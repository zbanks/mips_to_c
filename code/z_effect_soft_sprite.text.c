struct _mips2c_stack_EffectSS_Clear {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EffectSS_Copy {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ s32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_EffectSS_Delete {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EffectSS_DrawAllParticles {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_EffectSS_DrawParticle {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EffectSS_FindFreeSpace {
    /* 0x0 */ char pad_0[0x4];
    /* 0x4 */ s32 sp4;                              /* inferred */
};                                                  /* size = 0x8 */

struct _mips2c_stack_EffectSS_GetTable {};          /* size 0x0 */

struct _mips2c_stack_EffectSS_Init {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EffectSS_ResetEntry {};        /* size 0x0 */

struct _mips2c_stack_EffectSS_UpdateAllParticles {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EffectSS_UpdateParticle {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EffectSs_Spawn {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ EffectSsOverlay *sp28;               /* inferred */
    /* 0x2C */ char pad_2C[0x4];
    /* 0x30 */ EffectSsInit *sp30;                  /* inferred */
    /* 0x34 */ char pad_34[0x8];                    /* maybe part of sp30[3]? */
    /* 0x3C */ s32 sp3C;                            /* inferred */
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_800B096C {};              /* size 0x0 */

struct _mips2c_stack_func_800B09D0 {};              /* size 0x0 */

struct _mips2c_stack_func_800B0A24 {};              /* size 0x0 */
...
void EffectSS_Copy(GlobalContext *globalCtx, EffectSs *particle) {
    ...
    if ((FrameAdvance_IsEnabled(globalCtx) != 1) && (EffectSS_FindFreeSpace((s32) particle->priority, &sp1C) == 0)) {
        ...
        do {
            temp_t3 = phi_t3 + 0xC;
            temp_t2 = phi_t2 + 0xC;
            temp_t2->unk_-C = (s32) phi_t3->pos.x;
...
block_9:
            if (phi_v0->init != 0) {
                ...
                if (phi_v0->init(globalCtx, sp3C, &EffectSS2Info.data_table[sp3C], initParams) == 0) {
...
void EffectSS_UpdateAllParticles(GlobalContext *globalCtx) {
    ...
    if (EffectSS2Info.size > 0) {
        do {
            ...
            temp_v0 = temp_a0->unk_5C;
            phi_v0 = (s32) temp_v0;
            if ((s32) temp_v0 >= 0) {
                temp_a0->unk_5C = (s16) (temp_v0 - 1);
                temp_v1 = EffectSS2Info.data_table;
                temp_v0_2 = (temp_v1 + phi_s0)->unk_5C;
                phi_v0 = (s32) temp_v0_2;
                if ((s32) temp_v0_2 < 0) {
                    EffectSS_Delete(phi_s0 + temp_v1);
                    phi_v0 = (s32) (EffectSS2Info.data_table + phi_s0)->unk_5C;
                }
            }
            if (phi_v0 >= 0) {
...
void EffectSS_DrawAllParticles(GlobalContext *globalCtx) {
    ...
    if (temp_v1 > 0) {
        ...
        do {
            ...
            if ((s32) temp_v0_2->unk_5C >= 0) {
                temp_f0 = temp_v0_2->unk_0;
                if ((temp_f0 > 32000.0f) || (temp_f0 < -32000.0f) || (temp_f0_2 = temp_v0_2->unk_4, (temp_f0_2 > 32000.0f)) || (temp_f0_2 < -32000.0f) || (temp_f0_3 = temp_v0_2->unk_8, (temp_f0_3 > 32000.0f)) || (temp_f0_3 < -32000.0f)) {
