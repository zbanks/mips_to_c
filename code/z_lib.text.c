...
void IChain_Apply_u8(u8 *ptr, InitChainEntry *ichain) {
    ptr[ichain->unk_0 & 0x7FF] = (u8) ichain->unk_2;
}
...
void IChain_Apply_u16(u8 *ptr, InitChainEntry *ichain) {
    ptr[ichain->unk_0 & 0x7FF] = (s16) ichain->unk_2;
}
...
void IChain_Apply_u32(u8 *ptr, InitChainEntry *ichain) {
    ptr[ichain->unk_0 & 0x7FF] = (s32) ichain->unk_2;
}
...
void IChain_Apply_f32(u8 *ptr, InitChainEntry *ichain) {
    ptr[ichain->unk_0 & 0x7FF] = (f32) ichain->unk_2;
}

void IChain_Apply_f32div1000(u8 *ptr, InitChainEntry *ichain) {
    ptr[ichain->unk_0 & 0x7FF] = (f32) ((f32) ichain->unk_2 / 1000.0f);
}
...
void IChain_Apply_Vec3f(u8 *ptr, InitChainEntry *ichain) {
    ...
    temp_v0 = &ptr[ichain->unk_0 & 0x7FF];
    temp_f0 = (f32) ichain->unk_2;
    temp_v0->unk_8 = temp_f0;
...
void IChain_Apply_Vec3fdiv1000(u8 *ptr, InitChainEntry *ichain) {
    ...
    temp_v0 = &ptr[ichain->unk_0 & 0x7FF];
    temp_f0 = (f32) ichain->unk_2 / 1000.0f;
    temp_v0->unk_8 = temp_f0;
    temp_v0->unk_4 = temp_f0;
    temp_v0->unk_0 = temp_f0;
}
...
void IChain_Apply_Vec3s(u8 *ptr, InitChainEntry *ichain) {
    ...
    temp_v1 = ichain->unk_2;
    temp_v0 = &ptr[ichain->unk_0 & 0x7FF];
    temp_v0->unk_4 = temp_v1;
    temp_v0->unk_2 = temp_v1;
    temp_v0->unk_0 = temp_v1;
}
