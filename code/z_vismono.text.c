...
void func_80141924(void *arg0) {
    ...
    do {
        ...
        temp_v0 = phi_v0 + 4;
        temp_v1 = phi_v1 + 8;
        temp_v1->unk_-8 = (s16) ((((s32) (((((phi_v0 >> 3) & 0x1F) * 2) + (((phi_v0 * 4) & 0x1F) * 4)) * 0xFF) / 0xD9) << 8) | ((s32) (((((phi_v0 >> 6) & 0x1F) * 4) + ((phi_v0 >> 1) & 0x1F)) * 0xFF) / 0xD9));
        temp_v1->unk_-6 = (s16) ((((s32) (((((temp_a0 >> 3) & 0x1F) * 2) + (((temp_a0 * 4) & 0x1F) * 4)) * 0xFF) / 0xD9) << 8) | ((s32) (((((temp_a0 >> 6) & 0x1F) * 4) + ((temp_a0 >> 1) & 0x1F)) * 0xFF) / 0xD9));
        temp_v1->unk_-4 = (s16) ((((s32) (((((temp_a1 >> 3) & 0x1F) * 2) + (((temp_a1 * 4) & 0x1F) * 4)) * 0xFF) / 0xD9) << 8) | ((s32) (((((temp_a1 >> 6) & 0x1F) * 4) + ((temp_a1 >> 1) & 0x1F)) * 0xFF) / 0xD9));
        temp_v1->unk_-2 = (s16) ((((s32) (((((temp_a2 >> 3) & 0x1F) * 2) + (((temp_a2 * 4) & 0x1F) * 4)) * 0xFF) / 0xD9) << 8) | ((s32) (((((temp_a2 >> 6) & 0x1F) * 4) + ((temp_a2 >> 1) & 0x1F)) * 0xFF) / 0xD9));
        phi_v0 = temp_v0;
        phi_v1 = temp_v1;
    } while (temp_v0 != 0x100);
}
...
void *func_80141C34(void *arg0) {
    ...
    arg0->unk_0 = 0xE7000000;
    arg0->unk_4 = 0;
    temp_a0_2 = arg0 + 8;
    temp_a0_2->unk_0 = 0xEF90CCF0;
    temp_a0_2->unk_4 = 0xC184344;
    temp_a0_3 = temp_a0_2 + 8;
    temp_a0_3->unk_0 = 0xFC64FE60;
    temp_a0_3->unk_4 = 0xF5FCFD7B;
    phi_a0 = temp_a0_3 + 8;
    phi_a3 = &D_0F000000;
    phi_a1 = 0;
    do {
        phi_a0->unk_0 = 0xFD500000;
        phi_a0->unk_4 = phi_a3;
        temp_a0_4 = phi_a0 + 8;
        temp_a0_4->unk_0 = 0xF5500000;
        temp_a0_4->unk_4 = 0x7080200;
        temp_a0_5 = temp_a0_4 + 8;
        temp_a0_5->unk_0 = 0xE6000000;
        temp_a0_5->unk_4 = 0;
        temp_a0_6 = temp_a0_5 + 8;
        temp_a0_6->unk_4 = (s32) (((0x3BF & 0xFFF) << 0xC) | 0x7000000 | 0x1A);
        temp_a0_6->unk_0 = 0xF3000000;
        temp_a0_7 = temp_a0_6 + 8;
        temp_a0_7->unk_0 = 0xE7000000;
        temp_a0_7->unk_4 = 0;
        temp_a0_8 = temp_a0_7 + 8;
        temp_a0_8->unk_0 = 0xF548A000;
        temp_a0_8->unk_4 = 0x80200;
        temp_a0_9 = temp_a0_8 + 8;
        temp_a0_9->unk_0 = 0xF2000000;
        temp_a0_9->unk_4 = 0x9FC008;
        temp_a0_10 = temp_a0_9 + 8;
        temp_a0_10->unk_0 = 0xF548A000;
        temp_a0_10->unk_4 = 0x80200;
        temp_a0_11 = temp_a0_10 + 8;
        temp_a0_11->unk_0 = 0xF2008000;
        temp_a0_11->unk_4 = 0xA04008;
        temp_a0_12 = temp_a0_11 + 8;
        temp_a0_12->unk_4 = 0x1180200;
        temp_a0_12->unk_0 = 0xF548A000;
        temp_a0_13 = temp_a0_12 + 8;
        temp_a0_13->unk_0 = 0xF2004000;
        temp_a0_13->unk_4 = 0x1A00008;
        temp_a0_14 = temp_a0_13 + 8;
        temp_v1 = phi_a1 + 3;
        temp_a0_14->unk_0 = (s32) (((temp_v1 * 4) & 0xFFF) | 0xE4500000);
        temp_a0_14->unk_4 = (s32) ((phi_a1 * 4) & 0xFFF);
        temp_a0_15 = temp_a0_14 + 8;
        temp_a0_15->unk_4 = 0x400000;
        temp_a0_15->unk_0 = 0xE1000000;
        temp_a0_16 = temp_a0_15 + 8;
        temp_a0_16->unk_0 = 0xF1000000;
        temp_a0_16->unk_4 = 0x8000400;
        temp_a0_17 = temp_a0_16 + 8;
        phi_a0 = temp_a0_17;
        phi_a3 += 0x780;
        phi_a1 = temp_v1;
    } while (temp_v1 < 0xEE);
    temp_a0_17->unk_0 = 0xE7000000;
    temp_a0_17->unk_4 = 0;
    temp_a0 = temp_a0_17 + 8;
    temp_a0->unk_0 = 0xDF000000;
    temp_a0->unk_4 = 0;
    return temp_a0 + 8;
}
...
void VisMono_Draw(void *arg0, Gfx **gfx, u32 arg2) {
    ...
    temp_t5->words.w1 = phi_a2->unk_8;
    temp_t9 = sp5C;
    sp5C = &temp_t9[1];
    temp_t9->words.w0 = 0xFB000000;
    temp_t9->words.w1 = phi_a2->unk_C;
    temp_t3 = sp5C;
    sp5C = &temp_t3[1];
