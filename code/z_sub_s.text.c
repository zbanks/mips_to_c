typedef struct EnDno_ActorUnkStruct {
    ...
    /* 0x20 */ Vec3f unk_20;
    /* 0x2C */ Vec3f unk_2C;
    /* 0x38 */ Vec3f unk38;                         /* inferred */
    /* 0x44 */ Vec3f *unk44;                        /* inferred */
    /* 0x48 */ Actor *unk_48;
    /* 0x4C */ f32 unk_4C;
    /* 0x50 */ f32 unk_50;
    /* 0x54 */ s16 unk_54;
...
struct _mips2c_stack_func_8013B0C8 {
    ...
    /* 0x010 */ char pad10[0x38];                   /* maybe part of spC[15]? */
    /* 0x048 */ ? sp48;                             /* inferred */
    /* 0x048 */ char pad48[0x1B8];
};                                                  /* size = 0x200 */

struct _mips2c_stack_func_8013B350 {
    /* 0x00 */ char pad0[0x64];
    /* 0x64 */ ? sp64;                              /* inferred */
    /* 0x64 */ char pad64[0x34];
};                                                  /* size = 0x98 */
...
struct _mips2c_stack_func_8013E950 {
    ...
    /* 0x24 */ char pad24[0x4];
    /* 0x28 */ s16 sp28;                            /* inferred */
    /* 0x2A */ char pad2A[0x4];                     /* maybe part of sp28[3]? */
...
Gfx *func_8013AB00(GlobalContext *globalCtx, void **skeleton, Vec3s *limbDrawTable, s32 dListCount, void *func1, void *func2, void *func3, Actor *actor, Gfx *gfx) {
    ...
    sp4C.unk4 = (u16) limbDrawTable->unkA;
    sp64 = temp_v0_2->unk8;
    sp60 = temp_v0_2->unk8;
...
block_11:
    ...
    sp68.unk0 = (f32) arg3->x;
    sp68.unk4 = (f32) arg3->y;
    sp68.unk8 = (f32) arg3->z;
    sp5C.unk0 = (f32) arg3->x;
    sp5C.unk4 = (f32) arg3->y;
    sp5C.unk8 = (f32) arg3->z;
...
s32 func_8013C068(u8 *arg0, s32 arg1, ? *arg2, f32 arg3, s32 arg4) {
    ...
    arg2->unk0 = (f32) ((sp88 * sp9C) + ((phi_f14 * sp7C) + (phi_f16 * sp80) + (phi_f18 * sp84)));
    arg2->unk8 = (f32) ((sp78 * sp9C) + ((phi_f14 * sp6C) + (phi_f16 * sp70) + (phi_f18 * sp74)));
    return 1;
}
...
u8 func_8013DB90(GlobalContext *globalCtx, void *arg1, f32 arg2) {
    ...
    sp58.unk4 = temp_t7;
    sp4C.unk4 = temp_t7;
    sp4C.unk0 = (s32) sp30.unk0;
    sp58.unk0 = (s32) sp30.unk0;
    sp30.unk8 = temp_t8;
    sp4C.unk8 = temp_t8;
    sp58.unk8 = temp_t8;
    sp50 += arg2;
