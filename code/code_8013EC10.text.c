struct _mips2c_stack_func_8013EC10 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8013EC44 {};              /* size 0x0 */

struct _mips2c_stack_func_8013ECE0 {};              /* size 0x0 */

struct _mips2c_stack_func_8013ED9C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8013EDD0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8013EE04 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8013EE24 {};              /* size 0x0 */

struct _mips2c_stack_func_8013EE38 {};              /* size 0x0 */

struct _mips2c_stack_func_8013EE48 {};              /* size 0x0 */
...
void func_8013EC44(f32 arg0, s32 arg1, s32 arg2, s32 arg3) {
    ...
    if ((phi_v0 < 0x3E8) && (temp_a1 != 0) && (temp_a3 != 0)) {
        ...
        if (temp_a0 > 0) {
            ...
            D_801F69D0.unk_10B = (s8) (arg2 & 0xFF);
            D_801F69D0.unk_10C = temp_a3;
        }
    }
}
...
loop_7:
        if (phi_a1->unk_4 == 0) {
            temp_a0 = temp_a1 - ((s32) (phi_v0 * 0xFF) / 0x3E8);
            if (temp_a0 > 0) {
                phi_a1->unk_4 = (u8) temp_a0;
                phi_a1->unk_44 = (s8) (arg2 & 0xFF);
                phi_a1->unk_84 = temp_a3;
                return;
            }
