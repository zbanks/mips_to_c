    ...
    do {
        ...
        if (temp_s0 != 0) {
            do {
                ...
                phi_a0 = phi_a0_2;
                if (phi_s0->unk_0 != 0x9F) {
                    if (phi_s0->unk_0 != 0xCA) {
                        if (phi_s0->unk_0 != 0xFA) {
                            if (phi_s0->unk_0 != 0x16A) {
                                if (phi_s0->unk_0 != 0x176) {
                                    if ((phi_s0->unk_0 != 0x21D) && (phi_s0->unk_0 != 0x21E)) {
                                        if (phi_s0->unk_0 != 0x252) {
