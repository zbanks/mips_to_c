...
static s32 D_801BF55C = {0x1B, 0x21, 0x49, 0x16, 0x18, 0x1F, 0x44, 0x5F, 0x36};
static s32 D_801BF580 = {0x1B, 0x21, 0x49, 0x16, 0x18};
static s32 D_801BF594 = {0x1F, 0x44, 0x5F, 0x36};
static s32 D_801BF5A4 = {0x2B, 0x6A, 0x35};
...
s32 func_8010A0F0(void *arg0) {
    ...
    phi_s0 = 0;
loop_1:
    if (convert_scene_number_among_shared_scenes(arg0->unkA4) == *phi_s1) {
        return phi_s0;
    }
    temp_s0 = phi_s0 + 1;
    phi_s1 += 4;
...
void func_8010A33C(GlobalContext *globalCtx, s16 param_2) {
    ...
    if ((s32) param_2 >= 0) {
        if (func_8010A074(globalCtx) != 0) {
            ...
            temp_a0->unk110 = (s32) (temp_a0->unk110 | gBitFlags[param_2]);
...
void func_8010A430(GlobalContext *arg0) {
    ...
    temp_v1->unk27A = -1;
    sp28 = temp_v1;
    temp_v1->unk17C = THA_AllocEndAlign16(arg0 + 0x74, 0x1000U);
    ...
    if (func_8010A074(arg0) != 0) {
        ...
        func_8010A33C(arg0, (s16) sp24->unk6E0);
    }
}
...
void func_8010A580(GlobalContext *arg0) {
    ...
    func_80105B34(arg0);
    if ((sp20->unk6F1C == 0) && (sp20->unk6F1E == 0)) {
        if (func_8010A164(arg0) != 0) {
            temp_v0_2 = func_80109124((s16) (s32) sp38->world.pos.y);
            if ((temp_v0_2 != -1) && (sp2E = temp_v0_2, temp_a0 = 4 - temp_v0_2, temp_v1 = (convert_scene_number_among_shared_scenes(arg0->sceneNum) * 0x1C) + &gSaveContext, temp_v1->unk10C = (s32) (temp_v1->unk10C | gBitFlags[temp_a0]), gGameInfo->data[1438] = temp_a0, temp_a1 = arg0->interfaceCtx.mapRoomNum, (D_801BF5B0 != temp_a1))) {
                D_801BF5B0 = temp_a1;
                return;
            }
