...
void *func_80163700(u32 arg0, void *arg1) {
    ...
    temp_v0 = D_801D0BAC;
    if ((temp_v0 != 0) && (temp_a2 = temp_v0->unk_0, temp_a1 = temp_v0->unk_C, (temp_a2 != 0)) && (arg0 >= temp_a2) && (arg0 < (u32) (temp_a2 + (temp_v0->unk_10 - temp_a1)))) {
...
void func_80163758(? *arg0) {
    ...
    temp_t6 = D_801D0BA8;
    arg0->unk_0 = temp_t6;
    Load2_LoadOverlay(arg0->unk_4, arg0->unk_8, arg0->unk_C, arg0->unk_10, temp_t6);
    arg0->unk_14 = (s32) (arg0->unk_0 - arg0->unk_C);
    D_801D0BAC = arg0;
}
...
void func_80163804(GlobalContext *globalCtx) {
    ...
    do {
        temp_v0 = phi_v0 + 0x1C;
        temp_v1 = phi_v0->unk_10 - phi_v0->unk_C;
        phi_v0 = temp_v0;
        phi_a1_2 = (u32) phi_a1;
        if (phi_a1 < temp_v1) {
...
s32 func_801638D8(u32 arg0) {
    ...
    if (temp_v1 == 0) {
loop_2:
        if ((temp_a1 >= (u32) phi_a0->unk_C) && ((u32) phi_a0->unk_10 >= temp_a1)) {
            sp1C = phi_a0;
            arg0 = temp_a1;
            func_80163758(phi_a0, temp_a1);
            return arg0 + phi_a0->unk_14;
        }
        temp_a0 = phi_a0 + 0x1C;
        phi_a0 = temp_a0;
    ...
    if ((temp_a1 < (u32) temp_v1->unk_C) || (temp_a1 >= (u32) temp_v1->unk_10)) {
        return 0;
    }
    return temp_a1 + temp_v1->unk_14;
}
