...
void TransitionCircle_Update(void *arg0) {
    ...
    arg0 = temp_a3;
    arg0->unk16 = Math_StepToF(temp_a3 + 4, temp_a1, temp_a2);
}
...
void func_80164C14(void **arg0, s32 arg1, s32 arg2, ? arg3, s32 arg4, s32 arg5, f32 arg6) {
    ...
    temp_v0 = *arg0;
    temp_a0 = (arg2 & 7) << 0x15;
    temp_v0->unk0 = (s32) (temp_a0 | 0xFD000000 | 0x100000);
    temp_v0->unk4 = arg1;
    temp_v0_2 = temp_v0 + 8;
    temp_a1 = temp_a0 | 0xF5000000;
    temp_a2 = (arg5 & 0xF) << 0xE;
    temp_a3 = (arg4 & 0xF) * 0x10;
    temp_v0_2->unk0 = (s32) (temp_a1 | 0x100000);
    temp_v0_2->unk4 = (s32) (temp_a2 | 0x70C0000 | 0x300 | temp_a3);
    ...
    temp_v0_4->unk4 = (s32) ((((s32) (phi_t3 + 0x7FF) / phi_t5) & 0xFFF) | 0x7000000 | ((phi_t2 & 0xFFF) << 0xC));
    temp_v0_5->unk0 = 0xE7000000;
    temp_v0_5->unk4 = 0;
    temp_v0_6->unk4 = (s32) (temp_a2 | 0xC0000 | 0x300 | temp_a3);
    temp_v0_6->unk0 = (s32) (temp_a1 | ((((s32) ((temp_v1 >> 1) + 7) >> 3) & 0x1FF) << 9));
    temp_v0_7 = temp_v0_6 + 8;
    temp_v0_7->unk4 = (s32) (((((temp_v1 - 1) * 4) & 0xFFF) << 0xC) | (((temp_a0_2 - 1) * 4) & 0xFFF));
    temp_v0_7->unk0 = 0xF2000000;
    temp_v0_8 = temp_v0_7 + 8;
    temp_v0_8->unk0 = (s32) (((((0xA0 - temp_v1) * 4) & 0xFFF) << 0xC) | 0xF2000000 | (((0x78 - temp_a0_2) * 4) & 0xFFF));
    temp_v0_8->unk4 = (s32) (((((temp_v1 + 0x9F) * 4) & 0xFFF) << 0xC) | (((temp_a0_2 + 0x77) * 4) & 0xFFF));
    ...
    temp_v0_9->unk0 = (s32) ((((D_801FBBCC * 4) & 0xFFF) << 0xC) | 0xE4000000 | ((D_801FBBCE * 4) & 0xFFF));
    temp_v0_9->unk4 = 0;
    temp_v0_10->unk0 = 0xE1000000;
    temp_v0_11 = temp_v0_10 + 8;
    temp_v0_10->unk4 = (s32) (((s32) (phi_f0 * 32.0f) << 0x10) | ((s32) (phi_f2 * 32.0f) & 0xFFFF));
    temp_v0_11->unk0 = 0xF1000000;
    temp_v0_11->unk4 = (s32) ((phi_v1 << 0x10) | (phi_a0 & 0xFFFF));
...
void TransitionCircle_Draw(void *arg0, void **arg1) {
    ...
    sp4C = temp_t8 + 8;
    temp_t8->unk4 = 0;
    temp_t8->unk0 = 0xE7000000;
    temp_t1 = sp4C;
    sp4C = temp_t1 + 8;
    temp_t1->unk4 = &D_801D0D00;
    temp_t1->unk0 = 0xDE000000;
    temp_v0 = sp4C;
    sp4C = temp_v0 + 8;
    temp_v0->unk0 = (s32) (arg0->unk3 | 0xFA000000);
    temp_v0->unk4 = (s32) ((arg0->unk0 << 0x18) | (arg0->unk1 << 0x10) | (arg0->unk2 << 8) | 1);
    temp_t8_2 = sp4C;
    if (arg0->unk15 == 0) {
        temp_t4 = sp4C;
        sp4C = temp_t4 + 8;
        temp_t4->unk4 = 0xFF39F6FB;
        temp_t4->unk0 = 0xFCFF9DFF;
    } else {
        sp4C = temp_t8_2 + 8;
        temp_t8_2->unk0 = 0xFCFFEDFF;
        temp_t8_2->unk4 = 0xFFD996CB;
    }
    func_80164C14(&sp4C, arg0->unk18, 4, 0, (s32) arg0->unk1C, (s32) arg0->unk1D, arg0->unk4);
    temp_t4_2 = sp4C;
    sp4C = temp_t4_2 + 8;
    temp_t4_2->unk4 = 0;
    temp_t4_2->unk0 = 0xE7000000;
    *arg1 = sp4C;
}
