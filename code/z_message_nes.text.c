typedef struct {
    ...
    /* 0x12088 */ char pad12088[0x10];              /* maybe part of unk12084[5]? */
    /* 0x12098 */ f32 unk12098;                     /* inferred */
    /* 0x1209C */ char pad1209C[0x15];              /* maybe part of unk12098[6]? */
    /* 0x120B1 */ u8 unk120B1;
...
struct _mips2c_stack_func_8015B198 {
    ...
    /* 0x7C */ char pad7C[0x14];                    /* maybe part of sp78[6]? */
    /* 0x90 */ s32 sp90;                            /* inferred */
    /* 0x94 */ u32 sp94;                            /* inferred */
    /* 0x98 */ char pad98[0xC];                     /* maybe part of sp94[4]? */
    /* 0xA4 */ f32 spA4;                            /* inferred */
    /* 0xA8 */ ? spA8;                              /* inferred */
    /* 0xA8 */ char padA8[0x14];
    /* 0xBC */ s32 spBC;                            /* inferred */
    /* 0xC0 */ char padC0[0x6];                     /* maybe part of spBC[2]? */
    ...
    /* 0xD2 */ char padD2[0x8];                     /* maybe part of spD0[5]? */
