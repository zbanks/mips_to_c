...
typedef struct {
    ...
    /* 0x000E */ s16 life;
    /* 0x0010 */ char pad10[0x8];                   /* maybe part of life[5]? */
...
void *Effect_GetParams(s32 index) {
    ...
    if (temp_a0 < 0xF) {
        if (sEffTable.tireMarks[temp_a0].base.active == 1) {
            return &sEffTable.tireMarks[temp_a0].params.particles[0].unk0;
        }
        return NULL;
    }
    return NULL;
...
void Effect_Init(GlobalContext *globalCtx) {
    ...
    phi_s0 = &sEffTable.sparks[0].base;
    do {
...
void Effect_DrawAll(GraphicsContext *gfxCtx) {
    ...
    do {
        if (phi_s0_2->blures[0].base.active != 0) {
            sEffInfoTable->unk24(phi_s0_2 + 0xE60, gfxCtx);
        }
        temp_s0_2 = phi_s0_2 + 0x1B0;
        phi_s0_2 = temp_s0_2;
    ...
    do {
        if (phi_s0_3->shieldParticles[0].base.active != 0) {
            sEffInfoTable->unk4C(phi_s0_3 + 0x3890, gfxCtx);
        }
    ...
    do {
        if (phi_s0_4->tireMarks[0].base.active != 0) {
            sEffInfoTable->unk60(phi_s0_4 + 0x3DF4, gfxCtx);
        }
        temp_s0_4 = phi_s0_4 + 0x610;
        phi_s0_4 = temp_s0_4;
...
void Effect_UpdateAll(GlobalContext *globalCtx) {
    ...
    phi_s1_2 = &sEffTable;
    do {
        if ((phi_s1_2->blures[0].base.active != 0) && (sEffInfoTable->unk20(phi_s1_2 + 0xE60) == 1)) {
    ...
    phi_s1_3 = &sEffTable;
    do {
        if ((phi_s1_3->shieldParticles[0].base.active != 0) && (sEffInfoTable->unk48(phi_s1_3 + 0x3890) == 1)) {
    ...
    phi_s1_4 = &sEffTable;
    do {
        if ((phi_s1_4->tireMarks[0].base.active != 0) && (sEffInfoTable->unk5C(phi_s1_4 + 0x3DF4) == 1)) {
