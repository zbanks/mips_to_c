...
struct _mips2c_stack_BgCheck_AddActorMeshToLists {
    ...
    /* 0x164 */ char pad_164[0xC];                  /* maybe part of sp160[4]? */
    /* 0x170 */ ? sp170;                            /* inferred */
    /* 0x170 */ char pad_170[0x4];
    /* 0x174 */ f32 sp174;                          /* inferred */
    /* 0x178 */ char pad_178[0x18];
};                                                  /* size = 0x190 */
...
struct _mips2c_stack_BgCheck_SplitScenePolygonsIntoSubdivisions {
    ...
    /* 0x080 */ char pad_80[0x18];                  /* maybe part of sp7C[7]? */
...
struct _mips2c_stack_func_800C12A4 {
    /* 0x000 */ char pad_0[0x98];
    /* 0x098 */ f32 sp98;                           /* inferred */
    /* 0x09C */ char pad_9C[0x18];                  /* maybe part of sp98[7]? */
    /* 0x0B4 */ f32 spB4;                           /* inferred */
    /* 0x0B8 */ char pad_B8[0x1C];                  /* maybe part of spB4[8]? */
    /* 0x0D4 */ void *spD4;                         /* inferred */
    /* 0x0D8 */ void *spD8;                         /* inferred */
    /* 0x0DC */ void *spDC;                         /* inferred */
    /* 0x0E0 */ char pad_E0[0x8];                   /* maybe part of spDC[3]? */
    /* 0x0E8 */ s32 spE8;                           /* inferred */
    /* 0x0EC */ char pad_EC[0x4];
    /* 0x0F0 */ s32 spF0;                           /* inferred */
    /* 0x0F4 */ f32 spF4;                           /* inferred */
    /* 0x0F8 */ char pad_F8[0xC];                   /* maybe part of spF4[4]? */
...
struct _mips2c_stack_func_800C20F4 {
    ...
    /* 0x4C */ char pad_4C[0x1C];                   /* maybe part of sp48[8]? */
...
struct _mips2c_stack_func_800C45C4 {
    ...
    /* 0xC0 */ char pad_C0[0x10];                   /* maybe part of spBC[5]? */
...
struct _mips2c_stack_func_800C7974 {
    ...
    /* 0x070 */ ? sp70;                             /* inferred */
    /* 0x070 */ char pad_70[0x14];
    /* 0x084 */ s32 sp84;                           /* inferred */
    /* 0x088 */ char pad_88[0x4];
    /* 0x08C */ ? sp8C;                             /* inferred */
    /* 0x08C */ char pad_8C[0x48];
    ...
    /* 0x0E8 */ f32 spE8;                           /* inferred */
    /* 0x0EC */ ? spEC;                             /* inferred */
    /* 0x0EC */ char pad_EC[0xC];
    /* 0x0F8 */ ? spF8;                             /* inferred */
    /* 0x0F8 */ char pad_F8[0xC];
    /* 0x104 */ ? sp104;                            /* inferred */
    /* 0x104 */ char pad_104[0x1C];
};                                                  /* size = 0x120 */
...
struct _mips2c_stack_func_800C7E40 {
    ...
    /* 0x9C */ char pad_9C[0x18];                   /* maybe part of sp98[7]? */
    ...
    /* 0xCC */ char pad_CC[0x8];                    /* maybe part of spC8[3]? */
    /* 0xD4 */ s32 spD4;                            /* inferred */
    ...
    *param_3 = 0;
    ...
    do {
        ...
        *phi_v1 = phi_t0->vtxData[0] & 0x1FFF;
        temp_t1->unk_-4 = (s32) (phi_t2->vtxData[0] & 0x1FFF);
        phi_t0 += 2;
        phi_v1 += 4;
        phi_t2 += 2;
        phi_t1 = (? *) temp_t1;
...
s32 func_800C0474(CollisionPoly *arg0, s32 arg1, ?32 arg2, ?32 arg3, f32 *arg4, CollisionContext *arg5) {
    ...
    D_801EDA18.x = (f32) temp_v0->unk_0;
...
s32 func_800C07F0(CollisionPoly **arg0) {
    ...
    D_801EDBA4 = (f32) arg0->unk_0->dist;
    temp_t8 = arg0->unk_0;
    temp_f8 = D_801EDBA4;
    sp38 = temp_t8;
    temp_v0 = arg0->unk_8;
...
f32 func_800C0E74(CollisionContext *arg0, u16 arg1, u16 *arg2, CollisionPoly **arg3, CollisionPoly **arg4, f32 arg5, CollisionContext *arg6, s32 arg7, void *arg8, s32 arg9) {
    ...
    phi_a1 = temp_a1;
loop_3:
    temp_s0 = phi_a3 + (phi_s1->unk_0 * 0x10);
    phi_f20_2 = phi_f20;
    phi_f20_3 = phi_f20;
    if ((((arg7 & 1) != 0) && ((s32) temp_s0->normal.y < 0)) || (((arg9 & 0x20) != 0) && ((((u32) *(phi_a2->surfaceTypeList + (temp_s0->type * 8)) >> 0x1E) & 1) != 0)) || (temp_v0_2 = temp_s0->vtxData[0], ((temp_v0_2 & ((arg1 & 7) << 0xD)) != 0)) || ((temp_a0 = temp_s0->vtxData[1], ((temp_a0 & 0x8000) != 0)) && (((arg8 != 0) && (arg8->unk_2 != 2)) || ((arg8 == 0) && (arg1 != 1))))) {
        temp_v0_4 = phi_s1->unk_2;
        if (temp_v0_4 != 0xFFFF) {
...
loop_4:
    temp_f0 = arg5->unk_4;
    temp_s0 = (phi_s1->unk_0 * 0x10) + spE8;
    temp_t0 = (temp_s0->vtxData[2] * 6) + temp_s3;
    temp_a0 = ((temp_s0->vtxData[0] & 0x1FFF) * 6) + temp_s3;
    temp_a1 = ((temp_s0->vtxData[1] & 0x1FFF) * 6) + temp_s3;
    if ((temp_f0 < (f32) temp_a0->unk_2) && (temp_f0 < (f32) temp_a1->unk_2) && (temp_f0 < (f32) temp_t0->unk_2)) {
        phi_s1_2 = phi_v1 + (arg0->unk_2 * 4);
    } else {
        spD4 = temp_t0;
        ...
        if ((arg6 < fabsf(temp_f0_2)) || ((temp_s0->vtxData[0] & ((arg2 & 7) << 0xD)) != 0) || (((temp_s0->vtxData[1] & 0x8000) != 0) && (((arg8 != 0) && (arg8->actor.category != 2)) || ((arg8 == 0) && (arg2 != 1))))) {
            ...
            if (temp_v0_5 == 0xFFFF) {
                phi_s1_2 = arg1->polyNodes.tbl + (arg0->unk_2 * 4);
            } else {
            ...
            if (temp_f16 < 0.4f) {
                ...
                temp_f12 = (f32) temp_a0->unk_4;
                temp_f0_3 = (f32) temp_a1->unk_4;
                phi_f2 = temp_f12;
                phi_f12 = temp_f12;
                ...
                if ((sp10C < (phi_f2_2 - arg6)) || (temp_f12_2 < sp10C)) {
                    ...
                    spB4 = temp_f16;
                    sp98 = temp_f14;
                    if (func_800C074C((bitwise Vec3s *) temp_f12_2, temp_f14, temp_s0, temp_s3, sp104, arg5->unk_4, &spF4) != 0) {
                        temp_f2 = spF4 - sp10C;
...
loop_43:
    temp_s0_2 = (phi_s1_2->unk_0 * 0x10) + spE8;
    ...
    if (!(arg5->unk_4 < (f32) temp_a0_2->unk_2) || !(arg5->unk_4 < (f32) temp_a1_2->unk_2) || !(arg5->unk_4 < (f32) temp_t0_2->unk_2)) {
        spD4 = temp_t0_2;
        ...
        if ((arg6 < fabsf(temp_f0_5)) || ((temp_s0_2->vtxData[0] & ((arg2 & 7) << 0xD)) != 0) || (((temp_s0_2->vtxData[1] & 0x8000) != 0) && (((arg8 != 0) && (arg8->actor.category != 2)) || ((arg8 == 0) && (arg2 != 1))))) {
            ...
            if (temp_f16_2 < 0.4f) {
                temp_v0_6 = phi_s1_2->unk_2;
                if (temp_v0_6 != 0xFFFF) {
                    phi_s1_2 = arg1->polyNodes.tbl + (temp_v0_6 * 4);
                    goto block_77;
                }
            } else {
                temp_f12_3 = (f32) temp_a0_2->unk_0;
                temp_f0_6 = (f32) temp_a1_2->unk_0;
                phi_f2_3 = temp_f12_3;
                ...
                if ((sp104 < (phi_f2_4 - arg6)) || (temp_f12_4 < sp104)) {
                    ...
                    spB4 = temp_f16_2;
                    sp98 = temp_f14_2;
                    if (func_800C06A8((bitwise Vec3s *) temp_f12_4, temp_f14_2, temp_s0_2, temp_s3, arg5->unk_4, sp10C, &spF4) != 0) {
...
loop_3:
    temp_t0 = phi_s1->unk_0 * 0x10;
    temp_v1_2 = phi_a0 + temp_t0;
    phi_t2_2 = phi_t2;
    if (((temp_v1_2->unk_2 & phi_t1) != 0) || ((temp_s0 = temp_t0 + temp_v0->polyList, ((temp_v1_2->unk_4 & 0x8000) != 0)) && (((arg7 != 0) && (arg7->unk_2 != 2)) || ((arg7 == 0) && (temp_a1 != 1))))) {
        temp_v0_3 = phi_s1->unk_2;
        if (temp_v0_3 != 0xFFFF) {
        ...
        sp60 = phi_t1;
        phi_t2_3 = phi_t2;
        if (func_800C0668(temp_s0, sp7C, arg4->unk_0, arg4->unk_8, &sp84) != 0) {
            temp_f0 = sp84 - *arg3;
...
s32 func_800C20F4(void *arg0, u16 arg1, Vec3f *arg2, Vec3f *arg3, f32 arg4, CollisionPoly **arg5, CollisionPoly **arg6) {
    ...
    temp_a1 = arg1 & 0xFFFF;
    temp_v0 = arg2->x;
    temp_t0 = temp_v0->unk_18;
    temp_s2 = temp_v0->unk_10;
    phi_t0 = temp_t0;
    phi_s1 = arg0;
    phi_t2 = (temp_a1 & 7) << 0xD;
    phi_t1 = temp_t0;
loop_1:
    temp_a0 = phi_s1->unk_0 * 0x10;
    ...
    temp_f0 = arg3->y + arg4;
    if (!(temp_f0 < (f32) (temp_s2 + ((temp_s0->vtxData[0] & 0x1FFF) * 6))->unk_2) || !(temp_f0 < (f32) (temp_s2 + ((temp_s0->vtxData[1] & 0x1FFF) * 6))->unk_2) || !(temp_f0 < (f32) (temp_s2 + (temp_s0->vtxData[2] * 6))->unk_2)) {
        sp68 = phi_t1;
        sp48 = phi_t2;
...
s32 func_800C3C94(CollisionContext *arg0, ? *arg1) {
    ...
    temp_f0 = arg1->unk_0;
    if ((temp_f0 < (arg0->minBounds.x - 50.0f)) || ((arg0->maxBounds.x + 50.0f) < temp_f0) || (temp_f0_2 = arg1->unk_4, (temp_f0_2 < (arg0->minBounds.y - 50.0f))) || ((arg0->maxBounds.y + 50.0f) < temp_f0_2) || (temp_f0_3 = arg1->unk_8, (temp_f0_3 < (arg0->minBounds.z - 50.0f))) || ((arg0->maxBounds.z + 50.0f) < temp_f0_3)) {
        return 0;
    }
    return 1;
}
...
f32 func_800C3D50(s32 arg0, CollisionContext *colCtx, s32 arg2, CollisionPoly **arg3, s32 *arg4, Vec3f *pos, Actor *actor, s32 arg7, f32 arg8, s32 arg9) {
    ...
    *arg4 = 0x32;
    *arg3 = NULL;
    spA0.unk_0 = (f32) pos->x;
    spA0.unk_4 = (f32) pos->y;
    spA0.unk_8 = (f32) pos->z;
...
f32 func_800C4314(CollisionContext *arg0, void *arg1, Vec3f *arg2) {
    ...
    if (sp3C != 0) {
        arg1->unk_0 = (unaligned s32) sp3C->unk_0;
        arg1->unk_4 = (unaligned s32) sp3C->unk_4;
        arg1->unk_8 = (unaligned s32) sp3C->unk_8;
        arg1->unk_C = (unaligned s32) sp3C->unk_C;
    }
...
f32 func_800C43CC(CollisionContext *arg0, void *arg1, s32 *arg2, Vec3f *arg3) {
    ...
    if (sp34 != 0) {
        arg1->unk_0 = (unaligned s32) sp34->unk_0;
        arg1->unk_4 = (unaligned s32) sp34->unk_4;
        arg1->unk_8 = (unaligned s32) sp34->unk_8;
        arg1->unk_C = (unaligned s32) sp34->unk_C;
    }
    ...
    *arg6 = 0;
    ...
    if (((temp_f0 != 0.0f) || (temp_f2 != 0.0f)) && ((arg10 & 1) == 0)) {
        if ((arg9 + temp_f12) < 5.0f) {
            ...
            phi_v1 = temp_v1;
            if (temp_v0 != 0) {
                temp_f12_2 = (f32) spD0->unk_A * 0.00003051851f;
                if (temp_f12_2 > 0.5f) {
                    arg2->x = spA8;
                    if (arg9 > 1.0f) {
                        arg2->y = spAC - 1.0f;
                    ...
                    arg2->x = (arg5 * ((f32) spD0->unk_8 * 0.00003051851f)) + spA8;
                    arg2->y = (arg5 * temp_f12_2) + spAC;
                    arg2->z = (arg5 * ((f32) spD0->unk_C * 0.00003051851f)) + spB0;
                }
                *arg6 = (s32) spD0;
                *arg7 = spA4;
            }
            ...
            sp88.unk_0 = (f32) arg3->x;
            sp88.unk_4 = (f32) arg3->y;
            sp88.unk_8 = (f32) arg3->z;
            sp8C += arg9;
            sp7C.unk_0 = (f32) arg4->x;
            sp7C.unk_4 = (f32) arg4->y;
            sp7C.unk_8 = (f32) arg4->z;
            sp80 = sp8C;
            temp_v0_2 = func_800C4FD4(temp_f12, arg9, colCtx, (u16) arg1, NULL, (Vec3f *) &sp7C, (Vec3f *) &sp88, &spA8, &spD0, &spA4, arg8, 1.0f, phi_v0);
            phi_v1 = temp_v0_2;
            if (temp_v0_2 != 0) {
                temp_f2_2 = (f32) spD0->unk_8 * 0.00003051851f;
                temp_f12_3 = (f32) spD0->unk_C * 0.00003051851f;
                ...
                if (!(fabsf(temp_f16) < 0.008f)) {
                    ...
                    *arg7 = spA4;
                    phi_v1 = 1;
                    if ((((f32) spD0->unk_A * 0.00003051851f) > 0.5f) && (arg8 != 0)) {
                        arg8->actor.bgCheckFlags |= 0x1000;
                    }
                }
            }
    ...
    temp_a3 = &arg2->z;
    spB8.unk_0 = (f32) arg2->x;
    spB8.unk_4 = (f32) arg2->y;
    spB8.unk_8 = (f32) arg2->z;
    spB4 = 0;
    spBC += arg9;
    sp40 = temp_a3;
    spD4 = phi_v1;
    ...
    if ((spB4 != 0) || (*arg7 != 0x32)) {
        ...
        if (func_800C4FD4((bitwise f32) colCtx, (bitwise f32) (u16) arg1, NULL, (u16) arg4, arg2, (Vec3f *) &sp58, (Vec3f *) &spD0, &sp54, (void **) arg8, (s32 *)0x3F800000, (DynaPolyActor *)9) != 0) {
            temp_f2_3 = (f32) spD0->unk_8 * 0.00003051851f;
            temp_f12_4 = (f32) spD0->unk_C * 0.00003051851f;
...
s32 func_800C4E10(CollisionContext *arg0, u16 arg1, f32 *arg2, ? *arg3, f32 arg4, CollisionPoly **arg5, s32 *arg6, void *arg7) {
    ...
    *arg2 = arg3->unk_4;
    ...
    sp40.unk_0 = (s32) arg3->unk_0;
    temp_a2 = &sp3C;
    sp40.unk_4 = (f32) arg3->unk_4;
    sp40.unk_8 = (s32) arg3->unk_8;
    sp44 = *arg2;
    sp4C = temp_v0;
    sp3C = *arg2;
    phi_v1 = sp4C;
...
s32 func_800C4FD4(CollisionContext *arg0, u16 arg1, s32 arg2, ? *arg3, Vec3f *arg4, Vec3f *arg5, Vec3f *arg6, f32 *arg7, void **arg8, s32 *arg9, s32 argA) {
    ...
    spD4.unk_0 = (s32) arg4->x;
    spD4.unk_4 = (s32) arg4->y;
    spD4.unk_8 = (s32) arg4->z;
    *arg7 = 7e-44.0f;
    func_800C9640(arg0 + 0x44, arg0->colHeader->unk_14);
...
void BgCheck_SetActorMeshParams(ScaleRotPos *params, Vec3f *scale, Vec3s *rotation, Vec3f *position) {
    ...
    params->unk_C = (unaligned s32) rotation->unk_0;
...
void BgCheck_ActorMeshInit(GlobalContext *globalCtx, BgActor *mesh) {
    ...
    BgCheck_ActorMeshWaterboxesIndexInit(&mesh->unk_12);
...
void BgCheck_ActorMeshInitFromActor(BgActor *actorMesh, DynaPolyActor *actor, CollisionHeader *header) {
    ...
    actorMesh->unk_20 = (unaligned s32) temp_v1->unk_0;
    ...
    actorMesh->unk_40 = (unaligned s32) temp_v1->unk_0;
...
void BgCheck_ActorMeshUpdateParams(GlobalContext *globalCtx, BgActor *mesh) {
    ...
    mesh->unk_20 = (s32) mesh->unk_40;
    mesh->prevTransform.scale.z = mesh->curTransform.scale.z;
    mesh->unk_24 = (s32) mesh->unk_44;
...
void BgCheck_AddActorMeshToLists(GlobalContext *globalCtx, DynaCollisionContext *dyna, s32 index, s32 *currVertices, s32 *currPolygons, s32 *currWaterboxes) {
    ...
    dyna->bgActors[index].unk_12 = (s16) *currWaterboxes;
    sp170.unk_0 = (f32) temp_v0->world.pos.x;
    sp170.unk_4 = (f32) temp_v0->world.pos.y;
    sp170.unk_8 = (f32) temp_v0->world.pos.z;
        ...
        if ((temp_v0_3 != 0) && (temp_s5->numPolygons != 0)) {
            ...
            if ((s32) temp_s5->numVertices > 0) {
                ...
                do {
                    ...
                    sp148 = (f32) (dyna->vtxList + phi_s0_3)->unk_2;
                    sp154 = phi_f2;
                    sp14C = (f32) (dyna->vtxList + phi_s0_3)->unk_4;
            ...
            if ((s32) temp_s5->numPolygons > 0) {
                do {
                    ...
                    temp_a1 = &sp12C;
                    temp_a2_3 = &sp120;
                    temp_s0_2->unk_0 = (unaligned s32) temp_t8->unk_0;
                    temp_v1_2 = temp_s0_2->vtxData[0];
                    temp_s0_2->unk_4 = (unaligned s32) temp_t8->unk_4;
                    temp_a0_3 = temp_s0_2->vtxData[1];
                    temp_s0_2->unk_8 = (unaligned s32) temp_t8->unk_8;
                    temp_s0_2->unk_C = (unaligned s32) temp_t8->unk_C;
        ...
        if ((s32) temp_v0_7 > 0) {
            ...
            if ((s32) temp_v0_7 > 0) {
                ...
                do {
                    ...
                    spA0 += (f32) (temp_s5->waterBoxes + phi_s1_5)->unk_6;
                    Math_Vec3f_Copy((Vec3f *) &sp88, (Vec3f *) &spB8);
                    sp90 += (f32) (temp_s5->waterBoxes + phi_s1_5)->unk_8;
                    ...
                    temp_s0_3->properties = (temp_s5->waterBoxes + phi_s1_5)->unk_C;
                    temp_s3_2 = phi_s3 + 1;
                    phi_s1_5 += 0x10;
                    phi_s3 = temp_s3_2;
...
void func_800C756C(s32 param_1, s32 *param_2, s32 *param_3, s32 *param_4) {
    ...
    *param_4 = 0;
    ...
    phi_v0 = 0;
    do {
        temp_t0 = phi_v1->unk_138C;
        if (((temp_t0 & 1) != 0) && ((temp_t0 & 2) == 0) && ((temp_t0 & 4) == 0)) {
            temp_t0_2 = (param_1 + (phi_v0 * 0x64))->unk_8;
            *param_2 += temp_t0_2->unk_14;
            *param_3 += temp_t0_2->unk_C;
            *param_4 += temp_t0_2->unk_24;
        }
        temp_t0_3 = phi_v1->unk_138E;
        if (((temp_t0_3 & 1) != 0) && ((temp_t0_3 & 2) == 0) && ((temp_t0_3 & 4) == 0)) {
            temp_t0_4 = (param_1 + (phi_v0 * 0x64))->unk_6C;
            *param_2 += temp_t0_4->unk_14;
            *param_3 += temp_t0_4->unk_C;
            *param_4 += temp_t0_4->unk_24;
        }
        temp_v0 = phi_v0 + 2;
        phi_v1 += 4;
        phi_v0 = temp_v0;
...
f32 func_800C7974(s32 *arg0) {
    ...
    *arg0->unk_18 = 0x32;
    ...
    phi_f20_3 = -32000.0f;
    do {
        temp_v0 = (phi_a2 + phi_s3)->unk_13DC;
        phi_a2_2 = phi_a2;
        phi_f20 = phi_f20_3;
        phi_f20 = phi_f20_3;
        phi_f20 = phi_f20_3;
...
loop_4:
    temp_s0 = arg2->unk_13F0 + (phi_s1->unk_0 * 0x10);
    ...
    if ((arg9 < fabsf(temp_f0)) || (temp_a0 = temp_s0->vtxData[0], ((temp_a0 & ((arg1 & 7) << 0xD)) != 0)) || ((temp_v1 = temp_s0->vtxData[1], ((temp_v1 & 0x8000) != 0)) && (((argB != 0) && (argB->actor.category != 2)) || ((argB == 0) && (arg1 != 1))))) {
        ...
        if (temp_f18 < 0.4f) {
            temp_v0 = phi_s1->unk_2;
            if (temp_v0 != 0xFFFF) {
                phi_s1 = arg2->unk_1400 + (temp_v0 * 4);
                goto loop_4;
            }
        } else {
            temp_a1 = arg2->unk_13F4;
            temp_f12 = (f32) (temp_a1 + ((temp_a0 & 0x1FFF) * 6))->unk_4;
            temp_f0_2 = (f32) (temp_a1 + ((temp_v1 & 0x1FFF) * 6))->unk_4;
            phi_f2 = temp_f12;
            phi_f12 = temp_f12;
            ...
            temp_f0_3 = (f32) (temp_a1 + (temp_s0->vtxData[2] * 6))->unk_4;
            phi_f2_2 = phi_f2;
            phi_f12_2 = phi_f12;
            if (temp_f0_3 < phi_f2) {
                phi_f2_2 = temp_f0_3;
            ...
            if ((spBC < (phi_f2_2 - arg9)) || (temp_f12_2 < spBC)) {
                temp_v0_3 = phi_s1->unk_2;
                if (temp_v0_3 != 0xFFFF) {
                    phi_s1 = arg2->unk_1400 + (temp_v0_3 * 4);
                    goto loop_4;
                }
            } else {
                sp98 = temp_f18;
                ...
                temp_v0_2 = phi_s1->unk_2;
                if (temp_v0_2 != 0xFFFF) {
                    phi_s1 = arg2->unk_1400 + (temp_v0_2 * 4);
                    goto loop_4;
                }
            }
        }
    ...
    phi_t3 = *arg3 * 4;
loop_36:
    phi_s1_2 = arg2->unk_1400 + phi_t3;
loop_37:
    temp_s0_2 = arg2->unk_13F0 + (phi_s1_2->unk_0 * 0x10);
    ...
    if ((arg9 < fabsf(temp_f0_4)) || (temp_a0_2 = temp_s0_2->vtxData[0], ((temp_a0_2 & ((arg1 & 7) << 0xD)) != 0)) || ((temp_v1_2 = temp_s0_2->vtxData[1], ((temp_v1_2 & 0x8000) != 0)) && (((argB != 0) && (argB->actor.category != 2)) || ((argB == 0) && (arg1 != 1))))) {
        ...
        if (temp_f18_2 < 0.4f) {
            temp_v0_5 = phi_s1_2->unk_2;
            if (temp_v0_5 != 0xFFFF) {
                phi_s1_2 = arg2->unk_1400 + (temp_v0_5 * 4);
                goto loop_37;
            }
        } else {
            temp_a1_2 = arg2->unk_13F4;
            ...
            if ((spB4 < (phi_f2_4 - arg9)) || (temp_f12_4 < spB4)) {
                temp_v0_7 = phi_s1_2->unk_2;
                if (temp_v0_7 != 0xFFFF) {
                    phi_s1_2 = arg2->unk_1400 + (temp_v0_7 * 4);
                    goto loop_37;
                }
            } else {
                sp98 = temp_f18_2;
                ...
                temp_v0_6 = phi_s1_2->unk_2;
                if (temp_v0_6 != 0xFFFF) {
                    phi_s1_2 = arg2->unk_1400 + (temp_v0_6 * 4);
                    goto loop_37;
                }
            }
        }
...
s32 func_800C8580(f32 *arg0, u16 arg1, f32 *arg2, f32 *arg3, ? *arg4, f32 arg5, s32 *arg6, s32 *arg7, DynaPolyActor *arg8) {
    ...
    phi_s4 = 0;
    do {
        temp_v0 = phi_s6->unk_13DC;
        if (((temp_v0 & 1) != 0) && ((temp_v0 & 2) == 0)) {
            temp_v0_2 = phi_s4 * 0x64;
            temp_s3 = arg0 + temp_v0_2;
            temp_v1 = arg0 + temp_v0_2;
            if (arg8 != temp_s3->unk_54) {
                temp_s0 = temp_v1 + 0x54;
                if (!(sp98 < temp_v1->unk_B0) && !(temp_s0->unk_60 < sp98)) {
                    temp_f10 = (s32) arg5;
                    temp_s0->unk_5A = (s16) (temp_s0->unk_5A + (s16) temp_f10);
                    temp_s1 = temp_s0 + 0x54;
                    temp_f0 = (f32) temp_s0->unk_5A;
                    temp_f2 = (f32) temp_s0->unk_54 - sp94;
                    temp_f12 = (f32) temp_s0->unk_58 - sp9C;
...
loop_3:
    ...
    phi_s7 = phi_s7_2;
    phi_s7_3 = phi_s7_2;
    if (((temp_s0->vtxData[0] & ((temp_a1 & 7) << 0xD)) != 0) || (((temp_s0->vtxData[1] & 0x8000) != 0) && (((arg8 != 0) && (arg8->unk_2 != 2)) || ((arg8 == 0) && (temp_a1 != 1))))) {
        temp_v0_4 = phi_s1->unk_2;
        if (temp_v0_4 != 0xFFFF) {
            phi_s1 = arg2->unk_1400 + (temp_v0_4 * 4);
            goto loop_3;
        }
    } else {
        ...
        if (arg6 < Math3D_NormalizedDistanceFromPlane(sp8C, sp88, sp84, (f32) temp_s0->dist, (Vec3f *) &sp98)) {
            ...
            if ((func_800C0668(temp_s0, arg2->unk_13F4, sp98, spA0, &sp94) != 0) && (sp9C < sp94)) {
                temp_f0 = sp94 - sp9C;
...
s32 func_800C8A60(CollisionContext *arg0, u16 arg1, f32 *arg2, ? *arg3, f32 arg4, CollisionPoly **arg5, s32 *arg6, void *arg7) {
    ...
    do {
        ...
        if (((temp_v0 & 1) != 0) && ((temp_v0 & 2) == 0)) {
            ...
            if ((arg7 != temp_s0->unk_54) && (func_8017F9C0(temp_s0 + 0xA8, arg3->unk_0, arg3->unk_8) != 0) && (func_800C87D0(arg0, arg1 & 0xFFFF & 0xFFFF, arg0 + 0x50, temp_s0 + 0x5E, &sp78, arg3, arg4, &sp70, arg7, phi_s1) != 0) && (sp78 < phi_f20)) {
                *arg5 = sp70;
                *arg6 = phi_s1;
                phi_f20_2 = sp78;
                phi_s6 = 1;
...
s32 func_800C8EEC(CollisionContext *arg0, u16 arg1, ? *arg2, ? *arg3, Vec3f *arg4, Vec3f *arg5, f32 *arg6, f32 *arg7, void **arg8, s32 *arg9, s32 argA) {
    ...
    do {
        ...
        if (((temp_v0 & 1) != 0) && ((temp_v0 & 2) == 0)) {
            ...
            if ((arg8 != temp_v0_2->unk_54) && ((temp_f0 = arg2->unk_4, temp_f12 = temp_v0_2->unk_B0, temp_f2 = arg3->unk_4, !(temp_f0 < temp_f12)) || !(temp_f2 < temp_f12)) && ((temp_f12_2 = temp_v0_2->unk_B4, !(temp_f12_2 < temp_f0)) || !(temp_f12_2 < temp_f2))) {
                sp7C.unk_0 = (s32) arg2->unk_0;
                sp7C.unk_4 = (f32) arg2->unk_4;
                sp7C.unk_8 = (s32) arg2->unk_8;
                sp88.unk_0 = (s32) arg3->unk_0;
                sp88.unk_4 = (f32) arg3->unk_4;
                sp88.unk_8 = (s32) arg3->unk_8;
...
loop_3:
    ...
    if (((temp_s0->vtxData[0] & ((temp_a1 & 7) << 0xD)) != 0) || (((temp_s0->vtxData[1] & 0x8000) != 0) && (((arg6 != 0) && (arg6->unk_2 != 2)) || ((arg6 == 0) && (temp_a1 != 1))))) {
        temp_v0_3 = phi_s1->unk_2;
        if (temp_v0_3 != 0xFFFF) {
            phi_s1 = temp_s2->unk_1400 + (temp_v0_3 * 4);
            goto loop_3;
        }
        goto block_15;
    }
    BgCheck_PolygonCollidesWithSphere(temp_s0, temp_s2->unk_13F4, arg3, arg4);
    if (MIPS2C_ERROR(Read from unset register $v0) != 0) {
        *arg2 = temp_s0;
        return 1;
    }
    ...
    if (temp_v0_2 != 0xFFFF) {
        phi_v1 = temp_s2->unk_13F0;
        phi_s1 = temp_s2->unk_1400 + (temp_v0_2 * 4);
        goto loop_3;
    }
block_15:
    return 0;
...
void BgCheck_RelocateAllMeshHeaders(CollisionContext *colCtx, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if (((temp_v0 & 1) != 0) && ((temp_v0 & 2) == 0)) {
            ...
            BgCheck_RelocateMeshHeaderPointers(temp_s0->unk_8);
        }
        temp_s1 = phi_s1 + 1;
        phi_s2 += 2;
        phi_s1 = temp_s1;
...
s32 func_800C9EBC(void *arg0, void *arg1, f32 arg2, f32 arg3, f32 *arg4, WaterBox **arg5, s32 *arg6) {
    ...
    *arg6 = 0x32;
    temp_v0 = arg1->unk_0;
    temp_t0 = temp_v0->unk_24;
    if ((temp_t0 != 0) && (temp_a0 = temp_v0->unk_28, temp_t1 = temp_a0 + (temp_t0 * 0x10), (temp_a0 != 0)) && (phi_v1 = (WaterBox *) temp_a0, ((temp_a0 < temp_t1) != 0))) {
loop_4:
        temp_t0_2 = phi_v1->properties;
        temp_a0_2 = (temp_t0_2 >> 0xD) & 0x3F;
        if (((temp_a0_2 == arg0->unk_186E0) || (temp_a0_2 == 0x3F)) && ((temp_t0_2 & 0x80000) == 0) && (temp_a0_3 = phi_v1->xMin, ((f32) temp_a0_3 < arg2)) && (arg2 < (f32) (temp_a0_3 + phi_v1->xLength)) && (temp_a0_4 = phi_v1->zMin, ((f32) temp_a0_4 < arg3)) && (arg3 < (f32) (temp_a0_4 + phi_v1->zLength))) {
            *arg5 = phi_v1;
...
block_13:
    ...
    phi_t0 = 0;
loop_14:
    temp_v1_2 = phi_t1->unk_13DC;
    if (((temp_v1_2 & 1) != 0) && ((temp_v1_2 & 4) == 0) && (temp_v1_3 = arg1 + (phi_t0 * 0x64), temp_a0_5 = temp_v1_3 + 0x54, (temp_v1_3->unk_58->unk_24 != 0)) && (temp_t5 = temp_a0_5->unk_4, (temp_t5->unk_28 != 0)) && (temp_t3 = arg1->unk_144C, temp_v1_4 = temp_t3 + (temp_a0_5->unk_12 * 0x10), phi_v1_2 = (WaterBox *) temp_v1_4, ((temp_v1_4 < (u32) (temp_v1_4 + (temp_t5->unk_24 * 0x10))) != 0))) {
loop_19:
        if ((phi_v1_2->properties & 0x80000) != 0) {
            phi_a0 = temp_t3 + (temp_a0_5->unk_12 * 0x10) + (temp_a0_5->unk_4->unk_24 * 0x10);
            goto block_27;
        }
...
s32 func_800CA22C(void *arg0, void *arg1, void *arg2, f32 arg3, void **arg4, s32 *arg5) {
    ...
    *arg5 = 0x32;
    temp_v0 = arg1->unk_0;
    temp_t0 = temp_v0->unk_24;
    if ((temp_t0 == 0) || (temp_v1 = temp_v0->unk_28, (temp_v1 == 0))) {
        *arg4 = NULL;
        return -1;
    }
    phi_a0 = 0;
    if ((s32) temp_t0 > 0) {
        phi_t1 = temp_v1;
loop_5:
        temp_t3 = phi_t1->unk_C;
        temp_t2 = (temp_t3 >> 0xD) & 0x3F;
        if (((temp_t2 == arg0->unk_186E0) || (temp_t2 == 0x3F)) && ((temp_t3 & 0x80000) == 0) && (temp_t2_2 = phi_t1->unk_0, temp_f0 = arg2->unk_0, ((f32) temp_t2_2 < temp_f0)) && (temp_f0 < (f32) (temp_t2_2 + phi_t1->unk_6)) && (temp_t2_3 = phi_t1->unk_4, temp_f0_2 = arg2->unk_8, ((f32) temp_t2_3 < temp_f0_2)) && (temp_f0_2 < (f32) (temp_t2_3 + phi_t1->unk_8)) && (temp_f0_3 = arg2->unk_4, temp_f2 = (f32) phi_t1->unk_2, ((temp_f0_3 - arg3) < temp_f2)) && (temp_f2 < (temp_f0_3 + arg3))) {
            *arg4 = phi_t1;
            return phi_a0;
        }
        temp_a0 = phi_a0 + 1;
...
block_17:
    ...
    phi_a0_2 = 0;
loop_18:
    temp_v1_2 = phi_t0->unk_13DC;
    if (((temp_v1_2 & 1) != 0) && ((temp_v1_2 & 4) == 0) && ((temp_v1_2 & 2) == 0) && (temp_t3_2 = arg1->unk_144C, temp_t2_4 = arg1 + (phi_a0_2 * 0x64), temp_t1 = temp_t2_4 + 0x54, temp_v1_3 = temp_t3_2 + (temp_t2_4->unk_66 * 0x10), phi_v1 = (void *) temp_v1_3, ((temp_v1_3 < (u32) (temp_v1_3 + (temp_t2_4->unk_58->unk_24 * 0x10))) != 0))) {
loop_22:
        if ((phi_v1->unk_C & 0x80000) != 0) {
            phi_t2 = temp_t3_2 + (temp_t1->unk_12 * 0x10) + (temp_t1->unk_4->unk_24 * 0x10);
            goto block_32;
        }
        temp_t2_5 = phi_v1->unk_0;
        temp_f0_4 = arg2->unk_0;
        if (((f32) temp_t2_5 < temp_f0_4) && (temp_f0_4 < (f32) (temp_t2_5 + phi_v1->unk_6)) && (temp_t2_6 = phi_v1->unk_4, temp_f0_5 = arg2->unk_8, ((f32) temp_t2_6 < temp_f0_5)) && (temp_f0_5 < (f32) (temp_t2_6 + phi_v1->unk_8)) && (temp_f0_6 = arg2->unk_4, temp_f2_2 = (f32) phi_v1->unk_2, ((temp_f0_6 - arg3) < temp_f2_2)) && (temp_f2_2 < (temp_f0_6 + arg3))) {
            *arg5 = phi_a0_2;
            *arg4 = phi_v1;
            return phi_a0_2;
        }
...
f32 func_800CA568(CollisionContext *arg0, s32 arg1, s32 arg2) {
    ...
    return (f32) (&arg0->dyna.waterboxes.boxes[(u16) arg0->dyna.bgActors[arg2].unk_12])[arg1].ySurface;
}

s32 func_800CA634(CollisionContext *arg0, void *arg1) {
    return arg1->unk_C & 0xFF;
}
...
? func_800CA6F0(void *arg0, void *arg1, f32 arg2, f32 arg3, f32 *arg4, void **arg5, s32 *arg6) {
    ...
    *arg6 = 0x32;
    temp_v1 = arg1->unk_0;
    temp_t0 = temp_v1->unk_24;
    if ((temp_t0 == 0) || (temp_a0 = temp_v1->unk_28, temp_t1 = temp_a0 + (temp_t0 * 0x10), (temp_a0 == 0))) {
        goto block_28;
    }
    phi_v1 = (void *) temp_a0;
    if (temp_a0 < temp_t1) {
loop_5:
        temp_t0_2 = phi_v1->unk_C;
        temp_a0_2 = (temp_t0_2 >> 0xD) & 0x3F;
        if (((temp_a0_2 == arg0->unk_186E0) || (temp_a0_2 == 0x3F)) && ((temp_t0_2 & 0x80000) != 0) && (temp_a0_3 = phi_v1->unk_0, ((f32) temp_a0_3 < arg2)) && (arg2 < (f32) (temp_a0_3 + phi_v1->unk_6)) && (temp_a0_4 = phi_v1->unk_4, ((f32) temp_a0_4 < arg3)) && (arg3 < (f32) (temp_a0_4 + phi_v1->unk_8))) {
            *arg5 = phi_v1;
            *arg4 = (f32) phi_v1->unk_2;
            return 1;
        }
...
block_14:
    ...
    phi_t0 = 0;
loop_15:
    temp_v1_3 = phi_t1->unk_13DC;
    if (((temp_v1_3 & 1) != 0) && ((temp_v1_3 & 2) == 0) && (temp_t3 = arg1->unk_144C, temp_a0_5 = arg1 + (phi_t0 * 0x64), temp_t2 = temp_a0_5 + 0x54, temp_v1_4 = temp_t3 + (temp_a0_5->unk_66 * 0x10), phi_v1_2 = (void *) temp_v1_4, ((temp_v1_4 < (u32) (temp_v1_4 + (temp_a0_5->unk_58->unk_24 * 0x10))) != 0))) {
loop_18:
        if ((phi_v1_2->unk_C & 0x80000) == 0) {
            phi_a0 = temp_t3 + (temp_t2->unk_12 * 0x10) + (temp_t2->unk_4->unk_24 * 0x10);
            goto block_26;
        }
        temp_a0_6 = phi_v1_2->unk_0;
        if (((f32) temp_a0_6 < arg2) && (arg2 < (f32) (temp_a0_6 + phi_v1_2->unk_6)) && (temp_a0_7 = phi_v1_2->unk_4, ((f32) temp_a0_7 < arg3)) && (arg3 < (f32) (temp_a0_7 + phi_v1_2->unk_8))) {
            *arg5 = phi_v1_2;
            *arg4 = (f32) phi_v1_2->unk_2;
            *arg6 = phi_t0;
            return 1;
        }
        phi_a0 = temp_t3 + (temp_t2->unk_12 * 0x10) + (temp_t2->unk_4->unk_24 * 0x10);
