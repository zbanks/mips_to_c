...
struct _mips2c_stack_SpeedMeter_DrawTimeEntries {
    ...
    /* 0x100 */ char pad100[0x8];                   /* maybe part of spFC[3]? */
    /* 0x108 */ ? sp108;                            /* inferred */
    /* 0x108 */ char pad108[0x160];
    /* 0x268 */ s32 sp268;                          /* inferred */
    /* 0x26C */ char pad26C[0x8];                   /* maybe part of sp268[3]? */
    /* 0x274 */ s32 sp274;                          /* inferred */
    /* 0x278 */ s32 sp278;                          /* inferred */
    /* 0x27C */ char pad27C[0x14];
};                                                  /* size = 0x290 */
...
struct _mips2c_stack_func_80177AC8 {
    ...
    /* 0x088 */ ? sp88;                             /* inferred */
    /* 0x088 */ char pad88[0x160];
    /* 0x1E8 */ s32 sp1E8;                          /* inferred */
    /* 0x1EC */ char pad1EC[0xC];
};                                                  /* size = 0x1F8 */
...
struct _mips2c_stack_func_8017842C {
    ...
    /* 0x28 */ f32 sp28;                            /* inferred */
    /* 0x2C */ char pad2C[0x14];                    /* maybe part of sp28[6]? */
