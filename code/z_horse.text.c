struct _mips2c_stack_func_800F3940 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_800F39B4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_800F3A64 {};              /* size 0x0 */

struct _mips2c_stack_func_800F3B2C {};              /* size 0x0 */

struct _mips2c_stack_func_800F3B68 {};              /* size 0x0 */

struct _mips2c_stack_func_800F3C44 {
...
struct _mips2c_stack_func_800F3ED4 {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_800F40A0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_800F415C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_800F41E4 {
...
loop_7:
    if (arg0 == phi_v1->unk_0) {
        return 1;
    }
    if (arg0 == phi_v1->unk_4) {
        return 1;
    }
    if (arg0 == phi_v1->unk_8) {
        return 1;
    }
    temp_v1 = phi_v1 + 0x10;
    phi_v1 = temp_v1;
    if (arg0 == phi_v1->unk_C) {
        return 1;
    }
...
void func_800F3C44(GlobalContext *arg0, SaveContext *arg1) {
    ...
    if (func_800F3B68(arg0, arg1) != 0) {
        if ((D_801BDA9C != 0) && ((*(gBitFlags + 0x38) & gSaveContext.inventory.questItems) != 0)) {
            ...
            temp_v0 = Actor_Spawn(arg0 + 0x1CA0, arg0, 0xD, arg1->unk_24, phi_f2, arg1->unk_2C, (s16) (s32) arg1->unk_BC, (s16) (s32) arg1->unk_BE, (s16) (s32) arg1->unk_C0, (s16) 0x400B);
        ...
        if (((temp_v1 & temp_v0_2) != 0) && (func_800F3A64(temp_a1, temp_a1) != 0)) {
            Actor_Spawn(&arg0->actorCtx, arg0, 0xD, arg1->unk_24, arg1->unk_28, arg1->unk_2C, (s16) 0, (s16) (s32) arg1->unk_BE, (s16) 0, (s16) 0x4002);
        }
...
void func_800F3ED4(GlobalContext *arg0, SaveContext *arg1) {
    ...
    if ((gSaveContext.entranceIndex == 0x6400) && (func_800EE1D8(arg0) != 0) && (arg1->unk_14B == 4)) {
...
void func_800F40A0(GlobalContext *globalCtx, s32 param_2) {
    ...
    if (((temp_v1 == (GlobalContext *)0x6A) && ((gSaveContext.weekEventReg[92] & 7) == 1)) || ((temp_v1 == 0x35) && ((temp_v0 = gSaveContext.sceneSetupIndex, (temp_v0 == 1)) || (temp_v0 == 5)) && (param_2->unk_14B == 4)) || ((temp_v1 == (GlobalContext *)0x6A) && ((temp_v0_2 = gSaveContext.weekEventReg[92] & 7, (temp_v0_2 == 3)) || (temp_v0_2 == 2)))) {
...
void func_800F415C(void *arg0, Vec3f *arg1, s16 arg2) {
    ...
    if ((s32) arg2 < (s32) temp_a0_2) {
        arg0->unk_32 = (s16) (temp_v1 + arg2);
    } else if ((s32) temp_a0_2 < -(s32) arg2) {
        arg0->unk_32 = (s16) (temp_v1 - arg2);
    } else {
        arg0->unk_32 = (s16) (temp_v1 + temp_a0_2);
    }
...
s32 func_800F41E4(GlobalContext *globalCtx, ActorContext *actorCtx) {
    ...
    if (temp_s0 != 0) {
loop_2:
        if ((phi_s0->update != 0) && (phi_s0->init == 0) && (Object_IsLoaded(&globalCtx->objectCtx, (s32) phi_s0->objBankIndex) != 0) && (phi_s0->id == 0xD) && (phi_s0->unk_144 != 1)) {
            return 1;
        }
