struct _mips2c_stack_AudioMgr_HandlePRENMI {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_AudioMgr_HandleRetrace {
    /* 0x00 */ char pad_0[0x74];
    /* 0x74 */ void *sp74;                          /* inferred */
    /* 0x78 */ ? sp78;                              /* inferred */
    /* 0x78 */ char pad_78[0x24];
    /* 0x9C */ AudioTask *sp9C;                     /* inferred */
};                                                  /* size = 0xA0 */

struct _mips2c_stack_AudioMgr_Init {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ OSThread *sp2C;                      /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_AudioMgr_ThreadEntry {
...
struct _mips2c_stack_AudioMgr_Unlock {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80172C30 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */
...
void AudioMgr_HandleRetrace(AudioMgr *audioMgr) {
    ...
    if (temp_s0 != 0) {
        ...
        do {
            ...
            temp_t4->audioTask.flags = temp_t3->unk_-8;
            temp_t4->audioTask.framebuffer = temp_t3->unk_-4;
            phi_t3 = temp_t3;
            phi_t4 = temp_t4;
...
loop_13:
        osSetTimer((OSTimer *) &sp78, 0U, 0x16E360U, NULL, NULL, temp_s1, 0x29A);
        osRecvMesg(temp_s1, &sp74, 1);
        osStopTimer((OSTimer *) &sp78);
        if (sp74 == 0x29A) {
            ...
            do {
                ...
                temp_t2 = phi_t2 + 0xC;
                temp_t2->unk_-4 = (s32) phi_t4_2->task.t.type;
                temp_t2->unk_0 = (s32) temp_t4_2->unk_-8;
                temp_t2->unk_4 = (s32) temp_t4_2->unk_-4;
                phi_t4_2 = temp_t4_2;
                phi_t2 = temp_t2;
            } while (temp_t4_2 != &temp_s0_2->task.t.yield_data_size);
            temp_t2->unk_8 = (s32) temp_t4_2->task.t.type;
...
void AudioMgr_ThreadEntry(void *arg) {
    ...
    temp_s6 = arg + 0x64;
    IrqMgr_AddClient(arg->unk_0, (IrqMgrClient *) &sp4C, temp_s6);
    phi_s1_2 = 0;
    do {
    ...
    IrqMgr_RemoveClient(arg->unk_0, (IrqMgrClient *) &sp4C);
}
