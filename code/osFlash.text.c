...
s32 func_801872FC(OSIoMesg *arg0, s32 arg1, void *arg2, OSMesgQueue *arg3); /* static */
...
void func_80186D60(s32 *arg0, s32 *arg1) {
    ...
    *arg0 = D_801FD040.unk0;
    *arg1 = D_801FD040.unk4;
}
...
? func_80186EC8(void) {
    ...
    do {
        osSetTimer(&sp48, 0U, 0xABA95U, NULL, NULL, &sp30, &sp2C);
        osRecvMesg(&sp30, &sp2C, 1);
...
? func_80187124(s32 arg0) {
    ...
    osCreateMesgQueue(&sp30, &sp2C, 1);
    do {
        osSetTimer(&sp48, 0U, 0x8F0D1U, NULL, NULL, &sp30, &sp2C);
        osRecvMesg(&sp30, &sp2C, 1);
        osEPiReadIo(&D_801FD080, D_801FD080.baseAddress, &sp6C);
    } while ((sp6C & 2) == 2);
    osEPiReadIo(&D_801FD080, D_801FD080.baseAddress, &sp6C);
...
? func_801873BC(s32 arg0) {
    ...
    osCreateMesgQueue(&sp30, &sp2C, 1);
    do {
        osSetTimer(&sp48, 0U, 0x249FU, NULL, NULL, &sp30, &sp2C);
        osRecvMesg(&sp30, &sp2C, 1);
        osEPiReadIo(&D_801FD080, D_801FD080.baseAddress, &sp6C);
    } while ((sp6C & 1) == 1);
    osEPiReadIo(&D_801FD080, D_801FD080.baseAddress, &sp6C);
