...
void func_800F6CEC(GlobalContext *arg0, u8 arg1, void *arg2, LightSettings *arg3); /* static */
...
typedef struct GraphicsContext {
    ...
    /* 0x0014 */ char pad14[0x44];                  /* maybe part of overlayBuffer[18]? */
    /* 0x0058 */ OSMesgQueue *unk58;
    /* 0x005C */ OSMesgQueue unk5C;
    /* 0x0074 */ char pad74[0x12C];
    /* 0x01A0 */ Gfx *unk1A0;
    ...
    /* 0x02D8 */ char pad2D8[0x3];
    /* 0x02DB */ u8 framebufferCounter;
    /* 0x02DC */ void (*unk2DC)(s32, GlobalContext *); /* inferred */
    /* 0x02E0 */ GlobalContext *unk2E0;             /* inferred */
    /* 0x02E4 */ f32 viConfigXScale;
    /* 0x02E8 */ f32 viConfigYScale;
    /* 0x02EC */ char pad2EC[0x4];                  /* maybe part of viConfigYScale[2]? */
...
void func_800F6CEC(GlobalContext *arg0, u8 arg1, void *arg2, LightSettings *arg3) {
    s32 temp_a0;
    s32 temp_a1;
    s32 temp_t1;
    s32 temp_t3;
...
void func_800F8554(GlobalContext *arg0) {
    ...
    if (arg0->envCtx.unk_16 == 0) {
        ...
        if (arg0->csCtx.state != 0) {
            ...
            temp_f10 = Math_CosS(sp22) * 120.0f;
            sp24 = temp_a0_3;
            Math_SmoothStepToF(temp_a0_3, temp_f10 * 25.0f, 1.0f, 0.8f, 0.8f);
            Math_SmoothStepToF(temp_a0_3, Math_CosS(sp22) * 20.0f * 25.0f, 1.0f, 0.8f, 0.8f);
        } else {
            sp20 = (s32) temp_a0;
            arg0->envCtx.unk_4 = -(Math_SinS(temp_a0) * 120.0f) * 25.0f;
            arg0->envCtx.unk_8 = Math_CosS(sp22) * 120.0f * 25.0f;
            arg0->envCtx.unk_C = Math_CosS(sp22) * 20.0f * 25.0f;
        }
...
void func_800F9824(GlobalContext *globalCtx, EnvironmentContext *envCtx, View *view, GraphicsContext *gfxCtx, f32 vec, f32 vec_unk4, f32 vec_unk8, f32 arg5, f32 arg6, s8 arg7, s8 arg8) {
    ...
    if (!(sp6C < 0.0f)) {
        if ((u8) arg8 != 0) {
            func_80169474(globalCtx, (Vec3f *) &vec, &spC4);
            D_801F4F20 = (s32) spC4.x;
            temp_f4 = (s32) (spC4.y - 5.0f);
            D_801F4F24 = temp_f4;
            if (temp_f4 < 0) {
                D_801F4F24 = 0;
            }
            if ((D_801BDB94 != 0xFFFC) || (spC4.x < 0.0f) || (spC4.y < 0.0f) || (spC4.x > 320.0f) || (spC4.y > 240.0f)) {
                spC3 = 1;
            }
        }
        sp70 = -sp100;
    ...
    if ((temp_v0 == 0) && (temp_v1 = arg0->envCtx.unk_F2[2], (temp_v1 == 0))) {
        ...
        if (temp_v0 == 0) {
            ...
            if ((func_800FE4B8(arg0) != 0) && (arg0->envCtx.unk_F2[2] == 0)) {
                func_800FA3C4(&arg0->state, arg1, arg2, arg1);
            }
        }
        // Duplicate return node #9. Try simplifying control flow for better match
    }
...
void func_800FB010(GlobalContext *arg0) {
    ...
    if (D_801F4E68.unk0 != 0) {
        func_800FAF74(&arg0->state.gfxCtx, D_801F4E68.unk1, D_801F4E68.unk2, D_801F4E68.unk3, (u8) (s32) D_801F4F2C);
    }
}
...
void func_800FC158(GlobalContext *arg0) {
    ...
    if (func_80169FFC(arg0) != 0) {
        phi_s1 = arg0->envCtx.unk_8C.ambientColor;
...
void func_800FD538(Color_RGB8 *param_1, Color_RGB8 *param_2, f32 param_3, Vec3s *param_4) {
    ...
    Lib_LerpRGB(param_1, param_2, param_3, &sp1C);
    param_4->x = sp1C.r - param_1->r;
    param_4->y = sp1C.g - param_1->g;
    param_4->z = sp1C.b - param_1->b;
}
