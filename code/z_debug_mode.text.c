...
void func_800E9CA0(s32 arg0, s8 arg1, u8 *arg2) {
    ...
    *temp_v0 = arg1;
    ...
    do {
        temp_v1 = phi_v1 + 1;
        temp_a2 = phi_a2 + 1;
        temp_v1->unk_-1 = (u8) *phi_a2;
        phi_a2 = temp_a2;
        phi_v1 = temp_v1;
    } while (temp_a2->unk_-1 != 0);
}
...
void func_800E9CFC(GfxPrint *arg0) {
    ...
    do {
        ...
        temp_v0 = &D_801BB0DC + (phi_s0->unk_0 * 4);
        GfxPrint_SetColor(arg0, (u32) temp_v0->unk_0, (u32) temp_v0->unk_1, (u32) temp_v0->unk_2, (u32) temp_v0->unk_3);
...
void func_800E9DBC(s32 arg0, s32 arg1, s32 arg2, u8 *arg3) {
    ...
    D_801BB090 |= 2;
    if ((s32) temp_v1 < 0x50) {
        temp_v0->unk_0 = (s8) (arg0 & 0xFF);
        temp_v0->unk_1 = (s8) (arg1 & 0xFF);
        temp_v0->unk_2 = (s8) (arg2 & 0xFF);
        temp_a3 = *arg3;
        temp_t0 = temp_v0 + 4;
        temp_v0->unk_3 = temp_a3;
        phi_v1 = 0;
        phi_s0 = arg3 + 1;
        phi_t0 = temp_t0;
        phi_t0_2 = temp_t0;
...
void func_800E9E94(GfxPrint *arg0) {
    ...
    if ((s32) D_801BB0FC > 0) {
        phi_s1 = &D_801F3F83;
        do {
            temp_v0 = &D_801BB100 + (phi_s0->unk_2 * 4);
            GfxPrint_SetColor(arg0, (u32) temp_v0->unk_0, (u32) temp_v0->unk_1, (u32) temp_v0->unk_2, (u32) temp_v0->unk_3);
            GfxPrint_SetPos(arg0, (s32) phi_s0->unk_0, (s32) phi_s0->unk_1);
