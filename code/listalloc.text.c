struct _mips2c_stack_func_80174AA0 {};              /* size 0x0 */

struct _mips2c_stack_func_80174AB4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80174B20 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80174BA0 {
...
void func_80174B20(ListAlloc *arg0, void *arg1) {
    ...
    temp_a0 = arg1 - 8;
    if (arg1->unk_-8 != 0) {
        temp_a0->unk_0->unk_4 = (s32) temp_a0->unk_4;
    }
    temp_a0_2 = arg1 - 8;
    temp_v0 = temp_a0_2->unk_4;
    if (temp_v0 != 0) {
        *temp_v0 = temp_a0_2->unk_0;
    }
    if (temp_a0_2 == arg0->prev) {
        arg0->prev = temp_a0_2->unk_4;
    }
    if (temp_a0_2 == arg0->next) {
        arg0->next = temp_a0_2->unk_0;
    }
