...
Lights *Lights_NewAndDraw(GraphicsContext *gfxCtx, u8 ambientR, u8 ambientG, u8 ambientB, u8 numLights, u8 r, u8 g, u8 b, s8 x, s8 y, s8 z) {
    ...
    temp_s0->unk8 = temp_a1;
    temp_s0->unkC = temp_a1;
    temp_s0->unk9 = temp_a2;
    temp_s0->unkD = temp_a2;
    temp_s0->unkA = temp_a3;
    temp_s0->unkE = temp_a3;
    temp_s0->texture.cmd = 0;
    temp_s0->texture.lodscale = numLights;
    phi_v1_2 = 0;
    if (((s32) numLights > 0) && (((numLights & 1) == 0) || (temp_s0->unk10 = r, temp_s0->unk14 = r, temp_s0->unk11 = g, temp_s0->unk15 = g, temp_s0->unk12 = b, temp_s0->unk16 = b, temp_s0->unk18 = x, temp_s0->unk19 = y, temp_s0->unk1A = z, phi_v1_2 = 1, (numLights != 1)))) {
...
Lights *Lights_New(GraphicsContext *gfxCtx, u8 ambientR, u8 ambientG, u8 ambientB) {
    ...
    temp_v0->unkC = temp_a1;
    temp_v0->unk9 = temp_a2;
    temp_v0->unkD = temp_a2;
    temp_v0->unkA = temp_a3;
    temp_v0->unkE = temp_a3;
    ...
    if (temp_s3 != 0) {
        ...
        do {
            ...
            if ((*temp_v1 == 2) && (temp_v0_3->unk9 != 0)) {
                ...
                temp_s0_3->unk4 = Matrix_NewMtx(globalCtx->state.gfxCtx);
