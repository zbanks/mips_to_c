...
s32 Object_Spawn(ObjectContext *objectCtx, s16 id) {
    ...
    if ((s32) temp_v1_2 < 0x22) {
        (objectCtx + (temp_v1_2 * 0x44))->unk_54 = (s32) (((objectCtx + (temp_v1_2 * 0x44))->unk_10 + (temp_t3 - temp_t2) + 0xF) & ~0xF);
    }
        ...
        do {
            ...
            if ((s32) temp_v0 < 0) {
                if (phi_s0->dmaReq.vromAddr == 0) {
                    ...
                    temp_s2 = phi_s0 + 0x28;
                    temp_s3 = temp_s1->unk_4 - temp_s1->unk_0;
                    if (temp_s3 == 0) {
                        phi_s0->id = 0;
                    } else {
                        osCreateMesgQueue(temp_s2, phi_s0 + 0x40, 1);
                        DmaMgr_SendRequestImpl(phi_s0 + 8, phi_s0->segment, temp_s1->unk_0, temp_s3, 0, temp_s2, NULL);
                    }
...
void Scene_HeaderCmdColHeader(GlobalContext *globalCtx, SceneCmd *cmd) {
    ...
    temp_s0 = temp_v0;
    temp_s0->unk_10 = Lib_SegmentedToVirtual(temp_v0->unk_10);
    temp_a0 = temp_s0->unk_1C;
    temp_s0->unk_18 = Lib_SegmentedToVirtual(temp_s0->unk_18);
    if (temp_a0 != 0) {
        temp_s0->unk_1C = Lib_SegmentedToVirtual(temp_a0);
    }
    temp_a0_2 = temp_s0->unk_20;
    if (temp_a0_2 != 0) {
        temp_s0->unk_20 = Lib_SegmentedToVirtual(temp_a0_2);
    }
    temp_a0_3 = temp_s0->unk_28;
    if (temp_a0_3 != 0) {
        temp_s0->unk_28 = Lib_SegmentedToVirtual(temp_a0_3);
    }
...
void Scene_HeaderCmdObjectList(GlobalContext *globalCtx, SceneCmd *cmd) {
    ...
    if (phi_s3 < (s32) cmd->base.data1) {
        do {
            ...
            if (phi_s1_3 < 0x22) {
                (globalCtx + phi_s4)->unk_17DDC = func_8012F73C(&globalCtx->objectCtx, phi_s1_3, *phi_s2_2);
            }
            temp_s3 = phi_s3_2 + 1;
            phi_s2_2 += 2;
            phi_s4 += 0x44;
...
s32 Scene_LoadAreaTextures(GlobalContext *globalCtx, s32 fileIndex) {
    ...
    temp_a3 = temp_v0->unk_0;
    temp_a2 = temp_v0->unk_4 - temp_a3;
    phi_v0 = (s32) temp_v0;
    if (temp_a2 != 0) {
        sp18 = temp_a2;
        sp1C = temp_a3;
...
void Scene_HeaderCmdTimeSettings(GlobalContext *globalCtx, SceneCmd *cmd) {
    ...
    if ((sp18->unk_7006 == 0) && (gSaveContext.cutscene < 0xFFF0)) {
