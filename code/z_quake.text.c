...
struct _mips2c_stack_Quake_Calc {
    ...
    /* 0x78 */ char pad_78[0x14];                   /* maybe part of sp74[6]? */
    /* 0x8C */ f32 sp8C;                            /* inferred */
...
void Quake_UpdateShakeInfo(QuakeRequest *req, ShakeInfo *shake, f32 verticalPertubation, f32 horizontalPertubation) {
    ...
    shake->atOffset.x = sp28.unk_0;
    shake->atOffset.y = sp28.unk_4;
    shake->atOffset.z = sp28.unk_8;
...
QuakeRequest *Quake_AddImpl(Camera *camera, u32 callbackIdx) {
    ...
    sp18->unk_4 = camera;
    sp18->unk_20 = (s16) camera->thisIdx;
    sp18->unk_1C = 1;
    sp18->unk_8 = callbackIdx;
    sp18->unk_0 = (s16) (((s32) (Rand_ZeroOne() * 65536.0f) & 0xFFFC) + sp1E);
...
u32 Quake_SetQuakeValues2(s16 idx, s16 isShakePerpendicular, ? shakePlaneOffset, ? shakePlaneOffset_unk4) {
    ...
    if (temp_v0 != 0) {
        ...
        temp_v0->unk_14 = (unaligned s32) shakePlaneOffset.unk_0;
        temp_v0->shakePlaneOffset.z = (s16) shakePlaneOffset.unk_4;
        return 1U;
    }
    return 0U;
}
...
void Quake2_SetCountdown(s16 countdown) {
    sQuake2Context.unk_8 = countdown;
    sQuake2Context.unk_A = 2;
}
...
void Quake2_Update(void) {
    ...
    temp_a2 = sQuake2Context.unk_0;
    temp_a3 = (temp_a2 + (temp_a2->activeCamera * 4))->unk_800;
    temp_f0 = temp_a3->unk_E0;
    if (temp_f0 > 1.0f) {
        sp34 = 1.0f;
    } else {
        sp34 = temp_f0;
    ...
    if (temp_v0 != 0) {
        if ((temp_v0 & 0x800) != 0) {
            ...
            sp74 = 170.0f;
            sp60 = 0.01f;
            temp_f12 = (f32) sQuake2Context.unk_8 / 60.0f;
            sp58 = 0.6f;
            sp78 = 0.0f;
            sp70 = 0.0f;
            sp6C = 0.0f;
        ...
        if ((temp_v0 & 0x400) != 0) {
            ...
            sp58 = 0.4f;
            sp74 = 50.0f / temp_f2;
            temp_f12_2 = (temp_f2 - (f32) sQuake2Context.unk_8) / temp_f2;
            phi_f12 = temp_f12_2;
            phi_f14 = temp_f12_2;
            phi_f16 = 0.5f;
            phi_f18 = 0.01f;
        ...
        if ((temp_v0 & 0x200) != 0) {
            ...
            sp6C = 0.0f;
            sp5C = 0.0f;
            temp_f12_3 = (temp_f2_2 - (f32) sQuake2Context.unk_8) / temp_f2_2;
            phi_f12 = temp_f12_3;
            phi_f14 = temp_f12_3;
            phi_f16 = 1.0f;
            phi_f18 = 0.3f;
        ...
        if ((temp_v0 & 0x100) != 0) {
            ...
            temp_v0_2 = sQuake2Context.unk_8;
            sp74 = 150.0f;
            sp78 = 0.0f;
            sp68 = 0.2f;
            sp60 = 0.02f;
        ...
        if ((temp_v0 & 0x80) != 0) {
            ...
            sp68 = 0.0f;
            sp78 = 0.0f;
            temp_f12_5 = (f32) sQuake2Context.unk_8 / (f32) D_801C0EEC;
            phi_f12 = temp_f12_5;
            phi_f14 = temp_f12_5;
            phi_f16 = 1.0f;
            phi_f18 = 0.03f;
        ...
        if ((temp_v0 & 0x40) != 0) {
            ...
            temp_v0_3 = sQuake2Context.unk_8;
            sp78 = 0.0f;
            sp60 = 0.03f;
            sp74 = 150.0f;
            sp5C = 0.01f;
        ...
        if ((temp_v0 & 0x10) != 0) {
            ...
            sp6C = 0.0f;
            sp68 = 0.0f;
            temp_f12_7 = (f32) sQuake2Context.unk_8 / (f32) D_801C0EEC;
            phi_f12 = temp_f12_7;
            phi_f14 = temp_f12_7;
            phi_f16 = 1.0f;
            phi_f18 = -0.4f;
...
block_48:
        ...
        if ((temp_v0 & 4) != 0) {
            ...
            temp_f0_2 = temp_a3->unk_114 - temp_a3->unk_60;
            phi_f18 = 0.12f;
...
block_66:
            ...
            View_SetQuakeRotation(sQuake2Context.unk_0 + 0xB8, sp24 * (sp70 * 0.017453292f * phi_f14), sp28 * (sp6C * 0.017453292f * phi_f14), Math_SinS(D_801C0EE8) * (sp68 * 0.017453292f * phi_f12));
            sp24 = Math_SinS(D_801C0EE8);
            sp28 = Math_CosS(D_801C0EE8);
            View_SetQuakeScale(sQuake2Context.unk_0 + 0xB8, (sp24 * (phi_f18 * phi_f14)) + 1.0f, (sp28 * (sp60 * phi_f14)) + 1.0f, (Math_CosS(D_801C0EE4) * (sp5C * phi_f12)) + 1.0f);
            View_SetQuakeSpeed(sQuake2Context.unk_0 + 0xB8, sp58 * phi_f16);
            sQuake2Context.unk_A = 1;
            goto block_69;
        }
    } else {
        if (sQuake2Context.unk_A != 0) {
            View_ClearQuake(temp_a2 + 0xB8);
            sQuake2Context.unk_A = 0;
            sQuake2Context.unk_8 = 0;
        }
block_69:
        temp_v0_7 = sQuake2Context.unk_8;
        if (temp_v0_7 != 0) {
