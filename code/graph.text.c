...
typedef struct GraphicsContext {
    ...
    /* 0x014 */ char pad14[0x24];                   /* maybe part of overlayBuffer[10]? */
    /* 0x038 */ void *unk38;                        /* inferred */
    /* 0x03C */ char pad3C[0x1C];                   /* maybe part of unk38[8]? */
    /* 0x058 */ OSMesgQueue *unk58;
    /* 0x05C */ OSMesgQueue unk5C;
    /* 0x074 */ char pad74[0x4];
    /* 0x078 */ ? unk78;                            /* inferred */
    /* 0x078 */ char pad78[0x10];
    /* 0x088 */ ? unk88;                            /* inferred */
    /* 0x088 */ char pad88[0x118];
    /* 0x1A0 */ Gfx *unk1A0;
...
struct _mips2c_stack_Graph_RenderFrame {
    ...
    /* 0x38 */ char pad38[0x44];                    /* maybe part of sp34[18]? */
