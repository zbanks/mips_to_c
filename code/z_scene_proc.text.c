...
struct _mips2c_stack_AnimatedMat_DrawColorLerp {
    ...
    /* 0x4D */ char pad_4D[0x27];                   /* maybe part of sp4C[40]? */
...
struct _mips2c_stack_AnimatedMat_DrawColorNonLinearInterp {
    ...
    /* 0x040 */ char pad_40[0x30];                  /* maybe part of sp3C[13]? */
    /* 0x070 */ f32 sp70;                           /* inferred */
    /* 0x074 */ char pad_74[0xC4];                  /* maybe part of sp70[50]? */
    /* 0x138 */ f32 sp138;                          /* inferred */
    /* 0x13C */ char pad_13C[0xC4];                 /* maybe part of sp138[50]? */
    /* 0x200 */ f32 sp200;                          /* inferred */
    /* 0x204 */ char pad_204[0xC4];                 /* maybe part of sp200[50]? */
    /* 0x2C8 */ f32 sp2C8;                          /* inferred */
    /* 0x2CC */ char pad_2CC[0xC4];                 /* maybe part of sp2C8[50]? */
    /* 0x390 */ f32 sp390;                          /* inferred */
    /* 0x394 */ char pad_394[0xC4];                 /* maybe part of sp390[50]? */
    /* 0x458 */ f32 sp458;                          /* inferred */
    /* 0x45C */ char pad_45C[0xC4];                 /* maybe part of sp458[50]? */
    /* 0x520 */ f32 sp520;                          /* inferred */
    /* 0x524 */ char pad_524[0xC4];                 /* maybe part of sp520[50]? */
    /* 0x5E8 */ f32 sp5E8;                          /* inferred */
    /* 0x5EC */ char pad_5EC[0xC4];                 /* maybe part of sp5E8[50]? */
    /* 0x6B0 */ f32 sp6B0;                          /* inferred */
    /* 0x6B4 */ char pad_6B4[0xC4];                 /* maybe part of sp6B0[50]? */
    /* 0x778 */ f32 sp778;                          /* inferred */
    /* 0x77C */ char pad_77C[0xC4];                 /* maybe part of sp778[50]? */
    ...
    /* 0x849 */ char pad_849[0xF];                  /* maybe part of sp848[16]? */
    /* 0x858 */ void *sp858;                        /* inferred */
    /* 0x85C */ char pad_85C[0x4];
};                                                  /* size = 0x860 */
...
void AnimatedMat_DrawColor(GlobalContext *globalCtx, s32 segment, void *params) {
    ...
    temp_hi = (s32) sMatAnimStep % (s32) params->unk_0;
    sp20 = Lib_SegmentedToVirtual(params->unk_4) + (temp_hi * 5);
    temp_a0 = params->unk_8;
    phi_a3 = NULL;
    if (temp_a0 != 0) {
        sp18 = temp_hi;
...
void AnimatedMat_DrawColorLerp(GlobalContext *globalCtx, s32 segment, void *params) {
    ...
    sp74 = params;
    temp_s1 = Lib_SegmentedToVirtual(params->unk_4);
    temp_hi = (s32) sMatAnimStep % (s32) params->unk_0;
    temp_v1 = Lib_SegmentedToVirtual(params->unk_C) + 2;
    phi_v1 = temp_v1;
    phi_s0 = 1;
    phi_s0_2 = 1;
    phi_v1_2 = temp_v1;
    if ((s32) params->unk_2 >= 2) {
loop_1:
        phi_s0_2 = phi_s0;
        phi_v1_2 = phi_v1;
        if (temp_hi >= (s32) *phi_v1) {
            ...
            phi_s0_2 = temp_s0;
            phi_v1_2 = temp_v1_2;
            if (temp_s0 < (s32) sp74->unk_2) {
                goto loop_1;
            }
        }
    }
    temp_v0 = phi_v1_2->unk_-2;
    temp_s1_2 = temp_s1 + (phi_s0_2 * 5);
    temp_f20 = (f32) (temp_hi - temp_v0) / (f32) (phi_v1_2->unk_0 - temp_v0);
    sp48 = AnimatedMat_Lerp((s32) temp_s1_2->unk_-5, (s32) temp_s1_2->unk_0, temp_f20);
    temp_v1_3 = temp_s1_2 - 5;
    sp30 = temp_v1_3;
    sp49 = AnimatedMat_Lerp((s32) temp_v1_3->unk_1, (s32) temp_s1_2->unk_1, temp_f20);
    sp4A = AnimatedMat_Lerp((s32) sp30->unk_2, (s32) temp_s1_2->unk_2, temp_f20);
    sp4B = AnimatedMat_Lerp((s32) sp30->unk_3, (s32) temp_s1_2->unk_3, temp_f20);
    sp4C = AnimatedMat_Lerp((s32) sp30->unk_4, (s32) temp_s1_2->unk_4, temp_f20);
    temp_a0 = params->unk_8;
    phi_s1 = NULL;
    if (temp_a0 != 0) {
        temp_s1_3 = Lib_SegmentedToVirtual(temp_a0) + (phi_s0_2 * 4);
        sp44 = temp_s1_3 - 4;
        sp40 = AnimatedMat_Lerp((s32) temp_s1_3->unk_-4, (s32) temp_s1_3->unk_0, temp_f20);
        sp41 = AnimatedMat_Lerp((s32) sp44->unk_1, (s32) temp_s1_3->unk_1, temp_f20);
        sp42 = AnimatedMat_Lerp((s32) sp44->unk_2, (s32) temp_s1_3->unk_2, temp_f20);
        sp43 = AnimatedMat_Lerp((s32) sp44->unk_3, (s32) temp_s1_3->unk_3, temp_f20);
        phi_s1 = temp_s1_3;
    }
    if (phi_s1 != 0) {
...
block_8:
            ...
            temp_v0 = phi_v0 + 1;
            temp_t0 = phi_t0 + 4;
            temp_t0->unk_-4 = (f32) (*phi_a3 / phi_f2);
            phi_v0 = temp_v0;
            phi_a3 += 4;
            phi_t0 = temp_t0;
            phi_v1 += 4;
...
void AnimatedMat_DrawColorNonLinearInterp(GlobalContext *globalCtx, s32 segment, void *params) {
    ...
    sp858 = Lib_SegmentedToVirtual(params->unk_4);
    temp_s0 = Lib_SegmentedToVirtual(params->unk_8);
    temp_t9 = params->unk_2;
    temp_a0 = Lib_SegmentedToVirtual(params->unk_C);
    sp3C = (s32) temp_t9;
    temp_f20 = (f32) ((s32) sMatAnimStep % (s32) params->unk_0);
    phi_a0 = temp_a0;
    phi_a1 = &sp778;
    phi_v1 = sp858;
    phi_a2 = &sp6B0;
    ...
    if ((s32) temp_t9 > 0) {
        do {
            ...
            *phi_t2 = phi_f18_2;
            ...
            phi_a1 += 4;
            phi_s1 = temp_s1;
        } while (temp_s1 < (s32) params->unk_2);
        sp3C = (s32) params->unk_2;
    }
    sp844 = Scene_LagrangeInterpColor(sp3C, (f32 []) &sp778, (f32 []) &sp6B0, temp_f20);
    sp845 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp5E8, temp_f20);
    sp846 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp520, temp_f20);
    sp847 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp458, temp_f20);
    sp848 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp390, temp_f20);
    temp_a0_2 = params->unk_8;
    phi_s0_2 = NULL;
    if (temp_a0_2 != 0) {
        temp_s0_2 = Lib_SegmentedToVirtual(temp_a0_2);
        sp840 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp2C8, temp_f20);
        sp841 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp200, temp_f20);
        sp842 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp138, temp_f20);
        sp843 = Scene_LagrangeInterpColor((s32) params->unk_2, (f32 []) &sp778, (f32 []) &sp70, temp_f20);
        phi_s0_2 = temp_s0_2;
    }
    if (phi_s0_2 != 0) {
...
void AnimatedMat_DrawTexCycle(GlobalContext *globalCtx, s32 segment, void *params) {
    ...
    sp18 = Lib_SegmentedToVirtual(params->unk_4);
    temp_v0 = Lib_SegmentedToVirtual(*(sp18 + (*(Lib_SegmentedToVirtual(params->unk_8) + ((s32) sMatAnimStep % (s32) params->unk_0)) * 4)));
    temp_a1 = sMatAnimFlags;
    temp_a2 = globalCtx->state.gfxCtx;
    phi_a1 = temp_a1;
    if ((temp_a1 & 1) != 0) {
...
void Scene_DrawConfig5(GlobalContext *globalCtx) {
    ...
    phi_t0 = 0xFF;
    if (globalCtx->roomCtx.unk_7A != 0) {
        sp24 = 1;
        phi_t0 = (s32) globalCtx->roomCtx.unk_7C;
    } else {
        sp24 = 0;
    }
    if (phi_t0 == 0) {
...
void Scene_DrawConfigMatAnimManualStep(GlobalContext *globalCtx) {
    AnimatedMat_DrawStep(globalCtx, globalCtx->sceneMaterialAnims, (u32) globalCtx->roomCtx.unk_7A);
}
...
block_35:
        ...
        phi_s2->unk_4 = -1;
        phi_s2->unk_0 = (s32) ((phi_s1 & 0xFF) | 0xFA000000);
        temp_s3 = phi_s3 + 1;
        phi_s2 += 0x10;
        phi_s3 = temp_s3;
    } while (temp_s3 != 9);
