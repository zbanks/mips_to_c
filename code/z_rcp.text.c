...
Gfx *Gfx_SetFog(Gfx *gfx, s32 r, s32 g, s32 b, s32 a, s32 n, s32 f) {
    ...
    if (n >= 0x3E5) {
        if (n >= 0x3E8) {
            gfx->unk_8 = 0xDB080000;
            gfx->unk_C = 0;
        } else {
            gfx->unk_C = 0x7FFF8100;
            gfx->unk_8 = 0xDB080000;
        }
    } else if (n < 0) {
        gfx->unk_C = 0xFF;
        ...
        gfx->unk_8 = 0xDB080000;
        temp_v1 = f - n;
        gfx->unk_C = (s32) ((((0x1F400 / temp_v1) & 0xFFFF) << 0x10) | (((s32) ((n * -0x100) + 0x1F400) / temp_v1) & 0xFFFF));
    }
    return gfx + 0x10;
}
...
Gfx *Gfx_TexScroll(GraphicsContext *gfxCtx, u32 x, u32 y, s32 width, s32 height) {
    ...
    temp_v1->words.w1 = 0;
    temp_v1->unk_8 = (s32) (((temp_a1 & 0xFFF) << 0xC) | 0xF2000000 | (temp_a2 & 0xFFF));
    temp_v1->unk_C = (s32) ((((((width - 1) * 4) + temp_a1) & 0xFFF) << 0xC) | ((temp_a2 + ((height - 1) * 4)) & 0xFFF));
    temp_v1->unk_10 = 0xDF000000;
    temp_v1->unk_14 = 0;
    return temp_v1;
}
...
Gfx *Gfx_TwoTexScroll(GraphicsContext *gfxCtx, s32 tile1, u32 x1, u32 y1, s32 width1, s32 height1, s32 tile2, u32 x2, u32 y2, s32 width2, s32 height2) {
    ...
    temp_v1->words.w0 = 0xE8000000;
    temp_v1->words.w1 = 0;
    temp_v1->unk_8 = (s32) (((temp_a2 & 0xFFF) << 0xC) | 0xF2000000 | (temp_a3 & 0xFFF));
    temp_v1->unk_C = (s32) (((tile1 & 7) << 0x18) | (((temp_a2 + ((width1 - 1) * 4)) & 0xFFF) << 0xC) | ((temp_a3 + ((height1 - 1) * 4)) & 0xFFF));
    temp_v1->unk_10 = 0xE8000000U;
    temp_v1->unk_14 = 0;
    temp_v1->unk_18 = (s32) (((x2 & 0xFFF) << 0xC) | 0xF2000000 | (y2 & 0xFFF));
    temp_v1->unk_1C = (s32) (((tile2 & 7) << 0x18) | (((x2 + ((width2 - 1) * 4)) & 0xFFF) << 0xC) | ((y2 + ((height2 - 1) * 4)) & 0xFFF));
    temp_v1->unk_20 = 0xDF000000;
    temp_v1->unk_24 = 0;
    return temp_v1;
}
...
Gfx *Gfx_TwoTexScrollEnvColor(GraphicsContext *gfxCtx, s32 tile1, u32 x1, u32 y1, s32 width1, s32 height1, s32 tile2, u32 x2, u32 y2, s32 width2, s32 height2, s32 r, s32 g, s32 b, s32 a) {
    ...
    temp_v1->unk_18 = (s32) (((x2 & 0xFFF) << 0xC) | 0xF2000000 | (y2 & 0xFFF));
    temp_v1->unk_1C = (s32) (((tile2 & 7) << 0x18) | (((x2 + ((width2 - 1) * 4)) & 0xFFF) << 0xC) | ((y2 + ((height2 - 1) * 4)) & 0xFFF));
    temp_v1->unk_20 = 0xFB000000;
    temp_v1->unk_24 = (s32) ((r << 0x18) | ((g & 0xFF) << 0x10) | ((b & 0xFF) << 8) | (a & 0xFF));
    temp_v1->unk_28 = 0xDF000000;
    temp_v1->unk_2C = 0;
    return temp_v1;
}
...
void func_8012CF0C(GraphicsContext *gfxCtx, s32 iParm2, s32 iParm3, u8 r, u8 g, u8 b) {
    ...
    gSegments->unk_3C = (void *) gfxCtx->framebuffer;
    gSegments->unk_38 = temp_v1;
    temp_t4 = gfxCtx->zbuffer;
    temp_v0 = temp_v1 + 0xB0;
    temp_v0->words.w1 = (u32) &D_0E000140;
    temp_v0->words.w0 = 0xDE000000;
    temp_v0->unk_C = sFillSetupDL;
    temp_v0->unk_8 = 0xDE000000U;
    temp_v0->unk_10 = (s32) (((D_801FBBCC - 1) & 0xFFF) | 0xFF100000);
    temp_v0->unk_14 = &D_0F000000;
    if (temp_t4 != 0) {
        temp_v0->unk_18 = 0xFE000000;
        temp_v0->unk_1C = temp_t4;
    } else {
        temp_v0->unk_18 = 0xFE000000;
        temp_v0->unk_1C = &D_0F000000;
    }
    temp_v0->unk_20 = 0xDF000000U;
    temp_v0->unk_24 = 0;
    ...
    if (temp_t4 == 0) {
        ...
        temp_v0_3->unk_8 = 0xE7000000;
        temp_v0_3->unk_C = 0;
        temp_v0_3->unk_14 = 0x300000;
        temp_v0_3->unk_10 = 0xE3000A01;
        temp_v0_3->unk_18 = 0xE200001C;
        temp_v0_3->unk_1C = 0;
        temp_v0_3->unk_20 = 0xF7000000;
        temp_v0_3->unk_24 = 0xFFFCFFFC;
        temp_v0_3->unk_2C = &D_0E0002C8;
        temp_v0_3->unk_28 = 0xDE000000U;
        temp_v0_3->unk_34 = &D_0F000000;
        temp_v0_3->unk_30 = (s32) (((D_801FBBCC - 1) & 0xFFF) | 0xFF100000);
        temp_v0_3->unk_38 = 0xDF000000U;
        temp_v0_3->unk_3C = 0;
    }
    temp_v0_4 = graphDlEntry + 0x88;
    temp_v0_4->words.w1 = (u32) &D_0F000000;
    temp_v0_4->words.w0 = ((D_801FBBCC - 1) & 0xFFF) | 0xFF100000;
    temp_v0_4->unk_C = 0x300000;
    temp_v0_4->unk_8 = 0xE3000A01;
    temp_v0_4->unk_10 = 0xE200001C;
    temp_v0_4->unk_14 = 0;
    temp_v0_4->unk_18 = 0xF7000000;
    temp_a1 = ((r << 8) & 0xF800) | ((g * 8) & 0x7C0) | (((s32) b >> 2) & 0x3E) | 1;
    temp_v0_4->unk_1C = (s32) ((temp_a1 << 0x10) | temp_a1);
    temp_v0_4->unk_20 = 0xDE010000;
    temp_v0_4->unk_24 = &D_0E0002C8;
    temp_v0_5 = graphDlEntry + 0x2C8;
    temp_v0_5->words.w0 = (((D_801FBBCC - 1) & 0x3FF) << 0xE) | 0xF6000000 | (((D_801FBBCE - 1) & 0x3FF) * 4);
    temp_v0_5->words.w1 = 0;
    temp_v0_5->unk_8 = 0xE7000000;
    temp_v0_5->unk_C = 0;
    temp_v0_5->unk_10 = 0xDF000000U;
    temp_v0_5->unk_14 = 0;
    temp_v0_6 = graphDlEntry + 0x2E0;
    temp_v0_6->words.w0 = ((D_801FBBCC & 0x3FF) << 0xE) | 0xF6000000 | ((D_801FBBCE & 0x3FF) * 4);
    temp_v0_6->words.w1 = 0;
    temp_v0_6->unk_8 = 0xE7000000;
    temp_v0_6->unk_C = 0;
    temp_v0_6->unk_10 = 0xDF000000U;
    temp_v0_6->unk_14 = 0;
    phi_v1 = 0;
    ...
    do {
        ...
        if (phi_v1 == 0xD) {
            phi_a1->unk_8 = 0xE0000000U;
            phi_a1->unk_C = 0;
        } else {
            phi_a1->unk_8 = (u32) ((((phi_v1 * 4) + 4) & 0xFFFF) | 0xDB060000);
            phi_a1->unk_C = (s32) gSegments[phi_v1].unk_4;
        }
        temp_v1_2 = phi_v1 + 2;
...
void func_8012D40C(f32 *param_1, f32 *param_2, s16 *param_3) {
    ...
    param_1->unk_4 = (f32) ((f32) param_3->unk_2 * 0.25f);
    param_1->unk_8 = (f32) ((f32) param_3->unk_8 * 0.25f);
    param_1->unk_C = (f32) ((f32) param_3->unk_A * 0.25f);
    param_2->unk_0 = param_1->unk_0 / (f32) ((s32) gScreenWidth / 2);
    param_2->unk_8 = (f32) (param_1->unk_8 - param_1->unk_0);
    param_2->unk_4 = (f32) (param_1->unk_4 / (f32) ((s32) gScreenHeight / 2));
    param_2->unk_C = (f32) (param_1->unk_C - param_1->unk_4);
}
