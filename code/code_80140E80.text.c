...
void func_80140EAC(Gfx **arg0, void *arg1, f32 arg2, s32 arg3, s32 arg4, s32 arg5) {
    ...
    temp_v0->words.w1 = 0;
    temp_v0_2 = temp_v0 + 8;
    temp_v0_2->unk0 = (s32) (((arg3 - 1) & 0xFFF) | 0xFF100000);
    temp_v0_2->unk4 = arg2;
    temp_v0_3 = temp_v0_2 + 8;
    temp_v0_3->unk0 = 0xED000000;
    temp_v0_4 = temp_v0_3 + 8;
    temp_v0_3->unk4 = (s32) ((((s32) ((f32) arg3 * 4.0f) & 0xFFF) << 0xC) | ((s32) ((f32) arg4 * 4.0f) & 0xFFF));
    temp_v0_4->unk4 = 0xC;
    temp_v0_4->unk0 = 0xB000000;
    temp_v0_5 = temp_v0_4 + 8;
    if ((arg5 & 1) != 0) {
        temp_v0_5->unk0 = 0xA000000;
        temp_v0_5->unk4 = arg1;
        phi_v0 = temp_v0_5 + 8;
    } else {
        temp_v0_5->unk0 = 0x9000000;
        temp_v0_5->unk4 = arg1;
        phi_v0 = temp_v0_5 + 8;
    }
    phi_v0->unk0 = 0xE7000000U;
    phi_v0->unk4 = 0;
    temp_v0_6 = phi_v0 + 8;
    temp_v0_6->unk4 = &D_0F000000;
    temp_v0_6->unk0 = (s32) (((D_801FBBCC - 1) & 0xFFF) | 0xFF100000);
    temp_v0_7 = temp_v0_6 + 8;
    temp_v0_7->unk0 = 0xDE000000;
    temp_v0_7->unk4 = &D_0E0001C8;
    *arg0 = temp_v0_7 + 8;
}
...
void func_80141008(Gfx **arg0, f32 arg1, f32 arg2, s32 arg3, s32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, s32 arg9) {
    ...
    temp_v0->unk8 = 0U;
    temp_v0->unk4 = (s16) (s32) (arg5 * 4.0f);
    temp_a0_2 = arg4 * 4;
    temp_v0->unkA = temp_a0_2;
    temp_v0->unkE = temp_a0_2;
    temp_v0->unk14 = 0xFFF4;
    temp_v0->unk16 = 0;
    temp_v0->unk17 = 2;
    temp_v0->unk18 = 0;
    temp_v0->unk1A = 0;
    temp_v0->unkC = (s16) (s32) (arg6 * 4.0f);
    temp_v0->unk10 = arg1;
    if ((arg9 & 1) != 0) {
        sp2C = temp_v0;
        guS2DInitBg(temp_v0, temp_v0);
    } else {
        temp_v0->unk1C = (s16) (s32) (1024.0f / arg7);
        temp_v0->unk20 = (s32) temp_v0->unk8;
        temp_v0->unk1E = (s16) (s32) (1024.0f / arg8);
    }
...
void func_80141200(Gfx **arg0, Gfx **arg1, f32 arg2, s32 arg3, s32 arg4, s32 arg5) {
    ...
    temp_v1 = ((arg0->unkC << 8) & 0xF800) | ((arg0->unkD * 8) & 0x7C0) | (((u32) arg0->unkE >> 2) & 0x3E) | 1;
    temp_t6_2 = sp8C;
    sp8C = temp_t6_2 + 8;
    ...
    temp_t8_3 = sp8C;
    sp8C = temp_t8_3 + 8;
    temp_t8_3->words.w0 = ((s32) (arg0->unk8 * 255.0f) & 0xFF) | 0xFA000000;
    temp_t8_3->words.w1 = (u32) arg0->unkC;
    temp_t6_3 = sp8C;
    if (arg0->unk13 == 0) {
        temp_t6_4 = sp8C;
        sp8C = temp_t6_4 + 8;
...
void func_80141678(s32 **arg0, Gfx **arg1, f32 arg2, s32 arg4) {
    ...
    temp_t5->words.w1 = arg0->unkC;
    temp_t9 = sp3C;
    sp3C = temp_t9 + 8;
    temp_t9->words.w0 = 0xFB000000;
    temp_a0 = &sp3C;
    temp_t9->words.w1 = arg0->unk10;
    temp_t3 = sp3C;
    sp3C = temp_t3 + 8;
...
void func_80141778(u8 *arg0, s32 **arg1, Gfx **arg2) {
    ...
    temp_t8 = sp2C;
    sp2C = temp_t8 + 8;
    temp_t8->unk4 = (void *) (&D_801E3BB0 - 0x80000000);
    temp_t8->unk0 = 0xE1000000;
    temp_t2 = sp2C;
    sp2C = temp_t2 + 8;
    temp_t2->unk4 = (void *) (&D_801ABAB0 - 0x80000000);
    temp_t2->unk0 = 0xDD0007FF;
    temp_v0 = *arg0;
    if (temp_v0 != 1) {
        if (temp_v0 != 2) {
    ...
    temp_t9 = sp2C;
    sp2C = temp_t9 + 8;
    temp_t9->unk0 = 0xE1000000;
    sp24 = temp_t9;
    sp24->unk4 = func_80182CCC();
    temp_t2_2 = sp2C;
    sp2C = temp_t2_2 + 8;
    temp_t2_2->unk0 = 0xDD0007FF;
    sp24 = temp_t2_2;
    sp24->unk4 = func_80182CBC();
    *arg1 = sp2C;
}
