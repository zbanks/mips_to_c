...
block_6:
    if ((temp_t0 != 0) || (D_801D0D50 != 0)) {
        sp2C.unk0 = (f32) globalCtx->view.eye.x;
        sp2C.unk4 = (f32) globalCtx->view.eye.y;
        sp2C.unk8 = (f32) globalCtx->view.eye.z;
    } else {
        sp2C.unk0 = (f32) temp_t1->focus.pos.x;
        sp2C.unk4 = (f32) temp_t1->focus.pos.y;
        sp2C.unk8 = (f32) temp_t1->focus.pos.z;
    }
...
block_6:
    if ((temp_t0 != 0) || (D_801D0D50 != 0)) {
        sp24.unk0 = (f32) globalCtx->view.eye.x;
        sp24.unk4 = (f32) globalCtx->view.eye.y;
        sp24.unk8 = (f32) globalCtx->view.eye.z;
    } else {
        sp24.unk0 = (f32) temp_t1->focus.pos.x;
        sp24.unk4 = (f32) temp_t1->focus.pos.y;
        sp24.unk8 = (f32) temp_t1->focus.pos.z;
    }
