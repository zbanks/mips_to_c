...
void EffectShieldParticle_Init(EffShieldParticleParams *params, EffShieldParticleInit *init) {
    ...
    if ((params != 0) && (init != 0) && (temp_t6 = init->numParticles, params->numParticles = temp_t6, (((temp_t6 & 0xFF) < 0x11) != 0))) {
        params->unk_182 = (unaligned s32) init->unk_2;
        ...
        if ((u32) params < (u32) &params->particles[temp_t6 & 0xFF]) {
            do {
                ...
                temp_s0 = phi_s0 + 0x18;
                temp_s0->unk_-2 = (s16) (s32) (Rand_ZeroOne() * 65534.0f);
                phi_s0 = temp_s0;
        ...
        if (temp_t3 == 1) {
            ...
            params->lightInfo.params.dir.x = (unaligned s32) init->unk_2E;
            params->lightInfo.params.dir.color[1] = (unaligned s32) init->unk_32;
