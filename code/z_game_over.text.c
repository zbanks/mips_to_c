...
void func_801AA68C(GlobalContext *arg0) {
    ...
    case 1:
        ...
        if (phi_v0_2 == 0) {
            ...
            if ((&gSaveContext + (phi_v0_3 * 4))->unk4C != 0x4D) {
                phi_v0_4 = temp_a0;
                if (temp_a0 == 4) {

                }
                if ((&gSaveContext + (phi_v0_4 * 4))->unk4C != 0x4E) {
                    phi_v0_5 = temp_a0;
                    if (temp_a0 == 4) {

                    }
                    if ((&gSaveContext + (phi_v0_5 * 4))->unk4C != 0x4F) {
                        phi_v0_6 = temp_a0;
                        if (temp_a0 == 4) {

                        }
                        if ((&gSaveContext + (phi_v0_6 * 4))->unk4C != 0x50) {
                            ...
                            if (temp_a1 != 0) {
                                ...
                                (&gSaveContext + (phi_v0_7 * 4))->unk4C = temp_a1;
                            } else {
                                if (temp_a0 == 4) {
                                ...
                                (&gSaveContext + (phi_v0_8 * 4))->unk4C = 0xFF;
                            }
                        }
                    }
                }
