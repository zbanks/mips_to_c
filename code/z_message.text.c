...
s8 D_801D039C[];                                    /* unable to generate initializer */
...
typedef struct {
    ...
    /* 0x11F18 */ s8 unk11F18;                      /* inferred */
    /* 0x11F19 */ char pad11F19[0x1];               /* maybe part of unk11F18[2]? */
    /* 0x11F1A */ s16 unk11F1A;                     /* inferred */
    /* 0x11F1C */ s16 unk11F1C;                     /* inferred */
    /* 0x11F1E */ s16 unk11F1E;                     /* inferred */
    /* 0x11F20 */ char pad11F20[0x2];               /* maybe part of unk11F1E[2]? */
    /* 0x11F22 */ u8 unk11F22;
    ...
    /* 0x11FFE */ char pad11FFE[0x6];               /* maybe part of unk11FFC[4]? */
    /* 0x12004 */ s16 unk12004;                     /* inferred */
    /* 0x12006 */ s16 unk12006;                     /* inferred */
    /* 0x12008 */ s16 unk12008;                     /* inferred */
    /* 0x1200A */ s16 unk1200A;                     /* inferred */
    /* 0x1200C */ s16 unk1200C;                     /* inferred */
    /* 0x1200E */ s16 unk1200E;                     /* inferred */
    /* 0x12010 */ char pad12010[0x2];               /* maybe part of unk1200E[2]? */
    ...
    /* 0x1203E */ char pad1203E[0x2];               /* maybe part of unk1203C[2]? */
    /* 0x12040 */ Actor *unk12040;                  /* inferred */
    /* 0x12044 */ s16 unk12044;
    /* 0x12046 */ s16 unk12046;                     /* inferred */
    /* 0x12048 */ s8 unk12048;                      /* inferred */
    /* 0x12049 */ char pad12049[0x1];               /* maybe part of unk12048[2]? */
    ...
    /* 0x12080 */ void *unk12080;                   /* inferred */
    /* 0x12084 */ ? *unk12084;                      /* inferred */
    /* 0x12088 */ char pad12088[0x4];               /* maybe part of unk12084[2]? */
    ...
    /* 0x1209E */ char pad1209E[0x2];               /* maybe part of unk1209C[2]? */
    /* 0x120A0 */ u32 unk120A0;                     /* inferred */
    /* 0x120A4 */ s16 unk120A4;                     /* inferred */
    /* 0x120A6 */ s16 unk120A6;                     /* inferred */
    /* 0x120A8 */ s16 unk120A8;                     /* inferred */
    /* 0x120AA */ s16 unk120AA;                     /* inferred */
    /* 0x120AC */ s16 unk120AC;                     /* inferred */
    /* 0x120AE */ s16 unk120AE;                     /* inferred */
...
void func_8014CFDC(GlobalContext *arg0) {
    ...
    if (arg0->msgCtx.unk11FEC == 0) {
        ...
        sp1C = (s32) temp_t2;
        if (temp_t2 != 0xFE) {
            func_8014C70C(arg0, sp1E, (s16) (temp_v1->unk1206A + 0xA), temp_v1 + 0x10000);
        }
    }
}
...
void Message_Init(GlobalContext *globalCtx) {
    ...
    View_Init(&temp_s0->view, globalCtx->state.gfxCtx);
