struct _mips2c_stack_func_801639A0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_801639EC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80163A38 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80163A58 {
    /* 0x00 */ char pad_0[0x18];
...
struct _mips2c_stack_func_80163C0C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */
...
void func_80163A58(void *arg0) {
    ...
    phi_a1 = temp_a1;
    phi_a3_2 = temp_a3;
    if ((temp_a3->unk_16F1C != 0) || (temp_a3->unk_16F1E != 0)) {
        temp_a0 = temp_v1->unk_1EC;
        if ((temp_a0 == 1) || (temp_a0 == 0x13)) {
            ...
            if (ShrinkWindow_GetLetterboxMagnitude() == 0) {
                ...
                temp_v1->unk_200 = 0;
                temp_v1->unk_208 = 0;
                temp_v1->unk_1EC = (u16) (temp_v1->unk_1EC + 1);
                return;
            }
        ...
        if (temp_a0 != 0) {
            ...
            if (&D_801D0B70 == phi_a0) {
                ...
                if ((phi_a1->unk_6F1C == 0) && (phi_a1->unk_6F1E == 0)) {
...
void func_80163C0C(void *arg0) {
    ...
    if ((gGameInfo->data[190] == 3) && (((temp_v0 = arg0->unk_16F1C, (((s32) temp_v0 < 4) == 0)) && ((s32) temp_v0 < 8)) || (((s32) temp_v0 >= 0xB) && ((s32) temp_v0 < 0x1B))) && (&D_801D0B70 == D_801D0BAC)) {
        D_801F6C04();
    }
}
