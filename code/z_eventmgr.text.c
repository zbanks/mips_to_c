...
s32 func_800F22C4(s16 param_1, Actor *actor) {
    ...
    if (((s32) sp2A >= 0x29) && ((s32) sp2A < 0x118) && ((s32) sp28 >= 0x29) && ((s32) sp28 < 0xC8) && (OLib_Vec3fDist((Vec3f *) &actor->focus, Play_GetCamera(actorCutsceneCurrent.unk10, actorCutsceneCurrent.unk6) + 0x5C) < 700.0f)) {
        return 1;
    }
