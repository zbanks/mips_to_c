...
block_7:
        ...
        osSendMesg(&sched->interruptQ, (void *)0x29B, 0);
        return;
    }
...
block_16:
    ...
    if ((temp_v0_3 != 0) && (temp_s0_2->unk0 == 1)) {
        osSyncPrintf("DP止めようとします\n");
        temp_a0_3 = temp_s0_2->unk28;
        bzero(temp_a0_3, temp_s0_2->unk2C - temp_a0_3);
        osSendMesg(&sched->interruptQ, (void *)0x29C, 0);
    }
}
...
s32 Sched_TaskCheckFramebuffers(OSScTask *arg0, void *arg1) {
    ...
    if ((arg1 == 0) || (arg0->unk324 != 0) || ((temp_v0 == *arg1->unkC) && (temp_v0 != sp1C))) {
        return 0;
    }
    return 1;
}
...
void Sched_HandleRSPDone(SchedContext *sched) {
    ...
    if (temp_a0 != 1) {
        if (temp_a0 == 2) {
            temp_t3 = gRSPAudioTotalTime.unk4 + temp_v1;
            temp_t5 = *(&sRSPAudioStartTime + 4);
            gRSPAudioTotalTime.unk0 = (s32) ((((temp_t3 < temp_v1) + gRSPAudioTotalTime.unk0 + temp_v0) - sRSPAudioStartTime) - (temp_t3 < temp_t5));
            D_801FBB04 = temp_t3 - temp_t5;
        } else {
            temp_t1 = sRSPOtherTotalTime.unk4 + temp_v1;
            temp_t3_2 = *(&sRSPOtherStartTime + 4);
            sRSPOtherTotalTime.unk0 = (s32) ((((temp_t1 < temp_v1) + sRSPOtherTotalTime.unk0 + temp_v0) - sRSPOtherStartTime) - (temp_t1 < temp_t3_2));
            D_801FBB14 = temp_t1 - temp_t3_2;
        }
    } else {
        temp_t3_3 = *(&sRSPGFXStartTime + 4);
        temp_t1_2 = sRSPGFXTotalTime.unk4 + temp_v1;
        sRSPGFXTotalTime.unk0 = (s32) ((((temp_t1_2 < temp_v1) + sRSPGFXTotalTime.unk0 + temp_v0) - sRSPGFXStartTime) - (temp_t1_2 < temp_t3_3));
...
void Sched_HandleRDPDone(SchedContext *sched) {
    ...
    gRDPTotalTime.unk0 = (s32) ((temp_ret - sRDPStartTime) - (temp_v1 < temp_t9));
    gRDPTotalTime.unk4 = (s32) (temp_v1 - temp_t9);
...
void Sched_SendEntryMsg(SchedContext *sched) {
    osSendMesg(&sched->interruptQ, (void *)0x29E, 1);
}

void Sched_SendAudioCancelMsg(SchedContext *sched) {
    osSendMesg(&sched->interruptQ, (void *)0x29F, 1);
}

void Sched_SendGfxCancelMsg(SchedContext *sched) {
    osSendMesg(&sched->interruptQ, (void *)0x2A0, 1);
}
...
void Sched_FaultClient(void *param1, void *param2) {
    ...
    FaultDrawer_Printf("sched info\n", param1->unk304, param1->unk30C, param1->unk300, param1->unk308);
    FaultDrawer_Printf("GRAPH %08x %08x\n", param1->unk304, param1->unk30C);
    FaultDrawer_Printf("AUDIO %08x %08x\n\n", param1->unk300, param1->unk308);
    temp_a1 = param1->unk310;
    if (temp_a1 != 0) {
        FaultDrawer_Printf("RSPTask %08x %08x %02x %02x\n%01x %08x %08x\n", temp_a1, temp_a1->unk0, temp_a1->unk4, temp_a1->unk8, temp_a1->unk10, temp_a1->unk40, temp_a1->unk44);
    }
    temp_a1_2 = param1->unk314;
    if (temp_a1_2 != 0) {
        FaultDrawer_Printf("RDPTask %08x %08x %02x %02x\n", temp_a1_2, temp_a1_2->unk0, temp_a1_2->unk4, temp_a1_2->unk8);
    }
}
...
void Sched_Init(SchedContext *sched, void *stack, s32 pri, s32 arg3, s32 arg4, IrqMgr *irqMgr) {
    ...
    osCreateMesgQueue(&sched->interruptQ, sched->intBuf, 0x40);
    osCreateMesgQueue(&sched->cmdQ, sched->cmdMsgBuf, 8);
    osSetEventMesg(4U, &sched->interruptQ, (void *)0x29B);
    osSetEventMesg(9U, &sched->interruptQ, (void *)0x29C);
