struct _mips2c_stack_TitleSetup_Destroy {};         /* size 0x0 */

struct _mips2c_stack_TitleSetup_GameStateResetContext {}; /* size 0x0 */

struct _mips2c_stack_TitleSetup_Init {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_TitleSetup_InitImpl {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */
