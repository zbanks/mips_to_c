struct _mips2c_stack_PreRender_AntiAliasAlgorithm {
    ...
    /* 0x028 */ char pad28[0x4];
    /* 0x02C */ s32 *sp2C;                          /* inferred */
    /* 0x030 */ char pad30[0x14];                   /* maybe part of sp2C[6]? */
    /* 0x044 */ s32 sp44;                           /* inferred */
    /* 0x048 */ char pad48[0xC];                    /* maybe part of sp44[4]? */
    /* 0x054 */ u8 sp54;                            /* inferred */
    /* 0x055 */ u8 sp55;                            /* inferred */
    /* 0x056 */ char pad56[0x2];                    /* maybe part of sp55[3]? */
    /* 0x058 */ u16 sp58;                           /* inferred */
    /* 0x05A */ char pad5A[0x26];                   /* maybe part of sp58[20]? */
    /* 0x080 */ ? sp80;                             /* inferred */
    ...
    /* 0x098 */ char pad98[0x4];
    /* 0x09C */ s32 sp9C;                           /* inferred */
    /* 0x0A0 */ char padA0[0x1C];                   /* maybe part of sp9C[8]? */
    /* 0x0BC */ ? spBC;                             /* inferred */
    /* 0x0BC */ char padBC[0x4];
    ...
    /* 0x0DC */ char padDC[0x1C];                   /* maybe part of spD8[8]? */
    /* 0x0F8 */ ? spF8;                             /* inferred */
...
struct _mips2c_stack_func_801716C4 {
    ...
    /* 0x10 */ s32 sp10;                            /* inferred */
    /* 0x14 */ s32 sp14;                            /* inferred */
    /* 0x18 */ char pad18[0x10];                    /* maybe part of sp14[5]? */
...
struct _mips2c_stack_func_801720FC {
    ...
    /* 0x20 */ char pad20[0x3C];                    /* maybe part of sp1C[16]? */
