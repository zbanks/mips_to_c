...
u32 func_801716C4(u8 *arg0, u8 *arg1, u8 *arg2) {
    ...
    *temp_v0 += 1;
    temp_v1 = temp_s3 + arg0[1];
    *temp_v1 += 1;
    temp_a3 = temp_s3 + arg0[2];
    *temp_a3 += 1;
    temp_t0 = temp_s3 + arg1->unk_0;
    *temp_t0 += 1;
    temp_t1 = temp_s3 + arg1[1];
    *temp_t1 += 1;
    temp_t2 = temp_s3 + arg1[2];
    *temp_t2 += 1;
    temp_t3 = temp_s3 + arg2->unk_0;
    *temp_t3 += 1;
    temp_t4 = temp_s3 + arg2[1];
    *temp_t4 += 1;
    temp_t5 = temp_s3 + arg2[2];
    *temp_t5 += 1;
    phi_s0 = 0U;
    phi_s2 = &sp28;
    phi_s1 = 0U;
...
loop_6:
                    ...
                    *(*temp_a0 + phi_s0_2) = (s8) ((u32) ((s32) spB0 << 0xA) >> 0x1B);
                    spB0 = (&(&this->fbufSave[phi_s0_2])[phi_s4 * this->width])[1];
                    ...
                    spB0 = (&(&this->fbufSave[phi_s0_2])[phi_s4 * this->width])[2];
                    ...
                    spB0 = (&(&this->fbufSave[phi_s0_2])[phi_s4 * this->width])[3];
