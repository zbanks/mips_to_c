...
void func_80165460(GraphicsContext **arg0);         /* static */
...
SceneTableEntry gSceneTable[];                      /* unable to generate initializer */
u32 gSegments[16];
u16 *gZBufferPtr;
...
void func_80165460(GraphicsContext **arg0) {
    ...
    if (phi_v0 != 0) {
        ...
        temp_v1_2 = temp_t0->overlay.p;
        temp_t0->overlay.p = temp_v1_2 + 8;
        temp_v1_2->words.w0 = 0xDE000000;
        temp_v1_2->words.w1 = sp34;
        arg0->unk18B5C = (s32) temp_t0->framebuffer;
...
void Play_Fini(GlobalContext *globalCtx) {
    ...
    if ((globalCtx->unk_18B4A == 3) || (D_801D0D54 != 0)) {
        globalCtx->unk18E24(&globalCtx->unk_18B9C[92]);
        func_80166060(globalCtx);
        globalCtx->unk_18B4A = 0;
    }
    ShrinkWindow_Fini();
    TransitionFade_Destroy(&globalCtx->unk_18B9C[684]);
...
void func_80166B30(GlobalContext *globalCtx) {
    ...
    void *sp1C;
    s8 *sp18;
    ? (*temp_v0_6)(s8 *, s32, GlobalContext *);
        ...
        if (temp_v0 != 1) {
            if (temp_v0 != 2) {
                if (temp_v0 != 3) {
                    ...
                    temp_a0 = &globalCtx->unk_18B9C[92];
                    sp18 = temp_a0;
                    globalCtx = globalCtx;
                    sp1C = temp_a3;
                    temp_a2 = globalCtx;
                    ...
                    if (temp_a3->unkE40(temp_a0) != 0) {
                        ...
                        if (sp1C->unk875 != -0x14) {
                            ...
                            if (D_801F6D10 == 3) {
                                ...
                                func_8016424C(&D_801F6C30);
                                D_801F6D10 = 0;
                                Game_SetFramerateDivisor(&globalCtx->state, 3);
                                phi_a2_2 = globalCtx;
                                phi_v1_2 = sp1C;
                            }
                        }
...
block_110:
        ...
        case 6: // switch 3
            ...
            if ((s32) temp_v0_8 >= 0x14) {
                D_801F6D10 = 0;
                globalCtx = phi_a2_6;
                Game_SetFramerateDivisor(&phi_a2_6->state, 3);
        ...
        case 13: // switch 3
            ...
            if (sp1C->unk875 == -0x14) {
                ...
                if ((s32) globalCtx->envCtx.unk_EB < 0x6E) {
                    D_801F6D10 = 0;
                    globalCtx = globalCtx;
                    Game_SetFramerateDivisor(&temp_a0_4->state, 3);
                    globalCtx->sceneLoadFlag = 0;
                    phi_at = globalCtx + 0x20000;
                    goto block_110;
                }
        ...
        case 15: // switch 3
            ...
            if (sp1C->unk875 == -0x14) {
                ...
                if ((s32) globalCtx->envCtx.unk_EB <= 0) {
                    D_801F6D10 = 0;
                    globalCtx = globalCtx;
                    Game_SetFramerateDivisor(&temp_a0_5->state, 3);
                    globalCtx->sceneLoadFlag = 0;
                    phi_at = globalCtx + 0x20000;
                    goto block_110;
                }
...
void func_80167814(GlobalContext *globalCtx) {
    ...
    if (func_80122670(&globalCtx->frameAdvCtx, temp_a1) != 0) {
        ...
        if (temp_v1 != 0) {
            if (temp_v1 != 2) {
                ...
                D_801F6D10 = 3;
                Game_SetFramerateDivisor(&globalCtx->state, 1);
            }
        }
        ...
        if (D_801F6D10 != 3) {
            ...
            Room_nop8012D510(globalCtx, &sp38->currRoom, (void *) sp30, 0);
            ...
            TransitionFade_Update(&globalCtx->unk_18B9C[684], globalCtx->state.framerateDivisor);
        }
    }
    if ((sp5C == 0) || (D_801D0D50 != 0)) {
        ...
        Camera_Update(&sp48, globalCtx->cameraPtrs[phi_a2_2]);
    }
    if (sp5C == 0) {
...
void func_80168090(GlobalContext *globalCtx) {
    ...
    if ((temp_v0_16 == 3) || (temp_v0_16 == 0xB) || (D_801D0D54 != 0)) {
        ...
        sp98 = 0;
        spA0 = 0;
        View_SetViewport(&spA8, (Viewport *) &sp98);
        func_801400CC(&spA8, &sp218);
        sp40->unkE2C(&globalCtx->unk_18B9C[92], &sp218);
    }
    TransitionFade_Draw(&globalCtx->unk_18B9C[684], &sp218);
    if (D_801F6D30.a != 0) {
    ...
    if (temp_v0_17 == 2) {
        ...
        if (sp40->unk844 == 0) {
            ...
            if (sp40->unk758 != 0) {
                sp48 = (MtxF *)3;
                Room_Draw(globalCtx, &globalCtx->roomCtx.currRoom, (u32) (MtxF *)3);
        ...
        func_80165460(&globalCtx->state.gfxCtx);
        temp_v1_4 = gGameInfo;
...
block_66:
    ...
    if ((globalCtx->view.unk164 != 0) && (D_801D0D50 == 0)) {
        Camera_Update(&sp4C, globalCtx->cameraPtrs[globalCtx->activeCamera]);
        func_80140024(sp38);
...
void func_8016927C(GlobalContext *globalCtx, s16 sParm2) {
    func_801434E4(&globalCtx->state, &globalCtx->skyboxCtx, sParm2);
...
void Play_SceneInit(GlobalContext *arg0, s32 arg1, s32 arg2) {
    ...
    sp1C = temp_a1;
    arg0->sceneSegment = Play_LoadScene(arg0, &temp_a1->segment);
    sp1C->unkD = 0;
    *(gSegments + 8) = (u32) (arg0->sceneSegment + 0x80000000);
    func_801692C4(&arg0->state, (s8) arg2);
...
void func_80169E6C(GlobalContext *globalCtx, s32 param_1, s32 param_2) {
    ...
    if (globalCtx->sceneNum != 7) {
        func_80169DCC(globalCtx, param_1, gSaveContext.entranceIndex & 0xFFFF, (s32) globalCtx->roomCtx.currRoom.num, param_2, &temp_v1->world.pos, (s16) (s32) temp_v1->shape.rot.y);
    }
}
