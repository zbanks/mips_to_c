...
void Math3D_Lerp(Vec3f *a, Vec3f *b, f32 t, Vec3f *dst) {
    ...
    Math3D_ScaleAndAdd(a, &sp1C, t, dst);
}
...
f32 Math3D_DistanceSquared(Vec3f *a, Vec3f *b) {
    ...
    Math_Vec3f_Diff(a, b, &sp1C);
    return (bitwise f32) (bitwise s32) Math3D_LengthSquared(&sp1C);
}
...
void Math3D_TriSetCoords(TriNorm *tri, Vec3f *pointA, Vec3f *pointB, Vec3f *pointC) {
    ...
    Math3D_UnitNormalVector(pointA, pointB, pointC, &tri->plane.normal.x, &tri->plane.normal.y, &tri->plane.normal.z, &tri->plane.originDist);
}
...
u32 Math3D_IsPointInSphere(Sphere16 *sphere, Vec3f *point) {
    ...
    phi_v0 = 0U;
    if (Math3D_DistanceS(&sphere->center, point) < (f32) sphere->radius) {
        phi_v0 = 1U;
    }
    return phi_v0;
}
...
s32 Math3D_ColSphereLineSeg(Sphere16 *sphere, LineSegment *line) {
    ...
    line = line;
    temp_a0 = sphere;
    if ((Math3D_IsPointInSphere(sphere, &temp_a1->a) != 0) || (temp_a1_2 = &line->b, sphere = temp_a0, line = line, (Math3D_IsPointInSphere(temp_a0, temp_a1_2) != 0))) {
        return 1;
    }
    temp_f12 = line->a.x;
    temp_f14 = line->a.y;
...
s32 Math3D_ColSphereTri(Sphere16 *sphere, TriNorm *tri, Vec3f *uParm3) {
    ...
    *temp_at = (f32) sphere->center.y;
    ...
    if (fabsf(temp_f14_2) > 0.5f) {
        if (func_8017BD98(&tri->vtx[0].x, &sp38->x, sp34, D_801FBC30, D_801FBC28, 0.0f, temp_f14_2) != 0) {
            func_8017DD34(sphere, tri, uParm3);
            return 1;
        }
        goto block_21;
...
s32 func_8017E350(void *arg0, Vec3f *arg1, Vec3f *arg2, Vec3f *arg3, Vec3f *arg4) {
    ...
    Math_Vec3f_Diff((Vec3f *) temp_a0, (Vec3f *) temp_a1, &spD4);
    temp_v0 = arg0->unk0;
    ...
    if (!(fabsf(spD4.y) < 0.008f)) {
        temp_f0 = -spF0 / spD4.y;
        if ((temp_f0 >= 0.0f) && (temp_f0 <= 1.0f)) {
            temp_f2 = (spD4.x * temp_f0) + spEC;
            temp_f12 = (spD4.z * temp_f0) + spF4;
        ...
        temp_f10 = ((f32) arg0->unk2 - spF0) / spD4.y;
        spD0 = temp_f10;
        phi_t0_2 = phi_t0_3;
        if ((temp_f10 >= 0.0f) && (temp_f10 <= 1.0f)) {
            temp_f0_2 = (spD4.x * temp_f10) + spEC;
            temp_f2_2 = (spD4.z * temp_f10) + spF4;
    ...
    phi_t0 = phi_t0_2;
    if (!(fabsf(temp_f18) < 0.008f)) {
        temp_f14_2 = 2.0f * ((spD4.x * sp20) + (spD4.z * sp24));
    ...
    temp_f14_3 = 2.0f * ((spD4.x * spEC) + (spD4.z * spF4));
...
block_44:
        phi_a2_2 = phi_a2;
        phi_a1_4 = phi_a1_3;
        if ((phi_a2 != 0) && ((temp_f0_5 = (phi_f2 * spD4.y) + spF0, (temp_f0_5 < 0.0f)) || ((f32) arg0->unk2 < temp_f0_5))) {
            phi_a2_2 = 0;
        }
        if ((phi_a1_3 != 0) && ((temp_f0_6 = (spCC * spD4.y) + spF0, (temp_f0_6 < 0.0f)) || ((f32) arg0->unk2 < temp_f0_6))) {
            phi_a1_4 = 0;
        }
        phi_v1_3 = 0;
        ...
        if ((phi_a2_2 != 0) && (phi_a1_4 != 0)) {
            sp24 = spD4.x;
            sp84 = (phi_f2 * spD4.x) + spEC + (f32) arg0->unk6;
            sp20 = spEC;
            sp28 = spD4.y;
            sp88 = (phi_f2 * spD4.y) + spF0 + (f32) arg0->unk8 + (f32) arg0->unk4;
            sp2C = spF0;
            sp8C = (phi_f2 * spD4.z) + spF4 + (f32) arg0->unkA;
            sp90 = (spCC * spD4.x) + sp20 + (f32) arg0->unk6;
            sp94 = (spCC * sp28) + spF0 + (f32) arg0->unk8 + (f32) arg0->unk4;
            sp98 = (spCC * spD4.z) + spF4 + (f32) arg0->unkA;
            phi_t0 = phi_t0_2 | 4 | 8;
        } else if (phi_a2_2 != 0) {
            sp84 = (phi_f2 * spD4.x) + spEC + (f32) arg0->unk6;
            sp88 = (phi_f2 * spD4.y) + spF0 + (f32) arg0->unk8 + (f32) arg0->unk4;
            ...
            sp84 = (spCC * spD4.x) + spEC + (f32) arg0->unk6;
            sp88 = (spCC * spD4.y) + spF0 + (f32) arg0->unk8 + (f32) arg0->unk4;
            sp8C = (spCC * spD4.z) + spF4 + (f32) arg0->unkA;
            phi_t0 = phi_t0_2 | 4;
        }
loop_63:
        phi_v1_5 = phi_v1_3;
...
s32 Math3D_ColCylinderTri(Cylinder16 *cylinder, TriNorm *tri, Vec3f *pzParm3) {
    ...
    sp80 = 1e38.0f;
    phi_f2 = 1e38.0f;
    if (func_8017E350((void *) cylinder, tri->vtx, temp_a2, &D_801FBC48, &D_801FBC58) != 0) {
        temp_f2 = Math3D_DistanceSquared(&D_801FBC48, tri->vtx);
    ...
    sp80 = phi_f2_2;
    phi_f2_3 = phi_f2_2;
    if (func_8017E350((void *) cylinder, tri->vtx, sp44, &D_801FBC48, &D_801FBC58) != 0) {
        sp80 = phi_f2_2;
        temp_f0_3 = Math3D_DistanceSquared(&D_801FBC48, tri->vtx);
        phi_f2_3 = phi_f2_2;
    ...
    if (func_8017C008(&tri->vtx[0].x, &sp48->x, sp44, tri->plane.normal.x, tri->plane.normal.y, tri->plane.normal.z, tri->plane.originDist, (f32) cylinder->pos.z, (f32) cylinder->pos.x, &sp8C, sp84, sp88) != 0) {
        temp_a0 = &sp60;
        sp70 = sp8C;
        temp_a1_2 = &sp6C;
        ...
        Math_Vec3f_Diff((Vec3f *) temp_a0, (Vec3f *) temp_a1_2, &sp54);
        temp_f14_2 = sqrtf((sp54.x * sp54.x) + (sp54.z * sp54.z));
        if (fabsf(temp_f14_2) < 0.008f) {
            Math_Vec3f_Copy(pzParm3, (Vec3f *) &sp60);
            return 1;
        }
        Math3D_ScaleAndAdd((Vec3f *) &sp6C, &sp54, (f32) cylinder->radius / temp_f14_2, pzParm3);
        return 1;
    }
...
void func_8017F1A0(Cylinder16 *arg0, TriNorm *arg1) {
    ...
    Math3D_ColCylinderTri(arg0, arg1, &sp1C);
}
...
s32 Math3d_ColTriTri(TriNorm *tri1, TriNorm *tri2, Vec3f *uParm3) {
    ...
    if (func_8017D404((bitwise f32 *) sp58, &tri2->vtx[0].x, &sp4C->x, (bitwise f32) sp48, tri2->plane.normal.x, tri2->plane.normal.y, tri2->plane.normal.z, (bitwise Vec3f *) tri2->plane.originDist, tri1->vtx, sp44, uParm3, 0) != 0) {
        return 1;
    }
    if (func_8017D404(&tri2->vtx[0].x, &sp4C->x, &sp48->x, tri2->plane.normal.x, tri2->plane.normal.y, tri2->plane.normal.z, tri2->plane.originDist, sp44, sp40, uParm3, NULL) != 0) {
        return 1;
    }
    if (func_8017D404(&tri2->vtx[0].x, &sp4C->x, &sp48->x, tri2->plane.normal.x, tri2->plane.normal.y, tri2->plane.normal.z, tri2->plane.originDist, sp40, tri1->vtx, uParm3, NULL) != 0) {
        return 1;
    }
    if (func_8017D404(&tri1->vtx[0].x, &sp44->x, &sp40->x, tri1->plane.normal.x, tri1->plane.normal.y, tri1->plane.normal.z, tri1->plane.originDist, tri2->vtx, sp4C, uParm3, NULL) != 0) {
        return 1;
    }
    if (func_8017D404(&tri1->vtx[0].x, &sp44->x, &sp40->x, tri1->plane.normal.x, tri1->plane.normal.y, tri1->plane.normal.z, tri1->plane.originDist, sp4C, sp48, uParm3, NULL) != 0) {
        return 1;
    }
    if (func_8017D404(&tri1->vtx[0].x, &sp44->x, &sp40->x, tri1->plane.normal.x, tri1->plane.normal.y, tri1->plane.normal.z, tri1->plane.originDist, sp48, tri2->vtx, uParm3, NULL) != 0) {
        return 1;
    }
block_26:
    return 0;
