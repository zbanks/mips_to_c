...
struct _mips2c_stack_func_8017AA0C {
    ...
    /* 0x10 */ char pad_10[0xC];                    /* maybe part of spC[4]? */
    /* 0x1C */ f32 sp1C;                            /* inferred */
    /* 0x20 */ f32 sp20;                            /* inferred */
...
struct _mips2c_stack_func_8017BAD0 {
    ...
    /* 0x2C */ f32 sp2C;                            /* inferred */
    /* 0x30 */ char pad_30[0x20];                   /* maybe part of sp2C[9]? */
    /* 0x50 */ f32 sp50;                            /* inferred */
    /* 0x54 */ f32 sp54;                            /* inferred */
    /* 0x58 */ f32 sp58;                            /* inferred */
    /* 0x5C */ f32 sp5C;                            /* inferred */
...
struct _mips2c_stack_func_8017D668 {
    ...
    /* 0x04 */ f32 sp4;                             /* inferred */
    /* 0x08 */ f32 sp8;                             /* inferred */
    /* 0x0C */ char pad_C[0x10];                    /* maybe part of sp8[5]? */
    /* 0x1C */ f32 sp1C;                            /* inferred */
...
struct _mips2c_stack_func_8017D814 {
    ...
    /* 0x08 */ f32 sp8;                             /* inferred */
    /* 0x0C */ f32 spC;                             /* inferred */
    /* 0x10 */ char pad_10[0x8];                    /* maybe part of spC[3]? */
    /* 0x18 */ f32 sp18;                            /* inferred */
    /* 0x1C */ f32 sp1C;                            /* inferred */
...
struct _mips2c_stack_func_8017E350 {
    ...
    /* 0x28 */ f32 sp28;                            /* inferred */
    /* 0x2C */ f32 sp2C;                            /* inferred */
    /* 0x30 */ char pad_30[0x1C];                   /* maybe part of sp2C[8]? */
    /* 0x4C */ f32 sp4C;                            /* inferred */
    ...
    /* 0xA0 */ char pad_A0[0x18];                   /* maybe part of sp9C[7]? */
    /* 0xB8 */ f32 spB8;                            /* inferred */
    /* 0xBC */ char pad_BC[0x10];                   /* maybe part of spB8[5]? */
...
s32 func_80179798(Vec3f *arg0, Vec3f *arg1, void *arg2, void *arg3, void *arg4, ? *arg5) {
    ...
    sp28 = arg2->unk_0;
    sp24 = arg2->unk_4;
    temp_f2 = arg3->unk_0 - sp28;
    temp_f12 = arg3->unk_4 - sp24;
    sp20 = arg2->unk_8;
    sp34 = temp_f16;
    temp_f14 = arg3->unk_8 - sp20;
    sp30 = temp_f18;
    ...
    arg4->unk_0 = (f32) ((sp74 * temp_f0_4) + sp34);
    arg4->unk_4 = (f32) ((sp70 * temp_f0_4) + arg0->y);
    arg4->unk_8 = (f32) ((sp6C * temp_f0_4) + arg0->z);
    temp_f16_4 = (sp5C * temp_f0_4) + temp_f18_2;
    arg5->unk_0 = (f32) ((temp_f2 * temp_f16_4) + arg2->unk_0);
    arg5->unk_4 = (f32) ((temp_f12 * temp_f16_4) + arg2->unk_4);
    arg5->unk_8 = (f32) ((temp_f14 * temp_f16_4) + arg2->unk_8);
    return 1;
}
...
void func_8017B68C(void *arg0, void *arg1, void *arg2, void *arg3) {
    D_801FBD24 = (f32) arg0->unk_0;
    D_801FBD24 = (f32) arg0->unk_2;
    D_801FBD28 = (f32) arg0->unk_4;
    D_801FBD34 = (f32) arg1->unk_0;
    D_801FBD34 = (f32) arg1->unk_2;
    D_801FBD38 = (f32) arg1->unk_4;
    D_801FBD44 = (f32) arg2->unk_0;
    D_801FBD44 = (f32) arg2->unk_2;
    D_801FBD48 = (f32) arg2->unk_4;
    D_801FBD54 = (f32) arg3->unk_0;
    D_801FBD54 = (f32) arg3->unk_2;
    D_801FBD58 = (f32) arg3->unk_4;
...
s32 func_8017E294(void *arg0, Vec3f *arg1) {
    ...
    temp_v0 = arg0->unk_0;
    temp_f0 = (f32) arg0->unk_6 - arg1->x;
    temp_f2 = (f32) arg0->unk_A - arg1->z;
    temp_f12 = (f32) arg0->unk_8 + (f32) arg0->unk_4;
    if ((((temp_f0 * temp_f0) + (temp_f2 * temp_f2)) < (f32) (temp_v0 * temp_v0)) && (temp_f0_2 = arg1->y, (temp_f12 < temp_f0_2)) && (temp_f0_2 < ((f32) arg0->unk_2 + temp_f12))) {
        return 1;
    }
    return 0;
}
...
s32 func_8017E350(void *arg0, Vec3f *arg1, Vec3f *arg2, Vec3f *arg3, Vec3f *arg4) {
    ...
    temp_a0 = &spE0;
    temp_a1 = &spEC;
    spEC = arg1->x - (f32) arg0->unk_6;
    spF0 = (arg1->y - (f32) arg0->unk_8) - (f32) arg0->unk_4;
    spF4 = arg1->z - (f32) arg0->unk_A;
    spE0 = arg2->x - (f32) arg0->unk_6;
    spE4 = (arg2->y - (f32) arg0->unk_8) - (f32) arg0->unk_4;
    sp9C = sp9C;
    spE8 = arg2->z - (f32) arg0->unk_A;
    ...
    if (!(fabsf(spD8) < 0.008f)) {
        ...
        if ((temp_f0 >= 0.0f) && (temp_f0 <= 1.0f)) {
            ...
            if (((temp_f2 * temp_f2) + (temp_f12 * temp_f12)) < temp_f14) {
                sp6C = (f32) arg0->unk_6 + temp_f2;
                sp70 = (f32) arg0->unk_8 + (f32) arg0->unk_4;
                sp74 = (f32) arg0->unk_A + temp_f12;
                phi_t0_3 = 1;
            }
        }
        temp_f10 = ((f32) arg0->unk_2 - spF0) / spD8;
        spD0 = temp_f10;
        phi_t0_2 = phi_t0_3;
        if ((temp_f10 >= 0.0f) && (temp_f10 <= 1.0f)) {
            ...
            if (((temp_f0_2 * temp_f0_2) + (temp_f2_2 * temp_f2_2)) < temp_f14) {
                sp78 = (f32) arg0->unk_6 + temp_f0_2;
                sp7C = (f32) arg0->unk_8 + (f32) arg0->unk_4 + (f32) arg0->unk_2;
                sp80 = (f32) arg0->unk_A + temp_f2_2;
                phi_t0_2 = phi_t0_3 | 2;
            }
        }
    }
...
block_44:
        phi_a2_2 = phi_a2;
        phi_a1_4 = phi_a1_3;
        if ((phi_a2 != 0) && ((temp_f0_5 = (phi_f2 * spD8) + spF0, (temp_f0_5 < 0.0f)) || ((f32) arg0->unk_2 < temp_f0_5))) {
            phi_a2_2 = 0;
        }
        if ((phi_a1_3 != 0) && ((temp_f0_6 = (spCC * spD8) + spF0, (temp_f0_6 < 0.0f)) || ((f32) arg0->unk_2 < temp_f0_6))) {
            phi_a1_4 = 0;
        }
        phi_v1_3 = 0;
        ...
        if ((phi_a2_2 != 0) && (phi_a1_4 != 0)) {
            sp24 = spD4;
            sp84 = (phi_f2 * spD4) + spEC + (f32) arg0->unk_6;
            sp20 = spEC;
            sp28 = spD8;
            sp88 = (phi_f2 * spD8) + spF0 + (f32) arg0->unk_8 + (f32) arg0->unk_4;
            sp2C = spF0;
            sp8C = (phi_f2 * spDC) + spF4 + (f32) arg0->unk_A;
            sp90 = (spCC * spD4) + sp20 + (f32) arg0->unk_6;
            sp94 = (spCC * sp28) + spF0 + (f32) arg0->unk_8 + (f32) arg0->unk_4;
            sp98 = (spCC * spDC) + spF4 + (f32) arg0->unk_A;
            phi_t0 = phi_t0_2 | 4 | 8;
        } else if (phi_a2_2 != 0) {
            sp84 = (phi_f2 * spD4) + spEC + (f32) arg0->unk_6;
            sp88 = (phi_f2 * spD8) + spF0 + (f32) arg0->unk_8 + (f32) arg0->unk_4;
            ...
            sp84 = (spCC * spD4) + spEC + (f32) arg0->unk_6;
            sp88 = (spCC * spD8) + spF0 + (f32) arg0->unk_8 + (f32) arg0->unk_4;
            sp8C = (spCC * spDC) + spF4 + (f32) arg0->unk_A;
            phi_t0 = phi_t0_2 | 4;
        }
loop_63:
        phi_v1_5 = phi_v1_3;
        if (((1 << phi_v0_3) & phi_t0) != 0) {
            if (phi_v1_3 == 0) {
                ...
                arg3->x = temp_t2->unk_0;
                arg3->y = temp_t2->unk_4;
                arg3->z = temp_t2->unk_8;
                goto block_70;
            }
            if (phi_v1_3 == 1) {
...
? func_8017F9C0(void *arg0, f32 arg1, f32 arg2) {
    ...
    temp_v0 = arg0->unk_6;
    temp_f0 = (f32) arg0->unk_0 - arg1;
    temp_f2 = (f32) arg0->unk_4 - arg2;
...
void func_8017FD44(Vec3f *arg0, void *arg1, void *arg2, f32 arg3) {
    ...
    if (!(arg3 < -1.0f) || !(arg3 > 1.0f)) {
        temp_a0 = &sp2C;
        temp_f8 = (arg0->x + arg1->unk_0) * 0.5f;
        sp2C = temp_f8;
        temp_f6 = (arg0->z + arg1->unk_8) * 0.5f;
        sp34 = temp_f6;
        temp_f2 = temp_f8 - arg0->x;
        temp_f12 = temp_f6 - arg0->z;
        sp24 = sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12));
        temp_f14 = arg0->y;
        arg2->unk_4 = (f32) (((arg1->unk_4 - temp_f14) * arg3) + temp_f14);
        temp_v0 = Math_Vec3f_Yaw((Vec3f *) temp_a0, arg0);
        sp2A = temp_v0;
        temp_f18 = (s32) (32767.0f * arg3);
        sp20 = (s32) (s16) temp_f18;
        arg2->unk_0 = (f32) ((Math_SinS((s16) ((s16) temp_f18 + temp_v0)) * sp24) + sp2C);
        arg2->unk_8 = (f32) ((Math_CosS((s16) ((s16) temp_f18 + sp2A)) * sp24) + sp34);
    }
}
