...
struct _mips2c_stack_View_ClearQuake {};            /* size 0x0 */

struct _mips2c_stack_View_GetScale {};              /* size 0x0 */

struct _mips2c_stack_View_GetViewport {};           /* size 0x0 */

struct _mips2c_stack_View_Init {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_View_InitCameraQuake {};       /* size 0x0 */

struct _mips2c_stack_View_RenderToOrthographicMatrix {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_View_RenderToPerspectiveMatrix {
    /* 0x00 */ char pad_0[0x40];
};                                                  /* size = 0x40 */

struct _mips2c_stack_View_RenderView {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_View_SetQuake {};              /* size 0x0 */

struct _mips2c_stack_View_SetQuakeRotation {};      /* size 0x0 */

struct _mips2c_stack_View_SetQuakeScale {};         /* size 0x0 */

struct _mips2c_stack_View_SetQuakeSpeed {};         /* size 0x0 */

struct _mips2c_stack_View_SetScale {};              /* size 0x0 */

struct _mips2c_stack_View_SetScissorForLetterbox {
...
struct _mips2c_stack_View_SetViewOrientation {};    /* size 0x0 */

struct _mips2c_stack_View_SetViewport {};           /* size 0x0 */

struct _mips2c_stack_View_StepQuake {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ ? sp28;                              /* inferred */
    /* 0x28 */ char pad_28[0x40];
};                                                  /* size = 0x68 */

struct _mips2c_stack_View_SyncAndWriteScissor {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ s32 sp30;                            /* inferred */
    /* 0x34 */ Gfx *sp34;                           /* inferred */
};                                                  /* size = 0x38 */

struct _mips2c_stack_View_ViewportToVp {};          /* size 0x0 */

struct _mips2c_stack_View_WriteScissor {};          /* size 0x0 */

struct _mips2c_stack_func_8013F050 {};              /* size 0x0 */

struct _mips2c_stack_func_8013F0D0 {};              /* size 0x0 */

struct _mips2c_stack_func_8013F100 {};              /* size 0x0 */

struct _mips2c_stack_func_8013F120 {};              /* size 0x0 */

struct _mips2c_stack_func_8013F15C {};              /* size 0x0 */

struct _mips2c_stack_func_8013FBC8 {
    /* 0x00 */ char pad_0[0x4C];
    /* 0x4C */ Gfx *sp4C;                           /* inferred */
    /* 0x50 */ char pad_50[0x18];
};                                                  /* size = 0x68 */

struct _mips2c_stack_func_8013FD74 {
    /* 0x00 */ char pad_0[0x64];
    /* 0x64 */ Gfx *sp64;                           /* inferred */
    /* 0x68 */ char pad_68[0x30];
};                                                  /* size = 0x98 */

struct _mips2c_stack_func_80140024 {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_801400CC {
...
s32 View_SetQuake(View *view, ? rot, ? rot_unk4, ? rot_unk8, ? scale, ? scale_unk4, ? scale_unk8, f32 speed) {
    view->quakeRot.x = rot.unk_0;
    view->quakeRot.y = rot.unk_4;
    view->quakeRot.z = rot.unk_8;
    view->quakeScale.x = scale.unk_0;
    view->quakeScale.y = scale.unk_4;
    view->quakeScale.z = scale.unk_8;
    view->quakeSpeed = speed;
    return 1;
}
...
s32 View_StepQuake(View *view, RSPMatrix *matrix) {
    ...
    SysMatrix_FromRSPMatrix(matrix, (MtxF *) &sp28);
    SysMatrix_SetCurrentState((MtxF *) &sp28);
...
s32 View_RenderToPerspectiveMatrix(View *view) {
    ...
    view->unk_50 = (u32) temp_s2->words.w0;
    view->unk_54 = (u32) temp_s2->words.w1;
    view->unk_58 = (u32) temp_s2[1].words.w0;
    view->unk_5C = (u32) temp_s2[1].words.w1;
    ...
    do {
        temp_t6 = phi_t6 + 0xC;
        temp_t7 = phi_t7 + 0xC;
        temp_t7->unk_54 = (s32) phi_t6->words.w0;
        temp_t7->unk_58 = (s32) temp_t6->unk_-8;
        temp_t7->unk_5C = (s32) temp_t6->unk_-4;
        phi_t6 = temp_t6;
        phi_t7 = temp_t7;
    } while (temp_t6 != &temp_s2_2[7].words.w1);
    ...
    do {
        ...
        temp_t5->projection.m[3][2] = temp_t4->unk_-8;
        temp_t5->projection.m[3][3] = temp_t4->unk_-4;
        phi_t4 = temp_t4;
        phi_t5 = temp_t5;
    } while (temp_t4 != &temp_s2_3[7].words.w1);
...
s32 View_RenderToOrthographicMatrix(View *view) {
    ...
    view->unk_50 = (u32) temp_s1->words.w0;
    view->unk_54 = (u32) temp_s1->words.w1;
    view->unk_58 = (u32) temp_s1[1].words.w0;
    view->unk_5C = (u32) temp_s1[1].words.w1;
    View_SetScissorForLetterbox(view);
    temp_v1 = temp_s0->polyOpa.p;
    temp_s0->polyOpa.p = &temp_v1[1];
    ...
    do {
        temp_t5 = phi_t5 + 0xC;
        temp_t6 = phi_t6 + 0xC;
        temp_t6->unk_54 = (s32) phi_t5->words.w0;
        temp_t6->unk_58 = (s32) temp_t5->unk_-8;
        temp_t6->unk_5C = (s32) temp_t5->unk_-4;
        phi_t5 = temp_t5;
        phi_t6 = temp_t6;
    } while (temp_t5 != &temp_s1_2[7].words.w1);
...
s32 func_8013FBC8(View *view) {
    ...
    do {
        temp_t9 = phi_t9 + 0xC;
        temp_t0 = phi_t0 + 0xC;
        temp_t0->unk_54 = (s32) phi_t9->words.w0;
        temp_t0->unk_58 = (s32) temp_t9->unk_-8;
        temp_t0->unk_5C = (s32) temp_t9->unk_-4;
        phi_t9 = temp_t9;
        phi_t0 = temp_t0;
    } while (temp_t9 != &temp_s2_2[7].words.w1);
...
s32 func_8013FD74(View *view) {
    ...
    do {
        temp_t1 = phi_t1 + 0xC;
        temp_t2 = phi_t2 + 0xC;
        temp_t2->unk_54 = (s32) phi_t1->words.w0;
        temp_t2->unk_58 = (s32) temp_t1->unk_-8;
        temp_t2->unk_5C = (s32) temp_t1->unk_-4;
        phi_t1 = temp_t1;
        phi_t2 = temp_t2;
    } while (temp_t1 != &temp_s2_2[7].words.w1);
    temp_t2->projection.m[0][0] = temp_t1->words.w0;
    temp_v0_3 = temp_s1->overlay.p;
    temp_s1->overlay.p = &temp_v0_3[1];
    temp_v0_3->words.w0 = 0xDB0E0000;
    temp_v0_3->words.w1 = (u32) view->normal;
    ...
    do {
        ...
        temp_t9->projection.m[3][2] = temp_t2_2->unk_-8;
        temp_t9->projection.m[3][3] = temp_t2_2->unk_-4;
        phi_t2_2 = temp_t2_2;
        phi_t9 = temp_t9;
    } while (temp_t2_2 != &temp_s2_3[7].words.w1);
    temp_t9->viewing.m[0][0] = temp_t2_2->words.w0;
    temp_v0_5 = temp_s1->overlay.p;
    temp_s1->overlay.p = &temp_v0_5[1];
...
s32 func_80140024(View *view) {
    ...
    do {
        ...
        temp_t9 = phi_t9 + 0xC;
        temp_t9->unk_-C = (s32) phi_t6->m[0][0];
        temp_t9->unk_-8 = (s32) temp_t6_2->unk_-8;
        temp_t9->unk_-4 = (s32) temp_t6_2->unk_-4;
        phi_t6 = temp_t6_2;
        phi_t9 = temp_t9;
...
s32 func_801400CC(View *view, Gfx **gfxp) {
    ...
    view->unk_50 = (u32) temp_s0->words.w0;
    view->unk_54 = (u32) temp_s0->words.w1;
    view->unk_58 = (u32) temp_s0[1].words.w0;
    view->unk_5C = (u32) temp_s0[1].words.w1;
    ...
    do {
        temp_t7 = phi_t7 + 0xC;
        temp_t8 = phi_t8 + 0xC;
        temp_t8->unk_54 = (s32) phi_t7->words.w0;
        temp_t8->unk_58 = (s32) temp_t7->unk_-8;
        temp_t8->unk_5C = (s32) temp_t7->unk_-4;
        phi_t7 = temp_t7;
        phi_t8 = temp_t8;
    } while (temp_t7 != &temp_s0_2[7].words.w1);
