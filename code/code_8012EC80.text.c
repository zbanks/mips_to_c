...
u32 gUpgradeNegMasks[];                             /* unable to generate initializer */
...
typedef struct {
    ...
    /* 0x12046 */ char pad12046[0xE];               /* maybe part of unk12044[8]? */
    /* 0x12054 */ s16 unk12054;                     /* inferred */
    /* 0x12056 */ s16 unk12056;                     /* inferred */
    /* 0x12058 */ s16 unk12058;                     /* inferred */
    /* 0x1205A */ char pad1205A[0x10];              /* maybe part of unk12058[9]? */
...
s32 func_8012EC80(GlobalContext *globalCtx) {
    ...
    if ((&gSaveContext + (phi_v1 * 4))->unk4C == 0xFF) {
    ...
    return (s32) (&gSaveContext + (phi_v1_2 * 4))->unk4C;
}
...
void func_8012F0EC(s16 arg0) {
    ...
    (&gSaveContext + (((s32) gSaveContext.day % 5) * 4))->unkE68 = (s32) gSaveContext.unk_3DE0[arg0].unk4;
    phi_v1 = 0;
    do {
        temp_v1 = phi_v1 + 1;
        (&gSaveContext + (((s32) gSaveContext.day % 5) * 8) + phi_v1)->unkD6 = (u8) gSaveContext.playerName[phi_v1];
        phi_v1 = temp_v1;
    } while ((s32) temp_v1 < 8);
}
...
void func_8012F278(GlobalContext *globalCtx) {
    gSaveContext.roomInf[127][5] = (gSaveContext.roomInf[127][5] & 0xFFFF0000) | ((((globalCtx->msgCtx.unk12054 & 0xF) << 8) | ((globalCtx->msgCtx.unk12056 & 0xF) * 0x10) | (globalCtx->msgCtx.unk12058 & 0xF)) & 0xFFFF);
}
