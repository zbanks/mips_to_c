...
static ? sHeartsDDEnv;
static s16 sHeartsDDEnvColors = {0xC8, 0, 0, 0xFF, 0, 0, 0, 0, 0xFF, 0};
static s16 sHeartsDDEnvFactors = {0, 0, 0, 0x37, 0, 0, 0xFF38, 0, 0xFF, 0};
static ? sHeartsDDPrim;
static s16 sHeartsDDPrimColors = {0xFF, 0xFF, 0xFF, 0xFF, 0xBE, 0, 0x64, 0x64, 0xFF, 0};
static s16 sHeartsDDPrimFactors = {0, 0, 0, 0, 0xFFBF, 0xFF01, 0xFF65, 0xFF65, 0, 0};
static s16 sHeartsEnvColors = {0x32, 0x28, 0x3C, 0xFF, 0, 0, 0, 0, 0xFF, 0};
static ? sHeartsEnvFactors;                         /* unable to generate initializer */
static s16 sHeartsPrimColors = {0xFF, 0x46, 0x32, 0xFF, 0xBE, 0, 0x64, 0x64, 0xFF, 0};
...
void LifeMeter_Init(GlobalContext *globalCtx) {
    ...
    sHeartsDDPrim.unk6 = 0xFF;
    sHeartsDDPrim.unk8 = 0xFF;
    sHeartsDDPrim.unkA = 0xFF;
    sHeartsDDEnv.unk6 = 0xC8;
    sHeartsDDEnv.unk8 = 0;
    sHeartsDDEnv.unkA = 0;
    sHeartsDDPrim.unk0 = (s16) sHeartsDDPrim.unk6;
    sHeartsDDPrim.unk2 = (s16) sHeartsDDPrim.unk8;
    sHeartsDDPrim.unk4 = (s16) sHeartsDDPrim.unkA;
    sHeartsDDEnv.unk0 = (s16) sHeartsDDEnv.unk6;
    sHeartsDDEnv.unk2 = (s16) sHeartsDDEnv.unk8;
    sHeartsDDEnv.unk4 = (s16) sHeartsDDEnv.unkA;
}
...
void LifeMeter_UpdateColors(GlobalContext *globalCtx) {
    ...
    temp_v0->beatingHeartPrim[0] = ((s16) (s32) ((f32) sHeartsPrimFactors.unk0 * temp_f0) + 0xFF) & 0xFF;
    temp_v0->beatingHeartPrim[1] = ((s16) (s32) ((f32) sHeartsPrimFactors.unk2 * temp_f0) + 0x46) & 0xFF;
    temp_v0->beatingHeartPrim[2] = ((s16) (s32) ((f32) sHeartsPrimFactors.unk4 * temp_f0) + 0x32) & 0xFF;
    temp_v0->beatingHeartEnv[0] = ((s16) (s32) ((f32) sHeartsEnvFactors.unk0 * temp_f0) + 0x32) & 0xFF;
    temp_v0->beatingHeartEnv[1] = ((s16) (s32) ((f32) sHeartsEnvFactors.unk2 * temp_f0) + 0x28) & 0xFF;
    temp_v0->beatingHeartEnv[2] = ((s16) (s32) ((f32) sHeartsEnvFactors.unk4 * temp_f0) + 0x3C) & 0xFF;
    sHeartsDDEnv.unk0 = 0xC8;
    sHeartsDDPrim.unk0 = 0xFF;
    sHeartsDDPrim.unk2 = 0xFF;
    sHeartsDDPrim.unk4 = 0xFF;
    sHeartsDDEnv.unk2 = 0;
    sHeartsDDEnv.unk4 = 0;
    ...
    *temp_at = *(&sHeartsDDPrimColors + 4);
    ...
    sBeatingHeartsDDPrim.unk0 = (s16) (((s16) (s32) ((f32) sHeartsDDPrimFactors * temp_f0) + 0xFF) & 0xFF);
    sBeatingHeartsDDPrim.unk2 = (s16) (((s16) (s32) ((f32) *(&sHeartsDDPrimFactors + 2) * temp_f0) + 0xFF) & 0xFF);
    sBeatingHeartsDDPrim.unk4 = (s16) (((s16) (s32) ((f32) *(&sHeartsDDPrimFactors + 4) * temp_f0) + 0xFF) & 0xFF);
    sBeatingHeartsDDEnv.unk0 = (s16) (((s16) (s32) ((f32) sHeartsDDEnvFactors * temp_f0) + 0xC8) & 0xFF);
    sBeatingHeartsDDEnv.unk2 = (s16) ((s16) (s32) ((f32) *(&sHeartsDDEnvFactors + 2) * temp_f0) & 0xFF);
    sBeatingHeartsDDEnv.unk4 = (s16) ((s16) (s32) ((f32) *(&sHeartsDDEnvFactors + 4) * temp_f0) & 0xFF);
}

? func_80100A80(void *arg0) {
    gSaveContext.health = arg0->unk16C36;
    return 1;
}
...
? func_80100AA0(void *arg0) {
    ...
    arg0->unk16C38 = 0x140;
    arg0->unk16C36 = (s16) (arg0->unk16C36 + 0x10);
    temp_v1 = gSaveContext.health;
    if ((s32) arg0->unk16C36 >= (s32) temp_v1) {
        arg0->unk16C36 = temp_v1;
        return 1;
    }
    return 0;
}
...
? func_80100AF0(void *arg0) {
    ...
    if (arg0->unk16C38 != 0) {
        ...
        temp_v0_2->unk250 = (s16) (temp_v0_2->unk250 - 1);
        goto block_4;
    }
    temp_v0->unk250 = 0x140;
    temp_v0->unk24E = (s16) (temp_v0->unk24E - 0x10);
    if ((s32) temp_v0->unk24E <= 0) {
        temp_v0->unk24E = 0;
        arg0->unk18784(-1 - gSaveContext.health);
        return 1;
    }
block_4:
    return 0;
            ...
            if ((phi_t1 < 0) || (phi_t1 < phi_s1)) {
                if (phi_s1 < phi_s3) {
                    if (phi_s2 != 0) {
                        ...
                        temp_v0_14->words.w1 = ((temp_v1_2->unk23E & 0xFF) << 8) | (temp_v1_2->unk236 << 0x18) | ((temp_v1_2->unk23A & 0xFF) << 0x10) | (temp_v1_2->unk270 & 0xFF);
                        temp_v0_15 = temp_s0->overlay.p;
                        temp_s0->overlay.p = temp_v0_15 + 8;
                        temp_v0_15->words.w0 = 0xFB000000;
                        temp_v0_15->words.w1 = ((temp_v1_2->unk24A & 0xFF) << 8) | (temp_v1_2->unk242 << 0x18) | ((temp_v1_2->unk246 & 0xFF) << 0x10) | 0xFF;
                        phi_s2 = 0;
                    }
                    ...
                    if (phi_s2 != 1) {
                        ...
                        temp_v0_17->words.w1 = ((temp_v1_3->unk22E & 0xFF) << 8) | (temp_v1_3->unk22A << 0x18) | ((temp_v1_3->unk22C & 0xFF) << 0x10) | (temp_v1_3->unk270 & 0xFF);
                        temp_v0_18 = temp_s0->overlay.p;
                        temp_s0->overlay.p = temp_v0_18 + 8;
                        temp_v0_18->words.w0 = 0xFB000000;
                        temp_v0_18->words.w1 = ((temp_v1_3->unk234 & 0xFF) << 8) | (temp_v1_3->unk230 << 0x18) | ((temp_v1_3->unk232 & 0xFF) << 0x10) | 0xFF;
                        phi_s2 = 1;
                    }
                } else if (phi_s3 < phi_s1) {
                    if (phi_s2 != 2) {
                        ...
                        temp_v0_20->words.w1 = ((temp_v1_4->unk23E & 0xFF) << 8) | (temp_v1_4->unk236 << 0x18) | ((temp_v1_4->unk23A & 0xFF) << 0x10) | (temp_v1_4->unk270 & 0xFF);
                        temp_v0_21 = temp_s0->overlay.p;
                        temp_s0->overlay.p = temp_v0_21 + 8;
                        temp_v0_21->words.w0 = 0xFB000000;
                        temp_v0_21->words.w1 = ((temp_v1_4->unk24A & 0xFF) << 8) | (temp_v1_4->unk242 << 0x18) | ((temp_v1_4->unk246 & 0xFF) << 0x10) | 0xFF;
                        phi_s2 = 2;
                    }
                } else if (phi_s2 != 3) {
                    ...
                    temp_v0_23->words.w1 = ((temp_v1_5->unk240 & 0xFF) << 8) | (temp_v1_5->unk238 << 0x18) | ((temp_v1_5->unk23C & 0xFF) << 0x10) | (temp_v1_5->unk270 & 0xFF);
                    temp_v0_24 = temp_s0->overlay.p;
                    temp_s0->overlay.p = temp_v0_24 + 8;
                    temp_v0_24->words.w0 = 0xFB000000;
                    temp_v0_24->words.w1 = ((temp_v1_5->unk24C & 0xFF) << 8) | (temp_v1_5->unk244 << 0x18) | ((temp_v1_5->unk248 & 0xFF) << 0x10) | 0xFF;
                    phi_s2 = 3;
                }
                if (phi_s1 < phi_s3) {
                ...
                if (phi_s1 < phi_s3) {
                    if (phi_s2 != 4) {
                        ...
                        temp_v0_2->words.w1 = ((sHeartsDDPrim.unk4 & 0xFF) << 8) | (sHeartsDDPrim.unk0 << 0x18) | ((sHeartsDDPrim.unk2 & 0xFF) << 0x10) | ((phi_t0 + 0x169E8)->unk270 & 0xFF);
                        temp_v0_3 = temp_s0->overlay.p;
                        temp_s0->overlay.p = temp_v0_3 + 8;
                        temp_v0_3->words.w0 = 0xFB000000;
                        temp_v0_3->words.w1 = ((sHeartsDDEnv.unk4 & 0xFF) << 8) | (sHeartsDDEnv.unk0 << 0x18) | ((sHeartsDDEnv.unk2 & 0xFF) << 0x10) | 0xFF;
                        phi_s2 = 4;
                    }
                } else if (phi_s3 == phi_s1) {
                    if (phi_s2 != 5) {
                        ...
                        temp_v0_5->words.w1 = ((sBeatingHeartsDDPrim.unk4 & 0xFF) << 8) | (sBeatingHeartsDDPrim.unk0 << 0x18) | ((sBeatingHeartsDDPrim.unk2 & 0xFF) << 0x10) | ((phi_t0 + 0x169E8)->unk270 & 0xFF);
                        temp_v0_6 = temp_s0->overlay.p;
                        temp_s0->overlay.p = temp_v0_6 + 8;
                        temp_v0_6->words.w0 = 0xFB000000;
                        temp_v0_6->words.w1 = ((sBeatingHeartsDDEnv.unk4 & 0xFF) << 8) | (sBeatingHeartsDDEnv.unk0 << 0x18) | ((sBeatingHeartsDDEnv.unk2 & 0xFF) << 0x10) | 0xFF;
                        phi_s2 = 5;
                    }
                } else if (phi_s3 < phi_s1) {
                    if (phi_s2 != 6) {
                        ...
                        temp_v0_8->words.w1 = ((sHeartsDDPrim.unk4 & 0xFF) << 8) | (sHeartsDDPrim.unk0 << 0x18) | ((sHeartsDDPrim.unk2 & 0xFF) << 0x10) | ((phi_t0 + 0x169E8)->unk270 & 0xFF);
                        temp_v0_9 = temp_s0->overlay.p;
                        temp_s0->overlay.p = temp_v0_9 + 8;
                        temp_v0_9->words.w0 = 0xFB000000;
                        temp_v0_9->words.w1 = ((sHeartsDDEnv.unk4 & 0xFF) << 8) | (sHeartsDDEnv.unk0 << 0x18) | ((sHeartsDDEnv.unk2 & 0xFF) << 0x10) | 0xFF;
                        phi_s2 = 6;
                    }
                } else if (phi_s2 != 7) {
                    ...
                    temp_v0_11->words.w1 = ((sHeartsDDPrim.unkA & 0xFF) << 8) | (sHeartsDDPrim.unk6 << 0x18) | ((sHeartsDDPrim.unk8 & 0xFF) << 0x10) | ((phi_t0 + 0x169E8)->unk270 & 0xFF);
                    temp_v0_12 = temp_s0->overlay.p;
                    temp_s0->overlay.p = temp_v0_12 + 8;
                    temp_v0_12->words.w0 = 0xFB000000;
                    temp_v0_12->words.w1 = ((sHeartsDDEnv.unkA & 0xFF) << 8) | (sHeartsDDEnv.unk6 << 0x18) | ((sHeartsDDEnv.unk8 & 0xFF) << 0x10) | 0xFF;
                    phi_s2 = 7;
                }
                if (phi_s1 < phi_s3) {
