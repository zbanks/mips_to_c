struct _mips2c_stack_Font_LoadChar {};              /* size 0x0 */

struct _mips2c_stack_Font_LoadCharNES {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Font_LoadMessageBoxEndIcon {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_Font_LoadOrderedFont {
