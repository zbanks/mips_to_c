    ...
    if ((collider->unk2E & 0x80) != 0) {
        ...
        if (temp_v0 != 0) {
            ...
            if ((temp_v0->toucherFlags & 0x40) == 0) {
                ...
                CollisionCheck_HitEffects(globalCtx, collider->unk34, collider->unk3C, collider, (ColliderInfo *) (collider + 0x18), (Vec3f *) &sp28);
