struct _mips2c_stack_func_80178750 {};              /* size 0x0 */

struct _mips2c_stack_func_80178818 {
    /* 0x00 */ char pad_0[0x40];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80178978 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_801789D4 {};              /* size 0x0 */

struct _mips2c_stack_func_80178A24 {};              /* size 0x0 */

struct _mips2c_stack_func_80178A34 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80178A94 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80178AC0 {
    /* 0x00 */ char pad_0[0x4];
    /* 0x04 */ u16 sp4;                             /* inferred */
    /* 0x06 */ char pad_6[0x2];
...
struct _mips2c_stack_func_80178C80 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ s32 sp24;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80178D7C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80178DAC {
...
struct _mips2c_stack_func_80178E3C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80178E7C {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_get_framebuffer {};            /* size 0x0 */

struct _mips2c_stack_get_zbuffer {};                /* size 0x0 */
...
void func_80178C80(u32 arg0, s32 arg1, u32 *arg2, s32 *arg3, s32 *arg4) {
    ...
    if ((u32) (temp_v1 - 4) < temp_v0) {
        ...
        *arg2 = arg0 + temp_v1;
        *arg3 = D_801FBBE0.unk_0;
    } else {
        sp24 = temp_v1;
        DmaMgr_DMARomToRam(temp_v0 + arg0, &D_801FBBE0, 8U);
        *arg2 = D_801FBBE0.unk_0 + arg0 + temp_v1;
        *arg3 = D_801FBBE0.unk_4 - D_801FBBE0.unk_0;
    }
    *arg4 = 0;
}
