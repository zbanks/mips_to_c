struct _mips2c_stack_func_80142440 {
    ...
    /* 0x044 */ char pad44[0xE0];                   /* maybe part of sp40[57]? */
    /* 0x124 */ ? sp124;                            /* inferred */
    /* 0x124 */ char pad124[0x64];
    /* 0x188 */ s32 sp188;                          /* inferred */
    /* 0x18C */ char pad18C[0x60];                  /* maybe part of sp188[25]? */
    /* 0x1EC */ ? sp1EC;                            /* inferred */
    /* 0x1EC */ char pad1EC[0x64];
    /* 0x250 */ ? sp250;                            /* inferred */
    /* 0x250 */ char pad250[0x64];
    /* 0x2B4 */ ? sp2B4;                            /* inferred */
    /* 0x2B4 */ char pad2B4[0x6A];
    /* 0x31E */ s16 sp31E;                          /* inferred */
    /* 0x320 */ s16 sp320;                          /* inferred */
    /* 0x322 */ char pad322[0x16];
};                                                  /* size = 0x338 */
...
s32 func_80142440(SkyboxContext *skyboxCtx, Vtx *vtx, s32 arg2, s32 arg3, s32 arg4, s32 arg5, s32 arg6, s32 arg7, s32 arg8) {
    ...
    case 1:
        ...
        do {
            ...
            *phi_t0 = *D_801C5E88;
            ...
            phi_a3->unk8 = phi_t2;
            phi_a3->unk4 = phi_t2;
            phi_a2->unk10 = (s32) (temp_v0_2 + arg6);
            phi_a1->unk10 = arg5;
            phi_a1->unkC = arg5;
            phi_a1->unk8 = arg5;
            temp_a1 = phi_a1 + 0x14;
            ...
            temp_t0->unk-8 = (s32) temp_v1->unk8;
            temp_t0->unk-C = (s32) temp_v1->unk4;
            temp_t0->unk-4 = (s32) temp_v1->unkC;
            temp_t0->unk-10 = (s32) temp_v1->unk0;
            phi_a1 = temp_a1;
            phi_a2 = temp_a2;
            phi_t2 += arg7;
            phi_a3 += 0x14;
    ...
    case 3:
        ...
        do {
            ...
            *phi_t0_2 = *D_801C5E88;
            ...
            phi_a1_2->unk10 = (s32) (temp_v0_4 + arg6);
            phi_a2_2->unk10 = arg3;
            phi_a2_2->unkC = arg3;
            phi_a2_2->unk8 = arg3;
            ...
            temp_t0_2->unk-8 = (s32) temp_v1_2->unk8;
            temp_t0_2->unk-C = (s32) temp_v1_2->unk4;
            temp_t0_2->unk-4 = (s32) temp_v1_2->unkC;
            temp_t0_2->unk-10 = (s32) temp_v1_2->unk0;
            phi_a2_2 = temp_a2_2;
            phi_t2_2 += arg7;
            phi_a3_2 += 0x14;
            phi_a1_2 = temp_a1_2;
    ...
    case 5:
        ...
        do {
            ...
            *phi_t0_3 = *D_801C5E88;
            ...
            phi_a2_3->unk10 = (s32) (temp_v0_6 + arg6);
            phi_a3_3->unk10 = arg4;
            phi_a3_3->unkC = arg4;
            phi_a3_3->unk8 = arg4;
            ...
            temp_t0_3->unk-8 = (s32) temp_v1_3->unk8;
            temp_t0_3->unk-C = (s32) temp_v1_3->unk4;
            temp_t0_3->unk-4 = (s32) temp_v1_3->unkC;
            temp_t0_3->unk-10 = (s32) temp_v1_3->unk0;
            phi_a3_3 = temp_a3;
            phi_a2_3 = temp_a2_3;
            phi_t2_3 += arg7;
            phi_a1_3 += 0x14;
    ...
    do {
        ...
        temp_a1_3->unk-E = (s16) *(&sp250 + temp_a2_4);
        temp_a1_3->unk-A = 0;
        temp_a1_3->unk-C = (s16) *(&sp1EC + temp_a2_4);
        temp_a1_3->unk-8 = (s16) *(&sp188 + temp_a2_4);
        temp_a1_3->unk-3 = 0;
        temp_a1_3->unk-2 = 0;
        temp_a1_3->unk-4 = 0xFF;
        temp_a1_3->unk-6 = (s16) *(&sp124 + temp_a2_4);
        phi_a0_4 += 2;
        phi_a1_4 = temp_a1_3;
        phi_v0 = temp_v0_7;
    } while (temp_v0_7 != 0x20);
    temp_v1_4 = skyboxCtx->unk180;
    skyboxCtx->unk180 = temp_v1_4 + 8;
    temp_v1_4->words.w0 = 0x1020040;
    temp_v1_4->words.w1 = (u32) &vtx[arg2];
    arg2 += temp_v0_7;
    temp_v1_5 = skyboxCtx->unk180;
    skyboxCtx->unk180 = temp_v1_5 + 8;
