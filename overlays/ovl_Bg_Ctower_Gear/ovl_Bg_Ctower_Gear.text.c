...
struct _mips2c_stack_BgCtowerGear_Splash {
    ...
    /* 0x68 */ char pad68[0x8];                     /* maybe part of sp66[5]? */
...
void BgCtowerGear_Init(BgCtowerGear *this, GlobalContext *globalCtx) {
    s32 temp_s1;
...
void BgCtowerGear_Destroy(BgCtowerGear *this, GlobalContext *globalCtx) {
    s32 temp_v0;
    BgCtowerGear *this = (BgCtowerGear *) thisx;
...
void BgCtowerGear_Update(BgCtowerGear *this, GlobalContext *globalCtx) {
    s32 temp_v0;
    BgCtowerGear *this = (BgCtowerGear *) thisx;
...
void BgCtowerGear_UpdateOrgan(BgCtowerGear *this, GlobalContext *globalCtx) {
...
void BgCtowerGear_Draw(BgCtowerGear *this, GlobalContext *globalCtx) {
    BgCtowerGear *this = (BgCtowerGear *) thisx;
    func_800BDFC0(globalCtx, *(&D_80AD32E8 + ((this->dyna.actor.params & 3) * 4)));
}

void BgCtowerGear_DrawOrgan(BgCtowerGear *this, GlobalContext *globalCtx) {
    Gfx *sp2C;
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
