...
void EnMaYts_Destroy(EnMaYts *this, GlobalContext *globalCtx) {
    EnMaYts *this = (EnMaYts *) thisx;
...
void EnMaYts_Update(EnMaYts *this, GlobalContext *globalCtx) {
...
void EnMaYts_Draw(EnMaYts *this, GlobalContext *globalCtx) {
...
void EnMaYts_DrawSleeping(EnMaYts *this, GlobalContext *globalCtx) {
