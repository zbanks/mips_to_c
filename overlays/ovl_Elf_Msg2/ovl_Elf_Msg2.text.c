...
static InitChainEntry D_8096F0B0;                   /* unable to generate initializer */



void ElfMsg2_SetupAction(ElfMsg2 *this, void (*actionFunc)(ElfMsg2 *, GlobalContext *)) {
    ElfMsg2 *self = (ElfMsg2 *) this;
