typedef struct BgSpdweb {
    ...
    /* 0x160 */ u8 unk160;                          /* inferred */
    /* 0x161 */ u8 unk161;                          /* inferred */
    /* 0x162 */ s16 unk162;                         /* inferred */
    /* 0x164 */ f32 unk164;                         /* inferred */
    /* 0x168 */ ColliderTris unk168;                /* inferred */
    /* 0x188 */ ColliderTrisElement unk188;         /* inferred */
    /* 0x1E4 */ char pad1E4[0x114];                 /* maybe part of unk188[4]? */
...
struct _mips2c_stack_func_809CE4C8 {
    ...
    /* 0x28 */ char pad28[0x12];                    /* maybe part of sp24[5]? */
...
struct _mips2c_stack_func_809CE830 {
    ...
    /* 0xA8 */ char padA8[0x8];                     /* maybe part of spA4[3]? */
    /* 0xB0 */ f32 spB0;                            /* inferred */
...
void BgSpdweb_Init(BgSpdweb *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.params == 0) {
        Collider_InitAndSetTris(globalCtx, &this->unk168, (Actor *) this, &D_809CF0F8, &this->unk188);
        func_809CE068(this);
        ...
        Collider_InitAndSetTris(globalCtx, &this->unk168, (Actor *) this, &D_809CF1F8, &this->unk188);
        func_809CE068(this);
...
void BgSpdweb_Destroy(BgSpdweb *this, GlobalContext *globalCtx) {
...
block_32:
    ...
    func_809CE15C(arg0);
    CollisionCheck_SetAC(arg1, &arg1->colChkCtx, (Collider *) &arg0->unk168);
}
...
void BgSpdweb_Update(BgSpdweb *this, GlobalContext *globalCtx) {
    BgSpdweb *this = (BgSpdweb *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgSpdweb_Draw(BgSpdweb *this, GlobalContext *globalCtx) {
