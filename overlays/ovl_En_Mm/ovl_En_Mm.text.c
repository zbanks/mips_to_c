...
static InitChainEntry D_8096636C;                   /* unable to generate initializer */
...
typedef struct EnMm {
    ...
    /* 0x0194 */ void (*actionFunc)(EnMm *, GlobalContext *);
} EnMm;                                             /* size 0x198 */
...
void EnMm_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80966340);
...
void func_80965D3C(EnMm *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(temp_a0) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields(sp1E, &this->actor);
    ...
    if (Actor_HasParent(&this->actor, globalCtx) != 0) {
        ...
        if ((this->actor.bgCheckFlags & 1) == 0) {
            ...
            if (Math_StepToF(&this->actor.speedXZ, 0.0f, 1.0f) == 0) {
                ...
                this->unk190 += (s32) (this->actor.speedXZ * 800.0f);
            }
...
void func_8096611C(EnMm *this, GlobalContext *globalCtx) {
    ...
    Math_ScaledStepToS(&this->unk190, 0, 0x7D0);
}

void EnMm_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnMm *this = (EnMm *) thisx;
    Collider_ResetCylinderAC(globalCtx, &this->unk144.base);
    this->actionFunc(this, globalCtx);
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 10.0f, 20.0f, 0x1FU);
...
void EnMm_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk190 != 0) {
        ...
        SysMatrix_InsertXRotation_s(this->unk190, 1);
