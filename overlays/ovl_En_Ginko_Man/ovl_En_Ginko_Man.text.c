...
void EnGinkoMan_SetupIdle(EnGinkoMan *this) {
    EnGinkoMan *self = (EnGinkoMan *) this;
    EnGinkoMan *temp_a3;
    ...
    self->actionFunc = EnGinkoMan_Idle;
}
...
void EnGinkoMan_Idle(EnGinkoMan *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = self->actor.yawTowardsPlayer - self->actor.shape.rot.y;
    sp24 = temp_v1;
    EnGinkoMan_SwitchAnimation(self, globalCtx);
    if (func_800B84D0(&self->actor, globalCtx) != 0) {
        if ((gSaveContext.roomInf[127][0] & 0xFFFF) == 0) {
            func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 0);
            func_801518B0(globalCtx, 0x44CU, &self->actor);
            self->curTextId = 0x44C;
        } else {
            func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 1);
            if ((((s32) gSaveContext.day % 5) == 3) && (gSaveContext.isNight == 1)) {
                func_801518B0(globalCtx, 0x467U, &self->actor);
                self->curTextId = 0x467;
            } else {
                func_801518B0(globalCtx, 0x466U, &self->actor);
                self->curTextId = 0x466;
            }
        }
        EnGinkoMan_SetupDialogue(self);
        return;
    }
    phi_v0 = temp_v1;
    if (temp_v1 < 0) {
...
void EnGinkoMan_DepositDialogue(EnGinkoMan *this, GlobalContext *globalCtx) {
    ...
    if (func_80147624(temp_a0) != 0) {
        temp_v0 = self->curTextId;
        switch (temp_v0) {
        case 1100:
            globalCtx = temp_a3;
            func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 1);
            if ((gSaveContext.weekEventReg[10] & 8) != 0) {
                func_801518B0(globalCtx, 0x44EU, &self->actor);
                self->curTextId = 0x44E;
                return;
            }
            func_801518B0(globalCtx, 0x44DU, &self->actor);
            self->curTextId = 0x44D;
            return;
        case 1101:
            func_801518B0(temp_a3, 0x44EU, &self->actor);
            self->curTextId = 0x44E;
            return;
        case 1103:
            globalCtx = temp_a3;
            func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 0);
            func_801518B0(globalCtx, 0x450U, &self->actor);
            self->curTextId = 0x450;
            return;
        case 1107:
        case 1108:
        case 1109:
            if (self->isNewAccount == 1) {
                self->isNewAccount = 0;
                if (temp_v0 != 0x453) {
                    globalCtx = temp_a3;
                    func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 1);
                ...
                func_801518B0(phi_a3, 0x461U, &self->actor);
                phi_t6_2 = 0x461;
block_63:
                self->curTextId = phi_t6_2;
            ...
            func_801518B0(phi_a3_2, 0x45AU, &self->actor);
            self->curTextId = 0x45A;
            return;
        case 1110:
        case 1113:
            func_801518B0(temp_a3, 0x44EU, &self->actor);
        ...
        case 1114:
            ...
            if ((temp_v1 >= 0xC8U) && ((s32) self->previousBankValue < 0xC8) && (temp_v0_2 = gSaveContext.weekEventReg[59], ((temp_v0_2 & 0x40) == 0))) {
                gSaveContext.weekEventReg[59] = temp_v0_2 | 0x40;
                func_801518B0(temp_a3, 0x45BU, &self->actor);
                phi_t6_2 = 0x45B;
                goto block_63;
            }
            if ((temp_v1 >= 0x3E8U) && ((s32) self->previousBankValue < 0x3E8) && (temp_v0_3 = gSaveContext.weekEventReg[59], ((temp_v0_3 & 0x80) == 0))) {
                gSaveContext.weekEventReg[59] = temp_v0_3 | 0x80;
                func_801518B0(temp_a3, 0x45CU, &self->actor);
                self->curTextId = 0x45C;
                return;
            }
            if (temp_v1 >= 0x1388U) {
                temp_v0_4 = self->previousBankValue;
                if (((s32) temp_v0_4 < 0x1388) && (temp_t0 = gSaveContext.weekEventReg[60], ((temp_t0 & 1) == 0))) {
                    gSaveContext.weekEventReg[60] = temp_t0 | 1;
                    func_801518B0(temp_a3, 0x45DU, &self->actor);
                    self->curTextId = 0x45D;
                    return;
                }
                if ((s32) temp_v0_4 < (s32) (s16) temp_v1) {
                    globalCtx = temp_a3;
                    func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 1);
                    func_801518B0(globalCtx, 0x45EU, &self->actor);
                    self->curTextId = 0x45E;
                    return;
                }
                globalCtx = temp_a3;
                func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 0);
                func_801518B0(globalCtx, 0x460U, &self->actor);
                self->curTextId = 0x460;
                return;
            }
            globalCtx = temp_a3;
            func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 0);
        ...
        case 1116:
        case 1117:
            self->isStampChecked = 0;
            globalCtx = temp_a3;
            func_801477B4(temp_a3);
            EnGinkoMan_SetupBankAward(self);
            EnGinkoMan_BankAward(self, globalCtx);
            return;
        case 1121:
            func_801518B0(temp_a3, 0x462U, &self->actor);
            self->curTextId = 0x462;
            return;
        case 1122:
            func_801518B0(temp_a3, 0x463U, &self->actor);
            self->curTextId = 0x463;
            return;
        case 1123:
            func_801518B0(temp_a3, 0x464U, &self->actor);
            self->curTextId = 0x464;
            return;
        case 1124:
            temp_a3->msgCtx.unk11F22 = 0x44;
            EnGinkoMan_SetupStamp(self);
            return;
        case 1125:
            globalCtx = temp_a3;
            func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 0);
            globalCtx->msgCtx.bankRupees = gSaveContext.roomInf[127][0] & 0xFFFF;
            func_801518B0(globalCtx, 0x45AU, &self->actor);
            self->curTextId = 0x45A;
            return;
        case 1126:
        case 1127:
            func_801518B0(temp_a3, 0x468U, &self->actor);
            self->curTextId = 0x468;
            return;
        case 1129:
            EnGinkoMan_SetupStamp(self);
            return;
        ...
        case 1132:
        case 1150:
            if (self->choiceDepositWithdrawl == 0) {
                if ((u32) (gSaveContext.roomInf[127][0] & 0xFFFF) >= 0x1388U) {
                    func_801518B0(temp_a3, 0x45FU, &self->actor);
                    phi_t6 = 0x45F;
                    goto block_50;
                }
                if (gSaveContext.rupees == 0) {
                    func_801518B0(temp_a3, 0x458U, &self->actor);
                    self->curTextId = 0x458;
                } else {
                    func_801518B0(temp_a3, 0x479U, &self->actor);
                    self->curTextId = 0x479;
                }
            } else if ((((s32) gSaveContext.day % 5) == 3) && (gSaveContext.isNight == 1)) {
                func_801518B0(temp_a3, 0x46DU, &self->actor);
                self->curTextId = 0x46D;
            } else {
                func_801518B0(temp_a3, 0x46BU, &self->actor);
                phi_t6 = 0x46B;
block_50:
                self->curTextId = phi_t6;
            }
            self->choiceDepositWithdrawl = 0;
            return;
        case 1131:
            func_801518B0(temp_a3, 0x46EU, &self->actor);
            self->curTextId = 0x46E;
            return;
        case 1133:
            func_801518B0(temp_a3, 0x46BU, &self->actor);
            self->curTextId = 0x46B;
            return;
        case 1136:
            globalCtx = temp_a3;
        ...
        case 1148:
        case 1149:
            func_801518B0(phi_a3_3, 0x468U, &self->actor);
            self->curTextId = 0x468;
            return;
        case 1138:
        case 1139:
        case 1140:
            ...
            if (temp_v1_2 == 0) {
                func_801518B0(temp_a3, 0x478U, &self->actor);
                self->curTextId = 0x478;
                return;
            }
            temp_a3->msgCtx.bankRupees = temp_v1_2;
            func_801518B0(temp_a3, 0x45AU, &self->actor);
            self->curTextId = 0x45A;
            return;
        case 1143:
            globalCtx = temp_a3;
            func_801518B0(temp_a3, 0x471U, &self->actor);
            self->curTextId = 0x471;
            self->serviceFee = (s16) globalCtx->msgCtx.unk1206C;
            return;
        case 1145:
            func_801518B0(temp_a3, 0x44FU, &self->actor);
            phi_t6_2 = 0x44F;
            goto block_63;
        }
    } else {
...
void EnGinkoMan_SetupDialogue(EnGinkoMan *this) {
    EnGinkoMan *self = (EnGinkoMan *) this;
    self->actionFunc = EnGinkoMan_Dialogue;
}
...
void EnGinkoMan_Dialogue(EnGinkoMan *this, GlobalContext *globalCtx) {
    ...
    case 2:
        ...
        break;
    case 4:
        EnGinkoMan_WaitForDialogueInput(&self->actor, globalCtx);
        break;
    case 5:
        EnGinkoMan_DepositDialogue(self, globalCtx);
        break;
    case 6:
        ...
        break;
    case 14:
        EnGinkoMan_WaitForRupeeCount(&self->actor, globalCtx);
        break;
    }
    if ((&D_060008C0 == self->skelAnime.animCurrentSeg) && (func_801378B8(&self->skelAnime, self->skelAnime.animFrameCount) != 0)) {
        Audio_PlayActorSound2(&self->actor, 0x2992U);
    }
}

void EnGinkoMan_SetupBankAward(EnGinkoMan *this) {
    EnGinkoMan *self = (EnGinkoMan *) this;
    self->actionFunc = EnGinkoMan_BankAward;
}
...
void EnGinkoMan_BankAward(EnGinkoMan *this, GlobalContext *globalCtx) {
    ...
    if (Actor_HasParent(&self->actor, globalCtx) != 0) {
        ...
        EnGinkoMan_SetupBankAward2(self);
        return;
    }
    temp_v0 = self->curTextId;
    if (temp_v0 == 0x45B) {
        if ((gSaveContext.weekEventReg[10] & 8) == 0) {
            func_800B8A1C(&self->actor, globalCtx, ((u32) (gSaveContext.inventory.upgrades & *(gUpgradeMasks + 0x10)) >> gUpgradeShifts[4]) + 8, 500.0f, 100.0f);
            return;
        }
        func_800B8A1C(&self->actor, globalCtx, 2, 500.0f, 100.0f);
        return;
    }
    if (temp_v0 == 0x45C) {
        func_800B8A1C(&self->actor, globalCtx, 2, 500.0f, 100.0f);
    ...
    if ((gSaveContext.weekEventReg[59] & 8) == 0) {
        func_800B8A1C(&self->actor, globalCtx, 0xC, 500.0f, 100.0f);
        return;
    }
    func_800B8A1C(&self->actor, globalCtx, 2, 500.0f, 100.0f);
}
...
void EnGinkoMan_SetupBankAward2(EnGinkoMan *this) {
    EnGinkoMan *self = (EnGinkoMan *) this;
    self->actionFunc = EnGinkoMan_BankAward2;
}
...
void EnGinkoMan_BankAward2(EnGinkoMan *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&self->actor, globalCtx) != 0) {
        ...
        if (((temp_v0 & 8) == 0) && (self->curTextId == 0x45B)) {
            gSaveContext.weekEventReg[10] = temp_v0 | 8;
            func_801518B0(globalCtx, 0x47AU, &self->actor);
            self->curTextId = 0x47A;
        } else {
            func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 1);
            func_801518B0(globalCtx, 0x47BU, &self->actor);
            self->curTextId = 0x47B;
        }
        EnGinkoMan_SetupDialogue(self);
        return;
    }
    if (self->curTextId == 0x45D) {
    ...
    func_800B85E0(&self->actor, globalCtx, 500.0f, -1);
}

void EnGinkoMan_SetupStamp(EnGinkoMan *this) {
    EnGinkoMan *self = (EnGinkoMan *) this;
    func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &animations, 2);
    self->actionFunc = EnGinkoMan_Stamp;
}
...
void EnGinkoMan_Stamp(EnGinkoMan *this, GlobalContext *globalCtx) {
    ...
    if ((self->curTextId == 0x464) && (func_801378B8(&self->skelAnime, 10.0f) != 0)) {
        Audio_PlayActorSound2(&self->actor, 0x2993U);
    }
    temp_a0 = &self->skelAnime;
    sp20 = temp_a0;
    if (func_801378B8(temp_a0, self->skelAnime.animFrameCount) != 0) {
        temp_v0 = self->curTextId;
        if (temp_v0 != 0x464) {
            if (temp_v0 != 0x469) {
                ...
                globalCtx->msgCtx.bankRupees = gSaveContext.roomInf[127][0] & 0xFFFF;
                if ((((s32) gSaveContext.day % 5) == 3) && (gSaveContext.isNight == 1)) {
                    func_801518B0(globalCtx, 0x46CU, &self->actor);
                    self->curTextId = 0x46C;
                } else {
                    func_801518B0(globalCtx, 0x46AU, &self->actor);
                    self->curTextId = 0x46A;
                }
            }
        } else {
            func_800BDC5C(temp_a0, (ActorAnimationEntry []) &animations, 1);
            func_801518B0(globalCtx, 0x465U, &self->actor);
            self->curTextId = 0x465;
        }
        EnGinkoMan_SetupDialogue(self);
    }
}
...
void EnGinkoMan_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    EnGinkoMan_FacePlayer(&this->actor, globalCtx);
}
...
void EnGinkoMan_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnGinkoMan_OverrideLimbDraw, EnGinkoMan_PostLimbDraw, &this->actor);
}
