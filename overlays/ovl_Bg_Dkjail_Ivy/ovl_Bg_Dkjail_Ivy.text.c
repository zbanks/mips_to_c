typedef struct BgDkjailIvy {
    ...
    /* 0x1AC */ char pad1AC[0x1];
    /* 0x1AD */ u8 unk1AD;                          /* inferred */
...
void BgDkjailIvy_Init(BgDkjailIvy *this, GlobalContext *globalCtx) {
...
void BgDkjailIvy_Destroy(BgDkjailIvy *this, GlobalContext *globalCtx) {
...
void BgDkjailIvy_Update(BgDkjailIvy *this, GlobalContext *globalCtx) {
    BgDkjailIvy *this = (BgDkjailIvy *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgDkjailIvy_Draw(BgDkjailIvy *this, GlobalContext *globalCtx) {
