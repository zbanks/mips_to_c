...
struct _mips2c_stack_EnMinifrog_SetCamera {
    ...
    /* 0xB0 */ char padB0[0xC];                     /* maybe part of spAC[4]? */
...
void EnMinifrog_Init(EnMinifrog *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    u16 temp_v1;
    u16 temp_v1_2;
    void **temp_s0;
...
void EnMinifrog_Destroy(EnMinifrog *this, GlobalContext *globalCtx) {
    EnMinifrog *this = (EnMinifrog *) thisx;
...
void EnMinifrog_SetCamera(Actor *arg0, GlobalContext *arg1) {
    ...
    sp88.unk0 = (s32) temp_t9->unk5C;
    sp88.unk4 = (s32) temp_t9->unk60;
    sp88.unk8 = (s32) temp_t9->unk64;
...
void EnMinifrog_Update(EnMinifrog *this, GlobalContext *globalCtx) {
...
void EnMinifrog_UpdateMissingFrog(EnMinifrog *this, GlobalContext *globalCtx) {
    EnMinifrog *temp_v0;
    EnMinifrog *this = (EnMinifrog *) thisx;
...
void EnMinifrog_Draw(EnMinifrog *this, GlobalContext *globalCtx) {
