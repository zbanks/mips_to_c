...
static void *D_808A4D74 = {(void *)0x60059A0, (void *)0x6005BA0};
...
EnMinifrog *EnMinifrog_GetFrog(GlobalContext *globalCtx) {
    EnMinifrog *self = (EnMinifrog *) globalCtx;
    EnMinifrog *temp_v1;
    EnMinifrog *temp_v1_2;
    EnMinifrog *phi_v1;

    temp_v1 = self->unk1CE4;
    phi_v1 = temp_v1;
    if (temp_v1 != 0) {
loop_1:
...
void EnMinifrog_JumpTimer(Actor *arg0) {
    ...
    temp_v0 = arg0->unk2B4;
    if ((s32) temp_v0 > 0) {
        arg0->unk2B4 = (s16) (temp_v0 - 1);
        return;
    }
    arg0->unk2B4 = (s16) ((s32) Rand_ZeroFloat(40.0f) + 0x3C);
...
void EnMinifrog_ReturnFrogCutscene(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((func_80152498(arg1 + 0x4908) == 5) && (func_80147624(arg1) != 0)) {
        ...
        case 3458:
            ...
            temp_t3 = *(&D_808A4D7C + (arg0->unk2B0 * 2));
...
block_13:
        if ((arg0->unk2B6 & 1) != 0) {
            ...
            if (ActorCutscene_GetCanPlayNext((s16) arg0->cutscene) != 0) {
                ...
                arg0->unk2B6 = (u16) (arg0->unk2B6 & 0xFFFE);
                return;
            }
            ActorCutscene_SetIntentToPlay((s16) arg0->cutscene);
...
void EnMinifrog_SpawnGrowAndShrink(EnMinifrog *this, GlobalContext *globalCtx) {
    EnMinifrog *self = (EnMinifrog *) this;
    s16 temp_v0;

    EnMinifrog_Jump(&self->actor);
    temp_v0 = self->timer;
    if ((s32) temp_v0 > 0) {
        Actor_SetScale(&self->actor, (Math_SinS((s16) ((temp_v0 & 7) << 0xC)) * (0.0003f * (f32) self->timer)) + 0.01f);
        self->timer += -1;
        return;
    }
    Actor_SetScale(&self->actor, 0.01f);
    self->actionFunc = EnMinifrog_Idle;
}

void EnMinifrog_Idle(EnMinifrog *this, GlobalContext *globalCtx) {
    EnMinifrog *self = (EnMinifrog *) this;
    EnMinifrog_TurnToPlayer(&self->actor);
    EnMinifrog_Jump(&self->actor);
    EnMinifrog_JumpTimer(&self->actor);
    if (func_800B84D0(&self->actor, globalCtx) != 0) {
        self->actionFunc = (void (*)(EnMinifrog *, GlobalContext *)) EnMinifrog_ReturnFrogCutscene;
        if (self->actor.cutscene != -1) {
            self->flags |= 1;
            return;
        }
        // Duplicate return node #7. Try simplifying control flow for better match
    ...
    if ((self->actor.xzDistToPlayer < 100.0f) && (Actor_IsLinkFacingActor(&self->actor, 0x3000, globalCtx) != 0) && (Player_GetMask(globalCtx) == 0xD)) {
        func_800B8614(&self->actor, globalCtx, 110.0f);
    }
}
...
void EnMinifrog_SetupNextFrogInit(EnMinifrog *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 != 0) {
        ...
        if (temp_a1 != 0) {
            self->actor.home.rot.y = Actor_YawBetweenActors(&self->actor, &temp_a1->actor);
            EnMinifrog_TurnToMissingFrog(self);
        } else {
            EnMinifrog_TurnToPlayer(&self->actor, temp_a1);
        }
        if ((self->actor.params & 0xF) == self->frog->actor.home.rot.z) {
            EnMinifrog_SetJumpState(&self->actor);
            self->frog->actor.home.rot.z = 0;
        }
    }
}
...
void EnMinifrog_CheckChoirSuccess(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk2A8 = EnMinifrog_YellowFrogDialog;
    if (arg0->unk2AC != 0) {
        arg0 = arg0;
...
void EnMinifrog_NextFrogMissing(Actor *arg0, void *arg1) {
    ...
    arg0->unk2A8 = EnMinifrog_ContinueChoirCutscene;
}
...
void EnMinifrog_NextFrogReturned(Actor *arg0, void *arg1) {
    ...
    arg0->unk2A8 = EnMinifrog_ContinueChoirCutscene;
    arg0->unk2B6 = (u16) (arg0->unk2B6 & 0xFFC1);
    arg1->unk18798(arg1, &D_0400DEA8, 0, arg0);
}
...
void EnMinifrog_SetupNextFrogChoir(Actor *arg0, void *arg1) {
    ...
    if (temp_v0 != 0xFF) {
        ...
        temp_v0_2 = arg0->unk2B6;
        temp_v1 = 2 << (temp_v0 & 0xFF);
        if ((temp_v0_2 & temp_v1) == 0) {
            arg0->unk2B6 = (u16) (temp_v0_2 | temp_v1);
            arg0->unk2B4 = (s16) (arg0->unk2B4 - 1);
        }
    }
    temp_a1_2 = arg0->unk2AC;
    if (temp_a1_2 != 0) {
        arg0->home.rot.z = 0;
        arg0->unk2A8 = EnMinifrog_NextFrogMissing;
        arg0->unk2B4 = 0x3C;
        arg0->home.rot.y = Actor_YawBetweenActors(arg0, temp_a1_2);
        func_801A1F88();
        temp_t5 = arg0->unk2B6 & 0xFEFF;
        arg0->unk2B6 = temp_t5;
        arg0->unk2B6 = (u16) (temp_t5 & 0xFFC1);
        arg1->unk18798(arg1, &D_0400DEA8, 0);
        return;
    }
    if ((s32) arg0->unk2B4 <= 0) {
        arg0->unk2A8 = EnMinifrog_NextFrogReturned;
        arg0->unk2B4 = 0x1E;
    }
}
...
void EnMinifrog_BeginChoirCutscene(Actor *arg0, GlobalContext *arg1) {
    EnMinifrog_Jump(arg0);
    if (arg0->cutscene == -1) {
        arg0->unk2A8 = EnMinifrog_SetupNextFrogChoir;
        return;
    }
    if (ActorCutscene_GetCurrentIndex() == 0x7C) {
        ActorCutscene_Stop(0x7C);
    ...
    if (ActorCutscene_GetCanPlayNext((s16) arg0->cutscene) != 0) {
        ...
        arg0->unk2B6 = (u16) (arg0->unk2B6 | 0x100);
...
void EnMinifrog_GetFrogHP(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Actor_HasParent(arg0, arg1) != 0) {
        arg0->parent = NULL;
        arg0->unk2A8 = EnMinifrog_EndChoir;
        arg0->flags |= 0x10000;
    ...
    if (temp_v0 != 4) {
        ...
        if (func_80147624(globalCtx) != 0) {
            ...
            case 3455:
                ...
                return;
            case 3447:
                self->actionFunc = (void (*)(EnMinifrog *, GlobalContext *)) EnMinifrog_BeginChoirCutscene;
            ...
            case 3453:
                ...
                self->actionFunc = (void (*)(EnMinifrog *, GlobalContext *)) EnMinifrog_GetFrogHP;
                EnMinifrog_GetFrogHP(&self->actor, globalCtx);
                return;
            default:
                func_801477B4(globalCtx);
                self->actionFunc = EnMinifrog_SetupYellowFrogDialog;
                self->actor.flags &= 0xFFFEFFFF;
...
void EnMinifrog_SetupYellowFrogDialog(EnMinifrog *this, GlobalContext *globalCtx) {
    EnMinifrog *self = (EnMinifrog *) this;
    Math_ScaledStepToS(&self->actor.shape.rot.y, self->actor.yawTowardsPlayer, 0x180);
    self->actor.world.rot.y = self->actor.shape.rot.y;
    EnMinifrog_TurnToPlayer(&self->actor);
    EnMinifrog_Jump(&self->actor);
    EnMinifrog_JumpTimer(&self->actor);
    if (func_800B84D0(&self->actor, globalCtx) != 0) {
        self->actionFunc = EnMinifrog_YellowFrogDialog;
        if ((gSaveContext.weekEventReg[34] & 1) == 0) {
            func_801518B0(globalCtx, 0xD76U, &self->actor);
            return;
        }
        func_801518B0(globalCtx, 0xD7FU, &self->actor);
        return;
    }
    if ((self->actor.xzDistToPlayer < 150.0f) && ((Actor_IsLinkFacingActor(&self->actor, 0x3000, globalCtx) != 0) || ((self->actor.flags & 0x10000) == 0x10000)) && (Player_GetMask(globalCtx) == 0xD)) {
        func_800B8614(&self->actor, globalCtx, 160.0f);
    }
}
...
void EnMinifrog_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 25.0f, 12.0f, 0.0f, 0x1DU);
...
void EnMinifrog_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0_3->words.w1 = (temp_a0_2->unk0 << 0x18) | (temp_a0_2->unk1 << 0x10) | (temp_a0_2->unk2 << 8) | temp_a0_2->unk3;
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnMinifrog_OverrideLimbDraw, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) EnMinifrog_PostLimbDraw, &this->actor);
}
