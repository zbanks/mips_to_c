typedef struct EnGs {
    ...
    /* 0x1AA */ char pad1AA[0x6];                   /* maybe part of unk1A8[4]? */
    /* 0x1B0 */ Vec3f unk1B0;                       /* inferred */
    /* 0x1BC */ Vec3f unk1BC;                       /* inferred */
    /* 0x1C8 */ char pad1C8[0x2C];                  /* maybe part of unk1BC[4]? */
    /* 0x1F4 */ u8 unk1F4;                          /* inferred */
    /* 0x1F5 */ u8 unk1F5;                          /* inferred */
    /* 0x1F6 */ u8 unk1F6;                          /* inferred */
    /* 0x1F7 */ Color_RGB8 unk1F7;                  /* inferred */
    /* 0x1FA */ Color_RGB8 unk1FA;                  /* inferred */
    /* 0x1FD */ char pad1FD[0x3];
    /* 0x200 */ f32 unk200;                         /* inferred */
    /* 0x204 */ s32 unk204;                         /* inferred */
    /* 0x208 */ s32 unk208;                         /* inferred */
    /* 0x20C */ char pad20C[0x6];                   /* maybe part of unk208[2]? */
...
void EnGs_Init(EnGs *this, GlobalContext *globalCtx) {
    ...
    this->unk198 = temp_t8;
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, (Actor *) this, &D_8099A3A0);
    ...
    func_8013E3B8((Actor *) this, (s16 []) &this->unk212, 2);
    func_801A5080(0);
