...
s32 func_80A500F8(EnDnb *arg0) {
    ...
    do {
        ...
        func_80A507C0(arg0 + 0xD38, (Vec3f) subroutine_arg1, (bitwise Vec3f) spA8.unk4, (u8) (bitwise Vec3f) spA8.unk8, temp_fp->unk0, temp_fp->unk4, temp_fp->unk8, 0x10, 50.0f, 30.0f);
        temp_s2 = phi_s2 + 1;
        phi_s1 += 0x1000;
        phi_s2 = temp_s2;
    } while (temp_s2 != 0x10);
...
void EnDnb_Init(EnDnb *this, GlobalContext *globalCtx) {
    s32 temp_s0;
...
void EnDnb_Destroy(EnDnb *this, GlobalContext *globalCtx) {
    EnDnb *this = (EnDnb *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->dyna.bgId);
}

void EnDnb_Update(EnDnb *this, GlobalContext *globalCtx) {
    EnDnb *temp_v0;
    s16 temp_v1;
    s16 temp_v1_2;
    s32 temp_s0;
...
void EnDnb_Draw(EnDnb *this, GlobalContext *globalCtx) {
    EnDnb *this = (EnDnb *) thisx;
