struct _mips2c_stack_EnDnb_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnDnb_Draw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnDnb_Init {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnDnb_Update {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80A4FDD0 {
...
struct _mips2c_stack_func_80A4FEBC {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A4FFE8 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A500F8 {
...
struct _mips2c_stack_func_80A50510 {
    /* 0x00 */ char pad_0[0x40];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80A5063C {
    /* 0x00 */ char pad_0[0x40];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80A507C0 {};              /* size 0x0 */

struct _mips2c_stack_func_80A5086C {};              /* size 0x0 */

struct _mips2c_stack_func_80A50950 {
...
void func_80A4FDD0(EnDnbParticle *arg0, EnDnb *arg1, void *arg2, s32 arg3) {
    ...
    temp_a1 = &sp1C;
    temp_v0 = arg2 + (arg3 * 6);
    sp1C = (f32) temp_v0->unk_0 + arg1->dyna.actor.world.pos.x;
...
s32 func_80A500F8(EnDnb *arg0) {
    ...
    phi_s2 = 0;
    do {
        Lib_Vec3f_TranslateAndRotateY(arg0 + 0x24, phi_s1, &D_80A50CB0, (Vec3f *) &spA8);
...
void EnDnb_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    BgCheck3_LoadMesh(globalCtx, (DynaPolyActor *) this, &D_06004D8C);
...
loop_1:
    ...
    if (phi_a0->isEnabled == 0) {
        ...
        phi_a0->unk_01 = arg3;
        phi_a0->unk_02 = arg3;
        phi_a0->unk_0C.x = arg1.unk_0;
        phi_a0->unk_0C.y = arg1.unk_4;
        phi_a0->unk_0C.z = arg1.unk_8;
        phi_a0->unk_18.x = arg2.unk_0;
        phi_a0->unk_18.y = arg2.unk_4;
        phi_a0->unk_18.z = arg2.unk_8;
        phi_a0->unk_04 = arg4;
...
s32 func_80A5086C(EnDnbUnkStruct *arg0) {
    ...
    do {
        ...
        if (phi_a0->unk_28 == 1) {
            ...
            phi_v1 = phi_v1_2 + 1;
            if (temp_a1_2 != 0) {
                temp_a0->unk_C = (f32) (temp_a0->unk_C + temp_a0->unk_18);
                temp_a0->unk_1 = (u8) (temp_a1_2 - 1);
                temp_a0->unk_10 = (f32) (temp_a0->unk_10 + temp_a0->unk_1C);
                temp_a0->unk_14 = (f32) (temp_a0->unk_14 + temp_a0->unk_20);
            } else {
                temp_a0->unk_0 = 0;
            }
        }
