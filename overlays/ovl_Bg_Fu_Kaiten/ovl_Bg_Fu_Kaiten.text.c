...
void BgFuKaiten_Init(BgFuKaiten *this, GlobalContext *globalCtx) {
...
void BgFuKaiten_Destroy(BgFuKaiten *this, GlobalContext *globalCtx) {
    BgFuKaiten *this = (BgFuKaiten *) thisx;
...
void BgFuKaiten_Update(BgFuKaiten *this, GlobalContext *globalCtx) {
    BgFuKaiten *this = (BgFuKaiten *) thisx;
    BgFuKaiten_UpdateRotation(this);
    BgFuKaiten_UpdateHeight(this);
}

void BgFuKaiten_Draw(BgFuKaiten *this, GlobalContext *globalCtx) {
