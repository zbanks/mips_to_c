...
void EffKamejimaWave_Init(EffKamejimaWave *this, GlobalContext *globalCtx) {
...
void EffKamejimaWave_Destroy(EffKamejimaWave *this, GlobalContext *globalCtx) {
    EffKamejimaWave *this = (EffKamejimaWave *) thisx;
...
void EffKamejimaWave_Update(EffKamejimaWave *this, GlobalContext *globalCtx) {
    EffKamejimaWave *this = (EffKamejimaWave *) thisx;
