typedef struct EnBb {
    ...
    /* 0x24C */ char pad24C[0x1];
    /* 0x24D */ u8 unk24D;                          /* inferred */
    /* 0x24E */ char pad24E[0x2];                   /* maybe part of unk24D[3]? */
    /* 0x250 */ s16 unk250;                         /* inferred */
    /* 0x252 */ char pad252[0x2];
    /* 0x254 */ s16 unk254;                         /* inferred */
    /* 0x256 */ char pad256[0xA];                   /* maybe part of unk254[6]? */
    ...
    /* 0x278 */ Vec3f unk278;                       /* inferred */
    /* 0x284 */ char pad284[0x30];                  /* maybe part of unk278[5]? */
    /* 0x2B4 */ Vec3f unk2B4;                       /* inferred */
    /* 0x2C0 */ char pad2C0[0x34];                  /* maybe part of unk2B4[5]? */
    /* 0x2F4 */ ColliderSphere unk2F4;              /* inferred */
} EnBb;                                             /* size = 0x34C */
...
void EnBb_Init(EnBb *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk2F4, (Actor *) this, &D_808C37A0);
...
void func_808C23EC(EnBb *this, GlobalContext *globalCtx) {
    ...
    this->unk250 += -1;
    if (((this->unk260 + 120.0f) < this->actor.xzDistToPlayer) || (this->unk250 == 0) || (Player_GetMask(globalCtx) == 0x10) || (Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) &this->actor.home) > 400.0f)) {
        func_808C20D4(this);
    }
}
...
void EnBb_Update(EnBb *this, GlobalContext *globalCtx) {
    ...
    if ((func_808C28CC != temp_v0) && (func_808C2CB4 != temp_v0)) {
        ...
        Math_Vec3s_ToVec3f((Vec3f *) &this->actor.focus, (Vec3s *) &this->unk2F4.dim.worldSphere);
        if ((this->unk2F4.base.atFlags & 1) != 0) {
            this->actor.flags |= 0x1000000;
            CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk2F4);
        }
        if ((this->unk2F4.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk2F4);
        }
        if ((this->unk2F4.base.ocFlags1 & 1) != 0) {
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk2F4);
        }
        if (this->unk26C > 0.0f) {
            if (this->unk24D != 0xA) {
...
void EnBb_Draw(EnBb *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_808C32EC, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_808C3324, (Actor *) this);
    if (this->unk264 > 0.0f) {
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk278, 5, this->unk270, this->unk274, this->unk26C, (u8) (s32) this->unk24D);
}
