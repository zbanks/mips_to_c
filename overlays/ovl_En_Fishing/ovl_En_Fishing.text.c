...
typedef struct EnFishing {
    ...
    /* 0x14B */ char pad14B[0x1];
    /* 0x14C */ s16 unk14C;                         /* inferred */
    /* 0x14E */ u8 unk14E;                          /* inferred */
    /* 0x14F */ char pad14F[0x1];
    ...
    /* 0x1C4 */ char pad1C4[0x6];                   /* maybe part of unk1C0[2]? */
    /* 0x1CA */ u8 unk1CA;                          /* inferred */
    /* 0x1CB */ char pad1CB[0x2];                   /* maybe part of unk1CA[3]? */
    /* 0x1CD */ u8 unk1CD;                          /* inferred */
    /* 0x1CE */ char pad1CE[0x2];                   /* maybe part of unk1CD[3]? */
    /* 0x1D0 */ SkelAnime unk1D0;                   /* inferred */
    /* 0x214 */ LightNode *unk214;                  /* inferred */
    /* 0x218 */ LightInfo unk218;                   /* inferred */
    /* 0x226 */ char pad226[0x2];
    /* 0x228 */ ColliderJntSph unk228;              /* inferred */
    /* 0x248 */ ColliderJntSphElement unk248;       /* inferred */
    /* 0x288 */ char pad288[0x2C0];                 /* maybe part of unk248[12]? */
...
typedef struct {
    ...
    /* 0x7C */ char pad7C[0x4];                     /* maybe part of unk7A[3]? */
...
struct _mips2c_stack_EnFishing_Update {
    ...
    /* 0x08C */ char pad8C[0x16];                   /* maybe part of sp88[6]? */
    /* 0x0A2 */ u16 spA2;                           /* inferred */
    /* 0x0A4 */ f32 spA4;                           /* inferred */
    /* 0x0A8 */ char padA8[0x10];                   /* maybe part of spA4[5]? */
    /* 0x0B8 */ ? spB8;                             /* inferred */
...
struct _mips2c_stack_func_808FDCDC {
    ...
    /* 0x68 */ char pad68[0x10];                    /* maybe part of sp64[5]? */
    /* 0x78 */ ? sp78;                              /* inferred */
    /* 0x78 */ char pad78[0x4];
...
struct _mips2c_stack_func_808FE3F8 {
    ...
    /* 0x06C */ ? *sp6C;                            /* inferred */
    /* 0x070 */ char pad70[0x14];                   /* maybe part of sp6C[6]? */
    /* 0x084 */ Gfx *sp84;                          /* inferred */
    /* 0x088 */ char pad88[0xC];                    /* maybe part of sp84[4]? */
    /* 0x094 */ Gfx *sp94;                          /* inferred */
    /* 0x098 */ char pad98[0x10];                   /* maybe part of sp94[5]? */
    /* 0x0A8 */ Gfx *spA8;                          /* inferred */
    /* 0x0AC */ char padAC[0xC];                    /* maybe part of spA8[4]? */
    /* 0x0B8 */ Gfx *spB8;                          /* inferred */
    /* 0x0BC */ char padBC[0x10];                   /* maybe part of spB8[5]? */
    /* 0x0CC */ Gfx *spCC;                          /* inferred */
    /* 0x0D0 */ Gfx *spD0;                          /* inferred */
    /* 0x0D4 */ char padD4[0x10];                   /* maybe part of spD0[5]? */
    /* 0x0E4 */ Gfx *spE4;                          /* inferred */
    /* 0x0E8 */ char padE8[0x10];                   /* maybe part of spE4[5]? */
    /* 0x0F8 */ Gfx *spF8;                          /* inferred */
    /* 0x0FC */ char padFC[0x18];                   /* maybe part of spF8[7]? */
    /* 0x114 */ void *sp114;                        /* inferred */
    /* 0x118 */ char pad118[0x8];                   /* maybe part of sp114[3]? */
    /* 0x120 */ f32 sp120;                          /* inferred */
...
struct _mips2c_stack_func_808FF064 {
    ...
    /* 0x0B4 */ char padB4[0x4];
    /* 0x0B8 */ f32 spB8;                           /* inferred */
    /* 0x0BC */ f32 spBC;                           /* inferred */
    /* 0x0C0 */ f32 spC0;                           /* inferred */
    /* 0x0C4 */ ? spC4;                             /* inferred */
    /* 0x0C4 */ char padC4[0x8];
    /* 0x0CC */ f32 spCC;                           /* inferred */
    /* 0x0D0 */ char padD0[0xC];                    /* maybe part of spCC[4]? */
...
struct _mips2c_stack_func_80900A04 {
    ...
    /* 0x38 */ char pad38[0x5C];                    /* maybe part of sp34[24]? */
    /* 0x94 */ Gfx *sp94;                           /* inferred */
    /* 0x98 */ char pad98[0x18];                    /* maybe part of sp94[7]? */
...
struct _mips2c_stack_func_80909234 {
    ...
    /* 0xEC */ char padEC[0xA];                     /* maybe part of spE8[3]? */
...
struct _mips2c_stack_func_8090AB6C {
    ...
    /* 0x030 */ char pad30[0x4];
    /* 0x034 */ CutsceneContext *sp34;              /* inferred */
    /* 0x038 */ char pad38[0x10];                   /* maybe part of sp34[5]? */
    /* 0x048 */ ? sp48;                             /* inferred */
    /* 0x048 */ char pad48[0x8];
    ...
    /* 0x064 */ f32 sp64;                           /* inferred */
    /* 0x068 */ f32 sp68;                           /* inferred */
    /* 0x06C */ char pad6C[0x6];                    /* maybe part of sp68[2]? */
    /* 0x072 */ s16 sp72;                           /* inferred */
    /* 0x074 */ char pad74[0x8];                    /* maybe part of sp72[5]? */
    /* 0x07C */ f32 sp7C;                           /* inferred */
    /* 0x080 */ f32 sp80;                           /* inferred */
...
loop_1:
    ...
    if (temp_v1 != 0x23) {
        ...
        phi_s0->unk0 = (f32) temp_v0->unk2;
        phi_s0->unk4 = (f32) temp_v0->unk4;
        phi_s0->unkC = 0.0f;
        phi_s0->unk14 = 0.0f;
        phi_s0->unk8 = (f32) temp_v0->unk6;
        ...
        if (temp_v0_2 == 1) {
            ...
            phi_s0->unk38 = 1200.0f;
            phi_s0->unk24 = 0.08f;
            sp80.unk0 = (f32) phi_s0->unk0;
            sp80.unk4 = (f32) phi_s0->unk4;
            sp80.unk8 = (f32) phi_s0->unk8;
            sp84 += 50.0f;
...
void EnFishing_Init(EnFishing *this, GlobalContext *globalCtx) {
    ActorContext *sp5C;
    ...
    if ((s32) temp_v0 < 0x64) {
        ...
        temp_v1 = D_809171C4;
        Collider_SetJntSph(globalCtx, &temp_v1->unk228, (Actor *) this, &D_8090CF08, &temp_v1->unk248);
        this->actor.params = 1;
        temp_s0 = &this->unk1D0;
...
void EnFishing_Destroy(EnFishing *this, GlobalContext *globalCtx) {
...
void func_808FF064(GlobalContext *arg0, Vec3f *arg1, ? *arg2, ? *arg3) {
    ...
    spC4.unk0 = (s32) D_8090D4D8.unk0;
    spC4.unk4 = (s32) D_8090D4D8.unk4;
    spC4.unk8 = (s32) D_8090D4D8.unk8;
    phi_s1 = 0;
    if (D_8090CD24 != 0) {
        spA8.unk0 = arg1->x;
    ...
    if (temp_v0 < 0xC8) {
        ...
        do {
            ...
            temp_f0_2 = phi_s0->unk-C + spB8;
            temp_s1_2 = phi_s1_2 + 1;
            temp_s0_3 = phi_s0 + 0xC;
            temp_s0_3->unk-C = temp_f0_2;
            temp_s0_3->unk-8 = (f32) (phi_s0->unk-8 + spBC);
            temp_s0_3->unk-4 = (f32) (phi_s0->unk-4 + spC0);
            phi_s0 = temp_s0_3;
            phi_s1_2 = temp_s1_2;
            phi_f14 = temp_f0_2;
            phi_s2 += 0xC;
...
void func_808FF5E0(? *arg0) {
    ...
    sp70.unk0 = (s32) D_8090D4E4.unk0;
    temp_s0 = arg0 + 0x948;
    sp70.unk4 = (s32) D_8090D4E4.unk4;
    sp70.unk8 = (s32) D_8090D4E4.unk8;
    sp78 = 5.0f;
    ...
    if (temp_s2 < 0xC6) {
        ...
        do {
            ...
            temp_f0 = phi_s0->unkC + sp64;
            temp_s1 = phi_s1 - 1;
            temp_s0_2 = phi_s0 - 0xC;
            temp_s0_2->unkC = temp_f0;
            temp_f2 = phi_s0->unk10 + sp68;
            temp_s0_2->unk10 = temp_f2;
            temp_f12 = phi_s0->unk14 + sp6C;
...
void func_808FF750(void *arg0, void *arg1, void *arg2, u8 arg3) {
    ...
    sp98.unk0 = (s32) D_8090D4F0.unk0;
    sp98.unk4 = (s32) D_8090D4F0.unk4;
    sp98.unk8 = (s32) D_8090D4F0.unk8;
    sp88 = arg0->unk1CCC;
    sp84 = arg0->unk0;
    SysMatrix_StatePush();
    ...
    arg2->unk0 = (f32) (arg1->unk0 + sp8C);
    arg2->unk4 = (f32) (arg1->unk4 + sp90);
    arg2->unk8 = (f32) (arg1->unk8 + sp94);
...
void func_808FFC44(GlobalContext *arg0) {
    ...
    spB4.unk0 = (s32) D_8090D4FC.unk0;
    spB4.unk4 = (s32) D_8090D4FC.unk4;
    spB4.unk8 = (s32) D_8090D4FC.unk8;
    spBC = 0.85f;
    ...
    do {
        ...
        temp_f28_2 = phi_s0->unk-C + spA8;
        temp_f22_2 = phi_s0->unk-8 + spAC;
        temp_s1 = phi_s1 + 1;
        temp_f20_3 = phi_s0->unk-4 + spB0;
...
void func_80901480(Actor *arg0, GlobalContext *arg1) {
    ...
    spB4.unk0 = (?32) D_8090D620.unk0;
    spB4.unk4 = (f32) D_8090D620.unk4;
    D_809171FE += 1;
    spB4.unk8 = (?32) D_8090D620.unk8;
    if (temp_v0 != 0) {
...
void func_809038A4(EnFishing *arg0, u16 *arg1) {
    ...
    if ((temp_v0 == 3) && (arg0->unk19A == 0) && (D_8090CD0C == 0)) {
        ...
        phi_a2 = arg0;
        phi_f2 = temp_f0;
        if ((sp30 > 0.0f) || (arg0->unk1A4 < 40.0f)) {
...
void EnFishing_Update(EnFishing *this, GlobalContext *globalCtx) {
    s16 sp136;
    s16 sp134;
    f32 sp130;
    f32 sp12C;
    ...
    if (this->unk148 == 0) {
        Actor_SetScale((Actor *) this, this->unk1A4 * 15.0f * 0.00001f);
        ...
        Actor_SetScale((Actor *) this, this->unk1A4 * 65.0f * 0.000001f);
...
block_110:
    ...
    case 2:
        ...
        this->unk1AC = D_80917208.x + sp100;
        this->unk1B4 = D_80917208.z + sp108;
        if (D_80917206 == 2) {
...
loop_266:
                    ...
                    SysMatrix_MultiplyVector3fByState((Vec3f *) &sp10C, (Vec3f *) &sp100);
                    this->unk1AC = this->actor.world.pos.x + sp100;
                    temp_f0_10 = this->unk1AC;
                    this->unk1B4 = this->actor.world.pos.z + sp108;
        ...
        if (((s32) D_8090CD14 >= 3) && ((D_809171C8 == 0) || ((s32) D_809171D4 < 0x33)) && ((s32) D_809171D4 < 0x1770) && ((temp_v1_6 != 0) || (D_80917274 != 0)) && (D_80917266 != 0)) {
            ...
            case 6:
                ...
                Math_ApproachF((f32 *) sp48, spE0->unkCA0 + sp100, 1.0f, 6.0f);
                Math_ApproachF(sp44, spE0->unkCA4 + sp104, 1.0f, 6.0f);
                Math_ApproachF(sp3C, spE0->unkCA8 + sp108, 1.0f, 6.0f);
                D_809101C0 = 188.0f;
...
block_403:
    ...
    if (this->unk150 != 6) {
        if ((f32) globalCtx->colCtx.colHeader->waterBoxes->ySurface < this->actor.world.pos.y) {
            ...
            Math_ApproachS((s16 *) &this->actor.world.rot, spFE, sp134, (s16) (s32) (this->unk1A8 * 0.5f));
            phi_a1_2 = spF6;
            if ((s32) spF6 >= 0x1F41) {
                phi_a1_2 = 0x1F40;
        ...
        if (this->actor.speedXZ <= 0.5f) {
            Math_ApproachS((s16 *) &this->actor.shape, 0, 0xA, this->unk170);
...
void EnFishing_Draw(EnFishing *this, GlobalContext *globalCtx) {
    EnFishing *this = (EnFishing *) thisx;
    ...
    if (this->unk148 == 0) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk1D0.skeleton, this->unk1D0.limbDrawTbl, (s32) this->unk1D0.dListCount, func_80908554, func_80908674, (Actor *) this);
        return;
    }
    ...
    SkelAnime_DrawSV(globalCtx, this->unk1D0.skeleton, this->unk1D0.limbDrawTbl, (s32) this->unk1D0.dListCount, func_809086B4, func_80908734, (Actor *) this);
}
...
void func_80908B4C(GlobalContext *arg0) {
        ...
        if (phi_s1->unk30 != 0) {
            ...
            if ((phi_s1->unk20 < 500.0f) && (fabsf(phi_s1->unk18) < (100.0f + phi_s1->unk20))) {
                ...
                if (temp_v0 == 1) {
                    ...
                    Math_ApproachZeroF((f32 *) (phi_s1 + 0xC), 0.05f, 0.05f);
                } else if (temp_v0 == 2) {
    ...
    if (D_80911F44 == 0) {
        CollisionCheck_SetOC(arg0, arg0 + 0x18884, (Collider *) &D_809171C4->unk228);
    }
}
...
void func_80908E08(GraphicsContext **arg0) {
    ...
    do {
        if (phi_s0_3->unk30 == 2) {
            ...
            if (phi_s0_3->unk34 != 0) {
                SysMatrix_InsertTranslation(phi_s0_3->unk0, phi_s0_3->unk4, phi_s0_3->unk8, 0);
    ...
    do {
        if (phi_s0_4->unk30 == 3) {
            ...
            if (phi_s0_4->unk34 != 0) {
                SysMatrix_InsertTranslation(phi_s0_4->unk0, phi_s0_4->unk4, phi_s0_4->unk8, 0);
...
block_115:
        ...
        case 22:
            ...
            D_80911F58.unk0 = (f32) (spD4->world.pos.x + spF8);
            D_80911F58.unk4 = (f32) (spD4->world.pos.y + spFC);
            D_80911F58.unk8 = (f32) (spD4->world.pos.z + sp100);
