...
static ActorAnimationEntryS D_80BFDF80 = {
...
typedef struct EnBjt {
    ...
    /* 0x0188 */ void (*actionFunc)(EnBjt *, GlobalContext *);
    ...
    /* 0x01E6 */ char pad1E6[0x24];                 /* maybe part of unk1E0[7]? */
    /* 0x020A */ Vec3s unk20A;                      /* inferred */
    /* 0x0210 */ char pad210[0x24];                 /* maybe part of unk20A[7]? */
    /* 0x0234 */ u16 unk234;                        /* inferred */
    /* 0x0236 */ u16 unk236;                        /* inferred */
    /* 0x0238 */ f32 unk238;                        /* inferred */
    /* 0x023C */ char pad23C[0xC];                  /* maybe part of unk238[4]? */
    /* 0x0248 */ s32 unk248;                        /* inferred */
    /* 0x024C */ void *unk24C;                      /* inferred */
    /* 0x0250 */ s32 unk250;                        /* inferred */
    /* 0x0254 */ char pad254[0x8];                  /* maybe part of unk250[3]? */
} EnBjt;                                            /* size 0x25C */

void func_80BFD2E0(EnBjt *arg0) {
    arg0->unk144.animPlaybackSpeed = arg0->unk238;
...
void func_80BFD3A4(EnBjt *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk234 & 0x280) != 0) {
        Lib_Vec3f_TranslateAndRotateY(arg0 + 0x24, arg0->actor.shape.rot.y, &D_80BFDFE0, &sp28);
        Math_Vec3f_ToVec3s(arg0 + 0x1D2, &sp28);
        arg0->unk18C.dim.radius = 0x20;
        arg0->unk18C.dim.height = (s16) (s32) (arg0->actor.focus.pos.y - arg0->actor.world.pos.y);
...
s32 func_80BFD4FC(Actor *arg0) {
    ...
    Math_ApproachF(&arg0->scale.x, 0.017f, 0.21f, 0.3f);
    if ((0.017f - arg0->scale.x) < 0.00017000001f) {
        arg0->scale.x = 0.017f;
        temp_t0 = arg0->unk234 | 0x200;
        arg0->unk234 = temp_t0;
        arg0->unk234 = (u16) (temp_t0 & 0xFF7F);
        sp24 = 1;
    }
...
s32 func_80BFD5E4(Actor *arg0) {
    ...
    Math_ApproachF(&arg0->scale.x, 0.0f, 0.21f, 0.3f);
    if (arg0->scale.x < 0.00017000001f) {
        arg0->unk234 = (u16) (arg0->unk234 & 0xFEFF);
        arg0->scale.x = 0.0f;
        sp24 = 1;
    }
    temp_f0 = (arg0->scale.x / 0.017f) * 4.0f;
...
block_7:
            ...
            if ((temp_v0_2 == 0x2B) || (temp_v0_2 == 0x2D) || (temp_v0_2 == 0x2F) || (temp_v0_2 == 0x30) || (temp_v0_2 == 0x31) || (temp_v0_2 == 0x33)) {
                ...
                arg0->unk248 = 0;
                arg0->unk240 = (u16) ((s16) arg0->unk240 + 1);
                sp20 = 1;
            } else if (temp_v0_2 < 0) {
                arg0->unk248 = 0;
                arg0->unk240 = (u16) ((s16) arg0->unk240 + 1);
...
void func_80BFDA48(EnBjt *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58(&this->actor, globalCtx, &D_80BFDEB4, this->unk24C, &this->unk1DC) != 0) {
        this->actor.flags &= -0x101;
        func_8013AED4(&this->unk234, 3U, 7U);
        this->unk234 &= 0xFFF7;
        this->unk1DC = 0;
...
void func_80BFDAE8(EnBjt *this, GlobalContext *globalCtx) {
    ...
    if (func_80133038(globalCtx, &D_80BFDEA0, &sp28) == 0) {
        sp28.unk0 = 0;
    }
    if (sp28.unk0 == 1) {
        temp_v0 = this->unk234;
        if ((temp_v0 & 0x80) != 0) {
            if (func_80BFD4FC(&this->actor) != 0) {
                func_8013AED4(&this->unk234, 3U, 7U);
            }
        } else if ((temp_v0 & 0x100) != 0) {
            func_80BFD5E4(&this->actor);
            ...
            if ((fabsf(this->actor.yDistToPlayer) > 70.0f) || (this->actor.xzDistToPlayer > 140.0f) || ((gSaveContext.weekEventReg[90] & 0x80) != 0)) {
                func_8013AED4(&this->unk234, 0U, 7U);
                this->unk248 = 0;
                temp_t4 = this->unk234 & 0xFDFF;
                this->unk234 = temp_t4;
                this->unk234 = temp_t4 | 0x100;
            }
        } else if ((fabsf(this->actor.yDistToPlayer) < 20.0f) && (this->actor.xzDistToPlayer < 70.0f) && ((gSaveContext.weekEventReg[90] & 0x80) == 0)) {
            this->unk234 = temp_v0 | 0x80;
            this->unk248 = 0;
        }
        this->unk1D8 = sp28.unk0;
        return;
    }
...
void EnBjt_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk144, &D_06002390, NULL, &this->unk1E0, &this->unk20A, 7);
    this->unk250 = -1;
    func_80BFD30C(&this->actor, 0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk18C, &this->actor, &D_80BFDF48);
...
void EnBjt_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnBjt *this = (EnBjt *) thisx;
    func_80BFD8F0(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    func_80BFD984(this, globalCtx);
    if (this->unk1D8 != 0) {
        func_80BFD2E0(this);
        func_8013C964(&this->actor, globalCtx, 60.0f, 10.0f, 0, (s16) (this->unk234 & 7));
