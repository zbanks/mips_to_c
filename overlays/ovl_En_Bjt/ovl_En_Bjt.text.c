typedef struct EnBjt {
    ...
    /* 0x1E6 */ char pad1E6[0x24];                  /* maybe part of unk1E0[7]? */
    /* 0x20A */ Vec3s unk20A;                       /* inferred */
    /* 0x210 */ char pad210[0x24];                  /* maybe part of unk20A[7]? */
    /* 0x234 */ u16 unk234;                         /* inferred */
    /* 0x236 */ char pad236[0x12];                  /* maybe part of unk234[10]? */
    /* 0x248 */ s32 unk248;                         /* inferred */
    /* 0x24C */ void *unk24C;                       /* inferred */
    /* 0x250 */ s32 unk250;                         /* inferred */
    /* 0x254 */ char pad254[0x8];                   /* maybe part of unk250[3]? */
} EnBjt;                                            /* size = 0x25C */
...
void func_80BFDA48(EnBjt *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, D_80BFDEB4, this->unk24C, &this->unk1DC) != 0) {
...
void EnBjt_Init(EnBjt *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk18C, (Actor *) this, &D_80BFDF48);
...
void EnBjt_Destroy(EnBjt *this, GlobalContext *globalCtx) {
    EnBjt *this = (EnBjt *) thisx;

}

void EnBjt_Update(EnBjt *this, GlobalContext *globalCtx) {
    EnBjt *this = (EnBjt *) thisx;
    ...
    if (this->unk1D8 != 0) {
        func_80BFD2E0(this);
        func_8013C964((Actor *) this, globalCtx, 60.0f, 10.0f, 0, (s16) (this->unk234 & 7));
        Actor_SetHeight((Actor *) this, 26.0f);
        func_80BFD3A4(this, globalCtx);
    }
}

void EnBjt_Draw(EnBjt *this, GlobalContext *globalCtx) {
    EnBjt *this = (EnBjt *) thisx;
    if (this->unk1D8 != 0) {
