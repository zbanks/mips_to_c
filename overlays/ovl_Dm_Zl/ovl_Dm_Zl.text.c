typedef struct DmZl {
    ...
    /* 0x264 */ char pad264[0x4C];                  /* maybe part of actionFunc[20]? */
    /* 0x2B0 */ s16 unk2B0;                         /* inferred */
    /* 0x2B2 */ u8 unk2B2;                          /* inferred */
    /* 0x2B3 */ u8 unk2B3;                          /* inferred */
    /* 0x2B4 */ u8 unk2B4;                          /* inferred */
    /* 0x2B5 */ char pad2B5[0x5];                   /* maybe part of unk2B4[6]? */
    /* 0x2BA */ s16 unk2BA;                         /* inferred */
    /* 0x2BC */ char pad2BC[0x18];                  /* maybe part of unk2BA[13]? */
} DmZl;                                             /* size = 0x2D4 */
...
void DmZl_Init(DmZl *this, GlobalContext *globalCtx) {
    SkelAnime *sp34;
    SkelAnime *temp_a1;
...
void DmZl_Destroy(DmZl *this, GlobalContext *globalCtx) {
    DmZl *this = (DmZl *) thisx;
...
void DmZl_Update(DmZl *this, GlobalContext *globalCtx) {
    DmZl *this = (DmZl *) thisx;
    func_80A38468(this);
...
void DmZl_Draw(DmZl *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A3862C, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80A38648, (Actor *) this);
}
