typedef struct ObjY2lift {
    ...
    /* 0x148 */ char pad148[0x15];                  /* maybe part of unk144[6]? */
...
void ObjY2lift_Init(ObjY2lift *this, GlobalContext *globalCtx) {
...
void ObjY2lift_Destroy(ObjY2lift *this, GlobalContext *globalCtx) {
    ObjY2lift *this = (ObjY2lift *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->unk144);
}

void ObjY2lift_Update(ObjY2lift *this, GlobalContext *globalCtx) {
    f32 sp20;
    f32 sp1C;
    s32 sp18;
    ObjY2lift *temp_a0;
...
void ObjY2lift_Draw(ObjY2lift *this, GlobalContext *globalCtx) {
    ObjY2lift *this = (ObjY2lift *) thisx;
