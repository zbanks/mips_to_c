typedef struct BgDblueMovebg {
    ...
    /* 0x14C */ char pad14C[0x10];                  /* maybe part of unk148[5]? */
    /* 0x15C */ void (*actionFunc)(BgDblueMovebg *, GlobalContext *);
    /* 0x160 */ s32 unk160;                         /* inferred */
    /* 0x164 */ ? *unk164;                          /* inferred */
    /* 0x168 */ s32 unk168;                         /* inferred */
    /* 0x16C */ void *unk16C;                       /* inferred */
    /* 0x170 */ s8 unk170;                          /* inferred */
    /* 0x171 */ s8 unk171;                          /* inferred */
    /* 0x172 */ u16 unk172;                         /* inferred */
    /* 0x174 */ u16 unk174;                         /* inferred */
    /* 0x176 */ char pad176[0x2];
    /* 0x178 */ s32 unk178;                         /* inferred */
    /* 0x17C */ char pad17C[0x2];
    /* 0x17E */ s16 unk17E;                         /* inferred */
    /* 0x180 */ s16 unk180;                         /* inferred */
    /* 0x182 */ char pad182[0x2];
    ...
    /* 0x190 */ Vec3f unk190;                       /* inferred */
    /* 0x19C */ Vec3f unk19C;                       /* inferred */
    /* 0x1A8 */ Vec3f unk1A8;                       /* inferred */
    /* 0x1B4 */ char pad1B4[0x2];
    ...
    /* 0x1C4 */ s32 unk1C4;                         /* inferred */
    /* 0x1C8 */ s32 unk1C8;                         /* inferred */
    /* 0x1CC */ s16 unk1CC;                         /* inferred */
    /* 0x1CE */ s16 unk1CE;                         /* inferred */
    /* 0x1D0 */ s16 unk1D0;                         /* inferred */
    /* 0x1D2 */ s16 unk1D2;                         /* inferred */
    /* 0x1D4 */ f32 unk1D4;                         /* inferred */
    /* 0x1D8 */ char pad1D8[0x120];                 /* maybe part of unk1D4[73]? */
    /* 0x2F8 */ s32 unk2F8;                         /* inferred */
    /* 0x2FC */ s32 unk2FC;                         /* inferred */
    /* 0x300 */ char pad300[0x70];                  /* maybe part of unk2FC[29]? */
...
struct _mips2c_stack_BgDblueMovebg_Draw {
    ...
    /* 0x8C */ char pad8C[0x18];                    /* maybe part of sp88[7]? */
    /* 0xA4 */ GraphicsContext *spA4;               /* inferred */
    /* 0xA8 */ char padA8[0x38];
};                                                  /* size = 0xE0 */
...
struct _mips2c_stack_func_80A2ABD0 {
    ...
    /* 0x98 */ char pad98[0x14];                    /* maybe part of sp94[6]? */
    /* 0xAC */ ? spAC;                              /* inferred */
    /* 0xAC */ char padAC[0x4];
...
void BgDblueMovebg_Init(BgDblueMovebg *this, GlobalContext *globalCtx) {
    Vec3f *sp2C;
    PosRot *sp28;
    Vec3f *sp24;
    ? *temp_v0_3;
...
block_9:
    ...
    func_8013E3B8((Actor *) this, (s16 []) &this->unk1B6, 2);
    temp_t7 = this->unk160;
    switch (temp_t7) {
    case 1:
...
void BgDblueMovebg_Destroy(BgDblueMovebg *this, GlobalContext *globalCtx) {
    s32 temp_a2;
    s32 temp_v0;
    BgDblueMovebg *this = (BgDblueMovebg *) thisx;
...
block_12:
    ...
    if (arg0 == D_80A2BBF0) {
        ...
        SkinMatrix_Vec3fMtxFMultXYZ(&arg1->projectionMatrix, (Vec3f *) &sp54, &arg0->unk1A8);
...
void BgDblueMovebg_Update(BgDblueMovebg *this, GlobalContext *globalCtx) {
...
void BgDblueMovebg_Draw(BgDblueMovebg *this, GlobalContext *globalCtx) {
