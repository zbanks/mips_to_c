typedef struct EnDs2n {
    ...
    /* 0x1D8 */ char pad_1D8[0x4C];                 /* maybe part of actionFunc[20]? */
    /* 0x224 */ Vec3s unk_224;                      /* inferred */
    /* 0x22A */ Vec3s unk_22A;                      /* inferred */
...
void func_80AE16D8(EnDs2n *arg0) {
    ...
    if (temp_v0 == 0) {
        arg0->unk_230 = 2;
        arg0->unk_232 = (s32) (Rand_ZeroOne() * 60.0f) + 0x14;
        return;
    }
    arg0->unk_230 = 1;
block_5:
    arg0->unk_232 = temp_v0;
}

void EnDs2n_Init(Actor *thisx, GlobalContext *globalCtx) {
    EnDs2n *this = (EnDs2n *) thisx;
    ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 20.0f);
    SkelAnime_InitSV(globalCtx, &this->unk_190, &D_06008170, &D_06008038, NULL, NULL, 0);
    func_80AE1650(this);
}
...
void EnDs2n_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_800E9250(globalCtx, (Actor *) this, &this->unk_224, &this->unk_22A, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    func_80AE16D8(this);
}
...
void func_80AE18B4(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp20.unk_0 = (s32) D_80AE1AE8.unk_0;
    sp20.unk_4 = (s32) D_80AE1AE8.unk_4;
    sp20.unk_8 = (s32) D_80AE1AE8.unk_8;
    if ((arg1 == 1) || (arg1 == 0xC) || (arg1 == 0xF)) {
        temp_v0 = arg4 + (arg1 * 2);
        sp18 = temp_v0;
        arg3->y += (s32) Math_SinS(temp_v0->unk_1D8) * 0xC8;
        arg3->z += (s32) Math_CosS(temp_v0->unk_1FE) * 0xC8;
    }
    if (arg1 == 0x12) {
...
void EnDs2n_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_190.skeleton, this->unk_190.limbDrawTbl, (s32) this->unk_190.dListCount, func_80AE1874, func_80AE18B4, (Actor *) this);
}
