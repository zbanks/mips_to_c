...
void EnEndingHero4_Init(EnEndingHero4 *this, GlobalContext *globalCtx) {
...
void EnEndingHero4_Destroy(EnEndingHero4 *this, GlobalContext *globalCtx) {
    EnEndingHero4 *this = (EnEndingHero4 *) thisx;
...
void EnEndingHero4_Update(EnEndingHero4 *this, GlobalContext *globalCtx) {
    EnEndingHero4 *this = (EnEndingHero4 *) thisx;
...
void EnEndingHero4_Draw(EnEndingHero4 *this, GlobalContext *globalCtx) {
    EnEndingHero4 *this = (EnEndingHero4 *) thisx;
