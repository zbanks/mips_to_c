...
struct _mips2c_stack_EnIn_OverrideLimbDraw {
    ...
    /* 0x38 */ ? sp38;                              /* inferred */
    /* 0x38 */ char pad38[0x14];
    /* 0x4C */ void *sp4C;                          /* inferred */
    /* 0x50 */ ? sp50;                              /* inferred */
    /* 0x50 */ char pad50[0x58];
};                                                  /* size = 0xA8 */
...
void EnIn_PostLimbDraw(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp50.unk0 = (s32) D_808F6CB4.unk0;
    sp50.unk4 = (s32) D_808F6CB4.unk4;
    sp50.unk8 = (s32) D_808F6CB4.unk8;
    sp44.unk0 = (s32) D_808F6CC0.unk0;
    sp44.unk4 = (s32) D_808F6CC0.unk4;
    sp44.unk8 = (s32) D_808F6CC0.unk8;
    if (arg1 == 0x10) {
        arg1 = arg1;
        temp_a1 = arg4 + 0x4B4;
        sp24 = temp_a1;
