typedef struct EnYb {
    ...
    /* 0x2A0 */ char pad2A0[0x118];
    /* 0x3B8 */ ColliderCylinder unk3B8;            /* inferred */
    /* 0x404 */ char pad404[0xC];
    /* 0x410 */ u16 unk410;                         /* inferred */
    /* 0x412 */ s16 unk412;                         /* inferred */
    /* 0x414 */ s16 unk414;                         /* inferred */
    /* 0x416 */ s16 unk416;                         /* inferred */
    /* 0x418 */ char pad418[0x2];
    /* 0x41A */ s16 unk41A;                         /* inferred */
    /* 0x41C */ s16 unk41C;                         /* inferred */
    /* 0x41E */ char pad41E[0x2];
...
void EnYb_Init(EnYb *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk3B8, (Actor *) this, &D_80BFB2B0);
...
void EnYb_Destroy(EnYb *this, GlobalContext *globalCtx) {
    EnYb *this = (EnYb *) thisx;
...
void EnYb_Update(EnYb *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk41A != -1) && (ActorCutscene_GetCurrentIndex() != (this + (this->unk41A * 2))->unk416)) {
        ...
        if (ActorCutscene_GetCanPlayNext((this + (this->unk41A * 2))->unk416) != 0) {
            temp_v0 = this->unk41A;
            if (temp_v0 == 0) {
                ActorCutscene_StartAndSetUnkLinkFields((this + (temp_v0 * 2))->unk416, (Actor *) this);
                return;
            }
...
void EnYb_Draw(EnYb *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        if ((s32) temp_v0 < 0xFF) {
            ...
            temp_a2->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80BFB0E0, (Actor *) this, temp_a2->polyXlu.p);
            return;
        }
        func_8012C28C(temp_a2);
        Scene_SetRenderModeXlu(globalCtx, 0, 1U);
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80BFB074, (Actor *) this);
