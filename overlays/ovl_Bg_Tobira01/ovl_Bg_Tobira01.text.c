...
void func_80B12430(Actor *arg0, GlobalContext *arg1) {
    ...
    } else if (((gSaveContext.weekEventReg[88] & 0x40) == 0) && (arg0->unk160 == 0) && (arg1->actorCtx.unk1F5 != 0) && (arg1->actorCtx.unk1F4 == 0)) {
        arg0 = arg0;
    ...
    if (temp_v0 != arg0->unk160) {
        arg0 = arg0;
        Audio_PlayActorSound2(arg0, 0x2143U);
        arg0->unk162 = 0xB4;
        temp_f0 = ((f32) arg0->unk160 * 1.6666666f) + arg0->home.pos.y;
        arg0->unk164 = temp_f0;
        arg0->world.pos.y = temp_f0;
        phi_t0 = &gSaveContext;
        phi_a3 = arg0;
    }
    if (((sp1C->unkA6C & 0x40) == 0) && ((phi_t0->weekEventReg[88] & 0x40) != 0)) {
        temp_v0_3 = phi_a3->unk162;
        if (temp_v0_3 == 0) {
            phi_v1_2 = 0;
        } else {
            phi_a3->unk162 = (s16) (temp_v0_3 - 1);
            phi_v1_2 = phi_a3->unk162;
        }
        if (phi_v1_2 == 0) {
...
void BgTobira01_Init(BgTobira01 *this, GlobalContext *globalCtx) {
...
void BgTobira01_Destroy(BgTobira01 *this, GlobalContext *globalCtx) {
    BgTobira01 *this = (BgTobira01 *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->dyna.bgId);
}

void BgTobira01_Update(BgTobira01 *this, GlobalContext *globalCtx) {
    BgTobira01 *this = (BgTobira01 *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgTobira01_Draw(BgTobira01 *this, GlobalContext *globalCtx) {
