typedef struct ObjChikuwa {
    ...
    /* 0x15C */ char pad15C[0x140];
    /* 0x29C */ s16 unk29C;                         /* inferred */
    /* 0x29E */ s16 unk29E;                         /* inferred */
    /* 0x2A0 */ s16 unk2A0;                         /* inferred */
    /* 0x2A2 */ char pad2A2[0x704];                 /* maybe part of unk2A0[899]? */
    /* 0x9A6 */ u8 unk9A6;                          /* inferred */
    /* 0x9A7 */ char pad9A7[0x1];
...
void ObjChikuwa_Init(ObjChikuwa *this, GlobalContext *globalCtx) {
    f32 temp_f20;
    f32 temp_f8;
    s16 temp_v0;
    s32 temp_s3;
...
void ObjChikuwa_Destroy(ObjChikuwa *this, GlobalContext *globalCtx) {
    ObjChikuwa *this = (ObjChikuwa *) thisx;
...
void ObjChikuwa_Update(ObjChikuwa *this, GlobalContext *globalCtx) {
    Vec3f *temp_s0;
    f32 temp_f0;
    f32 temp_f20;
    s16 temp_s0_2;
...
void ObjChikuwa_Draw(ObjChikuwa *this, GlobalContext *globalCtx) {
    Gfx *temp_v0_3;
    Gfx *temp_v0_4;
    Gfx *temp_v0_5;
    Gfx *temp_v0_6;
        ...
        if ((s32) temp_v0 > 0) {
            ...
            do {
                ...
                if ((phi_s2->unk16A & 1) == 0) {
                    SysMatrix_SetStateRotationAndTranslation(temp_v0_2->unk0, temp_v0_2->unk4, temp_v0_2->unk8, (Vec3s *) &this->actor.shape);
