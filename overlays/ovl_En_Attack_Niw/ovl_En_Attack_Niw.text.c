typedef struct EnAttackNiw {
    ...
    /* 0x268 */ char pad268[0x8];                   /* maybe part of unk264[3]? */
    ...
    /* 0x286 */ char pad286[0xA];                   /* maybe part of unk284[6]? */
    /* 0x290 */ f32 unk290;                         /* inferred */
    /* 0x294 */ f32 unk294;                         /* inferred */
    /* 0x298 */ f32 unk298;                         /* inferred */
    /* 0x29C */ char pad29C[0x2C];                  /* maybe part of unk298[12]? */
...
void func_80958634(EnAttackNiw *this, GlobalContext *globalCtx) {
    ...
    this->unk2CC = (f32) Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) temp_a1);
    this->unk2C8 = (f32) Math_Vec3f_Pitch((Vec3f *) temp_a0, (Vec3f *) &sp34) * -1.0f;
    Math_SmoothStepToS(&this->actor.world.rot.y, (s16) (s32) this->unk2CC, 5, (s16) (s32) this->unk2D4, (s16) 0);
    Math_SmoothStepToS((s16 *) &this->actor.world.rot, (s16) (s32) this->unk2C8, 5, (s16) (s32) this->unk2D4, (s16) 0);
    Math_ApproachF(&this->unk2D4, 5000.0f, 1.0f, 100.0f);
    Actor_SetHeight((Actor *) this, this->unk2DC);
...
void func_80958974(EnAttackNiw *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS((s16 *) &this->actor.world.rot, (s16) (s32) this->unk2C8, 2, (s16) (s32) this->unk2D4, (s16) 0);
...
void EnAttackNiw_Draw(EnAttackNiw *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80958F6C, NULL, (Actor *) this);
}
