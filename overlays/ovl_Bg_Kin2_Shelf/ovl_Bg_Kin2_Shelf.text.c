typedef struct BgKin2Shelf {
    ...
    /* 0x165 */ char pad_165[0x1];
    /* 0x166 */ s8 unk_166;                         /* inferred */
    /* 0x167 */ s8 unk_167;                         /* inferred */
...
struct _mips2c_stack_func_80B70230 {
    ...
    /* 0x38 */ char pad_38[0x8];                    /* maybe part of sp36[5]? */
...
s32 func_80B6FE48(void *arg0, ? arg1) {
    ...
    temp_a1 = arg0->unk_166;
    temp_v1 = *(&D_80B70778 + (arg0->unk_1C & 1)) & arg0->unk_164 & 0xFF;
    if ((temp_a1 != 0) && (arg0->unk_167 != 0)) {
        return 0;
    }
    if ((temp_a1 == 0) && (arg0->unk_167 == 0)) {
        return temp_v1 != 0;
...
s32 func_80B6FEBC(void *arg0, void *arg1) {
    ...
    if ((temp_v0 & 1) != 0) {
        return (s32) arg0->unk_167 < 1;
    }
    if ((temp_v0 & 2) != 0) {
        return (s32) arg0->unk_166 < 1;
    }
    if ((temp_v0 & 4) != 0) {
        return ((s32) arg0->unk_167 < 0) ^ 1;
    }
    if ((temp_v0 & 8) != 0) {
        return ((s32) arg0->unk_166 < 0) ^ 1;
    }
    return 0;
}
...
void func_80B700C0(BgKin2Shelf *arg0, GlobalContext *arg1) {
    ...
    if (fabsf(temp_f2) > 0.1f) {
        temp_v0 = arg0->unk_150 - arg0->actor.shape.rot.y;
        phi_v0 = (s32) temp_v0;
        if (temp_f2 < 0.0f) {
...
void func_80B70230(BgKin2Shelf *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 0) {
        phi_f2 = (Math_SinS((s16) (s32) (arg0->unk_160 * 32768.0f)) * 0.012f) + 0.014f;
    } else {
        phi_f2 = (Math_SinS((s16) (s32) (arg0->unk_160 * 32768.0f)) * 0.003f) + 0.009f;
    }
    arg0->unk_160 += phi_f2;
    ...
    if ((arg0->unk_164 & 8) != 0) {
        phi_f20 = (f32) arg0->unk_166 - temp_f0;
    } else {
        phi_f20 = (f32) arg0->unk_166 + temp_f0;
    }
...
void func_80B704B4(BgKin2Shelf *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_160 += (Math_SinS((s16) (s32) (arg0->unk_160 * 32768.0f)) * 0.022f) + 0.022f;
    ...
    if ((arg0->unk_164 & 4) != 0) {
        phi_f20 = (f32) arg0->unk_167 - temp_f2;
    } else {
        phi_f20 = (f32) arg0->unk_167 + temp_f2;
    }
