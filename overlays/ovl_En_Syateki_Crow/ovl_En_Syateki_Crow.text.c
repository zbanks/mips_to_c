typedef struct EnSyatekiCrow {
    ...
    /* 0x1D6 */ char pad_1D6[0x30];                 /* maybe part of unk_1D0[9]? */
    /* 0x206 */ Vec3s unk_206;                      /* inferred */
    /* 0x20C */ char pad_20C[0x30];                 /* maybe part of unk_206[9]? */
...
void EnSyatekiCrow_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_s0 = this->actor.parent->unk_18C;
    phi_s0 = temp_s0;
    phi_s0_3 = temp_s0;
    if (temp_s0->unk2 != 0) {
        do {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_174, &D_060010C0, &D_060000F0, &this->unk_1D0, &this->unk_206, 9);
    temp_a1 = &this->unk_23C;
    sp38 = temp_a1;
    Collider_InitJntSph(globalCtx, temp_a1);
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_809CB0A0, &this->unk_25C);
    this->unk_23C.elements->dim.worldSphere.radius = D_809CB0AC->unk_20;
    ActorShape_Init(&this->actor.shape, 2000.0f, func_800B3FC0, 20.0f);
    if ((phi_s0_2 == 0) || (((s32) (this->actor.params & 0xFF00) >> 8) >= 0x80)) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    this->unk_1C8 = Lib_SegmentedToVirtual(phi_s0_2->points);
    this->unk_1CC = 1;
    this->unk_1C4 = 0x14;
    this->unk_1BC = 0;
    this->unk_1CE = (s16) phi_s0_2->count;
    func_809CA5D4(this);
}
...
void func_809CA5D4(Actor *arg0) {
    ...
    arg0->unk_30 = (s32) temp_v0->unk_C;
    arg0->unk_34 = (s32) temp_v0->unk_10;
...
void func_809CA67C(void *arg0, ? arg1) {
    ...
    temp_v0 = temp_v1->unk_26A;
    if ((temp_v0 == 1) && (arg0->unk_1C2 == 1) && ((temp_v1->unk_274 & (1 << ((s32) (arg0->unk_1C & 0xFF00) >> 8))) != 0)) {
        sp1C = temp_v1;
        func_809CA71C(1);
    } else if (temp_v0 != 1) {
        arg0->unk_1C2 = 1;
    }
    temp_v0_2 = arg0->unk_120->unk_274;
...
void func_809CA71C(void *arg0) {
    ...
    sp24 = (f32) *(temp_v0 + (arg0->unk_1CC * 6));
    sp28 = (f32) (arg0->unk_1C8 + (arg0->unk_1CC * 6))->unk_2;
    temp_t2 = (arg0->unk_1C8 + (arg0->unk_1CC * 6))->unk_4;
    arg0 = arg0;
    sp1C = temp_a0;
    sp2C = (f32) temp_t2;
    ...
    arg0->unk_BC = temp_v0_3;
    arg0->unk_30 = temp_v0_3;
    arg0->unk_13C = EnSyatekiCrow_Draw;
    arg0->unk_1B8 = func_809CA840;
}
...
void func_809CA840(void *arg0, ? arg1) {
    ...
    temp_v0 = arg0->unk_1BC;
    if ((((arg0->unk_1C & 0xF) * 0x14) + 0x14) < (s32) temp_v0) {
        temp_a0 = arg0->unk_120;
        arg0 = arg0;
        Audio_PlayActorSound2(temp_a0, 0x38B6U);
        arg0->unk_1BC = 0;
        arg0->unk_1B8 = func_809CA8E4;
        arg0->unk_74 = -0.5f;
        arg0->unk_70 = (f32) ((f32) ((s32) (arg0->unk_1C & 0xF0) >> 4) + 6.0f);
        return;
    }
    arg0->unk_1BC = (s16) (temp_v0 + 1);
}
...
void func_809CA8E4(EnSyatekiCrow *arg0, ? arg1) {
    ...
    if (temp_s1->unk_26A != 1) {
        func_809CA5D4(arg0);
        return;
    }
    temp_a0 = &arg0->actor.world;
    temp_a1 = &sp34;
    sp34 = (f32) *(arg0->unk_1C8 + (arg0->unk_1CC * 6));
    sp38 = (f32) (arg0->unk_1C8 + (arg0->unk_1CC * 6))->unk_2;
    sp28 = temp_a0;
    sp3C = (f32) (arg0->unk_1C8 + (arg0->unk_1CC * 6))->unk_4;
    sp30 = Math_Vec3f_DistXZ((Vec3f *) temp_a0, (Vec3f *) temp_a1);
    arg0->unk_1C0 = Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) &sp34);
    arg0->unk_1BE = Math_Vec3f_Pitch((Vec3f *) temp_a0, (Vec3f *) &sp34);
    if (sp30 > 100.0f) {
        Math_SmoothStepToS(&arg0->actor.world.rot.y, arg0->unk_1C0, 5, 0x3000, (s16) 0x100);
        arg0->actor.shape.rot.y = arg0->actor.world.rot.y;
        Math_SmoothStepToS((s16 *) &arg0->actor.shape, arg0->unk_1BE, 5, 0x3000, (s16) 0x100);
        arg0->actor.world.rot.x = (s16) -(s32) arg0->actor.shape.rot.x;
    } else {
        temp_v0 = arg0->unk_1CC;
        if ((s32) temp_v0 < (arg0->unk_1CE - 1)) {
            arg0->unk_1CC = temp_v0 + 1;
        } else {
            arg0->unk_1C2 = 0;
            temp_s1->unk_274 = (s16) (temp_s1->unk_274 & ~(1 << ((s32) (arg0->actor.params & 0xFF00) >> 8)));
            func_809CA5D4(arg0);
        }
    }
    SkelAnime_FrameUpdateMatrix(&arg0->unk_174);
    arg0->actor.shape.yOffset = (fabsf(arg0->unk_174.animCurrentFrame - 3.0f) * 150.0f) + 1700.0f;
    if (((s32) temp_s1->unk_26C % 0x5A) == 0) {
...
void func_809CAAF8(Actor *arg0) {
    ...
    temp_v0 = arg0->parent;
    temp_v0->unk_280 = (s16) (temp_v0->unk_280 + 0x3C);
    arg0->unk_1C2 = 0;
...
void func_809CABC0(EnSyatekiCrow *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk_1C4 >= 0x15) {
        sp34 = arg0->actor.parent;
        func_800B3030(arg1, arg0 + 0x24, &D_809CB050, &D_809CB050, (s16) (s32) (arg0->actor.scale.x * 10000.0f), (s16) 0, 0);
        arg0->actor.parent->unk_27A = (s16) (arg0->actor.parent->unk_27A + 1);
        arg0->actor.parent->unk_274 = (s16) (arg0->actor.parent->unk_274 & ~(1 << ((s32) (arg0->actor.params & 0xFF00) >> 8)));
        func_809CA5D4(arg0);
    }
    arg0->unk_1C4 += 1;
}
...
void func_809CACD0(Actor *arg0, GlobalContext *arg1) {
    if (func_809CA8E4 == arg0[1].gravity) {
        if ((arg0->unk_24D & 2) != 0) {
            ...
            play_sound(0x4807U);
            arg0->unk_1C4 = 0;
            arg0->unk_24D = (u8) (arg0->unk_24D & 0xFFFD);
...
s32 func_809CAE5C(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    if (arg1 == 7) {
        arg4->y += (s32) (3072.0f * sin_rad(arg5->unk_18C * 0.7853982f));
    } else if (arg1 == 8) {
        arg4->y += (s32) (5120.0f * sin_rad((arg5->unk_18C + 2.5f) * 0.7853982f));
    }
    return 0;
}
...
void EnSyatekiCrow_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_174.skeleton, this->unk_174.limbDrawTbl, (s32) this->unk_174.dListCount, func_809CAE5C, func_809CAF2C, (Actor *) this);
}
