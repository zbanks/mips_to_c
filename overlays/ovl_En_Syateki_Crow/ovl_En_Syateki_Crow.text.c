...
static InitChainEntry D_809CB0B0;                   /* unable to generate initializer */
...
typedef struct EnSyatekiCrow {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ char pad144[0x30];
    /* 0x0174 */ SkelAnime unk174;                  /* inferred */
    /* 0x01B8 */ void (*actionFunc)(EnSyatekiCrow *, GlobalContext *);
    /* 0x01BC */ s16 unk1BC;                        /* inferred */
    /* 0x01BE */ s16 unk1BE;                        /* inferred */
    /* 0x01C0 */ s16 unk1C0;                        /* inferred */
    /* 0x01C2 */ s16 unk1C2;                        /* inferred */
    ...
    /* 0x01D6 */ char pad1D6[0x30];                 /* maybe part of unk1D0[9]? */
    /* 0x0206 */ Vec3s unk206;                      /* inferred */
    /* 0x020C */ char pad20C[0x30];                 /* maybe part of unk206[9]? */
...
void EnSyatekiCrow_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, temp_a1, &this->actor, &D_809CB0A0, &this->unk25C);
...
void func_809CA8E4(EnSyatekiCrow *arg0, ? arg1) {
    ...
    sp30 = Math_Vec3f_DistXZ(&temp_a0->pos, (Vec3f *) temp_a1);
    arg0->unk1C0 = Math_Vec3f_Yaw(&temp_a0->pos, (Vec3f *) &sp34);
    arg0->unk1BE = Math_Vec3f_Pitch(&temp_a0->pos, (Vec3f *) &sp34);
    if (sp30 > 100.0f) {
        Math_SmoothStepToS(&arg0->actor.world.rot.y, arg0->unk1C0, 5, 0x3000, (s16) 0x100);
        arg0->actor.shape.rot.y = arg0->actor.world.rot.y;
        Math_SmoothStepToS(&arg0->actor.shape.rot.x, arg0->unk1BE, 5, 0x3000, (s16) 0x100);
    ...
    if (((s32) temp_s1->unk26C % 0x5A) == 0) {
        Audio_PlayActorSound2(&arg0->actor, 0x38B6U);
    }
}
...
void EnSyatekiCrow_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_809CACD0(&this->actor, globalCtx);
}
...
void EnSyatekiCrow_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk174.skeleton, this->unk174.limbDrawTbl, (s32) this->unk174.dListCount, func_809CAE5C, func_809CAF2C, &this->actor);
}
