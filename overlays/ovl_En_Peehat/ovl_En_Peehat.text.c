...
void func_80897258(GlobalContext *arg0, EnPeehat *arg1, Vec3f *arg2, f32 arg3, f32 arg4); /* static */
...
void func_80897F44(Actor *arg0, GlobalContext *arg1); /* static */
...
static ColliderTrisElementInit D_80899488 = {
    {
...
static InitChainEntry D_80899548;                   /* unable to generate initializer */
...
typedef struct EnPeehat {
    ...
    /* 0x02A8 */ void (*actionFunc)(EnPeehat *, GlobalContext *);
    /* 0x02AC */ char pad2AC[0x1];
    /* 0x02AD */ s8 unk2AD;                         /* inferred */
    /* 0x02AE */ u8 unk2AE;                         /* inferred */
    /* 0x02AF */ char pad2AF[0x1];                  /* maybe part of unk2AE[2]? */
    /* 0x02B0 */ s16 unk2B0;                        /* inferred */
    /* 0x02B2 */ s16 unk2B2;                        /* inferred */
    /* 0x02B4 */ s16 unk2B4;                        /* inferred */
    /* 0x02B6 */ char pad2B6[0x2];                  /* maybe part of unk2B4[2]? */
    ...
    /* 0x02D4 */ char pad2D4[0xC];                  /* maybe part of unk2D0[4]? */
    /* 0x02E0 */ Vec3f unk2E0;                      /* inferred */
    /* 0x02EC */ Vec3f unk2EC;                      /* inferred */
    /* 0x02F0 */ f32 unk2F0;                        /* overlap; inferred */
    /* 0x02F4 */ char pad2F4[0x8];                  /* maybe part of unk2F0[3]? */
    /* 0x02FC */ f32 unk2FC;                        /* inferred */
    /* 0x0300 */ char pad300[0xC4];                 /* maybe part of unk2FC[50]? */
    /* 0x03C4 */ ColliderCylinder unk3C4;           /* inferred */
    /* 0x0410 */ ColliderSphere unk410;             /* inferred */
    /* 0x0468 */ ColliderTris unk468;               /* inferred */
    /* 0x0488 */ ColliderTrisElement unk488;        /* inferred */
    /* 0x04E4 */ char pad4E4[0x5C];                 /* maybe part of unk488[2]? */
} EnPeehat;                                         /* size 0x540 */

void EnPeehat_Init(Actor *thisx, GlobalContext *globalCtx) {
    EnPeehat *this = (EnPeehat *) thisx;
    Actor_ProcessInitChain(&this->actor, &D_80899548);
    SkelAnime_Init(globalCtx, &this->unk144, &D_06001C80, &D_060009C4, &this->unk188, &this->unk218, 0x18);
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk3C4, &this->actor, &D_80899430);
    Collider_InitAndSetSphere(globalCtx, &this->unk410, &this->actor, &D_8089945C);
    Collider_InitAndSetTris(globalCtx, &this->unk468, &this->actor, &D_80899500, &this->unk488);
    ...
    this->unk3C4.dim.radius = 0x14;
    this->unk3C4.dim.height = 0xF;
    this->unk3C4.dim.yShift = -5;
    this->actor.hintId = 0x49;
    this->unk3C4.base.ocFlags1 &= 0xFFFE;
...
void EnPeehat_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_DestroyCylinder(globalCtx, &this->unk3C4);
    Collider_DestroySphere(globalCtx, &this->unk410);
    Collider_DestroyTris(globalCtx, &this->unk468);
    if (this->actor.params != 0) {
        temp_v0 = this->actor.parent;
        if ((temp_v0 != 0) && (temp_v0->update != 0)) {
            temp_v0->unk2AC = (u8) (temp_v0->unk2AC - 1);
        }
    }
}
...
void func_80897258(GlobalContext *arg0, EnPeehat *arg1, Vec3f *arg2, f32 arg3, f32 arg4) {
    f32 sp4C;
    f32 sp48;
    f32 sp44;
    s16 sp42;
    ...
    sp44 = (Math_SinS((s16) temp_v1) * arg3) + arg2->x;
    sp4C = (Math_CosS(sp42) * arg3) + arg2->z;
...
void func_80897390(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_s1 = 3 - arg0->unk2AC;
    arg0->unk3D5 = (u8) (arg0->unk3D5 & 0xFFFD);
...
void func_80897498(EnPeehat *arg0) {
    SkelAnime_ChangeAnim(arg0 + 0x144, &D_060009C4, 0.0f, 3.0f, (f32) SkelAnime_GetFrameCount(&D_060009C4.common), (u8) 2, 0.0f);
    arg0->unk2B0 = 0;
    arg0->unk2AD = 1;
    arg0->unk3C4.base.acFlags &= 0xFFFD;
...
void func_80897648(Actor *arg0) {
    if (func_80898454 != arg0->unk2A8) {
        SkelAnime_ChangeAnim(arg0 + 0x144, &D_060009C4, 0.0f, 3.0f, (f32) SkelAnime_GetFrameCount(&D_060009C4.common), (u8) 2, 0.0f);
    }
    arg0->unk2B0 = 0x10;
    Audio_PlayActorSound2(arg0, 0x3954U);
    arg0->unk2A8 = func_808976DC;
}
...
void func_808976DC(EnPeehat *arg0, GlobalContext *arg1) {
    ...
    if (Math_ScaledStepToS(arg0 + 0x2B2, 0xFA0, 0x320) != 0) {
        temp_v0 = arg0->unk2B0;
        if (temp_v0 != 0) {
            arg0->unk2B0 = temp_v0 - 1;
            if ((arg0->unk2B0 == 0) && (arg0->unk144.animPlaybackSpeed < 0.5f)) {
                arg0->unk2B0 = -1;
                arg0->unk144.animPlaybackSpeed = 1.0f;
            }
        }
        if ((SkelAnime_FrameUpdateMatrix(arg0 + 0x144) != 0) || (arg0->unk2B0 == 0)) {
            func_80897EAC(arg0);
        } else {
        ...
        if ((arg0->actor.world.pos.y - arg0->actor.floorHeight) < 80.0f) {
            ...
            sp34.y = arg0->actor.floorHeight;
            func_800BBFB0(arg1, &sp34, 90.0f, 1, (s16) 0x96, (s16) 0x64, (u8) 1);
        }
    }
    func_80897258(arg1, arg0, arg0 + 0x24, 75.0f, 2.0f);
    Math_StepToF(arg0 + 0x2C4, 0.075f, 0.005f);
    arg0->unk2B4 += arg0->unk2B2;
}
...
void func_80897864(Actor *arg0) {
    ...
    arg0->unk2B8 = 0.0f;
    if (func_80898338 == arg0->unk2A8) {
        arg0->unk2AD = (s8) -(s32) arg0->unk2AD;
    } else {
        arg0 = arg0;
    ...
    arg0->unk478 = (u8) (arg0->unk478 | 1);
    arg0->unk2A8 = func_80897910;
}
...
void func_80897910(Actor *arg0, void *arg1) {
    ...
    if ((gSaveContext.isNight == 0) && (Math_Vec3f_DistXZ(arg0 + 8, sp24 + 0x24) < 1200.0f)) {
        ...
        arg0->shape.rot.y += arg0->unk2AD * 0x1C2;
    } else {
        func_80898124(arg0);
    }
    Math_ScaledStepToS(arg0 + 0x2B2, 0xFA0, 0x1F4);
    arg0->unk2B4 = (s16) (arg0->unk2B4 + arg0->unk2B2);
    Math_StepToF(arg0 + 0x2C4, 0.075f, 0.005f);
...
void func_80897A94(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0_3 = arg0->unk478;
    if ((temp_v0_3 & 4) != 0) {
        arg0->unk478 = (u8) (temp_v0_3 & 0xFFFA);
        arg0->colChkInfo.health = 0;
        func_808982E0(arg0);
        return;
    }
    if (((arg0->unk3D5 & 2) != 0) || ((arg0->bgCheckFlags & 1) != 0)) {
        temp_a1 = &arg0->world;
        sp30 = temp_a1;
        func_800B3030(arg1, &temp_a1->pos, &D_801D15B0, &D_801D15B0, (s16) 0x28, (s16) 7, 0);
        Audio_PlaySoundAtPosition(arg1, &temp_a1->pos, 0xB, 0x3878U);
        if ((arg0->bgCheckFlags & 1) == 0) {
            Audio_PlaySoundAtPosition(arg1, &temp_a1->pos, 0x28, 0x3985U);
        }
    ...
    if ((temp_v0_3 & 2) != 0) {
        ...
        arg0->unk478 = (u8) (temp_v0_3 & 0xFFFD);
    ...
    temp_v0_4 = arg0->unk3D6;
    if ((temp_v0_4 & 2) != 0) {
        arg0->unk3D6 = (u8) (temp_v0_4 & 0xFFFD);
        temp_v1_2 = arg0->world.rot.y;
        if ((s32) (s16) (Actor_YawBetweenActors(arg0, arg0->unk3D0) - temp_v1_2) > 0) {
...
void func_80897D00(Actor *arg0) {
    ...
    arg0->unk2A8 = func_80897D48;
    arg0->unk478 = (u8) (arg0->unk478 & 0xFFFE);
}
...
void func_80897D48(EnPeehat *arg0, GlobalContext *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(arg0 + 0x144) != 0) {
        ...
        Audio_PlayActorSound2(&arg0->actor, 0x3957U);
    } else {
        ...
        if (temp_f0 < arg0->actor.world.pos.y) {
            ...
            if ((arg0->actor.world.pos.y - arg0->actor.floorHeight) < 60.0f) {
                Math_Vec3f_Copy(&sp34, &arg0->actor.world.pos);
                sp34.y = arg0->actor.floorHeight;
                func_800BBFB0(arg1, &sp34, 80.0f, 1, (s16) 0x96, (s16) 0x64, (u8) 1);
                func_80897258(arg1, arg0, &sp34, 75.0f, 2.0f);
            }
        }
    }
    Math_ScaledStepToS(&arg0->unk2B2, 0, 0x64);
    arg0->unk2B4 += arg0->unk2B2;
}
...
void func_80897EAC(EnPeehat *arg0) {
    ...
    arg0->unk468.base.atFlags |= 1;
    arg0->unk410.base.acFlags |= 1;
    arg0->actionFunc = func_80897F44;
    arg0->unk2B0 = (s16) temp_f16;
}
...
void func_80897F44(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_f0_2 = cos_rad(arg0->unk2B8);
    arg0->world.pos.y += temp_f0_2 * 1.4f;
    arg0->unk2B0 = (s16) (arg0->unk2B0 - 1);
    arg0->unk2B8 = (f32) (arg0->unk2B8 + (fabsf(temp_f0_2 * 0.18f) + 0.07f));
    if ((s32) arg0->unk2B0 <= 0) {
        arg0->speedXZ = Rand_ZeroFloat(0.5f) + 2.5f;
        arg0->unk2B0 = (s16) (s32) (Rand_ZeroFloat(10.0f) + 10.0f);
        arg0->unk2B6 = (s16) (s32) randPlusMinusPoint5Scaled(1000.0f);
    }
    SkelAnime_FrameUpdateMatrix(arg0 + 0x144);
    arg0->world.rot.y += arg0->unk2B6;
    arg0->shape.rot.y += 0x15E;
    if ((gSaveContext.isNight == 0) && (Math_Vec3f_DistXZ(arg0 + 8, sp24 + 0x24) < 1200.0f)) {
...
void func_80898144(Actor *arg0, void *arg1) {
    ...
    arg0->world.pos.y += cos_rad(arg0->unk2B8) * 1.4f;
    temp_a0 = arg0 + 0x24;
    temp_a1 = arg0 + 8;
    arg0->unk2B8 = (f32) (arg0->unk2B8 + (fabsf(cos_rad(arg0->unk2B8) * 0.18f) + 0.07f));
    sp20 = temp_a1;
    sp24 = temp_a0;
...
void func_808984E0(Actor *arg0) {
    ...
    arg0->unk421 = (u8) (arg0->unk421 & 0xFFFE);
    arg0->unk2C4 = 0.0f;
    if (arg0->colChkInfo.health == 0) {
        arg0->velocity.y = 6.0f;
    }
    arg0->unk2A8 = func_80898594;
}
...
void func_8089874C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk479;
    if ((temp_v0 & 0x80) != 0) {
        arg0->unk479 = (u8) (temp_v0 & 0xFF7F);
        arg0->unk421 = (u8) (arg0->unk421 & 0xFFFD);
        return;
    }
    temp_v0_2 = arg0->unk421;
    if ((temp_v0_2 & 2) != 0) {
        arg0->unk421 = (u8) (temp_v0_2 & 0xFFFD);
        if ((arg0->unk2AE != 0xA) || ((*arg0->unk44C & 0xDB0B3) == 0)) {
            if (Actor_ApplyDamage(arg0) == 0) {
                Enemy_StartFinishingBlow(arg1, arg0);
            }
            arg0->unk478 = (u8) (arg0->unk478 & 0xFFFC);
            func_800BE258(arg0, arg0 + 0x428);
            ...
            if (temp_v0_3 == 2) {
                ...
                arg0->unk2AE = 0x14U;
                arg0->unk2CC = 1.1f;
                Actor_Spawn(&arg1->actorCtx, arg1, 0xA2, (f32) arg0->unk436, (f32) arg0->unk438, (f32) arg0->unk43A, (s16) 0, (s16) 0, (s16) 0, (s16) 4);
            }
            func_800BE568(arg0, arg0 + 0x410);
            func_808984E0(arg0);
            return;
        }
    ...
    temp_v0_4 = arg0->unk2AE;
    if ((temp_v0_4 == 0xA) && ((arg0->unk3D5 & 2) != 0) && ((temp_v0_4 != 0xA) || ((*arg0->unk400 & 0xDB0B3) == 0))) {
        func_808971DC(arg0, arg1);
...
void EnPeehat_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.params == 0) {
        func_8089874C(&this->actor, globalCtx);
    }
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 25.0f, 30.0f, 30.0f, 5U);
    this->actionFunc(this, globalCtx);
    if ((globalCtx->gameplayFrames & 0x7F) == 0) {
        this->unk2C0 = Rand_ZeroFloat(0.25f) + 0.5f;
    }
    this->unk2BC += this->unk2C0;
    if (this->actor.params == 0) {
        if (func_80897910 == this->actionFunc) {
            Math_ScaledStepToS(&this->actor.shape.rot.x, 0x1770, 0x12C);
        } else {
            Math_ScaledStepToS(&this->actor.shape.rot.x, 0, 0x12C);
        }
    } else {
    ...
    this->unk3C4.dim.pos.y += (s32) (this->actor.shape.yOffset * this->actor.scale.y);
    if ((this->unk3C4.base.ocFlags1 & 1) != 0) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &sp58->base);
    }
    temp_t2 = &globalCtx->colChkCtx;
    sp5C = temp_t2;
    temp_s0 = &this->unk410;
    if (this->actor.params == 0) {
        CollisionCheck_SetOC(globalCtx, temp_t2, &temp_s0->base);
        if ((this->unk410.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, sp5C, &temp_s0->base);
        }
    }
    temp_s0_2 = this->unk468.base.atFlags;
    if ((temp_s0_2 & 2) != 0) {
        this->unk468.base.atFlags = temp_s0_2 & 0xFFFD;
        func_808982E0(&this->actor);
    }
    if ((this->unk468.base.atFlags & 1) != 0) {
        temp_s0_3 = &this->unk468;
        this->actor.flags |= 0x1000000;
        CollisionCheck_SetAT(globalCtx, sp5C, &temp_s0_3->base);
        if (this->actor.params == 0) {
            sp70 = NULL;
            CollisionCheck_SetAC(globalCtx, sp5C, &temp_s0_3->base);
            sp54 = &globalCtx->colCtx;
            sp64 = &this->actor.world;
            phi_s1 = &this->unk2E0;
            phi_s0 = 0xC;
            do {
                if (func_800C55C4(sp54, &sp64->pos, phi_s1, &sp74, &sp70, 1U, 1U, 0U, 1U, &sp6C) != 0) {
                    func_800BBFB0(globalCtx, &sp74, 0.0f, 1, (s16) 0x12C, (s16) 0x96, (u8) 1);
    ...
    CollisionCheck_SetAC(globalCtx, sp5C, &sp58->base);
    if (func_80898454 != this->actionFunc) {
        Math_StepToF(&this->unk2C4, 0.0f, 0.001f);
    }
    if (this->unk2C8 > 0.0f) {
        if (this->unk2AE != 0xA) {
            Math_StepToF(&this->unk2C8, 0.0f, 0.05f);
            if (this->unk2AE == 0) {
                temp_f0 = (this->unk2C8 + 1.0f) * 1.05f;
                this->unk2CC = temp_f0;
                if (temp_f0 > 2.1f) {
                    this->unk2CC = 2.1f;
                    return;
            ...
            temp_f0_2 = (this->unk2C8 + 1.0f) * 0.55f;
            this->unk2CC = temp_f0_2;
            if (temp_f0_2 > 1.1f) {
                this->unk2CC = 1.1f;
                return;
            }
        ...
        if (Math_StepToF(&this->unk2D0, 1.1f, 0.0275f) == 0) {
...
s32 func_80898E74(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, s16 *arg4, Actor *arg5) {
    ...
    if (arg1 == 4) {
        *arg4 = (s16) -(s32) arg5->unk2B4;
        goto block_7;
    }
    if ((arg1 == 3) || ((arg1 == 0x17) && ((temp_v0 = arg5->unk2A8, (func_80898594 == temp_v0)) || (func_80897520 == temp_v0)))) {
        temp_v0_2 = *arg0;
        temp_s1 = temp_v0_2->polyOpa.p;
        sp24 = temp_v0_2;
        SysMatrix_StatePush();
        SysMatrix_RotateStateAroundXAxis(arg5->unk2BC * 0.115f);
        SysMatrix_InsertYRotation_f(arg5->unk2BC * 0.13f, 1);
        SysMatrix_InsertZRotation_f(arg5->unk2BC * 0.1f, 1);
        temp_f0 = arg5->unk2C4;
...
void func_80899024(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (temp_s1 == &D_808995A3) {
        ...
        if (arg4->params == 0) {
            ...
            SysMatrix_GetStateTranslationAndScaledX(-400.0f, temp_s2 + 0xC);
            temp_s1_3 = *arg0;
...
void EnPeehat_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80898E74, phi_v0, &this->actor);
    if ((this->actor.speedXZ != 0.0f) || (this->actor.velocity.y != 0.0f)) {
        SysMatrix_GetStateTranslationAndScaledZ(4500.0f, &sp40);
        SysMatrix_GetStateTranslationAndScaledZ(-4500.0f, &sp4C);
        SysMatrix_GetStateTranslationAndScaledX(4500.0f, &sp58);
        temp_a0 = &this->unk468;
        sp34 = temp_a0;
        Collider_SetTrisVertices(temp_a0, 0, &sp40, &sp4C, &sp58);
        SysMatrix_GetStateTranslationAndScaledX(-4500.0f, &sp58);
        Collider_SetTrisVertices(temp_a0, 1, &sp40, &sp58, &sp4C);
    }
    if (this->unk2AE == 0) {
        temp_v0 = &this->actor.home.rot.z;
        this->unk2F0 -= 50.0f;
        this->unk2FC -= 50.0f;
        temp_f18 = temp_v0->unk2F0;
        phi_f18 = temp_f18;
        phi_v0_2 = temp_v0;
        phi_v1 = 6;
        phi_f18_2 = temp_f18;
        ...
        if (6 != 0x12) {
            do {
                temp_f18_2 = phi_v0_2->unk320;
                temp_v1 = phi_v1 + 4;
                phi_v0_2->unk2F0 = (f32) (phi_f18 - 50.0f);
                phi_v0_2->unk2FC = (f32) (phi_v0_2->unk2FC - 50.0f);
                phi_v0_2->unk308 = (f32) (phi_v0_2->unk308 - 50.0f);
                temp_v0_2 = phi_v0_2 + 0x30;
                temp_v0_2->unk2E4 = (f32) (phi_v0_2->unk314 - 50.0f);
                phi_f18 = temp_f18_2;
                phi_v0_2 = temp_v0_2;
                phi_v1 = temp_v1;
        ...
        temp_v0_3->unk2C0 = (f32) (phi_f18_2 - 50.0f);
        temp_v0_3->unk2CC = (f32) (phi_v0_3->unk2FC - 50.0f);
        temp_v0_3->unk2D8 = (f32) (phi_v0_3->unk308 - 50.0f);
        temp_v0_3->unk2E4 = (f32) (phi_v0_3->unk314 - 50.0f);
    }
    func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk2EC, 0x12, this->unk2CC, this->unk2D0, this->unk2C8, (u8) (s32) this->unk2AE);
}
