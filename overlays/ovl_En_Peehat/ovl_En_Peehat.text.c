typedef struct EnPeehat {
    ...
    /* 0x2AC */ char pad2AC[0x2];
    /* 0x2AE */ u8 unk2AE;                          /* inferred */
    /* 0x2AF */ char pad2AF[0x1];
    /* 0x2B0 */ s16 unk2B0;                         /* inferred */
    /* 0x2B2 */ s16 unk2B2;                         /* inferred */
    /* 0x2B4 */ s16 unk2B4;                         /* inferred */
    /* 0x2B6 */ char pad2B6[0x6];                   /* maybe part of unk2B4[4]? */
    ...
    /* 0x2F0 */ f32 unk2F0;                         /* overlap; inferred */
    /* 0x2F4 */ char pad2F4[0x8];                   /* maybe part of unk2F0[3]? */
    /* 0x2FC */ f32 unk2FC;                         /* inferred */
    /* 0x300 */ char pad300[0xC4];                  /* maybe part of unk2FC[50]? */
    /* 0x3C4 */ ColliderCylinder unk3C4;            /* inferred */
    /* 0x410 */ ColliderSphere unk410;              /* inferred */
    /* 0x468 */ ColliderTris unk468;                /* inferred */
    /* 0x488 */ ColliderTrisElement unk488;         /* inferred */
    /* 0x4E4 */ char pad4E4[0x5C];
} EnPeehat;                                         /* size = 0x540 */
...
void EnPeehat_Init(EnPeehat *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk3C4, (Actor *) this, &D_80899430);
    Collider_InitAndSetSphere(globalCtx, &this->unk410, (Actor *) this, &D_8089945C);
    Collider_InitAndSetTris(globalCtx, &this->unk468, (Actor *) this, &D_80899500, &this->unk488);
...
void func_80897258(GlobalContext *arg0, EnPeehat *arg1, ? *arg2, f32 arg3, f32 arg4) {
    ...
    sp44 = (Math_SinS((s16) temp_v1) * arg3) + arg2->unk0;
    sp4C = (Math_CosS(sp42) * arg3) + arg2->unk8;
...
void EnPeehat_Draw(EnPeehat *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80898E74, phi_v0, (Actor *) this);
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2EC, 0x12, this->unk2CC, this->unk2D0, this->unk2C8, (u8) (s32) this->unk2AE);
}
