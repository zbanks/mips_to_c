typedef struct EnPst {
    ...
    /* 0x1EA */ char pad_1EA[0xC];                  /* maybe part of unk_1E4[3]? */
    /* 0x1F6 */ Vec3s unk_1F6;                      /* inferred */
    /* 0x1FC */ char pad_1FC[0xC];                  /* maybe part of unk_1F6[3]? */
    /* 0x208 */ u16 unk_208;                        /* inferred */
    /* 0x20A */ char pad_20A[0x6];                  /* maybe part of unk_208[4]? */
...
block_8:
                ...
                if ((temp_v0_3 == 0x2D) || (temp_v0_3 == 0x33)) {
                    arg0->unk_218 = temp_v0_3;
                    arg0->unk_20E = (s16) (arg0->unk_20E + 1);
                    phi_a3 = 1;
                } else if (temp_v0_3 < 0) {
                    arg0->unk_20E = (s16) (arg0->unk_20E + 1);
                    phi_a3 = 3;
...
s32 func_80B2BBFC(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_208 & 7) != 0) {
        ...
        if (func_800B84D0(arg0, arg1) != 0) {
            temp_t9 = arg0->unk_208 & ~0x30;
            arg0->unk_208 = temp_t9;
...
void func_80B2BD98(EnPst *this, GlobalContext *globalCtx) {
    ...
    phi_a3 = temp_a3;
    phi_a3_2 = temp_a3;
    if ((func_80133038(globalCtx, *(&D_80B2C500 + (temp_v0 * 4)), (struct_80133038_arg2 *) &sp1C) == 0) || ((temp_a0 = temp_a3, (sp1C != temp_a3->unk_1D8)) && (this = temp_a3, phi_a3 = this, phi_a3_2 = this, (func_80B2BD30(temp_a0, (u8 *) globalCtx, &sp1C, temp_a3) == 0)))) {
...
void func_80B2BE54(EnPst *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, this->unk_1DC, this->unk_210, &this->unk_1E0) != 0) {
        if (func_80B2B874((Actor *) this) != this->unk_21C) {
        ...
        func_8013AED4(&this->unk_208, 3U, 7U);
        this->unk_1E0 = 0;
...
void EnPst_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp30 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_06001A80, NULL, &this->unk_1E4, &this->unk_1F6, 3);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_18C, (Actor *) this, &D_80B2C4B8);
...
void EnPst_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_1D8 != 0) {
        if (Actor_IsActorFacingLink((Actor *) this, 0x1FFE) != 0) {
            this->unk_214 = 0;
            func_8013C964((Actor *) this, globalCtx, 60.0f, 20.0f, 0, (s16) (this->unk_208 & 7));
        }
...
void EnPst_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_1D8 != 0) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80B2C11C, NULL, (Actor *) this);
    }
}
