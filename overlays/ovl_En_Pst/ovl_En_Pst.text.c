...
s32 func_80B2BD30(EnPst *arg0, u8 *arg2, struct_80133038_arg2 *, EnPst *); /* static */
...
typedef struct EnPst {
    ...
    /* 0x0188 */ void (*actionFunc)(EnPst *, GlobalContext *);
    ...
    /* 0x01EA */ char pad1EA[0xC];                  /* maybe part of unk1E4[3]? */
    /* 0x01F6 */ Vec3s unk1F6;                      /* inferred */
    /* 0x01FC */ char pad1FC[0xC];                  /* maybe part of unk1F6[3]? */
    /* 0x0208 */ u16 unk208;                        /* inferred */
    /* 0x020A */ char pad20A[0x6];                  /* maybe part of unk208[4]? */
    /* 0x0210 */ void *unk210;                      /* inferred */
    /* 0x0214 */ s32 unk214;                        /* inferred */
    /* 0x0218 */ char pad218[0x4];                  /* maybe part of unk214[2]? */
...
void func_80B2BD98(EnPst *this, GlobalContext *globalCtx) {
    ...
    phi_a3 = temp_a3;
    phi_a3_2 = temp_a3;
    if ((func_80133038(globalCtx, *(&D_80B2C500 + (temp_v0 * 4)), &sp1C) == 0) || ((temp_a0 = temp_a3, (sp1C.unk0 != temp_a3->unk1D8)) && (this = temp_a3, phi_a3 = this, phi_a3_2 = this, (func_80B2BD30(temp_a0, (u8 *) globalCtx, &sp1C, temp_a3) == 0)))) {
...
void func_80B2BE54(EnPst *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58(&this->actor, globalCtx, this->unk1DC, this->unk210, &this->unk1E0) != 0) {
        if (func_80B2B874(&this->actor) != this->unk21C) {
...
void EnPst_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk18C, &this->actor, &D_80B2C4B8);
...
void EnPst_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnPst *this = (EnPst *) thisx;
    func_80B2BBFC(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    if (this->unk1D8 != 0) {
        if (Actor_IsActorFacingLink(&this->actor, 0x1FFE) != 0) {
            this->unk214 = 0;
            func_8013C964(&this->actor, globalCtx, 60.0f, 20.0f, 0, (s16) (this->unk208 & 7));
        }
        Actor_SetHeight(&this->actor, 20.0f);
        func_80B2B830(&this->actor, globalCtx);
    }
}
...
void EnPst_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk1D8 != 0) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B2C11C, NULL, &this->actor);
    }
}
