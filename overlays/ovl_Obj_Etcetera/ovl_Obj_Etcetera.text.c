typedef struct ObjEtcetera {
    ...
    /* 0x1A0 */ ColliderCylinder unk1A0;            /* inferred */
    /* 0x1EC */ Vec3s unk1EC;                       /* inferred */
    /* 0x1F2 */ char pad1F2[0x3C];                  /* maybe part of unk1EC[11]? */
    /* 0x22E */ Vec3s unk22E;                       /* inferred */
    /* 0x234 */ char pad234[0x3C];                  /* maybe part of unk22E[11]? */
    /* 0x270 */ f32 unk270;                         /* inferred */
    /* 0x274 */ s16 unk274;                         /* inferred */
    /* 0x276 */ u16 unk276;                         /* inferred */
...
void ObjEtcetera_Init(ObjEtcetera *this, GlobalContext *globalCtx) {
    s32 sp3C;
    f32 sp38;
    f32 sp34;
    f32 sp30;
...
void ObjEtcetera_Destroy(ObjEtcetera *this, GlobalContext *globalCtx) {
...
void ObjEtcetera_Update(ObjEtcetera *this, GlobalContext *globalCtx) {
    ...
    CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk1A0);
}
