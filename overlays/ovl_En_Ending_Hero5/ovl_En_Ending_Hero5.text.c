...
void EnEndingHero5_Init(EnEndingHero5 *this, GlobalContext *globalCtx) {
...
void EnEndingHero5_Destroy(EnEndingHero5 *this, GlobalContext *globalCtx) {
    EnEndingHero5 *this = (EnEndingHero5 *) thisx;
...
void EnEndingHero5_Update(EnEndingHero5 *this, GlobalContext *globalCtx) {
    EnEndingHero5 *this = (EnEndingHero5 *) thisx;
...
void func_80C23A30(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 0xF) {
        ...
        temp_a0->unk4 = (s32) *(&D_80C23BF0 + (arg4->unk25C * 4));
    }
}
