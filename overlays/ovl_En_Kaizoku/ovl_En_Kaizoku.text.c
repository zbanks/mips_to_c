typedef struct EnKaizoku {
    ...
    /* 0x192 */ char pad192[0x8A];                  /* maybe part of unk18C[24]? */
    /* 0x21C */ Vec3s unk21C;                       /* inferred */
    /* 0x222 */ char pad222[0x8A];                  /* maybe part of unk21C[24]? */
    ...
    /* 0x2BA */ char pad2BA[0x2];
    /* 0x2BC */ s16 unk2BC;                         /* inferred */
    /* 0x2BE */ char pad2BE[0xC];                   /* maybe part of unk2BC[7]? */
    ...
    /* 0x2D9 */ char pad2D9[0x13];                  /* maybe part of unk2D8[20]? */
    /* 0x2EC */ s32 unk2EC;                         /* inferred */
    /* 0x2F0 */ f32 unk_2F0;
    /* 0x2F4 */ s16 unk_2F4;
    /* 0x2F6 */ char pad2F6[0xCE];                  /* maybe part of unk_2F4[104]? */
    /* 0x3C4 */ f32 unk3C4;                         /* inferred */
    /* 0x3C8 */ char pad3C8[0x4];
    ...
    /* 0x4A0 */ char pad4A0[0xF8];                  /* maybe part of unk420[2]? */
    /* 0x598 */ s32 unk598;                         /* inferred */
    /* 0x59C */ char pad59C[0x54];                  /* maybe part of unk598[22]? */
...
void EnKaizoku_Init(EnKaizoku *this, GlobalContext *globalCtx) {
    Actor *sp1EC;
    s32 sp1E8;
    s32 sp1E4;
    s32 sp1E0;
    ...
    this->unk2CA = this->actor.world.rot.z;
    temp_a0 = this->unk2CA;
    this->actor.colChkInfo.health = 8;
    this->unk2D4 = temp_v0 & 0x3F;
    this->unk2BC = ((s32) temp_v0 >> 6) & 0x7F;
    if ((s32) temp_a0 >= 2) {
        this->unk2CA = 0;
        goto block_4;
    }
...
block_4:
    ...
    SkelAnime_InitSV(globalCtx, &this->unk148, &D_0600D828, &D_060058B8, &this->unk18C, &this->unk21C, 0x18);
    Collider_InitAndSetCylinder(globalCtx, &this->unk3D4, (Actor *) this, &D_80B8AB7C);
    Collider_InitAndSetQuad(globalCtx, &this->unk420, (Actor *) this, &D_80B8ABA8);
    sp1DD = 0xFF;
    sp1DC = 0xFF;
    sp1DA = 0xFF;
    sp1D9 = 0xFF;
    ...
    sp1DE = 0xFF;
    sp1DF = 0;
    Effect_Add(globalCtx, &this->unk3D0, 1, 0U, (u8) 0, (void *) &sp4C);
    ...
    this->unk3D4.dim.radius = 0x14;
    this->unk3D4.dim.height = 0x41;
    this->unk3D4.dim.yShift = 0;
...
void EnKaizoku_Destroy(EnKaizoku *this, GlobalContext *globalCtx) {
    EnKaizoku *this = (EnKaizoku *) thisx;
    Effect_Destroy(globalCtx, this->unk3D0);
    Collider_DestroyCylinder(globalCtx, &this->unk3D4);
    Collider_DestroyQuad(globalCtx, &this->unk420);
    func_801A2ED8();
}
...
void func_80B86B74(Actor *arg0, GlobalContext *arg1) {
    ...
    sp3C = temp_a0_2;
    Math_ApproachF((f32 *) temp_a0_2, arg0->unk5C8, 0.5f, arg0->unk5E0);
    Math_ApproachF(arg0 + 0x5A8, arg0->unk5CC, 0.5f, arg0->unk5E0);
    Math_ApproachF(arg0 + 0x5AC, arg0->unk5D0, 0.5f, arg0->unk5E0);
    ...
    if (temp_a1_2 != 0) {
        ...
        arg0->unk5C4 = 0.0f;
        arg0->unk5C0 = 1.0f;
        func_8016981C(arg1, temp_a1_2, sp38, (f32 *) sp3C, arg0 + 0x5BC);
    }
}
...
void EnKaizoku_Update(EnKaizoku *this, GlobalContext *globalCtx) {
    f32 sp34;
    ...
    if ((this->actor.bgCheckFlags & 1) != 0) {
        ...
        this->actor.world.pos.x += this->unk3C4 + sp34;
        this->actor.world.pos.z += this->unk3CC + sp3C;
    ...
    if ((s32) this->unk2D2 > 0) {
        CollisionCheck_SetAT(globalCtx, sp2C, (Collider *) &this->unk420);
    }
}
...
void func_80B8A468(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 0xB) {
        ...
        if ((temp_v0 == 1) && ((temp_v1 = arg4->unk2B0, (temp_v1 == 9)) || (temp_v1 == 0xB))) {
            func_800A81F0(Effect_GetParams(arg4->unk3D0), (Vec3f *) &sp4C, (Vec3f *) &sp40);
        } else if (temp_v0 != 0) {
