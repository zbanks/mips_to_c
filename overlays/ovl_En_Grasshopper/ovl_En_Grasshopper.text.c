typedef struct EnGrasshopper {
    ...
    /* 0x037E */ char pad37E[0x2];
    /* 0x0380 */ Vec3f unk380;                      /* inferred */
    /* 0x038C */ s16 unk38C;                        /* inferred */
    /* 0x038E */ char pad38E[0x2A];                 /* maybe part of unk38C[22]? */
    /* 0x03B8 */ f32 unk3B8;                        /* inferred */
    /* 0x03BC */ char pad3BC[0x4];
    /* 0x03C0 */ Vec3f unk3C0;                      /* inferred */
    /* 0x03C4 */ f32 unk3C4;                        /* overlap; inferred */
    /* 0x03C8 */ f32 unk3C8;                        /* inferred */
    /* 0x03CC */ char pad3CC[0xC];                  /* maybe part of unk3C8[4]? */
    /* 0x03D8 */ ? unk3D8;                          /* inferred */
    /* 0x03D8 */ char pad3D8[0x120];
...
struct _mips2c_stack_func_809A6B6C {
    ...
    /* 0x34 */ f32 sp34;                            /* inferred */
    /* 0x38 */ f32 sp38;                            /* inferred */
    /* 0x3C */ char pad3C[0x6];                     /* maybe part of sp38[2]? */
...
struct _mips2c_stack_func_809A8A64 {
    ...
    /* 0x130 */ char pad130[0x40];
    /* 0x170 */ ? sp170;                            /* inferred */
    /* 0x170 */ char pad170[0x40];
    /* 0x1B0 */ ? sp1B0;                            /* inferred */
    /* 0x1B0 */ char pad1B0[0x50];
};                                                  /* size = 0x200 */
...
void EnGrasshopper_Init(EnGrasshopper *this, GlobalContext *globalCtx) {
    Vec3f *sp30;
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk510, (Actor *) this, &D_809A8D64, &this->unk530);
...
void EnGrasshopper_Destroy(EnGrasshopper *this, GlobalContext *globalCtx) {
    EnGrasshopper *this = (EnGrasshopper *) thisx;
...
void func_809A71CC(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = &arg0->world;
    sp2C = temp_a0;
    Math_ApproachF((f32 *) temp_a0, arg0->unk3B4, 0.3f, arg0->unk36C);
...
void func_809A753C(EnGrasshopper *arg0, GlobalContext *arg1) {
    ...
    if (func_800CA1AC(arg1, &arg1->colCtx, arg0->unk3C0.x, arg0->unk3C8, &arg0->unk4F8, &sp4C) != 0) {
        if (arg0->unk3C4 < arg0->unk4F8) {
            temp_v0 = arg0->unk356;
            if (((s32) temp_v0 < 3) || ((arg1->gameplayFrames & 7) == 0)) {
                temp_s0_2 = &sp40;
...
void func_809A797C(EnGrasshopper *arg0, GlobalContext *arg1) {
    ...
    Math_Vec3f_Copy(&arg0->unk4FC, (Vec3f *) &sp34);
    temp_v0_2 = arg0->unk2B8;
    if (((temp_v0_2 == 0xB) || (temp_v0_2 == 0xA)) && (arg0->unk2B6 != 0)) {
        func_800BF7CC(arg1, (Actor *) arg0, (Vec3f []) &arg0->unk2C4, 0xC, 2, 0.3f, 0.2f);
        arg0->unk2B6 = 0;
        arg0->unk2B8 = 0;
    }
...
void EnGrasshopper_Update(EnGrasshopper *this, GlobalContext *globalCtx) {
    ...
    Actor_SetScale((Actor *) this, this->unk360);
    temp_v0 = this->unk2B0;
    if (temp_v0 != 0) {
    ...
    Math_ApproachZeroF((f32 *) &this->unk4FC, 1.0f, 2.0f);
    ...
    if ((temp_v0_7 != 9) && (temp_v0_7 != 0xA) && ((temp_a1 = &globalCtx->colChkCtx, temp_a2 = &this->unk510, sp2C = temp_a2, sp30 = temp_a1, CollisionCheck_SetOC(globalCtx, temp_a1, (Collider *) temp_a2), CollisionCheck_SetAC(globalCtx, temp_a1, (Collider *) temp_a2), temp_v0_8 = this->unk358, (temp_v0_8 == 5)) || (temp_v0_8 == 6))) {
...
void func_809A847C(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp30.unk0 = (s32) D_809A8E08.unk0;
    sp30.unk4 = (s32) D_809A8E08.unk4;
    sp30.unk8 = (s32) D_809A8E08.unk8;
    sp24.unk0 = (s32) D_809A8E14.unk0;
    sp24.unk4 = (s32) D_809A8E14.unk4;
    sp24.unk8 = (s32) D_809A8E14.unk8;
    SysMatrix_StatePush();
    temp_v0 = arg4->unk35E;
    if ((temp_v0 != 2) && (temp_v0 != 3)) {
...
void EnGrasshopper_Draw(EnGrasshopper *this, GlobalContext *globalCtx) {
    Gfx *temp_s1;
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, NULL, func_809A847C, (Actor *) this);
    ...
    if (temp_v1 != 0) {
        ...
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2C4, 0xC, this->unk2BC, this->unk2C0, (f32) temp_v1 * 0.05f, (u8) (s32) this->unk2B8);
    }
...
void func_809A8A64(EnGrasshopper *arg0, GlobalContext *arg1) {
    ...
    do {
        if (phi_s2->unk0 != 0) {
            SkinMatrix_SetTranslate((MtxF *) &sp170, phi_s2->unk4, phi_s2->unk8, phi_s2->unkC);
            SkinMatrix_SetScale((MtxF *) &sp130, phi_s2->unk20, phi_s2->unk24, phi_s2->unk28);
            SkinMatrix_SetRotateRPY((MtxF *) &spF0, 0, 0, (s16) (s32) phi_s2->unk1C);
