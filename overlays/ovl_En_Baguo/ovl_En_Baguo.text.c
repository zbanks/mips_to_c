typedef struct EnBaguo {
    ...
    /* 0x18E */ char pad_18E[0xC];                  /* maybe part of unk_188[3]? */
    /* 0x19A */ Vec3s unk_19A;                      /* inferred */
    /* 0x1A0 */ char pad_1A0[0xC];                  /* maybe part of unk_19A[3]? */
    ...
    /* 0x1C4 */ Vec3f unk_1C4;                      /* inferred */
    /* 0x1D0 */ Vec3f unk_1D0;                      /* inferred */
    /* 0x1DC */ ColliderJntSph unk_1DC;             /* inferred */
    /* 0x1FC */ ColliderJntSphElement unk_1FC;      /* inferred */
    /* 0x23C */ char pad_23C[0x690];                /* maybe part of unk_1FC[27]? */
} EnBaguo;                                          /* size = 0x8CC */
...
void EnBaguo_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->unk_144, &D_060020E8, NULL, &this->unk_188, &this->unk_19A, 3);
    temp_f6 = (f32) this->actor.world.rot.z;
    this->actor.hintId = 0xB;
    this->actor.world.rot.z = 0;
    this->unk_1BC = 240.0f + (temp_f6 * 40.0f);
    Actor_SetScale((Actor *) this, 0.01f);
    this->actor.colChkInfo.mass = 0xFF;
    this->actor.targetMode = 2;
    Collider_InitAndSetJntSph(globalCtx, &this->unk_1DC, (Actor *) this, &D_80A3C314, &this->unk_1FC);
    this->unk_1DC.elements->dim.modelSphere.radius = 0x1E;
    this->unk_1DC.elements->dim.scale = 1.0f;
    this->unk_1DC.elements->dim.modelSphere.center.x = 0x50;
    this->unk_1DC.elements->dim.modelSphere.center.y = 0x50;
    this->unk_1DC.elements->dim.modelSphere.center.z = 0;
...
void EnBaguo_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnBaguo *this = (EnBaguo *) thisx;
    Collider_DestroyJntSph(globalCtx, &this->unk_1DC);
}
...
void func_80A3B3E0(EnBaguo *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = phi_v1 >> 0x10;
    sp3E = (s16) temp_v1;
    Math_Vec3f_Copy(&arg0->unk_1D0, &D_801D15B0);
    Math_Vec3f_Copy(&arg0->unk_1C4, &D_801D15B0);
    if (temp_v1 < 0x2000) {
        arg0->unk_1D0.x = 2000.0f;
    } else {
        arg0->unk_1B8 = 0;
        arg0->unk_1D0.z = 2000.0f;
...
void func_80A3B5E0(EnBaguo *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_1BC < sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12))) || (Player_GetMask(arg1) == 0x10)) {
        func_80A3B794(arg0);
        return;
    }
    if (arg0->unk_1B4 == 0) {
    ...
    if ((arg0->unk_1C0 == 0) && ((arg0->unk_1DC.base.atFlags & 4) != 0)) {
        arg0->unk_1C0 = 1;
        arg0->unk_1B8 ^= 1;
        arg0->actor.speedXZ = -7.0f;
    }
    Math_ApproachF((f32 *) &arg0->unk_1C4, arg0->unk_1D0.x, 0.2f, 1000.0f);
    Math_ApproachF(&arg0->unk_1C4.z, arg0->unk_1D0.z, 0.2f, 1000.0f);
    Math_ApproachF(&arg0->actor.speedXZ, 5.0f, 0.3f, 0.5f);
    temp_f0 = arg0->unk_1C4.z;
    arg0->actor.world.rot.x += (s32) arg0->unk_1C4.x;
    if (temp_f0 != 0.0f) {
        if (arg0->unk_1B8 == 0) {
...
void func_80A3B8F8(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_1B4;
    temp_a0 = arg0;
    phi_v0 = (s32) temp_v0;
    if (temp_v0 == 0) {
        arg0 = arg0;
        Actor_MarkForDeath(temp_a0);
        phi_v0 = (s32) arg0->unk_1B4;
    }
    if (phi_v0 >= 0x1A) {
...
void func_80A3B958(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 != 3) && (temp_v0 != 2)) {
        ...
        temp_v0_3 = arg0->unk_1ED;
        if ((((temp_v0_3 & 2) != 0) || (phi_s0 != 0)) && ((arg0->unk_1ED = (u8) (temp_v0_3 & 0xFFFD), (phi_s0 != 0)) || (arg0->colChkInfo.damageEffect == 0xE))) {
...
void EnBaguo_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0_3 = this->unk_1B6;
    if ((temp_v0_3 != 3) && (temp_v0_3 != 0)) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_1DC);
    }
    if (this->unk_1B6 != 3) {
        ...
        if (this->unk_1B2 == 0) {
            this->unk_1B0 += 1;
            if ((s32) this->unk_1B0 >= 3) {
                this->unk_1B0 = 0;
                this->unk_1B2 = (s16) (s32) (Rand_ZeroFloat(60.0f) + 20.0f);
            }
        }
        Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
        Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 20.0f, 20.0f, 60.0f, 0x1DU);
        if (this->unk_1B6 != 0) {
            CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_1DC);
        }
        if (this->unk_1B6 != 3) {
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_1DC);
        }
    }
}
