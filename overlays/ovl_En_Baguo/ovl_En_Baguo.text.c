...
typedef struct EnBaguo {
    ...
    /* 0x018E */ char pad18E[0xC];                  /* maybe part of unk188[3]? */
    /* 0x019A */ Vec3s unk19A;                      /* inferred */
    /* 0x01A0 */ char pad1A0[0xC];                  /* maybe part of unk19A[3]? */
    /* 0x01AC */ void (*actionFunc)(EnBaguo *, GlobalContext *);
    ...
    /* 0x01C4 */ Vec3f unk1C4;                      /* inferred */
    /* 0x01D0 */ Vec3f unk1D0;                      /* inferred */
    /* 0x01DC */ ColliderJntSph unk1DC;             /* inferred */
    /* 0x01FC */ ColliderJntSphElement unk1FC;      /* inferred */
    /* 0x023C */ char pad23C[0x690];
} EnBaguo;                                          /* size 0x8CC */
...
void EnBaguo_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk1DC, &this->actor, &D_80A3C314, &this->unk1FC);
...
void func_80A3B220(EnBaguo *arg0, GlobalContext *arg1) {
    ...
    if (arg0->actor.xzDistToPlayer < 200.0f) {
        ...
        if (Player_GetMask(arg1) != 0x10) {
            ...
            arg0 = temp_a2;
            Audio_PlayActorSound2(&temp_a2->actor, 0x39C9U);
...
void func_80A3B2CC(EnBaguo *arg0, GlobalContext *arg1) {
    ...
    if ((arg1->gameplayFrames & 7) == 0) {
        func_800BBDAC(arg1, &arg0->actor, &arg0->actor.world.pos, arg0->actor.shape.shadowScale - 20.0f, 0xA, 8.0f, (s16) 0x1F4, (s16) 0xA, (u8) 1);
    }
...
void func_80A3B3E0(EnBaguo *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk1B4 != 0) {
        Math_SmoothStepToS(&arg0->actor.world.rot.x, 0, 0xA, 0x64, (s16) 0x3E8);
        ...
        if ((arg0->unk1B4 & 8) != 0) {
            ...
            if (fabsf((f32) (arg0->actor.world.rot.y - temp_a1)) > 200.0f) {
                ...
                if ((arg1->gameplayFrames & 7) == 0) {
                    func_800BBDAC(arg1, &arg0->actor, &arg0->actor.world.pos, arg0->actor.shape.shadowScale - 20.0f, 0xA, 8.0f, (s16) 0x1F4, (s16) 0xA, (u8) 1);
                    Audio_PlayActorSound2(&arg0->actor, 0x38FBU);
                }
            }
        }
        arg0->actor.shape.rot.y = arg0->actor.world.rot.y;
...
void func_80A3B5E0(EnBaguo *arg0, GlobalContext *arg1) {
    ...
    Math_ApproachF(&arg0->unk1C4.x, arg0->unk1D0.x, 0.2f, 1000.0f);
    ...
    Audio_PlayActorSound2(&arg0->actor, 0x3005U);
}
...
void func_80A3B958(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 != 3) && (temp_v0 != 2)) {
        ...
        if ((((temp_v0_3 & 2) != 0) || (phi_s0 != 0)) && ((arg0->unk1ED = (u8) (temp_v0_3 & 0xFFFD), (phi_s0 != 0)) || (arg0->colChkInfo.damageEffect == 0xE))) {
            ...
            arg0->unk1F8->unk5 = 8;
            Item_DropCollectibleRandom(arg1, NULL, &arg0->world.pos, 0xB0);
...
void EnBaguo_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80A3B958(&this->actor, globalCtx);
    ...
    if ((temp_v0_3 != 3) && (temp_v0_3 != 0)) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, &this->unk1DC.base);
    }
    if (this->unk1B6 != 3) {
        ...
        if (this->unk1B6 != 0) {
            CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, &this->unk1DC.base);
        }
        if (this->unk1B6 != 3) {
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &this->unk1DC.base);
        }
    }
}
