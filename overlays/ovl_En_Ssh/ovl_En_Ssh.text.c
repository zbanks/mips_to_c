typedef struct EnSsh {
    ...
    /* 0x18E */ char pad18E[0xAE];                  /* maybe part of unk188[30]? */
    /* 0x23C */ Vec3s unk23C;                       /* inferred */
    /* 0x242 */ char pad242[0xAE];                  /* maybe part of unk23C[30]? */
    /* 0x2F0 */ void (*actionFunc)(EnSsh *, GlobalContext *);
    /* 0x2F4 */ ColliderCylinder unk2F4;            /* inferred */
    /* 0x340 */ char pad340[0x17C];                 /* maybe part of unk2F4[6]? */
    /* 0x4BC */ ColliderJntSph unk4BC;              /* inferred */
    /* 0x4DC */ char pad4DC[0x40];                  /* maybe part of unk4BC[3]? */
    /* 0x51C */ s16 unk51C;                         /* inferred */
    /* 0x51E */ char pad51E[0x2];
    /* 0x520 */ s16 unk520;                         /* inferred */
    /* 0x522 */ char pad522[0x6];                   /* maybe part of unk520[4]? */
    /* 0x528 */ s16 unk528;                         /* inferred */
    /* 0x52A */ s16 unk52A;                         /* inferred */
    /* 0x52C */ s16 unk52C;                         /* inferred */
    /* 0x52E */ char pad52E[0x2];
    /* 0x530 */ s32 unk530;                         /* inferred */
    /* 0x534 */ char pad534[0x4];
    /* 0x538 */ f32 unk538;                         /* inferred */
    /* 0x53C */ char pad53C[0x86];                  /* maybe part of unk538[34]? */
    /* 0x5C2 */ u16 unk5C2;                         /* inferred */
    /* 0x5C4 */ s8 unk5C4;                          /* inferred */
    /* 0x5C5 */ char pad5C5[0x1];
    /* 0x5C6 */ s16 unk5C6;                         /* inferred */
    /* 0x5C8 */ s16 unk5C8;                         /* inferred */
    /* 0x5CA */ char pad5CA[0x2];
} EnSsh;                                            /* size = 0x5CC */
...
struct _mips2c_stack_func_80974374 {
    ...
    /* 0x40 */ char pad40[0x8];
    /* 0x48 */ ? sp48;                              /* inferred */
    /* 0x48 */ char pad48[0x1C];
    /* 0x64 */ ? sp64;                              /* inferred */
    /* 0x64 */ char pad64[0x1C];
};                                                  /* size = 0x80 */
...
void func_80974118(Vec3s *arg0) {
    ...
    SysMatrix_StatePop();
    func_800A81F0(Effect_GetParams(arg0->unk530), (Vec3f *) &sp34, (Vec3f *) &sp28);
}
...
void func_80975720(EnSsh *this, GlobalContext *globalCtx) {
    ...
    func_809749B8(this, globalCtx);
    if ((this->unk520 == 0) && (this->unk52C == 0) && (this->actor.xzDistToPlayer < 100.0f) && (Actor_IsLinkFacingActor((Actor *) this, 0x3000, globalCtx) != 0)) {
...
void EnSsh_Draw(EnSsh *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80975DBC, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80975EB8, (Actor *) this);
}
