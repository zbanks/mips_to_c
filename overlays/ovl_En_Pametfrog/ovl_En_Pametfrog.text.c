...
void EnPametfrog_PlaceSnapper(EnPametfrog *arg0, GlobalContext *arg1) {
    ...
    sp64 = NULL;
    arg0->actor.child->unk_24 = (f32) ((Math_SinS(arg0->actor.shape.rot.y) * 300.0f) + arg0->actor.world.pos.x);
    temp_a1 = &sp48;
    temp_a2 = &sp3C;
...
void EnPametfrog_SetupFallOffSnapper(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->world.rot.y = arg0->child->unk_32 + 0x8000;
    arg0->flags |= 1;
    arg0->unk_2B6 = 0x1E;
...
void EnPametfrog_SetupDamage(Actor *arg0) {
    ...
    arg0->unk_2B6 = 0x14;
    arg0->unk_394 = (u8) (arg0->unk_394 & 0xFFFE);
    arg0->unk_395 = (u8) (arg0->unk_395 & 0xFFFE);
    arg0->speedXZ = 10.0f;
    Audio_PlayActorSound2(arg0, 0x38D3U);
...
void EnPametfrog_ApplyDamageEffect(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((temp_v0 & 2) != 0) && ((arg0->unk_395 = (u8) (temp_v0 & 0xFFFD), (arg0->unk_2AC != 0xA)) || ((*arg0->unk_3A0->unk_24 & 0xDB0B3) == 0))) {
        if (arg0->params == 0) {
...
void EnPametfrog_PostLimbDraw(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 0x14) {
        ...
        temp_v0 = arg4->unk_3A0 + 0x30;
        temp_v0->unk_0 = (s16) (s32) sp28;
        temp_v0->unk_2 = (s16) (s32) sp2C;
        temp_v0->unk_4 = (s16) (s32) sp30;
        temp_v0_2 = arg4->unk_3A0 + 0x70;
        sp24 = temp_v0_2;
        temp_v0_2->unk_0 = (s16) (s32) ((Math_SinS(arg4->shape.rot.y) * 35.0f) + arg4->focus.pos.x);
        temp_v0_2->unk_2 = (s16) (s32) (arg4->focus.pos.y - 10.0f);
        temp_v0_2->unk_4 = (s16) (s32) ((Math_CosS(arg4->shape.rot.y) * 35.0f) + arg4->focus.pos.z);
    }
