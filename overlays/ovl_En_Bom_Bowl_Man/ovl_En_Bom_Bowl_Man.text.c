typedef struct EnBomBowlMan {
    ...
    /* 0x2DC */ char pad2DC[0x14];                  /* maybe part of unk2D8[6]? */
    /* 0x2F0 */ s16 unk2F0;                         /* inferred */
    /* 0x2F2 */ s16 unk2F2;                         /* inferred */
    /* 0x2F4 */ s16 unk2F4;                         /* inferred */
    /* 0x2F6 */ s16 unk2F6;                         /* inferred */
...
void func_809C4DA4(EnBomBowlMan *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2B8 == 0) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2D0, (Actor *) this);
...
void func_809C5738(EnBomBowlMan *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw((Vec3f *) temp_a0, &this->unk2A0), 1, 0x7D0, (s16) 0xA);
    Math_ApproachF((f32 *) sp2C, this->unk2A0.x, 0.5f, 6.0f);
    ...
    if (temp_v1 != 0) {
        ...
        if (this->unk2F4 == 0) {
            ...
            if (temp_v1_2 >= 6) {
                ...
                if (sp24->unk14B == 4) {
                    this->unk2C0 = 5;
                    func_801518B0(globalCtx, D_809C618C[(s16) this->unk2C0], (Actor *) this);
                } else {
                    this->unk2C0 = 3;
                    func_801518B0(globalCtx, D_809C6198[(s16) this->unk2C0], (Actor *) this);
                }
                this->unk29C = 0;
                this->actionFunc = func_809C4DA4;
                return;
...
void EnBomBowlMan_Draw(EnBomBowlMan *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_809C5F44, NULL, (Actor *) this);
}
