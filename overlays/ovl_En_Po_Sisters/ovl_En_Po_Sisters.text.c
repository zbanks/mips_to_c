typedef struct EnPoSisters {
    ...
    /* 0x18D */ u8 unk18D;                          /* inferred */
    /* 0x18E */ u8 unk18E;                          /* inferred */
    /* 0x18F */ s8 unk18F;                          /* inferred */
    ...
    /* 0x19C */ char pad19C[0x42];                  /* maybe part of unk196[12]? */
    /* 0x1DE */ Vec3s unk1DE;                       /* inferred */
    /* 0x1E4 */ char pad1E4[0x42];                  /* maybe part of unk1DE[12]? */
    /* 0x226 */ u8 unk226;                          /* inferred */
    /* 0x227 */ u8 unk227;                          /* inferred */
    /* 0x228 */ u8 unk228;                          /* inferred */
    /* 0x229 */ u8 unk229;                          /* inferred */
    /* 0x22A */ char pad22A[0x2];                   /* maybe part of unk229[3]? */
    ...
    /* 0x240 */ char pad240[0x4C];                  /* maybe part of unk23C[20]? */
    /* 0x28C */ Vec3f unk28C;                       /* inferred */
    /* 0x298 */ char pad298[0x54];                  /* maybe part of unk28C[8]? */
    /* 0x2EC */ f32 unk2EC;                         /* inferred */
    /* 0x2F0 */ f32 unk2F0;                         /* inferred */
    /* 0x2F4 */ f32 unk2F4;                         /* inferred */
    /* 0x2F8 */ LightNode *unk2F8;                  /* inferred */
    /* 0x2FC */ LightInfo unk2FC;                   /* inferred */
    /* 0x30A */ char pad30A[0x2];
    /* 0x30C */ ColliderCylinder unk30C;            /* inferred */
    /* 0x358 */ MtxF unk358;                        /* inferred */
...
struct _mips2c_stack_EnPoSisters_Draw {
    ...
    /* 0x84 */ char pad84[0x60];                    /* maybe part of sp80[25]? */
...
void EnPoSisters_Init(EnPoSisters *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk30C, (Actor *) this, &D_80B1DA70);
...
void func_80B1AF8C(EnPoSisters *arg0) {
    ...
    arg0->actor.speedXZ = 0.0f;
    arg0->unk192 = (SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06000114) * 3) + 3;
    arg0->unk191 &= 0xFFFD;
...
void EnPoSisters_Draw(EnPoSisters *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0_2 == 0xFF) || (temp_v0_2 == 0)) {
        ...
        temp_s3->polyOpa.p = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80B1CB44, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80B1CD34, (Actor *) this, temp_s3->polyOpa.p);
    } else {
        ...
        temp_s3->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80B1CB44, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80B1CD34, (Actor *) this, temp_s3->polyXlu.p);
    }
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk28C, 8, this->actor.scale.x * 142.85713f * this->unk2F4, 0.0f, this->unk2F0, (u8) 0x14);
}
