typedef struct EnBigpamet {
    ...
    /* 0x18E */ char pad18E[0x48];                  /* maybe part of unk188[13]? */
    /* 0x1D6 */ Vec3s unk1D6;                       /* inferred */
    /* 0x1DC */ char pad1DC[0x48];                  /* maybe part of unk1D6[13]? */
    /* 0x224 */ SkelAnime unk224;                   /* inferred */
    /* 0x268 */ Vec3s unk268;                       /* inferred */
    /* 0x26E */ char pad26E[0x12];                  /* maybe part of unk268[4]? */
    /* 0x280 */ Vec3s unk280;                       /* inferred */
    /* 0x286 */ char pad286[0x12];                  /* maybe part of unk280[4]? */
    /* 0x298 */ void (*actionFunc)(EnBigpamet *, GlobalContext *);
    /* 0x29C */ u8 unk29C;                          /* inferred */
    /* 0x29D */ char pad29D[0x1];
    /* 0x29E */ s16 unk29E;                         /* inferred */
    /* 0x2A0 */ char pad2A0[0x2];
    /* 0x2A2 */ s16 unk2A2;                         /* inferred */
    /* 0x2A4 */ f32 unk2A4;                         /* inferred */
    /* 0x2A8 */ f32 unk2A8;                         /* inferred */
    /* 0x2AC */ f32 unk_2AC;
    /* 0x2B0 */ ColliderCylinder unk2B0;            /* inferred */
    /* 0x2FC */ char pad2FC[0x2D0];                 /* maybe part of unk2B0[10]? */
...
void EnBigpamet_Init(EnBigpamet *this, GlobalContext *globalCtx) {
    void **temp_s0;
    void **phi_s0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2B0, (Actor *) this, &D_80A29700);
...
void EnBigpamet_Destroy(EnBigpamet *this, GlobalContext *globalCtx) {
    EnBigpamet *this = (EnBigpamet *) thisx;
...
void func_80A2855C(EnBigpamet *this, GlobalContext *globalCtx) {
    ...
    if (temp_f2 > 2.0f) {
        ...
        this->unk2A8 = 1.5f - (temp_f0 * 0.23333333f);
        this->unk2A4 = 1.5f - (temp_f0 * 0.083333336f);
        return;
    }
...
void func_80A287E8(EnBigpamet *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->unk2B0.base.atFlags;
    if ((temp_v1 & 2) != 0) {
        temp_v0_2 = this->actor.world.rot.y;
        this->unk2B0.base.atFlags = temp_v1 & 0xFFFD;
...
void func_80A28A98(EnBigpamet *this, GlobalContext *globalCtx) {
    ...
    this->unk2A8 = (0.2f * temp_f2) + 0.1f;
    this->unk2A4 = (0.071428575f * temp_f2) + 1.0f;
}
...
void func_80A29028(EnBigpamet *arg0) {
    ...
    temp_v0 = arg0->unk2B0.base.acFlags;
    if ((temp_v0 & 2) != 0) {
        arg0->unk2B0.base.acFlags = temp_v0 & 0xFFFD;
...
void EnBigpamet_Update(EnBigpamet *this, GlobalContext *globalCtx) {
...
void EnBigpamet_Draw(EnBigpamet *this, GlobalContext *globalCtx) {
    ...
    temp_v1->words.w1 = (u32) D_80A29754[this->unk29C];
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A293E4, func_80A29494, (Actor *) this);
