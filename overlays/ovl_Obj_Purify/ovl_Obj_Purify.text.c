typedef struct ObjPurify {
    ...
    /* 0x160 */ char pad160[0x6];                   /* maybe part of actionFunc[2]? */
    /* 0x166 */ s16 unk166;                         /* inferred */
    /* 0x168 */ char pad168[0x8];                   /* maybe part of unk166[5]? */
...
void ObjPurify_Init(ObjPurify *this, GlobalContext *globalCtx) {
    s16 *sp24;
    s32 sp20;
    s16 *temp_v1;
    s16 temp_v0;
    ...
    sp24 = temp_v1;
    Actor_SetScale((Actor *) this, temp_v1->unk4);
    if (sp20 == 1) {
...
void ObjPurify_Destroy(ObjPurify *this, GlobalContext *globalCtx) {
    ObjPurify *this = (ObjPurify *) thisx;
...
void ObjPurify_Update(ObjPurify *this, GlobalContext *globalCtx) {
    ObjPurify *this = (ObjPurify *) thisx;
