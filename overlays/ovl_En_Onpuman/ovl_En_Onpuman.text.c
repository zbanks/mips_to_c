...
void EnOnpuman_Init(EnOnpuman *this, GlobalContext *globalCtx) {
    EnOnpuman *this = (EnOnpuman *) thisx;
    ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 36.0f);
    this->actor.flags |= 0x2000000;
    Collider_InitAndSetCylinder(globalCtx, &this->unk254, (Actor *) this, &D_80B12390);
...
void EnOnpuman_Destroy(EnOnpuman *this, GlobalContext *globalCtx) {
    EnOnpuman *this = (EnOnpuman *) thisx;
...
void EnOnpuman_Update(EnOnpuman *this, GlobalContext *globalCtx) {
