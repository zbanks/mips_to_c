typedef struct BgNumaHana {
    ...
    /* 0x15C */ FireObj unk15C;                     /* inferred */
    /* 0x1E8 */ ColliderCylinder unk1E8;            /* inferred */
    /* 0x234 */ void (*actionFunc)(BgNumaHana *, GlobalContext *);
    /* 0x238 */ char pad238[0xC];                   /* maybe part of actionFunc[4]? */
    /* 0x244 */ Vec3s unk244;                       /* inferred */
    /* 0x24A */ char pad24A[0x66];                  /* maybe part of unk244[18]? */
    /* 0x2B0 */ ? unk2B0;                           /* inferred */
    /* 0x2B0 */ char pad2B0[0x78];
...
void BgNumaHana_Init(BgNumaHana *this, GlobalContext *globalCtx) {
    s32 sp2C;
    FireObj *sp24;
...
void BgNumaHana_Destroy(BgNumaHana *this, GlobalContext *globalCtx) {
...
void BgNumaHana_Update(BgNumaHana *this, GlobalContext *globalCtx) {
    s32 sp34;
    f32 sp30;
    f32 sp2C;
    f32 sp28;
...
void BgNumaHana_Draw(BgNumaHana *this, GlobalContext *globalCtx) {
    ? *sp4C;
    ? *sp48;
    ? *temp_s2;
    Gfx *temp_v0;
