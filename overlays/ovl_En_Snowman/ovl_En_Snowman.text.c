typedef struct EnSnowman {
    ...
    /* 0x1CC */ Vec3s unk1CC;                       /* inferred */
    /* 0x1D2 */ char pad1D2[0x42];                  /* maybe part of unk1CC[12]? */
    /* 0x214 */ Vec3s unk214;                       /* inferred */
    /* 0x21A */ char pad21A[0x42];                  /* maybe part of unk214[12]? */
    /* 0x25C */ Vec3s unk25C;                       /* inferred */
    /* 0x262 */ char pad262[0xC];                   /* maybe part of unk25C[3]? */
    /* 0x26E */ Vec3s unk26E;                       /* inferred */
    /* 0x274 */ char pad274[0xC];                   /* maybe part of unk26E[3]? */
    /* 0x280 */ void (*actionFunc)(EnSnowman *, GlobalContext *);
    /* 0x284 */ void (*unk284)(EnSnowman *, GlobalContext *); /* inferred */
    /* 0x288 */ u8 unk288;                          /* inferred */
    /* 0x289 */ u8 unk289;                          /* inferred */
    /* 0x28A */ u8 unk28A;                          /* inferred */
    /* 0x28B */ u8 unk28B;                          /* inferred */
    ...
    /* 0x2AC */ char pad2AC[0x8];                   /* maybe part of unk2A8[3]? */
    /* 0x2B4 */ f32 unk2B4;                         /* inferred */
    /* 0x2B8 */ f32 unk2B8;                         /* inferred */
    /* 0x2BC */ f32 unk2BC;                         /* inferred */
    /* 0x2C0 */ Vec3f unk2C0;                       /* inferred */
    /* 0x2CC */ char pad2CC[0x60];                  /* maybe part of unk2C0[9]? */
...
void EnSnowman_Init(EnSnowman *this, GlobalContext *globalCtx) {
    s32 sp54;
    Actor *sp50;
    ActorContext *sp48;
    Actor *temp_a0_2;
    ...
    if ((s32) this->actor.params < 3) {
        ...
        Collider_InitAndSetCylinder(globalCtx, &this->unk32C, (Actor *) this, &D_80B19A00);
...
block_12:
    ...
    this->actor.flags &= -2;
    Collider_InitAndSetCylinder(globalCtx, &this->unk32C, (Actor *) this, &D_80B19A2C);
...
void EnSnowman_Destroy(EnSnowman *this, GlobalContext *globalCtx) {
    EnSnowman *this = (EnSnowman *) thisx;
...
void func_80B17FE0(EnSnowman *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->unk144) != 0) {
        if (this->unk289 == 1) {
            ...
            this->unk32C.base.acFlags |= 1;
            func_80B18BB4((Actor *) this, globalCtx, &this->unk2A8);
            return;
        }
        func_80B173D0(this);
...
void func_80B1848C(EnSnowman *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.params == 1) {
        ...
        Math_Vec3f_Copy((Vec3f *) &this->unk2B4, (Vec3f *) temp_a1);
...
void func_80B18C7C(EnSnowman *this, GlobalContext *globalCtx) {
    ...
    if (Math_StepToF((f32 *) &this->actor.scale, this->unk298, 0.0005f) != 0) {
        temp_f0 = this->unk298;
        if (temp_f0 < 0.01f) {
            func_80B18908(this);
...
void EnSnowman_Update(EnSnowman *this, GlobalContext *globalCtx) {
...
void EnSnowman_Draw(EnSnowman *this, GlobalContext *globalCtx) {
    EnSnowman *this = (EnSnowman *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80B19718, (Actor *) this);
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2C0, 9, this->unk2A4 * this->unk294, 0.0f, this->unk2A0, (u8) (s32) this->unk28B);
}
