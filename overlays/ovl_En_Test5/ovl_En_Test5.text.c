...
void EnTest5_Init(EnTest5 *this, GlobalContext *globalCtx) {
    WaterBox *sp2C;
    f32 sp28;
...
void EnTest5_Destroy(EnTest5 *this, GlobalContext *globalCtx) {
    EnTest5 *this = (EnTest5 *) thisx;
...
void func_80A90478(EnTest5 *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0->unk388 == 0) || (temp_v0->unk384 != 0xBA)) {
        sp3C = temp_v0;
        Math_Vec3f_DistXYZAndStoreDiff(&this->unk144, (Vec3f *) &temp_v0->world, (Vec3f *) &sp30);
        if ((sp30 >= 0.0f) && (sp30 <= this->unk150) && (sp38 >= 0.0f) && (sp38 <= this->unk154) && (fabsf(sp34) < 100.0f) && (temp_v0->yDistToWater > 12.0f)) {
            func_800B8A1C((Actor *) this, globalCtx, 0xBA, this->actor.xzDistToPlayer, fabsf(this->actor.yDistToPlayer));
        }
    }
}

void EnTest5_Update(EnTest5 *this, GlobalContext *globalCtx) {
    f32 sp4C;
    f32 sp48;
    f32 sp44;
    s32 sp40;
