typedef struct MirRay2 {
    ...
    /* 0x1A4 */ u16 unk1A4;                         /* inferred */
    /* 0x1A6 */ char pad1A6[0x2];
    /* 0x1A8 */ f32 unk1A8;                         /* inferred */
    /* 0x1AC */ LightNode *unk1AC;                  /* inferred */
    /* 0x1B0 */ LightInfo unk1B0;                   /* inferred */
    /* 0x1BE */ char pad1BE[0x2];
} MirRay2;                                          /* size = 0x1C0 */
...
void MirRay2_Init(MirRay2 *this, GlobalContext *globalCtx) {
    ColliderJntSph *sp2C;
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80AF4374, &this->unk164);
    func_80AF3F70(this);
...
void MirRay2_Destroy(MirRay2 *this, GlobalContext *globalCtx) {
...
void MirRay2_Update(MirRay2 *this, GlobalContext *globalCtx) {
    MirRay2 *this = (MirRay2 *) thisx;
    if ((this->unk1A4 & 1) != 0) {
...
void MirRay2_Draw(MirRay2 *this, GlobalContext *globalCtx) {
    MirRay2 *this = (MirRay2 *) thisx;
