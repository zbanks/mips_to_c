...
static s8 D_80C0B0F0 = {0, 0, 7, 0xA, 0xA, 0xB, 0xB, 0};
static s8 D_80C0B0F8 = {1, 2, 0, 1, 2, 1};
...
s32 func_80C0A740(Actor *arg0, void *arg1) {
    ...
    phi_v0_3 = 0;
    phi_v0_4 = 0;
    if (D_80C0B0E8.unk0 < sp1C.z) {
        phi_v0 = 1;
    }
    phi_v0_4 = phi_v0;
    if (phi_v0 != 0) {
        if (sp1C.z < D_80C0B0E8.unk4) {
            phi_v0_2 = 1;
        }
        phi_v0_4 = phi_v0_2;
        if (phi_v0_2 != 0) {
            ...
            phi_v0_4 = phi_v0_3;
            if ((phi_v0_3 != 0) && (sp1C.x < D_80C0B0E4)) {
                phi_v0_4 = 1;
            }
        }
    }
...
s32 func_80C0A95C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp64 = 1;
    Actor_CalcOffsetOrientedToDrawRotation(arg0, &sp4C, arg1->actorCtx.actorList[2].first + 0x24);
    phi_v0 = &D_80C0B0F8;
    phi_v1 = &D_80C0B0F0;
    phi_t0 = 1;
loop_1:
    ...
    phi_v0 = temp_v0;
    if (((temp_f0_2 - 79.5f) < sp4C.z) && (sp4C.z < (temp_f0_2 - 0.5f)) && ((temp_f0 + 0.5f) < sp4C.x) && (sp4C.x < (temp_f0 + 79.5f))) {
        phi_t0 = 0;
    } else {
        phi_v1 += 1;
...
void func_80C0ABA8(BgIkninSusceil *this, GlobalContext *globalCtx) {
    ...
    if (this->dyna.actor.world.pos.y <= this->dyna.actor.home.pos.y) {
        ...
        Audio_PlayActorSound2(&this->dyna.actor, 0x281DU);
        func_80C0AC74(this);
        return;
    }
    func_800B9010(&this->dyna.actor, 0x210EU);
}
...
void func_80C0AD64(BgIkninSusceil *this, GlobalContext *globalCtx) {
    ...
    func_800B9010(&this->dyna.actor, 0x210DU);
}
...
void BgIkninSusceil_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk168 == 0) && ((s32) this->unk166 > 0) && ((temp_t7->unkA74 & 0x100) != 0) && (temp_t7->unkB48 > 1000.0f)) {
        this->unk168 = 2;
        if ((func_80C0A95C(&this->dyna.actor, globalCtx) != 0) && (func_80C0AE5C != this->actionFunc)) {
