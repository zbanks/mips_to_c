...
void EnColMan_Init(EnColMan *this, GlobalContext *globalCtx) {
    u16 temp_t9;
    EnColMan *this = (EnColMan *) thisx;

    Collider_InitAndSetCylinder(globalCtx, &this->unk154, (Actor *) this, &D_80AFE730);
...
void EnColMan_Destroy(EnColMan *this, GlobalContext *globalCtx) {
    EnColMan *this = (EnColMan *) thisx;
...
void EnColMan_Update(EnColMan *this, GlobalContext *globalCtx) {
