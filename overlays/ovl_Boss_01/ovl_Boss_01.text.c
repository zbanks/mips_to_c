typedef struct Boss01 {
    ...
    /* 0x150 */ char pad150[0x4];                   /* maybe part of unk14E[3]? */
    ...
    /* 0x1B0 */ char pad1B0[0x8];                   /* maybe part of unk1AC[3]? */
    /* 0x1B8 */ u8 unk1B8;                          /* inferred */
    /* 0x1B9 */ u8 unk1B9;                          /* inferred */
    /* 0x1BA */ u8 unk1BA;                          /* inferred */
    /* 0x1BB */ u8 unk1BB;                          /* inferred */
    /* 0x1BC */ u8 unk1BC;                          /* inferred */
    /* 0x1BD */ char pad1BD[0x1];
    ...
    /* 0x1D6 */ char pad1D6[0x132];                 /* maybe part of unk1D0[52]? */
    /* 0x308 */ Vec3s unk308;                       /* inferred */
    /* 0x30E */ char pad30E[0x14A];                 /* maybe part of unk308[56]? */
    /* 0x458 */ f32 unk458;                         /* inferred */
    /* 0x45C */ f32 unk45C;                         /* inferred */
    /* 0x460 */ f32 unk460;                         /* inferred */
    /* 0x464 */ void (*actionFunc)(Boss01 *, GlobalContext *);
    /* 0x468 */ ColliderJntSph unk468;              /* inferred */
    /* 0x488 */ ColliderJntSphElement unk488;       /* inferred */
    /* 0x4C8 */ char pad4C8[0x80];                  /* maybe part of unk488[3]? */
    /* 0x548 */ ColliderJntSph unk548;              /* inferred */
    /* 0x568 */ ColliderJntSphElement unk568;       /* inferred */
    /* 0x5A8 */ ColliderJntSph unk5A8;              /* inferred */
    /* 0x5C8 */ ColliderJntSphElement unk5C8;       /* inferred */
    /* 0x608 */ char pad608[0x280];                 /* maybe part of unk5C8[11]? */
    /* 0x888 */ ColliderJntSph unk888;              /* inferred */
    /* 0x8A8 */ ColliderJntSphElement unk8A8;       /* inferred */
    /* 0x8E8 */ char pad8E8[0x40];
    /* 0x928 */ f32 unk928;                         /* inferred */
    /* 0x92C */ f32 unk92C;                         /* inferred */
    /* 0x930 */ f32 unk930;                         /* inferred */
    /* 0x934 */ char pad934[0xA8];                  /* maybe part of unk930[43]? */
    /* 0x9DC */ u32 unk9DC;                         /* inferred */
    /* 0x9E0 */ s16 unk9E0;                         /* inferred */
    /* 0x9E2 */ s16 unk9E2;                         /* inferred */
    /* 0x9E4 */ f32 unk9E4;                         /* inferred */
    /* 0x9E8 */ f32 unk9E8;                         /* inferred */
    /* 0x9EC */ f32 unk9EC;                         /* inferred */
    /* 0x9F0 */ f32 unk9F0;                         /* inferred */
    /* 0x9F4 */ f32 unk9F4;                         /* inferred */
    /* 0x9F8 */ f32 unk9F8;                         /* inferred */
    /* 0x9FC */ f32 unk9FC;                         /* inferred */
    /* 0xA00 */ f32 unkA00;                         /* inferred */
    /* 0xA04 */ f32 unkA04;                         /* inferred */
    /* 0xA08 */ Vec3f unkA08;                       /* inferred */
    /* 0xA0C */ f32 unkA0C;                         /* overlap; inferred */
    /* 0xA10 */ char padA10[0x4];
    /* 0xA14 */ f32 unkA14;                         /* inferred */
    /* 0xA18 */ f32 unkA18;                         /* inferred */
    /* 0xA1C */ f32 unkA1C;                         /* inferred */
    /* 0xA20 */ f32 unkA20;                         /* inferred */
    /* 0xA24 */ f32 unkA24;                         /* inferred */
    /* 0xA28 */ f32 unkA28;                         /* inferred */
    /* 0xA2C */ ColliderCylinder unkA2C;            /* inferred */
    /* 0xA78 */ ColliderCylinder unkA78;            /* inferred */
    /* 0xAC4 */ f32 unkAC4;                         /* inferred */
    /* 0xAC8 */ f32 unkAC8;                         /* inferred */
    /* 0xACC */ f32 unkACC;                         /* inferred */
    /* 0xAD0 */ f32 unkAD0;                         /* inferred */
    /* 0xAD4 */ f32 unkAD4;                         /* inferred */
    /* 0xAD8 */ u8 unkAD8;                          /* inferred */
    /* 0xAD9 */ u8 unkAD9;                          /* inferred */
    /* 0xADA */ s16 unkADA;                         /* inferred */
} Boss01;                                           /* size = 0xADC */
...
struct _mips2c_stack_Boss01_Update {
    ...
    /* 0x64 */ char pad64[0xC];                     /* maybe part of sp62[7]? */
...
struct _mips2c_stack_func_809D3CD0 {
    ...
    /* 0x74 */ char pad74[0x16];                    /* maybe part of sp70[6]? */
    ...
    /* 0xAC */ char padAC[0x8];                     /* maybe part of spA8[3]? */
    /* 0xB4 */ f32 spB4;                            /* inferred */
    /* 0xB8 */ f32 spB8;                            /* inferred */
...
void func_809D089C(s8 arg0, MtxF *arg1, ? *arg2) {
    ...
    temp_v0 = arg0 << 6;
    (arg1->mf[1][3] + temp_v0)->unk30 = (s16) (s32) arg2->unk0;
    (arg1->mf[1][3] + temp_v0)->unk32 = (s16) (s32) arg2->unk4;
    (arg1->mf[1][3] + temp_v0)->unk34 = (s16) (s32) arg2->unk8;
...
void Boss01_Init(Boss01 *this, GlobalContext *globalCtx) {
    ActorContext *sp40;
    ...
    if (temp_v0 == 0xA) {
        ...
        Collider_InitAndSetCylinder(globalCtx, &this->unkA2C, (Actor *) this, &D_809D7C74);
        Collider_InitAndSetCylinder(globalCtx, &this->unkA78, (Actor *) this, &D_809D7CA0);
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk468, (Actor *) this, &D_809D7A3C, &this->unk488);
    Collider_InitAndSetJntSph(globalCtx, &this->unk548, (Actor *) this, &D_809D7A70, &this->unk568);
    Collider_InitAndSetJntSph(globalCtx, &this->unk5A8, (Actor *) this, &D_809D7C0C, &this->unk5C8);
    Collider_InitAndSetJntSph(globalCtx, &this->unk888, (Actor *) this, &D_809D7C64, &this->unk8A8);
    SkelAnime_InitSV(globalCtx, &this->unk164, &D_0600F0A8, &D_06018438, &this->unk1D0, &this->unk308, 0x34);
...
void Boss01_Destroy(Boss01 *this, GlobalContext *globalCtx) {
    Boss01 *this = (Boss01 *) thisx;
...
block_5:
        ...
        this->unk9E4 = temp_f0 + sp60;
        this->unk9E8 = temp_f2 + sp64 + 40.0f;
        this->unk9F0 = temp_f0;
        this->unk9F4 = temp_f2 + this->unkA0C;
        this->unk9F8 = temp_f12;
        this->unk9EC = temp_f12 + sp68;
...
void func_809D32B4(Boss01 *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    if (func_809D3374 != arg0->actionFunc) {
        if ((arg2 & 0xFF) == 0) {
            ...
            arg0->unk1A8 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_0600FF94);
        } else {
            SkelAnime_ChangeAnimTransitionStop(arg0 + 0x164, &D_06010150, arg0->unk154);
            arg0->unk1A8 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06010150);
        }
...
loop_26:
    ...
    if (this->unk9E2 != 0) {
        ...
        this->unkA24 = Math_CosS((s16) (globalCtx->gameplayFrames << 0xF)) * this->unkA28;
        Math_ApproachZeroF(&this->unkA28, 1.0f, 0.75f);
        sp6C.unk0 = (f32) sp58->unk0;
        sp6C.unk4 = (f32) sp58->unk4;
        sp6C.unk8 = (f32) sp58->unk8;
        sp70 += this->unkA24;
        Play_CameraSetAtEye(globalCtx, this->unk9E2, (Vec3f *) &sp6C, (Vec3f *) sp5C);
    }
}
...
void Boss01_Update(Boss01 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0_4 == 0) {
        ...
        if (this->unk1BA != 0) {
            ...
            CollisionCheck_SetAC(globalCtx, sp48, (Collider *) &this->unk468);
        }
        if (this->unk1B8 != 0) {
            CollisionCheck_SetAT(globalCtx, sp48, (Collider *) &this->unk468);
        }
        if (this->unk1B9 != 0) {
            CollisionCheck_SetAT(globalCtx, sp48, (Collider *) &this->unk888);
        }
    } else {
...
void Boss01_Draw(Boss01 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk164.skeleton, this->unk164.limbDrawTbl, (s32) this->unk164.dListCount, func_809D5584, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_809D55CC, (Actor *) this);
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) (Vec3f *) &this->unk928, 0xF, this->unkACC, this->unkAD0, this->unkAD4, (u8) (s32) this->unkAD8);
...
void func_809D6BB4(Actor *this, GlobalContext *globalCtx) {
    ...
    func_800BE680(globalCtx, this, (Vec3f []) (Vec3f *) &this->world, 1, this->unkAC4, 0.0f, this->unkAC8, (u8) (s32) this->unk14C);
}
