typedef struct EnAm {
    ...
    /* 0x18E */ char pad18E[0x4E];                  /* maybe part of unk188[14]? */
    /* 0x1DC */ Vec3s unk1DC;                       /* inferred */
    /* 0x1E2 */ char pad1E2[0x4E];                  /* maybe part of unk1DC[14]? */
    /* 0x230 */ void (*actionFunc)(EnAm *, GlobalContext *);
    /* 0x234 */ u8 unk234;                          /* inferred */
    /* 0x235 */ char pad235[0x1];
    ...
    /* 0x24C */ Vec3f unk24C;                       /* inferred */
    /* 0x258 */ char pad258[0x90];                  /* maybe part of unk24C[13]? */
    /* 0x2E8 */ ColliderCylinder unk2E8;            /* inferred */
    /* 0x334 */ ColliderCylinder unk334;            /* inferred */
} EnAm;                                             /* size = 0x380 */
...
void EnAm_Init(EnAm *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2E8, (Actor *) this, &D_808B1070);
    Collider_InitAndSetCylinder(globalCtx, &this->unk334, (Actor *) this, &D_808B109C);
...
void func_808B03C0(EnAm *this, GlobalContext *globalCtx) {
    ...
    if ((temp_a0->unk238 == 0) || (this = temp_a0, phi_a0 = this, (Actor_XZDistanceToPoint((Actor *) temp_a0, (Vec3f *) temp_a1) > 240.0f))) {
...
void func_808B05C8(EnAm *this, GlobalContext *globalCtx) {
    ...
    sp24 = temp_a1;
    this->unk23C = Actor_YawToPoint((Actor *) this, (Vec3f *) temp_a1);
...
void EnAm_Draw(EnAm *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, NULL, func_808B0EA4, (Actor *) this);
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk24C, 0xD, this->unk248, 0.0f, this->unk244, (u8) 0x14);
}
