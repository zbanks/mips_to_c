...
s32 EffectSsFhgFlash_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    sp20.unk_0 = (f32) D_8097CEC8.unk_0;
    sp20.unk_4 = (f32) D_8097CEC8.unk_4;
    sp20.unk_8 = (f32) D_8097CEC8.unk_8;
...
void EffectSsFhgFlash_Update(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    if (temp_v0 == 1) {
        ...
        this->pos.x = randPlusMinusPoint5Scaled(10.0f) + temp_v0_2->unk_BEC;
        sp24 = temp_v0_2;
        this->pos.y = randPlusMinusPoint5Scaled(15.0f) + sp24->unk_BF0;
        this->pos.z = randPlusMinusPoint5Scaled(10.0f) + sp24->unk_BF4;
    } else if (((s32) temp_v0 >= 2) && ((s32) temp_v0 < 7)) {
        temp_v1 = this->actor;
        temp_a0 = temp_v1->unk_191 - 3;
        if (temp_a0 < 0) {
            sp30 = temp_v1 + (temp_v0 * 0x12C) + 0x2FF0;
        } else {
            sp30 = temp_v1 + (temp_v0 * 0x12C) + (temp_a0 * 0x14) + 0x2F00;
        }
        this->pos.x = randPlusMinusPoint5Scaled(70.0f) + sp30->unk_0;
        this->pos.y = randPlusMinusPoint5Scaled(70.0f) + sp30->unk_4;
        this->pos.z = randPlusMinusPoint5Scaled(70.0f) + sp30->unk_8;
    }
