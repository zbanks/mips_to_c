typedef struct ObjPzlblock {
    ...
    /* 0x148 */ char pad_148[0x32];                 /* maybe part of unk_144[13]? */
    /* 0x17A */ s8 unk_17A;                         /* inferred */
    /* 0x17B */ char pad_17B[0x1];
} ObjPzlblock;                                      /* size = 0x17C */

struct _mips2c_stack_ObjPzlblock_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjPzlblock_Init {
...
struct _mips2c_stack_ObjPzlblock_Update {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ void *sp2C;                          /* inferred */
    /* 0x30 */ char pad_30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_809A33E0 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809A3448 {};              /* size 0x0 */

struct _mips2c_stack_func_809A34E0 {};              /* size 0x0 */

struct _mips2c_stack_func_809A35EC {};              /* size 0x0 */

struct _mips2c_stack_func_809A376C {};              /* size 0x0 */

struct _mips2c_stack_func_809A3A48 {};              /* size 0x0 */

struct _mips2c_stack_func_809A3A74 {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ s32 sp20;                            /* inferred */
    /* 0x24 */ char pad_24[0x4];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809A3BA4 {};              /* size 0x0 */

struct _mips2c_stack_func_809A3BC0 {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ s32 sp20;                            /* inferred */
...
struct _mips2c_stack_func_809A3D1C {};              /* size 0x0 */

struct _mips2c_stack_func_809A3D38 {};              /* size 0x0 */

struct _mips2c_stack_func_809A3E58 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809A3F0C {
...
void func_809A3D38(void *arg0, void *arg1);         /* static */
...
static InitChainEntry D_809A4078[4];                /* unable to generate initializer */
...
void ObjPzlblock_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain((Actor *) this, D_809A4078);
    Actor_SetScale((Actor *) this, 0.1f);
    this->actor.home.rot.y = 0;
    this->actor.shape.rot.x = 0;
    this->actor.shape.rot.z = 0;
    BcCheck3_BgActorInit((DynaPolyActor *) this, 0);
    this->unk_17A = Object_GetIndex(&globalCtx->objectCtx, *sp24);
    if (sp28 == 0) {
        func_809A3D1C(this);
        return;
    }
...
void func_809A3A74(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        phi_a1 = temp_a1;
        if (temp_a3 == phi_v1) {
            phi_v1->unk_16E = (s16) (phi_v1->unk_16E + 1);
        } else {
            temp_a0 = phi_v1->unk_16E;
            if ((s32) temp_a0 > 0) {
                phi_v1->unk_16E = (s16) (temp_a0 - 1);
            }
        }
        phi_v1 += 2;
    } while (temp_a1 != 8);
...
void func_809A3BC0(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Math_StepToF(arg0->unk_164, arg0->unk_168, 2.3f) != 0) {
        ...
        if ((temp_v0 == 4) || (temp_v0 == 5) || (temp_v0 == 6)) {
            if ((func_809A35EC(arg0, (s32) arg0->unk_16C) == 0) || (func_809A33E0(arg0, arg1, 0x5A) != 0)) {
                Audio_PlayActorSound2(arg0, 0x2835U);
            }
        } else if (func_809A35EC(arg0, (s32) arg0->unk_16C) != 0) {
...
void ObjPzlblock_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 15.0f, 30.0f, 0.0f, 4U);
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->unk_17A) != 0) {
        sp2C = ((((s32) this->actor.params >> 0xC) & 1) * 0xC) + &D_809A4060;
        this->actor.objBankIndex = this->unk_17A;
        Actor_SetObjectSegment(globalCtx, (Actor *) this);
        BgCheck3_LoadMesh(globalCtx, (DynaPolyActor *) this, sp2C->unk_4);
...
void func_809A3E58(Actor *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 != 0) && ((Actor_UpdateBgCheckInfo(globalCtx, this, 15.0f, 30.0f, 0.0f, temp_v0), temp_v0_2 = this->unk_15C, (func_809A3A74 == temp_v0_2)) || (func_809A3D38 == temp_v0_2)) && ((this->bgCheckFlags & 1) != 0) && (BgCheck_GetActorOfMesh(&globalCtx->colCtx, (s32) this->floorBgId) == 0)) {
        this->unk_160 = 0U;
    }
}
