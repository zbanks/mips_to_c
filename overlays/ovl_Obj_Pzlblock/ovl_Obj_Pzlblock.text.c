typedef struct ObjPzlblock {
    ...
    /* 0x148 */ char pad148[0x32];                  /* maybe part of unk144[13]? */
    /* 0x17A */ s8 unk17A;                          /* inferred */
    /* 0x17B */ char pad17B[0x1];
...
void ObjPzlblock_Init(ObjPzlblock *this, GlobalContext *globalCtx) {
    s32 sp2C;
    s32 sp28;
    s16 *sp24;
...
void ObjPzlblock_Destroy(ObjPzlblock *this, GlobalContext *globalCtx) {
    ObjPzlblock *this = (ObjPzlblock *) thisx;
...
void ObjPzlblock_Update(ObjPzlblock *this, GlobalContext *globalCtx) {
    void *sp2C;
    ObjPzlblock *this = (ObjPzlblock *) thisx;
