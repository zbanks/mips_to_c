typedef struct EnFamos {
    ...
    /* 0x1D4 */ u8 unk_1D4;                         /* inferred */
    /* 0x1D5 */ s8 unk_1D5;                         /* inferred */
    /* 0x1D6 */ u8 unk_1D6;                         /* inferred */
    /* 0x1D7 */ char pad_1D7[0x1];
    /* 0x1D8 */ s8 unk_1D8;                         /* inferred */
    /* 0x1D9 */ char pad_1D9[0x1];
    /* 0x1DA */ s16 unk_1DA;                        /* inferred */
    /* 0x1DC */ char pad_1DC[0x2];
    /* 0x1DE */ s16 unk_1DE;                        /* inferred */
    /* 0x1E0 */ s16 unk_1E0;                        /* inferred */
    /* 0x1E2 */ s16 unk_1E2;                        /* inferred */
    /* 0x1E4 */ char pad_1E4[0x4];                  /* maybe part of unk_1E2[3]? */
    /* 0x1E8 */ void *unk_1E8;                      /* inferred */
    /* 0x1EC */ f32 unk_1EC;                        /* inferred */
    /* 0x1F0 */ f32 unk_1F0;                        /* inferred */
    /* 0x1F4 */ char pad_1F4[0x18];                 /* maybe part of unk_1F0[7]? */
    /* 0x20C */ ColliderCylinder unk_20C;           /* inferred */
    /* 0x258 */ ColliderCylinder unk_258;           /* inferred */
    /* 0x2A4 */ ColliderJntSph unk_2A4;             /* inferred */
    /* 0x2C4 */ ColliderJntSphElement unk_2C4;      /* inferred */
    /* 0x304 */ char pad_304[0x310];                /* maybe part of unk_2C4[13]? */
} EnFamos;                                          /* size = 0x614 */
...
void EnFamos_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0xFF) {
        ...
        this->unk_1E8 = Lib_SegmentedToVirtual((void *) temp_s0->points);
        temp_t8 = temp_s0->count;
        this->unk_1D6 = temp_t8;
        if ((temp_t8 & 0xFF) == 1) {
            this->unk_1E8 = NULL;
            this->unk_1D6 = 0;
        }
    ...
    SkelAnime_Init(globalCtx, &this->unk_144, &D_06003D38, &D_06003DC8, &this->unk_188, &this->unk_1AC, 6);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_20C, (Actor *) this, &D_808AE600);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_258, (Actor *) this, &D_808AE62C);
    Collider_InitAndSetJntSph(globalCtx, &this->unk_2A4, (Actor *) this, &D_808AE6A0, &this->unk_2C4);
    phi_s0 = D_808AE6B0;
    if (D_808AE6C0 == 0) {
        do {
            temp_s0_2 = phi_s0 + 4;
    ...
    this->unk_1EC = this->actor.world.pos.y;
    if ((s32) temp_v0_2 <= 0) {
        phi_f6 = 200.0f;
    } else {
...
void EnFamos_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnFamos *this = (EnFamos *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_20C);
    Collider_DestroyCylinder(globalCtx, &this->unk_258);
    Collider_DestroyJntSph(globalCtx, &this->unk_2A4);
}
...
void func_808ACB58(Actor *arg0) {
    ...
    do {
        ...
        phi_s0->unk_0 = (f32) ((Math_SinS(temp_s2) * 20.0f) + arg0->world.pos.x);
        phi_s0->unk_4 = (f32) arg0->floorHeight;
        phi_s0->unk_8 = (f32) ((Math_CosS(temp_s2) * 20.0f) + arg0->world.pos.z);
        temp_s4 = phi_s4 + 1;
        temp_s0 = phi_s0 + 0x24;
        temp_s0->unk_-4 = (f32) (Rand_ZeroFloat(0.0015f) + 0.002f);
        phi_s0 = temp_s0;
        phi_s4 = temp_s4;
    } while (temp_s4 != 0x14);
}
...
void func_808ACD2C(void *arg0) {
    ...
    do {
        ...
        temp_f20 = Math_CosS(temp_s1);
        phi_s0->unk_C = (f32) (Math_SinS(temp_s2) * (temp_f22 * temp_f20));
        phi_s0->unk_10 = (f32) ((Math_SinS(temp_s1) * temp_f22) + 4.5f);
        temp_f20_2 = Math_CosS(temp_s1);
        phi_s0->unk_14 = (f32) (Math_CosS(temp_s2) * (temp_f22 * temp_f20_2));
        phi_s0->unk_18 = (s16) (Rand_Next() >> 0x10);
        phi_s0->unk_1A = (s16) (Rand_Next() >> 0x10);
        phi_s0->unk_1C = (s16) (Rand_Next() >> 0x10);
        phi_s0->unk_0 = (f32) ((Math_SinS(temp_s2) * 20.0f) + arg0->unk_24);
        phi_s0->unk_4 = (f32) (randPlusMinusPoint5Scaled(60.0f) + (arg0->unk_28 + 40.0f));
        phi_s0->unk_8 = (f32) ((Math_CosS(temp_s2) * 20.0f) + arg0->unk_2C);
        temp_s4 = phi_s4 + 1;
        temp_s0 = phi_s0 + 0x24;
        temp_s0->unk_-4 = (f32) (Rand_ZeroFloat(0.002f) + 0.0025000002f);
        phi_s0 = temp_s0;
        phi_s4 = temp_s4;
    } while (temp_s4 != 0x14);
}
...
void func_808ACF98(Actor *arg0) {
    ...
    arg0->unk_1DA = (s16) (arg0->unk_1DA - 1);
...
void func_808AD05C(Actor *arg0) {
    ...
    temp_v0 = arg0->unk_2B5;
    if ((temp_v0 & 2) != 0) {
        arg0->unk_2B5 = (u8) (temp_v0 & 0xFFFD);
        if (arg0->unk_1D5 == 1) {
            if (arg0->unk_1D4 != 0) {
                arg0->unk_1D4 = 0U;
...
void func_808AD1F0(Actor *arg0) {
    ...
    temp_a0 = temp_a3;
    if (arg0->unk_1D8 != 0) {
        temp_t8 = arg0->unk_1D7 + 1;
        temp_v0 = temp_t8 & 0xFF;
        arg0->unk_1D7 = temp_t8;
        phi_v0 = temp_v0;
        if (arg0->unk_1D6 == temp_v0) {
            arg0->unk_1D7 = 0U;
            phi_v0 = 0 & 0xFF;
        }
    } else {
...
void func_808AD294(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Math_ScaledStepToS(&arg0->shape.rot.y, arg0->unk_1E4, 0x200) != 0) {
        func_808AD3E8(arg0);
    }
}
...
void func_808AD8B8(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_1DC = (s16) (arg0->unk_1DC - 1);
    if (arg0->unk_1DC == 0) {
        arg0->unk_2B5 = (u8) (arg0->unk_2B5 & 0xFFFE);
    }
    temp_v0 = func_800C9B18(arg1 + 0x830, arg0->floorPoly, (s32) arg0->floorBgId);
    temp_v1 = arg0->bgCheckFlags & 1;
    if ((temp_v1 != 0) || (arg0->floorHeight == -32000.0f) || (temp_v0 == 0xC) || (temp_v0 == 0xD)) {
        arg0->unk_21C = (u8) (arg0->unk_21C & 0xFFFE);
        arg0->unk_268 = (u8) (arg0->unk_268 | 1);
        if (temp_v1 != 0) {
            func_800DFD04((arg1 + (arg1->activeCamera * 4))->unk_800, 2, 0xF, 0xA);
        ...
        arg0->unk_2B5 = (u8) (arg0->unk_2B5 | 1);
        func_808ADB4C(arg0);
        return;
    }
    func_800B9010(arg0, 0x31D7U);
...
void func_808ADAE8(Actor *arg0, ? arg1) {
    ...
    temp_a0 = arg0 + 0x144;
    if (arg0->unk_1DC == 0) {
        arg0->unk_268 = (u8) (arg0->unk_268 & 0xFFFE);
    }
    arg0->unk_1DC = (s16) (arg0->unk_1DC - 1);
    arg0 = arg0;
...
void func_808ADE74(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->world.pos.x = randPlusMinusPoint5Scaled(5.0f) + arg0->unk_1F4;
    temp_v0 = arg0->unk_1DC;
    arg0->world.pos.z = randPlusMinusPoint5Scaled(5.0f) + arg0->unk_1FC;
    if (temp_v0 == 1) {
...
void EnFamos_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_1DE;
    if (((s32) temp_v0 <= 0) || (this->unk_1DE = temp_v0 - 1, func_808AE030(this), (func_808ADFF0 != this->actionFunc))) {
        sp30 = (s32) this->unk_1DA;
        func_808AD05C((Actor *) this);
        temp_v0_2 = this->unk_1E2;
        if ((s32) temp_v0_2 > 0) {
            this->unk_1E2 = temp_v0_2 - 1;
            if (this->unk_1E2 == 0) {
        ...
        if (sp30 != this->unk_1DA) {
            this->unk_1EC += this->actor.world.pos.y - sp34;
        }
        if ((s32) this->unk_1E0 >= 0) {
            Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 35.0f, 30.0f, 80.0f, 0x1FU);
            if ((func_808AD8B8 == this->actionFunc) && (this->unk_1D4 != 0) && ((this->actor.bgCheckFlags & 1) != 0)) {
        ...
        if ((this->unk_20C.base.atFlags & 1) != 0) {
        ...
        if ((this->unk_2A4.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, temp_a1_2, (Collider *) &this->unk_2A4);
        }
        temp_a2 = &this->unk_258;
        if ((this->unk_258.base.atFlags & 1) != 0) {
            sp28 = temp_a2;
            Collider_UpdateCylinder((Actor *) this, temp_a2);
            this->unk_258.dim.pos.y = (s16) (s32) this->actor.floorHeight;
...
void EnFamos_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808ADFF0 != this->actionFunc) {
        AnimatedMat_Draw(globalCtx, (AnimatedMaterial *) D_808AE6B0[this->unk_1D4]);
        SkelAnime_Draw(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, func_808AE304, func_808AE3A8, (Actor *) this);
