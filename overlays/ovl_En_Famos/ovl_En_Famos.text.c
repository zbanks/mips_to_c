...
static ColliderJntSphElementInit D_808AE658 = {
...
static void *D_808AE6B0 = {(void *)0x6003E30, (void *)0x6003E38};
static InitChainEntry D_808AE6B8;                   /* unable to generate initializer */
...
typedef struct EnFamos {
    ...
    /* 0x01D0 */ void (*actionFunc)(EnFamos *, GlobalContext *);
    /* 0x01D4 */ u8 unk1D4;                         /* inferred */
    /* 0x01D5 */ s8 unk1D5;                         /* inferred */
    /* 0x01D6 */ u8 unk1D6;                         /* inferred */
    /* 0x01D7 */ char pad1D7[0x1];                  /* maybe part of unk1D6[2]? */
    /* 0x01D8 */ s8 unk1D8;                         /* inferred */
    /* 0x01D9 */ char pad1D9[0x1];                  /* maybe part of unk1D8[2]? */
    /* 0x01DA */ s16 unk1DA;                        /* inferred */
    /* 0x01DC */ char pad1DC[0x2];                  /* maybe part of unk1DA[2]? */
    /* 0x01DE */ s16 unk1DE;                        /* inferred */
    /* 0x01E0 */ s16 unk1E0;                        /* inferred */
    /* 0x01E2 */ s16 unk1E2;                        /* inferred */
    /* 0x01E4 */ char pad1E4[0x4];                  /* maybe part of unk1E2[3]? */
    /* 0x01E8 */ void *unk1E8;                      /* inferred */
    /* 0x01EC */ f32 unk1EC;                        /* inferred */
    /* 0x01F0 */ f32 unk1F0;                        /* inferred */
    /* 0x01F4 */ char pad1F4[0x18];                 /* maybe part of unk1F0[7]? */
    /* 0x020C */ ColliderCylinder unk20C;           /* inferred */
    /* 0x0258 */ ColliderCylinder unk258;           /* inferred */
    /* 0x02A4 */ ColliderJntSph unk2A4;             /* inferred */
    /* 0x02C4 */ ColliderJntSphElement unk2C4;      /* inferred */
    /* 0x0304 */ char pad304[0x310];
} EnFamos;                                          /* size 0x614 */
...
void EnFamos_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk20C, &this->actor, &D_808AE600);
    Collider_InitAndSetCylinder(globalCtx, &this->unk258, &this->actor, &D_808AE62C);
    Collider_InitAndSetJntSph(globalCtx, &this->unk2A4, &this->actor, &D_808AE6A0, &this->unk2C4);
    phi_s0 = &D_808AE6B0;
    if (D_808AE6C0 == 0) {
        do {
            temp_s0_2 = phi_s0 + 4;
...
void func_808AD18C(Actor *arg0, GlobalContext *arg1) {
    func_808ACF98(arg0);
    if (arg0->unk1D8 != 0) {
        Math_Vec3f_Copy(arg0 + 0x200, &arg0->world.pos);
    }
...
void func_808ADE00(Actor *arg0) {
    ...
    arg0->unk1DC = 0x19;
    Math_Vec3f_Copy(arg0 + 0x1F4, &arg0->world.pos);
    arg0->flags |= 0x10;
...
void func_808ADE74(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 0) {
        Item_DropCollectibleRandom(arg1, arg0, &arg0->world.pos, 0xD0);
        func_808ADFA4(arg0);
        return;
    }
...
void EnFamos_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (((s32) temp_v0 <= 0) || (this->unk1DE = temp_v0 - 1, func_808AE030(this), (func_808ADFF0 != this->actionFunc))) {
        ...
        if ((s32) this->unk1E0 >= 0) {
            Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 35.0f, 30.0f, 80.0f, 0x1FU);
        ...
        if ((this->unk2A4.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, temp_a1_2, &this->unk2A4.base);
        }
        temp_a2 = &this->unk258;
        if ((this->unk258.base.atFlags & 1) != 0) {
            ...
            CollisionCheck_SetAT(globalCtx, sp2C, &temp_a2->base);
        }
    }
}
...
void EnFamos_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808ADFF0 != this->actionFunc) {
        ...
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_808AE304, func_808AE3A8, &this->actor);
        if (this->actor.colorFilterTimer != 0) {
            func_800AE5A0(globalCtx);
        }
    }
    func_808AE3FC(this, &globalCtx->state.gfxCtx);
}
