struct _mips2c_stack_EffectSsLightning_Draw {
    ...
    /* 0x114 */ char pad_114[0x40];
    /* 0x154 */ ? sp154;                            /* inferred */
    /* 0x154 */ char pad_154[0x40];
    /* 0x194 */ ? sp194;                            /* inferred */
    /* 0x194 */ char pad_194[0x44];
};                                                  /* size = 0x1D8 */
...
struct _mips2c_stack_func_8097A794 {
    ...
    /* 0x18 */ ? sp18;                              /* inferred */
    /* 0x18 */ char pad_18[0x50];
    /* 0x68 */ s16 sp68;                            /* inferred */
    /* 0x6A */ char pad_6A[0x2];
...
s32 EffectSsLightning_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    this->life = initParamsx->unk_18;
    this->regs[0] = (s16) initParamsx->unk_C;
    this->regs[1] = (s16) initParamsx->unk_D;
    this->regs[2] = (s16) initParamsx->unk_E;
    this->regs[3] = (s16) initParamsx->unk_F;
    this->regs[4] = (s16) initParamsx->unk_10;
    this->regs[5] = (s16) initParamsx->unk_11;
    this->regs[6] = (s16) initParamsx->unk_12;
    this->regs[7] = (s16) initParamsx->unk_13;
    this->regs[8] = initParamsx->unk_1A;
    this->regs[9] = initParamsx->unk_14;
    this->regs[10] = initParamsx->unk_16;
    this->regs[11] = initParamsx->unk_18;
    phi_s0 = D_8097AC80;
    if (D_8097ACA8 == 0) {
        do {
            temp_s0 = phi_s0 + 4;
