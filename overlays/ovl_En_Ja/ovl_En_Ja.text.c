...
void *func_80BC1B50(GlobalContext *arg0, void *arg1); /* static */
...
s32 func_80BC20D0(EnJa *arg0, u8 *arg2, struct_80133038_arg2 *, EnJa *); /* static */
...
static ActorAnimationEntryS D_80BC3714 = {
...
typedef struct EnJa {
    ...
    /* 0x0188 */ void (*actionFunc)(EnJa *, GlobalContext *);
    ...
    /* 0x01E4 */ char pad1E4[0x20];                 /* maybe part of unk1E0[9]? */
    ...
    /* 0x0234 */ char pad234[0x4C];                 /* maybe part of unk230[20]? */
    /* 0x0280 */ Vec3s unk280;                      /* inferred */
    /* 0x0286 */ char pad286[0x5A];                 /* maybe part of unk280[16]? */
    /* 0x02E0 */ Vec3s unk2E0;                      /* inferred */
    /* 0x02E6 */ char pad2E6[0x5A];                 /* maybe part of unk2E0[16]? */
    /* 0x0340 */ u16 unk340;                        /* inferred */
    /* 0x0342 */ char pad342[0x2];                  /* maybe part of unk340[2]? */
    /* 0x0344 */ f32 unk344;                        /* inferred */
    /* 0x0348 */ char pad348[0xC];                  /* maybe part of unk344[4]? */
    ...
    /* 0x0368 */ void *unk368;                      /* inferred */
    /* 0x036C */ s32 unk36C;                        /* inferred */
    /* 0x0370 */ char pad370[0x8];                  /* maybe part of unk36C[3]? */
} EnJa;                                             /* size 0x378 */
...
Actor *func_80BC1AE0(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 0) {
        arg0->child = temp_v0;
        Math_Vec3f_Copy(&sp24, &temp_v0->world.pos);
        Math_Vec3f_Copy(&sp30, &arg0->world.pos);
        arg0->world.rot.y = Math_Vec3f_Yaw(&sp30, &sp24);
    } else {
        arg0->child = NULL;
    }
    return arg0->child;
...
? func_80BC1B60(EnJa *arg0, GlobalContext *arg1) {
    ...
    Math_ApproachS(arg0 + 0x354, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk358), 4, 0x2AA8);
    ...
    Math_ApproachS(arg0 + 0x358, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk354), 4, 0x2AA8);
...
void func_80BC21A8(EnJa *this, GlobalContext *globalCtx) {
    ...
    phi_a3 = temp_a3;
    phi_a3_2 = temp_a3;
    if ((func_80133038(globalCtx, &D_80BC35F0, &sp18) == 0) || ((temp_a0 = temp_a3, (sp18.unk0 != temp_a3->unk1D8)) && (this = temp_a3, phi_a3 = this, phi_a3_2 = this, (func_80BC20D0(temp_a0, (u8 *) globalCtx, &sp18, temp_a3) == 0)))) {
...
void func_80BC22F4(EnJa *this, GlobalContext *globalCtx) {
    if (func_8010BF58(&this->actor, globalCtx, func_80BC2274(this, globalCtx), this->unk368, &this->unk1DC) != 0) {
        this->unk340 &= 0xFFF7;
...
void EnJa_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk36C = -1;
    func_80BC192C(&this->actor, 0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk18C, &this->actor, &D_80BC36DC);
...
void EnJa_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnJa *this = (EnJa *) thisx;
    func_80BC19FC(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    if (this->unk1D8 != 0) {
        func_80BC1900(this);
        func_80BC1A68(this);
        func_80BC1D70(this, globalCtx);
        func_8013C964(&this->actor, globalCtx, (f32) (this->unk18C.dim.radius + 0x1E), (f32) (this->unk18C.dim.height + 0xA), 0, (s16) (this->unk340 & 7));
        if (this->unk1D8 != 2) {
            Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
            Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 30.0f, 12.0f, 0.0f, 4U);
        }
        func_80BC1984(&this->actor, globalCtx);
    }
    if (this->unk1D8 == 1) {
...
void EnJa_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk1D8 != 0) {
        ...
        func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BC25E0, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80BC2620, func_80BC2B30, &this->actor);
    }
    if (this->unk1D8 == 1) {
