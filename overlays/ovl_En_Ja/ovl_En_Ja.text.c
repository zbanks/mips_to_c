typedef struct EnJa {
    ...
    /* 0x1E0 */ char pad_1E0[0xA0];                 /* maybe part of unk_1DC[41]? */
    /* 0x280 */ Vec3s unk_280;                      /* inferred */
    /* 0x286 */ char pad_286[0x5A];                 /* maybe part of unk_280[16]? */
    /* 0x2E0 */ Vec3s unk_2E0;                      /* inferred */
    /* 0x2E6 */ char pad_2E6[0x5A];                 /* maybe part of unk_2E0[16]? */
    /* 0x340 */ u16 unk_340;                        /* inferred */
    /* 0x342 */ char pad_342[0x1A];                 /* maybe part of unk_340[14]? */
    /* 0x35C */ s16 unk_35C;                        /* inferred */
    /* 0x35E */ char pad_35E[0x4];                  /* maybe part of unk_35C[3]? */
    /* 0x362 */ s16 unk_362;                        /* inferred */
    /* 0x364 */ char pad_364[0x4];                  /* maybe part of unk_362[3]? */
    /* 0x368 */ void *unk_368;                      /* inferred */
    /* 0x36C */ s32 unk_36C;                        /* inferred */
    /* 0x370 */ char pad_370[0x8];                  /* maybe part of unk_36C[3]? */
} EnJa;                                             /* size = 0x378 */
...
void func_80BC1900(EnJa *arg0) {
    arg0->unk_144.animPlaybackSpeed = arg0->unk_344;
...
void func_80BC1984(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_1CE = (s16) ((s32) fabsf(arg0->focus.pos.y - arg0->world.pos.y) + 5);
...
void func_80BC1A68(EnJa *arg0) {
    ...
    temp_v0 = arg0->unk_360;
    if (temp_v0 == 0) {
        phi_v1 = 0;
    } else {
        arg0->unk_360 = temp_v0 - 1;
        phi_v1 = arg0->unk_360;
    }
    if (phi_v1 == 0) {
        arg0->unk_362 += 1;
        if ((s32) arg0->unk_362 >= 4) {
            arg0 = arg0;
            arg0->unk_360 = Rand_S16Offset(0x1E, 0x1E);
            arg0->unk_362 = 0;
        }
    }
}
...
? func_80BC1B60(EnJa *arg0, GlobalContext *arg1) {
    ...
    sp32 = temp_v0;
    Math_ApproachS(arg0 + 0x356, (s16) ((temp_v0 - arg0->unk_35A) - arg0->actor.shape.rot.y), 4, 0x2AA8);
    temp_v1 = arg0->unk_356;
    ...
    Math_ApproachS(arg0 + 0x35A, (s16) ((sp32 - arg0->unk_356) - arg0->actor.shape.rot.y), 4, 0x2AA8);
    temp_v1_2 = arg0->unk_35A;
    ...
    Math_ApproachS(arg0 + 0x354, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk_358), 4, 0x2AA8);
    temp_v1_3 = arg0->unk_354;
    if ((s32) temp_v1_3 < -0x1C70) {
        ...
        arg0->unk_354 = phi_v0_3;
    }
    Math_ApproachS(arg0 + 0x358, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk_354), 4, 0x2AA8);
    temp_v1_4 = arg0->unk_358;
...
? func_80BC1D70(EnJa *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 & 8) != 0) {
        ...
        temp_t9 = phi_a0->unk_340 & 0xFFEF;
        phi_a0->unk_340 = temp_t9;
        phi_a0->unk_340 = temp_t9 | 0x20;
    } else if ((temp_v0 & 0x20) != 0) {
        arg0->unk_340 = temp_v0 & 0xFFDF;
        arg0->unk_354 = 0;
        arg0->unk_356 = 0;
        arg0->unk_358 = 0;
        arg0->unk_35A = 0;
        ...
        temp_v0_3 = arg0->unk_35E;
        if (temp_v0_3 == 0) {
            phi_v1 = 0;
        } else {
            arg0->unk_35E = temp_v0_3 - 1;
            phi_v1 = arg0->unk_35E;
        }
        if (phi_v1 == 0) {
            arg0->unk_35E = 0x14;
...
block_9:
    ...
    arg0->unk_34C = (f32) (arg0->unk_34C + phi_f0);
    temp_f2 = arg0->unk_34C;
    if (temp_f2 < 0.0f) {
        arg0->unk_34C = 0.0f;
    } else {
        if (temp_f2 > 120.0f) {
        ...
        arg0->unk_34C = phi_f0_2;
    }
    sp20 = (s32) temp_t0;
    SysMatrix_InsertTranslation(arg0->unk_34C, 0.0f, 0.0f, 1);
    arg0->unk_374 = (s32) temp_t0;
}
...
void func_80BC21A8(EnJa *this, GlobalContext *globalCtx) {
    ...
    this->unk_35C = gSaveContext.unk_14 + gGameInfo->data[15];
    this = this;
    temp_a3 = this;
    phi_a3 = temp_a3;
    phi_a3_2 = temp_a3;
    if ((func_80133038(globalCtx, &D_80BC35F0, (struct_80133038_arg2 *) &sp18) == 0) || ((temp_a0 = temp_a3, (sp18 != temp_a3->unk_1D8)) && (this = temp_a3, phi_a3 = this, phi_a3_2 = this, (func_80BC20D0(temp_a0, (u8 *) globalCtx, &sp18, temp_a3) == 0)))) {
...
void func_80BC22F4(EnJa *this, GlobalContext *globalCtx) {
    if (func_8010BF58((Actor *) this, globalCtx, func_80BC2274(this, globalCtx), this->unk_368, &this->unk_1DC) != 0) {
        this->unk_340 &= 0xFFF7;
        func_8013AED4(&this->unk_340, 3U, 7U);
        this->unk_1DC = 0;
        this->unk_340 |= 0x10;
...
void EnJa_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_144, &D_0600C240, NULL, &this->unk_280, &this->unk_2E0, 0x10);
    this->unk_36C = -1;
    func_80BC192C((Actor *) this, 0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_18C, (Actor *) this, &D_80BC36DC);
    ...
    func_8013AED4(&this->unk_340, 0U, 7U);
    this->unk_340 |= 0x10;
    this->unk_1D8 = 0;
    this->unk_368 = NULL;
    this->actionFunc = func_80BC21A8;
...
void EnJa_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_1D8 != 0) {
        ...
        func_8013C964((Actor *) this, globalCtx, (f32) (this->unk_18C.dim.radius + 0x1E), (f32) (this->unk_18C.dim.height + 0xA), 0, (s16) (this->unk_340 & 7));
        if (this->unk_1D8 != 2) {
...
void func_80BC2620(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    } else if (((arg4->unk_340 & 0x40) != 0) && (arg1 == 0xB)) {
        sp70 = *arg0;
        SysMatrix_StatePush();
    ...
    if (arg4->unk_1D8 == 1) {
        if ((arg1 == 0xB) && (((temp_f0 = arg4->unk_15C, (temp_f0 >= 0.0f)) && (temp_f0 <= 6.0f)) || ((temp_f0 >= 35.0f) && (temp_f0 <= 47.0f)))) {
            temp_a1 = *arg0;
            sp60 = temp_a1;
            SysMatrix_StatePush();
...
void func_80BC2B30(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    ...
    if (arg1 != 8) {
        if (arg1 == 0xF) {
            ...
            SysMatrix_InsertZRotation_s(arg2->unk_278, 1);
            SysMatrix_StatePush();
            return;
        }
    ...
    Matrix_Scale(arg2->scale.x, arg2->scale.y, arg2->scale.z, 1);
    Matrix_RotateY(arg2->unk_27C, 1U);
    SysMatrix_InsertXRotation_s(arg2->unk_27A, 1);
    SysMatrix_InsertZRotation_s(arg2->unk_27E, 1);
    SysMatrix_StatePush();
}
...
void func_80BC2EA4(Actor *arg0) {
    ...
    sp3C = Math_SinS(arg0->child->unk_BE);
...
void func_80BC3154(EnJa *arg0, void *arg1) {
    ...
    if (((s32) temp_v0 >= 0x12) && ((s32) temp_v0 < 0x53)) {
        ...
        arg1->unk_0 = (f32) (((temp_f2 * arg0->unk_204) + (temp_f0 * arg0->unk_228)) / 65.0f);
        arg1->unk_4 = (f32) (((temp_f2 * arg0->unk_208) + (temp_f0 * arg0->unk_22C)) / 65.0f);
        temp_f0_2 = temp_f0 - 32.5f;
        arg1->unk_8 = (f32) (((temp_f2 * arg0->unk_20C) + (temp_f0 * arg0->unk_230)) / 65.0f);
        arg1->unk_4 = (f32) (arg1->unk_4 + ((-0.11360947f * (temp_f0_2 * temp_f0_2)) + 120.0f));
        return;
    }
    if (((s32) temp_v0 >= 0x66) && ((s32) temp_v0 < 0xBF)) {
        temp_f0_3 = (f32) (temp_v0 - 0x66);
        temp_f2_2 = 89.0f - temp_f0_3;
        arg1->unk_0 = (f32) (((temp_f2_2 * arg0->unk_21C) + (temp_f0_3 * arg0->unk_210)) / 89.0f);
        arg1->unk_4 = (f32) (((temp_f2_2 * arg0->unk_220) + (temp_f0_3 * arg0->unk_214)) / 89.0f);
        temp_f0_4 = temp_f0_3 - 44.5f;
        arg1->unk_8 = (f32) (((temp_f2_2 * arg0->unk_224) + (temp_f0_3 * arg0->unk_218)) / 89.0f);
        arg1->unk_4 = (f32) (arg1->unk_4 + ((-0.08079788f * (temp_f0_4 * temp_f0_4)) + 160.0f));
    }
}
...
void func_80BC32D8(EnJa *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        temp_v0 = phi_s0->unk_E;
        temp_s1 = phi_s1 + 1;
        phi_s1 = temp_s1;
        if (temp_v0 != 0xBF) {
            phi_s0->unk_E = (s16) (temp_v0 + 1);
        } else {
            phi_s0->unk_E = 0;
        }
        phi_s0 += 0x10;
    ...
    temp_s0 = arg0 + 0x144;
    if (func_801378B8(temp_s0, arg0->unk_144.animFrameCount) != 0) {
        temp_v0_2 = arg0->unk_366;
        if ((s32) temp_v0_2 > 0) {
            arg0->unk_366 = temp_v0_2 - 1;
            return;
        }
        arg0->unk_366 = 3;
        return;
    ...
    if (func_801378B8(temp_s0, 34.0f) != 0) {
        temp_v0_3 = arg0->unk_364;
        if ((s32) temp_v0_3 > 0) {
            arg0->unk_364 = temp_v0_3 - 1;
            return;
        }
        arg0->unk_364 = 3;
