...
void DmRavine_Init(DmRavine *this, GlobalContext *globalCtx) {
...
void DmRavine_Destroy(DmRavine *this, GlobalContext *globalCtx) {
    DmRavine *this = (DmRavine *) thisx;
...
void DmRavine_Update(DmRavine *this, GlobalContext *globalCtx) {
    u8 temp_v0;
    DmRavine *this = (DmRavine *) thisx;
...
void DmRavine_Draw(DmRavine *this, GlobalContext *globalCtx) {
    DmRavine *this = (DmRavine *) thisx;
