...
? func_8092CCEC(Actor *arg0, GlobalContext *arg1) {
    ...
    sp3C.unk0 = (s32) temp_a2->x;
    sp3C.unk4 = (s32) temp_a2->y;
    sp3C.unk8 = (s32) temp_a2->z;
    sp30.unk0 = (s32) temp_a1->x;
    sp30.unk4 = (s32) temp_a1->y;
    sp30.unk8 = (s32) temp_a1->z;
    sp28 = temp_a2;
    Math_Vec3f_Copy((Vec3f *) &sp30, temp_a1);
    Math_Vec3f_Copy((Vec3f *) &sp3C, sp28);
    arg0->unk2D6 = Math_Vec3f_Yaw(&D_801D15B0, (Vec3f *) &sp3C);
    arg0->unk2D4 = Math_Vec3f_Yaw(&D_801D15B0, (Vec3f *) &sp30);
    arg0->unk2EC = Math_Vec3f_DistXZ((Vec3f *) &sp30, &D_801D15B0);
...
? func_8092D954(s16 arg0, s16 arg1, void *arg2, s16 *arg3, s32 arg4, s32 arg5) {
    ...
    arg2->unk0 = (s32) sp74.unk0;
    arg2->unk4 = (s32) sp74.unk4;
    arg2->unk8 = (s32) sp74.unk8;
    if (arg4 == 0) {
        if (arg5 != 0) {
            sp70 = arg0;
            sp6E = arg1;
