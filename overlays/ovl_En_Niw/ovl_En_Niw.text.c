...
struct _mips2c_stack_EnNiw_Update {
    ...
    /* 0x58 */ char pad58[0x54];                    /* maybe part of sp54[22]? */
...
void EnNiw_Init(EnNiw *this, GlobalContext *globalCtx) {
    ...
    sp38.unk0 = (s32) D_808934C4.unk0;
    sp38.unk4 = (s32) D_808934C4.unk4;
    sp38.unk8 = (s32) D_808934C4.unk8;
...
void EnNiw_Held(EnNiw *this, GlobalContext *globalCtx) {
    ...
    sp24.unk0 = (s32) D_808934DC.unk0;
    sp24.unk4 = (s32) D_808934DC.unk4;
    sp24.unk8 = (s32) D_808934DC.unk8;
    if (this->unkTimer250 == 0) {
        this->unk29E = 2;
...
void EnNiw_RunAway(EnNiw *this, GlobalContext *globalCtx) {
    ...
    sp38.unk0 = (s32) D_808934E8.unk0;
    sp38.unk4 = (s32) D_808934E8.unk4;
    sp38.unk8 = (s32) D_808934E8.unk8;
