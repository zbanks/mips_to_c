...
void ObjYasi_Init(ObjYasi *this, GlobalContext *globalCtx) {
...
void ObjYasi_Destroy(ObjYasi *this, GlobalContext *globalCtx) {
    ObjYasi *this = (ObjYasi *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->unk144);
}

void ObjYasi_Update(ObjYasi *this, GlobalContext *globalCtx) {
    f32 sp24;
    f32 sp20;
    f32 sp1C;
    f32 temp_f0;
...
void ObjYasi_Draw(ObjYasi *this, GlobalContext *globalCtx) {
    ObjYasi *this = (ObjYasi *) thisx;
