...
static Vec3f D_80A9E030;
static s32 D_80A9E2C8;
static ? D_80A9F6A8;
...
void BgHakuginPost_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->dyna.actor.params & 7) == 7) {
        Actor_ProcessInitChain(&this->dyna.actor, &D_80A9D8F8);
...
void func_80A9CAA8(BgHakuginPost *this, GlobalContext *globalCtx) {
    ...
    sp24 = temp_a3;
    Math_Vec3f_Copy(&temp_a3->pos, &D_80A9E030);
    Math_Vec3f_Copy(&this->dyna.actor.world.pos, &sp24->pos);
    ...
    func_80A9AD18(&this->dyna.actor, globalCtx, &D_80A9E028);
...
void func_80A9CD14(BgHakuginPost *this, GlobalContext *globalCtx) {
    ...
    func_800B8FE8(&this->dyna.actor, 0x210DU);
}
...
void func_80A9D0B4(BgHakuginPost *this, GlobalContext *globalCtx) {
    ...
    func_800B8FE8(&this->dyna.actor, 0x210EU);
}
...
void func_80A9D260(BgHakuginPost *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(temp_a0) != 0) {
        ...
        this = temp_a1;
        ActorCutscene_StartAndSetUnkLinkFields(temp_a0_2, &temp_a1->dyna.actor);
        this->unkFunc(this);
        return;
    }
...
void func_80A9D61C(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SysMatrix_SetStateRotationAndTranslation(thisx->world.pos.x, thisx->world.pos.y, thisx->world.pos.z, &thisx->shape.rot);
