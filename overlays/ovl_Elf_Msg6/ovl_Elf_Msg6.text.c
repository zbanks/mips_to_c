...
void ElfMsg6_Init(ElfMsg6 *this, GlobalContext *globalCtx) {
    ElfMsg6 *temp_a0;
    ElfMsg6 *temp_a2;
    f32 temp_f0;
    s16 temp_v0;
...
void ElfMsg6_Destroy(ElfMsg6 *this, GlobalContext *globalCtx) {
    ElfMsg6 *this = (ElfMsg6 *) thisx;
...
void ElfMsg6_Update(ElfMsg6 *this, GlobalContext *globalCtx) {
    ElfMsg6 *this = (ElfMsg6 *) thisx;
