...
static InitChainEntry D_80BA2300;                   /* unable to generate initializer */
...
s32 func_80BA15A0(void) {
    ...
    if (((gBitFlags->unk0 & temp_v0) != 0) && ((gSaveContext.weekEventReg[87] & 0x10) == 0)) {
        return 1;
    }
    if (((gBitFlags->unk4 & temp_v0) != 0) && ((gSaveContext.weekEventReg[87] & 0x20) == 0)) {
        return 1;
    }
    if (((gBitFlags->unk8 & temp_v0) != 0) && ((gSaveContext.weekEventReg[87] & 0x40) == 0)) {
        return 1;
    }
    if (((gBitFlags->unkC & temp_v0) != 0) && ((gSaveContext.weekEventReg[87] & 0x80) == 0)) {
        return 1;
    }
    return 0;
}
...
s32 func_80BA16F4(ElfMsg6 *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = gSaveContext.inventory.questItems;
    if ((gBitFlags->unk0 & temp_v0) == 0) {
        arg0->actor.textId = 0x256;
        return 0;
    }
    if ((gBitFlags->unk4 & temp_v0) == 0) {
...
void ElfMsg6_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this = this;
    globalCtx = globalCtx;
    Actor_ProcessInitChain(&temp_a0->actor, &D_80BA2300);
    temp_a2 = this;
    temp_v1 = temp_a2->actor.home.rot.x;
    phi_v0 = temp_v1;
    phi_a2 = &temp_a2->actor;
    phi_a2_2 = &temp_a2->actor;
    phi_a2_3 = temp_a2;
    if ((s32) temp_v1 < 0) {
    ...
    case 1:
        ...
        if ((temp_a2->actor.cutscene == -1) || ((temp_a1 = (s32) (temp_a2->actor.params & 0xFE00) >> 9, (temp_a1 != 0x7F)) && (this = temp_a2, phi_a2 = &this->actor, phi_a2_2 = &this->actor, (Flags_GetSwitch(globalCtx, temp_a1) != 0)))) {
    ...
    case 2:
        if (gSaveContext.inventory.items[*gItemSlots] == 0) {
            Actor_MarkForDeath(&temp_a2->actor);
            return;
        }
...
block_35:
    ...
    case 3:
        ...
        if (((temp_a1_2 != 0x7F) && (this = temp_a2, phi_a2_3 = this, phi_a2_4 = &this->actor, (Flags_GetSwitch(globalCtx, temp_a1_2) != 0))) || (phi_a2_4 = &phi_a2_3->actor, ((gSaveContext.weekEventReg[88] & 0x10) != 0)) || ((gSaveContext.weekEventReg[91] & 1) != 0) || (gSaveContext.inventory.items[gItemSlots[0x34]] == 0x34)) {
...
void func_80BA1CF8(ElfMsg6 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        ...
        if ((func_80BA1C00(this) != 0) && (temp_v1->speedXZ > 1.0f)) {
            temp_v1->unkA84 = (s16) -(s32) this->actor.textId;
            ActorCutscene_SetIntentToPlay(0x7C);
            sp20->unk230 = this;
...
void func_80BA2048(ElfMsg6 *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        ...
        temp_v0->unk264 = (u16) (temp_v0->unk264 | 0x20);
