typedef struct EnMk {
    ...
    /* 0x1DA */ char pad1DA[0x48];                  /* maybe part of unk1D4[13]? */
    /* 0x222 */ Vec3s unk222;                       /* inferred */
    /* 0x228 */ char pad228[0x48];                  /* maybe part of unk222[13]? */
    /* 0x270 */ Vec3s unk270;                       /* inferred */
    /* 0x276 */ s16 unk276;                         /* inferred */
    /* 0x278 */ s16 unk278;                         /* inferred */
    /* 0x27A */ u16 unk27A;                         /* inferred */
...
void EnMk_Init(EnMk *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, (Actor *) this, &D_8095A260);
...
void EnMk_Update(EnMk *this, GlobalContext *globalCtx) {
    ...
    if (((this->unk27A & 1) != 0) && (func_800EE29C(globalCtx, 0x7FU) == 0)) {
        func_800E9250(globalCtx, (Actor *) this, &this->unk270, (Vec3s *) &sp38, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        return;
    }
    Math_SmoothStepToS((s16 *) &this->unk270, 0, 6, 0x1838, (s16) 0x64);
...
void EnMk_Draw(EnMk *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_8095A150, func_8095A198, (Actor *) this);
}
