...
s32 EffectSsKakera_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    temp_v1 = initParamsx->unk3C;
    if (temp_v1 != 0) {
        this->gfx = temp_v1;
        temp_a2 = initParamsx->unk3A;
    ...
    this->vec.x = initParamsx->unk18;
    this->vec.y = initParamsx->unk1C;
    this->vec.z = initParamsx->unk20;
    this->regs[0] = initParamsx->unk2C;
    this->regs[1] = initParamsx->unk24;
    this->regs[2] = (s16) (s32) (Rand_ZeroOne() * 32768.0f);
    this->regs[3] = (s16) (s32) (Rand_ZeroOne() * 32768.0f);
    this->regs[4] = initParamsx->unk26;
    this->regs[5] = initParamsx->unk28;
    this->regs[6] = initParamsx->unk2A;
    this->regs[7] = initParamsx->unk2E;
    this->regs[8] = initParamsx->unk30;
    this->regs[9] = initParamsx->unk32;
    this->regs[12] = initParamsx->unk38;
    return 1;
}
...
void EffectSsKakera_Draw(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    if (((((s32) this->regs[4] >> 7) & 1) << 7) == 0x80) {
        ...
        if (sp40 >= 0) {
            ...
            temp_v0_4->words.w0 = temp_v1->unk0 | 0xFA000000;
            temp_v0_4->words.w1 = (temp_v1->unk3 << 8) | (temp_v1->unk1 << 0x18) | (temp_v1->unk2 << 0x10) | 0xFF;
        }
    ...
    if (sp40 >= 0) {
        ...
        temp_v0_7->words.w0 = temp_v1_2->unk0 | 0xFA000000;
        temp_v0_7->words.w1 = (temp_v1_2->unk3 << 8) | (temp_v1_2->unk1 << 0x18) | (temp_v1_2->unk2 << 0x10) | 0xFF;
    }
...
s32 func_8097E420(EffectSs *arg0, f32 *arg1, f32 arg2) {
    ...
    if (temp_v0 != 0) {
        ...
        arg0->accel.x += temp_v1->unk-4 * arg1->unk8 * phi_f0;
        arg0->accel.z -= temp_v1->unk-4 * arg1->unk0 * phi_f0;
    }
    return 1;
}
...
s32 func_8097E4F0(EffectSs *arg0, f32 *arg1, f32 arg2) {
    ...
    if (temp_v0 != 0) {
        ...
        arg0->accel.x -= arg1->unk0 * temp_v1->unk-4 * phi_f0;
        arg0->accel.z -= arg1->unk8 * temp_v1->unk-4 * phi_f0;
    }
    return 1;
}
...
void func_8097E7E0(Vec3f *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk50 == 0) {
        ...
        if (((((s32) temp_v1 >> 4) & 1) * 0x10) == 0x10) {
            if (arg0->y <= (temp_v0->floorHeight - (f32) (((s32) temp_v1 >> 2) & 3))) {
                arg0->unk52 = 0;
                temp_v0_2 = arg0->unk52;
                arg0->unk40 = 0;
                arg0->unk48 = (s16) (temp_v1 & 0xFF9F);
                arg0->unk20 = 0.0f;
                arg0->unk1C = 0.0f;
                arg0->unk18 = 0.0f;
                arg0->unk14 = 0.0f;
                arg0->unk10 = 0.0f;
                arg0->unkC = 0.0f;
                arg0->unk4A = temp_v0_2;
                arg0->unk42 = temp_v0_2;
                return;
            }
    ...
    if (temp_v0_3 != 0) {
        ...
        if ((arg0->unk10 < 0.0f) && (func_800C5A20(arg1 + 0x830, arg0, *(&D_8097EB64 + ((((s32) temp_v1_2 >> 2) & 3) * 4))) != 0) && (arg0->unkC = (f32) (arg0->unkC * func_8097DE30(0.9f, 0.2f)), arg0->unk10 = (f32) (arg0->unk10 * -0.8f), temp_v0_4 = arg0->unk50, arg0->unk14 = (f32) (arg0->unk14 * func_8097DE30(0.9f, 0.2f)), ((s32) temp_v0_4 > 0))) {
            arg0->unk50 = (s16) (temp_v0_4 - 1);
            return;
        }
        // Duplicate return node #17. Try simplifying control flow for better match
        return;
...
void EffectSsKakera_Update(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    func_8097E7E0(&this->pos, globalCtx);
    if (this->regs[10] != -1) {
