...
void EnBh_Init(EnBh *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
...
void EnBh_Destroy(EnBh *this, GlobalContext *globalCtx) {
    EnBh *this = (EnBh *) thisx;
...
void func_80C22DEC(EnBh *arg0, GlobalContext *arg1) {
    ...
    sp32 = phi_v1;
    Math_ApproachS((s16 *) &arg0->actor.world.rot, sp36, 0xA, arg0->unk1E0);
...
void EnBh_Update(EnBh *this, GlobalContext *globalCtx) {
    EnBh *temp_a0;
    EnBh *temp_a2;
    s16 temp_v0;
    s16 temp_v0_2;
...
void EnBh_Draw(EnBh *this, GlobalContext *globalCtx) {
    EnBh *this = (EnBh *) thisx;
