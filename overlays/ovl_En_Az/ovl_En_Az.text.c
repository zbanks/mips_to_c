...
s32 func_8013E054(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1); /* extern */
s32 func_8013E07C(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1); /* extern */
void func_80A94A30(Actor *arg0);                    /* static */
void func_80A94A64(Actor *arg0);                    /* static */
s32 func_80A94A90(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1); /* static */
...
void func_80A954AC(Actor *arg0);                    /* static */
...
extern ? D_0601ABF0;
extern ? D_0601AD00;
static struct_80B8E1A8 D_80A99010 = {
...
static InitChainEntry D_80A99140;                   /* unable to generate initializer */
static ? D_80A9914C;                                /* unable to generate initializer */
static ? D_80A9915C;                                /* unable to generate initializer */
static u32 D_80A9916C = {0x601A600, 0x601A730, 0x601A860, 0x601A990, 0x601AAC0};
static void *D_80A99180 = {
    (void *)0x601A6E8,
    (void *)0x601A818,
    (void *)0x601A948,
    (void *)0x601AA78,
...
typedef struct EnAz {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnAz *, GlobalContext *);
    /* 0x0148 */ SkelAnime unk148;                  /* inferred */
    /* 0x018C */ ColliderCylinder unk18C;           /* inferred */
    /* 0x01D8 */ Vec3s unk1D8;                      /* inferred */
    /* 0x01DE */ char pad1DE[0x8A];                 /* maybe part of unk1D8[24]? */
    /* 0x0268 */ Vec3s unk268;                      /* inferred */
    /* 0x026E */ char pad26E[0x8A];                 /* maybe part of unk268[24]? */
    /* 0x02F8 */ s16 unk2F8;                        /* inferred */
    /* 0x02FA */ s16 unk2FA;                        /* inferred */
    /* 0x02FC */ s32 unk2FC;                        /* inferred */
    /* 0x0300 */ EnDno_ActorUnkStruct unk300;       /* inferred */
    /* 0x036C */ char pad36C[0x8];
    /* 0x0374 */ u16 unk374;                        /* inferred */
    /* 0x0376 */ u16 unk376;                        /* inferred */
    /* 0x0378 */ u8 unk378;                         /* inferred */
    /* 0x0379 */ char pad379[0x1];                  /* maybe part of unk378[2]? */
    /* 0x037A */ s16 unk37A;                        /* inferred */
    /* 0x037C */ char pad37C[0x2];                  /* maybe part of unk37A[2]? */
    /* 0x037E */ s16 unk37E;                        /* inferred */
    /* 0x0380 */ s16 unk380;                        /* inferred */
    /* 0x0382 */ char pad382[0x2];                  /* maybe part of unk380[2]? */
    /* 0x0384 */ s16 unk384;                        /* inferred */
    /* 0x0386 */ char pad386[0x2];                  /* maybe part of unk384[2]? */
    /* 0x0388 */ Actor *unk388;                     /* inferred */
    /* 0x038C */ char pad38C[0x10];                 /* maybe part of unk388[5]? */
    /* 0x039C */ s16 unk39C;                        /* inferred */
    /* 0x039E */ s16 unk39E;                        /* inferred */
    /* 0x03A0 */ char pad3A0[0x14];                 /* maybe part of unk39E[11]? */
    /* 0x03B4 */ f32 unk3B4;                        /* inferred */
    /* 0x03B8 */ f32 unk3B8;                        /* inferred */
    /* 0x03BC */ f32 unk3BC;                        /* inferred */
    /* 0x03C0 */ s16 unk3C0;                        /* inferred */
    /* 0x03C2 */ char pad3C2[0xA];                  /* maybe part of unk3C0[6]? */
    /* 0x03CC */ s32 unk3CC;                        /* inferred */
    /* 0x03D0 */ s16 unk3D0;                        /* inferred */
    /* 0x03D2 */ u16 unk3D2;                        /* inferred */
...
void EnAz_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp54 = this;
    Actor_ProcessInitChain(&this->actor, &D_80A99140);
    ...
    func_8013E3B8(&this->actor, (s16 []) &this->unk3D0, 1);
    if (D_80A9913C == 0) {
        D_80A9913C = this;
        this->unk374 |= 1;
    }
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk18C, &this->actor, &D_80A99110);
    if ((this->unk374 & 2) != 0) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 0.0f, 0.0f, 0.0f, 5U);
...
s32 func_80A95730(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1) {
    ...
    if ((arg1->unk_4C < temp_f12) || ((bitwise f32) func_80A954AC(temp_s0) <= 0.0f)) {
        ...
        Math_SmoothStepToS(temp_s0 + 0x39E, temp_s0->world.rot.x, 2, sp32, (s16) 0);
        Math_SmoothStepToS(temp_s0 + 0xBE, temp_s0->world.rot.y, 2, sp2E, (s16) 0);
    }
...
s32 func_80A958B0(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1) {
    ...
    if ((arg1->unk_4C < temp_f12) || ((bitwise f32) func_80A954AC(temp_s0) <= 0.0f)) {
        ...
        sp28 = (s32) temp_a3;
        Math_SmoothStepToS(temp_s0 + 0x32, arg1->unk_56, 1, temp_a3, (s16) 0);
        Math_SmoothStepToS(temp_s0 + 0x39E, temp_s0->world.rot.x, 2, sp2E, (s16) 0);
        Math_SmoothStepToS(temp_s0 + 0xBE, temp_s0->world.rot.y, 2, sp2A, (s16) 0);
    }
    arg1->unk_64 = func_8013E07C;
    return sp50;
}
...
void func_80A95CEC(EnAz *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk374 & 0x8000) != 0) {
        ...
        if (func_8013E2D4(&this->actor, 0x7C, (s32) this->unk3D0, 1) != 0) {
            func_80A97C0C(this, globalCtx);
        }
    ...
    if (this->actor.yDistToWater > 8.0f) {
        if ((this->unk374 & 2) != 0) {
            ...
            if ((temp_f0 < this->unk148.animPlaybackSpeed) && (temp_f0 >= 0.0f)) {
                Audio_PlayActorSound2(&this->actor, 0x2909U);
            }
        } else {
            func_800B9010(&this->actor, 0x2108U);
        }
    }
...
void func_80A95FE8(EnAz *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->unk3D0) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields(this->unk3D0, &this->actor);
    } else {
        ActorCutscene_SetIntentToPlay(this->unk3D0);
    }
    temp_a1 = &this->actor.home;
    sp28 = temp_a1;
    if (Actor_DistanceToPoint(&this->actor, &temp_a1->pos) > 20.0f) {
        func_800B9010(&this->actor, 0x2108U);
        func_800BE33C(&this->actor.world.pos, &sp28->pos, &this->actor.world.rot, 0);
        Math_SmoothStepToS(&this->actor.shape.rot.x, this->actor.world.rot.x, 3, 0xE38, (s16) 0x38E);
    ...
    Math_SmoothStepToS(&this->actor.shape.rot.x, 0, 3, 0x1000, (s16) 0x100);
...
void func_80A97410(EnAz *arg0, GlobalContext *arg1) {
    ...
    if ((phi_v1 == 6) || (phi_v1 == 7)) {
        if (Actor_HasParent(&arg0->actor, arg1) != 0) {
            ...
            func_800B8A1C(&arg0->actor, arg1, arg0->unk3CC, arg0->actor.xzDistToPlayer, arg0->actor.yDistToPlayer);
        }
...
block_33:
            ...
            func_801518B0(arg1, arg0->unk3D2, &arg0->actor);
            arg0->unk378 = 2;
    ...
    if (((phi_v1_2 == 0) || (phi_v1_2 == 1)) && (temp_v0_6 = arg0->unk374, ((temp_v0_6 & 0x20) != 0))) {
        if (phi_v1_2 == 1) {
            ...
            if (func_800B8500(&arg0->actor, arg1, arg0->actor.xzDistToPlayer, arg0->actor.yDistToPlayer, -1) != 0) {
        ...
        if ((arg0->unk2FA == 0) && ((temp_v0_6 & 2) == 0)) {
            ...
            Math_Vec3f_Copy(&sp38, &sp44->world.pos);
            sp38.y = sp44->unkC44 + 3.0f;
            temp_v0_7 = Math_Vec3f_Pitch(&arg0->actor.focus.pos, &sp38);
            if (temp_v0_7 >= 0) {
        ...
        func_800B8898(arg1, &arg0->actor, &sp56, &sp54);
        if (((s32) sp56 >= 0) && ((s32) sp56 < 0x141) && ((s32) sp54 >= 0) && ((s32) sp54 < 0xF1) && (func_800B8500(&arg0->actor, arg1, 120.0f, 120.0f, 0) != 0)) {
...
void func_80A97A40(EnAz *this, GlobalContext *globalCtx) {
    if (func_8013E2D4(&this->actor, 0, -1, 0) != 0) {
...
void EnAz_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk374 & 0x200) != 0) {
        Audio_PlayActorSound2(&this->actor, 0x2889U);
    }
...
void EnAz_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk374 & 2) != 0) {
        SkelAnime_DrawSV(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, func_80A98DA4, func_80A98E48, &this->actor);
    } else {
