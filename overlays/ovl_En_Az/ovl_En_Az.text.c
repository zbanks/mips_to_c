typedef struct EnAz {
    ...
    /* 0x300 */ EnDno_ActorUnkStruct unk_300;       /* inferred */
    /* 0x36C */ char pad_36C[0x8];
    /* 0x374 */ u16 unk_374;                        /* inferred */
    /* 0x376 */ u16 unk_376;                        /* inferred */
    /* 0x378 */ u8 unk_378;                         /* inferred */
    /* 0x379 */ char pad_379[0x1];
    /* 0x37A */ s16 unk_37A;                        /* inferred */
    /* 0x37C */ char pad_37C[0x2];
    /* 0x37E */ s16 unk_37E;                        /* inferred */
    /* 0x380 */ s16 unk_380;                        /* inferred */
    /* 0x382 */ char pad_382[0x2];
    /* 0x384 */ s16 unk_384;                        /* inferred */
    /* 0x386 */ char pad_386[0x2];
    /* 0x388 */ Actor *unk_388;                     /* inferred */
    /* 0x38C */ char pad_38C[0x10];                 /* maybe part of unk_388[5]? */
    /* 0x39C */ s16 unk_39C;                        /* inferred */
    /* 0x39E */ s16 unk_39E;                        /* inferred */
    /* 0x3A0 */ char pad_3A0[0x14];                 /* maybe part of unk_39E[11]? */
    /* 0x3B4 */ f32 unk_3B4;                        /* inferred */
    /* 0x3B8 */ f32 unk_3B8;                        /* inferred */
    /* 0x3BC */ f32 unk_3BC;                        /* inferred */
    /* 0x3C0 */ char pad_3C0[0xC];                  /* maybe part of unk_3BC[4]? */
    /* 0x3CC */ s32 unk_3CC;                        /* inferred */
    /* 0x3D0 */ s16 unk_3D0;                        /* inferred */
    /* 0x3D2 */ u16 unk_3D2;                        /* inferred */
...
typedef struct EnDno_ActorUnkStruct {
    ...
    /* 0x0C */ char pad_C[0x4];
    /* 0x10 */ s16 unk_10;
    /* 0x12 */ char pad_12[0xA];                    /* maybe part of unk_10[6]? */
    /* 0x1C */ u8 unk_1C;
    /* 0x1D */ u8 unk_1D;
...
struct _mips2c_stack_EnAz_Init {
    ...
    /* 0x40 */ char pad_40[0xE];                    /* maybe part of sp3C[4]? */
...
void EnAz_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_2F8 = *(&D_80A9915C + (temp_a0 * 2));
    if (temp_a0_2 >= 0) {
    ...
    func_8013E3B8((Actor *) this, (s16 []) &this->unk_3D0, 1);
    if (D_80A9913C == 0) {
        D_80A9913C = this;
        this->unk_374 |= 1;
    }
    ...
    if ((this->unk_374 & 2) != 0) {
        sp34 = temp_a1;
        SkelAnime_InitSV(globalCtx, temp_a1, &D_06007438, &D_0600C94C, &this->unk_1D8, &this->unk_268, 0x18);
        Actor_SetScale((Actor *) this, 0.012f);
    } else {
        temp_a1_2 = &this->unk_148;
        sp34 = temp_a1_2;
        SkelAnime_InitSV(globalCtx, temp_a1_2, &D_06017990, &D_0600C94C, &this->unk_1D8, &this->unk_268, 0x18);
    }
    Collider_InitAndSetCylinder(globalCtx, &this->unk_18C, (Actor *) this, &D_80A99110);
    if ((this->unk_374 & 2) != 0) {
        this->unk_18C.dim.radius = (s16) (s32) ((f32) this->unk_18C.dim.radius * 1.2f);
        this->unk_18C.dim.height = (s16) (s32) ((f32) this->unk_18C.dim.height * 1.2f);
        this->unk_18C.dim.yShift = (s16) (s32) ((f32) this->unk_18C.dim.yShift * 1.2f);
    }
    ...
    func_8013E1C8(sp34, (struct_80B8E1A8 []) D_80A99010, 0, &this->unk_2FC);
    ...
    if (temp_v0_6 != 0x8E00) {
        if (temp_v0_6 != 0x8E10) {
            if (temp_v0_6 != 0x8E20) {
                ...
                if (this->unk_2FA == 2) {
                    temp_v1 = this->unk_374;
                    if ((temp_v1 & 2) == 0) {
                        this->unk_374 = temp_v1 | 0x20;
                        this->actor.flags |= 0x10009;
                        goto block_84;
                    }
                    this->actor.flags |= 9;
                    ...
                    temp_v1_2 = this->unk_374;
                    if ((temp_v1_2 & 2) != 0) {
                        this->unk_374 = temp_v1_2 | 0x20;
                        this->actor.flags |= 0x10009;
                    } else {
                        this->actor.flags |= 9;
                    }
block_84:
        ...
        if ((gSaveContext.weekEventReg[93] & 1) != 0) {
            temp_v1_3 = this->unk_374;
            this->unk_2FA = 5;
            if ((temp_v1_3 & 2) != 0) {
                this->unk_374 = temp_v1_3 | 0x20;
                this->actor.flags |= 9;
            }
        } else {
            this->unk_2FA = 0;
    ...
    if ((s32) sp4E >= 0) {
        this->unk_388 = NULL;
loop_87:
        temp_v0_7 = func_ActorCategoryIterateById(globalCtx, this->unk_388, 4, 0x18D);
        this->unk_388 = temp_v0_7;
        if (temp_v0_7 != 0) {
            if (sp4E != (((s32) temp_v0_7->params >> 8) & 0xF)) {
                this->unk_388 = temp_v0_7->next;
                goto block_90;
            }
        } else {
block_90:
...
void func_80A954AC(void *arg0) {
    ...
    temp_a0 = &sp28;
    temp_a1 = &sp1C;
    sp28 = arg0->unk_320 - arg0->unk_24;
    sp2C = arg0->unk_324 - arg0->unk_28;
    sp30 = arg0->unk_328 - arg0->unk_2C;
    sp1C = arg0->unk_320 - arg0->unk_338;
    sp20 = arg0->unk_324 - arg0->unk_33C;
    sp24 = arg0->unk_328 - arg0->unk_340;
...
s32 func_80A9565C(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1) {
    ...
    temp_s0->unk_374 = (u16) (temp_s0->unk_374 | 0x2000);
...
s32 func_80A958B0(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1) {
    ...
    sp50 = 0;
    temp_s0->gravity = 0.0f;
    if (*(&D_80A99E90 + (temp_s0->unk_2F8 * 4)) <= D_80A99E8C) {
        if ((temp_s0->unk_374 & 2) != 0) {
            phi_f0 = 480.0f;
        } else {
            phi_f0 = 240.0f;
        }
...
s32 func_80A95B34(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1) {
    ...
    if ((temp_v0 & 0x100) != 0) {
        if ((temp_v0 & 8) == 0) {
            ...
            temp_s0->unk_374 = (u16) (temp_s0->unk_374 | 8);
        }
        ...
        if ((temp_v0 & 8) != 0) {
            ...
            temp_s0->unk_374 = (u16) (temp_s0->unk_374 & 0xFFF7);
        }
...
void func_80A95CEC(EnAz *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_374 & 0x8000) != 0) {
        ...
        if (func_8013E2D4((Actor *) this, 0x7C, (s32) this->unk_3D0, 1) != 0) {
            func_80A97C0C(this, globalCtx);
        }
...
void func_80A95E88(EnAz *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.yDistToWater > 8.0f) {
        if ((this->unk_374 & 2) != 0) {
            temp_f0 = this->unk_148.animCurrentFrame;
            if ((temp_f0 < this->unk_148.animPlaybackSpeed) && (temp_f0 >= 0.0f)) {
...
void func_80A95FE8(EnAz *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->unk_3D0) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields(this->unk_3D0, (Actor *) this);
    } else {
    ...
    func_8013E1C8(sp2C, (struct_80B8E1A8 []) D_80A99010, 0, &this->unk_2FC);
    this->unk_374 &= 0xEFFF;
    this->actor.gravity = -1.0f;
...
s32 func_80A9617C(EnAz *arg0, GlobalContext *arg1) {
    ...
    case 5:                                         /* switch 1 */
    case 6:                                         /* switch 1 */
        if ((arg1->msgCtx.unk11F04 == 0x10DD) && ((arg0->unk_374 & 0x8000) != 0)) {
            sp34 = 2;
            if (func_8013E2D4(sp30, sp30->unk_3D0, 0x7C, 1) != 0) {
                sp30->unk_374 = (u16) (sp30->unk_374 | 0x8000);
                ...
                if ((s32) temp_v0_2 >= 0xCE) {
                    ...
                    case 4344:                      /* switch 2 */
                        if (arg1->msgCtx.choiceIndex == 0) {
                            ...
                            sp34 = 3;
                            func_8013E1C8(&arg0->unk_148, (struct_80B8E1A8 []) D_80A99010, 5, &arg0->unk_2FC);
                        } else {
                            sp34 = 3;
                            func_8019F230();
...
u16 func_80A97274(EnAz *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_374 & 0x4000) != 0) {
        return 0x10D7U;
    }
    temp_t8 = arg0->unk_2FA;
    switch (temp_t8) {
    default:
        gSaveContext.weekEventReg[24] &= 0xFB;
...
void func_80A97410(EnAz *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk_378 != 0) {
        if ((arg0->unk_2FA == 0) && ((arg0->unk_374 & 2) == 0)) {
        ...
        if (temp_v0 != 0) {
            ...
            temp_v0_2 = arg0 + 0x24;
            if ((arg0->unk_374 & 0x40) != 0) {
                temp_v0_3 = arg0 + 0x24;
                arg0->actor.focus.pos.x = (temp_v0_3->unk_0 * 0.5f) + (temp_v1->unk_0 * 0.5f);
                arg0->actor.focus.pos.y = (temp_v0_3->unk_4 * 0.5f) + (temp_v1->unk_4 * 0.5f) + 45.0f;
                arg0->actor.focus.pos.z = (temp_v0_3->unk_8 * 0.5f) + (temp_v1->unk_8 * 0.5f);
            } else {
                arg0->actor.focus.pos.x = (temp_v0_2->unk_0 * 0.7f) + (temp_v1->unk_0 * 0.3f);
                arg0->actor.focus.pos.y = (temp_v0_2->unk_4 * 0.7f) + (temp_v1->unk_4 * 0.3f) + 45.0f;
                arg0->actor.focus.pos.z = (temp_v0_2->unk_8 * 0.7f) + (temp_v1->unk_8 * 0.3f);
            }
        } else {
            temp_v0_4 = arg0 + 0x24;
            arg0->actor.focus.pos.x = temp_v0_4->unk_0;
            arg0->actor.focus.pos.y = temp_v0_4->unk_4;
            arg0->actor.focus.pos.z = temp_v0_4->unk_8;
        }
    ...
    if ((phi_v1 == 6) || (phi_v1 == 7)) {
        if (Actor_HasParent((Actor *) arg0, arg1) != 0) {
            ...
            func_800B8A1C((Actor *) arg0, arg1, arg0->unk_3CC, arg0->actor.xzDistToPlayer, arg0->actor.yDistToPlayer);
        }
        phi_v1_2 = arg0->unk_378;
    }
    if (phi_v1_2 == 9) {
...
block_33:
            ...
            func_801518B0(arg1, arg0->unk_3D2, (Actor *) arg0);
            arg0->unk_378 = 2;
            arg0->actor.textId = arg0->unk_3D2;
            return;
        }
        /* Duplicate return node #69. Try simplifying control flow for better match */
        return;
    }
    if (((phi_v1_2 == 0) || (phi_v1_2 == 1)) && (temp_v0_6 = arg0->unk_374, ((temp_v0_6 & 0x20) != 0))) {
        if (phi_v1_2 == 1) {
        ...
        if ((arg0->unk_2FA == 0) && ((temp_v0_6 & 2) == 0)) {
...
void func_80A97C4C(EnAz *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = &this->unk_148;
    sp24 = temp_a0;
    if ((SkelAnime_FrameUpdateMatrix(temp_a0) != 0) && (this->unk_2FC == 0xB)) {
        func_8013E1C8(temp_a0, (struct_80B8E1A8 []) D_80A99010, 0, &this->unk_2FC);
    }
    func_80A97410(this, globalCtx);
    temp_v0 = this->unk_2FA;
...
void func_80A97F9C(EnAz *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_v1;
    D_80A99E8C = Math3D_XZDistanceSquared(temp_v1->world.pos.x, temp_v1->world.pos.z, D_80A99E80.unk_0, D_80A99E80.unk_8);
    if (Math3D_XZDistanceSquared(this->actor.world.pos.x, this->actor.world.pos.z, D_80A99E80.unk_0, D_80A99E80.unk_8) >= 1000000.0f) {
        this->unk_374 |= 0x1000;
    }
    if ((this->unk_300.unk_1C & 0x20) == 0) {
        func_8013DE04(globalCtx, &this->unk_300, func_80A982E0, func_80A95B34, func_8013E054, func_8013E0A4);
    }
    if (((this->unk_374 & 0x10) == 0) && (func_800C9B90(&globalCtx->colCtx, this->actor.floorPoly, (s32) this->actor.floorBgId) != 0)) {
        this->unk_374 |= 0x10;
    }
...
void func_80A982E0(GlobalContext *arg0, EnDno_ActorUnkStruct *arg1) {
    ...
    temp_v1 = arg1->unk_48;
    temp_v0 = (bitwise s32) arg1->unk_00.z + (arg1->unk_10 * 6);
    arg1->unk_20.x = (f32) temp_v0->unk_0;
    if ((temp_v1->bgCheckFlags & 1) != 0) {
        arg1->unk_20.y = (f32) temp_v0->unk_2;
    } else {
        arg1->unk_20.y = (f32) temp_v0->unk_2 - temp_v1->unk_3A4;
    }
    arg1->unk_20.z = (f32) temp_v0->unk_4;
    sp28 = arg1->unk_20.x - arg1->unk_44->unk_0;
    sp2C = arg1->unk_20.y - arg1->unk_44->unk_4;
    sp30 = arg1->unk_20.z - arg1->unk_44->unk_8;
    ...
    if (temp_s0 != 0) {
        do {
            if ((phi_s0->id == 0x17) && ((s32) phi_s0->params < 0) && (arg0->room == phi_s0->room) && (Math3D_DistanceSquared(arg0 + 0x24, phi_s0 + 0x24) < 40000.0f)) {
                phi_s0->unk_276 = 0x14;
                phi_s0->unk_274 = Actor_YawBetweenActors(phi_s0, arg0);
            }
...
void EnAz_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_t7 = this->unk_374 & ~0x100;
    this->unk_374 = temp_t7;
    if (((this->actor.bgCheckFlags & 0x20) != 0) && (this->actor.yDistToWater > 22.0f)) {
        if ((this->unk_376 & 0x100) == 0) {
            this->unk_374 = temp_t7 | 0x200;
        }
        this->unk_374 |= 0x100;
    } else if ((this->unk_376 & 0x100) != 0) {
        this->unk_374 |= 0x400;
    }
    this->actionFunc(this, globalCtx);
    Actor_SetHeight((Actor *) this, 40.0f);
    if ((this->unk_374 & 0x200) != 0) {
        Audio_PlayActorSound2((Actor *) this, 0x2889U);
    }
    if ((this->unk_374 & 0x400) != 0) {
        Audio_PlayActorSound2((Actor *) this, 0x288AU);
    }
    this->unk_37E += 1;
    if ((s32) this->unk_37E >= 4) {
        this->unk_37E = 0;
    }
    this->unk_380 += 1;
    if ((s32) this->unk_380 >= 3) {
        this->unk_380 = 0;
    }
    this->unk_384 += -1;
    if ((s32) this->unk_384 < 0) {
        this->unk_384 = 2;
    }
    this->unk_39C += 1;
    if ((s32) this->unk_39C >= 0x10) {
        this->unk_39C = 0;
    }
    ...
    temp_v0 = this->unk_374;
    temp_t1 = temp_v0 & ~0x600;
    this->unk_374 = temp_t1;
    this->unk_376 = temp_v0;
    if ((globalCtx->cameraPtrs[globalCtx->activeCamera]->flags2 & 0x100) != 0) {
        this->unk_374 = temp_t1 | 0x800;
        return;
    }
    this->unk_374 &= 0xF7FF;
}
...
void EnAz_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->actor.yDistToWater >= 28.0f) && (this->actor.speedXZ > 0.5f)) {
        SysMatrix_InsertTranslation(this->unk_3B4, this->unk_3B8, this->unk_3BC, 0);
        ...
        if ((this->unk_374 & 2) != 0) {
            ...
            do {
                SysMatrix_StatePush();
                func_80A98F94(phi_s3, (f32) this->unk_39C, &sp94);
                ...
                func_80124618(phi_s5, (f32) this->unk_39C, &sp98);
        ...
        SysMatrix_InsertZRotation_s((s16) (s32) ((&D_80A993D0 + (this->unk_384 * 0xC))->unk_8 * 182.04445f), 1);
        temp_v0_7 = (this->unk_384 * 0xC) + &D_80A993AC;
...
void func_80A98F94(void *arg0, f32 arg1, f32 *arg2) {
    ...
    do {
        temp_a0 = phi_a0 + 8;
        temp_f0 = (f32) phi_a0->unk_8;
        phi_a0 = temp_a0;
    } while (temp_f0 < arg1);
    temp_f14 = temp_a0->unk_-4;
    temp_f2 = (f32) temp_a0->unk_-8;
    *arg2 = (((temp_a0->unk_4 - temp_f14) * ((arg1 - temp_f2) / (temp_f0 - temp_f2))) + temp_f14) * 0.01f;
}
