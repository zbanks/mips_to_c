...
void EnInvisibleRuppe_Init(EnInvisibleRuppe *this, GlobalContext *globalCtx) {
    ColliderCylinder *sp24;
...
void EnInvisibleRuppe_Destroy(EnInvisibleRuppe *this, GlobalContext *globalCtx) {
    EnInvisibleRuppe *this = (EnInvisibleRuppe *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk144);
}

void EnInvisibleRuppe_Update(EnInvisibleRuppe *this, GlobalContext *globalCtx) {
    EnInvisibleRuppe *this = (EnInvisibleRuppe *) thisx;
