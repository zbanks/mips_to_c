...
typedef struct BgDanpeiMovebg {
    ...
    /* 0x160 */ EnDno_ActorUnkStruct unk160;        /* inferred */
    /* 0x1CC */ u16 unk1CC;                         /* inferred */
    /* 0x1CE */ u16 unk1CE;                         /* inferred */
...
void BgDanpeiMovebg_Init(BgDanpeiMovebg *this, GlobalContext *globalCtx) {
    ...
    if (func_8013D8DC(arg0->unk1D4, arg1) != 0) {
        *(gSegments + 0x18) = (u32) (arg1->objectCtx.status[arg0->unk1D4].segment + 0x80000000);
        ...
        if ((((s32) arg0->actor.params >> 0xE) & 3) == 0) {
            ...
            func_8013DCE0(arg1, (Vec3f *) &arg0->actor.world, (Actor *) arg0, &arg0->unk160, arg1->setupPathList, arg0->actor.params & 0x7F, 0, 0, 0, 0);
            arg0->actionFunc = func_80AF70FC;
        }
    }
}

void BgDanpeiMovebg_Destroy(BgDanpeiMovebg *this, GlobalContext *globalCtx) {
    BgDanpeiMovebg *this = (BgDanpeiMovebg *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->unk144);
}

void BgDanpeiMovebg_Update(BgDanpeiMovebg *this, GlobalContext *globalCtx) {
    u16 temp_v0;
    BgDanpeiMovebg *this = (BgDanpeiMovebg *) thisx;
