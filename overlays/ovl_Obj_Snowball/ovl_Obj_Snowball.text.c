typedef struct ObjSnowball {
    ...
    /* 0x1A8 */ char pad1A8[0x64];                  /* maybe part of actionFunc[26]? */
    /* 0x20C */ f32 unk20C;                         /* inferred */
    /* 0x210 */ char pad210[0x1];
    /* 0x211 */ s8 unk211;                          /* inferred */
    /* 0x212 */ char pad212[0x2];                   /* maybe part of unk211[3]? */
...
struct _mips2c_stack_func_80B03A80 {
    /* 0x00 */ char pad0[0xA0];
    /* 0xA0 */ f32 spA0;                            /* inferred */
    /* 0xA4 */ char padA4[0x28];                    /* maybe part of spA0[11]? */
...
void func_80B02CD0(void *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = (arg0->unk16 * 8) + &D_80B04F84;
    Actor_SpawnAsChildAndCutscene(arg1 + 0x1CA0, arg1, temp_v0->unk0, arg0->unk8, arg0->unkC, arg0->unk10, (s16) (s32) arg0->unk14, (s16) 0, (s16) (s32) arg0->unk18, (s32) temp_v0->unk2, -1U, (s32) arg0->unk20, NULL);
}
...
void func_80B02D58(void *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 >= 0) {
        Item_DropCollectible(arg1, arg0 + 8, ((((s32) arg0->unk1C >> 8) & 0x7F) << 8) | temp_v0);
    }
}
...
void func_80B02DB0(void *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = (arg0->unk16 * 8) + &D_80B04F84;
    sp48 = temp_v1;
    Actor_SpawnAsChildAndCutscene(arg1 + 0x1CA0, arg1, temp_v1->unk0, arg0->unk8, arg0->unkC, arg0->unk10, (s16) (s32) arg0->unk14, (s16) 0, (s16) (s32) arg0->unk18, arg0->unk1C | temp_v1->unk2, ActorCutscene_GetAdditionalCutscene((s16) arg0->unk38), (s32) arg0->unk20, NULL);
}
...
void func_80B02E54(void *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = (arg0->unk16 * 8) + &D_80B04F84;
    Actor_SpawnAsChildAndCutscene(arg1 + 0x1CA0, arg1, temp_v0->unk0, arg0->unk8, arg0->unkC, arg0->unk10, (s16) (s32) arg0->unk14, (s16) 0, (s16) (s32) arg0->unk18, arg0->unk1C | temp_v0->unk2, -1U, (s32) arg0->unk20, NULL);
}
...
void func_80B030F8(void *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        if (temp_s7 < 4) {
            ...
            phi_s0 = 0x40;
            phi_s4 = 0;
            phi_s2 = D_80B04FC8.unk8;
        } else {
            phi_s3 = -0x190;
            if (temp_s7 < 6) {
                temp_s2 = D_80B04FC8.unk4;
                phi_f22 = 0.9f;
                phi_s3 = -0x154;
        ...
        temp_f20 = (Rand_ZeroOne() * (40.0f * arg0->unk20C)) + 20.0f;
        ...
        sp100 += arg0->unk28;
        sp104 += arg0->unk2C;
        EffectSsKakera_Spawn(arg1, (Vec3f *) &spFC, (Vec3f *) &spF0, (Vec3f *) &spFC, (s16) phi_s3, (s16) phi_s0, (s16) 0x1E, (s16) 0, (s16) 0, (s16) (s32) (s16) (s32) (((Rand_ZeroOne() * 15.0f) + 30.0f) * arg0->unk20C), (s16) phi_s4, (s16) 0, 0x32, (s16) -1, (s16) 0xEF, phi_s2);
        if ((arg0->unk210 == 0) && (temp_s7 >= 3)) {
    ...
    if (arg0->unk210 != 0) {
        ...
        do {
            ...
            sp104 = temp_f10_2;
            spFC = temp_f6 + arg0->unk24;
            sp100 += arg0->unk28;
            sp104 = temp_f10_2 + arg0->unk2C;
            spE4 = spF0 * -0.02f;
            spE8 = temp_f18 * -0.05f;
            spEC = spF8 * -0.02f;
...
void func_80B03E2C(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk1C6 = (s16) (arg0->yawTowardsPlayer - 0x4000);
    temp_f6 = Rand_ZeroOne() * -600.0f;
    arg0->unk1F6 = (s16) (arg0->yawTowardsPlayer + 0x4000);
    arg0->unk1CC = (s16) (s32) temp_f6;
    arg0->unk1FC = (s16) (s32) (Rand_ZeroOne() * 600.0f);
    phi_s1 = arg0;
    phi_s0 = arg0 + 0x1A8;
    phi_s4 = 0;
    do {
        phi_s1->unk1A8 = (f32) arg0->home.pos.x;
        phi_s1->unk1AC = (f32) (arg0->home.pos.y + (61.0f * arg0->unk20C));
        phi_s1->unk1B0 = (f32) arg0->home.pos.z;
        temp_f20 = Math_SinS(phi_s1->unk1C6);
        phi_s0->unkC = (f32) ((Rand_ZeroOne() + 5.0f) * temp_f20);
        phi_s0->unk10 = (f32) ((Rand_ZeroOne() * 11.0f) + 20.0f);
        temp_f20_2 = Math_CosS(phi_s0->unk1E);
        temp_f16 = Rand_ZeroOne() + 5.0f;
        phi_s0->unk1C = 0;
        phi_s0->unk20 = 0;
        phi_s0->unk14 = (f32) (temp_f16 * temp_f20_2);
        phi_s0->unk22 = (s16) ((s32) (Rand_ZeroOne() * 400.0f) + 0x44C);
        temp_s4 = phi_s4 + 0x30;
        temp_f10 = Rand_ZeroOne() * -600.0f;
        phi_s0->unk2D = 0;
        phi_s0->unk2C = 0;
        phi_s0->unk26 = (s16) (s32) temp_f10;
        phi_s1 += 0x30;
        phi_s0 += 0x30;
        phi_s4 = temp_s4;
    } while (temp_s4 != 0x60);
...
void ObjSnowball_Init(ObjSnowball *this, GlobalContext *globalCtx) {
    f32 sp50;
    f32 sp4C;
    f32 sp48;
    s32 sp44;
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80B04F74, &this->unk164);
...
void ObjSnowball_Destroy(ObjSnowball *this, GlobalContext *globalCtx) {
    ObjSnowball *this = (ObjSnowball *) thisx;
...
void func_80B04350(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = arg0;
    temp_v0 = temp_a3->unk155;
    temp_v1 = (temp_v0 & 2) != 0;
    phi_a3 = temp_a3;
    if (temp_v1 != 0) {
        temp_a3->unk155 = (u8) (temp_v0 & 0xFFFD);
    }
    if ((temp_v1 != 0) && (temp_a3->unk211 == 0) && ((*temp_a3->unk160->unk24 & 0x80004D08) != 0)) {
        temp_t3 = temp_a3->flags | 0x10;
        temp_a3->flags = temp_t3;
        if (temp_a3->home.rot.y == 1) {
            temp_a3->flags = temp_t3 & ~9;
        }
        temp_v0_2 = *temp_a3->unk160->unk24;
    ...
    if ((temp_v1 != 0) && ((*temp_a3->unk160->unk24 & 0x13820) == 0) && ((s32) temp_a3->unk209 <= 0)) {
        arg0 = temp_a3;
        func_80B02EE4(temp_a3, arg1, temp_a3);
        temp_a0_2 = arg0;
        if (*arg0->unk160->unk24 & 0x1000000) {
            arg0->unk209 = 0x19;
        } else {
            arg0->unk209 = 0xA;
        }
    ...
    temp_v0_3 = phi_a3->unk209;
    if ((s32) temp_v0_3 > 0) {
        phi_a3->unk209 = (s8) (temp_v0_3 - 1);
    }
...
void func_80B046E4(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        temp_a2 = &sp44;
        sp44 = phi_s0->unk1A8;
        sp48 = phi_s0->unk1AC - (60.0f * arg0->unk20C);
        sp4C = phi_s0->unk1B0;
        func_80B03A80(arg1, arg0->unk20C, temp_a2);
        temp_s1 = phi_s1 + 0x30;
        phi_s0 += 0x30;
        phi_s1 = temp_s1;
    } while (temp_s1 != 0x60);
...
void func_80B047C0(Actor *arg0, s32 arg1) {
    ...
    do {
        ...
        if ((phi_s1->unk1D5 & 1) == 0) {
            temp_s0->unk10 = (f32) (temp_s0->unk10 - 6.0f);
            temp_s0->unk10 = (f32) (temp_s0->unk10 * 0.96f);
            ...
            sp9C = temp_s0->unk0;
            spA0 = temp_s0->unk4 + 25.0f;
            spA4 = temp_s0->unk8;
            temp_s0->unk18 = func_800C411C(arg1 + 0x830, temp_s0 + 0x28, &sp98, arg0, (Vec3f *) &sp9C);
            if (temp_s0->unk10 <= 0.0f) {
                ...
                temp_f12 = arg0->unk20C * 60.0f * 0.9f;
                phi_f12 = temp_f12;
                if (sp8C > 0.0f) {
                    sp84 = temp_f12;
                ...
                if (((temp_s0->unk4 - phi_f12) < temp_f0) || (temp_f0 < -31990.0f)) {
                    temp_s0->unk2D = (u8) (temp_s0->unk2D | 1);
                    sp70 = temp_s0->unk0;
                    sp74 = temp_s0->unk4 - phi_f12;
                    sp78 = temp_s0->unk8;
                    func_80B03A80((bitwise GlobalContext *) phi_f12, (bitwise f32) arg1, (bitwise f32 *) arg0->unk20C, &sp70);
                }
            }
        }
        temp_s2 = phi_s2 + 0x30;
    ...
    arg0->unk208 = (s8) (arg0->unk208 - 1);
    if (((s32) arg0->unk208 <= 0) || ((phi_s1_2 = arg0, phi_s0 = arg0 + 0x1A8, ((arg0->unk1D5 & 1) != 0)) && ((arg0->unk205 & 1) != 0))) {
        if (arg0->unk20B != 0) {
    ...
    do {
        ...
        phi_s1_2 += 0x30;
        phi_s2_2 = temp_s2_2;
        if ((phi_s1_2->unk1D5 & 1) != 0) {
            phi_s0->unk2C = 0U;
        } else {
            temp_v0 = phi_s0->unk2C;
            if ((s32) temp_v0 < 0x88) {
                phi_s0->unk2C = (u8) (temp_v0 + 0x18);
            } else {
                phi_s0->unk2C = 0xA0U;
            }
        }
...
void ObjSnowball_Update(ObjSnowball *this, GlobalContext *globalCtx) {
    s32 sp24;
    f32 temp_f0;
    ObjSnowball *this = (ObjSnowball *) thisx;
...
void ObjSnowball_Draw(ObjSnowball *this, GlobalContext *globalCtx) {
    ObjSnowball *this = (ObjSnowball *) thisx;
    ...
    do {
        ...
        if ((phi_s3->unk1D5 & 1) == 0) {
            ...
            if ((temp_s0->unk28 != 0) && ((s32) temp_s0->unk2C > 0)) {
                ...
                func_800C0094(temp_s0->unk28, temp_s0->unk0, temp_s0->unk18, temp_s0->unk8, (MtxF *) &sp88);
