...
void EnHitTag_Init(EnHitTag *this, GlobalContext *globalCtx) {
...
void EnHitTag_Destroy(EnHitTag *this, GlobalContext *globalCtx) {
    EnHitTag *this = (EnHitTag *) thisx;
...
void EnHitTag_Update(EnHitTag *this, GlobalContext *globalCtx) {
    EnHitTag *this = (EnHitTag *) thisx;
