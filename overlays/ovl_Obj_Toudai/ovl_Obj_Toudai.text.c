typedef struct ObjToudai {
    ...
    /* 0x148 */ char pad148[0xE0];
    /* 0x228 */ f32 unk228;                         /* inferred */
    /* 0x22C */ char pad22C[0x8];                   /* maybe part of unk228[3]? */
    /* 0x234 */ s16 unk234;                         /* inferred */
    /* 0x236 */ u8 unk236;                          /* inferred */
    /* 0x237 */ char pad237[0x1];
    /* 0x238 */ s16 unk238;                         /* inferred */
    /* 0x23A */ char pad23A[0x6];                   /* maybe part of unk238[4]? */
...
void ObjToudai_Init(ObjToudai *this, GlobalContext *globalCtx) {
    ObjToudai *this = (ObjToudai *) thisx;
    Lib_MemCpy((void *) &this->unk148, &D_80A34590, 0xE0U);
}

void ObjToudai_Destroy(ObjToudai *this, GlobalContext *globalCtx) {
    ObjToudai *this = (ObjToudai *) thisx;

}

void ObjToudai_Update(ObjToudai *this, GlobalContext *globalCtx) {
    s32 temp_v0;
    f32 phi_f0;
    ObjToudai *this = (ObjToudai *) thisx;
...
void ObjToudai_Draw(ObjToudai *this, GlobalContext *globalCtx) {
    ObjToudai *this = (ObjToudai *) thisx;
