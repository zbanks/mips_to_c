typedef struct ObjGrassCarry {
    ...
    /* 0x194 */ char pad194[0x8];                   /* maybe part of unk190[3]? */
...
void ObjGrassCarry_Init(ObjGrassCarry *this, GlobalContext *globalCtx) {
...
void ObjGrassCarry_Destroy(ObjGrassCarry *this, GlobalContext *globalCtx) {
    ColliderCylinder *temp_a1;
    s32 temp_v1;
    void *temp_v0;
    ObjGrassCarry *this = (ObjGrassCarry *) thisx;
...
void ObjGrassCarry_Update(ObjGrassCarry *this, GlobalContext *globalCtx) {
