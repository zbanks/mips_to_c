struct _mips2c_stack_EnDaiku_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnDaiku_Draw {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ GraphicsContext *sp30;               /* inferred */
    /* 0x34 */ char pad_34[0x4];
};                                                  /* size = 0x38 */

struct _mips2c_stack_EnDaiku_Init {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnDaiku_Update {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ ColliderCylinder *sp2C;              /* inferred */
    /* 0x30 */ char pad_30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_8094373C {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ AnimationHeaderCommon **sp2C;        /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_809437C8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80943820 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ s32 sp24;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809438F8 {
...
struct _mips2c_stack_func_80943BC0 {};              /* size 0x0 */

struct _mips2c_stack_func_80943BDC {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80943E18 {};              /* size 0x0 */

struct _mips2c_stack_func_80943E60 {};              /* size 0x0 */
...
void EnDaiku_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->collider, (Actor *) this, &D_80944078);
...
block_4:
    ...
    Math_Vec3f_Copy(&this->unk_26C, (Vec3f *) &this->actor.world);
...
void func_809438F8(EnDaiku *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_278 == 3) {
        ...
        sp28 = temp_a0;
        Math_ApproachF((f32 *) temp_a0, this->unk_26C.x, 0.5f, fabsf(temp_f0));
        ...
        if (temp_f14 < 4.0f) {
            ...
            if ((temp_v0 != 0) && (fabsf((f32) (this->actor.world.rot.y - this->unk_282)) < 10.0f)) {
                ...
                this->unk_282 = Math_Vec3f_Yaw((Vec3f *) sp28, &this->unk_26C);
            }
        }
        phi_v0 = this->unk_278;
    }
...
void EnDaiku_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, func_80943E18, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80943E60, (Actor *) this);
}
