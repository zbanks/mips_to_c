...
struct _mips2c_stack_ObjKinoko_Draw {
    ...
    /* 0x28 */ char pad28[0x20];                    /* maybe part of sp24[9]? */
...
void ObjKinoko_Init(ObjKinoko *this, GlobalContext *globalCtx) {
    ObjKinoko *this = (ObjKinoko *) thisx;
    this->actor.world.pos.y += 4.0f;
}

void ObjKinoko_Destroy(ObjKinoko *this, GlobalContext *globalCtx) {
    ObjKinoko *this = (ObjKinoko *) thisx;

}

void ObjKinoko_Update(ObjKinoko *this, GlobalContext *globalCtx) {
    f32 temp_f0;
    f32 phi_f2;
    ObjKinoko *this = (ObjKinoko *) thisx;
...
void ObjKinoko_Draw(ObjKinoko *this, GlobalContext *globalCtx) {
