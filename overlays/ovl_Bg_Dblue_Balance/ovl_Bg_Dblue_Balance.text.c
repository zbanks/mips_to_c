typedef struct BgDblueBalance {
    ...
    /* 0x16C */ u32 unk16C;                         /* inferred */
    /* 0x170 */ u32 unk170;                         /* inferred */
    /* 0x174 */ s16 unk174;                         /* inferred */
    /* 0x176 */ s16 unk176;                         /* inferred */
    /* 0x178 */ s16 unk178;                         /* inferred */
    /* 0x17A */ s16 unk17A;                         /* inferred */
    /* 0x17C */ s8 unk17C;                          /* inferred */
    /* 0x17D */ s8 unk17D;                          /* inferred */
    /* 0x17E */ char pad17E[0x1];
    /* 0x17F */ s8 unk17F;                          /* inferred */
    /* 0x180 */ char pad180[0x2];                   /* maybe part of unk17F[3]? */
    /* 0x182 */ s8 unk182;                          /* inferred */
    /* 0x183 */ u8 unk183;                          /* inferred */
    /* 0x184 */ s16 unk184;                         /* inferred */
    /* 0x186 */ s8 unk186;                          /* inferred */
    /* 0x187 */ s8 unk187;                          /* inferred */
    /* 0x188 */ char pad188[0xA0];                  /* maybe part of unk187[161]? */
...
void BgDblueBalance_Init(BgDblueBalance *this, GlobalContext *globalCtx) {
    s32 sp2C;
    u32 sp24;
    void *sp20;
    s16 temp_v0;
...
void BgDblueBalance_Destroy(BgDblueBalance *this, GlobalContext *globalCtx) {
    s32 sp1C;
    Actor *temp_v0_2;
    Actor *temp_v0_3;
    s32 temp_a2;
...
void BgDblueBalance_Update(BgDblueBalance *this, GlobalContext *globalCtx) {
    BgDblueBalance *this = (BgDblueBalance *) thisx;
...
void BgDblueBalance_Draw(BgDblueBalance *this, GlobalContext *globalCtx) {
    Actor *sp38;
    Gfx *sp34;
