...
void EnGg2_Init(EnGg2 *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
    s16 temp_a0;
    u8 temp_t1;
...
void EnGg2_Destroy(EnGg2 *this, GlobalContext *globalCtx) {
    EnGg2 *this = (EnGg2 *) thisx;

}

void EnGg2_Update(EnGg2 *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    s16 temp_v0_2;
    u32 temp_t0;
    u32 temp_t4;
    ...
    func_80B3B8A4(this);
    func_800E9250(globalCtx, (Actor *) this, &this->unk1E0, &this->unk1E6, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
...
void EnGg2_Draw(EnGg2 *this, GlobalContext *globalCtx) {
    Gfx *sp30;
    Gfx *temp_v0;
    ...
    if (((this->actor.flags & 0x80) == 0x80) || (this->unk2F0 == 1)) {
        ...
        temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80B3BD44, func_80B3BDC0, (Actor *) this, temp_s1->polyXlu.p);
    }
}
