typedef struct EnHgo {
    ...
    /* 0x1D8 */ MtxF unk1D8;                        /* inferred */
    /* 0x218 */ char pad218[0x4];
    /* 0x21C */ Vec3s unk21C;                       /* inferred */
    /* 0x222 */ char pad222[0x6C];                  /* maybe part of unk21C[19]? */
    /* 0x28E */ Vec3s unk28E;                       /* inferred */
    /* 0x294 */ char pad294[0x6C];                  /* maybe part of unk28E[19]? */
    /* 0x300 */ Vec3s unk300;                       /* inferred */
    /* 0x306 */ Vec3s unk306;                       /* inferred */
...
void EnHgo_Init(EnHgo *this, GlobalContext *globalCtx) {
...
void EnHgo_Destroy(EnHgo *this, GlobalContext *globalCtx) {
    EnHgo *this = (EnHgo *) thisx;
...
void EnHgo_Update(EnHgo *this, GlobalContext *globalCtx) {
...
void EnHgo_Draw(EnHgo *this, GlobalContext *globalCtx) {
    Gfx *sp30;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80BD0CF0, func_80BD0D38, (Actor *) this);
