typedef struct EnWallmas {
    ...
    /* 0x198 */ char pad198[0x90];                  /* maybe part of unk192[25]? */
    /* 0x228 */ Vec3s unk228;                       /* inferred */
    /* 0x22E */ char pad22E[0x92];                  /* maybe part of unk228[25]? */
    ...
    /* 0x2E0 */ char pad2E0[0x78];                  /* maybe part of unk2D4[11]? */
    /* 0x358 */ ColliderCylinder unk358;            /* inferred */
...
void EnWallmas_Init(EnWallmas *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk358, (Actor *) this, &D_80876360);
...
void func_80874BE4(EnWallmas *this, GlobalContext *globalCtx) {
    ...
    if (((temp_v1->unkA6C & 0x8100000) != 0) || ((temp_v1->unkA70 & 0x80) != 0) || ((s32) temp_v1->unkB5E > 0) || ((s32) temp_v1->freezeTimer > 0) || ((temp_v1->bgCheckFlags & 1) == 0) || ((temp_a0 = &this->actor.home, (this->actor.params == 1)) && (this = this, ((120.0f + this->unk2C4) < Math_Vec3f_DistXZ((Vec3f *) temp_a0, (Vec3f *) temp_a3))))) {
        this = this;
...
void func_808752CC(EnWallmas *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.yDistToPlayer < -900.0f) {
        ...
        if ((temp_v0 == 0) || (Math_Vec3f_DistXZ((Vec3f *) &this->actor.home, (Vec3f *) &sp24->world) < this->unk2C4)) {
            func_80874B88(this, globalCtx);
            return;
        }
        func_808758C8(this);
...
void func_80875910(EnWallmas *this, GlobalContext *globalCtx) {
    ...
    this = this;
    if (Math_Vec3f_DistXZ((Vec3f *) temp_a0, (Vec3f *) &globalCtx->actorCtx.actorList[2].first->world) < this->unk2C4) {
...
void EnWallmas_Draw(EnWallmas *this, GlobalContext *globalCtx) {
    ...
    if (func_80874BE4 != this->actionFunc) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_808760A4, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80876118, (Actor *) this);
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2D4, 0xB, this->unk2CC, this->unk2D0, this->unk2C8, (u8) (s32) this->unk18C);
    }
