typedef struct EnJs {
    ...
    /* 0x246 */ char pad246[0x6E];                  /* maybe part of unk240[19]? */
    /* 0x2B4 */ f32 unk2B4;                         /* inferred */
    /* 0x2B8 */ u16 unk2B8;                         /* inferred */
    /* 0x2BA */ s16 unk2BA;                         /* inferred */
    /* 0x2BC */ s16 unk2BC;                         /* inferred */
    /* 0x2BE */ char pad2BE[0x4];                   /* maybe part of unk2BC[3]? */
...
void EnJs_Init(EnJs *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk188, (Actor *) this, &D_8096ABA0);
...
void func_8096A6F4(EnJs *arg0, GlobalContext *arg1) {
    ...
    if (((arg0->unk2B8 & 8) == 0) && (arg0->actor.xzDistToPlayer < 100.0f) && (Actor_IsLinkFacingActor((Actor *) arg0, 0x3000, arg1) != 0) && (Actor_IsActorFacingLink((Actor *) arg0, 0x1000) != 0)) {
        func_800B8614((Actor *) arg0, arg1, 120.0f);
    }
}
...
void EnJs_Update(EnJs *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk2C2 != -1) && (ActorCutscene_GetCurrentIndex() != (this + (this->unk2C2 * 2))->unk2BE)) {
        ...
        if (ActorCutscene_GetCanPlayNext((this + (this->unk2C2 * 2))->unk2BE) != 0) {
            ActorCutscene_Start((this + (this->unk2C2 * 2))->unk2BE, (Actor *) this);
            return;
        }
        ActorCutscene_SetIntentToPlay((this + (this->unk2C2 * 2))->unk2BE);
...
void EnJs_Draw(EnJs *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_8096A9F4, (Actor *) this);
}
