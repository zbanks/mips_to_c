...
void OceffWipe6_Init(OceffWipe6 *this, GlobalContext *globalCtx) {
    Camera *temp_t9;
...
void OceffWipe6_Destroy(OceffWipe6 *this, GlobalContext *globalCtx) {
    OceffWipe6 *this = (OceffWipe6 *) thisx;
    func_80115D5C(globalCtx);
    globalCtx->msgCtx.unk120B0 = 0;
}

void OceffWipe6_Update(OceffWipe6 *this, GlobalContext *globalCtx) {
    Camera *temp_t9;
    s16 temp_v0;
    OceffWipe6 *this = (OceffWipe6 *) thisx;
...
void OceffWipe6_Draw(OceffWipe6 *this, GlobalContext *globalCtx) {
    f32 sp60;
    f32 sp48;
    f32 sp38;
