typedef struct ObjWturn {
    /* 0x000 */ Actor actor;
    /* 0x144 */ void (*actionFunc)(ObjWturn *, GlobalContext *);
    /* 0x148 */ s16 unk_148;                        /* inferred */
    /* 0x14A */ s16 unk_14A;                        /* inferred */
} ObjWturn;                                         /* size = 0x14C */

struct _mips2c_stack_ObjWturn_Init {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjWturn_Update {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808A7954 {};              /* size 0x0 */

struct _mips2c_stack_func_808A7968 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808A7A24 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808A7A5C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808A7AAC {
...
struct _mips2c_stack_func_808A7BA0 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808A7C04 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_808A7C78 {
...
void func_808A7AAC(Actor *arg0, GlobalContext *arg1) {
    ...
    func_8016566C(0x8C);
    arg0->unk_148 = ActorCutscene_GetCurrentCamera((s16) arg0->cutscene);
    ...
    sp34 = sp28 + 4.0f;
    sp38 = temp_f16;
    Play_CameraSetAtEye(arg1, arg0->unk_148, (Vec3f *) &sp24, (Vec3f *) &sp30);
    arg0->unk_144 = func_808A7BA0;
}
...
void func_808A7BA0(ObjWturn *this, GlobalContext *globalCtx) {
    ...
    func_800B8FE8((Actor *) this, 0x2098U);
    func_80169988(globalCtx, this->unk_148, this->actor.shape.rot.z);
}
...
void func_808A7C78(ObjWturn *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = Play_GetCamera(globalCtx, this->unk_148);
    temp_v1 = globalCtx->actorCtx.actorList[2].first;
    this->unk_14A += 1;
    temp_v1->world.pos.y = this->actor.world.pos.y + ((f32) this->unk_14A * 4.0f);
    func_8016981C(globalCtx, this->unk_148, &temp_v1->focus, &temp_v0->eye, &D_808A7DC0);
    if (this->unk_14A == 1) {
