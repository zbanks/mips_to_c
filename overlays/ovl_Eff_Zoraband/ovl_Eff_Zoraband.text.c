...
void EffZoraband_Init(EffZoraband *this, GlobalContext *globalCtx) {
...
void EffZoraband_Destroy(EffZoraband *this, GlobalContext *globalCtx) {
    EffZoraband *this = (EffZoraband *) thisx;
...
void EffZoraband_Update(EffZoraband *this, GlobalContext *globalCtx) {
    EffZoraband *this = (EffZoraband *) thisx;
    this->actionFunc(this, globalCtx);
}

void EffZoraband_Draw(EffZoraband *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
