...
struct _mips2c_stack_TransitionWipe1_Draw {
    ...
    /* 0x34 */ char pad_34[0x44];                   /* maybe part of sp30[18]? */
...
void TransitionWipe1_Update(void *thisx, s32 updateRate) {
    ...
    if (thisx->unk_8 != 0) {
        temp_t0 = thisx->unk_E + ((s32) (gSaveContext.unk_3F51 * 3) / updateRate);
        thisx->unk_E = temp_t0;
    ...
    temp_t8 = thisx->unk_E - ((s32) (gSaveContext.unk_3F51 * 3) / updateRate);
    thisx->unk_E = temp_t8;
...
void TransitionWipe1_Draw(void *thisx, Gfx **gfxP) {
    ...
    temp_v0_2 = Gfx_BranchTexScroll(temp_a0_4, (u32) thisx->unk_C, (u32) thisx->unk_E, 0, 0);
    temp_t3 = sp7C;
    sp7C = temp_t3 + 8;
    ...
    temp_v0_3->words.w1 = (thisx->unk_0 << 0x18) | (thisx->unk_1 << 0x10) | (thisx->unk_2 << 8) | 0xFF;
    temp_t2 = sp7C;
    sp7C = temp_t2 + 8;
    ...
    temp_t6->words.w1 = (u32) thisx->unk_10;
    temp_t9 = sp7C;
    sp7C = temp_t9 + 8;
