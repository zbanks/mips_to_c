...
static s16 D_808ED644 = {0, 0, 0x200, 0xFE00, 0x78, 0x32};
static s16 D_808ED650 = 0;
static s16 D_808ED652 = 0x3C2;
static s16 D_808ED654 = {0xFEEF, 0, 0x200, 0xFE27, 0x73, 0xDF32};
...
static u8 D_808EF4EF = {0, 0xFE, 0xFC, 3, 0xC2, 0xFF, 0xAC, 0, 0, 0xE, 0x66, 9, 0x7F, 0xFF, 0xFF};
static u8 D_808EF4FF = 0;
static ? D_808EF500;                                /* unable to generate initializer */
static ? D_808EFE90;                                /* unable to generate initializer */
static s16 D_808EFEB4 = {0, 0, 0, 0xFE49, 0xFFFF, 0xFF00};
...
static InitChainEntry D_808F0338;                   /* unable to generate initializer */
static ? D_808F0344;                                /* unable to generate initializer */
static s32 D_808F0358 = 7;
static s32 D_808F035C = {9, 0xB, 0xD, 0xF, 0x34, 0x38, 0x3C, 0x40, 0x44, 0x5E, 0x62, 0x66, 0x6A, 0x6E};
...
void EnBigslime_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_808F0338);
    ...
    phi_s1 = 0;
    do {
        Collider_InitAndSetCylinder(globalCtx, phi_s2, &this->actor, &D_808F02A0);
        temp_s1 = phi_s1 + 0x4C;
        phi_s2 += 0x4C;
        phi_s1 = temp_s1;
    } while (temp_s1 < 0x390);
    this->bigslimeCollider[0].base.atFlags &= 0xFFFE;
    Collider_InitAndSetCylinder(globalCtx, &this->gekkoCollider, &this->actor, &D_808F02A0);
    ...
    phi_s2_2 = 0;
loop_11:
    temp_v0_2 = Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0xD9, 0.0f, 0.0f, 0.0f, (s16) 0, (s16) 0, (s16) 0, phi_s0);
    ...
    if (temp_v0_2 == 0) {
        ...
        if (temp_s2 >= 0) {
            do {
                Actor_MarkForDeath(phi_s1_3->unkA08);
...
loop_2:
        temp_a3 = phi_a3 + 1;
        temp_t0 = phi_t0 + 2;
        temp_t0->unk-2 = (s16) *phi_t1;
        temp_t2_2 = phi_t2 + 1;
        temp_t2_2->unkB = (s8) phi_t3->unkC;
        phi_t1 += 2;
        phi_t0 = temp_t0;
        phi_t3 += 1;
        phi_t2 = temp_t2_2;
...
void func_808E5484(Actor *arg0) {
    ...
    phi_s0_2 = &D_808EFEC0;
    do {
        temp_a3 = &D_808EE060 + (arg0->unk2B1 * 0xA20);
        temp_v1 = temp_a3 + (phi_s0_2->unk0 * 0x10);
        temp_v0 = temp_a3 + (phi_s0_2->unk1 * 0x10);
        temp_a0 = &sp7C;
        temp_a1 = &sp70;
        sp7C = (f32) (temp_v0->unk0 - temp_v1->unk0);
        sp80 = (f32) (temp_v0->unk2 - temp_v1->unk2);
        sp84 = (f32) (temp_v0->unk4 - temp_v1->unk4);
        temp_v0_2 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + (phi_s0_2->unk2 * 0x10);
        sp70 = (f32) (temp_v0_2->unk0 - temp_v1->unk0);
        sp74 = (f32) (temp_v0_2->unk2 - temp_v1->unk2);
        sp78 = (f32) (temp_v0_2->unk4 - temp_v1->unk4);
        Math3D_CrossProduct((Vec3f *) temp_a0, (Vec3f *) temp_a1, &sp64);
        func_808E5430(&sp64);
        temp_a0_2 = &sp88 + (phi_s0_2->unk0 * 0xC);
        Math_Vec3f_Sum(temp_a0_2, &sp64, temp_a0_2);
        temp_a0_3 = &sp88 + (phi_s0_2->unk1 * 0xC);
        Math_Vec3f_Sum(temp_a0_3, &sp64, temp_a0_3);
        temp_a0_4 = &sp88 + (phi_s0_2->unk2 * 0xC);
        Math_Vec3f_Sum(temp_a0_4, &sp64, temp_a0_4);
    ...
    do {
        ...
        temp_v0_3 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + phi_s1;
        temp_s1 = phi_s1 + 0x10;
        temp_v0_3->unkC = (s8) (s32) (phi_s0_3->x * 120.0f);
        temp_v0_3->unkD = (s8) (s32) (phi_s0_3->y * 120.0f);
        temp_v0_3->unkE = (s8) (s32) (phi_s0_3->z * 120.0f);
        phi_s0_3 += 0xC;
        phi_s1 = temp_s1;
    } while (temp_s1 != 0xA20);
}
...
void func_808E574C(Actor *arg0, ? *arg1, ? *arg2) {
    ...
    temp_t5 = (arg0->unk2B1 * 0xA20) + &D_808EE060;
    phi_v0 = 0;
    phi_t5 = temp_t5;
    phi_t0 = 0;
    phi_v1 = 0;
    ...
    do {
        ...
        phi_t2_2 = phi_t2;
        phi_t4 = temp_t4;
        if (phi_v0 < (s32) phi_t5->unk0) {
            phi_v0_2 = (s32) phi_t5->unk0;
        } else {
            temp_a0 = phi_t5->unk0;
    ...
    arg1->unk0 = (f32) ((f32) phi_v0_3 * arg0->scale.x);
    arg1->unk4 = (f32) ((f32) phi_v1_3 * arg0->scale.y);
    arg1->unk8 = (f32) ((f32) phi_a3_3 * arg0->scale.z);
    arg2->unk0 = (f32) ((f32) phi_t0_3 * arg0->scale.x);
    arg2->unk4 = (f32) ((f32) phi_t1_3 * arg0->scale.y);
    arg2->unk8 = (f32) ((f32) phi_t2_3 * arg0->scale.z);
}
...
void func_808E5988(Actor *arg0, ? *arg1, ? *arg2) {
    ...
    temp_f2 = arg1->unk0;
    if (temp_f0 < temp_f2) {
        arg0->unk620 = (f32) (temp_f2 * 0.000100000005f);
    } else {
        arg0->unk620 = (f32) (-temp_f0 * 0.000100000005f);
    }
    temp_f0_2 = arg2->unk8;
    temp_f2_2 = arg1->unk8;
    if (temp_f0_2 < temp_f2_2) {
        arg0->unk624 = (f32) (temp_f2_2 * 0.000100000005f);
        return;
    }
    arg0->unk624 = (f32) (-temp_f0_2 * 0.000100000005f);
}
...
void func_808E5A00(Actor *arg0, ? *arg1, ? *arg2) {
    ...
    if ((func_808E9AE0 != arg0->unk188) || ((arg0->bgCheckFlags & 1) == 0)) {
...
void func_808E5BB0(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        *phi_a3 = 0.0f;
        if (temp_v0 < temp_v1) {
            phi_a1 = temp_v0 * 0x10;
            do {
                temp_a0 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + phi_a1;
                temp_v0_2 = temp_a0->unk2;
                temp_a1 = phi_a1 + 0x10;
                phi_a1 = temp_a1;
                if ((s32) *phi_t0 < (s32) temp_v0_2) {
                    *phi_t0 = temp_v0_2;
                }
                if ((s32) temp_a0->unk2 < (s32) *phi_a2) {
                    *phi_a2 = (s16) (s32) temp_a0->unk2;
                }
                temp_v0_3 = temp_a0->unk4;
                temp_v1_2 = temp_a0->unk0;
    ...
    phi_s1_4 = 0;
    do {
        phi_v1->unk6C0 = (s16) (s32) (((f32) phi_a2_2->unk2 * arg0->scale.y) + arg0->world.pos.y);
        phi_v1->unk6BA = (s16) (s32) ((f32) (*phi_t0_2 - phi_a2_2->unk2) * arg0->scale.y);
        temp_f0_3 = phi_a3_2->unk4;
        temp_f2_2 = phi_a3_2->unk0;
        if (temp_f2_2 < temp_f0_3) {
            phi_f12 = temp_f0_3;
        } else {
            phi_f12 = temp_f2_2;
        }
        temp_a0_2 = phi_v0->unk2;
        phi_v0->unk0 = (s16) (s32) (phi_f12 * phi_f14);
        if ((s32) temp_a0_2 <= 0) {
            phi_v0->unk2 = 1;
        } else {
            phi_v0->unk2 = temp_a0_2;
        }
        temp_s1 = phi_s1 + 0x4C;
        phi_v0->unk6 = (s16) (s32) arg0->world.pos.x;
        phi_v0->unkA = (s16) (s32) arg0->world.pos.z;
        phi_a2_2 += 2;
        phi_v1 += 0x4C;
        phi_t0_2 += 2;
        phi_a3_2 += 4;
    ...
    do {
        ...
        if (1 != 3) {
            do {
                ...
                temp_a0_2 = phi_a0 + 2;
                temp_a1 = phi_a1 + 2;
                temp_a0_2->unk-2 = (s16) ((s32) (phi_a2->vtxSurfacePerturbation[0] * phi_f18) + phi_v0);
                temp_v0_2 = *temp_a1;
        ...
        (phi_a0_2 + 2)->unk-2 = (s16) ((s32) (phi_a2->vtxSurfacePerturbation[0] * phi_f18_2) + phi_v0_2);
        temp_t2 = phi_t2 + 4;
        phi_t2 = temp_t2;
        phi_a2 += 4;
        phi_t1 += 0x10;
...
void func_808E62B8(Actor *arg0) {
    ...
    arg0->unk2B0 = 1;
    temp_a2 = arg0->unkA08;
    temp_v1 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + (D_808F0358 * 0x10);
    temp_a2->unk1C = 2;
    temp_a2->unk24 = (f32) (((f32) temp_v1->unk0 * arg0->scale.x) + arg0->world.pos.x);
    temp_a2->unk28 = (f32) (((f32) temp_v1->unk2 * arg0->scale.y) + arg0->world.pos.y);
    temp_a2->unk30 = 0x3FFD;
    temp_a2->unk2C = (f32) (((f32) temp_v1->unk4 * arg0->scale.z) + arg0->world.pos.z);
    phi_a3 = arg0 + 4;
    phi_a1 = &D_808F035C;
    phi_t0 = 0x3CCA;
    phi_t1 = 0x3997;
    do {
        temp_a2_2 = phi_a3->unkA08;
        temp_v1_2 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + (*phi_a1 * 0x10);
        temp_a2_2->unk1C = 2;
        temp_a1 = phi_a1 + 8;
        temp_a3 = phi_a3 + 8;
        temp_a2_2->unk24 = (f32) (((f32) temp_v1_2->unk0 * arg0->scale.x) + arg0->world.pos.x);
        temp_a2_2->unk28 = (f32) (((f32) temp_v1_2->unk2 * arg0->scale.y) + arg0->world.pos.y);
        temp_a2_2->unk30 = phi_t0;
        temp_a2_2->unk2C = (f32) (((f32) temp_v1_2->unk4 * arg0->scale.z) + arg0->world.pos.z);
        temp_a2_3 = temp_a3->unkA04;
        temp_v1_3 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + (temp_a1->unk-4 * 0x10);
        temp_a2_3->unk1C = 2;
        temp_a2_3->unk24 = (f32) (((f32) temp_v1_3->unk0 * arg0->scale.x) + arg0->world.pos.x);
        temp_a2_3->unk28 = (f32) (((f32) temp_v1_3->unk2 * arg0->scale.y) + arg0->world.pos.y);
        temp_a2_3->unk30 = phi_t1;
        temp_t1 = phi_t1 - 0x666;
        temp_a2_3->unk2C = (f32) (((f32) temp_v1_3->unk4 * arg0->scale.z) + arg0->world.pos.z);
        phi_a3 = temp_a3;
        phi_a1 = temp_a1;
        phi_t0 += -0x666;
        phi_t1 = temp_t1;
...
void func_808E6538(Actor *arg0) {
    ...
    if (func_808EA860 == arg0->unk188) {
        temp_v0 = arg0->unkA44;
        if (temp_v0->unk1C == 0xA) {
            temp_v0->unk1C = 3;
        }
    }
}
...
void func_808E6570(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk688 = (u8) (arg0->unk688 & 0xFFFE);
    arg0->unk63D = (u8) (arg0->unk63D & 0xFFFC);
    phi_v0 = arg0;
    phi_a0 = 0;
    do {
        temp_a0_2 = phi_a0 + 4;
        phi_v0->unk76D = (u8) (phi_v0->unk76D & ~2);
        phi_v0->unk721 = (u8) (phi_v0->unk721 & ~2);
        phi_v0->unk6D5 = (u8) (phi_v0->unk6D5 & ~2);
        temp_v0_2 = phi_v0 + 0x130;
        temp_v0_2->unk559 = (s8) (phi_v0->unk689 & ~2);
        phi_v0 = temp_v0_2;
        phi_a0 = temp_a0_2;
    } while (temp_a0_2 != 0xC);
...
void func_808E670C(EnBigslime *arg0, GlobalContext *arg1) {
    ...
    sp44 = temp_v0;
    Math_Vec3f_Copy(&sp38, &temp_v0->eye);
    Math_Vec3f_Copy(&sp2C, &sp44->at);
    Math_StepToF(&sp38.x, (Math_SinS(arg0->cameraYawGrabPlayer) * 250.0f) + arg0->actor.world.pos.x, 10.0f);
    Math_StepToF(&sp38.y, -502.5f, 10.0f);
    Math_StepToF(&sp38.z, (Math_CosS(arg0->cameraYawGrabPlayer) * 250.0f) + arg0->actor.world.pos.z, 10.0f);
    Math_StepToF(&sp2C.x, arg0->actor.world.pos.x, 10.0f);
    Math_StepToF(&sp2C.y, -602.5f, 10.0f);
    Math_StepToF(&sp2C.z, arg0->actor.world.pos.z, 10.0f);
    Play_CameraSetAtEye(arg1, arg0->camId, &sp2C, &sp38);
}
...
void func_808E6828(EnBigslime *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = Play_GetCamera(arg1, arg0->camId);
    sp2C = temp_v0;
    Math_Vec3f_Diff(&temp_v0->eye, &temp_v0->at, &sp20);
    Math_Vec3f_Scale(&sp20, 0.9f);
    temp_a1 = &sp2C->at;
    sp1C = temp_a1;
    Math_Vec3f_Sum(&sp20, temp_a1, &sp20);
    Play_CameraSetAtEye(arg1, arg0->camId, sp1C, &sp20);
}
...
void func_808E68AC(Actor *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    temp_v0 = Play_GetCamera(arg1, arg0->unk2C6);
    ...
    Play_CameraSetAtEye(arg1, arg0->unk2C6, &sp34->at, (Vec3f *) &sp28);
}
...
void func_808E69F4(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_a2 != 0) {
        ...
        arg0->unk2C6 = 0;
        ActorCutscene_Stop(arg0->unk2B8);
        arg0->unk2B8 = ActorCutscene_GetAdditionalCutscene((s16) arg0->cutscene);
...
void func_808E6F50(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    func_808E68AC(&this->actor, globalCtx, (s32) this->idleTimer);
...
void func_808E6FE0(EnBigslime *arg0, GlobalContext *arg1) {
    ...
    arg0->idleTimer = 0;
    func_800B7298(arg1, &arg0->actor, 7U);
...
void func_808E7048(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        if (this->idleTimer == 0) {
            func_808E69F4(&this->actor, globalCtx);
    ...
    if (this->isAnimUpdate != 0) {
        ...
        func_808E68AC(&this->actor, globalCtx, 0x19);
        func_801A2E54(0x38);
        func_808E616C(this);
...
void func_808E7354(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if (phi_s0 >= (u32) &D_808EDF60) {
            Math_StepToS(temp_s1 + 2, (s16) (s32) ((f32) phi_s0->unk2 * 0.9f), 5);
        } else if (phi_s0 < (u32) &D_808ED740) {
            Math_StepToS(temp_s1 + 2, (s16) (s32) ((f32) phi_s0->unk2 * 1.3f), 5);
        } else {
            Math_StepToS(temp_s1 + 2, phi_s0->unk2, 5);
        }
        Math_StepToS(temp_s1, phi_s0->unk0, 5);
        Math_StepToS(temp_s1 + 4, phi_s0->unk4, 5);
        temp_s0 = phi_s0 + 0x10;
        phi_s0 = temp_s0;
        phi_s2 += 0x10;
...
void func_808E75D8(Actor *arg0) {
    ...
    do {
        ...
        temp_v0 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + phi_v1;
        temp_v1 = phi_v1 + 0x10;
        temp_f16 = temp_f14 + ((f32) temp_v0->unk0 * temp_f2);
        phi_v1 = temp_v1;
        phi_a1_2 = 0;
        if (temp_f16 > 1818.0f) {
            temp_v0->unk0 = (s16) (s32) ((1818.0f - temp_f14) / temp_f2);
            phi_a1_2 = 1;
        } else if (temp_f16 < 858.0f) {
            temp_v0->unk0 = (s16) (s32) ((858.0f - temp_f14) / temp_f2);
            phi_a1_2 = 1;
        }
        temp_f0 = arg0->world.pos.z;
        temp_f2_2 = temp_f0 + ((f32) temp_v0->unk4 * arg0->scale.z);
        phi_a1 = phi_a1_2;
        if (temp_f2_2 > -2012.0f) {
            temp_v0->unk4 = (s16) (s32) ((-2012.0f - temp_f0) / arg0->scale.z);
            phi_a1 = phi_a1_2 + 1;
        } else if (temp_f2_2 < -2972.0f) {
            temp_v0->unk4 = (s16) (s32) ((-2972.0f - temp_f0) / arg0->scale.z);
            phi_a1 = phi_a1_2 + 1;
        }
        temp_a2 = temp_v0->unk2;
        if (temp_a2 != -0x3E8) {
            temp_v0->unk2 = (s16) (temp_a2 + (phi_a1 * 0x64));
        }
    } while (temp_v1 != 0xA20);
}
    ...
    do {
        ...
        if (temp_a3 < phi_s0->unk4) {
            do {
                ...
                temp_a3_2 = phi_a3 + 1;
                phi_t0->unk0 = (s16) (s32) ((f32) phi_a1->unk0 * phi_f2);
                phi_t0->unk2 = temp_t1;
                phi_t0->unk4 = (s16) (s32) ((f32) phi_a1->unk4 * phi_f2);
                phi_a1 += 0x10;
                phi_t0 += 0x10;
                phi_a3 = temp_a3_2;
            } while (temp_a3_2 < phi_s0->unk4);
        }
        temp_s0 = phi_s0 + 4;
        phi_s0 = temp_s0;
        phi_s0_2 = temp_s0;
        ...
        do {
            ...
            if (temp_a3_3 < phi_s0_2->unk4) {
                ...
                do {
                    ...
                    phi_t0_2->unk0 = (s16) (s32) ((f32) phi_a1_2->unk0 * phi_f2_2);
                    phi_t0_2->unk2 = temp_t1_2;
                    phi_t0_2->unk4 = (s16) (s32) ((f32) phi_a1_2->unk4 * phi_f2_2);
                    phi_a1_2 += 0x10;
                    phi_t0_2 += 0x10;
                    phi_a3_2 = temp_a3_4;
                } while (temp_a3_4 < phi_s0_2->unk4);
            }
...
void func_808E7AF8(Actor *arg0) {
    ...
    func_808E7770(arg0);
    func_808E75D8(arg0);
    arg0->unk688 = (u8) (arg0->unk688 | 1);
    arg0->unk188 = func_808E7B80;
}
...
void func_808E7B80(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    do {
        temp_s1 = &D_808EE060 + (this->dynamicVtxState * 0xA20) + phi_s2;
        Math_SmoothStepToS(temp_s1, phi_s0->unk0, 5, 0x28, (s16) 5);
        Math_SmoothStepToS(temp_s1 + 4, phi_s0->unk4, 5, 0x28, (s16) 5);
        Math_SmoothStepToS(temp_s1 + 2, phi_s0->unk2, 2, 0x258, (s16) 3);
        temp_s0 = phi_s0 + 0x10;
        phi_s2 += 0x10;
        phi_s0 = temp_s0;
    } while ((u32) temp_s0 < (u32) &D_808EFEC0);
    func_808E75D8(&this->actor);
    phi_v0 = this;
    phi_v1 = 0;
loop_3:
    phi_v1_2 = phi_v1;
...
void func_808E7D68(EnBigslime *arg0) {
    ...
    do {
        ...
        if (temp_t0 < phi_s0->unk4) {
            ...
            do {
                ...
                temp_t0_2 = phi_t0 + 1;
                phi_v1->unk0 = (s16) (s32) ((f32) phi_v0->unk0 * phi_f0);
                phi_v1->unk2 = temp_t1;
                phi_v1->unk4 = (s16) (s32) ((f32) phi_v0->unk4 * phi_f0);
                phi_v0 += 0x10;
                phi_v1 += 0x10;
                phi_t0 = temp_t0_2;
            } while (temp_t0_2 < phi_s0->unk4);
        }
        temp_s1 = phi_s1 + 1;
        temp_s0 = phi_s0 + 4;
        phi_s1 = temp_s1;
    ...
    if (temp_s1 < 0xC) {
        do {
            temp_t0_3 = phi_s0_2->unk0;
            temp_a3 = phi_s0_2->unk4;
            temp_s1_2 = phi_s1_2 + 1;
            phi_s1_2 = temp_s1_2;
            if (temp_t0_3 < temp_a3) {
                ...
                do {
                    ...
                    temp_v1->unk-E = (s16) (s32) (((cos_rad((f32) (phi_s1_2 - 6) * 0.2617994f) * 0.05f) + -1.0f) * 1000.0f);
                    temp_v1->unk-10 = (s16) phi_v0_2->unk0;
                    temp_v1->unk-C = (s16) phi_v0_2->unk4;
...
void func_808E8064(EnBigslime *arg0) {
    ...
    do {
        ...
        if (temp_t0 < temp_a3) {
            ...
            do {
                temp_v1 = phi_v1 + 0x10;
                temp_v1->unk-E = (s16) (s32) (((cos_rad((f32) (phi_s1 - 1) * 0.31415927f) * 0.1f) + 0.9f) * 1000.0f);
                temp_v1->unk-10 = (s16) phi_v0->unk0;
                temp_v1->unk-C = (s16) phi_v0->unk4;
                phi_v1 = (void *) temp_v1;
                phi_v0 += 0x10;
            } while (temp_v1 < (u32) ((temp_a3 * 0x10) + &D_808EF4A0));
        }
        ...
        do {
            ...
            if (temp_t0_2 < phi_s0_2->unk4) {
                ...
                do {
                    ...
                    temp_t0_3 = phi_t0 + 1;
                    phi_v1_2->unk0 = (s16) (s32) ((f32) phi_v0_2->unk0 * phi_f0);
                    phi_v1_2->unk2 = temp_t1;
                    phi_v1_2->unk4 = (s16) (s32) ((f32) phi_v0_2->unk4 * phi_f0);
                    phi_v0_2 += 0x10;
                    phi_v1_2 += 0x10;
                    phi_t0 = temp_t0_3;
                } while (temp_t0_3 < phi_s0_2->unk4);
            }
            temp_s1_2 = phi_s1_2 + 1;
            phi_s1_2 = temp_s1_2;
            phi_s0_2 += 4;
...
void func_808E836C(EnBigslime *arg0) {
    ...
    phi_a0 = &D_808EF4C0;
    do {
        phi_a0->unk0 = (s16) phi_v1->unk0;
        phi_a0->unk4 = (s16) phi_v1->unk4;
        temp_a0 = phi_a0 + 0x40;
        temp_a0->unk-30 = (s16) phi_v1->unk10;
        temp_a0->unk-E = (s16) phi_v1->unk32;
        temp_a0->unk-C = (s16) phi_v1->unk34;
        temp_a0->unk-2C = (s16) phi_v1->unk14;
        temp_a0->unk-2E = (s16) phi_v1->unk12;
        temp_a0->unk-20 = (s16) phi_v1->unk20;
        temp_a0->unk-1C = (s16) phi_v1->unk24;
        temp_a0->unk-1E = (s16) phi_v1->unk22;
        temp_a0->unk-10 = (s16) phi_v1->unk30;
        temp_a0->unk-3E = (s16) phi_v1->unk2;
        phi_v1 += 0x40;
        phi_a0 = temp_a0;
...
void func_808E844C(EnBigslime *arg0) {
    ...
    Audio_PlayActorSound2(&arg0->actor, 0x392EU);
    arg0->idleTimer = 0;
...
void func_808E84DC(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 0) {
        ...
        do {
            ...
            Math_SmoothStepToS(temp_s0 + 2, phi_s1->unk2, 5, 0x226, (s16) 3);
            Math_SmoothStepToS(temp_s0, phi_s1->unk0, 5, 0x28, (s16) 5);
            Math_SmoothStepToS(temp_s0 + 4, phi_s1->unk4, 5, 0x28, (s16) 5);
            temp_s1 = phi_s1 + 0x10;
            phi_s2 += 0x10;
            phi_s1 = temp_s1;
        ...
        do {
            ...
            Math_SmoothStepToS(temp_s0_2 + 2, phi_s1_2->unk2, 5, 0x32, (s16) 3);
            Math_SmoothStepToS(temp_s0_2, phi_s1_2->unk0, 5, 0x28, (s16) 5);
            Math_SmoothStepToS(temp_s0_2 + 4, phi_s1_2->unk4, 5, 0x28, (s16) 5);
        ...
        do {
            ...
            Math_SmoothStepToS(temp_s0_3 + 2, phi_s1_3->unk2, 5, 0x226, (s16) 3);
            Math_SmoothStepToS(temp_s0_3, phi_s1_3->unk0, 5, 0x28, (s16) 5);
            Math_SmoothStepToS(temp_s0_3 + 4, phi_s1_3->unk4, 5, 0x28, (s16) 5);
...
void func_808E88B8(Actor *arg0, GlobalContext *arg1) {
    ...
    Play_CameraSetAtEye(arg1, arg0->unk2C6, temp_v0 + 0x50, temp_v0 + 0x5C);
    arg0->unk2BA = 0xF;
    arg0->unk2BC = 0;
    arg0->unk688 = (u8) (arg0->unk688 & 0xFFFE);
    ...
    arg0->unk2C8 = (s16) (arg0->unk2C8 + arg0->world.rot.y);
    SkelAnime_ChangeAnimDefaultRepeat((SkelAnime *) (arg0 + 0x144), &D_0600F990);
    Audio_PlayActorSound2(arg0, 0x38D4U);
    arg0->unk188 = func_808E89CC;
}
        ...
        do {
            ...
            if (1 != 3) {
                do {
                    ...
                    temp_v1_3 = phi_v1 + 2;
                    temp_a1 = phi_a1 + 2;
                    temp_v1_3->unk-2 = (s16) (phi_v0 + (s32) ((f32) (phi_t3 - phi_v0) * temp_f2));
                    temp_v0_3 = temp_v1_3->unk0;
                    temp_t3_2 = *temp_a1;
                    phi_v0 = temp_v0_3;
                    phi_t3 = temp_t3_2;
                    phi_v1 = temp_v1_3;
            ...
            (phi_v1_2 + 2)->unk-2 = (s16) (phi_v0_2 + (s32) ((f32) (phi_t3_2 - phi_v0_2) * temp_f2));
            temp_a3 = phi_a3 + 0x10;
            phi_a3 = temp_a3;
            phi_t0 += 0x10;
...
void func_808E8C38(void *arg0) {
    ...
    arg0->unk2C4 = 6;
    arg0->unk2B3 = (s8) (temp_t1 + 1);
    arg0->unk188 = func_808E8CCC;
}
...
block_10:
        ...
        Math_StepToF(&sp34->world.pos.x, this->actor.world.pos.x, 4.0f);
    ...
    if (this->isAnimUpdate != 0) {
        ...
        if ((temp_t0 & 0xFF) == 0) {
            ...
            func_800B8E58(sp34, (sp34->unkA68->unk92 + 0x6805) & 0xFFFF);
            phi_v1 = 1;
...
block_23:
    func_800B9010(&this->actor, 0x3139U);
}
...
void func_808E90A4(EnBigslime *arg0) {
    ...
    do {
        ...
        temp_f0 = (((f32) temp_v0->unk4 * (Math_CosS(arg0->actor.world.rot.y) * 0.70710677f)) + (((f32) temp_v0->unk0 * temp_f20) + ((f32) temp_v0->unk2 * 0.70710677f))) * 0.001f;
        phi_a0 += 0x10;
        phi_a1 = temp_a1;
        if (temp_f0 < 0.01f) {
...
void func_808E91EC(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        if (temp_v0 == 0) {
            Audio_PlayActorSound2(&this->actor, 0x38D8U);
            func_808E6C44(this, 0x3961);
        }
        temp_f12_2 = 0.5f - (cos_rad((f32) -(s32) this->idleTimer * 0.62831855f) * 0.5f);
        if (this->idleTimer == -5) {
            if ((sp44->unkA70 & 0x80) != 0) {
                sp44->parent = NULL;
                sp44->unkAE8 = 0x64;
            }
            sp44->velocity.y = 0.0f;
            sp40 = temp_f12_2;
            func_800B8D50(globalCtx, &this->actor, 10.0f, this->actor.world.rot.y, 10.0f, 4U);
        ...
        if (phi_t0->vtxSurfacePerturbation[0] != 0.0f) {
            ...
            if ((s32) temp_v0_3 > 0) {
                ...
                if (1 != 3) {
                    do {
                        ...
                        temp_v0_4 = phi_v0 + 2;
                        temp_a0 = phi_a0 + 2;
                        temp_v0_4->unk-2 = (s16) (temp_a1_2 + (s32) ((f32) ((phi_a2 - (s32) (phi_f18 * phi_t0->vtxSurfacePerturbation[0])) - temp_a1_2) * phi_f2));
                        temp_a2_3 = *temp_a0;
                ...
                temp_a1_3 = *phi_v0_2;
                (phi_v0_2 + 2)->unk-2 = (s16) (temp_a1_3 + (s32) ((f32) ((phi_a2_2 - (s32) (phi_f18_2 * phi_t0->vtxSurfacePerturbation[0])) - temp_a1_3) * phi_f2));
            } else {
                temp_a2_4 = *temp_a1;
                ...
                if (1 != 3) {
                    do {
                        ...
                        temp_v0_5->unk-2 = (s16) (phi_a2_3 - (s32) (phi_t0->vtxSurfacePerturbation[0] * phi_f16));
                        temp_a2_5 = *temp_a0_2;
                ...
                (phi_v0_4 + 2)->unk-2 = (s16) (phi_a2_4 - (s32) (phi_t0->vtxSurfacePerturbation[0] * phi_f16_2));
            }
            ...
            if (1 != 3) {
                do {
                    ...
                    temp_v0_6->unk-2 = (s16) (phi_a1 + (s32) ((f32) (phi_t7 - phi_a1) * phi_f2));
                    temp_a1_5 = temp_v0_6->unk0;
                    temp_t7_2 = *temp_a0_4;
                    phi_a1 = temp_a1_5;
                    phi_t7 = temp_t7_2;
                    phi_v0_5 = temp_v0_6;
            ...
            (phi_v0_6 + 2)->unk-2 = (s16) (phi_a1_2 + (s32) ((f32) (phi_t7_2 - phi_a1_2) * phi_f2));
        }
        temp_t2 = phi_t2 + 4;
        phi_t0 += 4;
        phi_t2 = temp_t2;
        ...
        do {
            ...
            if (1 != 3) {
                do {
                    ...
                    temp_v1_2 = phi_v1 + 2;
                    temp_a1 = phi_a1_2 + 2;
                    temp_v1_2->unk-2 = (s16) (phi_v0 + (s32) ((f32) (phi_t4 - phi_v0) * temp_f0));
            ...
            (phi_v1_2 + 2)->unk-2 = (s16) (phi_v0_2 + (s32) ((f32) (phi_t4_2 - phi_v0_2) * temp_f0));
            temp_a3 = phi_a3 + 0x10;
            phi_a3 = temp_a3;
            phi_t0 += 0x10;
...
void func_808E994C(Actor *arg0) {
    ...
    if ((arg0->bgCheckFlags & 1) != 0) {
        ...
        arg0->gravity = 0.0f;
    } else if ((func_808E84DC == arg0->unk188) && ((s32) arg0->unk2BA < 2)) {
        arg0->gravity = -2.0f;
    }
    arg0->unk688 = (u8) (arg0->unk688 & 0xFFFE);
    arg0->unk689 = (u8) (arg0->unk689 & 0xFFFE);
    phi_a2 = &D_808EF4A0;
    do {
        phi_t0 = &D_808EE060 + (arg0->unk2B1 * 0xA20) + phi_v1_3;
        phi_t1 = phi_a2;
        phi_a3 = 0;
loop_7:
        temp_a3 = phi_a3 + 1;
        temp_t1 = phi_t1 + 2;
        temp_t1->unk-2 = (s16) *phi_t0;
        phi_t0 += 2;
        phi_t1 = temp_t1;
        phi_a3 = temp_a3;
        if (temp_a3 != 3) {
    ...
    do {
        ...
        temp_a2_2->unk9DF = 0xC8;
        phi_a2_3 = (s16 *) temp_a2_2;
    } while (temp_a2_2 < (u32) &D_808EF4E0);
    phi_v1_2 = arg0;
    phi_v0 = 0;
    do {
        phi_v1_2->unk68A = (u8) (phi_v1_2->unk68A & ~4);
        temp_v0 = phi_v0 + 4;
        phi_v1_2->unk76E = (u8) (phi_v1_2->unk76E & ~4);
        phi_v1_2->unk722 = (u8) (phi_v1_2->unk722 & ~4);
        phi_v1_2->unk6D6 = (u8) (phi_v1_2->unk6D6 & ~4);
        phi_v1_2 += 0x130;
        phi_v0 = temp_v0;
    } while (temp_v0 != 0xC);
    temp_t8 = arg0->unk188;
    arg0->unk188 = func_808E9AE0;
    arg0->unk18C = temp_t8;
}
...
void func_808E9AE0(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if (phi_s2 < 0xA2) {
            ...
            temp_s0->unk0 += (s32) (temp_f0 / this->actor.scale.x);
            temp_s0->unk2 = (s16) (temp_s0->unk2 + (s32) (temp_f0 / this->actor.scale.y));
            temp_s0->unk4 = (s16) (temp_s0->unk4 + (s32) (temp_f0 / this->actor.scale.z));
            temp_f2 = this->actor.scale.y;
            temp_f12 = this->actor.world.pos.y;
            phi_v1 = temp_s0;
            phi_a0 = temp_v0_2 + &D_808EF4A0;
            phi_v0 = 0;
            if ((((f32) temp_s0->unk2 * temp_f2) + temp_f12) < -690.0f) {
                temp_s0->unk2 = (s16) (s32) (((-690.0f - temp_f12) / temp_f2) - 1.0f);
            }
            do {
                temp_v0_3 = phi_v0 + 1;
                temp_a0 = phi_a0 + 2;
                temp_a0->unk-2 = (s16) *phi_v1;
                phi_v1 += 2;
                phi_a0 = temp_a0;
                phi_v0 = temp_v0_3;
            } while (temp_v0_3 != 3);
    ...
    do {
        ...
        temp_v0_4->unk-61 = (u8) phi_v0_2->unk1F;
        temp_v0_4->unk-51 = (u8) phi_v0_2->unk2F;
        temp_v0_4->unk-41 = (u8) phi_v0_2->unk3F;
        temp_v0_4->unk-71 = (u8) phi_v0_2->unkF;
        phi_v0_2 = temp_v0_4;
    ...
    if ((temp_v0_5 & 2) != 0) {
        if (this->freezeTimer == 0) {
            func_808E6570(&this->actor, globalCtx);
            return;
        }
        this->bigslimeCollider[0].base.acFlags |= 1;
        func_808EBED0(&this->actor, globalCtx);
        func_808E7AF8(this);
        return;
    }
    if (this->freezeTimer == 0) {
...
void func_808E9F38(Actor *arg0) {
    ...
    phi_a1 = 0;
    do {
        phi_v1_2->unk5F = phi_t0;
        temp_t0 = phi_t0 + 0x28;
        phi_v1_2->unk3F = phi_a2;
        phi_v1_2->unk4F = phi_a3;
        phi_v1_2->unk2F = phi_a1;
        phi_t0 = temp_t0;
        phi_v1_2 += 0x40;
        phi_a2 += 0x28;
        phi_a3 += 0x28;
...
void func_808E9FC0(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if (((s32) temp_v0 < 0x46) && ((temp_v0 & 1) != 0)) {
        ...
        temp_a1 = &sp3C;
        sp3C = ((f32) temp_v0_2->unk0 * this->actor.scale.x) + this->actor.world.pos.x;
        sp40 = ((f32) temp_v0_2->unk2 * this->actor.scale.y) + this->actor.world.pos.y;
        sp44 = ((f32) temp_v0_2->unk4 * this->actor.scale.z) + this->actor.world.pos.z;
        EffectSsIceSmoke_Spawn(globalCtx, (Vec3f *) temp_a1, &D_808F0394, &D_801D15B0, (s16) 0x258);
    }
    func_800B9010(&this->actor, 0x2144U);
    phi_v0 = &D_808EFE90;
    do {
        temp_v0_3 = phi_v0 - 0x10;
        temp_v0_3->unk3F = (u8) phi_v0->unkF;
        phi_v0 = temp_v0_3;
...
void func_808EA14C(EnBigslime *arg0) {
    ...
    do {
        ...
        temp_v1->unk55A = (s8) (phi_v1->bigslimeCollider[0].base.ocFlags1 | 4);
        phi_v1 = temp_v1;
        phi_v0 = temp_v0;
    } while (temp_v0 != 0xC);
...
loop_1:
    ...
    if (phi_v1_2 != 0x390) {
        func_800B8D50(globalCtx, &this->actor, 7.0f, this->actor.yawTowardsPlayer, 5.0f, 0x10U);
    }
    if ((this->actor.bgCheckFlags & 1) != 0) {
        func_808E6570(&this->actor, globalCtx);
    }
...
void func_808EA264(Actor *arg0) {
    ...
    arg0->unk2BA = 0x64;
    arg0->unk2B6 = (s16) (arg0->yawTowardsPlayer + 0x8000);
    arg0->unk188 = func_808EA2D0;
    arg0->speedXZ = 8.0f;
    arg0->world.rot.y = arg0->unk2D0;
}
...
void func_808EA2D0(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if (Math_SmoothStepToS(&this->actor.world.rot.y, this->gekkoYaw, 5, 0x1000, (s16) 0x80) == 0) {
        ...
        if (Actor_XZDistanceToPoint(&this->actor, &temp_a1->pos) > 240.0f) {
            temp_v0 = Actor_YawToPoint(&this->actor, &temp_a1->pos);
...
void func_808EA538(Actor *arg0) {
    ...
    arg0->unk2BA = 0x3C;
    arg0->speedXZ = 0.0f;
    if ((s32) (s16) (Actor_YawToPoint(arg0, arg0 + 8) - arg0->unk2D0) > 0) {
        arg0->unk2B6 = (s16) ((Rand_Next() >> 0x14) + arg0->unk2D0 + 0x2000);
    } else {
        arg0->unk2B6 = (s16) ((arg0->unk2D0 - (Rand_Next() >> 0x14)) - 0x2000);
    }
    arg0->unk188 = func_808EA5E8;
}
...
void func_808EA5E8(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if ((&D_060069FC == this->skelAnime.animCurrentSeg) && (Math_ScaledStepToS(&this->gekkoRot.y, this->gekkoYaw, 0x400) != 0)) {
        if ((s32) (s16) (Actor_YawToPoint(&this->actor, &this->actor.home.pos) - this->gekkoRot.y) > 0) {
...
void func_808EA7A4(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.unk2B2 != 0) {
        func_808EA264(&this->actor);
    }
}
...
void func_808EA8FC(Actor *arg0, s32 arg1) {
    ...
    arg0->unk63D = (u8) (arg0->unk63D & 0xFFFE);
    arg0->unk2BA = 0x14;
    arg0->speedXZ = 10.0f;
    arg0->gravity = -2.0f;
    arg0->velocity.y = 0.0f;
...
void func_808EABCC(Actor *arg0) {
    ...
    arg0->gravity = 0.0f;
    arg0->unk2CE = (s16) (0x4000 - arg0->world.rot.x);
    arg0->unk2B3 = 0;
    arg0->unk2BC = 0;
    arg0->unk2BA = 2;
    arg0->speedXZ = 25.0f;
    arg0->unk2D0 = (s16) arg0->world.rot.y;
    phi_v0 = arg0;
    phi_v1 = 0;
    phi_v1_2 = 0;
    do {
        temp_v1 = phi_v1 + 1;
        phi_v0->unkA08->unk1C = 4;
        phi_v0 += 4;
        phi_v1 = temp_v1;
    } while (temp_v1 < 0xF);
    phi_v0_2 = arg0;
    do {
        ...
        phi_v0_2->unk76E = (u8) (phi_v0_2->unk76E | 4);
        phi_v0_2->unk722 = (u8) (phi_v0_2->unk722 | 4);
        phi_v0_2->unk6D6 = (u8) (phi_v0_2->unk6D6 | 4);
        temp_v0 = phi_v0_2 + 0x130;
        temp_v0->unk55A = (s8) (phi_v0_2->unk68A | 4);
        phi_v0_2 = temp_v0;
        phi_v1_2 = temp_v1_2;
    } while (temp_v1_2 != 0xC);
...
void func_808EACEC(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 < 0) {
        ...
        this->idleTimer += -1;
        Audio_PlayActorSound2(&this->actor, 0x3938U);
...
void func_808EAEBC(EnBigslime *arg0, GlobalContext *arg1) {
    ...
    SkelAnime_ChangeAnim(arg0 + 0x144, &D_0600276C, 0.5f, 0.0f, (f32) SkelAnime_GetFrameCount(&D_0600276C.common), (u8) 3, 0.0f);
    ...
    if ((s32) (s16) (Actor_YawToPoint(&arg0->actor, &arg0->actor.home.pos) - temp_v1) > 0) {
    ...
    do {
        ...
        temp_v0 = phi_v0 + 0x10;
        phi_v0->unkA08->unk1C = 7;
        temp_v0->unk9FC->unk1C = 7;
        temp_v0->unkA00->unk1C = 7;
        temp_v0->unkA04->unk1C = 7;
        phi_v0 = temp_v0;
        phi_a0_2 = temp_a0_2;
    } while (temp_a0_2 != 0xF);
    arg0->actor.flags &= -2;
    func_808E6CC8(&arg0->actor, arg1);
...
void func_808EB24C(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    sp24 = temp_v0_2;
    Math_Vec3f_Copy(&sp28, &temp_v0_2->at);
    Math_Vec3f_Diff(&sp24->eye, &this->iceShardRefPos, &sp34);
    sp34.y -= 1.8f;
    sp28.y -= 1.7f;
    Play_CameraSetAtEye(globalCtx, this->camId, &sp28, &sp34);
}
...
void func_808EB690(EnBigslime *arg0) {
    ...
    arg0->minislime[0]->unk1C = 8;
    arg0->minislime[1]->unk1C = 8;
    arg0->minislime[2]->unk1C = 8;
    phi_v1 = arg0 + 0xC;
    phi_v0 = 3;
    do {
        temp_v0 = phi_v0 + 4;
        temp_v1 = phi_v1 + 0x10;
        phi_v1->unkA08->unk1C = 8;
        temp_v1->unk9FC->unk1C = 8;
        temp_v1->unkA00->unk1C = 8;
        temp_v1->unkA04->unk1C = 8;
        phi_v1 = temp_v1;
        phi_v0 = temp_v0;
    } while (temp_v0 != 0xF);
    arg0->idleTimer = 0;
...
void func_808EB708(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if (phi_a3 == 0xF) {
        ...
        do {
            ...
            phi_v0_2->unkA08->unk1C = 9;
            temp_v0->unk9FC->unk1C = 9;
            temp_v0->unkA00->unk1C = 9;
            temp_v0->unkA04->unk1C = 9;
            phi_v0_2 = temp_v0;
            phi_a2 = temp_a2;
        } while (temp_a2 != 0xF);
        Actor_MarkForDeath(&this->actor);
...
void func_808EB8B4(EnBigslime *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->cutscene) != 0) {
        ...
        if ((func_808EA9B8 == temp_v0) || (func_808EA2D0 == temp_v0) || (func_808EAA8C == temp_v0)) {
            func_808EAAF8(&this->actor);
            return;
        }
        if (func_808E7B80 == temp_v0) {
            func_808E88B8(&this->actor, globalCtx);
            return;
        }
        func_808E6D58(&this->actor, globalCtx);
        return;
    }
    ActorCutscene_SetIntentToPlay(this->cutscene);
}
...
void func_808EB9E8(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s2 = 0;
loop_1:
    temp_v0 = phi_s1->unk689;
    phi_s2_2 = phi_s2;
    phi_s1_2 = phi_s1;
    if ((temp_v0 & 2) != 0) {
        phi_s1->unk689 = (u8) (temp_v0 & ~2);
        if (func_808E9DD0 == arg0->unk188) {
            ...
            if (temp_v0_3 == 3) {
                ...
                if (temp_v0_4 != 0) {
                    temp_v0_4->unk15C = -100.0f;
                }
            } else {
                if ((temp_v0_3 != 1) && (arg0->unk2CC == 0)) {
                    temp_f0 = Rand_ZeroOne();
                    if (temp_f0 < 0.15f) {
                        Item_DropCollectible(arg1, &arg0->world.pos, 5U);
                    } else if (temp_f0 < 0.3f) {
                        Item_DropCollectible(arg1, &arg0->world.pos, 0xFU);
                    }
                    arg0->unk2CC = 0x28;
                }
                goto block_17;
...
block_17:
    ...
    if (phi_s2_2 < 0xC) {
        do {
            ...
            temp_s1_2 = phi_s1_2 + 0x4C;
            temp_s1_2->unk63D = (s8) (phi_s1_2->unk689 & ~2);
            phi_s1_2 = temp_s1_2;
            phi_s2_3 = temp_s2_2;
        } while (temp_s2_2 < 0xC);
    }
...
void func_808EBBE4(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk63D;
    if (((temp_v0 & 2) != 0) && ((arg0->unk63D = (u8) (temp_v0 & 0xFFFD), (arg0->unk2B5 != 0xA)) || ((*arg0->unk668 & 0xDB0B3) == 0)) && (func_808E6538(arg0), (arg0->colChkInfo.damageEffect != 0xE))) {
        if (Actor_ApplyDamage(arg0) == 0) {
            ...
            if ((temp_v0_2 == 2) || (temp_v0_2 == 4)) {
                ...
                if (temp_v0_2 == 2) {
                    ...
                    arg0->unk2B5 = 0x14U;
                    Actor_Spawn(&arg1->actorCtx, arg1, 0xA2, (f32) arg0->unk652, (f32) arg0->unk654, (f32) arg0->unk656, (s16) 0, (s16) 0, (s16) 0, (s16) 4);
                }
            } else if (temp_v0_2 == 3) {
                func_808E6C70(arg0);
            }
...
void func_808EBED0(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s4 = 0;
    do {
        if ((s32) phi_s1->unkF > 0) {
            temp_v0 = arg0 + (phi_s4 * 0x24);
            temp_s0 = temp_v0 + 0xA54;
            temp_v0->unkA54 = (f32) (((f32) phi_s1->unk0 * arg0->scale.x) + arg0->world.pos.x);
            temp_v0->unkA58 = (f32) (((f32) phi_s1->unk2 * arg0->scale.y) + arg0->world.pos.y);
            temp_v0->unkA5C = (f32) (((f32) phi_s1->unk4 * arg0->scale.z) + arg0->world.pos.z);
            temp_s0->unk1A = (s16) (Rand_Next() >> 0x10);
            ...
            temp_s0->unkC = (f32) ((f32) phi_s1->unk0 * phi_f20);
            temp_s0->unk10 = (f32) (Math_SinS(temp_s2) * temp_f22);
            temp_s0->unk14 = (f32) ((f32) phi_s1->unk4 * phi_f20);
            temp_s0->unk20 = (f32) ((Rand_ZeroFloat(6.0f) + 2.0f) * 0.001f);
        }
        temp_s4 = phi_s4 + 1;
        phi_s1 += 0x10;
        phi_s4 = temp_s4;
...
void func_808EC158(Actor *arg0) {
    ...
    do {
        ...
        if ((s32) phi_s1->unkA6C > 0) {
            temp_s0->unk10 = (f32) (temp_s0->unk10 + -1.0f);
            Math_Vec3f_Sum(temp_s0, temp_s0 + 0xC, temp_s0);
            if (temp_s0->y < -710.0f) {
                temp_s0->unk18 = 0;
            }
            temp_s0->unk1A = (s16) (temp_s0->unk1A + ((Rand_Next() >> 0x17) + 0x700));
            temp_s0->unk1C = (s16) (temp_s0->unk1C + ((Rand_Next() >> 0x17) + 0x900));
            temp_s0->unk1E = (s16) (temp_s0->unk1E + ((Rand_Next() >> 0x17) + 0xB00));
        }
        temp_s2 = phi_s2 + 0x24;
        phi_s1 += 0x24;
        phi_s2 = temp_s2;
    ...
    if ((s32) temp_v0 > 0) {
        if (temp_v1 < 0) {
            ...
            arg0->unk2B4 = (u8) temp_v1;
        }
        arg0->unk628 = (f32) (arg0->unk628 + 0.0013f);
    }
    if (arg0->unk388 > 0.0f) {
        if ((arg0->unk2B5 != 0xA) && (func_808EB8B4 != arg0->unk188)) {
            Math_StepToF(arg0 + 0x388, 0.0f, 0.05f);
            temp_f0 = (arg0->unk388 + 1.0f) * 0.375f;
            arg0->unk38C = temp_f0;
            if (temp_f0 > 0.75f) {
                arg0->unk38C = 0.75f;
                return;
            }
            arg0->unk38C = (f32) arg0->unk38C;
            return;
        }
...
void func_808EC354(Actor *arg0, GlobalContext *arg1) {
    ...
    func_808E5388(arg0);
    arg0->unk2B2 = SkelAnime_FrameUpdateMatrix(arg0 + 0x144);
    if (func_808EB8B4 != arg0->unk188) {
        ...
        do {
            ...
            temp_v0->unk559 = (s8) (phi_v0->unk689 & ~2);
            phi_v0 = temp_v0;
            phi_a0 = temp_a0;
        } while (temp_a0 != 0xC);
    }
    arg0->unk188(arg0, arg1);
    if (func_808EACEC != arg0->unk188) {
        Actor_SetVelocityAndMoveYRotationAndGravity(arg0);
    } else {
        Actor_SetVelocityAndMoveXYRotation(arg0);
    }
    if (func_808EA2D0 != arg0->unk188) {
...
void EnBigslime_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808EB8B4 != this->actionFunc) {
        func_808EBBE4(&this->actor, globalCtx);
    } else {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 40.0f, 80.0f, 0x1FU);
...
void func_808EC990(EnBigslime *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        temp_a0 = phi_s1_2->unk4;
        phi_s1_3 = phi_s1_2;
        if ((arg0 + (temp_v1 * 4))->unkA08->unkF4 < (arg0 + (temp_a0 * 4))->unkA08->unkF4) {
            phi_s1_2->unk0 = temp_a0;
            phi_s1_2->unk4 = temp_v1;
            if (phi_s1_2 != &spB4) {
                phi_s1_3 = phi_s1_2 - 8;
            }
        }
    ...
    phi_s1_4 = &spB4;
    do {
        temp_s0 = (arg0 + (*phi_s1_4 * 4))->unkA08;
        ...
        SysMatrix_SetStateRotationAndTranslation(temp_s0->world.pos.x, temp_s0->world.pos.y, temp_s0->world.pos.z, &temp_s0->shape.rot);
        ...
        if ((s32) temp_s0->unk148 > 0) {
            SysMatrix_InsertTranslation(0.0f, (0.1f - temp_s0->unk150) * -4000.0f, 0.0f, 1);
            Matrix_Scale(0.1f, temp_s0->unk150, 0.1f, 1);
            ...
            temp_v0_6->words.w1 = temp_s0->unk148 | ~0xFF;
        ...
        func_808EC708(temp_s6, &arg1->state.gfxCtx, (u32) &D_06011050, temp_s0->scale.x * 0.4f * 0.1f, phi_f6 * 0.6862745f);
...
void func_808ECD14(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v1->words.w1 = (u32) ((arg0->unk2B1 * 0xA20) + &D_808EE060);
    ...
    if ((func_808E9AE0 == temp_v0) || (func_808E9DD0 == temp_v0) || (func_808EA1C8 == temp_v0) || (func_808E9FC0 == temp_v0)) {
        AnimatedMat_Draw(arg1, arg0->unkA48);
    ...
    if (arg0->scale.x > 0.0f) {
        ...
        phi_s0 = &D_808F03B8;
        do {
            temp_v0_2 = (arg0->unk2B1 * 0xA20) + (phi_s0->unk0 * 0x10) + &D_808EE060;
            temp_s2->mf[3][0] = ((f32) temp_v0_2->unk0 * arg0->scale.x * phi_s0->unk4) + arg0->world.pos.x;
            temp_s2->mf[3][1] = ((f32) temp_v0_2->unk2 * arg0->scale.y * phi_s0->unk4) + arg0->world.pos.y;
            temp_s2->mf[3][2] = ((f32) temp_v0_2->unk4 * arg0->scale.z * phi_s0->unk4) + arg0->world.pos.z;
            temp_s1 = temp_s4->polyXlu.p;
            temp_s4->polyXlu.p = temp_s1 + 8;
    ...
    func_808EC708(&arg0->world.pos, &arg1->state.gfxCtx, (u32) &D_06011050, arg0->unk620, arg0->unk624, arg0->scale.y * 1000.0f, (s16) (s32) arg0->unk2CA, 175.0f);
...
void func_808ED07C(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if ((arg1 + &D_808F0498) == &D_808F04A1) {
        SysMatrix_MultiplyVector3fByState(&D_808F04B0, &sp20);
        arg4->unk674 = (s16) (s32) sp20.y;
    }
}
...
void EnBigslime_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Math_Vec3f_Sum(&this->actor.world.pos, &this->gekkoPosOffset, &sp4C);
    SysMatrix_SetStateRotationAndTranslation(sp4C.x, sp4C.y, sp4C.z, &this->gekkoRot);
    temp_f12 = this->gekkoScale;
    Matrix_Scale(temp_f12, temp_f12, temp_f12, 1);
    SkinMatrix_Vec3fMtxFMultXYZ(&globalCtx->projectionMatrix, &sp4C, &this->gekkoProjectedPos);
    temp_v0_3 = sp40->polyOpa.p;
    sp40->polyOpa.p = temp_v0_3 + 8;
    temp_v0_3->words.w0 = 0xDA380003;
    sp38 = temp_v0_3;
    sp38->words.w1 = Matrix_NewMtx(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, NULL, func_808ED07C, &this->actor);
    ...
    func_808EC708(&sp4C, &globalCtx->state.gfxCtx, (u32) D_04076BC0, temp_f0, temp_f0, 0.0f, (s16) 0, 255.0f);
    if (this->minislimeState != 0) {
        func_808EC990(this, globalCtx);
    }
    func_808ED3F4(this, globalCtx);
    func_800BE680(globalCtx, &this->actor, (Vec3f []) this->limbPos, 0xC, this->gekkoScale * 142.85713f * this->unk_38C, this->unk_390, this->unk_388, (u8) (s32) this->gekkoDrawEffect);
}
...
void func_808ED3F4(EnBigslime *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        if ((s32) phi_s1->iceShardEffect[0].isActive > 0) {
            SysMatrix_SetStateRotationAndTranslation(temp_s0_3->unk0, temp_s0_3->unk4, temp_s0_3->unk8, temp_s0_3 + 0x1A);
            temp_f12_2 = temp_s0_3->unk20;
