...
struct _mips2c_stack_func_808E5BB0 {
    ...
    /* 0x70 */ char pad70[0x30];                    /* maybe part of sp6C[13]? */
    /* 0xA0 */ s16 spA0;                            /* inferred */
    /* 0xA2 */ char padA2[0x1A];                    /* maybe part of spA0[14]? */
    /* 0xBC */ s16 spBC;                            /* inferred */
    /* 0xBE */ char padBE[0x22];
};                                                  /* size = 0xE0 */
...
struct _mips2c_stack_func_808E8CCC {
    ...
    /* 0x28 */ char pad28[0xA];                     /* maybe part of sp24[3]? */
...
struct _mips2c_stack_func_808EAEBC {
    ...
    /* 0x3C */ char pad3C[0x4];                     /* maybe part of sp3A[3]? */
    /* 0x40 */ f32 sp40;                            /* inferred */
    /* 0x44 */ f32 sp44;                            /* inferred */
...
struct _mips2c_stack_func_808EC990 {
    ...
    /* 0x088 */ ? *sp88;                            /* inferred */
    /* 0x08C */ char pad8C[0x28];                   /* maybe part of sp88[11]? */
    /* 0x0B4 */ s32 spB4;                           /* inferred */
    /* 0x0B8 */ char padB8[0x34];                   /* maybe part of spB4[14]? */
    /* 0x0EC */ ? spEC;                             /* inferred */
...
void EnBigslime_Init(EnBigslime *this, GlobalContext *globalCtx) {
    Actor *temp_v0_2;
    s16 temp_v1;
    s16 temp_v1_2;
    s32 temp_s0;
...
void EnBigslime_Destroy(EnBigslime *this, GlobalContext *globalCtx) {
    s32 temp_s0;
...
void EnBigslime_Update(EnBigslime *this, GlobalContext *globalCtx) {
    f32 sp30;
    f32 sp2C;
    f32 sp28;
    Actor *temp_v0;
...
void func_808ECD14(Actor *arg0, GlobalContext *arg1) {
    ...
    func_808EC708((Vec3f *) &arg0->world, (GraphicsContext **) arg1, (u32) &D_06011050, arg0->unk620, arg0->unk624, arg0->scale.y * 1000.0f, (s16) (s32) arg0->unk2CA, 175.0f);
...
void func_808ED07C(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if ((arg1 + &D_808F0498) == &D_808F04A1) {
        ...
        arg4->unk674 = (s16) (s32) sp24;
    }
}

void EnBigslime_Draw(EnBigslime *this, GlobalContext *globalCtx) {
    f32 sp4C;
