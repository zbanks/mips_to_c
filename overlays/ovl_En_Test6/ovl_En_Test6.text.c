typedef struct EnTest6 {
    ...
    /* 0x168 */ LightInfo unk168;                   /* inferred */
    /* 0x176 */ char pad176[0x16];                  /* maybe part of unk168[2]? */
    /* 0x18C */ ? unk18C;                           /* inferred */
    /* 0x18C */ char pad18C[0xC8];
    /* 0x254 */ void *unk254;                       /* inferred */
    /* 0x258 */ s32 unk258;                         /* inferred */
...
struct _mips2c_stack_func_80A90FC0 {
    ...
    /* 0x2C */ char pad2C[0x1C];                    /* maybe part of sp28[8]? */
...
struct _mips2c_stack_func_80A92188 {
    ...
    /* 0x48 */ char pad48[0x8];                     /* maybe part of sp46[5]? */
...
struct _mips2c_stack_func_80A9369C {
    ...
    /* 0x7A */ char pad7A[0x16];
};                                                  /* size = 0x90 */

struct _mips2c_stack_func_80A939E8 {
    /* 0x00 */ char pad0[0x50];
    /* 0x50 */ s32 *sp50;                           /* inferred */
    /* 0x54 */ char pad54[0x3C];                    /* maybe part of sp50[16]? */
...
void EnTest6_Init(EnTest6 *this, GlobalContext *globalCtx) {
    EnTest6 *temp_s2;
...
void EnTest6_Destroy(EnTest6 *this, GlobalContext *globalCtx) {
    s32 temp_s0;
    EnTest6 *phi_s1;
    s32 phi_s0;
    EnTest6 *this = (EnTest6 *) thisx;
...
void EnTest6_Update(EnTest6 *this, GlobalContext *globalCtx) {
    EnTest6 *this = (EnTest6 *) thisx;
...
void EnTest6_Draw(EnTest6 *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    EnTest6 *this = (EnTest6 *) thisx;
