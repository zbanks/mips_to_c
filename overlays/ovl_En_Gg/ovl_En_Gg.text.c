typedef struct EnGg {
    ...
    /* 0x1EA */ char pad1EA[0x72];                  /* maybe part of unk1E4[20]? */
    /* 0x25C */ Vec3s unk25C;                       /* inferred */
    /* 0x262 */ char pad262[0x78];                  /* maybe part of unk25C[21]? */
    /* 0x2DA */ u8 unk2DA;                          /* inferred */
    /* 0x2DB */ char pad2DB[0x1];
    /* 0x2DC */ s16 unk2DC;                         /* inferred */
    /* 0x2DE */ char pad2DE[0x4];                   /* maybe part of unk2DC[3]? */
    /* 0x2E2 */ s16 unk2E2;                         /* inferred */
    /* 0x2E4 */ char pad2E4[0x4];                   /* maybe part of unk2E2[3]? */
    /* 0x2E8 */ s16 unk2E8;                         /* inferred */
    /* 0x2EA */ char pad2EA[0x1A];                  /* maybe part of unk2E8[14]? */
    /* 0x304 */ s16 unk304;                         /* inferred */
    /* 0x306 */ char pad306[0x2];
    /* 0x308 */ u8 unk308;                          /* inferred */
    /* 0x309 */ u8 unk309;                          /* inferred */
    /* 0x30A */ s16 unk30A;                         /* inferred */
    /* 0x30C */ char pad30C[0x4];                   /* maybe part of unk30A[3]? */
    /* 0x310 */ f32 unk310;                         /* inferred */
    /* 0x314 */ char pad314[0x30];                  /* maybe part of unk310[13]? */
    /* 0x344 */ ? unk344;                           /* inferred */
    /* 0x344 */ char pad344[0x38];
    /* 0x37C */ ? (*unk37C)(? *, GlobalContext *, GraphicsContext *); /* inferred */
    /* 0x380 */ char pad380[0x10];                  /* maybe part of unk37C[5]? */
} EnGg;                                             /* size = 0x390 */
...
? func_80B34FB4(EnGg *arg0, GlobalContext *arg1) {
    ...
    sp40.unk0 = (s32) temp_v0->world.pos.x;
    sp40.unk4 = (s32) temp_v0->world.pos.y;
    sp40.unk8 = (s32) temp_v0->world.pos.z;
    sp44 = temp_v0->unkC44 + 3.0f;
    sp34.unk0 = (s32) arg0->actor.world.pos.x;
    sp34.unk4 = (s32) arg0->actor.world.pos.y;
    sp34.unk8 = (s32) arg0->actor.world.pos.z;
    sp38 += 70.0f;
...
void func_80B352A4(void *arg0, ? arg1) {
    ...
    sp26 = (s16) temp_f6;
    temp_v0 = SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80B36C58[arg0->unk2E6].animation);
...
void func_80B358D8(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_t8 = arg0->unk2DA;
    arg0 = arg0;
    if ((arg0->unk2E6 == 0xE) && (sp1E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80B36C58[temp_t8].animation))) {
        arg0->unk2E6 = 0xF;
...
void EnGg_Init(EnGg *this, GlobalContext *globalCtx) {
...
void EnGg_Destroy(EnGg *this, GlobalContext *globalCtx) {
    EnGg *this = (EnGg *) thisx;

}

void EnGg_Update(EnGg *this, GlobalContext *globalCtx) {
    u32 temp_t3;
    u32 temp_t9;
    u8 temp_v0;
    u8 temp_v0_2;
...
void EnGg_Draw(EnGg *this, GlobalContext *globalCtx) {
    Gfx *sp3C;
    Gfx *sp38;
    ...
    if ((gSaveContext.weekEventReg[19] & 0x80) != 0) {
        ...
        temp_s1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80B368B0, func_80B368F0, (Actor *) this, temp_s1->polyOpa.p);
        goto block_7;
    }
    if (((this->actor.flags & 0x80) == 0x80) || (this->unk308 == 1)) {
        ...
        temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80B368B0, func_80B368F0, (Actor *) this, temp_s1->polyXlu.p);
block_7:
        phi_a2 = globalCtx->state.gfxCtx;
    }
