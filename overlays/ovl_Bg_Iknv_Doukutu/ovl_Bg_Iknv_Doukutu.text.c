...
void BgIknvDoukutu_Init(BgIknvDoukutu *this, GlobalContext *globalCtx) {
...
void BgIknvDoukutu_Destroy(BgIknvDoukutu *this, GlobalContext *globalCtx) {
    s32 temp_v0;
    BgIknvDoukutu *this = (BgIknvDoukutu *) thisx;
...
void BgIknvDoukutu_Update(BgIknvDoukutu *this, GlobalContext *globalCtx) {
    BgIknvDoukutu *this = (BgIknvDoukutu *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgIknvDoukutu_Draw(BgIknvDoukutu *this, GlobalContext *globalCtx) {
    Gfx *sp28;
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
