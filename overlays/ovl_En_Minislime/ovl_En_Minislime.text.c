...
void EnMinislime_Init(EnMinislime *this, GlobalContext *globalCtx) {
...
void EnMinislime_Destroy(EnMinislime *this, GlobalContext *globalCtx) {
    EnMinislime *this = (EnMinislime *) thisx;
...
void EnMinislime_Update(EnMinislime *this, GlobalContext *globalCtx) {
    f32 sp38;
    f32 sp34;
    f32 sp30;
