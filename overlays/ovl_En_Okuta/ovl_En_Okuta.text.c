typedef struct EnOkuta {
    ...
    /* 0x198 */ char pad198[0x5A];                  /* maybe part of unk192[16]? */
    /* 0x1F2 */ Vec3s unk1F2;                       /* inferred */
    /* 0x1F8 */ char pad1F8[0x5C];                  /* maybe part of unk1F2[16]? */
    ...
    /* 0x27C */ char pad27C[0x6C];                  /* maybe part of unk270[10]? */
...
void EnOkuta_Init(EnOkuta *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 0) || (temp_v0 == 1)) {
        ...
        Collider_InitAndSetCylinder(globalCtx, &this->unk2E8, (Actor *) this, &D_808708CC);
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2E8, (Actor *) this, &D_808708A0);
...
s32 func_80870254(Vec3s *arg0, f32 arg1, f32 *arg2) {
    ...
    if (func_8086EC00 == temp_v0) {
        if (arg1 < 5.0f) {
            ...
            arg2->unk0 = 1.0f;
            arg2->unk4 = 1.0f;
            arg2->unk8 = (f32) (2.0f - ((arg1 - 6.0f) * 0.0769f));
        }
        goto block_18;
    }
...
void EnOkuta_Draw(EnOkuta *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 < 0x10) {
        ...
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_808704DC, func_808705C8, (Actor *) this);
    } else {
        sp34 = temp_v1;
        sp30 = temp_t0;
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk270, 0xA, this->unk258 * this->actor.scale.y * 100.0f, this->unk25C, this->unk254, (u8) (s32) this->unk18C);
}
