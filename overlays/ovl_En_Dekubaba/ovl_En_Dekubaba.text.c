typedef struct EnDekubaba {
    ...
    /* 0x19E */ char pad19E[0x2A];                  /* maybe part of unk198[8]? */
    /* 0x1C8 */ Vec3s unk1C8;                       /* inferred */
    /* 0x1CE */ char pad1CE[0x2A];                  /* maybe part of unk1C8[8]? */
    ...
    /* 0x214 */ char pad214[0x24];                  /* maybe part of unk208[4]? */
    /* 0x238 */ CollisionPoly *unk238;              /* inferred */
    /* 0x23C */ ColliderJntSph unk23C;              /* inferred */
    /* 0x25C */ ColliderJntSphElement unk25C;       /* inferred */
    /* 0x29C */ char pad29C[0x180];                 /* maybe part of unk25C[7]? */
...
void EnDekubaba_Init(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk23C, (Actor *) this, &D_808B4E5C, &this->unk25C);
...
void func_808B1CF0(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    if (this->unk18E == 0) {
        if (Math_Vec3f_DistXZ((Vec3f *) sp38, (Vec3f *) &sp64->world) < (240.0f * this->unk1F8)) {
            func_808B2890(this);
            return;
        }
        func_808B2158(this);
...
void func_808B2608(EnDekubaba *arg0) {
    arg0->unk18E = SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_060002B8) * 2;
...
void func_808B2660(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    temp_a1 = &sp34->world;
    sp24 = temp_a1;
    Math_ApproachS(&this->actor.shape.rot.y, Math_Vec3f_Yaw((Vec3f *) temp_a0_2, (Vec3f *) temp_a1), 2, (s16) (((s32) this->unk18E % 5) * 0x222));
...
void func_808B29C4(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 == 0) {
        ...
        if ((temp_v1_3 & Math_ScaledStepToS(&this->unk196, -0xE38, (s16) (sp4A + 0xE38))) != 0) {
            ...
            func_800B0DE0(globalCtx, (Vec3f *) &this->actor.world, (Vec3f *) &sp3C, &D_801D15B0, &D_808B4E98, &D_808B4E9C, (s16) 1, (s16) (s32) (this->unk1F8 * 100.0f));
            this->unk18E = 1;
        }
        ...
        if (((s32) this->unk18E >= 4) && (Actor_IsActorFacingLink((Actor *) this, 0x16C) == 0)) {
...
void func_808B2CB8(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 == 0) {
        ...
        if (Math_ScaledStepToS(&this->unk196, -0x888, 0x16C) != 0) {
            ...
            sp3C.unk0 = this->actor.home.pos.x;
            sp3C.unk4 = (f32) this->actor.home.pos.y;
            sp3C.unk8 = (f32) this->actor.home.pos.z;
...
void func_808B3404(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 1) {
        sp78.unk0 = this->actor.world.pos.x;
        sp78.unk4 = (f32) this->actor.world.pos.y;
        sp78.unk8 = (f32) this->actor.world.pos.z;
...
void func_808B3C50(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_FrameUpdateMatrix(&this->unk144);
    Math_ScaledStepToS((s16 *) &this->actor.shape, this->unk192, 0x71C);
...
void func_808B3EE8(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    if ((Actor_HasParent((Actor *) this, globalCtx) != 0) || (this->unk18E == 0)) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
...
void EnDekubaba_Update(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    if (func_808B3404 == temp_v0_2) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 10.0f, this->unk1F8 * 15.0f, 10.0f, 5U);
    ...
    if (func_808B29C4 == this->actionFunc) {
        sp2C = func_808B3EE8;
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk23C);
        this->actor.flags |= 0x1000000;
    }
    if ((this->unk23C.base.acFlags & 1) != 0) {
        sp2C = func_808B3EE8;
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk23C);
    }
    if (func_808B3EE8 != this->actionFunc) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk23C);
    }
    if (this->unk1FC > 0.0f) {
        if (this->unk18C != 0xA) {
...
void func_808B465C(EnDekubaba *arg0, GraphicsContext **arg1) {
    ...
    if (sp90 > 0) {
        ...
        phi_s3 = arg0 + 0x214;
        do {
            spD4 += 20.0f * Math_SinS(phi_s2->unk192) * arg0->unk1F8;
...
void func_808B49C8(EnDekubaba *arg0, GraphicsContext **arg1) {
    ...
    func_800C0094(arg0->unk238, arg0->actor.home.pos.x, arg0->actor.home.pos.y, arg0->actor.home.pos.z, (MtxF *) &sp48);
...
void EnDekubaba_Draw(EnDekubaba *this, GlobalContext *globalCtx) {
    ...
    if (func_808B3EE8 != this->actionFunc) {
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, NULL, func_808B4ABC, (Actor *) this);
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) sp30, 4, this->unk200 * this->unk1F8, this->unk204, this->unk1FC, (u8) (s32) this->unk18C);
}
