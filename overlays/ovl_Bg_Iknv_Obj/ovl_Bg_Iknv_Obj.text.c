...
void BgIknvObj_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        if (temp_v0 != 1) {
            ...
            sp24 = temp_a1;
            Collider_InitAndSetCylinder(globalCtx, temp_a1, &this->dyna.actor, &BgIknvObjCollisionInit);
            Collider_UpdateCylinder(&this->dyna.actor, temp_a1);
            this->dyna.actor.colChkInfo.mass = 0xFF;
            gSaveContext.weekEventReg[51] &= 0xEF;
            Actor_SetHeight(&this->dyna.actor, (f32) gGameInfo->data[952]);
            return;
        }
...
void BgIknvObj_UpdateWaterwheel(BgIknvObj *this, GlobalContext *globalCtx) {
    BgIknvObj *self = (BgIknvObj *) this;
    if ((gSaveContext.weekEventReg[14] & 4) != 0) {
        self->dyna.actor.shape.rot.z += -0x64;
        globalCtx = globalCtx;
        func_800B9098(&self->dyna.actor);
        func_800B9010(&self->dyna.actor, 0x21AAU);
    }
...
void func_80BD7ED8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_80BD7E0C(temp_a3, temp_a1, arg1, temp_a3) != 0) {
        arg0->unk1AC = BgIknvObj_UpdateSakonDoor;
        gSaveContext.weekEventReg[51] &= 0xEF;
    }
...
void func_80BD7F4C(void *arg0, GlobalContext *arg1) {
    ...
    if ((s32) gSaveContext.time >= 0xD001) {
        arg0->unk1AC = func_80BD7ED8;
    }
    if ((arg0->unk14 == 1) && ((gSaveContext.weekEventReg[58] & 0x80) == 0)) {
        temp_a0 = arg0->unk38;
        arg0 = arg0;
...
void func_80BD7FDC(void *arg0, s16 arg1) {
    if (func_80BD7E0C((Actor *) (s16) (arg0->unk16 + 0x4000), arg1) != 0) {
        arg0->unk1AC = func_80BD7F4C;
...
void BgIknvObj_UpdateSakonDoor(BgIknvObj *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.weekEventReg[58] & 0x80) != 0) {
        self->actionFunc = (void (*)(BgIknvObj *, GlobalContext *)) func_80BD8040;
