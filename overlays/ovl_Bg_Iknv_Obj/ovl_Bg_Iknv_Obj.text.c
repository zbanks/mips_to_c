...
void BgIknvObj_Init(BgIknvObj *this, GlobalContext *globalCtx) {
...
void BgIknvObj_Destroy(BgIknvObj *this, GlobalContext *globalCtx) {
    ColliderCylinder *temp_a1;
    s32 temp_v0;
    BgIknvObj *this = (BgIknvObj *) thisx;
...
void BgIknvObj_Update(BgIknvObj *this, GlobalContext *globalCtx) {
    BgIknvObj *this = (BgIknvObj *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgIknvObj_Draw(BgIknvObj *this, GlobalContext *globalCtx) {
