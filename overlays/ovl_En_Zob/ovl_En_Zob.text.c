...
typedef struct EnZob {
    ...
    /* 0x02A8 */ ColliderCylinder unk2A8;           /* inferred */
    /* 0x02F4 */ u16 unk2F4;                        /* inferred */
    /* 0x02F6 */ Vec3s unk2F6;                      /* inferred */
    /* 0x02FC */ Vec3s unk2FC;                      /* inferred */
    /* 0x0302 */ s16 unk302;                        /* inferred */
    /* 0x0304 */ u16 unk304;                        /* inferred */
    /* 0x0306 */ s16 unk306;                        /* inferred */
    /* 0x0308 */ char pad308[0x6];                  /* maybe part of unk306[4]? */
    /* 0x030E */ s16 unk30E;                        /* inferred */
    /* 0x0310 */ s16 unk310;                        /* inferred */
    /* 0x0312 */ s16 unk312;                        /* inferred */
    /* 0x0314 */ void (*actionFunc)(EnZob *, GlobalContext *);
} EnZob;                                            /* size 0x318 */
...
void EnZob_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2A8, &this->actor, &D_80BA10D0);
    this->unk2F4 = 0;
    this->unk30E = -1;
    this->unk310 = 0;
    this->unk302 = 9;
...
void func_80B9FDDC(EnZob *this, GlobalContext *globalCtx) {
    func_801518B0(globalCtx, 0x120CU, &this->actor);
    this->actionFunc = func_80BA00BC;
}

void func_80B9FE1C(EnZob *this, GlobalContext *globalCtx) {
    func_801518B0(globalCtx, 0x1211U, &this->actor);
    this->actionFunc = func_80BA00BC;
}
...
void func_80BA0610(EnZob *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        ...
        func_801518B0(globalCtx, 0x120DU, &this->actor);
        this->unk304 = 3;
...
void func_80BA0728(EnZob *this, GlobalContext *globalCtx) {
    ...
    if (func_800B8718(this, globalCtx) != 0) {
        ...
        if ((temp_f0 < 180.0f) && (temp_f0 > 60.0f) && (Actor_IsLinkFacingActor(&this->actor, 0x3000, globalCtx) != 0) && (Actor_IsActorFacingLink(&this->actor, 0x3000) != 0)) {
...
void func_80BA0AD8(EnZob *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.xzDistToPlayer < 120.0f) && (Actor_IsLinkFacingActor(&this->actor, 0x3000, globalCtx) != 0) && (Actor_IsActorFacingLink(&this->actor, 0x3000) != 0)) {
...
void EnZob_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk30E != -1) && (ActorCutscene_GetCurrentIndex() != (this + (this->unk30E * 2))->unk306)) {
        if (ActorCutscene_GetCurrentIndex() == 0x7C) {
            ...
            ActorCutscene_Start((this + (this->unk30E * 2))->unk306, &this->actor);
        } else {
            ActorCutscene_SetIntentToPlay((this + (this->unk30E * 2))->unk306);
        }
    }
    if ((this->unk2F4 & 1) != 0) {
        func_800E9250(globalCtx, &this->actor, &this->unk2F6, &this->unk2FC, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        return;
    }
    Math_SmoothStepToS(&this->unk2F6.x, 0, 6, 0x1838, (s16) 0x64);
    Math_SmoothStepToS(&this->unk2F6.y, 0, 6, 0x1838, (s16) 0x64);
    Math_SmoothStepToS(&this->unk2FC.x, 0, 6, 0x1838, (s16) 0x64);
...
void EnZob_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BA0F64, func_80BA0FAC, &this->actor);
    if ((this->unk2F4 & 0x20) != 0) {
