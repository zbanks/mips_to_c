typedef struct EnZob {
    ...
    /* 0x2A8 */ ColliderCylinder unk_2A8;           /* inferred */
    /* 0x2F4 */ u16 unk_2F4;                        /* inferred */
    /* 0x2F6 */ Vec3s unk_2F6;                      /* inferred */
    /* 0x2FC */ Vec3s unk_2FC;                      /* inferred */
    /* 0x302 */ s16 unk_302;                        /* inferred */
    /* 0x304 */ s16 unk_304;                        /* inferred */
    /* 0x306 */ s16 unk_306;                        /* inferred */
    /* 0x308 */ char pad_308[0x6];                  /* maybe part of unk_306[4]? */
...
void EnZob_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, temp_s0, &D_06010810, &D_06006998, &this->unk_188, &this->unk_218, 0x18);
    SkelAnime_ChangeAnimDefaultRepeat(temp_s0, &D_06006998);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_2A8, (Actor *) this, &D_80BA10D0);
    this->unk_2F4 = 0;
    this->unk_30E = -1;
    this->unk_310 = 0;
    this->unk_302 = 9;
    ...
    this->actor.cutscene = (s8) this->unk_306;
    if (temp_v0 != 1) {
        if (temp_v0 != 2) {
...
void EnZob_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnZob *this = (EnZob *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_2A8);
}
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        ...
        case 0:
            ...
            if (Rand_ZeroFloat(1.0f) > 0.7f) {
                ...
                func_80B9F7E4(arg0, arg0->unk_302, 2U, arg0);
            }
            break;
        case 1:
...
void func_80B9FC0C(EnZob *arg0) {
    ...
    if (arg0->unk_30E != -1) {
        arg0 = arg0;
        temp_a0 = (arg0 + (arg0->unk_30E * 2))->unk_306;
...
void func_80B9FD24(EnZob *this, GlobalContext *globalCtx) {
    ...
    func_80B9F86C(this);
    if ((func_800EE29C(globalCtx, 0x1F4U) != 0) && (this->unk_30E = -1, temp_v1 = (s16) globalCtx->csCtx.npcActions[func_800EE200(globalCtx, 0x1F4U)]->unk0, (temp_v1 != this->unk_310))) {
        this->unk_310 = temp_v1;
        if (temp_v1 != 1) {
            if (temp_v1 != 2) {
                return;
            }
    ...
    if (temp_v0 != 4) {
        ...
        if (func_80147624(temp_a0) != 0) {
            ...
            case 4605:
                ...
                func_80151938(globalCtx, (temp_v0_2->unk_680C + 1) & 0xFFFF);
                return;
            case 4606:
                this->unk_304 = 1;
                globalCtx = temp_a3;
            ...
            case 4629:
                ...
                this->unk_304 = 0;
                func_80B9F7E4(this, 6, 2U);
                temp_t9 = this->unk_2F4 & 0xFFFE;
                this->unk_2F4 = temp_t9;
                this->unk_2F4 = temp_t9 | 2;
                return;
            case 4615:
                func_801477B4(temp_a3);
...
void func_80BA0C14(EnZob *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 < 0x31F) {
        this->unk_312 = temp_v0 + 0xC8;
    } else {
        this->unk_312 = temp_v0 + 0x1E;
    }
    if ((s32) this->unk_312 >= 0x3E8) {
        this->unk_312 = 0x3E7;
    }
    this = this;
...
void EnZob_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk_30E != -1) && (ActorCutscene_GetCurrentIndex() != (this + (this->unk_30E * 2))->unk_306)) {
        if (ActorCutscene_GetCurrentIndex() == 0x7C) {
            ActorCutscene_Stop(0x7C);
            ActorCutscene_SetIntentToPlay((this + (this->unk_30E * 2))->unk_306);
        } else if (ActorCutscene_GetCanPlayNext((this + (this->unk_30E * 2))->unk_306) != 0) {
            ActorCutscene_Start((this + (this->unk_30E * 2))->unk_306, (Actor *) this);
        } else {
            ActorCutscene_SetIntentToPlay((this + (this->unk_30E * 2))->unk_306);
        }
    }
    if ((this->unk_2F4 & 1) != 0) {
        func_800E9250(globalCtx, (Actor *) this, &this->unk_2F6, &this->unk_2FC, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        return;
    }
    Math_SmoothStepToS((s16 *) &this->unk_2F6, 0, 6, 0x1838, (s16) 0x64);
    Math_SmoothStepToS(&this->unk_2F6.y, 0, 6, 0x1838, (s16) 0x64);
    Math_SmoothStepToS((s16 *) &this->unk_2FC, 0, 6, 0x1838, (s16) 0x64);
    Math_SmoothStepToS(&this->unk_2FC.y, 0, 6, 0x1838, (s16) 0x64);
}
...
void EnZob_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk_2F4 & 0x20) != 0) {
        temp_s1->polyOpa.p = Gfx_SetFog(temp_s1->polyOpa.p, 0, 0, 0, 0, (s32) this->unk_312, 0x3E8);
    }
    SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80BA0F64, func_80BA0FAC, (Actor *) this);
    if ((this->unk_2F4 & 0x20) != 0) {
