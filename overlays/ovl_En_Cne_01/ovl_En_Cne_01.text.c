typedef struct EnCne01 {
    /* 0x000 */ Actor actor;
    /* 0x144 */ void (*actionFunc)(EnCne01 *, GlobalContext *);
    /* 0x148 */ void (*unk148)(EnCne01 *, GlobalContext *); /* inferred */
    /* 0x14C */ char pad14C[0x2];
    /* 0x14E */ u8 unk14E;                          /* inferred */
    /* 0x14F */ char pad14F[0x1];
    /* 0x150 */ void **unk150;                      /* inferred */
    /* 0x154 */ char pad154[0x18];                  /* maybe part of unk150[7]? */
    /* 0x16C */ Vec3s *unk16C;                      /* inferred */
    /* 0x170 */ char pad170[0x20];                  /* maybe part of unk16C[9]? */
    /* 0x190 */ s8 unk190;                          /* inferred */
    /* 0x191 */ s8 unk191;                          /* inferred */
    /* 0x192 */ s8 unk192;                          /* inferred */
    /* 0x193 */ s8 unk193;                          /* inferred */
    /* 0x194 */ ColliderCylinder unk194;            /* inferred */
    /* 0x1E0 */ u16 unk1E0;                         /* inferred */
    /* 0x1E2 */ s8 unk1E2;                          /* inferred */
    /* 0x1E3 */ s8 unk1E3;                          /* inferred */
    /* 0x1E4 */ Path *unk1E4;                       /* inferred */
    /* 0x1E8 */ s16 unk1E8;                         /* inferred */
    /* 0x1EA */ char pad1EA[0xDC];                  /* maybe part of unk1E8[111]? */
    /* 0x2C6 */ ? unk2C6;                           /* inferred */
    /* 0x2C6 */ char pad2C6[0x4];
    /* 0x2CA */ u16 unk2CA;                         /* inferred */
    /* 0x2CC */ ? unk2CC;                           /* inferred */
    /* 0x2CC */ char pad2CC[0x4];
    /* 0x2D0 */ u16 unk2D0;                         /* inferred */
    /* 0x2D2 */ ? unk2D2;                           /* inferred */
    /* 0x2D2 */ char pad2D2[0x4];
    /* 0x2D6 */ u16 unk2D6;                         /* inferred */
    /* 0x2D8 */ ? unk2D8;                           /* inferred */
    /* 0x2D8 */ char pad2D8[0x4];
    /* 0x2DC */ u16 unk2DC;                         /* inferred */
    /* 0x2DE */ ? unk2DE;                           /* inferred */
    /* 0x2DE */ char pad2DE[0x4];
    /* 0x2E2 */ u16 unk2E2;                         /* inferred */
    /* 0x2E4 */ ? unk2E4;                           /* inferred */
    /* 0x2E4 */ char pad2E4[0x4];
    /* 0x2E8 */ u16 unk2E8;                         /* inferred */
    /* 0x2EA */ char pad2EA[0x42];                  /* maybe part of unk2E8[34]? */
    /* 0x32C */ ? unk32C;                           /* inferred */
    /* 0x32C */ char pad32C[0x2F0];
} EnCne01;                                          /* size = 0x61C */

struct _mips2c_stack_EnCne01_Destroy {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnCne01_Draw {
    /* 0x00 */ char pad0[0x58];
};                                                  /* size = 0x58 */

struct _mips2c_stack_EnCne01_Init {
    /* 0x00 */ char pad0[0x24];
    /* 0x24 */ ColliderCylinder *sp24;              /* inferred */
    /* 0x28 */ char pad28[0x8];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnCne01_Update {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809CB290 {
    /* 0x00 */ char pad0[0x30];
...
struct _mips2c_stack_func_809CB404 {
    /* 0x00 */ char pad0[0x1C];
    /* 0x1C */ s32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809CB4A0 {
    /* 0x00 */ char pad0[0x1C];
    /* 0x1C */ s16 sp1C;                            /* inferred */
    /* 0x1E */ s16 sp1E;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809CB520 {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_809CB5A0 {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_809CB5D8 {};              /* size 0x0 */

struct _mips2c_stack_func_809CB5FC {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809CB920 {
    /* 0x00 */ char pad0[0x20];
...
struct _mips2c_stack_func_809CBBC8 {
    /* 0x00 */ char pad0[0x2C];
    /* 0x2C */ ? sp2C;                              /* inferred */
    /* 0x2C */ char pad2C[0x14];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_809CBCA0 {};              /* size 0x0 */
...
static s16 D_809CBF58[16] = {0xFA0, 4, 1, 3, 0x1770, 4, 1, 6, 0xFA0, 4, 1, 3, 0x1770, 4, 1, 6};
...
void EnCne01_Init(EnCne01 *this, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, (Actor *) this, &D_809CBF00);
...
void EnCne01_Destroy(EnCne01 *this, GlobalContext *globalCtx) {
    EnCne01 *this = (EnCne01 *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk194);
}

void EnCne01_Update(EnCne01 *this, GlobalContext *globalCtx) {
    EnCne01 *this = (EnCne01 *) thisx;
    func_809CB404((Actor *) this, globalCtx);
    this->actionFunc(this, globalCtx);
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 0.0f, 0.0f, 0.0f, 4U);
    func_809CB290(this, globalCtx);
    func_809CB4A0((Actor *) this, globalCtx);
}
...
s32 func_809CB920(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    sp34.unk0 = (s32) D_809CBF78.unk0;
    sp34.unk4 = (s32) D_809CBF78.unk4;
    sp34.unk8 = (s32) D_809CBF78.unk8;
...
void func_809CBBC8(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp2C.unk0 = (s32) D_809CBF84.unk0;
    sp2C.unk4 = (s32) D_809CBF84.unk4;
    sp2C.unk8 = (s32) D_809CBF84.unk8;
    if (arg1 == 7) {
        temp_a1 = *arg0;
...
void EnCne01_Draw(EnCne01 *this, GlobalContext *globalCtx) {
    Gfx *temp_s7;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    ...
    func_801343C0(globalCtx, this->unk150, this->unk16C, (s32) this->unk14E, func_809CB920, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_809CBBC8, func_809CBCA0, (Actor *) this);
