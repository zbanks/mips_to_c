...
void ObjNozoki_Init(ObjNozoki *this, GlobalContext *globalCtx) {
    u8 temp_t3;
...
void ObjNozoki_Destroy(ObjNozoki *this, GlobalContext *globalCtx) {
    ObjNozoki *this = (ObjNozoki *) thisx;
    if (this->unk15C == 0) {
...
void ObjNozoki_Update(ObjNozoki *this, GlobalContext *globalCtx) {
    ObjNozoki *this = (ObjNozoki *) thisx;
