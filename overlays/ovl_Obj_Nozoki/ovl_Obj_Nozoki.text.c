...
void func_80BA2B64(ObjNozoki *arg0, GlobalContext *arg1, u8 arg2, s32 arg3); /* static */
...
static InitChainEntry D_80BA34B0;                   /* unable to generate initializer */
...
void ObjNozoki_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80BA34B0);
    this->actor.shape.rot.x = 0;
    this->actor.shape.rot.z = 0;
    this->unk15F = this->actor.cutscene;
...
void func_80BA2514(ObjNozoki *this, GlobalContext *globalCtx) {
    ...
    sp20 = temp_a0;
    temp_v0 = Object_GetIndex(temp_a0, *(&D_80BA34B8 + (this->unk15C * 2)));
    if (temp_v0 < 0) {
    ...
    if (Object_IsLoaded(temp_a0, temp_v0) != 0) {
        ...
        if (temp_v0_2 == 0) {
            ...
            if (ActorCutscene_GetAdditionalCutscene((s16) this->unk15F) >= 0) {
        ...
        if (temp_v0_2 == 1) {
            Lib_Vec3f_TranslateAndRotateY(&this->actor.world.pos, this->actor.shape.rot.y, &D_80BA34C0, &this->actor.home.pos);
        ...
        if (temp_v0_2 == 2) {
            ...
            Lib_Vec3f_TranslateAndRotateY(&this->actor.home.pos, this->actor.shape.rot.y, &D_80BA34CC, &temp_a3->pos);
            Math_Vec3f_Copy(&this->actor.world.pos, (Vec3f *) sp20);
...
s32 func_80BA26A8(Actor *arg0) {
    ...
    if (ActorCutscene_GetCanPlayNext(temp_a0) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields((s16) arg0->unk15F, arg0);
        return 1;
    }
    ActorCutscene_SetIntentToPlay((s16) arg0->unk15F);
    return 0;
}
...
s32 func_80BA2708(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_s0 != 0) {
loop_2:
        Actor_CalcOffsetOrientedToDrawRotation(arg0, &sp30, phi_s0 + 0x24);
        if (sp30.z >= 0.0f) {
            return 0;
        }
...
void func_80BA27C4(ObjNozoki *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v1 & 0x20) == 0) {
        if ((this->actor.params & 0x200) != 0) {
            if (func_80BA2708(&this->actor, globalCtx) == 0) {
                return;
            }
            goto block_7;
        }
...
block_7:
            if ((D_80BA36B0 == 0) || (func_80BA26A8(&this->actor) != 0)) {
                func_80BA2790(this);
                if (D_80BA36B0 == 0) {
                    this->unk15E = 0x19;
                    play_sound(0x485FU);
                } else {
                    this->unk15E = ActorCutscene_GetLength((s16) this->unk15F);
                    if ((s32) this->unk15E < 0) {
                        this->unk15E = 0x32;
                    }
                    globalCtx->actorCtx.unk5 |= 0x10;
                }
            }
            globalCtx->actorCtx.actorList[2].first->unkAD0 = 0.0f;
        }
...
void func_80BA28DC(ObjNozoki *this, GlobalContext *globalCtx) {
    ...
    if ((globalCtx->actorCtx.unk5 & 0x20) == 0) {
        ...
        if (Flags_GetSwitch(globalCtx, temp_v1 & 0x7F) != 0) {
            ...
            if (temp_v1_2 == this->unk15F) {
                if (((this->actor.params & 0x400) != 0) && (Actor_CalcOffsetOrientedToDrawRotation(&this->actor, &sp28, &globalCtx->actorCtx.actorList[2].first->world.pos), (sp28.z < -20.0f))) {
                    this->unk15F = ActorCutscene_GetAdditionalCutscene((s16) this->unk15F);
                    return;
                }
                // Duplicate return node #21. Try simplifying control flow for better match
                return;
            ...
            sp34 = (s32) temp_v1_2;
            if (ActorCutscene_GetCurrentIndex() != this->unk15F) {
                this->unk15F = temp_v1_2;
...
void func_80BA2C94(ObjNozoki *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 >= 0) || (func_801690CC(globalCtx) == 0)) {
        if (D_80BA36B8 < *(&D_80BA34D8 + (D_80BA36B4 * 4))) {
            ...
            if ((this->unk15D != 1) && (Flags_GetSwitch(globalCtx, (s32) this->actor.world.rot.z) != 0)) {
                func_80BA2B64(this, globalCtx, 1U, (s32) this->actor.world.rot.x);
            } else if ((this->unk15D != 2) && (Flags_GetSwitch(globalCtx, (s32) this->actor.world.rot.x) != 0)) {
            ...
            Math_StepToF(&this->actor.speedXZ, *(&D_80BA34E4 + (this->unk15D * 4)), 0.1f);
            temp_v1 = globalCtx->actorCtx.unk5;
            ...
            sp24 = temp_a0;
            sp20 = temp_a1;
            temp_f0 = Math_Vec3f_StepToXZ(&temp_a0->pos, &temp_a1->pos, phi_f0);
            temp_f2 = temp_f0;
            ...
            if ((temp_v1_2 & 0x40) != 0) {
                ...
                Lib_Vec3f_TranslateAndRotateY(&sp20->pos, this->actor.shape.rot.y, &D_80BA34F0, &sp24->pos);
                this->actor.shape.rot.x = -0x1F40;
        ...
        globalCtx->roomCtx.unk7A = (s16) (s32) this->actor.velocity.x;
...
void func_80BA3044(ObjNozoki *this, GlobalContext *globalCtx) {
    ...
    if (temp_a3->unk15D == 0) {
        ...
        if ((temp_v0 & 0x40) != 0) {
            ...
            temp_a3->unk15E = 0x14;
            this = temp_a3;
            Math_Vec3f_Copy(&temp_a3->actor.world.pos, &temp_a2->pos);
            phi_a3 = this;
        ...
        temp_v0_2 = temp_a3->unk15E;
        if (temp_v0_2 == 0) {
            phi_v1 = 0;
        } else {
            temp_a3->unk15E = temp_v0_2 - 1;
            phi_v1 = temp_a3->unk15E;
        }
        if (phi_v1 == 0) {
            sp1C = &temp_a3->actor.home;
        }
    }
    Math_Vec3f_StepToXZ(phi_a3 + 0x24, &sp1C->pos, 8.0f);
}
...
void func_80BA311C(ObjNozoki *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 1) {
        if (D_80BA36B8 > 40.0f) {
            this->unk15D = 2;
            Audio_PlayActorSound2(&this->actor, 0x832U);
            return;
        }
        temp_v0_2 = this->unk15E;
        if (temp_v0_2 != 0) {
            ...
            if (phi_v1 == 0) {
                Audio_PlayActorSound2(&this->actor, 0x29ABU);
                return;
            }
            // Duplicate return node #14. Try simplifying control flow for better match
            return;
...
void func_80BA3344(ObjNozoki *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.textId == 0) || (func_800B867C(&this->actor, globalCtx) != 0)) {
