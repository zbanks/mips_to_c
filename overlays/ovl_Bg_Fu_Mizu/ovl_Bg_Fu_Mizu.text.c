typedef struct BgFuMizu {
    ...
    /* 0x148 */ char pad148[0x18];                  /* maybe part of unk144[7]? */
...
void BgFuMizu_Init(BgFuMizu *this, GlobalContext *globalCtx) {
...
void BgFuMizu_Destroy(BgFuMizu *this, GlobalContext *globalCtx) {
    BgFuMizu *this = (BgFuMizu *) thisx;
...
s32 func_80ADABA4(BgFuMizu *arg0, void *arg1) {
    ...
    temp_v0 = arg1->unk1CC0;
    phi_v0 = temp_v0;
    if (temp_v0 != 0) {
loop_1:
        if ((phi_v0 != 0) && (phi_v0->unk0 == 0x1B4) && (phi_v0->unkB7 == 0)) {
            return 0;
        }
...
void BgFuMizu_Update(BgFuMizu *this, GlobalContext *globalCtx) {
    f32 phi_f0;
    BgFuMizu *this = (BgFuMizu *) thisx;
...
void BgFuMizu_Draw(BgFuMizu *this, GlobalContext *globalCtx) {
