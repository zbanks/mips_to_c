...
void EnScopecoin_Init(EnScopecoin *this, GlobalContext *globalCtx) {
    s16 temp_v0;
...
void EnScopecoin_Destroy(EnScopecoin *this, GlobalContext *globalCtx) {
    EnScopecoin *this = (EnScopecoin *) thisx;

}

void EnScopecoin_Update(EnScopecoin *this, GlobalContext *globalCtx) {
    EnScopecoin *this = (EnScopecoin *) thisx;
    this->actionFunc(this, globalCtx);
}

void EnScopecoin_Draw(EnScopecoin *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *sp20;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
