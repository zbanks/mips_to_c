...
static ActorAnimationEntryS D_80C19180 = {
...
static void *D_80C19218 = {(void *)0x6009DF0, (void *)0x600A1F0};
...
typedef struct EnAnd {
    ...
    /* 0x0188 */ void (*actionFunc)(EnAnd *, GlobalContext *);
    /* 0x018C */ u8 unk18C;                         /* inferred */
    /* 0x018D */ char pad18D[0x2B];                 /* maybe part of unk18C[44]? */
    /* 0x01B8 */ Vec3s unk1B8;                      /* inferred */
    /* 0x01BE */ char pad1BE[0x96];                 /* maybe part of unk1B8[26]? */
    /* 0x0254 */ Vec3s unk254;                      /* inferred */
    /* 0x025A */ char pad25A[0x96];                 /* maybe part of unk254[26]? */
    /* 0x02F0 */ u16 unk2F0;                        /* inferred */
    /* 0x02F2 */ char pad2F2[0xE];                  /* maybe part of unk2F0[8]? */
    ...
    /* 0x0310 */ char pad310[0x4];                  /* maybe part of unk30C[2]? */
} EnAnd;                                            /* size 0x314 */
...
void func_80C18C50(EnAnd *this, GlobalContext *globalCtx) {
    ...
    if (globalCtx->csCtx.state != 0) {
        ...
        if (func_800EE29C(temp_a0, 0x235U) != 0) {
            ...
            func_800EDF24(&this->actor, globalCtx, sp28);
            return;
        }
...
void EnAnd_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, NULL, func_80C18ED0, &this->actor);
}
