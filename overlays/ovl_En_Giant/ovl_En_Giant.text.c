...
void func_80B023D0(EnGiant *this, GlobalContext *globalCtx) {
    ...
    func_80B02234(&this->actor);
    if (this->unk24C == 5) {
        func_800B9010(&this->actor, 0x1063U);
    }
    func_80B0211C(this);
}
...
void func_80B024D8(EnGiant *this, GlobalContext *globalCtx) {
    this->actor.draw = EnGiant_Draw;
    if (func_800EE29C(globalCtx, (u32) this->unk24A) != 0) {
        func_800EDF24(&this->actor, globalCtx, func_800EE200(globalCtx, (u32) this->unk24A));
        if (this->unk24C != globalCtx->csCtx.npcActions[func_800EE200(globalCtx, (u32) this->unk24A)]->unk0) {
            this->unk24C = globalCtx->csCtx.npcActions[func_800EE200(globalCtx, (u32) this->unk24A)]->unk0;
            func_80B01EE8(this);
        }
...
void EnGiant_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        if ((s32) temp_v0 >= 0xFF) {
            ...
            SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80B02688, &this->actor);
            return;
        }
        if ((s32) temp_v0 > 0) {
            if ((s32) temp_v0 >= 0x81) {
            ...
            temp_s0->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80B026C4, &this->actor, temp_s0->polyXlu.p);
