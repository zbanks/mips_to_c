typedef struct EnGiant {
    ...
    /* 0x24A */ u16 unk24A;                         /* inferred */
    /* 0x24C */ u16 unk24C;                         /* inferred */
    /* 0x24E */ s16 unk24E;                         /* inferred */
    /* 0x250 */ s16 unk250;                         /* inferred */
    /* 0x252 */ char pad252[0x2];
    /* 0x254 */ MtxF unk254;                        /* inferred */
...
void EnGiant_Init(EnGiant *this, GlobalContext *globalCtx) {
    s32 sp40;
    s16 sp3C;
    s32 sp38;
    ...
    temp_a1 = &this->unk144;
    sp30 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_060079B0, &D_06002168, &this->unk188, &this->unk1E8, 0x10);
...
void EnGiant_Destroy(EnGiant *this, GlobalContext *globalCtx) {
    EnGiant *this = (EnGiant *) thisx;
...
void func_80B01EE8(EnGiant *arg0) {
    ...
    case 15:
        ...
        SkelAnime_ChangeAnim(&arg0->unk144, (AnimationHeader *) &D_060116E4, 0.0f, (f32) sp34 - 1.0f, (f32) SkelAnime_GetFrameCount(&D_060116E4), (u8) 2, 0.0f);
...
void func_80B020A0(EnGiant *arg0) {
    ...
    if (temp_v0 != 6) {
        if (temp_v0 != 0xE) {
            temp_v0_2 = arg0->unk24E;
            if ((s32) temp_v0_2 < 0xFF) {
                arg0->unk24E = temp_v0_2 + 8;
            }
            /* Duplicate return node #9. Try simplifying control flow for better match */
            return;
        }
    ...
    if ((arg0->unk144.animCurrentFrame >= 90.0f) && (temp_v0_3 = arg0->unk24E, ((s32) temp_v0_3 > 0))) {
        arg0->unk24E = temp_v0_3 - 0xC;
    }
}
...
void func_80B0211C(EnGiant *arg0) {
    ...
    arg0 = arg0;
    temp_a2 = arg0;
    if ((SkelAnime_FrameUpdateMatrix(temp_a0) != 0) && ((temp_a1 = temp_a2->unk248, temp_a0_2 = temp_a2, (temp_a1 != 2)) || (temp_a2->unk24C != 6))) {
        arg0 = temp_a2;
...
void func_80B02234(Actor *arg0) {
    ...
    if ((arg0->draw != 0) && ((s32) arg0->unk24E > 0)) {
        temp_a0 = arg0 + 0x144;
        if ((arg0->unk248 == 8) && ((sp24 = temp_a0, (func_801378B8(temp_a0, 40.0f) != 0)) || (func_801378B8(temp_a0, 100.0f) != 0))) {
            Audio_PlayActorSound2(arg0, 0x294EU);
        }
        if ((arg0->unk248 == 2) && (func_801378B8((SkelAnime *) (arg0 + 0x144), 40.0f) != 0)) {
            Audio_PlayActorSound2(arg0, 0x294DU);
        }
        temp_a1 = arg0->unk250;
        temp_v0 = arg0->unk248;
        if ((temp_a1 != 0xFFFF) && (((temp_v0 == 9) && (arg0->unk15C >= 18.0f)) || (temp_v0 == 0xA))) {
            func_800B9010(arg0, temp_a1);
        }
        if (((arg0->unk248 == 0xC) && (arg0->unk15C >= 18.0f)) || (arg0->unk248 == 0xD)) {
...
void func_80B02354(EnGiant *arg0, GlobalContext *arg1, u32 arg2) {
    ...
    temp_f2 = (f32) temp_v0->unk10;
    sp1C = (f32) temp_v0->unk1C;
    sp28 = temp_f2;
    arg0->actor.world.pos.y = ((sp1C - temp_f2) * func_800F5A8C(temp_v0->unk4, temp_v0->unk2, arg1->csCtx.frames, arg1)) + temp_f2;
}

void func_80B023D0(EnGiant *this, GlobalContext *globalCtx) {
    if (func_800EE29C(globalCtx, (u32) this->unk24A) != 0) {
        func_80B02354(this, globalCtx, func_800EE200(globalCtx, (u32) this->unk24A));
        if (this->unk24C != globalCtx->csCtx.npcActions[func_800EE200(globalCtx, (u32) this->unk24A)]->unk0) {
            this->unk24C = globalCtx->csCtx.npcActions[func_800EE200(globalCtx, (u32) this->unk24A)]->unk0;
            func_80B01EE8(this);
        }
        func_80B020A0(this);
    }
...
void func_80B024D8(EnGiant *this, GlobalContext *globalCtx) {
    this->actor.draw = EnGiant_Draw;
    if (func_800EE29C(globalCtx, (u32) this->unk24A) != 0) {
        func_800EDF24((Actor *) this, globalCtx, func_800EE200(globalCtx, (u32) this->unk24A));
        if (this->unk24C != globalCtx->csCtx.npcActions[func_800EE200(globalCtx, (u32) this->unk24A)]->unk0) {
            this->unk24C = globalCtx->csCtx.npcActions[func_800EE200(globalCtx, (u32) this->unk24A)]->unk0;
            func_80B01EE8(this);
        }
...
void EnGiant_Update(EnGiant *this, GlobalContext *globalCtx) {
    s16 temp_v1;
    s16 phi_v0;
    s16 phi_v1;
    EnGiant *this = (EnGiant *) thisx;
    ...
    if (temp_v1 == 0) {
        ...
        this->unk296 = temp_v1 - 1;
        phi_v0 = this->unk296;
    }
    phi_v1 = this->unk296;
    if (phi_v0 == 0) {
        this->unk296 = Rand_S16Offset(0x3C, 0x3C);
        phi_v1 = this->unk296;
    }
    this->unk294 = phi_v1;
    if ((s32) this->unk294 >= 3) {
        this->unk294 = 0;
    }
}
...
void EnGiant_Draw(EnGiant *this, GlobalContext *globalCtx) {
    Gfx *sp3C;
    Gfx *sp34;
    Gfx *temp_a1;
    Gfx *temp_a1_2;
    ...
    if ((s32) temp_v0 > 0) {
        ...
        if ((s32) temp_v0 >= 0xFF) {
            ...
            sp3C = temp_v0_2;
            sp3C->words.w1 = Lib_SegmentedToVirtual(*(&D_80B0298C + (this->unk294 * 4)));
            temp_v0_3 = temp_s0->polyOpa.p;
            temp_s0->polyOpa.p = temp_v0_3 + 8;
            temp_v0_3->words.w1 = 0xFF;
            temp_v0_3->words.w0 = 0xFB000000;
            Scene_SetRenderModeXlu(globalCtx, 0, 1U);
            SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80B02688, (Actor *) this);
            return;
        }
        if ((s32) temp_v0 > 0) {
            if ((s32) temp_v0 >= 0x81) {
            ...
            sp34 = temp_a1_3;
            sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_80B0298C + (this->unk294 * 4)));
            temp_a1_4 = temp_s0->polyXlu.p;
            temp_s0->polyXlu.p = temp_a1_4 + 8;
            temp_a1_4->words.w0 = 0xFB000000;
            temp_a1_4->words.w1 = this->unk24E & 0xFF;
            temp_s0->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80B026C4, (Actor *) this, temp_s0->polyXlu.p);
            SysMatrix_InsertMatrix(&this->unk254, 0);
