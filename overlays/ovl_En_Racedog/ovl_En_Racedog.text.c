typedef struct EnRacedog {
    ...
    /* 0x1F2 */ char pad1F2[0x48];                  /* maybe part of unk1EC[13]? */
    /* 0x23A */ Vec3s unk23A;                       /* inferred */
    /* 0x240 */ char pad240[0x48];                  /* maybe part of unk23A[13]? */
    /* 0x288 */ s16 unk288;                         /* inferred */
    /* 0x28A */ s16 unk28A;                         /* inferred */
    /* 0x28C */ s16 unk28C;                         /* inferred */
    /* 0x28E */ char pad28E[0x2];
    /* 0x290 */ s16 unk290;                         /* inferred */
    /* 0x292 */ s16 unk292;                         /* inferred */
    /* 0x294 */ char pad294[0x4];                   /* maybe part of unk292[3]? */
    ...
    /* 0x2B0 */ char pad2B0[0x8];                   /* maybe part of unk2AC[3]? */
...
void EnRacedog_Init(EnRacedog *this, GlobalContext *globalCtx) {
...
void EnRacedog_Destroy(EnRacedog *this, GlobalContext *globalCtx) {
    EnRacedog *this = (EnRacedog *) thisx;
...
void EnRacedog_Update(EnRacedog *this, GlobalContext *globalCtx) {
    f32 sp2C;
    f32 *sp28;
    f32 *temp_a0;
    f32 temp_f0;
...
void func_80B25A90(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp1C.unk0 = (s32) D_80B26000.unk0;
    sp1C.unk4 = (s32) D_80B26000.unk4;
    sp1C.unk8 = (s32) D_80B26000.unk8;
    if (arg1 == 5) {
        arg1 = arg1;
...
void EnRacedog_Draw(EnRacedog *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk14C.skeleton, this->unk14C.limbDrawTbl, (s32) this->unk14C.dListCount, func_80B25A74, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80B25A90, (Actor *) this);
}
