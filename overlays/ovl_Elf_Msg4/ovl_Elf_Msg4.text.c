...
void ElfMsg4_Init(ElfMsg4 *this, GlobalContext *globalCtx) {
    ElfMsg4 *temp_a0;
    f32 temp_f0;
    s16 temp_v0;
    s16 temp_v0_2;
...
void ElfMsg4_Destroy(ElfMsg4 *this, GlobalContext *globalCtx) {
    ElfMsg4 *this = (ElfMsg4 *) thisx;
...
void ElfMsg4_Update(ElfMsg4 *this, GlobalContext *globalCtx) {
    Actor *temp_a0;
    s16 temp_v0;
    s32 temp_a1;
    ElfMsg4 *this = (ElfMsg4 *) thisx;
