...
struct _mips2c_stack_ObjShutter_Update {
    ...
    /* 0x21 */ char pad21[0x17];
};                                                  /* size = 0x38 */

extern ? D_060011E0;
static void D_80A38130;                             /* unable to generate initializer */

void ObjShutter_Init(ObjShutter *this, GlobalContext *globalCtx) {
    ObjShutter *this = (ObjShutter *) thisx;

}

void ObjShutter_Destroy(ObjShutter *this, GlobalContext *globalCtx) {
    ObjShutter *this = (ObjShutter *) thisx;

}

void ObjShutter_Update(ObjShutter *this, GlobalContext *globalCtx) {
    u8 sp20;
    f32 temp_f0;
    f32 temp_f0_2;
    f32 temp_f12;
...
void ObjShutter_Draw(ObjShutter *this, GlobalContext *globalCtx) {
    Gfx *sp20;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
