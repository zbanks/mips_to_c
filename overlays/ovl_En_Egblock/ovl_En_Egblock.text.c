typedef struct EnEgblock {
    ...
    /* 0x1AE */ char pad1AE[0xC06];                 /* maybe part of unk1AC[1540]? */
...
void EnEgblock_Init(EnEgblock *this, GlobalContext *globalCtx) {
...
void EnEgblock_Destroy(EnEgblock *this, GlobalContext *globalCtx) {
    EnEgblock *this = (EnEgblock *) thisx;
...
void EnEgblock_Update(EnEgblock *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    EnEgblock *this = (EnEgblock *) thisx;
...
void EnEgblock_Draw(EnEgblock *this, GlobalContext *globalCtx) {
