typedef struct ObjUsiyane {
    ...
    /* 0x160 */ char pad160[0x5A8];                 /* maybe part of actionFunc[363]? */
    /* 0x708 */ f32 unk708;                         /* inferred */
    /* 0x70C */ f32 unk70C;                         /* inferred */
    /* 0x710 */ Vec3f unk710;                       /* inferred */
    /* 0x71C */ char pad71C[0x28];                  /* maybe part of unk710[4]? */
...
void ObjUsiyane_Init(ObjUsiyane *this, GlobalContext *globalCtx) {
    s32 temp_v0;
...
void ObjUsiyane_Destroy(ObjUsiyane *this, GlobalContext *globalCtx) {
    ObjUsiyane *this = (ObjUsiyane *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->unk144);
}

void ObjUsiyane_Update(ObjUsiyane *this, GlobalContext *globalCtx) {
    ObjUsiyane *this = (ObjUsiyane *) thisx;
    this->actionFunc(this, globalCtx);
}

void ObjUsiyane_Draw(ObjUsiyane *this, GlobalContext *globalCtx) {
    ? sp84;
    f32 sp74;
    s32 temp_s1;
    s32 temp_s1_2;
...
loop_10:
                SysMatrix_StatePush();
                SkinMatrix_SetScaleRotateRPYTranslate((MtxF *) &sp84, 0.1f, 0.1f, 0.1f, (s16) (s32) phi_s0_2->unk180, (s16) (s32) phi_s0_2->unk182, (s16) (s32) phi_s0_2->unk184, phi_s0_2->unk168, phi_s0_2->unk16C, phi_s0_2->unk170);
