typedef struct ObjHakaisi {
    ...
    /* 0x16C */ char pad16C[0x24];                  /* maybe part of unk160[4]? */
    ...
    /* 0x19C */ char pad19C[0x4];                   /* maybe part of unk19A[3]? */
...
void ObjHakaisi_Init(ObjHakaisi *this, GlobalContext *globalCtx) {
...
void ObjHakaisi_Destroy(ObjHakaisi *this, GlobalContext *globalCtx) {
    ObjHakaisi *this = (ObjHakaisi *) thisx;
    if ((this->actor.params & 0xFF) != 3) {
...
void ObjHakaisi_Update(ObjHakaisi *this, GlobalContext *globalCtx) {
    ObjHakaisi *this = (ObjHakaisi *) thisx;
    this->actionFunc(this, globalCtx);
}

void ObjHakaisi_Draw(ObjHakaisi *this, GlobalContext *globalCtx) {
    Gfx *sp30;
    Gfx *sp28;
    Gfx *sp20;
    Gfx *temp_v0_2;
