...
void func_80B1456C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg0->unk_196;
    if (temp_a2 != -1) {
        if (ActorCutscene_GetCanPlayNext(temp_a2) != 0) {
            ActorCutscene_StartAndSetUnkLinkFields(arg0->unk_196, arg0);
        } else {
...
void func_80B14A24(Actor *arg0, GlobalContext *arg1, f32 arg2, f32 arg3, f32 arg4) {
    ...
    temp_s4 = &arg2;
    func_80B14CF8(arg1, subroutine_arg1, temp_s4->unk_4, temp_s4->unk_8, 0x64, 0x1E, 5);
    phi_s0 = 0;
    do {
...
void func_80B14B6C(Actor *arg0, GlobalContext *arg1, f32 arg2, f32 arg3, f32 arg4, s16 arg5) {
    ...
    func_80B14CF8(arg1, subroutine_arg1, arg2.unk_4, arg2.unk_8, 0x64, 0x32, 0x14);
}
...
void func_80B14CF8(GlobalContext *arg0, f32 arg1, f32 arg2, f32 arg3, s16 arg4, s16 arg5, s32 arg6) {
    ...
    temp_s6->unk_4 = (s32) D_80B155E0.unk_4;
    temp_fp = &spAC;
    temp_s6->unk_8 = (s32) D_80B155E0.unk_8;
    temp_s7->unk_0 = D_80B155EC.unk_0;
    temp_s7->unk_4 = (s32) D_80B155EC.unk_4;
    temp_s7->unk_8 = (s32) D_80B155EC.unk_8;
    phi_s1 = 0;
    if (arg6 > 0) {
        do {
...
void func_80B15330(Actor *arg0, GlobalContext *arg1) {
    ...
    SysMatrix_InsertRotationAroundUnitVector_s(arg0->unk_19C, arg0 + 0x184, 0);
