typedef struct EnWood02 {
    ...
    /* 0x14B */ char pad14B[0x4];                   /* maybe part of unk14A[5]? */
    /* 0x14F */ u8 unk14F;                          /* inferred */
    /* 0x150 */ u8 unk150;                          /* inferred */
    /* 0x151 */ u8 unk151;                          /* inferred */
    /* 0x152 */ char pad152[0x2];                   /* maybe part of unk151[3]? */
    /* 0x154 */ ColliderCylinder unk154;            /* inferred */
} EnWood02;                                         /* size = 0x1A0 */
...
struct _mips2c_stack_EnWood02_Draw {
    ...
    /* 0x2C */ char pad2C[0x11];                    /* maybe part of sp28[5]? */
...
block_10:
    ...
    if (((s32) temp_v0_2 < 0xB) || (temp_v0_2 == 0x1A)) {
        ...
        if (this->actor.home.rot.y != 0) {
            sp58.unk0 = this->actor.world.pos.x;
            sp58.unk4 = (f32) this->actor.world.pos.y;
            sp58.unk8 = (f32) this->actor.world.pos.z;
            sp5C += 200.0f;
