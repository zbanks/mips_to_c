...
s32 EnMaYto_SearchRomani(void *arg0, void *arg1) {
    ...
    temp_v1 = arg1->unk_1CE4;
    phi_v1 = temp_v1;
    if (temp_v1 != 0) {
loop_1:
        if (phi_v1->unk_0 == 0x21F) {
            temp_a1 = arg0->unk_204;
            temp_v0 = (s32) (phi_v1->unk_1C & 0xF000) >> 0xC;
...
void EnMaYto_ChangeAnim(EnMaYto *this, s32 index) {
    ...
    sp28 = temp_v1;
    SkelAnime_ChangeAnim(&this->skelAnime, (AnimationHeader *) temp_v1->unk_0, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(temp_v1->unk_0), (u8) (s32) temp_v1->unk_8, temp_v1->unk_C);
}
...
void EnMaYto_SetRomaniFaceExpression(EnMaYto *this, s16 overrideEyeTexIndex, s16 mouthTexIndex) {
    ...
    temp_v0 = this->actor.child;
    if ((temp_v0 != 0) && (temp_v0->id == 0x21F)) {
        temp_v0->unk_328 = overrideEyeTexIndex;
        temp_v0->unk_32E = mouthTexIndex;
    }
}
