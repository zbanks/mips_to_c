struct _mips2c_stack_EnMaYto_AfterMilkRunChooseNextDialogue {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_AfterMilkRunDialogueHandler {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_AfterMilkRunInit {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_BarnChooseNextDialogue {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_BarnDialogueHandler {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_BarnStartDialogue {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_BarnWait {
    /* 0x00 */ char pad0[0x26];
    /* 0x26 */ s16 sp26;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnMaYto_BeginWarmFuzzyFeelingCs {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_ChangeAnim {
    /* 0x00 */ char pad0[0x28];
    /* 0x28 */ void *sp28;                          /* inferred */
    /* 0x2C */ char pad2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnMaYto_CheckValidSpawn {};    /* size 0x0 */

struct _mips2c_stack_EnMaYto_ChooseAction {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_DefaultChooseNextDialogue {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_DefaultDialogueHandler {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnMaYto_DefaultHandlePlayerChoice {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_DefaultStartDialogue {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_DefaultWait {
    /* 0x00 */ char pad0[0x2C];
    /* 0x2C */ s16 sp2C;                            /* inferred */
    /* 0x2E */ char pad2E[0x2];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnMaYto_Destroy {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_DinnerChooseNextDialogue {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_DinnerDialogueHandler {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_DinnerHandlePlayerChoice {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_DinnerStartDialogue {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_DinnerWait {
    /* 0x00 */ char pad0[0x26];
    /* 0x26 */ s16 sp26;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnMaYto_Draw {
    /* 0x00 */ char pad0[0x30];
...
struct _mips2c_stack_EnMaYto_HasSpokeToPlayer {};   /* size 0x0 */

struct _mips2c_stack_EnMaYto_HasSpokeToPlayerToday {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_Init {
    /* 0x00 */ char pad0[0x30];
    /* 0x30 */ ColliderCylinder *sp30;              /* inferred */
    /* 0x34 */ char pad34[0xC];
};                                                  /* size = 0x40 */

struct _mips2c_stack_EnMaYto_InitAnimation {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_InitFaceExpression {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_KeepLookingForRomani {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_OverrideLimbDraw {
    /* 0x00 */ char pad0[0x4];
...
struct _mips2c_stack_EnMaYto_PostLimbDraw {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_PostMilkRunEnd {};     /* size 0x0 */

struct _mips2c_stack_EnMaYto_PostMilkRunExplainReward {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_PostMilkRunGiveReward {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnMaYto_PostMilkRunWaitDialogueEnd {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_SearchRomani {};       /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetFaceExpression {};  /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetRomaniFaceExpression {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetTalkedFlag {};      /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupAfterMilkRunDialogueHandler {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupAfterMilkRunInit {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_SetupBarnDialogueHandler {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_SetupBarnWait {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_SetupBeginWarmFuzzyFeelingCs {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupDefaultDialogueHandler {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_SetupDefaultWait {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_SetupDinnerDialogueHandler {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_SetupDinnerWait {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_SetupKeepLookingForRomani {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupPostMilkRunEnd {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupPostMilkRunExplainReward {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupPostMilkRunGiveReward {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupPostMilkRunWaitDialogueEnd {}; /* size 0x0 */

struct _mips2c_stack_EnMaYto_SetupWarmFuzzyFeelingCs {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_TryFindRomani {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_Update {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMaYto_UpdateCollision {
    /* 0x00 */ char pad0[0x1C];
    /* 0x1C */ ColliderCylinder *sp1C;              /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMaYto_UpdateEyes {};         /* size 0x0 */

struct _mips2c_stack_EnMaYto_WarmFuzzyFeelingCs {
    /* 0x00 */ char pad0[0x24];
    /* 0x24 */ u32 sp24;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80B90C78 {
    /* 0x00 */ char pad0[0x2A];
    /* 0x2A */ s16 sp2A;                            /* inferred */
    /* 0x2C */ void *sp2C;                          /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80B90E50 {};              /* size 0x0 */
...
void EnMaYto_Init(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, (Actor *) this, &D_80B91410);
...
void EnMaYto_InitAnimation(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    switch (temp_t6) {
    case 0:
        EnMaYto_ChangeAnim(this, 0xA);
        return;
    case 2:
        if (((s32) gSaveContext.day % 5) == 1) {
            EnMaYto_ChangeAnim(this, 0xE);
            return;
        }
        EnMaYto_ChangeAnim(this, 0x10);
        return;
    case 1:
        if ((gSaveContext.weekEventReg[22] & 1) != 0) {
            EnMaYto_ChangeAnim(this, 0xC);
            return;
        }
...
void EnMaYto_Destroy(EnMaYto *this, GlobalContext *globalCtx) {
    EnMaYto *this = (EnMaYto *) thisx;
...
void EnMaYto_SetupDefaultWait(EnMaYto *this) {
    if (this->actor.home.rot.y == this->actor.shape.rot.y) {
        this->currentAnim = 0xB;
        EnMaYto_ChangeAnim(this, 0xB);
    } else {
        this->currentAnim = 1;
...
void EnMaYto_DefaultWait(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    sp2C = (s16) (temp_a1 - 0x8000) - this->actor.yawTowardsPlayer;
    if ((Math_SmoothStepToS(&this->actor.shape.rot.y, temp_a1, 5, 0x3000, (s16) 0x100) == 0) && (this->currentAnim == 1)) {
        this->currentAnim = 0xB;
        EnMaYto_ChangeAnim(this, 0xB);
    }
...
void EnMaYto_DefaultDialogueHandler(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 5, 0x3000, (s16) 0x100);
    if ((this->textId == 0x3395) && (&D_0600AF7C == this->skelAnime.animCurrentSeg) && (func_801378B8(&this->skelAnime, this->skelAnime.animFrameCount) != 0)) {
...
void EnMaYto_DefaultHandlePlayerChoice(EnMaYto *this, GlobalContext *globalCtx) {
    if (func_80147624(globalCtx) != 0) {
        ...
        func_8019F230();
        func_801518B0(globalCtx, 0x3391U, (Actor *) this);
        this->textId = 0x3391;
...
void EnMaYto_DinnerWait(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    if ((temp_a0 != 0) && (sp26 = temp_v1, (func_800B84D0(temp_a0, globalCtx) != 0))) {
        func_800B86C8((Actor *) this, globalCtx, (Actor *) this);
        EnMaYto_DinnerStartDialogue(this, globalCtx);
        EnMaYto_SetupDinnerDialogueHandler(this);
        return;
    }
...
void EnMaYto_DinnerHandlePlayerChoice(EnMaYto *this, GlobalContext *globalCtx) {
    if (func_80147624(globalCtx) != 0) {
        if (globalCtx->msgCtx.choiceIndex == 0) {
            func_8019F208();
            EnMaYto_SetFaceExpression(this, 0, 3);
            func_801518B0(globalCtx, 0x3399U, (Actor *) this);
            this->textId = 0x3399;
            return;
        }
        func_8019F230();
        func_801518B0(globalCtx, 0x3398U, (Actor *) this);
        this->textId = 0x3398;
        /* Duplicate return node #4. Try simplifying control flow for better match */
    }
}
...
void EnMaYto_DinnerChooseNextDialogue(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    if (func_80147624(globalCtx) != 0) {
        ...
        case 13209:
            EnMaYto_SetFaceExpression(this, 3, 1);
            func_801518B0(globalCtx, 0x339AU, (Actor *) this);
            this->textId = 0x339A;
            return;
        case 13210:
            this->unk31E = 1;
            EnMaYto_SetFaceExpression(this, 0, 1);
            func_801518B0(globalCtx, 0x339BU, (Actor *) this);
            this->textId = 0x339B;
            return;
        case 13211:
            func_800B86C8((Actor *) this, globalCtx, this->actor.child);
            func_80B90E50(this, 0);
            EnMaYto_SetRomaniFaceExpression(this, 3, 3);
            func_801518B0(globalCtx, 0x339CU, (Actor *) this);
            this->textId = 0x339C;
            return;
        case 13212:
            this->unk31E = 1;
            ...
            func_801518B0(globalCtx, 0x339DU, (Actor *) this);
            this->textId = 0x339D;
            return;
        case 13213:
            func_80B90E50(this, 1);
            ...
            func_801518B0(globalCtx, 0x339EU, (Actor *) this);
            this->textId = 0x339E;
            func_80151BB4(globalCtx, 6U);
        ...
        case 13215:
            this->unk31E = 0;
            func_801518B0(globalCtx, 0x33A0U, (Actor *) this);
            this->textId = 0x33A0;
            return;
        case 13216:
            func_801518B0(globalCtx, 0x33A1U, (Actor *) this);
            this->textId = 0x33A1;
            return;
        case 13217:
            func_80B90E50(this, 1);
            ...
            func_801518B0(globalCtx, 0x33A2U, (Actor *) this);
            this->textId = 0x33A2;
            return;
        case 13218:
            this->unk31E = 1;
            ...
            func_801518B0(globalCtx, 0x33A3U, (Actor *) this);
            this->textId = 0x33A3;
            return;
        case 13219:
            this->unk31E = 0;
            EnMaYto_SetFaceExpression(this, 3, 3);
            func_801518B0(globalCtx, 0x33A4U, (Actor *) this);
            this->textId = 0x33A4;
            func_80151BB4(globalCtx, 6U);
            func_80151BB4(globalCtx, 5U);
            return;
        case 13221:
            func_801518B0(globalCtx, 0x33A6U, (Actor *) this);
            this->textId = 0x33A6;
            func_80151BB4(globalCtx, 6U);
            return;
        case 13223:
            func_801518B0(globalCtx, 0x33A8U, (Actor *) this);
            this->textId = 0x33A8;
            func_80151BB4(globalCtx, 6U);
...
void EnMaYto_AfterMilkRunDialogueHandler(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 5, 0x71C, (s16) 0xB6);
}
...
void EnMaYto_AfterMilkRunChooseNextDialogue(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    if (func_80147624(globalCtx) != 0) {
        ...
        EnMaYto_SetFaceExpression(this, 3, 1);
        func_801518B0(globalCtx, 0x33C2U, (Actor *) this);
        this->textId = 0x33C2;
    }
}
...
void EnMaYto_PostMilkRunGiveReward(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    func_800B8A1C((Actor *) this, globalCtx, 0x82, 500.0f, 100.0f);
    this->unk310 = 1;
}
                ...
                if (temp_a0 != 1) {
                    if (temp_a0 != 2) {
                        if (temp_a0 != 3) {
                            ...
                            EnMaYto_ChangeAnim(this, 0x16);
                            goto block_10;
                        }
                    } else {
                        gSaveContext.weekEventReg[14] |= 1;
                        EnMaYto_ChangeAnim(this, 0x12);
                        goto block_10;
                    }
                } else {
                    EnMaYto_ChangeAnim(this, 0);
block_10:
        ...
        if ((D_80B915F0 == 2) && (&D_06001FD0 == this->skelAnime.animCurrentSeg) && (func_801378B8(&this->skelAnime, this->skelAnime.animFrameCount) != 0)) {
...
void EnMaYto_DinnerStartDialogue(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    if (temp_hi != 1) {
        if (temp_hi != 2) {
            ...
            EnMaYto_SetTalkedFlag();
            func_801518B0(globalCtx, 0x33A7U, (Actor *) this);
            phi_t7 = 0x33A7U;
            goto block_25;
        }
        if (EnMaYto_HasSpokeToPlayer() != 0) {
        ...
        EnMaYto_SetTalkedFlag();
        func_801518B0(globalCtx, 0x33A5U, (Actor *) this);
        this->textId = 0x33A5;
        return;
    }
    if ((Player_GetMask(globalCtx) != 0) && (gSaveContext.playerForm == 4)) {
...
block_25:
    ...
    if (EnMaYto_HasSpokeToPlayer() != 0) {
        func_801518B0(globalCtx, 0x339FU, (Actor *) this);
        this->textId = 0x339F;
        return;
    }
    EnMaYto_SetTalkedFlag();
    func_801518B0(globalCtx, 0x3397U, (Actor *) this);
    this->textId = 0x3397;
}
...
void EnMaYto_BarnStartDialogue(EnMaYto *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.weekEventReg[22] & 1) != 0) {
        ...
        if (temp_hi == 2) {
            if (this->unk310 == 1) {
                func_801518B0(globalCtx, 0x33AEU, (Actor *) this);
                this->textId = 0x33AE;
                return;
            }
            this->unk310 = 1;
            EnMaYto_SetTalkedFlag();
            func_801518B0(globalCtx, 0x33A9U, (Actor *) this);
            this->textId = 0x33A9;
            return;
        }
        if (temp_hi == 3) {
            ...
            EnMaYto_SetTalkedFlag();
            EnMaYto_SetFaceExpression(this, 0, 1);
            func_801518B0(globalCtx, 0x33C6U, (Actor *) this);
            this->textId = 0x33C6;
            return;
        }
    ...
    if (EnMaYto_HasSpokeToPlayer() != 0) {
        this->unk31E = 2;
        EnMaYto_SetFaceExpression(this, 5, 3);
        func_801518B0(globalCtx, 0x33B3U, (Actor *) this);
        this->textId = 0x33B3;
        func_80151BB4(globalCtx, 6U);
        return;
    }
    EnMaYto_SetTalkedFlag();
    EnMaYto_SetFaceExpression(this, 5, 3);
    func_801518B0(globalCtx, 0x33B1U, (Actor *) this);
    this->textId = 0x33B1;
}
...
void EnMaYto_ChangeAnim(EnMaYto *this, s32 index) {
    ...
    sp28 = temp_v1;
    SkelAnime_ChangeAnim(&this->skelAnime, (AnimationHeader *) temp_v1->unk0, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(temp_v1->unk0), (u8) (s32) temp_v1->unk8, temp_v1->unkC);
}
...
void EnMaYto_UpdateEyes(EnMaYto *this) {
    ...
    temp_v0 = this->overrideEyeTexIndex;
    if (temp_v0 != 0) {
        this->eyeTexIndex = temp_v0;
        return;
    }
    temp_v0_2 = this->blinkTimer;
    if (temp_v0_2 == 0x64) {
        temp_v0_3 = this->eyeTexIndex;
        if (temp_v0_3 == 0) {
            this->blinkTimer = 0;
            return;
        }
        this->eyeTexIndex = temp_v0_3 - 1;
        return;
    }
    this->blinkTimer = temp_v0_2 + 1;
...
void EnMaYto_Update(EnMaYto *this, GlobalContext *globalCtx) {
    EnMaYto *this = (EnMaYto *) thisx;
    this->actionFunc(this, globalCtx);
    EnMaYto_UpdateCollision((Actor *) this, globalCtx);
    func_80B90C78((Actor *) this, globalCtx);
}
...
void EnMaYto_Draw(EnMaYto *this, GlobalContext *globalCtx) {
    Gfx *sp3C;
    Gfx *sp34;
    Gfx *sp30;
    Gfx *temp_v0;
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnMaYto_OverrideLimbDraw, EnMaYto_PostLimbDraw, (Actor *) this);
}
