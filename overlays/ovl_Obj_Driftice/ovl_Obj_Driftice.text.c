typedef struct ObjDriftice {
    ...
    /* 0x170 */ ? unk170;                           /* inferred */
    /* 0x170 */ char pad170[0xCC];
...
void ObjDriftice_Init(ObjDriftice *this, GlobalContext *globalCtx) {
    void *sp2C;
    s32 sp20;
    Path *temp_v0;
    s32 phi_v0;
    ...
    Actor_SetScale((Actor *) this, sp2C->unk0 * 0.035377357f);
...
void ObjDriftice_Destroy(ObjDriftice *this, GlobalContext *globalCtx) {
    ObjDriftice *this = (ObjDriftice *) thisx;
...
void func_80A671E0(ObjDriftice *arg0, GlobalContext *arg1) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp40, arg0->unk16C + (arg0->unk164 * 6) + (arg0->unk168 * 6));
    temp_a2 = arg0 + 0x64;
    sp24 = temp_a2;
...
void ObjDriftice_Update(ObjDriftice *this, GlobalContext *globalCtx) {
    ObjDriftice *temp_a0;
...
void ObjDriftice_Draw(ObjDriftice *this, GlobalContext *globalCtx) {
    ObjDriftice *this = (ObjDriftice *) thisx;
