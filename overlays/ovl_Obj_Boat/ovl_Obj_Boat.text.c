...
typedef struct ObjBoat {
    ...
    /* 0x160 */ char pad_160[0x3];                  /* maybe part of unk_15F[4]? */
...
struct _mips2c_stack_ObjBoat_Init {
    ...
    /* 0x24 */ ? sp24;                              /* inferred */
    /* 0x24 */ char pad_24[0x1C];
};                                                  /* size = 0x40 */

struct _mips2c_stack_ObjBoat_Update {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ ? sp2C;                              /* inferred */
    /* 0x2C */ char pad_2C[0xE];
...
void ObjBoat_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_163 = temp_v0->count - 1;
    temp_v0_2 = Lib_SegmentedToVirtual((void *) temp_v0->points);
    this->unk_164 = temp_v0_2;
    this->unk_15D = 1;
    temp_v1_2 = temp_v0_2 + (this->unk_15C * 6);
    this->actor.world.pos.x = (f32) temp_v1_2->unk_0;
    this->actor.world.pos.z = (f32) temp_v1_2->unk_4;
    this->actor.shape.rot.y = func_80B9AF50(this, (Vec3f *) &sp24);
    this->unk_15D = (s8) -(s32) this->unk_15D;
...
void func_80B9B124(ObjBoat *arg0) {
    arg0->unk_160 += 0x3E8;
    arg0->actor.world.pos.y = Math_SinS(arg0->unk_160) + arg0->actor.home.pos.y;
    arg0->actor.shape.rot.x = (s16) (s32) (Math_SinS(arg0->unk_160) * 100.0f);
    arg0->actor.shape.rot.z = (s16) (s32) (Math_SinS((s16) (arg0->unk_160 * 2)) * 50.0f);
}
...
void ObjBoat_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 != 0) || (sp40 = temp_v0, phi_v1 = sp40, (func_800CAF4C((DynaPolyActor *) this) != 0))) {
        if ((this->unk_15F == 0) && (((this->actor.params & 0x4000) != 0) || ((phi_v1 != 0) && (this->unk_15E == this->unk_15C)))) {
            this->unk_15D = (s8) -(s32) this->unk_15D;
            if ((s32) this->unk_15D > 0) {
        ...
        temp_v0_2 = this->unk_15F;
        if (temp_v0_2 != 0) {
            this->unk_15F = temp_v0_2 - 1;
        }
    }
    if (this->unk_15E != this->unk_15C) {
        sp3A = func_80B9AF50(this, (Vec3f *) &sp2C);
        if (Math_Vec3f_DistXZ((Vec3f *) &this->actor.world, (Vec3f *) &sp2C) < 200.0f) {
            temp_t3 = this->unk_15C + this->unk_15D;
            this->unk_15C = temp_t3;
            if (this->unk_15E == (temp_t3 & 0xFF)) {
            ...
            sp3C = phi_f0 * (f32) this->unk_15D;
        }
    }
    if (sp44->unk_394 != 0x1A) {
