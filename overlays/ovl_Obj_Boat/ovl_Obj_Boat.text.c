...
static InitChainEntry D_80B9B680;                   /* unable to generate initializer */
...
typedef struct {
    ...
    /* 0x0008 */ char pad8[0x2];                    /* maybe part of unk6[2]? */
...
void ObjBoat_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80B9B680);
    ...
    this->actor.shape.rot.y = func_80B9AF50(this, &sp24);
...
void ObjBoat_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk15E != this->unk15C) {
        ...
        if (Math_Vec3f_DistXZ(&this->actor.world.pos, &sp2C) < 200.0f) {
    ...
    if (sp44->unk394 != 0x1A) {
        ...
        if (this->actor.speedXZ != 0.0f) {
            func_800B9010(&this->actor, 0x2154U);
        }
    }
    func_80B9B124(this);
}
    ...
    if (func_800EE29C(temp_a0, 0x1FFU) != 0) {
        ...
        if (temp_v1 != this->unk15F) {
            ...
            if (temp_v0_2 != 1) {
                ...
                Math_Vec3s_ToVec3f(&this->world.pos, (Vec3s *) temp_v0_4);
        ...
        if (temp_v1 != 1) {
            ...
            if (((s32) temp_v0_5 < (s32) this->unk163) && (Math_Vec3f_StepTo(&this->world.pos, &sp34, this->speedXZ) < this->speedXZ)) {
