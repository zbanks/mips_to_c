...
struct _mips2c_stack_EnDekunuts_Draw {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnDekunuts_Init {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnDekunuts_Update {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ ColliderCylinder *sp2C;              /* inferred */
    /* 0x30 */ char pad_30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_808BD348 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808BD3B4 {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_808BD428 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808BD49C {
    /* 0x00 */ char pad_0[0x20];
...
struct _mips2c_stack_func_808BD78C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BD7D4 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ SkelAnime *sp1C;                     /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808BD870 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BD8D8 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ SkelAnime *sp24;                     /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_808BDA08 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BDA4C {
...
struct _mips2c_stack_func_808BDC9C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BDCF0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BDD54 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ SkelAnime *sp24;                     /* inferred */
    /* 0x28 */ char pad_28[0x8];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_808BDE7C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BDEF8 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808BDF60 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BDFB8 {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ SkelAnime *sp2C;                     /* inferred */
    /* 0x30 */ char pad_30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_808BE1CC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BE22C {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ SkelAnime *sp1C;                     /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808BE294 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_808BE358 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BE3A8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BE3FC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BE484 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BE4D4 {
...
struct _mips2c_stack_func_808BE680 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BE6C4 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808BE73C {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_808BEBD0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808BED30 {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ s32 sp2C;                            /* inferred */
...
static InitChainEntry D_808BEF84[3];                /* unable to generate initializer */
...
void EnDekunuts_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain((Actor *) this, D_808BEF84);
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->collider, (Actor *) this, &D_808BEF30);
...
void func_808BDA4C(EnDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.params == 2) {
        ...
        temp_v0_2 = Actor_PitchToPoint((Actor *) this, (Vec3f *) temp_a1);
        if (temp_v0_2 < -0x3800) {
            phi_a1 = -0x3800;
        } else {
        ...
        if (this->skelAnime.animCurrentFrame < 7.0f) {
            Math_ScaledStepToS((s16 *) &this->actor.world.rot, phi_a1, 0x800);
        } else {
            Math_ScaledStepToS((s16 *) &this->actor.world.rot, 0, 0x800);
        }
    }
    temp_a0 = &this->skelAnime;
    sp38 = temp_a0;
    ...
    if (func_801378B8(temp_a0, 7.0f) != 0) {
        ...
        if (Actor_Spawn(&globalCtx->actorCtx, globalCtx, 0xDA, sp48, sp4C, (Math_CosS(this->actor.shape.rot.y) * sp44) + this->actor.world.pos.z, (s16) (s32) this->actor.world.rot.x, (s16) (s32) this->actor.shape.rot.y, (s16) 0, (s16) phi_v0) != 0) {
            Audio_PlayActorSound2((Actor *) this, 0x387EU);
            return;
        }
...
void func_808BDD54(EnDekunuts *this, GlobalContext *globalCtx) {
    ...
    Math_ApproachF((f32 *) &this->actor.world, this->actor.home.pos.x, 0.5f, 3.0f);
...
void func_808BDFB8(EnDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (Math_SmoothStepToS(&this->actor.world.rot.y, this->unk_192, 1, 0xE38, (s16) 0xB6) == 0) {
        ...
        if ((temp_v0_2 & 0x20) != 0) {
            this->unk_192 = Actor_YawToPoint((Actor *) this, (Vec3f *) &this->actor.home);
        } else if ((temp_v0_2 & 8) != 0) {
            this->unk_192 = this->actor.wallYaw;
        } else if (this->unk_18D == 0) {
            temp_v0_3 = Actor_YawToPoint((Actor *) this, (Vec3f *) &this->actor.home);
    ...
    if ((this->unk_18D == 0) && (Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) &this->actor.home) < 20.0f) && (fabsf(this->actor.world.pos.y - this->actor.home.pos.y) < 2.0f)) {
...
void func_808BE3FC(EnDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_190 == 0) {
        ...
        if (this->actor.params == 1) {
            func_808BDCF0((Actor *) this);
            return;
        }
        if (this->actor.colChkInfo.health == 0) {
            func_808BE294((Actor *) this, 0);
            return;
        }
...
void func_808BE4D4(EnDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->skelAnime) != 0) {
        ...
        Item_DropCollectibleRandom(globalCtx, (Actor *) this, (Vec3f *) sp3C, 0xE0);
        ...
        EffectSsHahen_SpawnBurst(globalCtx, (Vec3f *) &this->actor.home, 6.0f, 0, (s16) 6, (s16) 2, (s16) 0xF, (s16) 0x40, (s16) 0xA, &D_06001F50);
...
void func_808BE73C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_28D;
    temp_a1 = arg0 + 0x294;
    if ((temp_v0 & 2) != 0) {
        arg0->unk_28D = (u8) (temp_v0 & 0xFFFD);
        arg1 = arg1;
        func_800BE258(arg0, temp_a1);
        if ((arg0->unk_18E != 0xA) || ((*arg0->unk_2B8 & 0xDB0B3) == 0)) {
...
void EnDekunuts_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_808BE73C((Actor *) this, globalCtx);
    this->actionFunc(this, globalCtx);
    Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 20.0f, (f32) this->collider.dim.radius, (f32) this->collider.dim.height, 0x1DU);
...
void EnDekunuts_Draw(Actor *thisx, GlobalContext *globalCtx) {
    EnDekunuts *this = (EnDekunuts *) thisx;
    SkelAnime_Draw(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, func_808BEBD0, func_808BED30, (Actor *) this);
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) this->unk_21C, 8, this->unk_214, this->unk_218, this->unk_210, (u8) (s32) this->unk_18E);
}
