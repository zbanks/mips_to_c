...
typedef struct EnTg {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnTg *, GlobalContext *);
    ...
    /* 0x01D8 */ char pad1D8[0x18];                 /* maybe part of unk1D6[13]? */
    /* 0x01F0 */ Vec3s unk1F0;                      /* inferred */
    /* 0x01F6 */ char pad1F6[0x78];                 /* maybe part of unk1F0[21]? */
    /* 0x026E */ Vec3s unk26E;                      /* inferred */
    /* 0x0274 */ char pad274[0x78];                 /* maybe part of unk26E[21]? */
    /* 0x02EC */ s16 unk2EC;                        /* inferred */
    /* 0x02EE */ char pad2EE[0x2];                  /* maybe part of unk2EC[2]? */
    /* 0x02F0 */ ? unk2F0;                          /* inferred */
    /* 0x02F1 */ char pad2F1[0x257];
} EnTg;                                             /* size 0x548 */
...
void EnTg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, (ColliderCylinder *) temp_a1_2, &this->actor, &D_809901C0);
...
void func_8098FBD0(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.x = D_80990228.unk0;
    sp18.y = D_80990228.unk4;
    sp18.z = D_80990228.unk8;
    if (arg1 == 9) {
...
void EnTg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, func_8098FBB4, func_8098FBD0, &this->actor);
}
...
void func_8098FEA8(GlobalContext *arg0, ? *arg1, s32 arg2) {
    ...
    sp44.x = D_8099024C.unk0;
    sp44.y = D_8099024C.unk4;
    sp44.z = D_8099024C.unk8;
    ...
    if (arg2 > 0) {
        do {
            if (phi_s0->unk0 == 1U) {
                ...
                SysMatrix_MultiplyVector3fByState(&sp44, phi_s0 + 0x14);
                SysMatrix_StatePop();
