...
void EnDnk_Init(EnDnk *this, GlobalContext *globalCtx) {
    s32 temp_v0;
    s8 phi_v0;
...
void EnDnk_Destroy(EnDnk *this, GlobalContext *globalCtx) {
    EnDnk *this = (EnDnk *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->collider);
}

void EnDnk_Update(EnDnk *this, GlobalContext *globalCtx) {
...
void func_80A51DA4(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 2) {
        ...
        if ((temp_v0 & 0x10) != 0) {
            if ((temp_v0 & 0x20) != 0) {
                sp40 = arg4->unk296 + 0x4000;
                sp3E = arg4->unk298 + 0x4000;
                sp3C = 0;
                sp3E += arg4->shape.rot.y;
