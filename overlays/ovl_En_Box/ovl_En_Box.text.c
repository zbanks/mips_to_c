typedef struct EnBox {
    ...
    /* 0x1A4 */ char pad1A4[0x8];                   /* maybe part of unk1A0[3]? */
    /* 0x1AC */ ? (*unk1AC)(EnBox *, GlobalContext *); /* inferred */
    /* 0x1B0 */ Vec3s unk1B0;                       /* inferred */
    /* 0x1B6 */ char pad1B6[0x18];                  /* maybe part of unk1B0[5]? */
    /* 0x1CE */ Vec3s unk1CE;                       /* inferred */
    /* 0x1D4 */ char pad1D4[0x18];                  /* maybe part of unk1CE[5]? */
    /* 0x1EC */ s16 unk1EC;                         /* inferred */
    /* 0x1EE */ u8 unk1EE;                          /* inferred */
    /* 0x1EF */ u8 unk1EF;                          /* inferred */
    /* 0x1F0 */ u8 unk1F0;                          /* inferred */
    /* 0x1F1 */ u8 unk1F1;                          /* inferred */
    /* 0x1F2 */ u8 unk1F2;                          /* inferred */
    /* 0x1F3 */ s8 unk1F3;                          /* inferred */
    /* 0x1F4 */ EnBox unk1F4;                       /* inferred */
    /* 0x200 */ void (*actionFunc)(EnBox *, GlobalContext *); /* overlap */
    /* 0x204 */ char pad204[0x14];                  /* maybe part of actionFunc[6]? */
...
void func_8086800C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_a3->unk1EE & 0x80) == 0) {
        sp28.unk0 = (s32) temp_a3->world.pos.x;
        sp28.unk4 = (f32) temp_a3->world.pos.y;
        sp28.unk8 = (s32) temp_a3->world.pos.z;
        arg0 = temp_a3;
        sp2C += 1.0f;
...
void func_80868630(EnBox *arg0, ? *arg1, ? *arg2, ? *arg3) {
    ...
    sp22 = (s16) temp_v0;
    arg1->unk0 = (f32) arg0->actor.world.pos.x;
    arg1->unk4 = (s32) arg0->actor.world.pos.y;
    arg1->unk8 = (f32) arg0->actor.world.pos.z;
    arg1->unk0 = (f32) (arg1->unk0 + (Math_SinS((s16) temp_v0) * sp24));
    arg1->unk8 = (f32) (arg1->unk8 + (Math_CosS(sp22) * sp24));
    arg2->unk4 = 1.0f;
...
void func_808692E0(Actor *arg0, GlobalContext *arg1) {
    ...
    sp34.unk0 = (s32) D_80869B88.unk0;
    sp34.unk4 = (s32) D_80869B88.unk4;
    sp34.unk8 = (s32) D_80869B88.unk8;
...
void EnBox_Draw(EnBox *this, GlobalContext *globalCtx) {
    ...
    if (((temp_v1 == 0xFF) && (temp_v0_2 = this->unk1F1, (temp_v0_2 != 4)) && (temp_v0_2 != 6)) || (((this->actor.flags & 0x80) != 0x80) && ((temp_v0_3 = this->unk1F1, (temp_v0_3 == 4)) || (temp_v0_3 == 6)))) {
        ...
        temp_s1->polyOpa.p = SkelAnime_Draw2(globalCtx, this->unk15C.skeleton, this->unk15C.limbDrawTbl, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80869600, (Actor *) this, temp_s1->polyOpa.p);
        return;
    }
    if (temp_v1 != 0) {
        ...
        temp_s1->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk15C.skeleton, this->unk15C.limbDrawTbl, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80869600, (Actor *) this, temp_s1->polyXlu.p);
    }
}
