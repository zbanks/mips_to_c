...
void func_80868630(EnBox *arg0, Vec3f *arg1, Vec3f *arg2, Vec3f *arg3); /* static */
...
Gfx *func_80869850(GraphicsContext *arg0);          /* static */
Gfx *func_80869874(GraphicsContext *arg0);          /* static */
Gfx *func_808698B4(GraphicsContext *arg0);          /* static */
...
typedef struct EnBox {
    ...
    /* 0x01A4 */ char pad1A4[0x8];                  /* maybe part of unk1A0[3]? */
    /* 0x01AC */ void (*unk1AC)(EnBox *, GlobalContext *); /* inferred */
    /* 0x01B0 */ Vec3s unk1B0;                      /* inferred */
    /* 0x01B6 */ char pad1B6[0x18];                 /* maybe part of unk1B0[5]? */
    /* 0x01CE */ Vec3s unk1CE;                      /* inferred */
    /* 0x01D4 */ char pad1D4[0x18];                 /* maybe part of unk1CE[5]? */
    /* 0x01EC */ s16 unk1EC;                        /* inferred */
    /* 0x01EE */ u8 unk1EE;                         /* inferred */
    /* 0x01EF */ u8 unk1EF;                         /* inferred */
    /* 0x01F0 */ u8 unk1F0;                         /* inferred */
    /* 0x01F1 */ u8 unk1F1;                         /* inferred */
    /* 0x01F2 */ u8 unk1F2;                         /* inferred */
    /* 0x01F3 */ s8 unk1F3;                         /* inferred */
    /* 0x01F4 */ EnBox unk1F4;                      /* inferred */
    /* 0x0200 */ void (*actionFunc)(EnBox *, GlobalContext *); /* overlap */
    /* 0x0204 */ char pad204[0x14];                 /* maybe part of actionFunc[6]? */
...
void func_80867C8C(void *arg0, GraphicsContext **arg1) {
    ...
    if (temp_s6 > 0) {
        ...
        if (temp_s6 > 0) {
            sp74 = (f32) temp_s6;
            do {
                temp_f2 = (f32) arg0->unk1C;
                temp_f0 = (f32) phi_s4 / sp74;
                temp_s0 = (s16) (s32) ((((f32) arg0->unk18 - temp_f2) * temp_f0) + temp_f2);
                temp_f20 = (f32) temp_s0;
                temp_f24 = 1.0f - (temp_f20 * 0.011764706f);
                temp_lo = temp_s0 * 0x9A6;
                temp_f26 = Rand_ZeroOne() * 0.03f * temp_f0 * temp_f24;
                temp_f30 = (Math_SinS(temp_lo) * 45.0f) + arg0->unk0;
                if (arg0->unk20 != 0) {
                    phi_f24 = (arg0->unk4 - (0.03f * temp_f20)) - (0.01f * temp_f20 * temp_f20);
                } else {
                    phi_f24 = arg0->unk4 + (0.03f * temp_f20) + (0.01f * temp_f20 * temp_f20);
                }
                temp_f28 = (Math_CosS(temp_lo) * 45.0f) + arg0->unk8;
...
void func_80867FBC(void *arg0, GlobalContext *arg1, s32 arg2) {
    arg0->unkC = func_80867C14;
    arg0->unk10 = func_80867C8C;
    arg0->unk20 = arg2;
}
...
void func_8086800C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = arg0;
    if ((temp_a3->unk1EE & 0x80) == 0) {
        sp28.x = temp_a3->world.pos.x;
        sp28.y = temp_a3->world.pos.y;
        sp28.z = temp_a3->world.pos.z;
        arg0 = temp_a3;
        sp2C += 1.0f;
        temp_f0 = func_800C411C(arg1 + 0x830, &sp38, &sp34, temp_a3, &sp28);
        if (temp_f0 != -32000.0f) {
...
void EnBox_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80869B50);
    BcCheck3_BgActorInit((DynaPolyActor *) this, 0);
    BgCheck_RelocateMeshHeader(&D_060080E8, &sp48);
    temp_s0 = &globalCtx->colCtx.dyna;
    this->unk144 = BgCheck_AddActorMesh(globalCtx, temp_s0, (DynaPolyActor *) this, sp48);
    this->unk1EE = 0;
    this->unk1F1 = ((s32) this->actor.params >> 0xC) & 0xF;
    this->unk1F2 = 0;
    this->unk1F3 = 0;
    this->actor.gravity = -5.5f;
    this->actor.minVelocityY = -50.0f;
    this->unk1F0 = (u8) this->actor.world.rot.z;
    ...
    if (this->actor.world.rot.x == 0xB4) {
        ...
        func_800C636C(globalCtx, temp_s0, this->unk144);
        temp_t4 = this->actor.world.rot.x;
        this->actor.world.rot.x = 0;
        this->unk220 = temp_t4 & 0x7F;
    }
    this->unk21C = ((s32) this->actor.params >> 5) & 0x7F;
    this->actor.shape.rot.x = this->actor.world.rot.x;
    if ((Actor_GetChestFlag(globalCtx, this->actor.params & 0x1F) != 0) || (this->unk21C == 0)) {
        this->unk1EF = 0xFF;
        this->unk1F2 = 0x64;
        ...
        temp_v0 = this->unk1F1;
        if (((temp_v0 == 3) || (temp_v0 == 8)) && (Flags_GetSwitch(globalCtx, (s32) this->unk1F0) == 0)) {
            func_800C62BC(globalCtx, temp_s0, this->unk144);
            ...
            if (((temp_v0_2 == 1) || (temp_v0_2 == 7)) && (Actor_GetRoomCleared(globalCtx, (u32) this->actor.room) == 0)) {
                ...
                temp_v0_3 = this->unk1F1;
                if ((temp_v0_3 == 9) || (temp_v0_3 == 0xA)) {

                } else if (((temp_v0_3 == 0xB) || (temp_v0_3 == 0xC)) && (Flags_GetSwitch(globalCtx, (s32) this->unk1F0) == 0)) {
                    ...
                    temp_v0_4 = this->unk1F1;
                    if ((temp_v0_4 == 4) || (temp_v0_4 == 6)) {
                        this->actor.flags |= 0x80;
                    }
                    func_80867BD0(this, func_80868CC8);
                    temp_t8 = this->unk1EE | 1;
                    this->unk1EE = temp_t8;
                    this->unk1EE = temp_t8 | 0x10;
                }
            }
        }
    }
    if ((this->unk21C == 0x11) && (Actor_GetChestFlag(globalCtx, this->actor.params & 0x1F) == 0)) {
        this->actor.flags |= 0x10;
    }
    ...
    temp_s0_2 = &this->unk15C;
    SkelAnime_Init(globalCtx, temp_s0_2, &D_060066A0, (AnimationHeader *) &D_0600043C, &this->unk1B0, &this->unk1CE, 5);
    ...
    func_80867BDC(&this->unk1F4, globalCtx, &this->actor.home);
}
...
void func_80868630(EnBox *arg0, Vec3f *arg1, Vec3f *arg2, Vec3f *arg3) {
    f32 sp24;
    s16 sp22;
    s32 temp_v0;
    ...
    sp22 = (s16) temp_v0;
    arg1->x = arg0->actor.world.pos.x;
    arg1->y = arg0->actor.world.pos.y;
    arg1->z = arg0->actor.world.pos.z;
    arg1->x += Math_SinS((s16) temp_v0) * sp24;
    arg1->z += Math_CosS(sp22) * sp24;
    arg2->y = 1.0f;
    arg2->x = Math_SinS(sp22);
    arg2->z = Math_CosS(sp22);
    arg3->x = 0.0f;
    arg3->y = 0.0f;
    arg3->z = 0.0f;
}
...
void func_80868734(EnBox *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        func_800B1280(arg1, &sp60, &sp54, &sp48, (s16) 0x64, (s16) 0x1E, (s16) 0xF);
        temp_s0 = phi_s0 + 1;
        phi_s0 = temp_s0;
    } while (temp_s0 != 0x14);
}
...
void func_808687E8(EnBox *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->actor.bgCheckFlags & 1) != 0) {
        ...
        arg0->unk1EE = temp_t2;
        if ((temp_v0 & 4) != 0) {
            arg0->unk1EE = temp_v0 & 0xFFFB;
        } else {
            arg0->unk1EE = temp_v0 | 4;
        }
        if (arg0->unk1F1 == 3) {
...
void func_80868944(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 >= -0xB) {
        arg0->unk1A0 = (s32) (temp_v0 + 1);
        return;
    }
    if (Flags_GetSwitch(arg1, (s32) arg0->unk1F0) != 0) {
        arg0->unk1A0 = (s32) (arg0->unk1A0 + 1);
    }
}
...
void func_808689E8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Flags_GetSwitch(arg1, (s32) arg0->unk1F0) != 0) {
        if (ActorCutscene_GetCanPlayNext(arg0->unk218) != 0) {
            ActorCutscene_StartAndSetUnkLinkFields(arg0->unk218, arg0);
            func_80867BD0((EnBox *) arg0, func_80868AFC);
            arg0->unk1A0 = -0x1E;
            return;
        }
        ActorCutscene_SetIntentToPlay(arg0->unk218);
...
void func_80868AFC(Actor *arg0, GlobalContext *arg1) {
    if ((func_800F22C4(arg0->unk218, arg0) != 0) || (arg0->unk1A0 != 0)) {
        func_80867BD0((EnBox *) arg0, func_80868B74);
        arg0->unk1A0 = 0;
        func_80867FBC(arg0 + 0x1F4, arg1, (arg0->unk1EE & 0x80) != 0);
...
void func_80868B74(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 < 0x28) {
        if ((arg0->unk1EE & 0x80) != 0) {
            arg0->world.pos.y -= 1.25f;
        } else {
            arg0->world.pos.y += 1.25f;
        }
        arg0->unk1A0 = (s32) (arg0->unk1A0 + 1);
        if ((arg0->unk218 != -1) && (arg0 = arg0, (ActorCutscene_GetCurrentIndex() == arg0->unk218))) {
    ...
    temp_a0 = arg0;
    if (temp_v0 < 0x3C) {
        arg0->unk1EF = (u8) (arg0->unk1EF + 0xC);
        arg0->unk1A0 = (s32) (temp_v0 + 1);
...
void func_80868CC8(EnBox *arg0, GlobalContext *arg1) {
    ...
    arg0->unk1EF = 0xFF;
    arg0->unk1EE |= 1;
    if ((arg0->unk1EC != 0) && (((s32) arg0->unk21A < 0) || (ActorCutscene_GetCurrentIndex() == arg0->unk21A) || (ActorCutscene_GetCurrentIndex() == -1))) {
        if ((s32) arg0->unk1EC < 0) {
            phi_a1 = &D_0600043C;
            phi_f0 = 1.5f;
        } else {
            sp5C.unk0 = (s32) D_80869B54.unk0;
            sp5C.unk4 = (s32) D_80869B54.unk4;
            sp5C.unk8 = (s32) D_80869B54.unk8;
            sp5C.unkC = (s32) D_80869B54.unkC;
            sp5C.unk10 = (s32) D_80869B54.unk10;
        ...
        if ((s32) arg0->unk1EC > 0) {
            Actor_SpawnAsChild(arg1 + 0x1CA0, &arg0->actor, arg1, 0x5C, arg0->actor.world.pos.x, arg0->actor.world.pos.y, arg0->actor.world.pos.z, (s16) (s32) arg0->actor.shape.rot.x, (s16) (s32) arg0->actor.shape.rot.y, (s16) (s32) arg0->actor.shape.rot.z, -1);
        ...
        if ((temp_v0_2 == 0xC) || (temp_v0_2 == 0x5A)) {
            Actor_SetCollectibleFlag(arg1, arg0->unk220);
        }
        Actor_SetChestFlag(arg1, arg0->actor.params & 0x1F);
        return;
    }
    Actor_CalcOffsetOrientedToDrawRotation(&arg0->actor, &sp4C, &arg1->actorCtx.actorList[2].first->world.pos);
    if ((sp4C.z > -50.0f) && (sp4C.z < 0.0f) && (fabsf(sp4C.y) < 10.0f) && (fabsf(sp4C.x) < 20.0f) && (Actor_IsLinkFacingActor(&arg0->actor, 0x3000, arg1) != 0)) {
        temp_v0_3 = arg0->unk21C;
        if (((temp_v0_3 == 0xC) || (temp_v0_3 == 0x5A)) && (Actor_GetCollectibleFlag(arg1, arg0->unk220) != 0)) {
            arg0->unk21C = 0xA;
        }
        temp_v0_4 = arg0->unk21C;
        phi_v0 = temp_v0_4;
...
void func_80869020(Actor *arg0, GlobalContext *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        ...
        temp_v0_2 = arg0->unk1EE;
        if ((temp_v0_2 & 0x20) != 0) {
            arg0->unk1EE = (u8) (temp_v0_2 & 0xFFDF);
        ...
        if ((temp_v0_2 & 0x40) != 0) {
            arg0->unk1EE = (u8) (temp_v0_2 & 0xFFBF);
            return;
        }
    ...
    temp_v0_3 = arg0->unk17C->unk16;
    if ((s32) temp_v0_3 > 0) {
        arg0->unk1A8 = (f32) ((f32) (0x7D00 - temp_v0_3) * 0.00006f);
        temp_f0 = arg0->unk1A8;
        phi_f2 = 0.0f;
        if (temp_f0 < 0.0f) {
            goto block_28;
...
block_28:
    ...
    if ((func_800C9EBC(arg1, &arg1->colCtx, arg0->world.pos.x, arg0->world.pos.z, &sp58, &sp54, &sp50) != 0) && (arg0->floorHeight < sp58)) {
        EffectSsBubble_Spawn(arg1, &arg0->world.pos, 5.0f, 2.0f, 20.0f, 0.3f);
    }
}
...
void func_808692E0(Actor *arg0, GlobalContext *arg1) {
    ...
    sp40.unk0 = D_80869B7C.unk0;
    sp40.unk4 = (s32) D_80869B7C.unk4;
    sp40.unk8 = (s32) D_80869B7C.unk8;
    sp34.x = D_80869B88.unk0;
    sp34.y = D_80869B88.unk4;
    sp34.z = D_80869B88.unk8;
    arg0->unk1F2 = (u8) (arg0->unk1F2 + 1);
    func_800B9010(arg0, 0x31F1U);
    if (Rand_ZeroOne() < 0.3f) {
        sp30 = (2.0f * Rand_ZeroOne()) - 1.0f;
        sp4C.unk0 = arg0->world.pos.x;
        sp4C.unk4 = (f32) arg0->world.pos.y;
        sp4C.unk8 = (f32) arg0->world.pos.z;
        temp_f2 = sp30 * 20.0f;
        ...
        EffectSsIceSmoke_Spawn(arg1, (Vec3f *) &sp4C, (Vec3f *) &sp40, &sp34, (s16) 0x96);
    }
}
...
void EnBox_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk1EE;
    if ((temp_v0 & 0x10) != 0) {
        this->unk1EE = temp_v0 & 0xFFEF;
        func_8086800C(&this->actor, globalCtx);
    }
    if ((this->unk21C == 0x11) && (Actor_GetChestFlag(globalCtx, this->actor.params & 0x1F) == 0)) {
    ...
    Actor_SetHeight(&this->actor, 40.0f);
    if ((this->unk21C == 0x76) && (func_80869020 == this->unk1AC) && (this->unk15C.animCurrentFrame > 45.0f) && ((s32) this->unk1F2 < 0x64)) {
        func_808692E0(&this->actor, globalCtx);
    }
    temp_v0_3 = this->actionFunc;
    if (temp_v0_3 != 0) {
        temp_v0_3(&this->unk1F4, globalCtx);
    }
}
...
void func_80869600(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, EnBox *arg4, s32 **arg5) {
    ...
    if (arg1 == 1) {
        ...
        *temp_v0 = 0xDA380003;
        sp2C = temp_v0;
        sp2C->unk4 = Matrix_NewMtx(*arg0);
        if (arg4->unk1F1 == 2) {
            temp_v0_2 = *arg5;
            *arg5 = temp_v0_2 + 8;
            temp_v0_2->unk4 = &D_06000DB0;
            temp_v0_2->unk0 = 0xDE000000;
            return;
        }
        if (func_800BE63C(arg4, arg5) != 0) {
            if ((bitwise s32) arg4->unk1F4.actor.world.pos.y == 0x3C) {
                temp_v0_3 = *arg5;
                *arg5 = temp_v0_3 + 8;
                temp_v0_3->unk4 = &D_06000A50;
                temp_v0_3->unk0 = 0xDE000000;
                return;
            }
            temp_v0_4 = *arg5;
            *arg5 = temp_v0_4 + 8;
            temp_v0_4->unk4 = &D_060006F0;
    ...
    if (arg1 == 3) {
        ...
        *temp_v0_6 = 0xDA380003;
        sp18 = temp_v0_6;
        sp18->unk4 = Matrix_NewMtx(*arg0);
        if (arg4->unk1F1 == 2) {
            temp_v0_7 = *arg5;
            *arg5 = temp_v0_7 + 8;
            temp_v0_7->unk4 = &D_06001D58;
        ...
        if (func_800BE63C(arg4, arg5) != 0) {
            if ((bitwise s32) arg4->unk1F4.actor.world.pos.y == 0x3C) {
                temp_v0_8 = *arg5;
                *arg5 = temp_v0_8 + 8;
                temp_v0_8->unk4 = &D_06001850;
                temp_v0_8->unk0 = 0xDE000000;
                return;
            }
            temp_v0_9 = *arg5;
            *arg5 = temp_v0_9 + 8;
            temp_v0_9->unk4 = &D_060012E8;
            temp_v0_9->unk0 = 0xDE000000;
            return;
        }
        temp_v0_10 = *arg5;
        *arg5 = temp_v0_10 + 8;
        temp_v0_10->unk0 = 0xDE000000;
        temp_v0_10->unk4 = &D_06001850;
...
void EnBox_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk1F4.actor.home.pos.z;
    temp_s1 = globalCtx->state.gfxCtx;
    if ((bitwise s32) temp_v0 != 0) {
        (bitwise ? (*)(EnBox *, GlobalContext *)) temp_v0(&this->unk1F4, globalCtx);
    }
    temp_v1 = this->unk1EF;
    if (((temp_v1 == 0xFF) && (temp_v0_2 = this->unk1F1, (temp_v0_2 != 4)) && (temp_v0_2 != 6)) || (((this->actor.flags & 0x80) != 0x80) && ((temp_v0_3 = this->unk1F1, (temp_v0_3 == 4)) || (temp_v0_3 == 6)))) {
        ...
        temp_s1->polyOpa.p = SkelAnime_Draw2(globalCtx, this->unk15C.skeleton, this->unk15C.limbDrawTbl, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80869600, &this->actor, temp_s1->polyOpa.p);
        return;
    }
    if (temp_v1 != 0) {
        ...
        temp_v0_5->words.w1 = (u32) this->unk1EF;
        temp_v0_6 = this->unk1F1;
        ...
        temp_s1->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk15C.skeleton, this->unk15C.limbDrawTbl, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80869600, &this->actor, temp_s1->polyXlu.p);
    }
}
