typedef struct EnZos {
    ...
    /* 0x14A */ char pad14A[0x66];                  /* maybe part of unk144[18]? */
    /* 0x1B0 */ Vec3s unk1B0;                       /* inferred */
    /* 0x1B6 */ char pad1B6[0x66];                  /* maybe part of unk1B0[18]? */
    /* 0x21C */ SkelAnime unk21C;                   /* inferred */
    /* 0x260 */ ColliderCylinder unk260;            /* inferred */
    /* 0x2AC */ s16 unk2AC;                         /* inferred */
    /* 0x2AE */ s16 unk2AE;                         /* inferred */
    /* 0x2B0 */ char pad2B0[0x6];                   /* maybe part of unk2AE[4]? */
    /* 0x2B6 */ u16 unk2B6;                         /* inferred */
...
void EnZos_Init(EnZos *this, GlobalContext *globalCtx) {
    SkelAnime *sp34;
    SkelAnime *temp_a1;
    s32 temp_v0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk260, (Actor *) this, &D_80BBC6F0);
    this->unk2B6 = 0;
...
void EnZos_Destroy(EnZos *this, GlobalContext *globalCtx) {
    EnZos *this = (EnZos *) thisx;
...
void EnZos_Update(EnZos *this, GlobalContext *globalCtx) {
...
void EnZos_Draw(EnZos *this, GlobalContext *globalCtx) {
    Gfx *temp_s0;
    ...
    SysMatrix_StatePop();
    SkelAnime_DrawSV(globalCtx, this->unk21C.skeleton, this->unk21C.limbDrawTbl, (s32) this->unk21C.dListCount, func_80BBC4E4, func_80BBC500, (Actor *) this);
    if ((this->unk2B6 & 0x40) != 0) {
