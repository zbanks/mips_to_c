typedef struct DmBal {
    ...
    /* 0x18C */ char pad_18C[0xC];                  /* maybe part of actionFunc[4]? */
    /* 0x198 */ s32 unk_198;                        /* inferred */
    /* 0x19C */ Vec3s unk_19C;                      /* inferred */
    /* 0x1A2 */ char pad_1A2[0xC0];                 /* maybe part of unk_19C[33]? */
    /* 0x262 */ Vec3s unk_262;                      /* inferred */
    /* 0x268 */ char pad_268[0xCC];                 /* maybe part of unk_262[35]? */
    /* 0x334 */ s16 unk_334;                        /* inferred */
    /* 0x336 */ s16 unk_336;                        /* inferred */
    /* 0x338 */ char pad_338[0x4];                  /* maybe part of unk_336[3]? */
} DmBal;                                            /* size = 0x33C */
...
void DmBal_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_144, &D_0600A6D0, &D_060005FC, &this->unk_19C, &this->unk_262, 0x21);
...
void func_80C1EC60(DmBal *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_338 += 0x320;
    arg0->unk_33A += 0x3E8;
    temp_f2 = (Math_CosS(arg0->unk_338) * 0.1f) + 1.0f;
    arg0->unk_194 = temp_f2;
    arg0->unk_190 = temp_f2;
    temp_f2_2 = (Math_SinS(arg0->unk_338) * 0.1f) + 1.0f;
    arg0->unk_18C = temp_f2_2 * temp_f2_2;
    arg0->actor.world.pos.y = (Math_SinS(arg0->unk_338) * 25.0f) + arg0->actor.home.pos.y;
}
...
s32 func_80C1EF80(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg5) {
    ...
    if (arg1 == 6) {
        ...
        Matrix_Scale(arg5->unk_18C, arg5->unk_190, arg5->unk_194, 1);
...
void DmBal_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80C1EF80, func_80C1F060, (Actor *) this);
}
