struct _mips2c_stack_EnBaisen_ChangeAnimation {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnBaisen_Destroy {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnBaisen_Draw {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnBaisen_Init {
    /* 0x00 */ char pad0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnBaisen_OverrideLimbDraw {};  /* size 0x0 */

struct _mips2c_stack_EnBaisen_Update {
    /* 0x00 */ char pad0[0x2C];
    /* 0x2C */ ColliderCylinder *sp2C;              /* inferred */
    /* 0x30 */ char pad30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80BE871C {};              /* size 0x0 */

struct _mips2c_stack_func_80BE87B0 {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BE87FC {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BE887C {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BE895C {
    /* 0x00 */ char pad0[0x1C];
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BE89D8 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BE8AAC {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */
...
void EnBaisen_Init(EnBaisen *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->collider, (Actor *) this, &D_80BE8E10);
    if (this->paramCopy == 0) {
...
void EnBaisen_Destroy(EnBaisen *this, GlobalContext *globalCtx) {
    EnBaisen *this = (EnBaisen *) thisx;
...
block_9:
    (Actor *) this->textId = *(&D_80BE8E3C + ((Actor *) this->unk2A0 * 2));
...
void func_80BE89D8(EnBaisen *this, GlobalContext *globalCtx) {
    ...
    if (this == temp_v0) {
        ...
        this->unk29E = Math_Vec3f_Yaw((Vec3f *) &this->actor.world, (Vec3f *) &temp_v0->world);
        if (this->animIndex != 0) {
...
void func_80BE8AAC(EnBaisen *this, GlobalContext *globalCtx) {
    ...
    if ((this->textIdIndex & 1) != 0) {
        ...
        temp_a3 = this->unk2A4;
        if (temp_a3 != 0) {
            this->unk29E = Math_Vec3f_Yaw((Vec3f *) &this->actor.world, (Vec3f *) &temp_a3->world);
        }
        if (this->animIndex != 0) {
            EnBaisen_ChangeAnimation(this, 0);
        }
...
void EnBaisen_Update(EnBaisen *this, GlobalContext *globalCtx) {
...
void EnBaisen_Draw(EnBaisen *this, GlobalContext *globalCtx) {
    EnBaisen *this = (EnBaisen *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnBaisen_OverrideLimbDraw, NULL, (Actor *) this);
}
