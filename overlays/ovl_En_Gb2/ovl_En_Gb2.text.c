typedef struct EnGb2 {
    ...
    /* 0x18E */ char pad18E[0x42];                  /* maybe part of unk188[12]? */
    /* 0x1D0 */ Vec3s unk1D0;                       /* inferred */
    /* 0x1D6 */ char pad1D6[0x42];                  /* maybe part of unk1D0[12]? */
    /* 0x218 */ void (*actionFunc)(EnGb2 *, GlobalContext *);
    /* 0x21C */ ColliderCylinder unk21C;            /* inferred */
    /* 0x268 */ s32 unk268;                         /* inferred */
    /* 0x26C */ u16 unk26C;                         /* inferred */
    /* 0x26E */ u16 unk26E;                         /* inferred */
    /* 0x270 */ Vec3s unk270;                       /* inferred */
    /* 0x276 */ Vec3s unk276;                       /* inferred */
    ...
    /* 0x28A */ u8 unk28A;                          /* inferred */
    /* 0x28B */ char pad28B[0x1];
...
void func_80B10240(EnGb2 *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->unk282) != 0) {
        ActorCutscene_Start(this->unk282, (Actor *) this);
        temp_v1_2 = (this->unk280 * 0x14) + &D_80B119B0;
        Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, this->unk27C, temp_v1_2->unk4, temp_v1_2->unk8, temp_v1_2->unkC, (s16) 0, (s16) 0, (s16) 0, (s32) this->unk27E);
        if (this->unk280 == 0) {
...
void func_80B10868(EnGb2 *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCurrentIndex() != this->unk286) {
        ...
        if (ActorCutscene_GetCanPlayNext(temp_a0) != 0) {
            this->actionFunc = func_80B10A48;
            ActorCutscene_StartAndSetFlag((this + (this->unk290 * 2))->unk282, (Actor *) this);
            return;
        }
...
void func_80B109DC(EnGb2 *this, GlobalContext *globalCtx) {
    if (func_800B84D0((Actor *) this, globalCtx) != 0) {
        func_801518B0(globalCtx, this->unk26E, (Actor *) this);
        this->actionFunc = func_80B10634;
        return;
    }
...
void func_80B10B5C(EnGb2 *this, GlobalContext *globalCtx) {
    ...
    if (func_80B0FA48(this, globalCtx) != 0) {
        this->unk26C &= 0xFFDF;
        if ((func_800B84D0((Actor *) this, globalCtx) != 0) && (temp_v1 = this->unk26C, ((temp_v1 & 0x40) != 0))) {
            temp_a1 = this->unk26E;
    ...
    this->unk26C &= 0xFFBF;
    if ((func_800B84D0((Actor *) this, globalCtx) != 0) && ((this->unk26C & 0x20) != 0)) {
        this->actor.flags &= 0xFFFEFFFF;
        func_801518B0(globalCtx, this->unk26E, (Actor *) this);
        temp_v0 = this->unk26E;
        if (temp_v0 == 0x14EB) {
...
void EnGb2_Init(EnGb2 *this, GlobalContext *globalCtx) {
...
void EnGb2_Destroy(EnGb2 *this, GlobalContext *globalCtx) {
    EnGb2 *this = (EnGb2 *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk21C);
}

void EnGb2_Update(EnGb2 *this, GlobalContext *globalCtx) {
    EnGb2 *this = (EnGb2 *) thisx;
    ...
    func_800E9250(globalCtx, (Actor *) this, &this->unk270, &this->unk276, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
}
...
void func_80B117FC(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.unk0 = (s32) D_80B11ACC.unk0;
    sp18.unk4 = (s32) D_80B11ACC.unk4;
    sp18.unk8 = (s32) D_80B11ACC.unk8;
    if (arg1 == 7) {
        SysMatrix_MultiplyVector3fByState((Vec3f *) &sp18, arg4 + 0x3C);
    }
}

void EnGb2_Draw(EnGb2 *this, GlobalContext *globalCtx) {
    Gfx *temp_v1;
    Gfx *temp_v1_2;
    ...
    if (this->unk28A == 0xFF) {
        ...
        temp_s1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B1179C, func_80B117FC, (Actor *) this, temp_s1->polyOpa.p);
        return;
    }
    ...
    temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B1179C, func_80B117FC, (Actor *) this, temp_s1->polyXlu.p);
}
