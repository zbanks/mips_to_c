...
void BgLbfshot_Init(BgLbfshot *this, GlobalContext *globalCtx) {
...
void BgLbfshot_Destroy(BgLbfshot *this, GlobalContext *globalCtx) {
    BgLbfshot *this = (BgLbfshot *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->dyna.bgId);
}

void BgLbfshot_Draw(BgLbfshot *this, GlobalContext *globalCtx) {
    BgLbfshot *this = (BgLbfshot *) thisx;
