...
void BgHakuginElvpole_Init(BgHakuginElvpole *this, GlobalContext *globalCtx) {
...
void BgHakuginElvpole_Destroy(BgHakuginElvpole *this, GlobalContext *globalCtx) {
    BgHakuginElvpole *this = (BgHakuginElvpole *) thisx;
...
void BgHakuginElvpole_Update(BgHakuginElvpole *this, GlobalContext *globalCtx) {
    BgHakuginElvpole *this = (BgHakuginElvpole *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgHakuginElvpole_Draw(BgHakuginElvpole *this, GlobalContext *globalCtx) {
