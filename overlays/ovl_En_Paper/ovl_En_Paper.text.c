typedef struct EnPaper {
    ...
    /* 0x148 */ Vec3f unk_148;                      /* inferred */
    /* 0x154 */ char pad_154[0xC24];                /* maybe part of unk_148[260]? */
    /* 0xD78 */ s32 unk_D78;                        /* inferred */
    /* 0xD7C */ s32 unk_D7C;                        /* inferred */
    /* 0xD80 */ s32 unk_D80;                        /* inferred */
    /* 0xD84 */ s16 unk_D84;                        /* inferred */
    /* 0xD86 */ char pad_D86[0x2];
} EnPaper;                                          /* size = 0xD88 */
...
void EnPaper_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_D84 = 0x46;
    this->unk_D78 = D_80C1FC60.x;
    this->unk_D7C = D_80C1FC60.y;
    this->unk_D80 = D_80C1FC60.z;
...
void func_80C1F87C(EnPaper *arg0) {
    ...
    temp_f2 = -sp2C;
    arg0->unk_D7C = Math_SinS(arg0->actor.shape.rot.x) * temp_f2;
    sp20 = temp_f2;
    sp28 = Math_CosS(arg0->actor.shape.rot.x) * temp_f2;
    arg0->unk_D78 = Math_SinS(arg0->actor.shape.rot.y) * sp28;
    arg0->unk_D80 = Math_CosS(arg0->actor.shape.rot.y) * sp28;
...
void EnPaper_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80C1F87C(this);
    temp_v0 = this->unk_D84;
    if (temp_v0 == 0) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    this->unk_D84 = temp_v0 - 1;
}
