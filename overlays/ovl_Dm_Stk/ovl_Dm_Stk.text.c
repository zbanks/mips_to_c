typedef struct DmStk {
    /* 0x000 */ Actor actor;
    /* 0x144 */ ObjectContext unk144;               /* inferred */
    /* 0x290 */ void (*actionFunc)(DmStk *, GlobalContext *); /* overlap */
    /* 0x294 */ ColliderCylinder unk294;            /* inferred */
    /* 0x2E0 */ s16 unk2E0;                         /* inferred */
    /* 0x2E2 */ char pad2E2[0x2];
    /* 0x2E4 */ s32 unk2E4;                         /* inferred */
    /* 0x2E8 */ s32 unk2E8;                         /* inferred */
    /* 0x2EC */ s32 unk2EC;                         /* inferred */
    /* 0x2F0 */ s32 unk2F0;                         /* inferred */
    /* 0x2F4 */ char pad2F4[0x4];
    /* 0x2F8 */ s32 unk2F8;                         /* inferred */
    /* 0x2FC */ s32 unk2FC;                         /* inferred */
    /* 0x300 */ f32 unk300;                         /* inferred */
    /* 0x304 */ char pad304[0x24];                  /* maybe part of unk300[10]? */
    /* 0x328 */ u16 unk328;                         /* inferred */
    /* 0x32A */ char pad32A[0x2];
    /* 0x32C */ s8 unk32C;                          /* inferred */
    /* 0x32D */ s8 unk32D;                          /* inferred */
    /* 0x32E */ s8 unk32E;                          /* inferred */
    /* 0x32F */ s8 unk32F;                          /* inferred */
    /* 0x330 */ s32 unk330;                         /* inferred */
    /* 0x334 */ s8 unk334;                          /* inferred */
    /* 0x335 */ s8 unk335;                          /* inferred */
    /* 0x336 */ s8 unk336;                          /* inferred */
    /* 0x337 */ s8 unk337;                          /* inferred */
    /* 0x338 */ s8 unk338;                          /* inferred */
    /* 0x339 */ u8 unk339;                          /* inferred */
    /* 0x33A */ u8 unk33A;                          /* inferred */
    /* 0x33B */ u8 unk33B;                          /* inferred */
} DmStk;                                            /* size = 0x33C */
...
struct _mips2c_stack_func_80AA2BC0 {
    ...
    /* 0x60 */ char pad60[0x28];                    /* maybe part of sp5C[11]? */
...
void DmStk_Init(DmStk *this, GlobalContext *globalCtx) {
    ObjectContext *sp34;
...
void DmStk_Destroy(DmStk *this, GlobalContext *globalCtx) {
    DmStk *this = (DmStk *) thisx;
...
void DmStk_Update(DmStk *this, GlobalContext *globalCtx) {
    GameInfo *temp_v0_2;
    u16 temp_t3;
    u8 temp_v0;
    DmStk *this = (DmStk *) thisx;
...
void DmStk_Draw(DmStk *this, GlobalContext *globalCtx) {
    Gfx *temp_v1;
    Gfx *temp_v1_2;
    Gfx *temp_v1_3;
    Gfx *temp_v1_4;
    ...
    if (this->unk33B != 0) {
        ...
        *(gSegments + 0x18) = (u32) (globalCtx->objectCtx.status[this->unk336].segment + 0x80000000);
        ...
        if ((s32) this->unk144.status[5].loadMsg < 0xFF) {
            ...
            temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, (void **) this->unk144.spaceEnd, (Vec3s *) this->unk144.status[0].dmaReq.filename, (s32) this->unk146, NULL, func_80AA2BC0, (Actor *) this, temp_s1->polyXlu.p);
            return;
        }
        ...
        SkelAnime_DrawSV(globalCtx, (void **) this->unk144.spaceEnd, (Vec3s *) this->unk144.status[0].dmaReq.filename, (s32) this->unk146, func_80AA2B14, func_80AA33A4, (Actor *) this);
