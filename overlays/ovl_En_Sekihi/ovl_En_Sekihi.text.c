...
void EnSekihi_Init(EnSekihi *this, GlobalContext *globalCtx) {
    s32 sp24;
    s32 *sp20;
    s32 sp1C;
    s32 *temp_t0;
...
void EnSekihi_Destroy(EnSekihi *this, GlobalContext *globalCtx) {
    EnSekihi *this = (EnSekihi *) thisx;
...
void EnSekihi_Update(EnSekihi *this, GlobalContext *globalCtx) {
    EnSekihi *this = (EnSekihi *) thisx;
