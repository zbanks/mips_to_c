typedef struct EnMaruta {
    ...
    /* 0x1B0 */ ? unk1B0;                           /* inferred */
    /* 0x1B0 */ char pad1B0[0xC];
    /* 0x1BC */ ? unk1BC;                           /* inferred */
    /* 0x1BC */ char pad1BC[0xC];
    /* 0x1C8 */ ? unk1C8;                           /* inferred */
    /* 0x1C8 */ char pad1C8[0x3C];
    /* 0x204 */ Vec3f unk204;                       /* inferred */
...
void EnMaruta_Init(EnMaruta *this, GlobalContext *globalCtx) {
...
void EnMaruta_Destroy(EnMaruta *this, GlobalContext *globalCtx) {
    EnMaruta *this = (EnMaruta *) thisx;
    if (this->unk210 == 0) {
...
void func_80B37590(EnMaruta *arg0, GlobalContext *arg1) {
    ...
    sp38.unk0 = (s32) temp_t6_2->unk0;
    sp38.unk4 = (s32) temp_t6_2->unk4;
    sp38.unk8 = (s32) temp_t6_2->unk8;
    sp2C = Rand_Next();
...
f32 func_80B38028(? *arg0, void *arg1, ? *arg2) {
    return (arg0->unk8 * (arg2->unk0 - arg1->unk0)) - (arg0->unk0 * (arg2->unk8 - arg1->unk8));
}
...
void func_80B382E4(GlobalContext *arg0, f32 arg1, s32 arg2, s32 arg3) {
    ...
    sp84.unk0 = (s32) arg1.unk0;
    sp84.unk4 = (s32) arg1.unk4;
    sp84.unk8 = (s32) arg1.unk8;
    sp68 = D_80B38B60;
    sp64 = D_80B38B64;
    temp_s2 = &sp6C;
    temp_s1 = &sp78;
...
void EnMaruta_Update(EnMaruta *this, GlobalContext *globalCtx) {
    EnMaruta *this = (EnMaruta *) thisx;
...
void EnMaruta_Draw(EnMaruta *this, GlobalContext *globalCtx) {
    f32 sp50;
    Gfx *temp_s1;
    Gfx *temp_s1_2;
    Gfx *temp_v1;
