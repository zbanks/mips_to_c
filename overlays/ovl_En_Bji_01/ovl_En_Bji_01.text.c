...
void EnBji01_Init(EnBji01 *this, GlobalContext *globalCtx) {
    u32 temp_v1;
...
void EnBji01_Destroy(EnBji01 *this, GlobalContext *globalCtx) {
    EnBji01 *this = (EnBji01 *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->collider);
}

void EnBji01_Update(EnBji01 *this, GlobalContext *globalCtx) {
...
void EnBji01_Draw(EnBji01 *this, GlobalContext *globalCtx) {
