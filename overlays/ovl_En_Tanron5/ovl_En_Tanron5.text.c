...
void func_80BE4930(void *arg0, Vec3f *arg1, f32 arg2); /* static */
void func_80BE4A2C(void *arg0, Vec3f *arg1, f32 arg2); /* static */
...
typedef struct EnTanron5 {
    ...
    /* 0x0154 */ s16 *unk154;                       /* overlap; inferred */
    /* 0x0158 */ char pad158[0x5];
    /* 0x015D */ u8 unk15D;                         /* inferred */
    /* 0x015E */ char pad15E[0x2A];                 /* maybe part of unk15D[43]? */
    /* 0x0188 */ s32 *unk188;                       /* inferred */
    ...
    /* 0x01A0 */ u8 unk1A0;                         /* inferred */
    /* 0x01A1 */ char pad1A1[0x3];                  /* maybe part of unk1A0[4]? */
} EnTanron5;                                        /* size 0x1A4 */

void func_80BE4930(void *arg0, Vec3f *arg1, f32 arg2) {
    f32 temp_f0;
    s16 temp_v0;
    void *phi_s0;
    s16 phi_v0;
...
loop_1:
    ...
    if (phi_s0->unk24 == 0) {
        phi_s0->unk24 = 1U;
        phi_s0->unk0 = (s32) arg1->x;
        phi_s0->unk4 = (s32) arg1->y;
        phi_s0->unk8 = (s32) arg1->z;
...
void func_80BE4A2C(void *arg0, Vec3f *arg1, f32 arg2) {
    f32 temp_f0;
    s16 temp_v0;
    void *phi_s0;
    s16 phi_v0;
...
void EnTanron5_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_SetScale(&this->actor, this->unk19C * D_80BE5DD0);
                ...
                if (&D_06007D18 == this->unk148) {
                    ...
                    if (spC4 >= 4) {
                        ...
                        do {
                            ...
                            Actor_Spawn(sp74, globalCtx, 0x268, spB8.x, spB8.y, spB8.z, (s16) (s32) temp_f20, (s16) (s32) Rand_ZeroFloat(65536.0f), (s16) 0, (s16) (phi_s0 + 0x64));
                            temp_s0_2 = phi_s0 + 1;
                            phi_s0 = temp_s0_2;
...
block_38:
                    ...
                    if (spC4 > 0) {
                        ...
                        do {
                            ...
                            sp9C = (randPlusMinusPoint5Scaled(phi_f22) * D_80BE5DD0) + spB8.x;
                            temp_f2 = D_80BE5DD0;
                            spA4 = (randPlusMinusPoint5Scaled(phi_f22) * temp_f2) + spB8.z;
                            ...
                            if (phi_s0_3 < 8) {
                                func_80BE4A2C(globalCtx->specialEffects, (Vec3f *) &sp9C, Rand_ZeroFloat(3.0f) + 6.0f);
                            }
    ...
    if ((&D_06007D18 == this->unk148) || (D_80BE5DD0 < 0.5f)) {
        ...
        CollisionCheck_SetOC(globalCtx, temp_s0_5, &temp_s1_2->base);
        phi_s0_4 = temp_s0_5;
    } else {
    ...
    CollisionCheck_SetAC(globalCtx, phi_s0_4, &temp_s1_2->base);
}
    ...
    if ((s32) this->params < 0x6E) {
        ...
        if ((this->bgCheckFlags & 1) != 0) {
            if ((s32) this->params < 0x6C) {
                Math_Vec3f_Copy(&sp5C, &this->world.pos);
                sp38 = globalCtx + 0x18000;
                sp5C.y = this->floorHeight;
                phi_s0 = 0;
                do {
