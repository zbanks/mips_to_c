typedef struct EnTanron5 {
    ...
    /* 0x154 */ s16 *unk_154;                       /* overlap; inferred */
    /* 0x15D */ u8 unk_15D;                         /* overlap; inferred */
    /* 0x188 */ s32 *unk_188;                       /* overlap; inferred */
    ...
    /* 0x1A1 */ char pad_1A1[0x3];                  /* maybe part of unk_1A0[4]? */
...
struct _mips2c_stack_EnTanron5_Update {
    ...
    /* 0xC8 */ char pad_C8[0x8];                    /* maybe part of spC4[3]? */
...
loop_1:
    ...
    if (phi_s0->unk_24 == 0) {
        ...
        phi_s0->unk_C = randPlusMinusPoint5Scaled(10.0f);
        phi_s0->unk_10 = (f32) (Rand_ZeroFloat(2.0f) + 3.0f);
        phi_s0->unk_14 = randPlusMinusPoint5Scaled(10.0f);
        phi_s0->unk_1C = -0.15f;
        phi_s0->unk_18 = 0.0f;
        phi_s0->unk_20 = 0.0f;
        ...
        phi_s0->unk_2C = (s16) (s32) (temp_f0 + 200.0f);
        return;
    }
    phi_s0 += 0x3C;
    if ((s32) temp_v0 >= 0x96) {
...
loop_1:
    ...
    if (phi_s0->unk_24 == 0) {
        ...
        phi_s0->unk_34 = arg2;
        phi_s0->unk_38 = (f32) (2.0f * arg2);
        phi_s0->unk_2C = (s16) (s32) (temp_f0 + 150.0f);
        return;
    }
    phi_s0 += 0x3C;
    if ((s32) temp_v0 >= 0x96) {
...
void EnTanron5_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 >= 0x64) {
        ...
        this->unk_198 = (s16) (s32) randPlusMinusPoint5Scaled(8192.0f);
        this->unk_19A = (s16) (s32) randPlusMinusPoint5Scaled(8192.0f);
        ...
        if ((s32) this->actor.params >= 0x6E) {
            ...
            this->unk_1A0 = (u8) (u32) Rand_ZeroFloat(1.999f);
    ...
    if (temp_v0 == 0) {
        ...
        do {
            temp_s4 = phi_s0 + 1;
            temp_v0_3 = Actor_Spawn(temp_s7, globalCtx, 0x268, (f32) phi_s1->unk_0, this->actor.world.pos.y, (f32) phi_s1->unk_2, (s16) 0, (s16) (s32) Rand_ZeroFloat(65536.0f), (s16) 0, (s16) temp_s4);
            temp_s0 = temp_v0_3;
            temp_a0 = temp_v0_3;
...
void EnTanron5_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 >= 3) {
        this->unk_1A0 = temp_v0 + 1;
        Actor_SetScale((Actor *) this, 0.0f);
        if ((s32) this->unk_1A0 >= 0x28) {
            Actor_MarkForDeath((Actor *) this);
            return;
        }
    ...
    Actor_SetScale((Actor *) this, this->unk_19C * D_80BE5DD0);
    if (&D_06007D18 == this->unk_148) {
        this->unk_18C = (s16) (s32) (65.0f * D_80BE5DD0);
        this->unk_18E = (s16) (s32) (380.0f * D_80BE5DD0);
    } else {
        temp_v0_3 = this->unk_1A0;
        if (temp_v0_3 == 0) {
            this->unk_18C = (s16) (s32) (85.0f * D_80BE5DD0);
            this->unk_18E = (s16) (s32) (200.0f * D_80BE5DD0);
        } else if (temp_v0_3 == 1) {
            this->unk_18C = (s16) (s32) (95.0f * D_80BE5DD0);
            this->unk_18E = (s16) (s32) (100.0f * D_80BE5DD0);
        } else if (temp_v0_3 == 2) {
            this->unk_18C = (s16) (s32) (95.0f * D_80BE5DD0);
            this->unk_18E = (s16) (s32) (30.0f * D_80BE5DD0);
        }
    }
    if (this->unk_144 == 0) {
        temp_v0_4 = this->unk_15D;
        if ((temp_v0_4 & 2) != 0) {
            temp_s0 = this->unk_188;
            temp_s1 = this->unk_154;
            this->unk_15D = temp_v0_4 & 0xFFFD;
            spC4 = 0xA;
            ...
            if ((gGameInfo->data[1267] != 0) || (((temp_s0->unk_0 & 0x5000202) != 0) && (D_80BE5DD0 < 0.5f)) || (*temp_s1 == 0x12A)) {
                if (&D_06007D18 == this->unk_148) {
...
block_38:
                ...
                temp_v0_5 = this->unk_188;
                sp90 = (f32) temp_v0_5->unk_E;
                sp94 = (f32) temp_v0_5->unk_10;
                sp98 = (f32) temp_v0_5->unk_12;
                Audio_PlayActorSound2((Actor *) this, 0x1808U);
                CollisionCheck_SpawnShieldParticlesMetal(globalCtx, (Vec3f *) &sp90);
            }
        }
    }
    temp_s1_2 = &this->unk_14C;
    Collider_UpdateCylinder((Actor *) this, temp_s1_2);
    if (&D_06006FD0 == this->unk_148) {
        this->unk_14C.dim.pos.y = (s16) (s32) this->actor.floorHeight;
    }
    if ((&D_06007D18 == this->unk_148) || (D_80BE5DD0 < 0.5f)) {
...
void func_80BE5818(Actor *this, GlobalContext *globalCtx) {
    ...
    if (((s32) this->params < 0x6E) && (temp_v0 = this->unk_1A0, temp_t7 = temp_v0 + 1, (temp_v0 != 0))) {
        this->unk_1A0 = temp_t7;
    ...
    if ((s32) this->params < 0x6E) {
        this->shape.rot.x += this->unk_198;
        this->shape.rot.y += this->unk_19A;
        sp6C = 1225.0f;
        if ((this->bgCheckFlags & 1) != 0) {
            if ((s32) this->params < 0x6C) {
                ...
                phi_s0 = 0;
                do {
                    func_80BE4930(sp38->unk_870, &sp5C, Rand_ZeroFloat(1.0f) + 2.0f);
                    temp_s0 = phi_s0 + 1;
                    phi_s0 = temp_s0;
                } while (temp_s0 != 4);
                this->unk_1A0 = (u8) (this->unk_1A0 + 1);
            } else {
                Actor_MarkForDeath(this);
            }
        }
        ...
        sp6C = 400.0f;
        this->unk_198 = (s16) (this->unk_198 + 0x2000);
        if ((this->bgCheckFlags & 1) != 0) {
            this->unk_198 = 0;
            this->speedXZ = 0.0f;
        }
    }
    temp_v0_2 = this->unk_1A1;
    if (temp_v0_2 == 0) {
