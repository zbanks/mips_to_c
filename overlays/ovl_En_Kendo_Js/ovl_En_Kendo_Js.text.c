typedef struct EnKendoJs {
    ...
    /* 0x1DE */ char pad1DE[0x48];                  /* maybe part of unk1D8[13]? */
    /* 0x226 */ Vec3s unk226;                       /* inferred */
    /* 0x22C */ char pad22C[0x48];                  /* maybe part of unk226[13]? */
    /* 0x274 */ void *unk274;                       /* inferred */
    /* 0x278 */ Vec3s unk278;                       /* inferred */
    /* 0x27E */ Vec3s unk27E;                       /* inferred */
...
void EnKendoJs_Init(EnKendoJs *this, GlobalContext *globalCtx) {
...
void EnKendoJs_Destroy(EnKendoJs *this, GlobalContext *globalCtx) {
    EnKendoJs *this = (EnKendoJs *) thisx;
...
void EnKendoJs_Update(EnKendoJs *this, GlobalContext *globalCtx) {
    EnKendoJs *this = (EnKendoJs *) thisx;
    this->actionFunc(this, globalCtx);
    SkelAnime_FrameUpdateMatrix(&this->unk190);
    func_800E9250(globalCtx, (Actor *) this, &this->unk278, &this->unk27E, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
...
void EnKendoJs_Draw(EnKendoJs *this, GlobalContext *globalCtx) {
    EnKendoJs *this = (EnKendoJs *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80B27B54, func_80B27B8C, (Actor *) this);
}
