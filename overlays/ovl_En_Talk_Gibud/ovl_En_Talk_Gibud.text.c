...
typedef struct EnTalkGibud {
    ...
    /* 0x1FC */ char pad1FC[0x90];                  /* maybe part of unk1F8[37]? */
    ...
    /* 0x2AA */ char pad2AA[0x96];                  /* maybe part of unk2A4[26]? */
    /* 0x340 */ Vec3s unk340;                       /* inferred */
    /* 0x346 */ char pad346[0xA4];                  /* maybe part of unk340[28]? */
    ...
    /* 0x3F6 */ u8 unk3F6;                          /* inferred */
    /* 0x3F7 */ char pad3F7[0x1];
...
void EnTalkGibud_Init(EnTalkGibud *this, GlobalContext *globalCtx) {
...
void EnTalkGibud_Destroy(EnTalkGibud *this, GlobalContext *globalCtx) {
    EnTalkGibud *this = (EnTalkGibud *) thisx;
...
void func_80B00158(Actor *arg0, GlobalContext *arg1) {
    ...
    sp84.unk0 = (s32) D_80B01460.unk0;
    sp84.unk4 = (s32) D_80B01460.unk4;
    sp84.unk8 = (s32) D_80B01460.unk8;
    temp_v0 = arg0->unk3EA;
    if ((s32) temp_v0 > 0) {
        phi_s3 = (s32) temp_v0;
        if ((s32) temp_v0 >= 4) {
...
void EnTalkGibud_Update(EnTalkGibud *this, GlobalContext *globalCtx) {
    EnTalkGibud *this = (EnTalkGibud *) thisx;
...
void EnTalkGibud_Draw(EnTalkGibud *this, GlobalContext *globalCtx) {
    Gfx *temp_v1;
    Gfx *temp_v1_2;
    Gfx *temp_v1_3;
    Gfx *temp_v1_4;
    ...
    if (this->actor.shape.shadowAlpha == 0xFF) {
        ...
        temp_s1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80B00F08, func_80B00F64, (Actor *) this, temp_s1->polyOpa.p);
    } else {
        ...
        temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80B00F08, func_80B00F64, (Actor *) this, temp_s1->polyXlu.p);
    }
    if ((s32) this->unk3F0 > 0) {
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) (Vec3f *) &this->unk1D8, 0xF, this->unk2A0, 0.5f, this->unk29C, (u8) (s32) this->unk3F6);
    }
}
