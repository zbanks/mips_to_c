...
static s16 D_8095F74C = {0x10, 0xD, 0xB, 9, 7, 5};
static s16 D_8095F758 = {0x91, 0x87, 0x78, 0x64, 0x46, 0x32, 0x2D, 0x28, 0x23, 0};
...
typedef struct EnIshi {
    ...
    /* 0x0190 */ void (*actionFunc)(EnIshi *, GlobalContext *);
...
void func_8095D804(void *arg0, GlobalContext *arg1) {
    ...
    phi_s1 = &D_8095F74C;
    do {
        spB8 = ((Rand_ZeroOne() - 0.5f) * 8.0f) + arg0->unk24;
        spBC = (Rand_ZeroOne() * 5.0f) + arg0->unk28 + 5.0f;
        spC0 = ((Rand_ZeroOne() - 0.5f) * 8.0f) + arg0->unk2C;
        Math_Vec3f_Copy(temp_s2, arg0 + 0x64);
        temp_v0_2 = arg0->unk90;
        if ((temp_v0_2 & 1) != 0) {
            spC4.x *= 0.6f;
            spC4.y *= -0.3f;
            phi_f4 = spC4.z * 0.6f;
...
block_8:
        ...
        EffectSsKakera_Spawn(arg1, (Vec3f *) temp_s3, temp_s2, (Vec3f *) temp_s3, (s16) -0x1A4, (s16) phi_v0, (s16) 0x1E, (s16) 5, (s16) 0, (s16) (s32) *phi_s1, (s16) 3, (s16) 0xA, 0x28, (s16) -1, (s16) (s32) temp_s6, phi_s4);
        temp_s1 = phi_s1 + 2;
        phi_s1 = temp_s1;
...
void func_8095DABC(void *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        spCC = (Math_SinS(temp_s1) * temp_f20) + arg0->unk24;
        spD0 = (Rand_ZeroOne() * 40.0f) + arg0->unk28 + 5.0f;
        spD4 = (Math_CosS(temp_s1) * temp_f20) + arg0->unk2C;
        Math_Vec3f_Copy(temp_s4, spA4);
        temp_v0 = arg0->unk90;
        phi_s1 = temp_s1;
        if ((temp_v0 & 1) != 0) {
            spD8.x *= 0.9f;
        ...
        spD8.x += temp_f20_2 * Math_SinS(temp_s1);
        temp_f22 = Rand_ZeroOne();
        spD8.y += (Rand_ZeroOne() * 4.0f) + (temp_f22 * (f32) phi_s2 * 0.7f);
        spD8.z += temp_f20_2 * Math_CosS(temp_s1);
        if (phi_s2 == 0) {
            phi_v1 = -0x1C2;
            phi_v0 = 0x29;
        } else {
        ...
        EffectSsKakera_Spawn(arg1, (Vec3f *) temp_s5, temp_s4, arg0 + 0x24, (s16) phi_v1, (s16) phi_v0, (s16) 0x1E, (s16) 5, (s16) 0, (s16) (s32) *phi_s3, (s16) 5, (s16) 2, 0x46, (s16) 0, (s16) 2, (Gfx *) &D_05006420);
        temp_s2 = phi_s2 + 1;
        phi_s2 = temp_s2;
        phi_s3 += 2;
    } while (temp_s2 != 9);
...
void func_8095DDA8(void *arg0, GlobalContext *arg1) {
    ...
    temp_a1 = arg0 + 0x24;
    arg0 = arg0;
    Math_Vec3f_Copy(&sp2C, temp_a1);
    temp_v0 = arg0->unk90;
    if ((temp_v0 & 1) != 0) {
        sp2C.x += 2.0f * arg0->unk64;
        sp2C.y -= 2.0f * arg0->unk68;
        sp2C.z += 2.0f * arg0->unk6C;
    } else if ((temp_v0 & 8) != 0) {
        sp2C.x -= 2.0f * arg0->unk64;
        sp2C.y += 2.0f * arg0->unk68;
        sp2C.z -= 2.0f * arg0->unk6C;
    }
    func_800BBFB0(arg1, &sp2C, 60.0f, 3, (s16) 0x50, (s16) 0x3C, (u8) 1);
}
...
void func_8095DE9C(void *arg0, GlobalContext *arg1) {
    ...
    func_800BBFB0(arg1, &sp2C, 140.0f, 0xA, (s16) 0xB4, (s16) 0x5A, (u8) 1);
}
...
void func_8095DFF0(EnIshi *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 >= 0) {
        ...
        if (temp_v0_2 != 0) {
            ...
            SysMatrix_GetStateTranslationAndScaledY(1.0f, &sp30);
            temp_f0 = (bitwise f32) Math3D_Parallel(&sp30, &D_8095F778);
            if (temp_f0 < 0.707f) {
                sp2C = temp_f0;
                temp_a0 = sp3C->actor.world.rot.y;
                temp_v1_2 = Math_FAtan2F(sp30.z, sp30.x) - temp_a0;
...
void EnIshi_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp30 = temp_v1;
    sp34 = temp_a2;
    Actor_ProcessInitChain(&this->actor, (temp_a2 * 0x14) + &D_8095F784);
    if (globalCtx->csCtx.state != 0) {
        this->actor.uncullZoneForward += 1000.0f;
    }
    if ((this->actor.shape.rot.y == 0) && ((this->unk197 & 2) == 0)) {
        sp34 = temp_a2;
    ...
    sp24 = temp_v0_2;
    sp28 = temp_v1_3;
    Actor_SetScale(&this->actor, *temp_v0_2);
    ...
    if ((sp30 == 0) && (func_8095D758(&this->actor, globalCtx, 0.0f) == 0)) {
        Actor_MarkForDeath(&this->actor);
        return;
    }
    ...
    this->unk196 = Object_GetIndex(&globalCtx->objectCtx, *(&D_8095F6E8 + ((((s32) this->actor.params >> 3) & 1) * 2)));
...
void func_8095E5C0(EnIshi *this, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) temp_a1) != 0) {
        ...
        this->actor.objBankIndex = this->unk196;
...
void func_8095E660(EnIshi *this, GlobalContext *globalCtx) {
    ...
    if (Actor_HasParent(&this->actor, globalCtx) != 0) {
        sp38 = temp_t0;
        func_8095E934(this);
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x14, *(&D_8095F7AC + (temp_t0 * 2)));
    ...
    if ((temp_v1 != 0) && (temp_t0 == 0) && ((this->unk144.info.acHitInfo->toucher.dmgFlags & 0x508) != 0)) {
        if (temp_a3 != 0) {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, (s32) *(&D_8095F6D4 + temp_t0), *(&D_8095F6D0 + (temp_t0 * 2)));
        temp_v0_2 = temp_t0 * 4;
        sp2C = temp_v0_2;
    ...
    if ((this->actor.xzDistToPlayer < 600.0f) || (temp_a3 != 0)) {
        temp_v0_3 = this->unk195;
        if ((s32) temp_v0_3 > 0) {
            this->unk195 = temp_v0_3 - 1;
            if (this->unk195 == 0) {
                this->unk144.base.colType = *(&D_8095F6EC + (temp_t0 * 0x2C));
            } else {
...
void func_8095E95C(EnIshi *this, GlobalContext *globalCtx) {
    ...
    if (Actor_HasNoParent(&this->actor, globalCtx) != 0) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 7.5f, 35.0f, 0.0f, 0xC5U);
        return;
    }
...
void func_8095EBDC(EnIshi *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->unk144.base.atFlags;
    temp_v0 = (temp_v1 & 2) != 0;
    if (temp_v0 != 0) {
        this->unk144.base.atFlags = temp_v1 & 0xFFFD;
    }
    temp_v1_2 = this->actor.bgCheckFlags;
    this->unk194 += -1;
    if (((temp_v1_2 & 9) != 0) || (temp_v0 != 0) || ((s32) this->unk194 <= 0)) {
        func_8095DF90(this, globalCtx);
        temp_s0_2 = sp70 * 4;
        temp_s1_3 = temp_s0_2 + &D_8095F6D8;
        *temp_s1_3(this, globalCtx);
        if ((this->actor.bgCheckFlags & 0x20) == 0) {
            Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, (s32) *(&D_8095F6D4 + sp70), *(&D_8095F6D0 + (sp70 * 2)));
    ...
    if ((temp_v1_2 & 0x40) != 0) {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x28, 0x28C5U);
    ...
    CollisionCheck_SetOC(globalCtx, temp_s1_2, &temp_s0->base);
    CollisionCheck_SetAT(globalCtx, temp_s1_2, &temp_s0->base);
}
...
void func_8095F0A4(EnIshi *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext((s16) this->actor.cutscene) != 0) {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, (s32) *(&D_8095F6D4 + sp28), *(&D_8095F6D0 + (sp28 * 2)));
        temp_v0 = sp28 * 4;
        sp24 = temp_v0;
...
void func_8095F210(void *arg0, GlobalContext *arg1) {
    ...
    temp_f0 = arg0->unkF4;
    if ((temp_f0 <= 1200.0f) || (((arg0->unk197 & 1) != 0) && (temp_f0 < 1300.0f))) {
    ...
    if (temp_f0 < 1300.0f) {
        ...
        temp_f8 = (s32) ((1300.0f - arg0->unkF4) * 2.55f);
...
void func_8095F36C(void *arg0, GraphicsContext **arg1) {
    ...
    temp_f0 = arg0->unkF4;
    temp_a2 = *arg1;
    if ((temp_f0 <= 2150.0f) || (((arg0->unk197 & 1) != 0) && (temp_f0 < 2250.0f))) {
        arg0->unkD0 = 0xA0;
        sp38 = temp_a2;
        func_8012C28C(*arg1);
    ...
    if (temp_f0 < 2250.0f) {
        ...
        arg0->unkD0 = (s8) (u32) (temp_f2 * 0.627451f);
        sp20 = temp_f2;
        sp38 = temp_a2;
        func_8012C2DC(*arg1);
