typedef struct EnTk {
    ...
    /* 0x2EA */ char pad2EA[0x2];
    /* 0x2EC */ Vec3f unk2EC;                       /* inferred */
    /* 0x2F8 */ Vec3s unk2F8;                       /* inferred */
    /* 0x2FE */ char pad2FE[0x2];
    /* 0x300 */ Vec3f unk300;                       /* inferred */
    /* 0x30C */ ? (*unk30C)(EnTk *, GlobalContext *); /* inferred */
    ...
    /* 0x31E */ char pad31E[0x2];
    /* 0x320 */ f32 unk320;                         /* inferred */
    /* 0x324 */ char pad324[0xA8];                  /* maybe part of unk320[43]? */
    /* 0x3CC */ u8 unk3CC;                          /* inferred */
    /* 0x3CD */ char pad3CD[0x1];
    /* 0x3CE */ u16 unk3CE;                         /* inferred */
    /* 0x3D0 */ s32 unk3D0;                         /* inferred */
    /* 0x3D4 */ char pad3D4[0x20];                  /* maybe part of unk3D0[9]? */
} EnTk;                                             /* size = 0x3F4 */
...
struct _mips2c_stack_func_80AECB6C {
    ...
    /* 0x35 */ char pad35[0xF];                     /* maybe part of sp34[16]? */
...
block_5:
    ...
    func_8013E3B8((Actor *) this, (s16 []) &this->unk312, 2);
    temp_v1 = this->unk2B0;
    if (temp_v1 != 0) {
        if (temp_v1 == 4) {
            if (D_80AF0050 != 0) {
...
void func_80AECB6C(EnTk *this, GlobalContext *globalCtx) {
    ...
    if (func_80133038(globalCtx, &D_80AEF800, (struct_80133038_arg2 *) &sp34) != 0) {
        if ((sp34 == this->unk3CC) || (func_80AED354(this, globalCtx, &sp34) != 0)) {
            phi_v0 = sp34;
            goto block_13;
        }
    } else {
...
? func_80AECE60(Actor *arg0, GlobalContext *arg1) {
    ...
    func_8013AF00((void *) &spA0, 3, arg0->unk3C8->count + 3);
    if ((arg0->unk3CE & 4) == 0) {
        temp_v0 = arg0 + 0x3EC;
        ...
        sp50 = temp_a2;
        sp4C = temp_v0;
        func_8013B6B0(arg0->unk3C8, temp_s1, temp_a2, arg0->unk3E8, arg0->unk3E4, temp_v0, (void *) &spA0, (Vec3f *) &sp7C, (s16) arg0->unk3D0);
        func_8013B878(arg1, arg0->unk3C8, arg0->unk3EC, (Vec3f *) &sp7C);
        ...
        temp_s0 = arg0 + 0x3D4;
        sp7C.unk0 = temp_s0->x;
        sp7C.unk4 = (f32) temp_s0->y;
        sp7C.unk8 = (f32) temp_s0->z;
        sp4C = arg0 + 0x3EC;
        sp50 = arg0 + 0x3F0;
        phi_s0 = temp_s0;
        phi_s1 = arg0 + 0x3E0;
    ...
    if ((arg1->unk_18B4A != 0) || (arg0->unk3D0 == 0)) {
        sp78 = arg0->unk3F0;
        sp74 = arg0->unk3EC;
        sp7C.unk0 = arg0->world.pos.x;
        sp7C.unk4 = (f32) arg0->world.pos.y;
        sp7C.unk8 = (f32) arg0->world.pos.z;
    }
    phi_s0->x = D_801D15B0.x;
    phi_s0->y = D_801D15B0.y;
    phi_s0->z = D_801D15B0.z;
    sp44 = temp_v1;
    if (func_8013B6B0(arg0->unk3C8, phi_s1, sp50, arg0->unk3E8, arg0->unk3E4, sp4C, (void *) &spA0, phi_s0, (s16) arg0->unk3D0) != 0) {
        arg0->unk3CE = (u16) (arg0->unk3CE | 8);
    } else {
        sp94.unk0 = (f32) arg0->world.pos.x;
        sp94.unk4 = (f32) arg0->world.pos.y;
        sp94.unk8 = (f32) arg0->world.pos.z;
        sp88.unk0 = (f32) phi_s0->x;
        sp88.unk4 = (f32) phi_s0->y;
        sp88.unk8 = (f32) phi_s0->z;
        sp44 = temp_v1;
...
loop_18:
        ...
        if (temp_v0_3 != 0) {
            if ((temp_v0_3->params & 0xF) == 1) {
                Math_Vec3f_Copy(&this->unk2EC, (Vec3f *) &temp_v0_3->world);
...
void func_80AEDC4C(EnTk *this, GlobalContext *globalCtx) {
    ...
    if (((s32) temp_a2 >= 0) && (func_8013E2D4((Actor *) this, this->unk314, (s32) temp_a2, 0) != 0)) {
    ...
    case 0:                                         /* switch 1 */
        ...
        case 5133:                                  /* switch 2 */
            ...
            if ((Math_SmoothStepToS(&this->unk31A, 0, 3, 0x16C, (s16) 0xA) == 0) && (Math_SmoothStepToS(&this->unk31C, 0, 3, 0x71C, (s16) 0xA) == 0) && ((s16) (this->actor.yawTowardsPlayer - 0x1555) == this->actor.shape.rot.y)) {
                ...
                func_801518B0(globalCtx, this->unk2E6, (Actor *) this);
                return;
            }
        default:                                    /* switch 1 */
        default:                                    /* switch 2 */
...
void func_80AEE2C0(EnTk *this, GlobalContext *globalCtx) {
    if (func_8013E2D4((Actor *) this, this->unk312, 0x7C, 0) != 0) {
...
void func_80AEE6B8(EnTk *this, GlobalContext *globalCtx) {
    if ((this->unk2CA & 0x20) != 0) {
        ...
        if (func_8013E2D4((Actor *) this, 0x7C, (s32) this->unk312, 0) != 0) {
            this->unk310 = 3;
            func_80AEDE10(this, globalCtx);
            this->unk2CA &= 0xFFDF;
            return;
...
void func_80AEE9B0(EnTk *this, GlobalContext *globalCtx) {
    ...
    if (Math_Vec3f_DistXZ((Vec3f *) &this->actor.world, &this->unk300) >= 100.0f) {
        this->unk2CA &= 0xFFFD;
    }
...
void EnTk_Draw(EnTk *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80AEF65C, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80AEF6A4, (Actor *) this);
}
