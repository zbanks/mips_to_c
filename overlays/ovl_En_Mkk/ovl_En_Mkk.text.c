...
void EnMkk_Init(EnMkk *this, GlobalContext *globalCtx) {
    s32 sp2C;
    PosRot *sp24;
    PosRot *temp_a1;
    s16 temp_v0;
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk17C, (Actor *) this, &D_80A4F720);
    ...
    sp24 = temp_a1;
    Math_Vec3f_Copy(&this->unk154, (Vec3f *) temp_a1);
    Math_Vec3f_Copy(&this->unk160, (Vec3f *) temp_a1);
...
void EnMkk_Destroy(EnMkk *this, GlobalContext *globalCtx) {
    EnMkk *this = (EnMkk *) thisx;
...
void func_80A4E2E8(EnMkk *this, GlobalContext *globalCtx) {
    ...
    if (((sp24->unkA74 & 0x100) != 0) || (Player_GetMask(globalCtx) == 0x10)) {
        Math_ScaledStepToS(&this->unk150, Actor_YawToPoint((Actor *) this, (Vec3f *) &this->actor.home), 0x400);
    ...
    if ((this->unk149 == 0) && ((sp24->unkA74 & 0x100) == 0) && (Player_GetMask(globalCtx) != 0x10) && ((this->actor.bgCheckFlags & 1) != 0) && (Actor_IsActorFacingLink((Actor *) this, 0x1800) != 0) && (this->actor.xzDistToPlayer < 120.0f) && (fabsf(this->actor.yDistToPlayer) < 100.0f)) {
        func_80A4E58C(this);
    }
}
...
void func_80A4E84C(EnMkk *arg0) {
    ...
    if ((arg0->unk14B & 3) != 0) {
        ...
        arg0->unk160.x = ((sp34 - temp_f12_2) * temp_f2_2 * 12.0f) + temp_f12_2;
        arg0->unk160.y = ((sp38 - temp_f14_2) * temp_f2_2 * 12.0f) + temp_f14_2;
        arg0->unk160.z = ((sp3C - temp_f16) * temp_f2_2 * 12.0f) + temp_f16;
        return;
    }
...
void EnMkk_Update(EnMkk *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk17C.base.atFlags & 1) != 0) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk17C);
    }
    ...
    CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk17C);
}
...
void func_80A4EF74(EnMkk *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 <= 0) {
        if ((this->unk14B & 8) != 0) {
            ...
            Math_Vec3f_Copy(&this->unk154, (Vec3f *) sp24);
            Math_Vec3f_Copy(&this->unk160, (Vec3f *) sp24);
...
void EnMkk_Draw(EnMkk *this, GlobalContext *globalCtx) {
    void *sp2C;
    Gfx *sp28;
    MtxF *sp1C;
