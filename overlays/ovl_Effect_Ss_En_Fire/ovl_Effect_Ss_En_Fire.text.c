struct _mips2c_stack_EffectSsEnFire_Draw {
    ...
    /* 0x54 */ char pad54[0xA];                     /* maybe part of sp50[3]? */
...
s32 EffectSsEnFire_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    if ((s32) initParamsx->unk16 < 0) {
        this->regs[5] = Math_Vec3f_Yaw((Vec3f *) &initParamsx->unk0->world, temp_s2) - initParamsx->unk0->shape.rot.y;
        this->regs[4] = Math_Vec3f_Pitch((Vec3f *) &initParamsx->unk0->world, temp_s2) - initParamsx->unk0->shape.rot.x;
        this->vec.z = Math_Vec3f_DistXYZ(temp_s2, (Vec3f *) &initParamsx->unk0->world);
    }
