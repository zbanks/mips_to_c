struct _mips2c_stack_EffectSsEnFire_Draw {
    /* 0x00 */ char pad_0[0x44];
    /* 0x44 */ Gfx *sp44;                           /* inferred */
    /* 0x48 */ char pad_48[0x8];                    /* maybe part of sp44[3]? */
    /* 0x50 */ Gfx *sp50;                           /* inferred */
    /* 0x54 */ char pad_54[0xA];                    /* maybe part of sp50[3]? */
    /* 0x5E */ s16 sp5E;                            /* inferred */
    /* 0x60 */ char pad_60[0x18];
};                                                  /* size = 0x78 */

struct _mips2c_stack_EffectSsEnFire_Init {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EffectSsEnFire_Update {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */
...
s32 EffectSsEnFire_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    Math_Vec3f_Copy((Vec3f *) this, temp_s2);
    ...
    if ((s32) initParamsx->unk_16 < 0) {
        this->regs[5] = Math_Vec3f_Yaw((Vec3f *) &initParamsx->unk_0->world, temp_s2) - initParamsx->unk_0->shape.rot.y;
        this->regs[4] = Math_Vec3f_Pitch((Vec3f *) &initParamsx->unk_0->world, temp_s2) - initParamsx->unk_0->shape.rot.x;
        this->vec.z = Math_Vec3f_DistXYZ(temp_s2, (Vec3f *) &initParamsx->unk_0->world);
    }
    this->regs[0] = initParamsx->unk_10;
    if ((initParamsx->unk_12 & 0x8000) != 0) {
        this->regs[1] = initParamsx->unk_10;
    } else {
        this->regs[1] = 0;
    }
    this->regs[6] = initParamsx->unk_12 & 0x7FFF;
    this->regs[7] = initParamsx->unk_16;
    this->regs[8] = initParamsx->unk_14;
    return 1;
}
    ...
    if (temp_v0 != 0) {
        ...
        if (this->actor->update != 0) {
            ...
            if ((s32) temp_v1 < 0) {
                ...
                SysMatrix_MultiplyVector3fByState(&this->vec, (Vec3f *) this);
                return;
            }
            if ((this->regs[8] & 0x8000) != 0) {
                temp_v0_3 = this->actor + (temp_v1 * 6);
                this->pos.x = (f32) temp_v0_3->unk_144;
                this->pos.y = (f32) temp_v0_3->unk_146;
                this->pos.z = (f32) temp_v0_3->unk_148;
                return;
            }
            temp_v0_4 = this->actor + (temp_v1 * 0xC);
            this->pos.x = temp_v0_4->unk_144;
            this->pos.y = temp_v0_4->unk_148;
            this->pos.z = temp_v0_4->unk_14C;
            return;
        }
        if (this->regs[6] != 0) {
            this->life = 0;
