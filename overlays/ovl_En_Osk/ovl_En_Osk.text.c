...
struct _mips2c_stack_EnOsk_Draw {
    ...
    /* 0x70 */ char pad70[0x10];                    /* maybe part of sp6C[5]? */
...
void EnOsk_Init(EnOsk *this, GlobalContext *globalCtx) {
    SkelAnime *temp_s1;
    SkelAnime *temp_s1_2;
    SkelAnime *temp_s1_3;
    s32 temp_v0;
...
void EnOsk_Destroy(EnOsk *this, GlobalContext *globalCtx) {
    EnOsk *this = (EnOsk *) thisx;
...
void func_80BF61EC(EnOsk *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, (u32) this->unk258) != 0) {
        func_800EDF24((Actor *) this, globalCtx, func_800EE200(globalCtx, (u32) this->unk258));
...
void EnOsk_Update(EnOsk *this, GlobalContext *globalCtx) {
    EnOsk *this = (EnOsk *) thisx;
...
void EnOsk_Draw(EnOsk *this, GlobalContext *globalCtx) {
    Gfx *sp8C;
    f32 sp84;
    f32 sp80;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80BF6C54, (Actor *) this);
    temp_a1 = &this->actor.focus;
    temp_t7 = globalCtx->cameraPtrs[globalCtx->activeCamera];
    sp54.unk0 = (f32) temp_t7->eye.x;
    sp54.unk4 = (f32) temp_t7->eye.y;
    sp54.unk8 = (f32) temp_t7->eye.z;
    sp34 = temp_a1;
