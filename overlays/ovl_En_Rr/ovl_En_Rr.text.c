typedef struct EnRr {
    ...
    /* 0x240 */ char pad_240[0xE4];                 /* maybe part of unk_234[20]? */
    /* 0x324 */ f32 unk_324;                        /* inferred */
    /* 0x328 */ f32 unk_328;                        /* inferred */
    /* 0x32C */ f32 unk_32C;                        /* inferred */
    /* 0x330 */ char pad_330[0x4];
    /* 0x334 */ f32 unk_334;                        /* inferred */
    /* 0x338 */ char pad_338[0x6];                  /* maybe part of unk_334[2]? */
    /* 0x33E */ s16 unk_33E;                        /* inferred */
    /* 0x340 */ char pad_340[0x68];                 /* maybe part of unk_33E[53]? */
    /* 0x3A8 */ f32 unk_3A8;                        /* inferred */
    /* 0x3AC */ char pad_3AC[0x4];
    /* 0x3B0 */ f32 unk_3B0;                        /* inferred */
    /* 0x3B4 */ char pad_3B4[0x10];                 /* maybe part of unk_3B0[5]? */
} EnRr;                                             /* size = 0x3C4 */
...
void EnRr_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk_148, (Actor *) this, &D_808FC150);
    ...
    if (this->actor.params != 3) {
        ...
        this->unk_148.dim.radius = (s16) (s32) ((f32) this->unk_148.dim.radius * 1.5f);
        this->unk_148.dim.height = (s16) (s32) ((f32) this->unk_148.dim.height * 1.5f);
        this->unk_194.dim.radius = (s16) (s32) ((f32) this->unk_194.dim.radius * 1.5f);
        this->unk_194.dim.height = (s16) (s32) ((f32) this->unk_194.dim.height * 1.5f);
        this->unk_194.dim.yShift = (s16) (s32) ((f32) this->unk_194.dim.yShift * 1.5f);
    }
...
void func_808FA01C(Actor *arg0, GlobalContext *arg1, void *arg2) {
    ...
    if (temp_v0 == 2) {
        arg0->unk_1E0 = 0;
        arg0[1].shape.feetPos[0].z = 0.85f;
        arg0[1].shape.feetPos[0].y = 4.0f;
        return;
    }
    if (temp_v0 == 4) {
        arg0->unk_1E0 = 0x14;
        arg0[1].shape.feetPos[0].z = 0.85f;
        arg0[1].shape.feetPos[0].y = 4.0f;
        Actor_Spawn(arg1 + 0x1CA0, arg1, 0xA2, (f32) arg2->unk_26, (f32) arg2->unk_28, (f32) arg2->unk_2A, (s16) 0, (s16) 0, (s16) 0, (s16) 4);
        return;
    }
    if (temp_v0 == 5) {
        arg0->unk_1E0 = 0x1E;
...
void func_808FA11C(Actor *arg0) {
    ...
    arg0[1].shape.feetPos[0].z = 0.85f;
    arg0->flags &= -0x401;
    arg0[1].shape.feetPos[1].x = 1.2750001f;
    arg0[1].shape.feetPos[0].y = 1.0f;
...
void func_808FA260(Actor *arg0) {
    ...
    arg0->unk_1E1 = 1;
    arg0->unk_1E6 = 0x14;
    arg0[1].colChkInfo.cylHeight = 0x9C4;
    arg0[1].shape.shadowScale = 0.0f;
    arg0[2].colChkInfo.cylRadius = 0x1770;
    arg0[2].colChkInfo.cylYShift = 0;
    temp_v1 = (1 * 4) + D_808FC1E4;
    arg0[2].colChkInfo.displacement.y = 0.8f;
    arg0[2].colChkInfo.damageTable = *D_808FC1E4;
    temp_v0 = arg0 + (1 << 5);
    temp_v0->unk_338 = 0x1770;
    temp_v0->unk_33C = 0;
    temp_v0->unk_330 = 0.8f;
    temp_v0->unk_328 = (f32) temp_v1->unk_0;
    temp_v0->unk_35C = 0;
    temp_v0->unk_358 = 0x1770;
    temp_v0->unk_350 = 0.8f;
    temp_v0->unk_348 = (f32) temp_v1->unk_4;
    temp_v0->unk_37C = 0;
    temp_v0->unk_378 = 0x1770;
    temp_v0->unk_370 = 0.8f;
    temp_v0->unk_368 = (f32) temp_v1->unk_8;
    temp_v0->unk_39C = 0;
    temp_v0->unk_398 = 0x1770;
    temp_v0->unk_390 = 0.8f;
    temp_v0->unk_388 = (f32) temp_v1->unk_C;
    arg0->unk_144 = func_808FB088;
...
void func_808FA344(EnRr *arg0) {
    ...
    temp_v1->unk_39C = 0;
    temp_v1->unk_398 = 0;
    temp_v1->unk_388 = 0.0f;
    temp_v1->unk_37C = 0;
    temp_v1->unk_378 = 0;
    temp_v1->unk_368 = 0.0f;
    temp_v1->unk_35C = 0;
    temp_v1->unk_358 = 0;
    temp_v1->unk_348 = 0.0f;
    temp_v1->unk_328 = 0.0f;
    temp_v1->unk_338 = 0;
    temp_v1->unk_33C = 0;
    temp_v1->unk_390 = 1.0f;
    temp_v1->unk_370 = 1.0f;
    temp_v1->unk_350 = 1.0f;
    temp_v1->unk_330 = 1.0f;
    if (arg0->unk_1E2 != 0) {
        arg0->unk_1E6 = 0x64;
...
void func_808FA3F8(Actor *arg0, void *arg1) {
    ...
    arg0->unk_1EA = 0x64;
    arg0->unk_1FC = 0x14;
    arg0->unk_15A = (u8) (arg0->unk_15A & 0xFFF7);
    arg0->flags &= -2;
    arg0->unk_1F0 = 8;
    arg0->unk_1E1 = 0;
    arg0->speedXZ = 0.0f;
    arg0[1].shape.feetPos[0].x = 0.0f;
    arg0[1].shape.shadowScale = 0.0f;
    arg0[1].colChkInfo.cylHeight = 0x1388;
    arg0[2].colChkInfo.cylYShift = 0;
    arg0[2].colChkInfo.cylRadius = 0;
    arg0[2].colChkInfo.damageTable = 0.0f;
    temp_v0 = arg0 + (1 << 5);
    arg0->unk_204 = 0.15f;
    arg0[1].shape.shadowDraw = (void (*)(Actor *, Lights *, GlobalContext *))0x44000000;
    arg0[2].colChkInfo.displacement.y = 1.0f;
    temp_v0->unk_39C = 0;
    temp_v0->unk_398 = 0;
    temp_v0->unk_388 = 0.0f;
    temp_v0->unk_37C = 0;
    temp_v0->unk_378 = 0;
    temp_v0->unk_368 = 0.0f;
    temp_v0->unk_35C = 0;
    temp_v0->unk_358 = 0;
    temp_v0->unk_348 = 0.0f;
    temp_v0->unk_328 = 0.0f;
    temp_v0->unk_338 = 0;
    temp_v0->unk_33C = 0;
    temp_v0->unk_390 = 1.0f;
    temp_v0->unk_370 = 1.0f;
    temp_v0->unk_350 = 1.0f;
    temp_v0->unk_330 = 1.0f;
    arg0->unk_144 = func_808FB1C0;
...
void func_808FA4F4(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_s1->unk_A70 & 0x80) != 0) {
        ...
        arg0[1].colChkInfo.cylHeight = 0x9C4;
        arg0[1].shape.shadowScale = 0.0f;
        arg0[1].shape.shadowDraw = (void (*)(Actor *, Lights *, GlobalContext *))0x45000000;
        if ((arg0->unk_1E2 == 0) && (gSaveContext.playerForm == 4) && (phi_v1 = 1, (((s32) (gSaveContext.equips.equipment & gEquipMasks[1]) >> gEquipShifts[1]) == 1))) {
            sp34 = 1;
            arg0->unk_1E2 = func_8012ED78(arg1, 1);
        } else {
            phi_v1 = 0;
        }
...
void func_808FA6B8(Actor *arg0) {
    ...
    func_800BCB70(arg0, 0x4000, 0xFF, 0, (s16) (s32) arg0->unk_1EC);
    arg0->unk_1E6 = 0x14;
    arg0[1].colChkInfo.cylHeight = 0x9C4;
    arg0[2].colChkInfo.cylRadius = 0;
    arg0[2].colChkInfo.cylYShift = 0;
    ...
    arg0[1].shape.shadowScale = 0.0f;
    arg0->unk_204 = 0.0f;
    arg0[1].shape.shadowDraw = (bitwise void (*)(Actor *, Lights *, GlobalContext *)) 0.0f;
    arg0[2].colChkInfo.damageTable = (bitwise DamageTable *) 0.0f;
    arg0[2].colChkInfo.displacement.y = 1.0f;
    temp_v0->unk_39C = 0;
    temp_v0->unk_398 = 0;
    temp_v0->unk_37C = 0;
...
void func_808FA7AC(EnRr *arg0) {
    ...
    arg0->unk_330 = 0.8f;
    arg0->unk_328 = *D_808FC1F8;
    temp_v1 = arg0 + (1 << 5);
    temp_v1->unk_338 = 0x1388;
    temp_v1->unk_33C = 0;
    temp_v1->unk_330 = 0.8f;
    temp_v1->unk_328 = (f32) temp_a1->unk_0;
    temp_v1->unk_35C = 0;
    temp_v1->unk_358 = 0x1388;
    temp_v1->unk_350 = 0.8f;
    temp_v1->unk_348 = (f32) temp_a1->unk_4;
    temp_v1->unk_37C = 0;
    temp_v1->unk_378 = 0x1388;
    temp_v1->unk_370 = 0.8f;
    temp_v1->unk_368 = (f32) temp_a1->unk_8;
    temp_v1->unk_39C = 0;
    temp_v1->unk_398 = 0x1388;
    temp_v1->unk_390 = 0.8f;
    temp_v1->unk_388 = (f32) temp_a1->unk_C;
...
void func_808FA910(Actor *arg0) {
    ...
    temp_a0 = arg0;
    temp_a0[2].colChkInfo.cylRadius = 0;
    temp_a0[2].colChkInfo.cylYShift = 0;
    temp_v0 = temp_a0 + (1 << 5);
    temp_a0[1].shape.shadowScale = 0.0f;
    temp_a0[2].colChkInfo.damageTable = (bitwise DamageTable *) 0.0f;
    temp_v0->unk_39C = 0;
    temp_v0->unk_398 = 0;
    temp_v0->unk_37C = 0;
    temp_v0->unk_378 = 0;
...
void func_808FA9CC(Actor *arg0) {
    ...
    arg0->unk_1F2 = 0;
    arg0[1].colChkInfo.cylRadius = 0;
    arg0[1].colChkInfo.cylHeight = 0x9C4;
    arg0[1].colChkInfo.cylYShift = 0;
    arg0->unk_1FA = 0;
    arg0->unk_200 = 0.0f;
    arg0[1].shape.yOffset = 0.0f;
    arg0[2].colChkInfo.cylYShift = 0;
    arg0[2].colChkInfo.cylHeight = 0;
    arg0[2].colChkInfo.cylRadius = 0;
    temp_v1 = arg0 + (1 << 5);
    arg0->unk_204 = 0.15f;
    arg0[1].shape.shadowDraw = (void (*)(Actor *, Lights *, GlobalContext *))0x45000000;
    arg0[2].colChkInfo.displacement.x = 1.0f;
    arg0[2].colChkInfo.displacement.y = 1.0f;
    temp_v1->unk_39C = 0;
    temp_v1->unk_39A = 0;
    temp_v1->unk_398 = 0;
    ...
    temp_v1->unk_33C = 0;
    temp_v1->unk_390 = 1.0f;
    temp_v1->unk_38C = 1.0f;
    temp_v1->unk_370 = 1.0f;
    temp_v1->unk_36C = 1.0f;
    temp_v1->unk_350 = 1.0f;
    temp_v1->unk_34C = 1.0f;
    temp_v1->unk_32C = 1.0f;
    temp_v1->unk_330 = 1.0f;
    arg0->unk_144 = func_808FB710;
}
...
s32 func_808FAA94(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 != 0) || ((arg0->unk_1A5 & 2) != 0)) {
        ...
        arg0->unk_1A5 = (u8) (arg0->unk_1A5 & 0xFFFD);
        if ((arg0->unk_1E0 == 0xA) && ((*sp2C->unk_3C & 0xDB0B3) != 0)) {
            goto block_19;
        }
        ...
        if (Actor_ApplyDamage(arg0) == 0) {
            ...
            if (arg0->colChkInfo.damageEffect == 3) {
                ...
                arg0->unk_159 = (u8) (arg0->unk_159 & 0xFFFE);
                arg0->unk_1A5 = (u8) (arg0->unk_1A5 & 0xFFFE);
                func_808FA9CC(arg0);
                return 1;
            }
...
void func_808FAC80(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_a2->unk_1F0 == 0) && ((temp_v0 = temp_a2->unk_1A4, ((temp_v0 & 2) != 0)) || ((temp_a2->unk_158 & 2) != 0))) {
        temp_a2->unk_1A4 = (u8) (temp_v0 & 0xFFFD);
        temp_a2->unk_158 = (u8) (temp_a2->unk_158 & 0xFFFD);
        arg0 = temp_a2;
...
void func_808FAD1C(EnRr *arg0, GlobalContext *arg1) {
    ...
    phi_s1 = arg0 + 0x344;
    do {
        phi_s1->unk_14 = (s16) (s32) (Math_CosS((s16) (arg0->unk_1F8 * phi_s0_2)) * arg0->unk_208);
        temp_s0_2 = phi_s0_2 + 1;
        phi_s1->unk_18 = (s16) (s32) (Math_SinS((s16) (arg0->unk_1FA * phi_s0_2)) * arg0->unk_208);
        phi_s0_2 = temp_s0_2;
        phi_s1 += 0x20;
    } while (temp_s0_2 != 5);
}
...
void func_808FAE50(EnRr *arg0, GlobalContext *arg1) {
    ...
    if (func_808FB42C != arg0->actionFunc) {
        ...
        do {
            ...
            phi_s1->unk_10 = (f32) (Math_CosS((s16) (arg0->unk_1F2 + phi_s3)) * arg0->unk_200);
            phi_s3 = temp_s3;
            phi_s1 += 0x20;
        ...
        if (arg0->unk_1E1 == 0) {
            do {
                phi_s1_2->unk_14 = (s16) (s32) (Math_CosS((s16) (arg0->unk_1F2 + (phi_s0 * arg0->unk_1F8))) * arg0->unk_208);
                temp_s0 = phi_s0 + 1;
                phi_s1_2->unk_18 = (s16) (s32) (Math_SinS((s16) (arg0->unk_1F2 + (phi_s0 * arg0->unk_1FA))) * arg0->unk_208);
                phi_s0 = temp_s0;
                phi_s1_2 += 0x20;
            } while (temp_s0 != 5);
        }
...
void func_808FAF94(EnRr *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_1E6 == 0) && ((sp2C->unk_A70 & 0x80) == 0) && (Player_GetMask(globalCtx) != 0x10) && (this->actor.xzDistToPlayer < (8421.053f * this->actor.scale.x))) {
...
void func_808FB1C0(EnRr *this, GlobalContext *globalCtx) {
    ...
    Math_StepToF((f32 *) &temp_s1->world, this->unk_228, 30.0f);
    Math_StepToF(&temp_s1->world.pos.y, this->unk_22C + this->unk_218, 30.0f);
    Math_StepToF(&temp_s1->world.pos.z, this->unk_230, 30.0f);
    Math_StepToF(&this->unk_218, -(f32) this->unk_148.dim.height, 5.0f);
}
...
void func_808FB2C0(EnRr *this, GlobalContext *globalCtx) {
    ...
    temp_v0->unk_AE8 = 0;
    sp24 = temp_v0;
    Math_StepToF((f32 *) &temp_v0->world, this->unk_228, 30.0f);
    Math_StepToF(&temp_v0->world.pos.y, this->unk_22C + this->unk_218, 30.0f);
    Math_StepToF(&temp_v0->world.pos.z, this->unk_230, 30.0f);
    Math_StepToF(&this->unk_218, -(f32) this->unk_148.dim.height, 5.0f);
    if (this->unk_1E6 == 0) {
        this->unk_1E1 = 0;
...
void func_808FB398(void *arg0, ? arg1) {
    ...
    temp_v0_2 = arg0 + 0x20;
    temp_v0_2->unk_35C = phi_v1;
    temp_v0_2->unk_37C = phi_v1;
    temp_v0_2->unk_39C = phi_v1;
    temp_v0_2->unk_33C = phi_v1;
}
...
void func_808FB42C(EnRr *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 < 0x28) {
        ...
        phi_s0 = 0;
        do {
            Math_StepToF(phi_s2, (f32) (phi_s0 + 0x3B) - ((f32) this->unk_1E4 * 25.0f), 50.0f);
            temp_s0 = phi_s0 + 1;
            temp_f0 = (f32) (4 - phi_s0);
            phi_s1[3] = (temp_f0 * temp_f0 * (f32) this->unk_1E4 * 0.003f) + 1.0f;
            phi_s2 = &phi_s2[8];
            phi_s0 = temp_s0;
            phi_s1 += 0x20;
        } while (temp_s0 != 5);
    ...
    Math_StepToF((f32 *) &this->actor.scale, 0.0f, this->unk_214);
...
void func_808FB794(EnRr *arg0, GlobalContext *arg1) {
    ...
    if ((temp_f0 < (f32) arg0->unk_148.dim.height) && (temp_f0 > 1.0f) && (((u32) arg1->gameplayFrames % 9U) == 0)) {
...
void EnRr_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_1E6;
    if (temp_v0 != 0) {
        this->unk_1E6 = temp_v0 - 1;
    }
    temp_v0_2 = this->unk_1F0;
    if (temp_v0_2 != 0) {
        this->unk_1F0 = temp_v0_2 - 1;
    }
    Actor_SetHeight((Actor *) this, this->actor.scale.y * 2000.0f);
    ...
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 30.0f, (f32) this->unk_148.dim.radius, 0.0f, 0x5DU);
    func_808FB794(this, globalCtx);
    temp_v1 = this->unk_1FC;
    temp_s2 = &this->unk_148;
    if (((s32) temp_v1 > 0) && ((globalCtx->actorCtx.actorList[2].first->unk_A70 & 0x80) == 0)) {
        this->unk_1FC = temp_v1 - 1;
        if (this->unk_1FC == 0) {
            this->unk_148.base.ocFlags1 |= 8;
        }
    }
    ...
    if ((func_808FB42C != temp_v0_3) && (func_808FB398 != temp_v0_3)) {
        ...
        temp_s3 = &this->unk_194;
        CollisionCheck_SetAC(globalCtx, temp_s0, (Collider *) temp_s3);
        if ((this->unk_1F0 == 0) && (func_808FB088 == this->actionFunc) && (this->unk_1EE == 0)) {
            CollisionCheck_SetAT(globalCtx, temp_s0, (Collider *) temp_s2);
            CollisionCheck_SetAT(globalCtx, temp_s0, (Collider *) temp_s3);
            phi_s0 = temp_s0;
        } else {
            this->unk_194.base.atFlags &= 0xFFFD;
            this->unk_148.base.atFlags &= 0xFFFD;
            phi_s0 = temp_s0;
        }
    } else {
        this->unk_194.base.atFlags &= 0xFFFD;
        this->unk_148.base.atFlags &= 0xFFFD;
        this->unk_194.base.acFlags &= 0xFFFD;
        this->unk_148.base.acFlags &= 0xFFFD;
        phi_s0 = &globalCtx->colChkCtx;
    }
    CollisionCheck_SetOC(globalCtx, phi_s0, (Collider *) temp_s2);
    if (this->unk_1EE == 0) {
        Math_ScaledStepToS(&this->unk_1F4, this->unk_1F6, 0x32);
        ...
        phi_s2 = 0;
        do {
            Math_SmoothStepToS(phi_s5, phi_s1->unk_338, 5, (s16) (s32) (this->unk_210 * 1000.0f), (s16) 0);
            Math_SmoothStepToS(phi_s4, phi_s0_2->unk_18, 5, (s16) (s32) (this->unk_210 * 1000.0f), (s16) 0);
            Math_StepToF(phi_s3, phi_s0_2[3], this->unk_210 * 0.2f);
            Math_StepToF(phi_s0_2, phi_s0_2[1], this->unk_210 * 300.0f);
    ...
    if (this->unk_21C > 0.0f) {
        if (this->unk_1E0 != 0xA) {
            ...
            temp_f0 = (this->unk_21C + 1.0f) * 0.425f;
            this->unk_220 = temp_f0;
            if (temp_f0 > 0.85f) {
                this->unk_220 = 0.85f;
                return;
            }
            this->unk_220 = this->unk_220;
            return;
        }
        if (Math_StepToF(&this->unk_224, 0.85f, 0.02125f) == 0) {
...
void EnRr_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a3 = 0 & 0x3F;
    temp_v0_2->words.w1 = Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0 & 0x7F, temp_a3, 0x20, 0x10, 1, temp_a3, ((s32) this->unk_1E8 * -6) & 0x7F, 0x20, 0x10);
    SysMatrix_StatePush();
    temp_f12 = this->unk_32C * (1.0f + this->unk_334);
    ...
    do {
        temp_f20 = (phi_s1->unk_334 + 1.0f) * phi_s1->unk_32C;
        SysMatrix_InsertTranslation(0.0f, phi_s1->unk_324 + 1000.0f, 0.0f, 1);
        SysMatrix_InsertRotation(phi_s3[13], phi_s3[14], phi_s3[15], 1);
        SysMatrix_StatePush();
    ...
    SysMatrix_GetStateTranslation((Vec3f *) &this->unk_228);
    this->unk_194.dim.pos.x = (s16) (s32) (((this->unk_228 - spA4) * 0.85f) + spA4);
    this->unk_194.dim.pos.y = (s16) (s32) (((this->unk_22C - spA8) * 0.85f) + spA8);
    this->unk_194.dim.pos.z = (s16) (s32) (((this->unk_230 - spAC) * 0.85f) + spAC);
    temp_v0_4 = sp9C->polyOpa.p;
    sp9C->polyOpa.p = &temp_v0_4[1];
    temp_v0_4->words.w1 = (u32) &D_06000470;
    temp_v0_4->words.w0 = 0xDE000000;
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) sp80, 0x14, this->actor.scale.y * 66.66667f * this->unk_220, this->unk_224, this->unk_21C, (u8) (s32) this->unk_1E0);
}
