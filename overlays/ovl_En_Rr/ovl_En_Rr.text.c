...
void func_808FA3F8(Actor *arg0, Actor *arg1, Actor *); /* static */
...
typedef struct EnRr {
    ...
    /* 0x01FC */ s16 unk1FC;                        /* inferred */
    /* 0x01FE */ char pad1FE[0x2];                  /* maybe part of unk1FC[2]? */
    ...
    /* 0x0240 */ char pad240[0xD4];
    /* 0x0314 */ f32 unk314;                        /* inferred */
    /* 0x0318 */ char pad318[0xC];                  /* maybe part of unk314[4]? */
    ...
    /* 0x0340 */ char pad340[0x68];                 /* maybe part of unk33E[53]? */
    /* 0x03A8 */ f32 unk3A8;                        /* inferred */
    /* 0x03AC */ char pad3AC[0x4];                  /* maybe part of unk3A8[2]? */
    /* 0x03B0 */ f32 unk3B0;                        /* inferred */
    /* 0x03B4 */ char pad3B4[0x10];                 /* maybe part of unk3B0[5]? */
} EnRr;                                             /* size 0x3C4 */
...
void EnRr_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_808FC1D0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk148, &this->actor, &D_808FC150);
    temp_a1 = &this->unk194;
    sp24 = temp_a1;
    Collider_InitAndSetCylinder(globalCtx, temp_a1, &this->actor, &D_808FC17C);
...
void func_808FB1C0(EnRr *this, GlobalContext *globalCtx) {
    ...
    Math_StepToF(&temp_s1->world.pos.x, this->unk228, 30.0f);
...
void func_808FB42C(EnRr *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 >= 0x5F) {
        if (this->unk1E2 != 0) {
            Item_DropCollectible(globalCtx, &this->actor.world.pos, 0x16U);
        }
    ...
    Math_StepToF(&this->actor.scale.x, 0.0f, this->unk214);
...
void EnRr_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808FAA94(&this->actor, globalCtx) == 0) {
        func_808FAC80(&this->actor, globalCtx);
    }
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 30.0f, (f32) this->unk148.dim.radius, 0.0f, 0x5DU);
    ...
    Collider_UpdateCylinder(&this->actor, temp_s2);
    temp_v0_3 = this->actionFunc;
    if ((func_808FB42C != temp_v0_3) && (func_808FB398 != temp_v0_3)) {
        temp_s0 = &globalCtx->colChkCtx;
        CollisionCheck_SetAC(globalCtx, temp_s0, &temp_s2->base);
        temp_s3 = &this->unk194;
        CollisionCheck_SetAC(globalCtx, temp_s0, &temp_s3->base);
        if ((this->unk1F0 == 0) && (func_808FB088 == this->actionFunc) && (this->unk1EE == 0)) {
            CollisionCheck_SetAT(globalCtx, temp_s0, &temp_s2->base);
            CollisionCheck_SetAT(globalCtx, temp_s0, &temp_s3->base);
            phi_s0 = temp_s0;
        } else {
    ...
    CollisionCheck_SetOC(globalCtx, phi_s0, &temp_s2->base);
    if (this->unk1EE == 0) {
...
void EnRr_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if (phi_s2 == 3) {
            SysMatrix_GetStateTranslation(&spA4);
        }
        temp_s2 = phi_s2 + 1;
        phi_s1 += 0x20;
        phi_s3 += 0x20;
    ...
    this->unk194.dim.pos.x = (s16) (s32) (((this->unk228 - spA4.x) * 0.85f) + spA4.x);
    this->unk194.dim.pos.y = (s16) (s32) (((this->unk22C - spA4.y) * 0.85f) + spA4.y);
    this->unk194.dim.pos.z = (s16) (s32) (((this->unk230 - spA4.z) * 0.85f) + spA4.z);
    temp_v0_4 = sp9C->polyOpa.p;
    sp9C->polyOpa.p = temp_v0_4 + 8;
    temp_v0_4->words.w1 = (u32) &D_06000470;
    temp_v0_4->words.w0 = 0xDE000000;
    func_800BE680(globalCtx, &this->actor, (Vec3f []) sp80, 0x14, this->actor.scale.y * 66.66667f * this->unk220, this->unk224, this->unk21C, (u8) (s32) this->unk1E0);
}
