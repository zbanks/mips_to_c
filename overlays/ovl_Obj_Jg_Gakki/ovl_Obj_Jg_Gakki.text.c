...
void ObjJgGakki_Init(ObjJgGakki *this, GlobalContext *globalCtx) {
    f32 sp34;
    SkelAnime *sp30;
    SkelAnime *temp_a1;
    f32 temp_f0;
...
void ObjJgGakki_Destroy(ObjJgGakki *this, GlobalContext *globalCtx) {
    ObjJgGakki *this = (ObjJgGakki *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk188);
}

void ObjJgGakki_Update(ObjJgGakki *this, GlobalContext *globalCtx) {
    ObjJgGakki *this = (ObjJgGakki *) thisx;
    SkelAnime_FrameUpdateMatrix(&this->unk144);
}

void ObjJgGakki_Draw(ObjJgGakki *this, GlobalContext *globalCtx) {
    ObjJgGakki *this = (ObjJgGakki *) thisx;
