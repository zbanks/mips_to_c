typedef struct Boss04 {
    ...
    /* 0x18E */ char pad18E[0x30];                  /* maybe part of unk188[9]? */
    /* 0x1BE */ Vec3s unk1BE;                       /* inferred */
    /* 0x1C4 */ char pad1C4[0x30];                  /* maybe part of unk1BE[9]? */
    /* 0x1F4 */ s16 unk1F4;                         /* inferred */
    /* 0x1F6 */ s8 unk1F6;                          /* inferred */
    /* 0x1F7 */ u8 unk1F7;                          /* inferred */
    /* 0x1F8 */ s16 unk1F8;                         /* inferred */
    /* 0x1FA */ s16 unk1FA;                         /* inferred */
    /* 0x1FC */ char pad1FC[0x2];
    /* 0x1FE */ s16 unk1FE;                         /* inferred */
    /* 0x200 */ s16 unk200;                         /* inferred */
    /* 0x202 */ char pad202[0x2];
    /* 0x204 */ void (*actionFunc)(Boss04 *, GlobalContext *);
    /* 0x208 */ ColliderJntSph unk208;              /* inferred */
    /* 0x228 */ ColliderJntSphElement unk228;       /* inferred */
    /* 0x268 */ ColliderJntSph unk268;              /* inferred */
    /* 0x288 */ ColliderJntSphElement unk288;       /* inferred */
    /* 0x2C8 */ s16 unk2C8;                         /* inferred */
    /* 0x2CA */ char pad2CA[0x2];
    ...
    /* 0x2DC */ char pad2DC[0x4];                   /* maybe part of unk2DA[3]? */
    /* 0x2E0 */ s16 unk2E0;                         /* inferred */
    /* 0x2E2 */ s16 unk2E2;                         /* inferred */
    /* 0x2E4 */ char pad2E4[0x3D8];                 /* maybe part of unk2E2[493]? */
    /* 0x6BC */ f32 unk6BC;                         /* inferred */
    /* 0x6C0 */ char pad6C0[0x4];
    /* 0x6C4 */ f32 unk6C4;                         /* inferred */
    /* 0x6C8 */ Vec3f unk6C8;                       /* inferred */
    /* 0x6D4 */ f32 unk6D4;                         /* inferred */
    /* 0x6D8 */ f32 unk6D8;                         /* inferred */
    /* 0x6DC */ f32 unk6DC;                         /* inferred */
    /* 0x6E0 */ f32 unk6E0;                         /* inferred */
    /* 0x6E4 */ f32 unk6E4;                         /* inferred */
    /* 0x6E8 */ f32 unk6E8;                         /* inferred */
    /* 0x6EC */ char pad6EC[0x4];
    /* 0x6F0 */ f32 unk6F0;                         /* inferred */
    /* 0x6F4 */ s16 unk6F4;                         /* inferred */
    /* 0x6F6 */ s16 unk6F6;                         /* inferred */
    /* 0x6F8 */ f32 unk6F8;                         /* inferred */
    /* 0x6FC */ f32 unk6FC;                         /* inferred */
    /* 0x700 */ f32 unk700;                         /* inferred */
    /* 0x704 */ u32 unk704;                         /* inferred */
    /* 0x708 */ s16 unk708;                         /* inferred */
    /* 0x70A */ s16 unk70A;                         /* inferred */
    /* 0x70C */ Vec3f unk70C;                       /* inferred */
    /* 0x718 */ Vec3f unk718;                       /* inferred */
    /* 0x724 */ char pad724[0x4];
    /* 0x728 */ f32 unk728;                         /* inferred */
    /* 0x72C */ char pad72C[0x10];                  /* maybe part of unk728[5]? */
    /* 0x73C */ f32 unk73C;                         /* inferred */
    /* 0x740 */ char pad740[0x4];
    /* 0x744 */ f32 unk744;                         /* inferred */
    /* 0x748 */ s16 unk748;                         /* inferred */
    /* 0x74A */ u8 unk74A;                          /* inferred */
    /* 0x74B */ char pad74B[0x1];
} Boss04;                                           /* size = 0x74C */
...
void Boss04_Init(Boss04 *this, GlobalContext *globalCtx) {
    CollisionPoly *spC0;
    f32 spB4;
    f32 spB0;
    f32 spAC;
    ...
    this->unk6FC = 1.0f;
    this->unk6F8 = 1.0f;
    Collider_InitAndSetJntSph(globalCtx, &this->unk208, (Actor *) this, &D_809EE1B4, &this->unk228);
    Collider_InitAndSetJntSph(globalCtx, &this->unk268, (Actor *) this, &D_809EE1E8, &this->unk288);
    ...
    do {
        ...
        Actor_SpawnAsChild(temp_s5, (Actor *) this, globalCtx, 0x23E, this->unk6E8 + sp90, phi_f24, this->unk6F0 + sp98, (s16) 0, (s16) 0, (s16) 0, phi_s2);
        temp_s2_2 = phi_s2 + 1;
...
void Boss04_Destroy(Boss04 *this, GlobalContext *globalCtx) {
    Boss04 *this = (Boss04 *) thisx;
...
void func_809EC568(Boss04 *this, GlobalContext *globalCtx) {
    ...
    case 0:
        ...
        if ((sp74->unkA6C & 0x100000) && (this->actor.projectedPos.z > 0.0f) && (fabsf(this->actor.projectedPos.x) < 300.0f) && (fabsf(this->actor.projectedPos.y) < 300.0f)) {
            if (((u32) this->unk704 >= 0xFU) && (ActorCutscene_GetCurrentIndex() == -1)) {
                ...
                Math_Vec3f_Copy(&this->unk70C, (Vec3f *) &sp74->world);
                this->unk70C.y += 100.0f;
                Math_Vec3f_Copy(&this->unk718, (Vec3f *) &this->actor.world);
                func_8016566C(0x96);
                this->unk744 = 60.0f;
    ...
    case 13:
        ...
        case 12:
            ...
            Math_ApproachF((f32 *) &this->unk718, this->actor.world.pos.x, 0.5f, 1000.0f);
    ...
    if (this->unk70A != 0) {
        ...
        sp54 += Math_SinS((s16) (this->unk748 << 0xE)) * (f32) this->unk748 * 1.5f;
        Play_CameraSetAtEye(globalCtx, this->unk70A, (Vec3f *) &sp50, sp44);
...
void func_809ECD18(Boss04 *this, GlobalContext *globalCtx) {
    ...
    if (this->unk1F8 == 0) {
        ...
        if (Rand_ZeroOne() < 0.1f) {
            Math_Vec3f_Copy(&this->unk6C8, (Vec3f *) &sp24->world);
        } else {
...
void func_809ECF58(Boss04 *this, GlobalContext *globalCtx) {
    ...
    Math_ApproachS((s16 *) &this->actor.shape, (s16) (s32) (Math_SinS((s16) (this->unk1F4 * 0xFB8)) * 5000.0f), 5, 0x800);
...
void Boss04_Update(Boss04 *this, GlobalContext *globalCtx) {
    ...
    if (func_809ED2A0 != this->actionFunc) {
        ...
        if (this->unk2CC > 3000.0f) {
            sp30 = temp_a1;
            CollisionCheck_SetAC(globalCtx, temp_a1, (Collider *) &this->unk208);
            this->actor.flags |= 1;
        } else {
            this->actor.flags &= -2;
...
void Boss04_Draw(Boss04 *this, GlobalContext *globalCtx) {
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    Gfx *temp_v0_4;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_809EDCCC, func_809EDECC, (Actor *) this);
