...
void func_80C08B7C(ObjKzsaku *arg0, GlobalContext *arg1); /* static */
void func_80C08BBC(ObjKzsaku *arg0);                /* static */
void func_80C08BD0(Actor *arg0, GlobalContext *arg1); /* static */
void func_80C08C84(ObjKzsaku *arg0);                /* static */
void func_80C08CB0(ObjKzsaku *arg0, GlobalContext *arg1); /* static */
extern ? D_06000040;
...
typedef struct ObjKzsaku {
    ...
    /* 0x015C */ void (*actionFunc)(ObjKzsaku *, GlobalContext *);
