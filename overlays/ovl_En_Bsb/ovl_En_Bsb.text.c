...
void func_80C0B31C(GlobalContext *arg0, Actor *arg1, PosRot *arg2); /* static */
...
static ColliderJntSphElementInit D_80C0F8D4 = {
    {
...
typedef struct EnBsb {
    ...
    /* 0x0288 */ Path *unk288;                      /* inferred */
    /* 0x028C */ s32 unk28C;                        /* inferred */
    /* 0x0290 */ u8 unk290;                         /* inferred */
    /* 0x0291 */ char pad291[0x1];                  /* maybe part of unk290[2]? */
    /* 0x0292 */ s16 unk292;                        /* inferred */
    /* 0x0294 */ s16 unk294;                        /* inferred */
    /* 0x0296 */ char pad296[0x2];                  /* maybe part of unk294[2]? */
    /* 0x0298 */ f32 unk298;                        /* inferred */
    /* 0x029C */ char pad29C[0x4];                  /* maybe part of unk298[2]? */
    /* 0x02A0 */ f32 unk2A0;                        /* inferred */
    /* 0x02A4 */ s32 unk2A4;                        /* inferred */
    /* 0x02A8 */ s32 unk2A8;                        /* inferred */
    /* 0x02AC */ s16 unk2AC;                        /* inferred */
    /* 0x02AE */ s8 unk2AE;                         /* inferred */
    /* 0x02AF */ u8 unk2AF;                         /* inferred */
    ...
    /* 0x02C8 */ char pad2C8[0x2];
    /* 0x02CA */ s16 unk2CA;                        /* inferred */
    /* 0x02CC */ s16 unk2CC;                        /* inferred */
    /* 0x02CE */ s16 unk2CE;                        /* inferred */
    /* 0x02D0 */ char pad2D0[0x2];                  /* maybe part of unk2CE[2]? */
    /* 0x02D2 */ s16 unk2D2;                        /* inferred */
    /* 0x02D4 */ char pad2D4[0x4];                  /* maybe part of unk2D2[3]? */
    /* 0x02D8 */ s32 unk2D8;                        /* inferred */
    /* 0x02DC */ s32 unk2DC;                        /* inferred */
    /* 0x02E0 */ f32 unk2E0;                        /* inferred */
    /* 0x02E4 */ f32 unk2E4;                        /* inferred */
    /* 0x02E8 */ f32 unk2E8;                        /* inferred */
    /* 0x02EC */ void unk2EC;                       /* inferred */
    /* 0x02ED */ char pad2ED[0x3];
    /* 0x02F0 */ f32 unk2F0;                        /* inferred */
    /* 0x02F4 */ char pad2F4[0x4];                  /* maybe part of unk2F0[2]? */
    /* 0x02F8 */ PosRot unk2F8;                     /* inferred */
    /* 0x0304 */ PosRot unk304;                     /* overlap; inferred */
    /* 0x0318 */ char pad318[0x2];
    ...
    /* 0x033C */ char pad33C[0xC0];                 /* maybe part of unk330[17]? */
    /* 0x03FC */ s32 unk3FC;                        /* inferred */
    /* 0x0400 */ char pad400[0xB34];                /* maybe part of unk3FC[718]? */
    /* 0x0F34 */ ColliderJntSph unkF34;             /* inferred */
    /* 0x0F54 */ ColliderJntSphElement unkF54;      /* inferred */
    /* 0x0F94 */ char padF94[0x184];
    /* 0x1118 */ u16 unk1118;                       /* inferred */
    /* 0x111A */ s16 unk111A;                       /* inferred */
    /* 0x111C */ s16 unk111C;                       /* inferred */
    /* 0x111E */ char pad111E[0x2];                 /* maybe part of unk111C[2]? */
    /* 0x1120 */ f32 unk1120;                       /* inferred */
    /* 0x1124 */ f32 unk1124;                       /* inferred */
    /* 0x1128 */ f32 unk1128;                       /* inferred */
    /* 0x112C */ f32 unk112C;                       /* inferred */
    /* 0x1130 */ f32 unk1130;                       /* inferred */
    /* 0x1134 */ f32 unk1134;                       /* inferred */
    /* 0x1138 */ f32 unk1138;                       /* inferred */
    /* 0x113C */ f32 unk113C;                       /* inferred */
    /* 0x1140 */ f32 unk1140;                       /* inferred */
    /* 0x1144 */ f32 unk1144;                       /* inferred */
    /* 0x1148 */ f32 unk1148;                       /* inferred */
    /* 0x114C */ f32 unk114C;                       /* inferred */
    /* 0x1150 */ f32 unk1150;                       /* inferred */
    /* 0x1154 */ f32 unk1154;                       /* inferred */
} EnBsb;                                            /* size 0x1158 */
...
void func_80C0B31C(GlobalContext *arg0, Actor *arg1, PosRot *arg2) {
    f32 spD4;
    f32 spD0;
    f32 spCC;
    f32 spC4;
    ...
    temp_s5 = &sp9C;
    spA8.x = D_80C0FAA0.unk0;
    spA8.y = D_80C0FAA0.unk4;
    spA8.z = D_80C0FAA0.unk8;
    temp_s5->unk0 = D_80C0FAAC.unk0;
    temp_s5->unk4 = (s32) D_80C0FAAC.unk4;
    temp_s5->unk8 = (s32) D_80C0FAAC.unk8;
    temp_f12 = (Rand_ZeroOne() - 0.5f) * 12.56f;
    spD0 = arg1->floorHeight;
    spCC = (sin_rad(temp_f12) * 5.0f) + arg2->pos.x;
    spD4 = (cos_rad(temp_f12) * 5.0f) + arg2->pos.z;
    sp9C = randPlusMinusPoint5Scaled(1.0f) * 0.5f;
    spA4 = randPlusMinusPoint5Scaled(1.0f) * 0.5f;
    spAC += (Rand_ZeroOne() - 0.5f) * 15.0f;
    temp_s1 = &spCC;
    EffectSsHahen_Spawn(arg0, (Vec3f *) temp_s1, &spA8, (Vec3f *) temp_s5, (s16) 0, (s16) (s32) ((Rand_ZeroOne() * 5.0f) + 10.0f), (s16) -1, (s16) 0xA, NULL);
...
void EnBsb_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->actor.params & 0x8000) != 0) {
        SkelAnime_Init(globalCtx, &this->unk144, &D_0600C3E0, &D_06004894, &this->unk188, &this->unk206, 0x15);
    ...
    SkelAnime_Init(globalCtx, &this->unk144, &D_0600C3E0, &D_060086BC, &this->unk188, &this->unk206, 0x15);
    temp_v0 = this->actor.params;
    this->unk2B6 = ((s32) temp_v0 >> 7) & 0x1F;
    this->unk2B8 = temp_v0 & 0x7F;
    this->unk2BA = this->actor.world.rot.z & 0x7F;
    this->actor.colChkInfo.health = 0x18;
    this->actor.hintId = 0x21;
    this->actor.gravity = -2.0f;
    Collider_InitAndSetJntSph(globalCtx, &this->unkF34, &this->actor, &D_80C0F9D0, &this->unkF54);
    if (this->unk2B6 == 0x1F) {
...
void EnBsb_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk2B0 == 0) {
        func_801A2ED8();
        Collider_DestroyJntSph(globalCtx, &this->unkF34);
    }
    temp_a0 = this->unk2D2;
...
s32 func_80C0B888(EnBsb *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk2DC == 0) {
        temp_v0 = arg0->actor.yawTowardsPlayer - arg0->unk2BC;
        phi_v1 = temp_v0 << 0x10;
        if ((s32) temp_v0 < 0) {
            phi_v1 = (s32) temp_v0 * -0x10000;
        }
        phi_v0 = 0;
        if (((phi_v1 >> 0x10) < (s32) (s16) (gGameInfo->data[2401] + 0x4000)) && (fabsf(arg0->actor.world.pos.y - arg1->actorCtx.actorList[2].first->unk28) < 20.0f) && (arg0->actor.xzDistToPlayer < 200.0f)) {
            arg0->unk2DC = 1;
            func_801A2E54(0x38);
            return 1;
        }
...
void func_80C0B970(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((func_801378B8(temp_a0, 8.0f) != 0) || (func_801378B8(temp_a0, 14.0f) != 0)) {
        ...
        if (func_801378B8(sp20, 8.0f) != 0) {
            func_80C0B31C(arg1, arg0, arg0 + 0x304);
            return;
        }
        func_80C0B31C(arg1, arg0, arg0 + 0x2F8);
...
s32 func_80C0BC30(EnBsb *arg0) {
    ...
    if ((temp_f0 < -2180.0f) && (temp_f0 > -2470.0f) && (fabsf(arg0->actor.world.pos.y - arg0->actor.home.pos.y) < 30.0f)) {
        sp38.unk0 = (s32) D_80C0FAB8.unk0;
        sp38.unk4 = (u16) D_80C0FAB8.unk4;
        sp30.unk0 = (s32) D_80C0FAC0.unk0;
        sp30.unk4 = (u16) D_80C0FAC0.unk4;
...
void func_80C0BE1C(EnBsb *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk111A != 0) {
        sp34 = temp_a0;
        Math_ApproachF(temp_a0, arg0->unk1140, 0.5f, 30.0f);
        Math_ApproachF(arg0 + 0x112C, arg0->unk1144, 0.5f, 30.0f);
        Math_ApproachF(arg0 + 0x1130, arg0->unk1148, 0.5f, 30.0f);
        temp_a0_2 = arg0 + 0x1134;
        sp30 = temp_a0_2;
        Math_ApproachF(temp_a0_2, arg0->unk114C, 0.5f, 30.0f);
        Math_ApproachF(arg0 + 0x1138, arg0->unk1150, 0.5f, 30.0f);
        Math_ApproachF(arg0 + 0x113C, arg0->unk1154, 0.5f, 30.0f);
        Math_ApproachF(arg0 + 0x1120, arg0->unk1124, 0.5f, 10.0f);
        Play_CameraSetAtEye(arg1, arg0->unk111A, (Vec3f *) sp30, (Vec3f *) sp34);
        func_80169940(arg1, arg0->unk111A, arg0->unk1120);
...
void func_80C0BF2C(EnBsb *arg0) {
    ...
    arg0->unkF34.elements->unk2E = 0x6E;
    arg0->unkF34.elements->dim.modelSphere.center.x = 0x12C;
    arg0->unkF34.elements->dim.modelSphere.center.y = 0x190;
    arg0->unkF34.base.colType = 0xC;
    temp_v1 = 3 << 6;
    arg0->unkF34.elements->info.elemType = 2;
    arg0->unkF34.elements->unk54 = 2U;
    arg0->unkF34.elements->unk94 = 2U;
    (arg0->unkF34.elements + temp_v1)->unk14 = 2U;
    (arg0->unkF34.elements + temp_v1)->unk54 = 2U;
    (arg0->unkF34.elements + temp_v1)->unk94 = 2U;
    (arg0->unkF34.elements + temp_v1)->unkD4 = 2U;
...
void func_80C0BFE8(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (((phi_v1 >> 0x10) < 0x4300) && !(this->actor.xzDistToPlayer > 300.0f)) {
        ...
        if ((globalCtx->msgCtx.unk1202A == 3) && (globalCtx->msgCtx.unk1202E == 0)) {
            ...
            this = this;
            func_800BC154(globalCtx, &globalCtx->actorCtx, &this->actor, 9U);
...
void func_80C0C0F4(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk2A4 = 0;
    arg0->unkF50->unk2E = 0x28;
    arg0->unkF50->unk28 = 0x3E8;
    arg0->unkF50->unk2A = 0x190;
    arg0->unkF48 = 0xA;
    temp_v0 = 3 << 6;
    arg0->unkF50->unk14 = 0;
    arg0->unkF50->unk54 = 0;
    arg0->unkF50->unk94 = 0;
    (arg0->unkF50 + temp_v0)->unk14 = 0;
    (arg0->unkF50 + temp_v0)->unk54 = 0;
    (arg0->unkF50 + temp_v0)->unk94 = 0;
    (arg0->unkF50 + temp_v0)->unkD4 = 0;
    arg0->unk2AE = 0;
    Audio_PlayActorSound2(arg0, 0x3869U);
    func_80C0B290(arg0, 0);
    if (ActorCutscene_GetCanPlayNext(arg0->unk2CC) == 0) {
        ActorCutscene_SetIntentToPlay(arg0->unk2CC);
        arg0->unk2B4 = 1;
        arg0->unk284 = func_80C0C238;
        return;
    }
    ActorCutscene_StartAndSetUnkLinkFields(arg0->unk2CC, arg0);
    arg0->flags &= 0xF7FFFFFF;
    Actor_SetSwitchFlag(arg1, (s32) arg0->unk2B8);
    arg0->unk2A4 = 1;
    arg0->unk2B4 = (s16) 1;
    arg0->unk284 = func_80C0C238;
}
...
void func_80C0C238(EnBsb *this, GlobalContext *globalCtx) {
    ...
    phi_v1 = temp_v1;
    if (temp_v1 == 0) {
        if (ActorCutscene_GetCanPlayNext(this->unk2CC) == 0) {
            ActorCutscene_SetIntentToPlay(this->unk2CC);
            return;
        }
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2CC, &this->actor);
        this->actor.flags &= 0xF7FFFFFF;
        Actor_SetSwitchFlag(globalCtx, (s32) this->unk2B8);
        this->unk2A4 = 1;
        phi_v1 = 1;
        goto block_4;
    }
block_4:
    if (phi_v1 == 1) {
        if ((globalCtx->gameplayFrames & 1) == 0) {
            func_80C0B31C(globalCtx, &this->actor, &this->actor.world);
        }
        Math_ApproachF(&this->actor.shape.shadowScale, 25.0f, 1.0f, 2.5f);
        if (this->unk2C4 <= this->unk144.animCurrentFrame) {
            func_80C0C32C(this);
        }
    }
}
...
void func_80C0C364(EnBsb *this, GlobalContext *globalCtx) {
    ...
    this->unk288 = func_8013D648(globalCtx, this->unk2B6, 0x1F);
    func_80C0BC30(this);
    temp_a0 = this->unk288;
    if (temp_a0 != 0) {
        sp2A = func_8013D83C(temp_a0, this->unk28C, &this->actor.world, &sp2C);
    }
    ...
    sp24 = phi_v1;
    func_80C0B970(&this->actor, globalCtx);
    if (phi_v1 < 0x1000) {
        this->unk2BC = this->actor.world.rot.y;
        func_80C0C430(this);
    }
}
...
void func_80C0C484(EnBsb *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = this->unk288;
    if (temp_a0 != 0) {
        phi_a1 = func_8013D83C(temp_a0, this->unk28C, &this->actor.world, &sp34);
    }
    sp32 = phi_a1;
    ...
    func_80C0B970(&this->actor, globalCtx);
    if (sp34 < 25.0f) {
        temp_a0_3 = this->unk288;
        if (temp_a0_3 != 0) {
            temp_t5 = this->unk28C + 1;
            this->unk28C = temp_t5;
            if (temp_t5 >= (s32) temp_a0_3->count) {
                this->unk28C = temp_t5 - 1;
                func_80C0DA58(this);
            }
        }
    }
...
void func_80C0C6A8(EnBsb *this, GlobalContext *globalCtx) {
    ...
    sp34 = this->unk144.animCurrentFrame;
    func_80C0B888(this, globalCtx);
    temp_v1 = this->unk2DC;
    if (((temp_v1 == 0) || ((temp_v1 != 0) && (this->unk2D8 == 2) && (this->unk2C4 <= sp34) && (this->unk294 == 0))) && ((temp_v0 = this->unk324, (temp_v0 == 0xB)) || (temp_v0 == 0xA)) && (this->unk322 != 0)) {
        func_800BF7CC(globalCtx, &this->actor, (Vec3f []) &this->unk330, 0x11, 2, this->unk32C, 0.4f);
        this->unk322 = 0;
        this->unk324 = 0;
    }
    temp_v0_2 = this->unk2D8;
    if ((temp_v0_2 == 2) && (this->unk2C4 <= sp34) && (this->unk294 == 0)) {
        if (this->unk2DC == 0) {
            func_80C0B290(&this->actor, 3);
            return;
        }
        func_80C0C86C(this);
        return;
    ...
    if (temp_v0_2 == 3) {
        ...
        if ((func_801378B8(temp_a0, 7.0f) != 0) || (func_801378B8(temp_a0, 15.0f) != 0)) {
            Audio_PlayActorSound2(&this->actor, 0x3AA3U);
        }
        if (this->unk2C4 <= sp34) {
            temp_t3 = this->unk2A4 + 1;
            this->unk2A4 = temp_t3;
            if (temp_t3 >= 2) {
                func_80C0C430(this);
            }
...
void func_80C0C86C(Actor *arg0) {
    ...
    arg0->unk294 = Rand_S16Offset(0, 0x1E);
    gSaveContext.weekEventReg[85] |= 0x40;
    arg0->unk2B4 = 4;
    arg0->unk284 = func_80C0C8EC;
}
...
void func_80C0C8EC(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk294 == 0) && (fabsf(sp2C->world.pos.y - this->actor.world.pos.y) >= 100.0f) && (this->actor.xzDistToPlayer < 500.0f)) {
        func_80C0CA28(this, globalCtx);
        return;
    }
    func_80C0BA58(&this->actor, globalCtx);
    if ((this->unk294 == 0) && (Actor_IsActorFacingLink(&this->actor, 0x11C7) != 0) && (fabsf(this->actor.world.pos.y - sp2C->world.pos.y) < 20.0f) && (this->actor.xzDistToPlayer < 180.0f)) {
        func_80C0CD90(this);
    }
}
...
void func_80C0CA28(Actor *arg0, GlobalContext *arg1) {
    ...
    func_800BBDAC(arg1, arg0, arg0 + 0x304, 5.0f, 0xA, 8.0f, (s16) 0x3E8, (s16) 0x64, (u8) 1);
    func_800BBDAC(arg1, arg0, arg0 + 0x2F8, 5.0f, 0xA, 8.0f, (s16) 0x3E8, (s16) 0x64, (u8) 1);
    Audio_PlayActorSound2(arg0, 0x386CU);
    arg0->flags |= 0x8000000;
    arg0->unk2B4 = 5;
    arg0->unk284 = func_80C0CB3C;
}
...
void func_80C0CB3C(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.velocity.y > 0.0f) {
        sp3C = temp_v0;
        Math_ApproachF(&this->actor.world.pos.x, temp_v0->world.pos.x, 0.5f, 30.0f);
    ...
    if (this->unk2D8 != 0x16) {
        sp3C = temp_v0;
        func_80C0B290(&this->actor, 0x16, (bitwise Actor *) 0.5f, 30.0f);
    }
    if ((fabsf(globalCtx->actorCtx.actorList[2].first->world.pos.y - this->actor.world.pos.y) < 40.0f) && (this->actor.xzDistToPlayer < 70.0f) && (globalCtx->actorCtx.actorList[2].first->unkD5C == 0)) {
        func_800B8D50(globalCtx, &this->actor, 2.0f, this->actor.yawTowardsPlayer, 5.0f, 0x10U);
    }
    if ((this->actor.bgCheckFlags & 1) != 0) {
        func_800BBDAC(globalCtx, &this->actor, &this->actor.world.pos, this->actor.shape.shadowScale, 0xA, 8.0f, (s16) 0x7D0, (s16) 0x64, (u8) 1);
        func_800BC848(&this->actor, globalCtx, 0xA, 0xA);
...
void func_80C0CD04(EnBsb *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk2D8;
    if ((temp_v0 == 0x18) && (this->unk2C4 <= this->unk144.animCurrentFrame)) {
        this->unk294 = 0xA;
        this->actor.flags &= 0xF7FFFFFF;
        this->actor.gravity = -2.0f;
        func_80C0C86C();
...
void func_80C0CDE4(EnBsb *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = globalCtx->actorCtx.actorList[2].first;
    temp_a2 = &sp34;
    temp_f6 = (f32) this->unkF34.elements->unk4E;
    sp34 = temp_f6;
    temp_f10 = (f32) this->unkF34.elements->unk50;
    sp38 = temp_f10;
    temp_f4 = (f32) this->unkF34.elements->unk52;
    sp3C = temp_f4;
    temp_f2 = temp_f6 - temp_v0->world.pos.x;
    temp_t0 = this->unkF34.base.atFlags;
    temp_f12 = temp_f10 - temp_v0->world.pos.y;
    temp_f14 = temp_f4 - temp_v0->world.pos.z;
    if (((temp_t0 & 4) != 0) || ((temp_v0->unkA6C & 0x400000) && (sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12) + (temp_f14 * temp_f14)) <= 70.0f) && (temp_v1 = (temp_v0->shape.rot.y - this->actor.shape.rot.y) + 0x8000, (((s32) temp_v1 < 0x2000) != 0)) && ((s32) temp_v1 >= -0x1FFF))) {
        this->unkF34.base.atFlags = temp_t0 & 0xFFF9;
        this = this;
        EffectSsHitMark_SpawnFixedScale(globalCtx, 3, (Vec3f *) temp_a2);
        Audio_PlayActorSound2(&this->actor, 0x1806U);
        func_80C0CF4C(this);
        return;
    }
    if (this->unk2C4 <= this->unk144.animCurrentFrame) {
...
void func_80C0CF4C(Actor *arg0) {
    arg0->speedXZ = 0.0f;
    arg0->unk2A4 = 0;
    SkelAnime_ChangeAnim(arg0 + 0x144, &D_06000C50, -1.0f, arg0->unk15C - 1.0f, 0.0f, (u8) 2, 0.0f);
    arg0->unk294 = 0xA;
    Audio_PlayActorSound2(arg0, 0x3AA3U);
    arg0->unk2B4 = 7;
    arg0->unk284 = func_80C0CFDC;
}
...
void func_80C0D00C(Actor *arg0) {
    ...
    if (arg0->world.pos.z < -1300.0f) {
        ...
        SysMatrix_GetStateTranslationAndScaledZ(-30.0f, &sp24);
    } else {
        Matrix_RotateY(arg0->yawTowardsPlayer, 0U);
        SysMatrix_GetStateTranslationAndScaledZ(-50.0f, &sp24);
        sp24.z = 0.0f;
    }
    Math_Vec3f_Copy(arg0 + 0x298, &sp24);
    Audio_PlayActorSound2(arg0, 0x3AA5U);
    func_80C0B290(arg0, 7);
    arg0->unk2AE = 1;
    arg0->unk2B4 = 8;
    arg0->unk284 = func_80C0D10C;
}
...
void func_80C0D10C(EnBsb *this, GlobalContext *globalCtx) {
    ...
    sp34 = this->unk144.animCurrentFrame;
    temp_v0 = this->unk324;
    if (((temp_v0 == 0xB) || (temp_v0 == 0xA)) && (this->unk322 != 0)) {
        func_800BF7CC(globalCtx, &this->actor, (Vec3f []) &this->unk330, 0x11, 2, this->unk32C, 0.4f);
        this->unk322 = 0;
        this->unk324 = 0;
    }
    func_80C0B31C(globalCtx, &this->actor, &this->unk304);
    func_80C0B31C(globalCtx, &this->actor, &this->unk2F8);
    if (this->unk2C4 <= sp34) {
...
void func_80C0D27C(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (((this->unk324 == 0xB) || (this->unk324 == 0xA)) && (this->unk322 != 0)) {
        func_800BF7CC(globalCtx, &this->actor, (Vec3f []) &this->unk330, 0x11, 2, this->unk32C, 0.4f);
        this->unk322 = 0;
        this->unk324 = 0;
    }
...
void func_80C0D3C0(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_f20 = (Math_SinS(arg0->yawTowardsPlayer) * 300.0f) + arg0->unk2E0;
    arg0->unk1140 = temp_f20;
    arg0->unk1128 = temp_f20;
    temp_f20_2 = arg0->unk2E4 - 30.0f;
    arg0->unk1144 = temp_f20_2;
    arg0->unk112C = temp_f20_2;
    temp_f20_3 = (Math_CosS(arg0->yawTowardsPlayer) * 300.0f) + arg0->unk2E8;
    arg0->unk1148 = temp_f20_3;
    arg0->unk1130 = temp_f20_3;
    temp_f20_4 = (Math_SinS(arg0->yawTowardsPlayer) * 10.0f) + arg0->unk2E0;
    arg0->unk114C = temp_f20_4;
    arg0->unk1134 = temp_f20_4;
    temp_f20_5 = arg0->unk2E4 - 10.0f;
    arg0->unk1150 = temp_f20_5;
    arg0->unk1138 = temp_f20_5;
    temp_f6 = Math_CosS(arg0->yawTowardsPlayer) * 10.0f;
    arg0->unk1124 = 60.0f;
    temp_f20_6 = temp_f6 + arg0->unk2E8;
    arg0->unk1154 = temp_f20_6;
    arg0->unk113C = temp_f20_6;
    func_80C0B290(arg0, 2);
    arg0->unk2B4 = 9;
    arg0->unk284 = func_80C0D51C;
...
void func_80C0D51C(EnBsb *this, GlobalContext *globalCtx) {
    ...
    sp4C = this->unk144.animCurrentFrame;
    temp_v0 = this->unk324;
    if (((temp_v0 == 0xB) || (temp_v0 == 0xA)) && (this->unk322 != 0)) {
        func_800BF7CC(globalCtx, &this->actor, (Vec3f []) &this->unk330, 0x11, 2, this->unk32C, 0.4f);
        this->unk322 = 0;
    ...
    if (this->unk2A4 == 0) {
        if (ActorCutscene_GetCanPlayNext(this->unk2CE) == 0) {
            ActorCutscene_SetIntentToPlay(this->unk2CE);
            return;
        }
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2CE, &this->actor);
        func_800B7298(globalCtx, &this->actor, 0x51U);
        this->unk111A = ActorCutscene_GetCurrentCamera((s16) this->actor.cutscene);
        this->unk2A4 = 1;
        goto block_8;
    }
block_8:
    if (this->unk2A8 == 2) {
        ...
        this->unk1140 = this->unk2E0 + sp44;
        this->unk1144 = this->unk2E4 + 30.0f;
        this->unk1148 = this->unk2E8 + (temp_f0 * 380.0f);
        temp_f18 = (Math_SinS(this->actor.world.rot.y) * 10.0f) + this->unk2E0;
        this->unk1150 = this->unk2E4 - 63.0f;
        this->unk114C = temp_f18;
        this->unk1154 = (Math_CosS(this->actor.world.rot.y) * 10.0f) + this->unk2E8;
    } else {
        temp_f8 = Math_SinS(this->actor.world.rot.y) * 10.0f;
        this->unk1150 = this->unk2E4 - 10.0f;
        this->unk114C = temp_f8 + this->unk2E0;
        this->unk1154 = (Math_CosS(this->actor.world.rot.y) * 10.0f) + this->unk2E8;
    }
    if (this->unk2A8 == 0) {
        this->actor.world.rot.y += this->unk2AC;
        Math_SmoothStepToS(&this->unk2AC, 0x1000, 1, 0x1F4, (s16) 0);
    ...
    if ((this->unk2A8 != 0) && (phi_v0_2 < 0x100) && (this->actor.world.pos.y < (this->actor.floorHeight + 30.0f))) {
        temp_v0_2 = this->unk2D8;
        this->unk2A8 = 2;
        if (temp_v0_2 < 9) {
            sp3C = globalCtx->actorCtx.actorList[2].first;
            func_80C0B290(&this->actor, 9);
            func_800B7298(globalCtx, &this->actor, 4U);
            sp3C->velocity.y = 5.0f;
            func_800BBDAC(globalCtx, &this->actor, &this->actor.world.pos, this->actor.shape.shadowScale - 20.0f, 0x14, 8.0f, (s16) 0x3E8, (s16) 0x64, (u8) 1);
            Audio_PlayActorSound2(&this->actor, 0x387BU);
            func_800BC848(&this->actor, globalCtx, 4, 0xA);
        } else if ((temp_v0_2 == 9) && (this->unk2C4 <= sp4C)) {
            func_80C0B290(&this->actor, 0xA);
            func_800B7298(globalCtx, &this->actor, 0x51U);
        }
    }
    func_80C0BE1C(this, globalCtx);
    if ((this->unk2A4 != 0) && (this->unk2A8 != 0) && (this->unk2D8 == 0xA) && (this->unk2C4 <= sp4C)) {
...
void func_80C0DA58(EnBsb *arg0) {
    ...
    arg0->unk1144 = 375.0f;
    arg0->unk112C = 375.0f;
    arg0->unk1148 = -1630.0f;
    arg0->unk1130 = -1630.0f;
    arg0->unk114C = -360.0f;
    arg0->unk1134 = -360.0f;
    arg0->unk1124 = 60.0f;
    arg0->unk1118 = arg0->unk111C;
    arg0->unk1118 = 0;
    arg0->unk1138 = 500.0f;
    arg0->unk1150 = 500.0f;
    arg0->unk1154 = -2250.0f;
    arg0->unk113C = -2250.0f;
    gSaveContext.weekEventReg[85] |= 0x40;
    arg0->unk2B4 = 0xD;
...
void func_80C0DB18(EnBsb *this, GlobalContext *globalCtx) {
    ...
    sp64.x = D_80C0FAC8.unk0;
    sp64.y = D_80C0FAC8.unk4;
    sp64.z = D_80C0FAC8.unk8;
    sp60 = this->unk144.animCurrentFrame;
    if (this->unk2A4 == 0) {
        if (ActorCutscene_GetCanPlayNext(this->unk2D2) == 0) {
            ActorCutscene_SetIntentToPlay(this->unk2D2);
            return;
        }
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2D2, &this->actor);
        func_80C0B290(&this->actor, 1);
...
block_4:
    ...
    this->unk112C = 375.0f;
    this->unk1144 = 375.0f;
    this->unk1130 = -1630.0f;
    this->unk1148 = -1630.0f;
    this->unk1134 = -360.0f;
    this->unk114C = -360.0f;
    this->unk1138 = 500.0f;
    this->unk1150 = 500.0f;
    this->unk1154 = -2250.0f;
    this->unk113C = -2250.0f;
    func_80C0BE1C((bitwise EnBsb *) -1630.0f, (bitwise GlobalContext *) -360.0f, this, globalCtx);
    temp_t3 = this->unk1118;
    switch (temp_t3) {
    case 0:
        temp_a0 = &this->actor.world;
        sp3C = temp_a0;
        Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&temp_a0->pos, &sp64), 1, 0x7D0, (s16) 0);
        Math_ApproachF(&temp_a0->pos.x, sp64.x, 0.5f, fabsf(Math_SinS(this->actor.world.rot.y) * 3.2f));
        Math_ApproachF(&this->actor.world.pos.z, sp64.z, 0.5f, fabsf(Math_CosS(this->actor.world.rot.y) * 3.2f));
        temp_f2 = this->actor.world.pos.x - sp64.x;
        temp_f12 = this->actor.world.pos.z - sp64.z;
        if ((sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12)) < 3.0f) && (temp_a0_2 = this->unk288, temp_a1 = temp_a0_2->count - 1, this->unk28C = temp_a1, (func_8013D68C(temp_a0_2, (s16) temp_a1, &this->unk2EC) != 0))) {
            this->unk2F0 = this->actor.world.pos.y;
            func_80C0B290(&this->actor, 3);
            this->unk1118 = (s16) this->unk1118 + 1;
            return;
        }
    default:
        return;
    case 1:
        ...
        Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&this->actor.world.pos, (Vec3f *) &this->unk2EC), 1, 0x7D0, (s16) 0);
        if ((this->unk2C4 <= sp60) && (this->unk111C += 1, (((s32) this->unk111C < 3) == 0))) {
            func_80C0B290(&this->actor, 1);
            this->unk111C = 0;
            this->unk1118 = (s16) this->unk1118 + 1;
            return;
        ...
        return;
    case 2:
        temp_v0 = Math_Vec3f_Yaw(&this->actor.world.pos, (Vec3f *) &this->unk1128);
        ...
        if (phi_v0 < 0x100) {
            Audio_PlayActorSound2(&this->actor, 0x3AA4U);
            func_80C0B290(&this->actor, 0x15);
            this->unk1118 = (s16) this->unk1118 + 1;
            func_801518B0(globalCtx, 0x1541U, &this->actor);
            return;
        }
        // Duplicate return node #34. Try simplifying control flow for better match
        return;
    ...
    case 4:
        temp_a1_3 = &sp64;
        sp64.x = -100.0f;
        temp_v0_2 = Math_Vec3f_Yaw(&this->actor.world.pos, temp_a1_3);
    ...
    case 5:
        if (this->actor.world.pos.y < (this->actor.home.pos.y + 30.0f)) {
            ...
            Audio_PlayActorSound2(&this->actor, 0x380DU);
            func_800BC848(&this->actor, globalCtx, 4, 0xA);
            this->unk1118 = (s16) this->unk1118 + 1;
            return;
        }
    ...
    case 6:
        ...
        if ((globalCtx->gameplayFrames & 7) == 0) {
            ...
            sp64.x += randPlusMinusPoint5Scaled(40.0f);
            sp64.z += randPlusMinusPoint5Scaled(40.0f);
            sp44 = Rand_ZeroFloat(10.0f);
            func_800BBDAC(globalCtx, &this->actor, &sp64, sp44 + 5.0f, Rand_S16Offset(1, 3), 4.0f, (s16) 0x3E8, (s16) 0x64, (u8) 1);
        }
        Math_ApproachF(&this->actor.shape.yOffset, -7000.0f, 0.5f, 200.0f);
        if (this->actor.shape.yOffset < -6999.0f) {
            ActorCutscene_Stop(this->unk2D2);
            Actor_MarkForDeath(&this->actor);
        }
        // Duplicate return node #34. Try simplifying control flow for better match
        return;
...
void func_80C0E1C0(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2D8 == 0x10) {
        sp50 = temp_f0;
        if (func_801378B8(&this->unk144, 30.0f) != 0) {
            Audio_PlayActorSound2(&this->actor, 0x3AA1U);
        } else if ((temp_f0 < 30.0f) && ((temp_v0 = globalCtx->csCtx.frames, (temp_v0 == 0x1D8)) || (temp_v0 == 0x1E7))) {
            Audio_PlayActorSound2(&this->actor, 0x3AA2U);
        }
    }
    if ((this->unk2D8 == 0x12) && (globalCtx->csCtx.frames == 0x381)) {
        Audio_PlayActorSound2(&this->actor, 0x3AA1U);
    }
    if (this->unk2A4 == 0) {
        phi_s0 = 0;
        if ((gSaveContext.weekEventReg[23] & 4) != 0) {
            D_80C0F8D0 = this->unk144.animCurrentFrame;
            phi_s1 = this;
            do {
                temp_v0_2 = Actor_Spawn(&globalCtx->actorCtx, globalCtx, 0x28F, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) (s32) this->actor.shape.rot.x, (s16) (s32) this->actor.shape.rot.y, (s16) (s32) this->actor.shape.rot.z, (s16) (phi_s1->unk3FC + 0x8000));
                if (temp_v0_2 != 0) {
                    temp_v0_2->unk2C0 = (f32) (this + (phi_s0 * 0xC))->unk334;
                }
                temp_s0 = phi_s0 + 1;
                phi_s1 += 4;
                phi_s0 = temp_s0;
...
void func_80C0E3B8(EnBsb *arg0) {
    ...
    temp_a0 = arg0 + 0x144;
    sp30 = temp_a0;
    SkelAnime_ChangeAnim(temp_a0, &D_06004894, 1.0f, D_80C0F8D0, (f32) SkelAnime_GetFrameCount(&D_06004894.common), (u8) 2, 0.0f);
...
void func_80C0E480(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0 != 0.0f) {
        ...
        if (temp_f0 <= temp_f2) {
            this->unk2C0 = temp_f2 - 40.0f;
        }
        this->unk294 = 2;
        this->unk2CA = 0xFF;
        this->actionFunc = func_80C0E4FC;
        this->unk2C0 = this->actor.home.pos.y + (temp_f2 - this->unk2C0);
    }
}
...
void func_80C0E4FC(EnBsb *this, GlobalContext *globalCtx) {
    ...
    this->unk31E += 0x320;
    this->unk320 += 0x320;
    if ((this->actor.gravity != 0.0f) && (this->actor.world.pos.y <= this->unk2C0)) {
        Actor_MarkForDeath(&this->actor);
    }
}
...
void func_80C0E618(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s0 = 0;
    phi_s0_2 = 0;
    if ((temp_v0 != 0) && (temp_v0 != 1) && (temp_v0 != 9) && (temp_v0 != 0xC) && (temp_v0 != 0xD) && (temp_v0 != 5) && ((temp_v0 != 8) || (arg0->unk2DC == 0))) {
        if ((arg0->unkF44 & 4) == 0) {
            temp_v1 = arg0->unkF50;
            temp_a0 = temp_v1->unk55;
            if ((temp_a0 & 2) != 0) {
                temp_v1->unk55 = (u8) (temp_a0 & 0xFFFD);
        ...
        if ((arg0->unkF45 & 2) != 0) {
            ...
            case 2:
                ...
                break;
            case 3:
                temp_v0_3 = arg0->unk324;
                if (((temp_v0_3 != 0xB) && (temp_v0_3 != 0xA)) || (arg0->unk322 == 0)) {
                    arg0->unk322 = 0x50;
                    arg0->unk324 = 0xB;
                    arg0->unk328 = 0.0f;
                    arg0->unk32C = 1.5f;
        ...
        if (phi_s0 == 1) {
            ...
            do {
                temp_v0_4 = arg0->unkF50 + phi_s0_2;
                if ((temp_v0_4->unk16 & 2) != 0) {
                    temp_a2 = &sp48;
                    sp48 = (f32) temp_v0_4->unkE;
                    sp4C = (f32) (arg0->unkF50 + phi_s0_2)->unk10;
                    sp50 = (f32) (arg0->unkF50 + phi_s0_2)->unk12;
...
s32 func_80C0E9CC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x214U) != 0) {
        ...
        temp_t8 = temp_v0 * 4;
        sp24 = temp_v0;
        if (arg0->unk296 != *(arg1 + temp_t8)->unk1F4C) {
            if (arg0->unk2B4 != 0xE) {
                func_80C0E178(arg0);
            }
            ...
            case 5:
                ...
                break;
            case 6:
                Actor_SetSwitchFlag(arg1, (s32) arg0->unk2BA);
                Audio_PlayActorSound2(arg0, 0x4823U);
                break;
            }
        }
        arg0->unk296 = (s16) arg1->csCtx.npcActions[sp24]->unk0;
...
void EnBsb_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk292;
    if (temp_v0 != 0) {
        this->unk292 = temp_v0 - 1;
    }
    temp_v0_2 = this->unk294;
    if (temp_v0_2 != 0) {
        this->unk294 = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk322;
    if (temp_v0_3 != 0) {
        this->unk322 = temp_v0_3 - 1;
    }
    temp_v1 = this->unk2B4;
    if ((temp_v1 != 0) && (temp_v1 != 0xA) && ((gSaveContext.weekEventReg[23] & 4) == 0) && (this->unk2B0 == 0)) {
        SkelAnime_FrameUpdateMatrix(&this->unk144);
    }
    this->actionFunc(this, globalCtx);
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    if (this->unk2B0 == 0) {
        func_80C0E618(&this->actor, globalCtx);
        if ((func_80C0E9CC(this, globalCtx) == 0) && (this->unk2B4 != 0xE)) {
            temp_a0 = this->actor.world.rot.y;
            this->actor.shape.rot.y = temp_a0;
            temp_f6 = Math_SinS(temp_a0) * 20.0f;
            this->actor.focus.pos.y = this->unk2E4;
            this->actor.focus.pos.x = temp_f6 + this->unk2E0;
            this->actor.focus.pos.z = (Math_CosS(this->actor.world.rot.y) * 20.0f) + this->unk2E8;
            Math_Vec3s_Copy(&this->actor.focus.rot, &this->actor.world.rot);
            if ((this->actor.bgCheckFlags & 1) != 0) {
                temp_f0 = this->actor.world.pos.z;
                if (temp_f0 < -1300.0f) {
                    this->actor.world.pos.z = temp_f0 + this->unk2A0;
                }
                this->actor.world.pos.x += this->unk298;
                Math_ApproachZeroF(&this->unk298, 1.0f, 2.0f);
                Math_ApproachZeroF(&this->unk2A0, 1.0f, 2.0f);
            }
        } else {
            temp_f0_2 = this->unk144.animCurrentFrame;
            if ((this->unk2D8 == 0xE) && (this->unk2C4 <= temp_f0_2)) {
                sp34 = temp_f0_2;
                func_80C0B290(&this->actor, 0xF);
            }
            phi_v0 = this->unk2D8;
            if ((this->unk2D8 == 0x10) && (this->unk2C4 <= this->unk144.animCurrentFrame)) {
                sp34 = this->unk144.animCurrentFrame;
                func_80C0B290(&this->actor, 0x11);
                phi_v0 = this->unk2D8;
            }
            if ((phi_v0 == 0x12) && (this->unk2C4 <= this->unk144.animCurrentFrame)) {
                func_80C0B290(&this->actor, 0x13);
            }
        }
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 30.0f, 60.0f, 40.0f, 0x1DU);
        func_80C0F640(this, globalCtx);
        if (func_80C0E9CC(this, globalCtx) == 0) {
            temp_v1_2 = this->unk2B4;
            if ((temp_v1_2 != 9) && (temp_v1_2 != 0xE) && (temp_v1_2 != 0xF) && ((temp_a1 = &globalCtx->colChkCtx, temp_a2 = &this->unkF34, sp2C = temp_a2, sp30 = temp_a1, CollisionCheck_SetAC(globalCtx, temp_a1, &temp_a2->base), CollisionCheck_SetOC(globalCtx, temp_a1, &temp_a2->base), temp_v1_3 = this->unk2B4, (temp_v1_3 == 6)) || (temp_v1_3 == 4))) {
        ...
        if (arg1 == 0xB) {
            if (arg5->unk2B4 == 0) {
                *arg2 = NULL;
                ...
                temp_a0->unk4 = (s32) ((arg5->unk2CA & 0xFF) | ~0xFF);
            }
        } else {
...
void func_80C0F170(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg4->unk2B0 == 0) {
        ...
        if ((phi_a2_2 == 2) || (phi_a2_2 == 3) || (phi_a2_2 == 4) || (phi_a2_2 == 5) || (phi_a2_2 == 6) || (phi_a2_2 == 7) || (phi_a2_2 == 8) || (phi_a2_2 == 9) || (phi_a2_2 == 0xA) || (phi_a2_2 == 0xC) || (phi_a2_2 == 0xD) || (phi_a2_2 == 0xF) || (phi_a2_2 == 0x10) || (phi_a2_2 == 0x11) || (phi_a2_2 == 0x12) || (phi_a2_2 == 0x13) || (phi_a2_2 == 0x14)) {
            arg1 = phi_a2_2;
            SysMatrix_GetStateTranslation(phi_a3_2 + (phi_a3_2->unk440 * 0xC) + 0x330);
            (arg4 + (arg4->unk440 * 4))->unk3FC = arg1;
            arg4->unk440 = (s16) (arg4->unk440 + 1);
            phi_a2_3 = arg1;
            phi_a3_3 = arg4;
            if ((s32) arg4->unk440 >= 0x11) {
                arg4->unk440 = 0;
            }
        }
    }
...
void EnBsb_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk2CA == 0xFF) {
        ...
        temp_v1_2->words.w1 = (this->unk2CA & 0xFF) | ~0xFF;
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80C0EEA0, func_80C0F170, &this->actor);
        temp_v1_3 = this->unk322;
        if (temp_v1_3 != 0) {
            ...
            if ((temp_v0 == 0xB) || (temp_v0 == 0xA)) {
                ...
                sp3C = temp_f6 * 0.05f;
                Math_ApproachF(&this->unk32C, this->unk328, 0.1f, 0.04f);
            } else {
                this->unk328 = 0.8f;
                this->unk32C = 0.8f;
            }
            func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk330, 0x11, this->unk328, this->unk32C, temp_f6 * 0.05f, (u8) (s32) this->unk324);
            return;
        }
    ...
    temp_v0_3->words.w1 = (this->unk2CA & 0xFF) | ~0xFF;
    temp_v0_4 = temp_s1->polyXlu.p;
    temp_s1->polyXlu.p = temp_v0_4 + 8;
    temp_s1->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80C0F078, NULL, &this->actor, temp_v0_4);
}
...
void func_80C0F640(EnBsb *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        phi_v1 = temp_v1;
        if (phi_v0->unk0 != 0) {
            temp_f0 = phi_v0->unk14;
            phi_v0->unk4 = (f32) (phi_v0->unk4 + phi_v0->unk10);
            temp_a0 = phi_v0->unk34;
            phi_v0->unk28 = (s16) (phi_v0->unk28 + 0x100);
            phi_v0->unk2C = (s16) (phi_v0->unk2C + 0x130);
            phi_v0->unk8 = (f32) (phi_v0->unk8 + temp_f0);
            phi_v0->unkC = (f32) (phi_v0->unkC + phi_v0->unk18);
            phi_v0->unk14 = (f32) (temp_f0 + phi_v0->unk20);
            if (temp_a0 != 0) {
                phi_v0->unk34 = (s16) (temp_a0 - 1);
            } else {
                phi_v0->unk0 = 0U;
            }
        }
