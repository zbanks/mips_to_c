typedef struct EnBsb {
    ...
    /* 0x02F0 */ f32 unk2F0;                        /* overlap; inferred */
    /* 0x02F4 */ char pad2F4[0x4];
    /* 0x02F8 */ PosRot unk2F8;                     /* inferred */
    /* 0x0304 */ PosRot unk304;                     /* overlap; inferred */
    /* 0x0318 */ char pad318[0x4];
...
struct _mips2c_stack_func_80C0DB18 {
    ...
    /* 0x40 */ char pad40[0x4];
    /* 0x44 */ f32 sp44;                            /* inferred */
    /* 0x48 */ char pad48[0xA];                     /* maybe part of sp44[3]? */
    /* 0x52 */ s16 sp52;                            /* inferred */
    /* 0x54 */ char pad54[0xC];                     /* maybe part of sp52[7]? */
...
void func_80C0B31C(GlobalContext *arg0, Actor *arg1, PosRot *arg2) {
    ...
    temp_s5 = &sp9C;
    spA8.unk0 = (s32) D_80C0FAA0.unk0;
    spA8.unk4 = (s32) D_80C0FAA0.unk4;
    spA8.unk8 = (s32) D_80C0FAA0.unk8;
...
void EnBsb_Init(EnBsb *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    s16 temp_v0_2;
    s8 temp_s0;
    s16 phi_s0;
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unkF34, (Actor *) this, &D_80C0F9D0, &this->unkF54);
    if (this->unk2B6 == 0x1F) {
...
void EnBsb_Destroy(EnBsb *this, GlobalContext *globalCtx) {
    s16 temp_a0;
    EnBsb *this = (EnBsb *) thisx;
...
void func_80C0C238(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 == 0) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2CC, (Actor *) this);
...
block_4:
    if (phi_v1 == 1) {
        if ((globalCtx->gameplayFrames & 1) == 0) {
            func_80C0B31C(globalCtx, (Actor *) this, &this->actor.world);
        }
...
void func_80C0C6A8(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (((temp_v1 == 0) || ((temp_v1 != 0) && (this->unk2D8 == 2) && (this->unk2C4 <= sp34) && (this->unk294 == 0))) && ((temp_v0 = this->unk324, (temp_v0 == 0xB)) || (temp_v0 == 0xA)) && (this->unk322 != 0)) {
        func_800BF7CC(globalCtx, (Actor *) this, (Vec3f []) &this->unk330, 0x11, 2, this->unk32C, 0.4f);
        this->unk322 = 0;
        this->unk324 = 0;
    }
...
void func_80C0C8EC(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk294 == 0) && (Actor_IsActorFacingLink((Actor *) this, 0x11C7) != 0) && (fabsf(this->actor.world.pos.y - sp2C->world.pos.y) < 20.0f) && (this->actor.xzDistToPlayer < 180.0f)) {
        func_80C0CD90(this);
    }
}
...
void func_80C0D10C(EnBsb *this, GlobalContext *globalCtx) {
    ...
    func_80C0B31C(globalCtx, (Actor *) this, &this->unk304);
    func_80C0B31C(globalCtx, (Actor *) this, &this->unk2F8);
    if (this->unk2C4 <= sp34) {
...
void func_80C0D51C(EnBsb *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2A4 == 0) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2CE, (Actor *) this);
...
void func_80C0DB18(EnBsb *this, GlobalContext *globalCtx) {
    ...
    sp64.unk0 = D_80C0FAC8.unk0;
    sp64.unk4 = (s32) D_80C0FAC8.unk4;
    sp64.unk8 = (s32) D_80C0FAC8.unk8;
    ...
    if (this->unk2A4 == 0) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2D2, (Actor *) this);
...
block_4:
    ...
    case 0:
        ...
        if ((sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12)) < 3.0f) && (temp_a0_2 = this->unk288, temp_a1 = temp_a0_2->count - 1, this->unk28C = temp_a1, (func_8013D68C(temp_a0_2, (s16) temp_a1, (void *) &this->unk2EC) != 0))) {
    ...
    case 1:
        ...
        Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw((Vec3f *) &this->actor.world, &this->unk2EC), 1, 0x7D0, (s16) 0);
        ...
        return;
    case 2:
        temp_v0 = Math_Vec3f_Yaw((Vec3f *) &this->actor.world, (Vec3f *) &this->unk1128);
...
void EnBsb_Update(EnBsb *this, GlobalContext *globalCtx) {
    f32 sp34;
    ...
    if (this->unk2B0 == 0) {
        ...
        if (func_80C0E9CC(this, globalCtx) == 0) {
            ...
            if ((temp_v1_2 != 9) && (temp_v1_2 != 0xE) && (temp_v1_2 != 0xF) && ((temp_a1 = &globalCtx->colChkCtx, temp_a2 = &this->unkF34, sp2C = temp_a2, sp30 = temp_a1, CollisionCheck_SetAC(globalCtx, temp_a1, (Collider *) temp_a2), CollisionCheck_SetOC(globalCtx, temp_a1, (Collider *) temp_a2), temp_v1_3 = this->unk2B4, (temp_v1_3 == 6)) || (temp_v1_3 == 4))) {
...
void EnBsb_Draw(EnBsb *this, GlobalContext *globalCtx) {
    f32 sp3C;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    Gfx *temp_v0_4;
    ...
    if (this->unk2CA == 0xFF) {
        ...
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80C0EEA0, func_80C0F170, (Actor *) this);
        ...
        if (temp_v1_3 != 0) {
            ...
            func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk330, 0x11, this->unk328, this->unk32C, temp_f6 * 0.05f, (u8) (s32) this->unk324);
            return;
        }
    ...
    temp_s1->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80C0F078, NULL, (Actor *) this, temp_v0_4);
}
