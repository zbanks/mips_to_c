...
void EnBu_Init(EnBu *this, GlobalContext *globalCtx) {
    EnBu *this = (EnBu *) thisx;
    this->actionFunc = EnBu_DoNothing;
}

void EnBu_Destroy(EnBu *this, GlobalContext *globalCtx) {
    EnBu *this = (EnBu *) thisx;
...
void EnBu_Update(EnBu *this, GlobalContext *globalCtx) {
    EnBu *this = (EnBu *) thisx;
    Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
    this->actionFunc(this, globalCtx);
}

void EnBu_Draw(EnBu *this, GlobalContext *globalCtx) {
    Gfx *sp20;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
