typedef struct EnAn {
    ...
    /* 0x1DC */ char pad1DC[0x24];
    /* 0x200 */ u8 unk200;                          /* inferred */
    /* 0x201 */ char pad201[0x3];                   /* maybe part of unk200[4]? */
    /* 0x204 */ s32 *unk204;                        /* inferred */
    /* 0x208 */ char pad208[0x8];                   /* maybe part of unk204[3]? */
    /* 0x210 */ s32 unk210;                         /* inferred */
    /* 0x214 */ char pad214[0x4];
    /* 0x218 */ Actor *unk218;                      /* inferred */
    /* 0x21C */ char pad21C[0x48];                  /* maybe part of unk218[19]? */
    /* 0x264 */ Vec3s unk264;                       /* inferred */
    /* 0x26A */ char pad26A[0x78];                  /* maybe part of unk264[21]? */
    /* 0x2E2 */ Vec3s unk2E2;                       /* inferred */
    /* 0x2E8 */ char pad2E8[0x78];                  /* maybe part of unk2E2[21]? */
    /* 0x360 */ u16 unk360;                         /* inferred */
    /* 0x362 */ char pad362[0x12];                  /* maybe part of unk360[10]? */
    /* 0x374 */ f32 unk374;                         /* inferred */
    /* 0x378 */ char pad378[0xC];                   /* maybe part of unk374[4]? */
    /* 0x384 */ s16 unk384;                         /* inferred */
    /* 0x386 */ char pad386[0x2];
    /* 0x388 */ s16 unk388;                         /* inferred */
    /* 0x38A */ char pad38A[0xE];                   /* maybe part of unk388[8]? */
    /* 0x398 */ void *unk398;                       /* inferred */
    /* 0x39C */ s32 unk39C;                         /* inferred */
    /* 0x3A0 */ char pad3A0[0x20];                  /* maybe part of unk39C[9]? */
    /* 0x3C0 */ s32 unk3C0;                         /* inferred */
    /* 0x3C4 */ char pad3C4[0x4];
} EnAn;                                             /* size = 0x3C8 */
...
struct _mips2c_stack_func_80B55914 {
    ...
    /* 0x1C */ char pad1C[0x6];                     /* maybe part of sp18[2]? */
...
struct _mips2c_stack_func_80B56418 {
    /* 0x00 */ char pad0[0x20];
    /* 0x20 */ s32 sp20;                            /* inferred */
    /* 0x24 */ char pad24[0x7];                     /* maybe part of sp20[2]? */
    /* 0x2B */ u8 sp2B;                             /* inferred */
    /* 0x2C */ char pad2C[0x2];                     /* maybe part of sp2B[3]? */
...
void func_80B553AC(void *arg0) {
    ...
    Math_Vec3f_Copy((Vec3f *) &sp40, arg0->unk218 + 0x24);
    Math_Vec3f_Copy((Vec3f *) &sp34, arg0 + 0x24);
    Math_ApproachS(arg0 + 0x37E, (s16) (Math_Vec3f_Yaw((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unkBE), 4, 0x2AA8);
    temp_v0 = arg0->unk37E;
...
s32 func_80B55D98(Actor *arg0, GlobalContext *arg1, u8 *arg2, u8 arg3, s16 arg4) {
    ...
    if ((phi_v1 != 0) && (phi_v1->update != 0)) {
        ...
        if (temp_v0_2 != 0) {
            ...
            sp48 = temp_v0_3;
            Math_Vec3s_ToVec3f((Vec3f *) &sp3C, ((arg0->unk1DC->count * 6) + temp_v0_3) - 0xC);
            Math_Vec3s_ToVec3f((Vec3f *) &sp30, ((arg0->unk1DC->count * 6) + sp48) - 6);
...
s32 func_80B56880(Actor *arg0, GlobalContext *arg1, u8 *arg2) {
    ...
    if ((temp_v0 != 0) && ((s32) temp_v0->count >= 2)) {
        temp_v0_2 = Lib_SegmentedToVirtual((void *) temp_v0->points);
        sp30 = temp_v0_2;
        Math_Vec3s_ToVec3f((Vec3f *) &sp40, ((arg0->unk1DC->count * 6) + temp_v0_2) - 6);
        Math_Vec3s_ToVec3f((Vec3f *) &sp34, ((arg0->unk1DC->count * 6) + sp30) - 0xC);
...
? func_80B5702C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp50 = 0;
    sp54 = 0;
    func_8013AF00((void *) &sp7C, 3, arg0->unk1DC->count + 3);
    temp_v1 = arg0 + 0x1E0;
    phi_v1 = temp_v1;
    if ((arg0->unk360 & 8) == 0) {
        temp_v0 = arg0 + 0x1F8;
        ...
        sp48 = temp_a1;
        sp40 = temp_v0;
        func_8013B6B0(arg0->unk1DC, temp_a1, temp_a2, arg0->unk1F4, arg0->unk1F0, temp_v0, (void *) &sp7C, (Vec3f *) &sp58, (s16) (s32) arg0->unk384);
        func_8013B878(arg1, arg0->unk1DC, arg0->unk1F8, (Vec3f *) &sp58);
        arg0->unk360 = (u16) (arg0->unk360 | 8);
        arg0->world.pos.y = sp5C;
        phi_v1 = arg0 + 0x1E0;
    } else {
        sp58.unk0 = temp_v1->x;
        sp58.unk4 = (f32) temp_v1->y;
        sp58.unk8 = (f32) temp_v1->z;
        sp40 = arg0 + 0x1F8;
        sp44 = arg0 + 0x1FC;
        sp48 = arg0 + 0x1EC;
    }
    ...
    sp3C = phi_v1;
    if (func_8013B6B0(arg0->unk1DC, sp48, sp44, arg0->unk1F4, arg0->unk1F0, sp40, (void *) &sp7C, phi_v1, (s16) (s32) arg0->unk384) != 0) {
        ...
        sp64.unk0 = (f32) phi_v1->x;
        sp64.unk4 = (f32) phi_v1->y;
        sp64.unk8 = (f32) phi_v1->z;
        sp3C = phi_v1;
...
void func_80B577F0(EnAn *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk190, (Actor *) this, &D_80B58BBC);
...
void func_80B57A44(EnAn *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, this->unk204, this->unk398, &this->unk210) != 0) {
...
void EnAn_Init(EnAn *this, GlobalContext *globalCtx) {
    s32 sp1C;
    s32 temp_v0;
    s32 temp_v1;
    s32 temp_v1_2;
...
void EnAn_Destroy(EnAn *this, GlobalContext *globalCtx) {
    EnAn *this = (EnAn *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk190);
}

void EnAn_Update(EnAn *this, GlobalContext *globalCtx) {
    EnAn *this = (EnAn *) thisx;
    if (func_80B53840(this, globalCtx) == 0) {
        ...
        if (this->unk200 != 0) {
            ...
            func_80B53F84(this);
            func_80B554E8(this);
            func_8013C964((Actor *) this, globalCtx, this->unk374, 30.0f, 0, (s16) (this->unk360 & 7));
