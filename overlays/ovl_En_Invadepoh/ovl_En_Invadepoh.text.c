...
void EnInvadepoh_SetSysMatrix(Vec3f *arg0);         /* static */
...
void func_80B45BB8(void *arg0);                     /* static */
void func_80B45C04(Actor *arg0, ? *arg1, s32 arg2, ? *arg3, s32 arg4, Vec3s *arg5, s16 arg6, f32 arg7, f32 arg8, f32 arg9); /* static */
void func_80B45CE0(void *arg0);                     /* static */
...
static f32 D_80B4E938 = {-20.0f, 1395.0f};
static s32 D_80B4E940 = 0;
static void *D_80B4E944 = {
    (void *)0x600FFC8,
    (void *)0x60107C8,
    (void *)0x6010FC8,
    (void *)0x60117C8,
...
static void *D_80B4E958 = {(void *)0x60127C8, (void *)0x6012BC8, (void *)0x6012FC8, (void *)0x60133C8};
static s8 D_80B4E968 = 0;
static void *D_80B4E96C = {
    (void *)0x6011AD8,
    (void *)0x60122D8,
    (void *)0x6012AD8,
    (void *)0x60132D8,
...
static void *D_80B4E984 = {(void *)0x6014AD8, (void *)0x6014ED8, (void *)0x60152D8, (void *)0x60156D8};
...
static InitChainEntry D_80B4EC24;                   /* unable to generate initializer */
static InitChainEntry D_80B4EC34;                   /* unable to generate initializer */
static InitChainEntry D_80B4EC44;                   /* unable to generate initializer */
static InitChainEntry D_80B4EC54;                   /* unable to generate initializer */
static InitChainEntry D_80B4EC68;                   /* unable to generate initializer */
static InitChainEntry D_80B4EC80;                   /* unable to generate initializer */
static InitChainEntry D_80B4EC98;                   /* unable to generate initializer */
static ? D_80B4ECB0;                                /* unable to generate initializer */
static ? D_80B4ECE8;                                /* unable to generate initializer */
static s16 D_80B4ED20 = {0x82, 0x7D, 0x73, 0x64, 0x50, 0x4E, 0x4C, 0x4A};
...
loop_2:
        temp_a0 = &sp70;
        sp70 = (f32) (phi_s0->unk0 - phi_s1->unk0);
        sp74 = (f32) (phi_s0->unk2 - phi_s1->unk2);
        sp78 = (f32) (phi_s0->unk4 - phi_s1->unk4);
        temp_f14 = phi_f20 + Math3D_Vec3fMagnitude((Vec3f *) temp_a0);
        temp_f12 = temp_f14 * temp_f22;
        if (arg0->unk320 <= temp_f12) {
            temp_f6 = temp_f12 - phi_f24;
            *arg1 = phi_s2;
            temp_f0 = (arg0->unk320 - phi_f24) / temp_f6;
            arg2->unk0 = (f32) ((temp_f0 * sp70) + (f32) phi_s1->unk0);
            arg2->unk4 = (f32) ((temp_f0 * sp74) + (f32) phi_s1->unk2);
            arg2->unk8 = (f32) ((temp_f0 * sp78) + (f32) phi_s1->unk4);
            return;
        }
        temp_s2 = phi_s2 + 1;
        phi_s0 += 6;
...
block_5:
    *arg1 = temp_s5;
    temp_v0 = temp_s5 * 6;
    arg2->unk0 = (f32) *(arg0->unk30C + temp_v0);
    arg2->unk4 = (f32) (arg0->unk30C + temp_v0)->unk2;
    arg2->unk8 = (f32) (arg0->unk30C + temp_v0)->unk4;
}
...
void func_80B43DD4(EnInvadepoh *arg0, s16 arg1, s16 arg2) {
    ...
    if (arg0->endPoint != temp_v0) {
        arg0 = arg0;
        Math_Vec3s_ToVec3f(&sp30, temp_a1);
        Math_Vec3s_ToVec3f(&sp24, sp40 + 6);
        Math_ScaledStepToS(arg0 + 0xBE, (s16) (Math_Vec3f_Yaw(&sp30, &sp24) + arg2), arg1);
    }
}
...
void func_80B43E6C(EnInvadepoh *arg0, s16 arg1, s16 arg2, s16 arg3) {
    ...
    sp48 = temp_t9;
    if (arg0->endPoint != temp_v0) {
        Math_Vec3s_ToVec3f(&sp38, temp_t9);
        Math_Vec3s_ToVec3f(&sp2C, sp48 + 6);
        Math_SmoothStepToS(arg0 + 0xBE, Math_Vec3f_Yaw(&sp38, &sp2C), arg1, arg2, (s16) (s32) arg3);
    }
}
...
void func_80B43F0C(Actor *arg0) {
    ...
    Math_Vec3s_ToVec3f(&sp1C, sp38 + 6);
    arg0->shape.rot.y = Math_Vec3f_Yaw(&sp28, &sp1C);
}
...
f32 EnInvadepoh_GetTotalPathDistance(Actor *arg0) {
    ...
    if (temp_s4 >= 2) {
        do {
            ...
            Math_Vec3s_ToVec3f(&sp48, phi_s0);
            temp_s1 = phi_s1 + 1;
...
void func_80B44024(Actor *arg0, void *arg1) {
    ...
    temp_v0 = arg1->unk18864 + ((((s32) arg0->params >> 8) & 0x7F) * 8);
    arg0->unk308 = (s8) (temp_v0->unk0 - 1);
    temp_a0 = temp_v0->unk4;
    arg0 = arg0;
    arg0->unk30C = Lib_SegmentedToVirtual(temp_a0);
}

void EnInvadepoh_SetPathPointToWorldPos(Actor *arg0, s8 arg1) {
    Math_Vec3s_ToVec3f(arg0 + 0x24, arg0->unk30C + (arg1 * 6));
}
...
s32 func_80B440B8(Actor *arg0, f32 arg1, f32 arg2) {
    ...
    temp_v0 = arg0->unk309;
    temp_a2 = arg0->unk30C + (temp_v0 * 6);
    temp_a3 = temp_a2 + 6;
    if ((s32) temp_v0 >= (s32) arg0->unk308) {
        return 0;
    }
    temp_f6 = temp_a3->unk4 - temp_a2->unk4;
    temp_f14 = (f32) (temp_a3->unk0 - temp_a2->unk0);
    sp48 = temp_a2;
    arg0 = arg0;
    ...
    temp_f18 = temp_f0;
    temp_f2 = arg0->world.pos.x - (f32) temp_a2->unk0;
    temp_f16 = arg0->world.pos.z - (f32) temp_a2->unk4;
...
s8 func_80B44234(Actor *arg0, Vec3f *arg1) {
    ...
    if ((s32) temp_s3 > 0) {
        do {
            Math_Vec3s_ToVec3f(&sp48, phi_s1);
            temp_f0 = Math3D_DistanceSquared(&sp48, arg1);
            if (temp_f0 < phi_f20) {
                phi_f20 = temp_f0;
                phi_s4_2 = phi_s0;
            }
...
void func_80B443A0(Actor *arg0) {
    ...
    temp_s1 = arg0->unk30C;
    temp_s5 = arg0->unk308;
    temp_f26 = 1.0f / arg0->unk310;
    Math_Vec3s_ToVec3f(&sp64, temp_s1);
    phi_s1 = temp_s1 + 6;
    phi_f20 = 0.0f;
    phi_s0 = arg0 + 0x37C;
    phi_s2 = 1;
...
void func_80B444BC(Actor *arg0) {
    func_80B44024(arg0);
    arg0->unk310 = EnInvadepoh_GetTotalPathDistance(arg0);
    func_80B443A0(arg0);
}
...
void func_80B447C0(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk309;
    temp_a3 = arg0->unk30C + (temp_v0 * 6);
    if ((s32) temp_v0 <= 0) {
        sp3C = 0.0f;
    } else {
        sp3C = (arg0 + (temp_v0 * 4))->unk378;
    }
    if ((s32) temp_v0 < (arg0->unk308 - 1)) {
        phi_f2 = (arg0 + (temp_v0 * 4))->unk37C;
    } else {
        phi_f2 = 1.0f;
    }
    ...
    if (temp_f18 < 0.001f) {
        ...
        sp34 = temp_f12;
        sp2C = temp_f16;
        Math_Vec3s_ToVec3f(&sp50, temp_a3);
        Math_Vec3s_ToVec3f(&sp44, temp_a3 + 6);
        arg0->unk314 = (f32) (((sp50.x * temp_f14) + (sp44.x * temp_f12)) * temp_f16);
        arg0->unk318 = (f32) (((sp50.y * temp_f14) + (sp44.y * temp_f12)) * temp_f16);
        arg0->unk31C = (f32) (((sp50.z * temp_f14) + (sp44.z * temp_f12)) * temp_f16);
        phi_a2 = arg0 + 0x314;
    }
...
s32 func_80B44B84(Actor *arg0, GlobalContext *arg1, f32 arg2, f32 arg3) {
    ...
    temp_v0_2 = arg0->unk30C + (arg0->unk309 * 6);
    temp_v0 = func_80B450C0(arg0 + 0x24, arg0 + 0x2C, (f32) temp_v0_2->unk6, (f32) temp_v0_2->unkA, arg2);
    sp2C = temp_v0;
...
s32 func_80B44C80(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = &sp6C;
    temp_f0 = (f32) temp_a2->unk0;
    temp_a1 = &sp60;
    temp_v0_2 = temp_a3 + (phi_v1 * 6);
    temp_f2 = (f32) temp_a2->unk4;
    temp_f12 = (f32) temp_v0_2->unk0;
    sp70 = 0.0f;
    temp_f14 = (f32) temp_v0_2->unk4;
...
void EnInvadepoh_SetSysMatrix(Vec3f *arg0) {
    MtxF *temp_v0;
...
void func_80B45BB8(void *arg0) {
    s32 temp_a1;

    temp_a1 = arg0->unk0;
    if ((temp_a1 != 0) && (arg0->unk8 != 0)) {
        *(&D_80B4EC0C + (arg0->unk4 * 4))(temp_a1);
    }
}

void func_80B45C04(Actor *arg0, ? *arg1, s32 arg2, ? *arg3, s32 arg4, Vec3s *arg5, s16 arg6, f32 arg7, f32 arg8, f32 arg9) {
    void *temp_v0;
    void *temp_v0_2;
    ...
    arg0->unk30 = arg7;
    arg0->unk38 = arg8;
    arg0->focus.pos.x = arg9;
    if (arg1 != 0) {
        temp_v0 = *(arg1 + (arg2 * 4));
        arg0->unk0 = arg1;
        arg0->unkC = 0;
        arg0->unkE = 0;
        arg0->home.pos.x = temp_v0;
        arg0->unk4 = (s8) temp_v0->unk0;
        arg0->unkF = (s8) **temp_v0->unk4;
    }
    if (arg3 != 0) {
        temp_v0_2 = *(arg3 + (arg4 * 4));
        arg0->home.pos.z = arg3;
        arg0->params = 0;
        arg0->objBankIndex = 0;
        arg0->unk18 = temp_v0_2;
        arg0->unk14 = (s8) temp_v0_2->unk0;
        arg0->targetMode = **temp_v0_2->unk4;
    }
}

void func_80B45CE0(void *arg0) {
    Vec3f sp3C;
    s16 sp38;
    s16 sp36;
    s16 sp34;
    ...
    temp_a1 = &sp34;
    sp34 = arg0->unk26 - arg0->unk20;
    sp36 = arg0->unk28 - arg0->unk22;
    sp38 = arg0->unk2A - arg0->unk24;
    Math_Vec3s_ToVec3f(&sp3C, (Vec3s *) temp_a1);
    Math_Vec3f_Scale(&sp3C, arg0->unk30);
    Math_Vec3f_ToVec3s((Vec3s *) &sp34, &sp3C);
    if ((s32) sp34 < 0) {
        sp34 = (s32) sp34 * -1;
    }
    if ((s32) sp36 < 0) {
    ...
    phi_v0 = (s32) arg0->unk2C;
    if ((s32) arg0->unk2C < (s32) sp36) {
        sp36 = (s16) (s32) arg0->unk2C;
        phi_v0 = (s32) arg0->unk2C;
    }
    if (phi_v0 < (s32) sp38) {
        sp38 = (s16) phi_v0;
    }
    Math_ScaledStepToS(arg0 + 0x20, arg0->unk26, sp34);
    Math_ScaledStepToS(arg0 + 0x22, arg0->unk28, sp36);
    Math_ScaledStepToS(arg0 + 0x24, arg0->unk2A, sp38);
    Math_StepToF(arg0 + 0x34, arg0->unk38, arg0->unk3C);
    temp_a1_2 = arg0->unk42;
    temp_v0_2 = arg0->unk40;
    if (temp_a1_2 != temp_v0_2) {
        temp_f16 = (s32) ((f32) (s16) (temp_a1_2 - temp_v0_2) * arg0->unk44);
...
s32 func_80B461DC(void) {
    ...
    do {
        if ((s32) phi_s0->unk1 > 0) {
            *(&D_80B4EC20 + (phi_s0->unk0 * 4))(phi_s0);
            phi_s0->unk1 = (s8) (phi_s0->unk1 - 1);
            phi_s4 = 1;
        }
        temp_s1 = phi_s1 + 1;
        phi_s0 += 0x10;
...
loop_1:
    ...
    func_80B45648(this);
    func_800BC154(globalCtx, &globalCtx->actorCtx, &this->actor, 0U);
    temp_v0 = D_80B4E940;
    if (temp_v0 == 1) {
        func_80B46DA8(this);
        return;
...
void EnInvadepoh_InitAlien(EnInvadepoh *this, GlobalContext *globalCtx) {
    EnInvadepoh *self = (EnInvadepoh *) this;
    ColliderCylinder *sp20;
    ColliderCylinder *temp_a1;

    Actor_ProcessInitChain(&self->actor, &D_80B4EC24);
    temp_a1 = &self->collider;
    sp20 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    ActorShape_Init(&self->actor.shape, 6800.0f, func_800B4088, 150.0f);
    self->actor.shape.shadowAlpha = 0x8C;
    self->actor.flags = 0x80001010;
    if ((((s32) self->actor.params >> 4) & 0xF) == 0xD) {
        self->actor.update = func_80B4D670;
        self->actor.world.pos.y = self->actor.home.pos.y + 150.0f;
    } else {
        self->actor.update = func_80B47BAC;
        Collider_SetCylinder(globalCtx, sp20, &self->actor, &D_80B4E8B0);
        self->actor.colChkInfo.mass = 0x28;
    }
    self->bankIndex = Object_GetIndex(&globalCtx->objectCtx, 0x23E);
    if ((s32) self->bankIndex < 0) {
...
void EnInvadepoh_InitParentCow(EnInvadepoh *this, GlobalContext *globalCtx) {
    EnInvadepoh *self = (EnInvadepoh *) this;
    Actor_ProcessInitChain(&self->actor, &D_80B4EC34);
    self->actor.update = func_80B47FA8;
    Actor_SpawnAsChild(&globalCtx->actorCtx, &self->actor, globalCtx, 0x200, 0.0f, 0.0f, 0.0f, (s16) 0, (s16) 0, (s16) 0, 0x30);
    self->bankIndex = Object_GetIndex(&globalCtx->objectCtx, 0x146);
    if ((s32) self->bankIndex < 0) {
        Actor_MarkForDeath(&self->actor);
    }
}
...
void EnInvadepoh_InitChildCow(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = self;
    self = self;
    Actor_ProcessInitChain(&temp_a0->actor, &D_80B4EC44);
    self->actor.update = func_80B481C4;
    self->bankIndex = Object_GetIndex(&globalCtx->objectCtx, 0x146);
    if ((s32) self->bankIndex < 0) {
        Actor_MarkForDeath(&self->actor);
    }
...
void EnInvadepoh_InitRomani(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = (s32) self->actor.params >> 4;
    temp_v1_2 = temp_v1 & 0xF;
    sp28 = temp_v1_2;
    Actor_ProcessInitChain(&self->actor, &D_80B4EC54);
    ...
    sp28 = temp_v1_2;
    func_800BC154(globalCtx, &globalCtx->actorCtx, &self->actor, 4U);
    temp_a1 = &self->collider;
    sp24 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    if (temp_v1_2 != 4) {
        sp28 = temp_v1_2;
        ActorShape_Init(&self->actor.shape, 0.0f, func_800B3FC0, 18.0f);
        Collider_SetCylinder(globalCtx, sp24, &self->actor, &D_80B4E8DC);
        self->actor.colChkInfo.mass = 0xFF;
    }
    if ((temp_v1 & 0xF) == 4) {
        self->actor.update = func_80B48620;
    } else if ((temp_v1 & 0xF) == 5) {
        self->actor.update = func_80B48FB0;
        self->actor.flags = 0x19;
    } else if ((temp_v1 & 0xF) == 7) {
        self->actor.update = func_80B49F88;
    } else if ((temp_v1 & 0xF) == 8) {
        self->actor.update = func_80B4A9C8;
    } else if ((temp_v1 & 0xF) == 9) {
        self->actor.update = func_80B4B0C4;
    } else {
        self->actor.update = func_80B4CE54;
    }
    sp28 = temp_v1 & 0xF;
    self->bankIndex = Object_GetIndex(&globalCtx->objectCtx, 0xB7);
    if ((s32) self->bankIndex < 0) {
        sp28 = temp_v1 & 0xF;
        Actor_MarkForDeath(&self->actor);
    }
...
void func_80B468B4(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = this;
    this = this;
    Actor_ProcessInitChain(&temp_a0->actor, &D_80B4EC68);
    ...
    if ((temp_v0 == 1) || ((s32) gSaveContext.time < 0x1AD8)) {
        this->actor.world.pos.x += D_80B4E934.unk0;
        this->actor.world.pos.y += D_80B4E934.unk4 + 3000.0f;
        this->actor.world.pos.z += D_80B4E934.unk8;
        func_80B491EC(this);
        return;
    }
    if (temp_v0 == 2) {
...
void EnInvadepoh_InitDog(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&self->actor, &D_80B4EC80);
    self->actor.update = func_80B4B8BC;
    temp_a1 = &self->collider;
    sp20 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    Collider_SetCylinder(globalCtx, temp_a1, &self->actor, &D_80B4E908);
    self->actor.colChkInfo.mass = 0x50;
    ActorShape_Init(&self->actor.shape, 0.0f, func_800B3FC0, 24.0f);
    self->bankIndex = Object_GetIndex(&globalCtx->objectCtx, 0x132);
    if ((s32) self->bankIndex < 0) {
        Actor_MarkForDeath(&self->actor);
    }
}
...
void EnInvadepoh_InitCremia(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&self->actor, &D_80B4EC98);
    self->actor.update = func_80B4C3A0;
    func_800BC154(globalCtx, &globalCtx->actorCtx, &self->actor, 4U);
    temp_a1 = &self->collider;
    sp20 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    Collider_SetCylinder(globalCtx, temp_a1, &self->actor, &D_80B4E8DC);
    self->actor.colChkInfo.mass = 0xFE;
    ActorShape_Init(&self->actor.shape, 0.0f, func_800B3FC0, 18.0f);
    self->bankIndex = Object_GetIndex(&globalCtx->objectCtx, 0xA7);
    if ((s32) self->bankIndex < 0) {
        Actor_MarkForDeath(&self->actor);
    }
    if ((gSaveContext.weekEventReg[22] & 1) == 0) {
...
void func_80B46E44(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(D_80B50404) != 0) {
        this = temp_a1;
        ActorCutscene_StartAndSetUnkLinkFields(D_80B50404, &temp_a1->actor);
        func_80B46EC0(this);
        return;
    }
...
loop_4:
        ...
        temp_v0_2 = phi_v0 + 1;
        phi_v0 = temp_v0_2;
        if ((temp_a0_2 != 0) && (temp_a0_2->unk38A != 0)) {
            func_80B47278(this);
            return;
        }
        phi_v1 += 4;
...
void func_80B47084(EnInvadepoh *this, GlobalContext *globalCtx) {
    if (ActorCutscene_GetCanPlayNext(D_80B50406) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields(D_80B50404.unk2, &this->actor);
        func_80B470E0(this);
        return;
    }
    ActorCutscene_SetIntentToPlay(D_80B50404.unk2);
}
...
void func_80B47380(Actor *arg0) {
    arg0->unk2B0 = (u8) (arg0->unk2B0 & ~1);
    arg0->unk2B1 = (u8) (arg0->unk2B1 & ~1);
    arg0->unk2B2 = (u8) (arg0->unk2B2 & ~1);
    ...
    arg0->unk38C = 0;
    arg0->unk38D = 0;
    arg0->unk2EC = func_80B473E4;
}

void func_80B473E4(EnInvadepoh *this, GlobalContext *globalCtx) {
    func_80B442E4(this);
    func_80B447C0(&this->actor, globalCtx);
...
void func_80B47600(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    func_80B447C0(&this->actor, globalCtx);
    func_80B43DD4(this, 0x320, 0);
    func_800B9010(&this->actor, 0x320AU);
...
block_11:
    ...
    if ((s32) this->actionTimer <= 0) {
        ...
        func_80B43AB0();
        Item_DropCollectible(globalCtx, &this->actor.world.pos, 8U);
        func_80B47478(this);
    }
}
...
void func_80B47BAC(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        thisx->objBankIndex = thisx->unk2F4;
        Actor_SetObjectSegment(globalCtx, thisx);
        func_80B45080();
        thisx->update = func_80B47D30;
        SkelAnime_InitSV(globalCtx, (SkelAnime *) (thisx + 0x144), &D_06004E50, &D_06001D80, thisx + 0x188, thisx + 0x212, 0xE);
        thisx->unk15C = (f32) ((f32) (thisx->params & 7) * thisx->unk154 * 0.125f);
...
void func_80B47D30(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (D_80B4E940 == 3) {
        temp_v0 = thisx->unk2EC;
        if ((func_80B477B4 == temp_v0) || (func_80B47600 == temp_v0)) {
            thisx->speedXZ = 0.0f;
        ...
        if ((func_80B474DC == temp_v0) || (func_80B473E4 == temp_v0)) {
            Actor_MarkForDeath(thisx);
            return;
        }
        goto block_20;
    ...
    if ((thisx->unk2B1 & 2) != 0) {
        temp_v0_2 = thisx->unk2A8;
        thisx->speedXZ = temp_v0_2->unk70 * 0.5f;
        ...
        thisx->gravity = 0.0f;
        thisx->world.rot.y = temp_v0_2->unk32;
        thisx->velocity.y = temp_v0_2->unk68 * 0.5f;
        ...
        Audio_PlaySoundAtPosition(globalCtx, &thisx->world.pos, 0x32, 0x3A09U);
        func_80B47830(thisx);
    }
block_20:
    thisx->unk2EC(thisx, globalCtx);
    if (thisx->draw != 0) {
        thisx->unk29C = SkelAnime_FrameUpdateMatrix((SkelAnime *) (thisx + 0x144));
    }
    temp_a1 = thisx + 0x2A0;
    sp20 = temp_a1;
    Collider_UpdateCylinder(thisx, temp_a1);
    temp_v0_3 = thisx->unk2B0;
    if ((temp_v0_3 & 1) != 0) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, &sp20->base);
    } else {
        thisx->unk2B0 = (u8) (temp_v0_3 & 0xFFFD);
    }
    temp_v0_4 = thisx->unk2B1;
    if ((temp_v0_4 & 1) != 0) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, &sp20->base);
    } else {
        thisx->unk2B1 = (u8) (temp_v0_4 & 0xFFFD);
    }
    temp_v0_5 = thisx->unk2B2;
    if ((temp_v0_5 & 1) != 0) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &sp20->base);
        return;
    }
    thisx->unk2B2 = (u8) (temp_v0_5 & 0xFFFD);
}
...
void func_80B47FA8(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        temp_a1 = thisx + 0x144;
        sp34 = temp_a1;
        SkelAnime_InitSV(globalCtx, (SkelAnime *) temp_a1, &D_06004010, NULL, thisx + 0x188, thisx + 0x212, 6);
...
void func_80B48060(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp6C = thisx->params & 7;
    SkelAnime_FrameUpdateMatrix((SkelAnime *) (thisx + 0x144));
    temp_a0 = &thisx->shape;
    sp24 = temp_a0;
    Math_ScaledStepToS(&temp_a0->rot.x, *(&D_80B4EDC0 + (sp6C * 2)), 0x32);
    if (thisx->child != 0) {
        SysMatrix_StatePush();
        SysMatrix_SetStateRotationAndTranslation(thisx->world.pos.x, thisx->world.pos.y, thisx->world.pos.z, &sp24->rot);
        ...
        SysMatrix_GetStateTranslation(&thisx->child->world.pos);
        SysMatrix_CopyCurrentState(&sp28);
        func_8018219C(&sp28, &thisx->child->shape.rot, 0);
        SysMatrix_StatePop();
    }
}
...
void func_80B481C4(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        temp_a1 = thisx + 0x144;
        sp34 = temp_a1;
        SkelAnime_InitSV(globalCtx, (SkelAnime *) temp_a1, &D_06004C30, NULL, thisx + 0x188, thisx + 0x212, 6);
...
void func_80B48620(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        temp_a1 = thisx + 0x144;
        sp38 = temp_a1;
        SkelAnime_InitSV(globalCtx, (SkelAnime *) temp_a1, &D_06013928, &D_06009E58, thisx + 0x188, thisx + 0x212, 0x17);
        func_80B45C04(thisx + 0x324, &D_80B4EA90, 6, &D_80B4EB00, 2, &D_801D15BC, (s16) 0x1388, 0.05f, 0.3f, 0.12f);
...
void func_80B48848(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    if (func_80B44B84(&this->actor, globalCtx, this->actor.speedXZ, 50.0f) != 0) {
        func_80B44514(this);
    ...
    if (((this->actor.flags & 0x40) == 0x40) && ((sp20 = temp_a0, (func_801378B8(temp_a0, 0.0f) != 0)) || (func_801378B8(temp_a0, 7.0f) != 0))) {
        Audio_PlayActorSound2(&this->actor, 0x3ABEU);
    }
    temp_v0 = this->actionTimer;
    if ((s32) temp_v0 > 0) {
        this->actionTimer = temp_v0 - 1;
...
void func_80B48AD4(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    if (this->rand == 0) {
        if ((this->actor.xzDistToPlayer < 350.0f) && ((globalCtx->gameplayFrames & 0x60) != 0)) {
            temp_v1 = (s32) ((f32) Math_Vec3f_Pitch(&this->actor.focus.pos, &globalCtx->actorCtx.actorList[2].first->focus.pos) * 0.85f) - this->actor.shape.rot.x;
...
void func_80B48E4C(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = (s32) ((f32) Math_Vec3f_Pitch(&this->actor.focus.pos, &sp28->focus.pos) * 0.85f) - this->actor.shape.rot.x;
...
void func_80B48FB0(Actor *thisx, GlobalContext *globalCtx) {
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        thisx->textId = 0x3330;
        SkelAnime_InitSV(globalCtx, (SkelAnime *) (thisx + 0x144), &D_06013928, &D_06009E58, thisx + 0x188, thisx + 0x212, 0x17);
        func_80B45C04(thisx + 0x324, &D_80B4EA90, 6, &D_80B4EB00, 2, &D_801D15BC, (s16) 0x64, 0.03f, 0.3f, 0.03f);
...
void func_80B490F0(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (sp2C != 0) {
        SkelAnime_FrameUpdateMatrix((SkelAnime *) (thisx + 0x144));
        func_80B45CE0(thisx + 0x324);
        if ((func_80B48E4C != thisx->unk2EC) && (sp28 == 0) && (thisx->isTargeted != 0)) {
            func_800B8614(thisx, globalCtx, 100.0f);
        }
        temp_a2 = thisx + 0x2A0;
        sp24 = temp_a2;
        Collider_UpdateCylinder(thisx, temp_a2);
...
void func_80B49228(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    sp28 = temp_f0;
    func_800B9010(&this->actor, 0x217BU);
...
void func_80B49454(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    Math_Vec3f_Sum((this->unk3AC * 0xC) + &D_80B4EDD0, &this->actor.home.pos, &sp30);
    temp_a0 = &this->actor.world;
    sp28 = temp_a0;
    if (Math3D_DistanceSquared(&temp_a0->pos, &sp30) < 160000.0f) {
        this->actor.speedXZ *= 0.8f;
    } else {
        Math_StepToF(&this->actor.speedXZ, 170.0f, 21.0f);
        this->actor.speedXZ *= 0.98f;
    }
    if (func_80B450C0(&sp28->pos.x, &this->actor.world.pos.z, sp30.x, sp30.z, this->actor.speedXZ) != 0) {
...
void func_80B49670(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&this->actor.world.pos, (Vec3f *) &sp30), 0xA, 0xBB8, (s16) 0x64);
...
void func_80B497EC(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    temp_a1 = &sp30;
    sp30 = this->actor.home.pos.x + D_80B4E934.unk0;
    sp34 = this->actor.home.pos.y + D_80B4E934.unk4 + 400.0f;
    sp38 = this->actor.home.pos.z + D_80B4E934.unk8;
    Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&this->actor.world.pos, (Vec3f *) temp_a1), 4, 0x1F40, (s16) 0x64);
...
void func_80B49A00(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    sp38 = this->actor.home.pos.z;
    Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&this->actor.world.pos, (Vec3f *) &sp30), 4, 0x1F40, (s16) 0x64);
...
void func_80B49B1C(Actor *thisx, GlobalContext *globalCtx) {
    thisx->unk2EC(thisx);
    thisx->unk3A8 = (s16) (thisx->unk3A8 + thisx->unk3AA);
    Math_StepToF(thisx + 0x39C, thisx->unk3A0, thisx->unk3A4);
    Actor_SetScale(thisx, 0.27f * ((Math_SinS(thisx->unk3A8) * thisx->unk39C) + 1.0f));
    Math_StepToS(thisx + 0x306, 0x258, 8);
    thisx->world.rot.y += thisx->unk306;
    thisx->unk304 = (s16) (thisx->unk304 + 0x258);
}
...
void func_80B49C38(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    func_80B44570(this);
    func_80B44C24(&this->actor, globalCtx);
...
void func_80B49DA0(Actor *arg0) {
    ...
    temp_a3 = arg0;
    temp_a3->unk350 = 0x7D0;
    temp_a3->unk370 = 0;
    temp_a3->unk354 = 0.08f;
    arg0 = temp_a3;
    SkelAnime_ChangeAnimTransitionRepeat(temp_a3 + 0x144, &D_06009E58, -10.0f);
    arg0->unk2EC = func_80B49DFC;
}
...
void func_80B49F88(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        Actor_SetObjectSegment(globalCtx, thisx);
        func_80B44F58();
        SkelAnime_InitSV(globalCtx, (SkelAnime *) (thisx + 0x144), &D_06013928, &D_06014088, thisx + 0x188, thisx + 0x212, 0x17);
        func_80B45C04(thisx + 0x324, &D_80B4EA90, 1, &D_80B4EB00, 1, &D_801D15BC, (s16) 0x64, 0.03f, 0.3f, 0.03f);
...
void func_80B4A1B8(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((sp2C != 0) && (thisx->update != 0)) {
        SkelAnime_FrameUpdateMatrix((SkelAnime *) (thisx + 0x144));
        func_80B45CE0(thisx + 0x324);
        if ((func_80B49DFC != thisx->unk2EC) && (sp28 == 0) && (thisx->isTargeted != 0)) {
...
void func_80B4A350(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.xzDistToPlayer < 300.0f) {
        temp_v1_2 = (s32) ((f32) Math_Vec3f_Pitch(&this->actor.focus.pos, &globalCtx->actorCtx.actorList[2].first->focus.pos) * 0.85f) - this->actor.shape.rot.x;
...
void func_80B4A9C8(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        if ((sp38 < 0x1800) || (sp38 >= 0x4000)) {
            ...
            thisx->draw = func_80B4E324;
            thisx->unk309 = (s8) thisx->unk308;
            func_80B4A2C0((EnInvadepoh *) thisx);
        }
        EnInvadepoh_SetPathPointToWorldPos(thisx, thisx->unk309);
        func_80B43F0C(thisx);
        func_800B4AEC(globalCtx, thisx, 50.0f);
        func_80B4516C((EnInvadepoh *) thisx);
        if ((gSaveContext.weekEventReg[21] & 0x20) != 0) {
...
void func_80B4ABDC(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (sp2C != 0) {
        thisx->unk29C = SkelAnime_FrameUpdateMatrix((SkelAnime *) (thisx + 0x144));
        func_80B45CE0(thisx + 0x324);
        if ((func_80B4A81C != thisx->unk2EC) && (sp28 == 0) && (thisx->isTargeted != 0)) {
            func_800B8614(thisx, globalCtx, 100.0f);
        }
        temp_a2 = thisx + 0x2A0;
        sp24 = temp_a2;
...
void func_80B4AD60(EnInvadepoh *this, GlobalContext *globalCtx) {
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        EnInvadepoh_SetTextID(&this->actor, globalCtx, 0x3331);
        func_80B4ADB8(this);
        return;
    }
    ...
    if ((func_80152498(&globalCtx->msgCtx) == 5) && (this = this, (func_80147624(globalCtx) != 0))) {
        ...
        if (temp_v0 == 0x3331) {
            if ((gSaveContext.weekEventReg[22] & 2) != 0) {
                EnInvadepoh_SetTextID(&this->actor, globalCtx, 0x3334, this);
                func_80151BB4(globalCtx, 0x1DU);
                func_80151BB4(globalCtx, 5U);
                return;
            }
            EnInvadepoh_SetTextID(&this->actor, globalCtx, 0x3333, this);
            return;
        }
        if (temp_v0 == 0x3333) {
            func_80B4AEC0(this);
...
void func_80B4AF94(EnInvadepoh *this, GlobalContext *globalCtx) {
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        EnInvadepoh_SetTextID(&this->actor, globalCtx, 0x3334);
...
void func_80B4B0C4(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        temp_a1 = thisx + 0x144;
        sp38 = temp_a1;
        SkelAnime_InitSV(globalCtx, (SkelAnime *) temp_a1, &D_06013928, &D_06014088, thisx + 0x188, thisx + 0x212, 0x17);
...
void func_80B4B218(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((sp38 != 0) && (thisx->update != 0)) {
        ...
        Math_StepToS(thisx + 0x370, 0x7D0, 0x28);
        Math_SmoothStepToS(&thisx->shape.rot.y, thisx->yawTowardsPlayer, 6, thisx->unk370, (s16) 0x28);
        temp_a0 = thisx + 0x324;
        temp_v1 = (s32) ((f32) Math_Vec3f_Pitch(&thisx->focus.pos, &sp34->focus.pos) * 0.9f) - thisx->shape.rot.x;
        phi_a0 = temp_a0;
        if ((s32) temp_v1 < -0xBB8) {
            temp_a0_2 = thisx + 0x324;
            temp_a0_2->unk26 = -0xBB8;
            phi_a0 = temp_a0_2;
        } else {
            phi_v0 = temp_v1;
            if ((s32) temp_v1 >= 0xBB9) {
        ...
        if ((s32) (s16) temp_f10 < -0x1F40) {
            ...
            phi_a0->unk28 = phi_v0_2;
        }
        func_80B45CE0(phi_a0);
        temp_a2 = thisx + 0x2A0;
        sp28 = temp_a2;
        Collider_UpdateCylinder(thisx, temp_a2);
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &temp_a2->base);
...
void func_80B4B484(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    if (func_80B44C80(&this->actor, globalCtx) != 0) {
        func_80B44690(this);
    }
    func_80B4B3DC(&this->actor);
...
void func_80B4B564(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->unk3BC;
    if ((s32) temp_v1 >= 0) {
        Math_Vec3s_ToVec3f(&sp28, &this->pathPoints[temp_v1]);
...
void func_80B4B768(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, Actor_YawBetweenActors(&this->actor, D_80B5040C), 5, 0x1388, (s16) 0x64);
    func_80B44E90(&this->actor, globalCtx);
    temp_a0 = &this->skelAnime;
    sp2C = temp_a0;
    if ((func_801378B8(temp_a0, 13.0f) != 0) || (func_801378B8(temp_a0, 19.0f) != 0)) {
        Audio_PlayActorSound2(&this->actor, 0x2910U);
    }
    if (this->animPlayFlag != 0) {
        func_80B4B510(this);
    }
...
void func_80B4B8BC(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        thisx->objBankIndex = thisx->unk2F4;
        Actor_SetObjectSegment(globalCtx, thisx);
        SkelAnime_InitSV(globalCtx, (SkelAnime *) (thisx + 0x144), &D_060080F0, &D_060021C8, thisx + 0x188, thisx + 0x212, 0xD);
        func_80B45C04(thisx + 0x324, NULL, 0, NULL, 0, &D_801D15BC, (s16) 0xBB8, 0.1f, 0.0f, 0.0f);
        func_80B44664(thisx, globalCtx);
        EnInvadepoh_SetPathPointToWorldPos(thisx, 0);
        func_800B4AEC(globalCtx, thisx, 50.0f);
        func_80B4516C((EnInvadepoh *) thisx);
        Math_Vec3f_Copy(thisx + 0x314, &thisx->world.pos);
        temp_v0 = D_80B4E940;
        if (temp_v0 == 2) {
...
void func_80B4BA84(Actor *thisx, GlobalContext *globalCtx) {
    ...
    D_80B5040C = temp_v0;
    if (temp_v0 == 0) {
        temp_v0_2 = thisx->unk3BC;
        thisx->unk3BC = -1;
        if ((((s32) temp_v0_2 < 0) ^ 1) != 0) {
            func_80B4B820((EnInvadepoh *) thisx);
        }
    } else {
        sp2C = (s32) thisx->unk3BC;
        thisx->unk3BC = func_80B44234(thisx, &temp_v0->world.pos);
        temp_v1 = thisx->unk3BC;
        if (sp2C != temp_v1) {
            temp_v0_3 = temp_v1 - thisx->unk309;
            phi_v0 = temp_v0_3;
            if (temp_v0_3 < 0) {
                phi_v0 = temp_v0_3 + thisx->unk308;
            }
            temp_v1_2 = (s32) thisx->unk308 >> 1;
            if (temp_v1_2 < phi_v0) {
                thisx->unk30A = -1;
...
void func_80B4BC4C(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    if (temp_t6 != 0) {
        ...
        sp2C = temp_a1;
        sp30 = temp_a0_3;
        if (Math3D_DistanceSquared(temp_a0_3, &temp_a1->pos) > 0.0001f) {
            Math_SmoothStepToS(&this->actor.shape.rot.y, Math_Vec3f_Yaw(temp_a0_3, &sp2C->pos), 3, this->behaviorInfo.unk4C, (s16) 0x1F4);
        }
        temp_v1 = (globalCtx->gameplayFrames + 0x14) & 0x7F;
        if ((temp_v1 & 0x40) != 0) {
            sp30 = (Vec3f *) &this->actor.shape.rot.y;
            sp48 = temp_v1;
            sp40 = Math_Vec3f_Yaw(&sp2C->pos, &sp50->actor.world.pos);
            if (temp_v1 == 0x40) {
                this->behaviorInfo.unk4C = 0;
            }
            Math_StepToS(sp34, 0x7D0, 0x28);
            Math_SmoothStepToS((s16 *) sp30, sp40, 6, this->behaviorInfo.unk4C, (s16) 0x28);
            temp_v1_2 = (s32) ((f32) Math_Vec3f_Pitch(&this->actor.focus.pos, &sp50->actor.focus.pos) * 0.85f) - this->actor.shape.rot.x;
...
void func_80B4C3A0(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        Actor_SetObjectSegment(globalCtx, thisx);
        func_80B44FEC();
        SkelAnime_InitSV(globalCtx, (SkelAnime *) (thisx + 0x144), &D_06015C28, &D_06016720, thisx + 0x188, thisx + 0x212, 0x16);
        func_80B45C04(thisx + 0x324, &D_80B4EBDC, 1, &D_80B4EC08, 0, &D_801D15BC, (s16) 0x64, 0.03f, 0.3f, 0.03f);
        thisx->textId = 0x33CD;
...
void func_80B4C5C0(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((sp2C != 0) && (thisx->update != 0)) {
        SkelAnime_FrameUpdateMatrix((SkelAnime *) (thisx + 0x144));
        func_80B45CE0(thisx + 0x324);
        if ((func_80B4C058 != thisx->unk2EC) && (sp28 == 0) && (thisx->isTargeted != 0)) {
            func_800B8614(thisx, globalCtx, 350.0f);
        }
        temp_a2 = thisx + 0x2A0;
        sp24 = temp_a2;
...
void func_80B4C730(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    sp68 = D_80B503F8;
    func_80B44700(this);
    func_80B44EFC(&this->actor, globalCtx);
    func_80B43E6C(this, 6, 0x7D0, 0x64);
    ...
    Math_Vec3s_ToVec3f(&sp40, &this->pathPoints[phi_a2] + 6);
    Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&sp4C, &sp40), 5, 0x7D0, (s16) 0x64);
    ...
    if ((temp_v1_3 & 0x40) != 0) {
        ...
        temp_v1_4 = (s32) ((f32) Math_Vec3f_Pitch(&this->actor.focus.pos, &sp68->actor.focus.pos) * 0.85f) - this->actor.shape.rot.x;
...
void func_80B4CAB0(Actor *arg0) {
    ...
    temp_a3 = arg0;
    temp_a3->unk350 = 0xFA0;
    temp_a3->unk354 = 0.08f;
    arg0 = temp_a3;
    SkelAnime_ChangeAnimTransitionRepeat(temp_a3 + 0x144, &D_06009E58, -10.0f);
    arg0->unk370 = 0;
    arg0->unk2EC = func_80B4CB0C;
}
...
void func_80B4CE54(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        func_80B44F58();
        SkelAnime_InitSV(globalCtx, (SkelAnime *) (thisx + 0x144), &D_06013928, &D_06014088, thisx + 0x188, thisx + 0x212, 0x17);
        func_80B45C04(thisx + 0x324, &D_80B4EA90, 1, &D_80B4EB00, 3, &D_801D15BC, (s16) 0x64, 0.03f, 0.3f, 0.03f);
...
void func_80B4D054(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((sp2C != 0) && (thisx->update != 0)) {
        SkelAnime_FrameUpdateMatrix((SkelAnime *) (thisx + 0x144));
        func_80B45CE0(thisx + 0x324);
        if ((func_80B4CB0C != thisx->unk2EC) && (sp28 == 0) && (thisx->isTargeted != 0)) {
            func_800B8614(thisx, globalCtx, 350.0f);
        }
        temp_a2 = thisx + 0x2A0;
        sp24 = temp_a2;
...
void func_80B4D15C(Actor *arg0) {
    ...
    arg0->unk15C = (f32) ((f32) (arg0->params & 7) * arg0->unk154 * 0.25f);
    arg0->unk304 = (s16) (temp_v1 * 0x5555);
    arg0->unk300 = (f32) temp_v0->unk0;
    sp20 = temp_v0;
    temp_f8 = Math_SinS(arg0->unk304) * 80.0f;
    arg0->world.pos.y = arg0->home.pos.y;
    arg0->world.pos.x = temp_f8 + arg0->home.pos.x;
    temp_f6 = Math_CosS(arg0->unk304) * 80.0f;
    arg0->shape.rot.y = arg0->unk304 + 0x4000;
    arg0->world.pos.z = temp_f6 + arg0->home.pos.z;
    arg0->unk370 = (s16) temp_v0->unk4;
    arg0->unk2EC = func_80B4D290;
    arg0->velocity.y = 0.0f;
    arg0->unk372 = (s16) temp_v0->unk6;
}
...
void func_80B4D480(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    if ((s32) this->actionTimer >= 0xA1) {
        ...
        if (((s32) temp_v0_2 < 0x69) && ((s32) temp_v0_2 >= 0x64)) {
            this->actor.gravity = -1.0f;
            sp2C = 0;
            Math_SmoothStepToS(&this->actor.shape.rot.x, 0x2000, 8, 0x320, (s16) 0x28);
        } else {
            this->actor.gravity = 0.7f;
            sp2C = 0;
            Math_SmoothStepToS(&this->actor.shape.rot.x, 0, 8, 0x320, (s16) 0x28);
        }
        this->actor.velocity.y += this->actor.gravity;
...
void func_80B4D670(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        SkelAnime_InitSV(globalCtx, (SkelAnime *) (thisx + 0x144), &D_06004E50, &D_06001674, thisx + 0x188, thisx + 0x212, 0xE);
        if (sp34 < 3) {
...
void func_80B4D760(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a2 = thisx;
    thisx = temp_a2;
    temp_a2->unk2EC(temp_a2, temp_a2);
    temp_a0 = thisx + 0x144;
    if (thisx->update != 0) {
        thisx = thisx;
...
void func_80B4D7B8(GraphicsContext **arg0) {
    ...
    phi_s3 = 0;
    do {
        if ((s32) phi_s2->unk1 > 0) {
            temp_v0 = arg0->unk18840;
            ...
            temp_v0_3->words.w1 = phi_s2->unk2 | ~0x55FF;
            ...
            temp_v0_5->words.w1 = Gfx_TwoTexScroll(arg0->unk0, 0, temp_s5, 0U, 0x20, 0x40, 1, 0U, temp_s6, 0x20, 0x40);
...
void func_80B4D9B4(Actor *thisx, GlobalContext *globalCtx) {
    func_80B4D7B8(&globalCtx->state.gfxCtx);
}
...
void func_80B4D9F4(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    if ((arg1 == 0xC) && (arg4->unk38D != 0)) {
        ...
        SysMatrix_StatePop();
    } else if ((arg1 == 0xD) && (arg4->unk38D != 0)) {
        SysMatrix_StatePush();
        SysMatrix_InsertZRotation_s(-0x53ED, 1);
...
void func_80B4DB14(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SysMatrix_StatePush();
    if (thisx->unk38B != 0) {
        if (thisx->unk389 == 0xFF) {
            func_8012C28C(globalCtx->state.gfxCtx);
            AnimatedMat_Draw(globalCtx, (AnimatedMaterial *) D_80B50400);
            Scene_SetRenderModeXlu(globalCtx, 0, 1U);
            temp_v1 = spCC->polyOpa.p;
            spCC->polyOpa.p = temp_v1 + 8;
            temp_v1->words.w1 = 0xFF;
            temp_v1->words.w0 = 0xFB000000;
            spCC->polyOpa.p = SkelAnime_DrawSV2(globalCtx, thisx->unk148, thisx->unk164, (s32) thisx->unk146, func_80B4D9D8, func_80B4D9F4, thisx, spCC->polyOpa.p);
        } else {
            AnimatedMat_Draw(globalCtx, (AnimatedMaterial *) D_80B50400);
            Scene_SetRenderModeXlu(globalCtx, 1, 2U);
            temp_v0 = spCC->polyXlu.p;
            spCC->polyXlu.p = temp_v0 + 8;
            temp_v0->words.w0 = 0xFB000000;
            temp_v0->words.w1 = (u32) thisx->unk389;
            spCC->polyXlu.p = SkelAnime_DrawSV2(globalCtx, thisx->unk148, thisx->unk164, (s32) thisx->unk146, func_80B4D9D8, func_80B4D9F4, thisx, spCC->polyXlu.p);
        }
        if (thisx->unk38D != 0) {
            ...
            temp_v1_4->words.w1 = ((u32) ((f32) thisx->unk38D * 0.5882353f) & 0xFF) | ~0xFF;
            spBC = temp_v1_5;
            spB8 = temp_a2;
            ...
            spB8->polyXlu.p = temp_v1_8 + 8;
        }
    }
    if (thisx->unk38C != 0) {
        SysMatrix_SetStateRotationAndTranslation(thisx->world.pos.x, thisx->world.pos.y + 68.0f, thisx->world.pos.z, &thisx->shape.rot);
        Matrix_Scale(thisx->unk390, thisx->unk394, thisx->unk398, 1);
        temp_v0_2 = spCC->polyXlu.p;
        spCC->polyXlu.p = temp_v0_2 + 8;
        temp_v0_2->words.w0 = 0xDA380003;
        temp_v0_2->words.w1 = Matrix_NewMtx(globalCtx->state.gfxCtx);
        temp_v0_3 = spCC->polyXlu.p;
        spCC->polyXlu.p = temp_v0_3 + 8;
    ...
    if (thisx->unk38B != 0) {
        ...
        sp74 = thisx->world.pos.x + sp80.x;
        temp_f14 = thisx->world.pos.y + sp80.y + 68.0f;
        sp78 = temp_f14;
        sp7C = thisx->world.pos.z + sp80.z;
        ...
        temp_s0_3->words.w1 = ((s32) ((f32) thisx->unk389 * 0.39215687f) & 0xFF) | 0xF0B46400;
        ...
        if (((s32) thisx->unk389 >= 0x81) && (func_80B456A8(globalCtx, (Vec3f *) &sp74) != 0)) {
            func_800F9824(globalCtx, &globalCtx->envCtx, &globalCtx->view, globalCtx->state.gfxCtx, (bitwise Vec3f) sp74.unk0, sp74.unk4, sp74.unk8, (s8) 10.0f, (s8) 9.0f, 0, 0);
        }
    }
    SysMatrix_StatePop();
}
...
void func_80B4E158(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, thisx->unk148, thisx->unk164, (s32) thisx->unk146, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80B4E120, NULL, thisx);
}

void func_80B4E1B0(Actor *thisx, GlobalContext *globalCtx) {
    func_8012C5B0(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, thisx->unk148, thisx->unk164, (s32) thisx->unk146, NULL, NULL, thisx);
}
...
s32 func_80B4E200(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    if (arg1 == 0xE) {
        ...
        arg4->x += (s32) (arg5->unk358 * (f32) arg5->unk346);
        arg4->z += arg5->unk364;
    }
    return 0;
}
...
void func_80B4E324(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v1->words.w1 = (u32) (&D_80B4E958)[thisx->unk343];
    temp_v1_2 = sp30->polyOpa.p;
    sp30->polyOpa.p = temp_v1_2 + 8;
    temp_v1_2->words.w0 = 0xDB060020;
    temp_v1_2->words.w1 = (u32) (&D_80B4E944)[thisx->unk333];
    SkelAnime_DrawSV(globalCtx, thisx->unk148, thisx->unk164, (s32) thisx->unk146, func_80B4E200, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80B4E2AC, thisx);
}
...
void func_80B4E3F0(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SysMatrix_InsertZRotation_s(thisx->unk304, 1);
    ...
    sp58->polyXlu.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xFA00FF80;
    temp_v0_2->words.w1 = 0xFFFF00B4;
    temp_v0_3 = sp58->polyXlu.p;
    sp58->polyXlu.p = temp_v0_3 + 8;
    temp_v0_3->words.w1 = 0xFF320000;
    temp_v0_3->words.w0 = 0xFB000000;
    temp_v0_4 = sp58->polyXlu.p;
    sp58->polyXlu.p = temp_v0_4 + 8;
    temp_v0_4->words.w0 = 0xDE000000;
    temp_v0_4->words.w1 = (u32) D_04023210;
    if (func_80B456A8(globalCtx, &sp5C) != 0) {
        func_800F9824(globalCtx, &globalCtx->envCtx, &globalCtx->view, globalCtx->state.gfxCtx, (bitwise Vec3f) sp5C.x, sp5C.y, sp5C.z, (s8) 20.0f, (s8) 9.0f, 0, 0);
    }
}
...
void func_80B4E660(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v1->words.w0 = 0xFB000000;
    SkelAnime_DrawSV(globalCtx, thisx->unk148, thisx->unk164, (s32) thisx->unk146, func_80B4E5B0, func_80B4E61C, thisx);
}
...
void func_80B4E7BC(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp30->polyOpa.p = temp_v1 + 8;
    temp_v1->words.w0 = 0xDB060024;
    temp_v1->words.w1 = (u32) (&D_80B4E984)[thisx->unk343];
    temp_v1_2 = sp30->polyOpa.p;
    sp30->polyOpa.p = temp_v1_2 + 8;
    temp_v1_2->words.w0 = 0xDB060020;
    temp_v1_2->words.w1 = (u32) (&D_80B4E96C)[thisx->unk333];
    SkelAnime_DrawSV(globalCtx, thisx->unk148, thisx->unk164, (s32) thisx->unk146, func_80B4E6E4, func_80B4E784, thisx);
}
