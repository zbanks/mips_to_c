...
struct _mips2c_stack_func_80B440B8 {
    ...
    /* 0x20 */ char pad20[0xC];                     /* maybe part of sp1E[7]? */
...
struct _mips2c_stack_func_80B4A350 {
    ...
    /* 0x34 */ char pad34[0xE];                     /* maybe part of sp30[4]? */
...
struct _mips2c_stack_func_80B4BC4C {
    ...
    /* 0x42 */ s16 sp42;                            /* inferred */
    /* 0x44 */ char pad44[0x4];                     /* maybe part of sp42[3]? */
...
struct _mips2c_stack_func_80B4DB14 {
    ...
    /* 0x8C */ char pad8C[0x2C];                    /* maybe part of sp88[12]? */
    /* 0xB8 */ GraphicsContext *spB8;               /* inferred */
    /* 0xBC */ Gfx *spBC;                           /* inferred */
    /* 0xC0 */ char padC0[0xC];                     /* maybe part of spBC[4]? */
...
void func_80B43DD4(EnInvadepoh *arg0, s16 arg1, s16 arg2) {
    ...
    if (arg0->endPoint != temp_v0) {
        ...
        Math_Vec3s_ToVec3f((Vec3f *) &sp24, sp40 + 6);
...
void func_80B43E6C(EnInvadepoh *arg0, s16 arg1, s16 arg2, s16 arg3) {
    ...
    if (arg0->endPoint != temp_v0) {
        ...
        Math_Vec3s_ToVec3f((Vec3f *) &sp2C, sp48 + 6);
...
void func_80B43F0C(Actor *arg0) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp1C, sp38 + 6);
...
void func_80B447C0(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_f18 < 0.001f) {
        ...
        Math_Vec3s_ToVec3f((Vec3f *) &sp44, temp_a3 + 6);
        arg0->unk314 = (f32) (((sp50 * temp_f14) + (sp44 * temp_f12)) * temp_f16);
        arg0->unk318 = (f32) (((sp54 * temp_f14) + (sp48 * temp_f12)) * temp_f16);
        arg0->unk31C = (f32) (((sp58 * temp_f14) + (sp4C * temp_f12)) * temp_f16);
        phi_a2 = arg0 + 0x314;
    }
...
void func_80B45CE0(void *arg0) {
    ...
    Math_Vec3f_Scale((Vec3f *) &sp3C, arg0->unk30);
...
void EnInvadepoh_Init(EnInvadepoh *this, GlobalContext *globalCtx) {
...
void EnInvadepoh_Destroy(EnInvadepoh *this, GlobalContext *globalCtx) {
    EnInvadepoh *this = (EnInvadepoh *) thisx;
...
void func_80B47084(EnInvadepoh *this, GlobalContext *globalCtx) {
    if (ActorCutscene_GetCanPlayNext(D_80B50406) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields(D_80B50404.unk2, (Actor *) this);
        func_80B470E0(this);
        return;
    }
...
void EnInvadepoh_Update(EnInvadepoh *this, GlobalContext *globalCtx) {
    EnInvadepoh *this = (EnInvadepoh *) thisx;
...
void func_80B4B8BC(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) thisx->unk2F4) != 0) {
        ...
        func_800B4AEC(globalCtx, thisx, 50.0f);
        func_80B4516C((EnInvadepoh *) thisx);
        Math_Vec3f_Copy(thisx + 0x314, (Vec3f *) &thisx->world);
        temp_v0 = D_80B4E940;
        if (temp_v0 == 2) {
...
void func_80B4BA84(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 0) {
        ...
        thisx->unk3BC = func_80B44234(thisx, (Vec3f *) &temp_v0->world);
...
void func_80B4C730(EnInvadepoh *this, GlobalContext *globalCtx) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp40, &this->pathPoints[phi_a2] + 6);
...
void func_80B4E3F0(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80B456A8(globalCtx, (Vec3f *) &sp5C) != 0) {
        func_800F9824(globalCtx, &globalCtx->envCtx, &globalCtx->view, globalCtx->state.gfxCtx, (bitwise Vec3f) sp5C.unk0, sp5C.unk4, sp5C.unk8, (s8) 20.0f, (s8) 9.0f, 0, 0);
    }
}
