...
typedef struct DmChar06 {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ char pad144[0x14C];
    /* 0x0290 */ void (*actionFunc)(DmChar06 *, GlobalContext *);
    /* 0x0294 */ char pad294[0xC];                  /* maybe part of actionFunc[4]? */
    /* 0x02A0 */ u8 unk2A0;                         /* inferred */
    /* 0x02A1 */ char pad2A1[0x3];                  /* maybe part of unk2A0[4]? */
} DmChar06;                                         /* size 0x2A4 */

void DmChar06_SetupAction(DmChar06 *this, void (*actionFunc)(DmChar06 *, GlobalContext *)) {
    DmChar06 *self = (DmChar06 *) this;
