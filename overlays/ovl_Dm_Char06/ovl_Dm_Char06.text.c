typedef struct DmChar06 {
    /* 0x000 */ Actor actor;
    /* 0x144 */ char pad144[0x14C];                 /* maybe part of actor[2]? */
    /* 0x290 */ void (*actionFunc)(DmChar06 *, GlobalContext *);
    /* 0x294 */ char pad294[0xC];                   /* maybe part of actionFunc[4]? */
    /* 0x2A0 */ u8 unk2A0;                          /* inferred */
    /* 0x2A1 */ char pad2A1[0x3];                   /* maybe part of unk2A0[4]? */
} DmChar06;                                         /* size = 0x2A4 */
...
void DmChar06_Init(DmChar06 *this, GlobalContext *globalCtx) {
...
void DmChar06_Destroy(DmChar06 *this, GlobalContext *globalCtx) {
    DmChar06 *this = (DmChar06 *) thisx;
...
void func_80AAE6F0(DmChar06 *this, GlobalContext *globalCtx) {
    ...
    if ((func_800EE29C(temp_a0, 0x1CFU) != 0) && (temp_a0_2 = globalCtx, globalCtx = globalCtx, temp_v0 = func_800EE200(temp_a0_2, 0x1CFU), temp_v1 = globalCtx->csCtx.npcActions[temp_v0], temp_a2 = globalCtx->csCtx.frames, (((s32) temp_a2 < (s32) temp_v1->startFrame) == 0)) && ((s32) temp_v1->endFrame >= (s32) temp_a2)) {
        ...
        if (temp_a0_3 == 2) {
            ...
            this->unk2A0 = (u8) (u32) (255.0f * (1.0f - func_800F5A8C(temp_v0_2->endFrame, temp_v0_2->startFrame, temp_a2, globalCtx)));
        }
        /* Duplicate return node #7. Try simplifying control flow for better match */
    }
}

void DmChar06_Update(DmChar06 *this, GlobalContext *globalCtx) {
    DmChar06 *this = (DmChar06 *) thisx;
    this->actionFunc(this, globalCtx);
}

void DmChar06_Draw(DmChar06 *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    ...
    temp_v0_2->words.w1 = (u32) this->unk2A0;
