typedef struct EnPoComposer {
    ...
    /* 0x1F0 */ SkelAnime unk1F0;                   /* inferred */
    /* 0x234 */ void (*actionFunc)(EnPoComposer *, GlobalContext *);
    /* 0x238 */ MtxF unk238;                        /* inferred */
    /* 0x278 */ LightNode *unk278;                  /* inferred */
    /* 0x27C */ LightInfo unk27C;                   /* inferred */
    /* 0x28A */ char pad28A[0x6];
    /* 0x290 */ s32 unk290;                         /* inferred */
    /* 0x294 */ Vec3s unk294;                       /* inferred */
    /* 0x29A */ char pad29A[0x42];                  /* maybe part of unk294[12]? */
    /* 0x2DC */ Vec3s unk2DC;                       /* inferred */
    /* 0x2E2 */ char pad2E2[0x4A];                  /* maybe part of unk2DC[13]? */
    /* 0x32C */ s16 unk32C;                         /* inferred */
    /* 0x32E */ s16 unk32E;                         /* inferred */
    /* 0x330 */ s16 unk330;                         /* inferred */
    /* 0x332 */ char pad332[0x2];
    /* 0x334 */ s16 unk334;                         /* inferred */
    /* 0x336 */ ? unk336;                           /* inferred */
    /* 0x336 */ char pad336[0x1];
    /* 0x337 */ u8 unk337;                          /* inferred */
    /* 0x338 */ u8 unk338;                          /* inferred */
    /* 0x339 */ u8 unk339;                          /* inferred */
    /* 0x33A */ ? unk33A;                           /* inferred */
    /* 0x33A */ char pad33A[0x1];
    /* 0x33B */ u8 unk33B;                          /* inferred */
    /* 0x33C */ u8 unk33C;                          /* inferred */
    /* 0x33D */ u8 unk33D;                          /* inferred */
    /* 0x33E */ char pad33E[0x2];                   /* maybe part of unk33D[3]? */
...
void EnPoComposer_Init(EnPoComposer *this, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, temp_s1, (Actor *) this, &D_80BC67D0, &this->unk1B0);
...
void EnPoComposer_Destroy(EnPoComposer *this, GlobalContext *globalCtx) {
...
void func_80BC52F0(EnPoComposer *this, GlobalContext *globalCtx) {
    if (ActorCutscene_GetCanPlayNext((this + (this->unk290 * 2))->unk324) != 0) {
        ActorCutscene_Start((this + (this->unk290 * 2))->unk324, (Actor *) this);
        func_80BC538C(this);
        return;
    }
...
void func_80BC5DEC(EnPoComposer *arg0) {
    ...
    if ((func_80BC55E0 == arg0->actionFunc) && (temp_f0 = arg0->unk1F0.animCurrentFrame, (temp_f0 < 12.0f))) {
        ...
        arg0->unk33D = 0xC8;
        arg0->unk33A = (s8) ((s32) temp_f16 + 0xE1);
...
void EnPoComposer_Update(EnPoComposer *this, GlobalContext *globalCtx) {
    EnPoComposer *this = (EnPoComposer *) thisx;
    func_80BC5DEC(this);
...
void EnPoComposer_Draw(EnPoComposer *this, GlobalContext *globalCtx) {
    Gfx *sp9C;
    ? *sp98;
    ? *sp94;
    f32 sp88;
    ...
    if ((temp_v0 == 0xFF) || (temp_v0 == 0)) {
        ...
        temp_s1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk1F0.skeleton, this->unk1F0.limbDrawTbl, (s32) this->unk1F0.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80BC60BC, func_80BC617C, (Actor *) this, temp_s1->polyOpa.p);
    } else {
        sp94 = phi_t0;
        func_8012C28C(globalCtx->state.gfxCtx);
        ...
        temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk1F0.skeleton, this->unk1F0.limbDrawTbl, (s32) this->unk1F0.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80BC60BC, func_80BC617C, (Actor *) this, temp_s1->polyXlu.p);
    }
