...
typedef struct EnElforg {
    ...
    /* 0x01C4 */ ColliderCylinder unk1C4;           /* inferred */
    /* 0x0210 */ void *unk210;                      /* inferred */
    /* 0x0214 */ u16 unk214;                        /* inferred */
    ...
    /* 0x022C */ void (*actionFunc)(EnElforg *, GlobalContext *);
} EnElforg;                                         /* size 0x230 */
...
block_8:
        ...
        case 5: // switch 2
            ...
            temp_a1 = &this->unk1C4;
            sp34 = temp_a1;
            Collider_InitAndSetCylinder(globalCtx, temp_a1, &this->actor, &D_80ACDA30);
...
void func_80ACCC98(EnElforg *arg0, GlobalContext *arg1) {
    ...
    func_80ACC8D4(&arg0->actor, sp3C + 0xBEC);
...
void func_80ACCEB0(EnElforg *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk214 & 1) != 0) {
        ...
        if (Math_Vec3f_DistXZ(&arg0->actor.world.pos, &arg0->actor.home.pos) > 150.0f) {
            arg0->unk224 = 5.0f;
        } else {
...
block_10:
    ...
    if ((arg0->unk214 & 2) != 0) {
        ...
        Actor_SetScale(&arg0->actor, arg0->actor.scale.x * 0.9f);
...
void func_80ACD1F0(EnElforg *arg0, GlobalContext *arg1) {
    ...
    if (func_800B867C(&arg0->actor, arg1) != 0) {
    ...
    func_800B9010(&arg0->actor, 0xCFU);
    if (ActorCutscene_GetCurrentIndex() != 0x7C) {
        if (ActorCutscene_GetCanPlayNext(0x7C) != 0) {
            ActorCutscene_Start(0x7C, &arg0->actor);
            return;
        }
...
void func_80ACD2E4(EnElforg *arg0, GlobalContext *arg1) {
    ...
    if (Player_GetMask(arg1) == 0xB) {
        sp3C.pos.x = sp34->unkBEC;
        sp3C.pos.y = sp34->unkBF0;
        sp3C.pos.z = sp34->unkBF4;
        arg0->unk224 = 5.0f;
        func_80ACCAC0(&arg0->actor, &sp3C);
    } else {
        arg0->unk224 = 1.0f;
        func_80ACCAC0(&arg0->actor, &arg0->actor.home);
    }
...
block_17:
        Actor_UpdateBgCheckInfo(arg1, &arg0->actor, 20.0f, 20.0f, 20.0f, 7U);
        func_80ACCBB8(arg0, arg1);
        if (Player_GetMask(arg1) == 0xB) {
            if ((arg0->unk214 & 8) == 0) {
                play_sound(0x4854U);
...
void func_80ACD6EC(EnElforg *arg0, GlobalContext *arg1) {
    if ((arg0->unk1C4.base.acFlags & 2) != 0) {
        ...
        Audio_PlayActorSound2(&arg0->actor, 0x288EU);
    } else {
        CollisionCheck_SetAC(arg1, &arg1->colChkCtx, &arg0->unk1C4.base);
    }
    func_80ACCBB8(arg0, arg1);
}
...
void EnElforg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80ACD878, NULL, &this->actor, sp34->polyXlu.p);
}
