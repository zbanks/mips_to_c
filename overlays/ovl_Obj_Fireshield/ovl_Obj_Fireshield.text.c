typedef struct ObjFireshield {
    ...
    /* 0x19C */ char pad_19C[0x8];                  /* maybe part of unk_198[3]? */
    /* 0x1A4 */ s16 unk_1A4;                        /* inferred */
    /* 0x1A6 */ u8 unk_1A6;                         /* inferred */
    /* 0x1A7 */ s8 unk_1A7;                         /* inferred */
    /* 0x1A8 */ s8 unk_1A8;                         /* inferred */
    /* 0x1A9 */ char pad_1A9[0x3];                  /* maybe part of unk_1A8[4]? */
...
void func_80A4CE28(ObjFireshield *arg0, GlobalContext *arg1) {
    ...
    if ((phi_t0 == 0) || (phi_t1 == 0) || (arg0->unk_19C != 0)) {
        arg0 = arg0;
        sp24 = phi_t0;
        sp20 = phi_t1;
        temp_v0_2 = Flags_GetSwitch(arg1, sp30);
        temp_v1 = arg0->unk_19C;
        phi_a3 = arg0;
        phi_t0_2 = phi_t0;
        phi_t1_2 = phi_t1;
        phi_t2 = temp_v0_2;
        if (temp_v1 == 2) {
            ...
            if (Math_StepToF(temp_a0, 1.0f, 0.03f) != 0) {
                arg0->unk_19C = 1;
                if (((arg0->actor.home.rot.z * 0xA) > 0) && (arg0->unk_1A7 != 0)) {
                    arg0 = arg0;
                    sp24 = phi_t0;
                    sp20 = phi_t1;
        ...
        if ((phi_a3->unk_1A0 > 0) && (phi_a3->unk_19C == 1) && ((phi_a3->actor.home.rot.z * 0xA) > 0) && ((*(&D_80A4D894 + (((s32) (sp30 & ~0x1F) >> 5) * 4)) & (1 << (sp30 & 0x1F))) == 0)) {
            phi_a3->unk_1A0 = 0;
        }
        if ((phi_a3->unk_19C == 0) || (phi_a3->unk_19C == 3)) {
            if ((phi_t0_2 == 0) && (phi_t1_2 == 0)) {
                if ((phi_a3->actor.home.rot.z * 0xA) > 0) {
                    temp_v0_4 = phi_a3->unk_1A0;
                    temp_t9 = temp_v0_4 - 1;
                    phi_v0 = temp_v0_4;
                    if (temp_v0_4 >= 2) {
                        phi_a3->unk_1A0 = temp_t9;
                        phi_v0 = temp_t9;
                    }
                    if (phi_v0 == 1) {
                        phi_a3->unk_19C = 2;
        ...
        if ((phi_t2 != 0) && ((phi_a3->unk_19C == 1) || (phi_a3->unk_19C == 2))) {
            ...
            if ((temp_lo == 0) || (phi_a3->unk_1A0 == 0)) {
                if (temp_lo > 0) {
                    phi_a3->unk_1A0 = temp_lo;
                }
                if (phi_a3->unk_1A7 != 0) {
...
void ObjFireshield_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_144.dim.radius = (s16) (s32) ((f32) this->unk_144.dim.radius * sp2C->unk_0);
    func_80A4D174(this);
...
void ObjFireshield_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80A4CABC == this->actionFunc) {
        ...
        temp_v0_4 = this->unk_144.base.atFlags;
        if ((temp_v0_4 & 2) != 0) {
            this->unk_144.base.atFlags = temp_v0_4 & 0xFFFD;
    ...
    temp_f0 = this->unk_198;
    this->actor.world.pos.y = (phi_f2 * (1.0f - this->unk_198)) + this->actor.home.pos.y;
    this->unk_1A6 = (u8) (u32) (temp_f0 * 255.0f);
    if (temp_f0 >= 0.7f) {
        temp_v0_5 = globalCtx->actorCtx.actorList[2].first;
        this->unk_144.dim.height = (s16) (s32) (temp_f0 * 80.0f);
        if (sp44 != 0) {
            this->unk_144.dim.yShift = (s32) (this->actor.home.pos.y - this->actor.world.pos.y) - this->unk_144.dim.height;
        } else {
            this->unk_144.dim.yShift = (s16) (s32) (this->actor.home.pos.y - this->actor.world.pos.y);
        }
        sp34 = temp_v0_5;
        func_800B9010((Actor *) this, 0x20B3U);
        temp_a1 = &this->unk_144;
        if (temp_v0_5->unk_14B == 1) {
            this->unk_144.info.toucher.damage = 0;
            this->unk_144.info.toucher.effect = 0;
        } else {
            this->unk_144.info.toucher.damage = 4;
            this->unk_144.info.toucher.effect = 1;
        }
        sp28 = temp_a1;
        Collider_UpdateCylinder((Actor *) this, temp_a1);
...
void ObjFireshield_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0->words.w1 = this->unk_1A6 | 0xFFDC0000;
