...
void DemoGetitem_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_144 = *(&D_80A4FD64 + temp_v0);
    this->unk_146 = *(&D_80A4FD68 + temp_v0);
    temp_v0_2 = Object_GetIndex(&globalCtx->objectCtx, *(&D_80A4FD60 + temp_v0));
    if (temp_v0_2 < 0) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    this->unk_148 = (s8) temp_v0_2;
}
...
void func_80A4FB68(DemoGetitem *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, (u32) arg0->unk_146) != 0) {
        if (arg1->csCtx.npcActions[func_800EE200(arg1, (u32) arg0->unk_146)]->unk0 != 4) {
            arg0->actor.shape.yOffset = 0.0f;
        }
        temp_v1 = arg1->csCtx.npcActions[func_800EE200(arg1, (u32) arg0->unk_146)]->unk0;
        if (temp_v1 != 2) {
            if (temp_v1 != 3) {
                if (temp_v1 != 4) {
                    goto block_10;
                ...
                func_800EDF24((Actor *) arg0, arg1, func_800EE200(arg1, (u32) arg0->unk_146));
        ...
        arg0->actor.draw = func_80A4FCF0;
        func_800EDE34((Actor *) arg0, arg1, func_800EE200(arg1, (u32) arg0->unk_146));
