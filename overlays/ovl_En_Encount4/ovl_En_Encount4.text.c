...
struct _mips2c_stack_func_809C42A8 {
    ...
    /* 0x58 */ char pad58[0x4];                     /* maybe part of sp56[3]? */
...
void EnEncount4_Init(EnEncount4 *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    EnEncount4 *this = (EnEncount4 *) thisx;

    temp_v0 = this->actor.params;
    this->unk14A = temp_v0 & 0x7F;
...
void EnEncount4_Destroy(EnEncount4 *this, GlobalContext *globalCtx) {
    EnEncount4 *this = (EnEncount4 *) thisx;
...
void EnEncount4_Update(EnEncount4 *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    EnEncount4 *this = (EnEncount4 *) thisx;
