...
void EnEncount4_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk14A = (s16) (temp_v0 & 0x7F);
    this->unk148 = (s16) (((s32) temp_v0 >> 0xC) & 0xF);
    if (this->unk14A == 0x7F) {
        this->unk14A = -1;
    }
    if (((s32) this->unk14A >= 0) && (this = this, (Flags_GetSwitch(globalCtx, (s32) this->unk14A) != 0))) {
...
void func_809C4078(EnEncount4 *this, GlobalContext *globalCtx) {
    ...
    if (gGameInfo->data[2401] == 0) {
        if ((this->unk154->unk0 != 0x28F) || (temp_s0->unk138 == 0)) {
            Actor_MarkForDeath(&this->actor);
            return;
        }
        temp_v1 = this->unk148;
        if ((temp_v1 != 0) || (this->actor.xzDistToPlayer < 240.0f)) {
            if ((temp_v1 == 0) && (temp_s0->unk2DC != 0)) {
                Actor_MarkForDeath(&this->actor);
                return;
            }
            phi_s6 = 0;
            if ((temp_v1 == 0) || (temp_s0->unk2DC != 0)) {
                ...
                if (phi_v0 < 5) {
                    ...
                    do {
                        ...
                        Actor_SpawnAsChild(temp_s4, &this->actor, globalCtx, 0x110, temp_f20, temp_f22, (*phi_s0 * Math_CosS(temp_s2)) + this->actor.world.pos.z, (s16) 0, (s16) (s32) this->actor.world.rot.y, (s16) 0, phi_s6);
                        temp_s0_2 = phi_s0 + 4;
                        phi_s1 += 2;
                        phi_s0 = temp_s0_2;
...
void func_809C42A8(EnEncount4 *this, GlobalContext *globalCtx) {
    ...
    temp_a2 = this->unk14A;
    if (((s32) temp_a2 >= 0) && (sp68 = this->unk154, (Flags_GetSwitch(globalCtx, (s32) temp_a2) != 0))) {
        this->unk150 = 0x64;
        this->actionFunc = func_809C464C;
        return;
    }
    if (this->unk148 == 1) {
        if ((*this->unk154 != 0x28F) || (this->unk154->unk138 == 0)) {
            Actor_MarkForDeath(&this->actor);
            return;
        }
        // Duplicate return node #20. Try simplifying control flow for better match
    ...
    if (((gSaveContext.weekEventReg[85] & 0x40) == 0) && ((s32) this->unk_14C < 2) && !(this->actor.xzDistToPlayer > 240.0f)) {
        ...
        temp_f0 = func_800C411C(&globalCtx->colCtx, &sp50, &sp4C, &this->actor, (Vec3f *) &sp5C);
        if (!(temp_f0 <= -32000.0f) && ((temp_f2 = sp6C->yDistToWater, (temp_f2 == -32000.0f)) || !(temp_f0 < (sp6C->world.pos.y - temp_f2)))) {
            ...
            sp64 = temp_f2_2;
            if (Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0xED, sp5C, sp60, temp_f2_2, (s16) 0, (s16) 0, (s16) 0, 0) != 0) {
                this->unk_14C += 1;
