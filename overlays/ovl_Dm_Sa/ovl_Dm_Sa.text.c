...
void DmSa_Init(DmSa *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
...
void DmSa_Destroy(DmSa *this, GlobalContext *globalCtx) {
    DmSa *this = (DmSa *) thisx;
...
void DmSa_Update(DmSa *this, GlobalContext *globalCtx) {
    SkelAnime *temp_a0;
    DmSa *this = (DmSa *) thisx;
...
void DmSa_Draw(DmSa *this, GlobalContext *globalCtx) {
