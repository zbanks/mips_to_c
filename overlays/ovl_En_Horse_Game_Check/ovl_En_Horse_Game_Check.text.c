...
static CollisionPoly D_808F9B30;                    /* unable to generate initializer */
static Vec3s D_808F9B50 = {{0xFFB0, 0, 0x50}, {0x50, 0, 0x50}, {0x50, 0, 0xFFB0}, {0xFFB0, 0, 0xFFB0}};
...
static InitChainEntry D_808F9BDC;                   /* unable to generate initializer */
...
typedef struct EnHorseGameCheck {
    ...
    /* 0x0164 */ char pad164[0x54];                 /* maybe part of unk160[22]? */
...
? func_808F8AA0(DynaPolyActor *arg0, GlobalContext *arg1) {
    ...
    temp_f0_2 = func_800C4000(arg1, &arg1->colCtx, (s32 *) &arg0->actor.floorPoly, &arg0->actor.world.pos);
    arg0->actor.floorHeight = temp_f0_2;
    arg0->actor.world.pos.y = temp_f0_2 + 3.0f;
    func_800C0094(arg0->actor.floorPoly, arg0->actor.world.pos.x, temp_f0_2, arg0->actor.world.pos.z, &sp38);
    SysMatrix_SetCurrentState(&sp38);
    ...
    sp2C = temp_a1;
    func_8018219C(&sp38, &temp_a1->rot, 1);
...
? func_808F8CCC(Actor *arg0, GlobalContext *arg1) {
    ...
    sp4C.x = D_808F9B94.unk0;
    sp4C.y = D_808F9B94.unk4;
    sp4C.z = D_808F9B94.unk8;
    sp40.x = D_808F9BA0.unk0;
    sp40.y = D_808F9BA0.unk4;
    sp40.z = D_808F9BA0.unk8;
    arg0->unk164 = 0;
    arg0->unk168 = 0;
    arg0->unk174 = 0;
    if ((gSaveContext.weekEventReg[92] & 7) != 1) {
        ...
        Play_CameraSetAtEye(arg1, 0, &sp40, &sp4C);
