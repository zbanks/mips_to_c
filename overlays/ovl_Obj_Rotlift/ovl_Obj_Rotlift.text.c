...
void func_80B95E20(ObjRotlift *arg0) {
    ...
    do {
        temp_s0 = *phi_s2;
        if (temp_s0->unk_138 == 0) {
            *phi_s2 = NULL;
        } else {
            temp_s0->unk_24 = (f32) ((Math_SinS(arg0->actor.shape.rot.y) * phi_f20) + arg0->actor.world.pos.x);
            temp_s0->unk_28 = (f32) (arg0->actor.world.pos.y + (380.0f * arg0->actor.scale.y));
            temp_s0->unk_2C = (f32) ((Math_CosS(arg0->actor.shape.rot.y) * phi_f20) + arg0->actor.world.pos.z);
            temp_s0->unk_BE = (s16) arg0->actor.shape.rot.y;
        }
        temp_s3 = phi_s3 + 1;
        phi_s2 += 4;
        phi_f20 -= 600.0f;
...
void ObjRotlift_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (sp54 == 0) {
        do {
            ...
            temp_s1 = phi_s1 + 1;
            temp_s2 = phi_s2 + 4;
            temp_s2->unk_-4 = Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, 0x183, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) (s32) this->actor.shape.rot.x, (s16) (s32) this->actor.shape.rot.y, (s16) (s32) this->actor.shape.rot.z, phi_v0);
            phi_s1 = temp_s1;
            phi_s2 = temp_s2;
        } while (temp_s1 != 2);
        func_80B95E20(this);
    ...
    BgCheck3_LoadMesh(globalCtx, (DynaPolyActor *) this, temp_s1_2->unk_8);
    temp_s1_2->unk_4 = Lib_SegmentedToVirtual(temp_s1_2->unk_4);
}
...
void ObjRotlift_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp1C = temp_v0;
    AnimatedMat_Draw(globalCtx, temp_v0->unk_4);
    func_800BDFC0(globalCtx, temp_v0->unk_0);
}
