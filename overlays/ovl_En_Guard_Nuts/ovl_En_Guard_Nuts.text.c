...
void EnGuardNuts_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk244, &this->actor, &D_80ABBDF0);
...
void func_80ABB854(Actor *arg0, GlobalContext *arg1) {
    ...
    sp3C.y = arg0->floorHeight;
    EffectSsHahen_SpawnBurst(arg1, &sp3C, 4.0f, 0, (s16) 0xA, (s16) 3, (s16) 0xF, (s16) -1, (s16) 0xA, NULL);
    arg0->unk23C = 0;
...
void func_80ABB990(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((gSaveContext.weekEventReg[23] & 0x20) == 0) {
        ...
        if (((phi_v1 >> 0x10) < 0x4000) && ((D_80ABBE20 == 0) || (arg0->xzDistToPlayer > 150.0f))) {
            ...
            sp40.y = arg0->floorHeight;
            EffectSsHahen_SpawnBurst(arg1, &sp40, 4.0f, 0, (s16) 0xA, (s16) 3, (s16) 0xF, (s16) -1, (s16) 0xA, NULL);
            Audio_PlayActorSound2(arg0, 0x387CU);
            D_80ABBE20 = 0;
            if (arg0->unk220 == 9) {
                arg0->unk224 = 1;
...
void EnGuardNuts_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80ABBC60, NULL, &this->actor);
