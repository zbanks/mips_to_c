typedef struct EnSyatekiDekunuts {
    ...
    /* 0x1DE */ char pad_1DE[0x4];                  /* maybe part of unk_1DC[3]? */
    /* 0x1E2 */ s16 unk_1E2;                        /* inferred */
    /* 0x1E4 */ void *unk_1E4;                      /* inferred */
    ...
    /* 0x1FA */ char pad_1FA[0x36];                 /* maybe part of unk_1F4[10]? */
    /* 0x230 */ Vec3s unk_230;                      /* inferred */
    /* 0x236 */ char pad_236[0x3A];                 /* maybe part of unk_230[10]? */
...
void EnSyatekiDekunuts_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->actor.params & 0xF) == 1) {
        ...
        this->unk_1CC = (unaligned s32) D_80A2CADC.unk_0;
        this->unk_1D0 = (unaligned s32) D_80A2CADC.unk_4;
        this->unk_1D4 = (unaligned s32) D_80A2CADC.unk_8;
        phi_v0 = 3;
    } else {
    ...
    SkelAnime_Init(globalCtx, &this->unk_144, &D_06002468, &D_06002A5C, &this->unk_1F4, &this->unk_230, 0xA);
    if (phi_s0_2 == 0) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    this->unk_1E4 = Lib_SegmentedToVirtual(phi_s0_2->points);
    this->unk_1E8 = (s16) ((s32) (this->actor.params & 0xF0) >> 4);
    this->unk_1D8 = 0;
    this->unk_1DC = 0;
    this->unk_1DA = 0;
    this->unk_1EA = (s16) phi_s0_2->count;
    func_80A2BE54(this);
}
...
void func_80A2BE54(EnSyatekiDekunuts *arg0) {
    ...
    arg0->actor.world.pos.x = temp_v0->unk_0;
    arg0->actor.world.pos.y = temp_v0->unk_4;
    arg0->actor.world.pos.z = temp_v0->unk_8;
    arg0->unk_30 = (s32) temp_v0->unk_C;
    arg0->unk_34 = (s32) temp_v0->unk_10;
    arg0->actor.prevPos.x = temp_v0->unk_0;
    arg0->actor.prevPos.y = temp_v0->unk_4;
    arg0->unk_BC = (unaligned s32) arg0->unk_30;
    arg0->unk_1D8 = 0;
    arg0->unk_1DC = 0;
    arg0->actor.prevPos.z = temp_v0->unk_8;
...
void func_80A2BF18(EnSyatekiDekunuts *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = temp_v0->unk_26A;
    if ((temp_v1 == 1) && (this->unk_1E2 == 1) && ((temp_v0->unk_272 & (1 << this->unk_1E8)) != 0)) {
        sp1C = temp_v0;
        func_80A2BFC4(1);
    } else if (temp_v1 != 1) {
        this->unk_1E2 = 1;
    }
    if ((this->actor.parent->unk_272 == 0) && (this->actor.parent->unk_274 == 0) && ((this->actor.params & 0xF) != 1)) {
        this->unk_1E2 = 1;
    }
}
...
void func_80A2BFC4(void *arg0) {
    ...
    sp14 = (f32) *(arg0->unk_1E4 + (arg0->unk_1E8 * 6));
...
void func_80A2C208(EnSyatekiDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_1F0 == 1) {
        Math_SmoothStepToS(&this->unk_1F2, -0x8000, 5, 0x1000, (s16) 0x100);
    }
    this->unk_1D8 += 1;
}
...
void func_80A2C2E0(EnSyatekiDekunuts *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_1D8;
    phi_v0 = temp_v0;
    if (((s32) this->unk_1EE < (s32) temp_v0) || (this->actor.parent->unk_26A != 1)) {
        func_80A2C3AC();
        phi_v0 = this->unk_1D8;
    }
    this->unk_1D8 = phi_v0 + 1;
}

void func_80A2C33C(EnSyatekiDekunuts *this, GlobalContext *globalCtx) {
    s16 temp_v0;

    if (((gSaveContext.unk_3DE0[1] == 0) && (*(&gSaveContext + 0x3DEC) == 0)) || (this->actor.parent->unk_26A != 1)) {
        func_80A2C3AC();
    }
    temp_v0 = this->unk_1D8;
    if ((s32) temp_v0 < 0xB) {
        this->unk_1D8 = temp_v0 + 1;
    }
}

void func_80A2C3AC(void *arg0) {
    func_800BDC5C(arg0 + 0x144, (ActorAnimationEntry []) D_80A2CAE8, 1);
    arg0->unk_188 = func_80A2C3F0;
}
...
void func_80A2C3F0(EnSyatekiDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.parent->unk_26A == 1) {
        ...
        if (((s32) this->unk_1D8 >= 0xA1) && (temp_a1 = this->unk_144.animFrameCount, this = this, (func_801378B8(temp_a0, temp_a1) != 0))) {
            this->unk_1D8 = 0;
            func_80A2C150(this);
            return;
        }
...
void func_80A2C4D0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->params & 0xF) == 1) {
        ...
        temp_v0->unk_280 = (s16) (temp_v0->unk_280 + 0x64);
        temp_v0->unk_26E = (s16) (temp_v0->unk_26E + 1);
    } else {
        sp2C = temp_v0;
        EffectSsExtra_Spawn(arg1, arg0 + 0x24, &D_80A2CBA0, &D_80A2CBAC, 5, 0);
        temp_v0->unk_280 = (s16) (temp_v0->unk_280 + 0x1E);
        temp_v0->unk_278 = (s16) (temp_v0->unk_278 + 1);
    }
...
void func_80A2C5DC(EnSyatekiDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (func_801378B8(temp_a0, this->unk_144.animFrameCount) != 0) {
        ...
        if ((s32) temp_v0 < 0xA0) {
            ...
            if ((this->actor.params & 0xF) != 1) {
                sp4C->unk_272 = (s16) (sp4C->unk_272 & ~(1 << this->unk_1E8));
            }
            func_80A2BE54(this);
            return;
        }
...
void EnSyatekiDekunuts_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80A2BF18 != this->actionFunc) && (temp_v0 = this->unk_1D8, (((s32) temp_v0 < (s32) this->unk_1EE) != 0)) && ((s32) temp_v0 >= 0xB)) {
        if (((this->unk_18C.base.acFlags & 2) != 0) && (this->unk_1E2 == 1)) {
            if ((this->actor.params & 0xF) == 1) {
...
void EnSyatekiDekunuts_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80A2BF18 != this->actionFunc) {
        SkelAnime_Draw(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, func_80A2C8A0, NULL, (Actor *) this);
    }
    if (this->unk_1EC == 1) {
        phi_s3 = 0;
        phi_s2 = 0;
        if ((s32) this->unk_1EA > 0) {
            do {
                temp_v0 = this->unk_1E4 + phi_s3;
                temp_f20 = (f32) temp_v0->unk_0;
                temp_f22 = (f32) temp_v0->unk_2;
                temp_f24 = (f32) temp_v0->unk_4;
                ...
                phi_s3 += 6;
                phi_s2 = temp_s2;
            } while (temp_s2 < (s32) sp6C->unk_1EA);
        }
    }
}
