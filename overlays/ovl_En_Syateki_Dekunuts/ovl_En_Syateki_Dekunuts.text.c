...
static ActorAnimationEntry D_80A2CAE8 = {
...
static InitChainEntry D_80A2CB90;                   /* unable to generate initializer */
...
typedef struct EnSyatekiDekunuts {
    ...
    /* 0x0188 */ void (*actionFunc)(EnSyatekiDekunuts *, GlobalContext *);
    /* 0x018C */ ColliderCylinder unk18C;           /* inferred */
    /* 0x01CC */ ? unk1CC;                          /* overlap; inferred */
    /* 0x01CD */ char pad1CD[0x3];
    /* 0x01D0 */ ? unk1D0;                          /* inferred */
    /* 0x01D1 */ char pad1D1[0x3];
    /* 0x01D4 */ ? unk1D4;                          /* inferred */
    /* 0x01D5 */ char pad1D5[0x3];
    /* 0x01D8 */ s16 unk1D8;                        /* inferred */
    /* 0x01DA */ s16 unk1DA;                        /* inferred */
    /* 0x01DC */ s16 unk1DC;                        /* inferred */
    /* 0x01DE */ char pad1DE[0x4];                  /* maybe part of unk1DC[3]? */
    ...
    /* 0x01FA */ char pad1FA[0x36];                 /* maybe part of unk1F4[10]? */
    /* 0x0230 */ Vec3s unk230;                      /* inferred */
    /* 0x0236 */ char pad236[0x3A];
...
void EnSyatekiDekunuts_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80A2CAB0);
...
void func_80A2C5DC(EnSyatekiDekunuts *this, GlobalContext *globalCtx) {
    ...
    if (func_801378B8(temp_a0, this->unk144.animFrameCount) != 0) {
        ...
        if ((s32) temp_v0 < 0xA0) {
            ...
            Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x1E, 0x3878U);
...
void EnSyatekiDekunuts_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80A2BF18 != this->actionFunc) && (temp_v0 = this->unk1D8, (((s32) temp_v0 < (s32) this->unk1EE) != 0)) && ((s32) temp_v0 >= 0xB)) {
        if (((this->unk18C.base.acFlags & 2) != 0) && (this->unk1E2 == 1)) {
            ...
            func_80A2C4D0(&this->actor, globalCtx);
        }
        temp_a2 = &this->unk18C;
        sp24 = temp_a2;
...
void EnSyatekiDekunuts_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80A2BF18 != this->actionFunc) {
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80A2C8A0, NULL, &this->actor);
    }
    if (this->unk1EC == 1) {
        phi_s3 = 0;
        phi_s2 = 0;
