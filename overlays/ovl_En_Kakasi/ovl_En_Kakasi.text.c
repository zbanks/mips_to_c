...
typedef struct EnKakasi {
    ...
    /* 0x198 */ char pad_198[0x8];                  /* maybe part of unk_196[5]? */
    /* 0x1A0 */ s32 unk_1A0;                        /* inferred */
    /* 0x1A4 */ s32 unk_1A4;                        /* inferred */
    /* 0x1A8 */ s32 unk_1A8;                        /* inferred */
    /* 0x1AC */ s16 unk_1AC;                        /* inferred */
    /* 0x1AE */ s16 unk_1AE;                        /* inferred */
    /* 0x1B0 */ char pad_1B0[0x4];                  /* maybe part of unk_1AE[3]? */
    /* 0x1B4 */ f32 unk_1B4;                        /* inferred */
    /* 0x1B8 */ f32 unk_1B8;                        /* inferred */
    /* 0x1BC */ f32 unk_1BC;                        /* inferred */
    /* 0x1C0 */ char pad_1C0[0x4];
    /* 0x1C4 */ f32 unk_1C4;                        /* inferred */
    /* 0x1C8 */ char pad_1C8[0x3C];                 /* maybe part of unk_1C4[16]? */
    /* 0x204 */ s16 unk_204;                        /* inferred */
    /* 0x206 */ char pad_206[0x2];
    /* 0x208 */ s16 unk_208;                        /* inferred */
    /* 0x20A */ char pad_20A[0x2];
    /* 0x20C */ f32 unk_20C;                        /* inferred */
    /* 0x210 */ f32 unk_210;                        /* inferred */
    /* 0x214 */ Vec3f unk_214;                      /* inferred */
    /* 0x220 */ Vec3f unk_220;                      /* inferred */
    /* 0x22C */ Vec3f unk_22C;                      /* inferred */
    /* 0x238 */ Vec3f unk_238;                      /* inferred */
    /* 0x23C */ f32 unk_23C;                        /* overlap; inferred */
    /* 0x240 */ f32 unk_240;                        /* overlap; inferred */
    /* 0x244 */ PosRot unk_244;                     /* inferred */
    /* 0x250 */ f32 unk_250;                        /* overlap; inferred */
    /* 0x254 */ ColliderCylinder unk_254;           /* overlap; inferred */
} EnKakasi;                                         /* size = 0x2A0 */
...
void EnKakasi_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk_254, (Actor *) this, &D_80971D80);
    SkelAnime_InitSV(globalCtx, &this->unk_14C, &D_060065B0, &D_06000214, NULL, NULL, 0);
    temp_f0 = (f32) (((s32) this->actor.params >> 8) & 0xFF) * 20.0f;
    this->unk_250 = temp_f0;
    if (temp_f0 < 40.0f) {
        this->unk_250 = 40.0f;
    }
    ...
    this->unk_1B8 = ((f32) temp_f8 * 20.0f) + 60.0f;
    if (((s32) temp_v0 > 0) && ((s32) temp_v0 < 8)) {
        this->actor.targetMode = temp_v0 - 1;
    }
    this->unk_194 = this->actor.params & 1;
...
void func_8096F800(EnKakasi *arg0, s32 arg1) {
    ...
    temp_v1 = arg0->unk_1A0;
    arg0->unk_1B4 = temp_f0;
...
void func_8096FAAC(EnKakasi *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk_208 != 0) {
        sp34 = temp_a0;
        Math_ApproachF(temp_a0, arg0->unk_238.x, 0.4f, 4.0f);
        Math_ApproachF(arg0 + 0x218, arg0->unk_238.y, 0.4f, 4.0f);
        Math_ApproachF(arg0 + 0x21C, arg0->unk_238.z, 0.4f, 4.0f);
        temp_a0_2 = arg0 + 0x220;
        sp30 = temp_a0_2;
        Math_ApproachF(temp_a0_2, arg0->unk_244.pos.x, 0.4f, 4.0f);
        Math_ApproachF(arg0 + 0x224, arg0->unk_244.pos.y, 0.4f, 4.0f);
        Math_ApproachF(arg0 + 0x228, arg0->unk_244.pos.z, 0.4f, 4.0f);
        Math_ApproachF(arg0 + 0x20C, arg0->unk_210, 0.3f, 10.0f);
        Play_CameraSetAtEye(arg1, arg0->unk_208, (Vec3f *) sp30, (Vec3f *) sp34);
        func_80169940(arg1, arg0->unk_208, arg0->unk_20C);
    }
}
...
void func_8096FBB8(EnKakasi *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg1->msgCtx.unk_12048;
    if ((temp_v0 == 0) || (temp_v0 == 1) || (temp_v0 == 2) || (temp_v0 == 3) || (temp_v0 == 4)) {
        arg0->unk_190 += 1;
    }
    if ((arg0->unk_190 != 0) && (arg0->unk_1A0 != 1)) {
        func_8096F800(arg0, 1);
    }
    phi_v0 = (s32) arg0->unk_190;
    if ((s32) arg0->unk_190 >= 9) {
        arg0->unk_190 = 8;
        phi_v0 = (s32) arg0->unk_190;
    }
    if (phi_v0 != 0) {
...
void func_8096FCC4(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 != -4) && (temp_v0 != -8) && (temp_v0_2 = gSaveContext.time, (temp_v0_2 != 0x4000)) && (temp_v0_2 != 0xC000) && ((gSaveContext.eventInf[1] & 0x80) == 0)) {
        if (this->actor.textId == 0) {
            ...
            this->unk_1AC = 5;
            temp_a2->unk_A6C = (s32) (temp_a2->unk_A6C | 0x20);
...
void func_8096FE00(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if (func_800B8718(this, globalCtx) != 0) {
        this->unk_14C.animPlaybackSpeed = 1.0f;
    ...
    if ((globalCtx->actorCtx.unk5 & 4) != 0) {
        ...
        if ((this->actor.projectedPos.z > -20.0f) && ((s32) sp22 > 0) && ((s32) sp22 < 0x140) && ((s32) sp20 > 0) && ((s32) sp20 < 0xF0) && (this->unk_1A0 != 1)) {
            func_8096F800(this, 1);
            this->unk_14C.animPlaybackSpeed = 2.0f;
        }
...
void func_8097006C(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    sp30 = this->unk_14C.animCurrentFrame;
    Math_SmoothStepToS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 5, 0x7D0, (s16) 0);
    if ((this->actor.textId != 0x1644) && (this->unk_1B4 <= sp30) && (this->unk_1A0 == 7)) {
        func_8096F800(this, 3);
        this->unk_1A4 = 0;
    }
    if (((this->actor.textId == 0x1651) || (this->actor.textId == 0x1659)) && (this->unk_1B4 <= sp30) && (this->unk_1A0 != 3)) {
        temp_t0 = this->unk_1A4 + 1;
        this->unk_1A4 = temp_t0;
        if (temp_t0 >= 2) {
            this->unk_1A4 = 0;
            func_8096F800(this, 3);
        }
    }
    if ((this->unk_1A8 == 2) && (this->unk_196 == 2)) {
        func_800B7298(globalCtx, (Actor *) this, 0x49U);
        this->unk_1A8 = 0;
    }
    if ((this->unk_1AC == func_80152498(&globalCtx->msgCtx)) && (func_80147624(globalCtx) != 0)) {
        func_801477B4(globalCtx);
        if (this->unk_1AC == 5) {
            if ((this->unk_196 == 2) && (this->actor.textId == 0x1647)) {
            ...
            if ((temp_v1 == 0x165D) || (temp_v1 == 0x165F) || (temp_v1 == 0x1660) || (temp_v1 == 0x1652)) {
                ...
                if (ActorCutscene_GetCurrentIndex() == 0x7C) {
                    ...
                    ActorCutscene_SetIntentToPlay(this->unk_1AE);
                    this->actionFunc = func_80970F20;
                    return;
                }
                if (ActorCutscene_GetCanPlayNext(this->unk_1AE) == 0) {
                    ActorCutscene_SetIntentToPlay(this->unk_1AE);
                    this->actionFunc = func_80970F20;
                    return;
                }
                ActorCutscene_StartAndSetUnkLinkFields(this->unk_1AE, (Actor *) this);
                this->unk_208 = ActorCutscene_GetCurrentCamera((s16) this->actor.cutscene);
                this->actionFunc = func_80970F20;
                return;
            }
...
void func_80970658(EnKakasi *this, GlobalContext *globalCtx) {
    if ((func_80152498(&globalCtx->msgCtx) == 5) && (func_80147624(globalCtx) != 0)) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(this->unk_1AE, (Actor *) this);
        this->unk_208 = ActorCutscene_GetCurrentCamera((s16) this->actor.cutscene);
        Math_Vec3f_Copy(&this->unk_22C, (Vec3f *) &this->actor.home);
        this->actionFunc = func_80970740;
...
block_6:
    if (phi_v1 == 1) {
        this->unk_22C.y = this->actor.home.pos.y + 50.0f;
        temp_v0 = (this->unk_190 * 0xC) + &D_80971DCC;
        temp_a1 = &this->unk_238;
        this->unk_238.x = temp_v0->unk_0;
        this->unk_23C = temp_v0->unk_4;
        this->unk_240 = temp_v0->unk_8;
        sp30 = temp_a1;
        ...
        Math_Vec3f_Copy(&this->unk_214, temp_a1);
        Math_Vec3f_Copy(&this->unk_220, (Vec3f *) sp34);
        ...
        if (temp_v0_2 == 4) {
            this->unk_190 = 0;
            this->unk_1A4 = 0;
            ActorCutscene_Stop(this->unk_1AE);
...
void func_80970978(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    phi_v0 = temp_v0;
    if ((temp_v0 == 0) && (this->unk_1A0 != 4)) {
        sp1C = this->unk_14C.animCurrentFrame;
        func_8096F800((EnKakasi *)4);
        this->unk_14C.animPlaybackSpeed = 2.0f;
        phi_v0 = this->unk_192;
    }
    if ((phi_v0 == 0) && (this->unk_1A0 == 4) && (this->unk_1B4 <= this->unk_14C.animCurrentFrame)) {
...
void func_80970A9C(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    sp40 = this->unk_14C.animCurrentFrame;
    Math_SmoothStepToS(&this->actor.shape.rot.y, this->actor.home.rot.y, 1, 0xBB8, (s16) 0);
    ...
    if ((this->actor.textId == 0x1648) && (this->unk_1A0 == 2) && (this->unk_1B4 <= sp40)) {
        temp_t4 = this->unk_1A4 + 1;
        this->unk_1A4 = temp_t4;
        if (temp_t4 >= 2) {
            func_8096F800(this, 0);
        }
    }
    if ((this->actor.textId == 0x164B) && (this->unk_1A0 == 0) && (this->unk_1B4 <= sp40)) {
        temp_t9 = this->unk_1A4 + 1;
        this->unk_1A4 = temp_t9;
        if (temp_t9 >= 2) {
            func_8096F800(this, 3);
        }
    }
...
block_18:
    if (this->unk_208 != 0) {
        ...
        func_8096FA18(this, globalCtx);
        temp_v0 = (this->unk_190 * 0xC) + &D_80971FA0;
        temp_a1 = &this->unk_238;
        this->unk_238.x = temp_v0->unk_0;
        this->unk_238.y = temp_v0->unk_4;
        this->unk_238.z = temp_v0->unk_8;
        sp2C = temp_a1;
        Math_Vec3f_Copy((Vec3f *) &sp34, temp_a1);
        OLib_DbCameraVec3fSum(sp30, (Vec3f *) &sp34, sp2C, 1);
        temp_v0_2 = (this->unk_190 * 0xC) + &D_80971FE8;
        this->unk_244.pos.x = temp_v0_2->unk_0 + this->unk_22C.x;
        this->unk_244.pos.y = temp_v0_2->unk_4 + this->unk_22C.y;
        this->unk_244.pos.z = temp_v0_2->unk_8 + this->unk_22C.z;
        Math_Vec3f_Copy(&this->unk_214, temp_a1);
        Math_Vec3f_Copy(&this->unk_220, (Vec3f *) &this->unk_244);
    }
    func_8096FAAC(this, globalCtx);
    if ((this->unk_1A8 != 0) && (this->unk_1AC == func_80152498(&globalCtx->msgCtx)) && (func_80147624(globalCtx) != 0)) {
        func_801477B4(globalCtx);
        if (this->unk_1AC == 5) {
            this->unk_190 += 1;
            if ((s32) this->unk_190 >= 6) {
                this->unk_190 = 5;
            }
...
void func_80970FF8(EnKakasi *arg0) {
    ...
    Math_Vec3f_Copy(&arg0->unk_22C, (Vec3f *) &arg0->actor.home);
    func_8016566C(0xB4);
...
void func_80971064(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    sp54 = this->unk_14C.animCurrentFrame;
    func_8096FA18(this, globalCtx);
    temp_a0 = &this->actor.shape.rot.y;
    sp3C = temp_a0;
    Math_SmoothStepToS(temp_a0, this->actor.home.rot.y, 1, 0xBB8, (s16) 0);
    this->unk_22C.y = this->actor.home.pos.y + 50.0f;
    temp_v1 = (this->unk_190 * 0xC) + &D_80971E38;
    temp_a1 = &this->unk_238;
    this->unk_238.x = temp_v1->unk_0;
    this->unk_238.y = temp_v1->unk_4;
    this->unk_238.z = temp_v1->unk_8;
    sp34 = temp_a1;
    Math_Vec3f_Copy((Vec3f *) &sp48, temp_a1);
    OLib_DbCameraVec3fSum(&this->actor.home, (Vec3f *) &sp48, sp34, 1);
    temp_v1_2 = this->unk_190;
    temp_v0 = (temp_v1_2 * 0xC) + &D_80971EEC;
    this->unk_244.pos.x = temp_v0->unk_0 + this->unk_22C.x;
    this->unk_244.pos.y = temp_v0->unk_4 + this->unk_22C.y;
    this->unk_244.pos.z = temp_v0->unk_8 + this->unk_22C.z;
    if ((temp_v1_2 != 6) && (temp_v1_2 != 7)) {
        Math_Vec3f_Copy(&this->unk_214, sp34);
        Math_Vec3f_Copy(&this->unk_220, (Vec3f *) &this->unk_244);
    }
    if (((s32) this->unk_190 >= 7) && ((s32) this->unk_190 != 0xE)) {
        this->actor.shape.rot.y += 0x800;
    }
    func_8096FAAC(this, globalCtx);
    temp_v1_3 = this->unk_190;
    switch (temp_v1_3) {
    case 0:
        this->unk_204 = 0x28;
        this->unk_190 = temp_v1_3 + 1;
        return;
    case 1:
        if ((this->unk_204 == 0) && (this->unk_1B4 <= sp54)) {
            this->unk_204 = 0x14;
            this->unk_190 = temp_v1_3 + 1;
            func_8096F800(this, 1);
            return;
    ...
    case 12:
    case 13:
        if ((this->unk_204 == 0) && (this->unk_190 = temp_v1_3 + 1, this->unk_204 = 0xA, (this->unk_190 == 0xE))) {
            func_800B7298(globalCtx, (Actor *) this, 0x49U);
            func_80165690();
            this->unk_204 = 0x14;
            return;
...
void func_80971440(EnKakasi *arg0) {
    ...
    phi_a2->unk_190 = 0;
    phi_a2->unk_1A4 = 0;
    phi_a2->unk_210 = 60.0f;
    phi_a2->unk_20C = 60.0f;
    arg0 = phi_a2;
    Math_Vec3f_Copy(&phi_a2->unk_22C, (Vec3f *) &phi_a2->actor.home);
    arg0->unk_196 = 4;
...
void func_809714BC(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_208 != 0) {
        temp_a1 = &this->unk_238;
        this->unk_22C.y = this->actor.home.pos.y + 50.0f;
        this->unk_238.x = D_80972030.unk_0;
        this->unk_238.y = D_80972030.unk_4;
        this->unk_238.z = D_80972030.unk_8;
        sp38 = temp_a1;
        Math_Vec3f_Copy((Vec3f *) &sp4C, temp_a1);
        OLib_DbCameraVec3fSum(&this->actor.home, (Vec3f *) &sp4C, sp38, 1);
        this->unk_244.pos.x = D_8097203C.unk_0 + this->unk_22C.x;
        this->unk_244.pos.y = D_8097203C.unk_4 + this->unk_22C.y;
        this->unk_244.pos.z = D_8097203C.unk_8 + this->unk_22C.z;
        Math_Vec3f_Copy(&this->unk_214, temp_a1);
        Math_Vec3f_Copy(&this->unk_220, (Vec3f *) &this->unk_244);
        func_8096FAAC(this, globalCtx);
    }
    ...
    if (temp_v0 < 0xF) {
        this->unk_1A4 = temp_v0 + 1;
        return;
    }
    this->actor.shape.rot.y += 0x3000;
    Math_SmoothStepToS(&this->unk_190, 0x1F4, 5, 0x32, (s16) 0);
...
void func_809717D0(EnKakasi *this, GlobalContext *globalCtx) {
    if (((gSaveContext.weekEventReg[79] & 8) != 0) && (this->actor.xzDistToPlayer < this->unk_250) && ((gGameInfo->data[2401] != 0) || (globalCtx->msgCtx.unk1202A == 0xD))) {
...
void func_8097185C(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCurrentIndex() == 0x7C) {
        sp24 = phi_a1;
        ActorCutscene_Stop(0x7C);
        ActorCutscene_SetIntentToPlay((this + (phi_a1 * 2))->unk_1AE);
        return;
    }
    temp_v1 = this + (phi_a1 * 2);
    sp20 = temp_v1;
    if (ActorCutscene_GetCanPlayNext(temp_v1->unk_1AE) == 0) {
        ActorCutscene_SetIntentToPlay(temp_v1->unk_1AE);
        return;
    }
    ActorCutscene_StartAndSetUnkLinkFields(temp_v1->unk_1AE, (Actor *) this);
    Audio_PlayActorSound2((Actor *) this, 0x3987U);
...
void EnKakasi_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0_2 = this->unk_204;
    if (temp_v0_2 != 0) {
        this->unk_204 = temp_v0_2 - 1;
    }
    if (this->unk_196 != 5) {
        if ((this->unk_1BC != 0.0f) || (this->unk_1C4 != 0.0f)) {
            Math_Vec3f_Copy((Vec3f *) &this->actor.focus, (Vec3f *) &this->unk_1BC);
...
void EnKakasi_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_14C.skeleton, this->unk_14C.limbDrawTbl, (s32) this->unk_14C.dListCount, NULL, func_80971CE0, (Actor *) this);
}
