...
typedef struct EnKakasi {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*unk144)(GlobalContext *, Actor *); /* inferred */
    /* 0x0148 */ void (*actionFunc)(EnKakasi *, GlobalContext *);
    ...
    /* 0x0198 */ char pad198[0x8];                  /* maybe part of unk196[5]? */
    ...
    /* 0x01B0 */ char pad1B0[0x4];                  /* maybe part of unk1AE[3]? */
    /* 0x01B4 */ f32 unk1B4;                        /* inferred */
    /* 0x01B8 */ f32 unk1B8;                        /* inferred */
    /* 0x01BC */ f32 unk1BC;                        /* inferred */
    /* 0x01C0 */ char pad1C0[0x4];                  /* maybe part of unk1BC[2]? */
    /* 0x01C4 */ f32 unk1C4;                        /* inferred */
    /* 0x01C8 */ char pad1C8[0x3C];                 /* maybe part of unk1C4[16]? */
    /* 0x0204 */ s16 unk204;                        /* inferred */
    /* 0x0206 */ char pad206[0x2];                  /* maybe part of unk204[2]? */
    ...
    /* 0x0214 */ Vec3f unk214;                      /* inferred */
    /* 0x0220 */ Vec3f unk220;                      /* inferred */
    /* 0x022C */ Vec3f unk22C;                      /* inferred */
    /* 0x0238 */ f32 unk238;                        /* inferred */
    /* 0x023C */ f32 unk23C;                        /* inferred */
    /* 0x0240 */ f32 unk240;                        /* inferred */
    /* 0x0244 */ PosRot unk244;                     /* inferred */
    /* 0x0250 */ f32 unk250;                        /* overlap; inferred */
...
void EnKakasi_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk254, &this->actor, &D_80971D80);
...
void func_8096FAAC(EnKakasi *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk208 != 0) {
        sp34 = temp_a0;
        Math_ApproachF(temp_a0, arg0->unk238, 0.4f, 4.0f);
        Math_ApproachF(arg0 + 0x218, arg0->unk23C, 0.4f, 4.0f);
        Math_ApproachF(arg0 + 0x21C, arg0->unk240, 0.4f, 4.0f);
...
void func_8096FE00(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if ((globalCtx->actorCtx.unk5 & 4) != 0) {
        func_800B8898(globalCtx, &this->actor, &sp22, &sp20);
...
void func_8097006C(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk1A8 == 2) && (this->unk196 == 2)) {
        func_800B7298(globalCtx, &this->actor, 0x49U);
        this->unk1A8 = 0;
    }
    if ((this->unk1AC == func_80152498(&globalCtx->msgCtx)) && (func_80147624(globalCtx) != 0)) {
        ...
        if (this->unk1AC == 5) {
            ...
            if ((temp_v1 == 0x165D) || (temp_v1 == 0x165F) || (temp_v1 == 0x1660) || (temp_v1 == 0x1652)) {
                ...
                ActorCutscene_StartAndSetUnkLinkFields(this->unk1AE, &this->actor);
...
block_6:
    if (phi_v1 == 1) {
        ...
        temp_a1 = &this->unk238;
        this->unk238 = temp_v0->unk0;
        this->unk23C = temp_v0->unk4;
        this->unk240 = temp_v0->unk8;
        sp30 = temp_a1;
        sp34 = &this->actor.home;
        sp38 = &this->unk22C;
        Math_Vec3f_Copy(&sp3C, (Vec3f *) temp_a1);
        OLib_DbCameraVec3fSum(sp34, &sp3C, (Vec3f *) sp30, 1);
        temp_a0 = &this->unk244;
        sp34 = temp_a0;
        Math_Vec3f_Copy(&temp_a0->pos, sp38);
        Math_Vec3f_Copy(&this->unk214, (Vec3f *) temp_a1);
        Math_Vec3f_Copy(&this->unk220, &sp34->pos);
...
void func_80970A9C(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if (this->unk190 == 0) {
        ...
        func_801518B0(globalCtx, 0x1648U & 0xFFFF, &this->actor);
        this->unk1A8 = 0;
        this->unk190 = 1;
    }
...
block_18:
    if (this->unk208 != 0) {
        ...
        this->unk240 = temp_v0->unk8;
        sp2C = temp_a1;
        Math_Vec3f_Copy(&sp34, (Vec3f *) temp_a1);
        OLib_DbCameraVec3fSum(sp30, &sp34, (Vec3f *) sp2C, 1);
        ...
        Math_Vec3f_Copy(&this->unk214, (Vec3f *) temp_a1);
        Math_Vec3f_Copy(&this->unk220, &this->unk244.pos);
    }
    func_8096FAAC(this, globalCtx);
...
void func_80970FF8(EnKakasi *arg0) {
    ...
    Math_Vec3f_Copy(&arg0->unk22C, &arg0->actor.home.pos);
    func_8016566C(0xB4);
...
void func_80971064(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    temp_a1 = &this->unk238;
    this->unk238 = temp_v1->unk0;
    this->unk23C = temp_v1->unk4;
    this->unk240 = temp_v1->unk8;
    sp34 = temp_a1;
    Math_Vec3f_Copy(&sp48, (Vec3f *) temp_a1);
    OLib_DbCameraVec3fSum(&this->actor.home, &sp48, (Vec3f *) sp34, 1);
    ...
    if ((temp_v1_2 != 6) && (temp_v1_2 != 7)) {
        Math_Vec3f_Copy(&this->unk214, (Vec3f *) sp34);
        Math_Vec3f_Copy(&this->unk220, &this->unk244.pos);
    }
...
void func_80971440(EnKakasi *arg0) {
    ...
    phi_a2->unk20C = 60.0f;
    arg0 = phi_a2;
    Math_Vec3f_Copy(&phi_a2->unk22C, &phi_a2->actor.home.pos);
    arg0->unk196 = 4;
...
void func_809714BC(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if (this->unk208 != 0) {
        temp_a1 = &this->unk238;
        this->unk22C.y = this->actor.home.pos.y + 50.0f;
        this->unk238 = D_80972030.unk0;
        this->unk23C = D_80972030.unk4;
        this->unk240 = D_80972030.unk8;
        sp38 = temp_a1;
        Math_Vec3f_Copy(&sp4C, (Vec3f *) temp_a1);
        OLib_DbCameraVec3fSum(&this->actor.home, &sp4C, (Vec3f *) sp38, 1);
    ...
    if ((globalCtx->gameplayFrames & 3) == 0) {
        sp38 = &temp_a1_2->pos.x;
        Math_Vec3f_Copy(&sp40, &temp_a1_2->pos);
        sp40.y = this->actor.floorHeight;
        sp40.x += randPlusMinusPoint5Scaled(2.0f);
        sp40.z += randPlusMinusPoint5Scaled(2.0f);
        if (globalCtx->sceneNum == 0x34) {
            EffectSsGSplash_Spawn(globalCtx, &sp40, NULL, NULL, (s16) 0, (s16) (s32) (randPlusMinusPoint5Scaled(100.0f) + 200.0f));
            Audio_PlaySoundAtPosition(globalCtx, &sp40, 0x32, 0x2817U);
        } else {
            func_800BBDAC(globalCtx, &this->actor, (Vec3f *) sp38, this->actor.shape.shadowScale - 20.0f, 5, 4.0f, (s16) 0xC8, (s16) 0xA, (u8) 1);
...
void func_8097185C(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    ActorCutscene_StartAndSetUnkLinkFields(temp_v1->unk1AE, &this->actor);
    Audio_PlayActorSound2(&this->actor, 0x3987U);
...
void func_8097193C(EnKakasi *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.shape.yOffset < -10.0f) {
        if ((globalCtx->gameplayFrames & 7) == 0) {
            func_800BBDAC(globalCtx, &this->actor, &this->actor.world.pos, this->actor.shape.shadowScale - 20.0f, 0xA, 8.0f, (s16) 0x1F4, (s16) 0xA, (u8) 1);
            Audio_PlayActorSound2(&this->actor, 0x3987U);
        }
...
void EnKakasi_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk196 != 5) {
        if ((this->unk1BC != 0.0f) || (this->unk1C4 != 0.0f)) {
            Math_Vec3f_Copy(&this->actor.focus.pos, (Vec3f *) &this->unk1BC);
...
void EnKakasi_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk14C.skeleton, this->unk14C.limbDrawTbl, (s32) this->unk14C.dListCount, NULL, func_80971CE0, &this->actor);
}
