typedef struct ObjHugebombiwa {
    ...
    /* 0x190 */ char pad190[0x324];                 /* maybe part of unk144[11]? */
...
struct _mips2c_stack_func_80A541F4 {
    ...
    /* 0x100 */ char pad100[0x10];
};                                                  /* size = 0x110 */

struct _mips2c_stack_func_80A54600 {
    /* 0x00 */ char pad0[0xA0];
    /* 0xA0 */ f32 spA0;                            /* inferred */
    /* 0xA4 */ char padA4[0x1C];                    /* maybe part of spA0[8]? */
    /* 0xC0 */ f32 spC0;                            /* inferred */
    /* 0xC4 */ f32 spC4;                            /* inferred */
...
void ObjHugebombiwa_Init(ObjHugebombiwa *this, GlobalContext *globalCtx) {
...
void ObjHugebombiwa_Destroy(ObjHugebombiwa *this, GlobalContext *globalCtx) {
    ObjHugebombiwa *this = (ObjHugebombiwa *) thisx;
...
void ObjHugebombiwa_Update(ObjHugebombiwa *this, GlobalContext *globalCtx) {
    ObjHugebombiwa *this = (ObjHugebombiwa *) thisx;
    this->actionFunc(this, globalCtx);
}

void ObjHugebombiwa_Draw(ObjHugebombiwa *this, GlobalContext *globalCtx) {
    f32 sp38;
    Gfx *temp_s1;
    Gfx *temp_v0_10;
    Gfx *temp_v0_11;
