...
typedef struct EnBombers {
    ...
    /* 0x0284 */ void (*actionFunc)(EnBombers *, GlobalContext *);
    ...
    /* 0x02AE */ char pad2AE[0x2];                  /* maybe part of unk2AC[2]? */
    ...
    /* 0x02C2 */ char pad2C2[0x2];                  /* maybe part of unk2C0[2]? */
    /* 0x02C4 */ s32 unk2C4;                        /* inferred */
    /* 0x02C8 */ ColliderCylinder unk2C8;           /* inferred */
...
void EnBombers_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2C8, &this->actor, &D_80C04770);
    this->actor.targetMode = 0;
    Actor_SetScale(&this->actor, 0.01f);
    temp_v0 = this->actor.params;
    this->unk2BC = ((s32) temp_v0 >> 4) & 0xF;
    this->unk2BE = temp_v0 & 0xF;
    if (this->unk2BC == 0) {
    ...
    if ((((gSaveContext.weekEventReg[73] & 0x10) != 0) || ((gSaveContext.weekEventReg[85] & 2) != 0)) && (((temp_v0_2 = this->unk2BE, (temp_v0_2 == 0)) && ((gSaveContext.weekEventReg[76] & 1) != 0)) || ((temp_v0_2 == 1) && ((gSaveContext.weekEventReg[76] & 2) != 0)) || ((temp_v0_2 == 2) && ((gSaveContext.weekEventReg[76] & 4) != 0)) || ((temp_v0_2 == 3) && ((gSaveContext.weekEventReg[76] & 8) != 0)) || ((temp_v0_2 == 4) && ((gSaveContext.weekEventReg[76] & 0x10) != 0)))) {
...
void EnBombers_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnBombers *this = (EnBombers *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk2C8);
}
...
void func_80C038B4(Actor *arg0) {
    ...
    temp_s0 = arg0 + 0x144;
    if ((arg0->unk2C4 == 2) && ((func_801378B8(temp_s0, 9.0f) != 0) || (func_801378B8(temp_s0, 10.0f) != 0) || (func_801378B8(temp_s0, 17.0f) != 0) || (func_801378B8(temp_s0, 18.0f) != 0))) {
        Audio_PlayActorSound2(arg0, 0x292CU);
    }
    temp_s0_2 = arg0 + 0x144;
    if ((arg0->unk2C4 == 0xF) && ((func_801378B8((SkelAnime *) temp_s0_2, 0.0f) != 0) || (func_801378B8((SkelAnime *) temp_s0_2, 2.0f) != 0) || (func_801378B8((SkelAnime *) temp_s0_2, 4.0f) != 0) || (func_801378B8((SkelAnime *) temp_s0_2, 6.0f) != 0))) {
        Audio_PlayActorSound2(arg0, 0x292CU);
    }
}
...
void func_80C03ACC(EnBombers *arg0) {
    arg0->unk2C8.dim.radius = 0xA;
    arg0->unk2C8.dim.height = 0x1E;
    arg0->unk2C0 = 0;
...
void func_80C03AF4(EnBombers *this, GlobalContext *globalCtx) {
    ...
    sp78 = this->unk144.animCurrentFrame;
    temp_v0 = this->unk2A0;
    if (temp_v0 != 0) {
        if (temp_v0 != 1) {
            ...
            if (sp78 >= 0.0f) {
                this->unk2A4 = Math_Vec3f_Yaw(&this->actor.world.pos, &this->unk294);
                Math_SmoothStepToS(&this->actor.world.rot.y, this->unk2A4, 0xA, 0x7D0, (s16) 0x14);
            }
            temp_a1 = &this->actor.world;
            temp_v1 = this->actor.world.rot.y - this->unk2A4;
            phi_v0 = temp_v1;
            if ((s32) temp_v1 < 0) {
                phi_v0 = (s16) -(s32) temp_v1;
            }
            if (((s32) phi_v0 < 0x100) && (sp38 = temp_a1, Math_Vec3f_Copy(&sp54, &temp_a1->pos), sp54.x += Math_SinS(this->actor.world.rot.y) * 60.0f, sp54.z += Math_CosS(this->actor.world.rot.y) * 60.0f, (func_800C55C4(&globalCtx->colCtx, &temp_a1->pos, &sp54, &sp6C, &sp7C, 1U, 0U, 0U, 1U, &sp48) != 0))) {
                this->unk2A8 = 0;
                ...
                if ((this->unk2AA == 0) || (sqrtf((temp_f2 * temp_f2) + (temp_f14 * temp_f14)) < 4.0f)) {
                    this->unk2A8 = Rand_S16Offset(0x14, 0x14);
                    if ((this->unk2A8 & 1) == 0) {
                        func_80C03824(this, 0x10, 1.0f);
                    } else {
                        func_80C03824(this, 0, 1.0f);
        ...
        sp38 = temp_a0;
        sp60.z += temp_f0;
        if ((s32) (s16) (this->actor.world.rot.y - Math_Vec3f_Yaw(&temp_a0->pos, &sp60)) < 0) {
            phi_v1 = (s32) (s16) (this->actor.world.rot.y - Math_Vec3f_Yaw(&sp38->pos, &sp60)) * -0x10000;
        } else {
            phi_v1 = (this->actor.world.rot.y - Math_Vec3f_Yaw(&temp_a0->pos, &sp60)) << 0x10;
        }
        if (((phi_v1 >> 0x10) < 0x4000) && (func_800C55C4(&globalCtx->colCtx, &sp38->pos, &sp60, &sp6C, &sp7C, 1U, 0U, 0U, 1U, &sp48) == 0)) {
            func_80C03824(this, 2, 1.0f);
            Math_Vec3f_Copy(&this->unk294, &sp60);
            this->unk2AA = Rand_S16Offset(0x1E, 0x32);
            this->unk2A0 += 1;
        }
    }
    ...
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        this->unk2C8.dim.radius = 0x14;
        this->unk2C8.dim.height = 0x3C;
        this->unk2A4 = this->actor.yawTowardsPlayer;
        func_80C03F64(this);
        return;
    }
...
void func_80C03F64(EnBombers *arg0) {
    arg0->unk2A4 = arg0->actor.yawTowardsPlayer;
...
void func_80C03FAC(EnBombers *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, this->unk2A4, 1, 0x1388, (s16) 0);
    temp_v1 = sp2C->unk14B;
    ...
    if ((this->unk2A6 == func_80152498(&globalCtx->msgCtx)) && (func_80147624(globalCtx) != 0)) {
        sp2A = 0;
...
void EnBombers_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk2AA;
    if (temp_v0 != 0) {
        this->unk2AA = temp_v0 - 1;
    }
    temp_v0_2 = this->unk2A8;
    if (temp_v0_2 != 0) {
        this->unk2A8 = temp_v0_2 - 1;
    }
    ...
    func_80C038B4(&this->actor);
    Actor_SetHeight(&this->actor, 20.0f);
    this->actionFunc(this, globalCtx);
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    Math_SmoothStepToS(&this->unk28A, this->unk290, 1, 0x1388, (s16) 0);
    Math_SmoothStepToS(&this->unk288, this->unk28E, 1, 0x1388, (s16) 0);
    if (this->unk2BA == 0) {
        this->unk2B8 += 1;
        if ((s32) this->unk2B8 >= 3) {
            this->unk2B8 = 0;
            this->unk2BA = (s32) Rand_ZeroFloat(60.0f) + 0x14;
        }
    }
...
void EnBombers_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp38 = temp_v0;
    sp38->words.w1 = Lib_SegmentedToVirtual(*(&D_80C0482C + (this->unk2B8 * 4)));
    temp_v0_2 = temp_s1->polyOpa.p;
    temp_s1->polyOpa.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xDB060024;
    sp34 = temp_v0_2;
    sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_80C04838 + (this->unk2BE * 4)));
    temp_v0_3 = temp_s1->polyOpa.p;
    temp_s1->polyOpa.p = temp_v0_3 + 8;
    temp_v0_3->words.w0 = 0xDB060028;
    sp30 = temp_v0_3;
    sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80C04818 + (this->unk2BE * 4)));
    Scene_SetRenderModeXlu(globalCtx, 0, 1U);
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80C045B4, NULL, &this->actor);
}
