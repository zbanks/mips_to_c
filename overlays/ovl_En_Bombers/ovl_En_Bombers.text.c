typedef struct EnBombers {
    ...
    /* 0x2AE */ char pad2AE[0x6];                   /* maybe part of unk2AC[4]? */
    ...
    /* 0x2C0 */ char pad2C0[0x8];                   /* maybe part of unk2BE[5]? */
    /* 0x2C8 */ ColliderCylinder unk2C8;            /* inferred */
...
void EnBombers_Init(EnBombers *this, GlobalContext *globalCtx) {
    Actor *temp_v0_3;
    s16 temp_v0;
    s16 temp_v0_2;
    s16 temp_v0_4;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2C8, (Actor *) this, &D_80C04770);
...
void EnBombers_Destroy(EnBombers *this, GlobalContext *globalCtx) {
    EnBombers *this = (EnBombers *) thisx;
...
void func_80C03AF4(EnBombers *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        if (temp_v0 != 1) {
            ...
            if (sp78 >= 0.0f) {
                this->unk2A4 = Math_Vec3f_Yaw((Vec3f *) &this->actor.world, &this->unk294);
        ...
        if (((phi_v1 >> 0x10) < 0x4000) && (func_800C55C4(&globalCtx->colCtx, (Vec3f *) sp38, (Vec3f *) &sp60, (Vec3f *) &sp6C, &sp7C, 1U, 0U, 0U, 1U, &sp48) == 0)) {
            ...
            Math_Vec3f_Copy(&this->unk294, (Vec3f *) &sp60);
...
void EnBombers_Update(EnBombers *this, GlobalContext *globalCtx) {
...
void EnBombers_Draw(EnBombers *this, GlobalContext *globalCtx) {
    Gfx *sp38;
    Gfx *sp34;
    Gfx *sp30;
    Gfx *temp_v0;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80C045B4, NULL, (Actor *) this);
}
