...
void EnBigPo_IdleFlying(Actor *arg0, void *arg1) {
    ...
    if (Actor_XZDistanceToPoint(arg0, (Vec3f *) temp_a1) > 300.0f) {
        arg0->unk208 = Actor_YawToPoint(arg0, (Vec3f *) temp_a1);
    }
...
void func_80B64880(Actor *arg0, GlobalContext *arg1) {
    ...
    Lights_PointGlowSetInfo(arg0 + 0x348, (s16) (s32) (sp58 + sp64), (s16) (s32) (sp5C + sp68), (s16) (s32) (sp60 + sp6C), (u8) (s32) arg0->unk294, (u8) (s32) arg0->unk295, (u8) (s32) arg0->unk296, (s16) (s32) arg0->unk297);
