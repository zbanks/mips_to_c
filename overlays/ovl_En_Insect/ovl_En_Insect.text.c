typedef struct EnInsect {
    ...
    /* 0x188 */ char pad188[0x1C];
    /* 0x1A4 */ SkelAnime unk1A4;                   /* inferred */
    /* 0x1E8 */ Vec3s unk1E8;                       /* inferred */
    /* 0x1EE */ char pad1EE[0x8A];                  /* maybe part of unk1E8[24]? */
    /* 0x278 */ Vec3s unk278;                       /* inferred */
    /* 0x27E */ char pad27E[0x8A];                  /* maybe part of unk278[24]? */
    /* 0x308 */ void (*actionFunc)(EnInsect *, GlobalContext *);
    /* 0x30C */ u16 unk30C;                         /* inferred */
...
void EnInsect_Init(EnInsect *this, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, (ColliderJntSph *) temp_a1_2, (Actor *) this, &D_8091BDA8, (ColliderJntSphElement *) &this->unk144.limbDrawTbl);
...
void func_8091AE5C(EnInsect *this, GlobalContext *globalCtx) {
    ...
    sp28 = temp_a1;
    sp2C = temp_a0;
    if ((func_8091A8C4((f32 *) temp_a0, temp_a1) > 1600.0f) || ((s32) this->unk312 < 4)) {
...
void func_8091B07C(EnInsect *this, GlobalContext *globalCtx) {
    ...
    sp28 = temp_a1;
    sp2C = temp_a0;
    if ((func_8091A8C4((f32 *) temp_a0, temp_a1) > 25600.0f) || ((s32) this->unk312 < 4)) {
        Math_ScaledStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) temp_a1), 0x7D0);
    } else if (sp38 != 0) {
...
block_14:
        ...
        if (Actor_HasParent((Actor *) this, globalCtx) != 0) {
            ...
            if (((this->unk30C & 8) == 0) && ((s32) D_8091BD60 < 4) && (func_8091A8F4(this, globalCtx) != 0) && (func_800B8A1C((Actor *) this, globalCtx, 0xBA, 60.0f, 30.0f) != 0)) {
                D_8091BD60 += 1;
            }
        }
