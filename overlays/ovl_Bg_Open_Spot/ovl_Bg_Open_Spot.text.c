...
void BgOpenSpot_Init(BgOpenSpot *this, GlobalContext *globalCtx) {
...
void BgOpenSpot_Destroy(BgOpenSpot *this, GlobalContext *globalCtx) {
    BgOpenSpot *this = (BgOpenSpot *) thisx;

}

void BgOpenSpot_Update(BgOpenSpot *this, GlobalContext *globalCtx) {
    u16 temp_v1;
    BgOpenSpot *this = (BgOpenSpot *) thisx;
