...
typedef struct EnScRuppe {
    ...
    /* 0x0190 */ void (*actionFunc)(EnScRuppe *, GlobalContext *);
...
void func_80BD6A8C(EnScRuppe *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk156 & 2) != 0) {
        ...
        this = this;
        Audio_PlayActorSound2(&temp_a0->actor, 0x4803U);
...
void func_80BD6B18(EnScRuppe *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 >= 0x1F) {
        ...
        Actor_SetScale(&this->actor, (30.0f - (f32) this->unk194) * 0.001f);
    }
...
void EnScRuppe_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, temp_a1, &this->actor, &D_80BD6E40);
...
void EnScRuppe_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80BD6910(&this->actor, globalCtx);
}
