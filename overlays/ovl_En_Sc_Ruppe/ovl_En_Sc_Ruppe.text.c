...
void func_80BD6A8C(EnScRuppe *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_156 & 2) != 0) {
        ...
        func_801159EC(*(&D_80BD6E14 + (this->unk_196 * 8)));
...
void func_80BD6B18(EnScRuppe *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 >= 0x1F) {
        if (func_80BD697C(this->unk_196) != 0) {
        ...
        Actor_SetScale((Actor *) this, (30.0f - (f32) this->unk_194) * 0.001f);
    }
...
void EnScRuppe_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_196 = this->actor.params & 0x1F;
...
void EnScRuppe_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp20 = temp_v0_2;
    sp20->words.w1 = Lib_SegmentedToVirtual(*(&D_80BD6E10 + (this->unk_196 * 8)));
