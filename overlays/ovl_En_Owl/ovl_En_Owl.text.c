...
void func_8095B3DC(EnOwl *this, GlobalContext *globalCtx); /* static */
void func_8095B480(EnOwl *arg0, GlobalContext *arg1); /* static */
void func_8095B574(EnOwl *arg0, GlobalContext *arg1); /* static */
void func_8095B9FC(EnOwl *this, GlobalContext *globalCtx); /* static */
void func_8095BF58(EnOwl *this, GlobalContext *globalCtx); /* static */
void func_8095BF78(Actor *arg0, GlobalContext *arg1); /* static */
void func_8095C09C(EnOwl *arg0, ? arg1);            /* static */
void func_8095C258(EnOwl *this, GlobalContext *globalCtx); /* static */
void func_8095C328(EnOwl *this, GlobalContext *globalCtx); /* static */
void func_8095C408(EnOwl *this, GlobalContext *globalCtx); /* static */
void func_8095C484(EnOwl *this, GlobalContext *globalCtx); /* static */
...
static InitChainEntry D_8095D31C;                   /* unable to generate initializer */
...
typedef struct EnOwl {
    ...
    /* 0x01DA */ char pad1DA[0x78];                 /* maybe part of unk1D4[21]? */
    /* 0x0252 */ Vec3s unk252;                      /* inferred */
    /* 0x0258 */ char pad258[0x78];                 /* maybe part of unk252[21]? */
    /* 0x02D0 */ SkelAnime unk2D0;                  /* inferred */
    /* 0x0314 */ Vec3s unk314;                      /* inferred */
    /* 0x031A */ char pad31A[0x5A];                 /* maybe part of unk314[16]? */
    /* 0x0374 */ Vec3s unk374;                      /* inferred */
    /* 0x037A */ char pad37A[0x5A];                 /* maybe part of unk374[16]? */
    /* 0x03D4 */ SkelAnime *unk3D4;                 /* inferred */
    ...
    /* 0x03E4 */ char pad3E4[0x4];                  /* maybe part of unk3E2[3]? */
    /* 0x03E8 */ u16 unk3E8;                        /* inferred */
    ...
    /* 0x03F4 */ void *unk3F4;                      /* inferred */
    /* 0x03F8 */ s32 unk3F8;                        /* inferred */
    /* 0x03FA */ s16 unk3FA;                        /* overlap; inferred */
    /* 0x03FC */ s32 unk3FC;                        /* inferred */
    /* 0x0400 */ s16 unk400;                        /* inferred */
    /* 0x0402 */ char pad402[0x4];                  /* maybe part of unk400[3]? */
    /* 0x0406 */ s16 unk406;                        /* inferred */
    /* 0x0408 */ u8 unk408;                         /* inferred */
    /* 0x0409 */ u8 unk409;                         /* inferred */
    /* 0x040A */ u8 unk40A;                         /* inferred */
    /* 0x040B */ u8 unk40B;                         /* inferred */
    /* 0x040C */ u8 unk40C;                         /* inferred */
    /* 0x040D */ u8 unk40D;                         /* inferred */
    /* 0x040E */ char pad40E[0x2];                  /* maybe part of unk40D[3]? */
    /* 0x0410 */ void (*actionFunc)(EnOwl *, GlobalContext *);
    /* 0x0414 */ void (*unk414)(EnOwl *, GlobalContext *); /* inferred */
} EnOwl;                                            /* size 0x418 */
...
void EnOwl_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_8095D31C);
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, &this->actor, &D_8095D2F0);
...
void func_8095AEC0(EnOwl *this, GlobalContext *globalCtx) {
    ...
    if (func_8095A978(&this->actor, globalCtx, 0x7D0U, 360.0f, 200.0f) != 0) {
        func_801A3098(0x45U);
...
void func_8095AFEC(EnOwl *this, GlobalContext *globalCtx) {
    func_8095A920(this, globalCtx);
    if (func_8095A978(&this->actor, globalCtx, 0xBF6U, 200.0f, 100.0f) != 0) {
        func_801A3098(0x45U);
...
void func_8095B574(EnOwl *arg0, GlobalContext *arg1) {
    ...
    if (func_800B84D0(&arg0->actor, arg1) != 0) {
        ...
        func_800B8500(&arg0->actor, arg1, 200.0f, 400.0f, 0);
    } else {
...
void func_8095BE0C(EnOwl *arg0, GlobalContext *arg1) {
    ...
    if (arg0->actor.textId == 0xBF0) {
        if (arg0->actor.isTargeted != 0) {
            func_800B8500(&arg0->actor, arg1, 200.0f, 200.0f, 0);
            return;
        }
        // Duplicate return node #8. Try simplifying control flow for better match
        return;
...
void func_8095BF20(EnOwl *arg0, GlobalContext *arg1) {
    func_8095A9FC(&arg0->actor, (GlobalContext *)0x7D0);
...
void func_8095C258(EnOwl *arg0) {
    ...
    arg0->unk3EA = 6;
    SkelAnime_ChangeAnim(arg0->unk3D4, &D_06001ADC, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(&D_06001ADC.common), (u8) 2, 5.0f);
}
...
void func_8095C328(EnOwl *arg0, GlobalContext *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(arg0->unk3D4) != 0) {
        ...
        if ((s32) temp_v0 > 0) {
            ...
            temp_a0 = arg0->unk3D4;
            SkelAnime_ChangeAnim(temp_a0, temp_a0->animCurrentSeg, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(&arg0->unk3D4->animCurrentSeg->common), (u8) 2, 0.0f);
            return;
        }
        arg0->unk3EA = 0xA0;
...
void EnOwl_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.update != 0) {
        if ((&D_06001ADC == this->unk190.animCurrentSeg) && (func_801378B8(&this->unk190, 4.0f) != 0)) {
            Audio_PlayActorSound2(&this->actor, 0x3926U);
        }
        if ((this->unk3E8 & 2) != 0) {
            this->unk3E0 = 2;
        } else {
...
void EnOwl_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, temp_v0_2->skeleton, temp_v0_2->limbDrawTbl, (s32) temp_v0_2->dListCount, func_8095CE18, func_8095CF44, &this->actor);
}
