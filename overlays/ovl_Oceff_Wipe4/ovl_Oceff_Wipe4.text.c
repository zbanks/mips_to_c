...
struct _mips2c_stack_OceffWipe4_Destroy {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_OceffWipe4_Draw {
    /* 0x00 */ char pad0[0x58];
...
struct _mips2c_stack_OceffWipe4_Init {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_OceffWipe4_Update {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

? func_800E01B8(f32 *, Camera *);                   /* extern */
? func_80115D5C(GlobalContext *);                   /* extern */
static u8 D_8099E3CF[31] = {
    0xFF,
    0,
    0x8F,
    0,
