struct _mips2c_stack_ObjHsStump_Appear {
    /* 0x00 */ char pad0[0x5C];
    /* 0x5C */ ? sp5C;                              /* inferred */
    /* 0x5C */ char pad5C[0x10];
    /* 0x6C */ ? sp6C;                              /* inferred */
    /* 0x6C */ char pad6C[0x10];
...
void ObjHsStump_Init(ObjHsStump *this, GlobalContext *globalCtx) {
    u8 temp_v0;
...
void ObjHsStump_Destroy(ObjHsStump *this, GlobalContext *globalCtx) {
    ObjHsStump *this = (ObjHsStump *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->dyna.bgId);
}

void ObjHsStump_Update(ObjHsStump *this, GlobalContext *globalCtx) {
    ObjHsStump *this = (ObjHsStump *) thisx;
    this->actionFunc(this, globalCtx);
}

void ObjHsStump_Draw(ObjHsStump *this, GlobalContext *globalCtx) {
    ObjHsStump *this = (ObjHsStump *) thisx;
