...
static InitChainEntry D_80AE9888;                   /* unable to generate initializer */
...
typedef struct ObjBigicicle {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(ObjBigicicle *, GlobalContext *);
...
void ObjBigicicle_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80AE9888);
    ...
    temp_f2 = (f32) phi_v0;
    sp28 = temp_f2;
    Actor_SetScale(&this->actor, temp_f2 * 0.001f);
    ...
    sp24 = temp_a1;
    sp30 = temp_f0;
    Collider_InitAndSetCylinder(globalCtx, temp_a1, &this->actor, &D_80AE9820);
    ...
    Collider_InitAndSetCylinder(globalCtx, temp_a1_2, &this->actor, &D_80AE984C);
    ...
    Collider_UpdateCylinder(&this->actor, (bitwise ColliderCylinder *) sp28);
    if (D_80AE9890 == 0) {
...
void func_80AE9258(ObjBigicicle *this, GlobalContext *globalCtx) {
    ...
    if (temp_s0 != 0) {
loop_1:
        if ((phi_s0->id == 0x8E) && (temp_f0 = this->actor.world.pos.y - phi_s0->world.pos.y, (temp_f0 < (f32) phi_s0->unk18E)) && (temp_f0 > 0.0f) && (Actor_XZDistanceBetweenActors(&this->actor, phi_s0) < (f32) phi_s0->unk18C)) {
...
block_7:
    ...
    Collider_UpdateCylinder(&this->actor, &this->unk198);
}
...
void func_80AE939C(ObjBigicicle *this, GlobalContext *globalCtx) {
    ...
    Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x28, 0x28FAU);
    ActorCutscene_Stop((s16) this->actor.cutscene);
    Actor_MarkForDeath(&this->actor);
}
