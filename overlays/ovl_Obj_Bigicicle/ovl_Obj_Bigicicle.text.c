...
void ObjBigicicle_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a1_2 = &this->unk_198;
    this->unk_14C.dim.radius = (s16) (s32) ((f32) this->unk_14C.dim.radius * temp_f0);
    this->unk_14C.dim.height = (s16) (s32) ((f32) this->unk_14C.dim.height * temp_f0);
    this->unk_14C.dim.yShift = (s16) (s32) ((f32) this->unk_14C.dim.yShift * temp_f0);
    sp28 = (bitwise f32) temp_a1_2;
    Collider_InitAndSetCylinder(globalCtx, temp_a1_2, (Actor *) this, &D_80AE984C);
    this->unk_198.dim.radius = (s16) (s32) ((f32) this->unk_198.dim.radius * temp_f0);
    this->unk_198.dim.height = (s16) (s32) ((f32) this->unk_198.dim.height * temp_f0);
    this->unk_198.dim.yShift = (s16) (s32) ((f32) this->unk_198.dim.yShift * temp_f0);
...
void func_80AE8FD4(ObjBigicicle *this, GlobalContext *globalCtx) {
    ...
    temp_a2 = this;
    if (((temp_a2->unk_14C.base.acFlags & 2) != 0) || (((temp_a2->unk_198.base.acFlags & 2) != 0) && ((temp_a2->unk_198.info.acHitInfo->toucher.dmgFlags & 0x3820) != 0))) {
        if ((temp_a2->unk_148 == 0) || (temp_a0 = temp_a2, (temp_a2->unk_149 == 1))) {
            this = temp_a2;
...
void func_80AE9090(ObjBigicicle *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext((s16) this->actor.cutscene) != 0) {
        ...
        if (this->unk_149 == 2) {
            ...
            this->unk_14C.dim.yShift += (s16) temp_f10;
            this->unk_198.dim.yShift += (s16) temp_f10;
            return;
        }
        this->unk_14A = 0x32;
        this->actionFunc = func_80AE9180;
...
void func_80AE9180(ObjBigicicle *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        this->actor.shape.rot.x = (s32) (randPlusMinusPoint5Scaled(1408.0f) * 0.02f * (f32) this->unk_14A) + 0x4000;
        this->actor.shape.rot.z = (s16) (s32) (randPlusMinusPoint5Scaled(1408.0f) * 0.02f * (f32) this->unk_14A);
        return;
    }
    this->actor.shape.rot.x = 0x4000;
...
block_7:
    ...
    Collider_UpdateCylinder((Actor *) this, &this->unk_14C);
    Collider_UpdateCylinder((Actor *) this, &this->unk_198);
}
...
void ObjBigicicle_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ObjBigicicle *this = (ObjBigicicle *) thisx;
    func_800BE03C(globalCtx, *(&D_80AE989C + (this->unk_149 * 4)));
    func_800BE03C(globalCtx, *(&D_80AE98A8 + (this->unk_149 * 4)));
