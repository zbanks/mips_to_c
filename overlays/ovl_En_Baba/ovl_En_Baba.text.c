typedef struct EnBaba {
    ...
    /* 0x14C */ char pad14C[0x4];
    /* 0x150 */ SkelAnime unk150;                   /* inferred */
    /* 0x194 */ ColliderCylinder unk194;            /* inferred */
    /* 0x1D4 */ s16 unk1D4;                         /* overlap; inferred */
    /* 0x1D6 */ s16 unk1D6;                         /* inferred */
    /* 0x1D8 */ char pad1D8[0x8];                   /* maybe part of unk1D6[5]? */
    /* 0x1E0 */ s16 unk1E0;                         /* inferred */
    /* 0x1E2 */ char pad1E2[0x2];
    /* 0x1E4 */ Path *unk1E4;                       /* inferred */
    /* 0x1E8 */ s16 unk1E8;                         /* inferred */
    /* 0x1EA */ char pad1EA[0x1C];                  /* maybe part of unk1E8[15]? */
    /* 0x206 */ Vec3s unk206;                       /* inferred */
    /* 0x20C */ char pad20C[0x66];                  /* maybe part of unk206[18]? */
    /* 0x272 */ Vec3s unk272;                       /* inferred */
    /* 0x278 */ char pad278[0x18C];                 /* maybe part of unk272[67]? */
    /* 0x404 */ s16 unk404;                         /* inferred */
    /* 0x406 */ char pad406[0x4];                   /* maybe part of unk404[3]? */
    /* 0x40A */ u16 unk40A;                         /* inferred */
    /* 0x40C */ s32 unk40C;                         /* inferred */
    /* 0x410 */ char pad410[0x24];                  /* maybe part of unk40C[10]? */
    /* 0x434 */ u8 unk434;                          /* inferred */
    /* 0x435 */ char pad435[0x1];
    /* 0x436 */ s16 unk436;                         /* inferred */
    /* 0x438 */ char pad438[0x8];                   /* maybe part of unk436[5]? */
} EnBaba;                                           /* size = 0x440 */
...
s32 func_80BA8D2C(Actor *arg0, f32 arg1) {
    ...
    if ((func_8013D68C(arg0->unk1E4, arg0->unk1E8, (void *) &sp2C) != 0) && (func_8013D768(arg0, (void *) &sp2C, sp3E) != 0)) {
...
? func_80BA9160(Actor *arg0, GlobalContext *arg1) {
    ...
    sp54 = 0;
    sp50 = 0;
    func_8013AF00((void *) &sp7C, 3, arg0->unk410->count + 3);
    temp_s1 = arg0 + 0x414;
    phi_s1 = temp_s1;
    if (arg0->unk438 == 0) {
        temp_v0 = arg0 + 0x42C;
        ...
        sp48 = temp_a1;
        sp40 = temp_v0;
        func_8013B6B0(arg0->unk410, temp_a1, temp_a2, arg0->unk428, arg0->unk424, temp_v0, (void *) &sp7C, (Vec3f *) &sp58, (s16) (s32) arg0->unk436);
        func_8013B878(arg1, arg0->unk410, arg0->unk42C, (Vec3f *) &sp58);
        arg0->unk438 = 1;
    ...
    if (func_8013B6B0(arg0->unk410, sp48, sp44, arg0->unk428, arg0->unk424, sp40, (void *) &sp7C, phi_s1, (s16) (s32) arg0->unk436) != 0) {
        arg0->unk43C = 1;
    } else {
...
void func_80BA9B80(EnBaba *this, GlobalContext *globalCtx) {
    ...
    if ((func_80133038(globalCtx, &D_80BAA488, (struct_80133038_arg2 *) &sp20) == 0) || ((sp20 != this->unk434) && (func_80BA9110((u8 *) this, globalCtx, &sp20) == 0))) {
        this->unk40A &= 0xFF7F;
        this->actor.flags &= -2;
        sp20 = 0;
    } else {
...
void func_80BA9CD4(EnBaba *this, GlobalContext *globalCtx) {
    ...
    sp2C = SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BAA3A0[this->unk40C].animation);
    this->unk1D6 = 0x25;
    this->unk1D4 = 0x17;
    if (this->unk40C == 3) {
        temp_a0 = &this->unk150;
...
void EnBaba_Init(EnBaba *this, GlobalContext *globalCtx) {
...
void EnBaba_Destroy(EnBaba *this, GlobalContext *globalCtx) {
    EnBaba *this = (EnBaba *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk194);
}

void EnBaba_Update(EnBaba *this, GlobalContext *globalCtx) {
    EnBaba *this = (EnBaba *) thisx;
...
void func_80BAA198(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.unk0 = (s32) D_80BAA4D4.unk0;
    sp18.unk4 = (s32) D_80BAA4D4.unk4;
    sp18.unk8 = (s32) D_80BAA4D4.unk8;
    if (arg1 == 7) {
...
void EnBaba_Draw(EnBaba *this, GlobalContext *globalCtx) {
    f32 sp54;
    f32 sp50;
    f32 sp4C;
    f32 sp48;
    ...
    if ((this->unk40A & 2) != 0) {
        ...
        func_801343C0(globalCtx, this->unk150.skeleton, this->unk150.limbDrawTbl, (s32) this->unk150.dListCount, func_80BA9FB0, func_80BAA198, func_80BAA20C, (Actor *) this);
