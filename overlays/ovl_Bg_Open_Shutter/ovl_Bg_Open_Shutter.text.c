...
void BgOpenShutter_Init(BgOpenShutter *this, GlobalContext *globalCtx) {
...
void BgOpenShutter_Destroy(BgOpenShutter *this, GlobalContext *globalCtx) {
...
void BgOpenShutter_Update(BgOpenShutter *this, GlobalContext *globalCtx) {
    u16 temp_v1;
    BgOpenShutter *this = (BgOpenShutter *) thisx;
...
void BgOpenShutter_Draw(BgOpenShutter *this, GlobalContext *globalCtx) {
    BgOpenShutter *this = (BgOpenShutter *) thisx;
