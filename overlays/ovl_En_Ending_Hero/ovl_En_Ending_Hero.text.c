...
void EnEndingHero_Init(EnEndingHero *this, GlobalContext *globalCtx) {
...
void EnEndingHero_Destroy(EnEndingHero *this, GlobalContext *globalCtx) {
    EnEndingHero *this = (EnEndingHero *) thisx;
...
void EnEndingHero_Update(EnEndingHero *this, GlobalContext *globalCtx) {
    EnEndingHero *this = (EnEndingHero *) thisx;
    if (this->unk240 == 0) {
        this->unk242 += 1;
...
void EnEndingHero_Draw(EnEndingHero *this, GlobalContext *globalCtx) {
    s32 sp40;
    Gfx *sp34;
    Gfx *sp30;
    Gfx *temp_v0;
