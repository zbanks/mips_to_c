...
static ActorAnimationEntryS D_80BB3EF4 = {
...
typedef struct EnGeg {
    ...
    /* 0x015C */ f32 unk15C;                        /* overlap; inferred */
    /* 0x0160 */ char pad160[0x28];                 /* maybe part of unk15C[11]? */
    /* 0x0188 */ void (*actionFunc)(EnGeg *, GlobalContext *);
    /* 0x018C */ ColliderCylinder unk18C;           /* inferred */
    /* 0x01D8 */ ColliderCylinder unk1D8;           /* inferred */
    /* 0x0224 */ char pad224[0xC];
    /* 0x0230 */ u16 unk230;                        /* inferred */
    /* 0x0232 */ s16 unk232;                        /* inferred */
    /* 0x0234 */ char pad234[0x4];                  /* maybe part of unk232[3]? */
    /* 0x0238 */ s16 unk238;                        /* inferred */
    /* 0x023A */ char pad23A[0x4];                  /* maybe part of unk238[3]? */
    /* 0x023E */ s16 unk23E;                        /* inferred */
    /* 0x0240 */ s16 unk240;                        /* inferred */
    /* 0x0242 */ char pad242[0x2];                  /* maybe part of unk240[2]? */
    ...
    /* 0x0252 */ char pad252[0x66];                 /* maybe part of unk24C[18]? */
    /* 0x02B8 */ Vec3s unk2B8;                      /* inferred */
    /* 0x02BE */ char pad2BE[0x1D8];
    /* 0x0496 */ u16 unk496;                        /* inferred */
    /* 0x0498 */ s16 unk498;                        /* inferred */
    /* 0x049A */ s16 unk49A;                        /* inferred */
    /* 0x049C */ s16 unk49C;                        /* inferred */
    /* 0x049E */ s16 unk49E;                        /* inferred */
    /* 0x04A0 */ s16 unk4A0;                        /* inferred */
    /* 0x04A2 */ s16 unk4A2;                        /* inferred */
    /* 0x04A4 */ s16 unk4A4;                        /* inferred */
    /* 0x04A6 */ s16 unk4A6;                        /* inferred */
    /* 0x04A8 */ s16 unk4A8;                        /* inferred */
    /* 0x04AA */ s16 unk4AA;                        /* inferred */
    /* 0x04AC */ s32 unk4AC;                        /* inferred */
    /* 0x04B0 */ s16 unk4B0;                        /* inferred */
    /* 0x04B2 */ char pad4B2[0x2];                  /* maybe part of unk4B0[2]? */
    /* 0x04B4 */ Vec3f unk4B4;                      /* inferred */
    /* 0x04C0 */ char pad4C0[0x18];                 /* maybe part of unk4B4[3]? */
    /* 0x04D8 */ s16 unk4D8;                        /* inferred */
    /* 0x04DA */ char pad4DA[0x2];                  /* maybe part of unk4D8[2]? */
    /* 0x04DC */ s32 unk4DC;                        /* inferred */
    /* 0x04E0 */ s16 unk4E0;                        /* inferred */
    /* 0x04E2 */ char pad4E2[0x2];                  /* maybe part of unk4E0[2]? */
    /* 0x04E4 */ Vec3f unk4E4;                      /* inferred */
} EnGeg;                                            /* size 0x4F0 */
...
s32 func_80BB1B14(EnGeg *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 != 0) && (arg0->unk4B0 = Math_Vec3f_Yaw(arg0 + 0x24, &temp_v0->world.pos), (func_80BB18FC(arg0, temp_v0) != 0))) {
        return 1;
    }
...
loop_4:
        if ((phi_s0->id == 9) && (func_80BB18FC(arg0, phi_s0) != 0)) {
            arg0->unk4B0 = Math_Vec3f_Yaw(arg0 + 0x24, &phi_s0->world.pos);
...
? func_80BB1D64(Actor *arg0, GlobalContext *arg1) {
    ...
    sp38 += 70.0f;
    Math_SmoothStepToS(arg0 + 0x468, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk46C), 4, 0x2AA8, (s16) 1);
    ...
    Math_SmoothStepToS(arg0 + 0x46C, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk468), 4, 0x2AA8, (s16) 1);
...
void func_80BB221C(EnGeg *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        ...
        globalCtx = globalCtx;
        sp27 = temp_a2;
        if ((func_800B84D0(&this->actor, temp_a1_2) != 0) && (temp_v1 = this->unk230, ((temp_v1 & 4) != 0))) {
            if (temp_a2 == 1) {
                this->unk496 = 0xD66;
            ...
            func_801518B0(globalCtx, this->unk496, &this->actor);
    ...
    if ((gSaveContext.weekEventReg[35] & 0x40) != 0) {
        temp_a1_4 = globalCtx;
        globalCtx = globalCtx;
        if ((func_800B84D0(&this->actor, temp_a1_4) != 0) && ((this->unk230 & 8) != 0)) {
            this->unk496 = 0xD62;
            func_801518B0(globalCtx, 0xD62U & 0xFFFF, &this->actor);
            this->unk230 &= 0xFFF7;
    ...
    globalCtx = globalCtx;
    if ((func_800B84D0(&this->actor, temp_a1_3) != 0) && ((this->unk230 & 8) != 0)) {
        gSaveContext.weekEventReg[35] |= 0x40;
        this->unk496 = 0xD5E;
        this->unk49A = this->unk49C;
        func_801518B0(globalCtx, 0xD5EU & 0xFFFF, &this->actor);
        this->actionFunc = func_80BB2520;
        this->unk230 &= 0xFFF7;
        this->actor.flags &= 0xFFFEFFFF;
        return;
...
void func_80BB2520(EnGeg *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->unk498) != 0) {
        ActorCutscene_StartAndSetFlag(this->unk498, &this->actor);
        temp_t3 = this->unk496;
        this->unk230 |= 0x10;
        switch (temp_t3) {
        case 3422:
...
void func_80BB2944(EnGeg *this, GlobalContext *globalCtx) {
    ...
    if (this->unk4AC == 0x13) {
        if (sp24 == SkelAnime_GetFrameCount(&(&D_80BB3EF4)[this->unk4AC].animationSeg->common)) {
            this->unk4AC = 6;
            func_80BB2020(this, globalCtx);
            return;
        }
...
void func_80BB2E00(EnGeg *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = SkelAnime_GetFrameCount(&(&D_80BB3EF4)[this->unk4AC].animationSeg->common);
    temp_v1 = this->unk4AC;
    if (temp_v1 == 2) {
        sp2C = temp_v0;
        ...
        if (func_801378B8(&this->unk144, 24.0f) != 0) {
            Audio_PlayActorSound2(&this->actor, 0x3867U);
            return;
        }
    ...
    if (temp_v1 == 4) {
        ...
        if (func_801378B8(temp_a0, 24.0f) != 0) {
            Audio_PlayActorSound2(&this->actor, 0x38B1U);
        }
        // Duplicate return node #12. Try simplifying control flow for better match
    }
}
...
void func_80BB2F7C(EnGeg *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&this->actor.world.pos, &this->unk4E4), 4, 0x3E8, (s16) 1);
    ...
    if ((this->actor.bgCheckFlags & 1) != 0) {
        temp_v0 = this->unk230;
        if ((temp_v0 & 0x80) != 0) {
            func_800B9010(&this->actor, 0x3203U);
            return;
        }
...
void func_80BB3318(EnGeg *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 < 2) {
        sp30 = temp_a0;
        sp46 = Math_Vec3f_Yaw(&temp_a0->pos, (temp_v0 * 0xC) + &D_80BB4044);
        sp40 = Math_Vec3f_DistXZ(&temp_a0->pos, (this->unk4D8 * 0xC) + &D_80BB4044);
        Math_SmoothStepToS(&this->actor.world.rot.y, sp46, 4, 0x3E8, (s16) 1);
        if (sp40 < 20.0f) {
            this->unk4D8 += 1;
        }
        this->actor.shape.rot.y = this->actor.world.rot.y;
        func_800AE930(&globalCtx->colCtx, Effect_GetParams(this->unk4DC), &sp30->pos.x, 18.0f, (s16) (s32) this->actor.shape.rot.y, this->actor.floorPoly, (s32) this->actor.floorBgId);
    }
...
void EnGeg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80BB3E9C);
    temp_a1_2 = &this->unk1D8;
    sp30 = temp_a1_2;
    Collider_InitSphere(globalCtx, (ColliderSphere *) temp_a1_2);
    Collider_SetSphere(globalCtx, (ColliderSphere *) temp_a1_2, &this->actor, &D_80BB3E70);
    ...
    Effect_Add(globalCtx, &this->unk4DC, 4, 0U, (u8) 0, &sp34);
...
void EnGeg_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80BB2088(&this->actor, globalCtx);
    func_80BB1C8C(this);
    func_8013D9C8(globalCtx, &this->unk238, &this->unk232, 3);
    func_80BB1D04(this);
    func_80BB178C(&this->actor, globalCtx);
}
