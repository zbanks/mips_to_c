typedef struct EnRuppecrow {
    /* 0x000 */ Actor actor;
    /* 0x144 */ char pad144[0x50];
    /* 0x194 */ SkelAnime unk194;                   /* inferred */
    /* 0x1D8 */ void (*actionFunc)(EnRuppecrow *, GlobalContext *);
    /* 0x1DC */ char pad1DC[0x4];
    /* 0x1E0 */ Vec3s unk1E0;                       /* inferred */
    /* 0x1E6 */ char pad1E6[0x30];                  /* maybe part of unk1E0[9]? */
    /* 0x216 */ Vec3s unk216;                       /* inferred */
    /* 0x21C */ char pad21C[0x30];                  /* maybe part of unk216[9]? */
    /* 0x24C */ Path *unk24C;                       /* inferred */
    /* 0x250 */ char pad250[0x4];
    /* 0x254 */ ColliderJntSph unk254;              /* inferred */
    /* 0x274 */ ColliderJntSphElement unk274;       /* inferred */
    /* 0x2B4 */ char pad2B4[0x50];                  /* maybe part of unk274[2]? */
...
void EnRuppecrow_Init(EnRuppecrow *this, GlobalContext *globalCtx) {
    ColliderJntSph *sp34;
    ...
    Collider_InitAndSetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80BE39D4, &this->unk274);
...
void EnRuppecrow_Destroy(EnRuppecrow *this, GlobalContext *globalCtx) {
    EnRuppecrow *this = (EnRuppecrow *) thisx;
    Collider_DestroyJntSph(globalCtx, &this->unk254);
}

void EnRuppecrow_Update(EnRuppecrow *this, GlobalContext *globalCtx) {
    EnRuppecrow *this = (EnRuppecrow *) thisx;
...
void EnRuppecrow_Draw(EnRuppecrow *this, GlobalContext *globalCtx) {
    EnRuppecrow *this = (EnRuppecrow *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk194.skeleton, this->unk194.limbDrawTbl, (s32) this->unk194.dListCount, NULL, NULL, (Actor *) this);
}
