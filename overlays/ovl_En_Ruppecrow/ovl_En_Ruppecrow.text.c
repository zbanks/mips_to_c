...
static InitChainEntry D_80BE3A0C;                   /* unable to generate initializer */

typedef struct EnRuppecrow {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ char pad144[0x50];
    /* 0x0194 */ SkelAnime unk194;                  /* inferred */
    /* 0x01D8 */ void (*actionFunc)(EnRuppecrow *, GlobalContext *);
    /* 0x01DC */ char pad1DC[0x4];                  /* maybe part of actionFunc[2]? */
    /* 0x01E0 */ Vec3s unk1E0;                      /* inferred */
    /* 0x01E6 */ char pad1E6[0x30];                 /* maybe part of unk1E0[9]? */
    /* 0x0216 */ Vec3s unk216;                      /* inferred */
    /* 0x021C */ char pad21C[0x30];                 /* maybe part of unk216[9]? */
    /* 0x024C */ Path *unk24C;                      /* inferred */
    /* 0x0250 */ char pad250[0x4];                  /* maybe part of unk24C[2]? */
    /* 0x0254 */ ColliderJntSph unk254;             /* inferred */
    /* 0x0274 */ ColliderJntSphElement unk274;      /* inferred */
    /* 0x02B4 */ char pad2B4[0x50];
...
? func_80BE2260(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = arg1;
    arg0->unk270->unk30 = (s16) (s32) arg0->world.pos.x;
    arg0->unk270->unk32 = (s16) (s32) ((f32) D_80BE39E0->unk1C + arg0->world.pos.y);
    arg0->unk270->unk34 = (s16) (s32) arg0->world.pos.z;
    arg1 = arg1;
...
void func_80BE2808(EnRuppecrow *arg0) {
    ...
    phi_s0 = 0;
    do {
        temp_a0 = (arg0 + (phi_s0 * 4))->unk144;
        if ((temp_a0 != 0) && (temp_a0->unk152 == 0)) {
...
void func_80BE2874(Actor *arg0, GlobalContext *arg1) {
    ...
    sp40 = phi_f0;
    if ((func_80BE2794(arg1) != 0) && (temp_v0_2 = arg0->unk2BC, (((s32) temp_v0_2 % 5) == 4))) {
        if (temp_v0_2 == 0x13) {
            ...
            temp_s0 = arg0 + (sp3A * 4);
            temp_s0->unk144 = temp_v0_3;
            temp_v0_3->gravity = -5.0f;
            temp_s0->unk144->velocity.y = 0.0f;
            Audio_PlayActorSound2(arg0, 0x28D9U);
            temp_s0->unk144->unk152 = 0x3C;
            temp_v0_4 = temp_s0->unk144;
            ...
            temp_s0_2->unk144 = temp_v0_5;
            temp_v0_5->gravity = -5.0f;
            temp_s0_2->unk144->velocity.y = 0.0f;
            Audio_PlayActorSound2(arg0, 0x28D9U);
            temp_s0_2->unk144->unk152 = 0x3C;
            temp_v0_6 = temp_s0_2->unk144;
            temp_v0_6->flags |= 0x10;
        }
    } else if (arg0->unk2BC == 0x13) {
        ...
        temp_s0_3->unk144 = temp_v0_7;
        temp_v0_7->gravity = -5.0f;
        temp_s0_3->unk144->velocity.y = 0.0f;
        Audio_PlayActorSound2(arg0, 0x28D9U);
        temp_s0_3->unk144->unk152 = 0x3C;
        temp_v0_8 = temp_s0_3->unk144;
        ...
        temp_s0_4->unk144 = temp_v0_9;
        temp_v0_9->gravity = -5.0f;
        temp_s0_4->unk144->velocity.y = 0.0f;
        Audio_PlayActorSound2(arg0, 0x28D9U);
        temp_s0_4->unk144->unk152 = 0x3C;
        temp_v0_10 = temp_s0_4->unk144;
...
void func_80BE2B80(Actor *arg0, GlobalContext *arg1) {
    ...
    func_80BE2668(arg0->unk24C, arg0->unk250, arg0 + 0x24, &sp30);
    ...
    if ((arg0->unk2B4 & 1) != 0) {
        if (func_80BE24CC(arg0, arg0->unk24C, arg0->unk250) != 0) {
            temp_v0 = arg0->unk250;
            if (temp_v0 <= 0) {
                arg0->unk250 = (s32) (*arg0->unk24C - 1);
            } else {
                arg0->unk250 = (s32) (temp_v0 - 1);
            }
            if ((func_80BE3354 == arg0->unk1D8) && ((func_80BE2794(arg1) == 0) || (((s32) arg0->unk250 % 2) == 0))) {
    ...
    if (func_80BE2330(arg0, arg0->unk24C, arg0->unk250) != 0) {
        temp_v0_2 = arg0->unk250;
        if (temp_v0_2 >= (*arg0->unk24C - 1)) {
            arg0->unk250 = 0;
        } else {
            arg0->unk250 = (s32) (temp_v0_2 + 1);
        }
        if ((func_80BE3354 == arg0->unk1D8) && ((func_80BE2794(arg1) == 0) || (((s32) arg0->unk250 % 2) == 0))) {
            func_80BE2874(arg0, arg1);
        }
...
s32 func_80BE2D4C(GlobalContext *arg0) {
    ...
    if (arg0->msgCtx.unk1202A == 3) {
        temp_a0 = arg0->actorCtx.actorList[2].first->unk14B;
        if (temp_a0 != 1) {
            if (temp_a0 != 2) {
                if (temp_a0 != 3) {
                    if (temp_a0 != 4) {
...
void func_80BE2E18(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v1 != 1) {
        if (temp_v1 != 2) {
            if (temp_v1 != 3) {
                ...
                } else if (temp_v0->unkA6C & 0x800000) {
                    arg0->unk2B8 = 16.0f;
                } else {
                    arg0->unk2B8 = 7.0f;
                }
    ...
    } else if ((temp_v0->unkA74 & 0x1000) != 0) {
        arg0->unk2B8 = 19.0f;
    } else {
        arg0->unk2B8 = 7.0f;
    }
    ...
    arg0->unk1B0 = (f32) (temp_f0 / 6.0f);
    if (temp_f2 > 800.0f) {
        arg0->unk2B8 = (f32) (temp_f0 * 0.5f);
        return;
    }
    if (temp_f2 > 500.0f) {
        arg0->unk2B8 = (f32) (temp_f0 * 0.8f);
        return;
    }
    if (temp_f2 < 150.0f) {
        arg0->unk2B8 = (f32) (temp_f0 * 1.2f);
    }
}
...
void func_80BE2F6C(Actor *arg0) {
    ...
    arg0->flags |= 0x10;
    arg0->unk265 = (u8) (arg0->unk265 & 0xFFFE);
    arg0->unk1D8 = func_80BE35A4;
}
...
void func_80BE3178(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->xzDistToPlayer < 1000.0f) && (func_80BE2D4C(arg1) != 0)) {
        ...
        arg0->unk1D8 = func_80BE32DC;
    }
    if ((sp24->unkA70 * 0x10) < 0) {
    ...
    arg0->unk2BE = (s16) (arg0->unk2BE + 0x1000);
    arg0->shape.yOffset = Math_SinS(arg0->unk2BE) * 500.0f;
...
void func_80BE3354(Actor *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCurrentIndex() != arg0->cutscene) {
        func_80BE2E18(arg0, arg1);
        Math_ApproachF(&arg0->speedXZ, arg0->unk2B8, 0.2f, 0.5f);
    }
    Actor_SetVelocityAndMoveXYRotation(arg0);
    arg0->unk2BE = (s16) (arg0->unk2BE + 0x1000);
    arg0->shape.yOffset = Math_SinS(arg0->unk2BE) * 500.0f;
...
void func_80BE348C(Actor *arg0, void *arg1) {
    ...
    Math_ApproachF(arg0 + 0x70, arg0->unk2B8, 0.1f, 0.1f);
    Math_ApproachF(arg0 + 0x68, 3.0f, 0.2f, 0.5f);
    if ((arg0->world.pos.y > 1000.0f) || (arg0->xzDistToPlayer > 2000.0f)) {
        Actor_MarkForDeath(arg0);
        return;
    }
    arg0->unk2BE = (s16) (arg0->unk2BE + 0x800);
    arg0->shape.yOffset = Math_SinS(arg0->unk2BE) * 500.0f;
    Actor_SetVelocityAndMoveYRotationAndGravity(arg0);
    if (((u32) arg1->unk9C % 0x2BU) == 0) {
        Audio_PlayActorSound2(arg0, 0x38B6U);
    }
}
...
void func_80BE35A4(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk2C4 != 0xA) {
        ...
        temp_f0 = (arg0->unk2C8 + 1.0f) * 0.25f;
        arg0->unk2CC = temp_f0;
        if (temp_f0 > 0.5f) {
            arg0->unk2CC = 0.5f;
        } else {
            arg0->unk2CC = (f32) arg0->unk2CC;
        }
    ...
    if ((arg0->flags & 0x8000) == 0) {
        if (arg0->unk2C4 != 0xA) {
            Math_ScaledStepToS(&arg0->shape.rot.x, 0x4000, 0x200);
        ...
        if (((arg0->bgCheckFlags & 1) != 0) || (arg0->floorHeight == -32000.0f)) {
            ...
            temp_a1 = &arg0->world;
            sp34 = temp_a1;
            func_800B3030(arg1, &temp_a1->pos, &D_801D15B0, &D_801D15B0, (s16) (s32) (arg0->scale.x * 10000.0f), (s16) 0, 0);
...
void EnRuppecrow_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk194, &D_060010C0, &D_060000F0, &this->unk1E0, &this->unk216, 9);
    ActorShape_Init(&this->actor.shape, 2000.0f, func_800B3FC0, 20.0f);
    temp_a1 = &this->unk254;
    sp34 = temp_a1;
    Collider_InitJntSph(globalCtx, temp_a1);
    Collider_InitAndSetJntSph(globalCtx, temp_a1, &this->actor, &D_80BE39D4, &this->unk274);
    this->unk254.elements->dim.worldSphere.radius = D_80BE39E0->unk20;
...
void EnRuppecrow_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnRuppecrow *this = (EnRuppecrow *) thisx;
    Collider_DestroyJntSph(globalCtx, &this->unk254);
}

void EnRuppecrow_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnRuppecrow *this = (EnRuppecrow *) thisx;
    func_80BE30F4(&this->actor, globalCtx);
    ...
    func_80BE2260(&this->actor, globalCtx);
}

void EnRuppecrow_Draw(Actor *thisx, GlobalContext *globalCtx) {
    EnRuppecrow *this = (EnRuppecrow *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk194.skeleton, this->unk194.limbDrawTbl, (s32) this->unk194.dListCount, NULL, NULL, &this->actor);
}
