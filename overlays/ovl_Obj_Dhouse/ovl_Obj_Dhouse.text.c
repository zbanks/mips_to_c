typedef struct ObjDhouse {
    ...
    /* 0x0148 */ char pad_148[0x14];                /* maybe part of unk_144[6]? */
    /* 0x015C */ void (*actionFunc)(ObjDhouse *, GlobalContext *);
    /* 0x0160 */ char pad_160[0x1214];              /* maybe part of actionFunc[1158]? */
...
void func_80B12B38(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s5 = 0;
    do {
        temp_v0 = phi_s0->unk_1E;
        if ((s32) temp_v0 >= 0) {
            phi_s3 = 0;
            if ((s32) temp_v0 >= (s32) phi_s1->unk_26) {
                phi_s0->unk_10 = (f32) (phi_s0->unk_10 - 2.5f);
                ...
                phi_s0->unk_18 = (s16) (phi_s0->unk_18 + phi_s1->unk_20);
                phi_s0->unk_1A = (s16) (phi_s0->unk_1A + phi_s1->unk_22);
                phi_s0->unk_1C = (s16) (phi_s0->unk_1C + phi_s1->unk_24);
                if (phi_s1->unk_26 == phi_s0->unk_1E) {
            ...
            if (phi_s3 != 0) {
                ...
                temp_v0_2 = phi_s0->unk_1E;
                if ((s32) temp_v0_2 >= 0x3D) {
                    phi_s0->unk_1E = -1;
                } else {
                    phi_s0->unk_1E = (s8) (temp_v0_2 + 1);
                }
            }
        }
        temp_s5 = phi_s5 + 1;
...
s32 func_80B12D78(Actor *arg0) {
    ...
    phi_v1 = 4;
    phi_a1 = 0;
    if ((s32) temp_a3->unk_28 < (s32) temp_v0->unk_28) {
        phi_v0 = temp_a3;
        phi_a1 = 1;
    }
    temp_a0 = phi_v0->unk_28;
    phi_a0 = (s32) temp_a0;
    phi_v0_2 = phi_v0;
    if ((s32) temp_a2->unk_28 < (s32) temp_a0) {
        phi_a0 = (s32) temp_a2->unk_28;
        phi_v0_2 = temp_a2;
        phi_a1 = 2;
    }
    temp_a2_2 = temp_a2 + 0x2C;
    if ((s32) temp_a2->unk_54 < phi_a0) {
        phi_v0_2 = temp_a2_2;
        phi_a1 = 3;
    }
    phi_a2 = temp_a2_2 + 0x2C;
    do {
        temp_a0_2 = phi_v0_2->unk_28;
        phi_a0_2 = (s32) temp_a0_2;
        if ((s32) phi_a2->unk_28 < (s32) temp_a0_2) {
            phi_a0_2 = (s32) phi_a2->unk_28;
            phi_a1 = phi_v1;
            phi_v0_2 = phi_a2;
        }
        temp_a2_3 = phi_a2 + 0x2C;
        phi_a0_3 = phi_a0_2;
        if ((s32) phi_a2->unk_54 < phi_a0_2) {
            phi_a0_3 = (s32) temp_a2_3->unk_28;
            phi_a1 = phi_v1 + 1;
            phi_v0_2 = temp_a2_3;
        }
        temp_a2_4 = temp_a2_3 + 0x2C;
        phi_a0_4 = phi_a0_3;
        if ((s32) temp_a2_3->unk_54 < phi_a0_3) {
            phi_a0_4 = (s32) temp_a2_4->unk_28;
            phi_a1 = phi_v1 + 2;
            phi_v0_2 = temp_a2_4;
        }
        temp_a2_5 = temp_a2_4 + 0x2C;
        if ((s32) temp_a2_4->unk_54 < phi_a0_4) {
            phi_a1 = phi_v1 + 3;
            phi_v0_2 = temp_a2_5;
        }
        temp_v1 = phi_v1 + 4;
...
void func_80B12E7C(Actor *arg0, GlobalContext *arg1, void *arg2, ? *arg3) {
    ...
    do {
        ...
        temp_s0->unk_0 = (f32) (Rand_ZeroOne() - 0.5f);
        temp_s0->unk_4 = Rand_ZeroOne();
        temp_f12 = temp_s0->unk_0;
        temp_f14 = temp_s0->unk_4;
        temp_f2 = Rand_ZeroOne() - 0.5f;
        temp_s0->unk_8 = temp_f2;
        temp_s0->unk_C = (f32) (temp_f12 * 24.0f);
        temp_s0->unk_10 = (f32) (temp_f14 * 34.0f);
        temp_s0->unk_14 = (f32) (temp_f2 * 24.0f);
        temp_s0->unk_0 = (f32) ((temp_f12 * 140.0f) + spA0);
        temp_s0->unk_4 = (f32) (((temp_f14 - 0.2f) * 50.0f) + spA4);
        temp_s0->unk_8 = (f32) ((temp_f2 * 140.0f) + spA8);
        temp_s0->unk_18 = (f32) ((Rand_ZeroOne() * 0.057f) + 0.003f);
        temp_s0->unk_1C = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_1E = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_20 = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_22 = (s16) ((Rand_Next() >> 0x11) - 0x3FFF);
        temp_s0->unk_24 = (s16) ((Rand_Next() >> 0x13) - 0xFFF);
        temp_s0->unk_26 = (s16) ((Rand_Next() >> 0x12) - 0x1FFF);
        temp_s0->unk_29 = 0;
        temp_s0->unk_28 = 0x28;
        if ((phi_s1 & 1) != 0) {
            sp88 = ((Rand_ZeroOne() - 0.5f) * sp94) + temp_s0->unk_0;
            sp8C = ((Rand_ZeroOne() - 0.3f) * sp98) + temp_s0->unk_4;
            sp90 = ((Rand_ZeroOne() - 0.5f) * sp9C) + temp_s0->unk_8;
...
void func_80B13170(Actor *arg0, GlobalContext *arg1, void *arg2, ? *arg3) {
    ...
    do {
        ...
        temp_f2 = Rand_ZeroOne() - 0.5f;
        temp_s0->unk_8 = temp_f2;
        temp_s0->unk_C = (f32) (temp_f12 * 23.0f);
        temp_s0->unk_14 = (f32) (temp_f2 * 23.0f);
        temp_s0->unk_10 = (f32) ((temp_f14 * 19.0f) + 5.0f);
        temp_s0->unk_0 = (f32) ((temp_f12 * 80.0f) + sp98);
        temp_s0->unk_4 = (f32) ((temp_f14 * 23.0f) + sp9C + 15.0f);
        temp_s0->unk_8 = (f32) ((temp_f2 * 80.0f) + spA0);
        temp_s0->unk_1C = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_1E = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_20 = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_22 = (s16) ((Rand_Next() >> 0x12) - 0x1FFF);
        temp_s0->unk_24 = (s16) ((Rand_Next() >> 0x13) - 0xFFF);
        temp_s0->unk_26 = (s16) ((Rand_Next() >> 0x12) - 0x1FFF);
        temp_s0->unk_28 = 0x28;
        if (phi_s1 < 3) {
            ...
            temp_s0->unk_29 = 1;
            temp_s0->unk_18 = (f32) (temp_f6 + 0.12f);
        } else {
            temp_f18 = Rand_ZeroOne() * 0.05f;
            temp_s0->unk_29 = 0;
            temp_s0->unk_18 = (f32) (temp_f18 + 0.003f);
        }
        if ((phi_s1 & 1) != 0) {
            sp8C = ((Rand_ZeroOne() - 0.5f) * 160.0f) + temp_s0->unk_0;
            sp90 = (Rand_ZeroOne() * 120.0f) + temp_s0->unk_4;
            sp94 = ((Rand_ZeroOne() - 0.5f) * 160.0f) + temp_s0->unk_8;
            temp_f20 = Rand_ZeroOne();
...
void func_80B13474(Actor *arg0, GlobalContext *arg1, ? *arg2) {
    ...
    do {
        ...
        temp_f2 = Rand_ZeroOne() - 0.5f;
        temp_s0->unk_8 = temp_f2;
        temp_s0->unk_C = (f32) (temp_f12 * 18.0f);
        temp_s0->unk_10 = (f32) (temp_f14 * 23.0f);
        temp_s0->unk_14 = (f32) (temp_f2 * 18.0f);
        temp_s0->unk_0 = (f32) ((temp_f12 * 40.0f) + arg2->unk_0);
        temp_s0->unk_4 = (f32) (((temp_f14 - 0.4f) * 20.0f) + arg2->unk_4);
        temp_s0->unk_8 = (f32) ((temp_f2 * 40.0f) + arg2->unk_8);
        temp_s0->unk_1C = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_1E = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_20 = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_22 = (s16) ((Rand_Next() >> 0x12) - 0x1FFF);
        ...
        temp_s0->unk_29 = 0;
        temp_s0->unk_18 = (f32) (temp_f4 + 0.003f);
        sp88 = ((Rand_ZeroOne() * 70.0f) - 35.0f) + temp_s0->unk_0;
        sp8C = (Rand_ZeroOne() * 60.0f) + temp_s0->unk_4;
        sp90 = ((Rand_ZeroOne() * 70.0f) - 35.0f) + temp_s0->unk_8;
        temp_f20 = Rand_ZeroOne();
    ...
    do {
        if ((s32) phi_s0->unk_28 > 0) {
            ...
            if (phi_s0->y < temp_f20) {
                ...
                phi_s0->unk_1C = (s16) (phi_s0->unk_1C + phi_s0->unk_22);
                phi_s0->unk_1E = (s16) (phi_s0->unk_1E + phi_s0->unk_24);
                phi_s0->unk_20 = (s16) (phi_s0->unk_20 + phi_s0->unk_26);
                phi_s0->unk_28 = (s8) (phi_s0->unk_28 - 1);
                if ((phi_s0->unk_29 & 1) != 0) {
...
void func_80B139F4(ObjDhouse *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = arg0->unk_1370;
    temp_a2 = (arg1 + (arg1->activeCamera * 4))->unk_800;
    if (temp_v1 == 0x75) {
...
void func_80B13C08(Actor *this, GlobalContext *globalCtx) {
    ...
    phi_s4_2 = 0;
    do {
        if ((s32) phi_s1->unk_1E >= 0) {
            SysMatrix_SetStateRotationAndTranslation(phi_s1->unk_0 + phi_s0->unk_8, phi_s1->unk_4 + phi_s0->unk_C, phi_s1->unk_8 + phi_s0->unk_10, phi_s1 + 0x18);
