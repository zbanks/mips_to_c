void func_80B12A50(void *arg0, ? *arg1, Vec3f *arg2); /* static */
...
void func_80B13474(Actor *arg0, GlobalContext *arg1, Vec3f *arg2); /* static */
void func_80B13724(Actor *arg0, GlobalContext *arg1); /* static */
void func_80B13908(ObjDhouse *arg0);                /* static */
void func_80B1391C(ObjDhouse *arg0, GlobalContext *arg1); /* static */
...
static InitChainEntry D_80B13FB4;                   /* unable to generate initializer */
...
typedef struct ObjDhouse {
    ...
    /* 0x0160 */ char pad160[0x1210];               /* maybe part of actionFunc[1157]? */
    /* 0x1370 */ s16 unk1370;                       /* inferred */
    /* 0x1372 */ char pad1372[0x2];                 /* maybe part of unk1370[2]? */
} ObjDhouse;                                        /* size 0x1374 */

void ObjDhouse_Init(Actor *thisx, GlobalContext *globalCtx) {
    ObjDhouse *this = (ObjDhouse *) thisx;
    Actor_ProcessInitChain(&this->actor, &D_80B13FB4);
...
void func_80B12A50(void *arg0, ? *arg1, Vec3f *arg2) {
    arg2->x = arg0->unk0 + arg1->unk8;
    arg2->y = arg0->unk4 + arg1->unkC;
    arg2->z = arg0->unk8 + arg1->unk10;
}
    ...
    do {
        ...
        if ((s32) temp_v0 >= 0) {
            ...
            if (phi_s0->unk10 < 0.0f) {
                ...
                temp_f0 = func_800C411C(arg1 + 0x830, &sp90, &sp7C, arg0, &sp80);
...
void func_80B12E7C(Actor *arg0, GlobalContext *arg1, void *arg2, ? *arg3) {
    ...
    SysMatrix_MultiplyVector3fXZByCurrentState(&D_80B13FC4, &sp94);
    sp94.y = 100.0f;
    ...
    do {
        ...
        temp_s0->unk0 = (f32) ((temp_f12 * 140.0f) + spA0.x);
        temp_s0->unk4 = (f32) (((temp_f14 - 0.2f) * 50.0f) + spA0.y);
        temp_s0->unk8 = (f32) ((temp_f2 * 140.0f) + spA0.z);
        ...
        temp_s0->unk28 = 0x28;
        if ((phi_s1 & 1) != 0) {
            sp88 = ((Rand_ZeroOne() - 0.5f) * sp94.x) + temp_s0->unk0;
            sp8C = ((Rand_ZeroOne() - 0.3f) * sp94.y) + temp_s0->unk4;
            sp90 = ((Rand_ZeroOne() - 0.5f) * sp94.z) + temp_s0->unk8;
...
void func_80B13170(Actor *arg0, GlobalContext *arg1, void *arg2, ? *arg3) {
    ...
    do {
        ...
        temp_s0->unk0 = (f32) ((temp_f12 * 80.0f) + sp98.x);
        temp_s0->unk4 = (f32) ((temp_f14 * 23.0f) + sp98.y + 15.0f);
        temp_s0->unk8 = (f32) ((temp_f2 * 80.0f) + sp98.z);
        temp_s0->unk1C = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk1E = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk20 = (s16) (Rand_Next() >> 0x10);
...
void func_80B13474(Actor *arg0, GlobalContext *arg1, Vec3f *arg2) {
    f32 sp90;
    f32 sp8C;
    f32 sp88;
    f32 *temp_s7;
    ...
    do {
        ...
        temp_s0->unk0 = (f32) ((temp_f12 * 40.0f) + arg2->x);
        temp_s0->unk4 = (f32) (((temp_f14 - 0.4f) * 20.0f) + arg2->y);
        temp_s0->unk8 = (f32) ((temp_f2 * 40.0f) + arg2->z);
        temp_s0->unk1C = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk1E = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk20 = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk22 = (s16) ((Rand_Next() >> 0x12) - 0x1FFF);
...
block_6:
    ...
    func_80B12B38(&arg0->actor, arg1);
    func_80B13724(&arg0->actor, arg1);
}
