...
typedef struct ObjJgameLight {
    ...
    /* 0x194 */ LightNode *unk194;                  /* inferred */
...
void ObjJgameLight_Init(ObjJgameLight *this, GlobalContext *globalCtx) {
...
void ObjJgameLight_Destroy(ObjJgameLight *this, GlobalContext *globalCtx) {
...
void func_80C15718(ObjJgameLight *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk1B2;
    if ((s32) temp_v0 >= 0x10) {
        arg0->unk1B2 = (s16) (temp_v0 - 0xF);
        return;
    }
    arg0->unk1B2 = 0;
}

void ObjJgameLight_Update(ObjJgameLight *this, GlobalContext *globalCtx) {
    ObjJgameLight *this = (ObjJgameLight *) thisx;
...
void ObjJgameLight_Draw(ObjJgameLight *this, GlobalContext *globalCtx) {
    Gfx *sp6C;
    Gfx *sp5C;
    f32 sp50;
    Gfx *sp4C;
