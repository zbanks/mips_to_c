...
s32 EnFg_UpdateAnimation(SkelAnime *arg0, s16 arg1) {
    ...
    if ((s32) arg1 >= 0) {
        ...
        if ((s32) arg1 < 4) {
            ...
            sp30 = 1;
            SkelAnime_ChangeAnim(arg0, (temp_t6 + &D_80A2E558)->unk_0, (temp_t6 + &D_80A2E558)->unk_4, (f32) (temp_t6 + &D_80A2E558)->unk_8, (f32) phi_t0, (u8) (s32) (temp_t6 + &D_80A2E558)->unk_C, (f32) (temp_t6 + &D_80A2E558)->unk_E);
            phi_t1 = 1;
        }
    }
    return phi_t1;
...
u8 func_80A2D400(void *arg0) {
    ...
    if ((s32) temp_v0 >= (s32) temp_v1) {
        ...
        arg0->unk_B7 = (u8) (temp_v1 - temp_v0);
    }
    return arg0->unk_B7;
}
...
s32 func_80A2D42C(Actor *arg0) {
    ...
    if ((temp_a1 & 2) != 0) {
        ...
        arg0->unk_19D = (u8) (temp_a1 & 0xFFFD);
        sp1C = phi_v1;
        ...
        if (temp_v0 != 2) {
            if (temp_v0 != 3) {
                if (temp_v0 != 4) {
                    ...
                    temp_v0_2 = arg0->unk_194;
                    arg0->flags &= -2;
                    arg0->unk_164 = 0.0f;
                    temp_a0 = temp_v0_2->unk_32;
                    sp22 = temp_a0;
                    sp20 = temp_v0_2->unk_30;
...
void func_80A2D9DC(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->velocity.y <= 0.0f) && ((arg0->bgCheckFlags & 1) != 0)) {
        arg0->unk_2FA = (s16) (arg0->unk_2FA + 1);
...
s32 EnFg_OverrideLimbDraw(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg5) {
    ...
    if ((arg5->unk_B7 == 0) && ((arg1 == 5) || (arg1 == 9))) {
        *arg2 = NULL;
    }
    return 0;
}
...
void EnFg_PostLimbDraw(GraphicsContext **arg0, s32 arg1, u32 *arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp34.unk_0 = (s32) D_80A2E598.unk_0;
    sp34.unk_4 = (s32) D_80A2E598.unk_4;
    sp34.unk_8 = (s32) D_80A2E598.unk_8;
    if ((arg1 == 7) || (arg1 == 8)) {
        temp_s0 = *arg0;
        SysMatrix_StatePush();
...
void EnFg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp50.unk_0 = (s32) D_80A2E5A4.unk_0;
    sp50.unk_4 = (s32) D_80A2E5A4.unk_4;
    sp50.unk_C = (s32) D_80A2E5A4.unk_C;
    sp50.unk_8 = (s32) D_80A2E5A4.unk_8;
    sp50.unk_10 = (s32) D_80A2E5A4.unk_10;
    sp50.unk_14 = (s32) D_80A2E5A4.unk_14;
    SysMatrix_StatePush();
...
void EnFg_AddDust(EnFgEffectDust *dustEffect, Vec3f *worldPos) {
    ...
    sp14.unk_0 = (s32) D_80A2E5BC.unk_0;
    sp14.unk_4 = (s32) D_80A2E5BC.unk_4;
    sp14.unk_8 = (s32) D_80A2E5BC.unk_8;
    sp8.unk_0 = (s32) D_80A2E5C8.unk_0;
    sp8.unk_4 = (s32) D_80A2E5C8.unk_4;
    sp8.unk_8 = (s32) D_80A2E5C8.unk_8;
    phi_a0 = dustEffect;
    phi_v0 = 0;
loop_1:
    temp_v0 = phi_v0 + 1;
    ...
    if (phi_a0->type == 0) {
        ...
        phi_a0->velocity.x = sp14.unk_0;
        phi_a0->velocity.y = sp14.unk_4;
        phi_a0->velocity.z = sp14.unk_8;
        phi_a0->unk_20.x = sp8.unk_0;
        phi_a0->unk_20.y = sp8.unk_4;
        phi_a0->unk_20.z = sp8.unk_8;
        phi_a0->xyScale = 0.4f;
        return;
    }
    phi_a0 += 0x3C;
    ...
    do {
        ...
        if (phi_a0[1].type == 1) {
            ...
            if (temp_v1_4 == 0) {
                ...
                temp_a0_2->unk_1 = temp_t3;
                phi_a1_4 = temp_t3 & 0xFF;
            }
            if (phi_a1_4 == 0) {
                temp_a0_2->unk_0 = 0;
            }
            temp_a0_2->unk_18 = (f32) (temp_a0_2->unk_18 + temp_a0_2->unk_30);
        }
        temp_a0_3 = temp_a0_2 + 0x3C;
        if (temp_a0_2->unk_3C == 1) {
            temp_v1_5 = temp_a0_3->unk_1;
            temp_t5 = temp_v1_5 - 1;
            if (temp_v1_5 == 0) {
                phi_a1_5 = 0;
            } else {
                temp_a0_3->unk_1 = temp_t5;
                phi_a1_5 = temp_t5 & 0xFF;
            }
            if (phi_a1_5 == 0) {
                temp_a0_3->unk_0 = 0;
            }
            temp_a0_3->unk_18 = (f32) (temp_a0_3->unk_18 + temp_a0_3->unk_30);
        }
        temp_a0_4 = temp_a0_3 + 0x3C;
        if (temp_a0_3->unk_3C == 1) {
            temp_v1_6 = temp_a0_4->unk_1;
            temp_t7_2 = temp_v1_6 - 1;
            if (temp_v1_6 == 0) {
                phi_a1_6 = 0;
            } else {
                temp_a0_4->unk_1 = temp_t7_2;
                phi_a1_6 = temp_t7_2 & 0xFF;
            }
            if (phi_a1_6 == 0) {
                temp_a0_4->unk_0 = 0;
            }
            temp_a0_4->unk_18 = (f32) (temp_a0_4->unk_18 + temp_a0_4->unk_30);
        }
