...
static u32 D_80A2E630 = 0x3ECCCCCD;                 /* const */
...
void func_80A2D4B8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 1) {
        ...
        arg0->params = 5;
        arg0->unk164 = 0.0f;
        arg0->world.rot.y = Math_Vec3f_Yaw(arg0->unk194 + 0x24, &arg0->world.pos);
...
void EnFg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1_2, &this->actor, &D_80A2E500);
...
void EnFg_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (((temp_v0 & 0x2000) != 0x2000) && ((temp_v0 & 0x8000) != 0x8000)) {
        ...
        temp_v0_2 = gGameInfo;
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, (f32) temp_v0_2->data[1536], (f32) temp_v0_2->data[1537], 0.0f, 5U);
    }
...
void EnFg_PostLimbDraw(GraphicsContext **arg0, s32 arg1, u32 *arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp34.x = D_80A2E598.unk0;
    sp34.y = D_80A2E598.unk4;
    sp34.z = D_80A2E598.unk8;
    if ((arg1 == 7) || (arg1 == 8)) {
        temp_s0 = *arg0;
        SysMatrix_StatePush();
    ...
    if (arg1 == 4) {
        SysMatrix_MultiplyVector3fByState(&sp34, arg4 + 0x3C);
    }
}
...
void EnFg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnFg_OverrideLimbDraw, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) EnFg_PostLimbDraw, &this->actor);
}

void EnFg_AddDust(EnFgEffectDust *dustEffect, Vec3f *worldPos) {
    EnFg *self = (EnFg *) dustEffect;
    ? sp14;
    ? sp8;
    s32 temp_v0;
    EnFg *phi_a0;
...
loop_1:
    ...
    if (phi_a0->unk0 == 0) {
        phi_a0->unk0 = 1U;
        phi_a0->unk1 = 0x10;
        phi_a0->unk14 = (f32) worldPos->x;
        phi_a0->unk18 = (f32) worldPos->y;
        phi_a0->unk1C = (f32) worldPos->z;
        phi_a0->actor.world.pos.z = sp14.unk0;
        phi_a0->unk30 = (s32) sp14.unk4;
        phi_a0->unk34 = (s32) sp14.unk8;
        phi_a0->unk20 = (s32) sp8.unk0;
        phi_a0->actor.world.pos.x = sp8.unk4;
        phi_a0->actor.world.pos.y = sp8.unk8;
        phi_a0->actor.flags = 0x3ECCCCCD;
        return;
    }
    phi_a0 += 0x3C;
    if (temp_v0 == 0xA) {
...
void EnFg_UpdateDust(EnFgEffectDust *dustEffect) {
    ...
    if (self->unk0 == 1) {
        ...
        self->unk18 = (f32) (self->unk18 + self->unk30);
    }
    temp_a0 = &self->actor.focus;
    if (self->unk3C == 1) {
        temp_v1_2 = temp_a0->unk1;
        temp_t9 = temp_v1_2 - 1;
        if (temp_v1_2 == 0) {
            phi_a1_2 = 0;
        } else {
            temp_a0->unk1 = temp_t9;
            phi_a1_2 = temp_t9 & 0xFF;
        }
        if (phi_a1_2 == 0) {
            temp_a0->unk0 = 0;
        }
        temp_a0->unk18 = (f32) (temp_a0->unk18 + temp_a0->unk30);
    }
    phi_a0 = temp_a0 + 0x3C;
    do {
        temp_v0 = phi_v0 + 4;
        ...
        if (phi_a0->unk0 == 1) {
            ...
            phi_a0->unk18 = (f32) (phi_a0->unk18 + phi_a0->unk30);
        }
