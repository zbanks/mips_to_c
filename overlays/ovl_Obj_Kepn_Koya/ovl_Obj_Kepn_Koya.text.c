...
void ObjKepnKoya_Init(ObjKepnKoya *this, GlobalContext *globalCtx) {
...
void ObjKepnKoya_Destroy(ObjKepnKoya *this, GlobalContext *globalCtx) {
    ObjKepnKoya *this = (ObjKepnKoya *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->dyna.bgId);
}

void ObjKepnKoya_Update(ObjKepnKoya *this, GlobalContext *globalCtx) {
    ObjKepnKoya *this = (ObjKepnKoya *) thisx;

}

void ObjKepnKoya_Draw(ObjKepnKoya *this, GlobalContext *globalCtx) {
    ObjKepnKoya *this = (ObjKepnKoya *) thisx;
