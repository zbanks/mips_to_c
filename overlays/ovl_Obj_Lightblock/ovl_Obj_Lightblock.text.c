...
void func_80AF3910(ObjLightblock *arg0, GlobalContext *arg1) {
    Actor_Spawn(arg1 + 0x1CA0, arg1, 0x48, arg0->dyna.actor.world.pos.x, arg0->dyna.actor.world.pos.y, arg0->dyna.actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, (s16) (((arg0->dyna.actor.params & 1) * 0x10) + &D_80AF3ECC)->unkC);
}

void ObjLightblock_Init(ObjLightblock *this, GlobalContext *globalCtx) {
    ...
    Actor_SetScale((Actor *) this, temp_s1->unk0);
    ...
    this->collider.dim.radius = temp_s1->unk4;
    this->collider.dim.height = temp_s1->unk6;
    this->alpha = 0xFF;
    this->collider.dim.yShift = temp_s1->unk8;
    func_80AF3AC8(this);
}

void ObjLightblock_Destroy(ObjLightblock *this, GlobalContext *globalCtx) {
...
void ObjLightblock_Update(ObjLightblock *this, GlobalContext *globalCtx) {
    ObjLightblock *this = (ObjLightblock *) thisx;
    this->actionFunc(this, globalCtx);
}

void ObjLightblock_Draw(ObjLightblock *this, GlobalContext *globalCtx) {
    Gfx *sp34;
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
