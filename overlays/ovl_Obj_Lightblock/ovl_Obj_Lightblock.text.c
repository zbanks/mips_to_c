...
static InitChainEntry D_80AF3EEC;                   /* unable to generate initializer */
...
void ObjLightblock_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->dyna.actor, &D_80AF3EEC);
    Actor_SetScale(&this->dyna.actor, temp_s1->unk0);
    ...
    Collider_SetCylinder(globalCtx, sp20, &this->dyna.actor, &D_80AF3EA0);
    Collider_UpdateCylinder(&this->dyna.actor, sp20);
