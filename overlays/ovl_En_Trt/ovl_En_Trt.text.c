...
void EnTrt_Init(EnTrt *this, GlobalContext *globalCtx) {
    EnTrt *this = (EnTrt *) thisx;
    Actor_ProcessInitChain((Actor *) this, &sInitChain);
    EnTrt_InitShop(this, globalCtx);
}

void EnTrt_Destroy(EnTrt *this, GlobalContext *globalCtx) {
    EnTrt *this = (EnTrt *) thisx;
    SkelAnime_Free(&this->skelAnime, globalCtx);
    Collider_DestroyCylinder(globalCtx, &this->collider);
}

void EnTrt_Update(EnTrt *this, GlobalContext *globalCtx) {
    EnTrt *this = (EnTrt *) thisx;
    this->blinkFunc(this);
...
void EnTrt_UpdateHeadYawAndPitch(EnTrt *this, GlobalContext *globalCtx) {
    ...
    sp34.unk0 = (f32) this->actor.world.pos.x;
...
void EnTrt_Draw(EnTrt *this, GlobalContext *globalCtx) {
