...
typedef struct ObjIceblock {
    ...
    /* 0x1AC */ void (*unk1AC)(ObjIceblock *, GlobalContext *); /* inferred */
    /* 0x1B0 */ s32 unk1B0;                         /* inferred */
    /* 0x1B4 */ char pad1B4[0x94];                  /* maybe part of unk1B0[38]? */
    /* 0x248 */ Vec3f unk248;                       /* inferred */
    /* 0x254 */ s16 unk254;                         /* inferred */
    /* 0x256 */ s16 unk256;                         /* inferred */
    /* 0x258 */ s16 unk258;                         /* inferred */
    /* 0x25A */ char pad25A[0x54];                  /* maybe part of unk258[43]? */
    /* 0x2AE */ s16 unk2AE;                         /* inferred */
    /* 0x2B0 */ s8 unk2B0;                          /* inferred */
    /* 0x2B1 */ s8 unk2B1;                          /* inferred */
    /* 0x2B2 */ char pad2B2[0x2];                   /* maybe part of unk2B1[3]? */
...
struct _mips2c_stack_func_80A2339C {
    ...
    /* 0x88 */ char pad88[0x1C];                    /* maybe part of sp84[8]? */
...
struct _mips2c_stack_func_80A24118 {
    ...
    /* 0xA0 */ char padA0[0x4];                     /* maybe part of sp9E[3]? */
    ...
    /* 0xB0 */ char padB0[0x8];                     /* maybe part of spAC[3]? */
    /* 0xB8 */ f32 spB8;                            /* inferred */
    /* 0xBC */ char padBC[0x8];                     /* maybe part of spB8[3]? */
    /* 0xC4 */ f32 spC4;                            /* inferred */
...
struct _mips2c_stack_func_80A243E0 {
    ...
    /* 0x0F8 */ char padF8[0x8];                    /* maybe part of spF4[3]? */
...
struct _mips2c_stack_func_80A246D8 {
    ...
    /* 0x9C */ f32 sp9C;                            /* inferred */
    /* 0xA0 */ char padA0[0x8];                     /* maybe part of sp9C[3]? */
    /* 0xA8 */ f32 spA8;                            /* inferred */
    /* 0xAC */ f32 spAC;                            /* inferred */
    /* 0xB0 */ f32 spB0;                            /* inferred */
    /* 0xB4 */ f32 spB4;                            /* inferred */
...
struct _mips2c_stack_func_80A24DD0 {
    ...
    /* 0x8C */ char pad8C[0x10];                    /* maybe part of sp8A[9]? */
    /* 0x9C */ f32 sp9C;                            /* inferred */
    /* 0xA0 */ f32 spA0;                            /* inferred */
    /* 0xA4 */ f32 spA4;                            /* inferred */
    /* 0xA8 */ f32 spA8;                            /* inferred */
    ...
    do {
        ...
        if (func_800C56E0(arg1 + 0x830, temp_s3, temp_a2, &spC8, &spB8, 1, 0, 0, 1, &spBC, arg0, 0.0f) != 0) {
            ...
            if (temp_f0_2 < phi_f22) {
                spB4 = 1;
                arg2->unk4 = 0.0f;
                arg2->unk0 = (f32) ((spC8 - spEC) + (300.0f * arg0->unk60 * sp100));
                arg2->unk8 = (f32) ((spD0 - spF4) + (300.0f * arg0->unk60 * temp_f26));
                phi_f22 = temp_f0_2;
            }
        }
        temp_s1 = phi_s1 + 4;
...
void ObjIceblock_Init(ObjIceblock *this, GlobalContext *globalCtx) {
    Actor *sp2C;
    ...
    if ((temp_v1 & 8) == 0) {
        ...
        if (temp_v0_2 != 0) {
            ...
            sp2C = temp_v0_2;
            Math_Vec3f_Diff((Vec3f *) &temp_v0_2->world, (Vec3f *) &this->actor.world, &this->unk248);
...
void ObjIceblock_Destroy(ObjIceblock *this, GlobalContext *globalCtx) {
...
void func_80A25FD4(GlobalContext *arg0, f32 *arg1) {
    ...
    if (temp_v0 == -1) {
        sp30 = 0;
    } else if (((arg0->view.unkE0.m[1][2] & 2) == 0) && ((s32) (arg0 + (temp_v0 * 2))->unk26E >= 0xB) && (func_80A24118((f32 *) arg0, arg1, 2.0f, (Vec3f *) &sp20) == 0) && (func_801233E4((GlobalContext *) arg1) == 0)) {
...
void ObjIceblock_Update(ObjIceblock *this, GlobalContext *globalCtx) {
    Actor *sp2C;
    ColliderCylinder *sp24;
    Actor *temp_v0;
    ColliderCylinder *temp_a1;
...
void ObjIceblock_Draw(ObjIceblock *this, GlobalContext *globalCtx) {
    ObjIceblock *this = (ObjIceblock *) thisx;
