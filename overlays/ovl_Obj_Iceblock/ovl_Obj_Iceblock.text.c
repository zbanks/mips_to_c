...
s32 func_800C56E0(CollisionContext *, f32 *, f32 *, Vec3f *, ? *, s32, s32, s32, s32, s32 *, f32 *, f32); /* extern */
...
void func_80A257B4(Actor *arg0, GlobalContext *arg1); /* static */
...
static InitChainEntry D_80A26FA4;                   /* unable to generate initializer */
...
typedef struct ObjIceblock {
    ...
    /* 0x01A8 */ void (*actionFunc)(ObjIceblock *, GlobalContext *);
    /* 0x01AC */ void (*unk1AC)(ObjIceblock *, GlobalContext *); /* inferred */
    /* 0x01B0 */ s32 unk1B0;                        /* inferred */
    /* 0x01B4 */ char pad1B4[0x44];                 /* maybe part of unk1B0[18]? */
    /* 0x01F8 */ f32 unk1F8;                        /* inferred */
    /* 0x01FC */ s32 unk1FC;                        /* inferred */
    /* 0x0200 */ char pad200[0x48];                 /* maybe part of unk1FC[19]? */
    /* 0x0248 */ Vec3f unk248;                      /* inferred */
    /* 0x0254 */ s16 unk254;                        /* inferred */
    /* 0x0256 */ s16 unk256;                        /* inferred */
    /* 0x0258 */ s16 unk258;                        /* inferred */
    /* 0x025A */ char pad25A[0x4E];                 /* maybe part of unk258[40]? */
    /* 0x02A8 */ f32 unk2A8;                        /* inferred */
    /* 0x02AC */ char pad2AC[0x2];
...
void func_80A2319C(Actor *arg0, f32 arg1) {
    ...
    do {
        ...
        phi_s0->unk0 = temp_s1_2;
        phi_s0->unk2 = temp_s2;
        phi_s0->unk4 = (f32) (((Rand_ZeroOne() * 0.2f) + 0.9f) * arg1);
        phi_s0->unk8 = (f32) (((Rand_ZeroOne() * 0.2f) + 0.9f) * arg1);
        temp_s3 = phi_s3 + 0x10;
        phi_s0->unkC = (f32) (((Rand_ZeroOne() * 0.2f) + 0.9f) * arg1);
        phi_s1 = temp_s1_2;
        phi_s0 += 0x10;
        phi_s2 = temp_s2;
        phi_s3 = temp_s3;
...
void func_80A232C4(GlobalContext *arg0, s16 arg1) {
    ...
    temp_v0 = arg1 * 2;
    arg0->unk276 = (s16) (arg0->unk276 + *(&D_80A26E80 + temp_v0));
    arg0->unk278 = (s16) (arg0->unk278 + *(&D_80A26E88 + temp_v0));
    if ((arg1 == 0) || (arg1 == 1)) {
        arg0->unk264 = (void *) (arg0 + 0x24);
        arg0->unk268 = (f32) (arg0->state.destroy + (f32) (arg0->unk276 * 0x3C));
    } else {
        arg0->unk264 = (void *) (arg0 + 0x2C);
        arg0->unk268 = (f32) (arg0->state.nextGameStateSize + (f32) (arg0->unk278 * 0x3C));
    }
    arg0->unk26C = arg1;
}
...
void func_80A23690(GlobalContext *arg0) {
    ...
    arg0->unk68 = (f32) (arg0->unk68 + arg0->state.heap.size);
...
s32 func_80A236D4(Actor *arg0, Vec3f *arg1) {
    ...
    sp28 = temp_f12;
    temp_v1 = Math_StepToF(&temp_a0->x, arg1->x, temp_a2_2) & 1;
    temp_a2 = temp_f12;
    sp20 = temp_v1;
...
void func_80A237A4(GlobalContext *arg0) {
    ...
    arg0->unk28C = (s16) (arg0->unk28C + arg0->unk288);
    arg0->unk28E = (s16) (arg0->unk28E + arg0->unk28A);
    ...
    sp20 = Math_SinS(phi_s1->unk10);
    temp_f2 = phi_s1->unk8;
    arg0->unk28 = (f32) ((Math_SinS(phi_s1->unk12) * temp_f2 * 0.5f) + ((arg0->unk244 - ((600.0f * arg0->unk5C) - 90.0f)) + (sp20 * temp_f2)) + phi_s1->unk0);
}
...
void func_80A23938(GlobalContext *arg0) {
    ...
    if ((temp_v0 & 0x20) != 0) {
        temp_s0 = arg0 + 0x27C;
        temp_s0->unk14 = (s16) arg0->state.alloc.base.unkE;
        phi_s0 = temp_s0;
        phi_f0 = 0.3f;
    } else {
        phi_s0 = arg0 + 0x27C;
    ...
    phi_s0->unk22 = (s16) (phi_s0->unk22 + (s32) ((f32) phi_s0->unk20 * -0.02f));
    phi_s0->unk22 = func_80A23090(phi_s0->unk22, 0x32, 0x320);
    phi_s0->unk20 = (s16) (phi_s0->unk20 + phi_s0->unk22);
    phi_s0->unk18 = (s16) (phi_s0->unk18 + (s32) ((f32) (s16) (phi_s0->unk16 - phi_s0->unk14) * -0.04f * arg0->state.unk98 * arg0->unk58 * 0.0016666667f));
    phi_s0->unk18 = func_80A23090(phi_s0->unk18, 0x32, 0x320);
    phi_s0->unk16 = (s16) (phi_s0->unk16 + phi_s0->unk18);
    arg0->unkBC = (s16) (s32) (Math_CosS(phi_s0->unk16) * (f32) phi_s0->unk20 * phi_s0->unk1C);
    temp_v1 = arg0->unkBC;
    ...
    arg0->unkC0 = (s16) (s32) (-Math_SinS(phi_s0->unk16) * (f32) phi_s0->unk20 * phi_s0->unk1C);
    temp_v1_2 = arg0->unkC0;
...
void func_80A23B88(GlobalContext *arg0) {
    ...
    if (fabsf(temp_f14 - temp_f6) < 3.0f) {
        arg0->unk24 = (f32) (temp_f16 + temp_f6);
    }
    temp_f16_2 = arg0->state.nextGameStateSize;
    temp_f14_2 = arg0->unk2C - temp_f16_2;
    if (temp_f14_2 >= 0.0f) {
        phi_f2_2 = 0.5f;
    } else {
        phi_f2_2 = -0.5f;
    ...
    if (fabsf(temp_f14_2 - temp_f4) < 3.0f) {
        arg0->unk2C = (f32) (temp_f16_2 + temp_f4);
    }
}
...
s32 func_80A23D08(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        temp_a1 = &sp98;
        sp98 = phi_s4->unk0 + (phi_s5->unk0 * arg0->unk58);
        spA0 = phi_s4->unk4 + (phi_s5->unk4 * arg0->unk60);
        func_80A2311C(&spA4, temp_a1, arg0->unkBE);
        temp_t9 = &spA4;
        spA4 += arg0->unk24;
        spAC += arg0->unk2C;
        ...
        if (func_800CA1E8(arg1, temp_fp, spA4, spAC, phi_s6, &spC4) != 0) {
            temp_f0_3 = phi_s0->unkC;
            if (phi_f20 < temp_f0_3) {
                spB8 = phi_s2;
                phi_f20 = temp_f0_3;
            }
        } else {
            phi_s0->unkC = -32000.0f;
        }
        temp_s2 = phi_s2 + 1;
        phi_s4 += 8;
        phi_s5 += 8;
    ...
    if (spBC >= 0) {
        ...
        arg0->state.heap.tail = temp_v0->unk1F4;
        arg0->state.alloc.base.prev = temp_v0->unk1F8;
        arg0->unk85 = (s8) temp_v0->unk1FC;
    } else {
    ...
    if (spB8 >= 0) {
        arg0->unk244 = (f32) (arg0 + (spB8 * 0x10))->unk200;
    } else {
        arg0->unk244 = -32000.0f;
    }
    return sp94;
}
...
s32 func_80A23F90(GlobalContext *arg0) {
    ...
    if (func_80A23D08(temp_a0, temp_a2) != 0) {
        ...
        temp_v0 = arg0 + (1 * 0x10);
        phi_f2_2 = phi_f2;
        if (temp_f12 < temp_v0->unk1F8) {
            temp_f0_2 = temp_v0->unk1F8;
            if (phi_f2 < temp_f0_2) {
                phi_f2_2 = temp_f0_2;
                phi_v1 = 1;
            }
        ...
        phi_f2_3 = phi_f2_2;
        if (temp_f12 < temp_v0->unk208) {
            temp_f0_3 = temp_v0->unk208;
        ...
        phi_f2_4 = phi_f2_3;
        if (temp_f12 < temp_v0->unk218) {
            temp_f0_4 = temp_v0->unk218;
        ...
        phi_f2_5 = phi_f2_4;
        if (temp_f12 < temp_v0->unk228) {
            temp_f0_5 = temp_v0->unk228;
...
s32 func_80A24118(f32 *arg0, f32 *arg1, f32 arg2, Vec3f *arg3) {
    ...
    do {
        temp_a1 = &spC4;
        spC4 = phi_s2->unk0 + (phi_s0->unk0 * arg0->unk58);
        temp_f0_2 = arg0->unk5C;
        spCC = 0.0f;
        spC8 = phi_s2->unk4 + (phi_s0->unk4 * temp_f0_2) + (arg0->unkC4 * temp_f0_2);
        func_80A2311C(temp_s3, temp_a1, sp9E);
        temp_f16 = spDC + arg0->unk108;
        spDC = temp_f16;
        temp_f8 = spE0 + arg0->unk10C;
        temp_a2_2 = temp_s5;
        spE0 = temp_f8;
        spD4 = temp_f8;
        spD0 = temp_f24 + temp_f16;
        temp_f18 = spE4 + arg0->unk110;
        temp_f6 = temp_f26 + temp_f18;
        spE4 = temp_f18;
        spD8 = temp_f6;
        if (func_800C56E0(arg1 + 0x830, temp_s3, temp_a2_2, &spB8, &spA8, 1, 0, 0, 1, &spAC, arg0, 0.0f) != 0) {
            temp_f0_3 = Math3D_DistanceSquared((Vec3f *) temp_s3, &spB8);
            if (temp_f0_3 < phi_f20) {
                temp_f20 = temp_f0_3;
                spA4 = 1;
                Math_Vec3f_Diff(&spB8, (Vec3f *) temp_s5, arg3);
                phi_f20 = temp_f20;
            }
        }
        temp_s0 = phi_s0 + 8;
...
s32 func_80A24384(GlobalContext *arg0) {
    ...
    if (func_80A24118(NULL, &sp1C) != 0) {
        arg0->unk24 = (f32) (arg0->unk24 + sp1C);
        arg0->unk2C = (f32) (arg0->unk2C + sp24);
        return 1;
    }
    return 0;
}
...
s32 func_80A246D8(f32 *arg0, f32 *arg1, f32 *arg2) {
    ...
    temp_s5 = arg1 + 0x830;
    temp_s6 = &spC0;
    temp_f20 = (arg0->unk60 * 300.0f) + 2.0f;
    phi_s3 = 0;
    phi_s7 = 0;
    do {
        phi_s1 = &D_80A26F68;
...
loop_2:
        temp_a1 = &spA8;
        spA8 = phi_s1->unk0 + (phi_s0->unk0 * arg0->unk58);
        temp_f0 = arg0->unk5C;
        spB0 = 0.0f;
        spAC = phi_s1->unk4 + (phi_s0->unk4 * temp_f0) + (arg0->unkC4 * temp_f0);
        func_80A2311C(temp_s6, temp_a1, phi_s3);
        spC0 += arg2->unk0;
        spC4 += arg2->unk4;
        temp_f4 = spC8 + arg2->unk8;
        spC8 = temp_f4;
        ...
        if (func_800C56E0(temp_s5, temp_s6, &spB4, &sp9C, &sp94, 1, 0, 0, 1, &sp98, arg0, 0.0f) != 0) {
            ...
            phi_s7 = 1;
            if ((temp_v0 != 0) && (temp_v0->actor.id == 0x143) && (temp_v0->unk2B0 == 3)) {
                temp_v0->unk1B0 = (s32) (temp_v0->unk1B0 | 0x80);
            }
        }
        temp_s0 = phi_s0 + 8;
        phi_s1 += 8;
...
s32 func_80A24954(GlobalContext *arg0, f32 *arg1) {
    ...
    sp27 = arg0->unk2B0;
    temp_f0 = arg0->unk244;
    if ((temp_f0 > -31999.0f) && (((arg0->unk5C * 600.0f) - 90.0f) < (temp_f0 - arg0->unk28))) {
        func_80A262BC(arg0, arg1);
        arg0->unk2B0 = 3;
        goto block_7;
    }
    if ((arg0->view.unkE0.m[1][2] & 4) != 0) {
        if (func_800C99D4(arg1 + 0x830, arg0->state.heap.tail, (s32) arg0->unk85) == 5) {
            func_80A25FA0(arg0);
            arg0->unk2B0 = 2;
        } else {
            func_80A25CF4(arg0);
...
block_7:
    ...
    return sp27 != arg0->unk2B0;
}

void func_80A24A48(GlobalContext *arg0, GlobalContext *arg1) {
    s32 temp_a2;

    if (((arg0->view.unkE0.m[1][2] & 0x10) == 0) && ((arg0->unk16E & 2) == 0)) {
...
void func_80A24AA8(ObjIceblock *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk1B0 & 4) != 0) {
        do {
            temp_v0 = BgCheck_GetActorOfMesh(arg1 + 0x830, phi_s0->unk1FC);
            temp_s1 = phi_s1 + 0x10;
            phi_s1 = temp_s1;
            if ((temp_v0 != 0) && (temp_v0->actor.id == 0x143) && (fabsf(arg0->actor.world.pos.y - phi_s0->unk1F8) < 0.1f)) {
                temp_v0->unk1B0 = (s32) (temp_v0->unk1B0 | 2);
            }
            phi_s0 += 0x10;
        } while (temp_s1 != 0x50);
    }
    ...
    if ((arg0->state.main & 0x40) != 0) {
        ...
        if (arg4 > 0) {
            ...
            do {
                ...
                sp88 = (Math_SinS((s16) ((s32) (Rand_ZeroOne() * temp_f22) + phi_s0)) * temp_f20) + arg0->unk24;
                sp90 = (Math_CosS((s16) ((s32) (Rand_ZeroOne() * temp_f22) + phi_s0)) * temp_f20) + arg0->unk2C;
    ...
    if ((arg0->state.main & 0x40) != 0) {
        ...
        do {
            if (!(phi_f22 < (Rand_ZeroOne() * 1.2f))) {
                ...
                temp_a1 = &sp9C;
                sp9C = (arg0->mainCamera.skyboxOffset.y - 0.5f) * 600.0f * arg0->unk58;
                spA4 = (arg0->unk60 * -300.0f) + 4.0f;
                func_80A2311C(temp_s2, temp_a1, sp8A);
                spA8 += arg0->unk24;
                spAC += arg0->unk28;
                spB0 += arg0->unk2C;
                temp_f20 = ((Rand_ZeroOne() * 800.0f) + (1600.0f * arg0->unk58)) * phi_f22;
...
void func_80A2508C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->flags & 0x40) != 0) {
        ...
        if (temp_v0 > 0) {
            arg0->unk2AC = (s16) (arg0->unk2AC + temp_v0);
        }
        if ((s32) arg0->unk2AC >= 0xA) {
            arg0->unk2AC = 0;
...
void func_80A252DC(GlobalContext *arg0, s32 arg1) {
    ...
    if ((arg1 == 0) && (phi_v0 != 0)) {
        arg0->unk26E = (s16) (arg0->unk26E + 1);
    } else {
        temp_a2 = arg0->unk26E;
        if ((s32) temp_a2 > 0) {
            arg0->unk26E = (s16) (temp_a2 - 1);
        }
    }
    if ((arg1 == 1) && (phi_v0 != 0)) {
        arg0->unk270 = (s16) (arg0->unk270 + 1);
    } else {
        temp_a0 = arg0->unk270;
        if ((s32) temp_a0 > 0) {
            arg0->unk270 = (s16) (temp_a0 - 1);
        }
    }
    if ((arg1 == 2) && (phi_v0 != 0)) {
        arg0->unk272 = (s16) (arg0->unk272 + 1);
    } else {
        temp_a0_2 = arg0->unk272;
        if ((s32) temp_a0_2 > 0) {
            arg0->unk272 = (s16) (temp_a0_2 - 1);
        }
    }
    if ((arg1 == 3) && (phi_v0 != 0)) {
    ...
    temp_v0_2 = arg0->unk274;
    if ((s32) temp_v0_2 > 0) {
        arg0->unk274 = (s16) (temp_v0_2 - 1);
    }
}
...
void func_80A25440(ObjIceblock *arg0) {
    ...
    if (temp_s1 != 0) {
        if (arg0->unk2B0 == 3) {
            ...
            temp_a0 = &sp34;
            sp34 = arg0->unk248.x;
            sp38 = arg0->unk248.y - sp24;
            sp3C = arg0->unk248.z;
            SysMatrix_MultiplyVector3fByState((Vec3f *) temp_a0, &sp28);
            temp_a0_2 = &sp34;
            sp34 = arg0->actor.world.pos.x;
            sp38 = arg0->actor.world.pos.y + sp24;
            sp3C = arg0->actor.world.pos.z;
            Math_Vec3f_Sum((Vec3f *) temp_a0_2, &sp28, temp_s1 + 0x24);
            Matrix_RotateY((s16) (arg0->unk256 + arg0->actor.home.rot.y), 1U);
            SysMatrix_InsertXRotation_s((s16) (arg0->unk254 + arg0->actor.home.rot.x), 1);
            SysMatrix_InsertZRotation_s((s16) (arg0->unk258 + arg0->actor.home.rot.z), 1);
            SysMatrix_CopyCurrentState(&sp40);
            func_8018219C(&sp40, temp_s1 + 0xBC, 1);
            return;
        }
...
void ObjIceblock_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80A26FA4);
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80A26E50);
    if ((this->actor.params & 1) != 0) {
        this->unk15C.dim.yShift = -0x64;
        this->unk15C.dim.height = 0x7E;
        this->unk15C.dim.radius = 0x1D;
    }
    if (D_80A26E7C == 0) {
    ...
    if ((temp_v1 & 8) == 0) {
        ...
        if (temp_v0_2 != 0) {
            this->unk1B0 = temp_v1 | 8;
            sp2C = temp_v0_2;
            Math_Vec3f_Diff(&temp_v0_2->world.pos, &this->actor.world.pos, &this->unk248);
            this->unk254 = temp_v0_2->shape.rot.x - this->actor.home.rot.x;
            this->unk256 = temp_v0_2->shape.rot.y - this->actor.home.rot.y;
            this->unk258 = temp_v0_2->shape.rot.z - this->actor.home.rot.z;
        }
    }
    if ((this->actor.params & 1) != 0) {
        this->unk2B4 = -1.0f;
...
void func_80A25994(Actor *arg0, s32 arg1) {
    ...
    func_80A25A8C(arg0);
    arg0->unk1AC = func_80A26B74;
}

void func_80A25A8C(Actor *arg0) {
    arg0->unk1A8 = func_80A25AA8;
    arg0->unk2A0 = 2;
}
...
void func_80A25AA8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_80A236D4(arg0, arg0 + 8) != 0) {
        ...
        arg0->unk24C = (f32) (arg0->unk24C + sp24);
        if ((arg0->params & 1) != 0) {
            arg0->unk1A0 = -0x45;
        } else {
            arg0->unk1A0 = 0;
        }
        arg0->unk1B0 = (s32) (arg0->unk1B0 | 0x100);
    }
}

void func_80A25BA0(Actor *arg0) {
    arg0->unk1A8 = func_80A25BBC;
...
void func_80A25D28(GlobalContext *arg0, f32 *arg1) {
    ...
    if (((arg0->view.unkE0.m[1][2] & 2) == 0) && ((s32) (arg0 + (temp_v0 * 2))->unk26E >= 0xB)) {
        ...
        sp34 = 1;
        if (func_80A24118((f32 *) arg0, arg1, phi_f0, &sp24) == 0) {
...
void func_80A25E50(GlobalContext *arg0, f32 *arg1) {
    ...
    temp_f2 = (Math_SinS((s16) (s32) (fabsf(arg0->unk268 - *arg0->unk264) * 546.13336f)) * 2.8f) + 1.2f;
    if (temp_f2 > 3.5f) {
        phi_f0 = 3.5f;
    } else {
        phi_f0 = temp_f2;
    }
    sp38 = Math_StepToF(arg0->unk264, arg0->unk268, phi_f0);
    func_80A23690(arg0);
    if (func_80A23F90(arg0, arg1) == 0) {
    ...
    if (sp38 != 0) {
        if (func_80A24118((f32 *) arg0, arg1, 59.9f, &sp28) != 0) {
            Audio_PlayActorSound2((Actor *) arg0, 0x2835U);
        }
        func_80A2541C(arg0, arg1);
        func_80A25CF4(arg0);
...
void func_80A25FD4(GlobalContext *arg0, f32 *arg1) {
    ...
    if (temp_v0 == -1) {
        sp30 = 0;
    } else if (((arg0->view.unkE0.m[1][2] & 2) == 0) && ((s32) (arg0 + (temp_v0 * 2))->unk26E >= 0xB) && (func_80A24118((f32 *) arg0, arg1, 2.0f, &sp20) == 0) && (func_801233E4((GlobalContext *) arg1) == 0)) {
...
void func_80A260E8(GlobalContext *arg0) {
    ...
    arg0->unk68 = 0.0f;
    arg0->unk2A0 = 0xF;
    arg0->unk260 = (f32) *(&D_80A26FC0 + (arg0->unk26C * 4));
    func_80A24DC4();
...
void func_80A26144(GlobalContext *arg0, f32 *arg1) {
    ...
    Math_StepToF(arg0 + 0x25C, arg0->unk260, 0.75f);
    temp_v1 = arg0->unk264;
    *temp_v1 += arg0->unk25C;
    ...
    temp_a3 = temp_v0_2 == 0;
    if ((temp_a3 != 0) || (sp28 != 0) || (arg0->unk2A0 == 1)) {
        sp24 = temp_a3;
        func_80A2541C(arg0, arg1);
    }
    temp_v0_3 = arg0->view.unkE0.m[1][2];
    if (((temp_v0_3 & 1) != 0) && (((temp_v0_2 == 0) != 0) || (sp28 != 0) || (arg0->state.unk98 > 400.0f))) {
...
void func_80A262BC(GlobalContext *arg0) {
    ...
    arg0->unk2A0 = -1;
    arg0->unk68 = (f32) (arg0->unk68 * 0.7f);
}
...
void func_80A262EC(GlobalContext *arg0, f32 *arg1) {
    ...
    if (arg0->unk2A0 == -1) {
        if ((arg0->unk68 < 0.0f) && (temp_f0 = arg0->unk28, temp_f2 = arg0->unk244, (temp_f0 < temp_f2)) && ((temp_f2 - (600.0f * arg0->unk5C)) <= temp_f0)) {
    ...
    } else if (arg0->unk2A0 == 1) {
        func_80A24BDC(arg0, (GlobalContext *) arg1, 0.7f, 1.3f, 6);
        func_80A24B74(arg0, (GlobalContext *) arg1);
    }
    arg0->unk68 = (f32) (arg0->unk68 + 5.0f);
    if (arg0->unk68 > 3.0f) {
        arg0->unk68 = 3.0f;
    }
    temp_f2_2 = arg0->unk244;
    arg0->unk28 = (f32) (arg0->unk28 + arg0->unk68);
    temp_f14 = arg0->unk28 + (600.0f * arg0->unk5C);
    if (temp_f2_2 < (temp_f14 - 90.0f)) {
        func_80A24B74(arg0, (GlobalContext *) arg1);
        func_80A26574(arg0);
        return;
    }
    if ((arg0->unk68 > 0.0f) && (temp_f14 < (temp_f2_2 + 3.0f)) && (temp_f2_2 <= temp_f14)) {
        func_80A24BDC(arg0, (GlobalContext *) arg1, 0.8f, 1.0f, 0xB);
        func_80A24B74(arg0, (GlobalContext *) arg1);
    }
    sp38 = arg0->unk24;
    sp3C = (arg0->unk244 - (600.0f * arg0->unk5C)) + 90.0f;
    sp40 = arg0->unk2C;
...
void func_80A265C0(GlobalContext *arg0, f32 *arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        arg0->unk2A0 = Rand_S16Offset(0x1E, 0x3C);
        temp_v1 = &arg0->mainCamera.eye;
        temp_v1->unkC = Rand_S16Offset(0x12C, 0x12C);
        sp24 = temp_v1;
        sp24->unkE = Rand_S16Offset(0x384, 0x258);
        sp24->y = (2.0f * Rand_ZeroOne()) + 1.0f;
        sp24->unk14 = (s16) (Rand_Next() >> 0x10);
        func_80A24B74(arg0, (GlobalContext *) arg1);
    }
    func_80A237A4(arg0);
    func_80A23938(arg0);
...
void func_80A266E0(Actor *arg0, GlobalContext *arg1) {
    ...
    sp20 = Math_StepToF(arg0 + 0x5C, 0.0f, arg0->unk2A8);
    ...
    if ((arg0->params & 1) != 0) {
        arg0->unk2B4 = (f32) arg0->scale.y;
        arg0->unk19E = (s16) ((s32) (arg0->scale.y * 1230.0f) + 1);
        arg0->unk1A0 = (s16) (s32) (arg0->scale.y * -1000.0f);
        arg0->unk19C = (s16) (s32) (arg0->scale.x * 290.0f);
    }
...
void ObjIceblock_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_800CAF70((DynaPolyActor *) this) != 0) {
        ...
        if ((temp_v1 & 0x20) != 0) {
            this->unk1B0 = temp_v1 & ~0x40;
        } else {
            this->unk1B0 = temp_t0;
            this->unk1B0 = temp_t0 | 0x20;
        }
    } else {
        temp_v1_2 = this->unk1B0;
        if ((temp_v1_2 & 0x20) != 0) {
            temp_t4 = temp_v1_2 | 0x40;
            this->unk1B0 = temp_t4;
            this->unk1B0 = temp_t4 & ~0x20;
        } else {
            this->unk1B0 = temp_v1_2 & ~0x40;
        }
    }
    temp_v0_2 = this->unk2B0;
    if ((temp_v0_2 == 1) || (temp_v0_2 == 2) || (temp_v0_2 == 3)) {
        temp_v0_3 = this->unk2AE;
        if ((s32) temp_v0_3 > 0) {
            this->unk2AE = temp_v0_3 - 1;
        }
    }
    if ((((this->unk15C.base.acFlags & 2) != 0) && ((this->unk15C.info.acHitInfo->toucher.dmgFlags & 0x800) != 0)) || (this->unk2AE == 0)) {
        temp_t8 = this->unk1B0 & ~0x100;
        this->unk2AE = -1;
        this->unk2B0 = 4;
        this->unk1B0 = temp_t8;
        if ((temp_t8 & 1) != 0) {
            this->unk1B0 = temp_t8 & ~1;
            func_800B7298(globalCtx, &this->actor, 6U);
        }
        func_80A266C4(this);
    }
    temp_v0_4 = this->unk2B1;
    if ((s32) temp_v0_4 > 0) {
        this->unk2B1 = temp_v0_4 - 1;
        if (this->unk2B1 == 0) {
    ...
    if (this->actor.update == 0) {
        if (sp2C != 0) {
            sp2C->child = NULL;
            sp2C->shape.rot.x = this->unk254 + this->actor.home.rot.x;
            sp2C->shape.rot.y = this->unk256 + this->actor.home.rot.y;
            sp2C->shape.rot.z = this->unk258 + this->actor.home.rot.z;
            this->actor.parent = NULL;
            return;
        }
    ...
    temp_a1 = &this->unk15C;
    this->unk15C.base.ocFlags1 &= 0xFFFD;
    this->unk15C.base.acFlags &= 0xFFFD;
    sp24 = temp_a1;
    Collider_UpdateCylinder(&this->actor, temp_a1);
    if ((this->unk1B0 & 0x10) != 0) {
        if (((this->actor.params & 1) != 0) && (this->unk2B4 > 0.0f)) {
            temp_t9 = this->unk15C.base.ocFlags1 & 0xFFFB;
            this->unk15C.base.ocFlags1 = temp_t9;
            this->unk15C.base.ocFlags1 = temp_t9 | 0x38;
            this->unk15C.info.bumper.dmgFlags |= 0xC13BB2;
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &sp24->base);
            goto block_33;
        }
    } else {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &sp24->base);
block_33:
    ...
    if ((this->unk1B0 & 0x100) != 0) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, &sp24->base);
    }
    func_80A25440(this);
...
void func_80A26B74(void *arg0, GlobalContext *arg1) {
    ...
    if (((arg0->unk1C & 1) != 0) && (arg0->unk2B4 > 0.0f)) {
...
void func_80A26BF8(void *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        sp70 = phi_s2->unk1B4;
        sp72 = phi_s2->unk1B6;
        SysMatrix_SetStateRotationAndTranslation(arg0->unk24, arg0->unk28, arg0->unk2C, (Vec3s *) temp_a3);
        Matrix_Scale(phi_s0->unk4, phi_s0->unk8, phi_s0->unkC, 1);
    ...
    if (((arg0->unk1C & 1) != 0) && (arg0->unk2B4 > 0.0f)) {
        AnimatedMat_Draw(arg1, Lib_SegmentedToVirtual(&D_060009D0));
        SysMatrix_SetStateRotationAndTranslation(arg0->unk24, arg0->unk28 - 20.0f, arg0->unk2C, arg0 + 0xBC);
        temp_f12 = arg0->unk2B4;
