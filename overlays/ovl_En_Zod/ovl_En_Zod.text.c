typedef struct EnZod {
    ...
    /* 0x14A */ char pad_14A[0x36];                 /* maybe part of unk_144[10]? */
    /* 0x180 */ Vec3s unk_180;                      /* inferred */
    /* 0x186 */ char pad_186[0x36];                 /* maybe part of unk_180[10]? */
    /* 0x1BC */ SkelAnime unk_1BC;                  /* inferred */
    /* 0x200 */ ColliderCylinder unk_200;           /* inferred */
    /* 0x24C */ s16 unk_24C;                        /* inferred */
    /* 0x24E */ s16 unk_24E;                        /* inferred */
    /* 0x250 */ Vec3s unk_250;                      /* inferred */
    /* 0x256 */ u16 unk_256;                        /* inferred */
    ...
    /* 0x270 */ char pad_270[0x10];                 /* maybe part of unk_26C[5]? */
    /* 0x280 */ f32 unk_280;                        /* inferred */
    /* 0x284 */ f32 unk_284;                        /* inferred */
    /* 0x288 */ char pad_288[0x10];                 /* maybe part of unk_284[5]? */
    /* 0x298 */ s16 unk_298;                        /* inferred */
    /* 0x29A */ u16 unk_29A;                        /* inferred */
...
struct _mips2c_stack_func_80BB01B0 {
    ...
    /* 0x78 */ char pad_78[0x24];                   /* maybe part of sp74[10]? */
    /* 0x9C */ f32 sp9C;                            /* inferred */
    /* 0xA0 */ char pad_A0[0x24];                   /* maybe part of sp9C[10]? */
    /* 0xC4 */ f32 spC4;                            /* inferred */
    /* 0xC8 */ char pad_C8[0x28];
};                                                  /* size = 0xF0 */
...
void EnZod_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_0600D658, &D_06000D94, &this->unk_144, &this->unk_180, 0xA);
    SkelAnime_ChangeAnimDefaultRepeat(sp34, &D_06000D94);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_200, (Actor *) this, &D_80BB0540);
    this->unk_260 = 0;
    temp_v0 = this->unk_260;
    this->unk_266 = 0x12C;
    this->unk_25E = temp_v0;
    this->unk_25C = temp_v0;
    temp_v0_2 = this->unk_266;
    this->unk_256 = 0;
    this->unk_25A = -1;
    this->unk_258 = -1;
    this->actor.textId = 0;
    ...
    this->unk_264 = temp_v0_2;
    this->unk_262 = temp_v0_2;
    temp_v0_3 = this + (2 * 4);
    this->unk_280 = 0.01f;
    this->unk_284 = 0.01f;
    this->unk_26C = 0.0f;
    this->unk_268 = 0.0f;
    temp_v0_3->unk_28C = 0.01f;
    temp_v0_3->unk_274 = 0.0f;
    temp_v0_3->unk_288 = 0.01f;
    temp_v0_3->unk_270 = 0.0f;
    temp_v0_3->unk_284 = 0.01f;
    temp_v0_3->unk_26C = 0.0f;
    temp_v0_3->unk_268 = 0.0f;
    temp_v0_3->unk_280 = 0.01f;
...
void EnZod_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnZod *this = (EnZod *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_200);
}
...
void func_80BAF3E0(EnZod *arg0) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        temp_a1 = arg0->unk_258;
        temp_a3 = arg0->unk_25A;
        if (temp_a1 == temp_a3) {
            func_80BAF338(arg0, temp_a1, 2U, (u16) temp_a3);
            temp_v0 = (s16) arg0->unk_258;
            if (temp_v0 != 3) {
                if (temp_v0 != 4) {
...
void func_80BAF4D8(EnZod *arg0) {
    ...
    phi_v0_2 = 0;
    do {
        temp_a1 = phi_v1->unk_262;
        phi_v1->unk_25C += temp_a1;
        phi_v1->unk_262 = temp_a1 - (s32) ((f32) phi_v1->unk_25C * 0.1f);
        temp_a1_2 = phi_v1->unk_262;
        phi_a2 = (s32) temp_a1_2;
        if ((s32) temp_a1_2 < 0) {
            phi_a2 = -(s32) temp_a1_2;
        }
        if (phi_a2 >= 0x65) {
            phi_v1->unk_262 = (s16) (s32) ((f32) temp_a1_2 * 0.9f);
        }
        if (phi_v0 != 0) {
            if (phi_v0 != 1) {

            } else if ((arg0->unk_258 == 4) && ((s32) arg0->unk_1BC.animCurrentFrame == 0x13)) {
                goto block_13;
            }
        } else if ((arg0->unk_258 == 4) && ((s32) arg0->unk_1BC.animCurrentFrame == 7)) {
block_13:
            phi_v1->unk_262 = -0x3E8;
        }
        temp_v0 = phi_v0 + 1;
        phi_v1 += 2;
        phi_v0 = temp_v0;
    ...
    phi_a1 = arg0;
    do {
        temp_f2 = phi_a1->unk_280;
        phi_a1->unk_268 += temp_f2;
        phi_a1->unk_280 = temp_f2 - (phi_a1->unk_268 * 0.8f);
        temp_f2_2 = phi_a1->unk_280;
        if (fabsf(temp_f2_2) > 0.01f) {
            phi_a1->unk_280 = temp_f2_2 * 0.5f;
        }
        if (phi_v0_2 != 0) {
            if (phi_v0_2 != 2) {
                if (phi_v0_2 != 3) {
                    if (phi_v0_2 != 4) {
                        ...
                        phi_a1->unk_280 = 0.15f;
                    }
                } else {
                    temp_a2 = arg0->unk_258;
                    if (temp_a2 != 3) {
                        if (temp_a2 != 4) {

                        } else if ((s32) arg0->unk_1BC.animCurrentFrame == 1) {
                            phi_a1->unk_280 = 0.1f;
                        }
                    } else {
                        temp_f6 = (s32) arg0->unk_1BC.animCurrentFrame;
                        if ((temp_f6 == 1) || (temp_f6 == 7) || (temp_f6 == 0xC) || (temp_f6 == 0x13)) {
                            phi_a1->unk_280 = 0.03f;
                        }
                    }
                }
            } else {
                temp_v1 = arg0->unk_258;
                if (((temp_v1 == 3) && ((s32) arg0->unk_1BC.animCurrentFrame == 0x13)) || ((temp_v1 == 4) && ((s32) arg0->unk_1BC.animCurrentFrame == 8))) {
                    phi_a1->unk_280 = 0.1f;
                }
            }
        } else {
            temp_v1_2 = arg0->unk_258;
            if (((temp_v1_2 == 3) || (temp_v1_2 == 4)) && ((s32) arg0->unk_1BC.animCurrentFrame == 1)) {
                phi_a1->unk_280 = 0.1f;
            }
        }
...
void func_80BAFE34(EnZod *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = (s16) arg0->unk_29A;
    if ((s32) temp_v0 < 0x31F) {
        arg0->unk_29A = temp_v0 + 0xC8;
    } else {
        arg0->unk_29A = temp_v0 + 0x1E;
    }
    if ((s32) (s16) arg0->unk_29A >= 0x3E8) {
        arg0->unk_29A = 0x3E7;
    }
    arg0 = arg0;
...
void EnZod_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80BAF4D8(this);
    temp_v1 = this->unk_24E;
    if (temp_v1 == 0) {
        phi_v0 = 0;
    } else {
        this->unk_24E = temp_v1 - 1;
        phi_v0 = this->unk_24E;
    }
    phi_v1 = this->unk_24E;
    if (phi_v0 == 0) {
        this->unk_24E = Rand_S16Offset(0x3C, 0x3C);
        phi_v1 = this->unk_24E;
    }
    this->unk_24C = phi_v1;
    ...
    if (func_80BAF2B4((Actor *) this, globalCtx) != 0) {
        func_800E9250(globalCtx, (Actor *) this, &this->unk_250, (Vec3s *) &sp38, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        temp_v1_2 = this->unk_250.x;
        if ((s32) temp_v1_2 >= 0xBB9) {
            this->unk_250.x = 0xBB8;
            return;
        }
    ...
    Math_SmoothStepToS((s16 *) &this->unk_250, 0, 6, 0x1838, (s16) 0x64);
    Math_SmoothStepToS(&this->unk_250.y, 0, 6, 0x1838, (s16) 0x64);
}
...
void func_80BB01B0(EnZod *arg0, GraphicsContext **arg1) {
    ...
    do {
        temp_t2 = phi_t2 + 0xC;
        temp_t1 = phi_t1 + 0xC;
        temp_t1->unk_-C = (s32) *phi_t2;
        temp_t1->unk_-8 = (s32) temp_t2->unk_-8;
        temp_t1->unk_-4 = (s32) temp_t2->unk_-4;
        phi_t2 = temp_t2;
        phi_t1 = temp_t1;
    ...
    do {
        ...
        temp_t0 = phi_t0 + 0xC;
        temp_t0->unk_-C = (s32) *phi_t7_2;
        temp_t0->unk_-8 = (s32) temp_t7_2->unk_-8;
        temp_t0->unk_-4 = (s32) temp_t7_2->unk_-4;
        phi_t7_2 = temp_t7_2;
        phi_t0 = temp_t0;
    ...
    do {
        ...
        case 2:
        case 3:
            SysMatrix_InsertXRotation_s((arg0 + (phi_s1 * 2))->unk_25A, 1);
            break;
        case 4:
        case 5:
        case 6:
        ...
        case 8:
        case 9:
            temp_f12 = (arg0 + -phi_s3)->unk_28C + 1.0f;
...
void EnZod_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk_256 & 2) != 0) {
        temp_s1->polyOpa.p = Gfx_SetFog(temp_s1->polyOpa.p, 0, 0, 0, 0, (s32) (s16) this->unk_29A, 0x3E8);
    }
