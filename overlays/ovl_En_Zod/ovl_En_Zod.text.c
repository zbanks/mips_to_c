...
typedef struct EnZod {
    ...
    /* 0x014A */ char pad14A[0x36];                 /* maybe part of unk144[10]? */
    /* 0x0180 */ Vec3s unk180;                      /* inferred */
    /* 0x0186 */ char pad186[0x36];                 /* maybe part of unk180[10]? */
    /* 0x01BC */ SkelAnime unk1BC;                  /* inferred */
    /* 0x0200 */ ColliderCylinder unk200;           /* inferred */
    /* 0x024C */ s16 unk24C;                        /* inferred */
    /* 0x024E */ s16 unk24E;                        /* inferred */
    /* 0x0250 */ Vec3s unk250;                      /* inferred */
    /* 0x0256 */ u16 unk256;                        /* inferred */
    /* 0x0258 */ u16 unk258;                        /* inferred */
    /* 0x025A */ u16 unk25A;                        /* inferred */
    ...
    /* 0x0270 */ char pad270[0x10];                 /* maybe part of unk26C[5]? */
    /* 0x0280 */ f32 unk280;                        /* inferred */
    /* 0x0284 */ f32 unk284;                        /* inferred */
    /* 0x0288 */ char pad288[0x10];                 /* maybe part of unk284[5]? */
    /* 0x0298 */ s16 unk298;                        /* inferred */
    /* 0x029A */ u16 unk29A;                        /* inferred */
    /* 0x029C */ void (*actionFunc)(EnZod *, GlobalContext *);
} EnZod;                                            /* size 0x2A0 */
...
void EnZod_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk200, &this->actor, &D_80BB0540);
    this->unk260 = 0;
    temp_v0 = this->unk260;
    this->unk266 = 0x12C;
    this->unk25E = temp_v0;
...
void func_80BAF1EC(EnZod *arg0, GlobalContext *arg1) {
    ...
    func_801518B0(arg1, sp26, &arg0->actor);
}
...
void func_80BAF99C(EnZod *arg0, GlobalContext *arg1) {
    ...
    } else if (func_80BAF2B4(&arg0->actor, arg1) != 0) {
        func_800B8614(&arg0->actor, arg1, 210.0f);
    }
    temp_a1 = &sp20;
...
void func_80BAFA44(EnZod *arg0, GlobalContext *arg1) {
    ...
    sp1E = phi_a3;
    func_80BAF338(arg0, 0, 2U, phi_a3);
    func_801518B0(arg1, sp1E, &arg0->actor);
}
...
void func_80BAFB84(EnZod *arg0, GlobalContext *arg1) {
    ...
    if (func_80BAF2B4(&arg0->actor, arg1) != 0) {
        func_800B8614(&arg0->actor, arg1, 210.0f);
    }
}
...
void func_80BAFDB4(EnZod *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCanPlayNext((s16) arg0->actor.cutscene) != 0) {
        ...
        func_801518B0(arg1, 0x103AU, &arg0->actor);
...
void EnZod_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp3A = 0;
    sp38 = 0;
    if (func_80BAF2B4(&this->actor, globalCtx) != 0) {
        func_800E9250(globalCtx, &this->actor, &this->unk250, (Vec3s *) &sp38, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    ...
    Math_SmoothStepToS(&this->unk250.x, 0, 6, 0x1838, (s16) 0x64);
...
void EnZod_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80BB01B0(this, &globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk1BC.skeleton, this->unk1BC.limbDrawTbl, (s32) this->unk1BC.dListCount, func_80BB0128, func_80BB0170, &this->actor);
    if ((this->unk256 & 2) != 0) {
