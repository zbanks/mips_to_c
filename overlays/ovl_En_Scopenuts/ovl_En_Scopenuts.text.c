typedef struct EnScopenuts {
    ...
    /* 0x2DC */ ColliderCylinder unk2DC;            /* inferred */
    /* 0x328 */ u16 unk328;                         /* inferred */
    /* 0x32A */ char pad32A[0x6];                   /* maybe part of unk328[4]? */
    /* 0x330 */ Path *unk330;                       /* inferred */
    /* 0x334 */ char pad334[0x4];
    /* 0x338 */ s16 unk338;                         /* inferred */
    /* 0x33A */ char pad33A[0x2];
    /* 0x33C */ s16 unk33C;                         /* inferred */
    /* 0x33E */ char pad33E[0xA];                   /* maybe part of unk33C[6]? */
    /* 0x348 */ s32 unk348;                         /* inferred */
    /* 0x34C */ char pad34C[0x4];
    /* 0x350 */ f32 unk350;                         /* inferred */
    /* 0x354 */ char pad354[0x4];
    /* 0x358 */ s16 unk358;                         /* inferred */
    /* 0x35A */ s16 unk35A;                         /* inferred */
    /* 0x35C */ char pad35C[0x18];                  /* maybe part of unk35A[13]? */
...
struct _mips2c_stack_func_80BCBD28 {
    ...
    /* 0x3A */ char pad3A[0x6];                     /* maybe part of sp38[4]? */
...
void func_80BCAC40(Actor *arg0, GlobalContext *arg1) {
    ...
    sp60.unk0 = (s32) arg0->world.pos.x;
    sp60.unk4 = (s32) arg0->world.pos.y;
    sp60.unk8 = (s32) arg0->world.pos.z;
    temp_s1 = &sp54;
    sp64 += 100.0f;
    phi_s0 = 0;
    do {
...
void func_80BCB230(Actor *arg0, GlobalContext *arg1) {
    ...
    sp24 = SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BCCB6C[arg0->unk348].animationSeg);
...
void func_80BCBD28(Actor *arg0, GlobalContext *arg1) {
    ...
    sp40 = SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BCCB6C[arg0->unk348].animationSeg);
    temp_a2 = arg0 + 0x24;
    sp30 = temp_a2;
    ...
    if (phi_v0 == 0) {
        if ((arg0->unk370 & 3) == 0) {
            sp44.unk0 = sp30->x;
            sp44.unk4 = (s32) sp30->y;
            sp44.unk8 = (s32) sp30->z;
...
void EnScopenuts_Init(EnScopenuts *this, GlobalContext *globalCtx) {
    SkelAnime *sp34;
...
void EnScopenuts_Destroy(EnScopenuts *this, GlobalContext *globalCtx) {
    EnScopenuts *this = (EnScopenuts *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk2DC);
}

void EnScopenuts_Update(EnScopenuts *this, GlobalContext *globalCtx) {
    EnScopenuts *this = (EnScopenuts *) thisx;
...
void EnScopenuts_Draw(EnScopenuts *this, GlobalContext *globalCtx) {
    EnScopenuts *this = (EnScopenuts *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BCC828, func_80BCC9CC, func_80BCC9E4, (Actor *) this);
}
