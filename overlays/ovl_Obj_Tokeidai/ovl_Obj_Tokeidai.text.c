...
void func_80AB4664(Actor *arg0, GraphicsContext **arg1); /* static */
...
extern ? D_0600E818;
extern ? D_0600F518;
static InitChainEntry D_80AB49E0;                   /* unable to generate initializer */
...
typedef struct ObjTokeidai {
    ...
    /* 0x0174 */ void (*actionFunc)(ObjTokeidai *, GlobalContext *);
    ...
    if (temp_v1 != 0) {
        if (temp_v1 != 1) {
            if (temp_v1 != 2) {
                ...
                Audio_PlayActorSound2(&this->actor, 0x2942U);
                goto block_9;
            }
        } else {
            Audio_PlayActorSound2(&this->actor, 0x2941U);
            goto block_9;
        }
    } else {
        Audio_PlayActorSound2(&this->actor, 0x2940U);
block_9:
    }
...
void func_80AB39BC(ObjTokeidai *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0_3 == 2) || (temp_v0_3 == 5)) {
        Audio_PlayActorSound2(&this->actor, 0x293FU);
    }
    this->unk15E = 0xD48;
...
void func_80AB3A7C(ObjTokeidai *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v1 < 0xD48) {
        ...
        if ((temp_v0 == 2) || (temp_v0 == 5)) {
            func_800B9010(&this->actor, 0x213DU);
            return;
        }
    ...
    temp_v0_2 = (s32) (this->actor.params & 0xF000) >> 0xC;
    if ((temp_v0_2 == 2) || (temp_v0_2 == 5)) {
        Audio_PlayActorSound2(&this->actor, 0x293EU);
    }
    this->unk15E = 0xD48;
