...
void func_80AC96A4(ObjOcarinalift *arg0, GlobalContext *arg1); /* static */
...
void func_80AC9C48(Actor *arg0, GlobalContext *arg1); /* static */
extern Gfx D_06001DB0;
extern Gfx D_06001E40;
extern CollisionHeader D_060048D0;
static InitChainEntry D_80AC9D70;                   /* unable to generate initializer */

typedef struct ObjOcarinalift {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ s32 unk144;                        /* inferred */
    /* 0x0148 */ char pad148[0x14];                 /* maybe part of unk144[6]? */
    /* 0x015C */ void (*actionFunc)(ObjOcarinalift *, GlobalContext *);
...
void ObjOcarinalift_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80AC9D70);
...
void func_80AC96D0(Actor *arg0, GlobalContext *arg1) {
    ...
    sp28 = temp_a2;
    Math_Vec3f_Diff(&sp48, &arg0->world.pos, temp_a2);
