...
void ObjOcarinalift_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80AC94C0(this, this->unk_168);
...
void ObjOcarinalift_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_176;
    if ((s32) temp_v0 > 0) {
        this->unk_176 = temp_v0 - 1;
        if (this->unk_176 == 0) {
