typedef struct EnNwc {
    ...
    /* 0x248 */ s8 unk248;                          /* inferred */
    /* 0x249 */ s8 unk249;                          /* inferred */
...
void func_80944A50(EnNwc *this, GlobalContext *globalCtx) {
    ...
    if (((sp40 * sp40) + (sp48 * sp48)) < 25.0f) {
        ...
        phi_v1_3 = (Math_Vec3f_Yaw((Vec3f *) temp_a3, (this->actor.home.rot.z * 0xC) + sp4C) + this->unk258) << 0x10;
block_25:
