struct _mips2c_stack_EnMa4_BeginDescribeThemCs {};  /* size 0x0 */

struct _mips2c_stack_EnMa4_BeginEponasSongCs {
    /* 0x00 */ char pad_0[0x1E];
    /* 0x1E */ s16 sp1E;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMa4_BeginHorsebackGame {};   /* size 0x0 */

struct _mips2c_stack_EnMa4_ChangeAnim {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ void *sp28;                          /* inferred */
    /* 0x2C */ char pad_2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnMa4_ChooseNextDialogue {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnMa4_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_DialogueHandler {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMa4_Draw {
...
struct _mips2c_stack_EnMa4_EndEponasSongCs {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnMa4_EponasSongCs {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ u32 sp24;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnMa4_HandlePlayerChoice {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMa4_HorsebackGameCheckPlayerInteractions {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_HorsebackGameEnd {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_HorsebackGameTalking {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_HorsebackGameWait {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_Init {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ ColliderCylinder *sp30;              /* inferred */
    /* 0x34 */ char pad_34[0xC];
};                                                  /* size = 0x40 */

struct _mips2c_stack_EnMa4_InitFaceExpression {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_InitHorsebackGame {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMa4_InitPath {
    /* 0x00 */ char pad_0[0x20];
...
struct _mips2c_stack_EnMa4_OverrideLimbDraw {
    /* 0x00 */ char pad_0[0x4];
...
struct _mips2c_stack_EnMa4_PostLimbDraw {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ ? sp28;                              /* inferred */
    /* 0x28 */ char pad_28[0x10];
};                                                  /* size = 0x38 */

struct _mips2c_stack_EnMa4_RunInCircles {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ PosRot *sp28;                        /* inferred */
    /* 0x2C */ char pad_2C[0x2];
    /* 0x2E */ s16 sp2E;                            /* inferred */
    /* 0x30 */ char pad_30[0x4];                    /* maybe part of sp2E[3]? */
    /* 0x34 */ f32 sp34;                            /* inferred */
    /* 0x38 */ f32 sp38;                            /* inferred */
    /* 0x3C */ f32 sp3C;                            /* inferred */
};                                                  /* size = 0x40 */

struct _mips2c_stack_EnMa4_SetFaceExpression {};    /* size 0x0 */

struct _mips2c_stack_EnMa4_SetupBeginDescribeThemCs {}; /* size 0x0 */

struct _mips2c_stack_EnMa4_SetupBeginEponasSongCs {}; /* size 0x0 */

struct _mips2c_stack_EnMa4_SetupBeginHorsebackGame {}; /* size 0x0 */

struct _mips2c_stack_EnMa4_SetupDialogueHandler {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_SetupEndEponasSongCs {}; /* size 0x0 */

struct _mips2c_stack_EnMa4_SetupEponasSongCs {};    /* size 0x0 */

struct _mips2c_stack_EnMa4_SetupHorsebackGameEnd {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnMa4_SetupHorsebackGameWait {}; /* size 0x0 */

struct _mips2c_stack_EnMa4_SetupWait {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMa4_StartDialogue {
    /* 0x00 */ char pad_0[0x20];
...
struct _mips2c_stack_EnMa4_Update {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ ColliderCylinder *sp24;              /* inferred */
    /* 0x28 */ char pad_28[0x8];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnMa4_Wait {
    /* 0x00 */ char pad_0[0x22];
    /* 0x22 */ s16 sp22;                            /* inferred */
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80ABDCA0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80ABDD9C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */
...
void EnMa4_InitPath(EnMa4 *arg0, GlobalContext *arg1) {
    ...
    arg0->pathIndex = 0;
    temp_a0_2 = arg0 + 0x24;
    arg0->pathPointsCount = (s16) temp_v1->unk_0;
    arg0->actor.home.pos.x = (f32) temp_v0->unk_0;
    arg0->actor.home.pos.y = (f32) temp_v0->unk_2;
    arg0->actor.home.pos.z = (f32) temp_v0->unk_4;
    sp20 = (f32) temp_v0->unk_6;
    sp24 = (f32) arg0->pathPoints->unk_8;
    sp28 = (f32) arg0->pathPoints->unk_A;
...
void EnMa4_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, (Actor *) this, &D_80AC00B0);
...
void EnMa4_RunInCircles(EnMa4 *arg0, GlobalContext *arg1) {
    ...
    if ((D_80AC024C == 0xD) && (func_801378B8(&arg0->skelAnime, 37.0f) != 0)) {
        Audio_PlayActorSound2((Actor *) arg0, 0x29BFU);
    }
    ...
    sp2E = Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) temp_a1);
    if (Math_Vec3f_DistXZ((Vec3f *) temp_a0, (Vec3f *) &sp34) > 50.0f) {
    ...
    Actor_UpdateBgCheckInfo(arg1, (Actor *) arg0, 0.0f, 0.0f, 0.0f, 4U);
    ...
    if ((&D_06007328 == arg0->skelAnime.animCurrentSeg) && ((sp28 = (PosRot *) temp_a0_2, (func_801378B8(temp_a0_2, 0.0f) != 0)) || (func_801378B8(temp_a0_2, 4.0f) != 0))) {
        Audio_PlayActorSound2((Actor *) arg0, 0x3ABEU);
    }
}
...
void EnMa4_Wait(EnMa4 *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 2) || (temp_v0 == 3)) {
        ...
        this->animTimer += 1;
        temp_v0_2 = this->animTimer;
        if (temp_v0_2 == 5) {
            EnMa4_ChangeAnim(this, 0x11);
        } else if (temp_v0_2 == 8) {
            this->animTimer = 0;
            EnMa4_ChangeAnim(this, 0xF);
        }
...
void EnMa4_DialogueHandler(EnMa4 *this, GlobalContext *globalCtx) {
    ...
    if (this->type != 2) {
        Math_SmoothStepToS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 5, 0x7D0, (s16) 0x3E8);
    }
}
...
void EnMa4_HorsebackGameWait(EnMa4 *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.unk_3E00 != 0) || ((u32) gSaveContext.unk_3E04 >= 0x2EE0U) || (this->poppedBalloonCounter == 0xA)) {
...
void EnMa4_HorsebackGameEnd(EnMa4 *this, GlobalContext *globalCtx) {
    ...
    temp_a2 = this;
    if (globalCtx->actorCtx.actorList[2].first->unk_A6C & 0x100000) {
...
void EnMa4_EponasSongCs(EnMa4 *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x78U) != 0) {
        ...
        if (globalCtx->csCtx.frames == temp_a0->unk_2) {
            temp_a1 = temp_a0->unk_0;
            if (D_80AC0260 != temp_a1) {
                D_80AC0260 = temp_a1;
                this->animTimer = 0;
                temp_a0_2 = temp_v1->unk_1F4C->unk_0;
                if (temp_a0_2 != 1) {
                    if (temp_a0_2 != 2) {

                    } else {
                        this->hasBow = 0;
                        EnMa4_ChangeAnim(this, 4, 1);
                    }
                } else {
                    this->hasBow = 1;
                    EnMa4_ChangeAnim(this, 1, 1);
                }
            }
        }
        func_800EDF24((Actor *) this, globalCtx, sp24);
        if ((D_80AC0260 == 2) && (this->animTimer == 0) && (func_801378B8(&this->skelAnime, this->skelAnime.animFrameCount) != 0)) {
...
void EnMa4_StartDialogue(EnMa4 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        if (temp_v0 != 1) {
            ...
            if (temp_v0_2 == 2) {
                temp_t0 = gSaveContext.unk_3E00;
                temp_t1 = gSaveContext.unk_3E04;
                sp20 = temp_t0;
                sp24 = temp_t1;
...
block_49:
    ...
    if (temp_v0_4 == 2) {
        temp_t2 = gSaveContext.unk_3E00;
        temp_t3 = gSaveContext.unk_3E04;
        sp20 = temp_t2;
        sp24 = temp_t3;
...
void EnMa4_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80ABDD9C((Actor *) this, globalCtx);
}
...
void EnMa4_PostLimbDraw(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp28.unk_0 = (s32) D_80AC0264.unk_0;
    sp28.unk_4 = (s32) D_80AC0264.unk_4;
    sp28.unk_8 = (s32) D_80AC0264.unk_8;
    if (arg1 == 0xE) {
...
void EnMa4_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnMa4_OverrideLimbDraw, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) EnMa4_PostLimbDraw, (Actor *) this);
}
