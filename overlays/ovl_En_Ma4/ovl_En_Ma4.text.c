...
struct _mips2c_stack_EnMa4_RunInCircles {
    ...
    /* 0x30 */ char pad30[0x4];                     /* maybe part of sp2E[3]? */
...
void EnMa4_Init(EnMa4 *this, GlobalContext *globalCtx) {
...
void EnMa4_Destroy(EnMa4 *this, GlobalContext *globalCtx) {
    EnMa4 *this = (EnMa4 *) thisx;
...
void EnMa4_HorsebackGameWait(EnMa4 *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.unk3E00 != 0) || ((u32) gSaveContext.unk3E04 >= 0x2EE0U) || (this->poppedBalloonCounter == 0xA)) {
...
void EnMa4_Update(EnMa4 *this, GlobalContext *globalCtx) {
...
void EnMa4_PostLimbDraw(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp28.unk0 = (s32) D_80AC0264.unk0;
    sp28.unk4 = (s32) D_80AC0264.unk4;
    sp28.unk8 = (s32) D_80AC0264.unk8;
    if (arg1 == 0xE) {
...
void EnMa4_Draw(EnMa4 *this, GlobalContext *globalCtx) {
