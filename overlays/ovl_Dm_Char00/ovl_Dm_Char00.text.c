typedef struct DmChar00 {
    ...
    /* 0x18E */ char pad18E[0x54];                  /* maybe part of unk188[15]? */
    /* 0x1E2 */ Vec3s unk1E2;                       /* inferred */
    /* 0x1E8 */ char pad1E8[0x54];                  /* maybe part of unk1E2[15]? */
...
void DmChar00_Init(DmChar00 *this, GlobalContext *globalCtx) {
    ActorShape *sp34;
    SkelAnime *sp30;
    ActorShape *temp_a0;
    SkelAnime *temp_a1;
...
void DmChar00_Destroy(DmChar00 *this, GlobalContext *globalCtx) {
    DmChar00 *this = (DmChar00 *) thisx;
...
void DmChar00_Update(DmChar00 *this, GlobalContext *globalCtx) {
    DmChar00 *this = (DmChar00 *) thisx;
...
void DmChar00_Draw(DmChar00 *this, GlobalContext *globalCtx) {
    ...
    if ((globalCtx->csCtx.state != 0) || ((globalCtx->sceneNum == 0x1A) && (gSaveContext.sceneSetupIndex == 0) && (globalCtx->roomCtx.currRoom.num == 0) && (globalCtx->csCtx.unk_12 == 1) && (this->actor.params == 0))) {
        ...
        sp58 = sp58;
        sp58->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80AA6A6C, NULL, (Actor *) this, temp_t5);
    }
}
