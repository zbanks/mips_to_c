typedef struct DmChar00 {
    ...
    /* 0x23C */ void (*actionFunc)(DmChar00 *, GlobalContext *);
...
struct _mips2c_stack_DmChar00_Destroy {};           /* size 0x0 */

struct _mips2c_stack_DmChar00_Draw {
...
struct _mips2c_stack_DmChar00_Init {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ SkelAnime *sp30;                     /* inferred */
    /* 0x34 */ ActorShape *sp34;                    /* inferred */
    /* 0x38 */ char pad_38[0x8];
};                                                  /* size = 0x40 */

struct _mips2c_stack_DmChar00_Update {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AA5580 {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80AA561C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5720 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA575C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5890 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA58CC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5950 {};              /* size 0x0 */

struct _mips2c_stack_func_80AA5960 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA59E4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5A6C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5AF4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5BF8 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AA5CD4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5D10 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5D6C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5DC8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5E2C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA5EBC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AA62FC {
    /* 0x00 */ char pad_0[0x18];
...
struct _mips2c_stack_func_80AA67F8 {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ Actor *sp2C;                         /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80AA695C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AA6A6C {
...
void func_80AA5720(Actor *arg0, void *arg1) {
    if ((arg0->params == 0) && (arg1->unk_1F34 == 0x1F9)) {
...
void func_80AA5890(Actor *arg0, void *arg1) {
    if ((arg0->params == 0) && (arg1->unk_1F34 == 0x14)) {
        Audio_PlayActorSound2(arg0, 0x281BU);
    }
}
...
void func_80AA5CD4(Actor *arg0, void *arg1) {
    if ((arg0->params != 0) && (arg1->unk_1F34 == 0x1D3)) {
        Audio_PlayActorSound2(arg0, 0x2924U);
    }
}
...
void DmChar00_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_240 = temp_t1->unk_0;
    this->unk_244 = temp_t1->unk_4;
    temp_t6 = (this->actor.params * 0x10) + &D_80AA77D8;
    this->unk_248 = temp_t1->unk_8;
    this->unk_24C = temp_t1->unk_C;
    temp_a0 = &this->actor.shape;
    this->unk_250 = temp_t6->unk_0;
    this->unk_254 = temp_t6->unk_4;
    this->unk_258 = temp_t6->unk_8;
    this->unk_25C = temp_t6->unk_C;
    this->unk_260 = 0x63;
...
void func_80AA67F8(DmChar00 *arg0, GlobalContext *arg1) {
    ...
    if ((arg1->csCtx.state == 0) && (gSaveContext.sceneSetupIndex == 0) && (arg1->csCtx.unk_12 == 1)) {
        if (arg0->unk_261 != 0x2A) {
            arg0->unk_261 = 0x2A;
            func_80AA5580(&arg0->unk_144, ((0x2AU & 0xFF) * 0x18) + &D_80AA6FB0, 0);
        }
        Math_SmoothStepToF((f32 *) &arg0->actor.world, 0.0f, 0.5f, 0.5f, 0.001f);
        ...
        if (sp2C->world.pos.z < -625.0f) {
            arg0->unk_261 = 0x2B;
            func_80AA5580(&arg0->unk_144, ((0x2BU & 0xFF) * 0x18) + &D_80AA6FB0, 0);
...
void DmChar00_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80AA62FC((Actor *) this, globalCtx);
}
...
void DmChar00_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((globalCtx->csCtx.state != 0) || ((globalCtx->sceneNum == 0x1A) && (gSaveContext.sceneSetupIndex == 0) && (globalCtx->roomCtx.currRoom.num == 0) && (globalCtx->csCtx.unk_12 == 1) && (this->actor.params == 0))) {
        ...
        temp_a0_2 = (this->unk_262 * 0x32) & 0x1FF;
        phi_a0 = temp_a0_2;
        if (temp_a0_2 >= 0x100) {
        ...
        sp58 = sp58;
        sp58->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, func_80AA6A6C, NULL, (Actor *) this, temp_t5);
    }
}
