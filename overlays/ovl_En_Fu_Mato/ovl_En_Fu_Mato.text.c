...
void func_80ACE4C8(EnFuMato *arg0, GlobalContext *arg1); /* static */
...
static u32 D_80ACF63C = {0x6001C80, 0x6001D68, 0x6001E50, 0x6001F38, 0x6002020, 0x6002108};
...
void EnFuMato_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetSphere(globalCtx, temp_a1, &this->actor, &D_80ACF610);
...
void func_80ACE718(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((arg0->bgCheckFlags & 1) != 0) || (arg0->world.pos.y < -500.0f)) {
        sp3C.x = D_80ACF684.unk0;
        sp3C.y = D_80ACF684.unk4;
        sp3C.z = D_80ACF684.unk8;
        sp30.x = D_80ACF690.unk0;
        sp30.y = D_80ACF690.unk4;
        sp30.z = D_80ACF690.unk8;
        func_800B3030(arg1, &arg0->world.pos, &sp3C, &sp30, (s16) 0x14, (s16) 0x28, 2);
...
void EnFuMato_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80ACF04C(&this->actor, globalCtx);
    if (this->unk30A == 1) {
        func_80ACEFC4(&this->actor);
    }
}
...
void EnFuMato_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v0_2 == 1) {
        func_80ACF1F4(this, &globalCtx->state.gfxCtx, this, sp24);
        return;
    }
    func_80ACF3F4(this, &globalCtx->state.gfxCtx, this, sp24);
}
