typedef struct DmAl {
    ...
    /* 0x18C */ MtxF unk18C;                        /* inferred */
    /* 0x1CC */ char pad1CC[0x140];                 /* maybe part of unk18C[6]? */
    /* 0x30C */ Vec3s unk30C;                       /* inferred */
    /* 0x312 */ char pad312[0x9C];                  /* maybe part of unk30C[27]? */
    /* 0x3AE */ Vec3s unk3AE;                       /* inferred */
    /* 0x3B4 */ char pad3B4[0x9C];                  /* maybe part of unk3AE[27]? */
    /* 0x450 */ u8 unk450;                          /* inferred */
    /* 0x451 */ char pad451[0x3];                   /* maybe part of unk450[4]? */
    /* 0x454 */ s32 unk454;                         /* inferred */
    /* 0x458 */ s32 unk458;                         /* inferred */
...
void DmAl_Init(DmAl *this, GlobalContext *globalCtx) {
...
void DmAl_Destroy(DmAl *this, GlobalContext *globalCtx) {
    DmAl *this = (DmAl *) thisx;

}

void DmAl_Update(DmAl *this, GlobalContext *globalCtx) {
    DmAl *this = (DmAl *) thisx;
...
void DmAl_Draw(DmAl *this, GlobalContext *globalCtx) {
    ? *temp_s1;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    ...
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80C1C028, func_80C1C064, func_80C1C11C, (Actor *) this);
    phi_s2 = &this->unk18C;
    phi_s1 = &D_80C1C294;
    do {
