...
s32 func_80BF2368(EnIg *arg0, u8 *arg2, struct_80133038_arg2 *); /* static */
...
static ActorAnimationEntryS D_80BF347C = {
...
typedef struct EnIg {
    ...
    /* 0x0188 */ void (*actionFunc)(EnIg *, GlobalContext *);
    /* 0x018C */ char pad18C[0x4];                  /* maybe part of actionFunc[2]? */
    /* 0x0190 */ MtxF unk190;                       /* inferred */
    /* 0x01D0 */ ColliderCylinder unk1D0;           /* inferred */
    /* 0x021C */ ColliderSphere unk21C;             /* inferred */
    /* 0x0274 */ char pad274[0x24];
    /* 0x0298 */ u8 unk298;                         /* inferred */
    /* 0x0299 */ char pad299[0x3];                  /* maybe part of unk298[4]? */
    /* 0x029C */ s32 *unk29C;                       /* inferred */
    /* 0x02A0 */ s32 unk2A0;                        /* inferred */
    /* 0x02A4 */ char pad2A4[0x4];                  /* maybe part of unk2A0[2]? */
    /* 0x02A8 */ Actor *unk2A8;                     /* inferred */
    /* 0x02AC */ char pad2AC[0x40];                 /* maybe part of unk2A8[17]? */
    /* 0x02EC */ Vec3s unk2EC;                      /* inferred */
    /* 0x02F2 */ char pad2F2[0x6C];                 /* maybe part of unk2EC[19]? */
    /* 0x035E */ Vec3s unk35E;                      /* inferred */
    /* 0x0364 */ char pad364[0x6C];                 /* maybe part of unk35E[19]? */
    /* 0x03D0 */ u16 unk3D0;                        /* inferred */
    /* 0x03D2 */ char pad3D2[0x2];                  /* maybe part of unk3D0[2]? */
    /* 0x03D4 */ f32 unk3D4;                        /* inferred */
    /* 0x03D8 */ char pad3D8[0xC];                  /* maybe part of unk3D4[4]? */
    /* 0x03E4 */ s16 unk3E4;                        /* inferred */
    /* 0x03E6 */ s16 unk3E6;                        /* inferred */
    /* 0x03E8 */ s16 unk3E8;                        /* inferred */
    ...
    /* 0x03F4 */ char pad3F4[0x4];                  /* maybe part of unk3F2[3]? */
    /* 0x03F8 */ void *unk3F8;                      /* inferred */
    /* 0x03FC */ s32 unk3FC;                        /* inferred */
    /* 0x0400 */ char pad400[0xC];                  /* maybe part of unk3FC[4]? */
} EnIg;                                             /* size 0x40C */
...
void func_80BF1258(EnIg *arg0) {
    arg0->unk144.animPlaybackSpeed = arg0->unk3D4;
...
void func_80BF1354(Actor *arg0, GlobalContext *arg1) {
    ...
    sp18 = temp_a1_2;
    CollisionCheck_SetOC(arg1, temp_a1_2, &temp_a2->base);
    arg0->unk26A = (s16) (s32) ((f32) arg0->unk262 * arg0->unk26C);
...
void func_80BF14B0(void *arg0) {
    ...
    Math_Vec3f_Copy(&sp40, arg0->unk2A8 + 0x24);
    Math_Vec3f_Copy(&sp34, arg0 + 0x24);
    Math_ApproachS(arg0 + 0x3EA, (s16) (Math_Vec3f_Yaw(&sp34, &sp40) - arg0->unkBE), 4, 0x2AA8);
    temp_v0 = arg0->unk3EA;
    ...
    temp_v0_2 = arg0->unk2A8;
    if (temp_v0_2->unk0 == 0) {
        sp40.y = temp_v0_2->unkC44 + 3.0f;
    } else {
        Math_Vec3f_Copy(&sp40, temp_v0_2 + 0x3C);
    }
    Math_ApproachS(arg0 + 0x3E8, Math_Vec3f_Pitch(&sp34, &sp40), 4, 0x2AA8);
    temp_v0_3 = arg0->unk3E8;
...
void func_80BF15EC(EnIg *arg0) {
    ...
    if (((arg0->unk3D0 & 0x20) != 0) && (arg0->unk2A8 != 0)) {
        temp_v0 = arg0->unk3EE;
        if (temp_v0 == 0) {
            phi_v1 = 0;
        } else {
            arg0->unk3EE = temp_v0 - 1;
            phi_v1 = arg0->unk3EE;
        }
        if (phi_v1 == 0) {
            func_80BF14B0();
            temp_t2 = arg0->unk3D0 & 0xFDFF;
...
block_7:
    ...
    if (temp_v0_3 == 0) {
        ...
        arg0->unk3EE = temp_v0_3 - 1;
        phi_v1_2 = arg0->unk3EE;
    }
    if (phi_v1_2 == 0) {
        arg0->unk3D0 |= 0x200;
    }
...
s32 func_80BF19A0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk3D0 & 7) != 0) {
        ...
        if (func_800B84D0(arg0, arg1) != 0) {
            ...
            arg0->unk3F6 = 0;
            arg0->unk3F8 = 0;
            arg0->child = arg0->unk2A8;
            temp_v1 = arg0->unk298;
            arg0->unk29C = func_80BF1920(arg0, arg1);
            if ((temp_v1 != 2) && (temp_v1 != 3) && (temp_v1 != 4)) {
                arg0->unk3D0 = (u16) (arg0->unk3D0 | 0x20);
            }
            arg0->unk188 = func_80BF2BD4;
            phi_v1 = 1;
        }
    }
    return phi_v1;
...
void func_80BF1A60(Actor *arg0, ? arg1) {
    ...
    if (temp_v0 == 0) {
        ...
        arg0->unk3F4 = (s16) (arg0->unk3F4 + 1);
        return;
    }
    if ((temp_v0 == 1) && (func_801378B8(arg0 + 0x144, arg0->unk154) != 0)) {
...
s32 func_80BF1C44(Actor *arg0, GlobalContext *arg1, u8 *arg2, u8 arg3, s16 arg4) {
    ...
    if (temp_a2 >= 0) {
        sp2C = temp_v0;
        arg0->unk274 = func_8013BB34(arg1, sp4F, temp_a2);
        phi_v1 = sp2C;
    }
    if ((phi_v1 != 0) && (phi_v1->update != 0)) {
        ...
        if (temp_v0_2 != 0) {
            ...
            sp48 = temp_v0_3;
            Math_Vec3s_ToVec3f(&sp3C, ((arg0->unk274->count * 6) + temp_v0_3) - 0xC);
            Math_Vec3s_ToVec3f(&sp30, ((arg0->unk274->count * 6) + sp48) - 6);
...
s32 func_80BF1D78(Actor *arg0) {
    ...
    if (func_80BF1C44(arg0, (GlobalContext *)4, (u8 *)0x202) != 0) {
        ...
        temp_t9 = arg0->unk3D0 | 0x20;
        arg0->unk3D0 = temp_t9;
        arg0->unk3D0 = (u16) (temp_t9 | 0x100);
        phi_v1 = 1;
    }
    return phi_v1;
}
...
s32 func_80BF1DF4(Actor *arg0, GlobalContext *arg1, void *arg2) {
    ...
    sp55 = (u8) arg0->params;
    arg0->unk274 = NULL;
    sp50 = func_80BF1200(arg1, arg2->unk0);
    temp_a2 = *(&D_80BF3318 + (arg2->unk0 * 4));
    if (temp_a2 >= 0) {
        arg0->unk274 = func_8013BB34(arg1, sp55, temp_a2);
    }
    if ((sp50 != 0) && (sp50->unk138 != 0)) {
        ...
        if (temp_v0 != 0) {
            ...
            Math_Vec3f_Copy(arg0 + 0x2B0, &sp40);
            Math_Vec3f_Copy(arg0 + 0x2BC, &sp34);
            ...
            arg0->unk3E0 = (s16) (arg2->unk8 - arg2->unk4);
            arg0->flags &= -2;
            arg0->unk3E2 = (s16) (sp56 - arg2->unk4);
            arg0->unk3D0 = (u16) (arg0->unk3D0 | 0x100);
...
s32 func_80BF1FA8(Actor *arg0, GlobalContext *arg1, void *arg2) {
    ...
    temp_a3 = *(&D_80BF3318 + (arg2->unk0 * 4));
    if (temp_a3 >= 0) {
        sp20 = 0;
        sp2E = temp_t0 & 0xFFFF;
        arg0->unk274 = func_8013BB34(arg1, sp2B, temp_a3);
    }
    temp_v0 = arg0->unk274;
    phi_v0 = temp_v0;
    phi_v1_2 = 0;
    ...
    if (phi_v0 != 0) {
        temp_v0_2 = arg0->unk298;
        if (((s32) temp_v0_2 < 0xA) && (temp_v0_2 != 0) && ((s32) arg0->unk3EC >= 0)) {
        ...
        temp_v0_3 = arg2->unk8;
        if (temp_v0_3 < phi_v1) {
            arg0->unk288 = (s32) ((phi_v1 - temp_v0_3) + 0xFFFF);
        } else {
            arg0->unk288 = (s32) (temp_v0_3 - phi_v1);
        }
        arg0->unk294 = (s32) ((temp_t0 & 0xFFFF) - phi_v1);
        temp_lo = (s32) arg0->unk288 / (s32) ((arg0->unk274->count - 2) & 0xFFFF);
        temp_t8 = arg0->unk3D0 & 0xFFF7;
        arg0->unk3D0 = temp_t8;
        arg0->unk28C = temp_lo;
        arg0->unk290 = (s32) (((s32) arg0->unk294 / temp_lo) + 2);
        arg0->unk3D0 = (u16) (temp_t8 & 0xFFEF);
        func_8013AED4(arg0 + 0x3D0, 3U, 7U);
        arg0->unk3D0 = (u16) (arg0->unk3D0 | 0x100);
...
s32 func_80BF219C(Actor *arg0, GlobalContext *arg1, u8 *arg2) {
    ...
    if (temp_a3 >= 0) {
        sp28 = 0;
        arg0->unk274 = func_8013BB34(arg1, sp4F, temp_a3);
        phi_v1 = sp28;
    }
    temp_v0 = arg0->unk274;
    if ((temp_v0 != 0) && ((s32) temp_v0->count >= 2)) {
        temp_v0_2 = Lib_SegmentedToVirtual((void *) temp_v0->points);
        sp30 = temp_v0_2;
        Math_Vec3s_ToVec3f(&sp40, ((arg0->unk274->count * 6) + temp_v0_2) - 6);
        Math_Vec3s_ToVec3f(&sp34, ((arg0->unk274->count * 6) + sp30) - 0xC);
...
? func_80BF2470(Actor *arg0, GlobalContext *arg1) {
    ...
    sp44 = func_80BF1200(arg1, arg0->unk298);
    if ((func_8013AD6C(arg1) == 0) && (arg0->unk3EC != 0)) {
        if ((sp44 != 0) && (sp44->unk138 != 0)) {
            if (((f32) arg0->unk3E2 / (f32) arg0->unk3E0) <= 0.9f) {
                sp44->unk1A7 = (s8) arg0->unk2A4;
            } else {
                sp44->unk1A7 = 0;
            }
        }
...
? func_80BF25E8(Actor *arg0, GlobalContext *arg1) {
    ...
    sp54 = 0;
    sp50 = 0;
    func_8013AF00(&sp7C, 3, arg0->unk274->count + 3);
    temp_v1 = arg0 + 0x278;
    phi_v1 = temp_v1;
    if ((arg0->unk3D0 & 8) == 0) {
        temp_v0 = arg0 + 0x290;
        ...
        sp48 = temp_a1;
        sp40 = temp_v0;
        func_8013B6B0(arg0->unk274, temp_a1, temp_a2, arg0->unk28C, arg0->unk288, temp_v0, &sp7C, &sp58, (s16) (s32) arg0->unk3EC);
        func_8013B878(arg1, arg0->unk274, arg0->unk290, &sp58);
        arg0->unk3D0 = (u16) (arg0->unk3D0 | 8);
    ...
    sp3C = phi_v1;
    if (func_8013B6B0(arg0->unk274, sp48, sp44, arg0->unk28C, arg0->unk288, sp40, &sp7C, phi_v1, (s16) (s32) arg0->unk3EC) != 0) {
        arg0->unk3D0 = (u16) (arg0->unk3D0 | 0x10);
    } else {
...
? func_80BF2890(Actor *arg0, ? arg1) {
    ...
    phi_v0 = temp_v0;
    if ((temp_v0 != 0) && (arg0->unk3F2 == 2)) {
        temp_v0_2 = temp_v1 & 0xFEFF;
        arg0->unk3D0 = temp_v0_2;
        phi_v0 = temp_v0_2 & 0x100;
    }
    if ((phi_v0 == 0) && (func_801378B8(arg0 + 0x144, arg0->unk154) != 0)) {
        if (arg0->unk408 != 0) {
...
? func_80BF293C(Actor *arg0, ? arg1) {
    ...
    } else if ((arg0->unk3FC == 7) && (func_801378B8(arg0 + 0x144, arg0->unk154) != 0)) {
        func_8013AED4(arg0 + 0x3D0, 3U, 7U);
...
void func_80BF2AF8(EnIg *this, GlobalContext *globalCtx) {
    ...
    this->unk3EC = gSaveContext.unk_14 + gGameInfo->data[15];
    if ((func_80133038(globalCtx, &D_80BF3260, &sp20) == 0) || ((sp20.unk0 != this->unk298) && (func_80BF2368(this, (u8 *) globalCtx, &sp20) == 0))) {
    ...
    this->unk2A8 = func_80BF146C(this, globalCtx);
    this->unk298 = sp20.unk0;
    func_80BF2A50(&this->actor, globalCtx);
}
...
void func_80BF2BD4(EnIg *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58(&this->actor, globalCtx, this->unk29C, this->unk3F8, &this->unk2A0) != 0) {
        func_8013AED4(&this->unk3D0, 3U, 7U);
        temp_t9 = this->unk3D0 & 0xFFDF;
        this->unk3D0 = temp_t9;
        this->unk3D0 = temp_t9 | 0x200;
        this->unk3EE = 0x14;
        this->unk2A0 = 0;
...
void EnIg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk144, &D_060130D0, NULL, &this->unk2EC, &this->unk35E, 0x13);
    this->unk3FC = -1;
    func_80BF1284(&this->actor, 0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk1D0, &this->actor, &D_80BF3418);
    Collider_InitAndSetSphere(globalCtx, &this->unk21C, &this->actor, &D_80BF3444);
...
void EnIg_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnIg *this = (EnIg *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk1D0);
    Collider_DestroySphere(globalCtx, &this->unk21C);
}

void EnIg_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnIg *this = (EnIg *) thisx;
    func_80BF19A0(&this->actor, globalCtx);
    ...
    if (this->unk298 != 0) {
        ...
        func_80BF13E4(this);
        func_80BF15EC(this);
        func_8013C964(&this->actor, globalCtx, 60.0f, 30.0f, 0, (s16) (this->unk3D0 & 7));
        Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 30.0f, 12.0f, 0.0f, 4U);
        func_80BF1354(&this->actor, globalCtx);
    }
}
...
void func_80BF2EFC(s32 arg0, s32 arg1, ? arg2, ? arg3, s32 arg4, void **arg5) {
    ...
    if (arg1 == 0xB) {
        ...
        temp_v0 = *arg5;
        *arg5 = temp_v0 + 8;
        temp_v0->unk4 = &D_06008710;
        temp_v0->unk0 = 0xDE000000;
        temp_v0_2 = *arg5;
        *arg5 = temp_v0_2 + 8;
        temp_v0_2->unk4 = &D_060087B8;
        temp_v0_2->unk0 = 0xDE000000;
    }
    if (arg1 == 0xC) {
        temp_v0_3 = *arg5;
        *arg5 = temp_v0_3 + 8;
        temp_v0_3->unk4 = &D_060089D8;
        temp_v0_3->unk0 = 0xDE000000;
    }
    if (arg1 == 9) {
        temp_v0_4 = *arg5;
        *arg5 = temp_v0_4 + 8;
        temp_v0_4->unk4 = &D_06008B00;
        temp_v0_4->unk0 = 0xDE000000;
        SysMatrix_MultiplyVector3fByState(&D_80BF351C, &sp2C);
        Math_Vec3f_ToVec3s(arg4 + 0x264, &sp2C);
    }
    if (arg1 == 0xA) {
...
void func_80BF302C(s32 arg0, s32 arg1, void *arg2, ? arg3) {
    ...
    if (arg1 == 9) {
        func_8013AD9C((s16) (arg2->unk3E8 + 0x4000), (s16) (arg2->unk3EA + arg2->unkBE + 0x4000), arg2 + 0x2D4, arg2 + 0x2E6, phi_v0, phi_v1);
        SysMatrix_StatePop();
        SysMatrix_InsertTranslation(arg2->unk2D4, arg2->unk2D8, arg2->unk2DC, 0);
        Matrix_Scale(arg2->unk58, arg2->unk5C, arg2->unk60, 1);
        Matrix_RotateY(arg2->unk2E8, 1U);
        SysMatrix_InsertXRotation_s(arg2->unk2E6, 1);
        SysMatrix_InsertZRotation_s(arg2->unk2EA, 1);
        SysMatrix_StatePush();
    }
}
...
void EnIg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk298 != 0) {
        ...
        sp44 = temp_v0;
        sp44->words.w1 = Lib_SegmentedToVirtual(*(&D_80BF3534 + (this->unk3F2 * 4)));
        temp_s1->polyOpa.p = func_8013AB00(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, (void *) func_80BF2EDC, (void *) func_80BF2EFC, (void *) func_80BF302C, &this->actor, temp_s1->polyOpa.p);
        SysMatrix_SetCurrentState(&this->unk190);
