...
typedef struct EnIg {
    ...
    /* 0x190 */ MtxF unk190;                        /* inferred */
    /* 0x1D0 */ ColliderCylinder unk1D0;            /* inferred */
    /* 0x21C */ ColliderSphere unk21C;              /* inferred */
    /* 0x274 */ char pad274[0x24];
    /* 0x298 */ u8 unk298;                          /* inferred */
    /* 0x299 */ char pad299[0x3];                   /* maybe part of unk298[4]? */
    /* 0x29C */ s32 *unk29C;                        /* inferred */
    /* 0x2A0 */ s32 unk2A0;                         /* inferred */
    /* 0x2A4 */ char pad2A4[0x4];
    /* 0x2A8 */ Actor *unk2A8;                      /* inferred */
    /* 0x2AC */ char pad2AC[0x40];                  /* maybe part of unk2A8[17]? */
    /* 0x2EC */ Vec3s unk2EC;                       /* inferred */
    /* 0x2F2 */ char pad2F2[0x6C];                  /* maybe part of unk2EC[19]? */
    /* 0x35E */ Vec3s unk35E;                       /* inferred */
    /* 0x364 */ char pad364[0x6C];                  /* maybe part of unk35E[19]? */
    /* 0x3D0 */ u16 unk3D0;                         /* inferred */
    /* 0x3D2 */ char pad3D2[0x1A];                  /* maybe part of unk3D0[14]? */
    /* 0x3EC */ s16 unk3EC;                         /* inferred */
    /* 0x3EE */ s16 unk3EE;                         /* inferred */
    /* 0x3F0 */ char pad3F0[0x2];
    /* 0x3F2 */ s16 unk3F2;                         /* inferred */
    /* 0x3F4 */ char pad3F4[0x4];                   /* maybe part of unk3F2[3]? */
    /* 0x3F8 */ void *unk3F8;                       /* inferred */
    /* 0x3FC */ s32 unk3FC;                         /* inferred */
    /* 0x400 */ char pad400[0xC];                   /* maybe part of unk3FC[4]? */
} EnIg;                                             /* size = 0x40C */
...
void func_80BF14B0(void *arg0) {
    ...
    Math_Vec3f_Copy((Vec3f *) &sp40, arg0->unk2A8 + 0x24);
    Math_Vec3f_Copy((Vec3f *) &sp34, arg0 + 0x24);
    Math_ApproachS(arg0 + 0x3EA, (s16) (Math_Vec3f_Yaw((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unkBE), 4, 0x2AA8);
    temp_v0 = arg0->unk3EA;
...
s32 func_80BF1C44(Actor *arg0, GlobalContext *arg1, u8 *arg2, u8 arg3, s16 arg4) {
    ...
    if ((phi_v1 != 0) && (phi_v1->update != 0)) {
        ...
        if (temp_v0_2 != 0) {
            ...
            sp48 = temp_v0_3;
            Math_Vec3s_ToVec3f((Vec3f *) &sp3C, ((arg0->unk274->count * 6) + temp_v0_3) - 0xC);
            Math_Vec3s_ToVec3f((Vec3f *) &sp30, ((arg0->unk274->count * 6) + sp48) - 6);
...
s32 func_80BF219C(Actor *arg0, GlobalContext *arg1, u8 *arg2) {
    ...
    if ((temp_v0 != 0) && ((s32) temp_v0->count >= 2)) {
        temp_v0_2 = Lib_SegmentedToVirtual((void *) temp_v0->points);
        sp30 = temp_v0_2;
        Math_Vec3s_ToVec3f((Vec3f *) &sp40, ((arg0->unk274->count * 6) + temp_v0_2) - 6);
        Math_Vec3s_ToVec3f((Vec3f *) &sp34, ((arg0->unk274->count * 6) + sp30) - 0xC);
...
? func_80BF25E8(Actor *arg0, GlobalContext *arg1) {
    ...
    sp54 = 0;
    sp50 = 0;
    func_8013AF00((void *) &sp7C, 3, arg0->unk274->count + 3);
    temp_v1 = arg0 + 0x278;
    phi_v1 = temp_v1;
    if ((arg0->unk3D0 & 8) == 0) {
        temp_v0 = arg0 + 0x290;
        ...
        sp48 = temp_a1;
        sp40 = temp_v0;
        func_8013B6B0(arg0->unk274, temp_a1, temp_a2, arg0->unk28C, arg0->unk288, temp_v0, (void *) &sp7C, (Vec3f *) &sp58, (s16) (s32) arg0->unk3EC);
        func_8013B878(arg1, arg0->unk274, arg0->unk290, (Vec3f *) &sp58);
    ...
    sp3C = phi_v1;
    if (func_8013B6B0(arg0->unk274, sp48, sp44, arg0->unk28C, arg0->unk288, sp40, (void *) &sp7C, phi_v1, (s16) (s32) arg0->unk3EC) != 0) {
...
void func_80BF2AF8(EnIg *this, GlobalContext *globalCtx) {
    ...
    if ((func_80133038(globalCtx, &D_80BF3260, (struct_80133038_arg2 *) &sp20) == 0) || ((sp20 != this->unk298) && (func_80BF2368(this, (u8 *) globalCtx, &sp20) == 0))) {
...
void func_80BF2BD4(EnIg *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, this->unk29C, this->unk3F8, &this->unk2A0) != 0) {
...
void EnIg_Init(EnIg *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk1D0, (Actor *) this, &D_80BF3418);
    Collider_InitAndSetSphere(globalCtx, &this->unk21C, (Actor *) this, &D_80BF3444);
...
void EnIg_Destroy(EnIg *this, GlobalContext *globalCtx) {
    EnIg *this = (EnIg *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk1D0);
    Collider_DestroySphere(globalCtx, &this->unk21C);
}

void EnIg_Update(EnIg *this, GlobalContext *globalCtx) {
    EnIg *this = (EnIg *) thisx;
    ...
    if (this->unk298 != 0) {
        ...
        func_80BF13E4(this);
        func_80BF15EC(this);
        func_8013C964((Actor *) this, globalCtx, 60.0f, 30.0f, 0, (s16) (this->unk3D0 & 7));
...
void EnIg_Draw(EnIg *this, GlobalContext *globalCtx) {
    Gfx *sp44;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    ...
    if (this->unk298 != 0) {
        ...
        temp_s1->polyOpa.p = func_8013AB00(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, (void *) func_80BF2EDC, (void *) func_80BF2EFC, (void *) func_80BF302C, (Actor *) this, temp_s1->polyOpa.p);
