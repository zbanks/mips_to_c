u8 *func_80B3DFF0(u8 *arg0, s32 arg1, f32 arg2, f32 arg3, ?32 arg4, s32 arg7, ?32 argA, f32 argB, s32 argC, s32, f32, f32, s32); /* static */
...
static s16 D_80B3FD6C = {1, 1, 1, 2, 2, 2, 3, 3};
...
u8 *func_80B3DFF0(u8 *arg0, s32 arg1, f32 arg2, f32 arg3, ?32 arg4, s32 arg7, ?32 argA, f32 argB, s32 argC) {
    f32 temp_f2;
    s32 temp_v0;
    u32 temp_t0;
    u32 temp_t1;
...
block_16:
        if (arg0->unk1DC == 2) {
            ...
            sp60 = -40.0f;
            sp64 = temp_f6;
            Lib_Vec3f_TranslateAndRotateY(arg0 + 0x1E4, arg0->unk1D4, (Vec3f *) &sp50, &sp74);
            func_80B3DFF0(arg0 + 0x2EC, subroutine_arg1, sp74.y, sp74.z, sp68.unk0, sp68.unk4, sp68.unk8, sp5C.unk0, sp5C.unk4, sp5C.unk8, 0.03f, 0.04f, 0x10);
        }
    }
    return 0;
}
...
void func_80B3EEDC(EnDai *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0->unk14B == (GlobalContext *)1) && (globalCtx->msgCtx.unk1202A == 3) && (globalCtx->msgCtx.unk1202E == (GlobalContext *)1)) {
        func_80B3E5DC(&this->actor, 1, (GlobalContext *)1);
        this->actionFunc = (void (*)(EnDai *, GlobalContext *)) func_80B3EE8C;
        return;
    }
    if ((temp_v0->unkA70 * 0x10) >= 0) {
        func_80B3E96C(&this->actor, (GlobalContext *)1);
        this->unk_A6C = 0;
        return;
    }
    if (this->unk_A6C == 0) {
...
void func_80B3EF90(EnDai *this, GlobalContext *globalCtx) {
    if (func_8010BF58(&this->actor, globalCtx, &D_80B3FC8C, NULL, &this->unk_1D0) != 0) {
...
void EnDai_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80B3E7C8(&this->actor, globalCtx) == 0) && (func_80B3E69C(this, globalCtx) != 0)) {
        func_80B3F044(&this->actor, globalCtx);
    ...
    if ((sp2C->unkA70 * 0x10) >= 0) {
        ...
        if ((temp_v0 & 0x200) == 0) {
            func_8013C964(&this->actor, globalCtx, 0.0f, 0.0f, 0, (s16) (temp_v0 & 7));
        }
        func_80B3E460(this);
    }
}
