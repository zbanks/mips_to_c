...
u8 *func_80B3DFF0(u8 *arg0, s32 arg1, s32 arg2, s32 arg3, ?32 arg4, ?32 arg7, ?32 argA, f32 argB, s32 argC, f32, f32, f32, s32); /* static */
...
u8 *func_80B3DFF0(u8 *arg0, s32 arg1, s32 arg2, s32 arg3, ?32 arg4, ?32 arg7, ?32 argA, f32 argB, s32 argC) {
    f32 temp_f2;
    s32 temp_v0;
    u32 temp_t0;
    u32 temp_t1;
...
loop_1:
    ...
    if (*phi_a0 == 0) {
        *phi_a0 = 1;
        ...
        arg0->unk_14 = (s32) (&arg1)[1];
        arg0->unk_18 = (s32) (&arg1)[2];
        arg0->unk_1C = (s32) arg4.unk_0;
        arg0->unk_20 = (s32) (&arg4)[1];
        arg0->unk_24 = (s32) (&arg4)[2];
        arg0->unk_28 = (s32) arg7.unk_0;
        arg0->unk_2C = (s32) (&arg7)[1];
        arg0->unk_30 = (s32) (&arg7)[2];
        arg0->unk_34 = argA;
        arg0->unk_38 = argB;
        return arg0;
    }
...
block_9:
            ...
            temp_v1_2 = phi_s2->unk_2 + (phi_s3 * 3);
...
s32 func_80B3E460(EnDai *arg0) {
    ...
    phi_a1_3 = 0;
    do {
        temp_a0 = phi_v0->unk_0;
        temp_v1 = phi_v1 + 2;
        phi_v1 = temp_v1;
        phi_a1_2 = phi_a1_3;
        if ((temp_a0 != 0) && (temp_a2 = phi_v0->unk_2, (temp_a2 != 0))) {
        ...
        temp_a0_2 = phi_v0->unk_3C;
        temp_v0 = phi_v0 + 0x3C;
        phi_a1 = phi_a1_2;
        if ((temp_a0_2 != 0) && (temp_a2_2 = temp_v0->unk_2, (temp_a2_2 != 0))) {
...
s32 func_80B3E5DC(Actor *arg0, s32 arg1) {
    ...
    if ((arg1 != 0) && (arg1 != 1)) {
        if ((arg1 != 5) && (arg1 != 6)) {
            if (arg1 != arg0->unk_A70) {
                goto block_12;
            }
        } else {
            temp_v0 = arg0->unk_A70;
            if ((temp_v0 != 5) && (temp_v0 != 6)) {
                goto block_12;
            }
        }
    } else {
        temp_v0_2 = arg0->unk_A70;
...
s32 func_80B3E69C(EnDai *arg0, GlobalContext *arg1) {
    ...
    if ((arg1->csCtx.state != 0) && (arg1->sceneNum == 0x5C) && (arg1->csCtx.unk_12 == 0) && ((gSaveContext.weekEventReg[30] & 1) == 0)) {
        if ((arg0->unk_1CE & 0x10) == 0) {
            ...
            arg0->unk_1DC = 0;
            arg0->unk_1CD = 0;
            arg0->unk_1F0.x = D_80B3FBF0.unk_0;
            arg0->unk_1F0.y = D_80B3FBF0.unk_4;
            arg0->unk_1F0.z = D_80B3FBF0.unk_8;
            arg0->unk_1FC.x = D_80B3FBF0.unk_0;
            arg0->unk_1FC.y = D_80B3FBF0.unk_4;
            arg0->unk_1FC.z = D_80B3FBF0.unk_8;
        }
        phi_v1 = 1;
    } else {
...
s32 func_80B3E7C8(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_1CE & 7) != 0) {
        ...
        if (func_800B84D0(arg0, arg1) != 0) {
            ...
            arg0[1].focus.pos.z = (bitwise f32) func_80B3EF90;
            phi_v1 = 1;
        }
    }
    return phi_v1;
...
loop_7:
            ...
            if (temp_v1 >= phi_v0) {
                ...
                return arg0[1].yawTowardsPlayer;
            }
            goto loop_7;
        }
        return arg0[1].yawTowardsPlayer;
...
? func_80B3E96C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = arg0->unk_1DA;
    if (temp_v1 == 0) {
        phi_v0 = 0;
    } else {
        arg0->unk_1DA = (s16) (temp_v1 - 1);
        phi_v0 = arg0->unk_1DA;
    }
    if (phi_v0 == 0) {
        if (arg0->unk_1DC != 0) {
            ...
            if (arg0->unk_1DC != 1) {
                if (arg0->unk_1DC != 2) {
                    if (arg0->unk_1DC != 3) {
                        ...
                        arg0[1].colChkInfo.displacement.z = D_80B3FBF0.unk_0;
                        arg0->unk_1F4 = (s32) D_80B3FBF0.unk_4;
                        arg0->unk_1F8 = (s32) D_80B3FBF0.unk_8;
                        arg0->unk_1FC = (f32) D_80B3FBF0.unk_0;
                        arg0->unk_200 = (s32) D_80B3FBF0.unk_4;
                        arg0->unk_1DC = 0;
                        arg0->unk_204 = (s32) D_80B3FBF0.unk_8;
                        arg0->unk_1DA = Rand_S16Offset(0x14, 0x14);
                    }
                } else {
...
block_16:
        if (arg0->unk_1DC == 2) {
            ...
            sp58 = 200.0f;
            sp6C = 6.0f;
            sp5C = Math_SinS((s16) arg0[1].bgCheckFlags) * 80.0f;
            temp_f6 = Math_CosS((s16) arg0[1].bgCheckFlags) * 80.0f;
            sp60 = -40.0f;
            sp64 = temp_f6;
            Lib_Vec3f_TranslateAndRotateY((Vec3f *) &arg0[1].colChkInfo, (s16) arg0[1].bgCheckFlags, (Vec3f *) &sp50, (Vec3f *) &sp74);
            func_80B3DFF0((u8 *) &arg0[2].velocity, subroutine_arg1, sp74.unk_4, sp74.unk_8, sp68.unk_0, (&sp68)[1], (&sp68)[2], sp5C.unk_0, (bitwise s32) (&sp5C)[1], (&sp5C)[2], 0.03f, 0.04f, 0x10);
        }
    }
    return 0;
}
...
void func_80B3EC10(f32 arg0, f32 arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, void *arg9) {
    ...
    arg9->unk_0 = (f32) (((arg5 - arg1) * temp_f0) + arg1);
    arg9->unk_4 = (f32) (((arg6 - arg2) * temp_f0) + arg2);
    arg9->unk_8 = (f32) (((arg7 - arg3) * temp_f0) + arg3);
}
...
loop_1:
    temp_v1 = phi_t0 * 4;
    if ((arg0->unk_1DC == *phi_v0) && (temp_f12 = *(&D_80B3FD2C + temp_v1), temp_f0 = arg0->unk_15C, (temp_f12 < temp_f0)) && (temp_f2 = *(&D_80B3FD4C + temp_v1), (temp_f0 <= temp_f2))) {
        temp_v0 = (phi_t0 * 0xC) + &D_80B3FD7C;
        func_80B3EC10(temp_f12, (bitwise f32) &D_80B3FD2C, subroutine_arg1, temp_v0->unk_4, temp_v0->unk_8, temp_f2, temp_v0->unk_C, temp_v0->unk_10, temp_v0->unk_14, (bitwise void *) temp_f0, arg0 + 0x1F0);
        phi_t1 = 1;
    } else {
        temp_t0 = phi_t0 + 1;
        phi_v0 += 2;
...
loop_1:
    temp_v1 = phi_t0 * 4;
    if ((arg0->unk_1DC == *phi_v0) && (temp_f12 = *(&D_80B3FDE8 + temp_v1), temp_f0 = arg0->unk_15C, (temp_f12 < temp_f0)) && (temp_f2 = *(&D_80B3FDF4 + temp_v1), (temp_f0 <= temp_f2))) {
        temp_v0 = (phi_t0 * 0xC) + &D_80B3FE08;
        func_80B3EC10(temp_f12, (bitwise f32) &D_80B3FDE8, subroutine_arg1, temp_v0->unk_4, temp_v0->unk_8, temp_f2, temp_v0->unk_C, temp_v0->unk_10, temp_v0->unk_14, (bitwise void *) temp_f0, arg0 + 0x1FC);
        phi_t1 = 1;
    } else {
        temp_t0 = phi_t0 + 1;
        phi_v0 += 2;
...
void func_80B3EEDC(EnDai *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0->unk_14B == (GlobalContext *)1) && (globalCtx->msgCtx.unk1202A == 3) && (globalCtx->msgCtx.unk1202E == (GlobalContext *)1)) {
...
void func_80B3F044(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x1D8U) != 0) {
        ...
        temp_t7 = temp_v0 * 4;
        sp2C = temp_v0;
        temp_t9 = (arg1 + temp_t7)->unk_1F4C;
        temp_v1 = *temp_t9;
        if ((temp_v1 & 0xFF) != arg0->unk_1CC) {
            sp28 = (s32) temp_v1;
            ...
            if (temp_v1 != 1) {
                if (temp_v1 != 2) {
                    if (temp_v1 != 3) {
                        ...
                        arg0->unk_1CE = (u16) (arg0->unk_1CE & 0xFF7F);
                    }
                } else {
                    sp28 = (s32) temp_v1;
        ...
        arg0->unk_1CC = (u8) *temp_t9;
    }
    temp_v0_2 = arg0->unk_1CC;
    if (temp_v0_2 != 1) {
        if (temp_v0_2 != 2) {
            if (temp_v0_2 != 3) {
                if (temp_v0_2 != 4) {
                    ...
                    phi_v0 = func_80B3E8BC(arg0, arg0->unk_1CC);
                    goto block_31;
                }
            } else {
                if (func_801378B8((SkelAnime *) &arg0[1], 6.0f) != 0) {
            ...
            if (func_801378B8((SkelAnime *) &arg0[1], 43.0f) != 0) {
                Audio_PlayActorSound2(arg0, 0x2962U);
            }
            phi_v0 = func_80B3E8BC(arg0, arg0->unk_1CC);
block_31:
            arg0[1].yawTowardsPlayer = phi_v0;
        }
    } else {
        arg0[1].yDistToPlayer += 1.0f;
        temp_f0 = arg0[1].yDistToPlayer;
        if (temp_f0 < 30.0f) {
            arg0->unk_1CD = (s8) (u32) ((temp_f0 / 30.0f) * 255.0f);
        } else {
            arg0->unk_1CD = 0xFF;
        }
    }
...
void EnDai_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_1F0.x = D_80B3FBF0.unk_0;
    this->unk_1F0.y = D_80B3FBF0.unk_4;
    this->unk_1F0.z = D_80B3FBF0.unk_8;
    this->unk_1FC.x = D_80B3FBF0.unk_0;
    this->unk_1FC.y = D_80B3FBF0.unk_4;
    this->unk_1CE = 0;
    this->unk_1D6 = 0;
    this->unk_1FC.z = D_80B3FBF0.unk_8;
...
void func_80B3F6EC(s32 arg0, s32 arg1, void *arg2, ? arg3) {
    ...
    if (arg1 != 2) {
        if (arg1 == 9) {
            if ((temp_a0->unk_1CE & 0x100) != 0) {
                arg2 = temp_a0;
                func_80B3EC84(temp_a0);
                phi_a0 = arg2;
            }
            Matrix_Scale(phi_a0->unk_1F0, phi_a0->unk_1F4, phi_a0->unk_1F8, 1);
            return;
        }
    ...
    Matrix_Scale(phi_a0_2->unk_1FC, phi_a0_2->unk_200, phi_a0_2->unk_204, 1);
}
...
void func_80B3F78C(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg1->actorCtx.unkB != 0) {
        arg0->unk_1CE = (u16) (arg0->unk_1CE | 0x40);
    } else {
        Actor_RecordUndrawnActor(arg1, arg0);
        arg0->unk_1CE = (u16) (arg0->unk_1CE & 0xFFBF);
    }
    ...
    sp44 = temp_v0_2;
    sp44->words.w1 = Lib_SegmentedToVirtual(*(&D_80B3FE58 + (arg0[1].yawTowardsPlayer * 4)));
    temp_s0->polyXlu.p = func_8013AB00(arg1, (void **) arg0[1].flags, arg0->unk_164, (s32) arg0[1].category, (void *) func_80B3F598, (void *) func_80B3F614, (void *) func_80B3F6EC, arg0, temp_s0->polyXlu.p);
    if ((arg0->unk_1CE & 0x40) != 0) {
        SysMatrix_SetCurrentState((MtxF *) &arg0[1].focus.rot);
        temp_v0_3 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_3[1];
...
void func_80B3F920(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk_1CD == 0xFF) {
        ...
        sp60 = temp_v0;
        sp60->words.w1 = Lib_SegmentedToVirtual(*(&D_80B3FE70 + (arg0[1].yawTowardsPlayer * 4)));
        temp_s0->polyOpa.p = func_8013AB00(arg1, arg0[1].flags, arg0->unk_164, (s32) arg0[1].category, (void *) func_80B3F598, (void *) func_80B3F614, (void *) func_80B3F6EC, arg0, temp_s0->polyOpa.p);
        SysMatrix_SetCurrentState((MtxF *) &arg0[1].focus.rot);
        ...
        temp_s0_2->polyXlu.p = &temp_v0_4[1];
        temp_v0_4->words.w0 = 0xFB000000;
        temp_v0_4->words.w1 = (u32) arg0->unk_1CD;
        temp_v0_5 = temp_s0_2->polyXlu.p;
        temp_s0_2->polyXlu.p = &temp_v0_5[1];
        temp_v0_5->words.w0 = 0xDB060020;
        sp48 = temp_v0_5;
        sp48->words.w1 = Lib_SegmentedToVirtual(*(&D_80B3FE70 + (arg0[1].yawTowardsPlayer * 4)));
        temp_s0_2->polyXlu.p = func_8013AB00(arg1, (void **) arg0[1].flags, arg0->unk_164, (s32) arg0[1].category, (void *) func_80B3F598, (void *) func_80B3F614, (void *) func_80B3F6EC, arg0, temp_s0_2->polyXlu.p);
        SysMatrix_SetCurrentState((MtxF *) &arg0[1].focus.rot);
        temp_v0_6 = temp_s0_2->polyXlu.p;
        temp_s0_2->polyXlu.p = &temp_v0_6[1];
        temp_v0_6->words.w0 = 0xDA380003;
        sp44 = temp_v0_6;
        sp44->words.w1 = Matrix_NewMtx(arg1->state.gfxCtx);
        temp_v0_7 = temp_s0_2->polyXlu.p;
        temp_s0_2->polyXlu.p = &temp_v0_7[1];
