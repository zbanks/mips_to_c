typedef struct EnMinideath {
    ...
    /* 0x15C */ Actor *unk15C;                      /* inferred */
    /* 0x160 */ ? unk160;                           /* inferred */
    /* 0x160 */ char pad160[0x4];
    /* 0x164 */ Vec3f unk164;                       /* inferred */
    /* 0x170 */ Vec3f unk170;                       /* inferred */
    /* 0x17C */ char pad17C[0x50];                  /* maybe part of unk170[7]? */
    /* 0x1CC */ ColliderJntSph unk1CC;              /* inferred */
    /* 0x1EC */ ColliderJntSphElement unk1EC;       /* inferred */
    /* 0x22C */ char pad22C[0x80];                  /* maybe part of unk1EC[3]? */
...
void EnMinideath_Init(EnMinideath *this, GlobalContext *globalCtx) {
    Actor *temp_v0;
    s16 temp_t5;
    s32 temp_s0;
    s32 temp_v1;
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk1CC, (Actor *) this, &D_808CBFBC, &this->unk1EC);
...
void EnMinideath_Destroy(EnMinideath *this, GlobalContext *globalCtx) {
    EnMinideath *this = (EnMinideath *) thisx;
...
block_7:
    ...
    if (phi_v0 != -1) {
        ...
        sp32 = temp_a0;
        sp38 = (Math_SinS(temp_a0) * sp44->unk308) + this->actor.parent->world.pos.x;
        sp40 = (Math_CosS(temp_a0) * sp44->unk308) + this->actor.parent->world.pos.z;
    ...
    if (temp_v1_3->scale.z > 0.0f) {
        sp3C = temp_v1_3->world.pos.y + this->unk158;
    }
...
void func_808CACD8(EnMinideath *this, GlobalContext *globalCtx) {
    ...
    if (Math_ScaledStepToS((s16 *) &this->actor.shape, this->unk150, 0x480) != 0) {
...
void func_808CB22C(EnMinideath *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk14A == 0) && (Actor_DistanceToPoint((Actor *) this, (Vec3f *) &this->actor.parent->focus) < 50.0f)) {
        func_808CAF08(this);
    }
}
...
void func_808CB6D4(EnMinideath *this, GlobalContext *globalCtx) {
    ...
    Math_ScaledStepToS((s16 *) &this->actor.shape, this->unk150, 0x480);
...
void EnMinideath_Update(EnMinideath *this, GlobalContext *globalCtx) {
        ...
        if ((this->unk1CC.base.atFlags & 1) != 0) {
            ...
            if ((phi_v0_3 == 4) || (phi_v0_3 == (this->unk148 & 3))) {
                if ((this->unk14E == 0) && (this->actor.parent->shape.rot.x == 0)) {
                    CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk1CC);
                }
                if (func_808CB094 != this->actionFunc) {
                    CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk1CC);
                }
            }
        }
