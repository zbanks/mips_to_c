typedef struct BgIkanaRotaryroom {
    ...
    /* 0x15C */ ColliderJntSph unk15C;              /* inferred */
    /* 0x17C */ ColliderJntSphElement unk17C;       /* inferred */
    /* 0x1BC */ char pad1BC[0x40];
    /* 0x1FC */ void *unk1FC;                       /* inferred */
    /* 0x200 */ ? (*unk200)(BgIkanaRotaryroom *, GlobalContext *, BgIkanaRotaryroom *); /* inferred */
    /* 0x204 */ void *unk204;                       /* inferred */
    /* 0x208 */ char pad208[0x370];                 /* maybe part of unk204[221]? */
    /* 0x578 */ ? (*unk578)(BgIkanaRotaryroom *, GlobalContext *, BgIkanaRotaryroom *); /* inferred */
    /* 0x57C */ char pad57C[0x4];
    /* 0x580 */ void (*actionFunc)(BgIkanaRotaryroom *, GlobalContext *);
    /* 0x584 */ char pad584[0x4];
...
void func_80B80358(f32 *arg0) {
    ...
    temp_f0_2 = arg0->unk8;
    arg0->unk4 = (f32) (temp_f12 + phi_f2_2);
    if (temp_f0_2 >= 0.0f) {
        phi_f2_3 = 0.5f;
    } else {
        phi_f2_3 = -0.5f;
    }
    arg0->unk8 = (f32) (temp_f0_2 + phi_f2_3);
    arg0->unk0 = (f32) (s32) arg0->unk0;
    arg0->unk4 = (f32) (s32) arg0->unk4;
    arg0->unk8 = (f32) (s32) arg0->unk8;
}
...
void func_80B80440(BgIkanaRotaryroom *arg0, GlobalContext *arg1) {
    ...
    func_80B80358(&sp50);
    arg0->unk204 = Actor_SpawnAsChildAndCutscene(&arg1->actorCtx, arg1, 0x218, sp50, sp54, sp58, (s16) (s32) arg0->actor.shape.rot.x, (s16) (s32) arg0->actor.shape.rot.y, (s16) (s32) arg0->actor.shape.rot.z, -1, ActorCutscene_GetAdditionalCutscene((s16) arg0->actor.cutscene), (s32) arg0->actor.unk20, NULL);
    SysMatrix_StatePop();
}
    ...
    if (temp_s2 != 0) {
        ...
        do {
            ...
            if (phi_s2->id == 0x1E) {
                ...
                phi_s3 = 0;
                do {
                    if ((Math3D_DistanceSquared((Vec3f *) &spB4, phi_s4) < 62500.0f) && (phi_s0->unk0 != spC4) && (phi_s0->unk1 == 0)) {
                        SysMatrix_StatePush();
...
void *func_80B80778(Actor *arg0, void *arg1, s16 *arg2) {
    ...
    if (*arg2 == 0x1E) {
        ...
        phi_s1 = 0;
loop_2:
        if ((phi_s0->unk1 == 0) && (SysMatrix_SetStateRotationAndTranslation(arg0->world.pos.x, arg0->world.pos.y, arg0->world.pos.z, arg0 + 0xBC), SysMatrix_MultiplyVector3fByState(phi_s0 + 4, (Vec3f *) &sp68), (Math3D_DistanceSquared(arg2 + 0x24, (Vec3f *) &sp68) < 62500.0f))) {
            sp58 = phi_s0;
        } else {
            temp_s1 = phi_s1 + 0x10;
            phi_s0 += 0x10;
...
void func_80B81234(void *arg0, void *arg1) {
    ...
    if (ActorCutscene_GetCurrentIndex() == arg0->unk38) {
        if ((temp_s1 != 0) && (temp_s0 = arg0 + 0x520, ((s32) temp_s1->unk118 > 0))) {
            ...
            temp_s1->unk24 = (f32) (temp_s0->unk4C - sp4C);
            temp_s1->unk28 = (f32) ((temp_s0->unk50 - sp50) + sp44);
            temp_s1->unk2C = (f32) (temp_s0->unk54 - sp54);
            if (sp64 != 0) {
                Math_Vec3f_Copy(temp_a0, temp_a1);
                arg0->unk57C = 0;
                return;
...
void BgIkanaRotaryroom_Init(BgIkanaRotaryroom *this, GlobalContext *globalCtx) {
    s32 sp34;
    ...
    if (sp30 == &D_80B82218) {
        Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80B82128, &this->unk17C);
    } else {
        Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80B8215C, &this->unk17C);
    }
    func_80B802E0(this);
    if (sp30 == &D_80B8221C) {
...
void BgIkanaRotaryroom_Destroy(BgIkanaRotaryroom *this, GlobalContext *globalCtx) {
...
void BgIkanaRotaryroom_Update(BgIkanaRotaryroom *this, GlobalContext *globalCtx) {
...
void BgIkanaRotaryroom_Draw(BgIkanaRotaryroom *this, GlobalContext *globalCtx) {
    BgIkanaRotaryroom *this = (BgIkanaRotaryroom *) thisx;
