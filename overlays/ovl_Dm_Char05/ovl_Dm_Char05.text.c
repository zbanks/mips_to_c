typedef struct {
    ...
    /* 0x02 */ u16 startFrame;
    /* 0x04 */ u16 endFrame;
    /* 0x06 */ char pad6[0x6];                      /* maybe part of endFrame[4]? */
    /* 0x0C */ s32 unkC;                            /* inferred */
    /* 0x10 */ s32 unk10;                           /* inferred */
    /* 0x14 */ s32 unk14;                           /* inferred */
    /* 0x18 */ char pad18[0x18];                    /* maybe part of unk14[7]? */
...
typedef struct DmChar05 {
    ...
    /* 0x18E */ s8 unk18E;                          /* inferred */
    /* 0x18F */ s8 unk18F;                          /* inferred */
    /* 0x190 */ f32 unk190;                         /* inferred */
    /* 0x194 */ f32 unk194;                         /* inferred */
    /* 0x198 */ f32 unk198;                         /* inferred */
    /* 0x19C */ u32 unk19C;                         /* inferred */
    /* 0x1A0 */ u32 unk1A0;                         /* inferred */
    /* 0x1A4 */ u32 unk1A4;                         /* inferred */
    /* 0x1A8 */ s32 unk1A8;                         /* inferred */
    /* 0x1AC */ s32 unk1AC;                         /* inferred */
...
void DmChar05_Init(DmChar05 *this, GlobalContext *globalCtx) {
    u16 temp_t8;
...
void DmChar05_Destroy(DmChar05 *this, GlobalContext *globalCtx) {
    DmChar05 *this = (DmChar05 *) thisx;
...
void DmChar05_Update(DmChar05 *this, GlobalContext *globalCtx) {
    DmChar05 *this = (DmChar05 *) thisx;
...
void DmChar05_Draw(DmChar05 *this, GlobalContext *globalCtx) {
    u16 temp_t6;
    DmChar05 *this = (DmChar05 *) thisx;
