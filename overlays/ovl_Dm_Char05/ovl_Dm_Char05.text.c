typedef struct {
    ...
    /* 0x02 */ u16 startFrame;
    /* 0x04 */ u16 endFrame;
    /* 0x06 */ char pad_6[0x6];                     /* maybe part of endFrame[4]? */
    /* 0x0C */ s32 unk_C;                           /* inferred */
    /* 0x10 */ s32 unk_10;                          /* inferred */
    /* 0x14 */ s32 unk_14;                          /* inferred */
    /* 0x18 */ char pad_18[0x18];                   /* maybe part of unk_14[7]? */
} CsCmdActorAction;                                 /* size = 0x30 */

typedef struct DmChar05 {
    /* 0x000 */ Actor actor;
    /* 0x144 */ SkelAnime unk_144;                  /* inferred */
    /* 0x188 */ void (*actionFunc)(DmChar05 *, GlobalContext *);
    ...
    /* 0x19C */ u32 unk_19C;                        /* inferred */
    /* 0x1A0 */ u32 unk_1A0;                        /* inferred */
    /* 0x1A4 */ u32 unk_1A4;                        /* inferred */
    /* 0x1A8 */ s32 unk_1A8;                        /* inferred */
    /* 0x1AC */ s32 unk_1AC;                        /* inferred */
    /* 0x1B0 */ s32 unk_1B0;                        /* inferred */
    /* 0x1B4 */ u8 unk_1B4;                         /* inferred */
    /* 0x1B5 */ char pad_1B5[0x3];                  /* maybe part of unk_1B4[4]? */
} DmChar05;                                         /* size = 0x1B8 */

struct _mips2c_stack_DmChar05_Destroy {};           /* size 0x0 */

struct _mips2c_stack_DmChar05_Draw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_DmChar05_Init {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_DmChar05_Update {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AAC5A0 {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80AAC63C {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ SkelAnime *sp30;                     /* inferred */
    /* 0x34 */ char pad_34[0x4];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80AAC6E4 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ SkelAnime *sp28;                     /* inferred */
    /* 0x2C */ char pad_2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80AAC770 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ SkelAnime *sp28;                     /* inferred */
    /* 0x2C */ char pad_2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80AAC7FC {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ SkelAnime *sp28;                     /* inferred */
    /* 0x2C */ char pad_2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80AAC888 {};              /* size 0x0 */

struct _mips2c_stack_func_80AAC990 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AAC9DC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AACA98 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AACAE4 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ u32 sp24;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80AACBE4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AACC48 {};              /* size 0x0 */

struct _mips2c_stack_func_80AACC6C {};              /* size 0x0 */

struct _mips2c_stack_func_80AACCD4 {};              /* size 0x0 */

struct _mips2c_stack_func_80AACD0C {};              /* size 0x0 */

struct _mips2c_stack_func_80AACD1C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AACD68 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AACE10 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AACE5C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AACF04 {
    /* 0x00 */ char pad_0[0x20];
...
struct _mips2c_stack_func_80AAD3F8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AAD450 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80AAD4A8 {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ SkelAnime *sp18;                     /* inferred */
    /* 0x1C */ char pad_1C[0x4];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AAD964 {};              /* size 0x0 */

struct _mips2c_stack_func_80AAD980 {};              /* size 0x0 */

struct _mips2c_stack_func_80AAD998 {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ GraphicsContext *sp30;               /* inferred */
    /* 0x34 */ char pad_34[0xC];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80AADA90 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80AADB4C {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80AADC00 {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ u32 sp2C;                            /* inferred */
    /* 0x30 */ char pad_30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80AADD9C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AADE78 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AADF54 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AAE030 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80AAE114 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ ? sp24;                              /* inferred */
    /* 0x24 */ char pad_24[0x10];
...
void func_80AACAE4(DmChar05 *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x234U) != 0) {
        ...
        if (temp_v1->unk0 == 2) {
            ...
            this->unk_18E = 1;
            this->unk_190 = (f32) globalCtx->csCtx.npcActions[phi_a3]->unk_C;
            this->unk_194 = (f32) globalCtx->csCtx.npcActions[phi_a3]->unk_10;
            this->unk_198 = (f32) globalCtx->csCtx.npcActions[phi_a3]->unk_14;
            return;
        }
        this->unk_18E = 0;
...
void func_80AACC6C(DmChar05 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 < 0xF7U) {
        this->unk_19C = temp_v0 + 8;
    }
    temp_v0_2 = this->unk_1A0;
    if (temp_v0_2 < 0xF7U) {
        this->unk_1A0 = temp_v0_2 + 8;
    }
    temp_v0_3 = this->unk_1A4;
    if (temp_v0_3 < 0xF7U) {
        this->unk_1A4 = temp_v0_3 + 8;
        return;
    }
    this->unk_19C = 0xFF;
    this->unk_1A0 = 0xFF;
...
void func_80AACCD4(DmChar05 *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_1AC;
    if (temp_v0 < 0x3CF) {
        this->unk_1AC = temp_v0 + 0x19;
        return;
    }
    this->unk_1AC = 0x3E4;
    this->actionFunc = func_80AACD0C;
...
void func_80AACF04(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_a2 != 0) {
        if (temp_a2 != 1) {
            ...
            if (func_800EE29C(arg1, 0x206U) != 0) {
                ...
                temp_t0 = temp_v0_3 * 4;
                sp28 = temp_v0_3;
                temp_v1_2 = (arg1 + temp_t0)->unk_1F4C;
                if (arg1->csCtx.frames == temp_v1_2->unk_2) {
                    temp_t4 = temp_v1_2->unk_0;
        ...
        if (func_800EE29C(arg1, 0x1D9U) != 0) {
            ...
            temp_t7 = temp_v0_4 * 4;
            sp28 = temp_v0_4;
            temp_v1_3 = (arg1 + temp_t7)->unk_1F4C;
            if (arg1->csCtx.frames == temp_v1_3->unk_2) {
                temp_t1 = temp_v1_3->unk_0;
    ...
    if (func_800EE29C(arg1, 0x6DU) != 0) {
        ...
        temp_t6 = temp_v0_5 * 4;
        sp28 = temp_v0_5;
        temp_v1_4 = (arg1 + temp_t6)->unk_1F4C;
        if (arg1->csCtx.frames == temp_v1_4->unk_2) {
            temp_t0_2 = temp_v1_4->unk_0;
...
void DmChar05_Update(Actor *thisx, GlobalContext *globalCtx) {
    DmChar05 *this = (DmChar05 *) thisx;
    func_80AACF04((Actor *) this, globalCtx);
    if (func_800EE29C(globalCtx, 0x6DU) != 0) {
    ...
    func_80AAD4A8((Actor *) this, globalCtx);
}
...
void DmChar05_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    switch (temp_t6) {
    case 0:
        func_80AAD998((Actor *) this, globalCtx, this, globalCtx);
        return;
    case 1:
        func_80AADA90((Actor *) this, globalCtx, this, globalCtx);
        return;
    case 2:
        func_80AADB4C((Actor *) this, globalCtx, this, globalCtx);
        return;
    case 3:
        func_80AADC00((Actor *) this, globalCtx, this, globalCtx);
        return;
    case 4:
...
void func_80AADD9C(GlobalContext *arg0, Actor *arg1) {
    ...
    if (Object_IsLoaded(&arg0->objectCtx, (s32) arg1->unk_18F) != 0) {
        arg1->objBankIndex = (s8) arg1->unk_18F;
    }
}
...
void func_80AAE114(GlobalContext *arg0, DmChar05 *arg1) {
    ...
    sp24.unk_0 = (s32) D_80AAE300.unk_0;
    sp24.unk_4 = (s32) D_80AAE300.unk_4;
    sp24.unk_C = (s32) D_80AAE300.unk_C;
    sp24.unk_8 = (s32) D_80AAE300.unk_8;
    ...
    if (arg1->unk_18F == arg1->actor.objBankIndex) {
        ...
        SysMatrix_InsertRotation(0, (s16) (arg0->gameplayFrames * 0x3E8), 0, 1);
        Matrix_Scale(0.2f, 0.2f, 0.2f, 1);
        GetItem_Draw(arg0, (sp + (sp34 * 2))->unk_24);
    }
    if (Object_IsLoaded(&arg0->objectCtx, (s32) arg1->unk_18F) != 0) {
        arg1->actor.objBankIndex = (s8) arg1->unk_18F;
    }
