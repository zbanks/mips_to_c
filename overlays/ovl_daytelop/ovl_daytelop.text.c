...
void Daytelop_Update(GameState *arg0, GameState *arg1) {
    ...
    if (arg0->unk242 == 1) {
        ...
        arg0->unk244 = (s16) (temp_v1 + (s16) (phi_a2 / (s32) temp_v0_2));
...
void Daytelop_Draw(GameState *arg0) {
    ...
    if (gSaveContext.day < 9) {
        ...
        temp_v0_44->words.w1 = (arg0->unk244 & 0xFF) | ~0xFF;
...
void Daytelop_Init(GameState *thisx) {
    ...
    ShrinkWindow_Fini();
    View_Init(thisx + 0xB0, thisx->gfxCtx);
