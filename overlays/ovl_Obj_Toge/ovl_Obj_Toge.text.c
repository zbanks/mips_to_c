...
void func_809A42A0(void *arg0, s32 arg1) {
    ...
    sp58 = arg0->unk_28 + 15.0f;
    temp_s3 = &sp54;
    phi_s0 = 0;
    phi_s2 = 0;
    do {
        sp54 = (Math_SinS(phi_s0) * 15.0f) + arg0->unk_24;
        sp5C = (Math_CosS(phi_s0) * 15.0f) + arg0->unk_2C;
...
s32 func_809A43EC(void *arg0, void *arg1) {
    ...
    temp_f18 = arg0->unk_1C8;
    temp_f2 = temp_v1->unk_24 - arg0->unk_1B8;
    temp_f16 = arg0->unk_1CC;
    temp_f12 = temp_v1->unk_2C - arg0->unk_1BC;
    temp_f0 = fabsf((temp_f2 * temp_f18) - (temp_f16 * temp_f12));
    temp_f4 = (temp_f16 * temp_f2) + (temp_f12 * temp_f18);
    sp4 = temp_f4;
    phi_v0 = 0;
    phi_v0_2 = 0;
    if (temp_f0 <= arg0->unk_1C0) {
        phi_v0 = 1;
    }
    phi_v0_2 = phi_v0;
    if ((phi_v0 != 0) && (fabsf(temp_f4) <= arg0->unk_1C4)) {
        phi_v0_2 = 1;
    }
    return phi_v0_2;
}
...
void ObjToge_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) sp3E > 0) {
        this->unk_1B4 = 1;
        this->unk_1B8 = (this->unk_1A4.x + this->unk_198.x) * 0.5f;
        this->unk_1BC = (this->unk_1A4.z + this->unk_198.z) * 0.5f;
        temp_v0_5 = Math_Vec3f_Yaw(sp2C, sp24);
        temp_a0_3 = temp_v0_5 << 0x10;
        sp36 = temp_v0_5;
        this->unk_1C8 = Math_CosS((s16) (temp_a0_3 >> 0x10));
        this->unk_1CC = Math_SinS(sp36);
        this->unk_1C0 = (f32) sp3E * 7.5f;
        this->unk_1C4 = Math3D_Distance(sp2C, sp24) * 0.5f;
    } else {
        this->unk_1B4 = 0;
    }
...
void func_809A4744(ObjToge *arg0) {
    ...
    arg0->unk_1B0 = 0;
    arg0->unk_1B2 = *(&D_809A4CFC + ((((s32) arg0->actor.params >> 0xB) & 7) * 2));
}
...
void func_809A477C(ObjToge *this, GlobalContext *globalCtx) {
    ...
    temp_v0_2 = this->unk_1B0;
    if ((s32) temp_v0_2 >= 0x1770) {
        this->unk_1B0 = 0x1770;
        func_809A488C();
    } else if (((s32) temp_v0_2 > 0) || ((s32) this->unk_1B2 <= 0)) {
        this->unk_1B0 = temp_v0_2 + 0xC8;
    }
    if (this->unk_1B4 == 0) {
...
block_5:
        this->unk_1B0 = phi_v0 + 0xC8;
        phi_a0 = this;
    }
    phi_a0->actor.shape.rot.y += phi_a0->unk_1B0;
}

void func_809A488C(void *arg0) {
    arg0->unk_190 = func_809A48AC;
    arg0->unk_70 = 1.0f;
}
...
void func_809A48AC(ObjToge *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 8) != 0) {
        this->actor.world.rot.y = Math_Vec3f_Yaw((Vec3f *) &this->actor.world, this + (this->unk_194 * 0xC) + 0x198);
        this->unk_194 = sp30;
        if ((this->unk_1B4 != 0) && (sp30 == 0)) {
            func_809A4804(this);
        } else {
            func_809A4744(this);
        }
    ...
    if ((phi_v1 >= 0x4001) || (phi_v1 == -0x8000)) {
        this->actor.world.rot.y = Math_Vec3f_Yaw((Vec3f *) temp_a0, this + (this->unk_194 * 0xC) + 0x198);
        this->unk_194 = sp30;
        if ((this->unk_1B4 != 0) && (sp30 == 0)) {
            func_809A4804(this);
        } else {
...
void ObjToge_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.colorFilterTimer == 0) {
        ...
        if ((this->unk_144.base.ocFlags2 & 1) != 0) {
