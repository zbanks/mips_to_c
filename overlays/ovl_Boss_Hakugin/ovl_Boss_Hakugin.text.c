...
void func_80B09840(Actor *arg0, GlobalContext *arg1, Actor *); /* static */
...
extern ? D_801C5D60;
extern ? D_801C5D80;
static ColliderJntSphElementInit D_80B0E700 = {
    {
...
static Vec3f D_80B0E9D4 = {{22.0f, 0.0f, 100.0f}, {0.0f, 0.0f, -100.0f}, {-22.0f, 0.0f, 100.0f}};
...
static s8 D_80B0EA95 = {5, 0xFF, 6, 0xFF, 7};
static s8 D_80B0EA9A = {8, 1};
static ? D_80B0EA9C;                                /* unable to generate initializer */
static s8 D_80B0EAA5 = {0xB, 0xFF, 0xFF, 0xC, 0xD, 0xFF, 0xFF};
...
static InitChainEntry D_80B0EAD8;                   /* unable to generate initializer */
...
static s32 D_80B0EB70 = {1, 2, 3, 3, 2, 1};
static s32 D_80B0EB88 = {2, 3, 4, 4, 4, 3, 2};
static s32 D_80B0EBA4 = {2, 3, 4, 4, 4, 4, 3, 2};
static s32 D_80B0EBC4 = {2, 4, 5, 6, 7, 8, 8, 8, 8, 7, 6, 5, 4, 2};
static ? D_80B0EBFC;                                /* unable to generate initializer */
static ? D_80B0EC38;                                /* unable to generate initializer */
static f32 D_80B0EDD4 = {0.00003051851f, 0.00003051851f}; /* const */
static f32 D_80B0EE08 = {0.001f, 0.001f};           /* const */
...
typedef struct BossHakugin {
    ...
    /* 0x01D8 */ char pad1D8[0x4];                  /* maybe part of unk1D4[2]? */
    ...
    /* 0x0450 */ char pad450[0x4];                  /* maybe part of unk44C[2]? */
    ...
    /* 0x0970 */ s16 unk970;                        /* overlap; inferred */
    /* 0x0972 */ char pad972[0x3E];                 /* maybe part of unk970[32]? */
    ...
    /* 0x09D8 */ char pad9D8[0x20];                 /* maybe part of unk9D4[9]? */
    ...
    /* 0x0A0C */ char padA0C[0x4];                  /* maybe part of unkA08[2]? */
    /* 0x0A10 */ s16 unkA10;                        /* inferred */
    /* 0x0A12 */ char padA12[0xA];                  /* maybe part of unkA10[6]? */
    /* 0x0A1C */ f32 unkA1C;                        /* inferred */
    /* 0x0A20 */ char padA20[0x18];                 /* maybe part of unkA1C[7]? */
    /* 0x0A38 */ s16 unkA38;                        /* inferred */
    /* 0x0A3A */ char padA3A[0x26];                 /* maybe part of unkA38[20]? */
    /* 0x0A60 */ s16 unkA60;                        /* inferred */
    /* 0x0A62 */ char padA62[0x26];                 /* maybe part of unkA60[20]? */
    /* 0x0A88 */ s16 unkA88;                        /* inferred */
    /* 0x0A8A */ char padA8A[0x1B9A];               /* maybe part of unkA88[3534]? */
    ...
    /* 0x26A8 */ char pad26A8[0xAC0];
    /* 0x3168 */ s16 unk3168;                       /* inferred */
    /* 0x316A */ char pad316A[0x5CA];               /* maybe part of unk3168[742]? */
...
void BossHakugin_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk484, &this->actor, &D_80B0E9AC, &this->unk4A4);
    phi_t0 = 0;
    phi_s0 = &this->unk262C;
    phi_s1 = &this->unk264C;
    phi_t0_2 = 0;
    do {
        sp60 = phi_t0;
        Collider_InitAndSetTris(globalCtx, phi_s0, &this->actor, &D_80B0E9F8, phi_s1);
        temp_t0 = phi_t0 + 0x90;
        phi_t0 = temp_t0;
        phi_s0 += 0x90;
        phi_s1 += 0x90;
    } while (temp_t0 < 0xB40);
    Collider_InitAndSetSphere(globalCtx, &this->unk37B8, &this->actor, &D_80B0EA08);
    this->unk37B8.dim.worldSphere.radius = 0x28;
    Collider_InitAndSetCylinder(globalCtx, &this->unk964, &this->actor, &D_80B0EA34);
    temp_s0 = &this->unk474;
    ...
    do {
        sp60 = phi_t0_2;
        *phi_s0_2 = Actor_SpawnAsChild(temp_s5, &this->actor, globalCtx, 0x1EA, 0.0f, 0.0f, 0.0f, (s16) 0, (s16) 0, (s16) 0, 1);
    ...
    do {
        ...
        temp_t0_3->unk9CC = Actor_SpawnAsChild(temp_s5, &this->actor, globalCtx, 0x1EA, 0.0f, 0.0f, 0.0f, (s16) 0, (s16) 0, (s16) 0, 2);
        phi_v1 = temp_v1;
...
void func_80B057A4(Vec3f *arg0, Vec3f *arg1, f32 arg2) {
    ...
    if (!(phi_f14 < 0.017453292f)) {
        ...
        if (func_80B0573C(&sp34) != 0) {
            SysMatrix_InsertRotationAroundUnitVector_f(arg2, &sp34, 0);
            SysMatrix_MultiplyVector3fByState(arg0, &sp28);
...
void func_80B0607C(BossHakugin *arg0, GlobalContext *arg1) {
    ...
    sp40 = temp_a0;
    sp54 = temp_f10;
    if (func_800C55C4(temp_a0, (Vec3f *) &sp58, (Vec3f *) &sp4C, &sp70, &sp8C, 1U, 1U, 0U, 1U, &sp84) != 0) {
        sp82 = Math_FAtan2F((f32) sp8C->normal.z * 0.00003051851f, (f32) sp8C->normal.x * 0.00003051851f) - arg0->unk1A0;
        arg0->unk1BC = Math_Vec3f_DistXZ((Vec3f *) &sp58, &sp70);
    } else {
        sp82 = 0;
    ...
    sp4C = (2.0f * sp58) - sp4C;
    sp54 = (2.0f * sp60) - sp54;
    if (func_800C55C4(sp40, (Vec3f *) &sp58, (Vec3f *) &sp4C, &sp64, &sp88, 1U, 1U, 0U, 1U, &sp84) != 0) {
        sp80 = Math_FAtan2F((f32) sp88->normal.z * 0.00003051851f, (f32) sp88->normal.x * 0.00003051851f) - arg0->unk1A0;
        arg0->unk1C0 = Math_Vec3f_DistXZ((Vec3f *) &sp58, &sp64);
    } else {
        sp80 = 0;
    ...
    if (arg0->unk1BC <= 89.100006f) {
        ...
        arg0->actor.world.pos.x = (sp70.x + (sp48 * sp44)) - (Math_SinS(arg0->unk1A0) * (5.0f * arg0->actor.speedXZ));
        sp44 = Math_SinS(arg0->unk1A0);
        arg0->actor.world.pos.z = (sp70.z - (sp48 * sp44)) - (Math_CosS(arg0->unk1A0) * (5.0f * arg0->actor.speedXZ));
        ...
        sp44 = Math_CosS(arg0->unk1A0);
        arg0->actor.world.pos.x = (sp64.x - (sp48 * sp44)) - (Math_SinS(arg0->unk1A0) * (5.0f * arg0->actor.speedXZ));
        sp44 = Math_SinS(arg0->unk1A0);
        arg0->actor.world.pos.z = (sp64.z + (sp48 * sp44)) - (Math_CosS(arg0->unk1A0) * (5.0f * arg0->actor.speedXZ));
    }
...
void func_80B06558(void *arg0) {
    ...
    Collider_SetTrisVertices(arg0 + 0x14, 0, &sp38, &sp44, &sp50);
}
...
void func_80B06600(Actor *arg0, Vec3f *arg1, GlobalContext *arg2) {
    ...
    Actor_CalcOffsetOrientedToDrawRotation(arg0, &sp98, (Vec3f *) &spBC);
    func_8019F1C0(arg0 + 0x458, 0x384DU);
    temp_s6 = &spB0;
    phi_s0 = arg0 + 0x2618;
    phi_s3 = 0x113;
    do {
        Actor_CalcOffsetOrientedToDrawRotation(arg0, &sp8C, &spC8);
        if (sp98.z < sp8C.z) {
            phi_s0->unk10 = (s16) ((Rand_Next() >> 0x13) + arg0->shape.rot.y);
        } else {
            temp_s1 = Math_Vec3f_Yaw(&spC8, (Vec3f *) &spBC);
            phi_s0->unk10 = (s16) ((Rand_Next() >> 0x13) + temp_s1);
        }
        temp_s1_2 = Math_Vec3f_Pitch(&spC8, (Vec3f *) &spBC);
        phi_s0->unkE = (s16) ((Rand_Next() >> 0x13) + temp_s1_2);
        phi_s0->unk12 = 0;
        temp_f20 = Math_CosS(phi_s0->unkE);
        phi_s0->unk0 = (f32) ((Math_SinS(phi_s0->unk10) * (80.0f * temp_f20)) + spC8.x);
        phi_s0->unk4 = (f32) (spC8.y - (Math_SinS(phi_s0->unkE) * 80.0f));
        temp_f20_2 = Math_CosS(phi_s0->unkE);
        temp_a2 = temp_s6;
        phi_s0->unk8 = (f32) ((Math_CosS(phi_s0->unk10) * (80.0f * temp_f20_2)) + spC8.z);
        spB0 = (2.0f * phi_s0->unk0) - spC8.x;
        spB4 = (2.0f * phi_s0->unk4) - spC8.y;
        spB8 = (2.0f * phi_s0->unk8) - spC8.z;
        if (func_800C55C4(arg2 + 0x830, &spC8, (Vec3f *) temp_a2, &spA4, &spD4, 0U, 1U, 0U, 1U, &sp84) != 0) {
            phi_s0->unkE = (s16) (phi_s0->unkE - 0x2000);
            temp_f20_3 = Math_CosS(phi_s0->unkE);
            phi_s0->unk0 = (f32) ((Math_SinS(phi_s0->unk10) * (80.0f * temp_f20_3)) + spC8.x);
            phi_s0->unk4 = (f32) (spC8.y - (Math_SinS(phi_s0->unkE) * 80.0f));
            temp_f20_4 = Math_CosS(phi_s0->unkE);
            phi_s0->unk8 = (f32) ((Math_CosS(phi_s0->unk10) * (80.0f * temp_f20_4)) + spC8.z);
            spC8.x = (2.0f * phi_s0->unk0) - spC8.x;
            spC8.y = (2.0f * phi_s0->unk4) - spC8.y;
            spC8.z = (2.0f * phi_s0->unk8) - spC8.z;
        } else {
            Math_Vec3f_Copy(&spC8, (Vec3f *) temp_s6);
        }
        phi_s0->unkC = phi_s3;
...
loop_3:
    if ((sp84 < (s32) arg0->actor.colChkInfo.health) || (((1 << (*(&D_80B0EAB0 + (sp94 * 4)) + 0x1F)) & arg0->unk1B0) == 0)) {
        ...
        sp94 = sp94;
        sp9C = sp9C;
        Math_Vec3f_Diff(temp_a0, temp_a1, &spA0);
        spA0.y -= 3.5f;
        temp_f10 = (s32) (Math3D_Vec3fMagnitude(&spA0) / 10.0f);
        phi_s4 = temp_f10;
        phi_s2 = 0;
        if (temp_f10 >= 2) {
            if (temp_f10 >= 4) {
            ...
            Math_Vec3f_Scale(&spA0, 1.0f / (f32) phi_s4);
            phi_s4_2 = phi_s4;
        } else {
            phi_s4_2 = 1;
        }
        ...
        if (phi_s4_2 > 0) {
            do {
                ...
                temp_f20 = (f32) phi_s2;
                temp_s0->unk0 = (f32) (randPlusMinusPoint5Scaled(20.0f) + (temp_s3->x + (spA0.x * temp_f20)));
                temp_s0->unk4 = (f32) (randPlusMinusPoint5Scaled(20.0f) + (temp_s3->y + (spA0.y * temp_f20)));
                temp_f0 = randPlusMinusPoint5Scaled(20.0f);
                temp_s2 = phi_s2 + 1;
                temp_s0->unkC = 0.01f;
                temp_s0->unk10 = 0x96;
                temp_s0->unk12 = (s16) (5 - phi_s2);
                temp_s0->unk8 = (f32) (temp_f0 + (temp_s3->z + (spA0.z * temp_f20)));
                phi_s1 += 0x14;
                phi_s2 = temp_s2;
...
void func_80B07450(Actor *arg0, s16 arg1) {
    ...
    if (func_801378B8(temp_s0, 0.0f) != 0) {
        ...
        Math_Vec3f_Copy(&sp48, arg0 + (D_80B0EA9A * 0xC) + 0x398);
    ...
    if (func_801378B8(temp_s0, 2.0f) != 0) {
        Math_Vec3f_Copy(&sp48, arg0 + (D_80B0EAAC * 0xC) + 0x398);
        func_80B06B20(arg0, &sp48);
        goto block_10;
    }
    if (func_801378B8(temp_s0, 3.0f) != 0) {
        Math_Vec3f_Copy(&sp48, arg0 + (D_80B0EA95 * 0xC) + 0x398);
        func_80B06D38(arg0, (GlobalContext *) arg1);
        goto block_10;
    }
    if (func_801378B8(temp_s0, 11.0f) != 0) {
        Math_Vec3f_Copy(&sp48, arg0 + (D_80B0EAA5 * 0xC) + 0x398);
        func_80B06B20(arg0, &sp48);
block_10:
        ...
        sp48.y += 5.0f;
        sp48.x += 40.0f * sp54;
        sp48.z += 40.0f * temp_f2_2;
        temp_s0_2 = Rand_S16Offset(0x28A, 0x64);
        func_800B12F0((GlobalContext *) arg1, &sp48, (Vec3f *) &sp54, &D_801D15B0, (s16) (s32) temp_s0_2, (s16) Rand_S16Offset(0x14, 0xA), (s16) 0x1E);
        phi_s0 = 0;
        do {
            func_80B0696C(arg0, &sp48);
            temp_s0_3 = phi_s0 + 1;
            phi_s0 = temp_s0_3;
        } while (temp_s0_3 != 4);
    }
...
void func_80B07DA4(BossHakugin *arg0, GlobalContext *arg1, f32 arg2, s16 arg3) {
    ...
    Math_Vec3f_Diff(temp_v0 + 0x50, temp_v0 + 0x5C, &sp38);
    temp_a0 = &temp_v0->eye;
    sp24 = temp_a0;
    Math_Vec3f_StepTo(temp_a0, arg0 + 0x38C, arg2);
    if (func_80B0573C(&sp38) != 0) {
        ...
        func_80B057A4(&sp38, (Vec3f *) &sp2C, (f32) arg3 * 0.0000958738f);
    }
    temp_v0->at.x = temp_v0->eye.x + (50.0f * sp38.x);
    temp_v0->at.y = temp_v0->eye.y + (50.0f * sp38.y);
    temp_v0->at.z = temp_v0->eye.z + (50.0f * sp38.z);
...
void func_80B0813C(BossHakugin *this, GlobalContext *globalCtx) {
    ...
    if (this->unk19C == 0) {
        globalCtx = globalCtx;
        CollisionCheck_SetAT(temp_a0, temp_a1, &this->unk964.base);
    }
...
void func_80B0863C(BossHakugin *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 0) {
        ...
        this->unk390 = 43.0f;
        this->unk394 = -1600.0f;
        Audio_PlayActorSound2(&this->actor, 0x394EU);
        goto block_16;
    }
    ...
    if (func_801378B8(temp_a0, 20.0f) != 0) {
        Audio_PlayActorSound2(&this->actor, 0x394FU);
    }
...
void func_80B08960(BossHakugin *this, GlobalContext *globalCtx) {
    ...
    func_80B07450(&this->actor, (s16) globalCtx);
    this->unk18D = 0xA;
...
block_9:
    if ((this->unk484.base.atFlags & 2) != 0) {
        func_800B8D50(globalCtx, &this->actor, 10.0f, 0, 6.0f, 0U);
    } else {
...
void func_80B094E0(BossHakugin *this, GlobalContext *globalCtx) {
    ...
    func_800B9010(&this->actor, 0x301BU);
...
void func_80B098BC(BossHakugin *this, GlobalContext *globalCtx) {
    ...
    if (Math_ScaledStepToS(&this->unk1A6, -0x800, 0x1C0) != 0) {
        ...
        func_800B8D50(globalCtx, &this->actor, 10.0f, (s16) (this->actor.shape.rot.y + 0x8000), 15.0f, 0x10U);
...
void func_80B09E20(BossHakugin *this, GlobalContext *globalCtx) {
    ...
    if (func_80B0728C(this) != 0) {
        func_80B06600(&this->actor, &this->unk380, globalCtx);
        func_80B09A94(this, globalCtx);
    }
}
...
void func_80B09EDC(BossHakugin *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext((s16) temp_a0) != 0) {
        ...
        func_80B07EEC(&this->actor, globalCtx, this);
        return;
    }
...
void func_80B0B660(BossHakugin *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 3) {
        ...
        sp60 = phi_f12;
        Math_Vec3f_Diff(temp_s0, sp48, &sp70);
        if (func_80B0573C(&sp70) != 0) {
...
block_9:
        ...
        if (arg0->unk192 != 4) {
            ...
            if (func_800C55C4(arg1 + 0x830, sp48, (Vec3f *) temp_s0_2, &sp94, &spA0, 1U, 1U, 1U, 1U, &sp5C) != 0) {
                Math_Vec3f_Copy(sp48, &sp94);
                ...
                if ((arg0->unk192 == 3) && ((phi_s0_2 != 0) || ((s32) spA0->normal.y >= 0x4000))) {
                    ...
                    func_80179F64(temp_s0_4, (Vec3f *) temp_a1, &sp70);
                    Math_Vec3f_Copy(temp_s0_4, &sp70);
                }
            } else {
...
void BossHakugin_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80B09EDC != this->actionFunc) && (func_80B0ADFC(this, globalCtx) == 0)) {
        func_80B0AC30(&this->actor, globalCtx);
    }
    func_80B0607C(this, globalCtx);
    temp_a2 = &sp6C->world;
    sp44 = temp_a2;
    Actor_CalcOffsetOrientedToDrawRotation(&this->actor, (Vec3f *) &this->unk44C, &temp_a2->pos);
    this->actionFunc(this, globalCtx);
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 450.0f, 89.100006f, 0.0f, 0x1DU);
    func_800BE3D0(this, this->actor.shape.rot.y, &sp70);
    Math_ScaledStepToS(&this->actor.shape.rot.x, sp70, 0x100);
    ...
    if (((temp_v0_2 & 1) != 0) && (this->actor.colorFilterTimer == 0)) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, &this->unk484.base);
    } else {
        this->unk484.base.atFlags = temp_v0_2 & 0xFFFD;
    }
    temp_v0_3 = this->unk1A4;
    if (temp_v0_3 == 0) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, &this->unk484.base);
    } else {
    ...
    if ((temp_v0_4 & 1) != 0) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &this->unk484.base);
    } else {
    ...
    if (this->unk1E4 > 0.0f) {
        if (this->unk196 != 0xA) {
            ...
            func_80B07B88(&this->actor, globalCtx);
        }
    }
    if (sp6C->floorHeight < -400.0f) {
        ...
        sp54 = 100.0f;
        if (func_800C55C4(&globalCtx->colCtx, (Vec3f *) &sp50, &sp44->pos, &sp5C, &sp68, 1U, 1U, 0U, 1U, &sp4C) != 0) {
            Math_Vec3f_Copy(&sp44->pos, &sp5C);
            Math_Vec3f_Copy(&sp6C->home.pos, &sp44->pos);
            Math_Vec3f_Copy(&sp6C->prevPos, &sp44->pos);
...
void BossHakugin_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B0C000, func_80B0C1BC, &this->actor);
    func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk398, 0xF, this->unk1DC, this->unk1E0, this->unk1E4, (u8) (s32) this->unk196);
    ...
    if (func_80B0A8C4 == this->actionFunc) {
        func_80B0E5A4(&this->actor, globalCtx);
    } else {
        func_80B0C398(this, &globalCtx->state.gfxCtx);
    }
    func_80B0C570(this, globalCtx);
    func_80B0C7B0(this, &globalCtx->state.gfxCtx);
    func_80B0CAF0(this, &globalCtx->state.gfxCtx);
    func_80B0CCD8(this, &globalCtx->state.gfxCtx);
    if ((s32) this->unk193 > 0) {
        func_80B0CF24(&this->actor, globalCtx);
    }
...
void func_80B0D2B8(BossHakugin *arg0, Gfx *arg1, f32 arg2) {
    ...
    do {
        if ((arg2 == 0.0f) || (temp_t1 = *(&D_80B0EBFC + (phi_s2 * 4)), phi_t1 = temp_t1, phi_t1 = temp_t1, (temp_t1 >= 0))) {
            ...
            temp_f0_2 = sp68.x * 0.07f;
            temp_f2_2 = sp68.y * 0.07f;
            temp_v0_2 = *temp_t0;
...
void func_80B0D750(u32 arg0, BossHakugin *arg1, GlobalContext *arg2) {
    ...
    if (temp_a0_2 != 0) {
        spA0 = temp_a0;
        func_800C0094(temp_a0_2, arg1->actor.world.pos.x, arg1->actor.floorHeight, arg1->actor.world.pos.z, &sp60);
