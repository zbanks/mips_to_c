typedef struct EnRu {
    ...
    /* 0x1E0 */ char pad_1E0[0x1E];                 /* maybe part of unk_1DC[8]? */
    /* 0x1FE */ Vec3s unk_1FE;                      /* inferred */
    /* 0x204 */ char pad_204[0x84];                 /* maybe part of unk_1FE[23]? */
    /* 0x288 */ Vec3s unk_288;                      /* inferred */
    /* 0x28E */ char pad_28E[0x106];                /* maybe part of unk_288[44]? */
    /* 0x394 */ ? unk_394;                          /* inferred */
    /* 0x394 */ char pad_394[0xBA];
    /* 0x44E */ s16 unk_44E;                        /* inferred */
    /* 0x450 */ char pad_450[0x4];                  /* maybe part of unk_44E[3]? */
} EnRu;                                             /* size = 0x454 */
...
s32 func_80A389A0(SkelAnime *arg0, s16 arg1) {
    ...
    if ((s32) arg1 >= 0) {
        ...
        if ((s32) arg1 < 8) {
            ...
            sp30 = 1;
            SkelAnime_ChangeAnim(arg0, (temp_t6 + &D_80A394A8)->unk_0, (temp_t6 + &D_80A394A8)->unk_4, (f32) (temp_t6 + &D_80A394A8)->unk_8, (f32) phi_t0, (u8) (s32) (temp_t6 + &D_80A394A8)->unk_C, (f32) (temp_t6 + &D_80A394A8)->unk_E);
            phi_t1 = 1;
        }
    }
    return phi_t1;
...
void func_80A38B7C(Actor *arg0, s32 arg1) {
    ...
    temp_v0 = arg0->unk_450;
    if (temp_v0 == 0) {
        phi_v1 = 0;
    } else {
        arg0->unk_450 = (s16) (temp_v0 - 1);
        phi_v1 = arg0->unk_450;
    }
    if (phi_v1 == 0) {
        arg0->unk_44E = (s16) (arg0->unk_44E + 1);
        if ((s32) arg0->unk_44E >= arg1) {
            arg0->unk_44E = 0;
            arg0 = arg0;
            arg0->unk_450 = Rand_S16Offset(0x1E, 0x1E);
        }
    }
}
...
void func_80A38C70(Actor *arg0, GlobalContext *arg1) {
    ...
    func_8013D9C8(arg1, arg0 + 0x336, (s16 *) &arg0[2].shape.feetPos[0].z, 0x17);
}
...
void EnRu_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_0600C700, NULL, &this->unk_1FE, &this->unk_288, 0x17);
...
s32 func_80A38FB4(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    if (arg1 == 0x15) {
        ...
        SysMatrix_InsertXRotation_s(arg5[2].yawTowardsPlayer, 1);
        SysMatrix_InsertZRotation_s(arg5[2].bgCheckFlags, 1);
        SysMatrix_InsertTranslation(-1500.0f, 0.0f, 0.0f, 1);
    }
    if (arg1 == 0xA) {
        Matrix_RotateY(arg5->unk_320, 1U);
        SysMatrix_InsertXRotation_s(arg5->unk_31E, 1);
    }
    if ((arg1 == 0xA) || (arg1 == 0xB) || (arg1 == 0x10)) {
        temp_v1 = arg5 + (arg1 * 2);
        sp24 = temp_v1;
        arg4->y += (s32) (Math_SinS(temp_v1->unk_336) * 200.0f);
        arg4->z += (s32) (Math_CosS(temp_v1->unk_364) * 200.0f);
    }
    return 0;
}
...
void func_80A390F8(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp30.unk_0 = (s32) D_80A39580.unk_0;
    sp30.unk_4 = (s32) D_80A39580.unk_4;
    sp30.unk_8 = (s32) D_80A39580.unk_8;
    sp24.unk_0 = (s32) D_80A3958C.unk_0;
    temp_v1 = arg1 + &D_80A39528;
    sp24.unk_4 = (s32) D_80A3958C.unk_4;
    sp24.unk_8 = (s32) D_80A3958C.unk_8;
    temp_v0 = *temp_v1;
    if ((s32) temp_v0 >= 0) {
        sp20 = temp_v1;
...
void EnRu_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp7C.unk_0 = (s32) D_80A395B0.unk_0;
    sp7C.unk_4 = (s32) D_80A395B0.unk_4;
    sp7C.unk_8 = (s32) D_80A395B0.unk_8;
    ...
    temp_v0_4->words.w1 = Lib_SegmentedToVirtual(*(&sp7C + (this->unk_44E * 4)));
    temp_v0_5 = temp_s0->polyOpa.p;
    temp_s0->polyOpa.p = &temp_v0_5[1];
    temp_v0_5->words.w0 = 0xDB060030;
    temp_v0_5->words.w1 = (u32) &D_80A395A8;
    temp_s0->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk_148.skeleton, this->unk_148.limbDrawTbl, (s32) this->unk_148.dListCount, func_80A38FB4, func_80A390F8, (Actor *) this, temp_s0->polyOpa.p);
    ...
    do {
        func_8013CD64(&this->unk_394, &this->actor.world, temp_s7, (f32) phi_s0_2 / 5.0f, 0xF, &D_80A39550, &D_80A39540);
