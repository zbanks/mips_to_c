typedef struct Boss06 {
    ...
    /* 0x1E8 */ char pad1E8[0x18];                  /* maybe part of unk1E4[7]? */
    /* 0x200 */ ? unk200;                           /* inferred */
    /* 0x200 */ char pad200[0x800];
    /* 0xA00 */ s16 unkA00;                         /* inferred */
    /* 0xA02 */ char padA02[0x2];
    /* 0xA04 */ f32 unkA04;                         /* inferred */
    /* 0xA08 */ f32 unkA08;                         /* inferred */
    /* 0xA0C */ f32 unkA0C;                         /* inferred */
    /* 0xA10 */ f32 unkA10;                         /* inferred */
...
struct _mips2c_stack_Boss06_Draw {
    ...
    /* 0x94 */ char pad94[0x3E];                    /* maybe part of sp90[16]? */
    /* 0xD2 */ u8 spD2;                             /* inferred */
    /* 0xD3 */ u8 spD3;                             /* inferred */
    /* 0xD4 */ char padD4[0xC];                     /* maybe part of spD3[13]? */
...
void Boss06_Init(Boss06 *this, GlobalContext *globalCtx) {
    Boss06 *temp_v1;
    s32 temp_a0;
    u8 *temp_v0;
    u8 *phi_v0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk14C, (Actor *) this, &D_809F40C0);
...
void Boss06_Destroy(Boss06 *this, GlobalContext *globalCtx) {
    Boss06 *this = (Boss06 *) thisx;
...
void Boss06_Update(Boss06 *this, GlobalContext *globalCtx) {
    f32 sp80;
    f32 sp7C;
    f32 *temp_s2;
    f32 temp_f20;
    ...
    if ((temp_v0_3 != 0) && (temp_v0_3 != 0)) {
        ...
        do {
            ...
            sp7C += 32.0f + this->unk1BC;
            sp80 += 32.0f + this->unk1C0;
...
void Boss06_Draw(Boss06 *this, GlobalContext *globalCtx) {
    f32 spE0;
    u8 spD3;
    u8 spD2;
    Gfx *sp90;
    ...
    if ((this->unk144 & 1) != 0) {
        ...
        sp68 = sp68;
        temp_v0_5->words.w1 = Lib_SegmentedToVirtual((void *) &this->unk200);
