...
void ObjRaillift_Init(ObjRaillift *this, GlobalContext *globalCtx) {
    s32 sp48;
    s32 sp44;
...
void ObjRaillift_Destroy(ObjRaillift *this, GlobalContext *globalCtx) {
    ObjRaillift *this = (ObjRaillift *) thisx;
...
void ObjRaillift_Update(ObjRaillift *this, GlobalContext *globalCtx) {
    Actor *temp_v0_2;
    s16 temp_v0;
    f32 phi_f0;
    f32 phi_f2;
...
void ObjRaillift_Draw(ObjRaillift *this, GlobalContext *globalCtx) {
    Gfx *sp58;
    Gfx *sp54;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
...
void ObjRaillift_DrawDekuFlowerPlatform(ObjRaillift *this, GlobalContext *globalCtx) {
    ObjRaillift *this = (ObjRaillift *) thisx;
    func_800BDFC0(globalCtx, &D_06000208);
}

void ObjRaillift_DrawDekuFlowerPlatformColorful(ObjRaillift *this, GlobalContext *globalCtx) {
    ObjRaillift *this = (ObjRaillift *) thisx;
