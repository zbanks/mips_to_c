typedef struct EnHonotrap {
    ...
    /* 0x194 */ char pad_194[0x8C];                 /* maybe part of unk_148[2]? */
    /* 0x220 */ s16 unk_220;                        /* inferred */
    /* 0x222 */ s16 unk_222;                        /* inferred */
    /* 0x224 */ char pad_224[0x4];                  /* maybe part of unk_222[3]? */
    ...
    /* 0x240 */ char pad_240[0x84];                 /* maybe part of unk_23C[34]? */
...
void func_8092E510(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_t8 = (u8) arg0[2].cutscene | 1;
    temp_t0 = temp_t8 | 2;
    arg0[2].cutscene = temp_t8;
    arg0[2].cutscene = temp_t0;
    arg0[2].cutscene = temp_t0 | 4;
}
...
void func_8092E638(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_s7 = &arg0[1].flags;
    Collider_InitTris(arg1, (ColliderTris *) temp_s7);
    Collider_SetTris(arg1, (ColliderTris *) temp_s7, arg0, &D_8093049C, (ColliderTrisElement *) &arg0[1].world);
    phi_s2 = 0;
    do {
        phi_s1 = 0;
        phi_s0_2 = (Vec3f *) &sp70;
loop_5:
        ...
        phi_s0_2->x = (temp_v0->unk_20 * temp_f20) + (temp_v0->unk_18 * temp_f22);
        phi_s0_2->y = temp_v0_2->unk_4;
        phi_s0_2->z = (temp_v0_2->unk_8 * temp_f22) - (temp_v0_2->unk_0 * temp_f20);
        ...
        Collider_SetTrisVertices((ColliderTris *) temp_s7, phi_s2, (Vec3f *) &sp70, (Vec3f *) &sp7C, (Vec3f *) &sp88);
        temp_s2 = phi_s2 + 1;
        phi_s2 = temp_s2;
    } while (temp_s2 != 2);
...
void func_8092E840(Actor *arg0, GlobalContext *arg1) {
    ...
    sp20 = temp_a1;
    Collider_InitCylinder(arg1, (ColliderCylinder *) temp_a1);
    Collider_SetCylinder(arg1, (ColliderCylinder *) temp_a1, arg0, &D_809304AC);
    ...
    arg0[1].shape.feetPos[1].y = temp_t9->world.pos.x;
    arg0[1].shape.feetPos[1].z = temp_t9->world.pos.y;
    arg0[1].projectedPos.x = temp_t9->world.pos.z;
    arg0[1].shape.feetPos[1].z += 10.0f;
    arg0->unk_23A = (s16) (s32) (Rand_ZeroOne() * 511.0f);
...
void func_8092E988(Actor *arg0, GlobalContext *arg1) {
    ...
    Actor_SetScale(arg0, 0.0001f);
    temp_s0 = &arg0[1].flags;
    Collider_InitCylinder(arg1, (ColliderCylinder *) temp_s0);
    Collider_SetCylinder(arg1, (ColliderCylinder *) temp_s0, arg0, &D_809304AC);
    CollisionCheck_SetInfo(&arg0->colChkInfo, NULL, &D_809304D8);
    phi_s0 = (s16) (s32) (Rand_ZeroOne() * 511.0f);
    phi_s2 = &arg0[1].projectedW;
    phi_s1 = 0;
    do {
        phi_s2->unk_1C = phi_s0;
        temp_s1 = phi_s1 + 0x14;
...
void EnHonotrap_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->actor.params;
    if ((temp_v0 == 0) || (temp_v0 == 3)) {
        Collider_DestroyTris(globalCtx, (ColliderTris *) &this->unk_148);
        return;
    }
...
void func_8092EBDC(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    if (((s32) this->unk_220 <= 0) && (this->actor.xzDistToPlayer < 750.0f)) {
...
void func_8092EE90(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    if (((s32) this->unk_220 <= 0) && (this->actor.xzDistToPlayer < 120.0f)) {
        temp_f0 = this->actor.yDistToPlayer;
        if ((temp_f0 < 0.0f) && (temp_f0 > -700.0f)) {
            temp_v0 = this->actor.yawTowardsPlayer - this->actor.shape.rot.y;
            if (((s32) temp_v0 >= -0x3FFF) && ((s32) temp_v0 < 0x4000)) {
...
void func_8092F208(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = temp_v0 & 2;
    if ((temp_v1 != 0) || ((s32) this->unk_220 <= 0)) {
...
void func_8092F34C(Actor *arg0) {
    ...
    arg0->unk_144 = func_8092F3D8;
    temp_f2 = 1.0f / (Actor_DistanceToPoint(arg0, arg0 + 0x228) + 1.0f);
    arg0->unk_220 = 0xA0;
    arg0->velocity.x = (arg0[1].shape.feetPos[1].y - arg0->world.pos.x) * temp_f2;
    arg0[1].projectedPos.y = 0.0f;
    arg0->velocity.y = (arg0[1].shape.feetPos[1].z - arg0->world.pos.y) * temp_f2;
    arg0->velocity.z = (arg0[1].projectedPos.x - arg0->world.pos.z) * temp_f2;
}
...
void func_8092F3D8(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    Math_StepToF(&this->unk_234, 13.0f, 0.5f);
    temp_f2 = this->unk_234;
    ...
    temp_s1 = Math_StepToF((f32 *) &this->actor.world, this->unk_228, temp_a2) & 1;
    temp_s1_2 = temp_s1 & Math_StepToF(&this->actor.world.pos.y, this->unk_22C, sp64);
    temp_s1_3 = temp_s1_2 & Math_StepToF(&this->actor.world.pos.z, this->unk_230, sp68);
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 10.0f, 10.0f, 0.0f, 0x1DU);
    temp_v0 = this->unk_148.base.atFlags;
    if ((temp_v0 & 4) != 0) {
        temp_v0_2 = globalCtx->actorCtx.actorList[2].first;
        temp_a1 = &sp34;
        sp34 = -(bitwise f32) temp_v0_2[10].wallPoly;
        sp38 = -(bitwise f32) temp_v0_2[10].floorPoly;
        sp3C = -temp_v0_2->unk_D2C;
        func_8092E5A4(&sp4C, (Vec3f *) temp_a1);
        temp_a2_2 = &this->actor.velocity;
        sp40.unk_0 = (f32) temp_a2_2->x;
        sp40.unk_4 = (f32) temp_a2_2->y;
        sp40.unk_8 = (f32) temp_a2_2->z;
        func_80179F64((Vec3f *) &sp40, (Vec3f *) &sp4C, temp_a2_2);
        this->actor.speedXZ = this->unk_234 * 0.5f;
...
void func_8092F5EC(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_148.base.atFlags;
    if ((temp_v0 & 4) != 0) {
        func_8018219C((MtxF *) &globalCtx->actorCtx.actorList[2].first[10].scale.y, (Vec3s *) &sp30, 0);
    ...
    if (((this->actor.bgCheckFlags & 8) != 0) || ((s32) this->unk_220 <= 0)) {
        func_8092F7A8(this, &sp30);
        return;
    }
    func_8092E510((Actor *) this, globalCtx);
...
void func_8092F854(Actor *arg0) {
    arg0->unk_144 = func_8092F878;
    arg0->unk_220 = 0x50;
    arg0[1].uncullZoneScale = 0.0f;
}
...
void func_8092F878(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    if ((s32) this->unk_220 < 0x29) {
        sp78 = Math_StepToF(&temp_s4[1], 1.0f, 0.05f);
    ...
    temp_s4[2] += 0.05f * (1.0f - temp_s4[1]);
    temp_f14 = temp_s4[2];
    phi_s2_2 = temp_s2_2;
    phi_v1 = temp_v1;
    phi_s0 = temp_s2_2 + 0xC;
    if (temp_f14 > 0.16666667f) {
        temp_s4[2] = temp_f14 - 0.16666667f;
    }
    temp_f20 = temp_s4[1] + temp_s4[2];
    phi_f20 = temp_f20;
    if (temp_f20 <= temp_s4->unk_0) {
        sp84 = temp_f2;
loop_10:
        phi_s2_2->unk_1E = 1;
        phi_s2_2->unk_C = (f32) ((sp88 * phi_f20) + this->actor.world.pos.x);
        phi_s2_2->unk_10 = (f32) this->actor.world.pos.y;
        phi_s2_2->unk_14 = (f32) ((sp84 * phi_f20) + this->actor.world.pos.z);
        sp54 = phi_v1;
        temp_f2_2 = Math_SinS((s16) (s32) (phi_f20 * 25486.223f)) * 1.6f;
        temp_cond = temp_f2_2 > 1.0f;
        phi_s0->unk_C = temp_f2_2;
        if (temp_cond) {
            phi_s0->unk_C = 1.0f;
        } else if (phi_s0->unk_C < 0.0f) {
            phi_s0->unk_C = 0.0f;
        }
        temp_v1_2 = phi_v1 + 0x14;
        temp_f20_2 = phi_f20 + 0.16666667f;
        phi_s0->unk_C = (f32) (phi_s0->unk_C * (0.006f * (((1.0f - temp_s4[1]) * 0.8f) + 0.2f)));
        phi_s0->unk_10 = (s16) (phi_s0->unk_10 + sp7C);
        phi_s0->unk_10 = (s16) (phi_s0->unk_10 & 0x1FF);
        phi_s2_2 += 0x14;
        phi_f20 = temp_f20_2;
        phi_v1 = temp_v1_2;
        phi_s0 += 0x14;
    ...
    if ((sp78 != 0) || ((s32) this->unk_220 <= 0)) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    temp_f20_3 = temp_s4->unk_0 * 120.0f;
    temp_f22 = temp_s4[1] * 120.0f;
    ...
    if ((sp80 * (((1.0f - temp_s4[1]) * 0.8f) + 0.2f)) > 0.2f) {
        this->unk_148.dim.pos.x = (s16) (s32) ((Math_SinS(this->actor.shape.rot.y) * sp70) + this->actor.world.pos.x);
        this->unk_148.dim.pos.y = (s16) (s32) (this->actor.world.pos.y - (24.0f * phi_f20_2));
        temp_s1 = &this->unk_148;
        temp_s0 = &globalCtx->colChkCtx;
        this->unk_148.dim.pos.z = (s16) (s32) ((Math_CosS(this->actor.shape.rot.y) * sp70) + this->actor.world.pos.z);
        this->unk_148.dim.radius = (s16) (s32) (15.0f * phi_f20_2);
        this->unk_148.dim.height = (s16) (s32) (37.5f * phi_f20_2);
...
void EnHonotrap_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_220;
    if ((s32) temp_v0 > 0) {
        this->unk_220 = temp_v0 - 1;
    }
    ...
    temp_v0_3 = this->unk_148.base.acFlags;
    if ((temp_v0_3 & 2) != 0) {
    ...
    if ((s32) this->unk_222 < 3) {
        this->unk_148.base.acFlags = temp_v0_3 & 0xFFFD;
...
void func_8092FE44(Actor *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_220;
    if ((s32) temp_v0 > 0) {
        this->unk_220 = (s16) (temp_v0 - 1);
    }
    this[2].cutscene = 0;
    this->unk_238 = (s16) (this->unk_238 + 0x640);
    if (this->params != 4) {
        this->shape.yOffset = (Math_SinS(this->unk_238) * 1000.0f) + 600.0f;
    }
    Actor_SetHeight(this, 5.0f);
    Audio_PlayActorSound2(this, 0x205BU);
    this->unk_144(this, globalCtx);
    this->unk_23A = (s16) (this->unk_23A - 0x14);
    this->unk_23A = (s16) (this->unk_23A & 0x1FF);
}
...
void func_8092FEFC(Actor *this, GlobalContext *globalCtx) {
    ...
    temp_v0_2 = this->unk_220;
    if ((s32) temp_v0_2 > 0) {
        this->unk_220 = (s16) (temp_v0_2 - 1);
    }
    this->unk_238 = (s16) (this->unk_238 + 0x640);
    Audio_PlayActorSound2(this, 0x205BU);
    this->unk_144(this, globalCtx);
...
void EnHonotrap_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0->words.w1 = (u32) D_809303F0[this->unk_222];
...
void func_80930030(Actor *this, GlobalContext *globalCtx) {
    ...
    temp_v0->words.w0 = 0xDB060020;
    sp4C = temp_v0;
    sp4C->words.w1 = Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0U, 0U, 0x20, 0x40, 1, 0U, (u32) this->unk_23A, 0x20, 0x80);
...
void func_80930190(Actor *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if (phi_s3->unk_1E != 0) {
            ...
            temp_v0_3->words.w1 = Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0U, 0U, 0x20, 0x40, 1, 0U, (u32) temp_s0->unk_10, 0x20, 0x80);
            SysMatrix_SetStateRotationAndTranslation(temp_s0->unk_0, temp_s0->unk_4 - (4000.0f * temp_s0->unk_C), temp_s0->unk_8, (Vec3s *) &spB8);
            temp_f14 = temp_s0->unk_C;
