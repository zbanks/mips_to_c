...
? func_800DFC90(Vec3s *, Camera *);                 /* extern */
void func_8092E510(Actor *arg0, GlobalContext *arg1); /* static */
void func_8092E5A4(Vec3f *arg0, Vec3f *arg1);       /* static */
...
void func_8092F7A8(EnHonotrap *arg0, Vec3s *);      /* static */
...
static void *D_809303F0 = {(void *)0x500B6C0, (void *)0x500BEC0, (void *)0x500C6C0, (void *)0x500C6C0};
static s32 D_80930400 = 1;
static ColliderTrisElementInit D_80930424 = {
    {
...
static InitChainEntry D_809304E0;                   /* unable to generate initializer */
...
typedef struct EnHonotrap {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnHonotrap *, GlobalContext *);
    /* 0x0148 */ ColliderCylinder unk148;           /* inferred */
    /* 0x0194 */ char pad194[0x8C];
    /* 0x0220 */ s16 unk220;                        /* inferred */
    /* 0x0222 */ s16 unk222;                        /* inferred */
    /* 0x0224 */ char pad224[0x4];                  /* maybe part of unk222[3]? */
    ...
    /* 0x0240 */ char pad240[0x84];                 /* maybe part of unk23C[34]? */
...
void func_8092E510(Actor *arg0, GlobalContext *arg1) {
    ...
    sp24 = temp_a1;
    CollisionCheck_SetAT(arg1, temp_a1, &temp_s1->base);
    CollisionCheck_SetAC(arg1, temp_a1, &temp_s1->base);
    CollisionCheck_SetOC(arg1, temp_a1, &temp_s1->base);
...
loop_5:
        ...
        Math_Vec3f_Sum(phi_s0_2, &arg0->world.pos, phi_s0_2);
        temp_s1 = phi_s1 + 0xC;
        phi_s1 = temp_s1;
        phi_s0_2 += 0xC;
        if (temp_s1 != 0x24) {
        ...
        Collider_SetTrisVertices(temp_s7, phi_s2, &sp70, &sp7C, &sp88);
        temp_s2 = phi_s2 + 1;
        phi_s2 = temp_s2;
    } while (temp_s2 != 2);
...
void EnHonotrap_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 0) || (temp_v0 == 3)) {
        func_8092E638(&this->actor, globalCtx, globalCtx);
        return;
    }
    if (temp_v0 == 4) {
        func_8092E988(&this->actor, globalCtx, globalCtx);
    ...
    func_8092E840(&this->actor, globalCtx, globalCtx);
...
void func_8092ECF0(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    if ((s32) this->unk222 <= 0) {
        ...
        Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0x8C, (sp40 * 12.0f) + this->actor.home.pos.x, this->actor.home.pos.y - 10.0f, (Math_CosS(this->actor.shape.rot.y) * 12.0f) + this->actor.home.pos.z, (s16) (s32) this->actor.home.rot.x, (s16) (s32) this->actor.home.rot.y, (s16) (s32) this->actor.home.rot.z, 1);
    }
}
...
void func_8092EF98(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    if ((s32) this->unk222 <= 0) {
        ...
        Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0x8C, (sp44 * 12.0f) + this->actor.home.pos.x, this->actor.home.pos.y, (Math_CosS(this->actor.shape.rot.y) * 12.0f) + this->actor.home.pos.z, (s16) (s32) this->actor.home.rot.x, (s16) (s32) this->actor.home.rot.y, (s16) (s32) this->actor.home.rot.z, 4);
        func_8092F05C(this);
    }
}
...
void func_8092F10C(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    this = this;
    temp_v0 = Math_StepToF(&temp_a0->x, phi_f0, 0.0006f);
...
void func_8092F208(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v1 != 0) || ((s32) this->unk220 <= 0)) {
        if ((temp_v1 != 0) && ((temp_v0 & 4) == 0)) {
            func_800B8D98(globalCtx, &this->actor, 5.0f, this->actor.yawTowardsPlayer, 0.0f);
        }
    ...
    if (this->actor.velocity.y > 0.0f) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 10.0f, 12.0f, 0.0f, 5U);
    }
    ...
    func_8092E510(&this->actor, globalCtx);
}
...
void func_8092F3D8(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    temp_s1 = Math_StepToF(&this->actor.world.pos.x, this->unk228, temp_a2) & 1;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 10.0f, 10.0f, 0.0f, 0x1DU);
    temp_v0 = this->unk148.base.atFlags;
    if ((temp_v0 & 4) != 0) {
        ...
        sp40.y = temp_a2_2->y;
        sp40.z = temp_a2_2->z;
        func_80179F64(&sp40, &sp4C, temp_a2_2);
...
void func_8092F5EC(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk148.base.atFlags;
    if ((temp_v0 & 4) != 0) {
        func_8018219C(globalCtx->actorCtx.actorList[2].first + 0xD04, &sp30, 0);
...
void func_8092F7BC(EnHonotrap *this, GlobalContext *globalCtx) {
    ...
    sp28 = Math_StepToF(&this->actor.scale.x, 0.0001f, 0.00015f);
    temp_f0 = this->actor.scale.x;
    this->actor.scale.y = temp_f0;
    this->actor.scale.z = temp_f0;
...
loop_10:
    ...
    Actor_CalcOffsetOrientedToDrawRotation(&this->actor, &sp68, &globalCtx->actorCtx.actorList[2].first->world.pos);
    phi_f0 = sp68.z;
    if (sp68.z < temp_f22) {
        phi_f0 = temp_f22;
    } else if (temp_f20_3 < sp68.z) {
        phi_f0 = temp_f20_3;
    }
    sp68.z = phi_f0;
    ...
    if ((sp80 * (((1.0f - temp_s4->unk4) * 0.8f) + 0.2f)) > 0.2f) {
        this->unk148.dim.pos.x = (s16) (s32) ((Math_SinS(this->actor.shape.rot.y) * sp68.z) + this->actor.world.pos.x);
        this->unk148.dim.pos.y = (s16) (s32) (this->actor.world.pos.y - (24.0f * phi_f20_2));
        temp_s1 = &this->unk148;
        temp_s0 = &globalCtx->colChkCtx;
        this->unk148.dim.pos.z = (s16) (s32) ((Math_CosS(this->actor.shape.rot.y) * sp68.z) + this->actor.world.pos.z);
        this->unk148.dim.radius = (s16) (s32) (15.0f * phi_f20_2);
        this->unk148.dim.height = (s16) (s32) (37.5f * phi_f20_2);
        CollisionCheck_SetAT(globalCtx, temp_s0, &temp_s1->base);
        CollisionCheck_SetAC(globalCtx, temp_s0, &temp_s1->base);
        CollisionCheck_SetOC(globalCtx, temp_s0, &temp_s1->base);
    }
}
...
void func_80930190(Actor *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if (phi_s3->unk1E != 0) {
            ...
            SysMatrix_SetStateRotationAndTranslation(temp_s0->unk0, temp_s0->unk4 - (4000.0f * temp_s0->unkC), temp_s0->unk8, &spB8);
            temp_f14 = temp_s0->unkC;
            Matrix_Scale(((fabsf(Math_SinS((s16) ((s32) (s16) (spB8.y - this->shape.rot.y) >> 1))) * 0.2f) + 1.7f) * temp_f14, temp_f14, 1.0f, 1);
