...
typedef struct EnBigokuta {
    ...
    /* 0x191 */ char pad_191[0x1];
    /* 0x192 */ s16 unk_192;                        /* inferred */
    /* 0x194 */ char pad_194[0x2];
    /* 0x196 */ s16 unk_196;                        /* inferred */
    /* 0x198 */ Vec3s unk_198;                      /* inferred */
    /* 0x19E */ char pad_19E[0x72];                 /* maybe part of unk_198[20]? */
    /* 0x210 */ Vec3s unk_210;                      /* inferred */
    /* 0x216 */ char pad_216[0x72];                 /* maybe part of unk_210[20]? */
    /* 0x288 */ f32 unk_288;                        /* inferred */
    /* 0x28C */ f32 unk_28C;                        /* inferred */
    /* 0x290 */ f32 unk_290;                        /* inferred */
    /* 0x294 */ char pad_294[0x18];                 /* maybe part of unk_290[7]? */
    /* 0x2AC */ f32 unk_2AC;                        /* inferred */
    /* 0x2B0 */ f32 unk_2B0;                        /* inferred */
    /* 0x2B4 */ f32 unk_2B4;                        /* inferred */
    /* 0x2B8 */ char pad_2B8[0xC];                  /* maybe part of unk_2B4[4]? */
    /* 0x2C4 */ Vec3f unk_2C4;                      /* inferred */
    /* 0x2D0 */ char pad_2D0[0x90];                 /* maybe part of unk_2C4[13]? */
    /* 0x360 */ ColliderCylinder unk_360;           /* inferred */
...
static u32 D_80AC4630 = 0x3F99999A;                 /* const */
static u32 D_80AC4638 = 0x3F99999A;                 /* const */
...
void EnBigokuta_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_148, &D_06006BC0, &D_060014B8, &this->unk_198, &this->unk_210, 0x14);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_360, (Actor *) this, &D_80AC4530);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_3AC, (Actor *) this, &D_80AC455C);
    CollisionCheck_SetInfo(&this->actor.colChkInfo, NULL, &D_80AC4588);
    this->unk_196 = ActorCutscene_GetAdditionalCutscene((s16) this->actor.cutscene);
    ...
    this->unk_2AC = (Math_SinS(this->actor.home.rot.y) * 66.0f) + this->actor.world.pos.x;
    this->unk_2B0 = (this->actor.home.pos.y - 49.5f) + 42.899998f;
    temp_f6 = Math_CosS(this->actor.home.rot.y) * 66.0f;
    this->unk_144 = func_80AC2B4C;
    this->unk_2B4 = temp_f6 + this->actor.world.pos.z;
}

void EnBigokuta_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnBigokuta *this = (EnBigokuta *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_360);
...
void func_80AC28B4(Actor *arg0, GlobalContext *arg1, Vec3f *arg2, Vec3f *arg3) {
    ...
    arg0[1].sfx = ActorCutscene_GetCurrentCamera((s16) arg0->cutscene);
    Play_CameraSetAtEye(arg1, (s16) arg0[1].sfx, arg2, arg3);
    ...
    temp_a0 = phi_a0 >> 0x10;
    sp26 = (s16) temp_a0;
    temp_f10 = (Math_SinS((s16) temp_a0) * 250.0f) + arg0[2].world.pos.x;
    arg0->unk_2BC = (f32) (arg0[2].world.pos.y + 100.0f);
    arg0->unk_2B8 = temp_f10;
    arg0->unk_2C0 = (f32) ((Math_CosS((s16) temp_a0) * 250.0f) + arg0[2].world.pos.z);
}
...
void func_80AC2F64(Actor *arg0, void *arg1) {
    ...
    if ((temp_f0 < 200.0f) && (arg1->unk_18778(arg1, arg1->unk_1CCC) != 0)) {
...
void func_80AC30EC(Actor *arg0, void *arg1) {
    ...
    ActorCutscene_SetIntentToPlay((s16) arg0->cutscene);
    arg0->unk_2A0 = (f32) ((Math_SinS(arg0->shape.rot.y) * 66.0f) + arg0->world.pos.x);
    arg0->unk_2A4 = (f32) ((arg0->home.pos.y - 49.5f) + 42.899998f);
    arg0->unk_2A8 = (f32) ((Math_CosS(arg0->shape.rot.y) * 66.0f) + arg0->world.pos.z);
    Audio_PlayActorSound2(arg0, 0x38BEU);
    arg0->unk_18C = func_80AC31EC;
}
...
void func_80AC31EC(Actor *arg0, void *arg1) {
    ...
    temp_s2 = arg1->unk_1CCC;
    func_80AC3054(arg0);
    SkelAnime_FrameUpdateMatrix((SkelAnime *) &arg0[1].flags);
    Math_StepToF(&arg0->world.pos.y, arg0->home.pos.y - 49.5f, 10.0f);
    temp_v1 = arg0[1].focus.unk_12;
    temp_s1 = temp_s2 + 0x24;
    temp_a1 = &arg0[2].home.pos.y;
    if ((s32) temp_v1 < 9) {
        arg0[1].focus.unk_12 = temp_v1 + 1;
    }
    temp_s2->unk_AE8 = 0;
    sp2C = temp_a1;
    Math_Vec3f_Copy(temp_s1, (Vec3f *) temp_a1);
    temp_a1_2 = &arg0[2].home.rot.z;
    sp28 = temp_a1_2;
    if (Math_Vec3f_StepTo(temp_s1, (Vec3f *) temp_a1_2, sqrtf((f32) arg0[1].focus.unk_12) * 5.0f) < 0.1f) {
        ...
        arg0->unk_2A4 = (f32) ((arg0->home.pos.y - 49.5f) + 42.899998f);
        arg0->unk_2A8 = (f32) ((Math_CosS(arg0->shape.rot.y) * 66.0f) + arg0->world.pos.z);
        Math_Vec3f_Copy(temp_s1, (Vec3f *) sp28);
        Math_Vec3f_Copy((Vec3f *) sp2C, temp_s1);
        temp_s2->unk_BE = (s16) (temp_s2->unk_BE + (arg0->shape.rot.y - sp3A));
        return;
    }
    Math_Vec3f_Copy((Vec3f *) sp2C, temp_s1);
    temp_s2->unk_68 = 0.0f;
...
void func_80AC33A4(Actor *arg0) {
    arg0[1].focus.unk_12 = 0xC;
    arg0->unk_18C = func_80AC33C0;
}
...
void func_80AC33C0(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0[1].focus.unk_12;
    if ((s32) temp_v0 >= 0) {
        sp24 = temp_v1;
        func_80AC3054(arg0);
        Math_Vec3f_Copy(temp_v1 + 0x24, (Vec3f *) &arg0[2].home.rot.z);
        if (arg0[1].focus.unk_12 == 0) {
...
void func_80AC3460(Actor *arg0) {
    ...
    temp_a0 = arg0[1].unk_52;
    arg0 = arg0;
    ActorCutscene_SetIntentToPlay(temp_a0);
    arg0[1].focus.unk_12 = 0;
    arg0->unk_18C = func_80AC34A8;
...
void func_80AC34A8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCanPlayNext(arg0[1].unk_52) != 0) {
        ActorCutscene_Start(arg0[1].unk_52, arg0);
...
void func_80AC35E8(Actor *arg0) {
    ...
    arg0->flags &= -2;
    arg0[1].focus.unk_12 = 0xA;
    arg0->unk_18C = func_80AC3650;
}
...
void func_80AC3650(Actor *arg0, GlobalContext *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(arg0 + 0x148) != 0) {
        ...
        if ((s32) temp_v0 > 0) {
            arg0[1].focus.unk_12 = temp_v0 - 1;
            if (arg0[1].focus.unk_12 == 6) {
        ...
        if (Math_StepToF(&arg0->scale.y, 0.001f, 0.001f) != 0) {
            ...
            ActorCutscene_Stop(arg0[1].unk_52);
        ...
        if (arg0->unk_288 > 0.0f) {
            arg0->unk_288 = (f32) (arg0->scale.y * 30.30303f);
            return;
        }
        /* Duplicate return node #16. Try simplifying control flow for better match */
        return;
...
void EnBigokuta_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk_3AC.base.acFlags & 1) != 0) {
        ...
        this->unk_360.dim.pos.y = (s16) (s32) this->actor.world.pos.y;
        this->unk_360.dim.pos.x = (s16) temp_f16;
        temp_f8 = Math_CosS(this->actor.shape.rot.y) * -20.0f;
        temp_a1 = &globalCtx->colChkCtx;
        this->unk_3AC.dim.pos.x = this->unk_360.dim.pos.x;
        this->unk_3AC.dim.pos.y = this->unk_360.dim.pos.y;
        this->unk_360.dim.pos.z = (s16) (s32) (temp_f8 + this->actor.world.pos.z);
        this->unk_3AC.dim.pos.z = this->unk_360.dim.pos.z;
        sp24 = temp_a1;
        CollisionCheck_SetAC(globalCtx, temp_a1, (Collider *) &this->unk_3AC);
        temp_a2 = &this->unk_360;
        sp20 = temp_a2;
    ...
    if (this->unk_288 > 0.0f) {
        if (this->unk_190 != 0xA) {
            Math_StepToF(&this->unk_288, 0.0f, 0.05f);
            temp_f0 = (this->unk_288 + 1.0f) * 0.6f;
            this->unk_28C = temp_f0;
            if (temp_f0 > 1.2f) {
                this->unk_28C = 1.2f;
                return;
            }
        ...
        if (Math_StepToF(&this->unk_290, 1.2f, 0.030000001f) == 0) {
...
s32 func_80AC3D48(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, s16 *arg4, Actor *arg5, Gfx **arg6) {
    ...
    if (arg1 == 0xA) {
        phi_a3 = 0xFF;
        if (func_80AC3650 == arg5->unk_18C) {
            temp_f0 = (f32) SkelAnime_GetFrameCount(&D_06000A74);
            phi_a3 = (s32) ((255.0f / temp_f0) * (temp_f0 - arg5->unk_160));
        }
        temp_v1 = *arg6;
        *arg6 = temp_v1 + 8;
        temp_v1->words.w1 = 0;
        ...
        *arg6 = temp_v1_2 + 8;
        ...
        temp_v0_2 = arg5->unk_18C;
        if (func_80AC31EC == temp_v0_2) {
            *arg4 -= (s16) (s32) ((f32) arg5[1].focus.unk_12 * 6144.0f * 0.11111111f);
        } else if (func_80AC33C0 == temp_v0_2) {
            temp_v0_3 = arg5[1].focus.unk_12;
            if (temp_v0_3 == 1) {
                phi_v1 = 0;
            } else if (temp_v0_3 == 0) {
                phi_v1 = -0xC00;
        ...
        temp_v0_4 = arg5->unk_18C;
        if (func_80AC3650 == temp_v0_4) {
            temp_v0_5 = arg5[1].focus.unk_12;
            if ((s32) temp_v0_5 < 5) {
            ...
            temp_f16 = (f32) arg5[1].focus.unk_12;
            temp_f18 = temp_f16 * 0.022222223f;
            temp_f2 = sin_rad((f32) arg5[1].focus.unk_12 * 1.0471976f) * 0.5f;
...
void EnBigokuta_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80AC3650 != this->actionFunc) || (this->unk_192 != 0)) {
        sp30 = temp_v1;
        Scene_SetRenderModeXlu(globalCtx, 0, 1U);
        temp_v0_2 = temp_v1->polyOpa.p;
        temp_v0_2->words.w1 = (u32) &sSetupDL[150];
        temp_v0_2->words.w0 = 0xDE000000;
        temp_v0_2[1].words.w1 = -1;
        temp_v0_2[1].words.w0 = 0xFB000000;
        sp30 = temp_v1;
        temp_v1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk_148.skeleton, this->unk_148.limbDrawTbl, (s32) this->unk_148.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80AC3D48, func_80AC4204, (Actor *) this, &temp_v0_2[2]);
    } else {
        sp30 = temp_v1;
        ...
        temp_v0[1].words.w1 = (u32) (this->actor.scale.y * 7727.273f) & 0xFF;
        sp30 = temp_v1;
        temp_v1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk_148.skeleton, this->unk_148.limbDrawTbl, (s32) this->unk_148.dListCount, NULL, func_80AC4204, (Actor *) this, &temp_v0[2]);
    }
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk_2C4, 0xD, this->unk_28C, this->unk_290, this->unk_288, (u8) (s32) this->unk_190);
}
