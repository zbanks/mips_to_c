...
static InitChainEntry D_80AC4590;                   /* unable to generate initializer */
...
typedef struct EnBigokuta {
    ...
    /* 0x018C */ void (*actionFunc)(EnBigokuta *, GlobalContext *);
    /* 0x0190 */ u8 unk190;                         /* inferred */
    /* 0x0191 */ char pad191[0x1];                  /* maybe part of unk190[2]? */
    /* 0x0192 */ s16 unk192;                        /* inferred */
    /* 0x0194 */ char pad194[0x2];                  /* maybe part of unk192[2]? */
    /* 0x0196 */ s16 unk196;                        /* inferred */
    /* 0x0198 */ Vec3s unk198;                      /* inferred */
    /* 0x019E */ char pad19E[0x72];                 /* maybe part of unk198[20]? */
    /* 0x0210 */ Vec3s unk210;                      /* inferred */
    /* 0x0216 */ char pad216[0x72];                 /* maybe part of unk210[20]? */
    /* 0x0288 */ f32 unk288;                        /* inferred */
    /* 0x028C */ f32 unk28C;                        /* inferred */
    /* 0x0290 */ f32 unk290;                        /* inferred */
    /* 0x0294 */ char pad294[0x18];                 /* maybe part of unk290[7]? */
    /* 0x02AC */ f32 unk2AC;                        /* inferred */
    /* 0x02B0 */ f32 unk2B0;                        /* inferred */
    /* 0x02B4 */ f32 unk2B4;                        /* inferred */
    /* 0x02B8 */ char pad2B8[0xC];                  /* maybe part of unk2B4[4]? */
    /* 0x02C4 */ Vec3f unk2C4;                      /* inferred */
    /* 0x02D0 */ char pad2D0[0x90];                 /* maybe part of unk2C4[13]? */
    /* 0x0360 */ ColliderCylinder unk360;           /* inferred */
...
void EnBigokuta_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk360, &this->actor, &D_80AC4530);
    Collider_InitAndSetCylinder(globalCtx, &this->unk3AC, &this->actor, &D_80AC455C);
...
void func_80AC3650(Actor *arg0, GlobalContext *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(arg0 + 0x148) != 0) {
        ...
        if (Math_StepToF(&arg0->scale.y, 0.001f, 0.001f) != 0) {
            Audio_PlaySoundAtPosition(arg1, &arg0->world.pos, 0x32, 0x38C5U);
...
void EnBigokuta_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80AC2B98(&this->actor, globalCtx) == 0) {
        Actor_MarkForDeath(&this->actor);
        return;
    }
    ...
    func_80AC39A0(&this->actor, globalCtx);
    ...
    if ((this->unk3AC.base.acFlags & 1) != 0) {
        ...
        sp24 = temp_a1;
        CollisionCheck_SetAC(globalCtx, temp_a1, &this->unk3AC.base);
        temp_a2 = &this->unk360;
        sp20 = temp_a2;
...
void EnBigokuta_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80AC3650 != this->actionFunc) || (this->unk192 != 0)) {
        ...
        sp30 = temp_v1;
        temp_v1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80AC3D48, func_80AC4204, &this->actor, temp_v0_2 + 0x10);
    } else {
        sp30 = temp_v1;
        ...
        sp30 = temp_v1;
        temp_v1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, NULL, func_80AC4204, &this->actor, temp_v0 + 0x10);
    }
    func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk2C4, 0xD, this->unk28C, this->unk290, this->unk288, (u8) (s32) this->unk190);
}
