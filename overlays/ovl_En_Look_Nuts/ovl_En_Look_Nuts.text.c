typedef struct EnLookNuts {
    ...
    /* 0x210 */ char pad210[0x6];                   /* maybe part of actionFunc[2]? */
    ...
    /* 0x224 */ char pad224[0x2];
    /* 0x226 */ s16 unk226;                         /* inferred */
    /* 0x228 */ char pad228[0x4];                   /* maybe part of unk226[3]? */
...
struct _mips2c_stack_EnLookNuts_Update {
    ...
    /* 0x38 */ char pad38[0xA];                     /* maybe part of sp34[3]? */
...
void EnLookNuts_Init(EnLookNuts *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk244, (Actor *) this, &D_80A68600);
...
void EnLookNuts_Destroy(EnLookNuts *this, GlobalContext *globalCtx) {
    EnLookNuts *this = (EnLookNuts *) thisx;
...
void EnLookNuts_Update(EnLookNuts *this, GlobalContext *globalCtx) {
    ...
    if (D_80A6862C == 0) {
        if (((s32) this->unk21C < 2) && (this->actor.xzDistToPlayer < 320.0f) && (this->actor.yDistToPlayer < 80.0f)) {
            sp5C.unk0 = (s32) D_80A68650.unk0;
            sp5C.unk4 = (s32) D_80A68650.unk4;
            sp5C.unk8 = (s32) D_80A68650.unk8;
            Math_Vec3f_Copy((Vec3f *) &sp50, (Vec3f *) &this->actor.world);
            temp_f16 = sp50 + (Math_SinS((s16) (this->actor.world.rot.y + (s32) this->unk230)) * 10.0f);
            sp54 += 30.0f;
            sp50 = temp_f16;
            sp58 += Math_CosS((s16) (this->actor.world.rot.y + (s32) this->unk230)) * 10.0f;
            SysMatrix_StatePush();
            ...
            if (this->unk222 == 0) {
                ...
                if (Player_GetMask(globalCtx) != 0x10) {
                    EffectSsSolderSrchBall_Spawn(globalCtx, (Vec3f *) &sp50, (Vec3f *) &sp44, &D_801D15B0, (s16) 0x32, &this->unk222, (s16) (s32) phi_v1);
                }
            }
