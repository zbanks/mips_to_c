typedef struct EnBba01 {
    ...
    /* 0x148 */ void (*unk148)(EnBba01 *, GlobalContext *); /* inferred */
...
void EnBba01_Init(EnBba01 *this, GlobalContext *globalCtx) {
    ColliderCylinder *sp24;
    ColliderCylinder *temp_a1;
    EnBba01 *this = (EnBba01 *) thisx;

    this->unk193 = func_8013D924(0xDF, globalCtx);
    this->unk190 = func_8013D924(0xDF, globalCtx);
    this->unk191 = func_8013D924(0xDF, globalCtx);
    this->unk192 = func_8013D924(0xDF, globalCtx);
...
void EnBba01_Destroy(EnBba01 *this, GlobalContext *globalCtx) {
    EnBba01 *this = (EnBba01 *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk194);
}

void EnBba01_Update(EnBba01 *this, GlobalContext *globalCtx) {
    EnBba01 *this = (EnBba01 *) thisx;
...
s32 func_809CC6F0(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    sp34.unk0 = (s32) D_809CCCF8.unk0;
    sp34.unk4 = (s32) D_809CCCF8.unk4;
    sp34.unk8 = (s32) D_809CCCF8.unk8;
...
void func_809CC984(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp2C.unk0 = (s32) D_809CCD04.unk0;
    sp2C.unk4 = (s32) D_809CCD04.unk4;
    sp2C.unk8 = (s32) D_809CCD04.unk8;
    if (arg1 == 7) {
        temp_a1 = *arg0;
...
void EnBba01_Draw(EnBba01 *this, GlobalContext *globalCtx) {
    Gfx *temp_s7;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    ...
    func_801343C0(globalCtx, this->unk150, this->unk16C, (s32) this->unk14E, func_809CC6F0, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_809CC984, func_809CCA5C, (Actor *) this);
