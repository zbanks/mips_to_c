...
static s16 D_809CCCD8 = {0xFA0, 4, 1, 3, 0x1770, 4, 1, 6, 0xFA0, 4, 1, 3, 0x1770, 4, 1, 6};
static ? D_809CCCF8;                                /* unable to generate initializer */
static ? D_809CCD04;                                /* unable to generate initializer */

typedef struct EnBba01 {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnBba01 *, GlobalContext *);
    /* 0x0148 */ void (*unk148)(EnBba01 *, GlobalContext *); /* inferred */
...
void EnBba01_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_809CCC80);
...
s32 func_809CC6F0(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    sp34.x = D_809CCCF8.unk0;
    sp34.y = D_809CCCF8.unk4;
    sp34.z = D_809CCCF8.unk8;
...
void func_809CC984(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp2C.x = D_809CCD04.unk0;
    sp2C.y = D_809CCD04.unk4;
    sp2C.z = D_809CCD04.unk8;
    if (arg1 == 7) {
        temp_a1 = *arg0;
...
void EnBba01_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk150, this->unk16C, (s32) this->unk14E, func_809CC6F0, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_809CC984, func_809CCA5C, &this->actor);
