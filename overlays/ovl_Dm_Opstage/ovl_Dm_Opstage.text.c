...
void DmOpstage_Init(DmOpstage *this, GlobalContext *globalCtx) {
    f32 temp_f6;
    f32 temp_f8;
    s32 temp_v0;
    s32 phi_v0;
...
void DmOpstage_Destroy(DmOpstage *this, GlobalContext *globalCtx) {
    DmOpstage *this = (DmOpstage *) thisx;
...
void DmOpstage_Update(DmOpstage *this, GlobalContext *globalCtx) {
    DmOpstage *this = (DmOpstage *) thisx;
...
void DmOpstage_Draw(DmOpstage *this, GlobalContext *globalCtx) {
    s32 temp_v1;
    s32 phi_v1;
    DmOpstage *this = (DmOpstage *) thisx;
