...
void func_808F7FD0(EnBomChu *arg0, ? *arg1, Vec3f *arg2); /* static */
...
static s16 D_808F8908 = {0xD, 0x64};
static InitChainEntry D_808F890C;                   /* unable to generate initializer */
...
typedef struct EnBomChu {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnBomChu *, GlobalContext *);
    ...
    /* 0x0178 */ char pad178[0x4];                  /* maybe part of unk174[2]? */
    /* 0x017C */ f32 unk17C;                        /* inferred */
    /* 0x0180 */ s32 unk180;                        /* inferred */
    /* 0x0184 */ s32 unk184;                        /* inferred */
    /* 0x0188 */ ColliderSphere unk188;             /* inferred */
} EnBomChu;                                         /* size 0x1E0 */
...
void EnBomChu_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk188, &this->actor, &D_808F88E0);
    this->unk188.dim.worldSphere.radius = D_808F8908;
    Effect_Add(globalCtx, &this->unk180, 2, 0U, (u8) 0, &D_808F8914);
    Effect_Add(globalCtx, &this->unk184, 2, 0U, (u8) 0, &D_808F8914);
    this->unk14A = 0x78;
    this->actor.room = -1;
    this->unk148 = 1;
...
void EnBomChu_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnBomChu *this = (EnBomChu *) thisx;
    Effect_Destroy(globalCtx, this->unk180);
    Effect_Destroy(globalCtx, this->unk184);
    Collider_DestroySphere(globalCtx, &this->unk188);
}
...
s32 func_808F75D0(EnBomChu *arg0, CollisionPoly *arg1, GlobalContext *arg2) {
    ...
    if (arg1 != 0) {
        ...
        temp_f12 = (arg0->unk158 * sp44) + (sp48 * arg0->unk15C) + (sp4C * arg0->unk160);
...
void func_808F7868(EnBomChu *this, GlobalContext *globalCtx) {
    ...
    if (Actor_HasNoParent(&this->actor, globalCtx) != 0) {
        ...
        sp2C = temp_v0;
        Math_Vec3f_Copy(&this->actor.world.pos, &temp_v0->world.pos);
...
void func_808F7A84(EnBomChu *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk14A == 0) || ((this->unk188.base.acFlags & 2) != 0) || ((this->unk188.base.ocFlags1 & 2) != 0)) {
        func_808F7E74(this, globalCtx);
        return;
    }
    sp60 = this->actor.world.pos.x + (2.0f * this->unk158);
    temp_a2 = &sp54;
    sp64 = this->actor.world.pos.y + (2.0f * this->unk15C);
    temp_f12 = this->unk160;
    sp68 = this->actor.world.pos.z + (2.0f * temp_f12);
    sp54 = this->actor.world.pos.x - (this->unk158 * 4.0f);
    sp58 = this->actor.world.pos.y - (this->unk15C * 4.0f);
    sp5C = this->actor.world.pos.z - (this->unk160 * 4.0f);
    if (func_808F7944((bitwise GlobalContext *) temp_f12, (bitwise Vec3f *) 4.0f, (Vec3f *) globalCtx, (Vec3f *) &sp60, (CollisionPoly **) temp_a2, &sp3C, &sp80, &sp78) != 0) {
        temp_a2_2 = &sp54;
        sp54 = (this->unk14C * temp_f20) + sp60;
        sp58 = (this->unk150 * temp_f20) + sp64;
        sp5C = (this->unk154 * temp_f20) + sp68;
        if (func_808F7944(globalCtx, (Vec3f *) &sp60, (Vec3f *) temp_a2_2, &sp48, &sp84, &sp7C) != 0) {
            sp70 = func_808F75D0(this, sp84, globalCtx);
            Math_Vec3f_Copy(&this->actor.world.pos, &sp48);
            ...
            Math_Vec3f_Copy(&this->actor.world.pos, (Vec3f *) &sp3C);
...
loop_11:
        phi_s1_2 = phi_s1;
        if (phi_s1 == 0) {
            sp54 = sp60 - (this->unk14C * temp_f20_2);
            sp58 = sp64 - (this->unk150 * temp_f20_2);
            sp5C = sp68 - (this->unk154 * temp_f20_2);
        } else if (phi_s1 == 1) {
            sp54 = (this->unk164 * temp_f20_2) + sp60;
            sp58 = (this->unk168 * temp_f20_2) + sp64;
            sp5C = (this->unk16C * temp_f20_2) + sp68;
        } else {
            sp54 = sp60 - (this->unk164 * temp_f20_2);
            sp58 = sp64 - (this->unk168 * temp_f20_2);
            sp5C = sp68 - (this->unk16C * temp_f20_2);
        }
        if (func_808F7944(globalCtx, (Vec3f *) &sp60, (Vec3f *) &sp54, &sp48, &sp84, &sp7C) != 0) {
            sp70 = func_808F75D0(this, sp84, globalCtx);
            Math_Vec3f_Copy(&this->actor.world.pos, &sp48);
            this->actor.floorBgId = (u8) sp7C;
        } else {
    ...
    if (this->unk149 != 0) {
        func_800B8F98(&this->actor, 0x1031U);
    }
    temp_f0_2 = this->actor.speedXZ;
    if (temp_f0_2 != 0.0f) {
        this->unk17C = temp_f0_2;
    }
}
...
void func_808F7FD0(EnBomChu *arg0, ? *arg1, Vec3f *arg2) {
    f32 temp_f0;

    temp_f0 = arg1->unk0 + arg0->unk170;
    arg2->x = arg0->actor.world.pos.x + (arg0->unk164 * temp_f0) + (arg0->unk158 * arg1->unk4) + (arg0->unk14C * arg1->unk8);
    arg2->y = arg0->actor.world.pos.y + (arg0->unk168 * temp_f0) + (arg0->unk15C * arg1->unk4) + (arg0->unk150 * arg1->unk8);
    arg2->z = arg0->actor.world.pos.z + (arg0->unk16C * temp_f0) + (arg0->unk160 * arg1->unk4) + (arg0->unk154 * arg1->unk8);
}
...
void func_808F8080(EnBomChu *arg0, GlobalContext *arg1, f32 arg2, s32 arg3) {
    ...
    if (arg3 != 0) {
        ...
        sp20 -= arg0->unk14C * 10.0f;
        sp28 -= arg0->unk154 * 10.0f;
    }
    sp24 += 5.0f;
...
void func_808F818C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp38 = 0x32;
    sp30 = temp_a1;
    Math_Vec3f_Copy(&sp74, temp_a1);
    Math_Vec3f_Copy(&sp50, arg0 + 0x158);
    ...
    if (temp_a3 != temp_v1) {
        ...
        temp_f14 = arg0->unk154;
        temp_f2 = arg0->unk14C;
        temp_f16 = arg0->unk160;
        temp_f10 = temp_f14 * temp_f0;
        temp_f14_2 = arg0->unk16C;
        temp_f18 = sp48 * temp_f2;
        temp_f2_2 = arg0->unk158;
        arg0->unk14C = (f32) ((temp_f14 * sp48) + (temp_f0 * temp_f2));
        arg0->unk154 = (f32) (temp_f10 - temp_f18);
        temp_f4 = sp48 * temp_f2_2;
        temp_f2_3 = arg0->unk164;
        arg0->unk158 = (f32) ((temp_f16 * sp48) + (temp_f0 * temp_f2_2));
        arg0->unk160 = (f32) ((temp_f16 * temp_f0) - temp_f4);
        temp_f6 = sp48 * temp_f2_3;
        arg0->unk164 = (f32) ((temp_f14_2 * sp48) + (temp_f0 * temp_f2_3));
        arg0->unk16C = (f32) ((temp_f14_2 * temp_f0) - temp_f6);
    }
    temp_a1_2 = &sp68;
    temp_a2 = &sp5C;
    sp68 = (2.0f * sp50.x) + sp74.x;
    sp6C = (2.0f * sp50.y) + sp74.y;
    sp70 = (2.0f * sp50.z) + sp74.z;
    sp5C = arg0->world.pos.x + (2.0f * arg0->unk158);
    sp60 = arg0->world.pos.y + (2.0f * arg0->unk15C);
    sp64 = arg0->world.pos.z + (2.0f * arg0->unk160);
    if (func_808F7944(arg1, (Vec3f *) temp_a1_2, (Vec3f *) temp_a2, &sp74, &sp3C, &sp38) != 0) {
        sp34 = func_808F75D0((EnBomChu *) arg0, sp3C, arg1);
        Math_Vec3f_Copy(sp30, &sp74);
...
void EnBomChu_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.floorBgId != 0x32) {
        func_808F818C(&this->actor, globalCtx);
    }
    if (this->unk148 != 0) {
        this->unk14A += -1;
    }
    ...
    temp_a2 = &this->unk188;
    this->unk188.dim.worldSphere.center.x = (s16) (s32) this->actor.world.pos.x;
    this->unk188.dim.worldSphere.center.y = (s16) (s32) this->actor.world.pos.y;
    this->unk188.dim.worldSphere.center.z = (s16) (s32) this->actor.world.pos.z;
    sp2C = temp_a2;
    sp30 = temp_a1;
    ...
    this->actor.focus.pos.x = this->actor.world.pos.x + (20.0f * this->unk158);
    this->actor.focus.pos.y = this->actor.world.pos.y + (20.0f * this->unk15C);
    this->actor.focus.pos.z = this->actor.world.pos.z + (20.0f * this->unk160);
    if (this->unk149 != 0) {
        sp30 = (CollisionCheckContext *) &globalCtx->colCtx;
        sp38 = Rand_ZeroOne();
        this->unk170 = Math_SinS((s16) (((s32) (Rand_ZeroOne() * 512.0f) + 0x3000) * this->unk14A)) * (5.0f + (sp38 * 3.0f));
        func_808F7FD0(this, &D_808F8938, &sp54);
        func_808F7FD0(this, &D_808F8944, &sp48);
        func_800A81F0(Effect_GetParams(this->unk180), &sp54, &sp48);
        func_808F7FD0(this, &D_808F8950, &sp48);
        func_800A81F0(Effect_GetParams(this->unk184), &sp54, &sp48);
        temp_t6 = &sp40;
        ...
        if (func_800CA1AC(globalCtx, (CollisionContext *) sp30, this->actor.world.pos.x, this->actor.world.pos.z, temp_t6, &sp44) != 0) {
            ...
            if (((this->actor.bgCheckFlags & 0x20) == 0) && (this->unk14A != 0x78)) {
                func_808F8080(this, globalCtx, sp40, 1);
            } else {
...
void EnBomChu_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SysMatrix_InsertTranslation(this->unk170 * 100.0f, 0.0f, 0.0f, 1);
