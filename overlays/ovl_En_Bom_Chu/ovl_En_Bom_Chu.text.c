typedef struct EnBomChu {
    ...
    /* 0x184 */ s32 unk184;                         /* inferred */
    /* 0x188 */ ColliderSphere unk188;              /* inferred */
} EnBomChu;                                         /* size = 0x1E0 */
...
void EnBomChu_Init(EnBomChu *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk188, (Actor *) this, &D_808F88E0);
...
void func_808F7FD0(EnBomChu *arg0, ? *arg1, ? *arg2) {
    ...
    arg2->unk0 = (f32) (arg0->actor.world.pos.x + (arg0->unk164 * temp_f0) + (arg0->unk158 * arg1->unk4) + (arg0->unk14C * arg1->unk8));
    arg2->unk4 = (f32) (arg0->actor.world.pos.y + (arg0->unk168 * temp_f0) + (arg0->unk15C * arg1->unk4) + (arg0->unk150 * arg1->unk8));
    arg2->unk8 = (f32) (arg0->actor.world.pos.z + (arg0->unk16C * temp_f0) + (arg0->unk160 * arg1->unk4) + (arg0->unk154 * arg1->unk8));
}
...
void EnBomChu_Update(EnBomChu *this, GlobalContext *globalCtx) {
    ...
    if (this->unk149 != 0) {
        ...
        func_800A81F0(Effect_GetParams(this->unk180), (Vec3f *) &sp54, (Vec3f *) &sp48);
        func_808F7FD0(this, &D_808F8950, &sp48);
        func_800A81F0(Effect_GetParams(this->unk184), (Vec3f *) &sp54, (Vec3f *) &sp48);
        temp_t6 = &sp40;
