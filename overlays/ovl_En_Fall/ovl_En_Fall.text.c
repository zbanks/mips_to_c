...
void EnFall_Init(EnFall *this, GlobalContext *globalCtx) {
    s32 temp_t8;
    s32 temp_v0;
    s32 phi_v0;
...
void EnFall_Destroy(EnFall *this, GlobalContext *globalCtx) {
    EnFall *this = (EnFall *) thisx;
...
void func_80A6C3FC(EnFall *this, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&temp_a2->objectCtx, (s32) this->unk148) != 0) {
        ...
        case 1:
            ...
            Actor_SetScale((Actor *) this, this->unk14C);
            return;
        case 7:
            this->actor.draw = func_80A6D88C;
            this->actionFunc = func_80A6CB74;
            Actor_SetScale((Actor *) this, this->unk14C * 3.0f);
        ...
        case 2:
            this->actor.draw = func_80A6D88C;
            Actor_SetScale((Actor *) this, this->unk14C * 5.3999996f);
...
void func_80A6CD74(EnFall *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x85U) != 0) {
        ...
        Actor_SetScale((Actor *) this, this->unk14C * 3.6f);
        this->actor.draw = func_80A6D88C;
        if ((func_800EE29C(globalCtx, 0x85U) != 0) && (globalCtx->csCtx.npcActions[func_800EE200(globalCtx, 0x85U)]->unk0 == 2)) {
            func_800EDF24((Actor *) this, globalCtx, func_800EE200(globalCtx, 0x85U));
            return;
...
void EnFall_Update(EnFall *this, GlobalContext *globalCtx) {
    EnFall *this = (EnFall *) thisx;
