...
void func_80A6D88C(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6D98C(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6DA7C(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6DC20(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6DC40(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6DD3C(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6E07C(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6E214(Actor *arg0, GlobalContext *arg1); /* static */
void func_80A6E37C(Actor *arg0, GlobalContext *arg1); /* static */
extern ? D_06000198;
extern ? D_06000400;
...
static u8 D_80A6E990;
static s8 D_80A6E9B4;
static ? D_80A6E9D8;
static ? D_80A6F098;
...
typedef struct EnFall {
    ...
    /* 0x015C */ char pad15C[0x4];                  /* maybe part of unk158[2]? */
    /* 0x0160 */ void (*actionFunc)(EnFall *, GlobalContext *);
} EnFall;                                           /* size 0x164 */
    ...
    if (temp_hi != 0) {
        if (temp_hi != 1) {
            if (temp_hi != 2) {
                ...
                sp20 = phi_f0;
                Actor_SetScale(arg0, arg0->unk14C * 3.6f);
                if (((s32) (arg0->params & 0xF80) >> 7) == 0xC) {
                    arg0->world.pos.y = arg0->home.pos.y + (phi_f0 * 6700.0f * (arg0->unk14C * 6.25f));
                    return;
                }
                phi_f10 = arg0->home.pos.y - (phi_f0 * 6700.0f * (arg0->unk14C * 6.25f));
                goto block_14;
            }
            Actor_SetScale(arg0, arg0->unk14C * 3.6f);
        ...
        Actor_SetScale(arg0, arg0->unk14C * 2.4f);
        phi_f10 = arg0->home.pos.y;
block_14:
        arg0->world.pos.y = phi_f10;
        return;
    }
    Actor_SetScale(arg0, arg0->unk14C * 1.2f);
    arg0->world.pos.y = arg0->home.pos.y;
}
...
void func_80A6C3FC(EnFall *this, GlobalContext *globalCtx) {
    ...
    temp_a2 = globalCtx;
    globalCtx = temp_a2;
    if (Object_IsLoaded(&temp_a2->objectCtx, (s32) this->unk148) != 0) {
        temp_t0 = (s32) (this->actor.params & 0xF80) >> 7;
        this->actionFunc = func_80A6CD74;
        this->actor.objBankIndex = (s8) this->unk148;
        switch (temp_t0) {
        case 1:
        ...
        case 7:
            ...
            Actor_SetScale(&this->actor, this->unk14C * 3.0f);
        ...
        case 2:
            this->actor.draw = func_80A6D88C;
            Actor_SetScale(&this->actor, this->unk14C * 5.3999996f);
        ...
        case 5:
            ...
            this->unk144 = 0x4000;
            this->unk146 = (u16) ((s32) gSaveContext.day % 5);
            func_80A6BF90(&this->actor, globalCtx, globalCtx);
            return;
        case 6:
        case 12:
...
void func_80A6C9A8(EnFall *this, GlobalContext *globalCtx) {
    func_80A6C7C0(&this->actor, globalCtx);
    if (func_800EE29C(globalCtx, 0x85U) != 0) {
        ...
        if ((func_800EE29C(globalCtx, 0x85U) != 0) && (globalCtx->csCtx.npcActions[func_800EE200(globalCtx, 0x85U)]->unk0 == 2)) {
            func_800EDF24(&this->actor, globalCtx, func_800EE200(globalCtx, 0x85U));
            return;
        }
...
void func_80A6CA9C(EnFall *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x85U) != 0) {
        ...
        if (this->unk150 == 0.0f) {
            Audio_PlayActorSound2(&this->actor, 0x299CU);
        }
        this->unk150 += 0.033333335f;
        if (this->unk150 > 1.0f) {
            this->unk150 = 1.0f;
            return;
        }
            ...
            if (temp_v0 != 0x231) {
                if (temp_v0 != 0x24E) {
                    if (temp_v0 != 0x2E1) {
                        ...
                        Audio_PlayActorSound2(&this->actor, 0x299DU);
                        goto block_28;
                    }
                } else {
                    Audio_PlayActorSound2(&this->actor, 0x28B5U);
                    goto block_28;
                }
            } else {
                Audio_PlayActorSound2(&this->actor, 0x3ABFU);
block_28:
            }
            if ((s32) globalCtx->csCtx.frames >= 0x28A) {
                func_800B9010(&this->actor, 0x219EU);
            }
...
void func_80A6CD38(EnFall *this, GlobalContext *globalCtx) {
    if ((globalCtx->csCtx.state != 0) && (globalCtx->sceneNum == 0x19)) {
        func_800B9010(&this->actor, 0x2129U);
    }
}
...
void func_80A6CD74(EnFall *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x85U) != 0) {
        ...
        Actor_SetScale(&this->actor, this->unk14C * 3.6f);
        this->actor.draw = func_80A6D88C;
        if ((func_800EE29C(globalCtx, 0x85U) != 0) && (globalCtx->csCtx.npcActions[func_800EE200(globalCtx, 0x85U)]->unk0 == 2)) {
            func_800EDF24(&this->actor, globalCtx, func_800EE200(globalCtx, 0x85U));
            return;
    ...
    if (temp_v0 != this->unk146) {
        this->unk146 = temp_v0;
        this->unk144 = gSaveContext.time;
    }
    func_80A6BF90(&this->actor, globalCtx);
}
...
void func_80A6CF70(EnFall *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.draw != 0) {
        if (Math_Vec3f_StepTo(&this->actor.world.pos, &this->actor.home.pos, this->actor.speedXZ) <= 0.0f) {
            Audio_PlayActorSound2(&this->actor, 0x2962U);
            ...
            sp44 = temp_a0;
            Actor_SpawnAsChild(temp_a0, &this->actor, globalCtx, 1, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, -2);
        ...
        func_800B9010(&this->actor, 0x2186U);
        // Duplicate return node #8. Try simplifying control flow for better match
    }
}
...
void func_80A6D100(f32 arg0) {
    ...
    temp_v0->unkF = (u8) temp_a1[D_80A6E4B4];
    phi_a0 = &D_80A6E4B5;
    phi_v1 = temp_v0 + 0x10;
    do {
        temp_a0 = phi_a0 + 4;
...
void func_80A6D220(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(temp_a0, 0x1C2U) != 0) {
        ...
        if ((thisx->unk154 & 1) != 0) {
            thisx->unk150 = (f32) (thisx->unk150 + 0.01f);
            if (thisx->unk150 > 1.0f) {
                thisx->unk150 = 1.0f;
            }
        }
        ...
        if (temp_v1 != 2) {
            if (temp_v1 != 3) {
                if (temp_v1 != 4) {
                    ...
                    thisx->unk154 = (u16) (thisx->unk154 | 1);
                }
            } else {
                temp_v0 = thisx->unk158;
                temp_t8 = temp_v0 - 2;
                phi_v0 = temp_v0;
                if (temp_v0 > 0) {
                    thisx->unk158 = temp_t8;
                    phi_v0 = temp_t8;
                }
                phi_v0_2 = phi_v0;
                if (phi_v0 < 0) {
            ...
            temp_v0_2 = thisx->unk158;
            temp_t6 = temp_v0_2 + 4;
            phi_v0_3 = temp_v0_2;
            if (temp_v0_2 < 0x64) {
                thisx->unk158 = temp_t6;
                phi_v0_3 = temp_t6;
            }
            phi_v0_4 = phi_v0_3;
            if (phi_v0_3 >= 0x65) {
    ...
    if ((func_800EE29C(globalCtx, 0x1C2U) != 0) && (thisx->unk158 > 0)) {
        func_8019F128(0x214FU);
    }
    Actor_SetScale(thisx, thisx->unk14C * 1.74f);
}
...
void func_80A6D444(Actor *arg0) {
    ...
    phi_v1 = &D_80A6E990;
    do {
        if ((s32) phi_v1->unk0 < 3) {
            phi_v1->unk4 = (f32) (phi_v1->unk4 + phi_v1->unk10);
            phi_v1->unk8 = (f32) (phi_v1->unk8 + phi_v1->unk14);
            phi_v1->unkC = (f32) (phi_v1->unkC + phi_v1->unk18);
            phi_v1->unk1C = (s16) (phi_v1->unk1C + 0x64);
            phi_v1->unk1E = (s16) (phi_v1->unk1E + 0xC8);
            phi_v1->unk20 = (s16) (phi_v1->unk20 + 0x12C);
            if ((arg0->world.pos.y + 3000.0f) < phi_v1->unk8) {
                phi_v1->unk0 = 3;
                arg0->unk158 = (s32) (arg0->unk158 - 1);
            }
        }
        temp_v1 = phi_v1 + 0x24;
        phi_v1 = temp_v1;
...
? func_80A6D504(Actor *arg0) {
    ...
    phi_s0 = &D_80A6E990;
loop_1:
    if ((s32) phi_s0->unk0 >= 3) {
        phi_s0->unk0 = (u8) (s32) Rand_ZeroFloat(3.0f);
        phi_s0->unk4 = (f32) arg0->world.pos.x;
        phi_s0->unk8 = (f32) arg0->world.pos.y;
        phi_s0->unkC = (f32) arg0->world.pos.z;
        sp2E = (s16) (s32) randPlusMinusPoint5Scaled(65536.0f);
        sp20 = Rand_ZeroFloat(1.0f);
        temp_f16 = (1.0f - (Rand_ZeroFloat(1.0f) * sp20)) * 3000.0f;
        sp24 = temp_f16;
        phi_s0->unk4 = (f32) (phi_s0->unk4 + (Math_SinS(sp2E) * sp24));
        temp_f18 = Math_CosS(sp2E) * temp_f16;
        phi_s0->unk10 = 0.0f;
        phi_s0->unk18 = 0.0f;
        phi_s0->unk14 = 80.0f;
        phi_s0->unkC = (f32) (phi_s0->unkC + temp_f18);
        phi_s0->unk1C = (s16) (s32) randPlusMinusPoint5Scaled(65536.0f);
        phi_s0->unk1E = (s16) (s32) randPlusMinusPoint5Scaled(65536.0f);
        phi_s0->unk20 = (s16) (s32) randPlusMinusPoint5Scaled(65536.0f);
        arg0->unk158 = (s32) (arg0->unk158 + 1);
        return 1;
    }
    temp_s0 = phi_s0 + 0x24;
...
void func_80A6D75C(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_800EE29C(globalCtx, 0x1C2U) != 0) && (globalCtx->csCtx.npcActions[func_800EE200(globalCtx, 0x1C2U)]->unk0 == 5)) {
        ...
        thisx->unk154 = (u16) (thisx->unk154 | 2);
    }
    if ((thisx->unk154 & 2) != 0) {
        thisx->unk150 = (f32) (thisx->unk150 + 0.033333335f);
        if (thisx->unk150 > 1.0f) {
            thisx->unk150 = 1.0f;
        }
        ...
        temp_v0 = thisx->unk15C;
        thisx->scale.y = Math_SinS(thisx->unk15C) * 5.0f;
        if ((s32) temp_v0 < 0x4000) {
            thisx->unk15C = (s16) (temp_v0 + 0x147);
        }
    }
}
...
void func_80A6D88C(Actor *this, GlobalContext *globalCtx) {
    ...
    SysMatrix_MultiplyVector3fByState(&D_80A6E588, &this->focus.pos);
    temp_v0_2 = temp_s0->polyOpa.p;
    temp_v1 = (s32) ((this->unk150 * 200.0f) + 40.0f) & 0xFF;
...
void func_80A6DA7C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = (s32) ((arg0->unk150 * 200.0f) + 40.0f) & 0xFF;
...
void func_80A6DD3C(Actor *this, GlobalContext *globalCtx) {
    ...
    temp_f0 = this->unk150;
    this->unk15C = (s16) (this->unk15C + (s32) (4.0f + (temp_f0 * 12.0f)));
    this->unk15E = (s16) (this->unk15E + (s32) (2.0f + (temp_f0 * 6.0f)));
    temp_v0_2 = temp_s0->polyXlu.p;
    temp_s0->polyXlu.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xFA000080;
    temp_f0_2 = this->unk150;
    ...
    sp48 = temp_t0;
    sp5C = temp_v0_4;
    sp5C->words.w1 = Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, sp74, (u32) -(s32) this->unk15E, 0x40, 0x40, 1, (u32) temp_t0, (u32) -(s32) this->unk15C, 0x40, 0x40);
    temp_v0_5 = temp_s0->polyXlu.p;
    temp_s0->polyXlu.p = temp_v0_5 + 8;
    temp_v0_5->words.w0 = 0xDB060028;
    temp_a3 = -(s32) this->unk15C;
    sp58 = temp_v0_5;
...
void func_80A6E07C(Actor *this, GlobalContext *globalCtx) {
    ...
    do {
        if ((s32) phi_s0->unk0 < 3) {
            ...
            SysMatrix_InsertRotation(phi_s0->unk1C, phi_s0->unk1E, phi_s0->unk20, 1);
            ...
            temp_v0_5->words.w0 = 0xDE000000;
            temp_v0_5->words.w1 = *(&D_80A6E594 + (phi_s0->unk0 * 4));
        }
        temp_s0 = phi_s0 + 0x24;
        phi_s0 = temp_s0;
...
void func_80A6E214(Actor *this, GlobalContext *globalCtx) {
    ...
    if (!(temp_f0 <= 0.0f)) {
        ...
        temp_s0->polyXlu.p = temp_v0_4 + 8;
        temp_v0_4->words.w0 = 0xFA000080;
        temp_v0_4->words.w1 = ((s32) (this->unk150 * 255.0f) & 0xFF) | ~0xFF;
        temp_v0_5 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = temp_v0_5 + 8;
