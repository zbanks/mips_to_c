...
void func_80ADF338(EnTakaraya *arg0, GlobalContext *arg1); /* static */
void func_80ADF4E0(EnTakaraya *arg0);               /* static */
...
static void *D_80ADFB00 = {(void *)0x6006F58, (void *)0x6007358, (void *)0x6007758, (void *)0x6007358};
static void *D_80ADFB10 = {(void *)0x6007B58, (void *)0x6007F58, (void *)0x6007758, (void *)0x6007F58};
static InitChainEntry D_80ADFB20;                   /* unable to generate initializer */
...
typedef struct EnTakaraya {
    ...
    /* 0x02A8 */ void (*actionFunc)(EnTakaraya *, GlobalContext *);
    /* 0x02AC */ u8 unk2AC;                         /* inferred */
    /* 0x02AD */ u8 unk2AD;                         /* inferred */
...
void EnTakaraya_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk144, &D_06008FC8, &D_06009890, &this->unk188, &this->unk218, 0x18);
    this->unk2B2 = ((s32) this->actor.params >> 8) & 0xFF;
...
void func_80ADEE4C(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Actor_IsActorFacingLink(arg0, 0x2000) != 0) {
        ...
        arg0->unk2B0 = (s16) (gSaveContext.playerForm + arg0->unk2B2);
...
void func_80ADEF74(EnTakaraya *arg0, GlobalContext *arg1) {
    ...
    if (Flags_GetSwitch(arg1, (s32) arg0->unk2B0) != 0) {
    ...
    if ((temp_v1 == 4) && (func_80147624(arg1) != 0)) {
        if (arg1->msgCtx.choiceIndex == 0) {
            if ((s32) gSaveContext.rupees < arg1->msgCtx.unk1206C) {
                ...
                if (&D_06009890 == arg0->unk144.animCurrentSeg) {
...
void func_80ADF520(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_801690CC(arg1) == 0) {
        if (Actor_GetChestFlag(arg1, (u32) arg0->params) != 0) {
            Actor_SetSwitchFlag(arg1, (s32) arg0->unk2B0);
...
void EnTakaraya_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_800E9250(globalCtx, &this->actor, &this->unk2B4, &sp30, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    func_80ADED8C(this);
}
...
void func_80ADF984(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    if (arg1 == 5) {
        Matrix_RotateY((s16) (0x400 - arg2->unk2B4), 1U);
...
void EnTakaraya_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 3) || (temp_v0 == 4)) {
        ...
        temp_v1_2->words.w1 = (u32) (&D_80ADFB10)[this->unk2AC];
    } else {
        temp_v1 = sp30->polyOpa.p;
        sp30->polyOpa.p = temp_v1 + 8;
        temp_v1->words.w0 = 0xDB060020;
        temp_v1->words.w1 = (u32) (&D_80ADFB00)[this->unk2AC];
    }
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80ADF94C, NULL, func_80ADF984, &this->actor);
}
