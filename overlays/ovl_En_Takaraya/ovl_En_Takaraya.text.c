typedef struct EnTakaraya {
    ...
    /* 0x2AE */ char pad2AE[0x4];                   /* maybe part of unk2AD[5]? */
...
void EnTakaraya_Init(EnTakaraya *this, GlobalContext *globalCtx) {
    u8 temp_t4;
    u8 temp_v0;
    void **temp_s0;
    void **phi_s1;
...
void EnTakaraya_Destroy(EnTakaraya *this, GlobalContext *globalCtx) {
    EnTakaraya *this = (EnTakaraya *) thisx;
...
void EnTakaraya_Update(EnTakaraya *this, GlobalContext *globalCtx) {
    ? sp30;
    EnTakaraya *this = (EnTakaraya *) thisx;

    this->actionFunc(this, globalCtx);
    func_800E9250(globalCtx, (Actor *) this, &this->unk2B4, (Vec3s *) &sp30, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    func_80ADED8C(this);
}
...
void EnTakaraya_Draw(EnTakaraya *this, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80ADF94C, NULL, func_80ADF984, (Actor *) this);
}
