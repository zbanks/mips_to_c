...
s32 func_80BD4E44(BgIkanaBombwall *arg0, BgIkanaBombwall *); /* static */
s32 func_80BD4EAC(BgIkanaBombwall *arg0, BgIkanaBombwall *); /* static */
void func_80BD4F18(BgIkanaBombwall *arg0);          /* static */
void func_80BD4F2C(BgIkanaBombwall *arg0, GlobalContext *arg1); /* static */
void func_80BD4F88(BgIkanaBombwall *arg0);          /* static */
void func_80BD4F9C(BgIkanaBombwall *arg0, GlobalContext *arg1); /* static */
void func_80BD4FF8(BgIkanaBombwall *arg0);          /* static */
...
static InitChainEntry D_80BD52D0;                   /* unable to generate initializer */
...
typedef struct BgIkanaBombwall {
    ...
    /* 0x01A8 */ void (*actionFunc)(BgIkanaBombwall *, GlobalContext *);
...
void func_80BD4720(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        phi_s0_2 = 0x40;
        if (temp_s1 == 0) {
            func_800BBFB0(arg1, temp_a1, 50.0f, 2, (s16) 0x64, (s16) 0x78, (u8) 1);
            phi_s0_2 = 0x20;
        }
        phi_s0 = phi_s0_2;
        if ((phi_s2 & 1) != 0) {
        ...
        EffectSsKakera_Spawn(arg1, temp_s3, &spD4, temp_s3, (s16) phi_v1, (s16) phi_s0, (s16) 0x1E, (s16) 0, (s16) 0, (s16) (s32) temp_v0, (s16) phi_t0, (s16) 0, 0x32, (s16) -1, (s16) 0x203, &D_06000288);
        temp_s2 = phi_s2 + 1;
        phi_s2 = temp_s2;
    } while (temp_s2 != 0x1E);
    SysMatrix_StatePop();
...
void BgIkanaBombwall_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80BD52D0);
    ...
    Collider_SetCylinder(globalCtx, sp20, &this->actor, phi_a3);
