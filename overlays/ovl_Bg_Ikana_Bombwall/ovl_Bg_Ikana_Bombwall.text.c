...
s32 func_80BD4E44(void *arg0) {
    ...
    if (((arg0->unk_16D & 2) != 0) && (temp_v0 = arg0->unk_164, (temp_v0 != 0)) && (Math3D_DistanceSquared(arg0 + 0x24, temp_v0 + 0x24) < 5625.0f)) {
        return 1;
    }
    return 0;
}
...
void func_80BD5118(Actor *arg0) {
    arg0->unk_1AC = 0x1E;
    arg0[1].velocity.x = func_80BD5134;
}
