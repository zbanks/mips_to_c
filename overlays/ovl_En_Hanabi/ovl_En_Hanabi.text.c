...
void func_80B235CC(Actor *arg0, Vec3f *arg1, s32 arg2); /* static */
void func_80B236C8(Actor *arg0, GlobalContext *arg1, GlobalContext *); /* static */
void func_80B23A38(Actor *arg0, GraphicsContext **arg1); /* static */
...
typedef struct EnHanabi {
    ...
    /* 0x0149 */ char pad149[0x44BF];
    /* 0x4608 */ LightInfo unk4608;                 /* inferred */
    /* 0x4616 */ char pad4616[0x1A];
    /* 0x4630 */ LightNode *unk4630;                /* inferred */
    /* 0x4634 */ LightNode *unk4634;                /* inferred */
    /* 0x4638 */ char pad4638[0x1C];                /* maybe part of unk4634[8]? */
...
void func_80B235CC(Actor *arg0, Vec3f *arg1, s32 arg2) {
    Actor *sp28;
    s32 temp_v0;
    void *temp_t0;
    Actor *phi_v1;
...
loop_1:
    if (phi_v1->unk4640 == 0) {
        ...
        sp28 = phi_v1;
        Lights_PointNoGlowSetInfo(arg0 + (phi_v0 * 0xE) + 0x4608, (s16) (s32) arg1->x, (s16) (s32) arg1->y, (s16) (s32) arg1->z, (u8) (s32) temp_t0->unk0, (u8) (s32) temp_t0->unk1, (u8) (s32) temp_t0->unk2, (s16) 0x3E8);
        phi_v1->unk4640 = 0x14;
        return;
    }
    temp_v0 = phi_v0 + 1;
...
void func_80B236C8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->home.rot.x != 0) {
        ...
        sp34.x += sp30 * Math_SinS(arg0->home.rot.y);
        sp34.y += randPlusMinusPoint5Scaled(300.0f);
        sp34.z += sp30 * Math_CosS(arg0->home.rot.y);
        if ((s32) arg0->home.rot.x >= 0x259) {
            phi_v0 = func_80B22C80(&sp34, arg0 + 0x148, 2.0f);
        } else {
            phi_v0 = func_80B22C80(&sp34, arg0 + 0x148, 1.0f);
        }
        sp28 = phi_v0;
...
void func_80B23934(EnHanabi *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.entranceIndex == 0x5410) && (gSaveContext.sceneSetupIndex == 7)) {
        ...
        if ((s32) temp_a2->csCtx.frames >= 0x673) {
            globalCtx = temp_a2;
            func_80B236C8(&this->actor, temp_a1, temp_a2);
            func_800B8FE8(&this->actor, 0x21B9U);
            phi_a2 = globalCtx;
        }
    }
    if ((phi_a2->sceneNum == 0x2D) && (gSaveContext.sceneSetupIndex == 7) && (phi_a2->csCtx.unk_12 == 0) && (phi_a2->csCtx.frames == 0x262)) {
        Audio_PlayActorSound2(&this->actor, 0x29B4U);
    }
}
