typedef struct EnHanabi {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ s16 unk_144;                       /* inferred */
    /* 0x0146 */ char pad_146[0x2];
    /* 0x0148 */ ? unk_148;                         /* inferred */
    /* 0x0148 */ char pad_148[0x44C0];
    /* 0x4608 */ LightInfo unk_4608;                /* inferred */
    /* 0x4616 */ char pad_4616[0x3E];               /* maybe part of unk_4608[5]? */
...
void func_80B22C2C(void *arg0, s32 arg1) {
    arg0->unk_1 = (s8) ((s32) Rand_ZeroFloat(20.0f) + 0x3C);
    arg0->unk_2 = (s8) arg1;
    arg0->unk_14 = 0.7f;
}
...
loop_1:
    phi_s3 = phi_s3_2;
    if ((s32) phi_s0->unk_0 <= 0) {
        phi_s0->unk_0 = 1U;
        Math_Vec3f_Copy(phi_s0 + 8, arg0);
        phi_s0->unk_20 = (f32) ((f32) phi_s1->unk_0 * temp_f22);
        phi_s0->unk_24 = (f32) (((f32) phi_s1->unk_2 * temp_f22) + 50.0f);
        phi_s0->unk_4 = (f32) (1.5f * arg2);
        phi_s0->unk_28 = (f32) ((f32) phi_s1->unk_4 * temp_f22);
...
void func_80B22E0C(? *arg0) {
    ...
    do {
        if (phi_s0->unk_0 == 1) {
            ...
            temp_f18 = phi_s0->unk_20;
            temp_f10 = phi_s0->unk_28;
            phi_s0->unk_24 = (f32) (temp_f12 * temp_f0);
            phi_s0->unk_8 = (f32) (phi_s0->unk_8 + temp_f18);
            phi_s0->unk_10 = (f32) (phi_s0->unk_10 + temp_f10);
            phi_s0->unk_C = (f32) (phi_s0->unk_C + temp_f12);
            phi_s0->unk_20 = (f32) (temp_f18 * temp_f0);
            phi_s0->unk_28 = (f32) (temp_f10 * temp_f0);
            phi_s0->unk_24 = (f32) (phi_s0->unk_24 - 1.0f);
            phi_s0->unk_20 = (f32) (phi_s0->unk_20 + randPlusMinusPoint5Scaled(0.8f));
            phi_s0->unk_24 = (f32) (phi_s0->unk_24 + randPlusMinusPoint5Scaled(0.8f));
            temp_v0 = phi_s0->unk_1;
            phi_s0->unk_28 = (f32) (phi_s0->unk_28 + randPlusMinusPoint5Scaled(0.8f));
            if ((s32) temp_v0 > 0) {
                phi_s0->unk_1 = (u8) (temp_v0 - 1);
            } else {
                phi_s0->unk_0 = 0U;
            }
        }
    ...
    do {
        if (phi_s0->unk_0 == 1) {
            ...
            if (phi_s0->unk_2 != sp53) {
                ...
                temp_v1 = phi_s0->unk_2;
                temp_a1 = temp_v1 + &D_80B23C40;
                temp_v0_6->words.w1 = (temp_a1->unk_2 << 8) | (*(temp_v1 + &D_80B23C40) << 0x18) | (temp_a1->unk_1 << 0x10) | 0xFF;
                sp53 = phi_s0->unk_2;
            }
            if ((s32) phi_s0->unk_1 < 6) {
                temp_v0_7 = temp_s2->polyXlu.p;
                temp_s2->polyXlu.p = temp_v0_7 + 8;
                temp_v0_7->words.w0 = 0xFA000000;
                temp_v1_2 = phi_s0->unk_2;
                temp_a1_2 = &D_80B23C2C + temp_v1_2;
                temp_v0_7->words.w1 = (temp_a1_2->unk_2 << 8) | (*(&D_80B23C2C + temp_v1_2) << 0x18) | (temp_a1_2->unk_1 << 0x10) | ((phi_s0->unk_1 * 0x32) & 0xFF);
            } else {
                temp_v0_8 = temp_s2->polyXlu.p;
                temp_s2->polyXlu.p = temp_v0_8 + 8;
                temp_v0_8->words.w0 = 0xFA000000;
                temp_v1_3 = phi_s0->unk_2;
                temp_a1_3 = &D_80B23C2C + temp_v1_3;
                temp_v0_8->words.w1 = (temp_a1_3->unk_2 << 8) | (*(&D_80B23C2C + temp_v1_3) << 0x18) | (temp_a1_3->unk_1 << 0x10) | 0xFF;
            }
...
void EnHanabi_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    do {
        ...
        temp_s2 = phi_s2 + 0xE;
        temp_s3 = phi_s3 + 4;
        temp_s3->unk_4630 = LightContext_InsertLight(globalCtx, temp_s5, phi_s0);
        phi_s0 += 0xE;
        phi_s3 = temp_s3;
        phi_s2 = temp_s2;
    } while (temp_s2 != 0x2A);
...
void EnHanabi_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    phi_s0 = 0;
    do {
        LightContext_RemoveLight(globalCtx, &globalCtx->lightCtx, phi_s1->unk_4634);
        temp_s0 = phi_s0 + 4;
        phi_s1 += 4;
        phi_s0 = temp_s0;
    } while (temp_s0 != 0xC);
...
void func_80B234C8(Actor *arg0) {
    ...
    phi_s0 = 0;
    do {
        temp_v0 = phi_s1->unk_4640;
        if ((s32) temp_v0 > 0) {
            phi_s1->unk_4640 = (s16) (temp_v0 - 1);
            temp_v0_2 = phi_s1->unk_4640;
            if (temp_v0_2 == 0) {
                phi_v1 = -1;
            } else {
            ...
            temp_v0_3 = &D_80B23C2C + (arg0 + (phi_s0 * 4))->unk_4648;
            Lights_PointSetColorAndRadius(arg0 + (phi_s0 * 0xE) + 0x4608, temp_v0_3->unk_0, temp_v0_3->unk_1, temp_v0_3->unk_2, (s16) phi_v1);
        }
        temp_s0 = phi_s0 + 1;
        phi_s1 += 2;
        phi_s0 = temp_s0;
...
void func_80B235CC(Actor *arg0, f32 *arg1, s32 arg2) {
    ...
    phi_v0 = 0;
loop_1:
    if (phi_v1->unk_4640 == 0) {
        (arg0 + (phi_v0 * 4))->unk_4648 = arg2;
        temp_t0 = arg2 + &D_80B23C2C;
        sp28 = phi_v1;
        Lights_PointNoGlowSetInfo(arg0 + (phi_v0 * 0xE) + 0x4608, (s16) (s32) arg1->unk_0, (s16) (s32) arg1->unk_4, (s16) (s32) arg1->unk_8, (u8) (s32) temp_t0->unk_0, (u8) (s32) temp_t0->unk_1, (u8) (s32) temp_t0->unk_2, (s16) 0x3E8);
        phi_v1->unk_4640 = 0x14;
        return;
    }
    temp_v0 = phi_v0 + 1;
    phi_v1 += 2;
...
void func_80B236C8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->home.rot.x != 0) {
        ...
        arg0->unk_144 = (s16) ((s32) Rand_ZeroFloat(5.0f) + 0x14);
