s32 func_80B83C80(Vec3f *arg0, Vec3f *arg1, BgDblueWaterfall *); /* static */
...
static InitChainEntry D_80B853A8;                   /* unable to generate initializer */

typedef struct BgDblueWaterfall {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ ColliderCylinder unk144;           /* inferred */
    /* 0x0190 */ void *unk190;                      /* inferred */
    /* 0x0194 */ void (*actionFunc)(BgDblueWaterfall *, GlobalContext *);
    /* 0x0198 */ f32 unk198;                        /* inferred */
    /* 0x019C */ s16 unk19C;                        /* inferred */
    /* 0x019E */ u8 unk19E;                         /* inferred */
    /* 0x019F */ u8 unk19F;                         /* inferred */
    /* 0x01A0 */ u8 unk1A0;                         /* inferred */
    /* 0x01A1 */ char pad1A1[0x2];                  /* maybe part of unk1A0[3]? */
    /* 0x01A3 */ s8 unk1A3;                         /* inferred */
    /* 0x01A4 */ s16 unk1A4;                        /* inferred */
    /* 0x01A6 */ char pad1A6[0x1];
...
void func_80B83EA4(BgDblueWaterfall *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk144.info.bumperFlags & 2) != 0) {
        ...
        do {
            ...
            temp_f4_2 = ((2.0f * Rand_ZeroOne()) - 1.0f) + ((spA4.x * 3.0f) + (temp_f4 * 5.0f));
            spC8 = temp_f4_2;
            spCC = (Rand_ZeroOne() * 10.0f) + 5.0f;
            temp_f2_2 = ((2.0f * Rand_ZeroOne()) - 1.0f) + ((spA4.z * 3.0f) + (spA0 * 5.0f));
...
block_9:
    ...
    SysMatrix_GetStateTranslationAndScaledZ(arg0->unk1A8, &sp34);
    SysMatrix_StatePop();
    temp_s1->world.pos.x += sp34.x;
    temp_s1->world.pos.z += sp34.z;
    temp_s1->unkB80 = 8.0f;
...
void BgDblueWaterfall_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80B853A8);
    this->actor.shape.rot.z = 0;
    this->actor.world.rot.z = 0;
    temp_a1 = &this->unk144;
    sp24 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80B85370);
    Collider_UpdateCylinder(&this->actor, temp_a1);
    this->unk190 = Lib_SegmentedToVirtual(&D_0600B448);
    Actor_SetHeight(&this->actor, -100.0f);
    func_80B84568(&this->actor, globalCtx);
...
void func_80B84928(BgDblueWaterfall *this, GlobalContext *globalCtx) {
    ...
    if (phi_a2 == 0) {
        if (sp2C != 0) {
            ...
            func_80B841A0(&this->actor, globalCtx, phi_a2);
...
void func_80B84AEC(BgDblueWaterfall *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->unk1A4) != 0) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(this->unk1A4, &this->actor);
        this->unk1A3 = 1;
        if (sp20 != 0) {
