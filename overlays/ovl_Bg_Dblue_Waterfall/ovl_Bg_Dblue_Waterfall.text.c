typedef struct BgDblueWaterfall {
    ...
    /* 0x190 */ void *unk_190;                      /* inferred */
    /* 0x194 */ void (*actionFunc)(BgDblueWaterfall *, GlobalContext *);
    /* 0x198 */ f32 unk_198;                        /* inferred */
    /* 0x19C */ s16 unk_19C;                        /* inferred */
    /* 0x19E */ u8 unk_19E;                         /* inferred */
    /* 0x19F */ u8 unk_19F;                         /* inferred */
    /* 0x1A0 */ u8 unk_1A0;                         /* inferred */
    /* 0x1A1 */ char pad_1A1[0x2];                  /* maybe part of unk_1A0[3]? */
    /* 0x1A3 */ s8 unk_1A3;                         /* inferred */
    /* 0x1A4 */ s16 unk_1A4;                        /* inferred */
    /* 0x1A6 */ char pad_1A6[0x6];                  /* maybe part of unk_1A4[4]? */
...
void func_80B83EA4(BgDblueWaterfall *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_144.info.bumperFlags & 2) != 0) {
        temp_a0 = &sp98;
        temp_f0 = (f32) arg0->unk_144.info.bumper.hitPos.x;
        spB4 = (f32) arg0->unk_144.info.bumper.hitPos.y;
        sp9C = 0.0f;
        temp_f2 = (f32) arg0->unk_144.info.bumper.hitPos.z;
...
void func_80B841A0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_172 & 2) != 0) {
        temp_f22 = (f32) arg0->unk_16A;
        temp_f24 = (f32) arg0->unk_16C;
        temp_s5 = &sp94;
        temp_f26 = (f32) arg0->unk_16E;
        phi_s2 = 0;
        phi_s1 = 0;
        do {
...
void func_80B84610(BgDblueWaterfall *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk_1A7 <= 0) {
        arg0->unk_1A7 = 0x10;
    } else {
        arg0->unk_1A7 -= Rand_Next() >> 0x1F;
    }
    if ((s32) arg0->unk_1A7 >= 6) {
        arg0->unk_1A8 += Rand_ZeroOne() * 0.1f;
        if (arg0->unk_1A8 > 0.5f) {
            arg0->unk_1A8 = 0.5f;
        } else {
            goto block_9;
        }
    } else {
        arg0->unk_1A8 -= Rand_ZeroOne() * 0.2f;
        if (arg0->unk_1A8 > -0.5f) {
            arg0->unk_1A8 = -0.5f;
        } else {
block_9:
            arg0->unk_1A8 = arg0->unk_1A8;
        }
    }
    SysMatrix_StatePush();
    Matrix_RotateY((s16) (arg0->actor.yawTowardsPlayer + 0x4000), 0U);
    SysMatrix_GetStateTranslationAndScaledZ(arg0->unk_1A8, (Vec3f *) &sp34);
    SysMatrix_StatePop();
...
void BgDblueWaterfall_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_190 = Lib_SegmentedToVirtual(&D_0600B448);
...
void func_80B8484C(BgDblueWaterfall *arg0, GlobalContext *arg1) {
    ...
    if (func_80B83D04(arg1) != 0) {
        temp_a0->unk_19E = 0;
        temp_a0->unk_19F = 0xFF;
        temp_a0->unk_1A0 = 0;
        temp_a0->unk_144.dim.radius = 0x37;
        temp_a0->unk_144.dim.height = 0x96;
        temp_a0->unk_144.dim.yShift = -0x96;
    } else {
        temp_a0->unk_19E = 0xFF;
        temp_a0->unk_19F = 0;
        temp_a0->unk_1A0 = 0;
        temp_a0->unk_144.dim.radius = 0x32;
        temp_a0->unk_144.dim.height = 0x2E4;
        temp_a0->unk_144.dim.yShift = -0x2E4;
    }
...
void func_80B84928(BgDblueWaterfall *this, GlobalContext *globalCtx) {
    ...
    sp30 = temp_v0;
    temp_v1 = this->unk_144.base.acFlags;
    temp_t7 = (temp_v1 & 2) != 0;
    sp2C = temp_t7;
    if (temp_t7 != 0) {
        this->unk_144.base.acFlags = temp_v1 & 0xFFFD;
    }
    if ((temp_v0 == 0) && ((this->unk_144.base.ocFlags2 & 1) != 0)) {
        sp28 = 0;
    ...
    if (phi_a2 == 0) {
        if (sp2C != 0) {
            if (sp30 != 0) {
                ...
                if ((this->unk_144.info.acHitInfo->toucher.dmgFlags & 0x800) != 0) {
                    this->unk_1A4 = (s16) this->actor.cutscene;
            ...
            if ((this->unk_144.info.acHitInfo->toucher.dmgFlags & 0x1000) != 0) {
                this->unk_1A4 = ActorCutscene_GetAdditionalCutscene((s16) this->actor.cutscene);
                func_80B84AD4(this, globalCtx);
                return;
            }
            /* Duplicate return node #19. Try simplifying control flow for better match */
...
void func_80B84AEC(BgDblueWaterfall *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->unk_1A4) != 0) {
        sp20 = func_80B83D04((GlobalContext *) this, globalCtx);
        ActorCutscene_StartAndSetUnkLinkFields(this->unk_1A4, (Actor *) this);
        this->unk_1A3 = 1;
        if (sp20 != 0) {
...
block_25:
        ...
        if ((s32) this->unk_19C < 0x3C) {
            temp_v0_7 = this->unk_19F;
            if ((s32) temp_v0_7 < 0xF5) {
                this->unk_19F = temp_v0_7 + 0xA;
            } else {
                this->unk_19F = 0xFF;
            }
        }
...
void func_80B84F20(BgDblueWaterfall *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        if ((s32) this->unk_19C < 0x32) {
            temp_v0_2 = this->unk_19E;
            if ((s32) temp_v0_2 < 0xFA) {
                this->unk_19E = temp_v0_2 + 5;
            } else {
                this->unk_19E = 0xFF;
            }
        }
        temp_v0_3 = this->unk_19F;
        if ((s32) temp_v0_3 >= 6) {
            this->unk_19F = temp_v0_3 - 5;
        } else {
            this->unk_19F = 0;
        }
...
void BgDblueWaterfall_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0_5 > 0) {
        if ((s32) temp_v0_5 < 0xFF) {
            ...
            temp_v0_7->words.w1 = this->unk_19F | ~0xFF;
        ...
        temp_v0_13->words.w1 = phi_a3->unk_19F | ~0xFF;
