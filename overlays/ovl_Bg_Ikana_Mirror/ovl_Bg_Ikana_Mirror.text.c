...
void func_80B7FB84(BgIkanaMirror *arg0, s32, BgIkanaMirror *); /* static */
...
static ColliderTrisElementInit D_80B7FF50 = {
    {
...
static InitChainEntry D_80B8021C;                   /* unable to generate initializer */
...
typedef struct BgIkanaMirror {
    ...
    /* 0x01D8 */ char pad1D8[0x2E0];                /* maybe part of unk17C[9]? */
    /* 0x04B8 */ ColliderQuad unk4B8;               /* inferred */
    /* 0x0538 */ char pad538[0x80];                 /* maybe part of unk4B8[2]? */
    /* 0x05B8 */ void (*actionFunc)(BgIkanaMirror *, GlobalContext *);
    /* 0x05BC */ void *unk5BC;                      /* inferred */
    /* 0x05C0 */ void *unk5C0;                      /* inferred */
    /* 0x05C4 */ s16 unk5C4;                        /* inferred */
    /* 0x05C6 */ u8 unk5C6;                         /* inferred */
    /* 0x05C7 */ u8 unk5C7;                         /* inferred */
    /* 0x05C8 */ s8 unk5C8;                         /* inferred */
    /* 0x05C9 */ char pad5C9[0x3];                  /* maybe part of unk5C8[4]? */
...
void func_80B7F730(BgIkanaMirror *arg0) {
    ...
    phi_s2 = arg0 + 0x4B8;
    do {
        SysMatrix_MultiplyVector3fByState(phi_s1, &sp84);
        SysMatrix_MultiplyVector3fByState(phi_s0, &sp78);
        SysMatrix_MultiplyVector3fByState(phi_s4, &sp6C);
        SysMatrix_MultiplyVector3fByState(phi_s3, &sp60);
...
loop_2:
    ...
    do {
        ...
        Collider_SetQuad(globalCtx, phi_s1_2, &this->actor, phi_s0_2);
