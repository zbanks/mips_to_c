...
void DmChar04_Init(DmChar04 *this, GlobalContext *globalCtx) {
    ActorShape *sp38;
    SkelAnime *sp34;
    ActorShape *temp_a0;
    SkelAnime *temp_a1;
...
void DmChar04_Destroy(DmChar04 *this, GlobalContext *globalCtx) {
    DmChar04 *this = (DmChar04 *) thisx;
...
void DmChar04_Update(DmChar04 *this, GlobalContext *globalCtx) {
    SkelAnime *temp_a0;
    DmChar04 *this = (DmChar04 *) thisx;
...
void DmChar04_Draw(DmChar04 *this, GlobalContext *globalCtx) {
    ...
    sp54 = sp54;
    sp54->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80AABF74, NULL, (Actor *) this, temp_t8);
}
