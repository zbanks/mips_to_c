...
static ActorAnimationEntryS D_80BF031C = {
...
static InitChainEntry D_80BF04B4;                   /* unable to generate initializer */
...
typedef struct EnAkindonuts {
    ...
    /* 0x02D8 */ void (*actionFunc)(EnAkindonuts *, GlobalContext *);
    /* 0x02DC */ char pad2DC[0x4];                  /* maybe part of actionFunc[2]? */
    /* 0x02E0 */ ColliderCylinder unk2E0;           /* inferred */
    ...
    /* 0x033A */ char pad33A[0x26];                 /* maybe part of unk338[20]? */
    /* 0x0360 */ s16 unk360;                        /* inferred */
    /* 0x0362 */ char pad362[0xA];                  /* maybe part of unk360[6]? */
...
void func_80BEF20C(void *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = SkelAnime_GetFrameCount(&(&D_80BF031C)[arg0->unk338].animationSeg->common);
    if (arg0->unk356 == 0x28) {
        arg0->unk338 = 5;
        sp22 = temp_a3;
...
void func_80BEF518(Actor *arg0, GlobalContext *arg1) {
    ...
    sp26 = (s16) (s32) arg0->unk15C;
    sp24 = SkelAnime_GetFrameCount(&(&D_80BF031C)[arg0->unk338].animationSeg->common);
    switch (sp26) {
    case 10:
        arg0->unk33E = 1;
        arg0->unk340 = 0.1f;
...
void func_80BEF83C(Actor *arg0, GlobalContext *arg1) {
    ...
    if (sp32 == SkelAnime_GetFrameCount(&(&D_80BF031C)[arg0->unk338].animationSeg->common)) {
...
void EnAkindonuts_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80BF04B4);
    temp_a1 = &this->unk144;
    sp34 = temp_a1;
    ...
    Collider_SetCylinderType1(globalCtx, temp_a1_2, &this->actor, &D_80BF02F0);
    ...
    func_80BEE938(&this->actor, globalCtx);
...
void EnAkindonuts_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80BECC7C(&this->actor, globalCtx);
}
...
void EnAkindonuts_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BEFFB4, func_80BF0178, func_80BF0190, &this->actor);
}
