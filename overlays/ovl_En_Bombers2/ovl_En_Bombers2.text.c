typedef struct EnBombers2 {
    ...
    /* 0x2C6 */ char pad2C6[0x8];                   /* maybe part of unk2C4[5]? */
    /* 0x2CE */ s16 unk2CE;                         /* inferred */
    /* 0x2D0 */ ColliderCylinder unk2D0;            /* inferred */
...
void EnBombers2_Init(EnBombers2 *this, GlobalContext *globalCtx) {
    f32 temp_f6;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2D0, (Actor *) this, &D_80C058B0);
...
void EnBombers2_Destroy(EnBombers2 *this, GlobalContext *globalCtx) {
    EnBombers2 *this = (EnBombers2 *) thisx;
...
void func_80C050B8(EnBombers2 *arg0, GlobalContext *arg1) {
    ...
    arg0->unk2B6 = Math_Vec3f_Yaw((Vec3f *) sp28, sp24);
    arg0->unk2C0 = 2;
...
void func_80C0520C(EnBombers2 *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2A8 == 0) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(this->unk2B0, (Actor *) this);
        this->unk2A8 = 1;
        return;
    }
...
void EnBombers2_Update(EnBombers2 *this, GlobalContext *globalCtx) {
    f32 sp34;
    SkelAnime *sp2C;
...
void EnBombers2_Draw(EnBombers2 *this, GlobalContext *globalCtx) {
    Gfx *sp38;
    Gfx *sp34;
    Gfx *sp30;
    Gfx *temp_v0;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80C056D4, NULL, (Actor *) this);
}
