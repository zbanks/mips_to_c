typedef struct EnAl {
    ...
    /* 0x1D0 */ char pad1D0[0x140];                 /* maybe part of unk190[6]? */
    /* 0x310 */ ColliderCylinder unk310;            /* inferred */
    /* 0x35C */ u8 unk35C;                          /* inferred */
    /* 0x35D */ char pad35D[0x3];                   /* maybe part of unk35C[4]? */
    /* 0x360 */ s32 *unk360;                        /* inferred */
    /* 0x364 */ s32 unk364;                         /* inferred */
    /* 0x368 */ Actor *unk368;                      /* inferred */
    /* 0x36C */ char pad36C[0x12];                  /* maybe part of unk368[5]? */
    /* 0x37E */ Vec3s unk37E;                       /* inferred */
    /* 0x384 */ char pad384[0x9C];                  /* maybe part of unk37E[27]? */
    /* 0x420 */ Vec3s unk420;                       /* inferred */
    /* 0x426 */ char pad426[0x9C];                  /* maybe part of unk420[27]? */
    /* 0x4C2 */ u16 unk4C2;                         /* inferred */
    /* 0x4C4 */ char pad4C4[0x10];                  /* maybe part of unk4C2[9]? */
    /* 0x4D4 */ f32 unk4D4;                         /* inferred */
    /* 0x4D8 */ char pad4D8[0x8];                   /* maybe part of unk4D4[3]? */
    /* 0x4E0 */ s16 unk4E0;                         /* inferred */
    /* 0x4E2 */ s16 unk4E2;                         /* inferred */
    /* 0x4E4 */ char pad4E4[0x8];                   /* maybe part of unk4E2[5]? */
    /* 0x4EC */ void *unk4EC;                       /* inferred */
    /* 0x4F0 */ s32 unk4F0;                         /* inferred */
    /* 0x4F4 */ char pad4F4[0x4];
    /* 0x4F8 */ s32 unk4F8;                         /* inferred */
    /* 0x4FC */ char pad4FC[0x4];
} EnAl;                                             /* size = 0x500 */
...
s32 func_80BDE4E0(Actor *arg0, s16 *arg1, s16 arg2) {
    ...
    if ((arg2 + 1) == *arg1) {
        Math_Vec3f_Copy((Vec3f *) &sp28, arg0->unk368 + 0x24);
...
void func_80BDED20(void *arg0) {
    ...
    Math_Vec3f_Copy((Vec3f *) &sp40, arg0->unk368 + 0x24);
    Math_Vec3f_Copy((Vec3f *) &sp34, arg0 + 0x24);
    Math_ApproachS(arg0 + 0x4DE, (s16) (Math_Vec3f_Yaw((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unkBE), 4, 0x2AA8);
    temp_v0 = arg0->unk4DE;
...
void func_80BDF5E8(EnAl *this, GlobalContext *globalCtx) {
    ...
    if ((func_80133038(globalCtx, &D_80BDFC70, (struct_80133038_arg2 *) &sp20) == 0) || ((sp20 != this->unk35C) && (func_80BDF390(this, (u8 *) globalCtx, &sp20) == 0))) {
...
void func_80BDF6C4(EnAl *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, this->unk360, this->unk4EC, &this->unk364) != 0) {
...
void EnAl_Init(EnAl *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk310, (Actor *) this, &D_80BDFFB8);
...
void EnAl_Destroy(EnAl *this, GlobalContext *globalCtx) {
    EnAl *this = (EnAl *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk310);
}

void EnAl_Update(EnAl *this, GlobalContext *globalCtx) {
    EnAl *this = (EnAl *) thisx;
    ...
    if (this->unk35C != 0) {
        func_80BDE250(this);
        func_80BDEE5C(this);
        func_8013C964((Actor *) this, globalCtx, this->unk4D4, 30.0f, this->unk4F0, (s16) (this->unk4C2 & 7));
...
void EnAl_Draw(EnAl *this, GlobalContext *globalCtx) {
    ? *temp_s1;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    ...
    if (this->unk35C != 0) {
        ...
        func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BDF914, func_80BDF950, func_80BDFA34, (Actor *) this);
        phi_s2 = &this->unk190;
        phi_s1 = &D_80BE007C;
        do {
