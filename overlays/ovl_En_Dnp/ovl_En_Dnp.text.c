...
? func_80B3CDA4(void *arg0, void *arg1) {
    ...
    sp30.unk0 = (s32) temp_v1->unk24;
    sp30.unk4 = (s32) temp_v1->unk28;
    sp30.unk8 = (s32) temp_v1->unk2C;
    sp34 = temp_v1->unkC44 + 3.0f;
    sp3C.unk0 = (s32) arg0->unk24;
    sp3C.unk4 = (s32) arg0->unk28;
    sp3C.unk8 = (s32) arg0->unk2C;
    sp40 += 10.0f;
...
void EnDnp_Init(EnDnp *this, GlobalContext *globalCtx) {
    s32 temp_v0;
    u16 temp_t4;
...
void EnDnp_Destroy(EnDnp *this, GlobalContext *globalCtx) {
    EnDnp *this = (EnDnp *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->collider);
}

void EnDnp_Update(EnDnp *this, GlobalContext *globalCtx) {
    f32 sp2C;
    f32 sp28;
    f32 temp_f0;
    f32 temp_f2;
...
void EnDnp_Draw(EnDnp *this, GlobalContext *globalCtx) {
