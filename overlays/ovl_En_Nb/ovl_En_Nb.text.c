typedef struct EnNb {
    ...
    /* 0x1E8 */ Actor *unk1E8;                      /* inferred */
    /* 0x1EC */ char pad1EC[0x16];                  /* maybe part of unk1E8[6]? */
    /* 0x202 */ Vec3s unk202;                       /* inferred */
    /* 0x208 */ char pad208[0x2A];                  /* maybe part of unk202[8]? */
    /* 0x232 */ Vec3s unk232;                       /* inferred */
    /* 0x238 */ char pad238[0x2A];                  /* maybe part of unk232[8]? */
    /* 0x262 */ u16 unk262;                         /* inferred */
    /* 0x264 */ char pad264[0x10];                  /* maybe part of unk262[9]? */
    /* 0x274 */ f32 unk274;                         /* inferred */
    /* 0x278 */ char pad278[0x8];                   /* maybe part of unk274[3]? */
    /* 0x280 */ s16 unk280;                         /* inferred */
    /* 0x282 */ s16 unk282;                         /* inferred */
    /* 0x284 */ char pad284[0x8];                   /* maybe part of unk282[5]? */
    /* 0x28C */ void *unk28C;                       /* inferred */
    /* 0x290 */ s32 unk290;                         /* inferred */
    /* 0x294 */ char pad294[0x8];                   /* maybe part of unk290[3]? */
} EnNb;                                             /* size = 0x29C */
...
void func_80BC06C4(void *arg0) {
    ...
    Math_Vec3f_Copy((Vec3f *) &sp40, arg0->unk1E8 + 0x24);
    Math_Vec3f_Copy((Vec3f *) &sp34, arg0 + 0x24);
    Math_ApproachS(arg0 + 0x27E, (s16) (Math_Vec3f_Yaw((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unkBE), 4, 0x2AA8);
    temp_v0 = arg0->unk27E;
...
void func_80BC0EAC(EnNb *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, this->unk1E0, this->unk28C, &this->unk1E4) != 0) {
...
void EnNb_Init(EnNb *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk190, (Actor *) this, &D_80BC15F0);
...
void EnNb_Update(EnNb *this, GlobalContext *globalCtx) {
    ...
    if (this->unk1DC != 0) {
        ...
        if (Actor_IsActorFacingLink((Actor *) this, 0x38E0) != 0) {
            func_8013C964((Actor *) this, globalCtx, this->unk274, 30.0f, 0, (s16) (this->unk262 & 7));
        }
...
void EnNb_Draw(EnNb *this, GlobalContext *globalCtx) {
    ...
    if (this->unk1DC != 0) {
        ...
        func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BC1174, func_80BC11B4, func_80BC1278, (Actor *) this);
    }
}
