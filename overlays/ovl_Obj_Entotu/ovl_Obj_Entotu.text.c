...
void func_80A349C0(void *arg0) {
    ...
    temp_v0 = func_80A34700(arg0->unk1C6);
...
void func_80A34B28(ObjEntotu *arg0, GlobalContext *arg1) {
    ...
    arg0->unk157 = (s8) (u32) ((f32) *D_80A3541F * arg0->unk1B8);
    arg0->unk167 = (s8) (u32) ((f32) *D_80A3542F * arg0->unk1B8);
    arg0->unk177 = (s8) (u32) ((f32) *D_80A3543F * arg0->unk1B8);
...
void ObjEntotu_Init(ObjEntotu *this, GlobalContext *globalCtx) {
    ObjEntotu *this = (ObjEntotu *) thisx;
    Lib_MemCpy((void *) &this->unk148, &D_80A35410, 0x70U);
    this->unk1C6 = Rand_S16Offset(0, 0x3B);
    this->unk1C4 = 0;
}

void ObjEntotu_Destroy(ObjEntotu *this, GlobalContext *globalCtx) {
    ObjEntotu *this = (ObjEntotu *) thisx;

}

void ObjEntotu_Update(ObjEntotu *this, GlobalContext *globalCtx) {
    ObjEntotu *this = (ObjEntotu *) thisx;
    func_80A349C0();
}

void ObjEntotu_Draw(ObjEntotu *this, GlobalContext *globalCtx) {
    ObjEntotu *this = (ObjEntotu *) thisx;
