...
static u8 D_80A3541F = {0, 0, 0, 8, 0xD5, 2, 0x5B, 0, 0, 2, 0, 3, 0xCC, 0x4D, 0x44, 0x34};
static u8 D_80A3542F = {0xFF, 0, 0, 0x1B, 0xAC, 1, 0x2D, 0, 0, 2, 0, 0xE9, 0xD0, 0, 0, 0};
static u8 D_80A3543F = {
    0,
    0xFB,
    0xAD,
    8,
...
typedef struct ObjEntotu {
    ...
    /* 0x0168 */ char pad168[0xF];                  /* maybe part of unk167[16]? */
    /* 0x0177 */ s8 unk177;                         /* inferred */
    /* 0x0178 */ char pad178[0x40];                 /* maybe part of unk177[65]? */
...
void ObjEntotu_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Lib_MemCpy(&this->unk148, &D_80A35410, 0x70U);
