...
void func_80C1DF18(Actor *arg0, GlobalContext *arg1) {
    ...
    sp2C.unk_0 = (s32) D_80C1E210.unk_0;
    sp2C.unk_4 = (s32) D_80C1E210.unk_4;
    sp2C.unk_8 = (s32) D_80C1E210.unk_8;
    sp2C.unk_C = (s32) D_80C1E210.unk_C;
    sp2C.unk_10 = (s32) D_80C1E210.unk_10;
    if (arg1->csCtx.state != 0) {
        ...
        if (func_800EE29C(arg1, 0x232U) != 0) {
            ...
            phi_a3 = temp_a3;
            phi_a2 = temp_a2;
            if ((temp_v1 & 0xFF) != temp_a3->unk_1EC) {
                temp_a3->unk_1EC = (u8) temp_v1;
                arg0 = temp_a3;
                sp24 = temp_v0;
                func_80C1DED0(temp_a0, (sp + (temp_v1 * 4))->unk_2C, temp_a2, temp_a3);
                phi_a3 = arg0;
                phi_a2 = sp24;
            }
    ...
    if (arg0->unk_1F8 != 0) {
        arg0->unk_1F8 = 0;
        func_80C1DED0(arg0, arg0->unk_1F4, (u32) arg0);
    }
}
