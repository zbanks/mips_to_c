...
void func_80B40100(Actor *arg0, GlobalContext *arg1); /* static */
...
typedef struct BgGoronOyu {
    ...
    /* 0x015C */ void (*actionFunc)(BgGoronOyu *, GlobalContext *);
...
void func_80B401F8(Actor *arg0, GlobalContext *arg1) {
    ...
    sp3C = temp_v0;
    Math_Vec3f_DistXYZAndStoreDiff(arg0 + 0x168, &temp_v0->world.pos, &sp30);
    if ((sp30.x >= 0.0f) && (sp30.x <= arg0->unk174) && (sp30.z >= 0.0f) && (sp30.z <= arg0->unk178) && (fabsf(sp30.y) < 100.0f) && (temp_v0->yDistToWater > 12.0f)) {
...
void BgGoronOyu_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80B40308(&this->actor, globalCtx);
    if (this->actor.params != 0) {
        this->actor.world.pos.y = this->actor.home.pos.y;
        func_80B40080(&this->actor);
        return;
    }
