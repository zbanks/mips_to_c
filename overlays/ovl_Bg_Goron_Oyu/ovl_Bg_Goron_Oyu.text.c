typedef struct BgGoronOyu {
    ...
    /* 0x160 */ char pad160[0x20];                  /* maybe part of actionFunc[9]? */
...
void func_80B40100(Actor *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCanPlayNext(temp_a0) != 0) {
        temp_a0_2 = temp_a1->unk17C;
        arg0 = temp_a1;
        ActorCutscene_StartAndSetUnkLinkFields(temp_a0_2, temp_a1);
        arg0->unk15C = func_80B40160;
        return;
    }
    ActorCutscene_SetIntentToPlay(temp_a1->unk17C);
}

void func_80B40160(Actor *arg0, GlobalContext *arg1) {
    Math_StepToF(arg0 + 0x164, 0.0f, 0.2f);
    arg0->world.pos.y = arg0->home.pos.y - arg0->unk164;
    func_80B40308(arg0, arg1);
    if (arg0->unk164 <= 0.0f) {
        ActorCutscene_Stop(arg0->unk17C);
        arg0->unk164 = 0.0f;
        func_80B40080(arg0);
    }
...
void func_80B401F8(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((sp30 >= 0.0f) && (sp30 <= arg0->unk174) && (sp38 >= 0.0f) && (sp38 <= arg0->unk178) && (fabsf(sp34) < 100.0f) && (temp_v0->yDistToWater > 12.0f)) {
...
void func_80B40308(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800CA1AC(arg1, arg1 + 0x830, arg0->world.pos.x, arg0->world.pos.z, &sp28, &sp2C) != 0) {
        ...
        arg0->unk174 = (f32) sp2C->xLength;
        arg0->unk178 = (f32) sp2C->zLength;
    }
}
...
void func_80B40394(BgGoronOyu *arg0, GlobalContext *arg1) {
    ...
    if ((arg1->state.frames & 3) == 0) {
        ...
        sp54 = (Rand_ZeroOne() * arg0->unk174) + arg0->unk168;
        sp58 = arg0->unk16C + 100.0f;
        temp_f6_2 = Rand_ZeroOne() * arg0->unk178;
        sp34 = 0.0f;
        sp3C = 0.0f;
        sp38 = 0.5f;
        sp5C = temp_f6_2 + arg0->unk170;
        sp6E = -0xC8 - (s32) (Rand_ZeroOne() * 50.0f);
        temp_f2_2 = arg0->unk16C;
...
void BgGoronOyu_Init(BgGoronOyu *this, GlobalContext *globalCtx) {
...
void BgGoronOyu_Destroy(BgGoronOyu *this, GlobalContext *globalCtx) {
    BgGoronOyu *this = (BgGoronOyu *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->unk144);
}

void BgGoronOyu_Update(BgGoronOyu *this, GlobalContext *globalCtx) {
    BgGoronOyu *this = (BgGoronOyu *) thisx;
    this->actionFunc(this, globalCtx);
    func_80B40394(this, globalCtx);
}

void BgGoronOyu_Draw(BgGoronOyu *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
