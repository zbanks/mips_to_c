...
void func_80A85620(u8 *arg0, Vec3f *arg1, f32 arg2, f32 arg3, f32 arg4); /* static */
...
void func_80A85E2C(u8 *arg0, Vec3f *arg1, Vec3f *arg2, Vec3f *arg3, f32 arg4, f32 arg5, f32 arg6, u8 arg7); /* static */
...
? *func_80A871E0(Actor *arg0, GlobalContext *arg1, Actor *); /* static */
...
typedef struct EnTru {
    ...
    /* 0x0188 */ void (*actionFunc)(EnTru *, GlobalContext *);
    /* 0x018C */ ColliderSphere unk18C;             /* inferred */
    /* 0x01E4 */ s32 unk1E4;                        /* inferred */
    /* 0x01E8 */ s32 unk1E8;                        /* inferred */
    /* 0x01EC */ char pad1EC[0xC];                  /* maybe part of unk1E8[4]? */
    /* 0x01F8 */ ? unk1F8;                          /* inferred */
    /* 0x01F9 */ char pad1F9[0x11];
    /* 0x020A */ Vec3s unk20A;                      /* inferred */
    /* 0x0210 */ char pad210[0x9C];                 /* maybe part of unk20A[27]? */
    /* 0x02AC */ Vec3s unk2AC;                      /* inferred */
    /* 0x02B2 */ char pad2B2[0x9C];                 /* maybe part of unk2AC[27]? */
    /* 0x034E */ u16 unk34E;                        /* inferred */
    /* 0x0350 */ char pad350[0x4];                  /* maybe part of unk34E[3]? */
    /* 0x0354 */ s32 *unk354;                       /* inferred */
    /* 0x0358 */ f32 unk358;                        /* inferred */
    /* 0x035C */ char pad35C[0x6];
    /* 0x0362 */ s16 unk362;                        /* inferred */
    /* 0x0364 */ char pad364[0x2];                  /* maybe part of unk362[2]? */
    /* 0x0366 */ s16 unk366;                        /* inferred */
    /* 0x0368 */ s16 unk368;                        /* inferred */
    /* 0x036A */ s16 unk36A;                        /* inferred */
    /* 0x036C */ s16 unk36C;                        /* inferred */
    /* 0x036E */ s16 unk36E;                        /* inferred */
    /* 0x0370 */ char pad370[0x8];                  /* maybe part of unk36E[5]? */
    /* 0x0378 */ void *unk378;                      /* inferred */
    /* 0x037C */ u32 unk37C;                        /* inferred */
    /* 0x0380 */ char pad380[0x4];                  /* maybe part of unk37C[2]? */
    /* 0x0384 */ s32 unk384;                        /* inferred */
    /* 0x0388 */ s32 unk388;                        /* inferred */
    /* 0x038C */ char pad38C[0x8];                  /* maybe part of unk388[3]? */
    /* 0x0394 */ ? unk394;                          /* inferred */
    /* 0x0395 */ char pad395[0x59F];
} EnTru;                                            /* size 0x934 */

void func_80A85620(u8 *arg0, Vec3f *arg1, f32 arg2, f32 arg3, f32 arg4) {
    s16 temp_v0;
    u32 temp_t8;
    u8 *phi_a0;
    s16 phi_v0;
...
loop_1:
    ...
    if (*phi_a0 == 0) {
        ...
        arg0->unk0 = 1;
        arg0->unk4 = (s32) arg1->x;
        arg0->unk8 = (s32) arg1->y;
        arg0->unkC = (s32) arg1->z;
...
void func_80A85E2C(u8 *arg0, Vec3f *arg1, Vec3f *arg2, Vec3f *arg3, f32 arg4, f32 arg5, f32 arg6, u8 arg7) {
    s32 temp_v0;
    u32 temp_t8;
    u8 *phi_a0;
    s32 phi_v0;
...
loop_1:
    ...
    if (*phi_a0 == 0) {
        ...
        arg0->unk8 = (s32) arg1->y;
        arg0->unkC = (s32) arg1->z;
        arg0->unk1C = (s32) arg3->x;
        arg0->unk20 = (s32) arg3->y;
        arg0->unk24 = (s32) arg3->z;
...
? func_80A86460(EnTru *arg0) {
    ...
    spB0.z = 20.0f;
    Lib_Vec3f_TranslateAndRotateY(arg0 + 0x24, arg0->actor.world.rot.y, &spB0, &sp8C);
...
? func_80A86674(Actor *arg0) {
    ...
    Lib_Vec3f_TranslateAndRotateY(arg0 + 0x24, arg0->world.rot.y, &D_80A8B3D8, &sp40);
    Lib_Vec3f_TranslateAndRotateY(&D_801D15B0, arg0->world.rot.y, &D_80A8B3E4, &sp34);
    temp_v0 = arg0->unk390;
    if (temp_v0 == 1) {
...
? func_80A86770(Actor *arg0) {
    ...
    phi_s1 = 0;
    do {
        Lib_Vec3f_TranslateAndRotateY(arg0 + 0x24, phi_s0, &D_801D15B0, &sp98);
        sp98.y = arg0->floorHeight + 1.0f;
...
? func_80A869DC(void *arg0, void *arg1) {
    ...
    Math_Vec3f_Copy(&sp38, sp44 + 0x24);
    sp38.y = sp44->unkC44 + 3.0f;
    Math_Vec3f_Copy(&sp2C, arg0 + 0x3C);
    sp2C.y -= 30.0f;
    Math_ApproachS(arg0 + 0x366, Math_Vec3f_Pitch(&sp2C, &sp38), 4, 0x2AA8);
...
s32 func_80A87400(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0_2 != 0) {
        ...
        Math_Vec3s_ToVec3f(&sp34, (arg0->unk384 * 6) + sp4C);
        Math_Vec3f_Copy(&sp40, arg0 + 0x24);
    ...
    if (temp_v1 != 0) {
        ...
        if (temp_v1 != 1) {
            ...
            if (func_801378B8(temp_a0, arg0->unk154) != 0) {
                ...
                sp4C.z = 40.0f;
                Lib_Vec3f_TranslateAndRotateY(&arg0->world.pos, sp3E, &sp4C, &sp40);
...
void func_80A881E0(EnTru *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58(&this->actor, globalCtx, this->unk354, this->unk378, &this->unk1E8) != 0) {
        if (sp2C->unk14B != 4) {
            this->unk34E |= 0x80;
        }
...
void EnTru_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk18C, &this->actor, &D_80A8B2A0);
...
void EnTru_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnTru *this = (EnTru *) thisx;
    func_80A872AC(&this->actor, globalCtx);
    ...
    this->unk388 = 0;
    func_8013C964(&this->actor, globalCtx, (f32) (this->unk18C.dim.worldSphere.radius + 0x1E), 20.0f, this->unk388, (s16) (this->unk34E & 7));
...
void EnTru_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A885B8, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80A88698, func_80A886D4, &this->actor);
    temp_a0_2 = &this->unk394;
    sp34 = temp_a0_2;
    func_80A85788(temp_a0_2, &globalCtx->state.gfxCtx);
    func_80A85BCC(temp_a0_2, &globalCtx->state.gfxCtx);
    func_80A85F84(temp_a0_2, &globalCtx->state.gfxCtx);
}
