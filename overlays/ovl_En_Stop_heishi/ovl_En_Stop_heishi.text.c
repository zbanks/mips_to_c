...
struct _mips2c_stack_func_80AE795C {
    ...
    /* 0x30 */ char pad30[0xE];                     /* maybe part of sp2C[4]? */
...
void EnStopheishi_Init(EnStopheishi *this, GlobalContext *globalCtx) {
    f32 temp_f10;
    s16 temp_v0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk29C, (Actor *) this, &D_80AE88B0);
    this->unk284 = 6;
    this->unk280 = this->actor.world.rot.y;
    func_80AE7E9C(this);
}

void EnStopheishi_Destroy(EnStopheishi *this, GlobalContext *globalCtx) {
    EnStopheishi *this = (EnStopheishi *) thisx;
...
void func_80AE75C8(EnStopheishi *arg0, GlobalContext *arg1) {
    ...
    if (arg0->actor.xzDistToPlayer < 200.0f) {
        ...
        sp20 = phi_f6;
        arg0 = arg0;
        arg0->unk25E = Math_Vec3f_Pitch(temp_a0, (Vec3f *) &sp1C);
    }
}
...
void func_80AE795C(EnStopheishi *arg0, EnStopheishi *arg1) {
    ...
    Math_ApproachF(arg0 + 0x2C, sp54, 0.5f, arg0->unk28C);
    ...
    arg0->unk270 = 0x14;
    arg0->unk25E = 0;
    if ((arg0->unk276 == 3) && ((Math_Vec3f_Copy((Vec3f *) &sp4C, sp28), temp_v0_4 = sp5C->unk14B, (temp_v0_4 == 3)) || (temp_v0_4 == 4))) {
        sp50 += 77.0f + (f32) gGameInfo->data[2437];
        arg0->unk25E = Math_Vec3f_Pitch(arg0 + 0x3C, (Vec3f *) &sp4C);
    }
}
...
void EnStopheishi_Update(EnStopheishi *this, GlobalContext *globalCtx) {
    ...
    Math_Vec3f_Copy((Vec3f *) &this->actor.focus, &this->unk290);
...
void EnStopheishi_Draw(EnStopheishi *this, GlobalContext *globalCtx) {
    EnStopheishi *this = (EnStopheishi *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80AE87A4, func_80AE87EC, (Actor *) this);
}
