typedef struct EnBom {
    ...
    /* 0x190 */ ColliderJntSph unk190;              /* inferred */
    /* 0x1B0 */ ColliderJntSphElement unk1B0;       /* inferred */
    /* 0x1F0 */ s16 timer;
    /* 0x1F2 */ s16 unk1F2;                         /* inferred */
    /* 0x1F4 */ f32 unk1F4;                         /* inferred */
    /* 0x1F8 */ u8 unk1F8;                          /* inferred */
    /* 0x1F9 */ u8 unk_1F9;
    /* 0x1FA */ s16 unk1FA;                         /* inferred */
    /* 0x1FC */ u8 unk1FC;                          /* inferred */
    /* 0x1FD */ char pad1FD[0x3];                   /* maybe part of unk1FC[4]? */
...
struct _mips2c_stack_func_808726DC {
    ...
    /* 0xB4 */ char padB4[0xC];                     /* maybe part of spB0[4]? */
    /* 0xC0 */ f32 spC0;                            /* inferred */
...
void EnBom_Init(EnBom *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_1F9 == 0) {
        Collider_SetJntSph(globalCtx, sp2C, (Actor *) this, &D_80872E18, &this->unk1B0);
        this->unk144.dim.radius = 6;
        this->unk144.dim.height = 0xB;
    } else {
        Collider_SetJntSph(globalCtx, temp_a1_2, (Actor *) this, &D_80872E4C, &this->unk1B0);
        this->unk144.dim.radius = 0x14;
        this->unk144.dim.height = 0x24;
    ...
    this->unk1B0.info.toucher.damage += (s32) (temp_t5 & 0xFF00) >> 8;
    if ((temp_v0 & 0x80) != 0) {
        this->actor.shape.rot.z = temp_v0 | 0xFF00;
    }
    this->unk190.elements->dim.worldSphere.center.x = (s16) (s32) this->actor.world.pos.x;
    this->unk190.elements->dim.worldSphere.center.y = (s16) (s32) this->actor.world.pos.y;
    this->unk190.elements->dim.worldSphere.center.z = (s16) (s32) this->actor.world.pos.z;
...
void func_80871058(EnBom *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 1) == 0) {
        ...
        if (Math_StepToF(&this->actor.speedXZ, 0.0f, sp58->unk0) == 0) {
            ...
            this->unk1FA += (s32) (this->actor.speedXZ * 800.0f);
        }
...
void func_808714D4(EnBom *this, GlobalContext *globalCtx) {
    ...
    Math_ScaledStepToS(&this->unk1FA, 0, 0x7D0);
}
...
void func_808715B8(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk1F0 & 1) == 0) {
        ...
        do {
            ...
            SysMatrix_GetStateTranslationAndScaledZ((f32) (0xA - arg0->unk1F0) * 300.0f * 0.1f, (Vec3f *) &spC0);
...
void EnBom_Update(EnBom *this, GlobalContext *globalCtx) {
    ...
    spA4.unk0 = (s32) D_80872EA0.unk0;
    spA4.unk4 = (s32) D_80872EA0.unk4;
    spA4.unk8 = (s32) D_80872EA0.unk8;
    ...
    sp74.unk0 = (s32) D_80872EC4.unk0;
    sp74.unk4 = (s32) D_80872EC4.unk4;
    sp74.unk8 = (s32) D_80872EC4.unk8;
    sp70 = D_80872ED0;
...
block_13:
        ...
        if (this->actor.params == 0) {
            ...
            if (((this->unk144.base.acFlags & 2) != 0) || (((this->unk144.base.ocFlags1 & 2) != 0) && ((temp_v0_4 = this->unk144.base.oc->category, (temp_v0_4 == 5)) || (temp_v0_4 == 9)))) {
                this->timer = 0;
            ...
            sp40 = temp_t3;
            sp78 = 0.2f;
            sp80.unk0 = temp_t3->pos.x;
            sp80.unk4 = (f32) temp_t3->pos.y;
            sp80.unk8 = (f32) temp_t3->pos.z;
            sp84 += 10.0f;
            temp_v1 = this->timer;
            ...
            if (((s32) this->timer < (s32) sp60->unk4) && (temp_v0_5 = this->unk1F2, (((s32) this->timer & (temp_v0_5 + 1)) != 0))) {
                Math_ApproachF(&this->unk1F4, 140.0f, 1.0f, 140.0f / (f32) temp_v0_5);
            } else {
                Math_ApproachZeroF(&this->unk1F4, 1.0f, 140.0f / (f32) this->unk1F2);
            }
            if ((s32) this->timer < 3) {
                Actor_SetScale((Actor *) this, this->actor.scale.x + 0.002f);
            }
            if (this->timer == 0) {
                sp80.unk0 = sp40->pos.x;
                sp80.unk4 = (f32) sp40->pos.y;
                sp80.unk8 = (f32) sp40->pos.z;
                sp44 = func_808715B8;
                sp84 += 10.0f;
                if (Actor_HasParent((Actor *) this, globalCtx) != 0) {
                    sp84 += 30.0f;
        ...
        if ((s32) this->actor.params <= 0) {
            ...
            if ((Actor_HasParent((Actor *) this, globalCtx) == 0) && (this->unk1F8 != 0)) {
        ...
        if ((*(&enBomScales + (this->unk_1F9 * 4)) <= this->actor.scale.x) && (this->actor.params != 1)) {
            if (this->actor.yDistToWater >= 20.0f) {
                ...
                this->unk1FC = gGameInfo->data[1329] + 0xA;
                return;
            }
...
void EnBom_Draw(EnBom *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.params == 0) {
        ...
        Collider_UpdateSpheres(0, &this->unk190);
        if (this->unk_1F9 == 0) {
...
void func_808726DC(GlobalContext *arg0, Vec3f *arg1, Vec3f *arg2, Vec3f *arg3, s32 arg4) {
    ...
    if (temp_v1 > 0) {
        ...
        do {
            ...
            phi_s0->unk18 = Math_FAtan2F(spD4, spCC);
            phi_s0->unk1A = Math_FAtan2F(sqrtf((spCC * spCC) + (spD4 * spD4)), spD0);
