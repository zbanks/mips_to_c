typedef struct ObjSwitch {
    ...
    /* 0x164 */ char pad164[0x1];
    /* 0x165 */ s8 unk165;                          /* inferred */
    /* 0x166 */ char pad166[0x6];                   /* maybe part of unk165[7]? */
    /* 0x16C */ u8 unk16C;                          /* inferred */
    /* 0x16D */ u8 unk16D;                          /* inferred */
    /* 0x16E */ u8 unk16E;                          /* inferred */
    /* 0x16F */ u8 unk16F;                          /* inferred */
    /* 0x170 */ s8 unk170;                          /* inferred */
    /* 0x171 */ char pad171[0x7];                   /* maybe part of unk170[8]? */
    /* 0x178 */ Collider unk178;                    /* inferred */
    /* 0x189 */ u8 unk189;                          /* overlap; inferred */
    /* 0x18A */ char pad18A[0x2];                   /* maybe part of unk189[3]? */
    /* 0x18C */ u8 unk18C;                          /* inferred */
    /* 0x18D */ char pad18D[0xC3];                  /* maybe part of unk18C[196]? */
...
struct _mips2c_stack_ObjSwitch_Init {
    ...
    /* 0x34 */ char pad34[0x18];                    /* maybe part of sp30[7]? */
...
void ObjSwitch_Init(ObjSwitch *this, GlobalContext *globalCtx) {
    ...
    if ((temp_s0 == &D_8093CCBC) || (temp_s0 == &D_8093CCD0)) {
        if (globalCtx->sceneNum == 0x4F) {
            ...
            this->unk16C = temp_v0->unk0;
            this->unk16D = temp_v0->unk1;
            this->actor.shape.rot.z = 0;
            this->actor.world.rot.z = 0;
            this->unk16E = temp_v0->unk2;
        } else {
            this->unk16C = 0xFF;
            this->unk16D = 0xFF;
            this->unk16E = 0xFF;
...
void func_8093B668(Actor *arg0, GlobalContext *arg1) {
    if (ActorCutscene_GetCanPlayNext((s16) arg0->cutscene) != 0) {
        ...
        func_8093AE1C(arg0, arg1, arg0->unk171);
        if (arg0->unk170 == 1) {
            arg0->unk170 = 2;
        }
        arg0->unk172 = 1;
...
void func_8093B6F4(ObjSwitch *arg0) {
    ...
    arg0->actor.scale.y = arg0->unk250;
}
...
void func_8093B710(DynaPolyActor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 & 7) == 1) {
        temp_v0_2 = arg0->unk189;
        if ((temp_v0_2 & 2) != 0) {
            arg0->unk189 = (u8) (temp_v0_2 & 0xFFFD);
...
void func_8093B9C0(ObjSwitch *arg0) {
    ...
    arg0->actor.scale.y = arg0->unk254;
}
...
void func_8093BB5C(DynaPolyActor *arg0) {
    arg0->unk15C = func_8093BB70;
}

void func_8093BB70(Actor *arg0, ? arg1) {
    arg0->scale.y += 0.0495f;
    if (arg0->unk250 <= arg0->scale.y) {
        func_8093AEC4();
        func_8093AE88(arg0);
...
s32 func_8093BBD0(DynaPolyActor *arg0) {
    ...
    if (((arg0->unk189 & 2) != 0) && ((arg0->unk16F & 2) == 0) && (temp_v0 = arg0->unk180, (temp_v0 != 0)) && (sp3C = temp_v0, SysMatrix_StatePush(), Matrix_RotateY(temp_v0->unk32, 0U), SysMatrix_InsertXRotation_s(temp_v0->unk30, 1), SysMatrix_GetStateTranslationAndScaledZ(1.0f, (Vec3f *) &sp2C), Matrix_RotateY(arg0->actor.shape.rot.y, 0U), SysMatrix_InsertXRotation_s(arg0->actor.shape.rot.x, 1), SysMatrix_InsertZRotation_s(arg0->actor.shape.rot.z, 1), SysMatrix_GetStateTranslationAndScaledZ(1.0f, (Vec3f *) &sp20), SysMatrix_StatePop(), ((bitwise f32) Math3D_Parallel((Vec3f *) &sp2C, (Vec3f *) &sp20) < -0.38268343f))) {
        return 1;
    }
    return 0;
}
...
void func_8093BDAC(DynaPolyActor *arg0) {
    arg0->unk15C = func_8093BDC0;
}

void func_8093BDC0(Actor *arg0, ? arg1) {
    arg0->unk164 = (s8) (arg0->unk164 + 1);
    if ((s32) arg0->unk164 >= 3) {
        func_8093AE88();
        func_8093AEC4(arg0);
...
void func_8093BF70(DynaPolyActor *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = ((arg0->unk189 & 2) != 0) != 0;
    phi_v0 = temp_a2;
    if (temp_a2 != 0) {
        temp_v0 = (arg0->unk16F & 2) == 0;
        phi_v0 = temp_v0;
        if (temp_v0 != 0) {
            phi_v0 = (s32) arg0->unk162 < 1;
        }
    }
    if (temp_a2 != 0) {
        arg0->unk162 = 0xA;
...
void ObjSwitch_Update(ObjSwitch *this, GlobalContext *globalCtx) {
    ...
    temp_a3 = this;
    temp_v0 = temp_a3->unk160;
    if ((s32) temp_v0 > 0) {
        temp_a3->unk160 = temp_v0 - 1;
    }
    temp_v0_2 = temp_a3->unk165;
    if ((s32) temp_v0_2 > 0) {
        temp_a3->unk165 = temp_v0_2 - 1;
    }
    this = temp_a3;
    ...
    case 1:
    case 5:
        this->unk16F = this->unk158;
        return;
    case 2:
        temp_v0_3 = this->unk178.acFlags;
        this->unk178.acFlags = temp_v0_3 & 0xFFFD;
        this->unk16F = temp_v0_3;
    ...
    case 4:
        ...
        if (func_801233E4(globalCtx) == 0) {
            ...
            if ((s32) temp_v0_4 > 0) {
                this->unk162 = temp_v0_4 - 1;
            }
        }
        if (this->unk162 == 0) {
            this->unk18C = D_8093CE08.base.colType;
        } else {
            this->unk18C = 0xA;
        }
        temp_a1 = &globalCtx->colChkCtx;
        temp_a2 = &this->unk178;
        this->unk16F = this->unk189;
        this = this;
        sp20 = temp_a2;
        sp24 = temp_a1;
...
void func_8093C778(void *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 0) {
        ...
        arg0 = arg0;
        sp1C = temp_v1_2;
        temp_v1_2->unk4 = Matrix_NewMtx(arg1->state.gfxCtx);
        temp_v1_3->unk0 = 0xFA000080;
        temp_v1_3->unk4 = (s32) ((arg0->unk16C << 0x18) | (arg0->unk16D << 0x10) | (arg0->unk16E << 8) | 0xFF);
        temp_v1_4 = temp_v1_3 + 8;
        temp_v1_4->unk0 = 0xDE000000;
        temp_v1_4->unk4 = &D_0501B508;
...
void func_8093C8B8(void *arg0, GraphicsContext **arg1) {
    ...
    temp_v0_2->words.w1 = *(D_8093CC60 + ((sp28 * 0x10) + (arg0->unk164 * 4)));
...
void func_8093CAC4(Actor *arg0, GlobalContext *arg1) {
    ...
    AnimatedMat_DrawStep(arg1, (AnimatedMaterial *) D_8093D3B0, arg0->unk168);
    ...
    temp_v0_3->words.w1 = (arg0->unk16C << 0x18) | (arg0->unk16D << 0x10) | (arg0->unk16E << 8) | 0xFF;
