...
void ObjAqua_Init(ObjAqua *this, GlobalContext *globalCtx) {
...
void ObjAqua_Destroy(ObjAqua *this, GlobalContext *globalCtx) {
    ObjAqua *this = (ObjAqua *) thisx;
...
void func_80ACBD48(ObjAqua *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = (Actor *) this->unk196;
    if ((s32) temp_v0 >= 6) {
        (Actor *) this->unk196 = (u8) (temp_v0 - 5);
    } else {
        (Actor *) this->unk196 = 0U;
    }
...
void ObjAqua_Update(ObjAqua *this, GlobalContext *globalCtx) {
...
void ObjAqua_Draw(ObjAqua *this, GlobalContext *globalCtx) {
    s16 sp62;
    s32 sp5C;
    Gfx *sp50;
    s16 sp46;
