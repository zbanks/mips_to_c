...
void EnRailgibud_Init(EnRailgibud *this, GlobalContext *globalCtx) {
...
void EnRailgibud_Destroy(EnRailgibud *this, GlobalContext *globalCtx) {
    EnRailgibud *this = (EnRailgibud *) thisx;
...
void func_80BA6800(EnRailgibud *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    sp50.unk0 = (s32) D_80BA8308.unk0;
    sp50.unk4 = (s32) D_80BA8308.unk4;
    sp50.unk8 = (s32) D_80BA8308.unk8;
...
void func_80BA6974(GlobalContext *globalCtx, Vec3f *vec, f32 arg2, s32 arg3, s16 arg4, s16 arg5) {
    ...
    temp_s6 = &sp74;
    sp80.unk0 = (s32) D_80BA8320.unk0;
    sp80.unk4 = (s32) D_80BA8320.unk4;
    sp80.unk8 = (s32) D_80BA8320.unk8;
    temp_s7 = &sp8C;
...
s32 func_80BA6D10(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    phi_v0 = 0;
    if ((Actor_DistanceToPoint(sp1C, (Vec3f *) &this->actor.home) < 100.0f) && ((sp1C->unkA6C & 0x2C6080) == 0) && ((sp1C->unkA70 & 0x4080) == 0)) {
        phi_v0 = 1;
    }
    return phi_v0;
}
...
void EnRailgibud_Update(EnRailgibud *this, GlobalContext *globalCtx) {
    EnRailgibud *this = (EnRailgibud *) thisx;
    func_80BA6B30(this);
...
void EnRailgibud_Draw(EnRailgibud *this, GlobalContext *globalCtx) {
    Gfx *temp_v1;
    Gfx *temp_v1_2;
    Gfx *temp_v1_3;
    Gfx *temp_v1_4;
