...
static InitChainEntry D_80BA82FC;                   /* unable to generate initializer */
...
void func_80BA5400(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = D_80BA82F8;
    arg0->unk294 = Lib_SegmentedToVirtual(temp_s0->unk4);
    arg0->unk298 = temp_v1;
    temp_t2 = temp_s0->unk0;
    arg0->unk29C = (s32) temp_t2;
    if (temp_v1 == 0) {
        phi_s0 = 1;
        if ((s32) temp_t2 >= 2) {
loop_3:
    ...
    sp74 = (f32) (arg0->unk294 + temp_lo)->unk2;
    sp78 = (f32) (arg0->unk294 + temp_lo)->unk4;
    temp_v0_2 = Math_Vec3f_Yaw(&temp_s0_3->pos, (Vec3f *) temp_a1);
    ...
    arg0->unk14 = (s32) temp_s0_3->unkC;
    arg0->unk18 = (s32) temp_s0_3->unk10;
}
...
void EnRailgibud_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80BA82FC);
    ...
    func_80BA5400(&this->actor, globalCtx);
    this->unk_3F2 = 0;
    this->unk_404 = 0;
    this->unk_3F8 = 0;
    this->unk_400 = 0;
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80BA82A0);
...
void func_80BA57F8(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.xzDistToPlayer <= 100.0f) && (func_800B715C(globalCtx) != 0) && (Player_GetMask(globalCtx) != 0xC)) {
        ...
        this->unk14 = (s32) this->unk30;
        this->unk18 = (s32) this->unk34;
        func_80BA59F0(this);
    }
    ...
    } else if (temp_v1->unk3EC != 0) {
block_8:
        sp2C = &this->actor.world.pos;
        sp36 = Math_Vec3f_Yaw(&this->actor.world.pos, (Vec3f *) &sp3C);
        if (Math_Vec3f_DistXZ(&this->actor.world.pos, (Vec3f *) &sp3C) > 60.0f) {
...
void func_80BA5B64(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&this->unk_3E2, 0, 1, 0x64, (s16) 0);
    Math_SmoothStepToS(&this->unk_3E8, 0, 1, 0x64, (s16) 0);
    if ((func_80BA6D10(this, globalCtx) != 0) && (Actor_IsActorFacingLink(&this->actor, 0x38E3) != 0)) {
...
void func_80BA6054(EnRailgibud *this) {
    ...
    Audio_PlayActorSound2(&this->actor, 0x38E6U);
...
void func_80BA62D4(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    sp28 = temp_a1;
    if (Actor_XZDistanceToPoint(&this->actor, &temp_a1->pos) < 5.0f) {
        temp_f0 = this->actor.speedXZ;
        if (temp_f0 > 0.2f) {
        ...
        Math_ScaledStepToS(&this->actor.shape.rot.y, Actor_YawToPoint(&this->actor, &temp_a1->pos), 0x1C2);
        this->unk30 = (unaligned s32) this->unkBC;
        this->actor.world.rot.z = (s16) (u16) this->actor.shape.rot.z;
    }
    if (func_80BA6D10(this, globalCtx) != 0) {
        temp_v0 = gSaveContext.playerForm;
        if ((temp_v0 != 1) && (temp_v0 != 3) && (Actor_IsActorFacingLink(&this->actor, 0x38E3) != 0)) {
            func_80BA5AF0(this);
        }
    }
}
...
void func_80BA6664(EnRailgibud *this) {
    ...
    this->actor.flags &= -2;
    Audio_PlayActorSound2(&this->actor, 0x38E7U);
    this->unk_3F2 = 0;
...
void func_80BA6800(EnRailgibud *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    sp50.x = D_80BA8308.unk0;
    sp50.y = D_80BA8308.unk4;
    sp50.z = D_80BA8308.unk8;
    sp44.unk0 = D_80BA8314.unk0;
    sp44.unk4 = (s32) D_80BA8314.unk4;
    sp44.unk8 = (s32) D_80BA8314.unk8;
    if ((arg1->gameplayFrames & arg2) == 0) {
        ...
        EffectSsHahen_Spawn(arg1, (Vec3f *) &sp5C, &sp50, (Vec3f *) &sp44, (s16) 0, (s16) ((Rand_Next() & 7) + 0xA), (s16) -1, (s16) 0xA, NULL);
...
void func_80BA6974(GlobalContext *globalCtx, Vec3f *vec, f32 arg2, s32 arg3, s16 arg4, s16 arg5) {
    ...
    temp_s6 = &sp74;
    sp80.x = D_80BA8320.unk0;
    sp80.y = D_80BA8320.unk4;
    sp80.z = D_80BA8320.unk8;
    temp_s7 = &sp8C;
    temp_s6->unk0 = D_801D15B0.x;
    temp_s6->unk4 = (f32) D_801D15B0.y;
    temp_s6->unk8 = (f32) D_801D15B0.z;
    sp78 = 2.5f;
    phi_s0 = arg3;
    if (arg3 >= 0) {
        do {
            ...
            sp94 = vec->z + sp7C;
            sp7C *= 0.5f;
            func_800B1210(globalCtx, (Vec3f *) temp_s7, (Vec3f *) temp_s6, &sp80, (s16) ((s16) (s32) (Rand_ZeroOne() * (f32) arg4 * 0.2f) + arg4), (s16) (s32) arg5);
            temp_s0 = phi_s0 - 1;
            phi_s0 = temp_s0;
        } while (temp_s0 >= 0);
    }
...
s32 func_80BA6D10(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    phi_v0 = 0;
    if ((Actor_DistanceToPoint(sp1C, &this->actor.home.pos) < 100.0f) && ((sp1C->unkA6C & 0x2C6080) == 0) && ((sp1C->unkA70 & 0x4080) == 0)) {
        phi_v0 = 1;
    }
    return phi_v0;
}
...
s32 func_80BA6DAC(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    phi_v0 = 0;
    if (Actor_DistanceToPoint(globalCtx->actorCtx.actorList[2].first, &this->actor.home.pos) >= 100.0f) {
        phi_v0 = 1;
    }
    return phi_v0;
}
...
void func_80BA6DF8(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk3FA != 1) && ((arg0->unk155 & 2) != 0)) {
        if (func_80BA57F8 == arg0->unk1D4) {
            arg0->home.pos.x = arg0->world.pos.x;
            arg0->home.pos.y = arg0->world.pos.y;
            arg0->home.pos.z = arg0->world.pos.z;
            arg0->unk14 = (s32) arg0->unk30;
            arg0->unk18 = (s32) arg0->unk34;
        }
        ...
        case 12:
            temp_v0 = arg0->unk1D4;
            if ((func_80BA5E18 != temp_v0) && ((func_80BA6604 != temp_v0) || (arg0->unk3F2 == 0))) {
                arg0->unk404 = 0x1E;
                arg0->unk3F6 = 0x28;
                arg0->unk2A0 = 1.0f;
                func_80BA6584(arg0);
            ...
            return;
        case 1:
            if ((func_80BA6604 != arg0->unk1D4) || (arg0->unk3F2 == 0)) {
                func_80BA6584(arg0);
            }
            // Duplicate return node #28. Try simplifying control flow for better match
            return;
...
s32 func_80BA7088(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    sp38 = 0.0f;
    sp40.unk0 = temp_s0->world.pos.x;
    sp40.unk4 = (f32) temp_s0->world.pos.y;
    sp40.unk8 = (f32) temp_s0->world.pos.z;
    sp40 -= 25.0f * Math_SinS(temp_s0->shape.rot.y);
    sp48 -= 25.0f * Math_CosS(temp_s0->shape.rot.y);
    sp3C = Math_Vec3f_StepTo(&this->actor.world.pos, (Vec3f *) &sp40, 10.0f);
...
void func_80BA7234(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((func_80BA5E18 == arg0->unk1D4) && (arg0->unk3F0 != 2)) {
        sp28 = func_80BA5E18;
    ...
    if ((sp28 == arg0->unk1D4) && (arg0->unk3F0 == 0) && ((arg0->bgCheckFlags & 8) != 0)) {
        temp_v0 = sp3C + 0x24;
        sp30.unk0 = sp3C->world.pos.x;
        sp30.unk4 = (s32) temp_v0->unk4;
        sp30.unk8 = (s32) temp_v0->unk8;
        sp28 = temp_v0;
...
void func_80BA7578(EnRailgibud *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_400 == 0) && (temp_a1 = globalCtx, (this->unk_3F8 == 0))) {
        ...
        if (func_800B84D0(&this->actor, temp_a1) != 0) {
            this->unk_3FA = 1;
            func_801518B0(globalCtx, 0x13B2U, &this->actor);
            this->unk_400 = 0x13B2;
            Audio_PlayActorSound2(&this->actor, 0x38E5U);
            this->actor.speedXZ = 0.0f;
            return;
    ...
    case 5:
        ...
        if (func_80147624(temp_a0_2) != 0) {
            func_801518B0(globalCtx, 0x13B3U, &this->actor);
            this->unk_400 = 0x13B3;
            return;
        }
    default:
...
void EnRailgibud_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80BA6DF8(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    if (func_80BA6604 != this->actionFunc) {
        SkelAnime_FrameUpdateMatrix(&this->skelAnime);
    }
    func_80BA71E4(&this->actor, globalCtx);
    func_80BA76C4(this, globalCtx);
    func_80BA7234(&this->actor, globalCtx);
...
void func_80BA78F8(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    if ((arg4->unk3F6 != 0) && ((arg1 == 3) || (arg1 == 4) || (arg1 == 6) || (arg1 == 8) || (arg1 == 9) || (arg1 == 0xB) || (arg1 == 0xE) || (arg1 == 0x10) || (arg1 == 0x11) || (arg1 == 0x12) || (arg1 == 0x14) || (arg1 == 0x15) || (arg1 == 0x16) || (arg1 == 0x18) || (arg1 == 0x19))) {
...
void EnRailgibud_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.shape.shadowAlpha == 0xFF) {
        ...
        temp_s1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, func_80BA789C, func_80BA78F8, &this->actor, temp_s1->polyOpa.p);
    } else {
        ...
        temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, func_80BA789C, func_80BA78F8, &this->actor, temp_s1->polyXlu.p);
    }
    if ((s32) this->unk_3F6 > 0) {
        func_800BE680(globalCtx, &this->actor, (Vec3f []) this->unk_1D8, 0xF, this->unk_2A4, 0.5f, this->unk_2A0, (u8) (s32) this->unk_404);
    }
}
...
? func_80BA7DC8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, (u32) arg0->unk3FC) != 0) {
        temp_v0 = func_800EE200(arg1, (u32) arg0->unk3FC);
        temp_t7 = temp_v0 * 4;
        sp2C = temp_v0;
        temp_v1 = arg1 + temp_t7;
        temp_a0 = *temp_v1->unk1F4C;
        if (arg0->unk3FE != temp_a0) {
            arg0->unk3FE = temp_a0;
        ...
        temp_v0_3 = arg0->unk3FE;
        if ((temp_v0_3 != 3) && (temp_v0_3 != 4)) {
            if (temp_v0_3 != 5) {

            } else if (func_801378B8(arg0 + 0x190, arg0->unk1A0) != 0) {
        ...
        } else if (func_80BA7D30 == arg0->unk1D4) {
