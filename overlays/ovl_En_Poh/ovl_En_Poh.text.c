typedef struct EnPoh {
    ...
    /* 0x194 */ u8 unk194;                          /* inferred */
    /* 0x195 */ u8 unk195;                          /* inferred */
    /* 0x196 */ u8 unk196;                          /* inferred */
    /* 0x197 */ u8 unk197;                          /* inferred */
    /* 0x198 */ u8 unk198;                          /* inferred */
    /* 0x199 */ u8 unk199;                          /* inferred */
    /* 0x19A */ u8 unk19A;                          /* inferred */
    /* 0x19B */ char pad19B[0x1];
    /* 0x19C */ Vec3s unk19C;                       /* inferred */
    /* 0x1A2 */ char pad1A2[0x78];                  /* maybe part of unk19C[21]? */
    /* 0x21A */ Vec3s unk21A;                       /* inferred */
    /* 0x220 */ char pad220[0x78];                  /* maybe part of unk21A[21]? */
    /* 0x298 */ f32 unk298;                         /* inferred */
    /* 0x29C */ f32 unk29C;                         /* inferred */
    /* 0x2A0 */ Vec3f unk2A0;                       /* inferred */
    /* 0x2AC */ char pad2AC[0x6C];                  /* maybe part of unk2A0[10]? */
    /* 0x318 */ LightNode *unk318;                  /* inferred */
    /* 0x31C */ LightInfo unk31C;                   /* inferred */
    /* 0x32A */ char pad32A[0x2];
    /* 0x32C */ ColliderCylinder unk32C;            /* inferred */
    /* 0x378 */ ColliderJntSph unk378;              /* inferred */
    /* 0x398 */ ColliderJntSphElement unk398;       /* inferred */
    /* 0x3D8 */ MtxF unk3D8;                        /* inferred */
} EnPoh;                                            /* size = 0x418 */
...
struct _mips2c_stack_EnPoh_Draw {
    ...
    /* 0x34 */ char pad34[0x30];                    /* maybe part of sp30[13]? */
...
void EnPoh_Init(EnPoh *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk378, (Actor *) this, &D_80B2F6D0, &this->unk398);
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk32C, (Actor *) this, &D_80B2F680);
...
void func_80B2CBBC(EnPoh *this, GlobalContext *globalCtx) {
    ...
    if (Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) temp_a1) > 400.0f) {
        this->unk192 = Actor_YawToPoint((Actor *) this, (Vec3f *) temp_a1);
    }
...
void func_80B2CD64(EnPoh *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0 > 280.0f) {
        func_80B2CB60(this);
    } else if ((this->unk18E == 0) && (temp_f0 < 140.0f) && (Actor_IsLinkFacingActor((Actor *) this, 0x2AAA, globalCtx) == 0)) {
        func_80B2CEC8(this);
    }
    if (this->unk197 == 0xFF) {
        func_800B9010((Actor *) this, 0x3071U);
...
void EnPoh_Update(EnPoh *this, GlobalContext *globalCtx) {
    ...
    if ((func_80B2CF28 == this->actionFunc) && ((s32) this->unk18E < 0xA)) {
        ...
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk378);
    }
    temp_a1 = &this->unk32C;
    sp24 = &this->unk378;
    sp20 = temp_a1;
...
void func_80B2EDD0(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4, Gfx **arg5) {
    ...
    if (arg1 == 0x12) {
        ...
        Lights_PointGlowSetInfo(arg4 + 0x31C, (s16) (temp_v0_3->unk30 + (s32) sp60), (s16) (temp_v0_3->unk32 + (s32) sp64), (s16) (temp_v0_3->unk34 + (s32) sp68), (u8) (s32) arg4->unk198, (u8) (s32) arg4->unk199, (u8) (s32) arg4->unk19A, (s16) (s32) ((f32) arg4->unk19B * 0.78431374f));
    }
...
void EnPoh_Draw(EnPoh *this, GlobalContext *globalCtx) {
    Gfx *sp68;
    ...
    if ((temp_v0 == 0xFF) || (temp_v0 == 0)) {
        ...
        sp64 = temp_t1;
        temp_v0_2 = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80B2ED14, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80B2EDD0, (Actor *) this, temp_v1_3 + 0x18);
        temp_v1_4 = temp_v0_2;
        ...
        sp64 = temp_t1;
        sp30 = temp_t0;
        temp_t1->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_80B2ED14, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80B2EDD0, (Actor *) this, temp_v1 + 0x18);
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2A0, 0xA, this->actor.scale.x * 100.0f * this->unk29C, 0.0f, this->unk298, (u8) 0x14);
}
...
void func_80B2F37C(Actor *arg0, GraphicsContext **arg1) {
    ...
    if (func_80B2DD2C == arg0->unk188) {
        ...
        Lights_PointGlowSetInfo(arg0 + 0x31C, (s16) (s32) (arg0->world.pos.x + sp7C), (s16) (s32) (arg0->world.pos.y + sp80), (s16) (s32) (arg0->world.pos.z + sp84), (u8) (s32) arg0->unk198, (u8) (s32) arg0->unk199, (u8) (s32) arg0->unk19A, (s16) 0xC8);
