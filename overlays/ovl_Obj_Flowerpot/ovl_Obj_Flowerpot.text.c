typedef struct ObjFlowerpot {
    ...
    /* 0x1E8 */ char pad1E8[0x2];
    /* 0x1EA */ u8 unk1EA;                          /* inferred */
    /* 0x1EB */ s8 unk1EB;                          /* inferred */
...
void ObjFlowerpot_Init(ObjFlowerpot *this, GlobalContext *globalCtx) {
    ColliderJntSph *sp28;
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80A1D3E8, &this->unk164);
...
void ObjFlowerpot_Destroy(ObjFlowerpot *this, GlobalContext *globalCtx) {
    ObjFlowerpot *this = (ObjFlowerpot *) thisx;
...
void ObjFlowerpot_Update(ObjFlowerpot *this, GlobalContext *globalCtx) {
    void *sp1C;
    ObjFlowerpot *this = (ObjFlowerpot *) thisx;
...
void ObjFlowerpot_Draw(ObjFlowerpot *this, GlobalContext *globalCtx) {
    Gfx *sp3C;
