typedef struct EnSyatekiOkuta {
    ...
    /* 0x1D8 */ char pad_1D8[0xC];
    /* 0x1E4 */ Vec3s unk_1E4;                      /* inferred */
    /* 0x1EA */ char pad_1EA[0x5A];                 /* maybe part of unk_1E4[16]? */
    /* 0x244 */ Vec3s unk_244;                      /* inferred */
    /* 0x24A */ char pad_24A[0x5A];                 /* maybe part of unk_244[16]? */
    /* 0x2A4 */ s16 unk_2A4;                        /* inferred */
    /* 0x2A6 */ s16 unk_2A6;                        /* inferred */
    /* 0x2A8 */ char pad_2A8[0x2];
...
void EnSyatekiOkuta_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->unk_144, &D_060033D0, &D_0600466C, &this->unk_1E4, &this->unk_244, 0x10);
...
s32 func_80A361F4(EnSyatekiOkuta *arg0) {
    ...
    if ((temp_v1 == 1) || (temp_v1 == 4)) {
        temp_a0 = arg0->actor.parent->unk_190;
        temp_a1 = (temp_v1 * 2) + 6;
...
block_4:
        if (func_801378B8(sp24, this->unk_144.animFrameCount) != 0) {
            func_80A36444(this);
        }
    }
}
...
void func_80A36488(EnSyatekiOkuta *this, GlobalContext *globalCtx) {
    if ((s32) this->actor.parent->unk_26C >= 0x46) {
        func_80A364C0();
    }
}
...
void func_80A365EC(EnSyatekiOkuta *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        this->unk_2AA = temp_v0 - 0xF;
    }
    if (func_801378B8(temp_s0, this->unk_144.animFrameCount) != 0) {
        temp_a0 = &sp78;
        temp_a1 = &sp84;
        if (this->unk_2A4 == 0) {
...
void func_80A368E0(EnSyatekiOkuta *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = arg0;
    temp_a3->unk_18C.dim.height = (s16) (s32) ((f32) (D_80A37570.dim.height - temp_a3->unk_18C.dim.yShift) * temp_a3->unk_1DC * temp_a3->actor.scale.y * 100.0f);
    temp_a3->unk_18C.dim.radius = (s16) (s32) ((f32) D_80A37570.dim.radius * temp_a3->actor.scale.x * 100.0f);
    phi_a3 = temp_a3;
    phi_a3_2 = temp_a3;
    if (func_80A363B4 == temp_a3->actionFunc) {
        temp_a0 = temp_a3;
        if ((temp_a3->unk_2A6 != 2) || (arg0 = temp_a3, phi_a3 = arg0, (func_80A361F4(temp_a0, temp_a3) == 0))) {
            phi_a3_2 = phi_a3;
            if (phi_a3->unk_144.animCurrentFrame < (phi_a3->unk_144.animFrameCount - 5.0f)) {
                phi_a3->unk_18C.dim.height = (s16) (s32) ((f32) phi_a3->unk_18C.dim.height * 1.35f);
            }
            goto block_5;
        }
    } else {
block_5:
        if (phi_a3_2->unk_2A6 == 1) {
            phi_a3_2->unk_18C.dim.radius += 0xA;
            phi_a3_2->unk_18C.dim.height += 0xF;
        }
        phi_a3_2->unk_18C.dim.pos.x = (s16) (s32) phi_a3_2->actor.world.pos.x;
        phi_a3_2->unk_18C.dim.pos.z = (s16) (s32) phi_a3_2->actor.world.pos.z;
        phi_a3_2->unk_18C.dim.pos.y = (s16) (s32) (phi_a3_2->actor.world.pos.y + ((f32) phi_a3_2->unk_144.limbDrawTbl->unk_2 * phi_a3_2->actor.scale.y));
...
s32 func_80A36A90(EnSyatekiOkuta *arg0) {
    ...
    temp_v1 = arg0->unk_18C.base.acFlags;
    if ((temp_v1 & 2) != 0) {
        arg0->unk_18C.base.acFlags = temp_v1 & 0xFFFD;
        return 1;
    }
    func_80A368E0();
block_6:
...
void EnSyatekiOkuta_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80A36A90(this, globalCtx) != 0) {
        ...
        if (this->unk_2A6 == 1) {
            ...
            temp_v0->unk_26E = 1;
            temp_v0->unk_280 = (s16) (temp_v0->unk_280 + 1);
        } else {
            sp24 = temp_v0;
        ...
        this->unk_18C.base.acFlags &= 0xFFFD;
    }
    func_80A36CB0(this);
}
...
void func_80A36CB0(EnSyatekiOkuta *arg0) {
    ...
    if (func_80A363B4 == temp_v0) {
        ...
        if (temp_f2 < 10.0f) {
            arg0->unk_1E0 = 1.0f;
            arg0->unk_1D8 = 1.0f;
            arg0->unk_1DC = ((temp_f2 - 7.0f) * 0.4f) + 1.0f;
            return;
        }
        if (temp_f2 < 14.0f) {
            temp_f0 = temp_f2 - 9.0f;
            temp_f12 = (temp_f0 * 0.075f) + 1.0f;
            arg0->unk_1E0 = temp_f12;
            arg0->unk_1D8 = temp_f12;
            arg0->unk_1DC = 1.8f - (temp_f0 * 0.25f);
            return;
        }
        temp_f0_2 = temp_f2 - 13.0f;
        temp_f12_2 = 1.3f - (temp_f0_2 * 0.05f);
        arg0->unk_1E0 = temp_f12_2;
        arg0->unk_1D8 = temp_f12_2;
        arg0->unk_1DC = (temp_f0_2 * 0.0333f) + 0.8f;
        return;
    }
    if (func_80A36488 == temp_v0) {
        arg0->unk_1E0 = 1.0f;
        arg0->unk_1D8 = 1.0f;
        arg0->unk_1DC = (sin_rad(0.19634955f * temp_f2) * 0.2f) + 1.0f;
        return;
    }
    if (func_80A36504 == temp_v0) {
        if (temp_f2 < 3.0f) {
            ...
            arg0->unk_1DC = (temp_f2 - 2.0f) + 1.0f;
        } else {
            arg0->unk_1DC = 2.0f - ((temp_f2 - 3.0f) * 0.333f);
        }
        arg0->unk_1E0 = 1.0f;
        phi_f14 = 1.0f;
        goto block_30;
    ...
    if (func_80A365EC == temp_v0) {
        temp_f2_2 = temp_f2 + (f32) arg0->unk_2A4;
        if (temp_f2_2 >= 35.0f) {
            arg0->unk_1E0 = 1.0f;
            arg0->unk_1DC = 1.0f;
            phi_f14 = 1.0f;
        ...
        if (temp_f2_2 < 4.0f) {
            ...
            arg0->unk_1E0 = temp_f0_3;
            arg0->unk_1D8 = temp_f0_3;
            arg0->unk_1DC = (temp_f2_2 * 0.1666f) + 1.0f;
            return;
        }
        if (temp_f2_2 < 25.0f) {
            temp_f0_4 = temp_f2_2 - 4.0f;
            temp_f12_3 = (temp_f0_4 * 0.01f) + 0.8f;
            arg0->unk_1E0 = temp_f12_3;
            arg0->unk_1D8 = temp_f12_3;
            arg0->unk_1DC = 1.5f - (temp_f0_4 * 0.025f);
            return;
        }
        if (temp_f2_2 < 27.0f) {
            temp_f0_5 = ((temp_f2_2 - 24.0f) * 0.25f) + 1.0f;
            arg0->unk_1E0 = temp_f0_5;
            arg0->unk_1DC = temp_f0_5;
            arg0->unk_1D8 = temp_f0_5;
            return;
        }
        if (temp_f2_2 < 30.0f) {
            temp_f0_6 = 1.5f - ((temp_f2_2 - 26.0f) * 0.233f);
            arg0->unk_1E0 = temp_f0_6;
            arg0->unk_1DC = temp_f0_6;
            arg0->unk_1D8 = temp_f0_6;
            return;
        }
        temp_f0_7 = ((temp_f2_2 - 29.0f) * 0.04f) + 0.8f;
        arg0->unk_1E0 = temp_f0_7;
        arg0->unk_1DC = temp_f0_7;
        arg0->unk_1D8 = temp_f0_7;
        return;
    }
    arg0->unk_1E0 = 1.0f;
    arg0->unk_1DC = 1.0f;
...
void EnSyatekiOkuta_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, func_80A37294, NULL, (Actor *) this);
