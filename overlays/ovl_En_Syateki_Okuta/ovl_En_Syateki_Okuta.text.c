...
static ActorAnimationEntry D_80A3759C = {
...
static InitChainEntry D_80A37B88;                   /* unable to generate initializer */
...
typedef struct EnSyatekiOkuta {
    ...
    /* 0x0188 */ void (*actionFunc)(EnSyatekiOkuta *, GlobalContext *);
    ...
    /* 0x024A */ char pad24A[0x5A];                 /* maybe part of unk244[16]? */
    /* 0x02A4 */ s16 unk2A4;                        /* inferred */
    /* 0x02A6 */ s16 unk2A6;                        /* inferred */
    /* 0x02A8 */ char pad2A8[0x2];                  /* maybe part of unk2A6[2]? */
...
void EnSyatekiOkuta_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80A37570);
...
void func_80A365EC(EnSyatekiOkuta *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0_2 < 3) {
        Actor_SetScale(&this->actor, (((f32) temp_v0_2 * 0.25f) + 1.0f) * 0.01f);
        return;
    }
    if ((s32) temp_v0_2 < 6) {
        Actor_SetScale(&this->actor, (1.5f - ((f32) (temp_v0_2 - 2) * 0.2333f)) * 0.01f);
        return;
    }
    if ((s32) temp_v0_2 < 0xB) {
        Actor_SetScale(&this->actor, (((f32) (temp_v0_2 - 5) * 0.04f) + 0.8f) * 0.01f);
        return;
    }
    if (Math_StepToF(&this->actor.scale.x, 0.0f, 0.002f) != 0) {
        ...
        do {
            ...
            EffectSsDtBubble_SpawnCustomColor(globalCtx, &temp_s1->pos, (Vec3f *) &sp84, &D_80A37B98, &D_80A37BA4, &D_80A37BA8, (s16) Rand_S16Offset(0x64, 0x32), (s16) 0x19, (s16) 0);
            temp_s0_2 = phi_s0 + 1;
            phi_s0 = temp_s0_2;
        } while (temp_s0_2 != 0xA);
        func_80A362F8(&this->actor);
...
void EnSyatekiOkuta_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80A36AF8(&this->actor, globalCtx);
...
void EnSyatekiOkuta_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80A37294, NULL, &this->actor);
