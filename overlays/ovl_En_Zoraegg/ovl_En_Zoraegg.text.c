...
struct _mips2c_stack_func_80B32F04 {
    ...
    /* 0x64 */ char pad64[0x10];                    /* maybe part of sp62[9]? */
...
void EnZoraegg_Init(EnZoraegg *this, GlobalContext *globalCtx) {
    ? sp40;
    SkelAnime *sp34;
    SkelAnime *temp_a1;
    s16 temp_v0;
...
void EnZoraegg_Destroy(EnZoraegg *this, GlobalContext *globalCtx) {
    EnZoraegg *this = (EnZoraegg *) thisx;
...
void func_80B324B0(EnZoraegg *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, (u32) arg0->unk1F0) != 0) {
        ...
        func_800EDF24((Actor *) arg0, arg1, func_800EE200(arg1, (u32) arg0->unk1F0));
...
void EnZoraegg_Update(EnZoraegg *this, GlobalContext *globalCtx) {
    EnZoraegg *temp_a2;
    s16 temp_v1;
    s16 phi_v0;
    s16 phi_v1;
...
void func_80B32F04(GlobalContext *arg0, GraphicsContext **arg1) {
    ...
    sp4C.unk0 = (s32) temp_t9->unk5C;
    sp4C.unk4 = (s32) temp_t9->unk60;
    sp4C.unk8 = (s32) temp_t9->unk64;
    sp20 = temp_a1;
...
void EnZoraegg_Draw(EnZoraegg *this, GlobalContext *globalCtx) {
    u8 temp_v0;
    u8 phi_v0;
    EnZoraegg *this = (EnZoraegg *) thisx;
