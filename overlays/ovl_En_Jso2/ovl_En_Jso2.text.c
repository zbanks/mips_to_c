...
typedef struct EnJso2 {
    ...
    /* 0x018E */ char pad18E[0x6];
    /* 0x0194 */ ? unk194;                          /* inferred */
    /* 0x0194 */ char pad194[0x6];
    /* 0x019A */ ? unk19A;                          /* inferred */
    /* 0x019A */ char pad19A[0x66];
    ...
    /* 0x02AC */ char pad2AC[0x4];
    /* 0x02B0 */ s16 unk2B0;                        /* inferred */
    /* 0x02B2 */ char pad2B2[0x2];
    ...
    /* 0x02E0 */ char pad2E0[0x86];                 /* maybe part of unk2D4[12]? */
    ...
    /* 0x0E64 */ char padE64[0x48];                 /* maybe part of unkE58[7]? */
    /* 0x0EAC */ ActorContext unkEAC;               /* inferred */
    /* 0x0EF4 */ ColliderCylinder unkEF4;           /* overlap; inferred */
...
void EnJso2_Init(EnJso2 *this, GlobalContext *globalCtx) {
    s32 sp370;
    s32 sp36C;
    s32 sp368;
    s8 sp367;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unkEF4, (Actor *) this, &D_80A7B608);
    Collider_InitAndSetQuad(globalCtx, &this->unkF40, (Actor *) this, &D_80A7B634);
    Collider_InitAndSetQuad(globalCtx, &this->unkFC0, (Actor *) this, &D_80A7B634);
    sp360 = 0xFF;
    sp364 = 0xFF;
    sp1C0 = 0xFF;
    sp1C6 = 0xFF;
    ...
    sp1BD = 0;
    sp1BE = 0;
    Effect_Add(globalCtx, &this->unk380, 1, 0U, (u8) 0, (void *) &sp1D4);
    Effect_Add(globalCtx, &this->unk384, 1, 0U, (u8) 0, (void *) &sp34);
    this->unk378 = 0.042f;
...
void EnJso2_Destroy(EnJso2 *this, GlobalContext *globalCtx) {
    EnJso2 *this = (EnJso2 *) thisx;
...
void func_80A778F8(EnJso2 *this, GlobalContext *globalCtx) {
    ...
    case 1:
        if (ActorCutscene_GetCanPlayNext((s16) this->actor.cutscene) == 0) {
            ...
            this->unkEAC.clearedRooms = 82.0f;
            this->unk1080 = 780.0f;
            ...
            Math_Vec3f_Copy(&this->unk1054, temp_s0_2);
            Math_Vec3f_Copy(&this->unk1060, (Vec3f *) &this->unk1084);
            func_800B7298(globalCtx, (Actor *) this, 6U);
            func_80122744(globalCtx, (void *) &this->unk27C, 1U, &D_80A7B6F4);
            this->unk1046 += 1;
        }
        break;
    case 2:
        ...
        this->unk108C = this->actor.world.pos.z + 100.0f;
        Math_Vec3f_Copy(&this->unk1054, temp_s0_3);
        Math_Vec3f_Copy(&this->unk1060, (Vec3f *) &this->unk1084);
        if (func_80122760(globalCtx, (void *) &this->unk27C, 60.0f) != 0) {
    ...
    case 9:
        ...
        sp54 = temp_a1_2;
        Math_Vec3f_Copy(this + (this->unk38C * 0xC) + 0x390, (Vec3f *) temp_a1_2);
        ...
        if (this->unk1044 == 0) {
            this->unk1078.x = this->unk2B8.x - 490.0f;
            this->unk1078.y = this->unk2B8.y;
            this->unk1078.z = this->unk2B8.z + 100.0f;
        }
        this->unk1084 = this->actor.focus.pos.x - 80.0f;
    ...
    case 10:
        ...
        Math_Vec3f_Copy(this + (this->unk38C * 0xC) + 0x390, (Vec3f *) &this->actor.world);
        Math_Vec3s_Copy(this + (this->unk38C * 6) + 0x480, &this->actor.world.rot);
        ...
        if (this->unk1044 == 0) {
            this->unk1078.x = this->unk2B8.x - 518.0f;
            this->unk1078.y = this->unk2B8.y - 11.0f;
            this->unk1078.z = this->unk2B8.z + 100.0f;
        }
    ...
    case 11:
        ...
        if (this->unk1044 == 0) {
            this->unk1078.x = this->unk2B8.x - 470.0f;
            this->unk1078.y = this->unk2B8.y - 10.0f;
            this->unk1078.z = this->unk2B8.z + 100.0f;
            this->unk1084 = this->actor.focus.pos.x - 80.0f;
            this->unk108C = this->actor.focus.pos.z;
...
void func_80A78C7C(EnJso2 *this, GlobalContext *globalCtx) {
    ...
    if (((temp_v0 & 4) != 0) || ((this->unkFC0.base.atFlags & 4) != 0)) {
        ...
        Math_Vec3f_Copy(&this->unkE58, (Vec3f *) &sp2C);
        this->unk368 = 1;
        this->unk28A = 0;
...
void func_80A7919C(EnJso2 *this, GlobalContext *globalCtx) {
    ...
    if (((phi_v0 & 4) != 0) || ((phi_v1 & 4) != 0)) {
        ...
        Math_Vec3f_Copy(&this->unkE58, (Vec3f *) &sp44);
        this->unk368 = 1;
        func_80A79864(this);
        return;
    }
...
void func_80A79524(EnJso2 *arg0) {
    ...
    Math_Vec3f_Copy(&arg0->unkE58, (Vec3f *) &sp24);
    temp_v0 = arg0->unk2A2;
...
void func_80A79600(EnJso2 *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk290 == 0) && (this->unk2A0 == 0)) {
        ...
        if ((temp_v0_2 == 0xB) || (temp_v0_2 == 0xA)) {
            func_800BF7CC(globalCtx, (Actor *) this, (Vec3f []) &this->unk2D4, 0xC, 2, 0.7f, 0.4f);
            this->unk2A0 = 0;
            this->unk2A2 = 0;
        }
        func_80A79864(this);
...
void func_80A796BC(EnJso2 *arg0, GlobalContext *arg1) {
    ...
    Math_Vec3f_Copy(&arg0->unkE58, (Vec3f *) &sp34);
    temp_v0 = arg0->unk2A2;
    if (((temp_v0 == 0xB) || (temp_v0 == 0xA)) && (arg0->unk2A0 != 0)) {
        func_800BF7CC(arg1, (Actor *) arg0, (Vec3f []) &arg0->unk2D4, 0xC, 2, 0.7f, 0.4f);
        arg0->unk2A0 = 0;
        arg0->unk2A2 = 0;
    }
...
void func_80A79BA0(EnJso2 *this, GlobalContext *globalCtx) {
    ...
    if (((s32) this->unkEAC.targetContext.unk50[1].unk10 == 0x15) && (this->unk374 <= temp_f0) && (this->unk2D0 == 0)) {
        sp58 = temp_f0;
        this->unk2D0 = Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, 0x1D9, this->unk2C4, this->unk2C8, this->unk2CC, (s16) 0, (s16) 0, (s16) 0, 3);
    }
    temp_v0 = this->unk2D0;
    if (temp_v0 != 0) {
...
block_24:
    ...
    if (this->unk1048 != 0) {
        ...
        this->unkEAC.clearedRooms = (bitwise u32) (temp_f0_2 + sp4C);
        ...
        this->unkEAC.collectibleFlags[0] = (bitwise u32) (temp_f2 + sp54);
...
void func_80A7A124(EnJso2 *this, GlobalContext *globalCtx) {
    ...
    if (((s32) this->unkEAC.targetContext.unk50[1].unk10 == 0x15) && (this->unk374 <= sp44)) {
        temp_v0 = this->unk2D0;
        if (temp_v0 == 0) {
            this->unk2D0 = Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, 0x1D9, this->unk2C4, this->unk2C8, this->unk2CC, (s16) 0, (s16) 0, (s16) 0, 4);
            goto block_15;
        }
...
void EnJso2_Update(EnJso2 *this, GlobalContext *globalCtx) {
    ...
    Actor_SetScale((Actor *) this, this->unk378);
    ...
    if ((this->actor.bgCheckFlags & 1) != 0) {
        ...
        Math_ApproachZeroF((f32 *) &this->unkE58, 1.0f, 2.0f);
...
void func_80A7AA9C(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 4) {
        ...
        if (((temp_v0_2 == 7) || (temp_v0_2 == 8) || (temp_v0_2 == 6) || (temp_v0_2 == 0x10)) && (arg4->unk368 == 0)) {
            func_800A81F0(Effect_GetParams(arg4->unk384), (Vec3f *) &sp68, (Vec3f *) &sp5C);
    ...
    if (arg1 == 6) {
        ...
        if (((temp_v0_4 == 7) || (temp_v0_4 == 8) || (temp_v0_4 == 6) || (temp_v0_4 == 0x10)) && (arg4->unk368 == 0)) {
            func_800A81F0(Effect_GetParams(arg4->unk380), (Vec3f *) &sp68, (Vec3f *) &sp5C);
        } else if (arg4->unk368 == 1) {
...
void EnJso2_Draw(EnJso2 *this, GlobalContext *globalCtx) {
    f32 sp68;
    Vec3s *sp64;
    MtxF *sp5C;
    Gfx *temp_v0;
    ...
    if (this->unk2B4 == 0) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A7AA48, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80A7AA9C, (Actor *) this);
    } else {
        ...
        temp_s2->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, NULL, (Actor *) this, temp_s2->polyXlu.p);
    }
        ...
        if (temp_v0_3 > 0) {
            ...
            do {
                if (*phi_s4 == 0) {
                    ...
                    Scene_SetRenderModeXlu(globalCtx, 1, 2U);
                    temp_s1 = phi_s1 - 1;
                    temp_s2->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, sp64, (s32) this->unk144.dListCount, NULL, NULL, (Actor *) this, temp_s2->polyXlu.p);
                    phi_s1 = (s16) temp_s1;
                    if (temp_s1 < 0) {
                        phi_s1 = 0x13;
                    }
    ...
    if (temp_v1 != 0) {
        ...
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2D4, this->unk2B0, this->unk2A4, this->unk2A8, temp_f6 * 0.05f, (u8) (s32) this->unk2A2);
    }
}
