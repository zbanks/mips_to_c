...
void EffStk_Init(EffStk *this, GlobalContext *globalCtx) {
    EffStk *this = (EffStk *) thisx;
    Actor_SetScale((Actor *) this, 0.2f);
    this->actionFunc = func_80BF0DE0;
}

void EffStk_Destroy(EffStk *this, GlobalContext *globalCtx) {
    EffStk *this = (EffStk *) thisx;
...
void EffStk_Update(EffStk *this, GlobalContext *globalCtx) {
    EffStk *this = (EffStk *) thisx;
    this->actionFunc(this, globalCtx);
}

void EffStk_Draw(EffStk *this, GlobalContext *globalCtx) {
    f32 sp50;
    f32 sp44;
    Gfx *sp38;
    Camera *temp_a1;
