...
void ObjHgdoor_Init(ObjHgdoor *this, GlobalContext *globalCtx) {
...
void ObjHgdoor_Destroy(ObjHgdoor *this, GlobalContext *globalCtx) {
    ObjHgdoor *this = (ObjHgdoor *) thisx;
...
void ObjHgdoor_Update(ObjHgdoor *this, GlobalContext *globalCtx) {
    ObjHgdoor *this = (ObjHgdoor *) thisx;
    this->actionFunc(this, globalCtx);
    func_80BD4500(this);
}

void ObjHgdoor_Draw(ObjHgdoor *this, GlobalContext *globalCtx) {
