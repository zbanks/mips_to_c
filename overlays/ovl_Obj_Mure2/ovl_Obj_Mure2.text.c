...
static InitChainEntry D_809615F4;                   /* unable to generate initializer */

typedef struct ObjMure2 {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(ObjMure2 *, GlobalContext *);
    /* 0x0148 */ Actor *unk148;                     /* inferred */
    /* 0x014C */ char pad14C[0x2C];                 /* maybe part of unk148[12]? */
...
void func_80960CF0(Vec3f *arg0, void *arg1) {
    ...
    phi_s0 = arg0 + 0xC;
    phi_s3 = 1;
    if ((s32) *(&D_809615A8 + ((arg1->unk1C & 3) * 2)) >= 2) {
        phi_s1 = 0;
        do {
            ...
            temp_s3 = phi_s3 + 1;
            temp_s0 = phi_s0 + 0xC;
            temp_s0->unk-4 = (f32) (phi_s0->z + (80.0f * Math_CosS(phi_s1)));
            phi_s0 = temp_s0;
            phi_s1 += 0x2000;
            phi_s3 = temp_s3;
        } while (temp_s3 < (s32) *(&D_809615A8 + ((arg1->unk1C & 3) * 2)));
    }
}
...
void func_80960E0C(Vec3f *arg0, void *arg1) {
    ...
    phi_s1 = &D_809615B8;
    phi_s2 = 0;
    if ((s32) *(&D_809615A8 + ((arg1->unk1C & 3) * 2)) > 0) {
        do {
            Math_Vec3f_Copy(phi_s0, arg1 + 0x24);
            phi_s0->x += (f32) phi_s1->unk0 * Math_CosS(phi_s1->unk2);
            temp_s2 = phi_s2 + 1;
            temp_s0 = phi_s0 + 0xC;
            temp_s0->unk-4 = (f32) (phi_s0->z - ((f32) phi_s1->unk0 * Math_SinS(phi_s1->unk2)));
            phi_s0 = temp_s0;
            phi_s1 += 4;
            phi_s2 = temp_s2;
        } while (temp_s2 < (s32) *(&D_809615A8 + ((arg1->unk1C & 3) * 2)));
    }
}
...
void func_8096104C(ObjMure2 *arg0, GlobalContext *arg1) {
    ...
    *(&D_809615E8 + (temp_s0 * 4))(&sp80, arg0);
    ...
    if ((s32) temp_v0 > 0) {
        do {
            if (phi_s0->unk148 == 0) {
                if ((((s32) arg0->unk178 >> phi_s2) & 1) == 0) {
                    temp_v0_2 = &sp80 + (phi_s2 * 0xC);
                    temp_v0_3 = Actor_SpawnAsChildAndCutscene(arg1 + 0x1CA0, arg1, *(&D_809615B0 + temp_s6), temp_v0_2->unk0, temp_v0_2->unk4, temp_v0_2->unk8, (s16) (s32) arg0->actor.world.rot.x, (s16) 0, (s16) (s32) arg0->actor.world.rot.z, (s32) sp7E, (u32) arg0->actor.cutscene, (s32) arg0->actor.unk20, NULL);
                    phi_s0->unk148 = temp_v0_3;
                    if (temp_v0_3 != 0) {
...
void func_809611BC(ObjMure2 *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        do {
            if ((((s32) arg0->unk178 >> phi_s2) & 1) == 0) {
                temp_a0 = phi_s0->unk148;
                if (temp_a0 != 0) {
                    if (Actor_HasParent(temp_a0, arg1) != 0) {
                        arg0->unk178 |= 1 << phi_s2;
                    } else {
                        Actor_MarkForDeath(phi_s0->unk148);
                    }
                    phi_s0->unk148 = NULL;
...
void func_809612BC(ObjMure2 *arg0) {
    ...
    if ((s32) temp_v1 > 0) {
        do {
            temp_a2 = phi_a1->unk148;
            if (temp_a2 != 0) {
                temp_a3 = arg0->unk178;
                if (((((s32) temp_a3 >> phi_v0) & 1) == 0) && (temp_a2->update == 0)) {
                    arg0->unk178 = temp_a3 | (1 << phi_v0);
                    phi_a1->unk148 = NULL;
...
void func_809613FC(ObjMure2 *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = this;
    if (Math3D_XZLengthSquared(this->actor.projectedPos.x, this->actor.projectedPos.z) < (*(&D_80961590 + ((temp_a0->actor.params & 3) * 4)) * temp_a0->unk17C)) {
...
void func_80961490(ObjMure2 *this, GlobalContext *globalCtx) {
    func_809612BC(this);
    if ((*(&D_8096159C + ((this->actor.params & 3) * 4)) * this->unk17C) <= Math3D_XZLengthSquared(this->actor.projectedPos.x, this->actor.projectedPos.z)) {
