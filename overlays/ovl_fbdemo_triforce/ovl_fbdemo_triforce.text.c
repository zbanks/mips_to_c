...
struct _mips2c_stack_TransitionTriforce_Draw {
    ...
    /* 0x28 */ char pad_28[0x48];                   /* maybe part of sp24[19]? */
...
void TransitionTriforce_Update(void *thisx, s32 updateRate) {
    ...
    if (updateRate > 0) {
        do {
            ...
            phi_v0 = temp_v0;
            if (temp_v1 == 1) {
                temp_f0 = thisx->unk_4 * (1.0f - thisx->unk_8);
                phi_f0 = temp_f0;
                if (temp_f0 < 0.03f) {
                    thisx->unk_4 = 0.03f;
                } else {
                ...
                temp_f0_2 = thisx->unk_4 - thisx->unk_8;
                phi_f0 = temp_f0_2;
                if (temp_f0_2 < 0.03f) {
                    thisx->unk_4 = 0.03f;
                } else {
                ...
                temp_f0_3 = thisx->unk_4 / (1.0f - thisx->unk_8);
                phi_f0 = temp_f0_3;
                if (temp_f0_3 > 1.0f) {
                    thisx->unk_4 = 1.0f;
                } else {
                ...
                temp_f0_4 = thisx->unk_4 + thisx->unk_8;
                phi_f0 = temp_f0_4;
                if (temp_f0_4 > 1.0f) {
                    thisx->unk_4 = 1.0f;
                } else {
...
void TransitionTriforce_Draw(void *thisx, Gfx **gfxP) {
    ...
    sp70 = temp_f0 * 360.0f;
    temp_v0 = thisx->unk_58;
    temp_a0 = thisx + (temp_v0 * 0xC0) + 0x60;
    thisx->unk_58 = (s32) (temp_v0 ^ 1);
    sp80 = temp_a0;
    sp84 = temp_v1;
