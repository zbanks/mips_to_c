typedef struct EnNeoReeba {
    ...
    /* 0x1DA */ char pad1DA[0x66];                  /* maybe part of unk1D4[18]? */
    /* 0x240 */ Vec3s unk240;                       /* inferred */
    /* 0x246 */ char pad246[0x66];                  /* maybe part of unk240[18]? */
    ...
    /* 0x2C8 */ char pad2C8[0x30];                  /* maybe part of unk2C4[13]? */
    /* 0x2F8 */ f32 unk2F8;                         /* inferred */
    /* 0x2FC */ f32 unk2FC;                         /* inferred */
    /* 0x300 */ char pad300[0x8];                   /* maybe part of unk2FC[3]? */
    /* 0x308 */ s16 unk308;                         /* inferred */
    /* 0x30A */ s16 unk30A;                         /* inferred */
    /* 0x30C */ s16 unk30C;                         /* inferred */
    /* 0x30E */ s16 unk30E;                         /* inferred */
    /* 0x310 */ u8 unk310;                          /* inferred */
    /* 0x311 */ char pad311[0x3];                   /* maybe part of unk310[4]? */
...
void EnNeoReeba_Init(EnNeoReeba *this, GlobalContext *globalCtx) {
...
void EnNeoReeba_Destroy(EnNeoReeba *this, GlobalContext *globalCtx) {
    EnNeoReeba *this = (EnNeoReeba *) thisx;
...
void EnNeoReeba_Update(EnNeoReeba *this, GlobalContext *globalCtx) {
...
void EnNeoReeba_Draw(EnNeoReeba *this, GlobalContext *globalCtx) {
    Gfx *temp_v1;
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80B7E378, NULL, (Actor *) this);
