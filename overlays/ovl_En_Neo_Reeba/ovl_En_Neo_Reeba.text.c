...
typedef struct EnNeoReeba {
    ...
    /* 0x02AC */ void (*actionFunc)(EnNeoReeba *, GlobalContext *);
    ...
    /* 0x0310 */ u8 unk310;                         /* inferred */
    /* 0x0311 */ char pad311[0x3];                  /* maybe part of unk310[4]? */
...
void EnNeoReeba_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->unk144, &D_06001EE8, &D_060001E4, &this->unk1D4, &this->unk240, 0x12);
    ...
    temp_a1 = &this->unk188;
    this->unk2B0 = D_801D15B0.x;
    this->unk2B4 = D_801D15B0.y;
    this->unk2B8 = D_801D15B0.z;
    this->unk2BC = D_801D15B0.x;
    this->unk2C0 = D_801D15B0.y;
    this->unk308 = 0;
    this->unk30C = 0;
    this->unk30E = 0;
    this->unk30A = 0;
    this->unk2F8 = 0.0f;
    this->unk2FC = 0.0f;
    this->unk2C4 = D_801D15B0.z;
    sp30 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80B7E520);
    func_80B7CA34(this);
}
...
void func_80B7CA70(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk30A = (s16) (temp_v0 - 1);
}

void func_80B7CB3C(Actor *arg0) {
    arg0->shape.yOffset = 0.0f;
    if (func_80B7CFFC == arg0->unk2AC) {
        arg0->unk30A = 0x14;
    } else {
        arg0->unk30A = 0xA;
    }
    arg0->unk2AC = func_80B7CB88;
    arg0->unk160 = 1.0f;
}
...
void func_80B7CB88(Actor *arg0, void *arg1) {
    ...
    if (arg0->unk30A == 0) {
        if ((temp_f0 < 140.0f) && (temp_f2 < 100.0f)) {
            arg0->unk2B0 = (f32) temp_s1->world.pos.x;
            arg0->unk2B4 = (f32) temp_s1->world.pos.y;
            arg0->unk2B8 = (f32) temp_s1->world.pos.z;
            arg0->unk2B0 = (f32) (arg0->unk2B0 + (10.0f * temp_s1->speedXZ * Math_SinS(temp_s1->world.rot.y)));
            arg0->unk2B8 = (f32) (arg0->unk2B8 + (10.0f * temp_s1->speedXZ * Math_CosS(temp_s1->world.rot.y)));
            func_80B7CFA0(arg0);
        } else {
...
void func_80B7CCE0(Actor *arg0) {
    ...
    arg0->unk2AC = func_80B7CD28;
}

void func_80B7CD28(EnNeoReeba *arg0, GlobalContext *arg1) {
    f32 temp_f0;

    if (Math_SmoothStepToF(arg0 + 0xC4, -2000.0f, 0.5f, arg0->unk2F8, 10.0f) == 0.0f) {
        func_80B7CA34(arg0);
...
void func_80B7CE94(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Math_SmoothStepToF(arg0 + 0xC4, 0.0f, 0.5f, arg0->unk2F8, 10.0f) == 0.0f) {
        func_80B7CB3C(arg0);
    } else if ((arg1->gameplayFrames & 3) == 0) {
...
void func_80B7CFFC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 0) {
        ...
        arg0->unk30C = (s16) (temp_v0 - 1);
    }
    temp_v0_2 = arg0->unk30A;
    if (temp_v0_2 == 0) {
        func_80B7CB3C(arg0);
        return;
    }
    arg0->unk30A = (s16) (temp_v0_2 - 1);
}

void func_80B7D130(void *arg0) {
    arg0->unk2AC = func_80B7D150;
    arg0->unk70 = 6.0f;
}
...
void func_80B7D254(Actor *arg0) {
    ...
    arg0->unk2B0 = (f32) arg0->world.pos.x;
    arg0->unk30A = 0x3C;
    temp_a0 = arg0->yawTowardsPlayer;
    arg0->unk2B4 = (s32) arg0->world.pos.y;
    arg0->unk2B8 = (f32) arg0->world.pos.z;
    arg0 = arg0;
    arg0->unk2B0 = (f32) (arg0->unk2B0 - (20.0f * Math_SinS(temp_a0)));
    temp_f6 = 20.0f * Math_CosS(arg0->yawTowardsPlayer);
    arg0->unk2AC = func_80B7D2E4;
    arg0->unk2B8 = (f32) (arg0->unk2B8 - temp_f6);
}
...
void func_80B7D3EC(Actor *arg0) {
    ...
    if ((arg0->params & 0x8000) != 0) {
        arg0->unk304 = (f32) (arg0->unk304 * 1.5f);
    }
...
void func_80B7D4FC(Actor *arg0) {
    arg0->unk30A = 0xA;
    arg0->unk160 = 1.0f;
    arg0->unk2BC = (f32) (Math_SinS(arg0->yawTowardsPlayer) * -12.0f);
    arg0->unk2C4 = (f32) (Math_CosS(arg0->yawTowardsPlayer) * -12.0f);
    arg0->unk2FC = 4551.0f;
    func_800BCB70(arg0, 0x4000, 0xFF, 0, (s16) 0x19);
    Audio_PlayActorSound2(arg0, 0x3988U);
    arg0->unk2AC = func_80B7D5A4;
}
...
void func_80B7D5A4(Actor *arg0, GlobalContext *arg1) {
    ...
    func_800BBDAC(arg1, arg0, &arg0->world.pos, arg0->shape.shadowScale, 1, 4.0f, (s16) 0xFA, (s16) 0xA, (u8) 1);
    arg0->unk30A = (s16) (arg0->unk30A - 1);
}
...
void func_80B7D788(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = temp_v1 * 4;
    if ((s32) temp_v1 < 0xB) {
        arg0->unk308 = (s16) (arg0->unk308 - 0x1388);
        temp_f0 = *(&D_80B7E54C + temp_v0);
        arg0->scale.z = temp_f0;
        arg0->scale.x = temp_f0;
        arg0->scale.y = *(&D_80B7E578 + temp_v0);
...
void func_80B7D9B8(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk199;
    if ((temp_v0 & 2) != 0) {
        arg0->unk199 = (u8) (temp_v0 & 0xFFFD);
        if (func_80B7D47C == arg0->unk2AC) {
            temp_t0 = arg0->colChkInfo.damageEffect;
            switch (temp_t0) { // switch 1
            default: // switch 1
                if ((s32) arg0->unk30E >= 2) {
...
block_7:
        ...
        if ((((arg0->unk19B & 1) != 0) || ((arg0->unk198 & 4) != 0)) && (func_80B7CFFC == arg0->unk2AC)) {
            func_80B7D254(arg0);
        }
block_26:
        temp_v0_3 = arg0->unk2AC;
        if ((func_80B7CA70 != temp_v0_3) && (func_80B7CD28 != temp_v0_3) && (func_80B7CE94 != temp_v0_3) && (func_80B7D5A4 != temp_v0_3) && (func_80B7D788 != temp_v0_3)) {
            ...
            sp28 = temp_a1_2;
            CollisionCheck_SetOC(arg1, temp_a1_2, &sp2C->base);
            CollisionCheck_SetAC(arg1, temp_a1_2, &sp2C->base);
            if (func_80B7D398 != arg0->unk2AC) {
                CollisionCheck_SetAT(arg1, sp28, &sp2C->base);
            }
        }
    }
}
...
void func_80B7DC80(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((func_80B7CA70 != temp_v0) && (func_80B7CD28 != temp_v0) && (func_80B7CE94 != temp_v0)) {
        ...
        arg0->world.pos.x += arg0->unk2BC;
        arg0->world.pos.z += arg0->unk2C4;
...
void func_80B7DD7C(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s0 = arg0;
    do {
        phi_s2->unk0 = (s32) temp_s5->unk0;
        phi_s2->unk4 = (f32) temp_s5->unk4;
        phi_s2->unk8 = (s32) temp_s5->unk8;
        phi_s0->unk2C8 = (f32) (phi_s0->unk2C8 + (phi_f20 * Math_SinS((s16) (arg0->shape.rot.y + phi_s1))));
        temp_s1 = phi_s1 + 0x5555;
        temp_s0 = phi_s0 + 0xC;
        temp_s0->unk2C4 = (f32) (phi_s0->unk2D0 + (phi_f20 * Math_CosS((s16) (arg0->shape.rot.y + phi_s1))));
        temp_s0->unk2C0 = (f32) (phi_s0->unk2CC + 5.0f);
        phi_s2 += 0xC;
        phi_s1 = temp_s1;
        phi_s0 = temp_s0;
    } while (temp_s1 != 0xFFFF);
    arg0->unk2EC = (s32) temp_s5->unk0;
    arg0->unk2F0 = (f32) temp_s5->unk4;
    arg0->unk2F4 = (s32) temp_s5->unk8;
    arg0->unk2F0 = (f32) (arg0->unk2F0 + sp54);
    arg0->unk304 = sp50;
    func_800BE680(arg1, arg0, (Vec3f []) (arg0 + 0x2C8), 4, sp50, 0.5f, arg0->unk300, (u8) (s32) arg0->unk310);
}
...
void func_80B7DF34(EnNeoReeba *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 == 0) || (temp_v0 == 0x14) || (temp_v0 == 0x1E)) {
        ...
        do {
            phi_s2->unk0 = (s32) temp_s5->unk0;
            phi_s2->unk4 = (s32) temp_s5->unk4;
            phi_s2->unk8 = (s32) temp_s5->unk8;
            phi_s0->unk2C8 += phi_f20 * Math_SinS((s16) (arg0->actor.shape.rot.y + phi_s1));
            temp_s1 = phi_s1 + 0x5555;
            temp_s0 = phi_s0 + 0xC;
            temp_f4 = phi_s0->unk2D0 + (phi_f20 * Math_CosS((s16) (arg0->actor.shape.rot.y + phi_s1)));
            temp_s0->unk2C0 = phi_s0->unk2CC + -20.0f;
            temp_s0->unk2C4 = temp_f4;
            phi_s2 += 0xC;
            phi_s1 = temp_s1;
            phi_s0 = temp_s0;
        } while (temp_s1 != 0xFFFF);
        arg0->unk2EC = temp_s5->unk0;
        arg0->unk2F0 = temp_s5->unk4;
        arg0->unk2F4 = temp_s5->unk8;
        func_800BE680(arg1, NULL, (Vec3f []) (arg0 + 0x2C8), 4, arg0->unk304, 0.5f, arg0->unk300, (u8) (s32) arg0->unk310);
    }
}
...
void EnNeoReeba_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->actor.params & 0x8000) != 0) {
        this->unk188.dim.radius = 0x1B;
        this->unk188.dim.height = 0x2D;
    }
    ...
    func_80B7D9B8(&this->actor, globalCtx);
    func_80B7DC80(&this->actor, globalCtx);
    func_80B7E260(this, globalCtx);
}

s32 func_80B7E378(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    if ((arg1 == 3) && (arg5->unk2FC != 0.0f)) {
        arg4->y += (s32) (arg5->unk2FC * Math_SinS(arg5->unk308));
        arg4->z += (s32) (arg5->unk2FC * Math_CosS(arg5->unk308));
    }
    return 0;
}
...
void EnNeoReeba_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80B7E378, NULL, &this->actor);
    if ((s32) this->unk30E > 0) {
        if (this->unk310 == 0xB) {
            func_80B7DD7C(&this->actor, globalCtx);
            return;
        }
