typedef struct BgBreakwall {
    ...
    /* 0x15C */ s8 unk_15C;                         /* inferred */
    /* 0x15D */ s8 unk_15D;                         /* inferred */
    /* 0x15E */ char pad_15E[0x2];                  /* maybe part of unk_15D[3]? */
...
? func_808B7460(void *arg0, GlobalContext *arg1) {
    if (Flags_GetSwitch(arg1, (s32) arg0->unk_15D) == 0) {
        arg0->unk_58 = 0.1f;
    }
    return 1;
}
...
void BgBreakwall_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_15C = Object_GetIndex(&globalCtx->objectCtx, sp24->unk_0);
    if (((s32) this->unk_15C < 0) || (sp24->unk_14(this, globalCtx) == 0)) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    BgBreakwall_SetupAction(this, func_808B76CC);
    this->unk_15D = (s8) ((s32) (this->actor.params & 0xFE00) >> 9);
}

void func_808B767C(Actor *arg0, GlobalContext *arg1) {
    if ((((arg0->params & 0xF) << 5) + &D_808B8140)->unk_10 != 0) {
...
void func_808B76CC(BgBreakwall *arg0, GlobalContext *arg1) {
    ...
    if (Object_IsLoaded(&arg1->objectCtx, (s32) arg0->unk_15C) != 0) {
        temp_v0 = arg0->actor.params & 0xF;
        temp_s1 = (temp_v0 << 5) + &D_808B8140;
        arg0->actor.draw = func_808B7FE4;
        arg0->actor.objBankIndex = arg0->unk_15C;
        if ((temp_v0 != 7) && (temp_v0 != 9) && (temp_v0 != 0xB)) {
            arg0->actor.flags &= -0x11;
        }
        Actor_SetObjectSegment(arg1, (Actor *) arg0);
        temp_a0 = temp_s1->unk_C;
        if (temp_a0 != 0) {
            temp_s1->unk_C = Lib_SegmentedToVirtual(temp_a0);
        }
        if (temp_s1->unk_10 != 0) {
            BcCheck3_BgActorInit((DynaPolyActor *) arg0, 0);
            BgCheck3_LoadMesh(arg1, (DynaPolyActor *) arg0, temp_s1->unk_10);
        }
        BgBreakwall_SetupAction(arg0, temp_s1->unk_18);
...
void func_808B7914(void *arg0, GlobalContext *arg1) {
    ...
    if ((arg1->gameplayFrames & 7) == 0) {
        sp30 = Rand_ZeroFloat(80.0f) + (arg0->unk_24 - 55.0f);
        sp34 = arg0->unk_28 + 70.0f;
        temp_f0 = Rand_ZeroFloat(80.0f);
        sp24 = 0.0f;
        sp2C = 0.0f;
        sp28 = 0.5f;
        sp38 = temp_f0 + (arg0->unk_2C - 130.0f);
...
void func_808B7A10(void *arg0, ? arg1) {
    ...
    if (gSaveContext.isNight != 0) {
        temp_v0 = arg0->unk_15E;
        if ((s32) temp_v0 < 0xF5) {
            arg0->unk_15E = (u8) (temp_v0 + 0xA);
            return;
        }
        arg0->unk_15E = 0xFFU;
        return;
    }
    temp_v0_2 = arg0->unk_15E;
    if ((s32) temp_v0_2 >= 0xB) {
        arg0->unk_15E = (u8) (temp_v0_2 - 0xA);
        return;
    }
    arg0->unk_15E = 0U;
}
