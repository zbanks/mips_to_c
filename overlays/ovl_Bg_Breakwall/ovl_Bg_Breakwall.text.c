...
static InitChainEntry D_808B82E0;                   /* unable to generate initializer */
...
typedef struct BgBreakwall {
    ...
    /* 0x015C */ s8 unk15C;                         /* inferred */
    /* 0x015D */ s8 unk15D;                         /* inferred */
    /* 0x015E */ char pad15E[0x2];                  /* maybe part of unk15D[3]? */
    /* 0x0160 */ void (*actionFunc)(BgBreakwall *, GlobalContext *);
} BgBreakwall;                                      /* size 0x164 */

void BgBreakwall_SetupAction(BgBreakwall *this, void (*actionFunc)(BgBreakwall *, GlobalContext *)) {
    BgBreakwall *self = (BgBreakwall *) this;
...
void BgBreakwall_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_808B82E0);
...
void func_808B76CC(BgBreakwall *arg0, GlobalContext *arg1) {
    ...
    if (Object_IsLoaded(&arg1->objectCtx, (s32) arg0->unk15C) != 0) {
        ...
        Actor_SetObjectSegment(arg1, &arg0->actor);
