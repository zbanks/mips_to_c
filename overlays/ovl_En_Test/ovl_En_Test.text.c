typedef struct EnTest {
    /* 0x000 */ Actor actor;
    /* 0x144 */ ActorShape unk144;                  /* inferred */
    /* 0x174 */ s32 unk174;                         /* inferred */
    /* 0x178 */ ? unk178;                           /* inferred */
    /* 0x178 */ char pad178[0x48];
    /* 0x1C0 */ ? unk1C0;                           /* inferred */
    /* 0x1C0 */ char pad1C0[0x48];
    /* 0x208 */ u8 unk208;                          /* inferred */
    /* 0x209 */ u8 unk209;                          /* inferred */
    /* 0x20A */ u8 unk20A;                          /* inferred */
    /* 0x20B */ char pad20B[0x1];
    /* 0x20C */ ? unk20C;                           /* inferred */
    /* 0x20C */ char pad20C[0x4B0];
} EnTest;                                           /* size = 0x6BC */
...
void EnTest_Draw(EnTest *this, GlobalContext *globalCtx) {
    ...
    if (temp_a2_2 != 0) {
        ...
        func_80863048((GraphicsContext **) globalCtx, &this->unk20C);
    }
}
