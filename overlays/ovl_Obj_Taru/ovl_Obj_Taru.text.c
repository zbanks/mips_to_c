typedef struct ObjTaru {
    ...
    /* 0x1A8 */ void (*actionFunc)(ObjTaru *, GlobalContext *);
    /* 0x1AC */ s8 unk_1AC;                         /* inferred */
    /* 0x1AD */ s8 unk_1AD;                         /* inferred */
    /* 0x1AE */ char pad_1AE[0x2];                  /* maybe part of unk_1AD[3]? */
} ObjTaru;                                          /* size = 0x1B0 */

struct _mips2c_stack_ObjTaru_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjTaru_Draw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjTaru_Init {
...
struct _mips2c_stack_ObjTaru_Update {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B9B6E0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B9B74C {
    ...
    /* 0xDC */ char pad_DC[0xC];
};                                                  /* size = 0xE8 */

struct _mips2c_stack_func_80B9B9C8 {
    /* 0x00 */ char pad_0[0xA0];
    /* 0xA0 */ f32 spA0;                            /* inferred */
    /* 0xA4 */ char pad_A4[0x18];                   /* maybe part of spA0[7]? */
...
struct _mips2c_stack_func_80B9BC64 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B9BCBC {
    /* 0x00 */ char pad_0[0x38];
    /* 0x38 */ s32 sp38;                            /* inferred */
    /* 0x3C */ char pad_3C[0x4];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80B9BD84 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B9BF7C {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ s32 sp18;                            /* inferred */
    /* 0x1C */ char pad_1C[0x4];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B9C07C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B9C174 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B9C1A0 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */
...
static InitChainEntry D_80B9C36C[5];                /* unable to generate initializer */
...
void func_80B9BC64(void *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 >= 0) {
        Item_DropCollectible(arg1, arg0 + 0x24, ((((s32) arg0->unk_1C >> 8) & 0x7F) << 8) | temp_v0);
    }
}
...
void ObjTaru_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain((Actor *) this, D_80B9C36C);
    ...
    if ((temp_v0 & 0x80) != 0) {
        ...
        sp20 = temp_a1;
        Collider_InitAndSetCylinder(globalCtx, temp_a1, (Actor *) this, &D_80B9C340);
        ...
        if ((sp24 != 1) || (func_80B9B6E0((Actor *) this, globalCtx) == 0)) {
            this->unk_1AD = -1;
        }
    }
...
s32 func_80B9BF7C(ObjTaru *arg0) {
    ...
    phi_a3 = 0;
    if (((arg0->actor.params & 0x80) == 0) && (temp_v1 = arg0->unk_15C.base.acFlags, ((temp_v1 & 2) != 0))) {
        temp_v0 = arg0->unk_15C.base.ac;
        arg0->unk_15C.base.acFlags = temp_v1 & 0xFFFD;
        if (temp_v0 != 0) {
            temp_v1_2 = *arg0->unk_15C.info.acHitInfo;
...
void func_80B9C07C(ObjTaru *arg0, GlobalContext *arg1) {
    if (func_80B9BF7C(arg0) != 0) {
        ...
        Audio_PlaySoundAtPosition(arg1, (Vec3f *) &arg0->actor.world, 0x14, 0x28AAU);
        if ((arg0->actor.params & 0x80) != 0) {
        ...
        if ((s32) temp_v0 >= 0) {
            if (temp_v0 == 0) {
                ...
                if (Rand_ZeroOne() < 0.1f) {
                    this = this;
                    this->unk_1AD = Rand_S16Offset(0x28, 0x50);
