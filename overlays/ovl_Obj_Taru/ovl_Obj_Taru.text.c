typedef struct ObjTaru {
    ...
    /* 0x1AC */ s8 unk1AC;                          /* inferred */
    /* 0x1AD */ s8 unk1AD;                          /* inferred */
    /* 0x1AE */ char pad1AE[0x2];                   /* maybe part of unk1AD[3]? */
} ObjTaru;                                          /* size = 0x1B0 */
...
struct _mips2c_stack_func_80B9B9C8 {
    ...
    /* 0xA4 */ char padA4[0x18];                    /* maybe part of spA0[7]? */
...
void ObjTaru_Init(ObjTaru *this, GlobalContext *globalCtx) {
    s32 sp24;
...
void ObjTaru_Destroy(ObjTaru *this, GlobalContext *globalCtx) {
    ColliderCylinder *temp_a1;
    ObjTaru *this = (ObjTaru *) thisx;
...
void ObjTaru_Update(ObjTaru *this, GlobalContext *globalCtx) {
    ObjTaru *temp_a0;
    s8 temp_v0;
    ObjTaru *this = (ObjTaru *) thisx;
...
void ObjTaru_Draw(ObjTaru *this, GlobalContext *globalCtx) {
    Gfx *phi_a1;
    ObjTaru *this = (ObjTaru *) thisx;
