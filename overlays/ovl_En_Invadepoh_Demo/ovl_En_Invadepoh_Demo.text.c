typedef struct EnInvadepohDemo {
    ...
    /* 0x170 */ SkelAnime unk170;                   /* inferred */
    /* 0x1B4 */ Vec3s unk1B4;                       /* inferred */
    /* 0x1BA */ char pad1BA[0x84];                  /* maybe part of unk1B4[23]? */
    /* 0x23E */ Vec3s unk23E;                       /* inferred */
    /* 0x244 */ char pad244[0x84];                  /* maybe part of unk23E[23]? */
...
struct _mips2c_stack_func_80C1A244 {
    ...
    /* 0x74 */ char pad74[0x24];                    /* maybe part of sp70[10]? */
...
void func_80C19590(Actor *arg0, void *arg1) {
    ...
    if (sp30 != 0) {
        Math_Vec3s_ToVec3f((Vec3f *) &sp20, (arg0->unk15C * 6) + Lib_SegmentedToVirtual(temp_v0->unk4));
        if (Math_Vec3f_StepTo(arg0 + 0x24, (Vec3f *) &sp20, arg0->unk14C) < arg0->unk14C) {
...
void func_80C1987C(Actor *arg0, void *arg1) {
    ...
    if (sp38 != 0) {
        ...
        Math_Vec3s_ToVec3f((Vec3f *) &sp28, (arg0->unk15C * 6) + temp_ret);
        if (Math_Vec3f_StepTo((Vec3f *) &arg0->world, (Vec3f *) &sp28, arg0->unk14C) < arg0->unk14C) {
...
void func_80C199EC(Actor *arg0, void *arg1) {
    ...
    if (sp30 != 0) {
        arg0->unk16C = (s16) (arg0->unk16C + 0x258);
        Math_Vec3s_ToVec3f((Vec3f *) &sp20, (arg0->unk15C * 6) + temp_v0_2);
        if (Math_Vec3f_StepTo(arg0 + 0x24, (Vec3f *) &sp20, arg0->unk14C) < arg0->unk14C) {
...
void EnInvadepohDemo_Init(EnInvadepohDemo *this, GlobalContext *globalCtx) {
    f32 temp_f10;
    s16 temp_f4;
    s16 temp_v0;
    s32 temp_v1;
...
void EnInvadepohDemo_Destroy(EnInvadepohDemo *this, GlobalContext *globalCtx) {
    EnInvadepohDemo *this = (EnInvadepohDemo *) thisx;
    *(&D_80C1AAEC + (this->unk148 * 4))();
}

void EnInvadepohDemo_Update(EnInvadepohDemo *this, GlobalContext *globalCtx) {
    EnInvadepohDemo *this = (EnInvadepohDemo *) thisx;
    this->actionFunc(this, globalCtx);
}

void EnInvadepohDemo_Draw(EnInvadepohDemo *this, GlobalContext *globalCtx) {
    EnInvadepohDemo *this = (EnInvadepohDemo *) thisx;
