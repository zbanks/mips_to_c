...
struct _mips2c_stack_func_80AF118C {
    ...
    /* 0x98 */ char pad98[0x20];
};                                                  /* size = 0xB8 */

struct _mips2c_stack_func_80AF14FC {
    /* 0x00 */ char pad0[0x6C];
    /* 0x6C */ ? sp6C;                              /* inferred */
    /* 0x6C */ char pad6C[0x5C];
};                                                  /* size = 0xC8 */
...
void func_80AF082C(EnTest7 *arg0, void (*arg1)(EnTest7 *, GlobalContext *), void (*)(EnTest7 *, ?), void (*)(EnTest7 *, GlobalContext *), void (*)(EnTest7 *, ?)); /* static */
...
void func_80AF19A8(EnTest7 *arg0, GlobalContext *arg1); /* static */
void func_80AF1A2C(EnTest7 *arg0, GlobalContext *arg1); /* static */
void func_80AF1B68(EnTest7 *arg0, void (*arg1)(EnTest7 *, GlobalContext *)); /* static */
void func_80AF1CA0(EnTest7 *arg0, GlobalContext *arg1); /* static */
void func_80AF1E44(EnTest7 *arg0, GlobalContext *arg1); /* static */
void func_80AF1F48(EnTest7 *arg0, ? arg1);          /* static */
void func_80AF2030(EnTest7 *arg0, GlobalContext *arg1); /* static */
void func_80AF21E8(EnTest7 *arg0, GlobalContext *arg1); /* static */
void func_80AF2318(EnTest7 *arg0, GlobalContext *arg1); /* static */
...
void func_80AF2938(EnTest7 *arg0, GlobalContext *arg1); /* static */
...
void func_80AF2F98(EnTest7 *arg0, GlobalContext *arg1); /* static */
void func_80AF30F4(EnTest7 *arg0, GlobalContext *arg1); /* static */
        ...
        if (phi_s0->unk0 != 0) {
            ...
            if ((temp_f12 > 30000.0f) || (temp_f12 < -30000.0f) || (temp_f14 = phi_s0->unkC, (temp_f14 > 30000.0f)) || (temp_f14 < -30000.0f) || (temp_f0 = phi_s0->unk10, (temp_f0 > 30000.0f)) || (temp_f0 < -30000.0f)) {
                ...
                if (phi_s0->unk0 == 1) {
                    ...
                    SkinMatrix_SetRotateYRP((MtxF *) &sp6C, phi_s0->unk30, phi_s0->unk32, phi_s0->unk34);
...
void EnTest7_Init(EnTest7 *this, GlobalContext *globalCtx) {
    Actor *sp40;
    f32 sp34;
    LightInfo *sp30;
    Actor *temp_s1;
...
void EnTest7_Destroy(EnTest7 *this, GlobalContext *globalCtx) {
    s16 temp_a0;
    EnTest7 *this = (EnTest7 *) thisx;
...
void func_80AF1B68(EnTest7 *arg0, void (*arg1)(EnTest7 *, GlobalContext *, EnTest7 *)) {
    ...
    if (temp_f0_2 < 11.0f) {
        arg0->unk148 = (f32) (temp_f0_2 + 1.0f);
        if (arg0->unk148 > 6.0f) {
            arg0->unk144 &= -2;
...
void func_80AF1F48(EnTest7 *arg0, ? arg1) {
    ...
    func_80AF0C30(&arg0->unk15C, &sp20, (s32 *)1, (f32 *) arg0);
}
...
void EnTest7_Update(EnTest7 *this, GlobalContext *globalCtx) {
    EnTest7 *temp_a0;
    EnTest7 *temp_a2;
    s32 temp_v0_2;
...
void EnTest7_Draw(EnTest7 *this, GlobalContext *globalCtx) {
    s32 sp40;
    Gfx *temp_a2;
...
block_3:
        ...
        func_80AF14FC((GraphicsContext **) globalCtx, &this->unk15C);
        if ((this->unk144 & 4) != 0) {
