typedef struct EnHintSkb {
    ...
    /* 0x238 */ char pad238[0x9C];                  /* maybe part of unk22C[14]? */
    /* 0x2D4 */ f32 unk2D4;                         /* inferred */
    /* 0x2D8 */ f32 unk2D8;                         /* inferred */
    /* 0x2DC */ s32 unk2DC;                         /* inferred */
    /* 0x2E0 */ Vec3s unk2E0;                       /* inferred */
    /* 0x2E6 */ char pad2E6[0x72];                  /* maybe part of unk2E0[20]? */
    /* 0x358 */ Vec3s unk358;                       /* inferred */
    /* 0x35E */ char pad35E[0x7E];                  /* maybe part of unk358[22]? */
    ...
    /* 0x3E6 */ u16 unk3E6;                         /* inferred */
    /* 0x3E8 */ u8 unk3E8;                          /* inferred */
    /* 0x3E9 */ u8 unk3E9;                          /* inferred */
    /* 0x3EA */ char pad3EA[0x2];                   /* maybe part of unk3E9[3]? */
...
void EnHintSkb_Init(EnHintSkb *this, GlobalContext *globalCtx) {
    ColliderJntSph *sp34;
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80C21CC8, &this->unk164);
...
void EnHintSkb_Destroy(EnHintSkb *this, GlobalContext *globalCtx) {
    EnHintSkb *this = (EnHintSkb *) thisx;
...
void func_80C215E4(GlobalContext *arg0, EnHintSkb *arg1, PosRot *arg2) {
    ...
    sp50.unk0 = (s32) D_80C21E58.unk0;
    sp50.unk4 = (s32) D_80C21E58.unk4;
    sp50.unk8 = (s32) D_80C21E58.unk8;
...
void EnHintSkb_Update(EnHintSkb *this, GlobalContext *globalCtx) {
    void (*temp_v0)(EnHintSkb *, GlobalContext *);
    EnHintSkb *this = (EnHintSkb *) thisx;
...
void EnHintSkb_Draw(EnHintSkb *this, GlobalContext *globalCtx) {
    u8 temp_v0;
    EnHintSkb *this = (EnHintSkb *) thisx;

    this->unk2DC = 0;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_Draw(globalCtx, this->unk1E4.skeleton, this->unk1E4.limbDrawTbl, func_80C21858, func_80C219D4, (Actor *) this);
    if ((s32) this->unk3E2 > 0) {
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk22C, this->unk2DE, this->unk2D8, 0.5f, this->unk2D4, (u8) (s32) this->unk3E9);
    }
    temp_v0 = this->unk3E8;
    if ((temp_v0 & 4) != 0) {
