typedef struct EnEstone {
    ...
    /* 0x01B4 */ char pad1B4[0x2BC0];               /* maybe part of unk168[148]? */
...
void EnEstone_Init(EnEstone *this, GlobalContext *globalCtx) {
    f32 spA0;
    f32 sp9C;
    f32 sp98;
    f32 sp94;
    ...
    this->unk15C = temp_f2;
    this->unk158 = temp_f2;
    Collider_InitAndSetCylinder(globalCtx, &this->unk168, (Actor *) this, &D_80A9AB70);
...
void EnEstone_Destroy(EnEstone *this, GlobalContext *globalCtx) {
    EnEstone *this = (EnEstone *) thisx;
...
void EnEstone_Update(EnEstone *this, GlobalContext *globalCtx) {
...
void EnEstone_Draw(EnEstone *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
