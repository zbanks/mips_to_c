...
static ActorAnimationEntry D_80A70428 = {
...
typedef struct EnMm3 {
    ...
    /* 0x01CC */ char pad1CC[0x8];
    /* 0x01D4 */ void (*actionFunc)(EnMm3 *, GlobalContext *);
    /* 0x01D8 */ char pad1D8[0x4];                  /* maybe part of actionFunc[2]? */
    /* 0x01DC */ s32 unk1DC;                        /* inferred */
    /* 0x01E0 */ Vec3s unk1E0;                      /* inferred */
    /* 0x01E6 */ char pad1E6[0x5A];                 /* maybe part of unk1E0[16]? */
    /* 0x0240 */ Vec3s unk240;                      /* inferred */
    /* 0x0246 */ char pad246[0x5A];                 /* maybe part of unk240[16]? */
    /* 0x02A0 */ Vec3s unk2A0;                      /* inferred */
    /* 0x02A6 */ Vec3s unk2A6;                      /* inferred */
    /* 0x02AC */ char pad2AC[0x2];
    /* 0x02AE */ s16 unk2AE;                        /* inferred */
    /* 0x02B0 */ u16 unk2B0;                        /* inferred */
...
void EnMm3_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a1 = &this->unk144;
    sp38 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_060096E8, &D_0600A4E0, &this->unk1E0, &this->unk240, 0x10);
    SkelAnime_ChangeAnim(sp38, &D_0600A4E0, -1.0f, (f32) SkelAnime_GetFrameCount(&D_0600A4E0.common), 0.0f, (u8) 2, 0.0f);
    temp_a1_2 = &this->unk188;
    sp38 = temp_a1_2;
    Collider_InitCylinder(globalCtx, (ColliderCylinder *) temp_a1_2);
    Collider_SetCylinder(globalCtx, (ColliderCylinder *) temp_a1_2, &this->actor, &D_80A703F0);
...
void EnMm3_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_DestroyCylinder(globalCtx, (ColliderCylinder *) &this->unk188);
}
...
void func_80A6F5E4(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = arg1;
    if (((arg0->unk2B4 != 0x2791) || (arg0->unk2AC == 0)) && (arg1 = arg1, (func_80147624(temp_a0) != 0))) {
        temp_t8 = arg0->unk2B4;
        switch (temp_t8) {
        case 10122:
            temp_a1 = arg1;
        ...
        case 10141:
            ...
            return;
        case 10142:
            arg0->unk2B2 = (u16) (arg0->unk2B2 | 0x20);
        ...
        temp_v0 = arg0->unk2AC;
        if (((s32) temp_v0 > 0) && (arg0->unk2B4 == 0x2791) && (arg0->unk2AC = (s16) (temp_v0 - 1), (arg0->unk2AC == 0))) {
...
void func_80A6F9DC(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk2B0 = (u16) (arg0->unk2B0 & 0xFFFD);
    temp_v0 = func_80152498(arg1 + 0x4908);
    switch (temp_v0) {
    case 3:
        arg0->unk2B0 = (u16) (arg0->unk2B0 | 2);
        break;
    case 4:
    ...
    temp_v0_3 = arg0->unk2B4;
    if (((temp_v0_3 == 0x279D) || (temp_v0_3 == 0x27A0) || (temp_v0_3 == 0x278B)) && (func_801378B8((SkelAnime *) (arg0 + 0x144), 8.0f) != 0) && (arg0->unk2AE == 0)) {
...
void func_80A6FBFC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (gSaveContext.unk_3DD0[0] == 0x10) {
        ...
        arg0->flags |= 0x10000;
        temp_t5 = gSaveContext.unk3DE4;
        temp_t4 = gSaveContext.unk3DE0;
        sp24 = temp_t5;
        sp20 = temp_t4;
        if ((temp_t4 != 0) || (temp_t5 >= 0x5DDU)) {
            gSaveContext.unk3DE0 = 0U;
            gSaveContext.unk3DE4 = 0x5DCU;
        } else {
            temp_v0_2 = gGameInfo;
            sp30 = sp20;
            sp34 = sp24;
            ...
            if ((sp20 >= (u32) temp_t4_2) && (((u32) temp_t4_2 < sp20) || (sp24 >= (u32) temp_t2))) {
                ...
                if (((u32) temp_t0 >= sp20) && ((sp20 < (u32) temp_t0) || ((u32) temp_t6 >= sp24))) {
                    gSaveContext.unk3DE4 = 0x3E8U;
                    gSaveContext.unk3DE0 = 0U;
                }
            }
        }
    } else if ((gSaveContext.unk3DE0 != 0) || ((u32) gSaveContext.unk3DE4 >= 0x5DDU)) {
        ...
        if (temp_v0 != 2) {
            if (temp_v0 != 3) {
                if (temp_v0 == 4) {
                    arg0 = arg0;
                    if (Player_GetMask(arg1) == 4) {
                        temp_t8 = arg0->unk2B2 | 0x10;
                        arg0->unk2B2 = temp_t8;
                        arg0->unk2B2 = (u16) (temp_t8 | 1);
                        return;
                    }
                    arg0->unk2B2 = (u16) (arg0->unk2B2 | 1);
                    return;
                }
                // Duplicate return node #10. Try simplifying control flow for better match
                return;
            }
            arg0->unk2B2 = (u16) (arg0->unk2B2 | 2);
            return;
        }
        arg0->unk2B2 = (u16) (arg0->unk2B2 | 4);
        return;
    }
    arg0->unk2B2 = (u16) (arg0->unk2B2 | 8);
}
...
void EnMm3_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk2B0 & 1) != 0) {
        func_800E9250(globalCtx, &this->actor, &this->unk2A0, &this->unk2A6, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    }
    temp_a2 = &this->unk188;
    sp34 = temp_a2;
...
s32 func_80A701E0(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    if (arg1 == 8) {
        ...
        arg4->x += arg5->unk2A2;
        arg4->z += arg5->unk2A0;
        if (((arg5->unk2B0 & 2) != 0) && (((u32) arg0->gameplayFrames % 3U) == 0)) {
...
void EnMm3_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp38 = sp38;
    sp30 = temp_v0;
    sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80A704FC + (this->unk1DC * 4)));
    temp_v0_2 = sp38->polyOpa.p;
    sp38->polyOpa.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xDB060030;
    temp_v0_2->words.w1 = (u32) &D_80A704E8;
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A701E0, func_80A702B0, &this->actor);
}
