...
void EnMm3_Init(EnMm3 *this, GlobalContext *globalCtx) {
    SkelAnime *sp38;
    SkelAnime *temp_a1;
    SkelAnime *temp_a1_2;
...
void EnMm3_Destroy(EnMm3 *this, GlobalContext *globalCtx) {
    EnMm3 *this = (EnMm3 *) thisx;
...
void EnMm3_Update(EnMm3 *this, GlobalContext *globalCtx) {
    SkelAnime *sp34;
    SkelAnime *temp_a2;
    EnMm3 *this = (EnMm3 *) thisx;
    ...
    if ((this->unk2B0 & 1) != 0) {
        func_800E9250(globalCtx, (Actor *) this, &this->unk2A0, &this->unk2A6, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    }
    temp_a2 = &this->unk188;
    sp34 = temp_a2;
...
void EnMm3_Draw(EnMm3 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A701E0, func_80A702B0, (Actor *) this);
}
