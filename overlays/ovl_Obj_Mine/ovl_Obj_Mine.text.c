...
typedef struct ObjMine {
    ...
    /* 0x01B8 */ char pad1B8[0x11FC];               /* maybe part of unk1B4[1152]? */
} ObjMine;                                          /* size = 0x13B4 */
...
struct _mips2c_stack_func_80A832D0 {
    ...
    /* 0x88 */ char pad88[0x8];                     /* maybe part of sp86[5]? */
...
struct _mips2c_stack_func_80A84088 {
    ...
    /* 0x50 */ char pad50[0x30];                    /* maybe part of sp4C[13]? */
...
void ObjMine_Init(ObjMine *this, GlobalContext *globalCtx) {
    s32 sp44;
    s32 sp3C;
    s32 sp38;
    s32 sp34;
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80A84594, &this->unk164);
...
void ObjMine_Destroy(ObjMine *this, GlobalContext *globalCtx) {
    ObjMine *this = (ObjMine *) thisx;
...
void func_80A82FC8(ObjMine *arg0, GlobalContext *arg1) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &spA0, arg0->unk1B4 + (arg0->unk1B0 * 6) + 6);
    temp_a1 = arg0 + 0x24;
    temp_a2 = arg0 + 0x64;
    sp2C = temp_a2;
    sp28 = temp_a1;
...
void ObjMine_Update(ObjMine *this, GlobalContext *globalCtx) {
    CollisionCheckContext *sp24;
    ColliderJntSph *sp20;
...
void ObjMine_Draw(ObjMine *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    ColliderJntSph *temp_a1;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
