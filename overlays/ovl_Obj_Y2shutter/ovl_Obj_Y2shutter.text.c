...
void ObjY2shutter_Init(ObjY2shutter *this, GlobalContext *globalCtx) {
    void *sp1C;
...
void ObjY2shutter_Destroy(ObjY2shutter *this, GlobalContext *globalCtx) {
    ObjY2shutter *this = (ObjY2shutter *) thisx;
...
void ObjY2shutter_Update(ObjY2shutter *this, GlobalContext *globalCtx) {
    s32 sp34;
    f32 sp2C;
    f32 sp28;
    f32 sp24;
...
void ObjY2shutter_Draw(ObjY2shutter *this, GlobalContext *globalCtx) {
    ObjY2shutter *this = (ObjY2shutter *) thisx;
