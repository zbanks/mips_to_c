...
s32 EffectSsEnIce_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    if (temp_v0 == 0) {
        ...
        this->regs[12] = (s16) (s32) (initParamsx->unk_10 * 100.0f);
        ...
        this->regs[8] = (s16) initParamsx->unk_30;
        this->regs[9] = (s16) initParamsx->unk_31;
        this->regs[11] = 1;
        this->regs[10] = (s16) initParamsx->unk_32;
    ...
    if (temp_v0 == 1) {
        ...
        this->regs[0] = (s16) initParamsx->unk_34;
        this->regs[12] = (s16) (s32) (initParamsx->unk_10 * 100.0f);
        this->regs[1] = Math_FAtan2F(initParamsx->unk_1C, initParamsx->unk_14);
        this->regs[2] = 0;
        this->regs[4] = (s16) initParamsx->unk_2C;
        this->regs[5] = (s16) initParamsx->unk_2D;
        this->regs[6] = (s16) initParamsx->unk_2E;
