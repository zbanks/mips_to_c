typedef struct EnDt {
    ...
    /* 0x24E */ char pad24E[0x6];                   /* maybe part of unk24C[4]? */
    /* 0x254 */ s16 unk254;                         /* inferred */
    /* 0x256 */ char pad256[0x1E];                  /* maybe part of unk254[16]? */
    /* 0x274 */ Actor *unk274;                      /* inferred */
    /* 0x278 */ Actor *unk278;                      /* inferred */
    /* 0x27C */ char pad27C[0xA];                   /* maybe part of unk278[3]? */
    /* 0x286 */ s16 unk286;                         /* inferred */
    /* 0x288 */ char pad288[0x4];                   /* maybe part of unk286[3]? */
...
void EnDt_Init(EnDt *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    s8 temp_s0;
    s16 phi_s0;
    EnDt *phi_s1;
    ...
    this->unk274 = NULL;
    this->unk278 = NULL;
    Collider_InitAndSetCylinder(globalCtx, &this->unk294, (Actor *) this, &D_80BEB29C);
...
void EnDt_Destroy(EnDt *this, GlobalContext *globalCtx) {
    EnDt *this = (EnDt *) thisx;
...
void EnDt_Update(EnDt *this, GlobalContext *globalCtx) {
...
void EnDt_Draw(EnDt *this, GlobalContext *globalCtx) {
    s32 sp40;
    Gfx *sp34;
    Gfx *sp30;
    Gfx *temp_v0;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BEB06C, NULL, (Actor *) this);
}
