typedef struct ObjSkateblock {
    ...
    /* 0x160 */ char pad160[0x60];                  /* maybe part of actionFunc[25]? */
    /* 0x1C0 */ u8 unk1C0;                          /* inferred */
    /* 0x1C1 */ u8 unk1C1;                          /* inferred */
    /* 0x1C2 */ char pad1C2[0x2];                   /* maybe part of unk1C1[3]? */
...
struct _mips2c_stack_func_80A216D4 {
    ...
    /* 0xB4 */ char padB4[0x8];                     /* maybe part of spB0[3]? */
...
void ObjSkateblock_Init(ObjSkateblock *this, GlobalContext *globalCtx) {
    s32 temp_t9;
...
void ObjSkateblock_Destroy(ObjSkateblock *this, GlobalContext *globalCtx) {
    ObjSkateblock *this = (ObjSkateblock *) thisx;
...
void func_80A22334(f32 *arg0, f32 *arg1) {
    ...
    if (temp_v0 == -1) {
        sp30 = 0;
    } else if (((arg0->unk1C1 & 2) == 0) && ((s32) (arg0 + (temp_v0 * 2))->unk172 >= 0xB) && (D_80A22A10 == 0) && (func_80A216D4(arg0, arg1, 2.0f, (Vec3f *) &sp20) == 0) && (func_801233E4((GlobalContext *) arg1) == 0)) {
...
void ObjSkateblock_Update(ObjSkateblock *this, GlobalContext *globalCtx) {
    ObjSkateblock *this = (ObjSkateblock *) thisx;
...
void ObjSkateblock_Draw(ObjSkateblock *this, GlobalContext *globalCtx) {
    void *sp2C;
    Gfx *sp20;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
