typedef struct EnTest3 {
    /* 0x000 */ Actor actor;
    /* 0x144 */ char pad144[0x3];
    /* 0x147 */ s8 unk147;                          /* inferred */
    /* 0x148 */ s8 unk148;                          /* inferred */
    /* 0x149 */ char pad149[0x2];                   /* maybe part of unk148[3]? */
    /* 0x14B */ s8 unk14B;                          /* inferred */
    /* 0x14C */ char pad14C[0x7];                   /* maybe part of unk14B[8]? */
    /* 0x153 */ u8 unk153;                          /* inferred */
    /* 0x154 */ char pad154[0x1];
    /* 0x155 */ u8 unk155;                          /* inferred */
    /* 0x156 */ char pad156[0xA2];                  /* maybe part of unk155[163]? */
    /* 0x1F8 */ s32 unk1F8;                         /* inferred */
    /* 0x1FC */ char pad1FC[0x40];                  /* maybe part of unk1F8[17]? */
    /* 0x23C */ void *unk23C;                       /* inferred */
    /* 0x240 */ char pad240[0x154];                 /* maybe part of unk23C[86]? */
    /* 0x394 */ u8 unk394;                          /* inferred */
    /* 0x395 */ char pad395[0x183];                 /* maybe part of unk394[388]? */
    /* 0x518 */ ColliderCylinder unk518;            /* inferred */
    /* 0x564 */ ColliderQuad unk564;                /* inferred */
    /* 0x5E4 */ ColliderQuad unk5E4;                /* inferred */
    /* 0x664 */ ColliderQuad unk664;                /* inferred */
    /* 0x6E4 */ ColliderCylinder unk6E4;            /* inferred */
    /* 0x730 */ char pad730[0xC];
    /* 0x73C */ s32 unk73C;                         /* inferred */
    /* 0x740 */ s32 unk740;                         /* inferred */
    /* 0x744 */ s32 unk744;                         /* inferred */
    /* 0x748 */ char pad748[0x24];                  /* maybe part of unk744[10]? */
    /* 0x76C */ void (*actionFunc)(EnTest3 *, GlobalContext *);
    /* 0x770 */ char pad770[0x2F8];                 /* maybe part of actionFunc[191]? */
    /* 0xA68 */ ? *unkA68;                          /* inferred */
    /* 0xA6C */ char padA6C[0x14];                  /* maybe part of unkA68[6]? */
    /* 0xA80 */ s32 unkA80;                         /* inferred */
    /* 0xA84 */ char padA84[0x2];
    /* 0xA86 */ s8 unkA86;                          /* inferred */
    /* 0xA87 */ char padA87[0x49];                  /* maybe part of unkA86[74]? */
    /* 0xAD0 */ f32 unkAD0;                         /* inferred */
    /* 0xAD4 */ char padAD4[0x2AC];                 /* maybe part of unkAD0[172]? */
    /* 0xD80 */ s32 unkD80;                         /* inferred */
    /* 0xD84 */ f32 unkD84;                         /* inferred */
    /* 0xD88 */ s8 unkD88;                          /* inferred */
    /* 0xD89 */ char padD89[0x5];                   /* maybe part of unkD88[6]? */
    /* 0xD8E */ s16 unkD8E;                         /* inferred */
    /* 0xD90 */ Actor *unkD90;                      /* inferred */
    /* 0xD94 */ ? (*unkD94)(EnTest3 *, GlobalContext *); /* inferred */
    /* 0xD98 */ char padD98[0x20];                  /* maybe part of unkD94[9]? */
} EnTest3;                                          /* size = 0xDB8 */
...
struct _mips2c_stack_func_80A40230 {
    ...
    /* 0x088 */ ? sp88;                             /* inferred */
    /* 0x088 */ char pad88[0xC];
    /* 0x094 */ ? sp94;                             /* inferred */
    /* 0x094 */ char pad94[0x424];
};                                                  /* size = 0x4B8 */

struct _mips2c_stack_func_80A40678 {
    /* 0x00 */ char pad0[0x2C];
    /* 0x2C */ u8 sp2C;                             /* inferred */
    /* 0x2D */ char pad2D[0xF];                     /* maybe part of sp2C[16]? */
...
void EnTest3_Init(EnTest3 *this, GlobalContext *globalCtx) {
    Camera *sp2C;
    void *sp28;
    Actor *temp_t4;
    Camera *temp_v0;
...
void EnTest3_Destroy(EnTest3 *this, GlobalContext *globalCtx) {
    EnTest3 *this = (EnTest3 *) thisx;
...
s32 func_80A40230(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unkD89 & 1) == 0) {
        ...
        sp4C = temp_a1;
        sp44 = temp_v0;
        func_8013B6B0(arg0->colCtx.dyna.bgActors[12].curTransform.pos.x, temp_a1, temp_a2, arg0->colCtx.dyna.bgActors[13].prevTransform.scale.x, arg0->unkDA8, temp_v0, (void *) &sp94, (Vec3f *) &sp70, (s16) arg0->colCtx.dyna.bgActors[12].curTransform.pos.y);
        ...
        sp70.unk0 = temp_v1->x;
        sp70.unk4 = (f32) temp_v1->y;
        sp70.unk8 = (f32) temp_v1->z;
        sp44 = arg0 + 0xDB0;
        sp48 = arg0 + 0xDB4;
        sp4C = arg0 + 0xDA4;
    }
    ...
    if (arg1->unk_18B4A != 0) {
        ...
        sp70.unk0 = arg0->unk24;
        sp70.unk4 = (f32) arg0->unk28;
        sp70.unk8 = (f32) arg0->unk2C;
    }
    ...
    sp40 = phi_v1;
    sp38 = arg0 + 0x24;
    if (func_8013B6B0(arg0->colCtx.dyna.bgActors[12].curTransform.pos.x, sp4C, sp48, arg0->colCtx.dyna.bgActors[13].prevTransform.scale.x, arg0->unkDA8, sp44, (void *) &sp94, phi_v1, (bitwise s16) arg0->colCtx.dyna.bgActors[12].curTransform.pos.y) != 0) {
        ...
        sp88.unk0 = (s32) sp38->x;
        sp88.unk4 = (s32) sp38->y;
        sp88.unk8 = (s32) sp38->z;
        sp7C.unk0 = (f32) phi_v1->x;
        sp7C.unk4 = (f32) phi_v1->y;
        sp7C.unk8 = (f32) phi_v1->z;
        sp3C = temp_t0;
        sp40 = phi_v1;
...
void EnTest3_Update(EnTest3 *this, GlobalContext *globalCtx) {
    ? sp34;
    PosRot *sp30;
    void *sp2C;
    PosRot *temp_a1;
