...
struct _mips2c_stack_ObjTakarayaWall_Draw {
    ...
    /* 0x80 */ char pad80[0x14];                    /* maybe part of sp7C[6]? */
...
void ObjTakarayaWall_Init(ObjTakarayaWall *this, GlobalContext *globalCtx) {
    ? *temp_v0_5;
    Actor *temp_s0;
    f32 *temp_v0;
    s32 temp_s0_2;
...
loop_2:
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk148, (Actor *) this, &D_80ADA2A0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk194, (Actor *) this, &D_80ADA2A0);
...
void ObjTakarayaWall_Destroy(ObjTakarayaWall *this, GlobalContext *globalCtx) {
    Vec3f *temp_s3;
    s32 temp_s0;
    Vec3f *phi_s1;
    s32 phi_s0;
...
void ObjTakarayaWall_Update(ObjTakarayaWall *this, GlobalContext *globalCtx) {
    ...
    sp1C = temp_a1;
    CollisionCheck_SetOC(globalCtx, temp_a1, (Collider *) &this->unk148);
    CollisionCheck_SetOC(globalCtx, temp_a1, (Collider *) &this->unk194);
}

void ObjTakarayaWall_Draw(ObjTakarayaWall *this, GlobalContext *globalCtx) {
    f32 sp9C;
    f32 sp98;
    f32 sp94;
