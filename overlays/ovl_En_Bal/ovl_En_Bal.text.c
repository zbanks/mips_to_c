typedef struct EnBal {
    ...
    /* 0x18C */ void (*actionFunc)(EnBal *, GlobalContext *);
    /* 0x190 */ SkelAnime unk_190;                  /* inferred */
    /* 0x1D4 */ char pad_1D4[0x28];
    /* 0x1FC */ s32 unk_1FC;                        /* inferred */
    /* 0x200 */ Vec3s unk_200;                      /* inferred */
    /* 0x206 */ char pad_206[0xC0];                 /* maybe part of unk_200[33]? */
    /* 0x2C6 */ Vec3s unk_2C6;                      /* inferred */
    /* 0x2CC */ char pad_2CC[0xCC];                 /* maybe part of unk_2C6[35]? */
    /* 0x398 */ s16 unk_398;                        /* inferred */
    /* 0x39A */ s16 unk_39A;                        /* inferred */
    ...
    /* 0x3B2 */ s8 unk_3B2;                         /* inferred */
    /* 0x3B3 */ char pad_3B3[0x1];
} EnBal;                                            /* size = 0x3B4 */
...
struct _mips2c_stack_EnBal_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnBal_Draw {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ GraphicsContext *sp30;               /* inferred */
    /* 0x34 */ char pad_34[0x4];
};                                                  /* size = 0x38 */

struct _mips2c_stack_EnBal_Init {
    /* 0x00 */ char pad_0[0x30];
...
struct _mips2c_stack_EnBal_Update {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A61A18 {};              /* size 0x0 */

struct _mips2c_stack_func_80A61A44 {};              /* size 0x0 */

struct _mips2c_stack_func_80A61A6C {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A61ADC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A61B5C {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ SkelAnime *sp20;                     /* inferred */
    /* 0x24 */ char pad_24[0x4];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A61C9C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A61CE4 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A61DF8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A61E5C {
    /* 0x00 */ char pad_0[0x3C];
    /* 0x3C */ ? sp3C;                              /* inferred */
    /* 0x3C */ char pad_3C[0xC];
};                                                  /* size = 0x48 */

struct _mips2c_stack_func_80A62128 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ ? sp1C;                              /* inferred */
    /* 0x1C */ char pad_1C[0xC];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A621C4 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A62260 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A622A0 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A623CC {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A624DC {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ SkelAnime *sp20;                     /* inferred */
...
struct _mips2c_stack_func_80A62818 {};              /* size 0x0 */

struct _mips2c_stack_func_80A62830 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A629C4 {};              /* size 0x0 */

struct _mips2c_stack_func_80A62AC4 {};              /* size 0x0 */

struct _mips2c_stack_func_80A62B30 {};              /* size 0x0 */

struct _mips2c_stack_func_80A62B78 {
...
struct _mips2c_stack_func_80A62CF0 {
...
struct _mips2c_stack_func_80A62DCC {};              /* size 0x0 */

struct _mips2c_stack_func_80A62ED0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A62FAC {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ s32 sp20;                            /* inferred */
    /* 0x24 */ void *sp24;                          /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A63158 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A634B4 {};              /* size 0x0 */

struct _mips2c_stack_func_80A634C8 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A635DC {};              /* size 0x0 */

struct _mips2c_stack_func_80A635F0 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ void *sp24;                          /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A636AC {
    /* 0x00 */ char pad_0[0x38];
    /* 0x38 */ ? sp38;                              /* inferred */
    /* 0x38 */ char pad_38[0x10];
};                                                  /* size = 0x48 */

struct _mips2c_stack_func_80A637FC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A63884 {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80A63A10 {
    /* 0x00 */ char pad_0[0x24];
...
struct _mips2c_stack_func_80A63B94 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */
...
void func_80A61B5C(void *arg0, ? arg1);             /* static */
...
static ActorAnimationEntry D_80A63D58[14] = {
...
void EnBal_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_3AE = this->actor.params & 0xFF;
    this->actor.uncullZoneForward = 3000.0f;
    Actor_SetScale((Actor *) this, 0.02f);
    temp_a1 = &this->unk_148;
    sp30 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_0600A6D0, (AnimationHeader *) &D_060005FC, &this->unk_200, &this->unk_2C6, 0x21);
    ...
    Collider_SetJntSph(globalCtx, (ColliderJntSph *) temp_a1_2, (Actor *) this, &D_80A63D30, (ColliderJntSphElement *) &this->unk_190.limbDrawTbl);
...
void EnBal_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnBal *this = (EnBal *) thisx;
    Collider_InitJntSph(globalCtx, (ColliderJntSph *) &this->unk_190);
}

void func_80A61A18(EnBal *arg0) {
    arg0->unk_190.animPlaybackSpeed->unk_3C = 6;
    arg0->unk_190.animPlaybackSpeed->unk_2E = 0x28;
    arg0->unk_190.animPlaybackSpeed->unk_28 = 0x898;
}

void func_80A61A44(EnBal *arg0) {
    arg0->unk_190.animPlaybackSpeed->unk_3C = 0x16;
    arg0->unk_190.animPlaybackSpeed->unk_2E = 0x19;
    arg0->unk_190.animPlaybackSpeed->unk_28 = 0;
}
...
void func_80A61B5C(EnBal *arg0, GlobalContext *arg1) {
    ...
    arg0->actor.focus.pos.y = arg0->actor.world.pos.y + 100.0f;
    arg0->unk_3A8 += 0x3E8;
    temp_f2 = (Math_CosS(arg0->unk_39E) * 0.1f) + 1.0f;
    arg0->unk_1F8 = temp_f2;
    arg0->unk_1F4 = temp_f2;
    temp_f2_2 = (Math_SinS(arg0->unk_39E) * 0.1f) + 1.0f;
    arg0->unk_1F0 = temp_f2_2 * temp_f2_2;
    arg0->actor.world.pos.y = (Math_SinS(arg0->unk_39E) * 50.0f) + arg0->actor.home.pos.y;
    if (arg0->unk_39A == 1) {
        temp_a0 = arg0 + 0x148;
        if (&D_0600CB78 != arg0->unk_148.animCurrentSeg) {
            func_800BDC5C(arg0 + 0x148, (ActorAnimationEntry []) D_80A63D58, 0xC);
            return;
        }
        sp20 = temp_a0;
        if (func_801378B8(temp_a0, arg0->unk_148.animFrameCount) != 0) {
            temp_v0 = arg0->unk_3A6;
            if (temp_v0 != 0) {
                arg0->unk_3A6 = temp_v0 - 1;
                return;
            }
            arg0->unk_39A = 0;
            arg0->unk_1FC = 0;
...
void func_80A61CE4(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 >= 0xB) {
        arg0->unk_164 = 0.0f;
        if ((s32) arg0->unk_398 >= 7) {
            arg0->unk_398 = 6;
        }
        arg0->unk_3A8 = (s16) (arg0->unk_3A8 + 1);
        return;
    }
...
void func_80A61E5C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp3C.unk_0 = (?32) arg0->world.pos.x;
    sp3C.unk_4 = (f32) arg0->world.pos.y;
    sp3C.unk_8 = (f32) arg0->world.pos.z;
    arg0->focus.pos.x = arg0->world.pos.x;
    temp_v0 = arg0->unk_3A8;
    arg0->focus.pos.y = arg0->world.pos.y + 20.0f;
    arg0->focus.pos.z = arg0->world.pos.z + 30.0f;
...
void func_80A62128(Actor *arg0) {
    ...
    temp_a3 = arg0;
    sp1C.unk_0 = (s32) D_80A63EA8.unk_0;
    sp1C.unk_4 = (s32) D_80A63EA8.unk_4;
    sp1C.unk_8 = (s32) D_80A63EA8.unk_8;
    arg0 = temp_a3;
...
void func_80A622A0(EnBal *arg0, ? arg1) {
    ...
    if ((s32) arg0->unk_3A8 < 0x1F4) {
        temp_f2 = (Math_CosS(arg0->unk_39E) * 0.1f) + 1.0f;
        arg0->unk_1F8 = temp_f2;
        arg0->unk_1F4 = temp_f2;
        temp_f2_2 = (Math_SinS(arg0->unk_39E) * 0.1f) + 1.0f;
        arg0->unk_1F0 = temp_f2_2 * temp_f2_2;
        arg0->actor.world.pos.y *= (f32) (0x1F4 - arg0->unk_3A8);
        temp_v0 = arg0->unk_3A8;
        arg0->actor.world.pos.y += (f32) temp_v0 * (arg0->actor.home.pos.y + (50.0f * Math_SinS(arg0->unk_39E)));
        arg0->actor.world.pos.y *= 0.002f;
        if ((s32) temp_v0 < 0x64) {
            arg0->unk_3A8 = temp_v0 + 1;
        } else {
            arg0->unk_3A8 = temp_v0 + 0xA;
        }
        arg0->unk_39E += 0x320;
        return;
    }
...
void func_80A624DC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 0x12C) {
        ...
        if (func_801378B8(arg0 + 0x148, arg0->unk_158) != 0) {
            func_80A62128(arg0);
            return;
        }
        goto block_5;
...
block_5:
    ...
    if ((arg0->xzDistToPlayer < 100.0f) && (func_80A621C4 != arg0->unk_18C)) {
        if (arg0->unk_3A6 != 3) {
            arg0->unk_39C = 1;
        } else {
            arg0->unk_39C = 0;
        }
        if (((arg1->actorCtx.actorList[2].first->unk_A6C << 8) >= 0) && ((arg1->actorCtx.actorList[2].first->bgCheckFlags & 0x20) == 0) && ((temp_v0_2 = arg0->unk_3A8, (((s32) temp_v0_2 < 0x12C) != 0)) || (temp_v0_2 == 0x12D))) {
            sp20 = temp_a3;
    ...
    if (func_801378B8(arg0 + 0x148, arg0->unk_158) != 0) {
        ...
        if (temp_v0_3 == 2) {
            ...
            arg0->unk_1FC = 0;
            func_800BDC5C(arg0 + 0x148, (ActorAnimationEntry []) D_80A63D58, 0xA);
            arg0->unk_3A6 = (s16) (arg0->unk_3A6 + 1);
            return;
        }
        if (temp_v0_3 == 3) {
            sp20 = arg0 + 0x148;
    ...
    if ((arg0->unk_3A6 == 3) && (func_801378B8(arg0 + 0x148, 20.0f) != 0)) {
        arg0->unk_39A = 1;
    }
}
...
void func_80A62830(EnBal *arg0, GlobalContext *arg1) {
    ...
    temp_v0->unk_A70 = (s32) (temp_v0->unk_A70 | 0x100000);
    arg0->unk_3B2 = 0;
...
block_15:
    ...
    case 6:
        ...
        goto block_15;
    case 10:
        if ((func_80147624(arg1) != 0) && (arg0->unk_3A0 == 0x1D08)) {
            arg0->unk_39A = 0;
            arg0->unk_1FC = 0;
        }
        goto block_15;
    }
    if (arg0->unk_3A0 == 0x1D07) {
        temp_f0 = arg0->unk_148.animCurrentFrame;
        if ((temp_f0 > 29.0f) && (temp_f0 < 33.0f)) {
            if (func_801378B8(&arg0->unk_148, 30.0f) != 0) {
                Audio_PlayActorSound2((Actor *) arg0, 0x28A5U);
            }
            func_80A62B78(arg0, arg1);
        }
        if (func_801378B8(&arg0->unk_148, 35.0f) != 0) {
            arg0->unk_39A = 0;
            arg0->unk_1FC = 0;
        }
    }
...
void func_80A62CF0(Actor *arg0, GlobalContext *arg1) {
    ...
    func_800B0EB0(arg1, (Vec3f *) &sp34, &D_80A63ED4, &D_80A63EE0, &D_80A63EEC, &D_80A63EF0, (s16) 0x96, (s16) 0x28, (s16) 0xF);
}
...
s32 func_80A62DCC(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_t1 = *(&D_80A63D40 + ((arg0->unk_3AE * 4) + (arg1->msgCtx.choiceIndex * 2)));
    temp_t2 = temp_t1 & 0xFFFF;
    arg0->unk_3AC = temp_t1;
    switch (temp_t2) {
    case 0:
...
void func_80A62ED0(Actor *arg0) {
    ...
    func_8012EF0C(arg0->unk_3AC);
    temp_t8 = (u16) arg0->unk_3AC;
    switch (temp_t8) {
    case 0:
...
block_9:
    ...
    temp_v0_3 = arg0->unk_398;
    if ((s32) temp_v0_3 >= 4) {
        arg0->unk_398 = (s16) (temp_v0_3 - 1);
        return;
    }
    if (temp_v0_3 != 0) {
        arg0->unk_1FC = 1;
...
void func_80A637FC(EnBal *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->actionFunc;
    if ((func_80A61B5C == temp_v0) || ((func_80A622A0 == temp_v0) && ((s32) arg0->unk_3A8 >= 0x33))) {
        temp_a2 = arg0 + 0x190;
        arg0 = arg0;
...
void func_80A63884(Actor *arg0, GlobalContext *arg1) {
    if ((arg0->unk_1A1 & 2) != 0) {
        ...
        arg0->unk_1A1 = (u8) (arg0->unk_1A1 & 0xFFFD);
        func_80A61C9C(arg0);
    }
}
...
void EnBal_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80A63884((Actor *) this, globalCtx);
    func_80A637FC(this, globalCtx);
    SkelAnime_FrameUpdateMatrix(&this->unk_148);
    if (func_80A61B5C != this->actionFunc) {
        Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
        Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 32.0f, 30.0f, 60.0f, 6U);
    }
    func_80A636AC((Actor *) this, globalCtx);
    if ((func_80A62830 == this->actionFunc) && (this->unk_3A0 != 0x1D10)) {
...
s32 func_80A63A10(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    if (arg1 == 6) {
        temp_v0 = arg5->unk_3A4;
        if ((temp_v0 == 0) || (temp_v0 == 4) || (temp_v0 == 5)) {
            sp24 = (s16) (s32) (Math_SinS(arg5->unk_3A8) * 3640.0f);
            temp_f18 = (s32) (Math_CosS(arg5->unk_3A8) * 3640.0f);
    ...
    if (arg1 == 0x16) {
        arg4->x += arg5->unk_38E;
        arg4->y -= arg5->unk_38C;
        if ((arg5->unk_3B2 == 1) && ((arg0->state.frames & 2) == 0)) {
...
void EnBal_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_148.skeleton, this->unk_148.limbDrawTbl, (s32) this->unk_148.dListCount, func_80A63A10, func_80A63B94, (Actor *) this);
}
