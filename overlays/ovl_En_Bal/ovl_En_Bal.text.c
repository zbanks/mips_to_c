typedef struct EnBal {
    ...
    /* 0x1D4 */ char pad1D4[0x28];
    /* 0x1FC */ s32 unk1FC;                         /* inferred */
    /* 0x200 */ Vec3s unk200;                       /* inferred */
    /* 0x206 */ char pad206[0xC0];                  /* maybe part of unk200[33]? */
    /* 0x2C6 */ Vec3s unk2C6;                       /* inferred */
    /* 0x2CC */ char pad2CC[0xCC];                  /* maybe part of unk2C6[35]? */
    /* 0x398 */ s16 unk398;                         /* inferred */
    /* 0x39A */ s16 unk39A;                         /* inferred */
    /* 0x39C */ s16 unk39C;                         /* inferred */
    /* 0x39E */ s16 unk39E;                         /* inferred */
    /* 0x3A0 */ s16 unk3A0;                         /* inferred */
    /* 0x3A2 */ char pad3A2[0x2];
    /* 0x3A4 */ s16 unk3A4;                         /* inferred */
    /* 0x3A6 */ char pad3A6[0x2];
    /* 0x3A8 */ s16 unk3A8;                         /* inferred */
    /* 0x3AA */ char pad3AA[0x4];                   /* maybe part of unk3A8[3]? */
    /* 0x3AE */ s16 unk3AE;                         /* inferred */
    /* 0x3B0 */ s16 unk3B0;                         /* inferred */
    /* 0x3B2 */ s8 unk3B2;                          /* inferred */
    /* 0x3B3 */ char pad3B3[0x1];
} EnBal;                                            /* size = 0x3B4 */
...
void EnBal_Init(EnBal *this, GlobalContext *globalCtx) {
    f32 sp34;
    SkelAnime *sp30;
    SkelAnime *temp_a1;
    SkelAnime *temp_a1_2;
    ...
    Collider_SetJntSph(globalCtx, (ColliderJntSph *) temp_a1_2, (Actor *) this, &D_80A63D30, (ColliderJntSphElement *) &this->unk190.limbDrawTbl);
...
void EnBal_Destroy(EnBal *this, GlobalContext *globalCtx) {
    EnBal *this = (EnBal *) thisx;
...
void func_80A61E5C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp3C.unk0 = (?32) arg0->world.pos.x;
    sp3C.unk4 = (f32) arg0->world.pos.y;
    sp3C.unk8 = (f32) arg0->world.pos.z;
    arg0->focus.pos.x = arg0->world.pos.x;
    temp_v0 = arg0->unk3A8;
    arg0->focus.pos.y = arg0->world.pos.y + 20.0f;
    arg0->focus.pos.z = arg0->world.pos.z + 30.0f;
...
void func_80A636AC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 2) {
        ...
        if (temp_v1 != 0) {
            sp38.unk0 = (s32) temp_v1->unk24;
            sp38.unk4 = (s32) temp_v1->unk28;
            sp38.unk8 = (s32) temp_v1->unk2C;
...
void EnBal_Update(EnBal *this, GlobalContext *globalCtx) {
    EnBal *this = (EnBal *) thisx;
...
void EnBal_Draw(EnBal *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, func_80A63A10, func_80A63B94, (Actor *) this);
}
