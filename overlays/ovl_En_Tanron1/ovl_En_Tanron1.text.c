...
struct _mips2c_stack_EnTanron1_Update {
    ...
    /* 0x2C */ ? *sp2C;                             /* inferred */
    /* 0x30 */ char pad30[0x24];                    /* maybe part of sp2C[10]? */
...
void EnTanron1_Init(EnTanron1 *this, GlobalContext *globalCtx) {
...
void EnTanron1_Destroy(EnTanron1 *this, GlobalContext *globalCtx) {
    EnTanron1 *this = (EnTanron1 *) thisx;
...
loop_1:
    ...
    if (phi_a0->unk24 == 0) {
        phi_a0->unk24 = 1U;
        phi_a0->unk2C = 0.0f;
        phi_a0->unk0 = (s32) arg1->pos.x;
        phi_a0->unk4 = (s32) arg1->pos.y;
        phi_a0->unk1C = 0;
        phi_a0->unk1A = arg2;
        phi_a0->unk8 = (s32) arg1->pos.z;
        phi_a0->unk18 = (s16) phi_a0->unk1C;
        arg0 = phi_a0;
        temp_t2 = (s32) Rand_ZeroFloat(100.0f);
        arg0->unk28 = 0;
        arg0->unk26 = (s16) temp_t2;
...
void EnTanron1_Update(EnTanron1 *this, GlobalContext *globalCtx) {
    EnTanron1 *sp5C;
    Actor *sp54;
    ? *sp2C;
    PosRot *sp28;
    ...
    phi_t0 = temp_t0;
    if (temp_v1 != 0) {
        this->unk148 = temp_v1 - 1;
    }
    temp_v1_2 = this->unk144;
    if (temp_v1_2 != 0) {
        if (temp_v1_2 != 1) {
            if (temp_v1_2 != 0x64) {
                if (temp_v1_2 != 0xC8) {
                    ...
                    if (temp_v1_2 != 0xFA) {
                        ...
                        do {
                            temp_s1 = phi_s1 + 1;
                            phi_s1 = temp_s1;
                            if ((phi_v0->unk24 != 0) && ((s32) phi_v0->unk28 < 8)) {
                                phi_v0->unk28 = 8;
                                phi_v0->unk24 = 2U;
                            }
                            phi_v0 += 0x40;
                    ...
                    this->unk14C = this->actor.world.pos.x;
                    this->unk158 = 0x5000;
                    this->unk15C = 50.0f;
                    this->unk154 = this->actor.world.pos.z;
                    this->unk150 = this->actor.world.pos.y;
                }
            } else {
                phi_f18 = 10.0f;
                if (10.0f < 1000.0f) {
...
loop_19:
                        ...
                        temp_f2 = this->unk14C - temp_f16;
                        temp_f12 = (this->unk150 - phi_v0_2->world.pos.y) + 70.0f;
                        temp_f14 = this->unk154 - phi_v0_2->world.pos.z;
                        if (sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12) + (temp_f14 * temp_f14)) < phi_f18) {
                            this->unk14C = temp_f16;
                            this->unk150 = phi_v0_2->world.pos.y + 70.0f;
                            this->unk154 = phi_v0_2->world.pos.z;
                        } else {
block_23:
...
block_25:
            ...
            this->unk14C = temp_t0->world.pos.x;
            this->unk150 = temp_t0->world.pos.y + 60.0f;
            this->unk154 = temp_t0->world.pos.z;
            if (this->unk148 != 0) {
                sp54 = temp_t0;
    ...
    if ((phi_t0->unk147 == 7) && (phi_t0->unkB28 != 0)) {
        this->unk14C = phi_t0->unkB9C;
        this->unk150 = phi_t0->unkBA0;
        this->unk158 = 0x5000;
        this->unk15C = 50.0f;
        this->unk154 = phi_t0->unkBA4;
        if (phi_a3 != this->unk144) {
            this->unk144 = 0x64;
        }
    } else {
...
loop_38:
            if (phi_a3 == phi_v0_3->params) {
                ...
                this->unk14C = phi_v0_3->world.pos.x;
                this->unk150 = phi_v0_3->world.pos.y + 50.0f;
                this->unk158 = 0x1000;
                this->unk15C = 150.0f;
                this->unk154 = phi_v0_3->world.pos.z;
                if (phi_a3 != this->unk144) {
                    this->unk144 = 0x64;
                }
            }
...
void EnTanron1_Draw(EnTanron1 *this, GlobalContext *globalCtx) {
    EnTanron1 *this = (EnTanron1 *) thisx;
    func_80BB5AAC();
}
...
void func_80BB5318(EnTanron1 *arg0, GlobalContext *arg1) {
    ...
    spB8 = 0;
    spB4 = NULL;
    temp_f30 = arg0->unk15C;
    phi_s2 = NULL;
    phi_f28 = 0.0f;
    if (temp_s4->unkADC != 0) {
        phi_s2 = temp_s4 + 0xB9C;
        if ((s32) temp_s4->unkADA >= 0x1E) {
            phi_f28 = 2500.0f;
        } else {
            phi_f28 = 400.0f;
        }
    ...
    if ((s32) arg0->actor.params > 0) {
        do {
            ...
            if (temp_v0_3 != 0) {
                ...
                if (temp_v0_3 != 0) {
                    spB4 = phi_s0;
                    temp_v0_4 = phi_s0->unk28;
                    if (temp_v0_4 == 0) {
                        spBA += 1;
                        phi_s0->unk2C = (f32) (Math_SinS((s16) (phi_s0->unk26 * 0x5000)) * 1.2f);
                        if ((phi_s0->unk26 & 3) == 0) {
                            temp_f20 = phi_s0->unk30 + (arg0->unk14C - phi_s0->x);
                            temp_f24 = phi_s0->unk34 + (arg0->unk150 - phi_s0->y);
                            temp_f22 = phi_s0->unk38 + (arg0->unk154 - phi_s0->z);
                            phi_s0->unk20 = Math_Atan2S(temp_f20, temp_f22);
                            phi_s0->unk1E = Math_Atan2S(temp_f24, sqrtf((temp_f20 * temp_f20) + (temp_f22 * temp_f22)));
                            if ((phi_s0->unk26 & 0xF) == 0) {
                                phi_s0->unk30 = randPlusMinusPoint5Scaled(temp_f30);
                                phi_s0->unk34 = randPlusMinusPoint5Scaled(temp_f30 * 0.5f);
                                phi_s0->unk38 = randPlusMinusPoint5Scaled(temp_f30);
                            }
                            ...
                            if ((((temp_f20_2 * temp_f20_2) + (temp_f24_2 * temp_f24_2) + (temp_f22_2 * temp_f22_2)) < 400.0f) && (temp_s4->unk14B != 3)) {
                                func_800B8D10(arg1, arg0, 0.0f, 0, 0.0f, 1, 1);
                            }
                        }
                        Math_ApproachS(phi_s0 + 0x1A, phi_s0->unk20, 2, arg0->unk158);
                        Math_ApproachS(phi_s0 + 0x18, phi_s0->unk1E, 2, arg0->unk158);
                        Matrix_RotateY(phi_s0->unk1A, 0U);
                        SysMatrix_InsertXRotation_s((s16) ((s32) phi_s0->unk18 * -1), 1);
                        temp_s1 = phi_s0 + 0xC;
                        SysMatrix_GetStateTranslationAndScaledZ(6.0f, temp_s1);
                        if (phi_s2 != 0) {
                            temp_f20_3 = phi_s2->unk0 - phi_s0->x;
                            temp_f22_3 = phi_s2->unk8 - phi_s0->z;
                            temp_f2 = temp_f20_3 * temp_f20_3;
                            temp_f24_3 = phi_s2->unk4 - phi_s0->y;
                            temp_f16 = temp_f22_3 * temp_f22_3;
                            if ((temp_f2 + (temp_f24_3 * temp_f24_3) + temp_f16) < phi_f28) {
                                sp84 = temp_f2;
                                sp80 = temp_f16;
                                phi_s0->unk20 = Math_Atan2S(temp_f20_3, temp_f22_3);
                                phi_s0->unk1E = Math_Atan2S(temp_f24_3, sqrtf(temp_f2 + temp_f16));
                                Matrix_RotateY(phi_s0->unk20, 0U);
                                SysMatrix_InsertXRotation_s((s16) ((s32) phi_s0->unk1E * -1), 1);
                        ...
                        phi_s0->unk18 = (s16) (phi_s0->unk18 + 0x3000);
                        phi_s0->unk1A = (s16) (phi_s0->unk1A + 0x5000);
                        phi_s0->unk30 = 0.0f;
                        phi_s0->unk34 = 0.0f;
                        phi_s0->unk28 = (s16) (temp_v0_4 + 1);
                    } else {
                        phi_s0->unk1A = (s16) (phi_s0->unk1A + phi_s0->unk2A);
                        Math_ApproachS(phi_s0 + 0x18, 0, 0xA, 0x1000);
                        Matrix_RotateY(phi_s0->unk1A, 0U);
                        SysMatrix_GetStateTranslationAndScaledZ(phi_s0->unk30, (Vec3f *) &spA4);
                        phi_s0->unkC = spA4;
                        phi_s0->unk10 = -2.0f;
                        phi_s0->unk14 = spAC;
                        if (phi_s2 != 0) {
                            temp_f20_4 = phi_s2->unk0 - phi_s0->x;
                            temp_f22_4 = phi_s2->unk8 - phi_s0->z;
                            temp_f2_2 = temp_f20_4 * temp_f20_4;
                            temp_f24_4 = phi_s2->unk4 - phi_s0->y;
                            temp_f16_2 = temp_f22_4 * temp_f22_4;
                            if ((temp_f2_2 + (temp_f24_4 * temp_f24_4) + temp_f16_2) < phi_f28) {
                                sp84 = temp_f2_2;
                                sp80 = temp_f16_2;
                                phi_s0->unk20 = Math_Atan2S(temp_f20_4, temp_f22_4);
                                phi_s0->unk1E = Math_Atan2S(temp_f24_4, sqrtf(temp_f2_2 + temp_f16_2));
                                Matrix_RotateY(phi_s0->unk20, 0U);
                                SysMatrix_InsertXRotation_s((s16) ((s32) phi_s0->unk1E * -1), 1);
                                SysMatrix_GetStateTranslationAndScaledZ(-20.0f, phi_s0 + 0xC);
                                phi_s0->unk30 = 5.0f;
                                phi_s0->unk3C = (f32) (phi_s0->y - 1000.0f);
                            }
                        }
                        temp_f0 = phi_s0->unk3C + 5.0f;
                        if (phi_s0->y <= temp_f0) {
                            phi_s0->y = temp_f0;
                            Math_ApproachZeroF(phi_s0 + 0x30, 1.0f, 0.3f);
                            Math_ApproachS(phi_s0 + 0x2A, 0, 1, 0x100);
                            phi_s0->unk28 = (s16) (phi_s0->unk28 + 1);
                            if ((s32) phi_s0->unk28 >= 0x33) {
                                phi_s0->unk24 = 0U;
                            }
                        } else {
                            Math_ApproachF(phi_s0 + 0x30, phi_s0->unk34, 1.0f, 0.5f);
                            if ((phi_s0->unk26 & 0xF) == 0) {
                                temp_s1_2 = arg1 + 0x830;
                                if (Rand_ZeroOne() < 0.5f) {
                                    phi_s0->unk34 = randPlusMinusPoint5Scaled(12.0f);
                                }
                                phi_s0->unk3C = func_800C3FA0(temp_s1_2, &sp98, phi_s0);
                                temp_t9 = &sp9C;
                                sp9C = phi_s0->y;
                                func_800CA1AC(arg1, temp_s1_2, phi_s0->x, phi_s0->z, temp_t9, &spA0);
                                if ((sp9C < phi_s0->y) && (phi_s0->unk3C < sp9C)) {
                                    phi_s0->unk3C = sp9C;
                                }
                            }
                        }
    ...
    if ((s32) temp_a0_2 > 0) {
        do {
            if (phi_s2->unk24 == 1) {
                ...
                Matrix_RotateY(phi_s2->unk1A, 1U);
                SysMatrix_InsertXRotation_s((s16) ((s32) phi_s2->unk18 * -1), 1);
                Matrix_Scale(1.2f, phi_s2->unk2C, 1.2f, 1);
    ...
    if (phi_a0_2 > 0) {
        do {
            if (phi_s2_2->unk24 == 2) {
                ...
                Matrix_RotateY(phi_s2_2->unk1A, 1U);
                SysMatrix_InsertXRotation_s((s16) ((s32) phi_s2_2->unk18 * -1), 1);
                Matrix_Scale(1.0f, phi_s2_2->unk2C, 1.0f, 1);
