...
void ObjTokeiStep_InitTimers(ObjTokeiStep *arg0) {
    ...
    temp_v1_2->unk_184 = 0xA;
    temp_v1_2->unk_198 = 0xA;
    temp_v1_2->unk_1AC = 0xA;
    temp_v1_2->unk_170 = 0xA;
}
...
s32 ObjTokeiStep_OpenProcess(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        if (phi_v1 != 0) {
            temp_v0 = phi_s0->unk_10;
            if ((s32) temp_v0 > 0) {
                phi_s0->unk_10 = (s16) (temp_v0 - 1);
                phi_s3 = 0;
            }
        }
        if ((phi_v1 != 0) && ((s32) phi_s0->unk_12 < 3) && ((s32) phi_s0->unk_10 <= 0)) {
            ...
            phi_s0->unk_C = (f32) (phi_s0->unk_C + -2.5f);
            phi_s0->unk_C = (f32) (phi_s0->unk_C * 0.83f);
            phi_s0->unk_4 = (f32) (phi_s0->unk_4 + phi_s0->unk_C);
            if (phi_s0->unk_4 < temp_f20) {
                phi_s0->unk_12 = (s8) (phi_s0->unk_12 + 1);
                if ((s32) phi_s0->unk_12 >= 3) {
                    phi_s0->unk_4 = temp_f20;
                } else {
                    phi_s0->unk_C = (f32) (phi_s0->unk_C * -0.4f);
                    if (phi_s0->unk_C > 4.0f) {
                        phi_s0->unk_C = 4.0f;
                    }
                    phi_s0->unk_4 = (f32) ((phi_s0->unk_4 - temp_f20) * -0.4f);
                    temp_f2 = phi_s0->unk_4;
                    if (phi_s0->unk_C < temp_f2) {
                        phi_s0->unk_4 = (f32) (phi_s0->unk_C + temp_f20);
                    } else {
                        phi_s0->unk_4 = (f32) (temp_f2 + temp_f20);
                    }
                    if (phi_s0->unk_12 == 1) {
...
void ObjTokeiStep_DrawOpen(Actor *thisx, GlobalContext *globalCtx) {
    ...
    do {
        ...
        temp_s0_2->unk_0 = 0xDE000000U;
        temp_s0_2->unk_4 = &D_06000088;
