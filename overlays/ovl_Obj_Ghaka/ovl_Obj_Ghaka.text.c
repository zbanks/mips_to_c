...
void ObjGhaka_Init(ObjGhaka *this, GlobalContext *globalCtx) {
...
void ObjGhaka_Destroy(ObjGhaka *this, GlobalContext *globalCtx) {
    ObjGhaka *this = (ObjGhaka *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->dyna.bgId);
}

void ObjGhaka_Update(ObjGhaka *this, GlobalContext *globalCtx) {
    ObjGhaka *this = (ObjGhaka *) thisx;
...
void ObjGhaka_Draw(ObjGhaka *this, GlobalContext *globalCtx) {
    Gfx *sp2C;
    Gfx *sp24;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
