...
static ? *D_80AB16A8 = {&D_80AB13A0, &D_80AB1398, &D_80AB1390, NULL, NULL};
static ? D_80AB16BC;                                /* unable to generate initializer */
static InitChainEntry D_80AB1764;                   /* unable to generate initializer */
...
typedef struct DmChar08 {
    ...
    /* 0x01A0 */ void (*actionFunc)(DmChar08 *, GlobalContext *);
    /* 0x01A4 */ Actor *unk1A4;                     /* inferred */
    /* 0x01A8 */ Actor *unk1A8;                     /* inferred */
    ...
    /* 0x01C4 */ char pad1C4[0xC];                  /* maybe part of unk1C0[4]? */
    /* 0x01D0 */ f32 unk1D0;                        /* inferred */
    /* 0x01D4 */ f32 unk1D4;                        /* inferred */
    /* 0x01D8 */ f32 unk1D8;                        /* inferred */
    /* 0x01DC */ char pad1DC[0x8];                  /* maybe part of unk1D8[3]? */
    /* 0x01E4 */ f32 unk1E4;                        /* inferred */
    /* 0x01E8 */ char pad1E8[0x8];                  /* maybe part of unk1E4[3]? */
    ...
    /* 0x01FC */ u16 unk1FC;                        /* inferred */
    /* 0x01FE */ u8 unk1FE;                         /* inferred */
    /* 0x01FF */ u8 unk1FF;                         /* inferred */
    /* 0x0200 */ u8 unk200;                         /* inferred */
    /* 0x0201 */ u8 unk201;                         /* inferred */
    /* 0x0202 */ u8 unk202;                         /* inferred */
    /* 0x0203 */ u8 unk203;                         /* inferred */
    /* 0x0204 */ char pad204[0x1];                  /* maybe part of unk203[2]? */
    /* 0x0205 */ u8 unk205;                         /* inferred */
    /* 0x0206 */ s8 unk206;                         /* inferred */
    /* 0x0207 */ u8 unk207;                         /* inferred */
    /* 0x0208 */ u8 unk208;                         /* inferred */
    /* 0x0209 */ u8 unk209;                         /* inferred */
    /* 0x020A */ char pad20A[0x2];                  /* maybe part of unk209[3]? */
} DmChar08;                                         /* size 0x20C */
...
void DmChar08_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80AB1764);
...
void func_80AAF79C(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCanPlayNext(phi_s0) != 0) {
        ActorCutscene_Start(phi_s0, &arg0->actor);
...
void func_80AAF8F4(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    Math_SmoothStepToF(&arg0->actor.world.pos.x, -6400.0f, 0.2f, 2.0f, 0.1f);
...
void func_80AAFA18(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCanPlayNext(phi_a0) != 0) {
        ...
        ActorCutscene_Start(phi_a0, &arg0->actor);
...
void func_80AB0A10(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    if (arg1->actorCtx.actorList[2].first->unk24 > 0.0f) {
        ...
        D_80AB1600.unk2 = (s16) (s32) ((500.0f * phi_f2_2) + 720.0f);
...
void DmChar08_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80AAFE88(&this->actor, globalCtx);
    ...
    if (this->unk1FF != 0) {
        func_80AAFCCC(&this->actor, globalCtx);
        func_800B8614(&this->actor, globalCtx, 400.0f);
    }
    func_80AB096C(&this->actor, globalCtx);
...
void DmChar08_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (((s32) this->unk1FF > 0) || (globalCtx->csCtx.state != 0)) {
        func_801343C0(globalCtx, this->unk15C.skeleton, this->unk15C.limbDrawTbl, (s32) this->unk15C.dListCount, func_80AB0E3C, func_80AB0E7C, func_80AB0F90, &this->actor);
