typedef struct DmChar08 {
    ...
    /* 0x1A4 */ Actor *unk_1A4;                     /* inferred */
    /* 0x1A8 */ Actor *unk_1A8;                     /* inferred */
    ...
    /* 0x1C4 */ char pad_1C4[0xC];                  /* maybe part of unk_1C0[4]? */
    /* 0x1D0 */ f32 unk_1D0;                        /* inferred */
    /* 0x1D4 */ f32 unk_1D4;                        /* inferred */
    /* 0x1D8 */ f32 unk_1D8;                        /* inferred */
    /* 0x1DC */ char pad_1DC[0x8];                  /* maybe part of unk_1D8[3]? */
    /* 0x1E4 */ f32 unk_1E4;                        /* inferred */
    /* 0x1E8 */ char pad_1E8[0x8];                  /* maybe part of unk_1E4[3]? */
    /* 0x1F0 */ f32 unk_1F0;                        /* inferred */
    /* 0x1F4 */ s16 unk_1F4;                        /* inferred */
    /* 0x1F6 */ char pad_1F6[0x4];                  /* maybe part of unk_1F4[3]? */
    /* 0x1FA */ s16 unk_1FA;                        /* inferred */
    /* 0x1FC */ s16 unk_1FC;                        /* inferred */
    /* 0x1FE */ s8 unk_1FE;                         /* inferred */
    /* 0x1FF */ u8 unk_1FF;                         /* inferred */
    /* 0x200 */ s8 unk_200;                         /* inferred */
    /* 0x201 */ u8 unk_201;                         /* inferred */
    /* 0x202 */ u8 unk_202;                         /* inferred */
    /* 0x203 */ s8 unk_203;                         /* inferred */
    /* 0x204 */ char pad_204[0x1];
    /* 0x205 */ u8 unk_205;                         /* inferred */
    /* 0x206 */ s8 unk_206;                         /* inferred */
    /* 0x207 */ s8 unk_207;                         /* inferred */
    /* 0x208 */ s8 unk_208;                         /* inferred */
    /* 0x209 */ u8 unk_209;                         /* inferred */
    /* 0x20A */ char pad_20A[0x2];                  /* maybe part of unk_209[3]? */
} DmChar08;                                         /* size = 0x20C */
...
void func_80AAF050(DmChar08 *arg0) {
    ...
    switch (temp_t6) {
    case 0:
        temp_v0 = arg0->unk_1F8;
        arg0->unk_201 = 0;
        if ((s32) temp_v0 > 0) {
            arg0->unk_1F8 = temp_v0 - 1;
        } else {
            arg0->unk_1F8 = 0;
        }
        temp_v0_2 = arg0->unk_1F8;
        if ((s32) temp_v0_2 < 4) {
            arg0->unk_201 = (u8) temp_v0_2;
        }
        if (temp_v0_2 == 0) {
            arg0 = arg0;
            arg0->unk_1F8 = Rand_S16Offset(0x1E, 0x1E);
            return;
        }
    default:
        return;
    case 1:
        temp_v0_3 = arg0->unk_1F8;
        arg0->unk_201 = 4;
        if ((s32) temp_v0_3 > 0) {
            arg0->unk_1F8 = temp_v0_3 - 1;
        } else {
            arg0->unk_1F8 = 0;
        }
        temp_v0_4 = arg0->unk_1F8;
        if ((s32) temp_v0_4 < 4) {
            arg0->unk_201 = temp_v0_4 + 4;
        }
        if (temp_v0_4 == 0) {
            arg0 = arg0;
            arg0->unk_1F8 = Rand_S16Offset(0x1E, 0x1E);
...
void DmChar08_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_1FC = 0xFFFF;
    this->unk_209 = 0;
    this->unk_1E4 = this->actor.world.pos.y;
    this->unk_1F0 = 0.0f;
    ...
    sp40 = temp_a0;
    this->unk_1A4 = Actor_Spawn(temp_a0, globalCtx, 0x23C, this->actor.world.pos.x + -80.0f, this->actor.world.pos.y + 390.0f, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, (s16) 1);
    this->unk_1A8 = Actor_Spawn(temp_a0, globalCtx, 0x23C, this->actor.world.pos.x + 68.0f, this->actor.world.pos.y + 368.0f, this->actor.world.pos.z - 174.0f, (s16) 0, (s16) 0x7530, (s16) 0, (s16) 1);
    ...
    func_80AAF15C(sp3C, (this->unk_202 * 0x18) + &D_80AB16BC, 0);
}
...
void func_80AAF610(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    phi_a2 = temp_v0;
    phi_v1 = temp_v0;
    if (((temp_v0->unk_A70 * 0x10) < 0) && (temp_f0 = temp_v0->world.pos.x, (temp_f0 > -5780.0f)) && (temp_f0 < -5385.0f) && (temp_f0_2 = temp_v0->world.pos.z, (temp_f0_2 > 1120.0f)) && (temp_f0_2 < 2100.0f)) {
        if (D_80AB1770 == 0) {
            sp18 = temp_v0;
            sp1C = temp_v0;
            play_sound(0x4807U);
    ...
    if ((phi_a2->unk_14B == 2) && (arg1->msgCtx.unk1202A == 3) && (arg1->msgCtx.unk1202E == 2)) {
...
void func_80AAF8F4(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_1FA += 0xC8;
    sp28 = 50.0f * Math_SinS(arg0->unk_1FA);
    Math_SmoothStepToF((f32 *) &arg0->actor.world, -6400.0f, 0.2f, 2.0f, 0.1f);
    Math_SmoothStepToF(&arg0->unk_1E4, -180.0f + sp28, 0.5f, 5.0f, 0.1f);
...
void func_80AAFBA4(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk_1FE > 0) {
        do {
            ...
            temp_s0 = phi_s0 + 1;
            phi_s0 = temp_s0;
        } while (temp_s0 < (s32) arg0->unk_1FE);
    }
}
...
void func_80AAFCCC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 0x38) {
        ...
        if (temp_v0_2 != 0) {
            ...
            arg0->unk_206 = (u8) (arg0->unk_206 + 1);
            return;
        }
        /* Duplicate return node #26. Try simplifying control flow for better match */
        return;
...
void func_80AAFE88(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(temp_a0, 0x1DAU) != 0) {
        ...
        temp_a0_3 = *temp_v1->unk_1F4C;
        if (arg0[1].colChkInfo.cylHeight != temp_a0_3) {
            arg0[1].colChkInfo.cylHeight = (s16) temp_a0_3;
            ...
            case 1:
                ...
                break;
            case 3:
                arg0[1].colChkInfo.atHitEffect = 2;
                break;
            case 4:
                arg0->unk_202 = 2;
                break;
            ...
            case 12:
                ...
                break;
            case 13:
                arg0[1].colChkInfo.atHitEffect = 0;
                break;
            case 14:
                arg1 = arg1;
        ...
        if (temp_v0_2 != 2) {
            if (temp_v0_2 != 5) {
                if (temp_v0_2 != 0xE) {
                    ...
                    Math_SmoothStepToS(&arg0->world.rot.y, sp2C->unk_1F4C[4], 0xA, 0xDC, (s16) 1);
            ...
            temp_v0_3 = sp2C->unk_1F4C;
            arg1 = arg1;
            temp_f12 = 2.0f * func_800F5A8C(temp_v0_3[2], temp_v0_3[1], arg1->csCtx.frames, arg1);
            phi_f12 = temp_f12;
            if (temp_f12 > 1.0f) {
                phi_f12 = 1.0f;
            }
            temp_t9 = (u32) ((1.0f - phi_f12) * 255.0f);
            arg0->unk_205 = (s8) temp_t9;
            if ((temp_t9 & 0xFF) < 6) {
                arg0[1].colChkInfo.acHitEffect = 2;
            }
            func_800EDF24(arg0, arg1, sp3C);
        }
        arg0[1].colChkInfo.damageTable = (bitwise DamageTable *) arg0->world.pos.y;
        if (((s32) arg0[1].colChkInfo.acHitEffect >= 2) || (*sp2C->unk_1F4C == 2)) {
            Math_SmoothStepToF(&arg0[1].colChkInfo.displacement.z, 1.0f, 0.02f, 0.1f, 0.00001f);
            return;
        }
        /* Duplicate return node #32. Try simplifying control flow for better match */
        return;
    }
    arg0[1].colChkInfo.cylHeight = 0x63;
}
...
void func_80AB01E8(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk_203 != temp_v0) {
        arg0->unk_203 = temp_v0;
...
void func_80AB023C(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_1FC != temp_v1) && (temp_v1 != 0)) {
        arg0->unk_1FC = temp_v1;
        arg0->unk_208 = 0;
...
void func_80AB032C(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_207;
    switch (temp_v0) {                              /* switch 1 */
    case 1:                                         /* switch 1 */
        temp_v0_2 = arg0->unk_208;
        if (temp_v0_2 != 0) {
            if (temp_v0_2 != 1) {
                return;
            }
            if (func_801378B8(arg0 + 0x15C, arg0->unk_15C.animFrameCount) != 0) {
                arg0->unk_202 = 2;
                arg0->unk_200 = 0;
                arg0->unk_207 = 0;
block_89:
        ...
        arg0->unk_202 = 6;
        arg0->unk_200 = 2;
        arg0->unk_208 = temp_v0_2 + 1;
        return;
    case 2:                                         /* switch 1 */
        temp_v0_3 = arg0->unk_208;
        if (temp_v0_3 != 0) {
            if (temp_v0_3 != 1) {
                if (temp_v0_3 != 2) {
                    return;
        ...
        arg0->unk_202 = 4;
        arg0->unk_200 = 2;
        arg0->unk_208 = temp_v0_3 + 1;
        return;
    case 3:                                         /* switch 1 */
    case 4:                                         /* switch 1 */
    case 8:                                         /* switch 1 */
        temp_t8 = arg0->unk_208;
        ...
        break;
    case 5:                                         /* switch 1 */
        temp_v0_4 = arg0->unk_208;
        switch (temp_v0_4) {                        /* switch 3 */
        case 0:                                     /* switch 3 */
            arg0->unk_202 = 3;
            arg0->unk_200 = 0;
            arg0->unk_208 = temp_v0_4 + 1;
            return;
        case 2:                                     /* switch 3 */
        case 3:                                     /* switch 3 */
            if (func_801378B8(arg0 + 0x15C, arg0->unk_15C.animFrameCount) != 0) {
    ...
    case 6:                                         /* switch 1 */
        ...
        arg0->unk_202 = 3;
        arg0->unk_200 = 5;
        arg0->unk_208 = temp_v0_5 + 1;
        return;
    case 7:                                         /* switch 1 */
        temp_v0_6 = arg0->unk_208;
        if (temp_v0_6 != 0) {
            if (temp_v0_6 != 1) {
                if (temp_v0_6 != 2) {
                    return;
        ...
        arg0->unk_202 = 5;
        arg0->unk_200 = 2;
        arg0->unk_208 = temp_v0_6 + 1;
        return;
    case 9:                                         /* switch 1 */
        temp_v0_7 = arg0->unk_208;
        switch (temp_v0_7) {                        /* switch 4 */
        case 0:                                     /* switch 4 */
            arg0->unk_202 = 3;
            arg0->unk_200 = 0;
            arg0->unk_208 = temp_v0_7 + 1;
            return;
        case 1:                                     /* switch 4 */
            if (func_801378B8(arg0 + 0x15C, arg0->unk_15C.animFrameCount) != 0) {
                arg0->unk_208 += 1;
...
void func_80AB096C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_202 == 1) && (func_801378B8((SkelAnime *) &arg0[1].home.rot.z, 16.0f) != 0)) {
...
void func_80AB0A10(DmChar08 *arg0, GlobalContext *arg1) {
    ...
    phi_v1 = &D_80AB1600;
    phi_f14 = arg1;
    if (arg1->actorCtx.actorList[2].first->unk_24 > 0.0f) {
        temp_f0 = arg0->unk_15C.animCurrentFrame;
        phi_f12 = 19.0f;
        if (temp_f0 <= 19.0f) {
        ...
        *D_80AB16A8 = &D_80AB13A0;
        do {
            temp_v0 = phi_v0 + 0x18;
            temp_v1 = phi_v1 + 0x18;
            temp_v1->unk_-12 = (s16) phi_v0->unk_6;
            temp_v1->unk_-C = (s16) phi_v0->unk_C;
            temp_v1->unk_-6 = (s16) phi_v0->unk_12;
            temp_v1->unk_-18 = (s16) phi_v0->unk_0;
            phi_v0 = temp_v0;
            phi_v1 = temp_v1;
        ...
        (&D_80AB1600)[1].y = (s16) temp_f6;
        (&D_80AB1600)[2].y = (s16) (s32) ((500.0f * phi_f2) + -200.0f);
        (&D_80AB1600)[3].y = (s16) (s32) ((900.0f * phi_f2) + -800.0f);
    } else {
        temp_f0_2 = arg0->unk_15C.animCurrentFrame + 26.0f;
        phi_f0 = temp_f0_2;
        phi_v0_2 = &D_80AB1648;
        phi_v1_2 = &D_80AB1600;
        phi_f12 = 29.0f;
        ...
        *D_80AB16A8 = &D_80AB14D0;
        do {
            ...
            phi_v1_2[3].x = (s16) -(s32) phi_v0_2->unk_12;
            phi_v1_2[2].x = (s16) -(s32) phi_v0_2->unk_C;
            phi_v1_2[1].x = (s16) -(s32) phi_v0_2->unk_6;
            temp_v1_2 = phi_v1_2 + 0x18;
            temp_v1_2->unk_-18 = (s16) -(s32) phi_v0_2->unk_0;
            phi_v0_2 = temp_v0_2;
            phi_v1_2 = temp_v1_2;
        } while (temp_v0_2 != &D_80AB1690);
        D_80AB1600.y = (s16) (s32) ((500.0f * phi_f2_2) + 720.0f);
        (&D_80AB1600)[1].y = (s16) (s32) ((660.0f * phi_f2_2) + 420.0f);
        (&D_80AB1600)[2].y = (s16) (s32) ((1130.0f * phi_f2_2) + -430.0f);
        (&D_80AB1600)[5].y = 0x4B0;
        (&D_80AB1600)[9].y = 0x6A4;
        (&D_80AB1600)[3].y = (s16) (s32) ((1430.0f * phi_f2_2) + -1060.0f);
    }
...
void DmChar08_Update(Actor *thisx, GlobalContext *globalCtx) {
    DmChar08 *this = (DmChar08 *) thisx;
    this->actor.focus.pos.y = this->unk_1D4 + this->actor.targetArrowOffset;
    this->actor.focus.pos.x = this->unk_1D0;
    this->actor.focus.pos.z = this->unk_1D8;
    ...
    this->actor.world.pos.y = this->unk_1E4;
...
void func_80AB0F90(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    ...
    case 4:
        arg2 = arg2;
        SysMatrix_StatePop();
        temp_f12 = ((1.0f - 0.7f) * arg2[1].colChkInfo.displacement.z) + 0.7f;
    ...
    case 22:
        arg2 = arg2;
        SysMatrix_StatePop();
        temp_f12_2 = (arg2[1].colChkInfo.displacement.z * 0.4f) + 0.6f;
        Matrix_Scale(temp_f12_2, temp_f12_2, temp_f12_2, 1);
        SysMatrix_StatePush();
        return;
    case 19:
    case 23:
        temp_f12_3 = (arg2[1].colChkInfo.displacement.z * 0.4f) + 0.6f;
        Matrix_Scale(temp_f12_3, temp_f12_3, temp_f12_3, 1);
        return;
    case 14:
        arg2 = arg2;
        SysMatrix_StatePop();
        temp_f12_4 = (arg2[1].colChkInfo.displacement.z * 0.52f) + 0.48f;
        Matrix_Scale(temp_f12_4, temp_f12_4, temp_f12_4, 1);
        SysMatrix_StatePush();
        return;
    case 10:
    case 12:
        temp_f0 = arg2[1].colChkInfo.displacement.z;
...
void DmChar08_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34 = temp_v0;
    sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_80AB1788 + (this->unk_201 * 4)));
    temp_v0_2 = temp_s1->polyOpa.p;
    temp_s1->polyOpa.p = &temp_v0_2[1];
    temp_v0_2->words.w0 = 0xDB060024;
    sp30 = temp_v0_2;
    sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80AB1788 + (this->unk_201 * 4)));
    if (((s32) this->unk_1FF > 0) || (globalCtx->csCtx.state != 0)) {
        func_801343C0(globalCtx, this->unk_15C.skeleton, this->unk_15C.limbDrawTbl, (s32) this->unk_15C.dListCount, func_80AB0E3C, func_80AB0E7C, func_80AB0F90, (Actor *) this);
        this->unk_1A4->world.pos.x = this->unk_1AC;
        this->unk_1A4->world.pos.y = this->unk_1B0;
        this->unk_1A4->world.pos.z = this->unk_1B4;
        this->unk_1A8->world.pos.x = this->unk_1B8;
        this->unk_1A8->world.pos.y = this->unk_1BC;
        this->unk_1A8->world.pos.z = this->unk_1C0;
    }
    if (this->unk_1FF == 0) {
    ...
    if (this->unk_1FF == 1) {
        ...
        temp_v0_5->words.w1 = (u32) this->unk_205;
