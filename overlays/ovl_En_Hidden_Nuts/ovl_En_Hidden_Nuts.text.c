...
void EnHiddenNuts_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->unk_144, &D_060023B8, &D_060024CC, &this->unk_188, &this->unk_1C4, 0xA);
    Actor_SetScale((Actor *) this, 0.01f);
    this->actor.colChkInfo.mass = 0xFF;
    this->actor.targetMode = 0;
    Collider_InitAndSetCylinder(globalCtx, &this->unk_234, (Actor *) this, &D_80BDC0D0);
    temp_v1 = this->actor.params;
    this->unk_21C = temp_v1 & 0x7F;
    this->unk_21E = ((s32) temp_v1 >> 7) & 0x1F;
    if (this->unk_21C == 0x7F) {
        this->unk_21C = -1;
    }
    if (((s32) this->unk_21C >= 0) && (Flags_GetSwitch(globalCtx, (s32) this->unk_21C) != 0)) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    temp_a1 = this->unk_21E;
    if (temp_a1 == 0x1F) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    this->unk_204 = func_8013D648(globalCtx, temp_a1, 0x3F);
    this->unk_226 = (s16) this->actor.cutscene;
    func_801A5080(2);
    func_80BDB268(this);
}
...
void EnHiddenNuts_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnHiddenNuts *this = (EnHiddenNuts *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_234);
}
...
void func_80BDB1B4(EnHiddenNuts *arg0, s32 arg1) {
    ...
    sp34 = 0.0f;
    sp30 = -4.0f;
    temp_v1 = arg0->unk_220;
    arg0->unk_22C = (f32) SkelAnime_GetFrameCount(*(&D_80BDC0FC + (arg1 * 4)));
    phi_f0 = 0.0f;
    phi_f2 = -4.0f;
    if (temp_v1 == 1) {
        phi_f0 = arg0->unk_22C;
    ...
    SkelAnime_ChangeAnim(arg0 + 0x144, *(&D_80BDC0FC + (temp_v1 * 4)), 1.0f, phi_f0, arg0->unk_22C, (u8) (s32) *(&D_80BDC120 + temp_v1), phi_f2);
}

void func_80BDB268(EnHiddenNuts *arg0) {
    arg0->actor.textId = 0x234;
    arg0->unk_228 = 1600.0f;
...
void func_80BDB2B8(EnHiddenNuts *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_218 == 0) {
        sp94.unk_0 = (s32) D_80BDC12C.unk_0;
        sp94.unk_4 = (s32) D_80BDC12C.unk_4;
        sp94.unk_8 = (s32) D_80BDC12C.unk_8;
        sp88.unk_0 = (s32) D_80BDC138.unk_0;
        sp88.unk_4 = (s32) D_80BDC138.unk_4;
        temp_s2 = &this->actor.world;
        sp88.unk_8 = (s32) D_80BDC138.unk_8;
        temp_s1 = &sp74;
        sp84 = D_80BDC144;
        sp80 = D_80BDC148;
        phi_s0 = 0;
...
void func_80BDB59C(EnHiddenNuts *this, GlobalContext *globalCtx) {
    ...
    Audio_PlayActorSound2((Actor *) this, 0x3201U);
    if (this->unk_218 == 0) {
        sp98.unk_0 = (s32) D_80BDC14C.unk_0;
        sp98.unk_4 = (s32) D_80BDC14C.unk_4;
        sp98.unk_8 = (s32) D_80BDC14C.unk_8;
        sp8C.unk_0 = (s32) D_80BDC158.unk_0;
        sp8C.unk_4 = (s32) D_80BDC158.unk_4;
        sp8C.unk_8 = (s32) D_80BDC158.unk_8;
        temp_s1 = &sp78;
        sp88 = D_80BDC164;
        sp84 = D_80BDC168;
        temp_s2 = &this->actor.world;
...
void func_80BDB7E8(EnHiddenNuts *this, GlobalContext *globalCtx) {
    ...
    ActorCutscene_StartAndSetUnkLinkFields(this->unk_226, (Actor *) this);
...
void func_80BDB8F4(EnHiddenNuts *this, GlobalContext *globalCtx) {
    if (this->unk_22C <= this->unk_144.animCurrentFrame) {
        func_80BDB930();
    }
}
...
void func_80BDB978(EnHiddenNuts *this, GlobalContext *globalCtx) {
    ...
    sp20 = temp_a0;
    sp24 = this->unk_144.animCurrentFrame;
    ...
    if (this->unk_22C <= sp24) {
        this->unk_224 += 1;
        if ((s32) this->unk_224 >= 2) {
...
void func_80BDBA28(EnHiddenNuts *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = arg0->unk_204;
    arg0->unk_208 = 1;
    if ((temp_a0 != 0) && (func_8013D68C(temp_a0, arg0->unk_208, (void *) &arg0->unk_20C) == 0)) {
        Actor_MarkForDeath((Actor *) arg0);
    }
    arg0->actor.speedXZ = 2.0f;
    arg0->actor.gravity = -2.0f;
    arg0->actor.velocity.y = 4.0f;
    arg0->actor.world.rot.y = Math_Vec3f_Yaw((Vec3f *) sp40, &arg0->unk_20C);
    arg0->unk_21A = 4;
...
void func_80BDBB48(EnHiddenNuts *this, GlobalContext *globalCtx) {
    ...
    Math_ApproachF((f32 *) sp30, this->unk_20C.x, 0.5f, fabsf(((f32) gGameInfo->data[2433] + 8.0f) * Math_SinS(this->actor.world.rot.y)));
    Math_ApproachF(&this->actor.world.pos.z, this->unk_20C.z, 0.5f, fabsf(((f32) gGameInfo->data[2433] + 8.0f) * Math_CosS(this->actor.world.rot.y)));
    temp_f2 = this->actor.world.pos.x - this->unk_20C.x;
    temp_f12 = this->actor.world.pos.z - this->unk_20C.z;
    if ((sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12)) < 4.0f) && (temp_a0_3 = this->unk_204, (temp_a0_3 != 0))) {
        this->unk_208 += 1;
        temp_a1_2 = this->unk_208;
