...
static InitChainEntry D_808E3DB8;                   /* unable to generate initializer */

typedef struct MirRay {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ LightInfo unk144;                  /* inferred */
    /* 0x0152 */ char pad152[0xE];                  /* maybe part of unk144[2]? */
    /* 0x0160 */ void *unk160;                      /* inferred */
    /* 0x0164 */ ColliderJntSphElement unk164;      /* inferred */
    /* 0x01A4 */ ColliderQuad unk1A4;               /* inferred */
    ...
    /* 0x023C */ char pad23C[0x4];                  /* maybe part of unk238[2]? */
    /* 0x0240 */ f32 unk240;                        /* inferred */
    /* 0x0244 */ f32 unk244;                        /* inferred */
    /* 0x0248 */ char pad248[0x4];                  /* maybe part of unk244[2]? */
    /* 0x024C */ f32 unk24C;                        /* inferred */
    /* 0x0250 */ f32 unk250;                        /* inferred */
    /* 0x0254 */ char pad254[0x4];                  /* maybe part of unk250[2]? */
    /* 0x0258 */ f32 unk258;                        /* inferred */
    /* 0x025C */ f32 unk25C;                        /* inferred */
    /* 0x0260 */ char pad260[0x4];                  /* maybe part of unk25C[2]? */
    /* 0x0264 */ f32 unk264;                        /* inferred */
    /* 0x0268 */ f32 unk268;                        /* inferred */
    /* 0x026C */ char pad26C[0x4];                  /* maybe part of unk268[2]? */
    ...
    /* 0x0294 */ LightNode *unk294;                 /* inferred */
    /* 0x0298 */ LightInfo unk298;                  /* inferred */
    /* 0x02A6 */ u8 unk2A6;                         /* inferred */
    /* 0x02A7 */ char pad2A7[0x1];                  /* maybe part of unk2A6[2]? */
} MirRay;                                           /* size 0x2A8 */
...
void func_808E26C8(MirRay *arg0, GlobalContext *arg1) {
    ...
    if (func_808E3984(temp_a0, temp_a1, temp_v1->world.pos.x, temp_v1->world.pos.y + 30.0f, temp_v1->world.pos.z, (s32) arg0->unk28C, (s32) arg0->unk28E) != 0) {
        if ((temp_s1->unk1F & 8) != 0) {
            Math_Vec3f_Diff(temp_v1 + 0x24, sp38, &sp44);
        } else {
            Math_Vec3f_Diff(sp34, sp38, &sp44);
        }
        temp_f0 = temp_s1->unk18;
        sp3C = (s16) (s32) ((temp_f0 * sp44.x) + arg0->unk274);
        sp3E = (s16) (s32) ((temp_f0 * sp44.y) + arg0->unk278);
        sp40 = (s16) (s32) ((temp_f0 * sp44.z) + arg0->unk27C);
...
void MirRay_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_808E3DB8);
    ...
    if ((temp_s1->unk1F & 2) != 0) {
        ...
        Collider_SetJntSph(globalCtx, (ColliderJntSph *) temp_a1, &this->actor, &D_808E3C68, &this->unk164);
    ...
    Collider_SetQuad(globalCtx, temp_s1_2, &this->actor, &D_808E3BF4);
...
void MirRay_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk2A6 == 0) {
        ...
        if (this->unk224 > 0.0f) {
            CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, &this->unk1A4.base);
        }
...
s32 func_808E3984(Vec3f *arg0, Vec3f *arg1, f32 arg2, f32 arg3, f32 arg4, s16 arg5, s16 arg6) {
    ...
    if (((temp_f12_2 * temp_f12_2) + (temp_f14_2 * temp_f14_2) + (temp_f16_2 * temp_f16_2)) <= (temp_f2_2 * temp_f2_2)) {
        arg0 = arg0;
        Math_Vec3f_Diff(arg1, temp_a1, &sp5C);
        temp_a1_2 = &sp50;
        sp50 = arg2 - arg0->x;
        sp54 = arg3 - arg0->y;
        sp58 = arg4 - arg0->z;
        if ((bitwise f32) Math3D_Parallel(&sp5C, (Vec3f *) temp_a1_2) < 0.0f) {
            return 0;
        }
        temp_a1_3 = &sp44;
        sp44 = arg2 - arg1->x;
        sp48 = arg3 - arg1->y;
        sp4C = arg4 - arg1->z;
        if ((bitwise f32) Math3D_Parallel(&sp5C, (Vec3f *) temp_a1_3) > 0.0f) {
            return 0;
        }
        phi_v0 = 1;
