...
void func_809EE668(s32 arg0, void *arg1, Vec3f *arg2); /* static */
...
static CollisionPoly D_809F1A30;                    /* unable to generate initializer */
static Vec3s D_809F1AD0 = {
    {0xF254, 0, 0xF254},
    {0xF254, 0, 0xDAC},
    {0xDAC, 0, 0xDAC},
    {0xDAC, 0, 0xF254},
...
static ColliderJntSphElementInit D_809F1B2C = {
    {
...
typedef struct Boss05 {
    ...
    /* 0x015D */ char pad15D[0x1];                  /* maybe part of unk15C[2]? */
    /* 0x015E */ s16 unk15E;                        /* inferred */
    /* 0x0160 */ s16 unk160;                        /* inferred */
    /* 0x0162 */ s16 unk162;                        /* inferred */
    /* 0x0164 */ char pad164[0x2];                  /* maybe part of unk162[2]? */
    ...
    /* 0x0170 */ void (*actionFunc)(Boss05 *, GlobalContext *);
    /* 0x0174 */ u8 unk174;                         /* inferred */
    /* 0x0175 */ char pad175[0x1];                  /* maybe part of unk174[2]? */
    ...
    /* 0x0188 */ u8 unk188;                         /* inferred */
    /* 0x0189 */ u8 unk189;                         /* inferred */
    /* 0x018A */ char pad18A[0x2];                  /* maybe part of unk189[3]? */
    /* 0x018C */ Vec3f unk18C;                      /* inferred */
    ...
    /* 0x01A4 */ char pad1A4[0x24];                 /* maybe part of unk1A2[19]? */
    /* 0x01C8 */ ColliderJntSph unk1C8;             /* inferred */
    /* 0x01E8 */ ColliderJntSphElement unk1E8;      /* inferred */
    /* 0x0228 */ char pad228[0x40];                 /* maybe part of unk1E8[2]? */
    /* 0x0268 */ SkelAnime unk268;                  /* inferred */
    /* 0x02AC */ Vec3s unk2AC;                      /* inferred */
    /* 0x02B2 */ char pad2B2[0x36];                 /* maybe part of unk2AC[10]? */
    /* 0x02E8 */ Vec3s unk2E8;                      /* inferred */
    /* 0x02EE */ char pad2EE[0x36];                 /* maybe part of unk2E8[10]? */
    ...
    /* 0x0336 */ char pad336[0x2];                  /* maybe part of unk334[2]? */
    /* 0x0338 */ f32 unk338;                        /* inferred */
    /* 0x033C */ Vec3f unk33C;                      /* inferred */
    /* 0x0348 */ s16 unk348;                        /* inferred */
    /* 0x034A */ char pad34A[0x2];                  /* maybe part of unk348[2]? */
    /* 0x034C */ f32 unk34C;                        /* inferred */
    /* 0x0350 */ char pad350[0x4];                  /* maybe part of unk34C[2]? */
    ...
    /* 0x0368 */ ColliderJntSph unk368;             /* inferred */
    /* 0x0388 */ ColliderJntSphElement unk388;      /* inferred */
    /* 0x03C8 */ SkelAnime unk3C8;                  /* inferred */
    /* 0x040C */ Vec3s unk40C;                      /* inferred */
    /* 0x0412 */ char pad412[0x72];                 /* maybe part of unk40C[20]? */
    /* 0x0484 */ Vec3s unk484;                      /* inferred */
    /* 0x048A */ char pad48A[0x72];                 /* maybe part of unk484[20]? */
    /* 0x04FC */ f32 unk4FC;                        /* inferred */
    /* 0x0500 */ s16 unk500;                        /* inferred */
    /* 0x0502 */ s16 unk502;                        /* inferred */
    /* 0x0504 */ char pad504[0x4];                  /* maybe part of unk502[3]? */
} Boss05;                                           /* size 0x508 */
...
void Boss05_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 0) || (temp_v0 == 1)) {
        ...
        this->unk4FC = (f32) SkelAnime_GetFrameCount(&D_06006484.common);
        Collider_InitAndSetJntSph(globalCtx, &this->unk1C8, &this->actor, &D_809F1B74, &this->unk1E8);
        Collider_InitAndSetJntSph(globalCtx, &this->unk368, &this->actor, &D_809F1BA8, &this->unk388);
    ...
    if (temp_v0 == 4) {
        ...
        SkelAnime_InitSV(globalCtx, &this->unk3C8, &D_06006378, &D_06006484, &this->unk40C, &this->unk484, 0x14);
        Collider_InitAndSetJntSph(globalCtx, &this->unk368, &this->actor, &D_809F1BDC, &this->unk388);
        ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 30.0f);
...
void func_809EEDE8(Boss05 *this, GlobalContext *globalCtx) {
    ...
    if (this->unk15C != 0xA) {
        Math_ApproachS(&this->actor.shape.rot.x, 0, 0x14, 0x800);
    }
    if (this->unk15C != 0) {
        if (this->unk15C != 1) {
            if (this->unk15C != 2) {
                if (this->unk15C != 0xA) {
                    ...
                    Math_ApproachS(&this->actor.shape.rot.x, -0x8000, 2, 0x2000);
                    ...
                    if (this->unk162 == 0x1B) {
                        Math_Vec3f_Copy(&sp94, &this->actor.world.pos);
                        sp94.y += 40.0f;
                        EffectSsGSplash_Spawn(globalCtx, &sp94, NULL, NULL, (s16) 1, (s16) 0x7D0);
...
block_42:
    ...
    temp_v0_5 = func_809EECBC(&this->actor, globalCtx);
    temp_s4 = temp_v0_5;
    phi_s4_2 = temp_s4;
    if ((temp_v0_5 != 0) || (this->unk168 == 1)) {
        ...
        func_800BC154(globalCtx, temp_s0_3, &this->actor, 1U);
        if (this->unk168 != 0) {
            phi_s4_2 = 0xA;
        }
        if (phi_s4_2 >= 0xA) {
            temp_v0_6 = Actor_SpawnAsChild(temp_s0_3, &this->actor, globalCtx, 0x12D, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) (s32) this->actor.shape.rot.x, (s16) (s32) this->actor.shape.rot.y, (s16) (s32) this->actor.shape.rot.z, 3);
            if (temp_v0_6 != 0) {
                ...
                Audio_PlayActorSound2(&this->actor, 0x381EU);
                if (phi_s4_2 >= 0xB) {
            ...
            do {
                temp_v0_7 = Actor_SpawnAsChild(temp_s0_3, &this->actor, globalCtx, 0x12D, this->unk324, this->unk328, this->unk32C, (s16) (s32) this->unk330, (s16) (s32) this->unk332, (s16) (s32) this->unk334, phi_s3_2 + 0xA);
                if (temp_v0_7 != 0) {
                    phi_v1 = 0;
                    do {
    ...
    if (sp103 == 0) {
        ...
        CollisionCheck_SetAT(globalCtx, temp_s0_6, &this->unk1C8.base);
        CollisionCheck_SetAT(globalCtx, temp_s0_6, &this->unk368.base);
    }
    temp_s0_7 = &globalCtx->colChkCtx;
    temp_s1_2 = &this->unk368;
    CollisionCheck_SetAC(globalCtx, temp_s0_7, &this->unk1C8.base);
    CollisionCheck_SetAC(globalCtx, temp_s0_7, &temp_s1_2->base);
}
...
void func_809EF9BC(Boss05 *this, GlobalContext *globalCtx) {
    ...
    if ((temp_f0 < 50.0f) && ((globalCtx->actorCtx.actorList[2].first->bgCheckFlags & 1) != 0)) {
        ...
        if ((this->unk160 & 0xF) == 0) {
            EffectSsGRipple_Spawn(globalCtx, &this->actor.world.pos, 0x1F4, 0x3E8, (s16) 0);
            return;
        }
...
void func_809EFAB4(Boss05 *this, GlobalContext *globalCtx) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 50.0f, 40.0f, 0x44U);
    this->actor.world.pos.y += 85.0f;
    this->actor.prevPos.y += 85.0f;
    ...
    if ((this->actor.bgCheckFlags & 0x40) != 0) {
        ...
        sp80.y += 20.0f;
        EffectSsGSplash_Spawn(globalCtx, &temp_s1->pos, NULL, NULL, (s16) 1, (s16) 0x3E8);
        this->unk166 = 0x14;
    }
    phi_s1 = 0;
    if (this->unk166 != 0) {
    ...
    if ((this->actor.bgCheckFlags & 1) != 0) {
        ...
        if (this->unk198 == 0.0f) {
            temp_v0 = Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0x12D, this->unk324, this->unk328, this->unk32C, (s16) (s32) this->unk330, (s16) (s32) this->unk332, (s16) (s32) this->unk334, 4);
            if (temp_v0 != 0) {
                temp_v1 = globalCtx->actorCtx.actorList[2].first;
                if (this == temp_v1->unk730) {
...
void func_809F010C(Boss05 *this, GlobalContext *globalCtx) {
    ...
    Math_ApproachS(&this->actor.shape.rot.x, 0, 2, 0x400);
...
void func_809F0374(Boss05 *this, GlobalContext *globalCtx) {
    ...
    Audio_PlayActorSound2(&this->actor, 0x3027U);
    SkelAnime_FrameUpdateMatrix(&this->unk3C8);
...
void func_809F04C0(Boss05 *this, GlobalContext *globalCtx) {
    SkelAnime_FrameUpdateMatrix(&this->unk3C8);
    Audio_PlayActorSound2(&this->actor, 0x3006U);
    Math_ApproachZeroF(&this->actor.speedXZ, 1.0f, 2.5f);
...
void func_809F0650(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk4FC = (f32) SkelAnime_GetFrameCount(&D_060006A4.common);
...
void func_809F0780(Boss05 *this, GlobalContext *globalCtx) {
    ...
    if ((s32) (s8) this->actor.colChkInfo.health <= 0) {
        ...
        if (func_801378B8(temp_s1, 22.0f) != 0) {
            do {
                temp_v0 = Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0x12D, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) (s32) this->actor.shape.rot.x, (s16) (s32) this->actor.shape.rot.y, (s16) (s32) this->actor.shape.rot.z, phi_s2 + 0xA);
                temp_s2 = phi_s2 + 1;
                phi_s2 = temp_s2;
                if (temp_v0 != 0) {
                    phi_v1 = 0;
            ...
            Audio_PlaySoundAtPosition(globalCtx, &temp_s1_3->pos, 0x28, 0x381FU);
            Actor_MarkForDeath(&this->actor);
            Item_DropCollectibleRandom(globalCtx, NULL, &temp_s1_3->pos, 0xE0);
            return;
        }
...
void Boss05_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.params == 4) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 50.0f, 40.0f, 0x45U);
        func_809EFE50(&this->actor, globalCtx);
        temp_a2 = &this->unk368;
    ...
    case 11:
        if (this->unk17A == 0) {
            func_809EE4E0(&this->actor, globalCtx);
            this->unk188 = 0;
            return;
        }
...
void func_809F1170(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 4) {
        ...
        func_8018219C(&sp3C, arg4 + 0x330, 0);
    ...
    if (arg1 == 3) {
        sp20 = arg4 + 0x1C8;
        SysMatrix_GetStateTranslationAndScaledY(-500.0f, &sp24);
...
void Boss05_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_809EEDE8 == this->actionFunc) {
        SkelAnime_DrawSV(globalCtx, this->unk268.skeleton, this->unk268.limbDrawTbl, (s32) this->unk268.dListCount, func_809F1050, func_809F1170, &this->actor);
        if ((this->unk16C & 1) != 0) {
        ...
        func_801343C0(globalCtx, this->unk3C8.skeleton, this->unk3C8.limbDrawTbl, (s32) this->unk3C8.dListCount, func_809F1284, func_809F12A0, func_809F135C, &this->actor);
    } else {
        temp_v0 = this->actor.params;
        if (temp_v0 == 2) {
            ...
            Matrix_Scale(this->actor.scale.x, this->actor.scale.y, this->actor.scale.z, 1);
            SkelAnime_DrawSV(globalCtx, this->unk268.skeleton, this->unk268.limbDrawTbl, (s32) this->unk268.dListCount, func_809F1404, NULL, &this->actor);
        } else if (temp_v0 == 3) {
            func_801343C0(globalCtx, this->unk268.skeleton, this->unk268.limbDrawTbl, (s32) this->unk268.dListCount, func_809F1430, func_809F1170, func_809F1464, &this->actor);
            SysMatrix_InsertTranslation(this->unk324, this->unk328, this->unk32C, 0);
            Matrix_RotateY(this->unk332, 1U);
            SysMatrix_InsertXRotation_s(this->unk330, 1);
            SysMatrix_InsertZRotation_s(this->unk334, 1);
            ...
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06006240));
            func_801343C0(globalCtx, this->unk3C8.skeleton, this->unk3C8.limbDrawTbl, (s32) this->unk3C8.dListCount, func_809F1284, func_809F12A0, func_809F135C, &this->actor);
            func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk18C, 1, this->unk17C, this->unk180, this->unk184, (u8) (s32) this->unk189);
        } else if (temp_v0 == 4) {
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06006240));
            if ((this->unk16C & 1) != 0) {
                sp34->polyOpa.p = Gfx_SetFog(sp34->polyOpa.p, 0xFF, 0, 0, 0xFF, 0x384, 0x44B);
            ...
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06006240));
            SkelAnime_DrawSV(globalCtx, this->unk3C8.skeleton, this->unk3C8.limbDrawTbl, (s32) this->unk3C8.dListCount, func_809F14AC, func_809F1550, &this->actor);
        }
    }
