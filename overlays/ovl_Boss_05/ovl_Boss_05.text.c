typedef struct Boss05 {
    ...
    /* 0x174 */ u8 unk_174;                         /* inferred */
    /* 0x175 */ char pad_175[0x1];
    ...
    /* 0x188 */ u8 unk_188;                         /* inferred */
    /* 0x189 */ u8 unk_189;                         /* inferred */
    /* 0x18A */ char pad_18A[0x2];                  /* maybe part of unk_189[3]? */
    /* 0x18C */ Vec3f unk_18C;                      /* inferred */
    ...
    /* 0x1A4 */ char pad_1A4[0x24];                 /* maybe part of unk_1A2[19]? */
    /* 0x1C8 */ ColliderJntSph unk_1C8;             /* inferred */
    /* 0x1E8 */ ColliderJntSphElement unk_1E8;      /* inferred */
    /* 0x228 */ char pad_228[0x40];
    /* 0x268 */ SkelAnime unk_268;                  /* inferred */
    /* 0x2AC */ Vec3s unk_2AC;                      /* inferred */
    /* 0x2B2 */ char pad_2B2[0x36];                 /* maybe part of unk_2AC[10]? */
    /* 0x2E8 */ Vec3s unk_2E8;                      /* inferred */
    /* 0x2EE */ char pad_2EE[0x36];                 /* maybe part of unk_2E8[10]? */
    /* 0x324 */ f32 unk_324;                        /* inferred */
    /* 0x328 */ f32 unk_328;                        /* inferred */
    /* 0x32C */ f32 unk_32C;                        /* inferred */
    /* 0x330 */ s16 unk_330;                        /* inferred */
    /* 0x332 */ s16 unk_332;                        /* inferred */
    /* 0x334 */ s16 unk_334;                        /* inferred */
    /* 0x336 */ char pad_336[0x2];
    /* 0x338 */ f32 unk_338;                        /* inferred */
    /* 0x33C */ Vec3f unk_33C;                      /* inferred */
    /* 0x348 */ s16 unk_348;                        /* inferred */
    /* 0x34A */ char pad_34A[0x2];
    /* 0x34C */ f32 unk_34C;                        /* inferred */
    /* 0x350 */ char pad_350[0x4];
    /* 0x354 */ f32 unk_354;                        /* inferred */
    /* 0x358 */ f32 unk_358;                        /* inferred */
    /* 0x35C */ f32 unk_35C;                        /* inferred */
    /* 0x360 */ f32 unk_360;                        /* inferred */
    /* 0x364 */ f32 unk_364;                        /* inferred */
    /* 0x368 */ ColliderJntSph unk_368;             /* inferred */
    /* 0x388 */ ColliderJntSphElement unk_388;      /* inferred */
    /* 0x3C8 */ SkelAnime unk_3C8;                  /* inferred */
    /* 0x40C */ Vec3s unk_40C;                      /* inferred */
    /* 0x412 */ char pad_412[0x72];                 /* maybe part of unk_40C[20]? */
    /* 0x484 */ Vec3s unk_484;                      /* inferred */
    /* 0x48A */ char pad_48A[0x72];                 /* maybe part of unk_484[20]? */
    /* 0x4FC */ f32 unk_4FC;                        /* inferred */
    /* 0x500 */ s16 unk_500;                        /* inferred */
    /* 0x502 */ s16 unk_502;                        /* inferred */
    /* 0x504 */ char pad_504[0x4];                  /* maybe part of unk_502[3]? */
} Boss05;                                           /* size = 0x508 */
...
struct _mips2c_stack_func_809EEDE8 {
    ...
    /* 0x064 */ char pad_64[0x8];                   /* maybe part of sp60[3]? */
    ...
    /* 0x084 */ char pad_84[0x10];                  /* maybe part of sp80[5]? */
    /* 0x094 */ ? sp94;                             /* inferred */
    /* 0x094 */ char pad_94[0x4];
    /* 0x098 */ f32 sp98;                           /* inferred */
    /* 0x09C */ char pad_9C[0x8];                   /* maybe part of sp98[3]? */
    /* 0x0A4 */ f32 spA4;                           /* inferred */
    /* 0x0A8 */ char pad_A8[0xC];                   /* maybe part of spA4[4]? */
    ...
    /* 0x0D8 */ ? spD8;                             /* inferred */
    /* 0x0D8 */ char pad_D8[0x2B];
    /* 0x103 */ u8 sp103;                           /* inferred */
    /* 0x104 */ char pad_104[0x4];                  /* maybe part of sp103[5]? */
...
void func_809EE4E0(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        sp8C = arg0->unk_18C + sp80;
        sp90 = arg0->unk_190 + sp84;
        sp94 = arg0->unk_194 + sp88;
...
void Boss05_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 0) || (temp_v0 == 1)) {
        ...
        this->unk_168 = this->actor.world.rot.z;
        ...
        SkelAnime_InitSV(globalCtx, &this->unk_268, &D_060024E0, &D_06000ABC, &this->unk_2AC, &this->unk_2E8, 0xA);
        SkelAnime_InitSV(globalCtx, &this->unk_3C8, &D_06006378, &D_06006484, &this->unk_40C, &this->unk_484, 0x14);
        this->unk_4FC = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06006484);
        Collider_InitAndSetJntSph(globalCtx, &this->unk_1C8, (Actor *) this, &D_809F1B74, &this->unk_1E8);
        Collider_InitAndSetJntSph(globalCtx, &this->unk_368, (Actor *) this, &D_809F1BA8, &this->unk_388);
    ...
    if (temp_v0 == 4) {
        ...
        SkelAnime_InitSV(globalCtx, &this->unk_3C8, &D_06006378, &D_06006484, &this->unk_40C, &this->unk_484, 0x14);
        Collider_InitAndSetJntSph(globalCtx, &this->unk_368, (Actor *) this, &D_809F1BDC, &this->unk_388);
        ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 30.0f);
    ...
    if ((s32) temp_v0 >= 0xA) {
        ...
        this->unk_500 = (s16) (s32) randPlusMinusPoint5Scaled(700.0f);
        this->unk_502 = (s16) (s32) randPlusMinusPoint5Scaled(1500.0f);
        temp_f4 = (s32) (Rand_ZeroFloat(30.0f) + 50.0f);
        this->actor.flags &= -2;
        this->actionFunc = func_809F0B0C;
        this->unk_162 = (s16) temp_f4;
    }
}
...
s32 func_809EECBC(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_v0 = 0;
    if (arg0->unk_16C == 0) {
        phi_v1 = arg0[1].colChkInfo.damageTable;
loop_2:
        temp_v0 = phi_v0 + 0x40;
        phi_v0 = temp_v0;
        if ((phi_v1->attack[22] & 2) != 0) {
        ...
        phi_v1 += 0x40;
        if (temp_v0 == 0x80) {
            if ((arg0[2].uncullZoneForward->unk_16 & 2) != 0) {
                temp_a0 = arg0;
...
void func_809EEDE8(Boss05 *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if ((temp_v0_2 == 0) || (temp_v0_2 == 3)) {
            ...
            if (phi_s3 < 3) {
                ...
                sp74 = temp_lo;
                sp80 = (f32) spCC;
                phi_s1->unk_0 = (s16) (s32) (Math_SinS((s16) ((this->unk_160 * spD4) + (phi_s3 * spD0))) * sp80);
            } else {
                phi_s1->unk_0 = 0;
                sp74 = temp_lo;
                sp80 = (f32) spC0;
                phi_s1->unk_2 = (s16) (s32) (Math_SinS((s16) ((this->unk_160 * spC8) + (phi_s3 * spC4))) * sp80);
            }
            if ((phi_s3 == 4) || (phi_s3 == 6)) {
                phi_s1->unk_4 = (s16) (s32) (2.0f * (Math_SinS((s16) ((this->unk_160 * spBC) + (phi_s3 * spB8))) * sp70));
            } else {
                phi_s1->unk_4 = (s16) (s32) (Math_SinS((s16) ((this->unk_160 * spBC) + (phi_s3 * spB8))) * sp70);
            }
        } else {
            if (temp_v0_2 == 1) {
                temp_v0_3 = phi_s0 + &D_809F1C60;
                phi_s1->unk_0 = (s16) temp_v0_3->unk_0;
                phi_s1->unk_2 = (s16) temp_v0_3->unk_2;
                phi_s1->unk_4 = (s16) temp_v0_3->unk_4;
                phi_s6_2 = 5;
                phi_s7_2 = 0x1000;
            } else if (temp_v0_2 == 2) {
                temp_v0_4 = phi_s0 + &D_809F1C8C;
                phi_s1->unk_0 = (s16) temp_v0_4->unk_0;
                phi_s1->unk_2 = (s16) temp_v0_4->unk_2;
                phi_s1->unk_4 = (s16) temp_v0_4->unk_4;
                phi_s6_2 = 1;
                phi_s7_2 = 0x2000;
            }
            phi_s4 = phi_s6_2;
        ...
        Math_ApproachS(sp6C, phi_s1->unk_0, phi_s4, phi_s5);
        Math_ApproachS(sp60, phi_s1->unk_2, phi_s4, phi_s5);
        Math_ApproachS(sp5C, phi_s1->unk_4, phi_s4, phi_s5);
        temp_s3 = phi_s3 + 1;
        sp5C = &sp5C[3];
        sp60 = &sp60[3];
        sp6C = &sp6C[3];
    ...
    temp_s0 = &this->unk_3C8;
    SkelAnime_FrameUpdateMatrix(temp_s0);
    temp_s1 = &this->unk_35C;
    ...
    if (this->unk_15C != 0) {
        if (this->unk_15C != 1) {
            if (this->unk_15C != 2) {
                if (this->unk_15C != 0xA) {
                    ...
                    this->unk_19C = (this->unk_162 & 1) << 9;
                    this->unk_174 = 3;
                    this->unk_3C8.animPlaybackSpeed = 4.0f;
            ...
            if (func_801378B8(temp_s0, this->unk_4FC) != 0) {
                this->unk_3C8.animPlaybackSpeed = 0.0f;
            }
            this->unk_174 = 1;
            if (this->unk_162 == 0) {
                this->unk_15C = 2;
        ...
        this->unk_174 = 0;
        this->unk_3C8.animPlaybackSpeed = 1.0f;
        if (spA4 < 0.0f) {
            ...
            if ((this->unk_162 == 0) && (sqrtf(this->actor.xyzDistToPlayerSq) <= phi_f2)) {
                this->unk_15C = 1;
                this->unk_162 = 0xA;
            }
            goto block_42;
...
block_42:
        ...
        if (((this->unk_160 & 3) == 0) && (Rand_ZeroOne() < 0.5f)) {
            Audio_PlayActorSound2((Actor *) this, 0x3860U);
        }
    }
    ...
    if ((temp_v0_5 != 0) || (this->unk_168 == 1)) {
        ...
        if (phi_s4_2 >= 0xA) {
            ...
            if (temp_v0_6 != 0) {
                ...
                if (this == (bitwise s32) temp_v1[5].shape.feetPos[0].z) {
                    temp_v1[5].shape.feetPos[0].z = (bitwise f32) temp_v0_6;
                    globalCtx->actorCtx.targetContext.unk38 = temp_v0_6;
                    globalCtx->actorCtx.targetContext.unk3C = temp_v0_6;
                }
                do {
                    temp_t5 = this->unk_268.limbDrawTbl + phi_s0_2;
                    temp_t1 = temp_v0_6->unk_288 + phi_s0_2;
                    temp_s0_4 = phi_s0_2 + 6;
                    temp_t1->unk_0 = (unaligned s32) temp_t5->unk_0;
                    temp_t1->unk_4 = (u16) temp_t5->unk_4;
                    phi_s0_2 = temp_s0_4;
                } while (temp_s0_4 < 0x3C);
                do {
                    temp_t9 = this->unk_3C8.limbDrawTbl + phi_s0_3;
                    temp_t7 = temp_v0_6->unk_3E8 + phi_s0_3;
                    temp_t7->unk_0 = (unaligned s32) temp_t9->unk_0;
                    temp_t7->unk_4 = (u16) temp_t9->unk_4;
                    temp_t6 = this->unk_3C8.limbDrawTbl + phi_s0_3;
                    temp_t3 = temp_v0_6->unk_3E8 + phi_s0_3;
                    temp_t3->unk_6 = (unaligned s32) temp_t6->unk_6;
                    temp_t3->unk_A = (u16) temp_t6->unk_A;
                    temp_t5_2 = this->unk_3C8.limbDrawTbl + phi_s0_3;
                    temp_t2 = temp_v0_6->unk_3E8 + phi_s0_3;
                    temp_t2->unk_C = (unaligned s32) temp_t5_2->unk_C;
                    temp_t2->unk_10 = (u16) temp_t5_2->unk_10;
                    temp_t9_2 = this->unk_3C8.limbDrawTbl + phi_s0_3;
                    temp_t8 = temp_v0_6->unk_3E8 + phi_s0_3;
                    temp_s0_5 = phi_s0_3 + 0x18;
                    temp_t8->unk_12 = (unaligned s32) temp_t9_2->unk_12;
                    temp_t8->unk_16 = (u16) temp_t9_2->unk_16;
                    phi_s0_3 = temp_s0_5;
                } while (temp_s0_5 != 0x78);
                Audio_PlayActorSound2((Actor *) this, 0x381EU);
                if (phi_s4_2 >= 0xB) {
                    temp_v0_6->unk_188 = (s8) (phi_s4_2 - 0xA);
                }
            }
        } else if (phi_s4_2 == 2) {
            do {
                temp_v0_7 = Actor_SpawnAsChild(temp_s0_3, (Actor *) this, globalCtx, 0x12D, this->unk_324, this->unk_328, this->unk_32C, (s16) (s32) this->unk_330, (s16) (s32) this->unk_332, (s16) (s32) this->unk_334, phi_s3_2 + 0xA);
                if (temp_v0_7 != 0) {
                    phi_v1 = 0;
                    do {
                        temp_t2_2 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t9_3 = temp_v0_7->unk_3E8 + phi_v1;
                        temp_t9_3->unk_0 = (unaligned s32) temp_t2_2->unk_0;
                        temp_t9_3->unk_4 = (u16) temp_t2_2->unk_4;
                        temp_t8_2 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t6_2 = temp_v0_7->unk_3E8 + phi_v1;
                        temp_t6_2->unk_6 = (unaligned s32) temp_t8_2->unk_6;
                        temp_t6_2->unk_A = (u16) temp_t8_2->unk_A;
                        temp_t3_2 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t5_3 = temp_v0_7->unk_3E8 + phi_v1;
                        temp_t5_3->unk_C = (unaligned s32) temp_t3_2->unk_C;
                        temp_t5_3->unk_10 = (u16) temp_t3_2->unk_10;
                        temp_t2_3 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t1_2 = temp_v0_7->unk_3E8 + phi_v1;
                        temp_v1_2 = phi_v1 + 0x18;
                        temp_t1_2->unk_12 = (unaligned s32) temp_t2_3->unk_12;
                        temp_t1_2->unk_16 = (u16) temp_t2_3->unk_16;
                        phi_v1 = temp_v1_2;
                    } while (temp_v1_2 != 0x78);
                    temp_v0_7->unk_162 = (s16) (s32) (Rand_ZeroFloat(20.0f) + 20.0f);
                }
    ...
    if (sp103 == 0) {
        ...
        CollisionCheck_SetAT(globalCtx, temp_s0_6, (Collider *) &this->unk_1C8);
        CollisionCheck_SetAT(globalCtx, temp_s0_6, (Collider *) &this->unk_368);
    }
    temp_s0_7 = &globalCtx->colChkCtx;
    temp_s1_2 = &this->unk_368;
    CollisionCheck_SetAC(globalCtx, temp_s0_7, (Collider *) &this->unk_1C8);
...
void func_809EF9BC(Boss05 *this, GlobalContext *globalCtx) {
    ...
    if ((temp_f0 < 50.0f) && ((globalCtx->actorCtx.actorList[2].first->bgCheckFlags & 1) != 0)) {
        ...
        Math_ApproachS(&this->unk_178, phi_a1, 0x14, 0x7D0);
        Math_ApproachS(&this->unk_176, this->actor.yawTowardsPlayer, 0x14, 0xFA0);
        if ((this->unk_160 & 0xF) == 0) {
    ...
    Math_ApproachS(&this->unk_178, 0, 0x14, 0x100);
}
...
void func_809EFAB4(Boss05 *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 1) != 0) {
        if ((this->unk_189 == 0xA) && (this->unk_17A != 0)) {
            this->unk_17A = 0;
        }
        Math_ApproachZeroF(&this->unk_198, 1.0f, 0.05f);
        if (this->unk_198 == 0.0f) {
            temp_v0 = Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, 0x12D, this->unk_324, this->unk_328, this->unk_32C, (s16) (s32) this->unk_330, (s16) (s32) this->unk_332, (s16) (s32) this->unk_334, 4);
            if (temp_v0 != 0) {
                temp_v1 = globalCtx->actorCtx.actorList[2].first;
                if (this == (bitwise s32) temp_v1[5].shape.feetPos[0].z) {
                    temp_v1[5].shape.feetPos[0].z = (bitwise f32) temp_v0;
                    globalCtx->actorCtx.targetContext.unk38 = temp_v0;
                    globalCtx->actorCtx.targetContext.unk3C = temp_v0;
                }
                phi_v1 = 0;
                do {
                    temp_t7 = this->unk_3C8.limbDrawTbl + phi_v1;
                    temp_t5 = temp_v0->unk_3E8 + phi_v1;
                    temp_t5->unk_0 = (unaligned s32) temp_t7->unk_0;
                    temp_t5->unk_4 = (u16) temp_t7->unk_4;
                    temp_t3 = this->unk_3C8.limbDrawTbl + phi_v1;
                    temp_t1 = temp_v0->unk_3E8 + phi_v1;
                    temp_t1->unk_6 = (unaligned s32) temp_t3->unk_6;
                    temp_t1->unk_A = (u16) temp_t3->unk_A;
                    temp_t9 = this->unk_3C8.limbDrawTbl + phi_v1;
                    temp_t7_2 = temp_v0->unk_3E8 + phi_v1;
                    temp_t7_2->unk_C = (unaligned s32) temp_t9->unk_C;
                    temp_t7_2->unk_10 = (u16) temp_t9->unk_10;
                    temp_t6 = this->unk_3C8.limbDrawTbl + phi_v1;
                    temp_t3_2 = temp_v0->unk_3E8 + phi_v1;
                    temp_v1_2 = phi_v1 + 0x18;
                    temp_t3_2->unk_12 = (unaligned s32) temp_t6->unk_12;
                    temp_t3_2->unk_16 = (u16) temp_t6->unk_16;
                    phi_v1 = temp_v1_2;
                } while (temp_v1_2 != 0x78);
...
void func_809EFE50(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_a2 = 0U;
    if ((arg0->unk_16A == 0) && (temp_v1 = arg0[2].uncullZoneForward, temp_a0 = temp_v1->unk_16, ((temp_a0 & 2) != 0))) {
        temp_v1->unk_16 = (u8) (temp_a0 & 0xFFFD);
        if ((*arg0[2].uncullZoneForward->unk_24 & 0x300000) != 0) {
            arg0->unk_16A = 6;
            arg0->unk_338 = -12.0f;
            arg0[2].shape.rot.z = arg0->yawTowardsPlayer;
            return;
        }
        arg0->unk_16A = 0xA;
        arg0->speedXZ = 0.0f;
...
block_13:
        ...
        if (phi_a2 != 0) {
            if ((func_809F0ABC == (bitwise s32) arg0[1].world.pos.z) && (arg0->unk_189 == 0xA) && (arg0[1].world.unk_12 != 0)) {
...
s32 func_809F0014(GlobalContext *arg0, ? arg1) {
    ...
    temp_v0 = arg0->state.alloc.base.unk_E - arg0->unk_BE;
    phi_v1 = (s32) temp_v0;
    if ((s32) temp_v0 < 0) {
        phi_v1 = -(s32) temp_v0;
    }
...
void func_809F010C(Boss05 *this, GlobalContext *globalCtx) {
    SkelAnime_FrameUpdateMatrix(&this->unk_3C8);
    Math_ApproachS((s16 *) &this->actor.shape, 0, 2, 0x400);
    Math_ApproachS(&this->actor.shape.rot.z, 0, 2, 0x400);
    Math_ApproachF(&this->unk_360, 1.0f, 1.0f, 0.5f);
    Math_ApproachF(&this->unk_364, 1.0f, 1.0f, 0.14f);
    if (this->unk_364 == 1.0f) {
...
void func_809F01CC(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = arg0;
    temp_a3[1].world.pos.z = func_809F0244;
    arg0 = temp_a3;
    SkelAnime_ChangeAnimTransitionRepeat(temp_a3 + 0x3C8, &D_06007488, -10.0f);
    arg0->unk_162 = (s16) (s32) (Rand_ZeroFloat(25.0f) + 25.0f);
...
void func_809F02D0(Boss05 *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_162 = (s16) (s32) (Rand_ZeroFloat(80.0f) + 60.0f);
    arg0->unk_34C = randPlusMinusPoint5Scaled(400.0f) + arg0->actor.world.pos.x;
    temp_f4 = randPlusMinusPoint5Scaled(400.0f) + arg0->actor.world.pos.z;
    arg0->unk_358 = 0.0f;
    arg0->unk_354 = temp_f4;
}
...
void func_809F0374(Boss05 *this, GlobalContext *globalCtx) {
    ...
    temp_f12 = this->unk_34C - this->actor.world.pos.x;
    temp_f14 = this->unk_354 - this->actor.world.pos.z;
    sp24 = temp_f12;
    sp20 = temp_f14;
    Math_ApproachS(&this->actor.world.rot.y, Math_Atan2S(temp_f12, temp_f14), 5, (s16) (s32) this->unk_358);
    Math_ApproachF(&this->unk_358, 2000.0f, 1.0f, 100.0f);
    if ((this->unk_162 == 0) || (((sp24 * sp24) + (sp20 * sp20)) < 2500.0f)) {
        func_809F01CC(this, globalCtx);
    }
    func_809F0058(this, globalCtx);
}
...
void func_809F0590(Boss05 *this, GlobalContext *globalCtx) {
    ...
    Math_ApproachS(&this->actor.world.rot.y, this->actor.yawTowardsPlayer, 5, (s16) (s32) this->unk_358);
    Math_ApproachF(&this->unk_358, 4000.0f, 1.0f, 400.0f);
    if ((this->unk_162 == 0) || (this->actor.xyzDistToPlayerSq <= 22500.0f)) {
...
void func_809F0650(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = arg0;
    temp_a3[1].world.pos.z = func_809F06B8;
    arg0 = temp_a3;
    SkelAnime_ChangeAnimTransitionStop(temp_a3 + 0x3C8, &D_060006A4, 0.0f);
    arg0[3].init = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_060006A4);
...
void func_809F06B8(Boss05 *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = &this->unk_3C8;
    sp1C = temp_a0;
    SkelAnime_FrameUpdateMatrix(temp_a0);
    if (func_801378B8(temp_a0, this->unk_4FC) != 0) {
        func_809F01CC(this, globalCtx);
    }
}
...
void func_809F0708(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = arg0;
    temp_a3[1].world.pos.z = func_809F0780;
    arg0 = temp_a3;
        ...
        if (func_801378B8(temp_s1, 22.0f) != 0) {
            do {
                ...
                if (temp_v0 != 0) {
                    phi_v1 = 0;
                    do {
                        temp_t4 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t2 = temp_v0->unk_3E8 + phi_v1;
                        temp_t2->unk_0 = (unaligned s32) temp_t4->unk_0;
                        temp_t2->unk_4 = (u16) temp_t4->unk_4;
                        temp_t0 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t8 = temp_v0->unk_3E8 + phi_v1;
                        temp_t8->unk_6 = (unaligned s32) temp_t0->unk_6;
                        temp_t8->unk_A = (u16) temp_t0->unk_A;
                        temp_t6 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t4_2 = temp_v0->unk_3E8 + phi_v1;
                        temp_t4_2->unk_C = (unaligned s32) temp_t6->unk_C;
                        temp_t4_2->unk_10 = (u16) temp_t6->unk_10;
                        temp_t3 = this->unk_3C8.limbDrawTbl + phi_v1;
                        temp_t0_2 = temp_v0->unk_3E8 + phi_v1;
                        temp_v1 = phi_v1 + 0x18;
...
void func_809F0B0C(Boss05 *this, GlobalContext *globalCtx) {
    ...
    if (phi_v0 == 1) {
        ...
        this->actor.shape.rot.x += this->unk_500;
        this->actor.shape.rot.y += this->unk_502;
        if (this->unk_162 == 0) {
            Actor_MarkForDeath((Actor *) this);
            return;
        }
    ...
    if (phi_v0 != 2) {
        ...
        Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
        if (this->unk_328 < (this->actor.floorHeight - 30.0f)) {
            Actor_MarkForDeath((Actor *) this);
        }
        return;
    }
...
void Boss05_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    do {
        ...
        temp_a0 = temp_v1->unk_162;
        temp_v0 = phi_v0 + 1;
        phi_v0 = temp_v0;
        if (temp_a0 != 0) {
            temp_v1->unk_162 = (s16) (temp_a0 - 1);
        }
    } while ((s32) temp_v0 < 3);
    temp_v0_2 = this->unk_16A;
    if (temp_v0_2 != 0) {
        this->unk_16A = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk_16C;
    if (temp_v0_3 != 0) {
        this->unk_16C = temp_v0_3 - 1;
    }
    temp_v0_4 = this->unk_168;
    if (temp_v0_4 != 0) {
        this->unk_168 = temp_v0_4 - 1;
    }
    temp_v0_5 = this->unk_17A;
    if (temp_v0_5 != 0) {
        this->unk_17A = temp_v0_5 - 1;
    }
    this->actionFunc(this, globalCtx);
    if (this->actor.params == 4) {
        Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
        Matrix_RotateY(this->unk_348, 0U);
        SysMatrix_GetStateTranslationAndScaledZ(this->unk_338, &this->unk_33C);
        this->actor.world.pos.x += this->unk_33C.x;
        this->actor.world.pos.z += this->unk_33C.z;
        Math_ApproachZeroF(&this->unk_338, 1.0f, 1.0f);
        Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 20.0f, 50.0f, 40.0f, 0x45U);
        func_809EFE50((Actor *) this, globalCtx);
        temp_a2 = &this->unk_368;
    ...
    case 1:
        ...
        this->unk_17A = 0x50;
        this->unk_184 = 1.0f;
        this->unk_188 = temp_v0_6 + 1;
        this->unk_17C = 0.0f;
        /* fallthrough */
    case 2:
        if (this->unk_17A == 0) {
            Math_ApproachZeroF(&this->unk_184, 1.0f, 0.02f);
            if (this->unk_184 == 0.0f) {
                this->unk_188 = 0;
                return;
            }
        default:
        ...
        Math_ApproachF(&this->unk_17C, 1.0f, 0.1f, 0.5f);
        return;
    case 10:
        this->unk_189 = 0xA;
        this->unk_17A = 0x50;
    ...
    case 11:
        ...
        Math_ApproachF(&this->unk_17C, 1.0f, 1.0f, 0.25f);
        Math_ApproachF(&this->unk_180, 1.0f, 0.1f, 0.1f);
        return;
    case 20:
        this->unk_189 = 0x14;
        this->unk_17A = 0x50;
    ...
    case 21:
        if (this->unk_17A == 0) {
            Math_ApproachZeroF(&this->unk_17C, 1.0f, 0.03f);
            if (this->unk_17C == 0.0f) {
                this->unk_188 = 0;
                this->unk_184 = 0.0f;
                return;
            }
        ...
        Math_ApproachF(&this->unk_17C, 1.0f, 0.5f, 0.5f);
        /* Duplicate return node #31. Try simplifying control flow for better match */
        return;
    }
}
...
s32 func_809F1050(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    if ((s32) temp_v1 >= 0) {
        ...
        arg4->x += temp_a1->unk_19E;
        arg4->y += temp_a1->unk_1A0;
        arg4->z += temp_a1->unk_1A2;
    }
    return 0;
}
...
void func_809F1170(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 4) {
        ...
        if (func_809EFAB4 == arg4[1].world.pos.z) {
        ...
        arg4->unk_330 = (s16) (arg4->unk_330 + 0xF00);
    }
    if (arg1 == 2) {
    ...
    if (arg1 == 3) {
        ...
        if (func_809EEDE8 == arg4[1].world.pos.z) {
...
void func_809F12A0(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    if (arg1 == 1) {
        ...
        if (arg4->unk_188 != 0) {
            ...
            if (arg4->unk_189 == 0) {
                arg4->unk_190 = (f32) (arg4->unk_190 - 15.0f);
            }
        }
    }
}
...
void func_809F1464(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    ...
    if ((arg1 >= 3) && (arg1 < 9)) {
        temp_f12 = arg2[1].targetArrowOffset;
...
s32 func_809F14AC(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    if (arg1 != *(&D_809F1CC0 + (arg5->params * 4))) {
        *arg2 = NULL;
    } else if ((s32) arg5->unk_15C >= 2) {
        arg4->x += arg5[1].params * 0x3000;
        arg4->y += arg5[1].params * 0x1A00;
        arg4->z += arg5[1].params << 0xD;
    }
    return 0;
}
...
void Boss05_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_809EEDE8 == this->actionFunc) {
        SkelAnime_DrawSV(globalCtx, this->unk_268.skeleton, this->unk_268.limbDrawTbl, (s32) this->unk_268.dListCount, func_809F1050, func_809F1170, (Actor *) this);
        if ((this->unk_16C & 1) != 0) {
            sp34->polyOpa.p = Gfx_SetFog(sp34->polyOpa.p, 0xFF, 0, 0, 0xFF, 0x384, 0x44B);
        }
        SysMatrix_InsertTranslation(this->unk_324, this->unk_328, this->unk_32C, 0);
        Matrix_RotateY(this->unk_332, 1U);
        SysMatrix_InsertXRotation_s(this->unk_330, 1);
        SysMatrix_InsertZRotation_s(this->unk_334, 1);
        Matrix_Scale(this->actor.scale.x, this->actor.scale.y, this->actor.scale.z, 1);
        AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06006240));
        func_801343C0(globalCtx, this->unk_3C8.skeleton, this->unk_3C8.limbDrawTbl, (s32) this->unk_3C8.dListCount, func_809F1284, func_809F12A0, func_809F135C, (Actor *) this);
    } else {
        temp_v0 = this->actor.params;
        if (temp_v0 == 2) {
            SysMatrix_InsertTranslation(this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, 0);
            Matrix_RotateY(this->unk_176, 1U);
            SysMatrix_InsertXRotation_s(this->unk_178, 1);
            Matrix_RotateY((s16) ((s32) this->unk_176 * -1), 1U);
            ...
            Matrix_Scale(this->actor.scale.x, this->actor.scale.y, this->actor.scale.z, 1);
            SkelAnime_DrawSV(globalCtx, this->unk_268.skeleton, this->unk_268.limbDrawTbl, (s32) this->unk_268.dListCount, func_809F1404, NULL, (Actor *) this);
        } else if (temp_v0 == 3) {
            func_801343C0(globalCtx, this->unk_268.skeleton, this->unk_268.limbDrawTbl, (s32) this->unk_268.dListCount, func_809F1430, func_809F1170, func_809F1464, (Actor *) this);
            SysMatrix_InsertTranslation(this->unk_324, this->unk_328, this->unk_32C, 0);
            Matrix_RotateY(this->unk_332, 1U);
            SysMatrix_InsertXRotation_s(this->unk_330, 1);
            SysMatrix_InsertZRotation_s(this->unk_334, 1);
            ...
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06006240));
            func_801343C0(globalCtx, this->unk_3C8.skeleton, this->unk_3C8.limbDrawTbl, (s32) this->unk_3C8.dListCount, func_809F1284, func_809F12A0, func_809F135C, (Actor *) this);
            func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk_18C, 1, this->unk_17C, this->unk_180, this->unk_184, (u8) (s32) this->unk_189);
        } else if (temp_v0 == 4) {
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06006240));
            if ((this->unk_16C & 1) != 0) {
                sp34->polyOpa.p = Gfx_SetFog(sp34->polyOpa.p, 0xFF, 0, 0, 0xFF, 0x384, 0x44B);
            ...
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06006240));
            SkelAnime_DrawSV(globalCtx, this->unk_3C8.skeleton, this->unk_3C8.limbDrawTbl, (s32) this->unk_3C8.dListCount, func_809F14AC, func_809F1550, (Actor *) this);
        }
    }
