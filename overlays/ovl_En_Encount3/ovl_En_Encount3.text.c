typedef struct EnEncount3 {
    ...
    /* 0x17C */ Actor *unk17C;                      /* inferred */
    /* 0x180 */ char pad180[0x4C];                  /* maybe part of unk17C[20]? */
...
void EnEncount3_Init(EnEncount3 *this, GlobalContext *globalCtx) {
    EnEncount3 *temp_a0;
    f32 temp_f0;
    s16 temp_v0;
    s32 temp_t5;
    ...
    this->unk14A = ((s32) temp_v0 >> 0xC) & 0xF;
    this->unk158 = ((s32) temp_v0 >> 7) & 0x1F;
    temp_f0 = (f32) this->actor.world.rot.z * 10.0f;
    this->unk15C = temp_v0 & 0x7F;
    this->unk15A = (s16) this->actor.cutscene;
    this->unk16C = temp_f0;
    if (temp_f0 < 10.0f) {
        this->unk16C = 10.0f;
    ...
    if ((s32) this->unk15C >= 0) {
        this = this;
        if (Flags_GetSwitch(globalCtx, (s32) this->unk15C) != 0) {
            temp_a0 = this;
            this = this;
...
void EnEncount3_Destroy(EnEncount3 *this, GlobalContext *globalCtx) {
    EnEncount3 *this = (EnEncount3 *) thisx;
...
void func_809AD084(EnEncount3 *this, GlobalContext *globalCtx) {
    ...
    if (!(this->unk16C < this->actor.xzDistToPlayer) && (Player_GetMask(globalCtx) == 6) && (D_809AD810 == 0)) {
        temp_v0 = this->unk15E;
        if ((s32) temp_v0 > 0) {
            this->unk15E = temp_v0 - 1;
            return;
        }
        temp_v0_2 = Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, this->unk154, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, (s32) this->unk158);
        this->unk17C = temp_v0_2;
        if (temp_v0_2 != 0) {
            this->unk14E += 1;
            D_809AD810 = 1;
...
void EnEncount3_Update(EnEncount3 *this, GlobalContext *globalCtx) {
    f32 sp3C;
    f32 sp38;
    s16 sp36;
    ...
    if (func_809AD194 == this->actionFunc) {
        ...
        if ((temp_f0 * 0.52f) < this->actor.xzDistToPlayer) {
            this->unk178 = (temp_f0 * 0.03125f * 0.001f) + 0.1f;
        } else {
            this->unk178 = 0.06f;
        }
        temp_f2 = this->actor.xzDistToPlayer;
        if (((f32) gGameInfo->data[2400] + (this->unk16C + 50.0f)) < temp_f2) {
            ...
            phi_v1 = 0;
            if (this->unk16C < temp_f2) {
                do {
                    sp36 = phi_v1;
                    temp_v1 = phi_v1 + 1;
                    (temp_s1 + phi_v1)->unkD45 = Rand_S16Offset(0, 0xC8);
                    phi_v1 = temp_v1;
    ...
    this->unk168 = this->unk16C / 7666.0f;
    if (sp2C != this->actionFunc) {
    ...
    temp_f0_2 = this->unk160 / 60.0f;
    this->unk164 = temp_f0_2;
    if (temp_f0_2 != 0.0f) {
        globalCtx->envCtx.unk_8C.fogNear = (s16) (s32) ((f32) (0x3C0 - (s16) globalCtx->envCtx.unk_C4.fogNear) * this->unk164);
        ...
        globalCtx->envCtx.unk_8C.fogColor[0] = (s16) (s32) ((40.0f - phi_f6) * this->unk164);
        phi_f10 = temp_f10;
        if ((s32) temp_t7 < 0) {
        ...
        temp_f4 = (f32) temp_t0;
        globalCtx->envCtx.unk_8C.fogColor[1] = (s16) (s32) ((10.0f - phi_f10) * this->unk164);
        phi_f4 = temp_f4;
        if ((s32) temp_t0 < 0) {
            phi_f4 = temp_f4 + 4294967296.0f;
        }
        globalCtx->envCtx.unk_8C.fogColor[2] = (s16) (s32) ((0.0f - phi_f4) * this->unk164);
    }
}

void EnEncount3_Draw(EnEncount3 *this, GlobalContext *globalCtx) {
    Gfx *sp50;
    Gfx *sp44;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    ...
    if (this->unk170 > 0.0f) {
        ...
        temp_v0_3->words.w1 = ((s32) this->unk170 & 0xFF) | 0xFFC80000;
        ...
        temp_f12 = this->unk168;
        Matrix_Scale(temp_f12, this->unk174, temp_f12, 1);
