...
typedef struct EnEncount3 {
    ...
    /* 0x017C */ Actor *unk17C;                     /* inferred */
    /* 0x0180 */ char pad180[0x4C];                 /* maybe part of unk17C[20]? */
...
void func_809AD084(EnEncount3 *this, GlobalContext *globalCtx) {
    ...
    if (!(this->unk16C < this->actor.xzDistToPlayer) && (Player_GetMask(globalCtx) == 6) && (D_809AD810 == 0)) {
        ...
        temp_v0_2 = Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, this->unk154, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, (s32) this->unk158);
        ...
        if (((f32) gGameInfo->data[2400] + (this->unk16C + 50.0f)) < temp_f2) {
            ...
            if (this->unk16C < temp_f2) {
                ...
                if (func_801690CC(globalCtx) == 0) {
                    func_800B8D50(globalCtx, &this->actor, 10.0f, Math_FAtan2F(sp38, sp3C), 0.0f, 1U);
                }
            }
        }
    }
