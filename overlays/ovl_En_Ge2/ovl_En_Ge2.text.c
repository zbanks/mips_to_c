typedef struct EnGe2 {
    ...
    /* 0x1DE */ char pad1DE[0x7E];                  /* maybe part of unk1D8[22]? */
    /* 0x25C */ Vec3s unk25C;                       /* inferred */
    /* 0x262 */ char pad262[0x7E];                  /* maybe part of unk25C[22]? */
    /* 0x2E0 */ s16 unk2E0;                         /* inferred */
    /* 0x2E2 */ s16 unk2E2;                         /* inferred */
    /* 0x2E4 */ char pad2E4[0x2];
    /* 0x2E6 */ s16 unk2E6;                         /* inferred */
    /* 0x2E8 */ char pad2E8[0x8];                   /* maybe part of unk2E6[5]? */
    /* 0x2F0 */ u8 *unk2F0;                         /* inferred */
...
void EnGe2_Init(EnGe2 *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk148, (Actor *) this, &D_80B8CE40);
...
s32 func_80B8BA40(Actor *arg0) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp30, Lib_SegmentedToVirtual(temp_v1->unk4) + (arg0->unk2F4 * 6));
    temp_a0 = arg0 + 0x24;
    sp28 = temp_a0;
...
void func_80B8C644(EnGe2 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 2) {
        ...
        if ((this->unk2F4 < (s32) *this->unk2F0) && (func_80B8BA40((Actor *) this) != 0)) {
            this->unk2F4 += 1;
        }
...
void func_80B8C9B8(EnGe2 *this, GlobalContext *globalCtx) {
    SkelAnime_FrameUpdateMatrix(&this->unk194);
    if ((func_80B8B5AC(globalCtx, (Actor *) this, &this->actor.focus, this->actor.shape.rot.y, (s16) 0x4000, 720.0f, this->unk2FC) != 0) && ((this->actor.params & 0x1F) != 0x1F) && (func_801690CC(globalCtx) == 0)) {
...
void EnGe2_Draw(EnGe2 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk194.skeleton, this->unk194.limbDrawTbl, (s32) this->unk194.dListCount, func_80B8CCB4, func_80B8CCFC, (Actor *) this);
}
