typedef struct EnGe2 {
    ...
    /* 0x1DE */ char pad_1DE[0x7E];                 /* maybe part of unk_1D8[22]? */
    /* 0x25C */ Vec3s unk_25C;                      /* inferred */
    /* 0x262 */ char pad_262[0x7E];                 /* maybe part of unk_25C[22]? */
    /* 0x2E0 */ s16 unk_2E0;                        /* inferred */
    /* 0x2E2 */ s16 unk_2E2;                        /* inferred */
    /* 0x2E4 */ char pad_2E4[0x2];
    /* 0x2E6 */ s16 unk_2E6;                        /* inferred */
    /* 0x2E8 */ char pad_2E8[0x8];                  /* maybe part of unk_2E6[5]? */
    /* 0x2F0 */ u8 *unk_2F0;                        /* inferred */
    /* 0x2F4 */ s32 unk_2F4;                        /* inferred */
    /* 0x2F8 */ u16 unk_2F8;                        /* inferred */
    /* 0x2FA */ s16 unk_2FA;                        /* inferred */
    /* 0x2FC */ f32 unk_2FC;                        /* inferred */
    /* 0x300 */ u8 unk_300;                         /* inferred */
    /* 0x301 */ u8 unk_301;                         /* inferred */
    /* 0x302 */ s16 unk_302;                        /* inferred */
    /* 0x304 */ char pad_304[0x2];
    /* 0x306 */ s16 unk_306;                        /* inferred */
    /* 0x308 */ void (*actionFunc)(EnGe2 *, GlobalContext *);
} EnGe2;                                            /* size = 0x30C */

struct _mips2c_stack_EnGe2_Destroy {};              /* size 0x0 */

struct _mips2c_stack_EnGe2_Draw {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ GraphicsContext *sp34;               /* inferred */
    /* 0x38 */ char pad_38[0x8];
};                                                  /* size = 0x40 */

struct _mips2c_stack_EnGe2_Init {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ SkelAnime *sp30;                     /* inferred */
    /* 0x34 */ char pad_34[0x14];
};                                                  /* size = 0x48 */

struct _mips2c_stack_EnGe2_Update {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ ColliderCylinder *sp28;              /* inferred */
    /* 0x2C */ char pad_2C[0xC];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80B8B514 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B8B5AC {
    /* 0x00 */ char pad_0[0x28];
...
struct _mips2c_stack_func_80B8B6B4 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ u8 *sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B8B7A8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B8B848 {
    /* 0x00 */ char pad_0[0x28];
...
struct _mips2c_stack_func_80B8B90C {
    /* 0x00 */ char pad_0[0x28];
...
struct _mips2c_stack_func_80B8BA40 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ Vec3f *sp28;                         /* inferred */
...
struct _mips2c_stack_func_80B8BB3C {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ f32 sp28;                            /* inferred */
    /* 0x2C */ f32 sp2C;                            /* inferred */
...
struct _mips2c_stack_func_80B8BC1C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B8BC78 {};              /* size 0x0 */

struct _mips2c_stack_func_80B8BCEC {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B8BD38 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B8BD90 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80B8BE08 {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ SkelAnime *sp2C;                     /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80B8BF04 {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ SkelAnime *sp30;                     /* inferred */
    /* 0x34 */ char pad_34[0x4];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80B8BFC8 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80B8C048 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B8C0B0 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B8C13C {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80B8C45C {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ SkelAnime *sp34;                     /* inferred */
    /* 0x38 */ char pad_38[0x8];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80B8C59C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B8C644 {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ SkelAnime *sp30;                     /* inferred */
    /* 0x34 */ char pad_34[0xC];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80B8C9B8 {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80B8CC0C {
    /* 0x00 */ char pad_0[0x28];
...
struct _mips2c_stack_func_80B8CCB4 {};              /* size 0x0 */

struct _mips2c_stack_func_80B8CCFC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */
...
void EnGe2_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp30 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_06008DD8, NULL, &this->unk_1D8, &this->unk_25C, 0x16);
    SkelAnime_ChangeAnimDefaultRepeat(sp30, &D_0600A344);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_148, (Actor *) this, &D_80B8CE40);
    ...
    if (temp_v0 == 0) {
        ...
        this->unk_2FC = fabsf((f32) temp_v0 * 20.0f);
    }
...
void func_80B8B7A8(EnGe2 *arg0, GlobalContext *arg1) {
    ...
    if (temp_t0 != 0x3F) {
        ...
        temp_v1 = temp_v0 + ((temp_v0 + (temp_t0 * 8))->unk_1 * 8);
        arg0->unk_2F0 = temp_v1;
        arg0 = arg0;
        temp_v0_2 = Lib_SegmentedToVirtual(temp_v1->unk_4);
...
s32 func_80B8B90C(EnGe2 *arg0) {
    ...
    sp34 = temp_v0;
    temp_v1 = Lib_SegmentedToVirtual(temp_v0->unk_4) + (arg0->unk_2F4 * 6);
    ...
    if (((temp_f12 * temp_f12) + (temp_f14 * temp_f14)) < 100.0f) {
        if ((arg0->unk_2F8 & 1) != 0) {
            temp_t4 = arg0->unk_2F4 - 1;
            arg0->unk_2F4 = temp_t4;
            if (temp_t4 < 0) {
                return 2;
            }
            goto block_8;
        }
        temp_t7 = arg0->unk_2F4 + 1;
...
s32 func_80B8BA40(Actor *arg0) {
    ...
    sp2C = Math_Vec3f_Pitch(temp_a0, (Vec3f *) &sp30);
    ...
    phi_v0 = 0;
    if (Math_Vec3f_DistXYZ(temp_a0, (Vec3f *) &sp30) < 40.0f) {
        phi_v0 = 1;
    }
    return phi_v0;
}
...
void func_80B8BE08(EnGe2 *this, GlobalContext *globalCtx) {
    ...
    if ((func_801378B8(sp2C, 2.0f) != 0) || (func_801378B8(sp2C, 6.0f) != 0)) {
        Audio_PlayActorSound2((Actor *) this, 0x2971U);
    }
}
...
void func_80B8C13C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_159 & 2) != 0) {
        ...
        arg0->flags &= -2;
        arg0->unk_2F8 = (u16) (arg0->unk_2F8 | 2);
        return;
    }
...
void func_80B8C45C(EnGe2 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 != 0) {
        this->unk_300 = 0x64;
        this->unk_2FA = this->actor.yawTowardsPlayer;
        if ((s32) this->unk_301 < temp_v1) {
            this->unk_301 = (u8) temp_v1;
        }
    }
    temp_v0 = this->unk_300;
    if ((s32) temp_v0 > 0) {
        ...
        this->actionFunc = func_80B8C59C;
        SkelAnime_ChangeAnim(sp34, &D_0600A344, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_0600A344), (u8) 0, -8.0f);
        this->unk_2E6 = 0;
        this->unk_301 = 0;
    }
    temp_v0_2 = this->unk_301;
    if (temp_v0_2 != 1) {
        if (temp_v0_2 != 2) {

        } else {
            Math_SmoothStepToS(&this->actor.shape.rot.y, this->unk_2FA, 2, 0xBB8, (s16) 0x3E8);
        }
    } else {
        Math_SmoothStepToS(&this->actor.shape.rot.y, this->unk_2FA, 2, 0x3E8, (s16) 0x1F4);
    }
    this->actor.world.rot.y = this->actor.shape.rot.y;
    func_80B8C13C((Actor *) this, globalCtx);
}
...
void func_80B8C644(EnGe2 *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x1DCU) != 0) {
        ...
        if (temp_v1 != this->unk_302) {
            this->unk_302 = temp_v1;
            switch (temp_v1) {
            case 1:
            ...
            case 2:
                ...
                this->unk_306 = (s16) (s32) (Rand_ZeroFloat(10.0f) + 20.0f);
                break;
            case 3:
                Actor_MarkForDeath((Actor *) this);
                break;
    ...
    if (temp_v0 != 2) {
        ...
        if ((this->unk_2F4 < (s32) *this->unk_2F0) && (func_80B8BA40((Actor *) this) != 0)) {
            this->unk_2F4 += 1;
        }
        temp_v0_2 = this->unk_306;
        this->actor.shape.rot.x += 0x3E8;
        this->actor.shape.rot.y += 0x7D0;
        this->actor.shape.rot.z += 0x1F4;
        if ((s32) temp_v0_2 > 0) {
            this->unk_306 = temp_v0_2 - 1;
            return;
        }
        this->unk_306 = (s16) (s32) (Rand_ZeroFloat(10.0f) + 20.0f);
        func_80B8BC1C((Actor *) this);
        return;
    }
    func_80B8B90C(this);
    ...
    temp_v0_3 = this->unk_306;
    if ((s32) temp_v0_3 > 0) {
        this->unk_306 = temp_v0_3 - 1;
        return;
    }
    this->unk_306 = (s16) (s32) (Rand_ZeroFloat(10.0f) + 20.0f);
    func_80B8BC1C((Actor *) this);
...
void func_80B8C9B8(EnGe2 *this, GlobalContext *globalCtx) {
    SkelAnime_FrameUpdateMatrix(&this->unk_194);
    if ((func_80B8B5AC(globalCtx, (Actor *) this, &this->actor.focus, this->actor.shape.rot.y, (s16) 0x4000, 720.0f, this->unk_2FC) != 0) && ((this->actor.params & 0x1F) != 0x1F) && (func_801690CC(globalCtx) == 0)) {
        func_800B7298(globalCtx, (Actor *) this, 0x1AU);
        func_801000A4(0x482CU);
        func_801518B0(globalCtx, 0x1194U, (Actor *) this);
        this->unk_300 = 0x32;
        func_80B8BD90(this);
    }
...
void EnGe2_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x1DCU) != 0) {
        temp_t2 = this->unk_2F8 & 0xFFFD;
        this->unk_2F8 = temp_t2;
        this->actionFunc = func_80B8C644;
        this->unk_2F8 = temp_t2 & 0xFFFE;
        this->actor.flags |= 0x20;
        this->actor.speedXZ = 0.0f;
    }
    this->actionFunc(this, globalCtx);
    temp_v0 = this->unk_2F8;
    if ((temp_v0 & 2) != 0) {
        this->unk_2E0 = 2;
        return;
    }
    if ((temp_v0 & 4) == 0) {
        temp_v1 = this->unk_2E2;
        if (temp_v1 == 0) {
            phi_v0 = 0;
        } else {
            this->unk_2E2 = temp_v1 - 1;
            phi_v0 = this->unk_2E2;
        }
        phi_v1 = this->unk_2E2;
        if (phi_v0 == 0) {
            this->unk_2E2 = Rand_S16Offset(0x3C, 0x3C);
            phi_v1 = this->unk_2E2;
        }
        this->unk_2E0 = phi_v1;
...
void EnGe2_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_194.skeleton, this->unk_194.limbDrawTbl, (s32) this->unk_194.dListCount, func_80B8CCB4, func_80B8CCFC, (Actor *) this);
}
