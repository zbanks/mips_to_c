typedef struct EnKusa2 {
    ...
    /* 0x194 */ char pad194[0x24];                  /* maybe part of actionFunc[10]? */
    /* 0x1B8 */ void *unk1B8;                       /* inferred */
    /* 0x1BC */ char pad1BC[0x2];
    /* 0x1BE */ s8 unk1BE;                          /* inferred */
    /* 0x1BF */ char pad1BF[0x1];
    /* 0x1C0 */ Actor *unk1C0;                      /* inferred */
    ...
    /* 0x1CE */ s8 unk1CE;                          /* inferred */
    /* 0x1CF */ u8 unk1CF;                          /* inferred */
    /* 0x1D0 */ s8 unk1D0;                          /* inferred */
    /* 0x1D1 */ s8 unk1D1;                          /* inferred */
    /* 0x1D2 */ char pad1D2[0x2];                   /* maybe part of unk1D1[3]? */
} EnKusa2;                                          /* size = 0x1D4 */
...
struct _mips2c_stack_func_80A5B508 {
    ...
    /* 0x54 */ char pad54[0x20];                    /* maybe part of sp50[9]? */
    ...
    /* 0x94 */ char pad94[0x14];                    /* maybe part of sp90[6]? */
        ...
        if ((s32) phi_s0->unk26 > 0) {
            ...
            if ((phi_v0 != 0) || (phi_s2 != 0)) {
                ...
                if (phi_v0 != 0) {
                    ...
                    if (phi_s2 != 0) {
                        arg2->x += phi_f20 * spA0 * phi_s0->unk58;
                        arg2->z -= phi_f20 * sp98 * phi_s0->unk58;
                    }
                }
                if ((phi_s2 != 0) && (fabsf(sp9C) < phi_s0->unk78)) {
                    temp_f20 = Math_CosS((s16) (s32) (phi_s0->unk7C * sp9C));
...
void func_80A5C918(Vec3f *arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        temp_f12 = arg1->unk1C;
        arg1->unk10 = (f32) (arg1->unk10 + sp4C);
        temp_f2 = arg1->unk10;
        arg1->unk14 = (f32) (arg1->unk14 + sp50);
        arg1->unk18 = (f32) (arg1->unk18 + sp54);
...
void EnKusa2_Init(EnKusa2 *this, GlobalContext *globalCtx) {
...
void EnKusa2_Destroy(EnKusa2 *this, GlobalContext *globalCtx) {
    EnKusa2 *this = (EnKusa2 *) thisx;
...
void EnKusa2_Update(EnKusa2 *this, GlobalContext *globalCtx) {
    Actor *temp_v0;
    EnKusa2 *this = (EnKusa2 *) thisx;
...
void EnKusa2_Draw(EnKusa2 *this, GlobalContext *globalCtx) {
