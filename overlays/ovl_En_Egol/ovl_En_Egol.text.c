...
void EnEgol_Init(EnEgol *this, GlobalContext *globalCtx) {
    s16 temp_f6;
    s16 temp_t0;
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk1BA4, (Actor *) this, &D_80A80D3C, &this->unk1BC4);
    Collider_InitAndSetJntSph(globalCtx, &this->unk1D44, (Actor *) this, &D_80A80D4C, &this->unk1D64);
    Collider_InitAndSetQuad(globalCtx, &this->unk1DA4, (Actor *) this, &D_80A80D5C);
...
void EnEgol_Destroy(EnEgol *this, GlobalContext *globalCtx) {
    EnEgol *this = (EnEgol *) thisx;
...
void func_80A7D780(Actor *arg0, GlobalContext *arg1) {
    ...
    Math_ApproachF((f32 *) temp_a0_2, arg0->unk408, 0.5f, fabsf(temp_f0));
...
void func_80A7DAF0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 >= 3) {
        ...
        if ((arg0->unk378 == 0) && (func_800C55C4(&arg1->colCtx, arg0 + 0x1E08, arg0 + 0x1DF0, (Vec3f *) &sp7C, &sp88, 0U, 1U, 0U, 1U, &sp78) != 0)) {
...
void EnEgol_Update(EnEgol *this, GlobalContext *globalCtx) {
    Actor *sp58;
    PosRot *sp40;
    Vec3f *sp3C;
    ...
    if ((temp_v1 != 6) && (temp_v1 != 3) && ((s32) temp_v1 < 0xD)) {
        ...
        if (phi_v0 >= 0x1889) {
            ...
            if ((phi_v0_2 >= 0x2001) && (this->actor.xzDistToPlayer < 100.0f)) {
                ...
                Math_Vec3f_Copy((Vec3f *) &this->unk1DA4.dim, temp_a1_2);
    ...
    if ((temp_v1_3 != 7) && (temp_v1_3 != 0) && (temp_v1_3 != 3) && (temp_v1_3 != 1) && (temp_v1_3 != 4) && (temp_v1_3 != 8) && (temp_v1_3 != 0xB) && (temp_v1_3 != 0xD)) {
        ...
        sp40 = temp_a1_4;
        this->unk414 = Math_Vec3f_Pitch(sp3C, (Vec3f *) temp_a1_4);
        this->unk416 = (s16) -Math_Vec3f_Yaw(sp3C, (Vec3f *) temp_a1_4);
...
block_60:
    ...
    if (temp_v1_6 != 0xE) {
        if ((temp_v1_6 != 0xB) || (temp_v1_6 != 0xD)) {
            ...
            CollisionCheck_SetAC(globalCtx, temp_a1_5, (Collider *) &this->unk1D44);
            CollisionCheck_SetAC(globalCtx, temp_a1_5, (Collider *) &this->unk1BA4);
        }
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk1BA4);
    }
    if ((s32) this->unk42C >= 7) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk1DA4);
    }
}
...
void func_80A7FAFC(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp60.unk0 = (s32) D_80A80E60.unk0;
    sp60.unk4 = (s32) D_80A80E60.unk4;
    sp60.unk8 = (s32) D_80A80E60.unk8;
    sp54.unk0 = (s32) D_80A80E6C.unk0;
    sp54.unk4 = (s32) D_80A80E6C.unk4;
    sp54.unk8 = (s32) D_80A80E6C.unk8;
    if (arg1 == 6) {
    ...
    if ((arg1 == 0xD) && ((s32) arg4->unk42C >= 3)) {
        sp48.unk0 = (s32) D_80A80E78.unk0;
        sp48.unk4 = (s32) D_80A80E78.unk4;
        sp48.unk8 = (s32) D_80A80E78.unk8;
...
loop_10:
            ...
            if (arg4->floorHeight < (arg4->unk1E0C + sp40 + 20.0f)) {
                if (temp_f20_2 < 10.0f) {
                    goto loop_10;
                }
            }
        ...
        Matrix_RotateY(arg4->world.rot.y, 0U);
        SysMatrix_InsertXRotation_s(arg4->unk41A, 1);
        sp50 = arg4->unk3BC * 700.0f;
        SysMatrix_MultiplyVector3fByState((Vec3f *) &sp48, (Vec3f *) &sp3C);
        SysMatrix_StatePop();
        arg4->unk1DF0 = (f32) (arg4->unk1E08 + sp3C);
        arg4->unk1DF4 = (f32) (arg4->unk1E0C + sp40);
        arg4->unk1DF8 = (f32) (arg4->unk1E10 + sp44);
        arg4->unk1DE4 = (f32) (arg4->unk1DFC + sp3C);
        arg4->unk1DE8 = (f32) (arg4->unk1E00 + sp40);
        arg4->unk1DEC = (f32) (arg4->unk1E04 + sp44);
...
void EnEgol_Draw(EnEgol *this, GlobalContext *globalCtx) {
    ? *sp54;
    MtxF *sp50;
    ? *temp_s0;
    Gfx *temp_v0_10;
    ...
    if (this->unk2B2 != 0xE) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80A7F8E8, func_80A7FAFC, (Actor *) this);
        temp_s2->polyOpa.p = func_801660B8(globalCtx, temp_s2->polyOpa.p);
    }
    temp_v0 = this->unk2BC;
    if (temp_v0 != 0) {
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2C0, 0xC, 0.8f, 0.8f, (f32) temp_v0 * 0.05f, (u8) 0x14);
    }
