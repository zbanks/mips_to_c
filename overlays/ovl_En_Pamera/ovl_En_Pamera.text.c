...
void EnPamera_Init(EnPamera *this, GlobalContext *globalCtx) {
    ? sp44;
...
void EnPamera_Destroy(EnPamera *this, GlobalContext *globalCtx) {
    EnPamera *this = (EnPamera *) thisx;
...
s32 func_80BD9234(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if (temp_s0 != 0) {
loop_2:
        if ((phi_s0->id == 9) && (Math_Vec3f_DistXZ((Vec3f *) &this->actor.world, phi_s0 + 0x24) < 500.0f) && (phi_s0->unk1F0 == 0)) {
            return 1;
        }
        temp_s0_2 = phi_s0->next;
        phi_s0 = temp_s0_2;
...
void EnPamera_Update(EnPamera *this, GlobalContext *globalCtx) {
...
void EnPamera_Draw(EnPamera *this, GlobalContext *globalCtx) {
