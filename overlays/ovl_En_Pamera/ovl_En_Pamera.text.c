...
typedef struct {
    ...
    /* 0x007C */ char pad7C[0x4];                   /* maybe part of unk7A[3]? */
...
void EnPamera_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80BDA480);
    ...
    if ((gSaveContext.weekEventReg[61] & 4) != 0) {
        ...
        Math_Vec3s_ToVec3f(&temp_a0_2->pos, &this->pathPoints[temp_v0]);
        Math_Vec3s_ToVec3f(&sp44, &this->pathPoints[this->pathIndex] - 6);
        temp_v0_2 = Math_Vec3f_Yaw(&sp44, (Vec3f *) sp3C);
...
s32 func_80BD84F0(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if (temp_s0 != 0) {
loop_2:
        if ((phi_s0->id == 5) && (Math_Vec3f_DistXZ(&this->actor.world.pos, phi_s0 + 0x24) < 200.0f)) {
...
void func_80BD8588(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.weekEventReg[61] & 4) != 0) {
        phi_v1 = (globalCtx + 0x18000)->unk864 + (temp_t6[temp_t9].unk1 * 8);
    }
    sp34 = phi_v1;
    ...
    Math_Vec3s_ToVec3f(&sp28, temp_v0);
    temp_v0_2 = Math_Vec3f_Yaw(&this->actor.world.pos, &sp28);
    this->actor.shape.rot.y = temp_v0_2;
    this->actor.world.rot.y = temp_v0_2;
}
...
void func_80BD8758(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if ((((s32) temp_v0 < 0x709) ^ 1) != 0) {
        if ((ActorCutscene_GetCanPlayNext(this->cutscenes[0]) != 0) && (temp_a0 = this->cutscenes[0], (temp_a0 != -1))) {
            ActorCutscene_StartAndSetUnkLinkFields(temp_a0, &this->actor);
...
void func_80BD8964(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if (Math_Vec3f_StepTo(&temp_a0->pos, (Vec3f *) temp_a1, 1.0f) < 5.0f) {
        this->actor.speedXZ = 1.5f;
        this = this;
...
void func_80BD8A7C(EnPamera *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_a1;
    sp30 = temp_a0;
    Math_SmoothStepToS(&this->actor.shape.rot.y, Math_Vec3f_Yaw(&temp_a0->pos, &temp_a1->pos), 0xA, 0x3000, (s16) 0x100);
    this->actor.world.rot.y = this->actor.shape.rot.y;
    if (Math_Vec3f_StepTo(&temp_a0->pos, &temp_a1->pos, 1.5f) < 10.0f) {
...
void func_80BD8B70(EnPamera *this, GlobalContext *globalCtx) {
    ...
    sp32 = Math_Vec3f_Yaw(&temp_a0->pos, (Vec3f *) temp_a1);
    if (Math_Vec3f_StepToXZ(&temp_a0->pos, (Vec3f *) &sp34, this->actor.speedXZ) > 10.0f) {
...
void EnPamera_LookDownWell(EnPamera *this) {
    EnPamera *self = (EnPamera *) this;
    func_80BD93CC(self, 1, 1);
    func_800BDC5C(&self->skelAnime, (ActorAnimationEntry []) &D_80BDA4B8, 4);
    self->actionFunc = func_80BD8F60;
}
...
void func_80BD8FF0(EnPamera *this) {
    ...
    this->pathIndex = temp_v0 - 1;
    sp24 = temp_a0;
    Math_Vec3s_ToVec3f(&temp_a0->pos, &this->pathPoints[temp_v0] - 6);
    Math_Vec3s_ToVec3f(&sp2C, &this->pathPoints[this->pathPointsCount] - 0xC);
    temp_v0_2 = Math_Vec3f_Yaw(&sp2C, &sp24->pos);
    this->actor.shape.rot.y = temp_v0_2;
    this->actor.world.rot.y = temp_v0_2;
...
s32 func_80BD9234(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if (temp_s0 != 0) {
loop_2:
        if ((phi_s0->id == 9) && (Math_Vec3f_DistXZ(&this->actor.world.pos, phi_s0 + 0x24) < 500.0f) && (phi_s0->unk1F0 == 0)) {
            return 1;
        }
        temp_s0_2 = phi_s0->next;
        phi_s0 = temp_s0_2;
...
void func_80BD94E0(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if ((func_80BD8B70 != temp_v0) && (func_80BD8964 != temp_v0) && (func_80BD909C != temp_v0) && (func_80BD8D1C != temp_v0) && ((func_80BD8DB0 != temp_v0) || (this->actor.speedXZ == 3.0f))) {
        func_800E9250(globalCtx, &this->actor, &this->limb9Rot, &this->limb8Rot, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        return;
    }
...
void EnPamera_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnPamera_OverrideLimbDraw, EnPamera_PostLimbDraw, &this->actor);
}
...
void func_80BD994C(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, temp_a1) != 0) {
        ...
        if (Player_GetMask(temp_a0) == 0xC) {
            ...
            func_801518B0(globalCtx, 0x15A8U, &this->actor);
            phi_t6 = 0x15A8U;
            goto block_10;
        }
...
void EnPamera_HandleDialogue(EnPamera *this, GlobalContext *globalCtx) {
    ...
    Math_SmoothStepToS(&self->actor.world.rot.y, self->actor.yawTowardsPlayer, 0xA, 0x71C, (s16) 0xB6);
...
void func_80BD9B4C(EnPamera *this, GlobalContext *globalCtx) {
    ...
    if (func_80147624(temp_a0) != 0) {
        ...
        switch (temp_v0) {
        case 5511:
            func_801518B0(globalCtx, 0x1588U, &this->actor);
            this->unk_324 = 0x1588;
            return;
        case 5512:
            func_801518B0(globalCtx, 0x1589U, &this->actor);
            this->unk_324 = 0x1589;
            return;
        case 5513:
            func_801518B0(globalCtx, 0x158AU, &this->actor);
            this->unk_324 = 0x158A;
            return;
        case 5514:
            func_801518B0(globalCtx, 0x158BU, &this->actor);
            this->unk_324 = 0x158B;
            return;
        case 5516:
            func_801518B0(globalCtx, 0x158DU, &this->actor);
            this->unk_324 = 0x158D;
            return;
        case 5518:
block_11:
