...
void BgSpoutFire_Init(BgSpoutFire *this, GlobalContext *globalCtx) {
    void **temp_s0;
    void **phi_s0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk14C, (Actor *) this, &D_80A61160);
...
void BgSpoutFire_Destroy(BgSpoutFire *this, GlobalContext *globalCtx) {
    BgSpoutFire *this = (BgSpoutFire *) thisx;
...
s32 func_80A60C24(Actor *arg0, void *arg1) {
    ...
    Actor_CalcOffsetOrientedToDrawRotation(arg0, (Vec3f *) &sp18, arg1->unk1CCC + 0x24);
    phi_v0 = 0;
...
void func_80A60E08(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk192 = (s16) (s32) (arg0->world.pos.x + (sp30 * temp_f0) + (sp38 * sp28));
    arg0->unk196 = (s16) (s32) ((arg0->world.pos.z - (sp30 * sp28)) + (sp38 * temp_f0));
}

void BgSpoutFire_Update(BgSpoutFire *this, GlobalContext *globalCtx) {
