typedef struct Boss07 {
    ...
    /* 0x07A0 */ char pad7A0[0xC];
    /* 0x07AC */ ? unk7AC;                          /* inferred */
    /* 0x07AC */ char pad7AC[0x258];
    /* 0x0A04 */ ? unkA04;                          /* inferred */
    /* 0x0A04 */ char padA04[0x258];
    ...
    /* 0x0F8C */ char padF8C[0x8];                  /* maybe part of unkF88[3]? */
    /* 0x0F94 */ ? unkF94;                          /* inferred */
    /* 0x0F94 */ char padF94[0x8];
    ...
    /* 0x0FAC */ char padFAC[0xC];
    /* 0x0FB8 */ ? unkFB8;                          /* inferred */
    /* 0x0FB8 */ char padFB8[0x258];
    /* 0x1210 */ ? unk1210;                         /* inferred */
    /* 0x1210 */ char pad1210[0x258];
    ...
    /* 0x19F0 */ char pad19F0[0x9150];              /* maybe part of unk1970[291]? */
    /* 0xAB40 */ s16 unkAB40;                       /* inferred */
    /* 0xAB42 */ char padAB42[0x2];
...
struct _mips2c_stack_func_809F94AC {
    ...
    /* 0x88 */ char pad88[0x10];                    /* maybe part of sp84[5]? */
...
struct _mips2c_stack_func_809FC4C0 {
    ...
    /* 0x7C */ f32 sp7C;                            /* inferred */
    /* 0x80 */ char pad80[0x10];                    /* maybe part of sp7C[5]? */
...
struct _mips2c_stack_func_809FE734 {
    ...
    /* 0x3C */ Vec3f *sp3C;                         /* inferred */
    /* 0x40 */ SkelAnime *sp40;                     /* inferred */
    /* 0x44 */ char pad44[0x7];                     /* maybe part of sp40[2]? */
...
struct _mips2c_stack_func_80A00720 {
    ...
    /* 0x094 */ char pad94[0x10];                   /* maybe part of sp90[5]? */
    ...
    /* 0x11C */ char pad11C[0x4];                   /* maybe part of sp11A[3]? */
    ...
    /* 0x17A */ char pad17A[0x6];                   /* maybe part of sp178[4]? */
    /* 0x180 */ f32 sp180;                          /* inferred */
    /* 0x184 */ char pad184[0xC];
};                                                  /* size = 0x190 */
...
void Boss07_Init(Boss07 *this, GlobalContext *globalCtx) {
    s16 *sp48;
    ActorContext *sp44;
    s16 *temp_v0_5;
    s16 temp_t2;
    ...
    if (temp_v0_3 == 0xB4) {
        ...
        Collider_InitAndSetCylinder(globalCtx, &this->unk1820, (Actor *) this, &D_80A07ED0);
    ...
    if ((temp_v0_3 == 0x64) || (temp_v0_3 == 0x65)) {
        ...
        Collider_InitAndSetCylinder(globalCtx, &this->unk1820, (Actor *) this, &D_80A07E78);
    ...
    if ((temp_v0_3 == 0xA) || (temp_v0_3 == 0xB)) {
        ...
        if (this->actor.params == 0xA) {
            ...
            Collider_InitAndSetQuad(globalCtx, &this->unk18F0, (Actor *) this, &D_80A07C3C);
            Collider_InitAndSetQuad(globalCtx, &this->unk1970, (Actor *) this, &D_80A07C8C);
    ...
    if ((temp_v0_3 == 0x14) || (temp_v0_3 == 0x15)) {
        ...
        Collider_InitAndSetJntSph(globalCtx, &this->unk3E8, (Actor *) this, &D_80A07E68, &this->unk408);
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk3E8, (Actor *) this, &D_80A07BCC, &this->unk408);
    Collider_InitAndSetJntSph(globalCtx, &this->unk6C8, (Actor *) this, &D_80A07C2C, &this->unk6E8);
    Collider_InitAndSetCylinder(globalCtx, &this->unk728, (Actor *) this, &D_80A07BDC);
    this->unk794 = 0.7f;
    this->unkFA0 = 0.7f;
...
void Boss07_Destroy(Boss07 *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    Boss07 *this = (Boss07 *) thisx;
...
block_4:
        ...
        if (phi_v0 >= 0x3DU) {
            ...
            if (this->unkABC8 == 0x46) {
                ...
                this->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06025018);
...
block_36:
            ...
            if ((temp_v0_4 >= (u32) (temp_v1->data[1626] + 0x104)) && (temp_v0_4 < (u32) (temp_v1->data[1627] + 0x172))) {
                ...
                Math_ApproachZeroF((f32 *) &this->actor.world, 0.1f, this->unkAC0C);
...
block_53:
            ...
            if ((u32) this->unkABC8 >= (u32) (temp_v1_3->data[1629] + 0xB4)) {
                sp84.unk0 = (s32) D_80A07FB4.unk0;
                sp84.unk4 = (s32) D_80A07FB4.unk4;
                sp84.unk8 = (s32) D_80A07FB4.unk8;
                sp78.unk0 = (s32) D_80A07FC0.unk0;
                sp78.unk4 = (s32) D_80A07FC0.unk4;
                sp78.unk8 = (s32) D_80A07FC0.unk8;
                play_sound(0x2159U);
                if (spC0 == 0) {
                    phi_f16 = 2.0f;
                } else {
    ...
    Math_ApproachF((f32 *) temp_s0_4, this->unkABEC, spA0, temp_f0_2);
    ...
    Math_ApproachF((f32 *) &this->unkABE0, this->unkABF8, spA0, temp_f0_3);
...
void func_809F7BC4(Boss07 *this, GlobalContext *globalCtx) {
    ...
    this->unkFA8 = NULL;
    Math_ApproachS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 0xA, 0x1000);
    Math_ApproachF((f32 *) &this->actor.world, this->unk164, 0.8f, this->unk170);
...
void func_809F7D2C(Boss07 *arg0, GlobalContext *arg1) {
    ...
    arg0->unk152 = 0;
    if ((arg1->actorCtx.actorList[2].first->unkA74 & 0x100) != 0) {
        arg0->unk14E = 4;
    } else {
    ...
    case 0:
        ...
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06033F80);
        break;
    case 1:
        SkelAnime_ChangeAnimTransitionStop(arg0 + 0x190, &D_06034E64, -5.0f);
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06034E64);
        break;
    case 2:
        SkelAnime_ChangeAnimTransitionStop(arg0 + 0x190, &D_060358C4, -5.0f);
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_060358C4);
        break;
    case 3:
        SkelAnime_ChangeAnimTransitionStop(arg0 + 0x190, &D_06036A7C, -5.0f);
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06036A7C);
        break;
    case 4:
        SkelAnime_ChangeAnimTransitionStop(arg0 + 0x190, &D_0603C4E0, -5.0f);
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_0603C4E0);
        func_809F4D10(arg0 + 0x164, 650.0f);
        arg0->unk170 = 0.0f;
        break;
    case 5:
        SkelAnime_ChangeAnimTransitionStop(arg0 + 0x190, &D_06037ADC, -5.0f);
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06037ADC);
        break;
    case 6:
        SkelAnime_ChangeAnimTransitionStop(arg0 + 0x190, &D_0603918C, -5.0f);
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_0603918C);
        break;
    case 7:
        SkelAnime_ChangeAnimTransitionStop(arg0 + 0x190, &D_06026204, -5.0f);
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06026204);
        break;
    }
    arg0->unk14C = 0;
}
...
void func_809F805C(Boss07 *this, GlobalContext *globalCtx) {
    ...
    case 4:
        ...
        if (((s32) temp_v0 >= 0x11) && ((s32) temp_v0 < 0x29)) {
            ...
            Math_ApproachF((f32 *) &this->actor.world, this->unk164, 0.1f, this->unk170);
...
void func_809F87C8(Boss07 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_FrameUpdateMatrix(temp_a0);
    func_809F4CBC(this, 2.0f);
    sp28->world.pos.x = this->unkF80;
    sp28->world.pos.y = this->unkF84;
    sp28->world.pos.z = this->unkF88;
    this->actor.flags &= -2;
    this->unk15A = 0x14;
    this->unkF7C += 1;
...
void func_809F8908(Boss07 *this, GlobalContext *globalCtx) {
    ...
    if ((s32) this->unk14C < 7) {
        globalCtx->actorCtx.actorList[2].first->world.pos.x = this->unkF80;
        globalCtx->actorCtx.actorList[2].first->world.pos.y = this->unkF84;
        globalCtx->actorCtx.actorList[2].first->world.pos.z = this->unkF88;
...
void func_809F8B1C(Boss07 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_FrameUpdateMatrix(temp_a0);
    func_809F4CBC(this, 2.0f);
    temp_s1->world.pos.x = this->unkF80;
    temp_s1->world.pos.y = this->unkF84;
    temp_s1->world.pos.z = this->unkF88;
    this->actor.flags &= -2;
    this->unk15A = 0x14;
    phi_v0 = 0;
    if ((s32) (s16) (0x2E - this->unkF7E) >= (s32) this->unk14C) {
...
void func_809F8DEC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_809F91D4 != arg0->unk144) {
        ...
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_0603B330);
    }
    arg0->unk158 = 0xA;
...
void func_809F9280(Actor *arg0, GlobalContext *arg1, u8 arg2, u8 arg3) {
    ...
    if (func_809F93DC != arg0->unk144) {
        ...
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_0601DEB4);
        arg0->unkABCC = 0;
        return;
    }
    if (arg3 == 0xE) {
...
void Boss07_Update(Boss07 *this, GlobalContext *globalCtx) {
    Boss07 *sp80;
    Actor *sp78;
    s32 sp74;
    s32 sp70;
    ...
    func_809F94AC(&this->unk7AC, (bitwise f32) this->unk79C, (Actor *) this, globalCtx);
    func_809F94AC(&this->unkFB8, (bitwise f32) this->unkFA8, (Actor *) this, globalCtx);
    if (this->unk158 != 0) {
    ...
    if ((sp2C == this->actionFunc) && (this->unk14E == 7) && ((s32) this->unk14C >= 6)) {
        CollisionCheck_SetAT(globalCtx, sp28, (Collider *) &this->unk6C8);
    } else {
        ...
        do {
            if (phi_s2_2 < 6) {
                ...
                if ((phi_s2_2 >= (s32) argB) && (phi_s2_2 < (s32) (s16) (argB + arg0->unkF7C))) {
                    ...
                    sp7C.unk0 = D_801D15B0.x;
                    sp7C.unk4 = (f32) D_801D15B0.y;
                    sp7C.unk8 = (f32) D_801D15B0.z;
                    phi_s6 += 1;
                }
            } else {
            ...
            temp_f24 = ((phi_s1->unk0 + phi_s0_2->unk0) - phi_s1->unk-C) + sp88 + sp7C;
            temp_f0_2 = phi_s1->unk4 + phi_s0_2->unk4 + arg6 + sp8C + sp80;
            phi_f0 = temp_f0_2;
            if (temp_f0_2 < 2.0f) {
                phi_f0 = 2.0f;
            }
            temp_f26 = phi_f0 - phi_s1->unk-8;
            temp_f20_2 = ((phi_s1->unk8 + phi_s0_2->unk8) - phi_s1->unk-4) + sp90 + sp84;
            ...
            phi_s1->unk0 = (f32) (phi_s1->unk-C + spA0);
            phi_s1->unk4 = (f32) (phi_s1->unk-8 + spA4);
            phi_s1->unk8 = (f32) (phi_s1->unk-4 + spA8);
            if ((phi_s2_2 != 0) && (argB == phi_s2_2)) {
                ...
                arg0->unkF80 = phi_s1->unk0 + spA0;
                arg0->unkF84 = phi_s1->unk4 + spA4;
                arg0->unkF88 = phi_s1->unk8 + spA8;
...
void Boss07_Draw(Boss07 *this, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_809FB504, func_809FB55C, func_809FB728, (Actor *) this);
    ...
    sp4C = &this->unk1210;
    sp50 = &this->unkFB8;
    func_809FB114(this, (GraphicsContext **) globalCtx, &this->unk7AC, &this->unkA04, this->unk77C, 0);
    func_809FB114(this, (GraphicsContext **) globalCtx, sp50, sp4C, this->unk77C, 1);
    if (this->unkAB48 == 0) {
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk334, 0xF, this->unk17F8, this->unk17FC, this->unk1800, (u8) (s32) this->unk1804);
    this->unk149 = 0;
}
...
void func_809FCCCC(Boss07 *this, GlobalContext *globalCtx) {
    ...
    case 5:
        if (this->unkABC8 == 0x14) {
            ...
            this->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06002C40);
        }
...
void func_809FD818(Actor *arg0, GlobalContext *arg1, s16 arg2) {
    ...
    if (func_809FD89C != arg0->unk144) {
        ...
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06009C7C);
    }
    arg0->unk158 = 0xA;
    arg0->unk152 = 0xC;
    arg0->unk150 = arg2;
...
void func_809FD984(Actor *arg0, GlobalContext *arg1, u8 arg2, u8 arg3) {
    ...
    if (func_809FDAB0 != arg0->unk144) {
        ...
        arg0->unk1D4 = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06000D0C);
...
void func_809FFA80(Boss07 *this, GlobalContext *globalCtx) {
    ...
    Math_ApproachS((s16 *) &this->actor.world.rot, sp36, 5, (s16) (s32) this->unk170);
...
void func_809FFEAC(Boss07 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        ...
        if (this->unk152 != 0) {
            this->unk164 = temp_v1->world.pos.x;
            this->unk168 = temp_v1->world.pos.y + 10.0f;
            this->unk16C = temp_v1->world.pos.z;
        } else {
        ...
        Math_ApproachS(&this->actor.world.rot.y, sp34, 0xA, (s16) (s32) this->unk170);
        Math_ApproachS((s16 *) &this->actor.world.rot, sp36, 0xA, (s16) (s32) this->unk170);
...
void func_80A00274(Boss07 *this, GlobalContext *globalCtx) {
    ...
    func_8019F1C0(&D_80A09A40, 0x301BU);
    func_809F4CBC(this, 0.5f);
    Math_ApproachS((s16 *) &this->actor.shape, (s16) (s32) ((Math_SinS((s16) (this->unk14C * 0xBB8)) * 1200.0f) + -4096.0f), 5, 0x800);
...
void func_80A00484(Boss07 *arg0, GlobalContext *arg1, u8 arg2, void *arg3) {
    ...
    if (temp_a2 != 0) {
        ...
        if ((arg1->actorCtx.actorList[2].first->unkA74 & 0x200) != 0) {
...
void func_80A00720(Boss07 *this, GlobalContext *globalCtx) {
    ...
    Math_ApproachS((s16 *) &this->actor.shape, (s16) (Math_Atan2S((temp_s3->world.pos.y - this->actor.world.pos.y) + phi_f24, sqrtf((temp_f20 * temp_f20) + (temp_f22 * temp_f22))) * -1), phi_s0, (s16) (s32) this->unk170);
    ...
    case 5:
        Math_ApproachF(&this->unk1890, 1.0f, 0.2f, 0.2f);
        temp_f20_2 = temp_s3->world.pos.x - this->unk189C;
        temp_f12 = (temp_s3->world.pos.y - this->unk18A0) + 20.0f;
        temp_f22_2 = temp_s3->world.pos.z - this->unk18A4;
        ...
        sp8C = temp_a2;
        sp90 = temp_a0;
        if ((func_800C55C4(temp_a0, (Vec3f *) &this->unk189C, temp_a2, (Vec3f *) &sp14C, &sp158, 1U, 1U, 1U, 1U, &sp144) != 0) && (this->unk14E != 5)) {
        ...
        sp16C = temp_s3->world.pos.x - this->unk189C;
        sp170 = (temp_s3->world.pos.y - this->unk18A0) + 10.0f;
        sp174 = temp_s3->world.pos.z - this->unk18A4;
        ...
        if ((fabsf(sp160) < 20.0f) && (fabsf(sp164) < 50.0f) && (sp168 > 40.0f) && (sp168 <= (this->unk1894 * 20.0f))) {
            if ((func_8012405C(globalCtx) != 0) && (temp_s3->unk14B == 4) && (temp_s3->unkA6C & 0x400000) && (temp_v0_2 = (temp_s3->shape.rot.y - this->actor.shape.rot.y) + 0x8000, (((s32) temp_v0_2 < 0x2000) != 0)) && ((s32) temp_v0_2 >= -0x1FFF)) {
                ...
                if (this->unk14E == 3) {
                    ...
                    Math_ApproachS(&this->unk18C4, sp118, 2, 0x2000);
                    Math_ApproachS(&this->unk18C6, sp11A, 2, 0x2000);
                    ...
                    SysMatrix_StatePush();
                    SysMatrix_MultiplyVector3fByState((Vec3f *) &sp16C, (Vec3f *) &sp160);
                    if ((fabsf(sp160) < 60.0f) && (fabsf(sp164) < 60.0f) && (sp168 > 40.0f) && (sp168 <= (this->unk18C0 * 16.666668f)) && (this->unk14E != 5)) {
                        this->unk18D8 += 2;
                    ...
                    if ((func_800C55C4(sp90, sp8C, &this->unk18B4, (Vec3f *) &sp14C, &sp158, 1U, 1U, 1U, 1U, &sp144) != 0) && (this->unk14E != 5)) {
                        sp14B = 1;
                        sp88 = 6.0f * -0.05f;
        ...
        if (sp14B != 0) {
            if (sp150 == 0.0f) {
                temp_f20_3 = this->unk18E0 - sp14C;
                temp_f22_3 = this->unk18E8 - sp154;
            ...
            this->unk18E0 = sp14C.unk0;
            this->unk18E4 = sp14C.unk4;
            this->unk18E8 = sp14C.unk8;
        }
        if (this->unk14E != 5) {
            if (this->unk150 == 0) {
                this->unk14E = 5;
...
void func_80A01750(Boss07 *this, GlobalContext *globalCtx) {
    ...
    case 0:
        ...
        case 1:
            ...
            this->unkABD4.x = 0.0f;
            this->unkABD4.y = (func_800B6FC8((Player *) sp88) + sp88->world.pos.y) - 24.0f;
            this->unkABD4.z = sp88->world.pos.z - 60.0f;
            this->unkABE0.x = sp88->world.pos.x;
            this->unkABE0.y = (func_800B6FC8((Player *) sp88) + sp88->world.pos.y) - 20.0f;
            this->unkABE0.z = sp88->world.pos.z;
            if (sp88->unk14B == 0) {
            ...
            if (this->unkABC8 == 0x4B) {
                this->unkABC8 = 0;
                this->unkABD0 = 2;
                this->unkABD4.x = sp88->world.pos.x;
                this->unkABD4.y = sp88->world.pos.y + 20.0f;
                this->unkABD4.z = (sp88->world.pos.z - 60.0f) + 120.0f;
                this->unkABE0.x = sp88->world.pos.x;
                this->unkABE0.y = sp88->world.pos.y + 24.0f + 5.0f;
                this->unkABE0.z = sp88->world.pos.z;
            }
        }
        break;
    case 2:
        ...
        phi_v1_4 = phi_v1_3;
        if (phi_v1_3 >= 0x1FU) {
            Math_ApproachF(&this->unkABE0.y, sp88->world.pos.y + 24.0f + 20.0f, 0.05f, this->unkAC0C);
            Math_ApproachF(&this->unkAC0C, 1.0f, 1.0f, 0.01f);
            phi_v1_4 = this->unkABC8;
            phi_t0 = &D_80A09A60;
        }
    ...
    case 3:
        ...
        phi_v1_8 = phi_v1_7;
        if (phi_v1_7 >= 0x4BU) {
            sp78.unk0 = (s32) D_80A082BC.unk0;
            sp78.unk4 = (s32) D_80A082BC.unk4;
            sp78.unk8 = (s32) D_80A082BC.unk8;
            sp6C.unk0 = (s32) D_80A082C8.unk0;
            sp6C.unk4 = (s32) D_80A082C8.unk4;
            sp6C.unk8 = (s32) D_80A082C8.unk8;
            if (this->unkABC8 == 0x4B) {
    ...
    case 4:
        ...
        if (temp_v1 >= 0xAU) {
            ...
            phi_v1_10 = phi_v1_9;
            if (phi_v1_9 >= 0x65U) {
                Math_ApproachF((f32 *) &this->unkABD4, sp88->world.pos.x + 40.0f, 0.1f, this->unkAC0C * 20.0f);
                Math_ApproachF(&this->unkABD4.y, sp88->world.pos.y + 10.0f, 0.1f, this->unkAC0C * 20.0f);
                Math_ApproachF(&this->unkABD4.z, sp88->world.pos.z + 90.0f, 0.1f, this->unkAC0C * 60.0f);
        ...
        Math_ApproachF((f32 *) &this->unkABE0, this->actor.world.pos.x, 0.05f, 10.0f);
...
block_13:
    ...
    Math_ApproachF(&this->unkABE0.y, sp64, 0.1f, 10.0f);
    Math_ApproachF(&this->unkABE0.z, sp68, 0.1f, 10.0f);
    if (sp4C->unk2BD2 != 0) {
        ShrinkWindow_SetLetterboxTarget(0x1B);
        sp54.unk0 = (f32) sp44->x;
        sp54.unk4 = (f32) sp44->y;
        sp54.unk8 = (f32) sp44->z;
        if (sp58 < 30.0f) {
            sp58 = 30.0f;
        }
        Play_CameraSetAtEye(globalCtx, sp4C->unk2BD2, sp3C, (Vec3f *) &sp54);
    }
}
...
void func_80A02B30(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk15C == 0) {
        ...
        if ((temp_v0_2 & 2) != 0) {
            ...
            arg0->unk186C = 0xF;
            if ((func_80A00274 == arg0->unk144) || ((arg1->actorCtx.actorList[2].first->unkA74 & 0x200) != 0)) {
                sp20 = arg0->unk1978;
                phi_a2 = 0U;
...
void func_80A03238(Actor *arg0, GlobalContext *arg1, void *arg2, void *arg3, void *arg4, f32 *arg5, ? *arg6, f32 arg7, u8 arg8, f32 arg9) {
    ...
    if (arg0->unk1874 != 0) {
        do {
            ...
            phi_s0->unk0 = (f32) (phi_s0->unk0 + sp8C);
            phi_s0->unk4 = (f32) (phi_s0->unk4 + sp90);
            phi_s0->unk8 = (f32) (phi_s0->unk8 + sp94);
            SysMatrix_StatePop();
            temp_s5 = phi_s5 + 0xC;
            phi_s4 += 2;
            phi_s0 += 0xC;
    ...
    do {
        if (phi_s3_2 < 5) {
            ...
            sp80 = arg6->unk0 * temp_f0 * 0.2f;
            sp84 = arg6->unk4 * temp_f0 * 0.2f;
            sp88 = arg6->unk8 * temp_f0 * 0.2f;
        } else {
        ...
        phi_s1->unk0 = (f32) (phi_s1->unk-C + sp8C);
        temp_s3_2 = phi_s3_2 + 1;
        temp_s2 = phi_s2_2 + 0xC;
        phi_s1->unk4 = (f32) (phi_s1->unk-8 + sp90);
        temp_s1 = phi_s1 + 0xC;
        temp_s1->unk-4 = (f32) (phi_s1->unk-4 + sp94);
...
block_7:
    ...
    do {
        ...
        phi_s0->unk19F0 = (f32) (this->unk1878 + sp9C);
        phi_s0->unk19F4 = (f32) (this->unk187C + spA0);
        temp_f22_2 = (f32) phi_s1;
        phi_s0->unk19F8 = (f32) (this->unk1880 + spA4);
...
void func_80A04890(Boss07 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 != 0) {
        ...
        sp20 = temp_a0;
        Math_ApproachS((s16 *) temp_a0, sp32, 5, (s16) (s32) this->unk170);
    ...
    this->unk164 = temp_v1_2->unk-960 + temp_v0->world.pos.x;
    this->unk168 = temp_v1_2->unk-95C + temp_v0->world.pos.y;
    temp_f12_2 = this->unk164 - this->actor.world.pos.x;
    this->unk16C = temp_v1_2->unk-958 + temp_v0->world.pos.z;
...
block_27:
    ...
    case 1:
        ...
        Math_ApproachS((s16 *) &this->actor.world.rot, sp7E, 5, (s16) (s32) this->unk170);
        Math_ApproachF(&this->unk170, 2000.0f, 1.0f, 100.0f);
        Math_ApproachF(&this->actor.speedXZ, this->unk18C, 1.0f, 1.0f);
...
void func_80A05B50(Boss07 *this, GlobalContext *globalCtx) {
    ...
    if (func_809F8EC8 == temp_v0->actionFunc) {
        Math_Vec3f_Copy((Vec3f *) &this->actor.world, (Vec3f *) &temp_v0->unkF80);
