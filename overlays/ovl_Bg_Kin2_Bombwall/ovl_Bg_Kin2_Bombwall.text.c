...
void BgKin2Bombwall_Init(BgKin2Bombwall *this, GlobalContext *globalCtx) {
...
void BgKin2Bombwall_Destroy(BgKin2Bombwall *this, GlobalContext *globalCtx) {
...
void BgKin2Bombwall_Update(BgKin2Bombwall *this, GlobalContext *globalCtx) {
    BgKin2Bombwall *this = (BgKin2Bombwall *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgKin2Bombwall_Draw(BgKin2Bombwall *this, GlobalContext *globalCtx) {
    BgKin2Bombwall *this = (BgKin2Bombwall *) thisx;
