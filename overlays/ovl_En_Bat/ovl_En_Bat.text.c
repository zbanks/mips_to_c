typedef struct EnBat {
    ...
    /* 0x16C */ Vec3f unk16C;                       /* inferred */
    /* 0x178 */ Vec3f unk178;                       /* inferred */
    /* 0x184 */ ColliderSphere unk184;              /* inferred */
} EnBat;                                            /* size = 0x1DC */
...
struct _mips2c_stack_EnBat_Draw {
    ...
    /* 0x3C */ char pad3C[0x18];                    /* maybe part of sp3A[13]? */
...
void EnBat_Init(EnBat *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk184, (Actor *) this, &D_80A44A00);
...
void EnBat_Destroy(EnBat *this, GlobalContext *globalCtx) {
    EnBat *this = (EnBat *) thisx;
...
void func_80A4392C(EnBat *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v1 & 8) != 0) {
        ...
        if (Math3D_XZDistanceSquared(this->actor.world.pos.x, this->actor.world.pos.z, this->actor.home.pos.x, this->actor.home.pos.z) > 90000.0f) {
            this->unk150 = Actor_YawToPoint((Actor *) this, (Vec3f *) &this->actor.home);
    ...
    if (((this->actor.bgCheckFlags & 1) != 0) || (this->actor.yDistToWater > -40.0f)) {
        ...
        } else if ((Math_ScaledStepToS((s16 *) &this->actor.shape, this->unk14E, 0x100) != 0) && (Rand_ZeroOne() < 0.015f)) {
            phi_v0_2 = 1;
            if (Rand_ZeroOne() < 0.5f) {
                phi_v0_2 = -1;
            }
...
void func_80A44114(EnBat *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.flags & 0x8000) == 0) {
        ...
        if (((this->actor.bgCheckFlags & 1) != 0) || (this->actor.floorHeight == -32000.0f)) {
            if (this->unk148 == 0xA) {
                func_800BF7CC(globalCtx, (Actor *) this, (Vec3f []) &this->unk160, 3, 2, 0.2f, 0.2f);
            }
...
void EnBat_Update(EnBat *this, GlobalContext *globalCtx) {
    ? sp34;
    ...
    if ((this->unk184.base.atFlags & 1) != 0) {
        sp30 = func_80A43CE8;
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk184);
    }
    if (func_80A43CE8 == this->actionFunc) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk184);
    }
    if ((this->unk184.base.acFlags & 1) != 0) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk184);
    }
    if (this->unk15C > 0.0f) {
        if (this->unk148 != 0xA) {
...
void EnBat_Draw(EnBat *this, GlobalContext *globalCtx) {
    Gfx *sp58;
    ...
    if (this->unk15C > 0.0f) {
        ...
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) sp34, 3, this->unk154, this->unk158, this->unk15C, (u8) (s32) this->unk148);
    }
}
