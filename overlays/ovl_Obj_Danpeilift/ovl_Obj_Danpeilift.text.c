...
void ObjDanpeilift_Init(ObjDanpeilift *this, GlobalContext *globalCtx) {
    Path *temp_v0;
    f32 temp_f0;
    s16 temp_v1;
...
void ObjDanpeilift_Destroy(ObjDanpeilift *this, GlobalContext *globalCtx) {
    ObjDanpeilift *this = (ObjDanpeilift *) thisx;
...
void ObjDanpeilift_Update(ObjDanpeilift *this, GlobalContext *globalCtx) {
    Actor *temp_v0_2;
    s16 temp_v0;
    f32 phi_f0;
    f32 phi_f2;
...
void ObjDanpeilift_Draw(ObjDanpeilift *this, GlobalContext *globalCtx) {
    ObjDanpeilift *this = (ObjDanpeilift *) thisx;
