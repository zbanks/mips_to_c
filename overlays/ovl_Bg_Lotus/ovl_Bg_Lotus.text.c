...
void BgLotus_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->dyna.actor.floorHeight = func_800C411C(&globalCtx->colCtx, &this->dyna.actor.floorPoly, &sp2C, &this->dyna.actor, &this->dyna.actor.world.pos);
    this->timer2 = 0x60;
...
void func_80AD68DC(BgLotus *arg0, GlobalContext *arg1) {
    ...
    if (func_800CAF70(&arg0->dyna) != 0) {
        temp_a1 = &arg0->dyna.actor.world;
        if (arg0->hasSpawnedRipples == 0) {
            sp2C = temp_a1;
            EffectSsGRipple_Spawn(arg1, &temp_a1->pos, 0x3E8, 0x578, (s16) 0);
            EffectSsGRipple_Spawn(arg1, &temp_a1->pos, 0x3E8, 0x578, (s16) 8);
            arg0->timer = 0x28;
        }
...
void func_80AD6A88(BgLotus *arg0, GlobalContext *arg1) {
    ...
    arg0 = arg0;
    if (Math_StepToF(&temp_a0->x, 0.0f, 0.0050000004f) != 0) {
...
void func_80AD6B68(BgLotus *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->dyna.actor.xzDistToPlayer > 100.0f) && (arg0->dyna.actor.projectedPos.z < 0.0f)) {
        ...
        Actor_SetScale(&arg0->dyna.actor, 0.1f);
        temp_f0 = arg0->height;
        temp_f2 = arg0->dyna.actor.floorHeight;
        if (temp_f0 < temp_f2) {
            arg0->dyna.actor.world.pos.y = temp_f2;
