typedef struct ObjBean {
    ...
    /* 0x1AC */ char pad1AC[0x6];
    /* 0x1B2 */ s16 unk1B2;                         /* inferred */
    /* 0x1B4 */ s8 unk1B4;                          /* inferred */
    /* 0x1B5 */ char pad1B5[0x3];                   /* maybe part of unk1B4[4]? */
    /* 0x1B8 */ f32 unk1B8;                         /* inferred */
    /* 0x1BC */ char pad1BC[0x18];                  /* maybe part of unk1B8[7]? */
    /* 0x1D4 */ void *unk1D4;                       /* inferred */
    /* 0x1D8 */ char pad1D8[0x6];                   /* maybe part of unk1D4[2]? */
    /* 0x1DE */ s8 unk1DE;                          /* inferred */
    /* 0x1DF */ char pad1DF[0x1F];                  /* maybe part of unk1DE[32]? */
    /* 0x1FE */ u8 unk1FE;                          /* inferred */
    /* 0x1FF */ char pad1FF[0x5];                   /* maybe part of unk1FE[6]? */
} ObjBean;                                          /* size = 0x204 */
...
void func_809372D0(ObjBean *arg0) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp38, arg0->unk1D4 + (arg0->unk1DC * 6));
    temp_a1 = arg0 + 0x1BC;
    temp_a2 = arg0 + 0x64;
    sp20 = temp_a2;
    sp28 = temp_a1;
