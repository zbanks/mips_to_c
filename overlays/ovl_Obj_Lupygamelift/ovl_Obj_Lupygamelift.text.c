...
void ObjLupygamelift_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_168 = temp_t2;
    temp_v1 = &globalCtx->setupPathList[temp_v0 & 0x7F];
    temp_t3 = temp_v1->count;
    this->unk_164 = (s32) temp_t3;
    if (temp_t2 >= (s32) temp_t3) {
        this->unk_168 = 0;
    }
    this->unk_16C = Lib_SegmentedToVirtual((void *) temp_v1->points);
...
void func_80AF0394(void *arg0) {
    ...
    arg0->unk_D0 = (s8) (u32) (temp_f0_2 - (phi_f14 * (temp_f0_2 - D_80AF0750)));
    arg0->unk_CC = (f32) (temp_f2_2 - (phi_f14 * (temp_f2_2 - D_80AF0758)));
}
...
void func_80AF04D8(ObjLupygamelift *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_170 = temp_v0 - 1;
}

void func_80AF0514(void *arg0) {
    arg0->unk_15C = func_80AF0530;
    arg0->unk_70 = (f32) arg0->unk_160;
}
...
void func_80AF0530(void *arg0, ? arg1) {
    ...
    temp_a1 = &sp30;
    sp30 = (f32) *(arg0->unk_16C + (arg0->unk_168 * 6));
    sp34 = (f32) (arg0->unk_16C + (arg0->unk_168 * 6))->unk_2;
    sp38 = (f32) (arg0->unk_16C + (arg0->unk_168 * 6))->unk_4;
    temp_f0 = Math_Vec3f_StepTo(arg0 + 0x24, (Vec3f *) temp_a1, arg0->unk_70);
    if (temp_f0 > 30.0f) {
        Math_SmoothStepToF(arg0 + 0x70, arg0->unk_160, 0.5f, 5.0f, 0.1f);
    } else if (temp_f0 > 0.0f) {
        Math_SmoothStepToF(arg0 + 0x70, 5.0f, 0.5f, 5.0f, 1.0f);
    } else {
        temp_v0 = arg0->unk_168;
        if (temp_v0 < (arg0->unk_164 - 1)) {
            arg0->unk_168 = (s32) (temp_v0 + 1);
        } else {
            arg0->unk_168 = 0;
        }
    }
    temp_v0_2 = arg0->unk_124;
    if (temp_v0_2->unk_138 == 0) {
        arg0->unk_124 = NULL;
    } else {
        temp_v0_2->unk_24 = (f32) arg0->unk_24;
        arg0->unk_124->unk_28 = (f32) arg0->unk_28;
        arg0->unk_124->unk_2C = (f32) arg0->unk_2C;
    }
    func_80AF0394(arg0);
}
