typedef struct EnPp {
    ...
    /* 0x18E */ char pad18E[0x96];                  /* maybe part of unk188[26]? */
    /* 0x224 */ Vec3s unk224;                       /* inferred */
    /* 0x22A */ char pad22A[0x96];                  /* maybe part of unk224[26]? */
    ...
    /* 0x2D6 */ char pad2D6[0x52];                  /* maybe part of unk2D4[42]? */
    /* 0x328 */ Vec3f unk328;                       /* inferred */
    /* 0x334 */ f32 unk334;                         /* inferred */
    /* 0x338 */ f32 unk338;                         /* inferred */
    /* 0x33C */ f32 unk33C;                         /* inferred */
    /* 0x340 */ char pad340[0x8];                   /* maybe part of unk33C[3]? */
    ...
    /* 0x35C */ char pad35C[0x4];
    /* 0x360 */ f32 unk360;                         /* inferred */
    /* 0x364 */ Vec3f unk364;                       /* inferred */
    /* 0x370 */ s32 unk370;                         /* inferred */
    /* 0x374 */ Vec3f unk374;                       /* inferred */
    /* 0x380 */ char pad380[0x6C];                  /* maybe part of unk374[10]? */
    ...
    /* 0x3F6 */ char pad3F6[0x2];
    /* 0x3F8 */ f32 unk3F8;                         /* inferred */
    /* 0x3FC */ f32 unk3FC;                         /* inferred */
    /* 0x400 */ f32 unk400;                         /* inferred */
    /* 0x404 */ s32 unk404;                         /* inferred */
    /* 0x408 */ Vec3f unk408;                       /* inferred */
    /* 0x414 */ char pad414[0x7C];                  /* maybe part of unk408[11]? */
    /* 0x490 */ f32 unk490;                         /* inferred */
    /* 0x494 */ ColliderJntSph unk494;              /* inferred */
    /* 0x4B4 */ ColliderJntSphElement unk4B4;       /* inferred */
    /* 0x4F4 */ ColliderJntSph unk4F4;              /* inferred */
    /* 0x514 */ ColliderJntSphElement unk514;       /* inferred */
    /* 0x554 */ ColliderQuad unk554;                /* inferred */
    /* 0x5D4 */ CollisionPoly *unk5D4;              /* inferred */
    /* 0x5D8 */ s32 unk5D8;                         /* inferred */
    /* 0x5DC */ char pad5DC[0x4];
    /* 0x5E0 */ f32 unk5E0;                         /* inferred */
    /* 0x5E4 */ char pad5E4[0x4];
    /* 0x5E8 */ f32 unk5E8;                         /* inferred */
} EnPp;                                             /* size = 0x5EC */
...
struct _mips2c_stack_EnPp_Init {
    ...
    /* 0x038 */ char pad38[0xC];                    /* maybe part of sp34[4]? */
    /* 0x044 */ ? sp44;                             /* inferred */
    /* 0x044 */ char pad44[0x184];
...
void EnPp_Init(EnPp *this, GlobalContext *globalCtx) {
    s32 sp1E0;
    s32 sp1DC;
    s32 sp1D8;
    s8 sp1D7;
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk494, (Actor *) this, &D_80B21688, &this->unk4B4);
    Collider_InitAndSetJntSph(globalCtx, &this->unk4F4, (Actor *) this, &D_80B216BC, &this->unk514);
    temp_a1 = &this->unk554;
    ...
    sp1D6 = 0xFF;
    sp1D7 = 0;
    Effect_Add(globalCtx, &this->unk5D8, 1, 0U, (u8) 0, (void *) &sp44);
    Actor_SetScale((Actor *) this, 0.03f);
...
void EnPp_Destroy(EnPp *this, GlobalContext *globalCtx) {
    EnPp *this = (EnPp *) thisx;
...
void func_80B1E970(EnPp *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk2CA == 0) && (arg0->unk2CC == 0)) {
        ...
        arg0->unk2D0 = Math_Vec3f_Yaw(arg0 + 0x24, (Vec3f *) &sp34);
...
void func_80B1F770(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk2C4 == 0) {
        ...
        arg0->unk2CA = 0xA;
        arg0->unk358 = (f32) (arg0->unk358 + sp44);
        arg0->unk360 = (f32) (arg0->unk360 + sp4C);
    }
    temp_v0_2 = arg0->unk3F4;
...
void func_80B1F940(EnPp *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk2C4 != 0) {
        Math_ApproachF((f32 *) &arg0->actor.world, arg0->unk358, 0.5f, 25.0f);
...
void func_80B1FC7C(EnPp *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v1 == 0xB) || (temp_v1 == 0xA)) {
        if (arg0->unk3F2 != 0) {
            func_800BF7CC(arg1, (Actor *) arg0, (Vec3f []) &arg0->unk408, 0xB, 2, 0.7f, 0.4f);
            arg0->unk3F2 = 0;
            arg0->unk3F4 = 0;
            goto block_4;
        }
                ...
                if (temp_v1 != 2) {
                    ...
                    if (temp_f2 > 900.0f) {
                        ...
                        if (arg0->unk350 > 0.0f) {
                            ...
                            temp_s3 = temp_s1;
                            do {
                                Math_Vec3f_Copy((Vec3f *) temp_s1, &arg0->unk328);
...
void EnPp_Update(EnPp *this, GlobalContext *globalCtx) {
    WaterBox *sp3C;
    f32 sp38;
    ...
    if ((this->unk2C8 != 0xD) && ((func_80B20668(this, globalCtx), Actor_SetHeight((Actor *) this, 40.0f), (this->unk2C8 == 9)) || ((this->actor.bgCheckFlags & 1) != 0))) {
    ...
    if (this->unk2C8 != 0xD) {
        ...
        if ((phi_v1 < 9) || (phi_v1 == 5)) {
            ...
            sp34 = temp_a1;
            CollisionCheck_SetAC(globalCtx, temp_a1, (Collider *) &this->unk494);
            CollisionCheck_SetAC(globalCtx, temp_a1, (Collider *) &this->unk4F4);
        ...
        if ((phi_v1_2 < 7) && (phi_v1_2 != 6)) {
            CollisionCheck_SetAT(globalCtx, temp_t7, (Collider *) &this->unk494);
            CollisionCheck_SetAT(globalCtx, sp34, (Collider *) sp30);
        }
        CollisionCheck_SetOC(globalCtx, sp34, (Collider *) sp30);
        if (this->unk2CE != 0) {
            CollisionCheck_SetAT(globalCtx, sp34, (Collider *) &this->unk554);
        }
    }
}
        ...
        if ((arg1 == 8) && (arg4->params == 0)) {
            ...
            if (arg4->unk2CE != 0) {
                ...
                if ((temp_f0 > 26.0f) || ((s32) arg4->unk2C8 >= 7)) {
                    ...
                    func_800A81F0(Effect_GetParams(arg4->unk5D8), (Vec3f *) &sp58, (Vec3f *) &sp4C);
                }
            }
        }
    } else {
...
void EnPp_Draw(EnPp *this, GlobalContext *globalCtx) {
    ? sp64;
    f32 sp60;
    f32 sp5C;
    f32 sp58;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B20E6C, func_80B20F70, (Actor *) this);
    temp_v0 = this->unk370;
    if (temp_v0 != 0) {
        phi_f0 = 0.4f;
        ...
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk374, (s16) temp_v0, phi_f0, phi_f0, 1.0f, (u8) 1);
    }
    temp_v1 = this->unk3F2;
    if (temp_v1 != 0) {
        temp_f8 = (f32) temp_v1;
        ...
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk408, 0xB, this->unk3F8, this->unk3FC, temp_f8 * 0.05f, (u8) (s32) this->unk3F4);
    }
    if (this->unk5D4 != 0) {
