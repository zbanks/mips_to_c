typedef struct EnGm {
    ...
    /* 0x1DC */ ColliderSphere unk1DC;              /* inferred */
    /* 0x234 */ char pad234[0x24];
    /* 0x258 */ u8 unk258;                          /* inferred */
    /* 0x259 */ char pad259[0x3];                   /* maybe part of unk258[4]? */
    /* 0x25C */ s32 unk25C;                         /* inferred */
    /* 0x260 */ s8 unk260;                          /* inferred */
    /* 0x261 */ char pad261[0x1];
    /* 0x262 */ s8 unk262;                          /* inferred */
    /* 0x263 */ char pad263[0x1];
    /* 0x264 */ s32 *unk264;                        /* inferred */
    /* 0x268 */ Actor *unk268;                      /* inferred */
    /* 0x26C */ char pad26C[0x48];                  /* maybe part of unk268[19]? */
    /* 0x2B4 */ Vec3s unk2B4;                       /* inferred */
    /* 0x2BA */ char pad2BA[0x72];                  /* maybe part of unk2B4[20]? */
    /* 0x32C */ Vec3s unk32C;                       /* inferred */
    /* 0x332 */ char pad332[0x72];                  /* maybe part of unk32C[20]? */
    /* 0x3A4 */ u16 unk3A4;                         /* inferred */
    /* 0x3A6 */ char pad3A6[0xE];                   /* maybe part of unk3A4[8]? */
    /* 0x3B4 */ f32 unk3B4;                         /* inferred */
    /* 0x3B8 */ s16 unk3B8;                         /* inferred */
    /* 0x3BA */ char pad3BA[0xA];                   /* maybe part of unk3B8[6]? */
    /* 0x3C4 */ s16 unk3C4;                         /* inferred */
    /* 0x3C6 */ s16 unk3C6;                         /* inferred */
    /* 0x3C8 */ char pad3C8[0x6];                   /* maybe part of unk3C6[4]? */
    /* 0x3CE */ s16 unk3CE;                         /* inferred */
    /* 0x3D0 */ char pad3D0[0x2];
    /* 0x3D2 */ s16 unk3D2;                         /* inferred */
    /* 0x3D4 */ char pad3D4[0x4];                   /* maybe part of unk3D2[3]? */
    /* 0x3D8 */ s16 unk3D8;                         /* inferred */
    /* 0x3DA */ char pad3DA[0xA];                   /* maybe part of unk3D8[6]? */
    /* 0x3E4 */ void *unk3E4;                       /* inferred */
    /* 0x3E8 */ s32 unk3E8;                         /* inferred */
    /* 0x3EC */ char pad3EC[0x10];                  /* maybe part of unk3E8[5]? */
    /* 0x3FC */ s32 unk3FC;                         /* inferred */
    /* 0x400 */ char pad400[0x4];
} EnGm;                                             /* size = 0x404 */
...
? *func_8094EDBC(Actor *arg0, GlobalContext *arg1); /* static */
...
static ? D_80951A88;                                /* unable to generate initializer */
static ? D_80951A90;                                /* unable to generate initializer */
static ? D_80951A98;                                /* unable to generate initializer */
static ? D_80951AD8;                                /* unable to generate initializer */
static ? D_80951B98;                                /* unable to generate initializer */
static ? D_80951BE8;                                /* unable to generate initializer */
static ? D_80951C2C;                                /* unable to generate initializer */
static ? D_80951C34;                                /* unable to generate initializer */
...
s32 func_8094DFF8(EnGm *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 >= 0) {
        arg0->unk144.animPlaybackSpeed = arg0->unk3A8;
...
s32 func_8094E054(Actor *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    } else if (arg2 != arg0->unk3E8) {
block_6:
        phi_v1 = 1;
    }
    if (phi_v1 != 0) {
        temp_a0 = arg0 + 0x144;
        if ((s32) arg0->unk262 >= 0) {
            arg0->unk3E8 = arg2;
            arg0 = arg0;
            temp_a1 = func_8013BC6C(temp_a0, D_80951CC0, arg2);
            arg0->unk3A8 = (f32) arg0->unk160;
            phi_a1 = temp_a1;
        }
    }
    return phi_a1;
...
s32 func_8094E0F8(EnGm *arg0, GlobalContext *arg1) {
    ...
    phi_a3 = 0;
    if ((temp_v1 != arg0->unk260) && (arg1->roomCtx.unk31 == 0)) {
        arg0->unk260 = temp_v1;
        sp1C = 0;
        arg0 = arg0;
        arg0->unk262 = func_8013D924(0x248, arg1);
...
void func_8094E1DC(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg0 + 0x190;
    if (arg0->unk258 == 7) {
        arg0->unk22A = (s16) (s32) ((f32) arg0->unk222 * arg0->unk22C);
...
void func_8094E2D0(EnGm *arg0) {
    ...
    phi_a1 = 0;
    phi_a1 = 0;
    if ((arg0->unk3A4 & 0x100) != 0) {
        temp_v1 = arg0->unk3CC;
        if (temp_v1 == 0) {
            phi_v0 = 0;
        } else {
            arg0->unk3CC = temp_v1 - 1;
            phi_v0 = arg0->unk3CC;
        }
        if (phi_v0 == 0) {
            temp_v0 = arg0->unk3CA;
            if (temp_v0 != 1) {
                if (temp_v0 != 2) {
                    if (temp_v0 != 3) {
                        ...
                        } else if (arg0->unk3CE == 1) {
                            arg0->unk3CE = 1;
                            phi_a1 = 1;
                        }
                    } else if (arg0->unk3CE == 2) {
                        arg0->unk3CE = 2;
                        phi_a1 = 1;
                    }
                } else {
                    temp_v0_2 = arg0->unk3CE;
                ...
                temp_v0_3 = arg0->unk3CE;
                if ((temp_v0_3 == 5) || (temp_v0_3 == 2)) {
                    arg0->unk3CE = 5;
                    phi_a1 = 1;
                }
            }
            if ((phi_a1 == 0) && ((temp_v0_4 = arg0->unk3CE, (temp_v0_4 == 4)) || (temp_v0_4 == 5))) {
                arg0->unk3CE = 1;
            }
            if (phi_a1 == 0) {
                arg0->unk3CE += 1;
                if ((s32) arg0->unk3CE >= 4) {
                    if (arg0->unk3CA == 0) {
                        arg0 = arg0;
                        arg0->unk3CC = Rand_S16Offset(0x1E, 0x1E);
                    } else {
                        arg0->unk3CC = 8;
                    }
                    arg0->unk3CE = 0;
...
block_6:
            if (((gSaveContext.weekEventReg[86] & 0x40) == 0) && (arg0->unk3E0 == 2)) {
                ActorCutscene_Stop(temp_v0);
            } else {
...
s32 func_8094E69C(Actor *arg0, GlobalContext *arg1) {
    ...
    case 1:
        ...
        if ((temp_v0_2 != 0) || (temp_v0_2->update != 0)) {
            ...
            arg0->unk3E2 = (s16) (arg0->unk3E2 + 1);
            if ((temp_t2 != ((s32) arg0->shape.rot.y / 0x16C)) && ((s32) arg0->unk3E2 < 0x14)) {
                Math_ApproachS(&arg0->shape.rot.y, temp_a1, 3, 0x2AA8);
            } else {
                arg0->shape.rot.y = (s16) temp_v0_3;
                arg0->unk3A4 = (u16) (arg0->unk3A4 | 0x20);
                arg0->unk3E2 = 0;
                arg0->unk3E0 = (s16) (arg0->unk3E0 + 1);
                sp2C = 1;
            }
        } else {
            arg0->unk3E0 = (s16) (temp_v1 + 1);
            arg0->unk3A4 = (u16) (arg0->unk3A4 | 0x20);
    ...
    case 9:
        ...
        arg0->unk3E2 = (s16) (arg0->unk3E2 + 1);
        if ((((s32) sp48 / 0x16C) != ((s32) arg0->shape.rot.y / 0x16C)) && ((s32) arg0->unk3E2 < 0x14)) {
            Math_ApproachS(&arg0->shape.rot.y, sp48, 3, 0x2AA8);
            arg0->unk3A4 = (u16) (arg0->unk3A4 & 0xFFDF);
        } else {
...
block_15:
                ...
                arg0->unk3E2 = (s16) (arg0->unk3E2 + 1);
                if ((((s32) temp_s1 / 0x16C) != ((s32) arg0->shape.rot.y / 0x16C)) && ((s32) arg0->unk3E2 < 0x14)) {
...
block_10:
        ...
        arg0->unk3E2 = (s16) (arg0->unk3E2 + 1);
        if ((((s32) temp_s1_2 / 0x16C) != ((s32) arg0->shape.rot.y / 0x16C)) && ((s32) arg0->unk3E2 < 0x14)) {
...
? *func_8094EDBC(Actor *arg0, GlobalContext *arg1) {
    u8 temp_t6;

    temp_t6 = arg0->unk258;
    switch (temp_t6) {
    case 1:
        arg0->unk3E4 = func_8094E52C;
        return &D_80951A98;
    case 2:
        arg0->unk3E4 = (s32 (*)(Actor *, GlobalContext *)) func_8094EA34;
        return &D_80951AD8;
    case 3:
        arg0->unk3E4 = func_8094E69C;
        return &D_80951B98;
    case 5:
        arg0->unk3E4 = func_8094EB1C;
        return &D_80951BE8;
    case 7:
        return &D_80951C2C;
    case 8:
...
s32 func_8094EE84(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk3A4 & 7) != 0) {
        ...
        if (func_800B84D0(arg0, arg1) != 0) {
            func_8013AED4(arg0 + 0x3A4, 0U, 7U);
            arg0->unk3E0 = 0;
            arg0->unk3E4 = 0;
            arg0->child = arg0->unk268;
            temp_v1 = arg0->unk258;
            arg0->unk264 = func_8094EDBC(arg0, arg1);
            ...
            if ((arg0->unk258 == 3) && ((gSaveContext.weekEventReg[75] & 1) != 0)) {
                arg0->unk3A4 = (u16) (arg0->unk3A4 & 0xFFDF);
            }
            arg0->unk188 = func_80950DB8;
            phi_v1 = 1;
        }
    }
    return phi_v1;
...
void func_8094F0E0(void *arg0) {
    ...
    Math_Vec3f_Copy((Vec3f *) &sp40, arg0->unk268 + 0x24);
    Math_Vec3f_Copy((Vec3f *) &sp34, arg0 + 0x24);
    temp_v0 = Math_Vec3f_Yaw((Vec3f *) &sp34, (Vec3f *) &sp40);
    sp32 = temp_v0;
    Math_ApproachS(arg0 + 0x3BE, (s16) ((temp_v0 - arg0->unk3C2) - arg0->unkBE), 4, 0x2AA8);
    temp_v1 = arg0->unk3BE;
    ...
    Math_ApproachS(arg0 + 0x3C2, (s16) ((sp32 - arg0->unk3BE) - arg0->unkBE), 4, 0x2AA8);
    temp_v1_2 = arg0->unk3C2;
    if ((s32) temp_v1_2 < -0x1C70) {
        ...
        arg0->unk3C2 = phi_v0_2;
    }
    Math_Vec3f_Copy((Vec3f *) &sp34, arg0 + 0x3C);
    temp_v0_2 = arg0->unk268;
    if (temp_v0_2->unk0 == 0) {
        sp44 = temp_v0_2->unkC44 + 3.0f;
    } else {
        Math_Vec3f_Copy((Vec3f *) &sp40, temp_v0_2 + 0x3C);
    }
    Math_ApproachS(arg0 + 0x3BC, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk3C0), 4, 0x2AA8);
    temp_v1_3 = arg0->unk3BC;
    if ((s32) temp_v1_3 < -0x1554) {
        ...
        arg0->unk3BC = phi_v0_3;
    }
    Math_ApproachS(arg0 + 0x3C0, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk3BC), 4, 0x2AA8);
    temp_v1_4 = arg0->unk3C0;
...
void func_8094F2E8(EnGm *arg0) {
    ...
    if (((arg0->unk3A4 & 0x20) != 0) && (temp_v0 = arg0->unk268, (temp_v0 != 0)) && (temp_v0->update != 0)) {
        temp_v0_2 = arg0->unk3C6;
        if (temp_v0_2 == 0) {
            phi_v1 = 0;
        } else {
            arg0->unk3C6 = temp_v0_2 - 1;
            phi_v1 = arg0->unk3C6;
        }
        if (phi_v1 == 0) {
            func_8094F0E0();
            temp_t2 = arg0->unk3A4 & 0xFDFF;
...
block_8:
    temp_v0_3 = arg0->unk3A4;
    if ((temp_v0_3 & 0x80) != 0) {
        arg0->unk3A4 = temp_v0_3 & 0xFF7F;
        arg0->unk3BC = 0;
        arg0->unk3BE = 0;
        arg0->unk3C0 = 0;
        arg0->unk3C2 = 0;
    ...
    temp_v0_4 = arg0->unk3C6;
    if (temp_v0_4 == 0) {
        phi_v1_2 = 0;
    } else {
        arg0->unk3C6 = temp_v0_4 - 1;
        phi_v1_2 = arg0->unk3C6;
    }
    if (phi_v1_2 == 0) {
        arg0->unk3A4 |= 0x200;
    }
...
void func_8094F3D0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0 == sp2C->unkA88) && (((s32) temp_a0 < 0xFF) || ((s32) temp_a0 >= 0x201)) && (temp_v0 == 3) && (arg0->unk3F0 == 3)) {
        if (((u32) arg1->state.frames % 3U) == 0) {
            if (arg0->unk3AC == 120.0f) {
                arg0->unk3AC = 0.0f;
            } else {
                arg0->unk3AC = 120.0f;
            }
    ...
    Math_SmoothStepToF(arg0 + 0x3B0, arg0->unk3AC, 0.8f, 40.0f, 10.0f);
    SysMatrix_InsertTranslation(arg0->unk3B0, 0.0f, 0.0f, 1);
    arg0->unk3F0 = sp28;
}

? func_8094F4EC(GlobalContext *arg0) {
    if ((arg0->mainCamera.paramData[56] != 6) && (arg0->subCameras[0].at.x == 0xC)) {
        arg0->unk3A4 = (u16) (arg0->unk3A4 & 0xDFFF);
...
? func_8094F53C(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    if ((sp34->unkA6C & 0x440) != 0) {
        arg0->unk3A4 = (u16) (arg0->unk3A4 | 0x400);
        sp24 = (s32) sp32;
        if (sp32 != arg0->unk3A6) {
            ...
            default:                                /* switch 1 */
                ...
                if (((bitwise s32) temp_v0 == 7) || ((bitwise s32) temp_v0 == 8)) {
                    arg0->unk3A4 = (u16) (arg0->unk3A4 | 0x2000);
        ...
        temp_v0_2 = arg0->unk3A4;
        if ((temp_v0_2 & 0x400) != 0) {
            arg0->view.viewing.m[3][1] = 0;
            arg0->unk3A6 = 0U;
            arg0->unk3A4 = (u16) (temp_v0_2 & 0xFBFF);
            arg0->unk3CC = 4;
            arg0->unk3CA = (s16) arg0->unk3C8;
...
s32 func_8094F7D0(GlobalContext *arg0, GlobalContext *arg1, u8 *arg2, u8 arg3, s16 arg4) {
    ...
    if (temp_a2 >= 0) {
        sp2C = temp_v0;
        arg0->unk234 = func_8013BB34(arg1, sp4F, temp_a2);
        phi_v1 = sp2C;
    }
    if ((phi_v1 != 0) && (phi_v1->update != 0)) {
        ...
        if (temp_v0_2 != 0) {
            ...
            sp48 = temp_v0_3;
            Math_Vec3s_ToVec3f((Vec3f *) &sp3C, ((arg0->unk234->count * 6) + temp_v0_3) - 0xC);
            Math_Vec3s_ToVec3f((Vec3f *) &sp30, ((arg0->unk234->count * 6) + sp48) - 6);
...
s32 func_8094F904(Actor *arg0, GlobalContext *arg1, void *arg2) {
    ...
    sp55 = (u8) arg0->params;
    arg0->unk234 = NULL;
    sp50 = func_8094DF90(arg1, arg2->unk0);
    temp_a2 = *(&D_80951A0C + (arg2->unk0 * 4));
    if (temp_a2 >= 0) {
        arg0->unk234 = func_8013BB34(arg1, sp55, temp_a2);
    }
    if ((sp50 != 0) && (sp50->unk138 != 0)) {
        ...
        if (temp_v0 != 0) {
            ...
            arg0->unk3B8 = (s16) (arg2->unk8 - arg2->unk4);
            temp_t1 = arg0->unk3A4 | 0x100;
            arg0->unk3A4 = temp_t1;
            arg0->unk3BA = (s16) (sp56 - arg2->unk4);
            arg0->flags &= -2;
            arg0->unk3A4 = (u16) (temp_t1 | 0x200);
...
s32 func_8094FAC4(Actor *arg0, GlobalContext *arg1, void *arg2) {
    ...
    temp_a3 = *(&D_80951A0C + (arg2->unk0 * 4));
    if (temp_a3 >= 0) {
        sp20 = 0;
        sp2E = temp_t0 & 0xFFFF;
        arg0->unk234 = func_8013BB34(arg1, sp2B, temp_a3);
    }
    temp_v0 = arg0->unk234;
    phi_v0 = temp_v0;
    phi_v1_2 = 0;
    ...
    if (phi_v0 != 0) {
        temp_v0_2 = arg0->unk258;
        if (((s32) temp_v0_2 < 9) && (temp_v0_2 != 0) && ((s32) arg0->unk3C4 >= 0)) {
        ...
        temp_v0_3 = arg2->unk8;
        if (temp_v0_3 < phi_v1) {
            arg0->unk248 = (s32) ((phi_v1 - temp_v0_3) + 0xFFFF);
        } else {
            arg0->unk248 = (s32) (temp_v0_3 - phi_v1);
        }
        arg0->unk254 = (s32) ((temp_t0 & 0xFFFF) - phi_v1);
        temp_lo = (s32) arg0->unk248 / (s32) ((arg0->unk234->count - 2) & 0xFFFF);
        temp_t8 = arg0->unk3A4 & 0xFFF7;
        arg0->unk3A4 = temp_t8;
        arg0->unk24C = temp_lo;
        arg0->unk250 = (s32) (((s32) arg0->unk254 / temp_lo) + 2);
        arg0->unk3A4 = (u16) (temp_t8 & 0xFFEF);
        func_8013AED4(arg0 + 0x3A4, 3U, 7U);
        temp_t3 = arg0->unk3A4 | 0x100;
        arg0->unk3A4 = temp_t3;
        arg0->unk3A4 = (u16) (temp_t3 | 0x200);
        func_8094E054(arg0, arg1, 7);
        arg0->gravity = -1.0f;
        phi_v1_2 = 1;
    }
...
s32 func_8094FD88(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    if (func_8094F7D0(arg0, arg1, (u8 *)4, (u8) 0x290) != 0) {
        ...
        func_8013AED4((u16 *) &arg0->subCameras[0].paramData[12], 3U, 7U);
        temp_t9 = arg0->unk3A4 | 0x100;
        arg0->unk3A4 = temp_t9;
        arg0->unk3A4 = (u16) (temp_t9 | 0x200);
        phi_v1 = 1;
    }
    return phi_v1;
}
...
s32 func_8094FE10(GlobalContext *arg0, GlobalContext *arg1, u8 *arg2) {
    ...
    if ((func_8094F7D0(arg0, arg1, arg2, 4U, (s16) 0x234) != 0) && (sp28 != 0) && (sp28->update != 0)) {
        ...
        temp_t4 = arg0->unk3A4 | 0x120;
        arg0->unk3A4 = temp_t4;
        arg0->unk3A4 = (u16) (temp_t4 | 0x200);
        sp2C = 1;
    }
    return sp2C;
}
...
s32 func_8094FF04(Actor *arg0, GlobalContext *arg1, u8 *arg2) {
    ...
    if (temp_a3 >= 0) {
        sp28 = 0;
        arg0->unk234 = func_8013BB34(arg1, sp4F, temp_a3);
        phi_v1 = sp28;
    }
    temp_v0 = arg0->unk234;
    if (temp_v0 != 0) {
        temp_v0_2 = Lib_SegmentedToVirtual((void *) temp_v0->points);
        sp48 = temp_v0_2;
        Math_Vec3s_ToVec3f((Vec3f *) &sp3C, ((arg0->unk234->count * 6) + temp_v0_2) - 0xC);
        Math_Vec3s_ToVec3f((Vec3f *) &sp30, ((arg0->unk234->count * 6) + sp48) - 6);
        ...
        arg0->unk400 = 0;
        temp_t2 = arg0->unk3A4 | 0x100;
        arg0->unk3A4 = temp_t2;
        arg0->unk3A4 = (u16) (temp_t2 | 0x200);
        phi_v1 = 1;
    }
    return phi_v1;
}
...
s32 func_80950088(Actor *arg0, GlobalContext *arg1, ? arg2) {
    ...
    func_8013AED4(arg0 + 0x3A4, 3U, 7U);
    temp_t8 = arg0->unk3A4 | 0x2100;
    arg0->unk3A4 = temp_t8;
    arg0->unk3A4 = (u16) (temp_t8 | 0x200);
...
? func_809503F8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk3E8 == 9) {
        sp20 = temp_a2;
        if (func_801378B8(temp_a2, arg0->unk154) != 0) {
        ...
        if ((temp_v0 != 5) && (temp_v0 != 6)) {
            ...
            if (temp_v0 == 9) {
                ...
                if (temp_v1 == 0) {
                    ...
                    arg0->unk3DE = (s16) (temp_v1 - 1);
                    phi_v0 = arg0->unk3DE;
                }
                if (phi_v0 == 0) {
                    func_8094E054(arg0, arg1, *(&D_80951DE4 + (arg0->unk3F4 * 4)));
                    temp_t4 = arg0->unk3F4 + 1;
                    temp_hi = temp_t4 % 0xC;
                    arg0->unk3F4 = temp_t4;
                    arg0->unk3F4 = temp_hi;
            ...
            func_8094E054(arg0, arg1, *(&D_80951DE4 + (arg0->unk3F4 * 4)));
            temp_t7 = arg0->unk3F4 + 1;
            temp_hi_2 = temp_t7 % 0xC;
            arg0->unk3F4 = temp_t7;
            arg0->unk3F4 = temp_hi_2;
            phi_v0_2 = Rand_S16Offset(0x1E, 0x1E);
block_18:
            arg0->unk3DE = phi_v0_2;
        }
    }
    return 0;
}
...
? func_80950690(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v1 != 2) {
        if (temp_v1 != 7) {
            ...
            temp_a0 = arg0->unk3B8;
            arg0->unk3D0 = (s16) (arg0->unk3D0 + 0x3E0);
            if (temp_a0 == 0) {
                phi_v1 = 0;
            } else {
                arg0->unk3B8 = (s16) (temp_a0 - 1);
                phi_v1 = arg0->unk3B8;
            }
            if (phi_v1 == 0) {
        ...
        if ((sp20 != 0) && (sp20->update != 0) && (temp_v0 != 0) && (temp_v0->update != 0) && ((sp24->unkA6C & 0x40) == 0)) {
            temp_a0_2 = arg0->unk3B8;
            if (temp_a0_2 == 0) {
                phi_v1_2 = 0;
            } else {
                arg0->unk3B8 = (s16) (temp_a0_2 - 1);
                phi_v1_2 = arg0->unk3B8;
            }
            if (phi_v1_2 == 0) {
                if (sp20 == arg0->unk268) {
                    arg0->unk268 = temp_v0;
                ...
                arg0->unk3B8 = Rand_S16Offset(0x3C, 0x3C);
            }
        }
    }
    func_8013D9C8(arg1, arg0 + 0x3D8, arg0 + 0x3D2, 3);
    return 0;
}
...
? func_80950804(Actor *arg0, GlobalContext *arg1) {
    ...
    sp44 = func_8094DF90(arg1, arg0->unk258);
    if ((func_8013AD6C(arg1) == 0) && (arg0->unk3C4 != 0)) {
        if ((sp44 != 0) && (sp44->unk138 != 0)) {
            if (((f32) arg0->unk3BA / (f32) arg0->unk3B8) <= 0.9f) {
                sp44->unk1A7 = (s8) arg0->unk261;
            } else {
                sp44->unk1A7 = 0;
            }
        }
...
? func_8095097C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp54 = 0;
    sp50 = 0;
    func_8013AF00((void *) &sp7C, 3, arg0->unk234->count + 3);
    temp_v1 = arg0 + 0x238;
    phi_v1 = temp_v1;
    if ((arg0->unk3A4 & 8) == 0) {
        temp_v0 = arg0 + 0x250;
        ...
        sp48 = temp_a1;
        sp40 = temp_v0;
        func_8013B6B0(arg0->unk234, temp_a1, temp_a2, arg0->unk24C, arg0->unk248, temp_v0, (void *) &sp7C, (Vec3f *) &sp58, (s16) (s32) arg0->unk3C4);
        func_8013B878(arg1, arg0->unk234, arg0->unk250, (Vec3f *) &sp58);
        arg0->unk3A4 = (u16) (arg0->unk3A4 | 8);
    ...
    sp3C = phi_v1;
    if (func_8013B6B0(arg0->unk234, sp48, sp44, arg0->unk24C, arg0->unk248, sp40, (void *) &sp7C, phi_v1, (s16) (s32) arg0->unk3C4) != 0) {
        arg0->unk3A4 = (u16) (arg0->unk3A4 | 0x10);
    } else {
...
void func_80950CDC(EnGm *this, GlobalContext *globalCtx) {
    ...
    this->unk3C4 = gSaveContext.unk_14 + gGameInfo->data[15];
    if ((func_80133038(globalCtx, &D_80951820, (struct_80133038_arg2 *) &sp20) == 0) || ((sp20 != this->unk258) && (func_80950280(this, (u8 *) globalCtx, &sp20) == 0))) {
    ...
    this->unk258 = sp20;
    this->unk268 = func_8094F074(this, globalCtx);
...
void func_80950DB8(EnGm *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, this->unk264, this->unk3E4, &this->unk25C) != 0) {
        func_8013AED4(&this->unk3A4, 3U, 7U);
        temp_v0 = func_8094DEE0((GlobalContext *) this, globalCtx, 4U, 0x262);
        if ((this->unk258 == 2) && (temp_v0 != 0) && (temp_v0->update != 0)) {
            this->unk268 = temp_v0;
            this->unk3B8 = Rand_S16Offset(0x3C, 0x3C);
        } else {
            this->unk3A4 &= 0xFFDF;
        }
        this->unk3A4 |= 0x200;
    ...
    func_8013D9C8(globalCtx, &this->unk3D8, &this->unk3D2, 3);
}
...
void func_80950F2C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp50.unk0 = (s32) D_80951E14.unk0;
    sp50.unk4 = (s32) D_80951E14.unk4;
    temp_a0 = arg1;
    sp50.unkC = (s32) D_80951E14.unkC;
    sp50.unk8 = (s32) D_80951E14.unk8;
    ...
    if (func_800EE29C(temp_a0, 0x20EU) != 0) {
        ...
        if ((temp_v1 & 0xFF) != arg0->unk259) {
            if (temp_v1 == 3) {
                sp2C = (s32) temp_v1;
                Audio_PlayActorSound2(arg0, 0x2892U);
            }
            arg0->unk259 = (u8) temp_t4->unk0;
            func_8094E054(arg0, arg1, (sp + ((u8) temp_t4->unk0 * 4))->unk50);
        }
        if ((arg0->unk259 == 3) && (temp_v0 = arg0->unk268, (temp_v0 != 0)) && (temp_v0->unk138 != 0)) {
...
void EnGm_Init(EnGm *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk144, &D_060078B0, NULL, &this->unk2B4, &this->unk32C, 0x14);
    this->unk3E8 = -1;
    func_8094E054((Actor *) this, globalCtx, 0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk190, (Actor *) this, &D_80951C5C);
    Collider_InitAndSetSphere(globalCtx, &this->unk1DC, (Actor *) this, &D_80951C88);
...
void EnGm_Update(EnGm *this, GlobalContext *globalCtx) {
    ...
    if (func_8094E0F8(this, globalCtx) == 0) {
        ...
        if (this->unk258 != 0) {
            ...
            func_8094E2D0(this);
            func_8094F2E8(this);
            func_8013C964((Actor *) this, globalCtx, this->unk3B4, 30.0f, 0, (s16) (this->unk3A4 & 7));
            temp_v1 = this->unk258;
...
s32 func_809513AC(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    if (((arg5->unk3A4 & 0x2000) != 0) && (phi_v0 < 9)) {
        temp_v1 = arg5 + (phi_v0 * 2);
        sp18 = temp_v1;
        arg4->y += (s32) (Math_SinS(temp_v1->unk3D8) * 200.0f);
        arg4->z += (s32) (Math_CosS(temp_v1->unk3D2) * 200.0f);
    }
    return 0;
}
...
void func_809514BC(void **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    temp_a0 = *arg0;
    if ((arg1 == 0xF) && ((arg4->unk3A4 & 0x800) != 0)) {
        temp_v1 = temp_a0->unk2B0;
        temp_a0->unk2B0 = (void *) (temp_v1 + 8);
        temp_v1->unk4 = &D_06007528;
...
void func_80951594(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    ...
    if (arg1 == 0x10) {
        func_8013AD9C((s16) (arg2->unk3BC + arg2->unk3C0 + 0x4000), (s16) (arg2->unk3BE + arg2->unk3C2 + arg2->shape.rot.y + 0x4000), arg2 + 0x290, arg2 + 0x2A8, phi_v1, phi_v0);
        SysMatrix_StatePop();
    ...
    if (arg1 == 9) {
        func_8013AD9C((s16) (arg2->unk3C0 + 0x4000), (s16) (arg2->unk3C2 + arg2->shape.rot.y + 0x4000), arg2 + 0x29C, arg2 + 0x2AE, phi_v1, phi_v0);
        SysMatrix_StatePop();
...
void EnGm_Draw(EnGm *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk258 != 0) && ((s32) this->unk262 >= 0)) {
        ...
        sp30 = temp_v0;
        sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80951E30 + (this->unk3CE * 4)));
        func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_809513AC, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_809514BC, func_80951594, (Actor *) this);
    }
}
