...
static ColliderJntSphElementInit D_80994170 = {
...
static void *D_809942B0 = {(void *)0x6007AA8, (void *)0x60082A8, (void *)0x60084A8, (void *)0x60082A8};
static void *D_809942C0 = {(void *)0x6000300, (void *)0x60027D8, (void *)0x60029D8, (void *)0x60027D8};
static InitChainEntry D_809942D0;                   /* unable to generate initializer */
...
typedef struct EnWf {
    ...
    /* 0x018E */ char pad18E[0x7E];                 /* maybe part of unk188[22]? */
    /* 0x020C */ Vec3s unk20C;                      /* inferred */
    /* 0x0212 */ char pad212[0x7E];                 /* maybe part of unk20C[22]? */
    /* 0x0290 */ void (*actionFunc)(EnWf *, GlobalContext *);
    /* 0x0294 */ u8 unk294;                         /* inferred */
    /* 0x0295 */ u8 unk295;                         /* inferred */
    /* 0x0296 */ u8 unk296;                         /* inferred */
    /* 0x0297 */ char pad297[0x1];                  /* maybe part of unk296[2]? */
    ...
    /* 0x02C4 */ char pad2C4[0x6C];                 /* maybe part of unk2B8[10]? */
    /* 0x0330 */ ColliderJntSph unk330;             /* inferred */
    /* 0x0350 */ ColliderJntSphElement unk350;      /* inferred */
    /* 0x0390 */ char pad390[0xC0];                 /* maybe part of unk350[4]? */
    /* 0x0450 */ ColliderCylinder unk450;           /* inferred */
    /* 0x049C */ ColliderCylinder unk49C;           /* inferred */
} EnWf;                                             /* size 0x4E8 */
...
void EnWf_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_809942D0);
    ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 70.0f);
    this->actor.shape.shadowAlpha = 0x96;
    Collider_InitAndSetJntSph(globalCtx, &this->unk330, &this->actor, &D_80994200, &this->unk350);
    Collider_InitAndSetCylinder(globalCtx, &this->unk450, &this->actor, &D_80994210);
    Collider_InitAndSetCylinder(globalCtx, &this->unk49C, &this->actor, &D_8099423C);
    ...
    if (this->unk295 != 0) {
        ...
        if (temp_v0_2 != 0) {
            ...
            this->actor.child->xzDistToPlayer = Actor_XZDistanceBetweenActors(&this->actor, temp_s1);
            temp_f2 = ((f32) phi_s0 * 0.5f) + 45.0f;
            this->unk2A4 = temp_f2;
            this->unk29C = (s16) (s32) (204800.0f / temp_f2);
            this->actor.shape.rot.y = Actor_YawBetweenActors(&this->actor, temp_s1);
    ...
    func_800BC154(globalCtx, temp_s0_2, &this->actor, 5U);
    phi_s1 = &D_809942B0;
    if (D_809942D8 == 0) {
        phi_s0_2 = &D_809942C0;
        do {
...
block_6:
    if ((func_8099408C(globalCtx, this) == 0) && (func_80990948(globalCtx, &this->actor, 0) == 0)) {
        ...
        if ((this->actor.xzDistToPlayer < 80.0f) && (sp24->unkADB != 0) && (phi_v1_2 >= 0x1F40)) {
            ...
            func_80991948(&this->actor);
            return;
        }
        this->unk2A0 += -1;
        if (this->unk2A0 == 0) {
            if (Actor_IsActorFacingLink(&this->actor, 0x1555) != 0) {
                if (Rand_ZeroOne() > 0.3f) {
                    func_80991438(&this->actor);
                } else {
                    func_80991948(&this->actor);
                }
            } else {
...
void func_8099149C(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (func_8099408C(temp_a2, this, temp_a2) == 0) {
        ...
        SkelAnime_FrameUpdateMatrix(&this->unk144);
        if (func_80990948(globalCtx, &this->actor, 0) == 0) {
            if (Actor_IsActorFacingLink(&this->actor, 0x11C7) == 0) {
                ...
                if ((func_800BC5EC(globalCtx, &this->actor) == 0) && ((Rand_ZeroOne() > 0.03f) || ((this->actor.xzDistToPlayer <= 80.0f) && (sp28 < 0x38E0)))) {
                    func_80991C04(&this->actor);
                } else if ((func_800BC5EC(globalCtx, &this->actor) != 0) && (Rand_ZeroOne() > 0.5f)) {
                    func_8099223C(&this->actor);
                } else {
                    func_80991948(&this->actor);
                }
            }
            ...
            func_80990E4C(&this->actor, globalCtx);
        }
...
void func_809919F4(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((func_8099408C(globalCtx, this) == 0) && (func_80990948(globalCtx, &this->actor, 0) == 0)) {
        ...
        if ((Math_CosS((s16) (sp26 - this->actor.shape.rot.y)) < -0.85f) && (func_800BC5EC(globalCtx, &this->actor) == 0) && (this->actor.xzDistToPlayer <= 80.0f)) {
            func_80991C04(&this->actor);
            return;
        }
        this->unk2A0 += -1;
        if (this->unk2A0 == 0) {
            if ((func_800BC5EC(globalCtx, &this->actor) != 0) && (Rand_ZeroOne() > 0.5f)) {
                func_8099223C(&this->actor);
                return;
            }
            func_80991200(this);
...
void func_80991C80(EnWf *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_v0_2;
    if (((temp_v0_2 != 0) && (func_800BC5B8(globalCtx, this) == 0) && ((Actor_IsActorFacingLink(&this->actor, 0x2000) == 0) || (this->actor.xzDistToPlayer >= 100.0f))) || (SkelAnime_FrameUpdateMatrix(sp20) != 0)) {
        if ((sp2C == 0) && (temp_v0_3 = this->unk2A0, (temp_v0_3 != 0))) {
            this->actor.shape.rot.y += (s32) (3276.0f * (1.5f + ((f32) (temp_v0_3 - 4) * 0.4f)));
            func_80990C6C(&this->actor, globalCtx, 1);
            this->unk2A0 += -1;
            return;
        }
        if ((Actor_IsActorFacingLink(&this->actor, 0x1554) == 0) && (sp2C == 0)) {
            func_80991200(this);
        ...
        if (Rand_ZeroOne() > 0.7f) {
            func_80992A74(&this->actor, globalCtx);
            return;
        }
        phi_v0 = (s32) sp2A;
        if ((s32) sp2A < 0) {
        ...
        if (phi_v0 < 0x2711) {
            ...
            func_80990948(globalCtx, &this->actor, 1);
            return;
        }
        func_80991948(&this->actor);
        // Duplicate return node #35. Try simplifying control flow for better match
...
void func_80992068(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->unk144) != 0) {
        if (Actor_IsActorFacingLink(&this->actor, 0x1554) == 0) {
            func_80991200(this);
            this->unk2A0 = (s32) Rand_ZeroFloat(5.0f) + 5;
            if (sp28 >= 0x32C9) {
                this->unk298 = 0x1E;
...
void func_809922B4(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->unk144) != 0) {
        if ((func_800BC5EC(globalCtx, &this->actor) == 0) && (temp_f0 = this->actor.xzDistToPlayer, (temp_f0 < 170.0f)) && (temp_f0 > 140.0f) && (Rand_ZeroOne() < 0.2f)) {
            func_80991438(&this->actor);
...
void func_809923E4(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2A0 == 0) {
        this = this;
        func_80990854(&temp_a0->actor, globalCtx);
        if (this->actor.colChkInfo.health == 0) {
            func_80992D6C(this, this);
            return;
        }
        func_80990948(globalCtx, &this->actor, 1, this);
...
void func_809924EC(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((SkelAnime_FrameUpdateMatrix(&this->unk144) != 0) && (temp_v1 = this->actor.wallYaw - this->actor.shape.rot.y, sp26 = temp_v1, (func_80990948(globalCtx, &this->actor, 0) == 0))) {
        if ((this->actor.bgCheckFlags & 8) != 0) {
            phi_v0 = (s32) temp_v1;
            if ((s32) temp_v1 < 0) {
                phi_v0 = -(s32) temp_v1;
...
block_13:
        if (func_8099408C(globalCtx, this) == 0) {
            if ((this->actor.xzDistToPlayer <= 80.0f) && (func_800BC5EC(globalCtx, &this->actor) == 0) && ((globalCtx->gameplayFrames & 7) != 0)) {
                func_80991C04(&this->actor);
                return;
            }
            if (Rand_ZeroOne() > 0.5f) {
...
void func_809926D0(Actor *arg0) {
    ...
    SkelAnime_ChangeAnim(arg0 + 0x144, &D_06004A90, -1.0f, (f32) SkelAnime_GetFrameCount(&D_06004A90.common), 0.0f, (u8) 2, -3.0f);
    arg0->unk2A0 = 0;
    arg0->speedXZ = 6.5f;
...
void func_809928CC(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->unk144) != 0) {
        ...
        if (func_800BE184(globalCtx, &this->actor, 0x42C80000, 0x2710, 0x4000, (s32) this->actor.shape.rot.y) != 0) {
        ...
        if ((Actor_IsActorFacingLink(&this->actor, 0x4000) != 0) && (this->actor.xzDistToPlayer < 60.0f) && (fabsf(this->actor.yDistToPlayer) < 50.0f)) {
    ...
    if (func_80990948(globalCtx, &this->actor, 0) == 0) {
        ...
        if (this->unk2A0 == 0) {
            ...
            if (phi_v1 >= 0x3A98) {
                ...
                this->actor.world.rot.y = this->actor.shape.rot.y;
                if ((this->actor.xzDistToPlayer <= 80.0f) && (sp2C = phi_v1, (func_800BC5EC(globalCtx, &this->actor) == 0)) && (((globalCtx->gameplayFrames & 3) == 0) || (phi_v1 < 0x38E0))) {
                    func_80991C04(&this->actor);
                } else {
                    func_80991438(&this->actor);
                }
...
void func_80993018(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((temp_a0_2 != 0) && (temp_a0_3 = this, (temp_a0_2->update != 0))) {
        ...
        this = this;
        temp_v0 = Actor_YawBetweenActors(temp_a0_4, &temp_a1->actor);
    ...
    if ((temp_a0 != 0) && (temp_a0->update != 0)) {
        if (func_80990EAC(this) != 0) {
            ...
            if (temp_a0_2->xzDistToPlayer < (80.0f + this->unk2A4)) {
                ...
                sp36 = Actor_YawBetweenActors(temp_a0_2, &this->actor);
...
void func_8099357C(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (this->unk295 != 0) {
        ...
        if ((temp_a1_2 != 0) && (temp_a1_2->update != 0)) {
            sp2E = Actor_YawBetweenActors(&this->actor, temp_a1_2);
            phi_a1 = sp2E;
            if (func_80990EAC(this) != 0) {
            ...
            this->actor.world.rot.y = this->actor.shape.rot.y;
            if (Actor_XZDistanceBetweenActors(&this->actor, this->actor.child) < (this->unk2A4 + 10.0f)) {
                func_80993148(this);
            }
            goto block_15;
        }
    ...
    sp28 = temp_a1;
    Math_SmoothStepToS(&this->actor.shape.rot.y, Actor_YawToPoint(&this->actor, &temp_a1->pos), 0xA, 0x800, (s16) 0x10);
    this->actor.world.rot.y = this->actor.shape.rot.y;
    if (Actor_XZDistanceToPoint(&this->actor, &temp_a1->pos) < 40.0f) {
        func_809910F0(this);
    }
block_15:
    if (this->unk2A2 == 0) {
...
void EnWf_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_8099386C(&this->actor, globalCtx);
    if (func_809923E4 != this->actionFunc) {
        func_809908E0(this);
    }
    this->actionFunc(this, globalCtx);
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 32.0f, 30.0f, 60.0f, 0x1DU);
    ...
    if (func_80990F50 != this->actionFunc) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &this->unk330.base);
    }
    temp_a1 = &this->unk450;
    if ((this->unk450.base.acFlags & 1) != 0) {
        ...
        CollisionCheck_SetAC(globalCtx, sp2C, &this->unk49C.base);
        CollisionCheck_SetAC(globalCtx, sp2C, &sp28->base);
    }
    if (func_809928CC == this->actionFunc) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, &this->unk330.base);
    }
    temp_v0_2 = this->unk330.base.atFlags;
    if ((temp_v0_2 & 1) != 0) {
        if ((temp_v0_2 & 4) == 0) {
            CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, &this->unk330.base);
        } else {
            func_80991FD8(this);
        }
    }
...
void func_80993E94(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if ((arg1 + &D_809942FC) == &D_80994302) {
        ...
        arg4->unk4E2 = (s16) (s32) sp20.x;
        arg4->unk4E4 = (s16) (s32) sp20.y;
        arg4->unk4E6 = (s16) (s32) sp20.z;
    }
}
...
void EnWf_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80990F50 != this->actionFunc) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80993E50, func_80993E94, &this->actor);
        func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk2B8, 0xA, this->unk2B0, this->unk2B4, this->unk2AC, (u8) (s32) this->unk296);
    }
}
