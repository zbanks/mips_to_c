typedef struct EnWf {
    ...
    /* 0x18E */ char pad_18E[0x7E];                 /* maybe part of unk_188[22]? */
    /* 0x20C */ Vec3s unk_20C;                      /* inferred */
    /* 0x212 */ char pad_212[0x7E];                 /* maybe part of unk_20C[22]? */
    /* 0x290 */ void (*actionFunc)(EnWf *, GlobalContext *);
    /* 0x294 */ u8 unk_294;                         /* inferred */
    /* 0x295 */ u8 unk_295;                         /* inferred */
    /* 0x296 */ u8 unk_296;                         /* inferred */
    /* 0x297 */ char pad_297[0x1];
    ...
    /* 0x2C4 */ char pad_2C4[0x6C];                 /* maybe part of unk_2B8[10]? */
    /* 0x330 */ ColliderJntSph unk_330;             /* inferred */
    /* 0x350 */ ColliderJntSphElement unk_350;      /* inferred */
    /* 0x390 */ char pad_390[0xC0];                 /* maybe part of unk_350[4]? */
    /* 0x450 */ ColliderCylinder unk_450;           /* inferred */
    /* 0x49C */ ColliderCylinder unk_49C;           /* inferred */
} EnWf;                                             /* size = 0x4E8 */
...
void EnWf_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk_330, (Actor *) this, &D_80994200, &this->unk_350);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_450, (Actor *) this, &D_80994210);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_49C, (Actor *) this, &D_8099423C);
    Math_Vec3f_Copy((Vec3f *) &this->actor.focus, (Vec3f *) &this->actor.world);
    temp_v0 = this->actor.shape.rot.x;
    if ((s32) temp_v0 <= 0) {
        this->unk_2A8 = 10000.0f;
    } else {
        this->unk_2A8 = (f32) temp_v0 * 40.0f;
    }
    ...
    if (this->unk_295 != 0) {
        ...
        if (temp_v0_2 != 0) {
            ...
            this->unk_2A4 = temp_f2;
            this->unk_29C = (s16) (s32) (204800.0f / temp_f2);
    ...
    if (this->actor.params == 0) {
        SkelAnime_InitSV(globalCtx, &this->unk_144, &D_060095D0, &D_0600A3CC, &this->unk_188, &this->unk_20C, 0x16);
    ...
    if (D_809942D8 == 0) {
        ...
        do {
            *phi_s1 = Lib_SegmentedToVirtual(*phi_s1);
            ...
            temp_s0_3->unk_-4 = Lib_SegmentedToVirtual(*phi_s0_2);
            phi_s1 += 4;
            phi_s0_2 = temp_s0_3;
        } while (temp_s0_3 != D_809942D0);
        D_809942D8 = 1;
    }
    this->unk_2A2 = (u16) (u32) Rand_ZeroFloat(96.0f);
}

void EnWf_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnWf *this = (EnWf *) thisx;
    Collider_DestroyJntSph(globalCtx, &this->unk_330);
    Collider_DestroyCylinder(globalCtx, &this->unk_450);
    Collider_DestroyCylinder(globalCtx, &this->unk_49C);
}
...
void func_809908E0(EnWf *arg0) {
    ...
    temp_v0 = arg0->unk_294;
    temp_t6 = temp_v0 + 1;
    if (temp_v0 != 0) {
        arg0->unk_294 = temp_t6;
        if ((temp_t6 & 0xFF) == 4) {
            arg0->unk_294 = 0;
            return;
        }
...
s32 func_80990948(GlobalContext *arg0, Actor *arg1, s16 arg2) {
    ...
    temp_v0_2 = arg1->unk_295;
    if (((temp_v0_2 == 0) || ((temp_v0_2 == 1) && (temp_v0_3 = arg1->child, (temp_v0_3 != 0)) && (temp_v0_3->update != 0))) && (arg1->xzDistToPlayer > 160.0f) && (arg1->unk_2A8 < Actor_XZDistanceToPoint(arg1, arg1 + 8))) {
        func_80993524(arg1);
        return 1;
    }
...
s32 func_80990EAC(EnWf *arg0) {
    if ((s32) arg0->actor.child->unk_148 < 0xC8) {
        return 1;
    }
    return 0;
}
...
void func_80990F0C(EnWf *arg0) {
    arg0->unk_450.base.acFlags &= 0xFFFE;
...
void func_80991200(EnWf *arg0) {
    ...
    temp_a3 = arg0;
    temp_a3->unk_450.base.acFlags |= 1;
    arg0 = temp_a3;
    SkelAnime_ChangeAnimTransitionRepeat(temp_a3 + 0x144, &D_0600A3CC, -4.0f);
    arg0->unk_2A0 = (s32) Rand_ZeroFloat(10.0f) + 2;
...
void func_809919F4(EnWf *this, GlobalContext *globalCtx) {
    ...
    Math_ScaledStepToS(&this->actor.shape.rot.y, (s16) (this->actor.yawTowardsPlayer + this->unk_29A), 0x9C4);
    if ((func_8099408C(globalCtx, this) == 0) && (func_80990948(globalCtx, (Actor *) this, 0) == 0)) {
        temp_a0 = this->unk_29A;
        this->actor.world.rot.y = this->actor.shape.rot.y;
...
void func_80991C80(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (((temp_f0 >= 9.0f) && (temp_f0 < 13.0f)) || ((temp_f0 >= 17.0f) && (temp_f0 < 20.0f))) {
        if ((this->unk_330.base.atFlags & 1) == 0) {
            Audio_PlayActorSound2((Actor *) this, 0x383FU);
        }
        this->unk_330.base.atFlags |= 1;
    } else {
        this->unk_330.base.atFlags &= 0xFFFE;
    }
    temp_a0 = &this->unk_144;
    sp20 = temp_a0;
    ...
    if (((temp_v0_2 != 0) && (func_800BC5B8(globalCtx, this) == 0) && ((Actor_IsActorFacingLink((Actor *) this, 0x2000) == 0) || (this->actor.xzDistToPlayer >= 100.0f))) || (SkelAnime_FrameUpdateMatrix(sp20) != 0)) {
        if ((sp2C == 0) && (temp_v0_3 = this->unk_2A0, (temp_v0_3 != 0))) {
...
void func_8099223C(Actor *arg0) {
    ...
    temp_a3 = arg0;
    temp_a3->unk_461 = (u8) (temp_a3->unk_461 & 0xFFFE);
    arg0 = temp_a3;
...
void func_809924EC(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((SkelAnime_FrameUpdateMatrix(&this->unk_144) != 0) && (temp_v1 = this->actor.wallYaw - this->actor.shape.rot.y, sp26 = temp_v1, (func_80990948(globalCtx, (Actor *) this, 0) == 0))) {
        if ((this->actor.bgCheckFlags & 8) != 0) {
            phi_v0 = (s32) temp_v1;
            if ((s32) temp_v1 < 0) {
                phi_v0 = -(s32) temp_v1;
...
void func_80992784(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((SkelAnime_FrameUpdateMatrix(&this->unk_144) != 0) && ((this->actor.bgCheckFlags & 3) != 0)) {
...
void func_80992A74(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_461 = (u8) (arg0->unk_461 | 1);
    SkelAnime_ChangeAnimTransitionRepeat(arg0 + 0x144, &D_06005700, -4.0f);
    temp_f0 = Math_SinS((s16) ((arg1->actorCtx.actorList[2].first->unk_BE + arg0->unk_29A) - arg0->yawTowardsPlayer));
    if (temp_f0 > 0.0f) {
        arg0->unk_29A = 0x3E80;
...
void func_80992B8C(EnWf *this, GlobalContext *globalCtx) {
    ...
    sp24 = globalCtx->actorCtx.actorList[2].first;
    Math_ScaledStepToS(&this->actor.shape.rot.y, (s16) (this->actor.yawTowardsPlayer + this->unk_29A), 0x7D0);
    if ((this->actor.bgCheckFlags & 8) != 0) {
        temp_v1 = this->unk_29A;
...
void func_80993018(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((temp_a0_2 != 0) && (temp_a0_3 = this, (temp_a0_2->update != 0))) {
        ...
        temp_a1 = this;
        if (temp_a0_4->xzDistToPlayer < (80.0f + this->unk_2A4)) {
...
void func_80993194(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((temp_a0 != 0) && (temp_a0->update != 0)) {
        if (func_80990EAC(this) != 0) {
            ...
            temp_a0_2 = this->actor.child;
            if (temp_a0_2->xzDistToPlayer < (80.0f + this->unk_2A4)) {
                func_80993350(this);
            } else {
                sp36 = Actor_YawBetweenActors(temp_a0_2, (Actor *) this);
                temp_v0 = Math_SmoothStepToS(&sp36, (s16) (this->actor.child->yawTowardsPlayer + 0x8000), 0xA, this->unk_29C, (s16) 0x10);
                sp34 = temp_v0;
...
void func_809933A0(EnWf *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 != 0) && (temp_v0->update != 0)) {
        if (func_80990EAC(this) != 0) {
            ...
            Math_ScaledStepToS(&sp2E, this->actor.child->yawTowardsPlayer, (s16) ((s32) this->unk_29C >> 2));
...
void func_8099357C(EnWf *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_295 != 0) {
        ...
        if ((temp_a1_2 != 0) && (temp_a1_2->update != 0)) {
            ...
            this->actor.world.rot.y = this->actor.shape.rot.y;
            if (Actor_XZDistanceBetweenActors((Actor *) this, this->actor.child) < (this->unk_2A4 + 10.0f)) {
                func_80993148(this);
            }
            goto block_15;
        }
...
void func_80993738(EnWf *arg0, GlobalContext *arg1) {
    ...
    if ((func_80991280 == temp_v0) && (temp_v1 = arg0->unk_298, (temp_v1 != 0))) {
        temp_a0 = temp_v1 * 0x1068;
        arg0 = arg0;
        arg0->unk_29E = (s16) (s32) (Math_SinS(temp_a0) * 8920.0f);
        return;
    }
...
void func_8099386C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0_2 = arg0->unk_461 & 2;
    if ((temp_v0_2 != 0) || ((arg0->unk_4AD & 2) != 0)) {
        if (((temp_v0_2 == 0) && ((arg0->unk_4AD & 2) != 0)) || (Actor_IsActorFacingLink(arg0, 0x4A38) == 0)) {
...
void EnWf_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80990F50 != this->actionFunc) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_330);
    }
    temp_a1 = &this->unk_450;
    if ((this->unk_450.base.acFlags & 1) != 0) {
        sp2C = &globalCtx->colChkCtx;
        sp28 = temp_a1;
        Collider_UpdateCylinder((Actor *) this, temp_a1);
        CollisionCheck_SetAC(globalCtx, sp2C, (Collider *) &this->unk_49C);
        CollisionCheck_SetAC(globalCtx, sp2C, (Collider *) sp28);
    }
    if (func_809928CC == this->actionFunc) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_330);
    }
    temp_v0_2 = this->unk_330.base.atFlags;
    if ((temp_v0_2 & 1) != 0) {
        if ((temp_v0_2 & 4) == 0) {
            CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_330);
        } else {
            func_80991FD8(this);
        }
    }
    ...
    if (this->unk_2AC > 0.0f) {
        if (this->unk_296 != 0xA) {
            ...
            temp_f0 = (this->unk_2AC + 1.0f) * 0.375f;
            this->unk_2B0 = temp_f0;
            if (temp_f0 > 0.75f) {
                this->unk_2B0 = 0.75f;
                return;
            }
        ...
        if (Math_StepToF(&this->unk_2B4, 0.75f, 0.01875f) == 0) {
...
void EnWf_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80990F50 != this->actionFunc) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80993E50, func_80993E94, (Actor *) this);
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk_2B8, 0xA, this->unk_2B0, this->unk_2B4, this->unk_2AC, (u8) (s32) this->unk_296);
    }
}
