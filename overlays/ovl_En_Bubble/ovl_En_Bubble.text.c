typedef struct EnBubble {
    ...
    /* 0x1A8 */ char pad1A8[0x5A];                  /* maybe part of unk168[2]? */
    /* 0x202 */ s16 unk202;                         /* inferred */
    /* 0x204 */ char pad204[0x4];                   /* maybe part of unk202[3]? */
    ...
    /* 0x23C */ char pad23C[0x1C];                  /* maybe part of unk238[8]? */
} EnBubble;                                         /* size = 0x258 */
...
s16 func_8089F660(EnBubble *arg0, GlobalContext *arg1) {
    ...
    sp90.unk0 = (s32) D_808A0764.unk0;
    sp90.unk4 = (s32) D_808A0764.unk4;
    sp90.unk8 = (s32) D_808A0764.unk8;
...
void func_808A005C(EnBubble *arg0) {
    ...
    temp_v0_2->unk8 = (s16) (s32) sp1C;
    temp_v0_2->unkA = (s16) (s32) sp20;
    temp_v0_2->unkC = (s16) (s32) sp24;
...
void EnBubble_Init(EnBubble *this, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_808A0748, &this->unk168);
