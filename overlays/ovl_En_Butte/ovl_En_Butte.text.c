typedef struct EnButte {
    ...
    /* 0x1EE */ char pad1EE[0x2A];                  /* maybe part of unk1E8[8]? */
    /* 0x218 */ Vec3s unk218;                       /* inferred */
    /* 0x21E */ char pad21E[0x2A];                  /* maybe part of unk218[8]? */
    /* 0x248 */ void (*actionFunc)(EnButte *, GlobalContext *);
    /* 0x24C */ s16 unk24C;                         /* inferred */
    /* 0x24E */ u8 unk24E;                          /* inferred */
    /* 0x24F */ u8 unk24F;                          /* inferred */
    /* 0x250 */ u8 unk250;                          /* inferred */
    /* 0x251 */ char pad251[0x1];
...
void EnButte_Init(EnButte *this, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, temp_a1_2, (Actor *) this, &D_8091D2F4, &this->unk164);
...
void func_8091C794(EnButte *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk24E != 0) && ((phi_f0 < sp40) || ((s32) this->unk24C < 4))) {
        if (Math_ScaledStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw((Vec3f *) &this->actor.world, (Vec3f *) &this->actor.home), sp4C->unk10) == 0) {
            sp38 = 0.5f;
        }
    } else {
        temp_v1 = this->unk24F;
