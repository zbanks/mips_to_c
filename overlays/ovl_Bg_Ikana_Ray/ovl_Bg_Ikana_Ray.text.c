...
void BgIkanaRay_Init(BgIkanaRay *this, GlobalContext *globalCtx) {
...
void BgIkanaRay_Destroy(BgIkanaRay *this, GlobalContext *globalCtx) {
    BgIkanaRay *this = (BgIkanaRay *) thisx;
...
void BgIkanaRay_Update(BgIkanaRay *this, GlobalContext *globalCtx) {
    BgIkanaRay *this = (BgIkanaRay *) thisx;
    this->update(this, globalCtx);
}

void BgIkanaRay_Draw(BgIkanaRay *this, GlobalContext *globalCtx) {
    BgIkanaRay *this = (BgIkanaRay *) thisx;
