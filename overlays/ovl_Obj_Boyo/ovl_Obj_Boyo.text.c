...
void ObjBoyo_Init(ObjBoyo *this, GlobalContext *globalCtx) {
...
void ObjBoyo_Destroy(ObjBoyo *this, GlobalContext *globalCtx2) {
    ObjBoyo *this = (ObjBoyo *) thisx;
...
void ObjBoyo_Update(ObjBoyo *this, GlobalContext *globalCtx2) {
    s32 sp30;
...
void ObjBoyo_Draw(ObjBoyo *this, GlobalContext *globalCtx) {
    ObjBoyo *this = (ObjBoyo *) thisx;
