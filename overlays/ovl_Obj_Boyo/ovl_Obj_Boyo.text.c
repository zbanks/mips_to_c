...
static InitChainEntry D_809A619C;                   /* unable to generate initializer */
static s16 D_809A61B4;                              /* unable to generate initializer */
...
void ObjBoyo_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_809A619C);
    temp_a1 = &this->collider;
    sp20 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_809A6170);
...
void func_809A5DE0(Actor *arg0, Actor *arg1) {
    arg1->unk2F0 = 30.0f;
    arg1->unk2F4 = Actor_YawBetweenActors(arg0, arg1);
}
...
void ObjBoyo_Update(Actor *thisx, GlobalContext *globalCtx2) {
    ...
    sp20 = temp_a2;
    sp24 = temp_a1;
    CollisionCheck_SetOC(globalCtx2, temp_a1, &temp_a2->base);
    if (this->actor.xzDistToPlayer < 2000.0f) {
        CollisionCheck_SetAC(globalCtx2, temp_a1, &temp_a2->base);
    }
}
