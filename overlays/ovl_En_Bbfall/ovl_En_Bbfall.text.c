typedef struct EnBbfall {
    ...
    /* 0x24C */ u8 unk_24C;                         /* inferred */
    /* 0x24D */ u8 unk_24D;                         /* inferred */
    /* 0x24E */ char pad_24E[0x1];
    ...
    /* 0x274 */ Vec3f unk_274;                      /* inferred */
    /* 0x280 */ char pad_280[0x30];                 /* maybe part of unk_274[5]? */
    /* 0x2B0 */ Vec3f unk_2B0;                      /* inferred */
    /* 0x2BC */ char pad_2BC[0x30];                 /* maybe part of unk_2B0[5]? */
    /* 0x2EC */ Vec3f unk_2EC;                      /* inferred */
    /* 0x2F8 */ char pad_2F8[0x8C];                 /* maybe part of unk_2EC[12]? */
    /* 0x384 */ ColliderJntSph unk_384;             /* inferred */
    /* 0x3A4 */ ColliderJntSphElement unk_3A4;      /* inferred */
    /* 0x3E4 */ char pad_3E4[0x80];                 /* maybe part of unk_3A4[3]? */
} EnBbfall;                                         /* size = 0x464 */
...
void EnBbfall_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk_384, (Actor *) this, &D_808C0D9C, &this->unk_3A4);
    ...
    phi_v1 = 0;
    do {
        temp_v0 = this->unk_384.elements + phi_v1;
        temp_v1 = phi_v1 + 0x40;
...
void EnBbfall_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnBbfall *this = (EnBbfall *) thisx;
    Collider_DestroyJntSph(globalCtx, &this->unk_384);
}
...
void func_808BF5AC(Actor *arg0) {
    ...
    arg0->unk_3A0->unk_4 = 0;
    temp_v0 = arg0->unk_3A0;
...
void func_808BF5E0(EnBbfall *arg0) {
    ...
    arg0->unk_384.base.atFlags &= 0xFFFE;
    arg0->unk_384.base.acFlags &= 0xFFFE;
    arg0->unk_384.base.ocFlags1 &= 0xFFFE;
    arg0->unk_24C = 0xFF;
    arg0->unk_254 = 0.8f;
    arg0->unk_258 = 1.0f;
    temp_s4 = arg0 + 0x24;
...
void func_808BF7A0(Actor *arg0) {
    ...
    arg0->unk_394 = (u8) (arg0->unk_394 | 1);
    arg0->unk_395 = (u8) (arg0->unk_395 | 1);
    arg0->unk_396 = (u8) (arg0->unk_396 | 1);
    arg0->gravity = -1.0f;
...
void func_808C01E0(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_395;
    if ((temp_v0 & 2) != 0) {
        arg0->unk_395 = (u8) (temp_v0 & 0xFFFD);
        temp_t0 = arg0->unk_394 & 0xFFF9;
        arg0->unk_394 = temp_t0;
        arg0->unk_394 = (u8) (temp_t0 & 0xFFFE);
        if ((arg0->unk_24F != 0xA) || ((*arg0->unk_3A0->unk_24 & 0xDB0B3) == 0)) {
            ...
            if (arg0->colChkInfo.damageEffect == 4) {
                ...
                arg0->unk_24F = 0x14U;
                arg0->unk_260 = 0.4f;
                Actor_Spawn(&arg1->actorCtx, arg1, 0xA2, (f32) temp_v0_2->unk_E, (f32) temp_v0_2->unk_10, (f32) temp_v0_2->unk_12, (s16) 0, (s16) 0, (s16) 0, (s16) 3);
                return;
            }
...
void EnBbfall_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808BFE58 != this->actionFunc) {
        ...
        temp_s0 = &this->unk_268;
        Math_Vec3f_Copy(&this->unk_274, temp_s0);
        Math_Vec3f_Copy(temp_s0, (Vec3f *) &this->actor.world);
        this->unk_268.y += 15.0f;
        temp_f0 = this->unk_258;
        this->unk_268.y -= 47.0f * this->unk_254;
        ...
        if (0 != 0x80) {
            do {
                ...
                temp_v0 = this->unk_384.elements + phi_a0;
                temp_v0->unk_36 = phi_f18;
                temp_a0 = phi_a0 + 0x40;
                temp_v0_2 = temp_v0 + 0x30;
                temp_v1_2 = phi_v1 + 0x18;
                temp_v0_2->unk_0 = (s16) (s32) phi_v1->unk_268.x;
                temp_f18_2 = (s32) (30.0f * temp_f0_2);
                temp_v0_2->unk_2 = (s16) (s32) (temp_v1_2->unk_254 + (47.0f * phi_f0));
                temp_v0_2->unk_4 = (s16) (s32) temp_v1_2->unk_258;
        ...
        temp_v0_3 = this->unk_384.elements + phi_a0_2;
        temp_v0_3->unk_36 = phi_f18_2;
        temp_v1_3 = phi_v1_2 + 0x18;
        temp_v0_4 = temp_v0_3 + 0x30;
        temp_v0_4->unk_0 = (s16) (s32) phi_v1_2->unk_268.x;
        temp_v0_4->unk_2 = (s16) (s32) (temp_v1_3->unk_254 + (47.0f * phi_f0_2));
        temp_v0_4->unk_4 = (s16) (s32) temp_v1_3->unk_258;
        temp_v0_5 = this->unk_384.elements;
        ...
        Math_Vec3s_ToVec3f((Vec3f *) &this->actor.focus, (Vec3s *) &this->unk_384.elements->dim.worldSphere);
        if ((this->unk_384.base.atFlags & 1) != 0) {
            this->actor.flags |= 0x1000000;
            CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_384);
        }
        if ((this->unk_384.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_384);
        }
        if ((this->unk_384.base.ocFlags1 & 1) != 0) {
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_384);
        }
        if (this->unk_25C > 0.0f) {
            if (this->unk_24F != 0xA) {
                Math_StepToF(&this->unk_25C, 0.0f, 0.05f);
                temp_f0_3 = (this->unk_25C + 1.0f) * 0.2f;
                this->unk_260 = temp_f0_3;
                if (temp_f0_3 > 0.4f) {
                    this->unk_260 = 0.4f;
                    return;
                }
                this->unk_260 = this->unk_260;
                return;
            }
            if (Math_StepToF(&this->unk_264, 0.4f, 0.01f) == 0) {
...
void func_808C080C(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (*temp_v1_2 != -1) {
        ...
        temp_v0_4->mf[3][0] = (arg4 + (*temp_v1_2 * 0xC))->unk_2B0;
        temp_v0_4->mf[3][1] = (arg4 + (*temp_v1_2 * 0xC))->unk_2B4;
        temp_v0_4->mf[3][2] = (arg4 + (*temp_v1_2 * 0xC))->unk_2B8;
