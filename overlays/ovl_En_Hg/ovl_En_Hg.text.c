...
void EnHg_Init(EnHg *this, GlobalContext *globalCtx) {
...
void EnHg_Destroy(EnHg *this, GlobalContext *globalCtx) {
    EnHg *this = (EnHg *) thisx;
...
void EnHg_Update(EnHg *this, GlobalContext *globalCtx) {
    EnHg *this = (EnHg *) thisx;
...
void EnHg_Draw(EnHg *this, GlobalContext *globalCtx) {
    Gfx *temp_v0;
    Gfx *temp_v0_2;
