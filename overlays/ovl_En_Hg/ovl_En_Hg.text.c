...
void EnHg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_s2, &this->actor, &D_80BCFFB0);
...
void func_80BCF398(EnHg *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.colChkInfo.health == 1) {
        ...
        if ((gSaveContext.sceneSetupIndex == 0) && (globalCtx->csCtx.unk_12 == 0) && ((temp_v0 = globalCtx->csCtx.frames, (temp_v0 == 0x14)) || (temp_v0 == 0x3C))) {
            Audio_PlayActorSound2(&this->actor, 0x3AB8U);
        }
    }
}
...
void func_80BCF4AC(EnHg *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0->unkA70 * 0x10) >= 0) {
        ...
        if (func_80152498(&globalCtx->msgCtx) == 0) {
            ...
            sp2C = temp_a1;
            if ((Math_Vec3f_DistXZ(&this->actor.world.pos, &temp_a1->pos) > 200.0f) && (Math_Vec3f_DistXZ(&sp34->world.pos, &temp_a1->pos) > 200.0f)) {
                func_80BCF5F0(this);
            }
        }
    }
...
void func_80BCF634(EnHg *this, GlobalContext *globalCtx) {
    if (Math_Vec3f_DistXZ(&globalCtx->actorCtx.actorList[2].first->world.pos, &this->actor.home.pos) < 200.0f) {
        func_80BCF468(this);
    }
}
...
void func_80BCF778(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->colChkInfo.health == 1) && ((temp_v0 = arg0->unk1D4, (func_80BCF4AC == temp_v0)) || (func_80BCF6D0 == temp_v0) || (func_80BCF634 == temp_v0))) {
...
void func_80BCFC0C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->colChkInfo.health == 1) && !(fabsf(arg0->yDistToPlayer) >= 80.0f)) {
        if ((arg1->actorCtx.actorList[2].first->unkA70 * 0x10) < 0) {
            if (D_80BD00C8 == 0) {
                arg0 = arg0;
                play_sound(0x4807U);
            }
        ...
        if ((phi_a2->xzDistToPlayer < 60.0f) && (fabsf(phi_a2->yDistToPlayer) < 40.0f) && (temp_v0 = phi_a2->unk1D4, (func_80BCF8A0 != temp_v0)) && (func_80BCF95C != temp_v0)) {
...
void EnHg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnHg_OverrideLimbDraw, EnHg_PostLimbDraw, &this->actor);
