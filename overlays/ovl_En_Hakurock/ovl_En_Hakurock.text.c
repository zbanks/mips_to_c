typedef struct EnHakurock {
    /* 0x000 */ Actor actor;
    /* 0x144 */ void (*actionFunc)(EnHakurock *, GlobalContext *);
    /* 0x148 */ s32 unk_148;                        /* inferred */
    /* 0x14C */ ColliderCylinder unk_14C;           /* inferred */
} EnHakurock;                                       /* size = 0x198 */

struct _mips2c_stack_EnHakurock_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnHakurock_Init {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnHakurock_Update {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ CollisionCheckContext *sp34;         /* inferred */
    /* 0x38 */ char pad_38[0x8];
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80B21BE0 {
...
struct _mips2c_stack_func_80B21EA4 {
...
struct _mips2c_stack_func_80B21FFC {};              /* size 0x0 */

struct _mips2c_stack_func_80B22040 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B220A8 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B221E8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B222AC {
    /* 0x00 */ char pad_0[0x22];
    /* 0x22 */ s16 sp22;                            /* inferred */
    /* 0x24 */ char pad_24[0x4];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80B2242C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B224C0 {};              /* size 0x0 */

struct _mips2c_stack_func_80B22500 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B226AC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B22750 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B228F4 {
    /* 0x00 */ char pad_0[0x18];
...
struct _mips2c_stack_func_80B229A4 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Gfx *sp24;                           /* inferred */
    /* 0x28 */ char pad_28[0x8];
};                                                  /* size = 0x30 */

void func_80B21BE0(void *arg0, Vec3f *arg1, s32 arg2); /* static */
...
void func_80B228F4(s32 arg0, GraphicsContext **arg1); /* static */
void func_80B229A4(s32 arg0, GraphicsContext **arg1); /* static */
extern ? D_06011100;
extern ? D_06011178;
...
void EnHakurock_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk_14C, (Actor *) this, &D_80B22A80);
    CollisionCheck_SetInfo(&this->actor.colChkInfo, NULL, &D_80B22AAC);
    if (this->actor.params == 1) {
        this->actor.gravity = -1.5f;
    } else {
        this->unk_14C.base.ocFlags1 &= 0xFFFB;
...
loop_1:
    ...
    if ((s32) phi_v0->unk_A10 < 0) {
        ...
        if ((arg2 == 1) || (arg2 == 3)) {
            temp_s0[3].x = (Rand_ZeroFloat(5.0f) + 25.0f) * 0.0012f;
            temp_s0->x = ((Rand_ZeroFloat(2.0f) + 9.0f) * temp_s0[1].x) + arg1->x;
            temp_s0->y = ((Rand_ZeroFloat(2.0f) + 3.0f) * temp_s0[1].y) + arg1->y;
            temp_f18 = Rand_ZeroFloat(2.0f) + 9.0f;
            temp_s0->unk_1A = 1;
            temp_s0->z = (temp_f18 * temp_s0[1].z) + arg1->z;
        } else {
            temp_s0[3].x = (Rand_ZeroFloat(5.0f) + 18.0f) * 0.0001f;
            temp_s0->x = ((Rand_ZeroFloat(2.0f) + 3.0f) * temp_s0[1].x) + arg1->x;
            temp_s0->y = ((Rand_ZeroFloat(3.0f) + 1.0f) * temp_s0[1].y) + arg1->y;
            temp_f8 = Rand_ZeroFloat(2.0f) + 3.0f;
            temp_s0->unk_1A = 0;
            temp_s0->z = (temp_f8 * temp_s0[1].z) + arg1->z;
        }
        temp_s0->unk_1C = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_1E = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_20 = (s16) (Rand_Next() >> 0x10);
        temp_s0->unk_18 = 0x28;
        return;
    }
    temp_v1 = phi_v1 + 0x28;
...
void func_80B21EA4(EnHakurock *arg0, s32 arg1) {
    ...
    Math_Vec3f_Copy((Vec3f *) &sp4C, arg0 + 0x24);
    ...
    if (phi_s0_3 < 3) {
        ...
        do {
            ...
            if (phi_s5 > 0) {
                do {
                    func_80B21BE0(arg0->actor.parent, (Vec3f *) &sp4C, arg1);
...
void func_80B21FFC(EnHakurock *arg0) {
    ...
    arg0->unk_14C.base.atFlags &= -3;
    arg0->unk_14C.base.ocFlags1 &= -3;
...
void func_80B220A8(Actor *arg0) {
    ...
    arg0[1].flags = 0xA;
    arg0[1].focus.rot.x = (s16) (s32) (arg0->scale.x * 2500.0f);
    temp_v1 = arg0[1].focus.rot.x;
    arg0[1].focus.rot.z = (s16) -(s32) temp_v1;
    arg0[1].focus.rot.y = temp_v1 * 2;
    Math_Vec3f_Copy(&arg0->prevPos, (Vec3f *) &arg0->world);
    arg0->unk_144 = func_80B221E8;
}
...
void func_80B221E8(EnHakurock *this, GlobalContext *globalCtx) {
    ...
    if (((this->unk_14C.base.atFlags & 2) != 0) || ((this->unk_148 == 0) && ((this->unk_14C.base.ocFlags1 & 2) != 0)) || (((this->actor.bgCheckFlags & 1) != 0) && (this->actor.velocity.y < 0.0f))) {
...
void func_80B222AC(Actor *arg0, void *arg1) {
    ...
    sp22 = (Rand_Next() >> 0x13) + temp_s1->unk_BE;
    arg0->shape.rot.y = (s16) (Rand_Next() >> 0x10);
    arg0->world.pos.x = (Math_SinS(sp22) * 600.0f) + temp_s1->unk_24;
    arg0->world.pos.y = temp_s1->unk_28 + 700.0f;
    temp_f8 = Math_CosS(sp22) * 600.0f;
    arg0->shape.shadowScale = 5.0f;
    arg0->velocity.y = -10.0f;
    arg0->world.pos.z = temp_f8 + temp_s1->unk_2C;
    Actor_SetScale(arg0, (Rand_ZeroFloat(5.0f) + 17.0f) * 0.01f);
    arg0->scale.x *= 0.6f;
    arg0->scale.z *= 0.6f;
    arg0[1].focus.rot.x = (s16) (s32) (arg0->scale.x * 150.0f);
    arg0[1].focus.rot.z = (s16) (s32) (arg0->scale.y * -750.0f);
    arg0[1].focus.rot.y = (s32) arg0[1].focus.rot.z * -2;
    Math_Vec3f_Copy(&arg0->prevPos, (Vec3f *) &arg0->world);
    arg0->params = 2;
    arg0->unk_144 = func_80B2242C;
}

void func_80B2242C(EnHakurock *this, GlobalContext *globalCtx) {
    if (((this->unk_14C.base.ocFlags1 & 2) != 0) && (this->actor.parent == this->unk_14C.base.oc)) {
    ...
    if ((this->actor.bgCheckFlags & 1) != 0) {
        ...
        Audio_PlayActorSound2((Actor *) this, 0x2947U);
        func_80B224C0(this);
    }
}
...
void func_80B22500(EnHakurock *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_14C.base.ocFlags1 & 2) != 0) {
        temp_v0_2 = this->unk_14C.base.oc;
        ...
        if ((globalCtx->actorCtx.actorList[2].first == temp_v0_2) && ((globalCtx->actorCtx.actorList[2].first[8].targetArrowOffset & 0x81000) != 0) && (globalCtx->actorCtx.actorList[2].first->unk_AD0 > 8.0f)) {
            globalCtx->actorCtx.actorList[2].first->unk_AD0 = -5.0f;
            globalCtx->actorCtx.actorList[2].first[8].shape.feetPos[1].z = -5.0f;
            temp_v0_3 = globalCtx->actorCtx.actorList[2].first->world.rot.y;
            globalCtx->actorCtx.actorList[2].first->unk_B8C = 4;
            globalCtx->actorCtx.actorList[2].first[8].colChkInfo.cylYShift = temp_v0_3;
            ...
            globalCtx->actorCtx.actorList[2].first[8].projectedPos.x += -5.0f * 0.05f;
            return;
        }
...
void func_80B226AC(Actor *arg0) {
    ...
    arg0->scale.y = 0.5f;
    arg0[1].focus.rot.x = (s16) (s32) (arg0->scale.x * 270.0f);
    arg0[1].flags = 0;
    arg0->unk_144 = func_80B22750;
    arg0->shape.shadowScale = 0.0f;
    arg0[1].focus.rot.z = (s16) (s32) (0.5f * -750.0f);
    arg0[1].focus.rot.y = (s32) arg0[1].focus.rot.z * -2;
}
...
void EnHakurock_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 1) || (temp_v0 == 2)) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 30.0f, (f32) this->unk_14C.dim.radius, 0.0f, 0x85U);
        temp_s0_2 = &this->unk_14C;
        ...
        sp34 = temp_a1_2;
        CollisionCheck_SetAT(globalCtx, temp_a1_2, (Collider *) temp_s0_2);
