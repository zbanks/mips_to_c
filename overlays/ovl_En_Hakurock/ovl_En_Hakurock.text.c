...
void EnHakurock_Init(EnHakurock *this, GlobalContext *globalCtx) {
    EnHakurock *this = (EnHakurock *) thisx;
    ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 52.0f);
    Collider_InitAndSetCylinder(globalCtx, &this->unk14C, (Actor *) this, &D_80B22A80);
...
void EnHakurock_Destroy(EnHakurock *this, GlobalContext *globalCtx) {
    EnHakurock *this = (EnHakurock *) thisx;
...
void EnHakurock_Update(EnHakurock *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 1) || (temp_v0 == 2)) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 30.0f, (f32) this->unk14C.dim.radius, 0.0f, 0x85U);
