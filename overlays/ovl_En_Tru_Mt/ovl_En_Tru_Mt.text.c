...
typedef struct EnTruMt {
    /* 0x000 */ Actor actor;
    /* 0x144 */ void (*actionFunc)(EnTruMt *, GlobalContext *);
    /* 0x148 */ SkelAnime unk_148;                  /* inferred */
    /* 0x18C */ ColliderSphere unk_18C;             /* inferred */
    /* 0x1E4 */ Vec3s unk_1E4;                      /* inferred */
    /* 0x1EA */ char pad_1EA[0x9C];                 /* maybe part of unk_1E4[27]? */
    /* 0x286 */ Vec3s unk_286;                      /* inferred */
    /* 0x28C */ char pad_28C[0x9C];                 /* maybe part of unk_286[27]? */
    /* 0x328 */ s16 unk_328;                        /* inferred */
    /* 0x32A */ char pad_32A[0x22];                 /* maybe part of unk_328[18]? */
    /* 0x34C */ s16 unk_34C;                        /* inferred */
    /* 0x34E */ char pad_34E[0x1A];                 /* maybe part of unk_34C[14]? */
    /* 0x368 */ u8 *unk_368;                        /* inferred */
    /* 0x36C */ s32 unk_36C;                        /* inferred */
    /* 0x370 */ char pad_370[0x38];                 /* maybe part of unk_36C[15]? */
} EnTruMt;                                          /* size = 0x3A8 */

struct _mips2c_stack_EnTruMt_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnTruMt_Draw {
...
struct _mips2c_stack_EnTruMt_Init {
...
struct _mips2c_stack_EnTruMt_Update {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B76030 {
...
struct _mips2c_stack_func_80B76110 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B76188 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80B761FC {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ Vec3s *sp28;                         /* inferred */
    /* 0x2C */ CollisionCheckContext *sp2C;         /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80B76368 {};              /* size 0x0 */

struct _mips2c_stack_func_80B763C4 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80B76540 {
    /* 0x00 */ char pad_0[0x20];
...
struct _mips2c_stack_func_80B76600 {
    /* 0x00 */ char pad_0[0x28];
...
struct _mips2c_stack_func_80B7679C {
...
struct _mips2c_stack_func_80B768F0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B76924 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B76980 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ void *sp1C;                          /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B76A64 {
    /* 0x00 */ char pad_0[0x34];
...
struct _mips2c_stack_func_80B76BB8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B76C38 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B76ED4 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ ? sp28;                              /* inferred */
...
struct _mips2c_stack_func_80B77008 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B77078 {
...
struct _mips2c_stack_func_80B77354 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */
...
? func_80B76030(SkelAnime *arg0, s16 arg1) {
    ...
    if ((s32) arg1 >= 0) {
        ...
        if ((s32) arg1 < 0x10) {
            ...
            temp_t1 = temp_v1->unk_A;
            phi_t1 = temp_t1;
            if ((s32) temp_t1 < 0) {
                sp2C = temp_v1;
                phi_t1 = SkelAnime_GetFrameCount(temp_v1->unk_0);
            }
            temp_t0 = (temp_t6 + &D_80B7755C)->unk_8;
            phi_t0 = temp_t0;
            if ((s32) temp_t0 < 0) {
                sp2C = temp_t6 + &D_80B7755C;
                sp36 = phi_t1;
                phi_t0 = SkelAnime_GetFrameCount((temp_t6 + &D_80B7755C)->unk_0);
            }
            SkelAnime_ChangeAnim(arg0, (temp_t6 + &D_80B7755C)->unk_0, (temp_t6 + &D_80B7755C)->unk_4, (f32) phi_t0, (f32) phi_t1, (u8) (s32) (temp_t6 + &D_80B7755C)->unk_C, (f32) (temp_t6 + &D_80B7755C)->unk_E);
            phi_v1 = 1;
        }
    }
    return phi_v1;
...
void func_80B76110(EnTruMt *arg0) {
    ...
    if (temp_v0 == 0) {
        ...
        arg0->unk_34E = temp_v0 - 1;
        phi_v1 = arg0->unk_34E;
    }
    if (phi_v1 == 0) {
        arg0->unk_34C += 1;
        if ((s32) arg0->unk_34C >= 3) {
            arg0 = arg0;
            arg0->unk_34E = Rand_S16Offset(0x1E, 0x1E);
            arg0->unk_34C = 0;
        }
    }
}
...
void func_80B76188(Actor *arg0) {
    ...
    temp_f0 = Math_CosS(arg0->unk_38A);
    arg0->unk_38A = (s16) (arg0->unk_38A + 0x1555);
    arg0->unk_38E = (s16) (s32) (temp_f0 * (f32) arg0->unk_38C);
...
? func_80B761FC(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0[1].bgCheckFlags = (u16) (s32) arg0->world.pos.x;
    arg0->unk_1D8 = (s16) (s32) arg0->world.pos.z;
    arg0[1].yawTowardsPlayer = (s16) (s32) (arg0->world.pos.y + 16.0f);
    if (((temp_v0 & 2) != 0) && (arg0->colChkInfo.damageEffect == 0xF) && (temp_v1 = arg0->child, ((temp_v1->unk_159 & 2) == 0)) && (temp_v1->colChkInfo.damageEffect != 0xF)) {
        arg0->unk_19D = (u8) (temp_v0 & 0xFFFD);
        if (arg0[2].colorFilterTimer == 0) {
            arg0[2].colorFilterTimer = 1;
            Audio_PlayActorSound2(arg0, 0x3AD4U);
        } else {
            arg0[2].colorFilterTimer = 0;
    ...
    if ((s32) arg0->unk_38C >= 0xB7) {
        func_80B76188(arg0);
    } else {
        arg0->unk_38E = 0;
    }
    temp_a2 = &arg0[1].focus.rot;
...
? func_80B76368(void *arg0, void *arg1) {
    ...
    temp_v1 = arg1->unk_1CC0;
    phi_v1 = temp_v1;
    if (temp_v1 != 0) {
loop_1:
        if (phi_v1->unk_0 == 0xA7) {
            arg0->unk_394 = (s16) phi_v1->unk_BE;
            arg0->unk_398 = (s32) phi_v1->unk_24;
            arg0->unk_39C = (s32) phi_v1->unk_28;
            arg0->unk_3A0 = (s32) phi_v1->unk_2C;
            return 1;
        }
...
void func_80B7679C(void *arg0, void *arg1) {
    ...
    temp_t0 = arg1->unk_1CCC;
    sp4C = temp_t0;
    Math_SmoothStepToS(arg0 + 0x34A, (s16) ((arg0->unk_92 - arg0->unk_BE) - 0x4000), 4, 0x38E0, (s16) 1);
    temp_v1 = arg0->unk_34A;
    ...
    sp40.unk_0 = (s32) temp_t0->unk_24;
    sp40.unk_4 = (s32) temp_t0->unk_28;
    sp40.unk_8 = (s32) temp_t0->unk_2C;
    sp44 = temp_t0->unk_C44 + 3.0f;
    sp34.unk_0 = (s32) arg0->unk_24;
    sp34.unk_4 = (s32) arg0->unk_28;
    sp34.unk_8 = (s32) arg0->unk_2C;
    sp38 += 30.0f;
    Math_SmoothStepToS(arg0 + 0x348, Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40), 4, 0x1C70, (s16) 1);
    temp_v1_2 = arg0->unk_348;
    ...
    arg0->unk_348 = phi_v0_2;
}

? func_80B768F0(EnTruMt *arg0) {
    if ((arg0->unk_328 & 0x10) != 0) {
        func_80B7679C();
    }
    return 1;
}
...
void func_80B76924(EnTruMt *arg0) {
    ...
    temp_a0 = arg0->unk_388;
    arg0 = arg0;
    temp_f10 = Math_SinS(temp_a0) * 30.0f * 182.04445f;
    arg0->unk_388 += 0x400;
    arg0->unk_392 = (s16) (s32) temp_f10;
}
...
void func_80B76980(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) gSaveContext.unk_3F3C >= 0xA) {
        ...
        temp_v1[8].targetArrowOffset &= -0x401;
        arg0->unk_144 = func_80B76BB8;
        arg0->speedXZ = 0.0f;
        return;
    }
...
void func_80B76A64(EnTruMt *this, GlobalContext *globalCtx) {
    ...
    func_80B76924(this);
    func_80B76980((Actor *) this, globalCtx);
    sp3C[8].targetArrowOffset = (bitwise f32) ((bitwise s32) sp3C[8].targetArrowOffset | 0x400);
    temp_a0 = this->unk_368;
    if (temp_a0 != 0) {
        func_80B76540(temp_a0, this->unk_36C, (Vec3f *) &this->actor.world, &sp34);
        Math_SmoothStepToS(&this->actor.world.rot.y, sp36, 4, 0x3E8, (s16) 1);
        this->actor.shape.rot.y = this->actor.world.rot.y;
        Math_SmoothStepToS((s16 *) &this->actor.shape, sp34, 4, 0x3E8, (s16) 1);
        ...
        if (func_80B76600(this, this->unk_368, this->unk_36C) != 0) {
            temp_v0 = this->unk_36C;
            if (temp_v0 >= (*this->unk_368 - 1)) {
                this->actionFunc = func_80B76C38;
                this->actor.speedXZ = 0.0f;
                return;
            }
            this->unk_36C = temp_v0 + 1;
            goto block_10;
        }
block_10:
...
void func_80B76C38(EnTruMt *this, GlobalContext *globalCtx) {
    ...
    func_80B76924(this);
    func_80B76980((Actor *) this, globalCtx);
    sp1C[8].targetArrowOffset = (bitwise f32) ((bitwise s32) sp1C[8].targetArrowOffset | 0x400);
}
...
void EnTruMt_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_0601AA60, NULL, &this->unk_1E4, &this->unk_286, 0x1B);
    temp_a1_2 = &this->unk_18C;
    sp30 = temp_a1_2;
    Collider_InitSphere(globalCtx, temp_a1_2);
    Collider_SetSphere(globalCtx, temp_a1_2, (Actor *) this, &D_80B77510);
    this->unk_18C.dim.worldSphere.radius = 0x16;
    this->actor.colChkInfo.damageTable = &D_80B7753C;
    this->unk_368 = func_8013D648(globalCtx, (s16) (this->actor.params & 0xFF), 0x3F);
    this->actor.targetMode = 0;
    Actor_SetScale((Actor *) this, 0.008f);
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 0.0f, 0.0f, 0.0f, 4U);
    this->unk_328 = 0;
    this->actor.room = -1;
    this->unk_368 = func_8013D648(globalCtx, (s16) ((s32) (this->actor.params & 0xFC00) >> 0xA), 0x3F);
...
void EnTruMt_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.eventInf[4] & 1) == 0) {
        func_80B761FC((Actor *) this, globalCtx);
    }
...
void func_80B77078(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 0x15) {
        phi_v0 = 0;
        if ((arg4->unk_328 & 0x10) != 0) {
            phi_v0 = 1;
        }
        func_80B76ED4(arg4[2].shape.rot.z, arg4[2].shape.face, arg4 + 0x33C, arg4 + 0x336, phi_v0);
        SysMatrix_InsertTranslation(arg4->unk_33C, arg4->unk_340, arg4->unk_344, 0);
        Matrix_Scale(arg4->scale.x, arg4->scale.y, arg4->scale.z, 1);
        Matrix_RotateY(arg4[2].colChkInfo.cylRadius, 1U);
        SysMatrix_InsertXRotation_s(arg4->unk_336, 1);
        SysMatrix_InsertZRotation_s(arg4[2].colChkInfo.cylHeight, 1);
    }
    if (arg1 == 0xE) {
        func_8012C28C(arg0->state.gfxCtx);
        sp4C = arg0->state.gfxCtx;
        SysMatrix_MultiplyVector3fByState(&D_80B77668, arg4 + 0x370);
        SysMatrix_InsertTranslation(arg4[2].shape.feetPos[1].z, arg4[2].projectedPos.x, arg4[2].projectedPos.y, 0);
        Matrix_RotateY((s16) (func_800DFCDC((arg0 + (arg0->activeCamera * 4))->unk_800) + 0x8000), 1U);
        SysMatrix_InsertZRotation_s(arg4->unk_392, 1);
        SysMatrix_InsertXRotation_s(arg4->unk_38E, 1);
        ...
        if ((temp_v1 == 0) || (temp_v1->update == 0)) {
            sp54 = temp_t0;
            Actor_SpawnAsChild(arg0 + 0x1CA0, arg4, arg0, 0x22F, temp_t0->mf[3][0], temp_t0->mf[3][1], temp_t0->mf[3][2], (s16) (s32) arg4->unk_38E, (s16) (func_800DFCDC((arg0 + (arg0->activeCamera * 4))->unk_800) + 0x8000), (s16) (s32) arg4->unk_392, -1);
            return;
        }
        if (temp_v1->unk_1A2 == 0) {
            temp_v1->world.pos.x = temp_t0->mf[3][0];
            arg4->child->world.pos.y = temp_t0->mf[3][1];
            arg4->child->world.pos.z = temp_t0->mf[3][2];
            temp_t4 = arg4->child;
            temp_t4->unk_30 = (unaligned s32) arg4->unk_38E;
            temp_t4->world.rot.z = (u16) arg4->unk_392;
            arg4->child->world.rot.y = func_800DFCDC((arg0 + (arg0->activeCamera * 4))->unk_800) + 0x8000;
            temp_v1_2 = arg4->child;
            temp_v1_2->unk_BC = (unaligned s32) temp_v1_2->unk_30;
...
void func_80B77354(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    if (arg1 == 0x15) {
        ...
        Matrix_RotateY(arg2[2].colChkInfo.cylRadius, 1U);
        SysMatrix_InsertXRotation_s(arg2->unk_336, 1);
        SysMatrix_InsertZRotation_s(arg2[2].colChkInfo.cylHeight, 1);
    }
}
...
void EnTruMt_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp48.unk_0 = (s32) D_80B77674.unk_0;
    sp48.unk_4 = (s32) D_80B77674.unk_4;
    sp48.unk_8 = (s32) D_80B77674.unk_8;
    ...
    sp44 = sp44;
    sp3C = temp_v0;
    sp3C->words.w1 = Lib_SegmentedToVirtual((sp + (this->unk_34C * 4))->unk_48);
    temp_v0_2 = sp44->polyOpa.p;
    sp44->polyOpa.p = &temp_v0_2[1];
    temp_v0_2->words.w0 = 0xDB060024;
    sp38 = temp_v0_2;
    sp38->words.w1 = Lib_SegmentedToVirtual((sp + (this->unk_34C * 4))->unk_48);
    func_801343C0(globalCtx, this->unk_148.skeleton, this->unk_148.limbDrawTbl, (s32) this->unk_148.dListCount, func_80B77008, func_80B77078, func_80B77354, (Actor *) this);
}
