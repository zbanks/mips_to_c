...
typedef struct EnTruMt {
    ...
    /* 0x1EA */ char pad1EA[0x9C];                  /* maybe part of unk1E4[27]? */
    /* 0x286 */ Vec3s unk286;                       /* inferred */
    /* 0x28C */ char pad28C[0x9C];                  /* maybe part of unk286[27]? */
    /* 0x328 */ s16 unk328;                         /* inferred */
    /* 0x32A */ char pad32A[0x22];                  /* maybe part of unk328[18]? */
    /* 0x34C */ s16 unk34C;                         /* inferred */
    /* 0x34E */ char pad34E[0x1A];                  /* maybe part of unk34C[14]? */
    /* 0x368 */ u8 *unk368;                         /* inferred */
    /* 0x36C */ s32 unk36C;                         /* inferred */
    /* 0x370 */ char pad370[0x38];                  /* maybe part of unk36C[15]? */
} EnTruMt;                                          /* size = 0x3A8 */
...
struct _mips2c_stack_func_80B76A64 {
    ...
    /* 0x36 */ s16 sp36;                            /* inferred */
    /* 0x38 */ char pad38[0x4];                     /* maybe part of sp36[3]? */
...
void func_80B7679C(void *arg0, void *arg1) {
    ...
    sp40.unk0 = (s32) temp_t0->unk24;
    sp40.unk4 = (s32) temp_t0->unk28;
    sp40.unk8 = (s32) temp_t0->unk2C;
    sp44 = temp_t0->unkC44 + 3.0f;
    sp34.unk0 = (s32) arg0->unk24;
    sp34.unk4 = (s32) arg0->unk28;
    sp34.unk8 = (s32) arg0->unk2C;
    sp38 += 30.0f;
...
void func_80B76A64(EnTruMt *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = this->unk368;
    if (temp_a0 != 0) {
        func_80B76540(temp_a0, this->unk36C, (Vec3f *) &this->actor.world, &sp34);
...
void EnTruMt_Init(EnTruMt *this, GlobalContext *globalCtx) {
    SkelAnime *sp34;
    ColliderSphere *sp30;
...
void EnTruMt_Destroy(EnTruMt *this, GlobalContext *globalCtx) {
    EnTruMt *this = (EnTruMt *) thisx;
    Collider_DestroySphere(globalCtx, &this->unk18C);
}

void EnTruMt_Update(EnTruMt *this, GlobalContext *globalCtx) {
    EnTruMt *this = (EnTruMt *) thisx;
...
void EnTruMt_Draw(EnTruMt *this, GlobalContext *globalCtx) {
    ? sp48;
    ...
    func_801343C0(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, func_80B77008, func_80B77078, func_80B77354, (Actor *) this);
}
