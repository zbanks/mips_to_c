typedef struct EnKitan {
    ...
    /* 0x284 */ SkelAnime unk284;                   /* inferred */
    /* 0x2C8 */ char pad2C8[0xE];
...
void EnKitan_Init(EnKitan *this, GlobalContext *globalCtx) {
    SkelAnime *sp34;
    SkelAnime *temp_a1;
    SkelAnime *temp_a1_2;
...
void EnKitan_Destroy(EnKitan *this, GlobalContext *globalCtx) {
    EnKitan *this = (EnKitan *) thisx;
...
void EnKitan_Update(EnKitan *this, GlobalContext *globalCtx) {
    EnKitan *this = (EnKitan *) thisx;
