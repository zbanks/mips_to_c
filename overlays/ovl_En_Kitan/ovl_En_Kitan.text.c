typedef struct EnKitan {
    ...
    /* 0x284 */ SkelAnime unk_284;                  /* inferred */
    /* 0x2C8 */ char pad_2C8[0xE];
...
struct _mips2c_stack_EnKitan_Init {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ SkelAnime *sp34;                     /* inferred */
    /* 0x38 */ char pad_38[0x8];
};                                                  /* size = 0x40 */

struct _mips2c_stack_EnKitan_Update {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80C0923C {
...
struct _mips2c_stack_func_80C09390 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80C09418 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80C094A8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80C09518 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ SkelAnime *sp28;                     /* inferred */
    /* 0x2C */ char pad_2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80C095C8 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80C09648 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80C09708 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ SkelAnime *sp24;                     /* inferred */
    /* 0x28 */ char pad_28[0x8];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80C09990 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ SkelAnime *sp24;                     /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80C09AA4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80C09B50 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80C09C74 {};              /* size 0x0 */

struct _mips2c_stack_func_80C09C90 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80C09CD0 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */
...
void EnKitan_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_06007FA8, &D_06002770, &this->unk_188, &this->unk_206, 0x15);
    SkelAnime_ChangeAnimDefaultRepeat(sp34, &D_06002770);
    temp_a1_2 = &this->unk_284;
    sp34 = temp_a1_2;
    Collider_InitAndSetCylinder(globalCtx, (ColliderCylinder *) temp_a1_2, (Actor *) this, &D_80C09D50);
...
void EnKitan_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnKitan *this = (EnKitan *) thisx;
    Collider_DestroyCylinder(globalCtx, (ColliderCylinder *) &this->unk_284);
}
...
s32 func_80C09390(Actor *arg0, GlobalContext *arg1) {
    if (arg1->actorCtx.actorList[2].first->unk_A6C & 0x800000) {
        goto block_6;
    }
...
loop_1:
    ...
    arg0->unk_2D0 = (s32) (temp_a0 | temp_a1);
...
void func_80C09B50(EnKitan *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        arg0->unk_2D6 = temp_v0 - 1;
        return;
    }
    func_80C0923C((Actor *)0x1E);
    Audio_PlayActorSound2((Actor *) arg0, 0x3A86U);
...
void EnKitan_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.draw != 0) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_284);
    }
