...
struct _mips2c_stack_Title_Draw {
    ...
    /* 0x98 */ char pad98[0x10];                    /* maybe part of sp94[5]? */
...
void Title_UpdateCounters(GameState *arg0) {
    ...
    temp_v0 = arg0->unk23A;
    if ((temp_v0 == 0) && (temp_v1 = arg0->unk23E, (temp_v1 != 0))) {
        arg0->unk23E = (s16) (temp_v1 - 1);
        arg0->unk238 = (s16) (arg0->unk238 - 1);
        if (arg0->unk238 == 0) {
            arg0->unk238 = 0x190;
        }
    } else {
        arg0->unk23A = (s16) (temp_v0 + arg0->unk23C);
        temp_v0_2 = arg0->unk23A;
        if ((s32) temp_v0_2 <= 0) {
            arg0->unk23A = 0;
            arg0->unk23C = 0xC;
    ...
    arg0->unk242 = (s16) (temp_v0_3 & 0x7F);
    arg0->unk240 = (s16) (temp_v0_3 + 1);
}
...
void Title_Draw(GameState *arg0) {
    ...
    do {
        ...
        temp_v0_26->words.w0 = ((arg0->unk242 & 0xFFF) << 0xC) | 0xF2000000U | (((arg0->unk240 & 0x7F) - (phi_a0 * 4)) & 0xFFF);
    ...
    func_800FC444(arg0->gfxCtx, 0, 0, 0, (s32) arg0->unk23A, 2);
