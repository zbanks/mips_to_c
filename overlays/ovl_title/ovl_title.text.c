...
void Title_UpdateCounters(GameState *arg0) {
    ...
    if ((temp_v0 == 0) && (temp_v1 = arg0->unk_23E, (temp_v1 != 0))) {
        ...
        arg0->unk_23A = (s16) (temp_v0 + arg0[3].input[2].press.button);
        temp_v0_2 = arg0->unk_23A;
        if ((s32) temp_v0_2 <= 0) {
            arg0->unk_23A = 0;
            arg0[3].input[2].press.button = 0xC;
        } else if ((s32) temp_v0_2 >= 0xFF) {
            arg0->unk_23A = 0xFF;
            arg0[3].input[2].rel.stick_x = 1;
        }
    }
    temp_v0_3 = arg0->unk_240;
    arg0[3].input[2].rel.button = temp_v0_3 & 0x7F;
...
void Title_Draw(GameState *arg0) {
    ...
    spC8 = 0.0f;
    spB4 = -4949.148f;
    spB8 = titleUnknownVector3f[1];
    spBC = titleUnknownVector3f[2];
    spA8 = temp_t0;
    ...
    do {
        ...
        temp_t0->polyOpa.p = &temp_v0_19[1];
        temp_a1 = phi_a3 + 2;
...
void Title_Main(GameState *thisx) {
    ...
    temp_v1->words.w1 = (u32) thisx[1].gfxCtx;
    Title_UpdateCounters(thisx);
    Title_Draw(thisx);
    if ((u8) thisx[3].input[2].rel.stick_x != 0) {
...
void Title_Destroy(GameState *thisx) {
    func_80146E40(&thisx[3].input[0].press.errno);
    ShrinkWindow_Fini();
    CIC6105_Nop80081828();
}
...
void Title_Init(GameState *thisx) {
    ...
    thisx[1].gfxCtx = temp_v0;
    DmaMgr_SendRequest0((void *) temp_v0, (u32) sp24, temp_a2);
    ...
    Sram_Alloc(thisx, (SramContext *) &thisx[3].input[0].press.errno);
    thisx->unk_240 = 0;
    thisx->unk_238 = 0x14;
    thisx->unk_23A = 0xFF;
    thisx[3].input[2].press.button = -0xC;
    thisx->unk_23E = 0x3C;
}
