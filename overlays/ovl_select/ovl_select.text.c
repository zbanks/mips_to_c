    ...
    if (arg0->unk25C == 0) {
        ...
        if ((~(temp_v0 | 0xFFFF7FFF) == 0) || (~(temp_v0 | ~0x1000) == 0)) {
            ...
            do {
                ...
                temp_v1 = phi_v1 + 1;
                gSaveContext.unk_3DE0[phi_v1].unk4 = 0;
                gSaveContext.unk_3DE0[phi_v1] = 0;
                gSaveContext.unk_3E18[phi_v1].unk4 = 0;
                gSaveContext.unk_3E18[phi_v1] = 0;
                gSaveContext.unk_3E50[phi_v1].unk4 = 0;
                gSaveContext.unk_3E50[phi_v1] = 0;
                gSaveContext.unk_3E88[phi_v1] = 0;
                gSaveContext.unk_3E88[phi_v1].unk4 = 0;
                gSaveContext.unk_3EC0[phi_v1].unk4 = 0;
                gSaveContext.unk_3EC0[phi_v1] = 0;
                phi_v1 = temp_v1;
            } while ((s32) temp_v1 < 7);
            gSaveContext.minigameState = 0;
            temp_v0_2 = arg0->unk214 + (arg0->unk218 * 0xC);
            temp_v1_2 = temp_v0_2->unk4;
            if (temp_v1_2 != 0) {
                sp24 = temp_t0;
                temp_v1_2(arg0, temp_v0_2->unk8, arg0->unk248, &gSaveContext);
            }
        }
        if (~((arg0 + 0x14)->unkC | ~0x4000) == 0) {
        ...
        if (~((arg0 + 0x14)->unkC | ~0x2000) == 0) {
            temp_v0_3 = gSaveContext.cutscene;
            if (temp_v0_3 == 0x8000) {
                gSaveContext.cutscene = 0;
            } else if (temp_v0_3 == 0) {
                gSaveContext.cutscene = 0x8800;
            } else if (temp_v0_3 == 0x8800) {
            ...
            if (temp_v0_4 == 0x8000) {
                ...
                gSaveContext.cutscene = 0;
            } else if (temp_v0_4 == 0xFFF0) {
                gSaveContext.cutscene = 0x8800;
            } else if (temp_v0_4 == 0xFFF1) {
                gSaveContext.cutscene = 0xFFF0;
            } else {
                if (temp_v0_4 == 0xFFF2) {
                    phi_a0 = 0xFFF1;
...
block_68:
        ...
        if (~((arg0 + 0x14)->unkC | ~8) == 0) {
            arg0->unk248 = (s32) (arg0->unk248 - 1);
        }
        phi_v0 = (arg0 + 0x14)->unkC;
        if (~((arg0 + 0x14)->unkC | ~4) == 0) {
            arg0->unk248 = (s32) (arg0->unk248 + 1);
            phi_v0 = (arg0 + 0x14)->unkC;
        }
        phi_v0_2 = phi_v0;
        ...
        temp_v0_5 = (arg0 + 0x14)->unk15;
        temp_t6 = gGameInfo;
        temp_v1_6 = temp_t6->data[126];
        if (temp_v0_5 != 0) {
            arg0->unk260 = (s32) ((s32) (temp_v1_6 * temp_v0_5) / 7);
        } else {
            if (~((arg0 + 0x14)->unkC | ~0x800) == 0) {
                if (arg0->unk26C == 1) {
                    arg0->unk264 = 0;
                }
                if (arg0->unk264 == 0) {
                    ...
                    sp2C = (s32) temp_v1_6;
                    play_sound(0x1800U);
                    arg0->unk260 = (s32) temp_v1_6;
                }
            }
            phi_a1 = 1;
            if ((~((arg0 + 0x14)->unk0 | ~0x800) == 0) && (arg0->unk264 == 0)) {
                sp2C = (s32) temp_t6->data[126];
                sp24 = arg0 + 0x14;
                play_sound(0x1800U);
                arg0->unk260 = (s32) ((s32) temp_t6->data[126] * 3);
            }
            if (~((arg0 + 0x14)->unkC | ~0x400) == 0) {
                if (phi_a1 == arg0->unk270) {
                    arg0->unk268 = 0;
                }
                if (arg0->unk268 == 0) {
                    arg0->unk268 = 0x14;
                    ...
                    sp2C = (s32) temp_t6->data[126];
                    play_sound(0x1800U);
                    arg0->unk260 = (s32) -(s32) temp_t6->data[126];
                }
            }
            if ((~((arg0 + 0x14)->unk0 | ~0x400) == 0) && (arg0->unk268 == 0)) {
                sp20 = -(s32) temp_t6->data[126];
                sp2C = (s32) temp_t6->data[126];
                sp24 = arg0 + 0x14;
                play_sound(0x1800U);
                arg0->unk260 = (s32) (sp20 * 3);
            }
            temp_v0_6 = (arg0 + 0x14)->unkC;
            phi_v0_3 = temp_v0_6;
            if ((~(temp_v0_6 | ~0x200) == 0) || (~((arg0 + 0x14)->unk0 | ~0x200) == 0)) {
                sp2C = (s32) temp_t6->data[126];
                sp24 = arg0 + 0x14;
                play_sound(0x1800U);
                arg0->unk260 = (s32) temp_t6->data[126];
                phi_v0_3 = (arg0 + 0x14)->unkC;
            }
            if ((~(phi_v0_3 | ~0x100) == 0) || (~((arg0 + 0x14)->unk0 | ~0x100) == 0)) {
                sp20 = -(s32) temp_t6->data[126];
                play_sound(0x1800U);
                arg0->unk260 = sp20;
            }
    ...
    if (~(arg0->input[0].press.button | ~0x20) == 0) {
        temp_t5 = arg0->unk21C + 1;
        temp_t8 = (s32) (temp_t5 + 7) % 7;
        arg0->unk21C = temp_t5;
        arg0->unk21C = temp_t8;
        temp_v0_7 = (arg0 + (temp_t8 * 4))->unk220;
        arg0->unk24C = temp_v0_7;
        arg0->unk218 = temp_v0_7;
    }
    temp_t5_2 = arg0->unk25C + arg0->unk260;
    temp_at = temp_t5_2 < -7;
    arg0->unk25C = temp_t5_2;
    if (temp_at != 0) {
        temp_v0_8 = arg0->unk210;
        temp_v1_7 = arg0->unk24C;
        arg0->unk260 = 0;
        temp_t8_2 = arg0->unk218 + 1;
        temp_t3 = (s32) (temp_t8_2 + temp_v0_8) % temp_v0_8;
        arg0->unk218 = temp_t8_2;
        arg0->unk218 = temp_t3;
        arg0->unk25C = 0;
        if (((s32) (temp_v1_7 + temp_v0_8 + 0x13) % temp_v0_8) == arg0->unk218) {
            temp_t7 = temp_v1_7 + 1;
            arg0->unk24C = temp_t7;
            arg0->unk24C = (s32) ((s32) (temp_t7 + temp_v0_8) % temp_v0_8);
        }
    }
    temp_a0 = arg0->unk218;
    temp_v1_8 = arg0->unk24C;
    phi_v1_3 = temp_v1_8;
    phi_a0_2 = temp_a0;
    phi_v1_4 = temp_v1_8;
    if (arg0->unk25C >= 8) {
        ...
        if (temp_v1_8 == temp_a0) {
            temp_v0_9 = arg0->unk210;
            temp_t4 = temp_v1_8 - 2;
            arg0->unk24C = temp_t4;
            temp_hi = (s32) (temp_t4 + temp_v0_9) % temp_v0_9;
            arg0->unk24C = temp_hi;
            phi_v1_3 = temp_hi;
        }
        temp_v0_10 = arg0->unk210;
        temp_t7_2 = arg0->unk218 - 1;
        arg0->unk218 = temp_t7_2;
        temp_hi_2 = (s32) (temp_t7_2 + temp_v0_10) % temp_v0_10;
        arg0->unk218 = temp_hi_2;
        phi_a0_2 = temp_hi_2;
        phi_v1_4 = phi_v1_3;
        if (((s32) (phi_v1_3 + temp_v0_10) % temp_v0_10) == temp_hi_2) {
            temp_t1 = phi_v1_3 - 1;
            temp_hi_3 = (s32) (temp_t1 + temp_v0_10) % temp_v0_10;
            arg0->unk24C = temp_t1;
            arg0->unk24C = temp_hi_3;
            phi_a0_2 = arg0->unk218;
            phi_v1_4 = temp_hi_3;
        }
    }
    temp_v0_11 = arg0->unk210;
    arg0->unk218 = (s32) ((s32) (phi_a0_2 + temp_v0_11) % temp_v0_11);
    arg0->unk24C = (s32) ((s32) (phi_v1_4 + temp_v0_11) % temp_v0_11);
    gGameInfo->data[2576] = (s16) arg0->unk218;
    gGameInfo->data[2577] = (s16) arg0->unk24C;
    gGameInfo->data[2578] = (s16) arg0->unk21C;
    temp_a1 = arg0->unk264;
    temp_t9 = temp_a1 - 1;
    phi_a1_2 = temp_a1;
    if (temp_a1 != 0) {
    ...
    temp_v0_12 = arg0->unk268;
    temp_t2 = temp_v0_12 - 1;
    phi_v0_4 = temp_v0_12;
    if (temp_v0_12 != 0) {
        arg0->unk268 = temp_t2;
        phi_v0_4 = temp_t2;
...
void func_808013B8(GraphicsContext **arg0, GfxPrint *arg1) {
    ...
    do {
        ...
        temp_v0 = arg0->unk210;
        temp_hi = (s32) (arg0->unk24C + phi_s0 + temp_v0) % temp_v0;
        if (temp_hi == arg0->unk218) {
            GfxPrint_SetColor(arg1, 0xFFU, 0x14U, 0x14U, 0xFFU);
        } else {
            GfxPrint_SetColor(arg1, 0xC8U, 0xC8U, 0x37U, 0xFFU);
        }
        temp_a2 = *(arg0->unk214 + (temp_hi * 0xC));
        phi_a2 = temp_a2;
        if (temp_a2 == 0) {
            phi_a2 = "**Null**";
        }
    ...
    GfxPrint_Printf(arg1, "OPT=%d", arg0->unk248);
}
...
void func_8080194C(GraphicsContext **arg0) {
    ...
    GfxPrint_Init(&sp10);
    GfxPrint_Open(&sp10, sp34->polyOpa.p);
    func_808013B8(arg0, &sp10);
    func_80801620(arg0, &sp10, (s32) gSaveContext.playerForm);
    func_808016E8(arg0, &sp10, gSaveContext.cutscene & 0xFFFF);
    sp34->polyOpa.p = GfxPrint_Close(&sp10);
...
void func_808019FC(GraphicsContext **arg0) {
    ...
    func_8012C4C0(temp_a0);
    GfxPrint_Init(&sp24);
    GfxPrint_Open(&sp24, sp54->polyOpa.p);
    func_80801594(arg0, &sp24);
    sp54->polyOpa.p = GfxPrint_Close(&sp24);
    GfxPrint_Destroy(&sp24);
}
...
void func_80801A64(GraphicsContext **arg0) {
    ...
    func_8012CF0C(arg0->unk0, 1, 1, 0U, (u8) 0, (u8) 0);
    temp_a0 = arg0 + 0xA8;
    sp28 = temp_a0;
    sp38 = 0x140;
    sp30 = 0xF0;
...
void Select_Init(GameState *thisx) {
    ...
    if (((s32) temp_v0 >= 0) && ((s32) temp_v0 < thisx->unk210)) {
        thisx->unk218 = (s32) temp_v0;
        thisx->unk24C = (s32) gGameInfo->data[2577];
        thisx->unk21C = (s32) gGameInfo->data[2578];
    }
