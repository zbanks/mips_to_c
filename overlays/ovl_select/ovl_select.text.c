...
void func_80800A44(GameState *arg0) {
    ...
    if (arg0->unk25C == 0) {
        ...
        if ((~(temp_v0 | 0xFFFF7FFF) == 0) || (~(temp_v0 | ~0x1000) == 0)) {
            ...
            temp_v0_3 = arg0->unk214 + (arg0->unk218 * 0xC);
            temp_v1_2 = temp_v0_3->unk4;
            if (temp_v1_2 != 0) {
                sp24 = temp_t0;
                temp_v1_2(arg0, temp_v0_3->unk8, arg0->unk248, &gSaveContext);
            }
        }
...
block_68:
        ...
        temp_v0_6 = (arg0 + 0x14)->unk15;
        temp_t6 = gGameInfo;
        temp_v1_6 = temp_t6->data[126];
        if (temp_v0_6 != 0) {
            arg0->unk260 = (s32) ((s32) (temp_v1_6 * temp_v0_6) / 7);
        } else {
            ...
            temp_v0_7 = (arg0 + 0x14)->unkC;
            phi_v0_3 = temp_v0_7;
            if ((~(temp_v0_7 | ~0x200) == 0) || (~((arg0 + 0x14)->unk0 | ~0x200) == 0)) {
                sp2C = (s32) temp_t6->data[126];
                sp24 = arg0 + 0x14;
                play_sound(0x1800U);
    ...
    if (~(arg0->input[0].press.button | ~0x20) == 0) {
        ...
        arg0->unk21C = temp_t5;
        arg0->unk21C = temp_t8;
        temp_v0_8 = (arg0 + (temp_t8 * 4))->unk220;
        arg0->unk24C = temp_v0_8;
        arg0->unk218 = temp_v0_8;
    }
    ...
    if (temp_at != 0) {
        ...
        arg0->unk218 = temp_t3;
        arg0->unk25C = 0;
        if (((s32) (temp_v1_7 + temp_v0_9 + 0x13) % temp_v0_9) == arg0->unk218) {
            temp_t7 = temp_v1_7 + 1;
            arg0->unk24C = temp_t7;
            arg0->unk24C = (s32) ((s32) (temp_t7 + temp_v0_9) % temp_v0_9);
        }
    }
    temp_a0 = arg0->unk218;
    ...
    temp_v0_12 = arg0->unk210;
    arg0->unk218 = (s32) ((s32) (phi_a0_2 + temp_v0_12) % temp_v0_12);
    arg0->unk24C = (s32) ((s32) (phi_v1_4 + temp_v0_12) % temp_v0_12);
