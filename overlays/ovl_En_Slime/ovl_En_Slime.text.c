typedef struct EnSlime {
    ...
    /* 0x180 */ Vec3f unk180;                       /* inferred */
    /* 0x18C */ char pad18C[0x30];                  /* maybe part of unk180[5]? */
    /* 0x1BC */ ColliderCylinder unk1BC;            /* inferred */
} EnSlime;                                          /* size = 0x208 */
...
struct _mips2c_stack_EnSlime_Draw {
    ...
    /* 0x74 */ char pad74[0x20];                    /* maybe part of sp70[9]? */
...
void EnSlime_Init(EnSlime *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    s16 temp_v0_2;
    s16 temp_v0_3;
    s32 temp_v1;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk1BC, (Actor *) this, &D_80A31AF0);
...
void EnSlime_Destroy(EnSlime *this, GlobalContext *globalCtx) {
    EnSlime *this = (EnSlime *) thisx;
...
void func_80A2F418(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 8) != 0) {
        ...
        if (Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) temp_a1) > 120.0f) {
            this->unk14E = Actor_YawToPoint((Actor *) this, (Vec3f *) sp24);
        }
    }
    ...
    if (this->unk170 < Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) sp24)) {
        func_80A2F684(this);
        return;
    }
    if ((Player_GetMask(globalCtx) != 0x10) && (this->actor.xzDistToPlayer < 280.0f) && (Actor_IsActorFacingLink((Actor *) this, 0x5000) != 0)) {
...
void func_80A2F6CC(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 8) != 0) {
        ...
        sp2C = temp_a1;
        this->unk14E = Actor_YawToPoint((Actor *) this, (Vec3f *) temp_a1);
    }
    ...
    if (Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) sp2C) < (this->unk170 * 0.8f)) {
        func_80A2F180(this);
    }
}
...
void func_80A2FBA0(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if (this->unk170 < Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) &this->actor.home)) {
        func_80A2F684(this);
        return;
    }
...
void func_80A30820(EnSlime *this, GlobalContext *globalCtx) {
    ...
    sp44 = Math_StepToF((f32 *) &this->actor.world, this->unk154, 10.0f);
...
void EnSlime_Update(EnSlime *this, GlobalContext *globalCtx) {
    Actor *sp2C;
...
void EnSlime_Draw(EnSlime *this, GlobalContext *globalCtx) {
    f32 spA4;
    f32 spA0;
    f32 sp9C;
    void *sp98;
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk180, 5, this->unk168, this->unk16C, this->unk164, (u8) (s32) this->unk14A);
}
