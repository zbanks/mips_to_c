...
static void *D_80A31B44 = {(void *)0x6000F70, (void *)0x6001070, (void *)0x6001170, (void *)0x6001070};
static InitChainEntry D_80A31B54;                   /* unable to generate initializer */
...
typedef struct EnSlime {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnSlime *, GlobalContext *);
    ...
    /* 0x0180 */ Vec3f unk180;                      /* inferred */
    /* 0x018C */ char pad18C[0x30];                 /* maybe part of unk180[5]? */
    /* 0x01BC */ ColliderCylinder unk1BC;           /* inferred */
} EnSlime;                                          /* size 0x208 */
...
void EnSlime_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk1BC, &this->actor, &D_80A31AF0);
    ...
    if (temp_v0_3 == 2) {
        this->unk160 = Lib_SegmentedToVirtual((void *) &D_0405BEF0);
        this->actor.hintId = 0x22;
    } else if (temp_v0_3 == 1) {
        this->unk160 = Lib_SegmentedToVirtual((void *) &D_0405FFC0);
        this->actor.hintId = 0x5D;
    } else if (temp_v0_3 == 3) {
        this->unk160 = Lib_SegmentedToVirtual((void *) &D_0405E6F0);
        this->actor.hintId = 5;
    } else {
        this->actor.hintId = 6;
    }
...
void EnSlime_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnSlime *this = (EnSlime *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk1BC);
}
...
void func_80A2F1A4(EnSlime *this, GlobalContext *globalCtx) {
    ...
    this->unk14C += -1;
    temp_f20 = sqrtf((f32) this->unk14C) * 0.2f;
    func_80A2F0A8(this);
    temp_v0 = this->unk14C;
    temp_f2 = ((sin_rad((f32) this->unk14C * 1.2566371f) * (0.13f * temp_f20)) + 1.0f) * 0.01f;
    ...
    if ((Player_GetMask(globalCtx) != 0x10) && (this->actor.xzDistToPlayer < 280.0f) && (Actor_IsActorFacingLink(&this->actor, 0x5000) != 0)) {
        func_80A2F8B4(this);
        return;
    }
    if (this->unk14C == 0) {
...
void func_80A2F354(Actor *arg0) {
    ...
    if (Actor_XZDistanceToPoint(arg0, temp_a1) > 120.0f) {
        arg0->unk14E = Actor_YawToPoint(arg0, temp_a1);
    } else if (Rand_ZeroOne() < 0.7f) {
        arg0->unk14E = (s16) ((s32) randPlusMinusPoint5Scaled(16384.0f) + arg0->shape.rot.y);
    }
    arg0->unk144 = func_80A2F418;
...
void func_80A2F418(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 8) != 0) {
        ...
        sp24 = temp_a1;
        if (Actor_XZDistanceToPoint(&this->actor, &temp_a1->pos) > 120.0f) {
            this->unk14E = Actor_YawToPoint(&this->actor, &sp24->pos);
        }
    }
    temp_f0 = fabsf(sin_rad((f32) this->unk14C * 0.1308997f));
    ...
    if (this->unk170 < Actor_XZDistanceToPoint(&this->actor, &sp24->pos)) {
        func_80A2F684(this);
        return;
    }
    if ((Player_GetMask(globalCtx) != 0x10) && (this->actor.xzDistToPlayer < 280.0f) && (Actor_IsActorFacingLink(&this->actor, 0x5000) != 0)) {
...
void func_80A2F684(Actor *arg0) {
    arg0->unk14C = 0x18;
    arg0->unk14E = Actor_YawToPoint(arg0, arg0 + 8);
    arg0->unk144 = func_80A2F6CC;
    arg0->world.rot.y = arg0->shape.rot.y;
}
...
void func_80A2F6CC(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 8) != 0) {
        ...
        sp2C = temp_a1;
        this->unk14E = Actor_YawToPoint(&this->actor, &temp_a1->pos);
    }
    temp_f20 = fabsf(sin_rad((f32) this->unk14C * 0.1308997f));
    Math_StepToF(&this->actor.scale.z, ((0.15f * temp_f20) + 1.0f) * 0.01f, 0.0002f);
    Math_StepToF(&this->actor.scale.x, (1.0f - (0.2f * temp_f20)) * 0.01f, 0.0002f);
    ...
    if (Actor_XZDistanceToPoint(&this->actor, &sp2C->pos) < (this->unk170 * 0.8f)) {
        func_80A2F180(this);
    }
}
...
void func_80A2FA88(EnSlime *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk1BC.base.atFlags;
    temp_a0 = &this->actor.scale;
    this->unk14C += -1;
    if ((temp_v0 & 2) != 0) {
        temp_f0 = this->actor.speedXZ;
        if (temp_f0 > 0.0f) {
            this->unk1BC.base.atFlags = temp_v0 & 0xFFFD;
            this->actor.speedXZ = temp_f0 * -1.2f;
        }
    }
    this = this;
    Math_StepToF(&temp_a0->x, 0.008f, 0.0025f);
...
void func_80A2FBA0(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if ((Player_GetMask(globalCtx) != 0x10) && (this->actor.xzDistToPlayer < 280.0f) && ((s32) this->unk14C < 0xC)) {
        func_80A2F8B4(this);
        return;
    }
    if (this->unk14C == 0) {
...
void func_80A2FD94(Actor *arg0) {
    ...
    arg0->unk14C = 0x1E;
    arg0->unk1CD = (u8) (arg0->unk1CD & 0xFFFE);
    Audio_PlayActorSound2(arg0, 0x38BFU);
    temp_a0 = arg0;
    temp_a1 = temp_a0->unk1C4;
    phi_a0 = temp_a0;
    if (temp_a1 != 0) {
        arg0 = temp_a0;
        arg0->world.rot.y = Actor_YawBetweenActors(temp_a0, temp_a1) + 0x8000;
        phi_a0 = arg0;
    } else {
        temp_a0->world.rot.y = temp_a0->yawTowardsPlayer + 0x8000;
    }
    phi_a0->unk144 = func_80A2FE38;
}
...
void func_80A30018(Actor *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    arg0->unk154 = (f32) (Rand_ZeroOne() * 6.2831855f);
    arg0->unk15C = (f32) (Rand_ZeroOne() * 6.2831855f);
...
void func_80A30344(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if (this->unk14C == 0) {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x28, 0x38BBU);
        func_80A30454(this);
...
void func_80A304B8(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if (Math_StepToF(&this->actor.scale.x, 0.0f, 0.002f) != 0) {
        ...
        if (temp_v0 == 2) {
            Item_DropCollectible(globalCtx, &this->actor.world.pos, 5U);
        } else if (temp_v0 == 1) {
            Item_DropCollectible(globalCtx, &this->actor.world.pos, 0xFU);
        } else if (temp_v0 == 3) {
            Item_DropCollectible(globalCtx, &this->actor.world.pos, 3U);
        }
        func_80A30BE0(this);
    }
...
void func_80A30778(Actor *arg0) {
    ...
    arg0->velocity.y = 0.0f;
    arg0->gravity = 0.0f;
    arg0->unk154 = func_80A3072C(arg0->world.pos.x, arg0->home.pos.x);
    arg0->unk15C = func_80A3072C(arg0->world.pos.z, arg0->home.pos.z);
    func_800BCB70(arg0, 0x8000, 0x80FF, 0x2000, (s16) 0xA);
    arg0->unk149 = 0;
    arg0->unk148 = 0xFE;
    arg0->unk144 = func_80A30820;
}
...
void func_80A30820(EnSlime *this, GlobalContext *globalCtx) {
    ...
    sp44 = Math_StepToF(&this->actor.world.pos.x, this->unk154, 10.0f);
    temp_v0 = Math_StepToF(&this->actor.world.pos.z, this->unk15C, 10.0f);
    this->actor.colorFilterTimer = 0xA;
    if ((sp44 & temp_v0) != 0) {
        temp_v0_2 = Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0x143, this->actor.world.pos.x, this->actor.world.pos.y + 30.0f, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, 0);
...
void func_80A30A20(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if (this->unk14C == 0) {
        ...
        if (this->actor.colChkInfo.health == 0) {
            func_80A30018(&this->actor, globalCtx, 0);
            return;
        }
        this->actor.world.rot.y = this->actor.shape.rot.y;
...
void func_80A30AE4(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v1 != 0) && (temp_v1->update != 0)) {
        ...
        temp_v0 = this->unk148 + 0xA;
        if (temp_v0 >= 0x100) {
            this->unk148 = 0xFF;
        } else {
            this->unk148 = (u8) temp_v0;
        }
    }
    if (this->unk148 == 0xFF) {
...
void func_80A30BE0(EnSlime *arg0) {
    ...
    arg0->actor.speedXZ = 0.0f;
    arg0->unk1BC.base.ocFlags1 &= 0xFFFE;
    arg0->actionFunc = func_80A30C2C;
    arg0->unk14C = arg0->unk152;
}
...
void func_80A30CEC(EnSlime *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 < 0xC) {
        ...
        this->unk174 = temp_f0;
        this->unk17C = temp_f0;
        this->unk178 = 2.0f * temp_f0;
        this->unk150 = (s16) (s32) (temp_f2 * 1638.4f);
    } else if ((s32) temp_v0 < 0x14) {
        temp_f0_2 = (f32) (temp_v0 - 0xC) * 0.000625f;
        temp_f2_2 = 0.01f + temp_f0_2;
        this->unk174 = temp_f2_2;
        this->unk17C = temp_f2_2;
        this->unk178 = 2.0f * (0.01f - temp_f0_2);
        this->unk150 = (s16) (s32) ((f32) temp_v0 * 1638.4f);
    } else if ((s32) temp_v0 < 0x18) {
        temp_f0_3 = (f32) (temp_v0 - 0x14) * 0.0033333332f;
        temp_f2_3 = 0.015f - temp_f0_3;
        this->unk174 = temp_f2_3;
        this->unk17C = temp_f2_3;
        this->unk178 = (2.0f * temp_f0_3) + 0.01f;
        Actor_SetScale(&this->actor, 1.5f * temp_f0_3);
        temp_v0_2 = this->unk14C;
        this->unk150 = (s16) (s32) (((f32) (0x17 - temp_v0_2) * 7281.778f) + 10922.667f);
        this->actor.shape.rot.y = (s16) (s32) ((f32) (0x1C - temp_v0_2) * 4096.0f);
    } else {
        Actor_SetScale(&this->actor, (((f32) (0x1C - temp_v0) * 0.1f) + 1.0f) * 0.01f);
        Math_Vec3f_Copy((Vec3f *) &this->unk174, &D_801D15B0);
        this->actor.shape.rot.y = (s16) (s32) ((f32) (0x1C - this->unk14C) * 4096.0f);
    }
    if (this->unk14C == 0x15) {
        this->unk1BC.base.ocFlags1 |= 1;
    }
    temp_v0_3 = this->actor.home.rot.y;
    this->unk150 += temp_v0_3;
...
void func_80A30F98(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk1CD;
    if (((temp_v0 & 2) != 0) && ((arg0->unk1CD = (u8) (temp_v0 & 0xFFFD), (arg0->unk14A != 0xA)) || ((*arg0->unk1F8 & 0xDB0B3) == 0))) {
        ...
        if (temp_v0_2 != 0xE) {
            ...
            if (temp_v0_2 == 4) {
                ...
                arg0->unk14A = 0x14U;
                arg0->unk168 = 0.4f;
                Actor_Spawn(&arg1->actorCtx, arg1, 0xA2, (f32) arg0->unk1E2, (f32) arg0->unk1E4, (f32) arg0->unk1E6, (s16) 0, (s16) 0, (s16) 0, (s16) 4);
            } else if (temp_v0_2 == 5) {
                arg0->unk14A = 0x20U;
                arg0->unk164 = 4.0f;
                arg0->unk168 = 0.4f;
...
void EnSlime_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80A30F98(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    this->actor.shape.shadowAlpha = this->unk148;
    if (this->unk148 == 0xFF) {
        temp_f0 = this->actor.scale.y;
        if (temp_f0 > 0.0001f) {
            this->actor.targetArrowOffset = 60.0f / temp_f0;
        }
        if ((this->unk1BC.base.ocFlags1 & 1) != 0) {
            Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
            Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 35.0f, 40.0f, 0x1DU);
        }
        temp_a1 = &this->unk1BC;
        sp28 = temp_a1;
        Collider_UpdateCylinder(&this->actor, temp_a1);
        this->unk1BC.dim.radius = (s16) (s32) ((f32) D_80A31AF0.dim.radius * (100.0f * this->actor.scale.z));
        this->unk1BC.dim.height = (s16) (s32) ((f32) D_80A31AF0.dim.height * (100.0f * this->actor.scale.y));
        if (func_80A2FA88 == this->actionFunc) {
            CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, &sp28->base);
        }
        if ((this->unk1BC.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, &sp28->base);
        }
        if ((sp2C->unkA74 & 0x100) != 0) {
            this->unk1BC.base.ocFlags1 &= 0xFFF7;
        } else {
        ...
        if (this->unk164 > 0.0f) {
            if (this->unk14A != 0xA) {
                ...
                temp_f0_2 = (this->unk164 + 1.0f) * 0.2f;
                this->unk168 = temp_f0_2;
                if (temp_f0_2 > 0.4f) {
                    this->unk168 = 0.4f;
                    return;
                }
            ...
            if (Math_StepToF(&this->unk16C, 0.4f, 0.01f) == 0) {
...
void EnSlime_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk148 != 0xFF) {
        ...
        temp_v0_3->words.w1 = this->unk148 | 0x96FFFF00;
    } else {
        ...
        temp_v0_5->words.w1 = (temp_a2->unk0 << 0x18) | (temp_a2->unk1 << 0x10) | (temp_a2->unk2 << 8) | temp_a2->unk3;
        temp_v0_6 = temp_s1->polyXlu.p;
        temp_s1->polyXlu.p = temp_v0_6 + 8;
        temp_v0_6->words.w0 = 0xFB000000;
        temp_v0_6->words.w1 = (temp_a3->unk0 << 0x18) | (temp_a3->unk1 << 0x10) | (temp_a3->unk2 << 8) | 0xFF;
    }
    if (func_80A30344 == this->actionFunc) {
        sp9C = 1.0f - (sin_rad((f32) this->unk14C * 1.5707964f) * 0.3f);
        spA0 = (sin_rad((f32) this->unk14C * 1.5707964f) * 0.3f) + 1.0f;
        spA4 = 1.0f - (cos_rad((f32) this->unk14C * 1.5707964f) * 0.3f);
        SysMatrix_RotateStateAroundXAxis(this->unk154);
        SysMatrix_InsertZRotation_f(this->unk15C, 1);
    ...
    if (this->unk148 == 0xFF) {
        ...
        temp_v0_9->words.w1 = (u32) (&D_80A31B44)[this->unk149];
    ...
    if (func_80A30CEC == this->actionFunc) {
        ...
        Matrix_RotateY(this->unk150, 1U);
        Matrix_Scale(this->unk174, this->unk178, this->unk17C, 1);
        temp_v0_16 = temp_s1->polyXlu.p;
        temp_s1->polyXlu.p = temp_v0_16 + 8;
        temp_v0_16->words.w0 = 0xDA380003;
        sp4C = temp_v0_16;
        sp4C->words.w1 = Matrix_NewMtx(globalCtx->state.gfxCtx);
        temp_v0_17 = temp_s1->polyXlu.p;
        temp_s1->polyXlu.p = temp_v0_17 + 8;
    ...
    if ((this->actor.params != 0) && (this->actor.scale.x > 0.0f)) {
        ...
        temp_v0_19->words.w1 = (u32) this->unk160;
        ...
        temp_s1->polyOpa.p = temp_v0_21 + 8;
        temp_v0_21->words.w1 = (u32) D_0405F6F0;
        temp_v0_21->words.w0 = 0xDE000000;
    }
    func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk180, 5, this->unk168, this->unk16C, this->unk164, (u8) (s32) this->unk14A);
}
