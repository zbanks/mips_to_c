...
void EnRecepgirl_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_144, &D_06011B60, &D_06009890, &this->unk_188, &this->unk_218, 0x18);
    phi_s0 = D_80C106B0;
    if (D_80C106C8 == 0) {
        do {
            temp_s0 = phi_s0 + 4;
...
void EnRecepgirl_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_800E9250(globalCtx, (Actor *) this, &this->unk_2AE, (Vec3s *) &sp30, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    func_80C100DC(this);
}
...
void func_80C10590(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    if (arg1 == 5) {
        Matrix_RotateY((s16) (0x400 - arg2->unk_2AE), 1U);
