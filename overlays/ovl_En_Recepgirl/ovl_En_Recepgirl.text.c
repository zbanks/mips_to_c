...
static void *D_80C106B0 = {(void *)0x600F8F0, (void *)0x600FCF0, (void *)0x60100F0, (void *)0x600FCF0};
static InitChainEntry D_80C106C0;                   /* unable to generate initializer */
...
typedef struct EnRecepgirl {
    ...
    /* 0x02A8 */ void (*actionFunc)(EnRecepgirl *, GlobalContext *);
...
void EnRecepgirl_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_800E9250(globalCtx, &this->actor, &this->unk2AE, &sp30, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    func_80C100DC(this);
}
...
void EnRecepgirl_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80C10558, NULL, func_80C10590, &this->actor);
}
