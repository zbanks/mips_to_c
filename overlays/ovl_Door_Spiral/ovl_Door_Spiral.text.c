...
void DoorSpiral_SetupAction(DoorSpiral *arg0, void (*arg1)(void *, void *)); /* static */
? func_809A2B70(void *arg0, void *arg1, void *);    /* static */
u8 func_809A2BF8(GlobalContext *arg0);              /* static */
void func_809A2DB0(void *arg0, void *arg1);         /* static */
...
void DoorSpiral_Init(DoorSpiral *this, GlobalContext *globalCtx) {
    s8 temp_v0_2;
    u8 temp_v0;
...
void DoorSpiral_Destroy(DoorSpiral *this, GlobalContext *globalCtx) {
...
void DoorSpiral_Update(DoorSpiral *this, GlobalContext *globalCtx) {
    DoorSpiral *this = (DoorSpiral *) thisx;
...
void DoorSpiral_Draw(DoorSpiral *this, GlobalContext *globalCtx) {
    void *sp2C;
