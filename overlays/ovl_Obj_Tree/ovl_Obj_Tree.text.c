...
void ObjTree_Init(ObjTree *this, GlobalContext *globalCtx) {
...
void ObjTree_Destroy(ObjTree *this, GlobalContext *globalCtx) {
    s32 temp_a2;
    ObjTree *this = (ObjTree *) thisx;
...
void ObjTree_Update(ObjTree *this, GlobalContext *globalCtx) {
    ObjTree *this = (ObjTree *) thisx;
    this->actionFunc(this, globalCtx);
    func_80B9A348((Actor *) this, globalCtx);
}

void ObjTree_Draw(ObjTree *this, GlobalContext *globalCtx) {
    s16 sp36;
    s16 sp34;
    Gfx *sp28;
    Gfx *sp20;
