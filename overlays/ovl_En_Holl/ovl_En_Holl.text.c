...
void EnHoll_ChangeRooms(GlobalContext *globalCtx) {
    ...
    sp4.unk8 = (RoomMesh *) temp_v0->currRoom.mesh;
    sp4.unkC = (void *) temp_v0->currRoom.segment;
    sp4.unk10 = (s32) temp_v0->currRoom.unk10;
    ...
    temp_v0->currRoom.unk10 = temp_v1->unk10;
    temp_v1->unk0 = (s32) sp4.unk0;
    temp_v1->unk4 = (s32) sp4.unk4;
    temp_v1->mesh = sp4.unk8;
    temp_v1->segment = sp4.unkC;
    temp_v1->unk10 = sp4.unk10;
