typedef struct EnJso {
    ...
    /* 0x292 */ s16 unk292;                         /* inferred */
    /* 0x294 */ s16 unk294;                         /* inferred */
    /* 0x296 */ s16 unk296;                         /* inferred */
    ...
    /* 0x2AC */ char pad2AC[0x8];                   /* maybe part of unk2AA[5]? */
    /* 0x2B4 */ Vec3f unk2B4;                       /* inferred */
    /* 0x2C0 */ char pad2C0[0x86];                  /* maybe part of unk2B4[12]? */
    /* 0x346 */ s16 unk346;                         /* inferred */
    /* 0x348 */ s16 unk348;                         /* inferred */
    /* 0x34A */ s16 unk34A;                         /* inferred */
    /* 0x34C */ u8 unk34C;                          /* inferred */
    /* 0x34D */ u8 unk34D;                          /* inferred */
    /* 0x34E */ u8 unk34E;                          /* inferred */
    /* 0x34F */ char pad34F[0x1];
    /* 0x350 */ f32 unk350;                         /* inferred */
    /* 0x354 */ f32 unk354;                         /* inferred */
    /* 0x358 */ char pad358[0x4];
    /* 0x35C */ ColliderCylinder unk35C;            /* inferred */
    /* 0x3A8 */ ColliderQuad unk3A8;                /* inferred */
    /* 0x428 */ ColliderQuad unk428;                /* inferred */
    /* 0x4A8 */ s32 unk4A8;                         /* inferred */
    /* 0x4AC */ s32 unk4AC;                         /* inferred */
    /* 0x4B0 */ s16 unk4B0;                         /* inferred */
    /* 0x4B2 */ char pad4B2[0x2];
    /* 0x4B4 */ s32 unk4B4;                         /* inferred */
    /* 0x4B8 */ s16 unk4B8;                         /* inferred */
    /* 0x4BA */ char pad4BA[0x2];
    /* 0x4BC */ u32 unk4BC;                         /* inferred */
    /* 0x4C0 */ u16 unk4C0;                         /* inferred */
    /* 0x4C2 */ s16 unk4C2;                         /* inferred */
    /* 0x4C4 */ char pad4C4[0x4];                   /* maybe part of unk4C2[3]? */
    /* 0x4C8 */ Vec3f unk4C8;                       /* inferred */
    /* 0x4D4 */ Vec3f unk4D4;                       /* inferred */
    /* 0x4E0 */ ? unk4E0;                           /* inferred */
    /* 0x4E0 */ char pad4E0[0x4];
    /* 0x4E4 */ f32 unk4E4;                         /* inferred */
    /* 0x4E8 */ f32 unk4E8;                         /* inferred */
    /* 0x4EC */ f32 unk4EC;                         /* inferred */
    /* 0x4F0 */ f32 unk4F0;                         /* inferred */
    /* 0x4F4 */ f32 unk4F4;                         /* inferred */
    /* 0x4F8 */ f32 unk4F8;                         /* inferred */
    /* 0x4FC */ f32 unk4FC;                         /* inferred */
    /* 0x500 */ f32 unk500;                         /* inferred */
    /* 0x504 */ char pad504[0x10];                  /* maybe part of unk500[5]? */
    /* 0x514 */ s16 unk514;                         /* inferred */
    /* 0x516 */ char pad516[0xACA];                 /* maybe part of unk514[1382]? */
    /* 0xFE0 */ Vec3f unkFE0;                       /* inferred */
} EnJso;                                            /* size = 0xFEC */
...
struct _mips2c_stack_func_809ADCB8 {
    ...
    /* 0x48 */ char pad48[0x16];                    /* maybe part of sp44[6]? */
...
struct _mips2c_stack_func_809AFE38 {
    ...
    /* 0x078 */ char pad78[0x10];                   /* maybe part of sp74[5]? */
    /* 0x088 */ ? sp88;                             /* inferred */
    /* 0x088 */ char pad88[0x6C];
...
void EnJso_Init(EnJso *this, GlobalContext *globalCtx) {
    s32 sp388;
    s32 sp384;
    s32 sp380;
    s8 sp37F;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk35C, (Actor *) this, &D_809B0F88);
    Collider_InitAndSetQuad(globalCtx, &this->unk3A8, (Actor *) this, &D_809B0FB4);
    Collider_InitAndSetQuad(globalCtx, &this->unk428, (Actor *) this, &D_809B0FB4);
    sp37E = 0xFF;
    sp1DD = 0xFF;
    sp37D = 0xFF;
    sp1DC = 0xFF;
    ...
    sp1DE = 0xFF;
    sp1DF = 0;
    Effect_Add(globalCtx, &this->unk4A8, 1, 0U, (u8) 0, (void *) &sp1EC);
    Effect_Add(globalCtx, &this->unk4AC, 1, 0U, (u8) 0, (void *) &sp4C);
...
void EnJso_Destroy(EnJso *this, GlobalContext *globalCtx) {
    Actor *temp_v1;
    s16 temp_v1_2;
    EnJso *this = (EnJso *) thisx;
...
void func_809ADCB8(EnJso *this, GlobalContext *globalCtx) {
    ...
    case 0:
        ...
        sp64 = temp_v1;
        ActorCutscene_StartAndSetUnkLinkFields(this->unk4B8, (Actor *) this);
...
block_55:
    ...
    case 1:
        ...
        if (sp5E != 0) {
            ...
            func_801518B0(globalCtx, *(&D_809B1004 + (this->unk348 * 2)), (Actor *) this);
            this->unk348 += 1;
            this->unk4BC = 0;
            this->unk4C0 = (s16) this->unk4C0 + 1;
            this->actor.shape.yOffset = 970.0f;
...
void func_809AF470(EnJso *arg0) {
    ...
    Math_Vec3f_Copy(&arg0->unkFE0, (Vec3f *) &sp24);
    arg0->unk27C = 8;
    arg0->unk35C.base.acFlags &= 0xFFFB;
...
void func_809AF53C(EnJso *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk288 == 0) && (this->unk2A8 == 0)) {
        ...
        if ((temp_v0_2 == 0xB) || (temp_v0_2 == 0xA)) {
            func_800BF7CC(globalCtx, (Actor *) this, (Vec3f []) &this->unk2B4, 0xC, 2, 0.3f, 0.2f);
            this->unk2A8 = 0;
            this->unk2AA = 0;
        }
        func_809AF76C(this);
...
void func_809AF5F8(EnJso *arg0, GlobalContext *arg1) {
    ...
    Math_Vec3f_Copy(&arg0->unkFE0, (Vec3f *) &sp34);
    temp_v0 = arg0->unk2AA;
    if (((temp_v0 == 0xB) || (temp_v0 == 0xA)) && (arg0->unk2A8 != 0)) {
        func_800BF7CC(arg1, (Actor *) arg0, (Vec3f []) &arg0->unk2B4, 0xC, 2, 0.3f, 0.2f);
        arg0->unk2A8 = 0;
        arg0->unk2AA = 0;
    }
...
void EnJso_Update(EnJso *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0_8 != 0) && (temp_v0_8 != 1) && (temp_v0_8 != 0xB) && (temp_v0_8 != 4) && (temp_v0_8 != 0xD) && (temp_v0_8 != 0xE) && (temp_v0_8 != 0xF)) {
        ...
        if ((this->unk27C == 6) && (this->unk34E == 0) && (this->unk34D == 0)) {
            CollisionCheck_SetAT(globalCtx, sp30, (Collider *) &this->unk3A8);
            CollisionCheck_SetAT(globalCtx, sp30, (Collider *) &this->unk428);
        }
    }
}
...
void func_809B0820(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 4) {
        ...
        if (((temp_v0 == 6) || (temp_v0 == 5)) && (arg4->unk34C == 0)) {
            func_800A81F0(Effect_GetParams(arg4->unk4AC), (Vec3f *) &sp48, (Vec3f *) &sp3C);
    ...
    if (arg1 == 6) {
        ...
        if (((temp_v0_2 == 6) || (temp_v0_2 == 5)) && (arg4->unk34C == 0)) {
            func_800A81F0(Effect_GetParams(arg4->unk4A8), (Vec3f *) &sp48, (Vec3f *) &sp3C);
        } else if (arg4->unk34C == 1) {
