...
? func_8016981C(GlobalContext *, s16, Vec3f *, PosRot *, f32 *); /* extern */
...
Gfx *func_809B0B70(GraphicsContext *arg0);          /* static */
...
static s16 D_809B10E4 = {0x80, 0, 0, 0, 0, 0x80, 0, 0, 0, 0, 0x80, 0, 0, 0, 0, 0x80, 0, 0, 0, 0, 0, 0};
...
typedef struct EnJso {
    ...
    /* 0x02AC */ char pad2AC[0x8];                  /* maybe part of unk2AA[5]? */
    /* 0x02B4 */ Vec3f unk2B4;                      /* inferred */
    /* 0x02C0 */ char pad2C0[0x86];
    ...
    /* 0x034E */ u8 unk34E;                         /* inferred */
    /* 0x034F */ char pad34F[0x1];                  /* maybe part of unk34E[2]? */
    /* 0x0350 */ f32 unk350;                        /* inferred */
    /* 0x0354 */ f32 unk354;                        /* inferred */
    /* 0x0358 */ char pad358[0x4];                  /* maybe part of unk354[2]? */
    /* 0x035C */ ColliderCylinder unk35C;           /* inferred */
    /* 0x03A8 */ ColliderQuad unk3A8;               /* inferred */
    /* 0x0428 */ ColliderQuad unk428;               /* inferred */
    /* 0x04A8 */ s32 unk4A8;                        /* inferred */
    /* 0x04AC */ s32 unk4AC;                        /* inferred */
    /* 0x04B0 */ s16 unk4B0;                        /* inferred */
    /* 0x04B2 */ char pad4B2[0x2];                  /* maybe part of unk4B0[2]? */
    /* 0x04B4 */ s32 unk4B4;                        /* inferred */
    /* 0x04B8 */ s16 unk4B8;                        /* inferred */
    /* 0x04BA */ char pad4BA[0x2];                  /* maybe part of unk4B8[2]? */
    /* 0x04BC */ u32 unk4BC;                        /* inferred */
    /* 0x04C0 */ u16 unk4C0;                        /* inferred */
    /* 0x04C2 */ s16 unk4C2;                        /* inferred */
    /* 0x04C4 */ char pad4C4[0x4];                  /* maybe part of unk4C2[3]? */
    /* 0x04C8 */ Vec3f unk4C8;                      /* inferred */
    /* 0x04D4 */ Vec3f unk4D4;                      /* inferred */
    /* 0x04E0 */ f32 unk4E0;                        /* inferred */
    /* 0x04E4 */ f32 unk4E4;                        /* inferred */
    /* 0x04E8 */ f32 unk4E8;                        /* inferred */
    /* 0x04EC */ f32 unk4EC;                        /* inferred */
    /* 0x04F0 */ f32 unk4F0;                        /* inferred */
    /* 0x04F4 */ f32 unk4F4;                        /* inferred */
    /* 0x04F8 */ f32 unk4F8;                        /* inferred */
    /* 0x04FC */ f32 unk4FC;                        /* inferred */
    /* 0x0500 */ f32 unk500;                        /* inferred */
    /* 0x0504 */ char pad504[0x10];                 /* maybe part of unk500[5]? */
    /* 0x0514 */ s16 unk514;                        /* inferred */
    /* 0x0516 */ char pad516[0xACA];                /* maybe part of unk514[1382]? */
    /* 0x0FE0 */ Vec3f unkFE0;                      /* inferred */
} EnJso;                                            /* size 0xFEC */
...
void EnJso_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk144, &D_0600AA00, &D_060081F4, &this->unk188, &this->unk200, 0x14);
    this->actor.focus.pos.x = this->actor.world.pos.x;
    this->actor.focus.pos.y = this->actor.world.pos.y;
    this->actor.focus.pos.z = this->actor.world.pos.z;
    Collider_InitAndSetCylinder(globalCtx, &this->unk35C, &this->actor, &D_809B0F88);
    Collider_InitAndSetQuad(globalCtx, &this->unk3A8, &this->actor, &D_809B0FB4);
    Collider_InitAndSetQuad(globalCtx, &this->unk428, &this->actor, &D_809B0FB4);
    sp37E = 0xFF;
    sp1DD = 0xFF;
    sp37D = 0xFF;
    sp1DC = 0xFF;
    ...
    sp1DE = 0xFF;
    sp1DF = 0;
    Effect_Add(globalCtx, &this->unk4A8, 1, 0U, (u8) 0, &sp1EC);
    Effect_Add(globalCtx, &this->unk4AC, 1, 0U, (u8) 0, &sp4C);
    this->actor.gravity = -3.0f;
    this->unk34A = this->actor.params;
    this->actor.flags |= 0x8000000;
    this->unk514 = this->unk34A & 3;
    this->unk354 = 0.035f;
    func_809ADC7C(this);
}
...
void EnJso_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_DestroyCylinder(globalCtx, &this->unk35C);
    Collider_DestroyQuad(globalCtx, &this->unk3A8);
    Collider_DestroyQuad(globalCtx, &this->unk428);
    ...
    Effect_Destroy(globalCtx, this->unk4A8);
    Effect_Destroy(globalCtx, this->unk4AC);
}
...
void func_809ADBC8(EnJso *arg0, s32 arg1) {
    ...
    sp28 = temp_v1;
    sp2C = -4.0f;
    arg0->unk350 = (f32) SkelAnime_GetFrameCount(*temp_v1);
    phi_f0 = -4.0f;
    if ((arg1 == 3) || (arg1 == 9)) {
        phi_f0 = 0.0f;
    }
    SkelAnime_ChangeAnim(arg0 + 0x144, (AnimationHeader *) *temp_v1, 1.0f, 0.0f, arg0->unk350, (u8) (s32) *(&D_809B103C + arg1), phi_f0);
}
...
void func_809ADC7C(EnJso *arg0) {
    ...
    arg0->unk4B8 = arg0->actor.parent->unk15A;
}
...
void func_809ADCB8(EnJso *this, GlobalContext *globalCtx) {
    ...
    case 0:
        sp64 = temp_v1;
        if (ActorCutscene_GetCanPlayNext(this->unk4B8) == 0) {
            ActorCutscene_SetIntentToPlay(this->unk4B8);
            return;
        }
        sp64 = temp_v1;
        ActorCutscene_StartAndSetUnkLinkFields(this->unk4B8, &this->actor);
        func_800B7298(globalCtx, &this->actor, 0x15U);
        this->unk4C2 = ActorCutscene_GetCurrentCamera((s16) this->actor.cutscene);
        temp_a1 = &this->actor.world;
        temp_v1->world.pos.x = this->actor.home.pos.x + 30.0f;
        temp_v1->world.pos.z = this->actor.home.pos.z + 30.0f;
        this->actor.flags &= -2;
        this->unk4EC = temp_v1->world.pos.x;
        this->unk4F0 = temp_v1->world.pos.y;
        this->unk4F4 = temp_v1->world.pos.z;
        this->unk4F8 = temp_v1->world.pos.x;
        this->unk4FC = temp_v1->world.pos.y;
        this->unk500 = temp_v1->world.pos.z;
        sp44 = temp_a1;
        sp64 = temp_v1;
        temp_v0 = Math_Vec3f_Yaw(&temp_v1->world.pos, &temp_a1->pos);
        temp_v1->world.rot.y = temp_v0;
        temp_v1->shape.rot.y = temp_v0;
        Math_Vec3f_Copy(&this->unk4C8, (Vec3f *) &this->unk4EC);
        Math_Vec3f_Copy(&this->unk4D4, (Vec3f *) &this->unk4F8);
        func_809ADBC8(this, 1);
        this->actor.draw = func_809B0BB0;
        Audio_PlayActorSound2(&this->actor, 0x3812U);
        temp_v0_2 = this->unk514;
        ...
        if (temp_v0_2 != 0) {
            if (temp_v0_2 != 1) {
                ...
                func_800BBDAC(globalCtx, &this->actor, &sp44->pos, this->actor.shape.shadowScale, 1, 8.0f, (s16) 0x1F4, (s16) 0xA, (u8) 1);
        ...
        this->unk4BC = 0;
        this->unk4C0 = (s16) this->unk4C0 + 1;
    default:
block_55:
        sp38 = &this->unk4F8;
        sp3C = &this->unk4D4;
        sp40 = &this->unk4EC;
        sp44 = (PosRot *) &this->unk4C8;
        Math_SmoothStepToS(&this->unk29C, this->unk2A2, 1, 0xBB8, (s16) 0);
        Math_SmoothStepToS(&this->unk29E, this->unk2A4, 1, 0xBB8, (s16) 0);
        Math_SmoothStepToS(&this->unk2A0, this->unk2A6, 1, 0xBB8, (s16) 0);
        Math_SmoothStepToS(&this->unk290, this->unk296, 1, 0xBB8, (s16) 0);
        Math_SmoothStepToS(&this->unk292, this->unk298, 1, 0xBB8, (s16) 0);
        Math_SmoothStepToS(&this->unk294, this->unk29A, 1, 0xBB8, (s16) 0);
        Math_Vec3f_Copy(&sp44->pos, (Vec3f *) sp40);
        Math_Vec3f_Copy(sp3C, (Vec3f *) sp38);
        temp_a1_2 = this->unk4C2;
        if (temp_a1_2 != 0) {
            this->unk4E0 = 0.0f;
            this->unk4E4 = 1.0f;
            this->unk4E8 = 0.0f;
            func_8016981C(globalCtx, temp_a1_2, sp3C, sp44, &this->unk4E0);
        }
        return;
    case 1:
        temp_v1->world.pos.x = this->actor.home.pos.x + 30.0f;
        temp_v1->world.pos.z = this->actor.home.pos.z + 90.0f;
        this->unk4EC = temp_v1->world.pos.x - 170.0f;
        this->unk4F0 = temp_v1->world.pos.y + 30.0f;
        this->unk4F4 = temp_v1->world.pos.z - 80.0f;
        this->unk4F8 = temp_v1->world.pos.x + 200.0f;
        this->unk4FC = temp_v1->world.pos.y + 10.0f;
        this->unk500 = temp_v1->world.pos.z;
        sp60 = temp_f2;
        Math_ApproachF(&this->actor.shape.shadowScale, 16.0f, 0.4f, 4.0f);
        sp5E = 0;
        temp_v0_5 = this->unk514;
        if (temp_v0_5 != 0) {
            if (temp_v0_5 != 1) {
                if (temp_v0_5 != 2) {
                    if (temp_v0_5 != 3) {
                        ...
                        Math_ApproachF(&this->unk354, 0.035f, 0.2f, 0.03f);
                        if (this->unk354 >= 0.034f) {
                            this->unk354 = 0.035f;
                            sp5E = 1;
                        }
                    }
        ...
        if (sp5E != 0) {
            ...
            func_801518B0(globalCtx, *(&D_809B1004 + (this->unk348 * 2)), &this->actor);
            this->unk348 += 1;
            this->unk4BC = 0;
            this->unk4C0 = (s16) this->unk4C0 + 1;
            this->actor.shape.yOffset = 970.0f;
        ...
        goto block_55;
    case 2:
        this->unk4EC = temp_v1->world.pos.x - 30.0f;
        this->unk4F0 = temp_v1->world.pos.y + 30.0f;
        this->unk4F4 = temp_v1->world.pos.z + 70.0f;
        this->unk4F8 = temp_v1->world.pos.x - 20.0f;
        this->unk4FC = temp_v1->world.pos.y + 20.0f;
        this->unk500 = temp_v1->world.pos.z;
        Math_SmoothStepToS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 1, 0xBB8, (s16) 0);
        if ((func_80152498(&globalCtx->msgCtx) == 5) && (func_80147624(globalCtx) != 0)) {
            func_801477B4(globalCtx);
            func_80151938(globalCtx, *(&D_809B1004 + (this->unk348 * 2)));
            this->unk4BC = 0;
            this->unk348 += 1;
            this->unk4C0 = (s16) this->unk4C0 + 1;
        }
    ...
    case 3:
        ...
        temp_v0_6 = this->unk296;
        temp_a0_2 = temp_v0_6 - this->unk290;
        ...
        if (temp_v0_6 != 0) {
            ...
            if ((phi_v0 < 0x64) && (this->unk34D == 5)) {
                this->unk2A6 = -0x32C8;
                this->unk34D = 2;
                this->unk2A2 = -0x32C8;
                this->unk2A4 = -0xBB8;
                this->unk2A0 = this->unk2A6;
                sp64 = temp_v1;
                Audio_PlayActorSound2(&this->actor, 0x39C7U);
            }
        }
        this->unk4EC = globalCtx->actorCtx.actorList[2].first->world.pos.x + 100.0f;
        this->unk4F0 = globalCtx->actorCtx.actorList[2].first->world.pos.y + 60.0f;
        this->unk4F4 = globalCtx->actorCtx.actorList[2].first->world.pos.z - 30.0f;
        this->unk4F8 = globalCtx->actorCtx.actorList[2].first->world.pos.x - 35.0f;
        this->unk4FC = globalCtx->actorCtx.actorList[2].first->world.pos.y + 30.0f;
        this->unk500 = globalCtx->actorCtx.actorList[2].first->world.pos.z - 40.0f;
        if ((func_80152498((MessageContext *) sp44) == 5) && (func_80147624(globalCtx) != 0)) {
            func_801477B4(globalCtx);
            this->unk29A = 0;
            temp_v1_2 = this->unk29A;
            this->unk4BC = 0;
            this->unk298 = temp_v1_2;
            this->unk4C0 = (s16) this->unk4C0 + 1;
            this->unk296 = temp_v1_2;
            this->unk2A6 = temp_v1_2;
            this->unk2A4 = temp_v1_2;
            this->unk2A2 = temp_v1_2;
        }
        goto block_55;
    case 4:
        this->unk4EC = temp_v1->world.pos.x - 40.0f;
        temp_t2 = this->unk4BC + 1;
        this->unk4F0 = temp_v1->world.pos.y + 20.0f;
        this->unk4F4 = temp_v1->world.pos.z;
        temp_at = temp_t2 < 0xAU;
        this->unk4F8 = temp_v1->world.pos.x - 30.0f;
        this->unk4FC = temp_v1->world.pos.y + 40.0f;
        this->unk4BC = temp_t2;
        this->unk500 = temp_v1->world.pos.z - 130.0f;
        if (temp_at == 0) {
            this->unk34D = 0;
            Audio_PlayActorSound2(&this->actor, 0x39C7U);
    ...
    case 5:
        ...
        if (temp_at_2 == 0) {
            ...
            ActorCutscene_Stop(this->unk4B8);
            this->unk294 = 0;
            temp_v1_3 = this->unk294;
            ...
            this->unk292 = temp_v1_3;
            this->unk290 = temp_v1_3;
            this->unk2A0 = temp_v1_3;
            this->unk29E = temp_v1_3;
            this->unk29C = temp_v1_3;
...
void func_809AE754(EnJso *arg0, GlobalContext *arg1) {
    ...
    sp38 = temp_a2;
    Math_Vec3f_Copy(&temp_a2->pos, &arg0->actor.home.pos);
    arg0->actor.floorHeight = arg0->actor.home.pos.y;
    func_800BBDAC(arg1, &arg0->actor, &temp_a2->pos, arg0->actor.shape.shadowScale, 1, 8.0f, (s16) 0x1F4, (s16) 0xA, (u8) 1);
    arg0->actor.flags |= 0x8000000;
    Audio_PlayActorSound2(&arg0->actor, 0x3812U);
    arg0->unk4B4 = 0;
    arg0->unk27C = 1;
...
void func_809AEA08(EnJso *this, GlobalContext *globalCtx) {
    ...
    if (func_801378B8(sp28, 12.0f) != 0) {
        ...
        if (Rand_ZeroFloat(1.0f) < 0.5f) {
            this->unk280 = (s16) -(s32) this->unk280;
        }
    }
    if ((this->unk286 == 0) && (D_809B0F40 == 0) && ((D_809B0F44 == 0) || (this->unk28C != 0))) {
        D_809B0F40 = 1;
        this->unk28E = 1;
        this->unk27C = 4;
        this->actor.speedXZ = 0.0f;
    ...
    this->unk27E += this->unk280;
    sp34 = (Math_SinS(this->unk27E) * 200.0f) + sp40->world.pos.x;
    sp38 = this->actor.world.pos.y;
    sp3C = (Math_CosS(this->unk27E) * 200.0f) + sp40->world.pos.z;
...
void func_809AECA8(Actor *arg0) {
    ...
    arg0->unk278 = func_809AED00;
    arg0->unk36D = (u8) (arg0->unk36D | 4);
}

void func_809AED00(EnJso *this, GlobalContext *globalCtx) {
    if (this->unk350 <= this->unk144.animCurrentFrame) {
        this->unk28A = 0;
        if (this->unk28E != 0) {
            this->unk28E = 0;
            D_809B0F40 = 0;
...
void func_809AEEC0(EnJso *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk3A8.base.atFlags;
    if ((((temp_v0 & 4) != 0) || ((this->unk428.base.atFlags & 4) != 0)) && (this->unk3A8.base.atFlags = temp_v0 & 0xFFF9, this->unk428.base.atFlags &= 0xFFF9, (this->unk34D == 0))) {
        Matrix_RotateY(this->actor.yawTowardsPlayer, 0U);
        temp_a0 = &sp24;
        sp24 = 0.0f;
        sp28 = 0.0f;
        sp2C = -10.0f;
        SysMatrix_MultiplyVector3fByState((Vec3f *) temp_a0, &this->unkFE0);
        this->unk34D = 1;
        this->unk282 = 0;
        this->unk34C = 1;
    ...
    if (!(this->unk144.animCurrentFrame < this->unk350)) {
        temp_v0_2 = this->actor.yawTowardsPlayer - this->actor.shape.rot.y;
        phi_v1 = temp_v0_2 << 0x10;
        if ((s32) temp_v0_2 < 0) {
            phi_v1 = (s32) temp_v0_2 * -0x10000;
        }
        if ((this->unk282 == 0) || (this->actor.xzDistToPlayer < 100.0f) || ((phi_v1 >> 0x10) >= 0x4301)) {
            func_801A0654(&this->actor.projectedPos, 0x39BE, 0);
...
void func_809AF110(EnJso *this, GlobalContext *globalCtx) {
    ...
    phi_v0 = temp_v0;
    if (((temp_v0 & 2) != 0) || (temp_v1 = this->unk428.base.atFlags, phi_v1 = temp_v1, ((temp_v1 & 2) != 0))) {
        this->unk34E = 1;
        this->unk3A8.base.atFlags = temp_t5;
        temp_t7 = this->unk428.base.atFlags & 0xFFFD;
        this->unk428.base.atFlags = temp_t7;
        phi_v0 = temp_t5 & 0xFF;
        phi_v1 = temp_t7 & 0xFF;
    }
    if ((((phi_v0 & 4) != 0) || ((phi_v1 & 4) != 0)) && (this->unk3A8.base.atFlags = phi_v0 & 0xFFF9, this->unk428.base.atFlags = phi_v1 & 0xFFF9, (this->unk34D == 0))) {
        Matrix_RotateY(this->actor.yawTowardsPlayer, 0U);
        temp_a0 = &sp40;
        sp40 = 0.0f;
        sp44 = 0.0f;
...
void func_809AF2F8(EnJso *this, GlobalContext *globalCtx) {
    if (this->unk288 == 0) {
        ...
        this->unk35C.base.colType = 0xA;
        this->unk35C.base.acFlags |= 4;
        this->unk34E = 0;
        D_809B0F40 = 0;
        this->unk28E = 0;
        func_809AE9B0(this, globalCtx);
...
void func_809AF368(EnJso *arg0) {
    ...
    arg0->unk35C.base.acFlags &= 0xFFFB;
    arg0->unk288 = 0x1E;
    arg0->unk27C = 9;
...
void func_809AF470(EnJso *arg0) {
    ...
    arg0->unk288 = 0x1E;
    arg0->actor.speedXZ = 0.0f;
    if (((temp_v0 == 0xB) || (temp_v0 == 0xA)) && (arg0->unk2A8 == 0)) {
        arg0->unk2A8 = 0;
        arg0->unk2AA = 0;
    }
    arg0->unk288 = 0x28;
    ...
    Math_Vec3f_Copy(&arg0->unkFE0, &sp24);
    arg0->unk27C = 8;
    arg0->unk35C.base.acFlags &= 0xFFFB;
...
void func_809AF53C(EnJso *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk288 == 0) && (this->unk2A8 == 0)) {
        temp_v0_2 = this->unk2AA;
        if ((temp_v0_2 == 0xB) || (temp_v0_2 == 0xA)) {
            func_800BF7CC(globalCtx, &this->actor, (Vec3f []) &this->unk2B4, 0xC, 2, 0.3f, 0.2f);
            this->unk2A8 = 0;
            this->unk2AA = 0;
        }
        func_809AF76C(this);
...
void func_809AF5F8(EnJso *arg0, GlobalContext *arg1) {
    ...
    Math_Vec3f_Copy(&arg0->unkFE0, &sp34);
    temp_v0 = arg0->unk2AA;
    if (((temp_v0 == 0xB) || (temp_v0 == 0xA)) && (arg0->unk2A8 != 0)) {
        func_800BF7CC(arg1, &arg0->actor, (Vec3f []) &arg0->unk2B4, 0xC, 2, 0.3f, 0.2f);
        arg0->unk2A8 = 0;
        arg0->unk2AA = 0;
    }
...
void func_809AF7F4(EnJso *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk288 == 0) || ((this->unk350 <= sp2C) && ((this->actor.bgCheckFlags & 1) != 0))) {
        this->actor.world.rot.x = 0;
        this->actor.velocity.y = 0.0f;
        this->actor.speedXZ = 0.0f;
        this->unk288 = 0;
        ...
        this->unk286 = Rand_S16Offset(0xA, 0xA);
        func_809AE9B0(this, globalCtx);
    }
}
...
block_4:
        if ((this->unk350 <= this->unk144.animCurrentFrame) && (this->unk288 == 0)) {
            func_809AFA58(this, globalCtx);
        }
    }
}
...
void func_809AFA58(EnJso *arg0, GlobalContext *arg1) {
    ...
    arg0->actor.flags |= 9;
    func_800BC154(arg1, arg1 + 0x1CA0, &arg0->actor, 4U);
...
void func_809AFAF4(EnJso *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = globalCtx->actorCtx.actorList[2].first;
    temp_a0 = globalCtx;
    if (!(this->unk144.animCurrentFrame < this->unk350) && (sp20 = temp_v1, this = this, globalCtx = globalCtx, temp_a2 = this, (func_801690CC(temp_a0) == 0)) && (globalCtx->msgCtx.unk11F10 == 0)) {
        if (fabsf(temp_v1->world.pos.y - temp_a2->actor.world.pos.y) < 60.0f) {
            temp_v0 = globalCtx->actorCtx.actorList[2].first;
            temp_t9 = *(&D_809B1004 + (temp_a2->unk348 * 2));
            temp_a2->actor.textId = temp_t9;
            this = temp_a2;
            sp1C = temp_v0;
            func_801518B0(globalCtx, temp_t9 & 0xFFFF, &temp_a2->actor);
            temp_v0->freezeTimer = 3;
            temp_v0->unkA6C = (s32) (temp_v0->unkA6C | 0x10000000);
            this->actor.flags |= 0x8000000;
...
void func_809AFC10(EnJso *this, GlobalContext *globalCtx) {
    ...
    if (((s32) temp_v1 >= 0x1BB2) && ((s32) temp_v1 < 0x1BB7)) {
        temp_t9 = *(&D_809B1004 + (this->unk348 * 2));
        this->actor.textId = temp_t9;
        func_801518B0(globalCtx, temp_t9 & 0xFFFF, &this->actor);
        return;
    }
    this = this;
    globalCtx = globalCtx;
...
void func_809AFE38(EnJso *this, GlobalContext *globalCtx) {
    ...
    if ((func_80152498(&globalCtx->msgCtx) == 5) && (func_80147624(globalCtx) != 0)) {
        ...
        do {
            ...
            spF4.x += randPlusMinusPoint5Scaled(30.0f);
            spF4.y = this->actor.floorHeight;
            spF4.z += randPlusMinusPoint5Scaled(30.0f);
            func_800B3030(globalCtx, temp_s1, phi_s0, phi_s0, (s16) (s32) ((Rand_ZeroFloat(1.0f) * 100.0f) + 100.0f), (s16) (s32) (s16) (s32) 20.0f, 1);
            temp_s0 = phi_s0 + 0xC;
            phi_s0 = temp_s0;
        ...
        sp74->unkA6C = (s32) (sp74->unkA6C & 0xEFFFFFFF);
...
void func_809B0034(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 & 2) != 0) {
        ...
        arg0->unk36D = (u8) (temp_v0 & 0xFFFD);
        if ((temp_v1 == 1) || (temp_v1 == 5)) {
            temp_v0_4 = arg0->unk2AA;
            if (((temp_v0_4 != 0xB) && (temp_v0_4 != 0xA)) || (arg0->unk2A8 == 0)) {
            ...
            if (temp_v1 != 2) {
                if (temp_v1 != 3) {
                    if (temp_v1 != 4) {
                        ...
                        temp_v0_2 = arg0->unk2AA;
                        if (((temp_v0_2 != 0xB) && (temp_v0_2 != 0xA)) || (arg0->unk2A8 == 0)) {
                    ...
                    temp_v0_3 = arg0->unk2AA;
                    if (((temp_v0_3 != 0xB) && (temp_v0_3 != 0xA)) || (arg0->unk2A8 == 0)) {
                        sp3C = 0;
...
void EnJso_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk27C != 2) && (this->unk346 == 0)) {
        SkelAnime_FrameUpdateMatrix(&this->unk144);
    }
    func_809B0034(&this->actor, globalCtx);
    if (this->actor.isTargeted != 0) {
        D_809B0F44 = 1;
        this->unk28C = 1;
    } else if (this->unk28C != 0) {
        this->unk28C = 0;
        D_809B0F44 = 0;
    }
    ...
    temp_v0 = this->unk282;
    if (temp_v0 != 0) {
        this->unk282 = temp_v0 - 1;
    }
    temp_v0_2 = this->unk286;
    if (temp_v0_2 != 0) {
        this->unk286 = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk288;
    if (temp_v0_3 != 0) {
        this->unk288 = temp_v0_3 - 1;
    }
    temp_v0_4 = this->unk2A8;
    if (temp_v0_4 != 0) {
        this->unk2A8 = temp_v0_4 - 1;
    }
    if (this->unk27C != 0xE) {
    ...
    Actor_SetScale(&this->actor, this->unk354);
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    this->actor.world.pos.x += this->unkFE0.x;
    this->actor.world.pos.z += this->unkFE0.z;
    if ((this->actor.bgCheckFlags & 1) != 0) {
        Math_ApproachZeroF(&this->unkFE0.x, 1.0f, 2.0f);
        Math_ApproachZeroF(&this->unkFE0.z, 1.0f, 2.0f);
    }
    if (this->unk27C != 1) {
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 35.0f, 40.0f, 40.0f, 0x1FU);
    }
    if ((this->unk27C == 4) || (this->unk27C == 5)) {
        this->unk4B0 += 1;
        phi_v1 = &this->unk188;
        phi_a0 = &this->unk18E;
        phi_a1 = &this->unk194;
        phi_a2 = &this->unk19A;
        if ((s32) this->unk4B0 >= 0x14) {
            this->unk4B0 = 0;
        }
        temp_v0_5 = this->unk4B4;
        if (temp_v0_5 < 0x13) {
            this->unk4B4 = temp_v0_5 + 1;
        }
        temp_t8 = this + (this->unk4B0 * 0xC);
        temp_t8->unk518 = (f32) this->actor.world.pos.x;
        temp_t8->unk51C = (f32) this->actor.world.pos.y;
        temp_t8->unk520 = (f32) this->actor.world.pos.z;
        temp_t0 = this + (this->unk4B0 * 0xC);
        temp_t0->unk51C = (f32) (temp_t0->unk51C + 40.0f);
        temp_t4 = this + (this->unk4B0 * 6);
        temp_t4->unk608 = (unaligned s32) this->unk30;
        temp_t4->unk60C = (u16) this->actor.world.rot.z;
        phi_v0 = 0;
        do {
            temp_t4_2 = this + (this->unk4B0 * 0x78) + phi_v0;
            temp_t4_2->unk680 = (unaligned s32) phi_v1->unk0;
            temp_a0 = phi_a0 + 0x18;
            temp_t4_2->unk684 = (u16) phi_v1->z;
            temp_t4_3 = this + (this->unk4B0 * 0x78) + phi_v0;
            temp_t4_3->unk686 = (unaligned s32) temp_a0->unk-18;
            temp_a1 = phi_a1 + 0x18;
            temp_a2 = phi_a2 + 0x18;
            temp_t4_3->unk68A = (u16) temp_a0->unk-14;
            temp_t4_4 = this + (this->unk4B0 * 0x78) + phi_v0;
            temp_t4_4->unk68C = (unaligned s32) temp_a1->unk-18;
            temp_t4_4->unk690 = (u16) temp_a1->unk-14;
            temp_t4_5 = this + (this->unk4B0 * 0x78) + phi_v0;
            temp_t4_5->unk692 = (unaligned s32) temp_a2->unk-18;
            temp_v0_6 = phi_v0 + 0x18;
            temp_t4_5->unk696 = (u16) temp_a2->unk-14;
            phi_v1 += 0x18;
            phi_v0 = temp_v0_6;
            phi_a0 = temp_a0;
            phi_a1 = temp_a1;
    ...
    if ((temp_v0_8 != 0) && (temp_v0_8 != 1) && (temp_v0_8 != 0xB) && (temp_v0_8 != 4) && (temp_v0_8 != 0xD) && (temp_v0_8 != 0xE) && (temp_v0_8 != 0xF)) {
        ...
        if ((this->unk27C == 6) && (this->unk34E == 0) && (this->unk34D == 0)) {
            CollisionCheck_SetAT(globalCtx, sp30, &this->unk3A8.base);
            CollisionCheck_SetAT(globalCtx, sp30, &this->unk428.base);
        }
    }
}
...
void func_809B0820(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 4) {
        ...
        SysMatrix_MultiplyVector3fByState(&D_809B10B4, &sp48);
        SysMatrix_MultiplyVector3fByState(&D_809B10C0, &sp3C);
        temp_v0 = arg4->unk27C;
        if (((temp_v0 == 6) || (temp_v0 == 5)) && (arg4->unk34C == 0)) {
            func_800A81F0(Effect_GetParams(arg4->unk4AC), &sp48, &sp3C);
        } else if (arg4->unk34C == 1) {
            func_800A8514(Effect_GetParams(arg4->unk4AC));
        }
    }
    if (arg1 == 6) {
        if (arg4->unk34D == 1) {
        ...
        SysMatrix_MultiplyVector3fByState(&D_809B10B4, &sp48);
        SysMatrix_MultiplyVector3fByState(&D_809B10C0, &sp3C);
        temp_v0_2 = arg4->unk27C;
        if (((temp_v0_2 == 6) || (temp_v0_2 == 5)) && (arg4->unk34C == 0)) {
            func_800A81F0(Effect_GetParams(arg4->unk4A8), &sp48, &sp3C);
        } else if (arg4->unk34C == 1) {
            func_800A8514(Effect_GetParams(arg4->unk4A8));
            arg4->unk34C = 0U;
        }
    }
    if ((arg1 == 4) || (arg1 == 6) || (arg1 == 7) || (arg1 == 8) || (arg1 == 9) || (arg1 == 0xA) || (arg1 == 0xB) || (arg1 == 0xC) || (arg1 == 0xE) || (arg1 == 0x10) || (arg1 == 0x11) || (arg1 == 0x13)) {
        SysMatrix_GetStateTranslation(arg4 + (arg4->unk344 * 0xC) + 0x2B4);
        arg4->unk344 = (s16) (arg4->unk344 + 1);
        if ((s32) arg4->unk344 >= 0xC) {
            arg4->unk344 = 0;
        }
    }
    SysMatrix_StatePop();
...
void func_809B0BB0(Actor *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk148, this->unk164, (s32) this->unk146, func_809B0734, func_809B0820, this);
    temp_v0 = this->unk4B4;
    if (temp_v0 > 0) {
        phi_s2 = this->unk4B0;
        if (temp_v0 > 0) {
            ...
            do {
                if (*phi_s4 == 0) {
                    phi_t2 = this->unk4B4 * 2;
                } else {
                    temp_v0_2 = this + (phi_s2 * 0xC);
                    temp_s0 = this + (phi_s2 * 6);
                    SysMatrix_InsertTranslation(temp_v0_2->unk518, temp_v0_2->unk51C, temp_v0_2->unk520, 0);
                    temp_f12 = this->unk354;
                    Matrix_Scale(temp_f12, temp_f12, temp_f12, 1);
                    Matrix_RotateY((s16) (s32) ((f32) temp_s0->unk60A * 0.0000958738f), 1U);
                    SysMatrix_InsertXRotation_s((s16) (s32) ((f32) temp_s0->unk608 * 0.0000958738f), 1);
                    SysMatrix_InsertZRotation_s((s16) (s32) ((f32) temp_s0->unk60C * 0.0000958738f), 1);
                    ...
                    temp_s2 = phi_s2 - 1;
                    temp_s3->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk148, this + (phi_s2 * 0x78) + 0x680, (s32) this->unk146, NULL, NULL, this, temp_s3->polyXlu.p);
                    phi_s2 = (s16) temp_s2;
                    if (temp_s2 < 0) {
                        phi_s2 = 0x13;
                    }
    ...
    temp_v1_2 = this->unk2A8;
    if (temp_v1_2 != 0) {
        temp_v0_6 = this->unk2AA;
        if ((temp_v0_6 == 0xB) || (temp_v0_6 == 0xA)) {
            this->unk2AC = (f32) (this->unk2AC + 0.3f);
            if (this->unk2AC > 0.5f) {
                this->unk2AC = 0.5f;
            }
            Math_ApproachF(this + 0x2B0, this->unk2AC, 0.1f, 0.04f);
        } else {
            this->unk2AC = 0.8f;
            this->unk2B0 = 0.8f;
        }
        func_800BE680(globalCtx, this, (Vec3f []) (this + 0x2B4), 0xC, this->unk2AC, this->unk2B0, (f32) temp_v1_2 * 0.05f, (u8) (s32) this->unk2AA);
    }
}
