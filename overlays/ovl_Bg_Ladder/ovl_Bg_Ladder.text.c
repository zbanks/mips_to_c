...
void BgLadder_Init(BgLadder *this, GlobalContext *globalCtx) {
    s16 temp_v0;
...
void BgLadder_Destroy(BgLadder *this, GlobalContext *globalCtx) {
    BgLadder *this = (BgLadder *) thisx;
...
void BgLadder_Update(BgLadder *this, GlobalContext *globalCtx) {
    BgLadder *this = (BgLadder *) thisx;
    this->action(this, globalCtx);
}

void BgLadder_Draw(BgLadder *this, GlobalContext *globalCtx) {
    Gfx *sp1C;
