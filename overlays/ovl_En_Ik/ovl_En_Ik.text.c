typedef struct EnIk {
    ...
    /* 0x2F4 */ char pad2F4[0x1];
    /* 0x2F5 */ u8 unk2F5;                          /* inferred */
    /* 0x2F6 */ char pad2F6[0x6];                   /* maybe part of unk2F5[7]? */
    ...
    /* 0x310 */ Vec3f unk310;                       /* inferred */
    /* 0x31C */ char pad31C[0x90];                  /* maybe part of unk310[13]? */
    /* 0x3AC */ ColliderCylinder unk3AC;            /* inferred */
    /* 0x3F8 */ ColliderQuad unk3F8;                /* inferred */
    /* 0x478 */ ColliderTris unk478;                /* inferred */
    /* 0x498 */ ColliderTrisElement unk498;         /* inferred */
    /* 0x4F4 */ char pad4F4[0x174];                 /* maybe part of unk498[5]? */
} EnIk;                                             /* size = 0x668 */
...
struct _mips2c_stack_func_8092B93C {
    ...
    /* 0x78 */ char pad78[0x8];                     /* maybe part of sp76[5]? */
...
void EnIk_Init(EnIk *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetTris(globalCtx, &this->unk478, (Actor *) this, &D_8092C0C0, &this->unk498);
    Collider_InitAndSetQuad(globalCtx, &this->unk3F8, (Actor *) this, &D_8092C0D0);
...
void func_8092B098(Actor *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCanPlayNext((s16) arg0->cutscene) != 0) {
        ...
        if (temp_a0 != -1) {
            ...
            Play_CameraSetAtEye(arg1, arg0->unk2FA, (Vec3f *) &arg0->focus, (Vec3f *) &sp24);
        }
        if (arg0->colChkInfo.health != 0) {
...
void EnIk_Update(EnIk *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk3F8.base.atFlags & 1) != 0) {
        CollisionCheck_SetAT(globalCtx, sp3C, (Collider *) &this->unk3F8);
    }
...
void func_8092B93C(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if ((arg1 == 0x11) && (arg4->unk2F6 != arg4->unk2F8) && ((temp_v0_2 = arg4->unk2F0, (func_8092A33C == temp_v0_2)) || (func_8092A754 == temp_v0_2) || (func_8092A994 == temp_v0_2))) {
        ...
        if ((arg4->unk408 & 1) != 0) {
            func_800A81F0(Effect_GetParams(arg4->unk300), (Vec3f *) &sp50, (Vec3f *) &sp44);
        }
...
void EnIk_Draw(EnIk *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_8092B900, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_8092B93C, (Actor *) this);
    func_8092BC6C(this, (GraphicsContext **) globalCtx);
    if (this->actor.colorFilterTimer != 0) {
        func_800AE5A0(globalCtx);
    }
    func_800BC620((Vec3f *) &this->actor.focus, &D_8092C200, 0xFF, globalCtx);
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk310, 0xD, this->unk308, this->unk30C, this->unk304, (u8) (s32) this->unk2F5);
}
