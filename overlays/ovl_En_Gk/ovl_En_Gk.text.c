...
static ActorAnimationEntry D_80B53268 = {
...
static AnimationHeaderCommon *D_80B53340 = {
...
static ?32 D_80B53498 = 0x44898000;                 /* const */

typedef struct EnGk {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ ColliderCylinder unk144;           /* inferred */
    /* 0x0190 */ SkelAnime unk190;                  /* inferred */
    /* 0x01D4 */ void (*actionFunc)(EnGk *, GlobalContext *);
    /* 0x01D8 */ Vec3s unk1D8;                      /* inferred */
    /* 0x01DE */ Vec3s unk1DE;                      /* inferred */
    /* 0x01E4 */ u16 unk1E4;                        /* inferred */
    /* 0x01E6 */ char pad1E6[0x2];                  /* maybe part of unk1E4[2]? */
    /* 0x01E8 */ Path *unk1E8;                      /* inferred */
    /* 0x01EC */ char pad1EC[0x4];                  /* maybe part of unk1E8[2]? */
    /* 0x01F0 */ Vec3s unk1F0;                      /* inferred */
    /* 0x01F6 */ char pad1F6[0x72];                 /* maybe part of unk1F0[20]? */
    /* 0x0268 */ Vec3s unk268;                      /* inferred */
    /* 0x026E */ char pad26E[0x72];                 /* maybe part of unk268[20]? */
    /* 0x02E0 */ s16 unk2E0;                        /* inferred */
    /* 0x02E2 */ s16 unk2E2;                        /* inferred */
    /* 0x02E4 */ s16 unk2E4;                        /* inferred */
    /* 0x02E6 */ char pad2E6[0x1A];                 /* maybe part of unk2E4[14]? */
    ...
    /* 0x031A */ char pad31A[0x3A];                 /* maybe part of unk318[30]? */
...
? func_80B5100C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp40.x = sp4C->world.pos.x;
    sp40.y = sp4C->world.pos.y;
    sp40.z = sp4C->world.pos.z;
    sp44 = sp4C->unkC44 + 3.0f;
    sp34.x = arg0->world.pos.x;
    sp34.y = arg0->world.pos.y;
    sp34.z = arg0->world.pos.z;
    sp38 += 70.0f;
    Math_SmoothStepToS(arg0 + 0x31E, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk322), 4, 0x2AA8, (s16) 1);
    ...
    Math_SmoothStepToS(arg0 + 0x322, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk31E), 4, 0x2AA8, (s16) 1);
...
void func_80B51308(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_t8 = arg0->unk31A;
    arg0 = arg0;
    if ((arg0->unk2E4 == 7) && (sp1E == SkelAnime_GetFrameCount(&(&D_80B53268)[temp_t8].animation->common))) {
        arg0->unk2E4 = 8;
...
void func_80B51698(void *arg0, ? arg1) {
    ...
    if (sp26 == SkelAnime_GetFrameCount(&(&D_80B53268)[arg0->unk2E4].animation->common)) {
        temp_v0 = arg0->unk2E4;
        if (temp_v0 != 0) {
            if (temp_v0 != 2) {
                return;
...
void func_80B51760(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 0xB) {
        sp2E = (s16) temp_f6;
        if ((s16) temp_f6 == SkelAnime_GetFrameCount(&(&D_80B53268)[temp_v0].animation->common)) {
            arg0->unk2E4 = 5;
...
void func_80B521E8(void *arg0, ? arg1) {
    ...
    arg0 = arg0;
    temp_a0 = arg0 + 0x190;
    if (sp1E == SkelAnime_GetFrameCount(&(&D_80B53268)[temp_t8].animation->common)) {
        arg0->unk2E4 = 1;
        arg0 = arg0;
...
void func_80B5227C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp26 = (s16) (s32) arg0->unk1A8;
    if ((sp26 + 1) == SkelAnime_GetFrameCount(&(&D_80B53268)[arg0->unk2E4].animation->common)) {
...
void EnGk_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1_2, &this->actor, &D_80B53210);
...
void EnGk_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 1) || ((temp_v0 == 0) && ((gSaveContext.weekEventReg[22] & 4) == 0))) {
        func_80B507A0(&this->actor, globalCtx);
        ...
        if ((this->actor.params & 0xF) == 1) {
            func_80B5123C(&this->actor, globalCtx);
        }
        func_80B50B38(this, globalCtx);
        phi_v0 = this->actor.params & 0xF;
    }
    if (phi_v0 == 0) {
        func_80B51510(&this->actor, globalCtx);
    }
}
...
void func_80B52AF0(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    temp_a2 = &sp40;
    sp58.x = D_80B533A8.unk0;
    sp58.y = D_80B533A8.unk4;
    sp58.z = D_80B533A8.unk8;
...
block_7:
    ...
    if (arg1 == 0x11) {
        ...
        SysMatrix_MultiplyVector3fByState(&sp58, arg4 + 0x3C);
...
void EnGk_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80B52AD4, func_80B52AF0, func_80B52D8C, &this->actor);
    if ((this->actor.params & 0xF) != 2) {
        func_8012C2DC(globalCtx->state.gfxCtx);
        temp_v0_5 = this->unk2E4;
        if ((temp_v0_5 == 0) || (temp_v0_5 == 1) || (temp_v0_5 == 2) || (temp_v0_5 == 3) || (phi_a0 = &sp5C, (temp_v0_5 == 4))) {
            temp_a0_2 = &sp5C;
