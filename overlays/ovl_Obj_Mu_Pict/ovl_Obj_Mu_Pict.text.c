struct _mips2c_stack_ObjMuPict_Destroy {};          /* size 0x0 */

struct _mips2c_stack_ObjMuPict_Draw {};             /* size 0x0 */

struct _mips2c_stack_ObjMuPict_Init {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjMuPict_Update {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80C06B5C {};              /* size 0x0 */

struct _mips2c_stack_func_80C06B70 {
    /* 0x00 */ char pad0[0x26];
    /* 0x26 */ s16 sp26;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80C06C54 {};              /* size 0x0 */

struct _mips2c_stack_func_80C06C68 {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80C06CC4 {};              /* size 0x0 */

struct _mips2c_stack_func_80C06CD8 {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80C06D90 {};              /* size 0x0 */

struct _mips2c_stack_func_80C06DC8 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80C06E88 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

void ObjMuPict_Init(ObjMuPict *this, GlobalContext *globalCtx) {
...
void ObjMuPict_Destroy(ObjMuPict *this, GlobalContext *globalCtx) {
    ObjMuPict *this = (ObjMuPict *) thisx;
...
void func_80C06C68(ObjMuPict *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext((s16) temp_a0) != 0) {
        ...
        this = temp_a1;
        ActorCutscene_Start((s16) temp_a0_2, (Actor *) temp_a1);
        func_80C06CC4(this);
        return;
    }
...
void func_80C06DC8(ObjMuPict *this, GlobalContext *globalCtx) {
    if (this->unk14A == 0) {
        if (this->unk148 == 0) {
            this->unk148 = 1;
            func_801518B0(globalCtx, 0x159AU, (Actor *) this);
            this->textId = 0x159A;
            return;
        }
        func_801518B0(globalCtx, 0x159DU, (Actor *) this);
        this->textId = 0x159D;
        return;
    }
    if (this->unk148 == 0) {
        this->unk148 = 1;
        func_801518B0(globalCtx, 0x15A0U, (Actor *) this);
        this->textId = 0x15A0;
        return;
    }
    func_801518B0(globalCtx, 0x15A3U, (Actor *) this);
    this->textId = 0x15A3;
}
...
void func_80C06E88(ObjMuPict *this, GlobalContext *globalCtx) {
    ...
    if (func_80147624(temp_a0) != 0) {
        ...
        switch (temp_t6) {
        case 5530:
            func_801518B0(globalCtx, 0x159BU, (Actor *) this);
            this->textId = 0x159B;
            return;
        case 5531:
            func_801518B0(globalCtx, 0x159CU, (Actor *) this);
            this->textId = 0x159C;
            return;
        case 5533:
            func_801518B0(globalCtx, 0x159EU, (Actor *) this);
            this->textId = 0x159E;
            return;
        case 5534:
            func_801518B0(globalCtx, 0x159FU, (Actor *) this);
            this->textId = 0x159F;
            return;
        case 5536:
            func_801518B0(globalCtx, 0x15A1U, (Actor *) this);
            this->textId = 0x15A1;
            return;
        case 5537:
            func_801518B0(globalCtx, 0x15A2U, (Actor *) this);
            this->textId = 0x15A2;
            return;
        case 5539:
            func_801518B0(globalCtx, 0x15A4U, (Actor *) this);
            this->textId = 0x15A4;
...
void ObjMuPict_Update(ObjMuPict *this, GlobalContext *globalCtx) {
    ObjMuPict *this = (ObjMuPict *) thisx;
    this->actionFunc(this, globalCtx);
}

void ObjMuPict_Draw(ObjMuPict *this, GlobalContext *globalCtx) {
    ObjMuPict *this = (ObjMuPict *) thisx;
