...
void BgIkanaDharma_Init(BgIkanaDharma *this, GlobalContext *globalCtx) {
...
void BgIkanaDharma_Destroy(BgIkanaDharma *this, GlobalContext *globalCtx) {
...
void BgIkanaDharma_Update(BgIkanaDharma *this, GlobalContext *globalCtx) {
    s16 sp2E;
    f32 sp28;
...
void BgIkanaDharma_Draw(BgIkanaDharma *this, GlobalContext *globalCtx) {
    BgIkanaDharma *this = (BgIkanaDharma *) thisx;
