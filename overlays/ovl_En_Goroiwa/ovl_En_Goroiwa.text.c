typedef struct EnGoroiwa {
    ...
    /* 0x164 */ char pad164[0x40];                  /* maybe part of unk144[3]? */
    /* 0x1A4 */ void (*actionFunc)(EnGoroiwa *, GlobalContext *);
    /* 0x1A8 */ char pad1A8[0x24];                  /* maybe part of actionFunc[10]? */
    /* 0x1CC */ s16 unk1CC;                         /* inferred */
    /* 0x1CE */ char pad1CE[0x2];
    /* 0x1D0 */ void *unk1D0;                       /* inferred */
    /* 0x1D4 */ char pad1D4[0xC];                   /* maybe part of unk1D0[4]? */
    /* 0x1E0 */ f32 unk1E0;                         /* inferred */
    /* 0x1E4 */ s8 unk1E4;                          /* inferred */
    /* 0x1E5 */ u8 unk1E5;                          /* inferred */
    /* 0x1E6 */ char pad1E6[0x62];                  /* maybe part of unk1E5[99]? */
...
struct _mips2c_stack_func_8093FC6C {
    ...
    /* 0x84 */ char pad84[0x24];                    /* maybe part of sp80[10]? */
...
struct _mips2c_stack_func_80940090 {
    /* 0x000 */ char pad0[0xA8];
    /* 0x0A8 */ s32 spA8;                           /* inferred */
    /* 0x0AC */ char padAC[0x2C];                   /* maybe part of spA8[12]? */
    /* 0x0D8 */ s32 spD8;                           /* inferred */
    /* 0x0DC */ char padDC[0x10];                   /* maybe part of spD8[5]? */
    ...
    /* 0x124 */ char pad124[0xC];
};                                                  /* size = 0x130 */

struct _mips2c_stack_func_80940588 {
    /* 0x000 */ char pad0[0xA4];
    /* 0x0A4 */ f32 spA4;                           /* inferred */
    /* 0x0A8 */ s32 spA8;                           /* inferred */
    /* 0x0AC */ f32 spAC;                           /* inferred */
    /* 0x0B0 */ f32 spB0;                           /* inferred */
    /* 0x0B4 */ char padB4[0x14];                   /* maybe part of spB0[6]? */
    /* 0x0C8 */ s16 spC8;                           /* inferred */
    /* 0x0CA */ char padCA[0x4];                    /* maybe part of spC8[3]? */
    /* 0x0CE */ s16 spCE;                           /* inferred */
    /* 0x0D0 */ s32 spD0;                           /* inferred */
    /* 0x0D4 */ char padD4[0x4];
    /* 0x0D8 */ s32 spD8;                           /* inferred */
    /* 0x0DC */ char padDC[0xC];                    /* maybe part of spD8[4]? */
...
struct _mips2c_stack_func_80940A1C {
    ...
    /* 0xAC */ f32 spAC;                            /* inferred */
    /* 0xB0 */ char padB0[0x18];                    /* maybe part of spAC[7]? */
    /* 0xC8 */ s32 spC8;                            /* inferred */
    /* 0xCC */ char padCC[0x10];                    /* maybe part of spC8[5]? */
...
f32 func_8093EB74(EnGoroiwa *arg0, GlobalContext *arg1) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp48, arg0->unk1D0);
    phi_s0 = 6;
    phi_f20 = 0.0f;
    phi_f20_2 = 0.0f;
    if ((s32) temp_s4 >= 2) {
        do {
            ...
            Math_Vec3s_ToVec3f((Vec3f *) &sp48, arg0->unk1D0 + phi_s0);
            temp_s0 = phi_s0 + 6;
...
void func_8093FAA4(EnGoroiwa *arg0, GlobalContext *arg1) {
    ...
    if (func_8093EAD4(&sp64, (Vec3f *) &sp70) != 0) {
        arg0->unk1B4 = sp64.unk0;
        arg0->unk1B8 = sp64.unk4;
        arg0->unk1BC = sp64.unk8;
    } else {
        sp64.unk0 = (f32) arg0->unk1B4;
        sp64.unk4 = (s32) arg0->unk1B8;
        sp64.unk8 = (s32) arg0->unk1BC;
    }
    ...
    if ((temp_t7->unkA6C & 0x300000C0) == 0) {
        ...
        if (this->actor.update != 0) {
            ...
            if ((this->actor.flags & 0x40) != 0) {
                ...
                phi_v1 = -3;
                if ((this->unk1E5 & 2) != 0) {
                    CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk144);
                    phi_v1 = -3;
                } else {
