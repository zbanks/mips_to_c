typedef struct EnPrz {
    ...
    /* 0x1C9 */ char pad1C9[0x3];                   /* maybe part of unk1C8[4]? */
    /* 0x1CC */ Vec3f unk1CC;                       /* inferred */
    /* 0x1D8 */ Vec3f unk1D8;                       /* inferred */
    ...
    /* 0x1F0 */ char pad1F0[0x2];
    /* 0x1F2 */ s16 unk1F2;                         /* inferred */
    /* 0x1F4 */ char pad1F4[0xE];                   /* maybe part of unk1F2[8]? */
    /* 0x202 */ s16 unk202;                         /* inferred */
    /* 0x204 */ s32 unk204;                         /* inferred */
    /* 0x208 */ char pad208[0x4];
    /* 0x20C */ f32 unk20C;                         /* inferred */
    /* 0x210 */ char pad210[0x10];                  /* maybe part of unk20C[5]? */
    /* 0x220 */ EnPrz *unk220;                      /* inferred */
    /* 0x224 */ ColliderCylinder unk224;            /* inferred */
} EnPrz;                                            /* size = 0x270 */
...
struct _mips2c_stack_func_80A767A8 {
    ...
    /* 0x2C */ char pad2C[0xC];                     /* maybe part of sp2B[13]? */
...
void EnPrz_Init(EnPrz *this, GlobalContext *globalCtx) {
    u32 temp_t8;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk224, (Actor *) this, &D_80A771F4);
    Math_Vec3f_Copy(&this->unk1D8, (Vec3f *) &this->actor.world);
    this->unk220 = this;
    this->unk1EC = 0xFF;
...
void EnPrz_Destroy(EnPrz *this, GlobalContext *globalCtx) {
    EnPrz *this = (EnPrz *) thisx;
...
void EnPrz_Update(EnPrz *this, GlobalContext *globalCtx) {
    s32 sp44;
    f32 sp40;
    f32 sp3C;
    f32 sp38;
    ...
    if (this->unk1EA != 7) {
        ...
        if (this->unk1C8 != 0) {
            Math_Vec3f_Copy((Vec3f *) &sp38, &this->unk1CC);
            this->unk1C8 = 0;
...
void func_80A76FCC(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp1C.unk0 = (s32) D_80A7724C.unk0;
    sp1C.unk4 = (s32) D_80A7724C.unk4;
    sp1C.unk8 = (s32) D_80A7724C.unk8;
    if (arg1 == 2) {
...
void EnPrz_Draw(EnPrz *this, GlobalContext *globalCtx) {
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    Gfx *temp_v1_2;
    ...
    if (this->unk1EC == 0xFF) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A76F70, func_80A76FCC, (Actor *) this);
        return;
    }
