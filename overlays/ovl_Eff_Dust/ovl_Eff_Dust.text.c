...
struct _mips2c_stack_func_80919768 {
    ...
    /* 0x84 */ ? sp84;                              /* inferred */
    /* 0x84 */ char pad_84[0xE];
    /* 0x92 */ s16 sp92;                            /* inferred */
    /* 0x94 */ char pad_94[0x1C];
};                                                  /* size = 0xB0 */
...
void func_80918D64(EffDust *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        temp_f0_3 = temp_v0->unk_4;
        temp_v0_2 = temp_v0 + 4;
        if (temp_f0_3 < 1.0f) {
            temp_v0_2->unk_0 = (f32) (temp_f0_3 + 0.05f);
        }
        temp_f0_4 = temp_v0_2->unk_4;
...
void func_80918FE4(EffDust *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        temp_v0_2 = temp_v0 + 4;
        if (temp_f0_3 < 1.0f) {
            temp_v0_2->unk_0 = (f32) (temp_f0_3 + 0.03f);
        }
        temp_f0_4 = temp_v0_2->unk_4;
        temp_v0_3 = temp_v0_2 + 4;
        if (temp_f0_4 < 1.0f) {
...
void func_80919230(EffDust *this, GlobalContext *globalCtx) {
    ...
    phi_v0 = temp_v0;
    if ((temp_a2 == 0) || (temp_a2->update == 0) || (phi_s2 = 0, ((globalCtx->actorCtx.actorList[2].first->unk_A6C & 0x1000) == 0))) {
        temp_v1 = this->life;
        if (temp_v1 != 0) {
            this->life = temp_v1 - 1;
        } else {
        ...
        do {
            ...
            temp_f0_7 = temp_v0_6->unk_4;
            temp_v0_7 = temp_v0_6 + 4;
            if (temp_f0_7 < 1.0f) {
                temp_v0_7->unk_0 = (f32) (temp_f0_7 + 0.2f);
            }
            temp_f0_8 = temp_v0_7->unk_4;
    ...
    do {
        ...
        temp_v0_3 = temp_v0_2 + 4;
        if (temp_f0_3 < 1.0f) {
            temp_v0_3->unk_0 = (f32) (temp_f0_3 + 0.1f);
        }
        temp_f0_4 = temp_v0_3->unk_4;
...
void func_80919768(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp84.unk_0 = (f32) temp_t9->eye.x;
    sp84.unk_4 = (f32) temp_t9->eye.y;
    sp84.unk_8 = (f32) temp_t9->eye.z;
