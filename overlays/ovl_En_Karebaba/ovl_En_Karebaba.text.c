typedef struct EnKarebaba {
    ...
    /* 0x192 */ char pad_192[0x2A];                 /* maybe part of unk_18C[8]? */
    /* 0x1BC */ Vec3s unk_1BC;                      /* inferred */
    /* 0x1C2 */ char pad_1C2[0x2A];                 /* maybe part of unk_1BC[8]? */
    /* 0x1EC */ u8 unk_1EC;                         /* inferred */
    /* 0x1ED */ char pad_1ED[0x1];
    /* 0x1EE */ s16 unk_1EE;                        /* inferred */
    /* 0x1F0 */ f32 unk_1F0;                        /* inferred */
    /* 0x1F4 */ f32 unk_1F4;                        /* inferred */
    /* 0x1F8 */ f32 unk_1F8;                        /* inferred */
    /* 0x1FC */ Vec3f unk_1FC;                      /* inferred */
    /* 0x208 */ Vec3f unk_208;                      /* inferred */
    /* 0x214 */ char pad_214[0xC];
    /* 0x220 */ Vec3f unk_220;                      /* inferred */
    /* 0x22C */ CollisionPoly *unk_22C;             /* inferred */
    /* 0x230 */ ColliderCylinder unk_230;           /* inferred */
...
struct _mips2c_stack_EnKarebaba_Draw {
    ...
    /* 0x5C */ char pad_5C[0x30];                   /* maybe part of sp58[13]? */
...
void EnKarebaba_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->unk_144, &D_06002A40, &D_060002B8, &this->unk_18C, &this->unk_1BC, 8);
...
void EnKarebaba_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnKarebaba *this = (EnKarebaba *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_27C);
    Collider_DestroyCylinder(globalCtx, &this->unk_230);
}
...
void func_808F13FC(EnKarebaba *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 4) {
        ...
        arg0->unk_1EC = 0x14;
        arg0->unk_1F0 = 3.0f;
        Actor_Spawn(arg1 + 0x1CA0, arg1, 0xA2, (f32) arg0->unk_27C.info.bumper.hitPos.x, (f32) arg0->unk_27C.info.bumper.hitPos.y, (f32) arg0->unk_27C.info.bumper.hitPos.z, (s16) 0, (s16) 0, (s16) 0, (s16) 3);
        return;
    }
    if (temp_v0 == 3) {
        arg0->unk_1EC = 0xA;
...
void func_808F152C(EnKarebaba *arg0) {
    arg0->unk_27C.dim.radius = 7;
    arg0->unk_27C.dim.height = 0x19;
    arg0->unk_27C.base.colType = 0xC;
    arg0->unk_27C.base.acFlags |= 4;
    arg0->unk_230.dim.height = 0x19;
}
...
void func_808F190C(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_1EE == 0) && (this->actor.params == 1)) {
        func_808F1A3C(this);
    }
}
...
void func_808F1A58(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    this->unk_230.dim.radius = *D_808F2DEC + (phi_v0 * 2);
...
void func_808F21A4(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    if ((Actor_HasParent((Actor *) this, globalCtx) != 0) || (this->unk_1EE == 0)) {
        func_808F238C(this);
        return;
    }
...
void EnKarebaba_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_1F0 > 0.0f) {
        if (this->unk_1EC != 0xA) {
            ...
            temp_f0 = (this->unk_1F0 + 1.0f) * 0.375f;
            this->unk_1F4 = temp_f0;
            if (temp_f0 > 0.75f) {
                this->unk_1F4 = 0.75f;
            } else {
                this->unk_1F4 = this->unk_1F4;
            }
        } else if (Math_StepToF(&this->unk_1F8, 0.75f, 0.01875f) == 0) {
    ...
    if (func_808F254C != temp_v0) {
        ...
        if ((sp2C != temp_v0_2) && (func_808F200C != temp_v0_2) && (func_808F21A4 != temp_v0_2)) {
            if ((func_808F241C != temp_v0_2) && (func_808F15B0 != temp_v0_2)) {
                ...
                sp30 = temp_a1;
                CollisionCheck_SetAT(globalCtx, temp_a1, (Collider *) &this->unk_230);
                CollisionCheck_SetAC(globalCtx, temp_a1, (Collider *) &this->unk_27C);
            }
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_230);
...
void EnKarebaba_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) sp50, phi_a3, this->unk_1F4, this->unk_1F8, this->unk_1F0, (u8) (s32) this->unk_1EC);
    if (this->unk_22C != 0) {
