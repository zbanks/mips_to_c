...
static s16 D_808F2DEC = {4, 0x19, 0, 0, 0, 0};
...
static InitChainEntry D_808F2E20;                   /* unable to generate initializer */
static ? D_808F2E28;                                /* unable to generate initializer */
static u32 D_808F2E2C = {0x6001330, 0x6001628, 0x6001828, 0, 0};

typedef struct EnKarebaba {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ SkelAnime unk144;                  /* inferred */
    /* 0x0188 */ void (*actionFunc)(EnKarebaba *, GlobalContext *);
    /* 0x018C */ Vec3s unk18C;                      /* inferred */
    /* 0x0192 */ char pad192[0x2A];                 /* maybe part of unk18C[8]? */
    /* 0x01BC */ Vec3s unk1BC;                      /* inferred */
    /* 0x01C2 */ char pad1C2[0x2A];                 /* maybe part of unk1BC[8]? */
    ...
    /* 0x01FC */ Vec3f unk1FC;                      /* inferred */
    /* 0x0208 */ Vec3f unk208;                      /* inferred */
    /* 0x0214 */ char pad214[0xC];                  /* maybe part of unk208[2]? */
    /* 0x0220 */ Vec3f unk220;                      /* inferred */
    /* 0x022C */ CollisionPoly *unk22C;             /* inferred */
    /* 0x0230 */ ColliderCylinder unk230;           /* inferred */
...
void EnKarebaba_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_808F2E20);
    ...
    temp_a1 = &this->unk27C;
    sp30 = temp_a1;
    Collider_InitAndSetCylinder(globalCtx, temp_a1, &this->actor, &D_808F2DA0);
    Collider_UpdateCylinder(&this->actor, temp_a1);
    temp_a1_2 = &this->unk230;
    sp30 = temp_a1_2;
    Collider_InitAndSetCylinder(globalCtx, temp_a1_2, &this->actor, &D_808F2DCC);
...
void func_808F15B0(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    sp1C = temp_f0;
    Actor_SetScale(&this->actor, 0.005f * temp_f0);
...
void func_808F1778(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    if ((Math_StepToF(&this->actor.scale.x, 0.01f, 0.0005f) != 0) && (this->actor.params == 2)) {
        func_808F1878(this);
    }
    ...
    EffectSsHahen_SpawnBurst(globalCtx, &this->actor.home.pos, 3.0f, 0, (s16) 0xC, (s16) 5, (s16) 1, (s16) -1, (s16) 0xA, NULL);
}
...
void func_808F190C(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    if (Math_Vec3f_DistXZ(&this->actor.home.pos, &sp24->world.pos) > 240.0f) {
        func_808F220C(this);
        return;
    }
...
void func_808F1C84(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    if (this->unk1EC == 0xA) {
        ...
        if (this->unk1EE == 0) {
            ...
            func_808F1374(&this->actor, globalCtx);
            return;
        }
    ...
    if (temp_v0 == 0) {
        ...
        EffectSsHahen_SpawnBurst(globalCtx, &temp_s0->pos, 3.0f, 0, (s16) 0xC, (s16) 5, (s16) 1, (s16) -1, (s16) 0xA, NULL);
        if ((this->actor.scale.x > 0.005f) && ((temp_v0_2 = this->actor.bgCheckFlags, ((temp_v0_2 & 2) != 0)) || ((temp_v0_2 & 8) != 0))) {
            ...
            this->actor.flags &= -6;
            EffectSsHahen_SpawnBurst(globalCtx, &temp_s0->pos, 3.0f, 0, (s16) 0xC, (s16) 5, (s16) 0xF, (s16) -1, (s16) 0xA, NULL);
        }
    ...
    if (temp_v0 == 1) {
        ...
        func_800B1210(globalCtx, &this->actor.home.pos, &D_801D15B0, &D_801D15B0, (s16) 0x1F4, (s16) 0x64);
...
void func_808F200C(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    if (Math_StepToF(&this->actor.scale.x, 0.0f, 0.0005f) != 0) {
        Item_DropCollectible(globalCtx, &this->actor.world.pos, 0xCU);
        func_808F238C(this);
    } else {
        EffectSsHahen_SpawnBurst(globalCtx, &this->actor.world.pos, 3.0f, 0, (s16) 0xC, (s16) 5, (s16) 1, (s16) -1, (s16) 0xA, NULL);
...
void func_808F21A4(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    if ((Actor_HasParent(&this->actor, globalCtx) != 0) || (this->unk1EE == 0)) {
        func_808F238C(this);
        return;
    }
...
void func_808F220C(EnKarebaba *arg0) {
    SkelAnime_ChangeAnim(arg0 + 0x144, &D_060002B8, -3.0f, (f32) SkelAnime_GetFrameCount(&D_060002B8.common), 0.0f, (u8) 2, -3.0f);
    func_808F152C(arg0);
...
void func_808F228C(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_FrameUpdateMatrix(&this->unk144);
    if ((Math_StepToF(&this->actor.scale.x, 0.005f, 0.0005f) != 0) && (this->actor.params == 2)) {
        func_808F1648(this);
    }
    temp_f0 = this->actor.scale.x;
    this->actor.scale.z = temp_f0;
...
void func_808F238C(EnKarebaba *arg0) {
    ...
    arg0->unk1F0 = 0.0f;
    Math_Vec3f_Copy(&arg0->actor.world.pos, &arg0->actor.home.pos);
...
void func_808F241C(EnKarebaba *this, GlobalContext *globalCtx) {
    ...
    sp1C = temp_f0;
    Actor_SetScale(&temp_a0->actor, 0.005f * temp_f0);
    temp_a2 = this;
...
void EnKarebaba_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808F254C != temp_v0) {
        ...
        if (func_808F1C84 == temp_v0) {
            ...
            Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 10.0f, 15.0f, 10.0f, 5U);
        } else {
        ...
        if ((sp2C != temp_v0_2) && (func_808F200C != temp_v0_2) && (func_808F21A4 != temp_v0_2)) {
            if ((func_808F241C != temp_v0_2) && (func_808F15B0 != temp_v0_2)) {
                ...
                sp30 = temp_a1;
                CollisionCheck_SetAT(globalCtx, temp_a1, &this->unk230.base);
                CollisionCheck_SetAC(globalCtx, temp_a1, &this->unk27C.base);
            }
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &this->unk230.base);
...
void func_808F280C(EnKarebaba *arg0, GraphicsContext **arg1) {
    ...
    func_800C0094(arg0->unk22C, arg0->actor.home.pos.x, arg0->actor.home.pos.y, arg0->actor.home.pos.z, &sp40);
    SysMatrix_InsertMatrix(&sp40, 0);
...
void EnKarebaba_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_800BE680(globalCtx, &this->actor, (Vec3f []) sp50, phi_a3, this->unk1F4, this->unk1F8, this->unk1F0, (u8) (s32) this->unk1EC);
    if (this->unk22C != 0) {
        func_808F280C(this, &globalCtx->state.gfxCtx);
    }
}
