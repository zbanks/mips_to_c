...
void ObjVisiblock_Init(ObjVisiblock *this, GlobalContext *globalCtx) {
...
void ObjVisiblock_Destroy(ObjVisiblock *this, GlobalContext *globalCtx) {
    ObjVisiblock *this = (ObjVisiblock *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->dyna.bgId);
}

void ObjVisiblock_Draw(ObjVisiblock *this, GlobalContext *globalCtx) {
    ObjVisiblock *this = (ObjVisiblock *) thisx;
