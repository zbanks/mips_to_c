...
s32 func_80B2FB10(Vec3f *arg0, Vec3f *arg1);        /* static */
s32 func_80B2FB94(Vec3f *arg0, f32 arg1, void *arg2, Vec3f *arg3, f32 *arg4); /* static */
s32 func_80B2FC98(void *arg0, f32 *arg1);           /* static */
void func_80B300F4(Actor *arg0, GlobalContext *arg1, void *arg2, Vec3f *arg3, f32 arg4, s32 arg5); /* static */
void func_80B30410(ObjSpidertent *arg0, Vec3f *arg1); /* static */
s32 func_80B30480(ObjSpidertent *arg0, GlobalContext *arg1, Vec3f *arg2); /* static */
void func_80B307E0(ObjSpidertent *arg0);            /* static */
void func_80B30808(ObjSpidertent *arg0, GlobalContext *arg1); /* static */
void func_80B30A2C(ObjSpidertent *arg0);            /* static */
...
static f32 D_80B313A0 = {-20.0f, 6.0f, 0.0f, 9.188579e-39f, nanf, -1.7014118e38f};
static f32 D_80B313B8 = {0.0f, 4.0f, 1.2f, 7.350072e-39f, nanf, -1.7014118e38f};
static f32 D_80B313D0 = {0.0f, 4.2f, 0.3f, 6.432792e-39f, nanf, 0.0000076293945f};
static f32 D_80B313E8 = {0.0f, 3.0f, 0.0f, 1.838865e-39f, -3.0316945e38f, -1.7014118e38f};
static Vec3f D_80B31400 = {1.0f, 0.0f, 0.0f};
static Vec3f D_80B3140C = {0.0f, 1.0f, 0.0f};
static InitChainEntry D_80B31418;                   /* unable to generate initializer */
...
typedef struct ObjSpidertent {
    ...
    /* 0x01D8 */ char pad1D8[0x1EA];
    /* 0x03C2 */ u8 unk3C2;                         /* inferred */
    /* 0x03C3 */ u8 unk3C3;                         /* inferred */
    /* 0x03C4 */ u8 unk3C4;                         /* inferred */
    /* 0x03C5 */ u8 unk3C5;                         /* inferred */
    /* 0x03C6 */ char pad3C6[0x2];                  /* maybe part of unk3C5[3]? */
    /* 0x03C8 */ void (*actionFunc)(ObjSpidertent *, GlobalContext *);
...
void func_80B300F4(Actor *arg0, GlobalContext *arg1, void *arg2, Vec3f *arg3, f32 arg4, s32 arg5) {
    void *spE0;
    f32 spCC;
    f32 spC8;
    f32 spC4;
    ...
    spB4 = arg2->unk2C;
    if (arg2->unk28 < 0.5f) {
        Math3D_CrossProduct((Vec3f *) &spAC, &D_80B3140C, &sp88);
    } else {
        Math3D_CrossProduct((Vec3f *) &spAC, &D_80B31400, &sp88);
    }
    if (func_80B2FB10(&sp88, &spA0) != 0) {
        ...
        if ((s32) temp_v0 > 0) {
            ...
            do {
                ...
                SysMatrix_MultiplyVector3fByState(&spA0, &sp94);
                if (temp_s0 == &D_80B313A0) {
                    spC4 = (sp94.x * arg4) + arg3->x;
                    spC8 = (sp94.y * arg4) + arg3->y;
                    spCC = (sp94.z * arg4) + arg3->z;
                } else {
                    temp_f0 = Rand_ZeroOne();
                    temp_f2 = (1.0f - (temp_f0 * temp_f0)) * arg4;
                    spC4 = (sp94.x * temp_f2) + arg3->x;
                    spC8 = (sp94.y * temp_f2) + arg3->y;
                    spCC = (sp94.z * temp_f2) + arg3->z;
                }
                if ((Math3D_DistanceSquared((Vec3f *) &spC4, arg0 + 0x24) < spE0->unk1C) && (func_80B2FC98(arg2, &spC4) != 0)) {
                    spB8 = temp_s0->unk8 * sp94.x;
                    spBC = temp_s0->unk8 * sp94.y;
                    spC0 = temp_s0->unk8 * sp94.z;
...
loop_3:
        ...
        phi_s1_2 = phi_s1;
        if ((func_80B2FB94(temp_s6, 6.0f, temp_s0, &sp58, &sp54) == 0) || (func_80B2FC98(temp_s0, &sp58.x) == 0)) {
            temp_s1 = phi_s1 + 0x5C;
            phi_s1 = temp_s1;
            phi_s1_2 = temp_s1;
            if (temp_s1 != 0x228) {
...
void ObjSpidertent_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80B31418);
    ...
    Collider_SetTris(globalCtx, sp48, &this->actor, temp_s5->unk8, &this->unk17C);
    ...
    SysMatrix_MultiplyVector3fByState((Vec3f *) temp_a0, &this->actor.focus.pos);
...
loop_4:
        ...
        Collider_SetTrisVertices(sp48, phi_s3, &sp70, &sp7C, &sp88);
        temp_s3 = phi_s3 + 1;
        phi_s3 = temp_s3;
        phi_s4 += 0x3C;
    } while (temp_s3 != 6);
    ...
    if ((s32) arg0->unk3C1 >= 0x20) {
        ...
        if ((s32) temp_v1 > 0) {
            ...
            if ((s32) arg0->unk3C1 >= 0x33) {
                ...
                Audio_PlaySoundAtPosition(arg1, &arg0->world.pos, 0xB, 0x3878U);
...
loop_43:
            ...
            if (!(temp_f0 < 5.0f) && ((arg0->unk3C0 & (1 << phi_s0)) == 0) && (func_80B2FB94(arg0 + 0x3A4, temp_f0, temp_s2, &sp60, &sp5C) != 0)) {
