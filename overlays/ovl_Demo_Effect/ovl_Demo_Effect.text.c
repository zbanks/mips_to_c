typedef struct DemoEffect {
    ...
    /* 0x165 */ char pad165[0x3];                   /* maybe part of unk164[4]? */
    /* 0x168 */ u8 unk168;                          /* inferred */
    /* 0x169 */ u8 unk169;                          /* inferred */
    /* 0x16A */ u8 unk16A;                          /* inferred */
    /* 0x16B */ char pad16B[0x1];
    /* 0x16C */ s16 unk16C;                         /* inferred */
    /* 0x16E */ char pad16E[0x2];
    /* 0x170 */ void (*unk170)(DemoEffect *, GlobalContext *); /* inferred */
    /* 0x174 */ void (*unk174)(Actor *, GlobalContext *); /* inferred */
...
struct _mips2c_stack_func_808CE078 {
    ...
    /* 0x34 */ char pad34[0x12];                    /* maybe part of sp30[5]? */
