...
s32 func_80B70B04(Actor *arg0, f32 arg1, f32 arg2, f32 arg3); /* static */
...
static ActorAnimationEntry D_80B732D0 = {
...
static ColliderJntSphElementInit D_80B73408 = {
...
static InitChainEntry D_80B73490;                   /* unable to generate initializer */
...
typedef struct EnRailSkb {
    ...
    /* 0x0228 */ void (*actionFunc)(EnRailSkb *, GlobalContext *);
    /* 0x022C */ void *unk22C;                      /* inferred */
    /* 0x0230 */ char pad230[0x4];                  /* maybe part of unk22C[2]? */
    /* 0x0234 */ Vec3f unk234;                      /* inferred */
    /* 0x0240 */ char pad240[0x9C];                 /* maybe part of unk234[14]? */
    ...
    /* 0x02F4 */ Vec3s unk2F4;                      /* inferred */
    /* 0x02FA */ char pad2FA[0x72];                 /* maybe part of unk2F4[20]? */
    /* 0x036C */ Vec3s unk36C;                      /* inferred */
    /* 0x0372 */ char pad372[0x7E];                 /* maybe part of unk36C[22]? */
    /* 0x03F0 */ s16 unk3F0;                        /* inferred */
    /* 0x03F2 */ s16 unk3F2;                        /* inferred */
    /* 0x03F4 */ s16 unk3F4;                        /* inferred */
    /* 0x03F6 */ s16 unk3F6;                        /* inferred */
    /* 0x03F8 */ s16 unk3F8;                        /* inferred */
    /* 0x03FA */ s16 unk3FA;                        /* inferred */
    /* 0x03FC */ s16 unk3FC;                        /* inferred */
    /* 0x03FE */ s16 unk3FE;                        /* inferred */
    /* 0x0400 */ u16 unk400;                        /* inferred */
    /* 0x0402 */ u8 unk402;                         /* inferred */
    /* 0x0403 */ u8 unk403;                         /* inferred */
...
loop_3:
    ...
    temp_v0_2 = Math_Vec3f_Yaw(&arg0->world.pos, (Vec3f *) temp_a1);
...
void EnRailSkb_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80B708C0(&this->actor, globalCtx);
    ...
    Collider_SetJntSph(globalCtx, temp_a1, &this->actor, &D_80B73450, &this->unk164);
    ...
    Actor_ProcessInitChain(&this->actor, &D_80B73490);
...
void func_80B716A8(EnRailSkb *this, GlobalContext *globalCtx) {
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        ...
        if (func_80B7285C(this) == 0) {
            func_801518B0(globalCtx, 0x13ECU, &this->actor);
            this->unk400 = 0x13EC;
            func_80B72830(this, 1);
        } else {
            func_801518B0(globalCtx, 0x13F5U, &this->actor);
            this->unk400 = 0x13F5;
        }
...
void func_80B71954(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_a0;
    sp36 = Math_Vec3f_Yaw(&temp_a0->pos, this->unk22C + 0x24);
    sp30 = Math_Vec3f_DistXZ(&temp_a0->pos, this->unk22C + 0x24);
...
void func_80B71A58(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    sp36 = Math_Vec3f_Yaw(&this->actor.world.pos, this->unk22C + 0x24);
    temp_a0 = &this->unk1E4;
    sp2C = temp_a0;
    if (func_801378B8(temp_a0, this->unk1E4.animFrameCount) != 0) {
...
void func_80B71BB8(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    sp34 = Math_Vec3f_DistXZ(&temp_s0->pos, this->unk22C + 0x24);
    temp_v0 = this->unk3F2;
    if ((s32) temp_v0 > 0) {
        this->unk3F2 = temp_v0 - 1;
        return;
    }
    Math_SmoothStepToS(&this->actor.shape.rot.y, Math_Vec3f_Yaw(&temp_s0->pos, this->unk22C + 0x24), 1, 0x71C, (s16) 0xB6);
    if (((this->actor.bgCheckFlags & 1) != 0) && (this->unk22C->unkB7 == 0)) {
        Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    } else {
        this->actor.velocity.y += this->actor.gravity;
        this->actor.world.pos.y += this->actor.velocity.y;
        Math_SmoothStepToF(&temp_s0->pos.x, this->unk22C->unk24, 0.6f, 1.6f, 0.1f);
...
void func_80B71F3C(EnRailSkb *arg0, GlobalContext *arg1) {
    ...
    if (func_80147624(arg1) != 0) {
        ...
        switch (temp_t8) {
        case 5100:
            func_801518B0(arg1, 0x13EDU, &arg0->actor);
            arg0->unk400 = 0x13ED;
            return;
        case 5101:
            func_801518B0(arg1, 0x13EEU, &arg0->actor);
            arg0->unk400 = 0x13EE;
            return;
        case 5102:
            func_801518B0(arg1, 0x13EFU, &arg0->actor);
            arg0->unk400 = 0x13EF;
            return;
        case 5103:
        case 5109:
            func_801518B0(arg1, 0x13F0U, &arg0->actor);
            arg0->unk400 = 0x13F0;
            return;
        case 5105:
            func_801518B0(arg1, 0x13F2U, &arg0->actor);
            arg0->unk400 = 0x13F2;
            return;
        case 5106:
            if (arg0->unk3FC == 1) {
                func_801518B0(arg1, 0x13F4U, &arg0->actor);
                arg0->unk400 = 0x13F4;
                return;
            }
            func_801477B4(arg1);
...
block_20:
        ...
        if ((func_80B71EA8 != temp_v0_2) && (func_80B71954 != temp_v0_2) && (func_80B71A58 != temp_v0_2) && (func_80B71BB8 != temp_v0_2)) {
            ...
            sp32 = Math_Vec3f_Yaw(&temp_a0_2->pos, (Vec3f *) temp_a1);
            if (Math_Vec3f_DistXZ(&temp_a0_2->pos, (Vec3f *) &sp38) > 100.0f) {
...
void func_80B72430(EnRailSkb *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    sp50.x = D_80B73498.unk0;
    sp50.y = D_80B73498.unk4;
    sp50.z = D_80B73498.unk8;
...
block_36:
            ...
            CollisionCheck_SetOC(arg1, &arg1->colChkCtx, &arg0->unk144.base);
...
void EnRailSkb_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80B72190(&this->actor, globalCtx);
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 15.0f, 30.0f, 60.0f, 5U);
...
s32 func_80B72E88(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg5) {
    ...
    if (arg1 == 0xB) {
        ...
        sp24.x = D_80B734C4.unk0;
        sp24.y = D_80B734C4.unk4;
        sp24.z = D_80B734C4.unk8;
        arg1 = arg1;
        SysMatrix_MultiplyVector3fByState(&sp24, arg5 + 0x3C);
...
void EnRailSkb_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk1E4.skeleton, this->unk1E4.limbDrawTbl, func_80B72E88, func_80B7302C, &this->actor);
    if ((s32) this->unk3F0 > 0) {
        func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk234, this->unk2DE, this->unk2F0, 0.5f, this->unk2EC, (u8) (s32) this->unk403);
    }
    temp_v0 = this->unk402;
