typedef struct EnRailSkb {
    ...
    /* 0x22C */ void *unk_22C;                      /* inferred */
    /* 0x230 */ char pad_230[0x4];
    /* 0x234 */ Vec3f unk_234;                      /* inferred */
    /* 0x240 */ char pad_240[0x9C];                 /* maybe part of unk_234[14]? */
    /* 0x2DC */ s32 unk_2DC;                        /* inferred */
    /* 0x2E0 */ s32 unk_2E0;                        /* inferred */
    /* 0x2E4 */ s32 unk_2E4;                        /* inferred */
    /* 0x2E8 */ s32 unk_2E8;                        /* inferred */
    /* 0x2EC */ f32 unk_2EC;                        /* inferred */
    /* 0x2F0 */ f32 unk_2F0;                        /* inferred */
    /* 0x2F4 */ Vec3s unk_2F4;                      /* inferred */
    /* 0x2FA */ char pad_2FA[0x72];                 /* maybe part of unk_2F4[20]? */
    /* 0x36C */ Vec3s unk_36C;                      /* inferred */
    /* 0x372 */ char pad_372[0x7E];                 /* maybe part of unk_36C[22]? */
    /* 0x3F0 */ s16 unk_3F0;                        /* inferred */
    /* 0x3F2 */ s16 unk_3F2;                        /* inferred */
    /* 0x3F4 */ s16 unk_3F4;                        /* inferred */
    /* 0x3F6 */ s16 unk_3F6;                        /* inferred */
    /* 0x3F8 */ s16 unk_3F8;                        /* inferred */
    /* 0x3FA */ s16 unk_3FA;                        /* inferred */
    /* 0x3FC */ s16 unk_3FC;                        /* inferred */
    /* 0x3FE */ s16 unk_3FE;                        /* inferred */
    /* 0x400 */ u16 unk_400;                        /* inferred */
    /* 0x402 */ u8 unk_402;                         /* inferred */
    /* 0x403 */ u8 unk_403;                         /* inferred */
...
void func_80B708C0(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = D_80B7348C;
    arg0[1].projectedPos.x = Lib_SegmentedToVirtual(temp_s0->unk_4);
    arg0[2].scale.x = temp_v1;
    temp_t2 = temp_s0->unk_0;
    arg0[2].scale.z = (bitwise f32) temp_t2;
    if (temp_v1 == 0) {
        phi_s0 = 1;
        if ((s32) temp_t2 >= 2) {
loop_3:
            ...
            temp_s0_2 = phi_s0 + 1;
            phi_s0 = temp_s0_2;
            if (temp_s0_2 < (bitwise s32) arg0[2].scale.z) {
                if (temp_s0_2 != 0xA) {
                    goto loop_3;
                }
            }
    ...
    temp_v1_2 = arg0[2].scale.x;
    temp_a2 = arg0[1].projectedPos.x;
    temp_v0 = (bitwise s32) temp_a2 + ((bitwise s32) temp_v1_2 * 6);
    arg0->world.pos.x = (f32) temp_v0->unk_0;
    arg0->world.pos.y = (f32) temp_v0->unk_2;
    arg0->world.pos.z = (f32) temp_v0->unk_4;
    phi_a3 = 0;
    if ((bitwise s32) temp_v1_2 < ((bitwise s32) arg0[2].scale.z - 1)) {
        phi_a3 = (bitwise s32) temp_v1_2 + 1;
    }
    temp_lo = phi_a3 * 6;
    temp_a1 = &sp70;
    sp70 = (f32) *((bitwise s32) temp_a2 + temp_lo);
    sp74 = (f32) ((bitwise s32) arg0[1].projectedPos.x + temp_lo)->unk_2;
    sp78 = (f32) ((bitwise s32) arg0[1].projectedPos.x + temp_lo)->unk_4;
...
s32 func_80B70B04(Actor *arg0, f32 arg1, s32 arg2, f32 arg3) {
    ...
    sp54 = 1;
    sp4C = 0;
    sp60 = (f32) arg0[1].projectedPos.x->unk_4 - arg3;
    sp64 = (f32) arg0[1].projectedPos.x->unk_0 - arg1;
    sp58 = (f32) arg0[1].projectedPos.x->unk_A - arg3;
    sp5C = (f32) arg0[1].projectedPos.x->unk_6 - arg1;
    temp_s3 = func_80B70AB4((bitwise s32) temp_s4->unk_0, temp_s4[1], temp_s5->unk_0, temp_s5[1]);
    phi_s0 = 1;
    phi_s2 = sp4C * 6;
loop_1:
    temp_s2 = phi_s2 + 6;
    ...
    phi_v0 = 0;
    phi_s0_2 = temp_s0;
    if (phi_s0 < (arg0[2].scale.z - 1)) {
        phi_v0 = temp_s0 * 6;
    } else {
        phi_s0_2 = 0;
    }
    sp60 = (f32) (arg0[1].projectedPos.x + temp_s2)->unk_4 - arg3;
    sp64 = (f32) *(arg0[1].projectedPos.x + temp_s2) - arg1;
    sp58 = (f32) (arg0[1].projectedPos.x + phi_v0)->unk_4 - arg3;
    sp5C = (f32) *(arg0[1].projectedPos.x + phi_v0) - arg1;
    phi_s0 = phi_s0_2;
    if (func_80B70AB4((bitwise s32) temp_s4->unk_0, temp_s4[1], temp_s5->unk_0, temp_s5[1]) != temp_s3) {
        sp54 = 0;
    } else if (phi_s0_2 != 0) {
        goto loop_1;
    }
...
loop_1:
        if ((phi_s0->id == 0x1E3) && (func_80B70B04(arg0, subroutine_arg1, phi_s0->world.pos.y, phi_s0->world.pos.z) != 0)) {
            ...
            arg0[1].shape.feetPos[1].z = (bitwise f32) phi_s0;
            return;
        }
...
void EnRailSkb_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->unk_1E4, &D_06005EF8, &D_060064E0, &this->unk_2F4, &this->unk_36C, 0x14);
    temp_a1 = &this->unk_144;
    sp34 = temp_a1;
    Collider_InitJntSph(globalCtx, temp_a1);
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80B73450, &this->unk_164);
...
void func_80B70FF8(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.xzDistToPlayer < 65.0f) {
        ...
        if ((phi_v1 < 0x2AAA) && ((s32) this->unk_3F2 >= 6)) {
            func_80B71354(this);
        }
    }
...
void func_80B710AC(Actor *arg0) {
    ...
    arg0[1].shape.feetPos[1].y = (bitwise f32) func_80B710E4;
}
...
void func_80B71114(Actor *arg0) {
    Audio_PlayActorSound2(arg0, 0x389EU);
    arg0[1].shape.feetPos[1].y = (bitwise f32) func_80B7114C;
}
...
void func_80B7114C(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 0) {
        ...
        if (this->actor.colChkInfo.health != 0) {
            ...
            func_800BDC5C(&this->unk_1E4, (ActorAnimationEntry []) D_80B732D0, 3);
...
void func_80B71354(Actor *arg0) {
    ...
    func_800BDC5C((SkelAnime *) &arg0[1].colChkInfo, (ActorAnimationEntry []) D_80B732D0, 2);
    arg0[1].shape.feetPos[1].y = (bitwise f32) func_80B713A4;
}
...
void func_80B713A4(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_a0;
    if (func_801378B8(temp_a0, this->unk_1E4.animFrameCount) != 0) {
...
void func_80B7151C(Actor *arg0) {
    ...
    func_800BDC5C((SkelAnime *) &arg0[1].colChkInfo, (ActorAnimationEntry []) D_80B732D0, 1);
    arg0[1].shape.feetPos[1].y = (bitwise f32) func_80B715AC;
}
...
void func_80B716A8(EnRailSkb *this, GlobalContext *globalCtx) {
    if (func_800B84D0((Actor *) this, globalCtx) != 0) {
        ...
        func_800BDC5C(&this->unk_1E4, (ActorAnimationEntry []) D_80B732D0, 0xC);
        func_80B717C8(this);
    } else if ((this->actor.xzDistToPlayer < 100.0f) && ((this->unk_144.base.acFlags & 2) == 0)) {
...
void func_80B71954(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_a0;
    sp36 = Math_Vec3f_Yaw((Vec3f *) temp_a0, this->unk_22C + 0x24);
    sp30 = Math_Vec3f_DistXZ((Vec3f *) temp_a0, this->unk_22C + 0x24);
...
void func_80B71A08(Actor *arg0) {
    Audio_PlayActorSound2(arg0, 0x3831U);
    func_800BDC5C((SkelAnime *) &arg0[1].colChkInfo, (ActorAnimationEntry []) D_80B732D0, 2);
    arg0[1].shape.feetPos[1].y = (bitwise f32) func_80B71A58;
}
...
void func_80B71A58(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    sp36 = Math_Vec3f_Yaw((Vec3f *) &this->actor.world, this->unk_22C + 0x24);
    temp_a0 = &this->unk_1E4;
    sp2C = temp_a0;
    if (func_801378B8(temp_a0, this->unk_1E4.animFrameCount) != 0) {
        Audio_PlayActorSound2((Actor *) this, 0x3831U);
        func_800BDC5C(sp2C, (ActorAnimationEntry []) D_80B732D0, 2);
        temp_v0 = this->unk_22C;
        temp_v1 = temp_v0->unk_B7;
        if (this->unk_2E8 < (s32) temp_v1) {
            temp_v0->unk_B7 = (u8) (temp_v1 - 1);
        } else {
            temp_v0->unk_B7 = (u8) (temp_v1 - 1);
            func_80B71B6C(this);
        }
    ...
    if (func_801378B8(sp2C, 3.0f) != 0) {
        temp_v0_2 = this->unk_22C;
        temp_v1_2 = temp_v0_2->unk_B7;
        if (this->unk_2E8 < (s32) temp_v1_2) {
            temp_v0_2->unk_B7 = (u8) (temp_v1_2 - 1);
        } else {
            temp_v0_2->unk_B7 = (u8) (temp_v1_2 - 1);
            func_80B71B6C(this);
        }
...
void func_80B71BB8(EnRailSkb *this, GlobalContext *globalCtx) {
    ...
    sp34 = Math_Vec3f_DistXZ((Vec3f *) temp_s0, this->unk_22C + 0x24);
    temp_v0 = this->unk_3F2;
    if ((s32) temp_v0 > 0) {
        this->unk_3F2 = temp_v0 - 1;
        return;
    }
    Math_SmoothStepToS(&this->actor.shape.rot.y, Math_Vec3f_Yaw((Vec3f *) temp_s0, this->unk_22C + 0x24), 1, 0x71C, (s16) 0xB6);
    if (((this->actor.bgCheckFlags & 1) != 0) && (this->unk_22C->unk_B7 == 0)) {
        Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
    } else {
        this->actor.velocity.y += this->actor.gravity;
        this->actor.world.pos.y += this->actor.velocity.y;
        Math_SmoothStepToF((f32 *) temp_s0, this->unk_22C->unk_24, 0.6f, 1.6f, 0.1f);
        Math_SmoothStepToF(&this->actor.world.pos.z, this->unk_22C->unk_2C, 0.6f, 1.6f, 0.1f);
    }
    ...
    if ((sp34 < 50.0f) && ((temp_v0_2 & 1) != 0)) {
        Audio_PlayActorSound2((Actor *) this, 0x3831U);
        func_800BDC5C(&this->unk_1E4, (ActorAnimationEntry []) D_80B732D0, 9);
...
void func_80B71DF0(EnRailSkb *arg0) {
    ...
    } else if ((func_80B7114C == temp_v0) && ((s32) arg0->unk_3F0 >= 2)) {
        arg0->unk_3F0 = 0;
    }
    arg0 = arg0;
...
void func_80B71F3C(EnRailSkb *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_400;
    if (((temp_v0 == 0x13ED) || (temp_v0 == 0x13F5)) && (arg0->unk_3F2 != 1)) {
        func_80B71D8C(arg0, arg1, func_80B71DF0);
        func_80B717C8(arg0);
        arg0->unk_3F2 = 1;
    }
    if (func_80147624(arg1) != 0) {
        temp_t8 = arg0->unk_400;
        switch (temp_t8) {
        case 5100:
...
void func_80B72100(Actor *arg0, GlobalContext *arg1) {
    if (func_80147624(arg1) != 0) {
        if (arg1->msgCtx.choiceIndex == 0) {
            ...
            arg0[3].world.rot.z = 0x13F1;
            return;
        }
        func_8019F208();
        func_801518B0(arg1, 0x13F3U, arg0);
        arg0[3].world.rot.z = 0x13F3;
        /* Duplicate return node #4. Try simplifying control flow for better match */
    }
}
...
void func_80B72190(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = arg0 + 0x1E4;
    if ((func_80B714D8 != arg0[1].shape.feetPos[1].y) && ((sp2C = temp_a0, (func_801378B8(temp_a0, 8.0f) != 0)) || (func_801378B8(temp_a0, 15.0f) != 0))) {
        Audio_PlayActorSound2(arg0, 0x3830U);
    }
    temp_v1 = arg0->parent;
    temp_v0 = arg0[1].shape.feetPos[1].y;
    if (temp_v1 == 0) {
        temp_t8 = arg0->unk_3F6;
        arg0->unk_3F6 = 1;
        arg0->unk_3F4 = temp_t8;
        if ((func_80B713A4 == (bitwise s32) temp_v0) || (func_80B710E4 == (bitwise s32) temp_v0) || (func_80B7114C == (bitwise s32) temp_v0) || (func_80B7123C == (bitwise s32) temp_v0) || (func_80B717E0 == (bitwise s32) temp_v0)) {
            arg0->unk_3F6 = 0;
        }
        if (arg0->unk_3F4 == 0) {
            return;
    ...
    if (temp_v1->unk_3F4 != 0) {
block_20:
        temp_v0_2 = arg0[1].shape.feetPos[1].y;
        if ((func_80B71EA8 != (bitwise s32) temp_v0_2) && (func_80B71954 != (bitwise s32) temp_v0_2) && (func_80B71A58 != (bitwise s32) temp_v0_2) && (func_80B71BB8 != (bitwise s32) temp_v0_2)) {
            temp_a0_2 = &arg0->world;
            temp_a1 = &sp38;
            sp38 = (f32) *((bitwise s32) arg0[1].projectedPos.x + ((bitwise s32) arg0[2].scale.x * 6));
            sp3C = (f32) ((bitwise s32) arg0[1].projectedPos.x + ((bitwise s32) arg0[2].scale.x * 6))->unk_2;
            sp2C = (SkelAnime *) temp_a0_2;
            sp40 = (f32) ((bitwise s32) arg0[1].projectedPos.x + ((bitwise s32) arg0[2].scale.x * 6))->unk_4;
            ...
            if (Math_Vec3f_DistXZ((Vec3f *) temp_a0_2, (Vec3f *) &sp38) > 100.0f) {
                ...
                temp_v0_3 = arg0[2].scale.x;
                if ((bitwise s32) temp_v0_3 < ((bitwise s32) arg0[2].scale.z - 1)) {
                    arg0[2].scale.x = (bitwise f32) ((bitwise s32) temp_v0_3 + 1);
                } else {
                    arg0[2].scale.x = 0.0f;
                }
            }
...
void func_80B72430(EnRailSkb *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    (&sp5C)[1] = arg0->actor.world.pos.y;
    (&sp5C)[2] = arg0->actor.world.pos.z;
    sp50.unk_0 = (s32) D_80B73498.unk_0;
    sp50.unk_4 = (s32) D_80B73498.unk_4;
    sp50.unk_8 = (s32) D_80B73498.unk_8;
    sp44.unk_0 = D_80B734A4.unk_0;
    (&sp44)[1] = D_80B734A4.unk_4;
    (&sp44)[2] = D_80B734A4.unk_8;
...
void func_80B725C0(EnRailSkb *arg0, GlobalContext *arg1) {
    ...
    if (func_80B7114C != temp_v0_2) {
        if ((s32) arg0->unk_3F0 < 0x14) {
            ...
            arg0->unk_2EC = (f32) arg0->unk_3F0 * 0.05f;
            return;
        }
...
void func_80B72970(EnRailSkb *arg0, GlobalContext *arg1) {
    ...
    if ((func_80B714D8 != temp_v1) && (func_80B7123C != temp_v1) && (func_80B715AC != temp_v1) && (func_80B71954 != temp_v1) && (func_80B71A58 != temp_v1) && (func_80B71BB8 != temp_v1) && (arg0->unk_3FE != 1)) {
...
block_14:
                ...
                case 2:                             /* switch 2 */
                    ...
                    func_800BDC5C(&arg0->unk_1E4, (ActorAnimationEntry []) D_80B732D0, 3);
                    arg0->unk_402 |= 1;
                    func_80B712FC(arg0);
                    break;
                case 3:                             /* switch 2 */
                ...
                case 14:                            /* switch 2 */
                    ...
                    /* fallthrough */
                case 15:                            /* switch 2 */
                    temp_v0_3 = sp3C[8].colChkInfo.atHitEffect;
...
block_36:
            ...
            if (func_80B713A4 == arg0->actionFunc) {
                CollisionCheck_SetAT(arg1, &arg1->colChkCtx, (Collider *) &arg0->unk_144);
                phi_v1 = arg0->actionFunc;
            }
            ...
            CollisionCheck_SetOC(arg1, &arg1->colChkCtx, (Collider *) &arg0->unk_144);
...
s32 func_80B72E88(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg5) {
    ...
    if (arg1 == 0xB) {
        ...
        sp24.unk_0 = (s32) D_80B734C4.unk_0;
        sp24.unk_4 = (s32) D_80B734C4.unk_4;
        sp24.unk_8 = (s32) D_80B734C4.unk_8;
        arg1 = arg1;
        SysMatrix_MultiplyVector3fByState((Vec3f *) &sp24, arg5 + 0x3C);
    } else if ((arg1 == 0xC) && (arg5[169].z == 1)) {
        arg1 = arg1;
        SysMatrix_InsertZRotation_s(0x71C, 1);
    }
    if (((arg1 == 0xB) || (arg1 == 0xC)) && ((arg5->unk_402 & 2) != 0)) {
        *arg2 = NULL;
    }
    return 0;
}
...
void func_80B7302C(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if ((arg4[3].world.unk_12 & 0x80) == 0) {
        arg2 = arg2;
        Collider_UpdateSpheres(arg1, arg4 + 0x144);
        if ((arg1 == 0xB) && (temp_v0 = arg4[3].world.unk_12, ((temp_v0 & 1) != 0)) && ((temp_v0 & 2) == 0)) {
            func_800BBCEC(arg4, arg0, 1, arg2);
            arg4[3].world.unk_12 |= 2;
        } else {
            temp_v0_2 = arg4[3].world.unk_12;
        ...
        if (arg4->unk_3F0 != 0) {
            if ((arg1 == 2) || (arg1 == 4) || (arg1 == 5) || (arg1 == 6) || (arg1 == 7) || (arg1 == 8) || (arg1 == 9) || (arg1 == 0xD) || (arg1 == 0xE) || (arg1 == 0xF) || (arg1 == 0x10) || (arg1 == 0x11) || (arg1 == 0x12)) {
                temp_t5 = arg4[2].targetArrowOffset;
                SysMatrix_GetStateTranslation(arg4 + ((((bitwise s32) temp_t5 * 4) - (bitwise s32) temp_t5) * 4) + 0x234);
                arg4[2].targetArrowOffset = (bitwise f32) ((bitwise s32) arg4[2].targetArrowOffset + 1);
                return;
            }
            if ((arg1 == 0xB) && ((arg4[3].world.unk_12 & 2) == 0)) {
                temp_t1 = arg4[2].targetArrowOffset;
                SysMatrix_MultiplyVector3fByState(&D_80B734D0, arg4 + ((((bitwise s32) temp_t1 * 4) - (bitwise s32) temp_t1) * 4) + 0x234);
                arg4[2].targetArrowOffset = (bitwise f32) ((bitwise s32) arg4[2].targetArrowOffset + 1);
            }
...
void EnRailSkb_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk_1E4.skeleton, this->unk_1E4.limbDrawTbl, func_80B72E88, func_80B7302C, (Actor *) this);
    if ((s32) this->unk_3F0 > 0) {
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk_234, this->unk_2DE, this->unk_2F0, 0.5f, this->unk_2EC, (u8) (s32) this->unk_403);
    }
    temp_v0 = this->unk_402;
    if (((temp_v0 & 0x40) != 0) && ((temp_v0 & 0x80) == 0)) {
        this->unk_402 = temp_v0 | 0x80;
    }
}
