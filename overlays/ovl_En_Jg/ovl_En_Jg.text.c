...
typedef struct EnJg {
    ...
    /* 0x01DC */ void (*actionFunc)(EnJg *, GlobalContext *);
    ...
    /* 0x01FE */ char pad1FE[0xCC];                 /* maybe part of unk1F8[35]? */
    /* 0x02CA */ Vec3s unk2CA;                      /* inferred */
    /* 0x02D0 */ char pad2D0[0xCE];
    /* 0x039E */ s16 unk39E;                        /* inferred */
    /* 0x03A0 */ s16 unk3A0;                        /* inferred */
    /* 0x03A2 */ s16 unk3A2;                        /* inferred */
    /* 0x03A4 */ char pad3A4[0x24];                 /* maybe part of unk3A2[19]? */
    /* 0x03C8 */ s16 unk3C8;                        /* inferred */
    /* 0x03CA */ u8 unk3CA;                         /* inferred */
    /* 0x03CB */ u8 unk3CB;                         /* inferred */
    /* 0x03CC */ u16 unk3CC;                        /* inferred */
    /* 0x03CE */ u16 unk3CE;                        /* inferred */
    /* 0x03D0 */ char pad3D0[0x4];                  /* maybe part of unk3CE[3]? */
} EnJg;                                             /* size 0x3D4 */
...
void func_80B742F8(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = arg0->unk39E;
    if (temp_v1 == 4) {
        if (sp24 == SkelAnime_GetFrameCount(&(&D_80B75878)[arg0->unk39E].animationSeg->common)) {
            arg0->unk39E = 5;
            func_8013BC6C(arg0 + 0x198, &D_80B75878, (s32) arg0->unk39E);
            return;
        }
...
void func_80B74840(EnJg *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = SkelAnime_GetFrameCount(&(&D_80B75878)[arg0->unk39E].animationSeg->common);
    if (arg0->unk3A0 == 1) {
...
void func_80B751F8(Actor *arg0, GlobalContext *arg1) {
    ...
    sp24 = SkelAnime_GetFrameCount(&(&D_80B75878)[arg0->unk39E].animationSeg->common);
    if (func_800B84D0(arg0, arg1) != 0) {
        temp_a1 = arg0->unk3CE;
        arg0->unk3CC = (u16) (arg0->unk3CC | 4);
        arg0->speedXZ = 0.0f;
...
void EnJg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1_2, &this->actor, &D_80B75820);
...
void EnJg_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80B749D0 != temp_v0) && (func_80B74AD8 != temp_v0)) {
        func_80B73AE4(&this->actor, globalCtx);
        Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
        SkelAnime_FrameUpdateMatrix(&this->unk198);
        if ((this->unk3A0 != 3) && ((this->actor.params & 1) == 0)) {
            func_80B7517C(this, globalCtx);
        }
        func_800E9250(globalCtx, &this->actor, &this->unk1EC, &this->unk1F2, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    }
...
void EnJg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    EnJg *this = (EnJg *) thisx;
    SkelAnime_DrawSV(globalCtx, this->unk198.skeleton, this->unk198.limbDrawTbl, (s32) this->unk198.dListCount, func_80B75658, func_80B75708, &this->actor);
}
