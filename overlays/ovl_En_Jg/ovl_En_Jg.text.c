...
s8 func_80B73DF4(void *arg0) {
    if ((s32) (s16) (arg0->unk_92 - arg0->unk_BE) > 0) {
        return arg0->unk_38;
    }
    return ActorCutscene_GetAdditionalCutscene((s16) arg0->unk_38);
}
...
void func_80B73E3C(Actor *arg0) {
    ...
    if (arg0->unk_3D0 == 0xA) {
        ...
        arg0->unk_3C8 = ActorCutscene_GetAdditionalCutscene(arg0->unk_3C8);
        if (ActorCutscene_GetCurrentIndex() == 0x7C) {
...
void func_80B741F8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (ActorCutscene_GetCanPlayNext(arg0->unk_3C8) != 0) {
        ...
        case 3540:
        case 3542:
            temp_v0 = func_80B73A90(arg1, arg0->unk_3D0);
            arg0->unk_144 = temp_v0;
            ActorCutscene_Start(arg0->unk_3C8, temp_v0);
...
void func_80B747C8(void *arg0, ? arg1) {
    ...
    temp_a3 = arg0;
    if (temp_a3->unk_39E != 1) {
        temp_a3->unk_39E = 1;
        temp_a3->unk_3A2 = 0x3E8;
        temp_a2 = temp_a3->unk_39E;
        arg0 = temp_a3;
...
void func_80B74840(EnJg *arg0, GlobalContext *arg1) {
    ...
    sp3E = (s16) (s32) arg0->unk_198.animCurrentFrame;
    temp_v0 = SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80B75878[arg0->unk_39E].animationSeg);
    if (arg0->unk_3A0 == 1) {
        temp_f10 = (f32) temp_v0;
        arg0->unk_3A0 = 2;
        arg0->unk_3A2 = 0x3E8;
        arg0->unk_198.animCurrentFrame = temp_f10;
...
void func_80B74BC8(EnJg *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x1D6U) != 0) {
        ...
        if (arg0->unk_3CB != temp_a0) {
            arg0->unk_3CB = (u8) temp_a0;
            temp_t1 = *temp_v1->unk_1F4C;
            switch (temp_t1) {
            case 1:
                temp_a0_2 = arg0->unk_1E8;
                arg0->unk_3CA = 0x11;
                if (temp_a0_2 != 0) {
            ...
            func_8013BC6C(arg0 + 0x198, D_80B75878, (s32) arg0->unk_3CA);
        }
        if (((arg0->unk_3CC & 8) == 0) && (((arg0->unk_3CA == 0xA) && (func_801378B8(arg0 + 0x198, 14.0f) != 0) && (arg0->unk_3A0 != 3)) || (((temp_v0_2 = arg0->unk_3CA, (temp_v0_2 == 0xB)) || (temp_v0_2 == 0xC)) && (arg0->unk_3A0 == 3)))) {
            arg0->unk_3CC |= 8;
            arg0->unk_1E8 = Actor_SpawnAsChildAndCutscene(&arg1->actorCtx, arg1, 0x226, arg0->actor.world.pos.x, arg0->actor.world.pos.y, arg0->actor.world.pos.z, (s16) (s32) arg0->actor.shape.rot.x, (s16) (s32) arg0->actor.shape.rot.y, (s16) (s32) arg0->actor.shape.rot.z, (s32) arg0->actor.params, (u32) arg0->actor.cutscene, (s32) arg0->actor.unk20, NULL);
        }
...
void EnJg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a1 = &this->unk_198;
    sp30 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_0601AFF0, &D_0601ADC0, &this->unk_1F8, &this->unk_2CA, 0x23);
    temp_a1_2 = &this->unk_14C;
    sp34 = temp_a1_2;
    ...
    if ((temp_v0 & 1) == 0) {
        if ((globalCtx->sceneNum == 8) && (gSaveContext.sceneSetupIndex == 7) && (globalCtx->csCtx.unk_12 == 0)) {
            this->unk_39E = 0;
            this->unk_3A0 = 3;
            func_8013BC6C(sp30, D_80B75878, (s32) this->unk_39E);
            this->actionFunc = func_80B74BC8;
            return;
        }
        this->unk_1E0 = func_8013D648(globalCtx, (s16) ((s32) (temp_v0 & 0xFC00) >> 0xA), 0x3F);
        this->unk_39E = 4;
        this->unk_3A0 = 1;
        this->unk_3A2 = 0x3E8;
        this->unk_3CE = 0xDAC;
    ...
    this->unk_39E = 0;
    this->unk_3C8 = (s16) this->actor.cutscene;
    func_8013BC6C(sp30, D_80B75878, (s32) this->unk_39E);
...
void EnJg_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((func_80B749D0 != temp_v0) && (func_80B74AD8 != temp_v0)) {
        ...
        SkelAnime_FrameUpdateMatrix(&this->unk_198);
        if ((this->unk_3A0 != 3) && ((this->actor.params & 1) == 0)) {
            func_80B7517C(this, globalCtx);
        }
        func_800E9250(globalCtx, (Actor *) this, &this->unk_1EC, &this->unk_1F2, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    }
...
void EnJg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    EnJg *this = (EnJg *) thisx;
    SkelAnime_DrawSV(globalCtx, this->unk_198.skeleton, this->unk_198.limbDrawTbl, (s32) this->unk_198.dListCount, func_80B75658, func_80B75708, (Actor *) this);
}
