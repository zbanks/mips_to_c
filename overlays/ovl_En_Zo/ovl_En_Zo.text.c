typedef struct EnZo {
    ...
    /* 0x1E2 */ char pad1E2[0x1C];                  /* maybe part of unk1E0[15]? */
    /* 0x1FE */ Vec3s unk1FE;                       /* inferred */
    /* 0x204 */ char pad204[0x72];                  /* maybe part of unk1FE[20]? */
    /* 0x276 */ Vec3s unk276;                       /* inferred */
    /* 0x27C */ char pad27C[0xE8];                  /* maybe part of unk276[39]? */
    /* 0x364 */ ? unk364;                           /* inferred */
    /* 0x364 */ char pad364[0xBA];
    /* 0x41E */ s16 unk41E;                         /* inferred */
    /* 0x420 */ char pad420[0x4];                   /* maybe part of unk41E[3]? */
} EnZo;                                             /* size = 0x424 */
...
void func_8099EC50(EnZo *this, GlobalContext *globalCtx) {
    ...
    if ((func_8013D68C(this->unk1DC, this->unk1E0, (void *) &sp28) != 0) && (func_8013D768((Actor *) this, (void *) &sp28, sp36) != 0)) {
        this->unk1E0 += 1;
...
void func_8099F15C(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp30.unk0 = (s32) D_8099F5CC.unk0;
    sp30.unk4 = (s32) D_8099F5CC.unk4;
    sp30.unk8 = (s32) D_8099F5CC.unk8;
    sp24.unk0 = (s32) D_8099F5D8.unk0;
    temp_v1 = arg1 + &D_8099F578;
    sp24.unk4 = (s32) D_8099F5D8.unk4;
    sp24.unk8 = (s32) D_8099F5D8.unk8;
    temp_v0 = *temp_v1;
    if ((s32) temp_v0 >= 0) {
        sp20 = temp_v1;
...
void EnZo_Draw(EnZo *this, GlobalContext *globalCtx) {
    ...
    temp_s0->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, func_8099EFF4, func_8099F15C, (Actor *) this, temp_s0->polyOpa.p);
