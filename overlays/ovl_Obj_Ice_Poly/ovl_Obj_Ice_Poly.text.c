typedef struct ObjIcePoly {
    ...
    /* 0x18C */ s16 unk18C;                         /* overlap; inferred */
    /* 0x18E */ s16 unk18E;                         /* inferred */
    /* 0x190 */ char pad190[0x8];                   /* maybe part of unk18E[5]? */
    /* 0x198 */ Collider unk198;                    /* inferred */
    /* 0x1A8 */ u8 unk1A8;                          /* overlap; inferred */
    /* 0x1A9 */ char pad1A9[0x2F];                  /* maybe part of unk1A8[48]? */
    /* 0x1D8 */ s16 unk1D8;                         /* inferred */
    /* 0x1DA */ s16 unk1DA;                         /* inferred */
    /* 0x1DC */ s16 unk1DC;                         /* inferred */
    /* 0x1DE */ char pad1DE[0x6];                   /* maybe part of unk1DC[4]? */
    /* 0x1E4 */ ColliderCylinder unk1E4;            /* inferred */
    /* 0x224 */ s16 unk224;                         /* overlap; inferred */
    /* 0x226 */ s16 unk226;                         /* inferred */
    /* 0x228 */ char pad228[0x10];                  /* maybe part of unk226[9]? */
    /* 0x238 */ void *unk238;                       /* inferred */
    /* 0x23C */ char pad23C[0x5];                   /* maybe part of unk238[2]? */
    /* 0x241 */ u8 unk241;                          /* inferred */
    /* 0x242 */ char pad242[0x2A];                  /* maybe part of unk241[43]? */
    /* 0x26C */ s32 *unk26C;                        /* inferred */
    /* 0x270 */ s16 unk270;                         /* inferred */
    /* 0x272 */ s16 unk272;                         /* inferred */
    /* 0x274 */ s16 unk274;                         /* inferred */
    /* 0x276 */ char pad276[0x6];                   /* maybe part of unk274[4]? */
...
void func_80931A38(ObjIcePoly *this, GlobalContext *globalCtx) {
    ...
    if ((((this->unk1E4.base.acFlags & 2) != 0) && ((temp_v1 = this->unk1E4.base.ac, (temp_v1 == 0)) || ((temp_v0_3 = temp_v1->id, (temp_v0_3 != 0x1AF)) && (this->unk1E4.info.acHitInfo->toucher.dmgFlags == 0x800)) || ((temp_v0_3 == 0x1AF) && (temp_v1->params == 1)))) || (((this->unk241 & 2) != 0) && ((temp_v1_2 = this->unk238, (temp_v1_2 == 0)) || ((temp_v0_4 = temp_v1_2->unk0, (temp_v0_4 != 0x1AF)) && (*this->unk26C == 0x800)) || ((temp_v0_4 == 0x1AF) && (temp_v1_2->unk1C == 1))))) {
        ...
        if ((temp_a1 != 0xFF) && (Flags_GetSwitch(globalCtx, (s32) temp_a1) != 0)) {
            ...
            if (this->unk14A == 0) {
                CollisionCheck_SetAT(globalCtx, temp_s3, (Collider *) &this->unk14C);
                CollisionCheck_SetAT(globalCtx, temp_s3, &this->unk198);
            }
            temp_s3_2 = &globalCtx->colChkCtx;
            phi_s0 = (Collider *) &this->unk14C;
            phi_s2 = (Collider *) &this->unk1E4;
            phi_s1 = 0;
            do {
