...
typedef struct ObjIcePoly {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(ObjIcePoly *, GlobalContext *);
    /* 0x0148 */ u8 unk148;                         /* inferred */
    /* 0x0149 */ u8 unk149;                         /* inferred */
    /* 0x014A */ s16 unk14A;                        /* inferred */
    /* 0x014C */ ColliderCylinder unk14C;           /* inferred */
    /* 0x018C */ s16 unk18C;                        /* overlap; inferred */
    /* 0x018E */ s16 unk18E;                        /* inferred */
    /* 0x0190 */ char pad190[0x8];                  /* maybe part of unk18E[5]? */
    /* 0x0198 */ Collider unk198;                   /* inferred */
    /* 0x01A8 */ u8 unk1A8;                         /* overlap; inferred */
    /* 0x01A9 */ char pad1A9[0x2F];                 /* maybe part of unk1A8[48]? */
    /* 0x01D8 */ s16 unk1D8;                        /* inferred */
    /* 0x01DA */ s16 unk1DA;                        /* inferred */
    /* 0x01DC */ s16 unk1DC;                        /* inferred */
    /* 0x01DE */ char pad1DE[0x6];                  /* maybe part of unk1DC[4]? */
    /* 0x01E4 */ ColliderCylinder unk1E4;           /* inferred */
    /* 0x0224 */ s16 unk224;                        /* overlap; inferred */
    /* 0x0226 */ s16 unk226;                        /* inferred */
    /* 0x0228 */ char pad228[0x10];                 /* maybe part of unk226[9]? */
    /* 0x0238 */ void *unk238;                      /* inferred */
    /* 0x023C */ char pad23C[0x5];
    /* 0x0241 */ u8 unk241;                         /* inferred */
    /* 0x0242 */ char pad242[0x2A];                 /* maybe part of unk241[43]? */
    /* 0x026C */ s32 *unk26C;                       /* inferred */
    /* 0x0270 */ s16 unk270;                        /* inferred */
    /* 0x0272 */ s16 unk272;                        /* inferred */
    /* 0x0274 */ s16 unk274;                        /* inferred */
    /* 0x0276 */ char pad276[0x6];                  /* maybe part of unk274[4]? */
...
void ObjIcePoly_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk149 = (u8) ((s32) temp_v0 >> 8);
    this->actor.uncullZoneForward = 5600.0f;
    Actor_SetScale(&this->actor, (f32) this->actor.params * 0.01f);
    phi_s2 = &this->unk14C;
    phi_s1 = &this->unk1E4;
    phi_s3 = 0;
    do {
        Collider_InitAndSetCylinder(globalCtx, phi_s2, &this->actor, &D_80932320);
        Collider_InitAndSetCylinder(globalCtx, phi_s1, &this->actor, &D_8093234C);
        Collider_UpdateCylinder(&this->actor, phi_s2);
        Collider_UpdateCylinder(&this->actor, phi_s1);
        temp_s3 = phi_s3 + 0x4C;
        phi_s2 += 0x4C;
        phi_s1 += 0x4C;
        phi_s3 = temp_s3;
    } while (temp_s3 != 0x98);
    this->unk18E = (s16) (s32) (this->actor.scale.y * 58.0f);
    temp_v0_2 = this->unk18E;
    this->unk18C = (s16) (s32) (this->actor.scale.x * 48.0f);
    this->unk1DC = temp_v0_2;
    this->unk226 = temp_v0_2;
    this->unk1D8 = (s16) (s32) (this->actor.scale.x * 23.0f);
    this->unk1DA = (s16) (s32) (this->actor.scale.y * 50.0f);
    this->unk224 = this->unk18C + 0x11;
    this->actor.colChkInfo.mass = 0xFF;
    this->unk148 = 0xFF;
    this->unk274 = this->unk1DC;
    this->unk270 = this->unk1D8;
    this->unk272 = this->unk1DA;
    Actor_SetHeight(&this->actor, this->actor.scale.y * 30.0f);
    temp_a1 = this->unk149;
...
void func_80931828(ObjIcePoly *arg0, GlobalContext *arg1) {
    ...
    spA4 = (f32) (arg0->unk14C.dim.height * 2) + arg0->actor.world.pos.y;
    ...
    do {
        ...
        sp9C = temp_f0_2;
        spA0 = ((f32) arg0->unk14C.dim.radius * (sp94 * 0.083333336f)) + arg0->actor.world.pos.x;
        spA8 = ((f32) arg0->unk14C.dim.radius * (temp_f0_2 * 0.083333336f)) + arg0->actor.world.pos.z;
...
void func_80931A38(ObjIcePoly *this, GlobalContext *globalCtx) {
    ...
    temp_v0_2 = this->unk14C.base.atFlags;
    if (((temp_v0_2 & 2) != 0) || ((this->unk1A8 & 2) != 0)) {
        this->unk14A = 0x28;
        this->unk14C.base.atFlags = temp_v0_2 & 0xFFFD;
        this->unk1A8 &= 0xFFFD;
    }
    if ((((this->unk1E4.base.acFlags & 2) != 0) && ((temp_v1 = this->unk1E4.base.ac, (temp_v1 == 0)) || ((temp_v0_3 = temp_v1->id, (temp_v0_3 != 0x1AF)) && (this->unk1E4.info.acHitInfo->toucher.dmgFlags == 0x800)) || ((temp_v0_3 == 0x1AF) && (temp_v1->params == 1)))) || (((this->unk241 & 2) != 0) && ((temp_v1_2 = this->unk238, (temp_v1_2 == 0)) || ((temp_v0_4 = temp_v1_2->unk0, (temp_v0_4 != 0x1AF)) && (*this->unk26C == 0x800)) || ((temp_v0_4 == 0x1AF) && (temp_v1_2->unk1C == 1))))) {
            ...
            do {
                ...
                if (temp_v0_6 != 0) {
                    if ((this != temp_v0_6) && (this != temp_v0_6)) {
                        temp_v0_6->unk14A = 0;
                        temp_v0_6->unk144 = func_80931E58;
                    }
        ...
        if ((temp_a1 != 0xFF) && (Flags_GetSwitch(globalCtx, (s32) temp_a1) != 0)) {
            ...
            if (this->unk14A == 0) {
                CollisionCheck_SetAT(globalCtx, temp_s3, &this->unk14C.base);
                CollisionCheck_SetAT(globalCtx, temp_s3, &this->unk198);
            }
            temp_s3_2 = &globalCtx->colChkCtx;
            phi_s0 = &this->unk14C.base;
            phi_s2 = &this->unk1E4.base;
            phi_s1 = 0;
            do {
...
void func_80931E58(ObjIcePoly *this, GlobalContext *globalCtx) {
    if (ActorCutscene_GetCanPlayNext((s16) this->actor.cutscene) != 0) {
        ...
        this->unk14A = 0x28;
        Audio_PlayActorSound2(&this->actor, 0x28A2U);
...
void func_80931EEC(ObjIcePoly *this, GlobalContext *globalCtx) {
    ...
    this->unk148 += -6;
    this->actor.scale.y = (f32) this->actor.params * 0.01f * (0.5f + ((f32) this->unk14A * 0.0125f));
    if (this->unk14A == 0) {
...
void ObjIcePoly_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0_3->words.w1 = this->unk148 | 0x326400;
