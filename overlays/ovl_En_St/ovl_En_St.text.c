typedef struct EnSt {
    ...
    /* 0x18F */ char pad18F[0x1];
    /* 0x190 */ ColliderCylinder unk190;            /* inferred */
    /* 0x1DC */ ColliderCylinder unk1DC;            /* inferred */
    /* 0x228 */ ColliderCylinder unk228;            /* inferred */
    /* 0x274 */ ColliderCylinder unk274;            /* inferred */
    /* 0x2C0 */ s8 unk2C0;                          /* inferred */
    /* 0x2C1 */ char pad2C1[0x3];                   /* maybe part of unk2C0[4]? */
    ...
    /* 0x2D8 */ char pad2D8[0x34];                  /* maybe part of unk2D4[14]? */
    /* 0x30C */ s16 unk30C;                         /* inferred */
    ...
    /* 0x31A */ char pad31A[0xCE];                  /* maybe part of unk318[104]? */
    /* 0x3E8 */ Vec3s unk3E8;                       /* inferred */
    /* 0x3EE */ char pad3EE[0xAE];                  /* maybe part of unk3E8[30]? */
    /* 0x49C */ Vec3s unk49C;                       /* inferred */
    /* 0x4A2 */ char pad4A2[0xAE];                  /* maybe part of unk49C[30]? */
} EnSt;                                             /* size = 0x550 */
...
s16 func_808A5988(Actor *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    if (arg2 < (s32) arg0->unk31A) {
        ...
        if (temp_v0 != 0) {
            ...
            sp44 += temp_v0_2->unk358;
            sp48 += temp_v0_2->unk35C;
            sp4C += temp_v0_2->unk360;
            phi_t0 = (s32) temp_t0;
            phi_a3 = 1;
            phi_t0 = (s32) temp_t0;
            if (temp_t0 == 0xA) {
            ...
            func_800BE680(arg1, arg0, (Vec3f []) (Vec3f *) &sp44, 1, 0.6f, sp34->unk2DC, sp40, (u8) phi_t0);
        }
    }
    return phi_a3;
}
...
void func_808A6A78(EnSt *this, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->unk2C0) != 0) {
        ...
        Collider_InitAndSetCylinder(globalCtx, &this->unk190, (Actor *) this, &D_808A75B0);
        Collider_InitAndSetCylinder(globalCtx, &this->unk1DC, (Actor *) this, &D_808A75DC);
        Collider_InitAndSetCylinder(globalCtx, &this->unk228, (Actor *) this, &D_808A7608);
        Collider_InitAndSetCylinder(globalCtx, &this->unk274, (Actor *) this, &D_808A7634);
...
void EnSt_Init(EnSt *this, GlobalContext *globalCtx) {
    ...
    if (((temp_a1 != 0x3F) && (this = this, phi_a2 = (Actor *) this, (Flags_GetSwitch(globalCtx, temp_a1) != 0))) || (phi_a2 = (Actor *) this, ((s32) this->unk2C0 < 0))) {
