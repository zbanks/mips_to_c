...
static ActorAnimationEntryS D_808A768C = {
...
typedef struct EnSt {
    ...
    /* 0x0188 */ void (*actionFunc)(EnSt *, GlobalContext *);
    /* 0x018C */ u16 unk18C;                        /* inferred */
    /* 0x018E */ u8 unk18E;                         /* inferred */
    /* 0x018F */ char pad18F[0x1];                  /* maybe part of unk18E[2]? */
    /* 0x0190 */ ColliderCylinder unk190;           /* inferred */
    /* 0x01DC */ ColliderCylinder unk1DC;           /* inferred */
    /* 0x0228 */ ColliderCylinder unk228;           /* inferred */
    /* 0x0274 */ ColliderCylinder unk274;           /* inferred */
    /* 0x02C0 */ s8 unk2C0;                         /* inferred */
    /* 0x02C1 */ char pad2C1[0x3];                  /* maybe part of unk2C0[4]? */
    ...
    /* 0x02DC */ char pad2DC[0x30];                 /* maybe part of unk2D8[13]? */
    ...
    /* 0x0324 */ char pad324[0xC4];                 /* maybe part of unk322[99]? */
    /* 0x03E8 */ Vec3s unk3E8;                      /* inferred */
    /* 0x03EE */ char pad3EE[0xAE];                 /* maybe part of unk3E8[30]? */
    /* 0x049C */ Vec3s unk49C;                      /* inferred */
    /* 0x04A2 */ char pad4A2[0xAE];                 /* maybe part of unk49C[30]? */
} EnSt;                                             /* size 0x550 */
...
void func_808A5050(EnSt *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        Lib_Vec3f_TranslateAndRotateY(&D_801D15B0, phi_s0, (Vec3f *) temp_s4, &spAC);
        sp94 = 0.0f;
        sp98 = 1.0f;
        sp9C = 5.0f;
        Lib_Vec3f_TranslateAndRotateY(&D_801D15B0, phi_s0, (Vec3f *) temp_s4, &spB8);
        spA0 = arg0->actor.world.pos.x + (2.0f * spB8.x);
        spA8 = arg0->actor.world.pos.z + (2.0f * spB8.z);
        func_800B0EB0(arg1, (Vec3f *) temp_fp, &spB8, &spAC, &D_808A770C, &D_808A7710, (s16) 0x64, (s16) 0x28, (s16) (s32) (temp_f4 + 8.0f));
        temp_s1 = phi_s1 + 1;
...
void func_808A52A8(EnSt *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        spA0 = arg0->actor.world.pos.x + (2.0f * spB8.x);
        spA8 = arg0->actor.world.pos.z + (2.0f * spB8.z);
        func_800B0EB0(arg1, (Vec3f *) &spA0, &spB8, &spAC, &D_808A7714, &D_808A7718, (s16) 0x64, (s16) 0x28, (s16) (s32) (temp_f4 + 8.0f));
        temp_s1 = phi_s1 + 1;
...
void func_808A54B0(Actor *arg0, GraphicsContext **arg1) {
    ...
    if (((arg0->unk18C & 1) != 0) && (arg0->colChkInfo.health != 0)) {
        temp_s0 = *arg1;
        *(gSegments + 0x18) = (arg1 + (arg0->unk2C0 * 0x44))->unk17D98 + 0x80000000;
        temp_v0 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = temp_v0 + 8;
        temp_v0->words.w0 = 0xDB060018;
        temp_v0->words.w1 = (arg1 + (arg0->unk2C0 * 0x44))->unk17D98;
        func_8012C2DC(*arg1);
...
? func_808A576C(Actor *arg0) {
    ...
    do {
        if (arg0->unk18E != 0xA) {
            phi_s0->unk31C = (s16) (s32) ((Rand_ZeroOne() * 16.0f) + 8.0f);
        } else {
            phi_s0->unk31C = 0x50;
        }
        phi_s0->unk334 = (s16) phi_s0->unk31C;
        phi_s4->unk2DC = 0.90000004f;
        temp_v0 = arg0->unk18E;
        if ((temp_v0 == 0) || (temp_v0 == 1)) {
            phi_s1->unk35C = (f32) (((Rand_ZeroOne() - 0.5f) * 40.0f) - 10.0f);
        } else {
            phi_s1->unk35C = (f32) (((Rand_ZeroOne() - 0.5f) * 30.0f) + 10.0f);
        }
        phi_s1->unk358 = (f32) (Math_SinS(phi_s2) * 18.0f);
        temp_s3 = phi_s3 + 4;
        temp_s1 = phi_s1 + 0xC;
        temp_s1->unk354 = (f32) (Math_CosS(phi_s2) * 18.0f);
        phi_s0 += 2;
        phi_s4 += 4;
        phi_s1 = temp_s1;
...
s16 func_808A5988(Actor *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    temp_v1 = arg0 + (arg2 * 2);
    phi_a3 = 0;
    if (arg2 < (s32) arg0->unk31A) {
        temp_v0 = temp_v1->unk31C;
        if (temp_v0 != 0) {
            temp_t1 = arg0 + (arg2 * 4);
            sp40 = (f32) temp_v0 / (f32) temp_v1->unk334;
            temp_t0 = arg0->unk18E;
            sp34 = temp_t1;
            sp3C = temp_v1;
            sp53 = temp_t0;
            ...
            sp44.x += temp_v0_2->unk358;
            sp44.y += temp_v0_2->unk35C;
            sp44.z += temp_v0_2->unk360;
            phi_t0 = (s32) temp_t0;
            phi_a3 = 1;
            phi_t0 = (s32) temp_t0;
            if (temp_t0 == 0xA) {
                if ((temp_v1->unk334 - temp_v1->unk31C) < 0x14) {
                    phi_t0 = 0xB;
                }
                sp40 = 1.0f;
            }
            func_800BE680(arg1, arg0, (Vec3f []) &sp44, 1, 0.6f, sp34->unk2DC, sp40, (u8) phi_t0);
        }
    }
    return phi_a3;
}
...
void func_808A5AF8(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        temp_a1 = &sp54;
        sp54.x += phi_s0->unk358;
        sp54.y += phi_s0->unk35C;
        sp54.z += phi_s0->unk360;
...
s16 func_808A5BEC(Actor *arg0) {
    ...
    if (((arg0->unk18C & 4) == 0) || (arg0->xzDistToPlayer > 180.0f)) {
        ...
        if (phi_v1 == 0) {
            ...
            arg0->unk310 = 8;
            temp_t2 = arg0->unk18C ^ 2;
            arg0->unk18C = temp_t2;
            if ((temp_t2 & 1) != 0) {
                arg0->unk310 = (s16) (arg0->unk310 * 2);
            }
            arg0->unk30E = 0x1E;
        }
...
void func_808A5CCC(Actor *arg0) {
    ...
    temp_v0 = arg0->unk310;
    if (temp_v0 != 0) {
        arg0->unk310 = (s16) (temp_v0 - 1);
    }
    if ((s32) arg0->unk310 < 8) {
    ...
    if (phi_v1 == 0) {
        arg0->unk18C = (u16) (arg0->unk18C & 0xFFFE);
    }
}
...
void func_808A5DCC(Vec3s *arg0, u8 *arg1) {
    ...
    if (temp_f2 == 0.0f) {
        ...
        arg0->unk34C = (f32) (arg0->unk34C + temp_f2);
        if (arg0->unk34C >= 255.0f) {
            arg0->unk34C = 255.0f;
            arg0->unk2D8 = (f32) (temp_f2 * -1.0f);
        }
        phi_f0 = arg0->unk34C;
        if (arg0->unk34C <= 0.0f) {
            arg0->unk34C = 0.0f;
            arg0->unk2D8 = (f32) (arg0->unk2D8 * -1.0f);
            phi_f0 = arg0->unk34C;
        }
    }
    arg1->unk0 = (u8) (u32) phi_f0;
    arg1->unk1 = 0;
    arg1->unk2 = 0;
}
...
s32 func_808A5F28(EnSt *arg0, GlobalContext *arg1) {
    ...
    temp_f0 = arg0->unk2C8;
    if ((((temp_f0 > 0.0f) && (arg0->actor.world.pos.y < temp_v1->world.pos.y)) || ((temp_f0 > 0.0f) && (arg0->actor.xzDistToPlayer > 180.0f)) || ((temp_f0 < 0.0f) && (temp_f0_2 = temp_v1->world.pos.y, (temp_f0_2 <= arg0->actor.world.pos.y)) && (arg0->actor.floorHeight <= temp_f0_2) && (arg0->actor.xzDistToPlayer < 120.0f))) && ((arg0->unk18C & 8) == 0)) {
        phi_a3 = 1;
    }
    return phi_a3;
}
...
void func_808A60E0(Actor *arg0) {
    ...
    temp_f2 = arg0->unk15C / (arg0->unk158 - 1.0f);
    if (temp_f2 == 1.0f) {
        arg0 = arg0;
        sp1C = temp_f2;
        sp20 = phi_f12;
    ...
    arg0->unk2D4 = (f32) ((1.0f - temp_f2) * phi_f12 * phi_f0);
    if (phi_f0 < 0.0f) {
        arg0->unk2D4 = (f32) (phi_f0 * phi_f12);
    }
}
...
void func_808A6220(Actor *arg0, GlobalContext *arg1) {
    ...
    if (phi_v0 == 0) {
        ...
        if (arg0->colChkInfo.health != 0) {
            ...
            temp_a1_2 = arg0 + 0x228;
            sp28 = temp_a1_2;
            Collider_UpdateCylinder(arg0, temp_a1_2);
            temp_a1_3 = arg0 + 0x274;
            sp24 = temp_a1_3;
            Collider_UpdateCylinder(arg0, temp_a1_3);
            ...
            if ((s32) phi_v0_2 < 0x4E00) {
                ...
                sp20 = temp_a1_4;
                CollisionCheck_SetAC(arg1, temp_a1_4, &sp28->base);
            } else {
                temp_a1_5 = &arg1->colChkCtx;
                sp20 = temp_a1_5;
                CollisionCheck_SetAC(arg1, temp_a1_5, &sp2C->base);
            }
            CollisionCheck_SetAC(arg1, sp20, &sp24->base);
        }
    }
    temp_a1_6 = arg0 + 0x190;
    if (arg0->colChkInfo.health != 0) {
        sp20 = &arg1->colChkCtx;
        sp2C = temp_a1_6;
        Collider_UpdateCylinder(arg0, temp_a1_6);
        if (((arg0->unk2C8 < 0.0f) && ((arg0->unk18C & 0x10) != 0)) || ((arg0->unk18C & 1) != 0)) {
            arg0->unk1D4 = -0x28;
            arg0->unk1D0 = 0x38;
            arg0->unk1D2 = 0x50;
        } else {
        ...
        CollisionCheck_SetOC(arg1, sp20, &sp2C->base);
        CollisionCheck_SetAT(arg1, sp20, &sp2C->base);
    }
}
...
void func_808A6468(EnSt *arg0) {
    ...
    temp_t8 = arg0->unk18C | 0xC;
    arg0->unk18C = temp_t8;
    arg0->unk18C = temp_t8 & 0xFFED;
    arg0->unk2C8 = -1.0f;
    func_808A5D7C(arg0);
    arg0->unk30E = 0x1E;
    arg0->unk30C = 0;
...
s32 func_808A6580(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk239 & 2) != 0) {
        ...
        arg0->unk239 = (u8) (arg0->unk239 & 0xFFFD);
    }
    temp_v0_2 = arg0->unk1ED;
    if (((temp_v0_2 & 2) != 0) || ((arg0->unk285 & 2) != 0)) {
        arg0->unk1ED = (u8) (temp_v0_2 & 0xFFFD);
        arg0->unk285 = (u8) (arg0->unk285 & 0xFFFD);
        if (arg0->colChkInfo.damageEffect == 4) {
        ...
        if (arg0->unk18E == 0xA) {
            ...
            if (temp_v0_3 != 1) {
                if (temp_v0_3 != 5) {
                    ...
                    arg0->unk314 = 0x14;
                    arg0->unk312 = 0;
                    func_800BCB70(arg0, 0x4000, 0xC8, 0, (s16) (s32) arg0->unk314);
                    func_8013BC6C((SkelAnime *) (arg0 + 0x144), &D_808A768C, 1);
                    arg0->unk18C = (u16) (arg0->unk18C | 8);
                    arg0->unk188 = func_808A6D84;
                    arg0->unk2C8 = -1.0f;
                } else {
                    arg0->unk18E = 0x1EU;
                    arg0->unk312 = 0x28;
                    func_808A576C(arg0);
                    func_800BCB70(arg0, 0, 0xC8, 0, (s16) (s32) arg0->unk312);
                }
            } else {
            ...
            Audio_PlaySoundAtPosition(arg1, &arg0->world.pos, 0x28, 0x3885U);
            ...
            if (arg0->unk18E != 0xA) {
                func_8013BC6C((SkelAnime *) (arg0 + 0x144), &D_808A768C, 7);
                arg0->unk2CC = 0.0f;
                arg0->unk2D4 = 0.0f;
                arg0->gravity = -1.0f;
            }
    ...
    if (((arg0->unk1A3 & 1) != 0) || ((arg0->unk1A0 & 2) != 0)) {
        if ((arg0->unk316 == 0) && (arg0->unk314 == 0) && (arg0->unk312 == 0) && ((arg0->unk1A0 & 4) == 0) && (arg0->colChkInfo.health != 0)) {
            arg1->damagePlayer(arg1, -8);
            Audio_PlayActorSound2(sp3C, 0x83EU);
            func_800B8D98(arg1, arg0, 4.0f, arg0->yawTowardsPlayer, 6.0f);
            arg0->unk316 = 0xA;
            arg0->unk18C = (u16) (arg0->unk18C | 1);
            arg0->unk30E = 0;
        }
        arg0->unk1A0 = (u8) (arg0->unk1A0 & 0xFFFD);
        arg0->unk1A2 = (u8) (arg0->unk1A2 & 0xFFFD);
    }
    return sp38;
}
...
void func_808A6A78(EnSt *this, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->unk2C0) != 0) {
        ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 8.0f);
        temp_a1 = &this->unk144;
        sp34 = temp_a1;
        SkelAnime_Init(globalCtx, temp_a1, &D_06005298, NULL, &this->unk3E8, &this->unk49C, 0x1E);
        func_8013BC6C(sp34, &D_808A768C, 0);
        Collider_InitAndSetCylinder(globalCtx, &this->unk190, &this->actor, &D_808A75B0);
        Collider_InitAndSetCylinder(globalCtx, &this->unk1DC, &this->actor, &D_808A75DC);
        Collider_InitAndSetCylinder(globalCtx, &this->unk228, &this->actor, &D_808A7608);
        Collider_InitAndSetCylinder(globalCtx, &this->unk274, &this->actor, &D_808A7634);
...
void func_808A6C04(EnSt *this, GlobalContext *globalCtx) {
    ...
    temp_f6 = Math_SinS(this->unk30C) * this->unk2C4;
    this->unk30C += 0xE00;
    this->unk2CC = temp_f6;
    Math_ApproachF(&this->unk2C4, 1.0f, 0.1f, 0.3f);
    this->actor.velocity.y = this->unk2D4 + this->unk2CC;
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    temp_a0 = &this->unk144;
    if (((this->unk18C & 8) != 0) && (sp24 = temp_a0, (func_801378B8(temp_a0, this->unk144.animFrameCount) != 0))) {
        func_8013BC6C(temp_a0, &D_808A768C, 3);
        this->unk18C &= 0xFFF7;
        return;
    }
    if ((this->unk310 == 0) && (func_808A5F28(this, globalCtx) != 0) && (func_808A6064(this) == 0)) {
        func_808A650C(this);
        this->actionFunc = func_808A6D84;
        return;
    }
    if ((this->unk316 == 0) && (this->unk314 == 0) && (this->unk312 == 0) && (this->unk2C8 > 0.0f) && (this->actor.xzDistToPlayer < 62.0f)) {
        this->unk30E = 0;
        this->unk18C |= 1;
    }
    func_808A5CCC(&this->actor);
}

void func_808A6D84(EnSt *this, GlobalContext *globalCtx) {
    func_808A60E0(&this->actor);
    this->actor.velocity.y = this->unk2D4 + this->unk2CC;
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    ...
    if (this->unk18E == 0xA) {
        ...
        do {
            ...
            if (temp_v1 == 0) {
                ...
                phi_v0->unk31C = temp_v1 - 1;
                phi_a0 = phi_v0->unk31C;
            }
            if (phi_a0 == 0) {
                phi_a2 = phi_a2_2 + 1;
            }
        ...
        if (phi_a2 == 0xC) {
            func_8013BC6C(&this->unk144, &D_808A768C, 7);
            this->unk18E = 1;
            this->unk2CC = 0.0f;
            this->unk2D4 = 0.0f;
...
void func_808A701C(EnSt *this, GlobalContext *globalCtx) {
    ...
    temp_v0_2 = this->unk318;
    if (temp_v0_2 == 0) {
        phi_a0_3 = 0;
    } else {
        this->unk318 = temp_v0_2 - 1;
        phi_a0_3 = this->unk318;
    }
    if (phi_a0_3 == 0) {
        this->unk18C |= 0x40;
        if (this->unk18E == 1) {
            func_808A576C(&this->actor, 0, 0, 0x18);
            this->unk318 = 0xA;
        }
    }
}
...
void EnSt_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this = this;
    this->unk2C0 = Object_GetIndex(&globalCtx->objectCtx, 1);
    temp_a1 = this->actor.params & 0x3F & 0xFF;
    if (((temp_a1 != 0x3F) && (this = this, phi_a2 = &this->actor, (Flags_GetSwitch(globalCtx, temp_a1) != 0))) || (phi_a2 = &this->actor, ((s32) this->unk2C0 < 0))) {
...
void EnSt_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_DestroyCylinder(globalCtx, &this->unk1DC);
    Collider_DestroyCylinder(globalCtx, &this->unk228);
...
void EnSt_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808A6580(&this->actor, globalCtx) != 0) {
        ...
        } else if ((s32) this->unk312 < 0x14) {
            if (((s32) this->unk312 % 2) != 0) {
                phi_v0 = -1;
            } else {
                phi_v0 = 1;
            }
    ...
    func_808A6220(&this->actor, globalCtx);
}
...
s32 func_808A73E8(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg5, void **arg6) {
    ...
    if (arg1 == 4) {
        ...
        *arg6 = temp_v1_2 + 8;
        ...
        temp_v1_2->unk4 = (s32) ((sp20 << 0x18) | (sp21 << 0x10) | (sp22 << 8));
    }
    return 0;
}
...
void func_808A7478(Actor *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk18C & 0x20) == 0) {
        ...
        if (func_808A6A3C((EnSt *) this) != 0) {
            ...
            temp_s0->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk148, this->unk164, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_808A73E8, NULL, this, temp_s0->polyXlu.p);
        } else {
            func_8012C28C(globalCtx->state.gfxCtx);
            temp_s0->polyOpa.p = SkelAnime_Draw2(globalCtx, this->unk148, this->unk164, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *, Gfx **)) func_808A73E8, NULL, this, temp_s0->polyOpa.p);
        }
    }
    phi_s0 = 0;
    phi_s1 = 0;
    ...
    if (temp_s1 != 0) {
        this->unk31A = (s16) (this->unk31A + 2);
    }
    func_808A54B0(this, &globalCtx->state.gfxCtx);
}
