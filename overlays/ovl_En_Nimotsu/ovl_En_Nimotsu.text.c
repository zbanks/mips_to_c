...
void EnNimotsu_Init(EnNimotsu *this, GlobalContext *globalCtx) {
...
void EnNimotsu_Destroy(EnNimotsu *this, GlobalContext *globalCtx) {
    EnNimotsu *this = (EnNimotsu *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk18C);
}

void EnNimotsu_Update(EnNimotsu *this, GlobalContext *globalCtx) {
    f32 sp4C;
    f32 sp48;
    f32 sp44;
    s16 temp_v1;
...
void EnNimotsu_Draw(EnNimotsu *this, GlobalContext *globalCtx) {
    f32 sp44;
    f32 sp40;
    f32 sp3C;
    f32 sp38;
