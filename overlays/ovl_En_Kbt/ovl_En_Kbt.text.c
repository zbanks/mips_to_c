...
typedef struct EnKbt {
    ...
    /* 0x018E */ char pad18E[0x72];                 /* maybe part of unk188[20]? */
    ...
    /* 0x027F */ u8 unk27F;                         /* inferred */
    /* 0x0280 */ s16 unk280;                        /* inferred */
    /* 0x0282 */ s16 unk282;                        /* inferred */
    /* 0x0284 */ s16 unk284;                        /* inferred */
    /* 0x0286 */ char pad286[0x2];                  /* maybe part of unk284[2]? */
    /* 0x0288 */ void (*actionFunc)(EnKbt *, GlobalContext *);
} EnKbt;                                            /* size 0x28C */
...
void func_80B34314(EnKbt *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        ...
        this = temp_a3;
        func_800B86C8(&temp_a3->actor, globalCtx, temp_a2);
...
block_17:
            ...
            this = phi_a3;
            func_800B8614(&phi_a3->actor, globalCtx, 260.0f);
            phi_a3_2 = this;
        }
    }
...
void EnKbt_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B349C8, func_80B34A00, &this->actor);
}
