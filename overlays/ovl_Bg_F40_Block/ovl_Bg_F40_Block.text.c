typedef struct BgF40Block {
    ...
    /* 0x15C */ Path *unk15C;                       /* inferred */
    /* 0x160 */ char pad160[0x8];                   /* maybe part of unk15C[3]? */
...
? func_80BC3980(BgF40Block *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 0x3F) {
        ...
        if (temp_t8 != 0) {
            ...
            arg0->actor.world.pos.y = (f32) temp_v0_2->unk2;
...
? func_80BC3A2C(BgF40Block *arg0, GlobalContext *arg1) {
    ...
    arg0->unk160 = *temp_v0 - 1;
    arg0->unk164 = *temp_v0 - 1;
    if (temp_v1 != 0x3F) {
        temp_t2 = arg1->setupPathList + (temp_v1 * 8);
        arg0->unk15C = temp_t2;
        if (temp_t2 != 0) {
            arg0 = arg0;
            temp_v1_2 = Lib_SegmentedToVirtual(temp_t2->unk4) + (arg0->unk164 * 6);
            arg0->actor.world.pos.x = (f32) temp_v1_2->unk0;
            arg0->actor.world.pos.y = (f32) temp_v1_2->unk2;
...
s32 func_80BC3B00(Actor *arg0) {
    ...
    temp_a1 = &sp28;
    temp_a0_2 = arg0 + 0x24;
    temp_v1_2 = Lib_SegmentedToVirtual(temp_a0) + (arg0->unk164 * 6);
    sp28 = (f32) temp_v1_2->unk0;
    sp2C = (f32) temp_v1_2->unk2;
    sp30 = (f32) temp_v1_2->unk4;
    if (arg0->unk168 == 6) {
...
s32 func_80BC3D08(Actor *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    if (arg2 != 0) {
        ...
        sp48 = temp_f6;
        temp_f4 = ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk4 * ((800.0f * arg0->scale.y) - (arg0->speedXZ * 0.5f))) + arg0->world.pos.y;
        sp4C = temp_f4;
        temp_f16 = ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk8 * ((800.0f * arg0->scale.z) - (arg0->speedXZ * 0.5f))) + arg0->world.pos.z;
        sp50 = temp_f16;
        sp3C = (*(&D_80BC4620 + (arg0->unk168 * 0xC)) * arg0->speedXZ) + temp_f6;
        sp40 = ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk4 * arg0->speedXZ) + temp_f4;
        sp44 = ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk8 * arg0->speedXZ) + temp_f16;
    } else {
        temp_f4_2 = (*(&D_80BC4620 + (temp_a3 * 0xC)) * 800.0f * arg0->scale.x) + arg0->world.pos.x;
        sp3C = temp_f4_2;
        temp_f10 = ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk4 * 800.0f * arg0->scale.y) + arg0->world.pos.y;
        sp40 = temp_f10;
        temp_f18 = ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk8 * 800.0f * arg0->scale.z) + arg0->world.pos.z;
        sp44 = temp_f18;
        sp48 = temp_f4_2 - (*(&D_80BC4620 + (arg0->unk168 * 0xC)) * arg0->speedXZ * 1.5f);
        sp4C = temp_f10 - ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk4 * arg0->speedXZ * 1.5f);
        sp50 = temp_f18 - ((&D_80BC4620 + (arg0->unk168 * 0xC))->unk8 * arg0->speedXZ * 1.5f);
    }
...
void func_80BC4038(Actor *arg0) {
    ...
    temp_t6 = arg0->unk164;
    arg0->unk168 = 6;
    arg0->unk164 = (s32) arg0->unk160;
    arg0->unk160 = temp_t6;
}

void BgF40Block_Init(BgF40Block *this, GlobalContext *globalCtx) {
    s32 temp_v0;
    ...
    if (temp_v0 != 0x3F) {
        this->unk15C = &globalCtx->setupPathList[temp_v0];
    } else {
        this->unk15C = NULL;
    }
    if (this->unk15C != 0) {
...
void BgF40Block_Destroy(BgF40Block *this, GlobalContext *globalCtx) {
    BgF40Block *this = (BgF40Block *) thisx;
...
void func_80BC41AC(Actor *arg0, GlobalContext *arg1) {
    if (func_80BC3D08(arg0, arg1, 1) != 0) {
        if (Flags_GetSwitch(arg1, (s32) (arg0->params & 0xFE00) >> 9) == 0) {
            func_80BC4038(arg0);
            arg0->unk16C = func_80BC44F4;
            return;
        }
        /* Duplicate return node #4. Try simplifying control flow for better match */
        return;
    }
    arg0->unk16C = func_80BC4344;
}
...
void func_80BC4228(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_80BC3B00(arg0) != 0) {
        temp_v0 = arg0->unk160;
        arg0->speedXZ = 20.0f;
        if (temp_v0 < (*arg0->unk15C - 1)) {
            arg0->unk164 = (s32) (temp_v0 + 1);
        } else {
            arg0->unk16C = func_80BC4530;
    ...
    if (func_80BC3D08(arg0, arg1, 0) != 0) {
        ActorCutscene_Stop((s16) arg0->cutscene);
        arg0->unk16C = (void (*)(BgF40Block *, GlobalContext *)) func_80BC41AC;
...
void func_80BC4448(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_80BC3D08(arg0, arg1, 0) != 0) {
        ActorCutscene_Stop((s16) arg0->cutscene);
        arg0->unk16C = (void (*)(BgF40Block *, GlobalContext *)) func_80BC43CC;
        Audio_PlayActorSound2(arg0, 0x29A4U);
    }
}
...
void BgF40Block_Update(BgF40Block *this, GlobalContext *globalCtx) {
    BgF40Block *temp_a2;
    BgF40Block *this = (BgF40Block *) thisx;
...
void BgF40Block_Draw(BgF40Block *this, GlobalContext *globalCtx) {
    BgF40Block *this = (BgF40Block *) thisx;
