typedef struct EnTanron2 {
    ...
    /* 0x158 */ u8 unk_158;                         /* inferred */
    /* 0x159 */ u8 unk_159;                         /* inferred */
    /* 0x15A */ u8 unk_15A;                         /* inferred */
    /* 0x15B */ s8 unk_15B;                         /* inferred */
    /* 0x15C */ f32 unk_15C;                        /* inferred */
    /* 0x160 */ f32 unk_160;                        /* inferred */
    /* 0x164 */ ColliderCylinder unk_164;           /* inferred */
    /* 0x1B0 */ ColliderCylinder unk_1B0;           /* inferred */
...
void EnTanron2_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk_164, (Actor *) this, &D_80BB8190);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_1B0, (Actor *) this, &D_80BB81BC);
    if ((gGameInfo->data[1312] != 0) || ((gSaveContext.eventInf[6] & 1) != 0)) {
        func_80BB69C0(this);
    } else {
        func_80BB6F64(this);
    }
    this->unk_14A = (s16) (s32) Rand_ZeroFloat(65536.0f);
    this->unk_14C = (s16) (s32) (Rand_ZeroFloat(800.0f) + 1400.0f);
    if (Rand_ZeroOne() < 0.5f) {
        this->unk_14C = (s16) -(s32) this->unk_14C;
    }
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 35.0f, 60.0f, 60.0f, 4U);
    this->actor.floorHeight += 20.0f;
    this->unk_148 = (s16) (s32) Rand_ZeroFloat(32.0f);
}
...
void func_80BB69C0(EnTanron2 *arg0) {
    ...
    arg0->unk_160 = 0.0f;
    arg0->unk_15C = 0.0f;
    arg0->unk_164.dim.radius = 0x19;
    arg0->unk_164.dim.height = 0x2E;
    arg0->unk_164.dim.yShift = -0x17;
    arg0->unk_158 = 0;
}
...
void func_80BB69FC(EnTanron2 *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0 == 1.0f) {
        ...
        sp34 = Math_SmoothStepToF((f32 *) &this->actor.world, temp_s1->x, temp_f0, this->unk_160, 0.0f);
        sp30 = Math_SmoothStepToF(&this->actor.world.pos.y, temp_s1->y, this->unk_15C, this->unk_160, 0.0f);
        if ((this->unk_158 == 0) && ((sp34 + sp30 + Math_SmoothStepToF(&this->actor.world.pos.z, temp_s1->z, this->unk_15C, this->unk_160, 0.0f)) < 2.0f)) {
            this->unk_158 = 1;
...
void func_80BB6B80(EnTanron2 *arg0) {
    ...
    arg0->unk_159 = 1;
    arg0->actor.flags |= 1;
    arg0->unk_164.dim.radius = 0x1E;
    arg0->unk_164.dim.height = 0x32;
    arg0->unk_164.dim.yShift = -0x19;
}
...
void func_80BB7408(EnTanron2 *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.world.pos.y <= temp_f2) {
        ...
        if ((s32) (s8) this->actor.colChkInfo.health <= 0) {
            ...
            temp_v0 = D_80BB8450;
            temp_v0->unk_6F6 = (s16) (temp_v0->unk_6F6 - 1);
            temp_v0_2 = D_80BB8450;
            temp_v0_2->unk_2E2 = (s16) (temp_v0_2->unk_2E2 + 4);
            temp_v0_3 = D_80BB8450;
            temp_v0_3->unk_2E0 = (s16) (temp_v0_3->unk_2E0 + 4);
            return;
        }
...
void func_80BB7578(EnTanron2 *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_154 == 0) && (temp_v0 = arg0->unk_164.base.acFlags, ((temp_v0 & 2) != 0))) {
        temp_v1 = arg0->unk_164.info.acHitInfo;
        arg0->unk_164.base.acFlags = temp_v0 & 0xFFFD;
        if ((*temp_v1 & 0x80) != 0) {
            sp34 = temp_a2;
...
block_11:
    if (func_80BB69FC == arg0->actionFunc) {
        temp_v0_3 = D_80BB8450;
        phi_v0 = temp_v0_3;
        if (temp_v0_3->unk_1F6 != 1) {
            if ((temp_v0_3->unk_1F7 != 0) && (Rand_ZeroOne() < 0.1f)) {
                phi_v0 = D_80BB8450;
                goto block_16;
            }
            goto block_19;
...
block_16:
        temp_v1_2 = phi_v0->unk_1F7;
        sp24 = &arg0->actor.velocity;
        if (temp_v1_2 != 0) {
            phi_v0->unk_1F7 = (u8) (temp_v1_2 - 1);
        }
block_18:
        func_80BB6B80(arg0);
        arg0->unk_158 = 2;
...
void EnTanron2_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0_2 = this->unk_150;
    if (temp_v0_2 != 0) {
        this->unk_150 = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk_152;
    if (temp_v0_3 != 0) {
        this->unk_152 = temp_v0_3 - 1;
    }
    temp_v0_4 = this->unk_154;
    if (temp_v0_4 != 0) {
        this->unk_154 = temp_v0_4 - 1;
    }
        ...
        do {
            ...
            if (temp_a2 > 0) {
                if (((phi_a3_2 - 1) & 1) != 0) {
                    ...
                    if (temp_t5 != 0) {
                        temp_t6 = D_80BB8458;
                        if (temp_t6->unk_F4 < temp_t5->unk_F4) {
                            D_80BB845C = temp_t5;
                            D_80BB845C = temp_t6;
                        }
                    }
...
block_14:
                    ...
                    do {
                        temp_v0_3 = phi_s0_2->unk_4;
                        if (temp_v0_3 != 0) {
                            temp_a0_2 = phi_s0_2->unk_0;
                            if (temp_a0_2->unk_F4 < temp_v0_3->unk_F4) {
                                phi_s0_2->unk_0 = temp_v0_3;
                                phi_s0_2->unk_4 = temp_a0_2;
                            }
                        }
                        temp_a0_3 = phi_s0_2->unk_8;
                        if (temp_a0_3 != 0) {
                            temp_v0_4 = phi_s0_2->unk_4;
                            if (temp_v0_4->unk_F4 < temp_a0_3->unk_F4) {
                                phi_s0_2->unk_4 = temp_a0_3;
                                phi_s0_2->unk_8 = temp_v0_4;
                            }
                        }
    ...
    do {
        ...
        if (temp_a0_4 != 0) {
            ...
            SysMatrix_InsertTranslation(temp_a0_4->unk_24, temp_a0_4->unk_28, temp_a0_4->unk_2C, 0);
            SysMatrix_NormalizeXYZ(temp_s1_3);
            temp_a0_5 = *phi_s0_3;
            Matrix_Scale(temp_a0_5->unk_58, temp_a0_5->unk_5C, 0.0f, 1);
            SysMatrix_InsertZRotation_s((*phi_s0_3)->unk_14A, 1);
    ...
    if (temp_s1_4 != 0) {
        do {
            if (((s32) phi_s1_2->params < 0x64) && (phi_s1_2->unk_15B != 0)) {
                sp40 = &D_06004550;
    ...
    if (temp_s1_6 != 0) {
        do {
            if (((s32) phi_s1_3->params < 0x64) && (phi_s1_3->unk_15B != 0) && (phi_s1_3->world.pos.y <= phi_s1_3->floorHeight)) {
                sp40 = &D_040377B0;
