...
typedef struct EnTanron2 {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnTanron2 *, GlobalContext *);
    ...
    /* 0x0158 */ u8 unk158;                         /* inferred */
    /* 0x0159 */ u8 unk159;                         /* inferred */
    /* 0x015A */ u8 unk15A;                         /* inferred */
    /* 0x015B */ s8 unk15B;                         /* inferred */
    /* 0x015C */ f32 unk15C;                        /* inferred */
    /* 0x0160 */ f32 unk160;                        /* inferred */
    /* 0x0164 */ ColliderCylinder unk164;           /* inferred */
    /* 0x01B0 */ ColliderCylinder unk1B0;           /* inferred */
...
void EnTanron2_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk164, &this->actor, &D_80BB8190);
    Collider_InitAndSetCylinder(globalCtx, &this->unk1B0, &this->actor, &D_80BB81BC);
...
void func_80BB69FC(EnTanron2 *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0 == 1.0f) {
        ...
        sp34 = Math_SmoothStepToF(&this->actor.world.pos.x, temp_s1->x, temp_f0, this->unk160, 0.0f);
        ...
        if ((this->unk158 == 0) && ((sp34 + sp30 + Math_SmoothStepToF(&this->actor.world.pos.z, temp_s1->z, this->unk15C, this->unk160, 0.0f)) < 2.0f)) {
            this->unk158 = 1;
            Audio_PlayActorSound2(&this->actor, 0x38D4U);
        }
...
void func_80BB6BD8(EnTanron2 *this, GlobalContext *globalCtx) {
    ...
    if (this->unk14E == 0) {
        ...
        if (this->actor.world.pos.y <= temp_f2) {
            ...
            sp34 = temp_a2;
            Audio_PlayActorSound2(&this->actor, 0x3A10U);
            temp_v0 = D_80BB8450;
            temp_v1 = this->unk158;
    ...
    if (this->unk14E == 1) {
        ...
        this->unk150 = 0xA;
        Audio_PlayActorSound2(&this->actor, 0x3A0FU);
        ...
        if (this->unk14E == 0) {
            ...
            if (this->actor.world.pos.y <= temp_f2) {
                ...
                if (D_80BB8450->unk6F8 > 0.1f) {
                    Audio_PlayActorSound2(&this->actor, 0x28C6U);
                }
...
void func_80BB71C8(EnTanron2 *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        SysMatrix_GetStateTranslationAndScaledZ(Rand_ZeroFloat(10.0f) + 5.0f, &spA8);
        sp90 = arg0->actor.world.pos.x + spA8.x;
        sp94 = arg0->actor.world.pos.y + spA8.y;
        sp98 = arg0->actor.world.pos.z + spA8.z;
        sp9C = spA8.x * -0.03f;
        spA0 = spA8.y * -0.03f;
        spA4 = spA8.z * -0.03f;
        temp_f20 = Rand_ZeroFloat(100.0f);
        EffectSsDtBubble_SpawnCustomColor(arg1, (Vec3f *) temp_s4, &spA8, (Vec3f *) temp_s5, &D_80BB81E8, &D_80BB81EC, (s16) (s32) (temp_f20 + 200.0f), (s16) (s32) (Rand_ZeroFloat(5.0f) + 15.0f), (s16) 0);
        temp_s0 = phi_s0 + 1;
        phi_s0 = temp_s0;
    } while (temp_s0 != 0xF);
}
...
void func_80BB7398(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->colChkInfo.health <= 0) {
        ...
        Audio_PlaySoundAtPosition(arg1, &arg0->world.pos, 0x1E, 0x3A12U);
        return;
    }
...
void func_80BB7578(EnTanron2 *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk154 == 0) && (temp_v0 = arg0->unk164.base.acFlags, ((temp_v0 & 2) != 0))) {
        ...
        if ((*temp_v1 & 0x80) != 0) {
            ...
            arg0->unk158 = 1;
            Audio_PlayActorSound2(&arg0->actor, 0x3A11U);
...
void EnTanron2_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk159 != 0) {
        ...
        sp20 = temp_a2_2;
        Collider_UpdateCylinder(&this->actor, temp_a2_2);
        CollisionCheck_SetAC(globalCtx, (CollisionCheckContext *) sp24, &temp_a2_2->base);
    }
