typedef struct DoorWarp1 {
    ...
    /* 0x1D0 */ u16 unk_1D0;                        /* inferred */
    /* 0x1D2 */ char pad_1D2[0x1];
    /* 0x1D3 */ u8 unk_1D3;                         /* inferred */
    /* 0x1D4 */ s8 unk_1D4;                         /* inferred */
    /* 0x1D5 */ char pad_1D5[0x3];                  /* maybe part of unk_1D4[4]? */
    /* 0x1D8 */ void (*actionFunc)(DoorWarp1 *, GlobalContext *);
    /* 0x1DC */ LightNode *unk_1DC;                 /* inferred */
    /* 0x1E0 */ LightInfo unk_1E0;                  /* inferred */
    /* 0x1EE */ char pad_1EE[0x2];
    /* 0x1F0 */ LightNode *unk_1F0;                 /* inferred */
    /* 0x1F4 */ LightInfo unk_1F4;                  /* inferred */
...
void func_808B8568(DoorWarp1 *arg0, GlobalContext *arg1) {
    ...
    temp_a1 = arg1 + 0x818;
    sp30 = temp_a1;
    arg0->unk_1DC = LightContext_InsertLight(arg1, temp_a1, sp34);
    ...
    arg0->unk_1F0 = LightContext_InsertLight(arg1, temp_a1, sp34);
}
...
s32 func_808B866C(DoorWarp1 *arg0, GlobalContext *arg1) {
    ...
    if (fabsf(arg0->actor.xzDistToPlayer) < 60.0f) {
        temp_f0 = arg1->actorCtx.actorList[2].first->unk_28;
...
void DoorWarp1_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    globalCtx = globalCtx;
    sp18 = temp_a1;
    LightContext_RemoveLight(temp_a0, temp_a1, this->unk_1DC);
    LightContext_RemoveLight(globalCtx, temp_a1, this->unk_1F0);
    phi_a0 = 0;
    do {
        temp_a0_2 = phi_a0 + 1;
...
u8 func_808B900C(DoorWarp1 *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x239U) != 0) {
        ...
        if (arg0->unk_208 != temp_a0) {
            arg0->unk_208 = (u8) temp_a0;
            if (*temp_v1->unk_1F4C == 2) {
                sp1B = 1;
            }
        }
    }
...
void func_808B921C(DoorWarp1 *this, GlobalContext *globalCtx) {
    ...
    temp_f0 = this->unk_1A8;
    this->unk_203 = (u8) (u32) (temp_f0 * 200.0f);
    if (temp_f0 > 0.8f) {
...
void func_808B958C(DoorWarp1 *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v1 >= 0x65) {
        ...
        this->unk_1CA = temp_v1 + 1;
    }
    temp_t8 = this->unk_1D0 + 1;
    this->unk_1D0 = temp_t8;
...
void func_808B96B0(DoorWarp1 *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_1C4;
    if ((s32) temp_v0 < 0x64) {
        this->unk_1C4 = temp_v0 + 2;
    }
    temp_v0_2 = this->unk_1C6;
    if ((s32) temp_v0_2 < 0x78) {
        this->unk_1C6 = temp_v0_2 + 4;
    }
    temp_v0_3 = this->unk_1C8;
    if ((s32) temp_v0_3 < 0xE6) {
        this->unk_1C8 = temp_v0_3 + 4;
        return;
    }
...
void func_808B98A8(DoorWarp1 *this, GlobalContext *globalCtx) {
    ...
    Lights_PointNoGlowSetInfo(&this->unk_1E0, (s16) (s32) (temp_s1->world.pos.x + 10.0f), (s16) (s32) (temp_s1->world.pos.y + 10.0f), (s16) (s32) (temp_s1->world.pos.z + 10.0f), (u8) 0xEB, (u8) 0xFF, (u8) 0xFF, (s16) 0xFF);
    Lights_PointNoGlowSetInfo(&this->unk_1F4, (s16) (s32) (temp_s1->world.pos.x - 10.0f), (s16) (s32) (temp_s1->world.pos.y - 10.0f), (s16) (s32) (temp_s1->world.pos.z - 10.0f), (u8) 0xEB, (u8) 0xFF, (u8) 0xFF, (s16) 0xFF);
...
void func_808B9B30(DoorWarp1 *this, GlobalContext *globalCtx) {
    if (fabsf(this->actor.xzDistToPlayer) >= 60.0f) {
        if (func_808B849C(this, globalCtx) != 0) {
            this->unk_1A0 = Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, 0x140, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, func_808B849C(this, globalCtx) - 1);
        }
...
void func_808B9F10(DoorWarp1 *this, GlobalContext *globalCtx) {
    ...
    Audio_PlayActorSound2((Actor *) this, 0x2025U);
    if ((this->unk_203 == 0) && (func_808B866C(this, globalCtx) != 0) && (func_801690CC(globalCtx) == 0) && (this->unk_203 == 0)) {
...
void func_808B9FD0(DoorWarp1 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_ChangeAnimImpl(&this->unk_15C, &D_06001374, 1.0f, (f32) sp34, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06001374), (u8) 2, 40.0f, (s8) 1);
    this->unk_1CA = 0x32;
...
void func_808BA550(DoorWarp1 *this, GlobalContext *globalCtx) {
    ...
    temp_a2 = this->unk_1CA;
    temp_v1 = globalCtx->actorCtx.actorList[2].first;
    if (temp_a2 != 0) {
        this->unk_1CA = temp_a2 - 1;
    }
    phi_a2 = (s32) this->unk_1CA;
    if ((s32) this->unk_1CA < 0x1F) {
        temp_t7 = temp_v1->unk_14B;
        phi_f0 = 0.0f;
        switch (temp_t7) {
        case 0:
            phi_f0 = -37.0f;
        ...
        if (phi_a2 <= 0) {
            ...
            if ((s32) temp_v0 < 0xFA0) {
                this->unk_1CC = temp_v0 + 0x28;
            }
            temp_v1->world.rot.y -= this->unk_1CC;
            temp_v1->shape.rot.y -= this->unk_1CC;
        }
        sp30 = temp_v1;
    ...
    temp_t5 = this->unk_1D0 + 1;
    this->unk_1D0 = temp_t5;
    ...
    if (((s32) D_808BC000 < temp_v0_2) && (gSaveContext.nextCutsceneIndex == 0xFFEF)) {
        ...
        func_808BA10C(this, globalCtx);
        phi_v0 = (s32) this->unk_1D0;
    }
    if (phi_v0 >= 0x8D) {
        globalCtx->envCtx.unk_E5 = 1;
        temp_f0 = (f32) (this->unk_1D0 - 0x8C) / 20.0f;
        phi_f0_2 = temp_f0;
        if (temp_f0 > 1.0f) {
            phi_f0_2 = 1.0f;
        }
    ...
    sp30 = globalCtx->actorCtx.actorList[2].first;
    Lights_PointNoGlowSetInfo(&this->unk_1E0, (s16) (s32) (globalCtx->actorCtx.actorList[2].first->world.pos.x + 10.0f), (s16) (s32) (globalCtx->actorCtx.actorList[2].first->world.pos.y + 10.0f), (s16) (s32) (globalCtx->actorCtx.actorList[2].first->world.pos.z + 10.0f), (u8) 0xEB, (u8) 0xFF, (u8) 0xFF, (s16) 0xFF);
    Lights_PointNoGlowSetInfo(&this->unk_1F4, (s16) (s32) (globalCtx->actorCtx.actorList[2].first->world.pos.x - 10.0f), (s16) (s32) (globalCtx->actorCtx.actorList[2].first->world.pos.y - 10.0f), (s16) (s32) (globalCtx->actorCtx.actorList[2].first->world.pos.z - 10.0f), (u8) 0xEB, (u8) 0xFF, (u8) 0xFF, (s16) 0xFF);
    ...
    temp_f0_2 = 1.0f - ((f32) (temp_v0_3 - this->unk_1D0) / (f32) ((temp_v0_3 * 0) + 0x64));
    if (temp_f0_2 > 0.0f) {
...
void DoorWarp1_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_1A0;
    if ((temp_v0 != 0) && (this->unk_204 != temp_v0->unk_15C)) {
        temp_v0->world.pos.y = this->actor.world.pos.y;
        this->unk_1A0->unk_158 = (f32) this->actor.world.pos.y;
        this->unk_1A0->unk_15C = (f32) this->unk_204;
    }
    this->actionFunc(this, globalCtx);
    if ((this->actor.params & 0xFF) < 2) {
        Actor_SetScale((Actor *) this, (f32) this->unk_1C4 / 100.0f);
    }
}
...
void func_808BAE9C(DoorWarp1 *arg0, GlobalContext *arg1) {
    ...
    SysMatrix_InsertTranslation(0.0f, arg0->unk_1A4 * 230.0f, 0.0f, 1);
    ...
    if (arg0->unk_1B0 > 0.0f) {
        ...
        SysMatrix_InsertTranslation(0.0f, arg0->unk_1A8 * 60.0f, 0.0f, 1);
...
void func_808BB4F4(void *arg0, GlobalContext *arg1) {
    ...
    sp64.unk_0 = (s32) D_808BBB50.unk_0;
    sp64.unk_4 = (s32) D_808BBB50.unk_4;
    sp64.unk_8 = (s32) D_808BBB50.unk_8;
    phi_v1 = 0;
    if (arg0->unk_1D4 != 0) {
        SysMatrix_InsertTranslation(arg0->unk_24, arg0->unk_28 + arg0->unk_1A4, arg0->unk_2C, 0);
        Matrix_Scale(4.0f, arg0->unk_1AC, 4.0f, 1);
    ...
    sp60 = phi_v1;
    SysMatrix_InsertTranslation(arg0->unk_24, arg0->unk_28, arg0->unk_2C, 0);
    Matrix_RotateY(arg0->unk_32, 1U);
    Matrix_Scale(1.0f, arg0->unk_1A8, 1.0f, 1);
