...
void ObjMilkBin_Init(ObjMilkBin *this, GlobalContext *globalCtx) {
...
void ObjMilkBin_Destroy(ObjMilkBin *this, GlobalContext *globalCtx) {
    ObjMilkBin *this = (ObjMilkBin *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->collider);
}

void ObjMilkBin_Update(ObjMilkBin *this, GlobalContext *globalCtx) {
...
void ObjMilkBin_Draw(ObjMilkBin *this, GlobalContext *globalCtx) {
    ObjMilkBin *this = (ObjMilkBin *) thisx;
    if ((this->disableDraw & 1) == 0) {
