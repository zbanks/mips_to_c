...
void OceffWipe5_Init(OceffWipe5 *this, GlobalContext *globalCtx) {
    Camera *temp_t9;
...
void OceffWipe5_Destroy(OceffWipe5 *this, GlobalContext *globalCtx) {
    OceffWipe5 *this = (OceffWipe5 *) thisx;
    func_80115D5C(globalCtx);
    globalCtx->msgCtx.unk120B0 = 0;
}

void OceffWipe5_Update(OceffWipe5 *this, GlobalContext *globalCtx) {
    Camera *temp_t9;
    s16 temp_v0;
    OceffWipe5 *this = (OceffWipe5 *) thisx;
...
void OceffWipe5_Draw(OceffWipe5 *this, GlobalContext *globalCtx) {
    f32 sp70;
    f32 sp58;
    f32 sp48;
    s32 sp40;
