...
void func_80A0B500(BgDyYoseizo *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        ...
        this->unk2E8 = Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, 0x175, sp54->world.pos.x, sp54->world.pos.y + 200.0f, sp54->world.pos.z, (s16) 0, (s16) 0, (s16) 0, this->actor.params & 0xF);
        this->unk300 = 0x78;
    }
}
    ...
    do {
        if (phi_s0->unk0 != 0) {
            ...
            if ((s32) phi_s0->unk36 < 5) {
                ...
                temp_s3->unk0 = temp_s2->unk0;
                temp_s1 = phi_s0 + 4;
                temp_s3->unk4 = (s32) temp_s2->unk4;
                temp_s3->unk8 = (s32) temp_s2->unk8;
                ...
                phi_s0->unkC = (f32) (phi_s0->unkC + sp98);
            }
        }
