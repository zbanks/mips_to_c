...
void ObjSwprize_Init(ObjSwprize *this, GlobalContext *globalCtx) {
    s16 temp_a1;
...
void ObjSwprize_Destroy(ObjSwprize *this, GlobalContext *globalCtx) {
    ObjSwprize *this = (ObjSwprize *) thisx;
...
void ObjSwprize_Update(ObjSwprize *this, GlobalContext *globalCtx) {
    ObjSwprize *this = (ObjSwprize *) thisx;
