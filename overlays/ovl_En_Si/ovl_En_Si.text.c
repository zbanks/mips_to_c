typedef struct EnSi {
    ...
    /* 0x148 */ ColliderSphere unk_148;             /* inferred */
    /* 0x15B */ u8 unk_15B;                         /* overlap; inferred */
} EnSi;                                             /* size = 0x1A0 */
...
void func_8098CA20(EnSi *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg0 + 0x148;
    arg0->unk_148.dim.worldSphere.center.x = (s16) (s32) arg0->actor.world.pos.x;
    arg0->unk_148.dim.worldSphere.center.y = (s16) (s32) arg0->actor.world.pos.y;
    arg0->unk_148.dim.worldSphere.center.z = (s16) (s32) arg0->actor.world.pos.z;
    arg0->unk_148.dim.worldSphere.radius = (s16) (s32) ((f32) arg0->unk_148.dim.modelSphere.radius * arg0->unk_148.dim.scale);
...
void func_8098CAD0(void *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = (s32) (arg0->unk_1C & 0xFC) >> 2;
...
void EnSi_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnSi *this = (EnSi *) thisx;
    Collider_DestroySphere(globalCtx, &this->unk_148);
}
