...
typedef struct EnSi {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnSi *, GlobalContext *);
    /* 0x0148 */ ColliderSphere unk148;             /* inferred */
    /* 0x015B */ u8 unk15B;                         /* overlap; inferred */
    /* 0x015C */ char pad15C[0x44];                 /* maybe part of unk15B[69]? */
} EnSi;                                             /* size 0x1A0 */
...
void EnSi_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetSphere(globalCtx, temp_a1, &this->actor, &D_8098CD80);
