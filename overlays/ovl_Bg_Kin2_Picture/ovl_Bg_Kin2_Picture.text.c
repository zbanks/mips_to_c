...
void BgKin2Picture_Init(BgKin2Picture *this, GlobalContext *globalCtx) {
    ? sp8C;
    ? sp80;
    ? sp74;
    ? sp68;
    ...
    Collider_SetTris(globalCtx, temp_a1, (Actor *) this, &D_80B6FA08, &this->unk17C);
...
void BgKin2Picture_Destroy(BgKin2Picture *this, GlobalContext *globalCtx) {
...
void func_80B6F4D4(BgKin2Picture *this, GlobalContext *globalCtx) {
    ...
    CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk15C);
}
...
void func_80B6F72C(BgKin2Picture *this, GlobalContext *globalCtx) {
    ...
    if (Math_ScaledStepToS((s16 *) &this->actor.shape, 0x4000, this->unk238) != 0) {
...
void BgKin2Picture_Update(BgKin2Picture *this, GlobalContext *globalCtx) {
    BgKin2Picture *this = (BgKin2Picture *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgKin2Picture_Draw(BgKin2Picture *this, GlobalContext *globalCtx) {
    BgKin2Picture *this = (BgKin2Picture *) thisx;
