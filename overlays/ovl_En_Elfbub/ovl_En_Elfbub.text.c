...
void EnElfbub_Init(EnElfbub *this, GlobalContext *globalCtx) {
    Actor *temp_v0;
    s32 temp_f4;
    ...
    this->unk198 = 0.08f;
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, (Actor *) this, &D_80ACE270);
...
void EnElfbub_Destroy(EnElfbub *this, GlobalContext *globalCtx) {
    EnElfbub *this = (EnElfbub *) thisx;
...
void EnElfbub_Update(EnElfbub *this, GlobalContext *globalCtx) {
    EnElfbub *this = (EnElfbub *) thisx;
    Collider_UpdateCylinder((Actor *) this, &this->unk144);
    this->actionFunc(this, globalCtx);
    Actor_SetHeight((Actor *) this, this->actor.shape.yOffset);
}

void EnElfbub_Draw(EnElfbub *this, GlobalContext *globalCtx) {
    Gfx *sp2C;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
