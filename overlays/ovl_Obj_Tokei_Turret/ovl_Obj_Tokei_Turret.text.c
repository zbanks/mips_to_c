...
void ObjTokeiTurret_Init(ObjTokeiTurret *this, GlobalContext *globalCtx) {
    s32 sp1C;
...
void ObjTokeiTurret_Destroy(ObjTokeiTurret *this, GlobalContext *globalCtx) {
    ObjTokeiTurret *this = (ObjTokeiTurret *) thisx;
    BgCheck_RemoveActorMesh(globalCtx, &globalCtx->colCtx.dyna, this->unk144);
}

void ObjTokeiTurret_Update(ObjTokeiTurret *this, GlobalContext *globalCtx) {
    ObjTokeiTurret *this = (ObjTokeiTurret *) thisx;

}

void ObjTokeiTurret_Draw(ObjTokeiTurret *this, GlobalContext *globalCtx) {
    Gfx *sp28;
