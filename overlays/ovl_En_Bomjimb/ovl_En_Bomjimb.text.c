typedef struct EnBomjimb {
    ...
    /* 0x2E0 */ u8 unk2E0;                          /* inferred */
    /* 0x2E1 */ char pad2E1[0x3];                   /* maybe part of unk2E0[4]? */
    /* 0x2E4 */ Actor *unk2E4;                      /* inferred */
...
void EnBomjimb_Init(EnBomjimb *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    s16 temp_v0_2;
    s32 temp_v1;
    u16 temp_t2;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2E8, (Actor *) this, &D_80C03194);
...
block_20:
        ...
        Math_Vec3f_Copy(&this->unk2A0, (Vec3f *) &this->actor.home);
...
void EnBomjimb_Destroy(EnBomjimb *this, GlobalContext *globalCtx) {
    EnBomjimb *this = (EnBomjimb *) thisx;
    ...
    if ((func_80C012FC(this) == 0) && (func_80C013B4(this) == 0) && (func_80C013F0(this, globalCtx) == 0)) {
        ...
        if (temp_v0 != 0) {
            if (temp_v0 != 1) {
                ...
                if (sp80 >= 0.0f) {
                    this->unk2D6 = Math_Vec3f_Yaw((Vec3f *) &this->actor.world, &this->unk294);
                ...
                if (((s32) phi_v0 < 0x100) && (sp38 = temp_a1, Math_Vec3f_Copy((Vec3f *) &sp54, (Vec3f *) temp_a1), sp54 += Math_SinS(this->actor.world.rot.y) * 60.0f, sp5C += Math_CosS(this->actor.world.rot.y) * 60.0f, (func_800C55C4(&globalCtx->colCtx, (Vec3f *) temp_a1, (Vec3f *) &sp54, (Vec3f *) &sp60, &sp7C, 1U, 0U, 0U, 1U, &sp44) != 0))) {
                    ...
                    if ((this->unk2B0 == 0) || (sqrtf((temp_f2 * temp_f2) + (temp_f14 * temp_f14)) < 4.0f)) {
                        ...
                        Math_ApproachF((f32 *) &this->actor.world, temp_f12, 0.3f, this->unk2B4);
            ...
            if (((phi_v1 >> 0x10) < 0x4000) && (func_800C55C4(&globalCtx->colCtx, (Vec3f *) sp38, (Vec3f *) &sp48, (Vec3f *) &sp60, &sp7C, 1U, 0U, 0U, 1U, &sp44) == 0)) {
                ...
                Math_Vec3f_Copy(&this->unk294, (Vec3f *) &sp48);
...
void func_80C01CD0(EnBomjimb *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2DC != 7) {
        ...
        Math_ApproachF((f32 *) temp_a0, this->unk294.x, 0.3f, 2.0f);
...
void func_80C02108(EnBomjimb *arg0) {
    ...
    func_80C012E0(arg0);
    Math_Vec3f_Copy(&arg0->unk2A0, (Vec3f *) &arg0->actor.world);
    arg0->unk2D4 = 0;
    arg0->unk2CA = 5;
...
void EnBomjimb_Update(EnBomjimb *this, GlobalContext *globalCtx) {
...
void EnBomjimb_Draw(EnBomjimb *this, GlobalContext *globalCtx) {
    Gfx *sp38;
    Gfx *sp34;
    Gfx *sp30;
    Gfx *temp_v0;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80C02FA8, NULL, (Actor *) this);
}
