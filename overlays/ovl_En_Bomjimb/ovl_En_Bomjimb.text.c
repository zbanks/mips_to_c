...
typedef struct EnBomjimb {
    ...
    /* 0x014B */ u8 unk14B;                         /* overlap; inferred */
    /* 0x014C */ char pad14C[0x3C];                 /* maybe part of unk14B[61]? */
    ...
    /* 0x0284 */ void (*actionFunc)(EnBomjimb *, GlobalContext *);
    /* 0x0288 */ char pad288[0x2];
    ...
    /* 0x02BC */ char pad2BC[0x4];                  /* maybe part of unk2B8[2]? */
    ...
    /* 0x02E0 */ u8 unk2E0;                         /* inferred */
    /* 0x02E1 */ char pad2E1[0x3];                  /* maybe part of unk2E0[4]? */
    /* 0x02E4 */ Actor *unk2E4;                     /* inferred */
...
void EnBomjimb_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk2E8, &this->actor, &D_80C03194);
    this->actor.targetMode = 6;
    Actor_SetScale(&this->actor, 0.01f);
    temp_v0 = this->actor.params;
    this->unk2C6 = ((s32) temp_v0 >> 4) & 0xF;
    this->unk2B2 = ((s32) temp_v0 >> 8) & 0xFF;
    if (this->unk2C6 != 0) {
        this->unk2C8 = (temp_v0 & 0xF) + 1;
    }
    if ((s32) this->unk2C8 < 0) {
        this->unk2C8 = 0;
    }
    if ((s32) this->unk2C6 < 0) {
        this->unk2C6 = 0;
    }
    temp_v1 = gSaveContext.weekEventReg[73] & 0x10;
    if ((temp_v1 != 0) || ((gSaveContext.weekEventReg[85] & 2) != 0)) {
        temp_t2 = (u16) this->unk2C8;
        switch (temp_t2) {
        case 0:
...
block_20:
        ...
        Math_Vec3f_Copy(&this->unk2A0, &this->actor.home.pos);
        temp_v0_2 = this->unk2C6;
...
void func_80C011CC(Actor *arg0) {
    ...
    temp_a0 = arg0 + 0x144;
    if ((arg0->unk2DC == 5) && ((sp24 = temp_a0, (func_801378B8(temp_a0, 9.0f) != 0)) || (func_801378B8(temp_a0, 10.0f) != 0) || (func_801378B8(sp24, 17.0f) != 0) || (func_801378B8(sp24, 18.0f) != 0))) {
        Audio_PlayActorSound2(arg0, 0x292CU);
    }
    temp_a0_2 = arg0 + 0x144;
    if ((arg0->unk2DC == 0x13) && ((sp24 = (SkelAnime *) temp_a0_2, (func_801378B8((SkelAnime *) temp_a0_2, 2.0f) != 0)) || (func_801378B8((SkelAnime *) temp_a0_2, 6.0f) != 0))) {
        Audio_PlayActorSound2(arg0, 0x292CU);
    }
    if ((arg0->unk2DC == 0x12) && (func_801378B8((SkelAnime *) (arg0 + 0x144), 15.0f) != 0)) {
        Audio_PlayActorSound2(arg0, 0x292DU);
    }
    if ((arg0->unk2DC == 7) && (func_801378B8((SkelAnime *) (arg0 + 0x144), 8.0f) != 0)) {
        Audio_PlayActorSound2(arg0, 0x292DU);
    }
}
...
s32 func_80C013B4(EnBomjimb *arg0) {
    ...
    phi_v0 = 0;
    if ((arg0->unk2E8.base.acFlags & 2) != 0) {
        func_80C0267C();
        phi_v0 = 1;
    }
    return phi_v0;
...
s32 func_80C013F0(EnBomjimb *arg0, GlobalContext *arg1) {
    ...
    if (((arg0->unk2E8.base.ocFlags1 & 2) != 0) && (temp_a2 = arg0->unk2E8.base.oc, (temp_a2->id == 0x81)) && (D_80C03170 == 0) && (temp_a2->update != 0) && (sp1C = temp_a2, arg0 = arg0, (Actor_HasParent(temp_a2, arg1) == 0))) {
        D_80C03170 = temp_a2;
        arg0->unk2E4 = temp_a2;
    ...
    if ((func_80C012FC(this) == 0) && (func_80C013B4(this) == 0) && (func_80C013F0(this, globalCtx) == 0)) {
        ...
        if (temp_v0 != 0) {
            if (temp_v0 != 1) {
                ...
                if (sp80 >= 0.0f) {
                    this->unk2D6 = Math_Vec3f_Yaw(&this->actor.world.pos, &this->unk294);
                    Math_SmoothStepToS(&this->actor.world.rot.y, this->unk2D6, 0xA, 0x7D0, (s16) 0x14);
                }
                temp_a1 = &this->actor.world;
                temp_v1 = this->actor.world.rot.y - this->unk2D6;
                phi_v0 = temp_v1;
                if ((s32) temp_v1 < 0) {
                    phi_v0 = (s16) -(s32) temp_v1;
                }
                if (((s32) phi_v0 < 0x100) && (sp38 = temp_a1, Math_Vec3f_Copy(&sp54, &temp_a1->pos), sp54.x += Math_SinS(this->actor.world.rot.y) * 60.0f, sp54.z += Math_CosS(this->actor.world.rot.y) * 60.0f, (func_800C55C4(&globalCtx->colCtx, &temp_a1->pos, &sp54, &sp60, &sp7C, 1U, 0U, 0U, 1U, &sp44) != 0))) {
                    this->unk2AE = 0;
                    ...
                    temp_f12 = this->unk294.x;
                    temp_f2 = temp_f12 - this->actor.world.pos.x;
                    temp_f14 = this->unk294.z - this->actor.world.pos.z;
                    if ((this->unk2B0 == 0) || (sqrtf((temp_f2 * temp_f2) + (temp_f14 * temp_f14)) < 4.0f)) {
                        this->unk2AE = Rand_S16Offset(0x14, 0x14);
                        if ((this->unk2AE & 1) == 0) {
                            func_80C0113C(this, 0x14, 1.0f);
                        } else {
                            func_80C0113C(this, 0, 1.0f);
                        ...
                        Math_ApproachF(&this->actor.world.pos.x, temp_f12, 0.3f, this->unk2B4);
                        Math_ApproachF(&this->actor.world.pos.z, this->unk294.z, 0.3f, this->unk2B4);
                        Math_ApproachF(&this->unk2B4, 1.0f, 0.3f, 0.5f);
                    }
                }
            }
        } else if (this->unk2AE == 0) {
            ...
            sp38 = temp_a0;
            sp48.z += temp_f0;
            if ((s32) (s16) (this->actor.world.rot.y - Math_Vec3f_Yaw(&temp_a0->pos, &sp48)) < 0) {
                phi_v1 = (s32) (s16) (this->actor.world.rot.y - Math_Vec3f_Yaw(&sp38->pos, &sp48)) * -0x10000;
            } else {
                phi_v1 = (this->actor.world.rot.y - Math_Vec3f_Yaw(&temp_a0->pos, &sp48)) << 0x10;
            }
            if (((phi_v1 >> 0x10) < 0x4000) && (func_800C55C4(&globalCtx->colCtx, &sp38->pos, &sp48, &sp60, &sp7C, 1U, 0U, 0U, 1U, &sp44) == 0)) {
                func_80C0113C(this, 5, 1.0f);
                Math_Vec3f_Copy(&this->unk294, &sp48);
                this->unk2B0 = Rand_S16Offset(0x1E, 0x32);
                this->unk2CC += 1;
            }
        }
        if (sp84->unkA74 != 0x1000000) {
...
void func_80C01A24(EnBomjimb *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->unk2E8.base.acFlags;
    this->actor.gravity = -0.1f;
    if ((temp_v1 & 2) != 0) {
        temp_v0 = this->unk2E4;
        this->unk2E8.base.acFlags = temp_v1 & 0xFFFD;
        if ((temp_v0 != 0) && (temp_v0->update != 0)) {
            temp_v0->unk2C4 = 90000.0f;
        }
    ...
    if ((this->unk2C0 != 0) && ((this->actor.bgCheckFlags & 1) == 0)) {
        func_80C01B40(this);
    }
}
...
void func_80C01C18(EnBomjimb *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 != 0) && (temp_v0->update != 0)) {
        ...
        arg0->unk2E4->shape.rot.z = 0xFA0 - ((s16) (arg1->gameplayFrames & 2) * 0xFA0);
        temp_v0_2 = arg0->unk2E4;
        arg0->unk294.y = arg0->actor.world.pos.y;
        arg0->unk294.x = temp_v0_2->world.pos.x;
        arg0->unk294.z = temp_v0_2->world.pos.z;
    }
    arg0->actor.speedXZ = 0.0f;
    arg0->unk2CA = 2;
...
void func_80C01CD0(EnBomjimb *this, GlobalContext *globalCtx) {
    ...
    temp_a2 = this->unk2E4;
    if ((temp_a2 != 0) && ((temp_a2->update == 0) || (sp3C = this->unk144.animCurrentFrame, (Actor_HasParent(temp_a2, globalCtx) != 0)))) {
    ...
    if (this->unk2DC != 7) {
        sp2C = temp_a0;
        sp28 = temp_a1;
        Math_SmoothStepToS(&this->actor.world.rot.y, Math_Vec3f_Yaw(&temp_a0->pos, temp_a1), 1, 0xBB8, (s16) 0);
        Math_ApproachF(&temp_a0->pos.x, this->unk294.x, 0.3f, 2.0f);
        Math_ApproachF(&this->actor.world.pos.z, this->unk294.z, 0.3f, 2.0f);
        temp_f2 = this->actor.world.pos.x - this->unk294.x;
        temp_f12 = this->actor.world.pos.z - this->unk294.z;
        if (sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12)) < 3.0f) {
            ...
            Math_Vec3f_Copy(&sp2C->pos, sp28);
        }
    } else if (this->unk2B8 <= this->unk144.animCurrentFrame) {
        this->actor.draw = NULL;
    }
    if ((this->unk2C0 == 0) && ((this->unk2E4->bgCheckFlags & 1) != 0)) {
        Audio_PlayActorSound2(&this->actor, 0x28ABU);
        this->unk2C0 = 1;
    }
    if (this->unk2AE == 0) {
        if (this->actor.draw == 0) {
            this->unk2AE = Rand_S16Offset(0x14, 0x1E);
            this->unk2E4->shape.rot.z = 0x3E8;
            return;
        }
        temp_a2_2 = this->unk2E4;
        this->unk2AE = 0xA;
        if ((temp_a2_2 != 0) && (temp_a2_2->update != 0)) {
            if ((globalCtx->gameplayFrames & 0xF) == 0) {
                temp_a2_2->shape.rot.z = (s16) -(s32) temp_a2_2->shape.rot.z;
                temp_a2_3 = this->unk2E4;
                temp_a2_3->shape.rot.z = (s16) (s32) ((f32) temp_a2_3->shape.rot.z * 0.1f);
            }
            phi_a2 = this->unk2E4;
            if (fabsf((f32) this->unk2E4->shape.rot.z) < 100.0f) {
                goto block_23;
            }
        }
...
void func_80C02108(EnBomjimb *arg0) {
    ...
    arg0->unk2D6 = temp_v0 + 0x8000;
    arg0->actor.world.rot.y = temp_v0;
    func_80C012E0(arg0);
    Math_Vec3f_Copy(&arg0->unk2A0, &arg0->actor.world.pos);
    arg0->unk2D4 = 0;
    arg0->unk2CA = 5;
...
void func_80C0217C(EnBomjimb *this, GlobalContext *globalCtx) {
    ...
    if ((func_80C012FC(this) == 0) && (func_80C013B4(this) == 0) && (func_80C013F0(this, globalCtx) == 0)) {
        ...
        if (this->unk2DC == 6) {
            if (this->unk2B8 <= this->unk144.animCurrentFrame) {
        ...
        temp_a1 = &this->actor.world;
        sp40 = temp_a1;
        Math_Vec3f_Copy(&sp74, &temp_a1->pos);
        temp_f16 = sp74.x + (Math_SinS(this->actor.world.rot.y) * 50.0f);
        sp74.y += 20.0f;
        sp74.x = temp_f16;
        ...
        sp3C = temp_a0;
        sp74.z += temp_f16_2;
        if (func_800C55C4(temp_a0, &temp_a1->pos, &sp74, &sp64, &sp70, 1U, 0U, 0U, 1U, &sp60) != 0) {
            temp_v0 = (this->actor.world.rot.y - this->actor.yawTowardsPlayer) - 0x8000;
            this->unk2D6 = temp_v0;
            if ((s32) temp_v0 < 0) {
                this->unk2D6 += (s32) Rand_ZeroFloat(512.0f) + 0x4000;
                if (this->unk2D0 != 0) {
                    this->unk2D6 += (s32) Rand_ZeroFloat(512.0f) + 0x4000;
                }
                this->unk2D0 = 1;
        ...
        if (sp50 == 0) {
            ...
            if (this->actor.xzDistToPlayer < 60.0f) {
                this->unk2D6 = this->actor.yawTowardsPlayer + 0x8000;
            }
        }
        this->actor.world.rot.y = this->unk2D6 + this->unk2D4;
...
void func_80C0250C(EnBomjimb *arg0) {
    ...
    arg0->unk2D4 = 0;
    arg0->actor.speedXZ = 0.0f;
    arg0->unk2D6 = arg0->actor.yawTowardsPlayer + 0x8000;
    func_80C012E0(arg0);
    arg0->unk2CA = 6;
...
void func_80C02570(EnBomjimb *this, GlobalContext *globalCtx) {
    ...
    if ((func_80C012FC(this) == 0) && (func_80C013B4(this) == 0) && (temp_a0 = &this->actor.world.rot.y, (func_80C013F0(this, globalCtx) == 0))) {
        ...
        if ((sp2C->unkA74 == 0x1000000) || (temp_f0 > 410.0f)) {
...
void func_80C02740(EnBomjimb *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = temp_a3->unk14B;
    if ((temp_v1 != 3) && (temp_v1 != 4)) {
        sp24 = temp_a3;
        func_80C0113C(arg0, 0x11, 1.0f, temp_a3);
        func_801518B0(arg1, 0x72EU, &arg0->actor);
        temp_a3->actor.freezeTimer = 3;
        temp_a3->unkA6C = (s32) (temp_a3->unkA6C | 0x10000000);
        func_80C012E0(arg0);
        arg0->unk2CA = 9;
    ...
    func_801518B0(arg1, *(&D_80C03230 + (gSaveContext.unk_FE6 * 2)), &arg0->actor);
    gSaveContext.unk_FE7[gSaveContext.unk_FE6] = arg0->unk2C8 + 1;
    gSaveContext.unk_FE6 += 1;
    if ((s32) gSaveContext.unk_FE6 >= 5) {
        func_801A3098(0x922U);
    } else {
        Audio_PlayActorSound2(&arg0->actor, 0x4823U);
    }
    temp_t8 = (u16) arg0->unk2C8;
    switch (temp_t8) {
    case 0:
...
void func_80C02A14(EnBomjimb *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk2CA == 8) && (temp_v0 == 9)) {
        ...
        if (this->unk2E0 == 0) {
            ...
            if (func_801378B8(temp_a0, 7.0f) != 0) {
                ...
                sp1C = temp_v1;
                this = this;
                Audio_PlayActorSound2(&temp_a0_2->actor, 0x2896U);
                this->unk2E0 = 1;
            }
        }
    }
    if ((this->unk2DC == 0xF) && (this->unk2CA == 8)) {
    ...
    if ((func_80152498(&globalCtx->msgCtx) == 5) && (sp1C = globalCtx->actorCtx.actorList[2].first, this = this, (func_80147624(globalCtx) != 0))) {
        ...
        temp_v0_2 = this->unk2CA;
        if ((temp_v0_2 == 8) && ((s32) gSaveContext.unk_FE6 >= 5)) {
            func_80C02CA4(this, globalCtx);
            return;
        }
        if (temp_v0_2 == 8) {
            globalCtx->actorCtx.actorList[2].first->unkA6C = (s32) (globalCtx->actorCtx.actorList[2].first->unkA6C & 0xEFFFFFFF);
        }
        func_80C01FD4(this);
        // Duplicate return node #19. Try simplifying control flow for better match
    }
...
void func_80C02BCC(EnBomjimb *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2C0 == 0) {
        ...
        if ((func_80152498(&globalCtx->msgCtx) == 5) && (func_80147624(globalCtx) != 0)) {
            func_801477B4(globalCtx);
            this->unk2C0 = 1;
            sp2C->unkA6C = (s32) (sp2C->unkA6C & 0xEFFFFFFF);
            return;
        }
...
void func_80C02CA4(EnBomjimb *arg0, GlobalContext *arg1) {
    if (gGameInfo->data[2413] == 0) {
        arg1->nextEntranceIndex = *(arg1->setupExitList + (arg0->unk2B2 * 2));
...
void EnBomjimb_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0_2 = this->unk2AE;
    if (temp_v0_2 != 0) {
        this->unk2AE = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk2AC;
    if (temp_v0_3 != 0) {
        this->unk2AC = temp_v0_3 - 1;
    }
    SkelAnime_FrameUpdateMatrix(&this->unk144);
    this->actor.shape.rot.y = this->actor.world.rot.y;
    func_80C011CC(&this->actor);
    Actor_SetHeight(&this->actor, 20.0f);
    this->actionFunc(this, globalCtx);
    Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
    if (this->unk2CA == 0) {
        temp_v0_4 = this->unk2E4;
        if ((temp_v0_4 != 0) && (temp_v0_4->update != 0)) {
            Math_Vec3f_Copy(&temp_v0_4->world.pos, &this->actor.world.pos);
            if ((this->actor.bgCheckFlags & 1) != 0) {
                this->unk2E4->world.pos.y = this->actor.world.pos.y + 35.0f;
            } else {
                this->unk2E4->world.pos.y = this->actor.world.pos.y + 25.0f;
            }
        }
    }
    ...
    if (this->unk2C4 == 0) {
        this->unk2C2 += 1;
        if ((s32) this->unk2C2 >= 3) {
            this->unk2C2 = 0;
            this->unk2C4 = (s32) Rand_ZeroFloat(60.0f) + 0x14;
        }
    }
...
s32 func_80C02FA8(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    if ((arg1 == 0x13) && (arg5->unk2C8 != 0)) {
        *arg2 = NULL;
    }
    if ((arg1 == 0x14) && (arg5->unk2C8 == 0)) {
        *arg2 = NULL;
    }
    return 0;
}
...
void EnBomjimb_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp38 = temp_v0;
    sp38->words.w1 = Lib_SegmentedToVirtual(*(&D_80C03274 + (this->unk2C2 * 4)));
    temp_v0_2 = temp_s1->polyOpa.p;
    temp_s1->polyOpa.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xDB060024;
    sp34 = temp_v0_2;
    sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_80C03280 + (this->unk2C8 * 4)));
    temp_v0_3 = temp_s1->polyOpa.p;
    temp_s1->polyOpa.p = temp_v0_3 + 8;
    temp_v0_3->words.w0 = 0xDB060028;
    sp30 = temp_v0_3;
    sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80C03260 + (this->unk2C8 * 4)));
    Scene_SetRenderModeXlu(globalCtx, 0, 1U);
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80C02FA8, NULL, &this->actor);
}
