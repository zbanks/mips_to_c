typedef struct EnSw {
    ...
    /* 0x1EE */ char pad1EE[0xAE];                  /* maybe part of unk1E8[30]? */
    /* 0x29C */ Vec3s unk29C;                       /* inferred */
    /* 0x2A2 */ char pad2A2[0xC6];                  /* maybe part of unk29C[34]? */
    /* 0x368 */ f32 unk368;                         /* inferred */
    /* 0x36C */ f32 unk36C;                         /* inferred */
    /* 0x370 */ f32 unk370;                         /* inferred */
    /* 0x374 */ Vec3f unk374;                       /* inferred */
    /* 0x380 */ char pad380[0x90];                  /* maybe part of unk374[13]? */
    /* 0x410 */ u16 unk410;                         /* inferred */
    /* 0x412 */ u8 unk412;                          /* inferred */
    /* 0x413 */ char pad413[0x1];
    /* 0x414 */ f32 unk414;                         /* inferred */
    /* 0x418 */ char pad418[0x30];                  /* maybe part of unk414[13]? */
    /* 0x448 */ f32 unk448;                         /* inferred */
    /* 0x44C */ f32 unk44C;                         /* inferred */
    /* 0x450 */ f32 unk450;                         /* inferred */
    /* 0x454 */ s16 unk454;                         /* inferred */
    /* 0x456 */ s16 unk456;                         /* inferred */
    /* 0x458 */ char pad458[0x2];
    /* 0x45A */ s16 unk45A;                         /* inferred */
    /* 0x45C */ s16 unk45C;                         /* inferred */
    /* 0x45E */ s16 unk45E;                         /* inferred */
    /* 0x460 */ s16 unk460;                         /* inferred */
    /* 0x462 */ s16 unk462;                         /* inferred */
    /* 0x464 */ char pad464[0x34];                  /* maybe part of unk462[27]? */
    /* 0x498 */ s16 unk498;                         /* inferred */
    /* 0x49A */ char pad49A[0x2];
    /* 0x49C */ s32 unk49C;                         /* inferred */
    /* 0x4A0 */ s32 unk4A0;                         /* inferred */
} EnSw;                                             /* size = 0x4A4 */
...
s16 func_808D8D60(Actor *arg0, GlobalContext *arg1, s32 arg2) {
    ...
    if (arg2 < (s32) arg0->unk462) {
        ...
        if (temp_v0 != 0) {
            ...
            sp44 += temp_v0_2->unk380;
            sp48 += temp_v0_2->unk384;
            sp4C += temp_v0_2->unk388;
            phi_t0 = (s32) temp_t0;
            phi_a3 = 1;
            phi_t0 = (s32) temp_t0;
            if (temp_t0 == 0xA) {
            ...
            func_800BE680(arg1, arg0, (Vec3f []) (Vec3f *) &sp44, 1, 0.3f, sp34->unk418, sp40, (u8) phi_t0);
        }
    }
    return phi_a3;
}
...
void func_808D9E44(Actor *arg0) {
    ...
    temp_a1 = &sp1C;
    sp1C += arg0->unk368 * 16.0f;
    sp20 += arg0->unk36C * 16.0f;
    sp24 += arg0->unk370 * 16.0f;
...
void func_808DA350(EnSw *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0->unkA6C & 0x200000) && (temp_a0 = this, (this->actor.xyzDistToPlayerSq < 8000.0f))) {
        ...
        Math_Vec3f_Copy(&this->unk374, (Vec3f *) &temp_v0->world);
...
void func_808DA3F4(EnSw *this, GlobalContext *globalCtx) {
    ...
    if (func_801378B8(&this->unk144, this->unk154) == 0) {
        ...
        sp2C = temp_f16;
        Math_Vec3f_Copy((Vec3f *) &sp38, &this->unk374);
...
void func_808DA578(EnSw *this, GlobalContext *globalCtx) {
    ...
    if (func_801378B8(&this->unk144, this->unk144.animFrameCount) == 0) {
        ...
        if ((this->actor.speedXZ == 0.0f) && (this->unk44C != 0.0f)) {
            Math_Vec3f_Copy((Vec3f *) &sp30, &this->unk374);
    ...
    temp_f0 = Math_Vec3f_DistXYZ((Vec3f *) &this->actor.world, &this->unk374);
    temp_v0 = this->unk410;
    if ((temp_v0 & 0x20) == 0) {
...
void func_808DA6FC(EnSw *this, GlobalContext *globalCtx) {
    ...
    sp30 = temp_a0;
    sp34 = &this->unk374;
    temp_f0 = Math_Vec3f_DistXYZ((Vec3f *) temp_a0, &this->unk374);
    sp4C = temp_f0;
    temp_f16 = (s32) this->unk414;
    if ((temp_f16 != 0) && (temp_f16 < (s32) temp_f0)) {
        Math_Vec3f_Copy((Vec3f *) temp_a0, &this->unk374);
...
void func_808DAA60(EnSw *this, GlobalContext *globalCtx) {
    ...
    if (phi_v1 == 0) {
        if (func_801378B8(&this->unk144, this->unk144.animFrameCount) == 0) {
            ...
            if (this->unk45E == 0) {
                sp28 = temp_f16;
                Math_Vec3s_ToVec3f((Vec3f *) &sp34, (this->unk4A0 * 6) + sp44);
...
void func_808DAEB4(EnSw *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 & 2) != 0) {
        ...
        if ((s32) (this->actor.scale.x * 100.0f) == 0) {
            ...
            temp_f6 = sp5C + (this->unk368 * 10.0f);
            sp5C = temp_f6;
            temp_f16 = sp60 + (this->unk36C * 10.0f);
            sp60 = temp_f16;
            temp_f18 = sp64 + (this->unk370 * 10.0f);
            sp64 = temp_f18;
...
void EnSw_Init(EnSw *this, GlobalContext *globalCtx) {
    ...
    if (func_808D9968(this, globalCtx) == 0) {
        ...
        Collider_InitAndSetSphere(globalCtx, &this->unk18C, (Actor *) this, &D_808DB9E0);
        if ((this->actor.params & 3) == 0) {
...
void EnSw_Draw(EnSw *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk410 & 4) != 0) {
        ...
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_808DB7F4, NULL, (Actor *) this);
    }
    phi_s0 = 0;
    phi_s1 = 0;
    do {
