...
void EnDyExtra_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    do {
        temp_a1 = *phi_a0;
        if (temp_a1 != 0) {
            (temp_v0 + (phi_v1 * 0x10))->unk_F = (u8) (&sp68)[temp_a1];
        }
        temp_v1 = phi_v1 + 1;
        phi_a0 += 1;
        phi_v1 = temp_v1;
    ...
    temp_v0_5->words.w1 = (temp_v1_3->unk_2 << 8) | (temp_v1_3->unk_0 << 0x18) | (temp_v1_3->unk_1 << 0x10) | 0xFF;
    temp_v0_6 = temp_s0->polyXlu.p;
    temp_s0->polyXlu.p = &temp_v0_6[1];
    temp_v0_6->words.w0 = 0xFB000000;
    temp_v1_4 = (this->type * 4) + &D_80A61754;
    temp_v0_6->words.w1 = (temp_v1_4->unk_2 << 8) | (temp_v1_4->unk_0 << 0x18) | (temp_v1_4->unk_1 << 0x10) | 0x80;
