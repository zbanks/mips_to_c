...
s32 func_80BABF64(u8 *arg2, GlobalContext *, struct_80133038_arg2 *); /* static */
...
extern ? D_06013380;
static s16 D_80BAE800 = {0xFA0, 4, 1, 3, 0x1770, 4, 1, 6, 0xFA0, 4, 1, 3, 0x1770, 4, 1, 6};
...
void func_80BAAF1C(EnSuttari *arg0) {
    ...
    if ((temp_v1 == 3) && (sp1E == SkelAnime_GetFrameCount(&(&sAnimations)[temp_t8].animation->common))) {
...
void func_80BAAFDC(EnSuttari *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->actor.xzDistToPlayer < 500.0f) && (arg0->actor.yDistToPlayer < 100.0f)) {
        sp54.x = D_80BAE938.unk0;
        sp54.y = D_80BAE938.unk4;
        sp54.z = D_80BAE938.unk8;
        Math_Vec3f_Copy(&sp48, arg0 + 0x24);
        temp_f6 = sp48.x + (Math_SinS((s16) (arg0->actor.world.rot.y + arg0->unk3F4)) * 10.0f);
        sp48.y += 60.0f;
        sp48.x = temp_f6;
        sp48.z += Math_CosS((s16) (arg0->actor.world.rot.y + arg0->unk3F4)) * 10.0f;
        SysMatrix_StatePush();
        Matrix_RotateY(arg0->actor.shape.rot.y, 0U);
        sp5C = 20.0f;
        SysMatrix_MultiplyVector3fByState(&sp54, &sp3C);
        SysMatrix_StatePop();
        if (arg0->unk3F0 == 0) {
            EffectSsSolderSrchBall_Spawn(arg1, &sp48, &sp3C, &D_801D15B0, (s16) 0x32, arg0 + 0x3F0, (s16) 1);
        }
        if (arg0->unk3F0 == 1) {
            play_sound(0x482CU);
...
void func_80BAB1A0(EnSuttari *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->actor.xzDistToPlayer < 500.0f) && (arg0->actor.yDistToPlayer < 100.0f)) {
        sp54.x = D_80BAE944.unk0;
        sp54.y = D_80BAE944.unk4;
        sp54.z = D_80BAE944.unk8;
        Math_Vec3f_Copy(&sp48, arg0 + 0x24);
        temp_f6 = sp48.x + (Math_SinS((s16) (arg0->actor.world.rot.y + arg0->unk3F4)) * 350.0f);
        sp48.y += 60.0f;
        sp48.x = temp_f6;
        sp48.z += Math_CosS((s16) (arg0->actor.world.rot.y + arg0->unk3F4)) * 350.0f;
        SysMatrix_StatePush();
        Matrix_RotateY(arg0->actor.shape.rot.y, 0U);
        sp5C = 20.0f;
        SysMatrix_MultiplyVector3fByState(&sp54, &sp3C);
...
s32 func_80BABDD8(Actor *arg0, GlobalContext *arg1, void *arg2) {
    ...
    sp28 = temp_v0_4;
    Math_Vec3s_ToVec3f(&sp38, (Vec3s *) temp_v0_4);
    Math_Vec3s_ToVec3f(&sp2C, sp28 + 6);
    ...
    Math_Vec3f_Copy(arg0 + 0x438, &sp38);
    Math_Vec3f_Copy(arg0 + 0x444, &sp2C);
    arg0->world.rot.y = Math_Vec3f_Yaw(&sp38, &sp2C);
    arg0->world.pos.x = sp38.x;
    arg0->world.pos.y = sp38.y;
    arg0->world.pos.z = sp38.z;
    return 1;
}
...
? func_80BABFD4(Actor *arg0, GlobalContext *arg1) {
    ...
    sp54 = 0;
    sp50 = 0;
    func_8013AF00(&sp7C, 3, arg0->unk404->count + 3);
    temp_s1 = arg0 + 0x408;
    phi_s1 = temp_s1;
    if (arg0->unk42C == 0) {
        temp_v0 = arg0 + 0x420;
        ...
        sp48 = temp_a1;
        sp40 = temp_v0;
        func_8013B6B0(arg0->unk404, temp_a1, temp_a2, arg0->unk41C, arg0->unk418, temp_v0, &sp7C, &sp58, (s16) (s32) arg0->unk42A);
        func_8013B878(arg1, arg0->unk404, arg0->unk420, &sp58);
        arg0->unk42C = 1;
    ...
    if (func_8013B6B0(arg0->unk404, sp48, sp44, arg0->unk41C, arg0->unk418, sp40, &sp7C, phi_s1, (s16) (s32) arg0->unk42A) != 0) {
        arg0->unk430 = 1;
    } else {
...
? func_80BAC220(Actor *arg0, GlobalContext *arg1) {
    ...
    Lib_Vec3f_TranslateAndRotateY(temp_a0, arg0->world.rot.y, (Vec3f *) &sp3C, &sp30);
    arg0->world.pos.x = sp30.x;
    arg0->world.pos.y = sp30.y;
    arg0->unk434 = (s16) (arg0->unk434 + arg0->unk42A);
    arg0->world.pos.z = sp30.z;
    return 0;
}
...
void func_80BAC2FC(Actor *arg0, GlobalContext *arg1) {
    ...
    case 13:
        ...
        break;
    case 15:
        if ((arg0->unk450 == 1) && (sp22 == SkelAnime_GetFrameCount(&(&sAnimations)[arg0->unk450].animation->common))) {
            arg0->unk450 = 2;
            arg1 = arg1;
            sp24 = temp_v1;
...
void func_80BACA14(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0_2 == 1) || (temp_v0_2 == 2)) {
        ...
        if (func_800B84D0(&this->actor, globalCtx) != 0) {
            this->unk3F2 = this->unk2DE;
            func_80BAAB78(&this->actor, globalCtx);
...
void func_80BACEE0(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    if ((func_80133038(globalCtx, &D_80BAE820, &sp20) == 0) || ((sp20.unk0 != this->unk428) && (func_80BABF64((u8 *) this, globalCtx, &sp20) == 0))) {
        this->actor.flags &= -2;
        sp20.unk0 = 0;
    } else {
        this->actor.flags |= 1;
    }
    this->unk428 = sp20.unk0;
    func_80BAC2FC(&this->actor, globalCtx);
    func_80BAB434(this);
    if (this->unk428 == 5) {
...
void func_80BAD004(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    func_80BAC2FC(&this->actor, globalCtx);
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        func_801518B0(globalCtx, 0x2A3AU, &this->actor);
...
void func_80BAD2B4(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    func_80BAB374(&this->actor, globalCtx);
}
...
void func_80BAD380(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 & 0x200) != 0) {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x1E, 0x180EU);
...
void func_80BAD5F8(EnSuttari *this, GlobalContext *globalCtx) {
    struct_80133038_arg2 sp28;
    s16 sp26;

    sp26 = (s16) (s32) this->skelAnime.animCurrentFrame;
    if ((sp26 == SkelAnime_GetFrameCount(&(&sAnimations)[this->animationIdx].animation->common)) && (this->animationIdx == 0) && ((this->flags1 & 0x20) != 0)) {
        this->animationIdx = 2;
        func_800BDC5C(&this->skelAnime, (ActorAnimationEntry []) &sAnimations, 2);
    }
    this->unk42A = gSaveContext.unk_14 + gGameInfo->data[15];
    if ((func_80133038(globalCtx, &D_80BAE820, &sp28) == 0) || ((sp28.unk0 != this->unk428) && (func_80BABF64((u8 *) this, globalCtx, &sp28) == 0))) {
        this->actor.flags &= -2;
        sp28.unk0 = 0;
    } else {
        this->actor.flags |= 1;
    }
    this->unk428 = sp28.unk0;
    func_80BAC2FC(&this->actor, globalCtx);
    ...
    func_80BAB434(this);
    if (((this->flags1 & 0x20) != 0) && (this->unk430 == 0) && (sp28.unk0 != 7)) {
        if (func_800B84D0(&this->actor, globalCtx) != 0) {
            func_801518B0(globalCtx, 0x2A02U, &this->actor);
            this->actionFunc = func_80BAD130;
...
void func_80BAD7F8(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    if (((this->flags1 & 0x2000) != 0) && (this->animationIdx == 1) && (sp26 == SkelAnime_GetFrameCount(&(&sAnimations)[this->animationIdx].animation->common))) {
        this->animationIdx = 2;
        func_800BDC5C(&this->skelAnime, (ActorAnimationEntry []) &sAnimations, 2);
    }
    this->unk42A = gSaveContext.unk_14 + gGameInfo->data[15];
    ...
    if (((this->flags1 & 0x20) != 0) && (sp28.unk0 != 9)) {
        if (func_800B84D0(&this->actor, globalCtx) != 0) {
            func_801518B0(globalCtx, 0x2A02U, &this->actor);
            this->actionFunc = func_80BAD130;
        } else if ((this->actor.xzDistToPlayer < 100.0f) || (this->actor.isTargeted != 0)) {
...
void func_80BADA9C(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    if ((this->flags1 & 1) != 0) {
        this->unk3F2 = this->unk2DE;
        func_80BAA9B4(this);
    } else if ((this->animationIdx == 7) && (sp2C == SkelAnime_GetFrameCount(&(&sAnimations)[this->animationIdx].animation->common))) {
        this->animationIdx = 1;
...
void func_80BADD0C(EnSuttari *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->cutscenes[this->cutsceneIdx]) != 0) {
        ...
        if (temp_v0 == 0) {
            ActorCutscene_Start(this->cutscenes[temp_v0], &this->enFsn->actor);
        } else {
            ActorCutscene_Start(this->cutscenes[temp_v0], &this->actor);
        }
        func_80BAAA94(this);
        this->actionFunc = func_80BADA9C;
        return;
...
void EnSuttari_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, temp_a1, &this->actor, &sCylinderInit);
...
void EnSuttari_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->flags1 & 0x8000) == 0) {
        func_80BAB4F0(&this->actor, globalCtx);
    }
    if ((this->flags2 & 2) != 0) {
    ...
    if (this->unk428 != 0) {
        ...
        if ((temp_v0 == 2) || (temp_v0 == 6)) {
            ...
            if ((func_801378B8(temp_a0, 8.0f) != 0) || (func_801378B8(temp_a0, 16.0f) != 0)) {
                Audio_PlayActorSound2(&this->actor, 0x298BU);
                return;
            }
...
void EnSuttari_PostLimbDraw(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (((((temp_v0 & 8) != 0) && ((temp_v0 & 0x10) != 0)) || (((temp_v0 & 2) != 0) && ((temp_v0 & 0x20) == 0)) || (((temp_v0 & 4) != 0) && ((temp_v0 & 0x20) == 0))) && (arg1 == 8)) {
        ...
        if (arg4->child == 0) {
            if ((arg4->unk1E4 & 0x100) != 0) {
                ...
                if (temp_v0_2 != 0) {
                    func_8018219C(sp44, &temp_v0_2->shape.rot, 0);
                }
            } else {
    ...
    if (arg1 == 0xF) {
        SysMatrix_MultiplyVector3fByState(&D_80BAE950, &arg4->focus.pos);
    }
}
...
void EnSuttari_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->flags1 & 0x80) != 0) {
        ...
        func_801343C0(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnSuttari_OverrideLimbDraw, EnSuttari_PostLimbDraw, EnSuttari_UnkDraw, &this->actor);
        if ((this->flags1 & 0x80) != 0) {
            ...
            sp54 = 0.2f;
            sp58 = 0.2f;
            func_800BC620(&sp5C, (Vec3f *) temp_a1, 0xFF, globalCtx);
        }
    }
}
