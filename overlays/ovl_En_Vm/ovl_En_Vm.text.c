typedef struct EnVm {
    ...
    /* 0x210 */ u8 unk210;                          /* inferred */
    /* 0x211 */ char pad211[0x1];
    /* 0x212 */ s16 unk212;                         /* inferred */
    /* 0x214 */ char pad214[0x2];
    ...
    /* 0x228 */ char pad228[0xC];                   /* maybe part of unk224[4]? */
    /* 0x234 */ Vec3f unk234;                       /* inferred */
    /* 0x240 */ ColliderJntSph unk240;              /* inferred */
    /* 0x260 */ ColliderJntSphElement unk260;       /* inferred */
    /* 0x2A0 */ char pad2A0[0x40];
    /* 0x2E0 */ ColliderTris unk2E0;                /* inferred */
    /* 0x300 */ ColliderTrisElement unk300;         /* inferred */
} EnVm;                                             /* size = 0x35C */
...
void EnVm_Init(EnVm *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetTris(globalCtx, &this->unk2E0, (Actor *) this, &D_808CD554, &this->unk300);
    Collider_InitAndSetJntSph(globalCtx, &this->unk240, (Actor *) this, &D_808CD508, &this->unk260);
...
void EnVm_Draw(EnVm *this, GlobalContext *globalCtx) {
    ...
    sp28 = temp_v0;
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_808CD020, func_808CD08C, (Actor *) this);
    if (this->unk210 == 2) {
