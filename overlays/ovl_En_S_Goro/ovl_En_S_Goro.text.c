typedef struct EnSGoro {
    ...
    /* 0x18C */ void (*actionFunc)(EnSGoro *, GlobalContext *);
    /* 0x190 */ ColliderCylinder unk_190;           /* inferred */
    /* 0x1DC */ u16 unk_1DC;                        /* inferred */
    /* 0x1DE */ char pad_1DE[0x16];                 /* maybe part of unk_1DC[12]? */
    /* 0x1F4 */ s32 unk_1F4;                        /* inferred */
    /* 0x1F8 */ Vec3s unk_1F8;                      /* inferred */
    /* 0x1FE */ char pad_1FE[0x66];                 /* maybe part of unk_1F8[18]? */
    /* 0x264 */ Vec3s unk_264;                      /* inferred */
    /* 0x26A */ char pad_26A[0x9E];                 /* maybe part of unk_264[27]? */
    /* 0x308 */ s32 unk_308;                        /* inferred */
    /* 0x30C */ char pad_30C[0x4];
} EnSGoro;                                          /* size = 0x310 */
...
struct _mips2c_stack_EnSGoro_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnSGoro_Draw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnSGoro_Init {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ ColliderCylinder *sp30;              /* inferred */
    /* 0x34 */ char pad_34[0xC];
};                                                  /* size = 0x40 */

struct _mips2c_stack_EnSGoro_Update {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBCA80 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ void *sp1C;                          /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BBD348 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBD8F0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBD93C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBD98C {
    /* 0x00 */ char pad_0[0x26];
    /* 0x26 */ s16 sp26;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBDACC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBDC34 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBDCFC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBDDF8 {
    /* 0x00 */ char pad_0[0x1E];
    /* 0x1E */ s16 sp1E;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BBDE78 {
    /* 0x00 */ char pad_0[0x1E];
    /* 0x1E */ s16 sp1E;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BBDF28 {
    /* 0x00 */ char pad_0[0x1E];
    /* 0x1E */ s16 sp1E;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BBDFA8 {
...
struct _mips2c_stack_func_80BBE05C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBE0E4 {};              /* size 0x0 */

struct _mips2c_stack_func_80BBE144 {
...
struct _mips2c_stack_func_80BBE374 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBE498 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BBE73C {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBE844 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBE904 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBE9F8 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBEAD8 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBEBF8 {
    /* 0x00 */ char pad_0[0x2E];
    /* 0x2E */ s16 sp2E;                            /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80BBECBC {
    /* 0x00 */ char pad_0[0x2F];
    /* 0x2F */ u8 sp2F;                             /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80BBEEB4 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBEF34 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BBEFA0 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80BBF01C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80BBF298 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ ? sp28;                              /* inferred */
...
struct _mips2c_stack_func_80BBF3D0 {};              /* size 0x0 */

struct _mips2c_stack_func_80BBF3EC {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80BBF5F0 {
    /* 0x00 */ char pad_0[0x30];
...
struct _mips2c_stack_func_80BBF6BC {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */
...
static ActorAnimationEntryS D_80BBF878[16] = {
                ...
                if ((temp_v1_2 & 2) == 0) {
                    ...
                    if (temp_v0_2 != 0xCFB) {
                        if (temp_v0_2 != 0xCFC) {
                            ...
                            arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x20);
                            return 0xCFE;
                        }
                        return 0xCFD;
                    }
...
u16 func_80BBD348(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        switch (temp_v0) {
        case 1637:
            arg0->unk_1DC = (u16) (arg0->unk_1DC & 0xFDFF);
            return 0x666U;
        case 1638:
            temp_t0 = arg0->unk_1DC | 0x20;
            arg0->unk_1DC = temp_t0;
            arg0->unk_1DC = (u16) (temp_t0 | 0x400);
            return 0x667U;
        case 1640:
            arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x200);
            return 0x669U;
        case 1641:
            arg0->unk_1DC = (u16) (arg0->unk_1DC & 0xFDFF);
            return 0x66AU;
        case 1642:
            temp_t8 = arg0->unk_1DC | 0x20;
            arg0->unk_1DC = temp_t8;
            arg0->unk_1DC = (u16) (temp_t8 | 0x400);
            return 0x66BU;
        case 1655:
            arg0->unk_1DC = (u16) (arg0->unk_1DC & 0xFDFF);
            return 0x678U;
        ...
        case 1667:
            ...
            return 0x684U;
        case 1648:
            if ((arg0->unk_1DE & 0x400) != 0) {
                if (gSaveContext.inventory.ammo[gItemSlots[12]] != 0) {
                    arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x20);
                    play_sound(0x4806U);
                    return 0x673U;
                }
                arg0->unk_30C = (s16) arg1->msgCtx.unk1206C;
                if ((s32) gSaveContext.rupees < (s32) arg0->unk_30C) {
                    temp_t8_2 = arg0->unk_1DC | 0x20;
                    arg0->unk_1DC = temp_t8_2;
                    arg0->unk_1DC = (u16) (temp_t8_2 | 0x400);
                    play_sound(0x4806U);
                    return 0x674U;
                }
        ...
        if (temp_v0 == 0) {
            ...
            if (temp_v0_2 != 1) {
                if (temp_v0_2 != 2) {
                    if (temp_v0_2 != 3) {
                        ...
                        if ((gSaveContext.day == 3) && (gSaveContext.isNight != 0)) {
                            temp_v1 = arg0->unk_1DE;
                            if ((temp_v1 & 0x10) == 0) {
                                arg0->unk_1DE = (u16) (temp_v1 | 0x10);
                                return 0x668U;
                            }
                            arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x20);
                            return 0x66DU;
                        }
                        temp_v1_2 = arg0->unk_1DE;
                        if ((temp_v1_2 & 1) == 0) {
                            arg0->unk_1DE = (u16) (temp_v1_2 | 1);
                            return 0x664U;
                        }
                        arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x20);
                        return 0x66CU;
                    ...
                    if ((gSaveContext.day == 3) && (gSaveContext.isNight != 0)) {
                        temp_v1_3 = arg0->unk_1DE;
                        if ((temp_v1_3 & 0x40) == 0) {
                            arg0->unk_1DE = (u16) (temp_v1_3 | 0x40);
                            return 0x668U;
                        }
                        arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x20);
                        return 0x66DU;
                    }
                    temp_v1_4 = arg0->unk_1DE;
                    if ((temp_v1_4 & 4) == 0) {
                        arg0->unk_1DE = (u16) (temp_v1_4 | 4);
                        return 0x664U;
                    }
                    arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x20);
                    return 0x66CU;
                ...
                if ((gSaveContext.day == 3) && (gSaveContext.isNight != 0)) {
                    temp_v1_5 = arg0->unk_1DE;
                    if ((temp_v1_5 & 0x80) == 0) {
                        arg0->unk_1DE = (u16) (temp_v1_5 | 0x80);
                        return 0x668U;
                    }
                    temp_t6 = arg0->unk_1DC | 0x20;
                    arg0->unk_1DC = temp_t6;
                    arg0->unk_1DC = (u16) (temp_t6 | 0x400);
                    return 0x66DU;
                }
                temp_v1_6 = arg0->unk_1DE;
                if ((temp_v1_6 & 8) == 0) {
                    arg0->unk_1DE = (u16) (temp_v1_6 | 8);
                    return 0x664U;
                }
                temp_t2 = arg0->unk_1DC | 0x20;
                arg0->unk_1DC = temp_t2;
                arg0->unk_1DC = (u16) (temp_t2 | 0x400);
                return 0x66CU;
            }
            if (gSaveContext.inventory.items[gItemSlots[12]] == 0xC) {
                if ((gSaveContext.day == 3) && (gSaveContext.isNight != 0)) {
                    temp_v1_7 = arg0->unk_1DE;
                    if ((temp_v1_7 & 0x20) == 0) {
                        arg0->unk_1DE = (u16) (temp_v1_7 | 0x20);
                        arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x200);
                        return 0x677U;
                    }
                    return 0x67AU;
                }
                temp_v1_8 = arg0->unk_1DE;
                if ((temp_v1_8 & 2) == 0) {
                    arg0->unk_1DE = (u16) (temp_v1_8 | 2);
                    arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x200);
                    return 0x66EU;
                }
                return 0x679U;
            ...
            if ((gSaveContext.day == 3) && (gSaveContext.isNight != 0)) {
                temp_v1_9 = arg0->unk_1DE;
                if ((temp_v1_9 & 0x200) == 0) {
                    arg0->unk_1DE = (u16) (temp_v1_9 | 0x200);
                    arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x200);
                    return 0x67EU;
                }
                return 0x683U;
            }
            temp_v1_10 = arg0->unk_1DE;
            if ((temp_v1_10 & 0x100) == 0) {
                arg0->unk_1DE = (u16) (temp_v1_10 | 0x100);
                arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x200);
                return 0x67BU;
            }
            return 0x681U;
...
s32 func_80BBD8F0(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = func_ActorCategoryIterateById(arg1, arg0->unk_144, 4, 0x213);
...
void func_80BBD98C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp26 = (s16) (s32) arg0->unk_160;
    arg0->unk_306 = (s16) (arg0->unk_306 + 0x400);
    temp_v0 = arg0->unk_1DC;
    temp_f2 = Math_SinS(arg0->unk_306) * 0.01f * 0.1f;
    temp_f12 = 0.01f - temp_f2;
    arg0->unk_2D0 = temp_f2;
    ...
    if ((temp_v0 & 0x800) == 0) {
        if (arg0->unk_306 == 0) {
            if ((temp_v0 & 0x80) != 0) {
                arg0->unk_1DC = (u16) (temp_v0 & 0xFF7F);
                Audio_PlayActorSound2(arg0, 0x3A1BU);
                phi_v0 = arg0->unk_1DC;
            } else {
                arg0->unk_1DC = (u16) (temp_v0 | 0x80);
        ...
        if ((gSaveContext.weekEventReg[22] & 4) != 0) {
            arg0->unk_1DC = temp_t7;
            phi_v0 = temp_t7 & 0xFFFF;
        }
    }
    if (((phi_v0 & 1) == 0) && (sp26 == 0)) {
        arg0->unk_1DC = (u16) (phi_v0 | 1);
...
s32 func_80BBDACC(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0[2].floorPoly;
    if (temp_v0 == 0xF) {
        if (((arg0->unk_144->unk_3CC & 1) != 0) && (arg0 = arg0, temp_v0_2 = Object_GetIndex(arg1 + 0x17D88, 0x1D8), temp_t1 = temp_v0_2 * 0x10, arg0->unk_1F4 = temp_v0_2, (temp_v0_2 >= 0))) {
            gSegments[6] = (arg1 + ((temp_t1 + temp_v0_2) * 4))->unk_17D98 + 0x80000000;
            arg0[2].floorPoly = (CollisionPoly *)0xC;
            func_8013BC6C(arg0 + 0x148, D_80BBF878, 0xC);
            return 1;
        }
        goto block_8;
    }
    if ((temp_v0 == 0xC) && ((arg0->unk_144->unk_3CC & 1) == 0) && (arg0 = arg0, temp_v0_3 = Object_GetIndex(arg1 + 0x17D88, 0xA1), temp_a3 = arg0, temp_t1_2 = temp_v0_3 * 0x10, temp_a3->unk_1F4 = temp_v0_3, (temp_v0_3 >= 0))) {
        gSegments[6] = (arg1 + ((temp_t1_2 + temp_v0_3) * 4))->unk_17D98 + 0x80000000;
        temp_a3[2].floorPoly = (CollisionPoly *)0xF;
        arg0 = temp_a3;
        func_8013BC6C(temp_a3 + 0x148, D_80BBF878, 0xF);
        arg0->unk_160 = (f32) arg0->unk_158;
        return 1;
    }
block_8:
    return 0;
...
s32 func_80BBDC34(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    if ((arg1->actorCtx.actorList[2].first->unk_14B == 1) && (arg1->msgCtx.unk1202A == 3) && (temp_a0 = arg0 + 0x148, (arg1->msgCtx.unk1202E == 1))) {
        arg0->mainCamera.posOffset.y = 6e-45.0f;
        arg0 = arg0;
        func_8013BC6C(temp_a0, D_80BBF878, 4);
        temp_v0 = arg0->unk_1C & 0xF;
        arg0->unk_306 = (s16) (0x400 << (temp_v0 + 1));
        if ((temp_v0 % 2) == 0) {
            arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x80);
        }
...
s32 func_80BBDCFC(GlobalContext *arg0) {
    ...
    temp_v0 = arg0->unk_1DC;
    if (((temp_v0 & 0x40) == 0) && ((temp_a0_2 = arg0->view.projection.m[3], ((arg0->view.projection.m[2][3]->unk_1E4 & 0x80) != 0)) || ((gSaveContext.weekEventReg[22] & 4) != 0))) {
        arg0->unk_1DC = (u16) (temp_v0 | 0x40);
        arg0->mainCamera.posOffset.y = 6e-45.0f;
        arg0 = arg0;
        func_8013BC6C((SkelAnime *) temp_a0_2, D_80BBF878, 4);
        temp_v1 = arg0->unk_1C & 0xF;
        arg0->unk_306 = (s16) (0x400 << (temp_v1 + 1));
        if ((temp_v1 % 2) == 0) {
            arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x80);
        }
        arg0->view.viewing.m[3][1] = (s32) func_80BBEFA0;
        arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x800);
        return 1;
    }
block_8:
    return 0;
...
void func_80BBDDF8(Actor *arg0) {
    ...
    sp1E = (s16) (s32) arg0->unk_160;
    temp_t8 = arg0[2].floorPoly;
    arg0 = arg0;
    if ((arg0[2].floorPoly != 0xD) && (sp1E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BBF878[temp_t8].animationSeg))) {
        arg0[2].floorPoly = 0xD;
...
void func_80BBDE78(Actor *arg0) {
    ...
    temp_a0 = D_80BBF878[arg0[2].floorPoly].animationSeg;
    temp_v1 = (s32) arg0->unk_160;
    arg0 = arg0;
    sp1E = (s16) temp_v1;
    temp_v0 = SkelAnime_GetFrameCount((AnimationHeaderCommon *) temp_a0);
    if (arg0[2].floorPoly != 0xE) {
        if ((s16) temp_v1 == temp_v0) {
            arg0[2].floorPoly = 0xE;
    ...
    if ((s16) temp_v1 == temp_v0) {
        arg0[2].floorPoly = 0xF;
        arg0->unk_1DC = (u16) (arg0->unk_1DC & 0xFBFF);
...
void func_80BBDF28(Actor *arg0) {
    ...
    temp_t8 = arg0[2].floorPoly;
    arg0 = arg0;
    if ((arg0[2].floorPoly != 0xF) && (sp1E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BBF878[temp_t8].animationSeg))) {
        arg0[2].floorPoly = 0xF;
        func_8013BC6C(arg0 + 0x148, D_80BBF878, 0xF);
    }
}
...
void func_80BBDFA8(EnSGoro *arg0, GlobalContext *arg1) {
    ...
    sp24.unk_0 = arg0->actor.world.pos.x;
    (&sp24)[1] = arg0->actor.world.pos.y;
    (&sp24)[2] = arg0->actor.world.pos.z;
    arg0->unk_190.dim.pos.x = (s16) (s32) sp24;
    arg0->unk_190.dim.pos.y = (s16) (s32) sp28;
    arg0->unk_190.dim.radius = (s16) (s32) 24.0f;
    arg0->unk_190.dim.height = (s16) (s32) 62.0f;
    arg0->unk_190.dim.pos.z = (s16) (s32) sp2C;
    if (arg0 != -0x190) {
...
void func_80BBE05C(EnSGoro *arg0) {
    ...
    if ((arg0->unk_1DC & 4) != 0) {
        ...
        if (temp_v0 == 0) {
            ...
            arg0->unk_1EE = temp_v0 - 1;
            phi_v1 = arg0->unk_1EE;
        }
        if (phi_v1 == 0) {
            arg0->unk_1EC += 1;
            if ((s32) arg0->unk_1EC >= 3) {
                arg0 = arg0;
                arg0->unk_1EE = Rand_S16Offset(0x1E, 0x1E);
                arg0->unk_1EC = 0;
            }
        }
    }
...
? func_80BBE144(Actor *arg0, Actor *arg1) {
    ...
    sp4C = arg1[22].projectedPos.z;
    Math_SmoothStepToS(arg0 + 0x2D6, (s16) ((arg0->yawTowardsPlayer - arg0[2].unk_52) - arg0->shape.rot.y), 4, 0x2AA8, (s16) 1);
    temp_v1 = arg0[2].focus.unk_12;
    if ((s32) temp_v1 < -0x1FFE) {
        arg0[2].focus.unk_12 = -0x1FFE;
    } else {
        phi_v0 = temp_v1;
        if ((s32) temp_v1 >= 0x1FFF) {
            phi_v0 = 0x1FFE;
        }
        arg0[2].focus.unk_12 = phi_v0;
    }
    Math_SmoothStepToS(arg0 + 0x2DA, (s16) ((arg0->yawTowardsPlayer - arg0[2].focus.unk_12) - arg0->shape.rot.y), 4, 0x2AA8, (s16) 1);
    temp_v1_2 = arg0[2].unk_52;
    if ((s32) temp_v1_2 < -0x1C70) {
        arg0[2].unk_52 = -0x1C70;
    } else {
        phi_v0_2 = temp_v1_2;
        if ((s32) temp_v1_2 >= 0x1C71) {
            phi_v0_2 = 0x1C70;
        }
        arg0[2].unk_52 = phi_v0_2;
    }
    sp40.unk_0 = (s32) sp4C->unk_24;
    sp40.unk_4 = (s32) sp4C->unk_28;
    sp40.unk_8 = (s32) sp4C->unk_2C;
    sp44 = sp4C->unk_C44 + 3.0f;
    sp34.unk_0 = (s32) arg0->world.pos.x;
    sp34.unk_4 = (s32) arg0->world.pos.y;
    sp34.unk_8 = (s32) arg0->world.pos.z;
    sp38 += 70.0f;
    Math_SmoothStepToS(arg0 + 0x2D4, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0[2].sfx), 4, 0x2AA8, (s16) 1);
    temp_v1_3 = arg0[2].focus.rot.z;
    if ((s32) temp_v1_3 < -0x1C70) {
        arg0[2].focus.rot.z = -0x1C70;
    } else {
        phi_v0_3 = temp_v1_3;
        if ((s32) temp_v1_3 >= 0x1C71) {
            phi_v0_3 = 0x1C70;
        }
        arg0[2].focus.rot.z = phi_v0_3;
    }
    Math_SmoothStepToS(arg0 + 0x2D8, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0[2].focus.rot.z), 4, 0x2AA8, (s16) 1);
    temp_v1_4 = arg0[2].sfx;
...
? func_80BBE374(Actor *arg0, Actor *arg1) {
    ...
    temp_v0 = arg0->unk_1F0;
    if (temp_v0 == 0) {
        phi_v1 = 0;
    } else {
        arg0->unk_1F0 = (s16) (temp_v0 - 1);
        phi_v1 = arg0->unk_1F0;
    }
    if (phi_v1 != 0) {
        temp_v1 = arg0->unk_1DC;
        phi_v1_2 = temp_v1;
        if ((temp_v1 & 8) != 0) {
            temp_t9 = temp_v1 & 0xFFFB;
            if ((temp_v1 & 4) != 0) {
                arg0->unk_1DC = temp_t9;
                arg0->unk_1EC = 3;
                phi_v1_2 = temp_t9 & 0xFFFF;
            }
        }
        arg0->unk_1DC = (u16) (phi_v1_2 & 0xFFFD);
        arg0[2].focus.rot.z = 0;
        arg0[2].focus.unk_12 = 0;
        arg0[2].sfx = 0;
        arg0[2].unk_52 = 0;
        return 1;
    }
    temp_v1_2 = arg0->unk_1DC;
    if ((temp_v1_2 & 0x10) != 0) {
        arg0->unk_1DC = (u16) (temp_v1_2 | 2);
        func_80BBE144(arg1, arg1);
    } else if (((temp_v1_2 & 8) == 0) && (arg1 = arg1, (Actor_IsActorFacingLinkAndWithinRange(arg0, 120.0f, 0x3FFC) != 0))) {
        arg0->unk_1DC = (u16) (arg0->unk_1DC | 2);
        func_80BBE144(arg0, arg1);
    } else {
        if ((arg0->unk_1DC & 2) != 0) {
            arg0->unk_1F0 = 0x14;
        }
        arg0->unk_1DC = (u16) (arg0->unk_1DC & 0xFFFD);
        arg0[2].focus.rot.z = 0;
        arg0[2].focus.unk_12 = 0;
        arg0[2].sfx = 0;
        arg0[2].unk_52 = 0;
...
void func_80BBE498(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a3 = arg1;
    arg1 = temp_a3;
    if (Object_IsLoaded(temp_a3 + 0x17D88, arg0->unk_1F4) != 0) {
        arg0->unk_1DC = 0U;
        if ((arg0->params & 0xF) < 3) {
            if ((gSaveContext.weekEventReg[22] & 4) != 0) {
                arg0->unk_1DC = 0x40U;
                arg0->unk_1DC = (u16) (0x40U | 4);
                arg0[2].floorPoly = (CollisionPoly *)5;
                arg1 = arg1;
                func_8013BC6C(arg0 + 0x148, D_80BBF878, 5);
            } else {
                arg0->unk_1EC = 3;
                arg0[2].floorPoly = (CollisionPoly *)0xB;
                arg0->unk_1DC = (u16) (arg0->unk_1DC | 8);
                arg1 = arg1;
                func_8013BC6C(arg0 + 0x148, D_80BBF878, 0xB);
            }
        } else {
            arg0[2].floorPoly = (CollisionPoly *)0xF;
            arg0->unk_1DC = (u16) (arg0->unk_1DC | 4);
            arg1 = arg1;
            func_8013BC6C(arg0 + 0x148, D_80BBF878, 0xF);
        }
        arg0->unk_2D0 = 0.01f;
        ...
        case 8:
            ...
            return;
        case 9:
            arg0->unk_1DC = (u16) (arg0->unk_1DC | 1);
            arg0->unk_18C = func_80BBEAD8;
            arg0->shape.yOffset = 14.0f;
            return;
        default:
...
void func_80BBE73C(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    if ((func_80BBDC34(arg0, arg1) == 0) && (func_80BBDCFC(arg0, arg1) == 0)) {
        if (func_800B84D0((Actor *) arg0, arg1) != 0) {
            temp_t7 = arg0->unk_1DC | 0x10;
            temp_v0 = temp_t7 & 0xFFFF;
            arg0->unk_1DC = temp_t7;
            if ((temp_v0 & 8) != 0) {
                arg0->unk_1DC = (u16) (temp_v0 | 4);
                arg0->unk_1EC = 0;
            }
            temp_v0_2 = func_80BBCA80(arg0, arg1);
            arg0->unk_304 = temp_v0_2;
            func_801518B0(arg1, temp_v0_2 & 0xFFFF, (Actor *) arg0);
            arg0->view.viewing.m[3][1] = (s32) func_80BBE844;
        } else if ((arg0->state.unk_98 < 250.0f) || (arg0->unk_114 != 0)) {
            func_800B863C((Actor *) arg0, arg1);
        }
        Math_SmoothStepToS(arg0 + 0xBE, arg0->unk_16, 5, 0x1000, (s16) 0x100);
        arg0->state.input[1].prev.button = (u16) arg0->unk_BE;
    }
}
...
void func_80BBE844(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    if ((func_80152498(arg1 + 0x4908) == 6) && (func_80147624(arg1) != 0)) {
        ...
        if ((temp_v0 & 0x20) != 0) {
            arg0->unk_1DC = temp_t8;
            arg0->unk_1DC = (u16) (temp_t8 & 0xFFEF);
...
block_5:
    Math_SmoothStepToS(arg0 + 0xBE, arg0->state.alloc.base.unk_E, 5, 0x1000, (s16) 0x100);
    arg0->state.input[1].prev.button = (u16) arg0->unk_BE;
}
...
void func_80BBEAD8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800B84D0(arg0, arg1) != 0) {
        arg0->unk_1DC = (u16) (arg0->unk_1DC | 0x10);
        temp_v1 = arg0->unk_1DC;
        arg0->unk_304 = func_80BBD348(arg0, arg1);
        if ((temp_v1 & 1) != 0) {
            arg0->unk_1DC = (u16) (temp_v1 & 0xFFFE);
            arg0[2].floorPoly = (CollisionPoly *)2;
            func_8013BC6C((SkelAnime *) &arg0[1].flags, D_80BBF878, 2);
            arg0->unk_18C = func_80BBEBF8;
        } else {
            func_801518B0(arg1, arg0->unk_304, arg0);
            arg0->unk_18C = func_80BBECBC;
        }
    } else if ((arg0->xzDistToPlayer < 250.0f) || (arg0->isTargeted != 0)) {
        func_800B863C(arg0, arg1);
    }
...
void func_80BBEBF8(Actor *arg0, GlobalContext *arg1) {
    ...
    sp2E = (s16) (s32) arg0->unk_160;
    if ((arg0[2].floorPoly == 2) && (sp2E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BBF878[arg0[2].floorPoly].animationSeg))) {
        arg0[2].floorPoly = 0xF;
        func_8013BC6C(arg0 + 0x148, D_80BBF878, 0xF);
        func_801518B0(arg1, arg0->unk_304, arg0);
        arg0->unk_18C = func_80BBECBC;
...
void func_80BBECBC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (sp2F == 6) {
        if (func_80147624(arg1) != 0) {
            ...
            if ((temp_v1_2 & 0x20) != 0) {
                arg0->unk_1DC = temp_t0;
                arg0->unk_1DC = (u16) (temp_t0 & 0xFFEF);
                arg0->unk_304 = 0U;
                arg0->unk_18C = func_80BBEAD8;
                return;
            }
...
void func_80BBEEB4(Actor *arg0, GlobalContext *arg1) {
    if (Actor_HasParent(arg0, arg1) != 0) {
        arg0->parent = NULL;
        func_801159EC((s16) ((s32) arg0->unk_30C * -1));
        arg0->unk_18C = func_80BBEF34;
        return;
    }
    func_800B8A1C(arg0, arg1, 0x34, 300.0f, 300.0f);
}
...
void EnSGoro_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_148, &D_06011AC8, &D_06012DE0, &this->unk_1F8, &this->unk_264, 0x12);
    temp_a1 = &this->unk_190;
    sp30 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    Collider_SetCylinder(globalCtx, temp_a1, (Actor *) this, &D_80BBF820);
...
void EnSGoro_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    gSegments[6] = (u32) (globalCtx->objectCtx.status[this->unk_1F4].segment + 0x80000000);
    SkelAnime_FrameUpdateMatrix(&this->unk_148);
    if (this->unk_308 != 0xE) {
        func_80BBE374((Actor *) this, (Actor *) globalCtx);
    }
    func_80BBE05C(this);
    func_80BBE0E4(this);
...
void func_80BBF3EC(GlobalContext *arg0, s32 arg1, Actor *arg2) {
    ...
    if (arg1 != 0xA) {
        if ((arg1 == 0x11) && (arg2[2].floorPoly != 0xE)) {
            phi_v1 = 0;
            if ((arg2->unk_1DC & 2) != 0) {
                phi_v1 = 1;
            }
            ...
            func_80BBF298((s16) (arg2[2].focus.rot.z + arg2[2].sfx + 0x4000), (s16) (arg2[2].focus.unk_12 + arg2[2].unk_52 + arg2->shape.rot.y + 0x4000), arg2 + 0x2DC, arg2 + 0x2E8, phi_v0, phi_v1);
            SysMatrix_StatePop();
            SysMatrix_InsertTranslation(arg2[2].targetArrowOffset, arg2[2].scale.x, arg2[2].scale.y, 0);
            Matrix_Scale(arg2->scale.x, arg2->scale.y, arg2->scale.z, 1);
            Matrix_RotateY(arg2->unk_2EA, 1U);
            SysMatrix_InsertXRotation_s(arg2->unk_2E8, 1);
            SysMatrix_InsertZRotation_s(arg2->unk_2EC, 1);
            SysMatrix_StatePush();
            return;
        }
    ...
    if (arg2[2].floorPoly != 0xE) {
        ...
        func_80BBF298((s16) (arg2[2].sfx + 0x4000), (s16) (arg2[2].unk_52 + arg2->shape.rot.y + 0x4000), arg2 + 0x2F0, arg2 + 0x2FC, phi_v0_2, phi_v1_2);
        SysMatrix_StatePop();
        SysMatrix_InsertTranslation(arg2[2].velocity.y, arg2[2].velocity.z, arg2[2].speedXZ, 0);
        Matrix_Scale(arg2->scale.x, arg2->scale.y, arg2->scale.z, 1);
        Matrix_RotateY(arg2->unk_2FE, 1U);
        SysMatrix_InsertXRotation_s(arg2->unk_2FC, 1);
        SysMatrix_InsertZRotation_s(arg2->unk_300, 1);
        SysMatrix_StatePush();
    }
}
...
void func_80BBF5F0(Actor *arg0, GlobalContext *arg1) {
    ...
    sp38 = sp38;
    sp30 = temp_v0;
    sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80BBF978 + (arg0->unk_1EC * 4)));
    temp_v0_2 = sp38->polyOpa.p;
    sp38->polyOpa.p = &temp_v0_2[1];
    temp_v0_2->words.w1 = 0;
    temp_v0_2->words.w0 = 0xE7000000;
    func_801343C0(arg1, arg0[1].home.pos.x, arg0[1].world.pos.x, (s32) arg0->unk_14A, func_80BBF3D0, NULL, func_80BBF3EC, arg0);
}
