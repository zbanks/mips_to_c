typedef struct EnSGoro {
    ...
    /* 0x1DC */ u16 unk1DC;                         /* inferred */
    /* 0x1DE */ char pad1DE[0x16];                  /* maybe part of unk1DC[12]? */
    /* 0x1F4 */ s32 unk1F4;                         /* inferred */
    /* 0x1F8 */ Vec3s unk1F8;                       /* inferred */
    /* 0x1FE */ char pad1FE[0x66];                  /* maybe part of unk1F8[18]? */
    /* 0x264 */ Vec3s unk264;                       /* inferred */
    /* 0x26A */ char pad26A[0x9E];                  /* maybe part of unk264[27]? */
    /* 0x308 */ s32 unk308;                         /* inferred */
    /* 0x30C */ char pad30C[0x4];
} EnSGoro;                                          /* size = 0x310 */
...
void func_80BBDDF8(Actor *arg0) {
    ...
    temp_t8 = arg0->unk308;
    arg0 = arg0;
    if ((arg0->unk308 != 0xD) && (sp1E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BBF878[temp_t8].animationSeg))) {
        arg0->unk308 = 0xD;
...
void func_80BBDF28(Actor *arg0) {
    ...
    temp_t8 = arg0->unk308;
    arg0 = arg0;
    if ((arg0->unk308 != 0xF) && (sp1E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BBF878[temp_t8].animationSeg))) {
        arg0->unk308 = 0xF;
        func_8013BC6C(arg0 + 0x148, D_80BBF878, 0xF);
    }
}
...
? func_80BBE144(Actor *arg0, Actor *arg1) {
    ...
    sp40.unk0 = (s32) sp4C->unk24;
    sp40.unk4 = (s32) sp4C->unk28;
    sp40.unk8 = (s32) sp4C->unk2C;
    sp44 = sp4C->unkC44 + 3.0f;
    sp34.unk0 = (s32) arg0->world.pos.x;
    sp34.unk4 = (s32) arg0->world.pos.y;
    sp34.unk8 = (s32) arg0->world.pos.z;
    sp38 += 70.0f;
    Math_SmoothStepToS(arg0 + 0x2D4, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk2D8), 4, 0x2AA8, (s16) 1);
    ...
    Math_SmoothStepToS(arg0 + 0x2D8, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk2D4), 4, 0x2AA8, (s16) 1);
...
void func_80BBEBF8(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk308 == 2) && (sp2E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80BBF878[arg0->unk308].animationSeg))) {
        arg0->unk308 = 0xF;
        func_8013BC6C(arg0 + 0x148, D_80BBF878, 0xF);
        func_801518B0(arg1, arg0->unk304, arg0);
        arg0->unk18C = func_80BBECBC;
...
void EnSGoro_Init(EnSGoro *this, GlobalContext *globalCtx) {
...
void EnSGoro_Destroy(EnSGoro *this, GlobalContext *globalCtx) {
    EnSGoro *this = (EnSGoro *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk190);
}

void EnSGoro_Update(EnSGoro *this, GlobalContext *globalCtx) {
    EnSGoro *this = (EnSGoro *) thisx;
...
void EnSGoro_Draw(EnSGoro *this, GlobalContext *globalCtx) {
    EnSGoro *this = (EnSGoro *) thisx;
    if ((this->unk1DC & 1) != 0) {
        func_80BBF6BC();
        return;
