typedef struct BgIkanaBlock {
    ...
    /* 0x178 */ u16 unk178;                         /* inferred */
    /* 0x17A */ u8 unk17A;                          /* inferred */
    /* 0x17B */ char pad17B[0x1];
    /* 0x17C */ u8 unk17C;                          /* inferred */
    /* 0x17D */ s8 unk17D;                          /* inferred */
    /* 0x17E */ s8 unk17E;                          /* inferred */
...
s32 func_80B7EB94(BgIkanaBlock *arg0, GlobalContext *arg1) {
    ...
    sp68 += arg0->actor.world.pos.y + arg0->unk170 + 2.0f;
...
void BgIkanaBlock_Init(BgIkanaBlock *this, GlobalContext *globalCtx) {
...
void BgIkanaBlock_Destroy(BgIkanaBlock *this, GlobalContext *globalCtx) {
    BgIkanaBlock *this = (BgIkanaBlock *) thisx;
...
void BgIkanaBlock_Update(BgIkanaBlock *this, GlobalContext *globalCtx) {
    s8 temp_v0;
    BgIkanaBlock *this = (BgIkanaBlock *) thisx;
