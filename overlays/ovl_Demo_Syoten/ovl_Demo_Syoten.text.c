typedef struct {
    ...
    /* 0x02 */ u16 startFrame;
    /* 0x04 */ u16 endFrame;
    /* 0x06 */ char pad6[0x4];                      /* maybe part of endFrame[3]? */
...
typedef struct DemoSyoten {
    ...
    /* 0x174 */ char pad174[0x132];
    /* 0x2A6 */ ? unk2A6;                           /* inferred */
    /* 0x2A6 */ char pad2A6[0x132];
    /* 0x3D8 */ f32 unk3D8;                         /* inferred */
    /* 0x3DC */ ? *unk3DC;                          /* inferred */
    /* 0x3E0 */ void *unk3E0;                       /* inferred */
    /* 0x3E4 */ u16 unk3E4;                         /* inferred */
    /* 0x3E6 */ s16 unk3E6;                         /* inferred */
    /* 0x3E8 */ u8 *unk3E8;                         /* inferred */
    /* 0x3EC */ s32 unk3EC;                         /* inferred */
    /* 0x3F0 */ u16 unk3F0;                         /* inferred */
    /* 0x3F2 */ u16 unk3F2;                         /* inferred */
...
void DemoSyoten_Init(DemoSyoten *this, GlobalContext *globalCtx) {
    ? *sp44;
    ? *temp_a0;
    u16 temp_t3;
    u16 temp_t5;
...
void DemoSyoten_Destroy(DemoSyoten *this, GlobalContext *globalCtx) {
    DemoSyoten *this = (DemoSyoten *) thisx;
...
s32 func_80C16818(Actor *arg0) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp28, Lib_SegmentedToVirtual(temp_v1->unk4) + (arg0->unk3EC * 6));
    temp_a0 = arg0 + 0x24;
    sp24 = temp_a0;
...
void func_80C168D0(DemoSyoten *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = arg0->unk3E8;
    if (temp_v1 != 0) {
        Math_Vec3s_ToVec3f((Vec3f *) &sp30, Lib_SegmentedToVirtual(temp_v1->unk4) + (arg0->unk3EC * 6));
...
void DemoSyoten_Update(DemoSyoten *this, GlobalContext *globalCtx) {
    DemoSyoten *this = (DemoSyoten *) thisx;
...
void DemoSyoten_Draw(DemoSyoten *this, GlobalContext *globalCtx) {
