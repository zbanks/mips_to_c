...
static InitChainEntry D_80960BD8;                   /* unable to generate initializer */
...
void ObjLightswitch_InitCollider(Actor *arg0, GlobalContext *arg1) {
    ...
    SysMatrix_SetStateRotationAndTranslation(arg0->world.pos.x, arg0->world.pos.y + (arg0->shape.yOffset * arg0->scale.y), arg0->world.pos.z, &arg0->shape.rot);
...
void ObjLightswitch_SpawnEffects(void *arg0, GlobalContext *arg1) {
    ...
    sp58 = Math_SinS(arg0->unkBE);
    sp54 = Math_CosS(arg0->unkBE);
    temp_v0 = arg0->unk1AE;
    if ((s32) temp_v0 >= 0x1900) {
        ...
        temp_a1 = &sp5C;
        sp5C = arg0->unk24 + ((temp_f12_2 * sp58) + (temp_f2_3 * sp54));
        sp60 = arg0->unk28 + sp4C + 10.0f;
        sp64 = arg0->unk2C + ((temp_f12_2 * sp54) - (temp_f2_3 * sp58));
...
void ObjLightswitch_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    ObjLightswitch_InitCollider(&this->actor, globalCtx);
...
void ObjLightswitch_SetAction(void (*arg0)(ObjLightswitch *), void (*arg1)(ObjLightswitch *), s8 arg2) {
    arg0->unk1B8 = arg1;
    arg0->unk1BC = arg2;
    arg0->unk1A4 = ObjLightswitch_PlayCinema;
}

void ObjLightswitch_PlayCinema(ObjLightswitch *this, GlobalContext *globalCtx) {
    ObjLightswitch *self = (ObjLightswitch *) this;
    if (ActorCutscene_GetCanPlayNext((s16) self->actor.cutscene) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields((s16) self->actor.cutscene, &self->actor);
        ObjLightswitch_UpdateSwitchFlags(self, globalCtx, self->switchFlagSetType);
...
void ObjLightswitch_SetupIdle(ObjLightswitch *this) {
    ...
    self->colorG = 0x1F40;
    self->colorB = 0x3FC0;
    self->colorAlpha = 0x3FC0;
    self->actionFunc = ObjLightswitch_Idle;
}
...
void ObjLightswitch_Idle(ObjLightswitch *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = ((s32) self->actor.params >> 4) & 3;
    if ((s32) self->hitState >= 0xA) {
        if (temp_v0 == 3) {
...
void ObjLightSwitch_Asleep(ObjLightswitch *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 0) {
        this = this;
        Audio_PlayActorSound2(&temp_a0->actor, 0x286FU);
    ...
    if (temp_v0_2 == 0xF) {
        this->faceState = 1;
        Audio_PlayActorSound2(&this->actor, 0x2815U);
    }
}
...
void ObjLightSwitch_DrawOpa(void *arg0, GraphicsContext **arg1) {
    ...
    temp_v0->words.w1 = ((((s32) arg0->unk1AC >> 6) & 0xFF) << 8) | (((s32) arg0->unk1A8 >> 6) << 0x18) | ((((s32) arg0->unk1AA >> 6) & 0xFF) << 0x10) | (((s32) arg0->unk1AE >> 6) & 0xFF);
    temp_v0_2 = temp_s1->polyOpa.p;
    temp_s1->polyOpa.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xDB060024;
    temp_v0_2->words.w1 = (u32) D_801AEFA0;
    sp58 = arg0->unk24;
    sp5C = arg0->unk28 + (arg0->unkC4 * arg0->unk5C);
    sp60 = arg0->unk2C;
    ...
    sp38 = temp_v0_4;
    sp38->words.w1 = Lib_SegmentedToVirtual(*(&sLightswitchFaceGfx + (arg0->unk1B6 * 4)));
