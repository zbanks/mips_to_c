typedef struct EnWiz {
    ...
    /* 0x278 */ SkelAnime unk_278;                  /* inferred */
    /* 0x2BC */ Vec3s unk_2BC;                      /* inferred */
    /* 0x2C2 */ ? unk_2C2;                          /* inferred */
    /* 0x2C2 */ char pad_2C2[0x6];
    /* 0x2C8 */ ? unk_2C8;                          /* inferred */
    /* 0x2C8 */ char pad_2C8[0x6];
    /* 0x2CE */ ? unk_2CE;                          /* inferred */
    /* 0x2CE */ char pad_2CE[0x66];
    /* 0x334 */ Vec3s unk_334;                      /* inferred */
    /* 0x33A */ char pad_33A[0x72];                 /* maybe part of unk_334[20]? */
    ...
    /* 0x3BA */ char pad_3BA[0x8];                  /* maybe part of unk_3B8[5]? */
    /* 0x3C2 */ s16 unk_3C2;                        /* inferred */
    /* 0x3C4 */ s16 unk_3C4;                        /* inferred */
    /* 0x3C6 */ char pad_3C6[0xE];                  /* maybe part of unk_3C4[8]? */
    /* 0x3D4 */ f32 unk_3D4;                        /* inferred */
    /* 0x3D8 */ f32 unk_3D8;                        /* inferred */
    /* 0x3DC */ f32 unk_3DC;                        /* inferred */
    /* 0x3E0 */ f32 unk_3E0;                        /* inferred */
    /* 0x3E4 */ f32 unk_3E4;                        /* inferred */
    /* 0x3E8 */ f32 unk_3E8;                        /* inferred */
    /* 0x3EC */ f32 unk_3EC;                        /* inferred */
    /* 0x3F0 */ f32 unk_3F0;                        /* inferred */
    /* 0x3F4 */ f32 unk_3F4;                        /* inferred */
    /* 0x3F8 */ f32 unk_3F8;                        /* inferred */
    /* 0x3FC */ char pad_3FC[0x18];                 /* maybe part of unk_3F8[7]? */
    /* 0x414 */ f32 unk_414;                        /* inferred */
    /* 0x418 */ f32 unk_418;                        /* inferred */
    /* 0x41C */ f32 unk_41C;                        /* inferred */
    /* 0x420 */ char pad_420[0x30];                 /* maybe part of unk_41C[13]? */
    /* 0x450 */ f32 unk_450;                        /* inferred */
    /* 0x454 */ ColliderJntSph unk_454;             /* inferred */
    /* 0x474 */ ColliderJntSphElement unk_474;      /* inferred */
    /* 0x4B4 */ char pad_4B4[0x240];                /* maybe part of unk_474[10]? */
    /* 0x6F4 */ ColliderCylinder unk_6F4;           /* inferred */
    /* 0x740 */ s32 unk_740;                        /* inferred */
    /* 0x744 */ char pad_744[0x4];
    /* 0x748 */ s16 unk_748;                        /* inferred */
    /* 0x74A */ s16 unk_74A;                        /* inferred */
    /* 0x74C */ s16 unk_74C;                        /* inferred */
    /* 0x74E */ s16 unk_74E;                        /* inferred */
    /* 0x750 */ char pad_750[0x2];
    /* 0x752 */ s16 unk_752;                        /* inferred */
    /* 0x754 */ s16 unk_754;                        /* inferred */
    /* 0x756 */ char pad_756[0x2];
    /* 0x758 */ f32 unk_758;                        /* inferred */
    /* 0x75C */ f32 unk_75C;                        /* inferred */
    /* 0x760 */ Vec3f unk_760;                      /* inferred */
    /* 0x76C */ char pad_76C[0x614];                /* maybe part of unk_760[130]? */
} EnWiz;                                            /* size = 0xD80 */
...
struct _mips2c_stack_EnWiz_Draw {
    ...
    /* 0x60 */ char pad_60[0x56];                   /* maybe part of sp5C[22]? */
    /* 0xB6 */ s16 spB6;                            /* inferred */
    /* 0xB8 */ char pad_B8[0x4];                    /* maybe part of spB6[3]? */
    /* 0xBC */ f32 spBC;                            /* inferred */
    /* 0xC0 */ char pad_C0[0x20];
};                                                  /* size = 0xE0 */
...
struct _mips2c_stack_func_80A46E24 {
    ...
    /* 0x4A */ char pad_4A[0x6];                    /* maybe part of sp48[4]? */
...
void EnWiz_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_144, &D_0600B320, &D_060066C0, &this->unk_188, &this->unk_200, 0x14);
    SkelAnime_InitSV(globalCtx, &this->unk_278, &D_0600B320, &D_060066C0, &this->unk_2BC, &this->unk_334, 0x14);
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk_454, (Actor *) this, &D_80A48CB8, &this->unk_474);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_6F4, (Actor *) this, &D_80A48CC8);
    temp_v1 = this->actor.params;
    this->unk_3B8 = Rand_S16Offset(0, 7);
    this->unk_74C = temp_v1 & 0x7F;
    this->unk_74A = ((s32) temp_v1 >> 8) & 0xFF;
    if (this->unk_74C == 0x7F) {
        this->unk_74C = -1;
    }
    temp_v0 = this->unk_74A;
...
void EnWiz_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnWiz *this = (EnWiz *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_6F4);
    Collider_DestroyJntSph(globalCtx, &this->unk_454);
    if (this->unk_74A != 2) {
        func_801A2ED8();
    }
}
...
void func_80A455C4(Actor *arg0, s32 arg1, s32 arg2) {
    ...
    arg0[3].flags = temp_f0;
    temp_v1 = arg1 + &D_80A48D4C;
    sp28 = temp_v1;
    SkelAnime_ChangeAnim(arg0 + 0x144, *sp2C, 1.0f, 0.0f, temp_f0, (u8) (s32) *temp_v1, -2.0f);
    if (arg2 != 0) {
        SkelAnime_ChangeAnim(arg0 + 0x278, *sp2C, 1.0f, 0.0f, arg0[3].flags, (u8) (s32) *temp_v1, -2.0f);
    }
}
...
void func_80A456A0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk_3CB < 6) {
        temp_v1 = arg0->unk_3CB;
        temp_s0 = Play_GetCamera(arg1, arg0->unk_74E);
        switch (temp_v1) {
        case 0:
            arg0->unk_3B4 = 0x64;
            arg0->unk_3CB = (u8) (temp_v1 + 1);
            arg0->unk_3C8 = (s16) arg0->world.rot.y;
            break;
        case 1:
            temp_a1 = arg0 + 0x24;
            sp38 = temp_a1;
            ...
            temp_f10 = sp58 + (Math_SinS(arg0->unk_3C8) * 200.0f);
            sp5C += 100.0f;
            sp58 = temp_f10;
            temp_f16 = sp60 + (Math_CosS(arg0->unk_3C8) * 200.0f);
            sp50 += 80.0f;
            sp60 = temp_f16;
            ...
            if ((fabsf(temp_s0->eye.x - sp58) < 2.0f) && (fabsf(temp_s0->eye.y - sp5C) < 2.0f) && (fabsf(temp_s0->eye.z - sp60) < 2.0f) && (fabsf(temp_s0->at.x - sp4C) < 2.0f) && (fabsf(temp_s0->at.y - sp50) < 2.0f) && (fabsf(temp_s0->at.z - sp54) < 2.0f)) {
                ...
                phi_v1 = 0;
                if (arg0[5].projectedPos.x > 0) {
                    phi_a2 = arg0;
                    phi_s0 = arg0 + 0x81C;
                    do {
                        sp44 = phi_v1;
                        sp2C = phi_a2;
                        phi_a2->unk_896 = Math_Vec3f_Yaw(phi_s0, (Vec3f *) sp34);
                        temp_v1_2 = phi_v1 + 1;
                        phi_v1 = temp_v1_2;
                        phi_a2 += 6;
                        phi_s0 = &phi_s0[1];
                    } while (temp_v1_2 < arg0[5].projectedPos.x);
                }
                ...
                arg0->unk_3B4 = 0x28;
                arg0->unk_3CB = (u8) (arg0->unk_3CB + 1);
            }
            break;
        case 2:
            if (arg0->unk_3B4 == 0) {
        ...
        case 5:
            ...
            if (arg0->unk_3B4 == 0) {
                arg0->unk_3C8 = 0;
                arg0->unk_3CB = 6U;
                arg0->unk_44C = (s16) arg0->unk_3C8;
            } else {
                Math_SmoothStepToS((s16 *) &arg0[2].update, 0x1388, 0x64, 0x3E8, (s16) 0x3E8);
                arg0->world.rot.y += arg0->unk_3C0;
            }
            ...
            temp_f4 = sp58 + (Math_SinS(arg0->unk_3C8) * 200.0f);
            sp5C += 100.0f;
            sp58 = temp_f4;
            temp_f10_2 = sp60 + (Math_CosS(arg0->unk_3C8) * 200.0f);
            sp50 += 80.0f;
            sp60 = temp_f10_2;
            Math_ApproachF((f32 *) &temp_s0->eye, sp58, 0.3f, 30.0f);
            Math_ApproachF(&temp_s0->eye.z, sp60, 0.3f, 30.0f);
        ...
        if (temp_v0_2 < 0xB) {
            temp_t8 = temp_v0_2 + 1;
            arg0->unk_3CC = temp_t8;
            if ((arg0->unk_74A != 2) && (temp_t8 == 0xB)) {
                func_801A2E54(0x38);
            }
        }
    }
...
void func_80A45CD8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0_2 != 0) {
        do {
            ...
            if (phi_v0_2->id != 0x15E) {
                ...
                (arg0 + (phi_s3_2 * 4))->unk_420 = phi_v0_2;
                phi_s3_7 = phi_s3_2 + 1;
                if (arg0->unk_3B0 != 6) {
                    temp_v1 = arg0->unk_74A;
                    phi_v1 = temp_v1;
                    if (temp_v1 == 2) {
                        phi_v1 = 0;
                    }
    ...
    if (arg0->unk_3B0 != 5) {
        arg0[5].projectedPos.x = phi_s3_3;
        if (phi_s3_3 < 0) {

        } else if (arg0[5].projectedPos.x >= 0xB) {
            arg0[5].projectedPos.x = 0xA;
        }
        ...
        phi_fp = (s16) temp_f6;
        if (((s16) temp_f6 == arg0->unk_748) || ((s16) temp_f6 == phi_s3_4)) {
            do {
loop_19:
                temp_f8 = (s32) Rand_ZeroFloat(sp44);
                phi_fp = (s16) temp_f8;
                if ((s16) temp_f8 == arg0->unk_748) {
                    goto loop_19;
                }
            } while ((s16) temp_f8 == phi_s3_4);
            phi_v1_2 = (s16) temp_f8;
        }
        temp_v0_4 = arg0->unk_3B6;
        arg0->unk_748 = phi_v1_2;
        if (temp_v0_4 != 0) {
            temp_s4 = arg0 + 0x24;
            if (temp_v0_4 != 1) {
                Math_Vec3f_Copy(arg0 + 0x24, (arg0 + (phi_fp * 4))->unk_420 + 0x24);
                ...
                if (temp_s3_2 >= 0) {
                    ...
                    do {
                        if (phi_fp != phi_s3_5) {
                            ...
                            temp_s5 = arg0 + 0x30;
                            Math_Vec3f_Copy(phi_s2, (arg0 + (phi_s3_5 * 4))->unk_420 + 0x24);
                            temp_s4_2->unk_0 = (unaligned s32) temp_s5->unk_0;
                            temp_s4_2->unk_4 = (u16) temp_s5->unk_4;
                            temp_s1->unk_7F2 = 0x64;
                            temp_s1->unk_806 = phi_s3_5;
                            phi_a0 = arg0 + 0x188;
                            ...
                            do {
                                ...
                                temp_v1_2->unk_-18 = (unaligned s32) phi_a0->unk_0;
                                temp_a1 = phi_a1 + 0x18;
                                temp_v1_2->unk_-14 = (u16) phi_a0->unk_4;
                                temp_a2 = phi_a2 + 0x18;
                                temp_a3 = phi_a3 + 0x18;
                                temp_a1->unk_-18 = (unaligned s32) *phi_a2;
                                temp_t0 = phi_t0 + 0x18;
                                temp_t1 = phi_t1 + 0x18;
                                temp_a1->unk_-14 = (u16) temp_a2->unk_-14;
                                temp_t2 = phi_t2 + 0x18;
                                temp_a3->unk_-18 = (unaligned s32) temp_t0->unk_-18;
                                temp_a3->unk_-14 = (u16) temp_t0->unk_-14;
                                temp_t1->unk_-18 = (unaligned s32) temp_t2->unk_-18;
                                temp_t1->unk_-14 = (u16) temp_t2->unk_-14;
                                phi_a0 += 0x18;
                                phi_v1_3 = temp_v1_2;
                                phi_a2 = temp_a2;
                                phi_a1 = temp_a1;
            ...
            Math_Vec3f_Copy(temp_s4, arg0[3].targetArrowOffset + 0x24);
            phi_s2_2 = arg0 + 0x81C;
            phi_s0 = 0x80;
            phi_s1 = arg0;
            if (arg0[5].projectedPos.x > 0) {
                do {
                    ...
                    phi_s1->unk_7F2 = phi_s0;
                    temp_s3_4 = phi_s3_6 + 1;
                    phi_s2_2 = &phi_s2_2[1];
                    phi_s0 = (s16) (phi_s0 - 0xA);
                    phi_s1 += 2;
                    phi_s3_6 = temp_s3_4;
                } while (temp_s3_4 < arg0[5].projectedPos.x);
                return;
            }
            /* Duplicate return node #37. Try simplifying control flow for better match */
            return;
...
void func_80A460A4(Actor *arg0) {
    ...
    if (temp_v1 > 0) {
        phi_s1 = arg0;
        do {
            temp_f14 = phi_s1->unk_81C;
            phi_fp_2 = phi_fp_3;
            if (temp_f14 != 0.0f) {
                temp_f16 = phi_s1[6].yDistToWater;
                if (temp_f16 != 0.0f) {
                    temp_v1_2 = arg0 + (phi_s2 * 2);
                    temp_v0 = temp_v1_2->unk_806;
                    temp_a0 = (arg0 + (temp_v0 * 4))->unk_420;
                    temp_s4 = phi_s1 + 0x81C;
                    temp_f2 = temp_a0->unk_24 - temp_f14;
                    temp_f12 = temp_a0->unk_2C - temp_f16;
                    phi_fp_2 = phi_fp_3 + 1;
                    if (sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12)) < 30.0f) {
                        temp_v1_2->unk_806 = (s16) (temp_v0 - 1);
                        if ((s32) temp_v1_2->unk_806 < 0) {
                            temp_v1_2->unk_806 = (s16) (arg0[5].projectedPos.x - 1);
                        }
                    }
                    temp_s0 = arg0 + (temp_v1_2->unk_806 * 4);
                    Math_ApproachF(temp_s4, temp_s0->unk_420->unk_24, 0.3f, 30.0f);
                    Math_ApproachF(phi_s1 + 0x820, temp_s0->unk_420->unk_28, 0.3f, 30.0f);
                    Math_ApproachF(phi_s1 + 0x824, temp_s0->unk_420->unk_2C, 0.3f, 30.0f);
                    (arg0 + (phi_s2 * 6))->unk_896 = Math_Vec3f_Yaw((Vec3f *) temp_s4, temp_s0->unk_420 + 0x24);
                    phi_v1 = arg0[5].projectedPos.x;
                }
            }
            temp_s2 = phi_s2 + 1;
            phi_s1 += 0xC;
...
void func_80A46280(EnWiz *arg0, GlobalContext *arg1) {
    if (ActorCutscene_GetCanPlayNext((s16) arg0->actor.cutscene) != 0) {
        ...
        arg0->unk_74E = ActorCutscene_GetCurrentCamera((s16) arg0->actor.cutscene);
    ...
    if (arg0->unk_3B2 == 0) {
        ...
        if (arg0->unk_3CB != 0) {
            ...
            if (arg0[5].projectedPos.x > 0) {
                ...
                phi_s2 = arg0;
                do {
                    phi_s2->unk_896 = Math_Vec3f_Yaw(phi_s1, temp_s3);
                    temp_s0_2 = phi_s0 + 1;
                    phi_s1 = &phi_s1[1];
                    phi_s2 += 6;
                    phi_s0 = temp_s0_2;
                } while (temp_s0_2 < arg0[5].projectedPos.x);
            }
            func_80A455C4(arg0, 0, 1);
            arg0->unk_3CA = 0;
            arg0->unk_3C6 = 0xFF;
            Math_Vec3f_Copy((Vec3f *) &arg0[3].focus.rot, sp30);
            if (arg0->unk_3B6 == 0) {
                Audio_PlayActorSound2(arg0, 0x38A4U);
            } else {
                Audio_PlayActorSound2(arg0, 0x30A6U);
        ...
        arg0[2].child = (Actor *) func_80A46414;
    }
}
...
void func_80A46414(Actor *arg0, void *arg1) {
    ...
    sp3C.unk_0 = (s32) D_80A48D54.unk_0;
    sp3C.unk_4 = (s32) D_80A48D54.unk_4;
    sp3C.unk_8 = (s32) D_80A48D54.unk_8;
    sp38 = arg1->unk_1CCC;
    func_80A456A0(arg0);
    if ((s32) arg0->unk_3CB >= 2) {
        SkelAnime_FrameUpdateMatrix((SkelAnime *) &arg0[1]);
        if ((arg0->unk_3B6 == 0) && ((s32) arg0->unk_3CB >= 6)) {
            if (!(arg0->xzDistToPlayer < 200.0f)) {
                if (sp38->unk_D57 != 0) {
                    ...
                    if (phi_a0 < 0x7D0) {
                        temp_v0_2 = temp_v1 - (sp38->unk_BE + 0x8000);
...
block_12:
        ...
        if (arg0->unk_3B6 == 0) {
            Math_SmoothStepToS((s16 *) &arg0[2].draw, arg0->unk_3C6, 0xA, 0xA, (s16) 0xA);
            if (arg0->unk_3CA == 0) {
                arg0->unk_3B2 = 0x14;
                arg0->unk_3CA = 1U;
            }
        ...
        if (arg0->unk_3B2 == 0) {
            Math_ApproachF((f32 *) &arg0[3].home, 0.015f, 0.05f, 0.01f);
            Math_SmoothStepToS(arg0 + 0x3C2, 0xFF, 1, 5, (s16) 0);
        }
        if (!(arg0[3].home.pos.x < 0.0138f)) {
            arg0->unk_3B0 = 7;
            arg0->flags &= 0xF7FFFFFF;
            arg0[3].colChkInfo.displacement.x->unk_8 = 0x1013A22;
            Math_Vec3f_Copy((Vec3f *) &arg0[3].world, (Vec3f *) &sp3C);
            temp_v0_3 = arg0->unk_3CB;
            arg0->unk_3C6 = 0;
            if (temp_v0_3 == 6) {
                arg0->unk_3B2 = 0;
                arg0->unk_3B4 = 0x14;
            ...
            if ((s32) temp_v0_3 >= 7) {
                if (arg0->unk_3B6 == 1) {
                    arg0[2].child = (Actor *) func_80A468CC;
                    return;
                }
                func_80A4668C(arg0);
...
void func_80A4668C(Actor *arg0) {
    ...
    Math_ApproachF((f32 *) &arg0[3].home, 0.015f, 0.05f, 0.001f);
    arg0->unk_3C0 = 0;
    arg0->unk_44C = 0;
    arg0->unk_3B0 = 9;
    if ((s32) arg0->unk_3B6 >= 2) {
        SkelAnime_ChangeAnim((SkelAnime *) &arg0[1].destroy, (AnimationHeader *) &D_060025F0, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(&D_060025F0), (u8) 0, 0.0f);
        arg0->unk_3B6 = 3;
    }
    Math_SmoothStepToS(arg0 + 0x3C2, 0xFF, 1, 5, (s16) 0);
    arg0[2].child = (Actor *) func_80A46764;
}
...
void func_80A46764(Actor *arg0, ? arg1) {
    ...
    Audio_PlayActorSound2(arg0, 0x30A5U);
    arg0->world.rot.y += arg0->unk_3C0;
    if ((s32) arg0->unk_3B6 >= 3) {
        func_80A460A4(arg0);
    } else {
        phi_v0 = arg0;
        phi_v1 = 0;
        if ((bitwise s32) arg0[5].projectedPos.x > 0) {
            do {
                temp_v1 = phi_v1 + 1;
                temp_v0 = phi_v0 + 6;
                temp_v0->unk_890 = (s16) (phi_v0->unk_896 + arg0->unk_3C0);
                phi_v0 = temp_v0;
                phi_v1 = temp_v1;
            } while (temp_v1 < (bitwise s32) arg0[5].projectedPos.x);
        }
    }
    Math_SmoothStepToS((s16 *) &arg0[2].update, 0x1388, 0x64, 0x3E8, (s16) 0x3E8);
    Math_SmoothStepToS((s16 *) &arg0[2].draw, arg0->unk_3C6, 0x14, 0x32, (s16) 0xA);
    if ((bitwise f32) arg0[3].flags <= sp2C) {
        temp_v0_2 = arg0->unk_44C;
        if ((s32) temp_v0_2 < 0xA) {
            arg0->unk_44C = (s16) (temp_v0_2 + 1);
        }
    }
    if (((s32) arg0->unk_44C >= 3) && (arg0->unk_3BA == 0)) {
        arg0->unk_3C6 = 0;
        func_80A46C88(arg0);
    }
}
...
void func_80A468CC(Actor *arg0, ? arg1) {
    ...
    arg0->unk_74E = ActorCutscene_GetCurrentCamera(sp2E);
    arg0->flags |= 0x100000;
    func_80A455C4(arg0, 2, 0);
    arg0->unk_3B0 = 2;
    arg0[5].projectedPos.y = 1e-45.0f;
    arg0->unk_3BC = 0;
    Math_SmoothStepToS(arg0 + 0x3C2, 0xFF, 1, 5, (s16) 0);
    arg0[2].child = (Actor *) func_80A46990;
}
...
void func_80A46990(Actor *arg0, GlobalContext *arg1) {
    ...
    Math_SmoothStepToS(arg0 + 0x3C2, 0xFF, 1, 5, (s16) 0);
    Math_Vec3f_Copy(Play_GetCamera(arg1, arg0->unk_74E) + 0x50, arg0 + 0x3C);
    Audio_PlayActorSound2(arg0, 0x30A5U);
    temp_v1 = arg0[5].projectedPos.y;
    temp_v0 = (arg0 + ((bitwise s32) temp_v1 * 4))->unk_420;
    if ((temp_v0 != 0) && (temp_f14 = arg0->world.pos.x, temp_f16 = arg0->world.pos.z, temp_f2 = temp_f14 - temp_v0->unk_24, temp_f12 = temp_f16 - temp_v0->unk_2C, (sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12)) < 30.0f))) {
        if (arg0->unk_3BC == 0) {
            temp_t9 = (bitwise s32) temp_v1 + 1;
            arg0[5].projectedPos.y = (bitwise f32) temp_t9;
            if (temp_t9 >= (bitwise s32) arg0[5].projectedPos.x) {
                arg0->unk_3BC = 1;
                arg0[5].projectedPos.y = 0.0f;
            }
            goto block_10;
        }
        temp_v1_2 = arg0[5].projectedPos.x;
        temp_v0_2 = arg0 + ((((bitwise s32) temp_v1_2 * 4) - (bitwise s32) temp_v1_2) * 4);
        temp_f2_2 = temp_f14 - temp_v0_2->unk_81C;
        temp_f12_2 = temp_f16 - temp_v0_2->unk_824;
        arg0->flags |= 0x8000000;
        if (sqrtf((temp_f2_2 * temp_f2_2) + (temp_f12_2 * temp_f12_2)) < 20.0f) {
            phi_s0 = 0;
            if ((bitwise s32) temp_v1_2 > 0) {
                phi_s1 = (Vec3f *) &arg0[6].wallBgId;
                do {
                    Math_Vec3f_Copy(phi_s1, &D_801D15B0);
                    temp_s0 = phi_s0 + 1;
                    phi_s1 = &phi_s1[1];
                    phi_s0 = temp_s0;
                } while (temp_s0 < (bitwise s32) arg0[5].projectedPos.x);
            }
            arg0[5].projectedPos.y = 0.0f;
...
block_10:
    temp_a1 = &arg0->world;
    sp3C = temp_a1;
    Math_Vec3f_Copy((Vec3f *) &arg0[6].wallBgId, (Vec3f *) temp_a1);
    arg0->unk_896 = (s16) arg0->world.rot.y;
    Math_ApproachF((f32 *) sp3C, (arg0 + ((bitwise s32) arg0[5].projectedPos.y * 4))->unk_420->unk_24, 0.3f, 30.0f);
    Math_ApproachF(&arg0->world.pos.y, (arg0 + ((bitwise s32) arg0[5].projectedPos.y * 4))->unk_420->unk_28, 0.3f, 30.0f);
    Math_ApproachF(&arg0->world.pos.z, (arg0 + ((bitwise s32) arg0[5].projectedPos.y * 4))->unk_420->unk_2C, 0.3f, 30.0f);
    temp_v0_3 = arg0[5].projectedPos.x;
    if ((bitwise s32) temp_v0_3 > 0) {
        temp_s1 = (((bitwise s32) temp_v0_3 * 4) - (bitwise s32) temp_v0_3) * 4;
        temp_v1_3 = arg0 + temp_s1;
        phi_s2 = temp_v1_3 + 0x81C;
        phi_s3 = temp_v1_3 + 0x810;
        phi_s0_2 = arg0 + ((((bitwise s32) temp_v0_3 * 4) - (bitwise s32) temp_v0_3) * 2);
        phi_s1_2 = temp_s1;
        do {
            Math_Vec3f_Copy(phi_s2, phi_s3);
            temp_s1_2 = phi_s1_2 - 0xC;
            temp_s0_2 = phi_s0_2 - 6;
            temp_s0_2->unk_89C = (s16) phi_s0_2->unk_890;
            phi_s2 += -0xC;
            phi_s3 += -0xC;
            phi_s0_2 = temp_s0_2;
            phi_s1_2 = temp_s1_2;
    ...
    arg0->world.rot.y = Math_Vec3f_Yaw((Vec3f *) sp3C, (arg0 + ((bitwise s32) arg0[5].projectedPos.y * 4))->unk_420 + 0x24);
}

void func_80A46C88(Actor *arg0) {
    func_80A455C4((Actor *)3, 0);
    arg0->unk_44C = 0;
    arg0[2].child = func_80A46CC4;
}
...
void func_80A46CC4(Actor *arg0, ? arg1) {
    ...
    if ((bitwise f32) arg0[3].flags <= sp34) {
        arg0->unk_44C = (s16) (arg0->unk_44C + 1);
        if ((s32) arg0->unk_44C >= 2) {
            func_80A46DDC(arg0);
        }
    }
    Math_SmoothStepToS((s16 *) &arg0[2].draw, arg0->unk_3C6, 0xA, 0xA, (s16) 0xA);
...
void func_80A46E24(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk_3B2 == 0) {
        if ((func_801378B8((SkelAnime *) &arg0[1], 6.0f) != 0) && (arg0->unk_3BA == 0)) {
            sp60 = arg1->actorCtx.actorList[2].first;
            sp50 = (s32) arg0->unk_74A;
        ...
        if ((sp64 >= 8.0f) && (arg0->unk_3CA == 0)) {
            arg0->unk_3B2 = 3;
            arg0->unk_3CA = 1U;
        }
        if ((bitwise f32) arg0[3].flags <= sp64) {
            func_80A47000(arg0);
        }
    }
}
...
void func_80A47000(Actor *arg0) {
    ...
    arg0->world.rot.y += arg0->unk_3C0;
    arg0->flags &= -2;
    arg0[2].child = (Actor *) func_80A470D8;
}
...
void func_80A470D8(void *arg0, ? arg1) {
    ...
    if ((arg0->unk_3B6 == 0) || (arg0->unk_3B0 == 4)) {
        Math_ApproachZeroF(arg0 + 0x3D4, 0.3f, 0.01f);
        Math_SmoothStepToS(arg0 + 0x3C4, arg0->unk_3C6, 5, 0x32, (s16) 0);
    } else {
        Math_ApproachZeroF(arg0 + 0x3D4, 0.3f, 0.001f);
        Math_SmoothStepToS(arg0 + 0x3C4, arg0->unk_3C6, 0xA, 0x32, (s16) 0);
        phi_v0 = arg0;
        phi_v1 = 0;
        if (arg0->unk_740 > 0) {
            do {
                ...
                phi_v0 = temp_v0;
                phi_v1 = temp_v1;
            } while (temp_v1 < arg0->unk_740);
        }
    }
    Math_Vec3f_Copy(arg0 + 0x3F0, &D_801D15B0);
    if (arg0->unk_3D4 < 0.001f) {
        arg0->unk_3D4 = 0.0f;
        if ((arg0->unk_3CB == 6) && (arg0->unk_3B4 == 0)) {
            arg0->unk_3CB = 7U;
            ActorCutscene_Stop((s16) arg0->unk_38);
            arg0->unk_4 = (s32) (arg0->unk_4 & 0xFFEFFFFF);
        }
        if (arg0->unk_3CB != 6) {
            arg0->unk_3C2 = 0;
            if (arg0->unk_3B6 == 0) {
                arg0->unk_470->unk_8 = 0x1000202;
            }
            arg0->unk_3AC = func_80A462F8;
...
void func_80A47298(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_3B2 = 0x14;
    if ((arg0->unk_3B6 != 0) && ((s32) arg0->colChkInfo.health <= 0)) {
    ...
    arg0[5].projectedPos.x = 0.0f;
    arg0->unk_3C6 = 0;
    arg0[3].home.pos.x = 0.015f;
    if ((arg0->unk_752 != 0) && ((temp_v1 = arg0->unk_754, (temp_v1 == 0)) || (temp_v1 == 0x14))) {
        arg0->unk_3B2 = 0;
    }
    arg0->unk_3C0 = 0x4E20;
    if ((arg0->unk_752 != 0) && (arg0->unk_754 == 0xB)) {
        arg0->unk_3C0 = 0;
        arg0->unk_3B2 = 0;
    }
    arg0->unk_3B0 = 4;
    arg0[2].child = (Actor *) func_80A473B8;
}
...
void func_80A473B8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((s32) arg0->unk_752 < 0x32) && (arg0->unk_754 == 0xB)) {
    ...
    if (((s32) arg0->unk_752 != 0) && ((s32) arg0->unk_752 < 0x1E) && ((temp_v0 = arg0->unk_754, (temp_v0 == 0)) || (temp_v0 == 0x14))) {
        arg0->velocity.y = 30.0f;
        arg0->gravity = -3.0f;
        arg0->unk_752 = 0;
        arg0->unk_754 = 0;
    } else if ((arg0->unk_750 == 0) && (arg0->unk_3B6 != 0) && ((s32) arg0->colChkInfo.health <= 0)) {
        arg0->velocity.y = 30.0f;
        arg0->gravity = -3.0f;
        arg0->unk_750 = 1;
    }
    arg0->world.rot.y += arg0->unk_3C0;
    Math_SmoothStepToS((s16 *) &arg0[2].update, 0, 0xA, 0xBB8, (s16) 0x14);
    phi_v0 = arg0;
    phi_v1 = 0;
    if ((bitwise s32) arg0[5].projectedPos.x > 0) {
        do {
            temp_v1 = phi_v1 + 1;
            temp_v0_2 = phi_v0 + 6;
            temp_v0_2->unk_890 = (s16) (phi_v0->unk_896 + arg0->unk_3C0);
            phi_v0 = temp_v0_2;
            phi_v1 = temp_v1;
        } while (temp_v1 < (bitwise s32) arg0[5].projectedPos.x);
    }
    if ((arg0->unk_3B2 == 1) || ((arg0->velocity.y < 0.0f) && (arg0->world.pos.y < ((arg0 + (arg0->unk_748 * 4))->unk_420->unk_28 + 11.0f)))) {
        arg0->unk_3B2 = 0;
        temp_v0_3 = arg0->unk_3B2;
        arg0->velocity.y = 0.0f;
        arg0->gravity = 0.0f;
        arg0->unk_752 = temp_v0_3;
        arg0->unk_754 = temp_v0_3;
        if ((s32) arg0->colChkInfo.health <= 0) {
            if (arg0->unk_3B6 == 0) {
                temp_v0_4 = arg0->unk_74A;
                arg0->unk_3B6 = 1;
...
void func_80A477E8(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s1_2 = temp_s1;
    phi_s2 = 0;
    if ((temp_s1->unk_705 & 2) != 0) {
        temp_s1->unk_465 = (u8) (temp_s1->unk_465 & 0xFFFD);
        if ((s32) temp_s1->unk_3B0 >= 7) {
            ...
            if (temp_s0 != 2) {
                if (temp_s0 != 3) {
                    if (temp_s0 != 4) {
                        ...
                        temp_v0 = temp_s1->unk_754;
                        if (((temp_v0 != 0xB) && (temp_v0 != 0xA)) || (arg0 = temp_s1, (temp_s1->unk_752 == 0))) {
                            arg0 = temp_s1;
                    ...
                    temp_v0_2 = temp_s1->unk_74A;
                    if ((temp_v0_2 == 0) || (temp_v0_2 == 2)) {
                        temp_s1->unk_752 = 0x50;
                        temp_s1->unk_754 = 0xB;
                        temp_s1[5].uncullZoneDownward = 0.0f;
                        temp_s1[5].prevPos.x = 1.5f;
                    }
                    arg0 = temp_s1;
...
block_19:
                ...
                if (temp_s1->unk_74A == 1) {
                    temp_s1->unk_752 = 0x28;
                    temp_s1->unk_754 = 0;
                }
                phi_s2 = 1;
            }
...
block_22:
    temp_v0_3 = phi_s1_2[5].projectedPos.x;
    phi_s1_3 = phi_s1_2;
    if ((temp_v0_3 != 0) && (phi_s1_2->unk_3B6 != 1)) {
        phi_v1 = 0;
        if (temp_v0_3 > 0) {
            temp_s5 = &spBC;
            temp_s4 = &spB0;
            ...
            do {
                phi_v1_2 = phi_v1;
                phi_s1_5 = phi_s1_3;
                if ((gGameInfo->data[1682] != 0) || (((phi_s1_3[3].colChkInfo.displacement.x + (phi_v1 << 6))->unk_56 & 2) != 0)) {
                    phi_s1_3->unk_3B6 = 2;
                    temp_v0_4 = phi_s1_3 + (phi_v1 * 0xC);
                    phi_s1_3->unk_465 = (u8) (phi_s1_3->unk_465 & 0xFFFD);
                    arg0 = phi_s1_3;
                    temp_s3 = temp_v0_4 + 0x81C;
                    if (phi_f0 == temp_v0_4->unk_81C) {
                        if (phi_f0 != temp_v0_4->unk_824) {
                            arg0 = phi_s1_3;
                            goto block_31;
                        }
                    } else {
block_31:
                ...
                phi_s1_3 = phi_s1_5;
                phi_v1 = temp_v1;
            } while (temp_v1 < phi_s1_5[5].projectedPos.x);
        }
    }
}
...
void EnWiz_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_3B0 != 1) {
        ...
        SkelAnime_FrameUpdateMatrix(&this->unk_278);
    }
    Actor_SetHeight((Actor *) this, 60.0f);
    Actor_SetScale((Actor *) this, this->unk_3D4);
    func_80A477E8((Actor *) this, globalCtx);
    this->actionFunc(this, globalCtx);
    temp_v0 = this->unk_3B2;
    this->actor.shape.rot.y = this->actor.world.rot.y;
    if (temp_v0 != 0) {
        this->unk_3B2 = temp_v0 - 1;
    }
    temp_v0_2 = this->unk_3B4;
    if (temp_v0_2 != 0) {
        this->unk_3B4 = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk_752;
    if (temp_v0_3 != 0) {
        this->unk_752 = temp_v0_3 - 1;
    }
    this->unk_6F4.dim.radius = 0x23;
    this->unk_6F4.dim.height = 0x82;
    this->unk_6F4.dim.yShift = 0;
    if ((s32) this->unk_3B0 >= 7) {
        temp_s1 = &globalCtx->colChkCtx;
        CollisionCheck_SetAC(globalCtx, temp_s1, (Collider *) &this->unk_454);
        temp_a1 = &this->unk_6F4;
        sp28 = temp_a1;
    ...
    Math_ApproachF(&this->unk_3E4, this->unk_3F0, 0.3f, 0.002f);
    Math_ApproachF(&this->unk_3E8, this->unk_3F4, 0.3f, 0.002f);
    Math_ApproachF(&this->unk_3EC, this->unk_3F8, 0.3f, 0.002f);
    temp_v0_4 = this->unk_3B6;
    if (temp_v0_4 == 0) {
        this->unk_740 = 0;
        return;
    }
...
loop_15:
                temp_v0_5 = phi_v0 + 4;
                temp_v1 = phi_v1 + 0x18;
                temp_v1->unk_-18 = (unaligned s32) phi_a3->unk_0;
                temp_a0 = phi_a0 + 0x18;
                temp_a1_2 = phi_a1 + 0x18;
                temp_v1->unk_-14 = (u16) phi_a3->z;
                temp_a2 = phi_a2 + 0x18;
                temp_a0->unk_-18 = (unaligned s32) phi_t0->unk_0;
                temp_t1 = phi_t1 + 0x18;
                temp_a0->unk_-14 = (u16) phi_t0->unk_4;
                temp_t2 = phi_t2 + 0x18;
                temp_a1_2->unk_-18 = (unaligned s32) temp_t1->unk_-18;
                temp_a1_2->unk_-14 = (u16) temp_t1->unk_-14;
                temp_a2->unk_-18 = (unaligned s32) temp_t2->unk_-18;
                temp_a2->unk_-14 = (u16) temp_t2->unk_-14;
                phi_a3 += 0x18;
                phi_v1 = temp_v1;
                phi_t0 += 0x18;
                phi_a0 = temp_a0;
    ...
    if (this->unk_740 > 0) {
        do {
            phi_a3_2 = &this->unk_188;
            phi_v1_2 = phi_s1_2 + 0x8D0;
            phi_t0_2 = &this->unk_18E;
            phi_a0_2 = phi_s1_2 + 0x8D6;
            phi_t1_2 = &this->unk_194;
            phi_a1_2 = phi_s1_2 + 0x8DC;
            phi_t2_2 = &this->unk_19A;
            phi_a2_2 = phi_s1_2 + 0x8E2;
            phi_v0_2 = 0;
loop_20:
            temp_v0_6 = phi_v0_2 + 4;
            temp_v1_2 = phi_v1_2 + 0x18;
            temp_v1_2->unk_-18 = (unaligned s32) phi_a3_2->unk_0;
            temp_a0_2 = phi_a0_2 + 0x18;
            temp_v1_2->unk_-14 = (u16) phi_a3_2->z;
            temp_t0 = phi_t0_2 + 0x18;
            temp_a1_3 = phi_a1_2 + 0x18;
            temp_a0_2->unk_-18 = (unaligned s32) *phi_t0_2;
            temp_t1_2 = phi_t1_2 + 0x18;
            temp_a2_2 = phi_a2_2 + 0x18;
            temp_a0_2->unk_-14 = (u16) temp_t0->unk_-14;
            temp_t2_2 = phi_t2_2 + 0x18;
            temp_a1_3->unk_-18 = (unaligned s32) temp_t1_2->unk_-18;
            temp_a1_3->unk_-14 = (u16) temp_t1_2->unk_-14;
            temp_a2_2->unk_-18 = (unaligned s32) temp_t2_2->unk_-18;
            temp_a2_2->unk_-14 = (u16) temp_t2_2->unk_-14;
            phi_a3_2 += 0x18;
            phi_v1_2 = temp_v1_2;
            phi_t0_2 = temp_t0;
            phi_a0_2 = temp_a0_2;
...
void func_80A47FCC(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp24.unk_0 = D_80A48D68.unk_0;
    (&sp24)[1] = D_80A48D68.unk_4;
    (&sp24)[2] = D_80A48D68.unk_8;
    if (arg1 == 9) {
        sp24 = 0x45E42000;
        sp28 = -1500.0f;
        if (arg4->unk_3B0 != 9) {
    ...
    if ((arg1 == 1) || (arg1 == 2) || (arg1 == 3) || (arg1 == 4) || (arg1 == 6) || (arg1 == 7) || (arg1 == 0xA) || (arg1 == 0xB) || (arg1 == 0xC) || (arg1 == 0xF) || (arg1 == 0x12) || (arg1 == 0xD)) {
        SysMatrix_GetStateTranslation(arg4 + (arg4->unk_7F0 * 0xC) + 0x760);
        arg4->unk_7F0 = (s16) (arg4->unk_7F0 + 1);
        if ((s32) arg4->unk_7F0 >= 0xC) {
            arg4->unk_7F0 = 0;
        }
    }
}
...
void func_80A48138(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp4C.unk_0 = D_80A48D74.unk_0;
    (&sp4C)[1] = D_80A48D74.unk_4;
    (&sp4C)[2] = D_80A48D74.unk_8;
    if (arg4->unk_3B0 != 6) {
        if (arg1 == 9) {
            sp4C = 0x45E42000;
            sp50 = -1500.0f;
...
void EnWiz_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk_3B0 == 6) || (this->unk_3C2 != 0xFF)) {
        ...
        temp_s5->polyXlu.p = &temp_v1_3[1];
        temp_v1_3->words.w1 = 0;
        temp_v1_3->words.w0 = 0xE7000000;
        temp_v1_4 = temp_s5->polyXlu.p;
        temp_s5->polyXlu.p = &temp_v1_4[1];
        temp_v1_4->words.w0 = 0xFB000000;
        temp_v1_4->words.w1 = this->unk_3C2 & 0xFF;
        temp_s5->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, NULL, func_80A48138, (Actor *) this, temp_s5->polyXlu.p);
    } else {
        ...
        temp_v1_2->words.w1 = (this->unk_3C2 & 0xFF) | ~0xFF;
        SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, NULL, func_80A47FCC, (Actor *) this);
    }
    temp_v1_5 = this->unk_752;
    if (temp_v1_5 != 0) {
        temp_f6 = (f32) temp_v1_5;
        temp_v0 = this->unk_754;
        if ((temp_v0 == 0xB) || (temp_v0 == 0xA)) {
            this->unk_758 += 0.3f;
            if (this->unk_758 > 0.5f) {
                this->unk_758 = 0.5f;
            }
            spBC = temp_f6 * 0.05f;
            Math_ApproachF(&this->unk_75C, this->unk_758, 0.1f, 0.04f);
        } else {
            this->unk_758 = 0.8f;
            this->unk_75C = 0.8f;
        }
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk_760, 0xC, this->unk_758, this->unk_75C, temp_f6 * 0.05f, (u8) (s32) this->unk_754);
    }
    if (this->unk_740 > 0) {
        SysMatrix_StatePush();
        phi_v0 = (s32) this->unk_742;
        phi_s2 = this;
        if (this->unk_3B6 == 1) {
            phi_v0 = 0xA;
        }
        ...
        if (phi_v0 > 0) {
            ...
            do {
                ...
                func_8012C2DC(globalCtx->state.gfxCtx);
                temp_f12 = phi_s2->unk_81C;
                if (temp_f12 != 0.0f) {
                    temp_f0 = phi_s2->unk_824;
                    if (temp_f0 != 0.0f) {
                        temp_s0 = this + (phi_s3 * 6);
                        sp5C = this + (phi_s3 * 0x78) + 0x8D0;
                        sp58 = this + (phi_s3 * 2);
                        SysMatrix_InsertTranslation(temp_f12, phi_s2->unk_820 + 10.0f, temp_f0, 0);
                        temp_f12_2 = this->unk_3D4;
                        Matrix_Scale(temp_f12_2, temp_f12_2, temp_f12_2, 1);
                        Matrix_RotateY(temp_s0->unk_896, 1U);
                        SysMatrix_InsertXRotation_s(temp_s0->unk_894, 1);
                        SysMatrix_InsertZRotation_s(temp_s0->unk_898, 1);
                        Scene_SetRenderModeXlu(globalCtx, 1, 2U);
                        temp_v1_6 = temp_s5->polyXlu.p;
                        temp_s5->polyXlu.p = &temp_v1_6[1];
                        temp_v1_6->words.w1 = 0;
                        temp_v1_6->words.w0 = 0xE7000000;
                        temp_v1_7 = temp_s5->polyXlu.p;
                        temp_s5->polyXlu.p = &temp_v1_7[1];
                        temp_v1_7->words.w0 = 0xFB000000;
                        temp_v1_7->words.w1 = sp58->unk_7F2 & 0xFF;
                        temp_s5->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk_278.skeleton, sp5C, (s32) this->unk_278.dListCount, NULL, NULL, (Actor *) this, temp_s5->polyXlu.p);
                        (&this->unk_454.elements[phi_s3])[1].dim.worldSphere.center.x = (s16) (s32) phi_s2->unk_81C;
                        (&this->unk_454.elements[phi_s3])[1].dim.worldSphere.center.y = (s16) (s32) (phi_s2->unk_820 + 50.0f);
                        (&this->unk_454.elements[phi_s3])[1].dim.worldSphere.center.z = (s16) (s32) phi_s2->unk_824;
                        temp_v1_8 = this->unk_454.elements;
                        (&temp_v1_8[phi_s3])[1].dim.worldSphere.radius = temp_v1_8->dim.modelSphere.radius;
                        temp_v1_9 = this->unk_454.elements;
                        (&temp_v1_9[phi_s3])[1].dim.scale = temp_v1_9->dim.scale;
                    }
                }
                temp_s3 = phi_s3 + 1;
                phi_s2 += 0xC;
