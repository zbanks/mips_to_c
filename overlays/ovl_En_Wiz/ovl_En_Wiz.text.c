...
static ColliderJntSphElementInit D_80A48B50 = {
...
static ?32 D_80A48DAC = 0x45E42000;                 /* const */
static ?32 D_80A48DB4 = 0x45A5A000;                 /* const */
static ?32 D_80A48DB8 = 0x45E42000;                 /* const */
static ?32 D_80A48DC0 = 0x45A5A000;                 /* const */
...
typedef struct EnWiz {
    ...
    /* 0x0278 */ SkelAnime unk278;                  /* inferred */
    /* 0x02BC */ Vec3s unk2BC;                      /* inferred */
    /* 0x02C2 */ ? unk2C2;                          /* inferred */
    /* 0x02C3 */ char pad2C3[0x5];
    /* 0x02C8 */ ? unk2C8;                          /* inferred */
    /* 0x02C9 */ char pad2C9[0x5];
    /* 0x02CE */ ? unk2CE;                          /* inferred */
    /* 0x02CF */ char pad2CF[0x65];
    /* 0x0334 */ Vec3s unk334;                      /* inferred */
    /* 0x033A */ char pad33A[0x72];                 /* maybe part of unk334[20]? */
    /* 0x03AC */ void (*actionFunc)(EnWiz *, GlobalContext *);
    ...
    /* 0x03BA */ char pad3BA[0x8];                  /* maybe part of unk3B8[5]? */
    /* 0x03C2 */ s16 unk3C2;                        /* inferred */
    /* 0x03C4 */ s16 unk3C4;                        /* inferred */
    /* 0x03C6 */ char pad3C6[0xE];                  /* maybe part of unk3C4[8]? */
    ...
    /* 0x03E8 */ f32 unk3E8;                        /* inferred */
    /* 0x03EC */ f32 unk3EC;                        /* inferred */
    /* 0x03F0 */ f32 unk3F0;                        /* inferred */
    /* 0x03F4 */ f32 unk3F4;                        /* inferred */
    ...
    /* 0x0420 */ char pad420[0x30];                 /* maybe part of unk41C[13]? */
    /* 0x0450 */ f32 unk450;                        /* inferred */
    /* 0x0454 */ ColliderJntSph unk454;             /* inferred */
    /* 0x0474 */ ColliderJntSphElement unk474;      /* inferred */
    /* 0x04B4 */ char pad4B4[0x240];                /* maybe part of unk474[10]? */
    /* 0x06F4 */ ColliderCylinder unk6F4;           /* inferred */
    /* 0x0740 */ s32 unk740;                        /* inferred */
    /* 0x0742 */ s16 unk742;                        /* overlap; inferred */
    /* 0x0744 */ char pad744[0x4];                  /* maybe part of unk742[3]? */
    /* 0x0748 */ s16 unk748;                        /* inferred */
    /* 0x074A */ s16 unk74A;                        /* inferred */
    /* 0x074C */ s16 unk74C;                        /* inferred */
    /* 0x074E */ s16 unk74E;                        /* inferred */
    /* 0x0750 */ char pad750[0x2];                  /* maybe part of unk74E[2]? */
    /* 0x0752 */ s16 unk752;                        /* inferred */
    /* 0x0754 */ s16 unk754;                        /* inferred */
    /* 0x0756 */ char pad756[0x2];                  /* maybe part of unk754[2]? */
    /* 0x0758 */ f32 unk758;                        /* inferred */
    /* 0x075C */ f32 unk75C;                        /* inferred */
    /* 0x0760 */ Vec3f unk760;                      /* inferred */
    /* 0x076C */ char pad76C[0xB0];
    /* 0x081C */ f32 unk81C;                        /* inferred */
    /* 0x0820 */ f32 unk820;                        /* inferred */
    /* 0x0824 */ f32 unk824;                        /* inferred */
    /* 0x0828 */ char pad828[0x558];                /* maybe part of unk824[343]? */
} EnWiz;                                            /* size 0xD80 */
...
void EnWiz_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk454, &this->actor, &D_80A48CB8, &this->unk474);
    Collider_InitAndSetCylinder(globalCtx, &this->unk6F4, &this->actor, &D_80A48CC8);
...
void func_80A456A0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk3CB < 6) {
        ...
        case 1:
            ...
            Math_Vec3f_Copy(&sp4C, temp_a1);
            temp_f10 = sp58.x + (Math_SinS(arg0->unk3C8) * 200.0f);
            sp58.y += 100.0f;
            sp58.x = temp_f10;
            temp_f16 = sp58.z + (Math_CosS(arg0->unk3C8) * 200.0f);
            sp4C.y += 80.0f;
            sp58.z = temp_f16;
            Math_ApproachF(&temp_s0->eye.x, sp58.x, 0.3f, 30.0f);
            Math_ApproachF(&temp_s0->eye.z, sp58.z, 0.3f, 30.0f);
            Math_ApproachF(&temp_s0->at.x, sp4C.x, 0.3f, 30.0f);
            Math_ApproachF(&temp_s0->at.z, sp4C.z, 0.3f, 30.0f);
            temp_s0->eye.y = sp58.y;
            temp_s0->at.y = sp4C.y;
            if ((fabsf(temp_s0->eye.x - sp58.x) < 2.0f) && (fabsf(temp_s0->eye.y - sp58.y) < 2.0f) && (fabsf(temp_s0->eye.z - sp58.z) < 2.0f) && (fabsf(temp_s0->at.x - sp4C.x) < 2.0f) && (fabsf(temp_s0->at.y - sp4C.y) < 2.0f) && (fabsf(temp_s0->at.z - sp4C.z) < 2.0f)) {
                temp_a1_2 = &arg1->actorCtx.actorList[2].first->world;
                sp34 = temp_a1_2;
                temp_v0 = Math_Vec3f_Yaw(sp38, &temp_a1_2->pos);
                ...
                if (arg0->unk740 > 0) {
                    ...
                    do {
                        sp44 = phi_v1;
                        sp2C = phi_a2;
                        phi_a2->unk896 = Math_Vec3f_Yaw(phi_s0, &sp34->pos);
                        temp_v1_2 = phi_v1 + 1;
                        phi_v1 = temp_v1_2;
                        phi_a2 += 6;
                        phi_s0 += 0xC;
        ...
        case 3:
            ...
            sp38 = &temp_a1_3->pos;
            Math_Vec3f_Copy(&sp58, &temp_a1_3->pos);
            Math_Vec3f_Copy(&sp4C, &temp_a1_3->pos);
            temp_f8 = sp58.x + (Math_SinS(arg0->world.rot.y) * 160.0f);
            sp58.y += 70.0f;
            sp58.x = temp_f8;
        ...
        case 5:
            ...
            sp38 = &temp_a1_4->pos;
            Math_Vec3f_Copy(&sp58, &temp_a1_4->pos);
            Math_Vec3f_Copy(&sp4C, &temp_a1_4->pos);
            temp_f4 = sp58.x + (Math_SinS(arg0->unk3C8) * 200.0f);
            sp58.y += 100.0f;
            sp58.x = temp_f4;
            temp_f10_2 = sp58.z + (Math_CosS(arg0->unk3C8) * 200.0f);
            sp4C.y += 80.0f;
            sp58.z = temp_f10_2;
            Math_ApproachF(&temp_s0->eye.x, sp58.x, 0.3f, 30.0f);
            Math_ApproachF(&temp_s0->eye.z, sp58.z, 0.3f, 30.0f);
...
void func_80A46280(EnWiz *arg0, GlobalContext *arg1) {
    if (ActorCutscene_GetCanPlayNext((s16) arg0->actor.cutscene) != 0) {
        ActorCutscene_StartAndSetFlag((s16) arg0->actor.cutscene, &arg0->actor);
...
void func_80A46414(Actor *arg0, void *arg1) {
    ...
    sp3C.x = D_80A48D54.unk0;
    sp3C.y = D_80A48D54.unk4;
    sp3C.z = D_80A48D54.unk8;
    sp38 = arg1->unk1CCC;
    func_80A456A0(arg0);
...
block_12:
        ...
        if (!(arg0->unk3D4 < 0.0138f)) {
            ...
            Math_Vec3f_Copy(arg0 + 0x3F0, &sp3C);
...
block_10:
    temp_a1 = &arg0->world;
    sp3C = temp_a1;
    Math_Vec3f_Copy(arg0 + 0x81C, &temp_a1->pos);
    arg0->unk896 = (s16) arg0->world.rot.y;
    Math_ApproachF(&sp3C->pos.x, (arg0 + (arg0->unk744 * 4))->unk420->unk24, 0.3f, 30.0f);
    ...
    arg0->world.rot.y = Math_Vec3f_Yaw(&sp3C->pos, (arg0 + (arg0->unk744 * 4))->unk420 + 0x24);
}
...
void func_80A46E24(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk3B2 == 0) {
        if ((func_801378B8((SkelAnime *) (arg0 + 0x144), 6.0f) != 0) && (arg0->unk3BA == 0)) {
            ...
            Math_Vec3f_Copy(&sp54, &arg0->world.pos);
            temp_f16 = sp54.x + (Math_SinS(arg0->world.rot.y) * 40.0f);
            sp54.y += 60.0f;
            sp54.x = temp_f16;
            sp54.z += Math_CosS(arg0->world.rot.y) * 40.0f;
            if (sp50 == 2) {
                sp50 = 0;
            }
            temp_a1 = sp60 + 0x24;
            sp44 = temp_a1;
            sp48 = Math_Vec3f_Pitch(&sp54, temp_a1);
            Actor_SpawnAsChild(arg1 + 0x1CA0, arg0, arg1, 0x15F, sp54.x, sp54.y, sp54.z, (s16) (s32) sp48, (s16) Math_Vec3f_Yaw(&sp54, temp_a1), (s16) 0, sp50 * 4);
            arg0->unk3BA = 1;
...
void func_80A476C8(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk3C2 < 0x1E) {
        ...
        Audio_PlaySoundAtPosition(arg1, &arg0->world.pos, 0x32, 0x3878U);
...
block_31:
                        ...
                        do {
                            ...
                            Math_Vec3f_Copy(temp_s2, temp_s3);
                            phi_s0 = 1;
                            phi_s0_2 = 1;
                            if (Rand_ZeroOne() < 0.5f) {
                                phi_s0 = -1;
                            }
                            spA4.x += (f32) Rand_S16Offset(0x14, 0x14) * (f32) phi_s0;
                            spA4.y += 70.0f + randPlusMinusPoint5Scaled(30.0f);
                            if (Rand_ZeroOne() < 0.5f) {
                                phi_s0_2 = -1;
                            }
                            spA4.z += (f32) Rand_S16Offset(0x14, 0x14) * (f32) phi_s0_2;
                            func_800B0DE0(arg1, temp_s2, (Vec3f *) temp_s4, (Vec3f *) temp_s5, &D_80A48D60, &D_80A48D64, (s16) Rand_S16Offset(0x15E, 0x64), (s16) (s32) temp_f20);
...
void EnWiz_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_SetScale(&this->actor, this->unk3D4);
    func_80A477E8(&this->actor, globalCtx);
    ...
    if ((s32) this->unk3B0 >= 7) {
        ...
        CollisionCheck_SetAC(globalCtx, temp_s1, &this->unk454.base);
        temp_a1 = &this->unk6F4;
        sp28 = temp_a1;
        Collider_UpdateCylinder(&this->actor, temp_a1);
        CollisionCheck_SetAC(globalCtx, temp_s1, &sp28->base);
        CollisionCheck_SetOC(globalCtx, temp_s1, &sp28->base);
    }
...
void func_80A48138(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg4->unk3B0 != 6) {
        ...
        if (arg4->unk3B2 == 0) {
            SysMatrix_InsertTranslation(0.0f, 0.0f, 0.0f, 1);
            SysMatrix_MultiplyVector3fByState((Vec3f *) &sp4C, &sp38);
            sp38.x += randPlusMinusPoint5Scaled(4.0f);
            sp38.y += randPlusMinusPoint5Scaled(7.0f);
            sp38.z += randPlusMinusPoint5Scaled(5.0f);
            func_800B3030(arg0, &sp38, &D_801D15B0, &D_801D15B0, (s16) (s32) ((Rand_ZeroFloat(1.0f) * 50.0f) + 70.0f), (s16) 0xA, 1);
            Audio_PlaySoundAtPosition(arg0, &sp38, 0xA, 0x3878U);
        }
...
void EnWiz_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk3B0 == 6) || (this->unk3C2 != 0xFF)) {
        ...
        temp_s5->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80A48138, &this->actor, temp_s5->polyXlu.p);
    } else {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80A47FCC, &this->actor);
    }
    ...
    if (temp_v1_5 != 0) {
        ...
        func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk760, 0xC, this->unk758, this->unk75C, temp_f6 * 0.05f, (u8) (s32) this->unk754);
    }
    if (this->unk740 > 0) {
        SysMatrix_StatePush();
            ...
            do {
                ...
                if (temp_f12 != 0.0f) {
                    ...
                    if (temp_f0 != 0.0f) {
                        ...
                        temp_s5->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk278.skeleton, sp5C, (s32) this->unk278.dListCount, NULL, NULL, &this->actor, temp_s5->polyXlu.p);
