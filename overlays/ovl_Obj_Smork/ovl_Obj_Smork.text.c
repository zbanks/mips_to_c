typedef struct ObjSmork {
    ...
    /* 0x148 */ char pad148[0x7C];
    /* 0x1C4 */ s8 unk1C4;                          /* inferred */
    /* 0x1C5 */ char pad1C5[0x1];
...
struct _mips2c_stack_func_80A3D9C4 {
    ...
    /* 0x48 */ char pad48[0xE];                     /* maybe part of sp44[4]? */
...
void ObjSmork_Init(ObjSmork *this, GlobalContext *globalCtx) {
    ObjSmork *this = (ObjSmork *) thisx;
    Lib_MemCpy((void *) &this->unk148, &D_80A3E290, 0x70U);
    this->unk1C6 = Rand_S16Offset(0, 0x3B);
    this->unk1C4 = 0;
}

void ObjSmork_Destroy(ObjSmork *this, GlobalContext *globalCtx) {
    ObjSmork *this = (ObjSmork *) thisx;

}

void ObjSmork_Update(ObjSmork *this, GlobalContext *globalCtx) {
    ObjSmork *this = (ObjSmork *) thisx;
    func_80A3D940();
}

void ObjSmork_Draw(ObjSmork *this, GlobalContext *globalCtx) {
    ObjSmork *this = (ObjSmork *) thisx;
    func_80A3D9C4();
}
