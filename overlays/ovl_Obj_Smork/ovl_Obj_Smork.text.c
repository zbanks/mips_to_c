...
struct _mips2c_stack_ObjSmork_Destroy {};           /* size 0x0 */

struct _mips2c_stack_ObjSmork_Draw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjSmork_Init {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjSmork_Update {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A3D680 {};              /* size 0x0 */

struct _mips2c_stack_func_80A3D940 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A3D9C4 {
...
static u8 D_80A3E29F[16] = {0, 0, 0, 8, 0xD5, 2, 0x5B, 0, 0, 2, 0, 3, 0xCC, 0x4D, 0x44, 0x34};
static u8 D_80A3E2AF[16] = {0xFF, 0, 0, 0x1B, 0xAC, 1, 0x2D, 0, 0, 2, 0, 0xE9, 0xD0, 0, 0, 0};
static u8 D_80A3E2BF[65] = {
    0,
    0xFB,
    0xAD,
    8,
...
void func_80A3D940(void *arg0) {
    ...
    temp_v0 = func_80A3D680(arg0->unk_1C6);
...
void func_80A3D9C4(void *arg0, void *arg1) {
    ...
    arg0->unk_1BC = (f32) (arg0->unk_1BC + 1.8f);
    temp_a0 = 3 * 0x10;
    arg0->unk_1C0 = (f32) (arg0->unk_1C0 + 0.6f);
    ...
    arg0->unk_157 = (s8) (u32) ((f32) *D_80A3E29F * arg0->unk_1B8);
    arg0->unk_167 = (s8) (u32) ((f32) *D_80A3E2AF * arg0->unk_1B8);
    arg0->unk_177 = (s8) (u32) ((f32) *D_80A3E2BF * arg0->unk_1B8);
    ...
    if (arg0->unk_1B8 > 0.0f) {
        ...
        arg0->unk_BE = (s16) (func_800DFCDC((arg1 + (arg1->unk_810 * 4))->unk_800) + 0x8000);
        ...
        sp44 = temp_v0_2;
        sp44->words.w1 = Gfx_TwoTexScroll(arg1->unk_0, 0, 0U, (u32) sp57, 0x20, 0x20, 1, 0U, (u32) sp56, 0x20, 0x20);
...
void ObjSmork_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Lib_MemCpy((void *) &this->unk_148, &D_80A3E290, 0x70U);
