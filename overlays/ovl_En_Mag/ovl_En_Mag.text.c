...
struct _mips2c_stack_func_8096CDC8 {
    ...
    /* 0x04 */ char pad4[0x8];                      /* maybe part of sp0[3]? */
    /* 0x0C */ s32 spC;                             /* inferred */
    /* 0x10 */ char pad10[0x28];                    /* maybe part of spC[11]? */
    /* 0x38 */ void *sp38;                          /* inferred */
    /* 0x3C */ char pad3C[0x2C];
};                                                  /* size = 0x68 */
...
struct _mips2c_stack_func_8096D230 {
    ...
    /* 0x4C */ char pad4C[0x70];                    /* maybe part of sp48[29]? */
...
struct _mips2c_stack_func_8096D74C {
    ...
    /* 0x078 */ char pad78[0x140];                  /* maybe part of sp74[81]? */
    /* 0x1B8 */ s32 sp1B8;                          /* inferred */
    /* 0x1BC */ char pad1BC[0xC];                   /* maybe part of sp1B8[4]? */
    /* 0x1C8 */ Gfx *sp1C8;                         /* inferred */
    /* 0x1CC */ char pad1CC[0xC];
};                                                  /* size = 0x1D8 */
