typedef struct EnFu {
    ...
    /* 0x1DE */ char pad1DE[0x78];                  /* maybe part of unk1D8[21]? */
    /* 0x256 */ Vec3s unk256;                       /* inferred */
    /* 0x25C */ char pad25C[0x78];                  /* maybe part of unk256[21]? */
    /* 0x2D4 */ Actor *unk2D4;                      /* inferred */
    /* 0x2D8 */ ? unk2D8;                           /* inferred */
    /* 0x2D8 */ char pad2D8[0x264];
    /* 0x53C */ s16 unk53C;                         /* inferred */
    /* 0x53E */ s16 unk53E;                         /* inferred */
    /* 0x540 */ s16 unk540;                         /* inferred */
    /* 0x542 */ char pad542[0x4];                   /* maybe part of unk540[3]? */
    /* 0x546 */ s16 unk546;                         /* inferred */
    /* 0x548 */ char pad548[0x2];
    /* 0x54A */ s16 unk54A;                         /* inferred */
    /* 0x54C */ s16 unk54C;                         /* inferred */
    /* 0x54E */ s16 unk54E;                         /* inferred */
    /* 0x550 */ s16 unk550;                         /* inferred */
    /* 0x552 */ char pad552[0x2];
} EnFu;                                             /* size = 0x554 */
...
void func_809616E0(EnFu *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk520 > 0) {
        ...
        do {
            ...
            if (arg0->unk546 == 1) {
                sp88.unk0 = (s32) D_80964C04.unk0;
                sp88.unk4 = (s32) D_80964C04.unk4;
                sp88.unk8 = (s32) D_80964C04.unk8;
                temp_a1 = temp_fp;
                sp7C.unk0 = (s32) D_80964C10.unk0;
                sp7C.unk4 = (s32) D_80964C10.unk4;
                sp7C.unk8 = (s32) D_80964C10.unk8;
                sp78 = D_80964C1C;
                sp74 = D_80964C20;
...
void func_80961F38(GlobalContext *arg0, Vec3f *arg1, s16 *arg2, s16 arg3, s16 arg4, s16 arg5) {
    ...
    sp34.unk0 = (s32) temp_v0->focus.pos.x;
    sp34.unk4 = (s32) temp_v0->focus.pos.y;
    sp34.unk8 = (s32) temp_v0->focus.pos.z;
...
void func_8096209C(EnFu *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v1 != 0) && ((temp_v0 & 2) != 0)) {
        sp34.unk0 = (s32) D_80964B24.unk0;
        sp34.unk4 = (s32) D_80964B24.unk4;
        sp34.unk8 = (s32) D_80964B24.unk8;
    } else if (temp_v1 != 0) {
        sp34.unk0 = (s32) D_80964B0C.unk0;
        sp34.unk4 = (s32) D_80964B0C.unk4;
        sp34.unk8 = (s32) D_80964B0C.unk8;
    } else if ((temp_v0 & 2) != 0) {
        sp34.unk0 = (s32) D_80964B18.unk0;
        sp34.unk4 = (s32) D_80964B18.unk4;
        sp34.unk8 = (s32) D_80964B18.unk8;
    } else {
        sp34.unk0 = (s32) D_80964B24.unk0;
        sp34.unk4 = (s32) D_80964B24.unk4;
        sp34.unk8 = (s32) D_80964B24.unk8;
...
void EnFu_Draw(EnFu *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_809643FC, func_8096450C, (Actor *) this);
}
...
void func_809647EC(GlobalContext *arg0, void *arg1, s32 arg2) {
    ...
    sp44.unk0 = (s32) D_80964C58.unk0;
    sp44.unk4 = (s32) D_80964C58.unk4;
    sp44.unk8 = (s32) D_80964C58.unk8;
