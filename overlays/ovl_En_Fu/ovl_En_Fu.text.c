...
s32 func_80963810(GlobalContext *arg0, s32 arg1, f32 arg2, f32 arg3); /* static */
...
static ActorAnimationEntry D_80964B30 = {
...
typedef struct EnFu {
    ...
    /* 0x01D4 */ void (*actionFunc)(EnFu *, GlobalContext *);
    /* 0x01D8 */ Vec3s unk1D8;                      /* inferred */
    /* 0x01DE */ char pad1DE[0x78];                 /* maybe part of unk1D8[21]? */
    /* 0x0256 */ Vec3s unk256;                      /* inferred */
    /* 0x025C */ char pad25C[0x78];                 /* maybe part of unk256[21]? */
    /* 0x02D4 */ Actor *unk2D4;                     /* inferred */
    /* 0x02D8 */ ? unk2D8;                          /* inferred */
    /* 0x02D9 */ char pad2D9[0x247];
    /* 0x0520 */ s32 unk520;                        /* inferred */
    /* 0x0524 */ char pad524[0x14];                 /* maybe part of unk520[6]? */
    /* 0x0538 */ void *unk538;                      /* inferred */
    /* 0x053C */ s16 unk53C;                        /* inferred */
    /* 0x053E */ s16 unk53E;                        /* inferred */
    /* 0x0540 */ s16 unk540;                        /* inferred */
    /* 0x0542 */ s16 unk542;                        /* inferred */
    /* 0x0544 */ s16 unk544;                        /* inferred */
    /* 0x0546 */ s16 unk546;                        /* inferred */
    /* 0x0548 */ s16 unk548;                        /* inferred */
    /* 0x054A */ s16 unk54A;                        /* inferred */
    /* 0x054C */ s16 unk54C;                        /* inferred */
    /* 0x054E */ s16 unk54E;                        /* inferred */
    /* 0x0550 */ s16 unk550;                        /* inferred */
    /* 0x0552 */ char pad552[0x2];                  /* maybe part of unk550[2]? */
} EnFu;                                             /* size 0x554 */
...
void func_809616E0(EnFu *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk520 > 0) {
        spA0 = phi_a2;
        do {
            temp_v0 = arg0->unk538 + phi_s1;
            temp_f20 = arg0->actor.world.pos.x - (f32) temp_v0->unk0;
            temp_f22 = arg0->actor.world.pos.z - (f32) temp_v0->unk4;
            if ((spA0 == 0) || ((phi_s2 & 1) != 0)) {
                temp_v0_2 = arg0->unk538 + phi_s1;
                Actor_Spawn(arg1 + 0x1CA0, arg1, arg0->unk544, (f32) temp_v0_2->unk0, (f32) temp_v0_2->unk2, (f32) temp_v0_2->unk4, (s16) 0, (s16) (s32) Math_FAtan2F(temp_f22, temp_f20), (s16) 0, (s16) phi_s2);
                arg0->unk54C += 1;
            }
            if (arg0->unk546 == 1) {
                sp88.x = D_80964C04.unk0;
                sp88.y = D_80964C04.unk4;
                sp88.z = D_80964C04.unk8;
                temp_a1 = temp_fp;
                sp7C.x = D_80964C10.unk0;
                sp7C.y = D_80964C10.unk4;
                sp7C.z = D_80964C10.unk8;
                sp78 = D_80964C1C;
                sp74 = D_80964C20;
                sp94 = (f32) *(arg0->unk538 + phi_s1);
                sp98 = (f32) (arg0->unk538 + phi_s1)->unk2;
                sp9C = (f32) (arg0->unk538 + phi_s1)->unk4;
                func_800B0EB0(arg1, (Vec3f *) temp_a1, &sp88, &sp7C, &sp78, &sp74, (s16) 0x64, (s16) 0x96, (s16) 0xA);
                sp94 -= 0.1f * temp_f20;
                sp9C -= 0.1f * temp_f22;
                func_800B3030(arg1, (Vec3f *) temp_fp, &sp88, &sp7C, (s16) 0x64, (s16) 0, 3);
            }
            temp_s2 = phi_s2 + 1;
            phi_s1 += 6;
            phi_s2 = temp_s2;
        } while (temp_s2 < arg0->unk520);
    }
}
...
void func_809619D0(EnFu *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v1 > 0) {
        do {
            temp_v0 = phi_v0 + 1;
            temp_a2_2 = arg1->setupPathList + (phi_a2_2->unk1 * 8);
            phi_v0 = temp_v0;
            phi_a2 = temp_a2_2;
            phi_a2_2 = temp_a2_2;
        } while (temp_v0 < (s32) temp_v1);
    }
    arg0->unk520 = (s32) phi_a2->unk0;
    arg0 = arg0;
    arg0->unk538 = Lib_SegmentedToVirtual(phi_a2->unk4);
...
loop_1:
    ...
    if (phi_v0_2 != 0) {
        ...
        SkelAnime_InitSV(globalCtx, &this->unk190, &D_0600B2B0, &D_06001F74, &this->unk1D8, &this->unk256, 0x15);
        temp_a1 = &this->unk144;
        sp38 = temp_a1;
        Collider_InitCylinder(globalCtx, temp_a1);
        Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80964BD8);
        this->actor.colChkInfo.mass = 0xFF;
        Actor_SetScale(&this->actor, 0.01f);
        this->actor.flags &= -2;
        this->actor.shape.rot.y += 0x4000;
        this->actor.gravity = -0.2f;
        this->unk30 = (unaligned s32) sp3C->unk0;
        this->unk546 = 0;
        this->unk54A = 1;
        this->unk54C = 0;
        this->unk53C = 0;
        ...
        if (((s32) gSaveContext.day % 5) == 2) {
            ...
            sp40.unk0 = temp_t3->home.pos.x;
            sp40.unk4 = (f32) temp_t3->home.pos.y;
            sp40.unk8 = (f32) temp_t3->home.pos.z;
            this->unk2D4 = Actor_Spawn(&globalCtx->actorCtx, globalCtx, 0x1BC, sp40, sp44, sp48, (s16) 0, (s16) 0, (s16) 0, (s16) 0);
            return;
        }
        this->unk2D4 = NULL;
...
s32 func_80961D10(Actor *arg0) {
    if (((arg0->unk155 & 2) != 0) && (arg0->unk542 == 0)) {
        return 1;
    }
    if (((arg0->unk156 & 2) != 0) && (arg0->unk542 == 2) && (*arg0->unk150 == 0x6A)) {
        return 1;
    }
    return 0;
}
...
void func_80961F38(GlobalContext *arg0, Vec3f *arg1, s16 *arg2, s16 arg3, s16 arg4, s16 arg5) {
    ...
    sp34.x = temp_v0->focus.pos.x;
    sp34.y = temp_v0->focus.pos.y;
    sp34.z = temp_v0->focus.pos.z;
    temp_v1 = Math_Vec3f_Yaw(arg1, &sp34) - arg3;
    temp_a0 = temp_v1;
    sp40 = temp_v1;
    if ((s32) temp_a0 < 0) {
        phi_v1 = -(s32) temp_a0;
    ...
    if ((s32) arg5 < phi_v1) {
        ...
        Math_SmoothStepToS(arg2 + 2, 0, 6, 0x1838, (s16) 0x64);
    } else {
        Math_SmoothStepToS(arg2, Math_Vec3f_Pitch(arg1, &sp34), 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS(arg2 + 2, sp40, 6, 0x1838, (s16) 0x64);
    }
    temp_v0_2 = arg2->unk2;
    if ((s32) temp_v0_2 < 0) {
    ...
    if ((s32) arg4 < phi_v1_2) {
        if ((s32) temp_v0_2 > 0) {
            ...
            arg2->unk2 = (s16) -(s32) arg4;
        }
    }
    Math_SmoothStepToS(arg2 + 4, 0, 6, 0x7D0, (s16) 0x64);
}
...
void func_8096209C(EnFu *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v1 != 0) && ((temp_v0 & 2) != 0)) {
        sp34.x = D_80964B24.unk0;
        sp34.y = D_80964B24.unk4;
        sp34.z = D_80964B24.unk8;
    } else if (temp_v1 != 0) {
        sp34.x = D_80964B0C.unk0;
        sp34.y = D_80964B0C.unk4;
        sp34.z = D_80964B0C.unk8;
    } else if ((temp_v0 & 2) != 0) {
        sp34.x = D_80964B18.unk0;
        sp34.y = D_80964B18.unk4;
        sp34.z = D_80964B18.unk8;
    } else {
        sp34.x = D_80964B24.unk0;
        sp34.y = D_80964B24.unk4;
        sp34.z = D_80964B24.unk8;
    ...
    SysMatrix_MultiplyVector3fByState(&sp34, arg0 + 0x3C);
    SysMatrix_StatePop();
...
void func_80962340(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800B84D0(arg0, temp_a1) != 0) {
        if (arg0->unk54A == 2) {
            ...
            } else if ((gSaveContext.unk3E00 == 0) && (gSaveContext.unk3E04 == 0) && (temp_v0 != 0x2888)) {
...
void func_80962588(Actor *arg0, GlobalContext *arg1) {
    if ((func_80147624(arg1) != 0) && (arg0->unk552 == 0x2871)) {
...
void func_80962660(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_80147624(arg1) != 0) {
        ...
        case 10365:
            ...
            arg0->unk53C = 0;
            func_800BDC5C(arg0 + 0x190, (ActorAnimationEntry []) &D_80964B30, 3);
            func_801A2BB8(0x25);
            temp_v0 = arg0->unk542;
            if (temp_v0 == 0) {
                if (arg0->unk546 == 1) {
...
void func_80962A10(EnFu *arg0, GlobalContext *arg1) {
    ...
    arg0->unk53C = 0;
    if (((s32) temp_v0->unk168 < 0x12C) || (temp_v0->unk164 < 40.0f) || ((s32) temp_v0->unk16A < 0x258)) {
        sp20 = temp_v0;
...
void func_80962BA8(Actor *arg0) {
    arg0->unk54A = 0;
    arg0->unk2D4->unk160 = 1;
    arg0->unk1D4 = func_80962BCC;
}
...
void func_80962BCC(EnFu *arg0, GlobalContext *arg1) {
    ...
    if (((s32) temp_s0->unk168 < 0x64) || (temp_s0->unk164 < 30.0f) || ((s32) temp_s0->unk16A < 0x258)) {
    ...
    temp_v0->unkA74 = (s32) (temp_v0->unkA74 | 0x400000);
    func_8010E9F0(4, 0x3C);
    temp_a2 = arg0;
    temp_a0 = temp_a2;
    phi_a2 = temp_a2;
...
void func_80962D60(EnFu *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg1->actorCtx.actorList[2].first;
    if (((s32) temp_v1->unk168 < 0x64) || (temp_v1->unk164 < 40.0f) || ((s32) temp_v1->unk16A < 0x258)) {
        sp20 = temp_v1;
...
void func_80962F4C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_t6 == 0) && (temp_t7 < 0x7D0U)) {
        sp3C = temp_v1;
        Math_SmoothStepToS(temp_t0 + 0x168, (s16) (*(&D_80964B00 + (arg0->unk542 * 4)) + 0xC8), 0xA, 5, (s16) 5);
    } else if ((sp28 == 0) && (sp2C < 0xFA0U)) {
        sp3C = temp_v1;
        Math_SmoothStepToS(temp_t0 + 0x168, (s16) (*(&D_80964B00 + (arg0->unk542 * 4)) + 0x64), 0xA, 5, (s16) 5);
    }
    ...
    sp3C = arg1->actorCtx.actorList[2].first;
    if (((func_800CAF94((DynaPolyActor *) arg0->child) == 0) && ((arg1->actorCtx.actorList[2].first->bgCheckFlags & 1) != 0)) || ((gSaveContext.unk_3DE0[4] == 0) && (*(&gSaveContext + 0x3E04) == 0)) || (arg0->unk54C == arg0->unk548)) {
        arg1->actorCtx.actorList[2].first->unkA74 = (s32) (arg1->actorCtx.actorList[2].first->unkA74 & 0xFFBFFFFF);
        sp3C = arg1->actorCtx.actorList[2].first;
        func_80961E88(arg1);
        arg1->actorCtx.actorList[2].first->unkA6C = (s32) (arg1->actorCtx.actorList[2].first->unkA6C | 0x20);
        if ((s32) arg0->unk548 < (s32) arg0->unk54C) {
...
void func_80963350(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = arg1 + 0x4908;
    temp_s0 = arg0->child;
    if ((arg0->unk54A == 0) && (((sp28 = temp_a0, (func_80152498(temp_a0) == 5)) && (func_80147624(arg1) != 0)) || ((func_80152498(sp28) == 2) && ((u8) arg1->msgCtx.unk12023 == 1)))) {
        func_801477B4(arg1);
        arg0->unk54A = 2;
        D_80964C24 = 1;
    }
    if ((arg0->unk54A == 3) && (arg1->interfaceCtx.unk_286 == 0)) {
        arg0->unk54A = 2;
        D_80964C24 = 1;
    }
    if ((temp_s0->unk168 != 0) || (temp_s0->unk16A != 0) || (temp_s0->unk164 > 0.0f) || (func_809638F8(arg1) == 0)) {
...
void func_80963540(Actor *arg0) {
    arg0->child->unk118 = 0xA;
    arg0->unk1D4 = func_80963560;
}
...
void func_80963560(Actor *arg0, GlobalContext *arg1) {
    ...
    } else if ((arg0->unk552 == 0x2880) && ((gSaveContext.weekEventReg[22] & 0x80) == 0)) {
...
void func_809639D0(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_hi != 1) {
        ...
        if (((u32) (gSaveContext.inventory.upgrades & *(gUpgradeMasks + 4)) >> gUpgradeShifts[1]) == 0) {
...
void func_80963FF8(EnFu *arg0, GlobalContext *arg1) {
    if (arg1->actorCtx.actorList[2].first->unkA6C & 0x100000) {
        arg1->actorCtx.unk268 = 1;
...
void func_80964034(EnFu *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 == 0) {
        ...
        arg0->unk54E = temp_v0 - 1;
        phi_v1 = arg0->unk54E;
    }
    if (phi_v1 == 0) {
        arg0->unk54E = 0xC;
        sp2C.unk0 = (s32) arg0->actor.world.pos.x;
        sp2C.unk4 = (s32) arg0->actor.world.pos.y;
        sp2C.unk8 = (s32) arg0->actor.world.pos.z;
        sp30 += 62.0f;
...
void func_809642E0(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk542 == 0) {
        CollisionCheck_SetAC(arg1, arg1 + 0x18884, &sp1C->base);
    }
    CollisionCheck_SetOC(arg1, arg1 + 0x18884, &sp1C->base);
}

void EnFu_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnFu *this = (EnFu *) thisx;
    this->actionFunc(this, globalCtx);
    func_809642E0(&this->actor, globalCtx);
...
s32 func_809643FC(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg5) {
    if (arg1 == 9) {
        ...
        SysMatrix_InsertXRotation_s(arg5->unk526, 1);
        SysMatrix_InsertZRotation_s(arg5->unk524, 1);
        Matrix_RotateY(arg5->unk528, 1U);
        SysMatrix_InsertTranslation(-1600.0f, -300.0f, 0.0f, 1);
    } else if (arg1 == 0x14) {
        SysMatrix_InsertTranslation(1800.0f, 200.0f, 0.0f, 1);
        SysMatrix_InsertXRotation_s(arg5->unk52C, 1);
        SysMatrix_InsertZRotation_s(arg5->unk52A, 1);
        Matrix_RotateY(arg5->unk52E, 1U);
        SysMatrix_InsertTranslation(-1800.0f, -200.0f, 0.0f, 1);
    }
    return 0;
}
...
void EnFu_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SysMatrix_StatePush();
    func_80964950(globalCtx, &this->unk2D8, 0xA);
    SysMatrix_StatePop();
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_809643FC, func_8096450C, &this->actor);
}
...
void func_80964694(EnFu *arg0, void *arg1, ? *arg2, s32 arg3) {
    ...
    sp2C.unk0 = (s32) D_80964C40.unk0;
    sp2C.unk4 = (s32) D_80964C40.unk4;
    sp2C.unk8 = (s32) D_80964C40.unk8;
    sp20.unk0 = (s32) D_80964C4C.unk0;
    sp20.unk4 = (s32) D_80964C4C.unk4;
    sp20.unk8 = (s32) D_80964C4C.unk8;
    phi_v0 = 0;
    phi_a1 = arg1;
    phi_v0_2 = 0;
    phi_a1_2 = arg1;
    if ((arg3 > 0) && (arg1->unk36 != 0)) {
loop_2:
        temp_v0 = phi_v0 + 1;
        temp_a1 = phi_a1 + 0x38;
        phi_v0 = temp_v0;
    ...
    if (phi_v0_2 < arg3) {
        phi_a1_2->unk36 = 1;
        phi_a1_2->unk8 = (s32) arg2->unk0;
        phi_a1_2->unkC = (s32) arg2->unk4;
        phi_a1_2->unk10 = (s32) arg2->unk8;
        phi_a1_2->unk20 = (s32) sp2C.unk0;
        phi_a1_2->unk24 = (s32) sp2C.unk4;
        phi_a1_2->unk28 = (s32) sp2C.unk8;
        phi_a1_2->unk14 = (s32) sp20.unk0;
        phi_a1_2->unk18 = (s32) sp20.unk4;
        phi_a1_2->unk1C = (s32) sp20.unk8;
        phi_a1_2->unk0 = 0.01f;
        arg1 = phi_a1_2;
        arg1->unk8 = (f32) (arg1->unk8 + (4.0f * Math_SinS(arg0->actor.shape.rot.y)));
        temp_f8 = 4.0f * Math_CosS(arg0->actor.shape.rot.y);
        arg1->unk37 = 0x10;
        arg1->unk10 = (f32) (arg1->unk10 + temp_f8);
    }
}
...
void func_809647EC(GlobalContext *arg0, void *arg1, s32 arg2) {
    ...
    sp44.x = D_80964C58.unk0;
    sp44.y = D_80964C58.unk4;
    sp44.z = D_80964C58.unk8;
    ...
    if (arg2 > 0) {
        do {
            if (phi_s0->unk36 == 1U) {
                temp_v0 = phi_s0->unk37;
                temp_t3 = temp_v0 - 1;
                if (temp_v0 == 0) {
                    phi_v1 = 0;
                } else {
                    phi_s0->unk37 = temp_t3;
                    phi_v1 = temp_t3 & 0xFF;
                }
                if (phi_v1 == 0) {
                    phi_s0->unk36 = 0U;
                }
                phi_s0->unkC = (f32) (phi_s0->unkC + phi_s0->unk24);
                phi_s0->unk8 = (f32) (phi_s0->unk8 + (2.0f * Math_SinS(phi_s0->unk2C)));
                phi_s0->unk10 = (f32) (phi_s0->unk10 + (2.0f * Math_CosS(phi_s0->unk2C)));
                SysMatrix_StatePush();
                SysMatrix_InsertTranslation(phi_s0->unk8, phi_s0->unkC, phi_s0->unk10, 0);
                Matrix_RotateY(temp_s2, 1U);
                SysMatrix_MultiplyVector3fByState(&sp44, phi_s0 + 8);
                SysMatrix_StatePop();
                phi_s0->unk2C = (s16) (phi_s0->unk2C + 0x1770);
            }
            temp_s1 = phi_s1 + 1;
            phi_s0 += 0x38;
            phi_s1 = temp_s1;
    ...
    if (arg2 > 0) {
        do {
            ...
            if (phi_s2->unk36 == 1) {
                ...
                SysMatrix_InsertTranslation(phi_s2->unk8, phi_s2->unkC, phi_s2->unk10, 0);
                SysMatrix_NormalizeXYZ(temp_s0);
                temp_f12 = phi_s2->unk0;
