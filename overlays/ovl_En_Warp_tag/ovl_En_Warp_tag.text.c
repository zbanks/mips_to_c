...
static InitChainEntry D_809C1008;                   /* unable to generate initializer */
...
typedef struct EnWarptag {
    ...
    /* 0x0160 */ void (*actionFunc)(EnWarptag *, GlobalContext *);
...
void EnWarptag_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_809C1008);
...
void func_809C0AB4(EnWarptag *this, GlobalContext *globalCtx) {
    ...
    if (((s32) globalCtx->unk_1879C[4] >= 0) && (sp34 = temp_t1, temp_a0 = globalCtx->unk_1879C[4], (ActorCutscene_GetCurrentIndex() != temp_a0))) {
        ...
        ActorCutscene_StartAndSetUnkLinkFields(globalCtx->unk_1879C[4], &this->actor);
