...
void func_809C085C(EnWarptag *this, GlobalContext *globalCtx) {
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->unk_15C) != 0) {
        this->actionFunc = func_809C08E0;
    ...
    if (Math_StepToS(&this->unk_15E, 0x2710, 0xC8) != 0) {
        ...
        if (this->actor.yDistToPlayer < -80.0f) {
            ...
            if (this->actor.draw != 0) {
                ...
                phi_v1 = temp_s1->unk_14B;
            }
            temp_t0 = (sp + (phi_v1 * 4))->unk_58;
            temp_v0 = (globalCtx + 0x18000)->unk_850 + (temp_t0 * 0x10);
            sp44 = (f32) temp_v0->unk_2;
            sp48 = (f32) temp_v0->unk_4;
            sp4C = (f32) temp_v0->unk_6;
            phi_v1_2 = 0x8FF;
            if ((this->actor.params & 0x3C0) == 0x3C0) {
                phi_v1_2 = 0x9FF;
            }
            func_80169DCC(globalCtx, 0, gSaveContext.entranceIndex & 0xFFFF, (s32) ((globalCtx + 0x18000)->unk_85C + (temp_t0 * 2))->unk_1, phi_v1_2, (Vec3f *) &sp44, (s16) (s32) (((f32) (((s32) temp_v0->unk_A >> 7) & 0x1FF) / 180.0f) * 32768.0f));
            func_80169EFC(globalCtx);
            gSaveContext.respawnFlag = -5;
            func_80165690();
        }
    }
    temp_s1->shape.rot.y += this->unk_15E;
    temp_v0_2 = this->unk_15E - 0xFA0;
    phi_v0 = temp_v0_2;
    if (temp_v0_2 < 0) {
        phi_v0 = 0;
    }
