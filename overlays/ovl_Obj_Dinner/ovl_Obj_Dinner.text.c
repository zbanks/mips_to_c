...
void ObjDinner_Init(ObjDinner *this, GlobalContext *globalCtx) {
...
void ObjDinner_Destroy(ObjDinner *this, GlobalContext *globalCtx) {
    ObjDinner *this = (ObjDinner *) thisx;

}

void ObjDinner_Update(ObjDinner *this, GlobalContext *globalCtx) {
    ObjDinner *this = (ObjDinner *) thisx;

}

void ObjDinner_Draw(ObjDinner *this, GlobalContext *globalCtx) {
