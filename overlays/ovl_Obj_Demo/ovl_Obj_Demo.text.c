...
void ObjDemo_Init(ObjDemo *this, GlobalContext *globalCtx) {
    f32 temp_f6;
    s16 temp_a1;
    s16 temp_a3;
    s16 temp_v0;
    ...
    if (this->actor.shape.rot.x == 0) {
        ...
        this->unk14C = (f32) this->actor.shape.rot.x * 4.0f;
    }
...
void func_80983678(ObjDemo *this, GlobalContext *globalCtx) {
    func_80983634(globalCtx);
    if ((this->actor.xzDistToPlayer < this->unk14C) && (fabsf(this->actor.yDistToPlayer) < this->unk150)) {
        if (this->unk148 == 1) {
...
void func_80983704(ObjDemo *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk148 == 1) && (ActorCutscene_GetCurrentIndex() == 0x7D)) {
        ActorCutscene_Stop(0x7D);
        ActorCutscene_SetIntentToPlay((s16) this->actor.cutscene);
        return;
    }
...
void ObjDemo_Update(ObjDemo *this, GlobalContext *globalCtx) {
    s16 temp_a1;
    s16 temp_a3;
    ObjDemo *this = (ObjDemo *) thisx;
