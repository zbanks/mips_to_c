typedef struct EffChange {
    ...
    /* 0x144 */ char pad144[0xC];
    /* 0x150 */ f32 unk150;                         /* inferred */
    /* 0x154 */ f32 unk154;                         /* inferred */
    /* 0x158 */ char pad158[0x1C];                  /* maybe part of unk154[8]? */
    /* 0x174 */ ? unk174;                           /* inferred */
    /* 0x174 */ char pad174[0x24];
    /* 0x198 */ ? unk198;                           /* inferred */
    /* 0x198 */ char pad198[0x24];
    /* 0x1BC */ s16 unk1BC;                         /* inferred */
    /* 0x1BE */ char pad1BE[0x3];                   /* maybe part of unk1BC[2]? */
    /* 0x1C1 */ u8 unk1C1;                          /* inferred */
    /* 0x1C2 */ char pad1C2[0x6];                   /* maybe part of unk1C1[7]? */
...
void EffChange_Init(EffChange *this, GlobalContext *globalCtx) {
    ? *sp28;
    ? *temp_a0;
...
void EffChange_Destroy(EffChange *this, GlobalContext *globalCtx) {
    EffChange *this = (EffChange *) thisx;
...
void EffChange_Update(EffChange *this, GlobalContext *globalCtx) {
    EffChange *this = (EffChange *) thisx;
