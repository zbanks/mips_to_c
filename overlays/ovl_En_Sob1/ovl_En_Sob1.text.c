...
struct _mips2c_stack_EnSob1_PositionSelectedItem {
    ...
    /* 0x04 */ char pad4[0x18];                     /* maybe part of sp0[7]? */
...
void EnSob1_Init(EnSob1 *this, GlobalContext *globalCtx) {
    s16 *sp24;
    s16 *temp_a2;
    s32 temp_v0;
...
void EnSob1_Destroy(EnSob1 *this, GlobalContext *globalCtx) {
    EnSob1 *this = (EnSob1 *) thisx;
...
void EnSob1_InitShop(EnSob1 *this, GlobalContext *globalCtx) {
    ...
    if (EnSob1_AreObjectsLoaded(this, globalCtx) != 0) {
        ...
        this->actor.world.pos.x += temp_v0->unk0;
        this->actor.world.pos.y += temp_v0->unk4;
        temp_a0 = (temp_v1 * 0x18) + &sShops;
        this->actor.world.pos.z += temp_v0->unk8;
        sp24 = temp_a0;
        ...
        *(&sInitFuncs + (this->shopType * 4))(this, globalCtx);
        ...
        this->posXZRange.xMin = temp_t4->unk0;
        this->posXZRange.xMax = temp_t4->unk4;
        this->posXZRange.zMin = temp_t4->unk8;
        this->posXZRange.zMax = temp_t4->unkC;
...
void EnSob1_Update(EnSob1 *this, GlobalContext *globalCtx) {
...
void EnSob1_DrawZoraShopkeeper(EnSob1 *this, GlobalContext *globalCtx) {
...
void EnSob1_DrawGoronShopkeeper(EnSob1 *this, GlobalContext *globalCtx) {
...
void EnSob1_DrawBombShopkeeper(EnSob1 *this, GlobalContext *globalCtx) {
    u32 sp5C;
    Gfx *sp4C;
    EnGirlA *temp_t0;
    EnGirlA *temp_t0_2;
