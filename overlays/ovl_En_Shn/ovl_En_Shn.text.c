...
void *func_80AE625C(s32 arg0, void *arg1);          /* static */
...
static ActorAnimationEntryS D_80AE7218 = {
...
typedef struct EnShn {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnShn *, GlobalContext *);
    /* 0x0148 */ SkelAnime unk148;                  /* inferred */
    /* 0x018C */ char pad18C[0x4C];
    /* 0x01D8 */ u16 unk1D8;                        /* inferred */
    /* 0x01DA */ u16 unk1DA;                        /* inferred */
    /* 0x01DC */ s32 *unk1DC;                       /* inferred */
    /* 0x01E0 */ s32 unk1E0;                        /* inferred */
    /* 0x01E4 */ void *unk1E4;                      /* inferred */
    /* 0x01E8 */ char pad1E8[0x12];
    /* 0x01FA */ Vec3s unk1FA;                      /* inferred */
    /* 0x0200 */ char pad200[0x5A];                 /* maybe part of unk1FA[16]? */
    /* 0x025A */ Vec3s unk25A;                      /* inferred */
    /* 0x0260 */ char pad260[0x5A];                 /* maybe part of unk25A[16]? */
    /* 0x02BA */ s16 unk2BA;                        /* inferred */
    /* 0x02BC */ s16 unk2BC;                        /* inferred */
    /* 0x02BE */ s16 unk2BE;                        /* inferred */
    /* 0x02C0 */ char pad2C0[0xA];                  /* maybe part of unk2BE[6]? */
    /* 0x02CA */ s16 unk2CA;                        /* inferred */
    /* 0x02CC */ f32 unk2CC;                        /* inferred */
    /* 0x02D0 */ char pad2D0[0x8];                  /* maybe part of unk2CC[3]? */
    /* 0x02D8 */ void *unk2D8;                      /* inferred */
    /* 0x02DC */ char pad2DC[0x4];                  /* maybe part of unk2D8[2]? */
    /* 0x02E0 */ s32 unk2E0;                        /* inferred */
    /* 0x02E4 */ char pad2E4[0x4];                  /* maybe part of unk2E0[2]? */
    /* 0x02E8 */ s32 unk2E8;                        /* inferred */
    /* 0x02EC */ char pad2EC[0x4];                  /* maybe part of unk2E8[2]? */
} EnShn;                                            /* size 0x2F0 */
...
void func_80AE626C(EnShn *arg0) {
    ...
    Math_ApproachS(arg0 + 0x2BC, (s16) (Math_Vec3f_Yaw(&sp34, &sp40) - arg0->actor.shape.rot.y), 4, 0x2AA8);
    temp_v0 = arg0->unk2BC;
    ...
    Math_ApproachS(arg0 + 0x2BA, Math_Vec3f_Pitch(&sp34, &sp40), 4, 0x2AA8);
...
void func_80AE69E8(EnShn *this, GlobalContext *globalCtx) {
    ...
    if (((gSaveContext.weekEventReg[23] & 8) != 0) && (func_80AE61C0(&this->actor) != 0)) {
        this->unk1D8 |= 8;
        return;
    }
    this->unk1D8 &= 0xFFF7;
...
void func_80AE6A64(EnShn *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk1E4;
    if (temp_v0 != 0) {
        Math_Vec3f_Copy(&sp38, temp_v0 + 0x24);
...
void EnShn_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnShn *this = (EnShn *) thisx;
    func_80AE68F0(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    func_80AE65F4(this, globalCtx);
    func_80AE6130(this);
    func_80AE63A8(this, globalCtx);
    this->unk2E0 = 0;
    func_8013C964(&this->actor, globalCtx, 120.0f, 40.0f, 0, (s16) (this->unk1D8 & 7));
}
...
void EnShn_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, func_80AE6CF0, func_80AE6D40, func_80AE6D90, &this->actor);
}
