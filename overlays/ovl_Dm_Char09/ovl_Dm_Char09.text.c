...
typedef struct DmChar09 {
    ...
    /* 0x204 */ char pad204[0xC];                   /* maybe part of actionFunc[4]? */
    ...
    /* 0x224 */ void *unk224;                       /* inferred */
    /* 0x228 */ s16 unk228;                         /* inferred */
    /* 0x22A */ s16 unk22A;                         /* inferred */
    /* 0x22C */ char pad22C[0x2];
    /* 0x22E */ u8 unk22E;                          /* inferred */
    /* 0x22F */ u8 unk22F;                          /* inferred */
} DmChar09;                                         /* size = 0x230 */
...
struct _mips2c_stack_func_80AB2268 {
    ...
    /* 0x28 */ char pad28[0x4];                     /* maybe part of sp27[5]? */
...
void DmChar09_Init(DmChar09 *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
    f32 temp_f16;
...
void DmChar09_Destroy(DmChar09 *this, GlobalContext *globalCtx) {
    DmChar09 *this = (DmChar09 *) thisx;
...
void func_80AB1FDC(DmChar09 *this, GlobalContext *globalCtx) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp58, this->unk224 + (this->unk21C * 6) + (this->unk220 * 6));
...
void DmChar09_Update(DmChar09 *this, GlobalContext *globalCtx) {
    DmChar09 *this = (DmChar09 *) thisx;
...
void DmChar09_Draw(DmChar09 *this, GlobalContext *globalCtx) {
    DmChar09 *this = (DmChar09 *) thisx;
    if ((globalCtx->csCtx.state != 0) && (this->unk22E != 0)) {
        func_8012C28C(globalCtx->state.gfxCtx);
        func_8012C2DC(globalCtx->state.gfxCtx);
        SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80AB25D8, NULL, (Actor *) this);
    }
}
