...
void BgHakaBombwall_Init(BgHakaBombwall *this, GlobalContext *globalCtx) {
...
void BgHakaBombwall_Destroy(BgHakaBombwall *this, GlobalContext *globalCtx) {
...
void BgHakaBombwall_Update(BgHakaBombwall *this, GlobalContext *globalCtx) {
    BgHakaBombwall *this = (BgHakaBombwall *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgHakaBombwall_Draw(BgHakaBombwall *this, GlobalContext *globalCtx) {
    BgHakaBombwall *this = (BgHakaBombwall *) thisx;
