typedef struct EnScopecrow {
    ...
    /* 0x192 */ char pad192[0x30];                  /* maybe part of unk18C[9]? */
    /* 0x1C2 */ Vec3s unk1C2;                       /* inferred */
    /* 0x1C8 */ char pad1C8[0x30];                  /* maybe part of unk1C2[9]? */
...
void func_80BCD640(EnScopecrow *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_t6;
    if (temp_t6 != 0) {
        func_80BCD4D0(temp_t6, this->unk1FC, (Vec3f *) &this->actor.world, &sp30);
...
void EnScopecrow_Init(EnScopecrow *this, GlobalContext *globalCtx) {
    ? sp4C;
    f32 sp44;
    f32 sp40;
    f32 sp3C;
    ...
    if ((globalCtx->actorCtx.unk5 & 2) != 0) {
        ...
        Collider_InitAndSetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80BCDB94, &this->unk220);
...
void EnScopecrow_Destroy(EnScopecrow *this, GlobalContext *globalCtx) {
    EnScopecrow *this = (EnScopecrow *) thisx;
    Collider_DestroyJntSph(globalCtx, &this->unk200);
}

void EnScopecrow_Update(EnScopecrow *this, GlobalContext *globalCtx) {
    EnScopecrow *this = (EnScopecrow *) thisx;
...
void EnScopecrow_Draw(EnScopecrow *this, GlobalContext *globalCtx) {
    EnScopecrow *this = (EnScopecrow *) thisx;
