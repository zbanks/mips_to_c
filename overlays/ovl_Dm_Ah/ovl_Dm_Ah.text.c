...
static ActorAnimationEntryS D_80C1DDE0 = {
...
static void *D_80C1DE20 = {(void *)0x6008D70, (void *)0x6009570};
static ? D_80C1DE28;                                /* unable to generate initializer */

typedef struct DmAh {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ SkelAnime unk144;                  /* inferred */
    /* 0x0188 */ void (*actionFunc)(DmAh *, GlobalContext *);
    /* 0x018C */ char pad18C[0x24];                 /* maybe part of actionFunc[10]? */
    /* 0x01B0 */ Vec3s unk1B0;                      /* inferred */
    /* 0x01B6 */ char pad1B6[0x60];                 /* maybe part of unk1B0[17]? */
    /* 0x0216 */ Vec3s unk216;                      /* inferred */
    /* 0x021C */ char pad21C[0x60];                 /* maybe part of unk216[17]? */
    /* 0x027C */ u16 unk27C;                        /* inferred */
    /* 0x027E */ u8 unk27E;                         /* inferred */
    /* 0x027F */ char pad27F[0x1];                  /* maybe part of unk27E[2]? */
    /* 0x0280 */ Actor *unk280;                     /* inferred */
...
? func_80C1D4D0(void *arg0, ? arg1) {
    ...
    Math_Vec3f_Copy(&sp40, arg0->unk280 + 0x24);
    ...
    Math_ApproachS(arg0 + 0x28A, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk28E), 4, 0x2AA8);
    ...
    Math_ApproachS(arg0 + 0x28E, (s16) (Math_Vec3f_Pitch(&sp34, &sp40) - arg0->unk28A), 4, 0x2AA8);
...
void DmAh_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80C1DAD4, func_80C1DB24, &this->actor);
}
