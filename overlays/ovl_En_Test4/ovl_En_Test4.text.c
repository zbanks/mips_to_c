...
typedef struct EnTest4 {
    ...
    /* 0x148 */ u16 unk_148;                        /* inferred */
    /* 0x14A */ u16 unk_14A;                        /* inferred */
    /* 0x14C */ u8 unk_14C;                         /* inferred */
    /* 0x14D */ char pad_14D[0x3];                  /* maybe part of unk_14C[4]? */
...
void func_80A425E4(EnTest4 *arg0, GlobalContext *arg1) {
    ...
    if (((s32) *(&D_80A434D0 + (arg0->unk_144 * 2)) < 0) || ((arg1->actorCtx.unk5 & 2) != 0) || (((s32) gSaveContext.day % 5) == 3) || ((s32) gSaveContext.time >= 0xB555)) {
        gSaveContext.unk_3F64 = 1000.0f;
    }
...
void EnTest4_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((D_80A43340 != 0) || ((gSaveContext.eventInf[2] & 0x80) != 0)) {
        ...
        if (((s32) gSaveContext.day % 5) == 0) {
            ...
            if (temp_v0_3 == 0x4000) {
                ...
                phi_v1 = &gSaveContext;
                if ((gSaveContext.cutsceneTrigger == 0) && ((s32) *(&D_80A434D0 + (this->unk_144 * 2)) >= 0) && ((globalCtx->actorCtx.unk5 & 2) == 0)) {
    ...
    if (((s32) *(&D_80A434D0 + (this->unk_144 * 2)) < 0) || ((globalCtx->actorCtx.unk5 & 2) != 0)) {
        gSaveContext.unk_3F60 = 0;
        gSaveContext.unk_3F64 = 1000.0f;
    }
}
...
void func_80A42AB8(EnTest4 *this, GlobalContext *globalCtx) {
    ...
    if ((globalCtx->unk_18B4A == 0) && (sp34 = globalCtx + 0x18000, (func_801690CC(globalCtx) == 0)) && ((s32) globalCtx->numSetupActors <= 0) && (globalCtx->roomCtx.unk31 == 0) && (func_8016A168() == 0)) {
        temp_v0 = gSaveContext.time;
        temp_a0 = *(&D_80A43364 + (this->unk_144 * 2));
        temp_v1 = this->unk_148;
        temp_a2 = temp_v0 - temp_a0;
        temp_a3 = this->unk_146 - temp_a0;
        phi_t0 = &gSaveContext;
        if ((temp_a2 * temp_a3) <= 0) {
            ...
            if (temp_a0 == 0x4000) {
                ...
                if (temp_hi == 3) {
                    ...
                    if ((((s32) (&D_80A434D0)[this->unk_144] < 0) || ((globalCtx->actorCtx.unk5 & 2) != 0)) && (temp_hi != 3)) {
                        func_80A41FA4(this, globalCtx, temp_a2, temp_a3);
                    } else {
...
block_24:
            ...
            temp_v0_3 = this->unk_144;
            if (((s32) (&D_80A434D0)[temp_v0_3] >= 0) && ((globalCtx->actorCtx.unk5 & 2) == 0)) {
                sp54->unk_A6C = (s32) (sp54->unk_A6C | 0x200);
                this->unk_146 = phi_t0->time;
                return;
            }
            if (temp_v0_3 == 0) {
                this->unk_144 = 1;
        ...
        if (((s16) (temp_v0 - temp_v1) * (s16) (this->unk_14A - temp_v1)) <= 0) {
            func_801A0124(&this->actor.projectedPos, ((s32) this->actor.params >> 5) & 0xF & 0xFF, temp_a2, temp_a3);
            this->unk_14A = gSaveContext.time;
            if (((s32) gSaveContext.day % 5) == 3) {
                if ((this->unk_148 == 0) && ((gSaveContext.inventory.items[0] == 0xFF) || (globalCtx->sceneNum == 0x6F))) {
...
void func_80A42F20(EnTest4 *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v1 < 0x3C) {
        ...
        if (phi_v0 == 0x3C) {
            ...
            phi_a2->unk_146 = temp_t2;
            phi_a1->numSetupActors = (s16) -(s32) phi_a1->numSetupActors;
            temp_v0_2->unk_A6C = (s32) (temp_v0_2->unk_A6C & ~0x200);
            return;
        }
