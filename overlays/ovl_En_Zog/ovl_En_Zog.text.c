typedef struct EnZog {
    ...
    /* 0x1DA */ char pad_1DA[0x84];                 /* maybe part of unk_1D4[23]? */
    /* 0x25E */ Vec3s unk_25E;                      /* inferred */
    /* 0x264 */ char pad_264[0x84];                 /* maybe part of unk_25E[23]? */
    /* 0x2E8 */ void *unk_2E8;                      /* inferred */
    /* 0x2EC */ s32 unk_2EC;                        /* inferred */
    /* 0x2F0 */ Vec3f unk_2F0;                      /* inferred */
...
void func_80B93468(EnZog *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_2E8 = temp_t1;
    if (temp_t1 != 0) {
        arg0 = arg0;
        temp_v1 = Lib_SegmentedToVirtual(temp_t1->unk_4) + (arg0->unk_2EC * 6);
        temp_v1_2 = temp_v1 + 6;
        arg0->actor.world.pos.x = (f32) *temp_v1;
        arg0->actor.world.pos.z = (f32) temp_v1_2->unk_-2;
        arg0->actor.world.rot.y = Math_Atan2S((f32) temp_v1_2->unk_0 - arg0->actor.world.pos.x, (f32) temp_v1_2->unk_4 - arg0->actor.world.pos.z);
...
void EnZog_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp50 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_06029170, &D_0600FC0C, &this->unk_1D4, &this->unk_25E, 0x17);
    ...
    Math_Vec3f_Copy(&this->unk_2F0, (Vec3f *) &this->actor.world);
...
void func_80B93A48(EnZog *arg0, GlobalContext *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        temp_a0_2 = arg0->unk_302;
        if (arg0->unk_300 != temp_a0_2) {
            arg0->unk_302 = temp_a0_2 + 1;
            goto block_6;
        }
        if (temp_a0_2 == 0) {
            temp_v0 = arg0->unk_2FE;
            if (temp_v0 != arg0->unk_2FC) {
                arg0->unk_2FC = temp_v0;
block_6:
            }
        }
        temp_v1 = arg0->unk_2FC;
        if ((s32) arg0->unk_302 >= (s32) *(&D_80B95984 + (temp_v1 * 2))) {
            temp_v0_2 = arg0->unk_2FE;
            arg0->unk_302 = 0;
            arg0->unk_300 = 0;
            if (temp_v0_2 != temp_v1) {
                arg0->unk_2FC = temp_v0_2;
            }
        }
        arg0->unk_304 = *(*(&D_80B95974 + (arg0->unk_2FC * 4)) + (arg0->unk_302 * 2));
        SkelAnime_ChangeAnimDefaultStop(sp18, *(&D_80B958C0 + (arg0->unk_304 * 4)));
...
void func_80B93B44(EnZog *arg0) {
    ...
    phi_v0 = temp_v0;
    if ((temp_v0 & 4) == 0) {
        temp_v1 = arg0->unk_31A;
        if (temp_v1 != -1) {
            temp_a0 = (arg0 + (temp_v1 * 2))->unk_30C;
            arg0 = arg0;
...
s32 func_80B93BE0(EnZog *arg0, GlobalContext *arg1) {
    ...
    if (phi_a1 >= 0x4001) {
        ...
        if ((arg0->unk_2EC + 1) >= (s32) arg0->unk_2E8->unk_0) {
            arg0->unk_30A |= 1;
            return 1;
        }
        goto block_10;
...
void func_80B93D2C(EnZog *arg0, GlobalContext *arg1) {
    ...
    sp28.unk_0 = (s32) arg0->actor.world.pos.x;
    sp28.unk_4 = (f32) arg0->actor.world.pos.y;
    sp28.unk_8 = (s32) arg0->actor.world.pos.z;
    sp2C += arg0->actor.yDistToWater;
    temp_a0 = arg0->unk_308;
    arg0 = arg0;
...
s32 func_80B93EA0(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x1D7U) != 0) {
        ...
        temp_v1 = arg0->unk_306;
        if (temp_v1 != 2) {
            if (temp_v1 != 8) {
                if ((temp_v1 != 9) && (temp_v1 != 0xA)) {
                    arg0->unk_30A = (u16) (arg0->unk_30A & 0xFFF7);
                } else {
                    temp_v0_2 = arg0->unk_322;
                    if ((s32) temp_v0_2 < 0x96) {
                        arg0->unk_322 = (s16) (temp_v0_2 + 0xF);
                    } else {
                        arg0->unk_322 = 0x96;
                    }
                    goto block_33;
...
block_33:
        ...
        if ((s16) sp3E != arg0->unk_306) {
            arg0->unk_306 = (s16) sp3E;
            temp_t7 = arg0->unk_306;
            ...
            case 8:                                 /* switch 2 */
                arg0->unk_322 = 0xFA;
                arg0->unk_30A = (u16) (arg0->unk_30A | 8);
                return 1;
            case 9:                                 /* switch 2 */
                arg0->unk_322 = 0;
                arg0->unk_30A = (u16) (arg0->unk_30A | 8);
                ...
                arg0->unk_31C = 0;
                arg0->unk_31E = 0;
                arg0->unk_30A = (u16) (arg0->unk_30A & 0xFFFD);
                return 1;
            case 10:                                /* switch 2 */
                func_80B939C0(arg0, 0xE, 0U);
                arg0->unk_31C = 0;
                arg0->unk_30A = (u16) (arg0->unk_30A | 2);
                arg0->unk_31E = 1;
                return 1;
            case 11:                                /* switch 2 */
...
void func_80B943EC(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v1 & 0x10) != 0) {
        if ((temp_v0->unk_A70 * 0x10) >= 0) {
            arg0->unk_30A = (u16) (temp_v1 & 0xFFEF);
            return;
        }
        /* Duplicate return node #6. Try simplifying control flow for better match */
        return;
    }
    if (((temp_v0->unk_A70 * 0x10) < 0) && (arg0->xzDistToPlayer < 120.0f)) {
        arg0->unk_30A = (u16) (temp_v1 | 0x10);
...
void func_80B9461C(EnZog *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_304 == 0xB) && ((s32) this->unk_190.animCurrentFrame >= 0x37)) {
        this->unk_30A |= 2;
    }
}
...
void func_80B94A00(EnZog *this, GlobalContext *globalCtx) {
    ...
    temp_f0 = this->unk_190.animCurrentFrame;
    ...
    if ((this->actor.yDistToWater > 0.0f) && ((globalCtx->gameplayFrames & 7) == 0)) {
        sp30.unk_0 = (f32) this->actor.world.pos.x;
        sp30.unk_4 = (f32) this->actor.world.pos.y;
        sp30.unk_8 = (f32) this->actor.world.pos.z;
    ...
    if ((this->unk_304 == 4) && ((sp2C = temp_a0, (func_801378B8(temp_a0, 136.0f) != 0)) || (func_801378B8(temp_a0, 155.0f) != 0))) {
        Audio_PlayActorSound2((Actor *) this, 0x804U);
    }
    temp_a0_2 = &this->unk_190;
    if ((this->unk_304 == 5) && ((sp2C = temp_a0_2, (func_801378B8(temp_a0_2, 12.0f) != 0)) || (func_801378B8(temp_a0_2, 37.0f) != 0))) {
...
void func_80B94D0C(EnZog *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_320;
    this->actor.speedXZ = 0.0f;
    if ((s32) temp_v0 > 0) {
        this->unk_320 = temp_v0 - 1;
        this->unk_31C = 1;
        this->unk_31E = 1;
    } else {
        this->unk_31C = 2;
...
void func_80B94E34(EnZog *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0 < 0.1f) {
        ...
        if (temp_f0 > 0.1f) {
            ...
            if ((sp48->speedXZ > 3.0f) && (this->unk_324 == 0)) {
                this->unk_324 = 0x19;
                func_800B8E58(sp48, (sp48->unk_A68->unk_92 + 0x6818) & 0xFFFF);
            }
        }
    ...
    temp_v0_2 = this->unk_324;
    if ((s32) temp_v0_2 > 0) {
        this->unk_324 = temp_v0_2 - 1;
    }
    if (func_800B84D0((Actor *) this, globalCtx) != 0) {
        ...
        if (((s32) temp_v0_3 >= 0x3E81) && ((s32) temp_v0_3 < 0x7D00) && (this->unk_302 == 0)) {
            func_800B8614((Actor *) this, globalCtx, 150.0f);
        }
    }
...
void EnZog_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_304 == 6) {
        if (func_801378B8(&this->unk_190, 43.0f) == 0) {
            goto block_6;
        }
        goto block_8;
    }
block_6:
    if ((this->unk_304 == 0x11) && (func_801378B8(&this->unk_190, 14.0f) != 0)) {
block_8:
        Audio_PlayActorSound2((Actor *) this, 0x2995U);
    }
    temp_a2 = &this->unk_144;
    if ((this->unk_30A & 1) != 0) {
        this->unk_144.dim.pos.x = (s16) (s32) this->unk_2F0.x;
        this->unk_144.dim.pos.y = (s16) (s32) this->actor.world.pos.y;
        this->unk_144.dim.pos.z = (s16) (s32) this->unk_2F0.z;
    } else {
        sp2C = temp_a2;
    ...
    if ((temp_v1 & 4) != 0) {
        temp_v0 = this->unk_31A;
        if (temp_v0 == -1) {
            this->unk_30A = temp_v1 & 0xFFFB;
            return;
        }
        if ((this + (temp_v0 * 2))->unk_30C == -1) {
            this->unk_30A = temp_v1 & 0xFFFB;
            return;
        }
        if (ActorCutscene_GetCurrentIndex() == 0x7C) {
            ActorCutscene_Stop(0x7C);
            ActorCutscene_SetIntentToPlay((this + (this->unk_31A * 2))->unk_30C);
            return;
        }
        if (ActorCutscene_GetCanPlayNext((this + (this->unk_31A * 2))->unk_30C) != 0) {
            ActorCutscene_StartAndSetUnkLinkFields((this + (this->unk_31A * 2))->unk_30C, (Actor *) this);
            this->unk_30A &= 0xFFFB;
            return;
        }
        ActorCutscene_SetIntentToPlay((this + (this->unk_31A * 2))->unk_30C);
