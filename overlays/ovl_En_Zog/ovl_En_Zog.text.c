...
static void *D_80B958AC = {(void *)0x6024750, (void *)0x6024F50, (void *)0x6025750};
static void *D_80B958B8 = {(void *)0x6025F50, (void *)0x6026750};
static ? D_80B958C0;                                /* unable to generate initializer */
static AnimationHeader *D_80B958DC = {(AnimationHeader *)0x600CA94, (AnimationHeader *)0x600F110};
static AnimationHeader *D_80B958E4 = {
    (AnimationHeader *)0x601579C,
    (AnimationHeader *)0x6015B80,
    (AnimationHeader *)0x600ECBC,
};
static AnimationHeader *D_80B958F0 = {(AnimationHeader *)0x6008EB8, (AnimationHeader *)0x60099A4};
static AnimationHeader *D_80B958F8 = {
...
typedef struct EnZog {
    ...
    /* 0x01DA */ char pad1DA[0x84];                 /* maybe part of unk1D4[23]? */
    /* 0x025E */ Vec3s unk25E;                      /* inferred */
    /* 0x0264 */ char pad264[0x84];                 /* maybe part of unk25E[23]? */
    /* 0x02E8 */ void *unk2E8;                      /* inferred */
    /* 0x02EC */ s32 unk2EC;                        /* inferred */
    /* 0x02F0 */ Vec3f unk2F0;                      /* inferred */
    ...
    /* 0x030A */ u16 unk30A;                        /* inferred */
    /* 0x030C */ s16 unk30C;                        /* inferred */
    /* 0x030E */ char pad30E[0xC];                  /* maybe part of unk30C[7]? */
    ...
    /* 0x0328 */ void (*actionFunc)(EnZog *, GlobalContext *);
} EnZog;                                            /* size 0x32C */
...
void EnZog_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, &this->actor, &D_80B95880);
    ...
    Math_Vec3f_Copy(&this->unk2F0, &this->actor.world.pos);
    ...
    if (temp_v0 != 2) {
        ...
        do {
            sp5C = phi_t0;
            Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0x267, this->actor.world.pos.x, this->actor.world.pos.y + 500.0f, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, 0x64);
            temp_t0 = phi_t0 + 1;
            phi_t0 = temp_t0;
        } while (temp_t0 != 5);
...
void func_80B93D2C(EnZog *arg0, GlobalContext *arg1) {
    ...
    sp28.x = arg0->actor.world.pos.x;
    sp28.y = arg0->actor.world.pos.y;
    sp28.z = arg0->actor.world.pos.z;
    ...
    if ((arg1->gameplayFrames & 0xF) == 0) {
        EffectSsGRipple_Spawn(arg1, &sp28, 0x96, 0x1F4, (s16) 0);
    }
}
...
void func_80B9451C(EnZog *this, GlobalContext *globalCtx) {
    ...
    func_80B943EC(&this->actor, globalCtx);
}
...
void func_80B94A00(EnZog *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.yDistToWater > 0.0f) && ((globalCtx->gameplayFrames & 7) == 0)) {
        ...
        EffectSsGRipple_Spawn(globalCtx, &sp30, 0x96, 0x1F4, (s16) 0);
    }
    ...
    if ((this->unk304 == 4) && ((sp2C = temp_a0, (func_801378B8(temp_a0, 136.0f) != 0)) || (func_801378B8(temp_a0, 155.0f) != 0))) {
        Audio_PlayActorSound2(&this->actor, 0x804U);
    }
    ...
    if ((this->unk304 == 5) && ((sp2C = temp_a0_2, (func_801378B8(temp_a0_2, 12.0f) != 0)) || (func_801378B8(temp_a0_2, 37.0f) != 0))) {
        ...
        Audio_PlayActorSound2(&this->actor, 0x801U);
...
void func_80B94E34(EnZog *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0 < 0.1f) {
        ...
        if (temp_f0 > 0.1f) {
            ...
            sp38.y += 20.0f;
            temp_f2 = sp38.z + randPlusMinusPoint5Scaled(30.0f);
            temp_a3 = temp_f2;
            sp38.z = temp_f2;
            if ((func_800CA1AC(globalCtx, &globalCtx->colCtx, sp38.x, temp_a3, &sp38.y, &sp44) != 0) && (this->actor.world.pos.y < sp38.y)) {
                EffectSsGSplash_Spawn(globalCtx, &sp38, NULL, NULL, (s16) 1, (s16) (s32) (Rand_ZeroFloat(this->actor.speedXZ * 40.0f) + (this->actor.speedXZ * 60.0f)));
            }
...
block_8:
        Audio_PlayActorSound2(&this->actor, 0x2995U);
    }
    temp_a2 = &this->unk144;
    if ((this->unk30A & 1) != 0) {
    ...
    if ((temp_v1 & 4) != 0) {
        ...
        if (ActorCutscene_GetCanPlayNext((this + (this->unk31A * 2))->unk30C) != 0) {
            ActorCutscene_StartAndSetUnkLinkFields((this + (this->unk31A * 2))->unk30C, &this->actor);
            this->unk30A &= 0xFFFB;
            return;
        }
        ActorCutscene_SetIntentToPlay((this + (this->unk31A * 2))->unk30C);
...
void EnZog_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk30A & 8) != 0) {
        ...
        temp_a2->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, NULL, func_80B95598, &this->actor, temp_v0);
        return;
    }
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80B954C4, &this->actor);
}
