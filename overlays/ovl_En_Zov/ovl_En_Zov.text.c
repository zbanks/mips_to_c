typedef struct EnZov {
    ...
    /* 0x148 */ Vec3s unk_148;                      /* inferred */
    /* 0x14E */ char pad_14E[0x84];                 /* maybe part of unk_148[23]? */
    /* 0x1D2 */ Vec3s unk_1D2;                      /* inferred */
    /* 0x1D8 */ char pad_1D8[0x84];                 /* maybe part of unk_1D2[23]? */
    /* 0x25C */ SkelAnime unk_25C;                  /* inferred */
    /* 0x2A0 */ ColliderCylinder unk_2A0;           /* inferred */
    /* 0x2EC */ s16 unk_2EC;                        /* inferred */
    /* 0x2EE */ s16 unk_2EE;                        /* inferred */
    /* 0x2F0 */ Vec3s unk_2F0;                      /* inferred */
    /* 0x2F6 */ Vec3s unk_2F6;                      /* inferred */
    /* 0x2FC */ Vec3f unk_2FC;                      /* inferred */
    /* 0x308 */ Vec3f unk_308;                      /* inferred */
    /* 0x314 */ Vec3f unk_314;                      /* inferred */
    /* 0x320 */ u16 unk_320;                        /* inferred */
    /* 0x322 */ s16 unk_322;                        /* inferred */
    /* 0x324 */ s16 unk_324;                        /* inferred */
    /* 0x326 */ s16 unk_326;                        /* inferred */
...
void EnZov_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk_2A0, (Actor *) this, &D_80BD26E0);
    temp_a1 = &this->unk_25C;
    sp34 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_06016258, &D_0600D3EC, &this->unk_148, &this->unk_1D2, 0x17);
    ...
    this->unk_328 = (s16) this->actor.cutscene;
    sp34 = (SkelAnime *) temp_a1_2;
    Math_Vec3f_Copy(&this->unk_2FC, (Vec3f *) temp_a1_2);
    Math_Vec3f_Copy(&this->unk_308, (Vec3f *) temp_a1_2);
    Math_Vec3f_Copy(&this->unk_314, (Vec3f *) temp_a1_2);
...
void EnZov_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnZov *this = (EnZov *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_2A0);
}
...
void func_80BD13DC(EnZov *arg0) {
    ...
    if (arg0->unk_32C != -1) {
        arg0 = arg0;
        temp_a0 = (arg0 + (arg0->unk_32C * 2))->unk_328;
...
void func_80BD1470(EnZov *arg0, s16 arg1, u8 arg2, f32 arg3) {
    ...
    if (((arg1 != arg0->unk_322) || (arg2 != 0)) && ((s32) arg1 >= 0) && ((s32) arg1 < 0xE)) {
        if (arg1 != 6) {
            if (arg1 != 7) {
                phi_f0 = 0.0f;
            } else {
...
void func_80BD160C(EnZov *arg0, GlobalContext *arg1) {
    ...
    if ((gSaveContext.weekEventReg[53] & 0x20) != 0) {
        ...
        temp_v0_2 = arg0->unk_320;
        phi_s1 = 0x1022;
        if ((temp_v0_2 & 4) != 0) {
            phi_s1 = 0x1023;
        } else {
            arg0->unk_320 = temp_v0_2 | 4;
...
void func_80BD19FC(EnZov *this, GlobalContext *globalCtx) {
    ...
    if (func_801378B8(&this->unk_25C, 10.0f) != 0) {
        this->unk_2EE = 3;
        this->unk_320 &= 0xFFFD;
    }
}
...
s32 func_80BD1AE0(EnZov *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x1F8U) != 0) {
        ...
        if (temp_v1 != arg0->unk_326) {
            arg0->unk_326 = temp_v1;
            temp_v0 = arg0->unk_326;
            if (temp_v0 != 1) {
                if (temp_v0 != 2) {
                    if (temp_v0 != 3) {
                        if (temp_v0 != 4) {
...
void EnZov_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (((this->unk_320 & 1) != 0) && (func_80BD15A4((Actor *) this, globalCtx) != 0)) {
        func_800E9250(globalCtx, (Actor *) this, &this->unk_2F0, &this->unk_2F6, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    } else {
        if (((this->unk_320 & 0x10) != 0) && (this->unk_322 == 0)) {
            Math_SmoothStepToS((s16 *) &this->unk_2F0, -0x1B58, 6, 0x1838, (s16) 0x64);
        } else {
            Math_SmoothStepToS((s16 *) &this->unk_2F0, 0, 6, 0x1838, (s16) 0x64);
        }
        Math_SmoothStepToS(&this->unk_2F0.y, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS((s16 *) &this->unk_2F6, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS(&this->unk_2F6.y, 0, 6, 0x1838, (s16) 0x64);
    }
    ...
    if ((this->unk_32C != -1) && (temp_v1_2 = this->unk_32C, (ActorCutscene_GetCurrentIndex() != (this + (temp_v1_2 * 2))->unk_328))) {
        if ((temp_v1_2 == 0) && (ActorCutscene_GetCurrentIndex() == 0x7C)) {
            ActorCutscene_Stop(0x7C);
            ActorCutscene_SetIntentToPlay((this + (this->unk_32C * 2))->unk_328);
            return;
        }
        if (ActorCutscene_GetCanPlayNext((this + (this->unk_32C * 2))->unk_328) != 0) {
            ActorCutscene_Start((this + (this->unk_32C * 2))->unk_328, (Actor *) this);
            return;
        }
        ActorCutscene_SetIntentToPlay((this + (this->unk_32C * 2))->unk_328);
...
s32 func_80BD2380(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    if (arg1 == 0xC) {
        arg4->x += arg5->unk_2F2;
        if (((arg5->unk_320 & 0x10) != 0) && (arg5->unk_322 == 0)) {
            arg4->z += arg5->unk_2F0;
        }
    }
    if (arg1 == 0xB) {
...
void EnZov_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_t8 = (u16) this->unk_322;
    temp_a0_2 = this->unk_2EC;
    temp_f6 = (s32) this->unk_25C.animCurrentFrame;
    ...
    switch (temp_t8) {
    case 0:
        if ((temp_a0_2 == 0) && ((this->unk_320 & 0x10) == 0)) {
            phi_v1 = 1U;
        }
        break;
    case 5:
