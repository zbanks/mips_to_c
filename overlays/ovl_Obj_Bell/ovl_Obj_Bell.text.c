struct _mips2c_stack_ObjBell_Destroy {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjBell_Draw {
    /* 0x00 */ char pad0[0x24];
    /* 0x24 */ ? sp24;                              /* inferred */
    /* 0x24 */ char pad24[0xC];
    /* 0x30 */ ? sp30;                              /* inferred */
...
struct _mips2c_stack_ObjBell_Init {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_ObjBell_Update {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A35510 {
    /* 0x00 */ char pad0[0x24];
...
struct _mips2c_stack_func_80A356D8 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A357A8 {
    /* 0x00 */ char pad0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A358FC {
    /* 0x00 */ char pad0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A359B4 {
    /* 0x00 */ char pad0[0x24];
    /* 0x24 */ Gfx *sp24;                           /* inferred */
    /* 0x28 */ char pad28[0x8];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80A35B18 {
    /* 0x00 */ char pad0[0x24];
    /* 0x24 */ Gfx *sp24;                           /* inferred */
    /* 0x28 */ char pad28[0x8];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80A35BD4 {
    /* 0x00 */ char pad0[0x1C];
...
block_19:
    ...
    if (phi_a3 == 1) {
        arg0 = arg0;
        sp24 = phi_a3;
        Math_Vec3s_ToVec3f((Vec3f *) &sp34, temp_a1);
        Math_Vec3f_Copy((Vec3f *) &sp28, arg0 + 0x24);
        temp_v1 = arg0->unk_20C;
        arg0->dyna.actor.world.rot.y = Math_Vec3f_Yaw((Vec3f *) &sp34, (Vec3f *) &sp28);
...
s32 func_80A357A8(ObjBell *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 & 2) != 0) {
        ...
        if ((phi_v0 < 0x3FFC) && (this->unk_214 == 0) && (temp_f0 > 0.18f)) {
            func_800B8D98(globalCtx, (Actor *) this, 8.0f * temp_f0, temp_a3, 11.0f * temp_f0);
            this->unk_214 = 0x1E;
        }
    }
    ...
    if ((temp_v1_2 & 2) != 0) {
        ...
        if (temp_v0_2 != 0xE) {
            if (temp_v0_2 == 0xF) {
                Audio_PlayActorSound2((Actor *) this, 0x28F3U);
...
void ObjBell_Init(ObjBell *this, GlobalContext *globalCtx) {
    ObjBell *this = (ObjBell *) thisx;
    BcCheck3_BgActorInit((DynaPolyActor *) this, 0);
    BgCheck3_LoadMesh(globalCtx, (DynaPolyActor *) this, &D_06001BA8);
    Actor_SetScale((Actor *) this, 0.08f);
    Collider_InitAndSetSphere(globalCtx, &this->collider1, (Actor *) this, &D_80A35E90);
    Collider_InitAndSetSphere(globalCtx, &this->collider2, (Actor *) this, &D_80A35EBC);
    CollisionCheck_SetInfo2(&this->dyna.actor.colChkInfo, &D_80A35EF4, &D_80A35EE8);
}

void ObjBell_Destroy(ObjBell *this, GlobalContext *globalCtx) {
...
void ObjBell_Update(ObjBell *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    ObjBell *this = (ObjBell *) thisx;
...
void ObjBell_Draw(ObjBell *this, GlobalContext *globalCtx) {
    ? sp30;
    ? sp24;
    ObjBell *this = (ObjBell *) thisx;

    func_80A35B18(this, (GraphicsContext **) globalCtx);
    func_80A35BD4(this, (GraphicsContext **) globalCtx);
    func_80A359B4(this, (GraphicsContext **) globalCtx);
    Math_Vec3s_ToVec3f((Vec3f *) &sp30, (Vec3s *) &this->collider1.dim);
    SysMatrix_MultiplyVector3fByState((Vec3f *) &sp30, (Vec3f *) &sp24);
    Math_Vec3f_ToVec3s((Vec3s *) &this->collider1.dim.worldSphere, (Vec3f *) &sp24);
    Math_Vec3s_ToVec3f((Vec3f *) &sp30, (Vec3s *) &this->collider2.dim);
    SysMatrix_MultiplyVector3fByState((Vec3f *) &sp30, (Vec3f *) &sp24);
    Math_Vec3f_ToVec3s((Vec3s *) &this->collider2.dim.worldSphere, (Vec3f *) &sp24);
}
