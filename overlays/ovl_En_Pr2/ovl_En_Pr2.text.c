typedef struct EnPr2 {
    ...
    /* 0x1CA */ char pad_1CA[0x2];
    /* 0x1CC */ Path *unk_1CC;                      /* inferred */
    /* 0x1D0 */ char pad_1D0[0x4];
    /* 0x1D4 */ s16 unk_1D4;                        /* inferred */
    /* 0x1D6 */ s16 unk_1D6;                        /* inferred */
    ...
    /* 0x1E8 */ char pad_1E8[0x4];                  /* maybe part of unk_1E6[3]? */
    ...
    /* 0x234 */ char pad_234[0x3C];                 /* maybe part of unk_228[6]? */
...
void EnPr2_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_1E0 = this->actor.params & 0xF;
    Math_Vec3f_Copy(&this->unk_228, (Vec3f *) &this->actor.home);
    if (this->unk_1E0 == 2) {
        this->unk_208 = (f32) (((s32) this->actor.params >> 4) & 0xFF) * 20.0f;
    }
    this->unk_1F4 = 0xFF;
    this->actor.shape.yOffset = 500.0f;
    this->actor.shape.shadowScale = 12.0f;
    if ((s32) this->unk_1E0 < 0xA) {
        ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 19.0f);
        Collider_InitAndSetCylinder(globalCtx, &this->unk_27C, (Actor *) this, &D_80A75BE0);
...
void func_80A74510(EnPr2 *arg0, s32 arg1) {
    ...
    sp30 = temp_v1;
    sp34 = 1.0f;
    arg0->unk_1F8 = (f32) SkelAnime_GetFrameCount(*temp_v1);
    phi_f0 = 1.0f;
    if (arg0->unk_210 == 3) {
        phi_f0 = 0.0f;
    }
    SkelAnime_ChangeAnim(arg0 + 0x144, (AnimationHeader *) *temp_v1, phi_f0, 0.0f, arg0->unk_1F8, (u8) (s32) *(&D_80A75C38 + arg1), 0.0f);
}
...
void func_80A74DEC(EnPr2 *arg0, EnPr2 *arg1) {
    ...
    temp_a2 = &arg0->unk_21C;
    sp20 = temp_a2;
    Math_Vec3f_Copy(temp_a2, sp24 + 0x24);
    arg0->unk_1EE = Math_Vec3f_Yaw((Vec3f *) &arg0->actor.world, sp20);
    arg0->unk_20C = Rand_ZeroFloat(30.0f);
    arg0->unk_1DC = 0;
    arg0->unk_1D8 = 0x46;
    arg0->unk_1D4 = 2;
...
void func_80A74E90(EnPr2 *arg0, GlobalContext *arg1) {
    ...
    Math_ApproachF(&arg0->unk_204, 0.02f, 0.1f, 0.005f);
    if ((arg0->unk_1D8 == 0) || ((sp44->unk_A6C * 0x10) >= 0) || (arg0->unk_1E0 == 0)) {
        func_80A74888(arg0);
        return;
    }
    if (arg0->unk_1F4 != 0xFF) {
        arg0->actor.speedXZ = 0.0f;
        Math_SmoothStepToS(&arg0->unk_1F4, 0, 1, 0x1E, (s16) 0x64);
        if ((s32) arg0->unk_1F4 < 2) {
    ...
    if ((arg0->unk_1DC == 0) && (fabsf((f32) (arg0->actor.world.rot.y - arg0->unk_1EE)) < 200.0f)) {
        Math_Vec3f_Copy(&arg0->unk_21C, (Vec3f *) &sp44->world);
    }
    if ((Rand_ZeroOne() < 0.3f) && (arg0->unk_1D6 == 0)) {
        arg0->unk_1D6 = 1;
        arg0->unk_20C = Rand_ZeroFloat(30.0f);
    }
    arg0->unk_21C.y = sp44->world.pos.y + 30.0f + arg0->unk_20C;
    Math_ApproachF(&arg0->actor.speedXZ, 5.0f, 0.3f, 1.0f);
    arg0->unk_1F0 = 0;
    if (arg0->unk_1E0 == 2) {
        temp_f14 = arg0->actor.world.pos.x;
        temp_f2 = temp_f14 - arg0->unk_228.x;
        temp_f12 = arg0->actor.world.pos.z - arg0->unk_228.z;
        if (arg0->unk_208 < sqrtf((temp_f2 * temp_f2) + (temp_f12 * temp_f12))) {
            arg0->unk_1DE = 0x14;
    ...
    Math_Vec3f_Copy(&arg0->unk_228, (Vec3f *) &arg0->actor.world);
block_17:
    if (func_800CA1AC(arg1, &arg1->colCtx, arg0->actor.world.pos.x, arg0->actor.world.pos.z, &arg0->unk_200, &sp40) != 0) {
        temp_f0 = arg0->unk_200 - 40.0f;
        if (temp_f0 < arg0->unk_21C.y) {
            arg0->unk_21C.y = temp_f0;
        }
    }
    if ((arg0->unk_1E0 == 1) && (func_80A7429C((Actor *) arg0, arg1) == 0)) {
        if (arg0->unk_1F4 == 0xFF) {
            arg0->unk_1F4 = 0xFE;
            return;
        }
    ...
    sp30 = &arg0->unk_21C;
    if ((arg0->unk_27C.base.atFlags & 2) != 0) {
        arg0->unk_1DC = Rand_S16Offset(0x1E, 0x1E);
        arg0->unk_1D8 = 0x64;
        if (arg0->unk_1E0 != 2) {
            func_80A74888(arg0);
        }
    ...
    arg0->unk_1EE = Math_Vec3f_Yaw((Vec3f *) sp2C, sp30);
    func_80A7436C((Actor *) arg0, arg0->unk_1EE);
}
...
void func_80A751B4(EnPr2 *arg0) {
    ...
    if ((s32) arg0->unk_1E0 < 0xA) {
        func_80A74510(arg0, 2);
    } else {
        temp_f0 = (f32) SkelAnime_GetFrameCount(&D_06003904);
        arg0->unk_1F8 = temp_f0;
        SkelAnime_ChangeAnim(&arg0->unk_144, (AnimationHeader *) &D_06003904, 1.0f, temp_f0, temp_f0, (u8) 2, 0.0f);
        arg0->unk_1D8 = Rand_S16Offset(0x14, 0x1E);
        arg0->unk_1E4 = 0x4000;
...
void func_80A75310(EnPr2 *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk_1E0 < 0xA) {
        phi_s0 = arg0;
        phi_s1 = 0;
        if (arg0->unk_1F8 <= arg0->unk_144.animCurrentFrame) {
            sp58 = &arg1->actorCtx;
            do {
                Actor_Spawn(sp58, arg1, 0x180, phi_s0->unk_234, phi_s0->unk_238, phi_s0->unk_23C, (s16) (s32) arg0->actor.world.rot.x, (s16) (s32) arg0->actor.world.rot.y, (s16) (s32) arg0->actor.world.rot.z, (s16) (phi_s1 + 0xA));
                temp_s1 = phi_s1 + 1;
                phi_s0 += 0xC;
                phi_s1 = temp_s1;
            } while (temp_s1 != 5);
    ...
    Math_SmoothStepToS(&arg0->actor.shape.rot.z, arg0->unk_1E4, 5, 0x2710, (s16) 0x3E8);
    Math_SmoothStepToS(&arg0->actor.shape.rot.y, arg0->unk_1E6, 5, 0x2710, (s16) 0x3E8);
    phi_s0_2 = 0;
    phi_s0_3 = 0;
    if ((Rand_ZeroOne() < 0.3f) && (arg0->unk_1D6 == 0)) {
        arg0->unk_1D6 = 1;
    }
    if (func_800CA1AC(arg1, &arg1->colCtx, arg0->actor.world.pos.x, arg0->actor.world.pos.z, &arg0->unk_200, &sp74) != 0) {
        temp_f0 = arg0->unk_200 - 15.0f;
    ...
    if ((arg0->unk_1D8 == 0) || (phi_s0_2 != 0)) {
        Math_SmoothStepToS(&arg0->unk_1F4, 0, 1, 0xF, (s16) 0x32);
        temp_s1_2 = &sp64;
        if ((s32) arg0->unk_1F4 < 2) {
...
void EnPr2_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_SetScale((Actor *) this, this->unk_204);
    this->actionFunc(this, globalCtx);
    temp_v0 = this->unk_1DA;
    if (temp_v0 != 0) {
        this->unk_1DA = temp_v0 - 1;
    }
    temp_v0_2 = this->unk_1D8;
    if (temp_v0_2 != 0) {
        this->unk_1D8 = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk_1DC;
    if (temp_v0_3 != 0) {
        this->unk_1DC = temp_v0_3 - 1;
    }
    temp_v0_4 = this->unk_1DE;
    if (temp_v0_4 != 0) {
        this->unk_1DE = temp_v0_4 - 1;
    }
    ...
    if (this->unk_1D6 != 0) {
        Math_Vec3f_Copy((Vec3f *) &sp58, &this->unk_270);
        this->unk_1D6 = 0;
    ...
    if ((this->unk_1F4 == 0xFF) && ((s32) this->unk_1E0 < 0xA)) {
        this->actor.shape.rot.x = this->actor.world.rot.x;
        this->actor.shape.rot.y = this->actor.world.rot.y;
        this->actor.shape.rot.z = this->actor.world.rot.z;
        if (this->unk_1D4 != 3) {
            temp_s0_2 = &this->unk_27C;
...
s32 func_80A758E8(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    temp_v0 = arg5->unk_1E0;
    if ((s32) temp_v0 < 0xA) {
        if (arg1 == 2) {
            arg4->y += -(s32) arg5->unk_1FC;
        }
...
void EnPr2_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_1F4 == 0xFF) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80A758E8, func_80A75950, (Actor *) this);
        return;
    }
    ...
    temp_s0->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80A759D8, NULL, (Actor *) this, temp_s0->polyXlu.p);
}
