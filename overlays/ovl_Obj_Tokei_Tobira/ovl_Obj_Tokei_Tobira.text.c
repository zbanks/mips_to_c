    ...
    if ((temp_v1->bgCheckFlags & 0x200) != 0) {
        ...
        if (BgCheck_GetActorOfMesh(&globalCtx->colCtx, (s32) temp_v1->wallBgId) == this) {
            ...
            if (temp_f0 > 20.0f) {
                if (sp3C > 0.0f) {
                    this->unk_168 = 1;
                    temp_a0_2 = this;
                    this->unk_160 += (temp_f0 - 20.0f) * temp_f14 * 5.3333335f;
                    if (this->unk_16C <= 0) {
                        this = this;
                        sp40 = temp_f0;
                        sp48 = temp_f14;
        ...
        if (this->unk_168 == 1) {
            ...
            if ((sp2C > 0.0f) && (sp2C < 30.0f)) {
                this->unk_168 = 1;
                this->unk_160 += temp_f14 * 290.0f;
            }
        }
    }
    temp_v0 = phi_a3->unk_16C;
    if (temp_v0 > 0) {
        phi_a3->unk_16C = temp_v0 - 1;
    }
    phi_a3->unk_168 = 0;
    phi_a3->unk_160 *= 0.87f;
    temp_f2 = phi_a3->unk_160;
    phi_a3->unk_164 += temp_f2;
    temp_f12 = phi_a3->unk_164 * phi_f14;
    if (temp_f12 > 14336.0f) {
        phi_a3->unk_160 = temp_f2 * 0.1f;
        phi_a3->unk_164 = 14336.0f * phi_f14;
        goto block_22;
    }
    if (temp_f12 < -1000.0f) {
        phi_a3->unk_160 = temp_f2 * 0.1f;
        phi_a3->unk_164 = -1000.0f * phi_f14;
block_22:
    }
    temp_v0_2 = phi_a3->actionFunc;
    phi_a3->actor.shape.rot.y = (s32) phi_a3->unk_164 + phi_a3->actor.home.rot.y;
    if (temp_v0_2 != 0) {
