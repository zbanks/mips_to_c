typedef struct DmTag {
    ...
    /* 0x198 */ char pad198[0x10];                  /* maybe part of unk194[5]? */
    /* 0x1A8 */ void *unk1A8;                       /* inferred */
} DmTag;                                            /* size = 0x1AC */
...
s32 func_80C2291C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk18C & 7) != 0) {
        ...
        if (func_800B84D0(arg0, arg1) != 0) {
            ...
            arg0->unk190 = func_80C22880(arg0, arg1);
            arg0->unk188 = func_80C229FC;
            phi_v1 = 1;
        }
    }
    return phi_v1;
...
void func_80C229FC(DmTag *this, GlobalContext *globalCtx) {
    if (func_8010BF58((Actor *) this, globalCtx, this->unk190, this->unk1A8, &this->unk194) != 0) {
        this->actionFunc = func_80C229AC;
    }
}

void DmTag_Init(DmTag *this, GlobalContext *globalCtx) {
    Actor *temp_v0;
    u16 *temp_a0;
    ...
    if ((globalCtx->sceneNum == 0x61) && (temp_a0 = &this->unk18C, (globalCtx->curSpawn == 4))) {
...
void DmTag_Destroy(DmTag *this, GlobalContext *globalCtx) {
    DmTag *this = (DmTag *) thisx;

}

void DmTag_Update(DmTag *this, GlobalContext *globalCtx) {
    DmTag *this = (DmTag *) thisx;
    func_80C2291C((Actor *) this, globalCtx);
    this->actionFunc(this, globalCtx);
    func_8013C964((Actor *) this, globalCtx, 40.0f, fabsf(this->actor.yDistToPlayer) + 1.0f, 0, (s16) (this->unk18C & 7));
