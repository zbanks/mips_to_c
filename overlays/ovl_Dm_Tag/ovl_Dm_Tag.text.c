...
typedef struct DmTag {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ char pad144[0x44];
    /* 0x0188 */ void (*actionFunc)(DmTag *, GlobalContext *);
    ...
    /* 0x0198 */ char pad198[0x10];                 /* maybe part of unk194[5]? */
    /* 0x01A8 */ void *unk1A8;                      /* inferred */
} DmTag;                                            /* size 0x1AC */
...
void func_80C229FC(DmTag *this, GlobalContext *globalCtx) {
    if (func_8010BF58(&this->actor, globalCtx, this->unk190, this->unk1A8, &this->unk194) != 0) {
...
void DmTag_Update(Actor *thisx, GlobalContext *globalCtx) {
    DmTag *this = (DmTag *) thisx;
    func_80C2291C(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    func_8013C964(&this->actor, globalCtx, 40.0f, fabsf(this->actor.yDistToPlayer) + 1.0f, 0, (s16) (this->unk18C & 7));
