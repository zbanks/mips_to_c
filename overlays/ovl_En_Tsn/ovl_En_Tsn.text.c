typedef struct EnTsn {
    ...
    /* 0x188 */ char pad188[0x8];
    /* 0x190 */ SkelAnime unk190;                   /* inferred */
    /* 0x1D4 */ void (*actionFunc)(EnTsn *, GlobalContext *);
    /* 0x1D8 */ char pad1D8[0x48];                  /* maybe part of actionFunc[19]? */
    /* 0x220 */ u16 unk220;                         /* inferred */
    /* 0x222 */ Vec3s unk222;                       /* inferred */
...
void EnTsn_Init(EnTsn *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
    SkelAnime *temp_a1_2;
...
void EnTsn_Destroy(EnTsn *this, GlobalContext *globalCtx) {
    EnTsn *this = (EnTsn *) thisx;
...
block_30:
    ...
    if ((arg0->unk220 & 2) != 0) {
        ...
        if (temp_v1_2 != 0) {
            Math_SmoothStepToF((f32 *) &arg0->focus, temp_v1_2->unk3C, 0.8f, 100.0f, 5.0f);
...
void EnTsn_Update(EnTsn *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a2;
    s16 temp_v1;
    s16 phi_v0;
    ...
    if ((this->unk220 & 1) != 0) {
        func_800E9250(globalCtx, (Actor *) this, &this->unk222, &this->unk228, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    } else {
        Math_SmoothStepToS((s16 *) &this->unk222, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS(&this->unk222.y, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS((s16 *) &this->unk228, 0, 6, 0x1838, (s16) 0x64);
...
void func_80AE1024(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.unk0 = (s32) D_80AE11BC.unk0;
    sp18.unk4 = (s32) D_80AE11BC.unk4;
    sp18.unk8 = (s32) D_80AE11BC.unk8;
    if (arg1 == 0xF) {
        SysMatrix_MultiplyVector3fByState((Vec3f *) &sp18, arg4 + 0x3C);
    }
}

void EnTsn_Draw(EnTsn *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80AE0FA8, func_80AE1024, (Actor *) this);
}
