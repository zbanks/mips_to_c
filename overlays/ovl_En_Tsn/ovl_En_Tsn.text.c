Actor *func_80ADFCA0(GlobalContext *arg0, Actor *); /* static */
...
void func_80AE0F84(Actor *arg0, GlobalContext *globalCtx); /* static */
...
typedef struct EnTsn {
    ...
    /* 0x0188 */ char pad188[0x8];
    /* 0x0190 */ SkelAnime unk190;                  /* inferred */
    /* 0x01D4 */ void (*actionFunc)(EnTsn *, GlobalContext *);
    /* 0x01D8 */ char pad1D8[0x48];                 /* maybe part of actionFunc[19]? */
    /* 0x0220 */ u16 unk220;                        /* inferred */
...
void EnTsn_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->actor.params & 0x100) != 0) {
        func_80ADFCEC(&this->actor, globalCtx, func_800B3FC0);
        return;
    }
    ...
    Collider_SetCylinder(globalCtx, (ColliderCylinder *) temp_a1_2, &this->actor, &D_80AE1190);
...
void EnTsn_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnTsn *this = (EnTsn *) thisx;
    Collider_DestroyCylinder(globalCtx, (ColliderCylinder *) &this->unk144);
}
...
block_19:
        ...
        case 4231: // switch 2
            SkelAnime_ChangeAnimTransitionRepeat(arg0 + 0x190, &D_06001198, -10.0f);
            func_80151938(arg1, (sp2C->unk680C + 1) & 0xFFFF);
            return;
        case 4232: // switch 2
            gSaveContext.weekEventReg[26] |= 1;
...
void func_80AE0304(EnTsn *arg0, GlobalContext *arg1) {
    if (func_800B84D0(&arg0->actor, arg1) != 0) {
        ...
        if (arg0->actor.textId == 0) {
            func_80ADFF84(&arg0->actor, arg1);
        }
    } else if ((arg0->actor.xzDistToPlayer < 150.0f) && (Actor_IsLinkFacingActor(&arg0->actor, 0x3000, arg1) != 0)) {
        func_800B8614(&arg0->actor, arg1, 160.0f);
        arg0->unk220 |= 1;
    } else {
        arg0->unk220 &= 0xFFFE;
    }
...
void func_80AE04FC(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_80152498(temp_a2 + 0x4908) == 0x10) {
        ...
        if (temp_v0 < 0) {
            ...
            SkelAnime_ChangeAnimTransitionRepeat(arg0->unk1D8 + 0x190, &D_06001198, -10.0f);
            arg0->unk1D4 = func_80AE0704;
        }
...
void func_80AE0698(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk1D4 = func_80AE0C88;
    arg0->unk220 = (u16) (arg0->unk220 & 0xFFFD);
...
void func_80AE0704(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((temp_v0 & 8) != 0) && (arg1->msgCtx.unk11F04 == 0x1078)) {
        arg0->unk220 = (u16) (temp_v0 & 0xFFF7);
        arg1 = arg1;
        SkelAnime_ChangeAnimTransitionRepeat(arg0->unk1D8 + 0x190, &D_06001198, -10.0f);
    }
    arg1 = arg1;
        ...
        if (temp_v0_2 == 5) {
            ...
            if (func_80147624(temp_a0) != 0) {
                ...
                case 4206:
                    ...
                    arg0->unk220 = (u16) (arg0->unk220 | 2);
                    gSaveContext.weekEventReg[25] |= 0x40;
                    arg0->unk1D8->unk18 = 1;
                    arg0->unk220 = (u16) (arg0->unk220 | 4);
                    break;
                case 4207:
                case 4208:
                case 4209:
                ...
                case 4217:
                    arg1 = arg1;
                    sp2C = temp_v0_3;
                    SkelAnime_ChangeAnimTransitionRepeat(arg0->unk1D8 + 0x190, &D_06000964, -10.0f);
                    func_80151938(arg1, (temp_v0_3->unk680C + 1) & 0xFFFF);
                    break;
                case 4218:
                ...
                case 4216:
                    sp3C->unkA87 = 0;
                    func_80151938(arg1, (temp_v0_3->unk680C + 1) & 0xFFFF);
                    SkelAnime_ChangeAnimTransitionRepeat(arg0->unk1D8 + 0x190, &D_060092FC, -10.0f);
                    break;
                case 4220:
                    arg1 = arg1;
                    if (func_80114E90() != 0) {
...
block_30:
    ...
    if ((arg0->unk220 & 2) != 0) {
        temp_v1_2 = arg0->unk1D8;
        if (temp_v1_2 != 0) {
            Math_SmoothStepToF(&arg0->focus.pos.x, temp_v1_2->unk3C, 0.8f, 100.0f, 5.0f);
            Math_SmoothStepToF(&arg0->focus.pos.y, arg0->unk1D8->unk40, 0.8f, 100.0f, 5.0f);
            Math_SmoothStepToF(&arg0->focus.pos.z, arg0->unk1D8->unk44, 0.8f, 100.0f, 5.0f);
        }
    }
    if ((arg0->unk220 & 4) != 0) {
        if (arg0->cutscene == -1) {
            arg0->unk220 = (u16) (arg0->unk220 & 0xFFFB);
            return;
        }
...
void EnTsn_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 25.0f, 0.0f, 4U);
    SkelAnime_FrameUpdateMatrix(&this->unk190);
    if ((this->unk220 & 1) != 0) {
        func_800E9250(globalCtx, &this->actor, &this->unk222, &this->unk228, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    } else {
        Math_SmoothStepToS(&this->unk222.x, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS(&this->unk222.y, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS(&this->unk228.x, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS(&this->unk228.y, 0, 6, 0x1838, (s16) 0x64);
    }
    temp_v1 = this->unk230;
    if (temp_v1 == 0) {
        phi_v0 = 0;
    } else {
        this->unk230 = temp_v1 - 1;
        phi_v0 = this->unk230;
    }
    phi_v1 = this->unk230;
    if (phi_v0 == 0) {
        this->unk230 = Rand_S16Offset(0x3C, 0x3C);
        phi_v1 = this->unk230;
    }
...
void func_80AE1024(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.x = D_80AE11BC.unk0;
    sp18.y = D_80AE11BC.unk4;
    sp18.z = D_80AE11BC.unk8;
    if (arg1 == 0xF) {
...
void EnTsn_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp3C = sp3C;
    sp34 = temp_v0;
    sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_80AE11C8 + (this->unk22E * 4)));
    temp_v0_2 = sp3C->polyOpa.p;
    sp3C->polyOpa.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xDB060024;
    sp30 = temp_v0_2;
    sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80AE11C8 + (this->unk22E * 4)));
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80AE0FA8, func_80AE1024, &this->actor);
}
