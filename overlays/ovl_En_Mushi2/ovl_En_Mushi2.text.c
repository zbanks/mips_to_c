typedef struct EnMushi2 {
    ...
    /* 0x2A8 */ SkelAnime unk2A8;                   /* inferred */
    /* 0x2EC */ char pad2EC[0x1C];
    ...
    /* 0x334 */ CollisionPoly *unk334;              /* inferred */
    /* 0x338 */ s32 unk338;                         /* inferred */
    /* 0x33C */ char pad33C[0xC];                   /* maybe part of unk338[4]? */
    /* 0x348 */ f32 unk348;                         /* inferred */
    /* 0x34C */ void *unk34C;                       /* inferred */
    /* 0x350 */ f32 unk350;                         /* inferred */
    /* 0x354 */ f32 unk354;                         /* inferred */
    /* 0x358 */ f32 unk358;                         /* inferred */
    /* 0x35C */ f32 unk35C;                         /* inferred */
    /* 0x360 */ char pad360[0x8];                   /* maybe part of unk35C[3]? */
    /* 0x368 */ s16 unk368;                         /* inferred */
    /* 0x36A */ s16 unk36A;                         /* inferred */
    /* 0x36C */ char pad36C[0x2];
    /* 0x36E */ s16 unk36E;                         /* inferred */
    /* 0x370 */ s16 unk370;                         /* inferred */
    /* 0x372 */ char pad372[0x2];
} EnMushi2;                                         /* size = 0x374 */
...
void EnMushi2_Init(EnMushi2 *this, GlobalContext *globalCtx) {
    s32 sp3C;
    SkelAnime *sp34;
    SkelAnime *temp_a1;
    SkelAnime *temp_a1_2;
    ...
    Collider_SetJntSph(globalCtx, (ColliderJntSph *) temp_a1_2, (Actor *) this, &D_80A6B974, (ColliderJntSphElement *) &this->unk2A8.limbDrawTbl);
    func_80A68808(this);
...
void EnMushi2_Destroy(EnMushi2 *this, GlobalContext *globalCtx) {
    EnMushi2 *this = (EnMushi2 *) thisx;
...
void EnMushi2_Update(EnMushi2 *this, GlobalContext *globalCtx) {
    f32 sp4C;
    ...
    if (this->actor.update != 0) {
        ...
        if ((this->actor.flags & 0x40) != 0) {
            ...
            if ((func_80A6AE7C != temp_v0_10) && (func_80A6B0D8 != temp_v0_10) && ((func_80A6A36C != temp_v0_10) || ((s32) this->unk36A < 0xDD)) && (((sp30 != temp_v0_10) && (func_80A6A824 != temp_v0_10) && (func_80A6A9E4 != temp_v0_10)) || !(this->unk358 > 0.999f) || !(this->unk354 < 400.0f))) {
                phi_v0 = 1;
                if (this->unk34C == 0) {
                    this->unk2BA = (u8) (this->unk2BA | 8);
                } else {
                    this->unk2BA = (u8) (this->unk2BA & 0xFFF7);
...
void EnMushi2_Draw(EnMushi2 *this, GlobalContext *globalCtx) {
    EnMushi2 *this = (EnMushi2 *) thisx;
    func_80A687A0(this);
