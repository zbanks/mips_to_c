...
static InitChainEntry D_80896B50;                   /* unable to generate initializer */
...
typedef struct EnTite {
    ...
    /* 0x018E */ char pad18E[0x90];                 /* maybe part of unk188[25]? */
    /* 0x021E */ Vec3s unk21E;                      /* inferred */
    /* 0x0224 */ char pad224[0x90];                 /* maybe part of unk21E[25]? */
    /* 0x02B4 */ void (*actionFunc)(EnTite *, GlobalContext *);
    /* 0x02B8 */ char pad2B8[0x1];
    /* 0x02B9 */ u8 unk2B9;                         /* inferred */
    /* 0x02BA */ char pad2BA[0x1];                  /* maybe part of unk2B9[2]? */
    /* 0x02BB */ u8 unk2BB;                         /* inferred */
    /* 0x02BC */ s16 unk2BC;                        /* inferred */
    /* 0x02BE */ s16 unk2BE;                        /* inferred */
    /* 0x02C0 */ u32 unk2C0;                        /* inferred */
    /* 0x02C4 */ f32 unk2C4;                        /* inferred */
    /* 0x02C8 */ f32 unk2C8;                        /* inferred */
    /* 0x02CC */ f32 unk2CC;                        /* inferred */
    /* 0x02D0 */ Vec3f unk2D0;                      /* inferred */
    /* 0x02DC */ char pad2DC[0xD0];
    /* 0x03AC */ ColliderSphere unk3AC;             /* inferred */
} EnTite;                                           /* size 0x404 */
...
void EnTite_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80896B50);
    SkelAnime_Init(globalCtx, &this->unk144, &D_06003A20, &D_060012E4, &this->unk188, &this->unk21E, 0x19);
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk3AC, &this->actor, &D_80896AD0);
    this->unk2C0 = 0x1D;
    this->unk3AC.dim.worldSphere.radius = D_80896AD0.dim.modelSphere.radius;
    phi_s3 = &D_80896B24;
    if (D_80896B60 == 0) {
        do {
            phi_s0 = phi_s3;
...
void EnTite_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnTite *this = (EnTite *) thisx;
    Collider_DestroySphere(globalCtx, &this->unk3AC);
}

void func_80893A18(Actor *arg0) {
    arg0->unk3C0 = 6;
    arg0->unk3BD = (u8) (arg0->unk3BD & 0xFFFB);
}
    ...
    if ((arg0->bgCheckFlags & 2) != 0) {
        ...
        if ((temp_v0 == 0) || (temp_v0 == 1)) {
            ...
            do {
                phi_s0 = 0;
loop_9:
                sp7C = randPlusMinusPoint5Scaled(1.0f) + phi_s1->unk0;
                sp80 = randPlusMinusPoint5Scaled(1.0f) + phi_s1->unk4;
                sp84 = randPlusMinusPoint5Scaled(1.0f) + phi_s1->unk8;
...
void func_80893ED4(EnTite *arg0) {
    ...
    arg0->unk2BC = Rand_S16Offset(0xF, 0x1E);
...
void func_808942B4(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((((arg0->bgCheckFlags & 1) != 0) || ((phi_a3 = arg1, (func_80893ADC(arg0) != 0)) && (arg0->yDistToWater > 0.0f))) && (phi_a3 = arg1, (arg0->velocity.y <= 0.0f))) {
        arg0->speedXZ = 0.0f;
        arg0->unk3BC = (u8) (arg0->unk3BC & 0xFFFD);
        if (func_80893ADC(arg0) == 0) {
    ...
    if ((temp_v0 & 2) == 0) {
        ...
        CollisionCheck_SetAT(phi_a3, phi_a3 + 0x18884, arg0 + 0x3AC);
        return;
    }
    arg0->unk3BC = (u8) (temp_v0 & 0xFFFD);
    func_80894B2C(arg0);
}

void func_80894414(Actor *arg0) {
    SkelAnime_ChangeAnimDefaultStop(arg0 + 0x144, &D_0600069C);
    arg0->unk2B4 = func_80894454;
}
...
void func_8089452C(Actor *arg0, GlobalContext *arg1) {
    ...
    sp2C.y += arg0->yDistToWater;
    arg0->velocity.y *= 0.75f;
    EffectSsGRipple_Spawn(arg1, &sp2C, 0, 0x1F4, (s16) 0);
    Audio_PlayActorSound2(arg0, 0x388AU);
    arg0->unk2B4 = func_808945B4;
}
...
void func_80894638(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->world.rot.y = arg0->shape.rot.y;
    temp_a0 = arg0 + 0x144;
    arg0->unk160 = (f32) ((f32) temp_v1 * 0.01f);
    sp24 = temp_a0;
...
void func_8089484C(Actor *arg0) {
    ...
    sp24 = func_80894910;
    if (func_80894910 != arg0->unk2B4) {
        arg0->unk2B8 = Rand_S16Offset(1, 3);
    }
...
void func_80894910(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->bgCheckFlags & 0x40) != 0) {
        ...
        if (func_80893ADC(arg0) != 0) {
            ...
            sp34.y += arg0->yDistToWater;
            arg0->velocity.y *= 0.75f;
            EffectSsGRipple_Spawn(arg1, &sp34, 0, 0x1F4, (s16) 0);
        }
    } else {
        func_80893BCC(arg0, arg1);
    }
...
void func_80894E0C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg0;
    temp_v0 = temp_a2->unk2BC;
    temp_a0 = temp_a2;
    if (temp_v0 != 0) {
        temp_a2->unk2BC = (s16) (temp_v0 - 1);
    }
    arg0 = temp_a2;
    temp_a2_2 = arg0;
...
void func_80895020(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk2BA = 1;
    Item_DropCollectibleRandom(arg1, arg0, temp_s5, arg0->unk2BE);
    arg0->unk2BC = 0x19;
    arg0->velocity.y = 0.0f;
    arg0->speedXZ = 0.0f;
    arg0->gravity = -0.58f;
    ...
    phi_s1 = 0;
    do {
        Math_Vec3f_Diff(phi_s2, temp_s5, &sp74);
        temp_f0 = Math3D_Vec3fMagnitude(&sp74);
        phi_f2 = temp_f0;
        if (temp_f0 > 1.0f) {
            phi_f2 = 1.2f / temp_f0;
        }
        phi_s0->unk0 = (f32) (sp74.x * phi_f2);
        phi_s0->unk8 = (f32) (sp74.z * phi_f2);
        temp_s1 = phi_s1 + 0xC;
        temp_s0 = phi_s0 + 0xC;
        temp_s0->unk-8 = (f32) (Rand_ZeroFloat(3.5f) + 5.5f);
        phi_s2 += 0xC;
        phi_s0 = temp_s0;
        phi_s1 = temp_s1;
    } while (temp_s1 != 0x6C);
    arg0->unk2B4 = func_808951B8;
}
...
void func_808951B8(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        temp_s1_2->unk334 = (f32) (phi_s1_2->unk340 + arg0->gravity);
        phi_s0_2 += 0xC;
        phi_s3 += 0xC;
        phi_s1_2 = temp_s1_2;
        phi_s2 = temp_s2;
...
void func_808952EC(Actor *arg0) {
    ...
    arg0->speedXZ = 0.0f;
    arg0->gravity = -1.0f;
    arg0->unk2B8 = (s8) (u32) (Rand_ZeroOne() * 50.0f);
    arg0->bgCheckFlags &= 0xFFFE;
    arg0->unk2B4 = func_80895424;
...
void func_80895424(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk2B8;
    if (temp_v0 != 0) {
        arg0->unk2B8 = (u8) (temp_v0 - 1);
    } else {
        arg0->unk2B8 = (u8) (u32) (Rand_ZeroOne() * 30.0f);
        arg0->unk15C = (f32) (Rand_ZeroOne() * 5.0f);
    }
    SkelAnime_FrameUpdateMatrix(arg0 + 0x144);
    ...
    if ((temp_v0_2 & 1) != 0) {
        ...
        temp_v0_3 = arg0->unk2BC;
        if (temp_v0_3 == 0) {
            func_808955E4(arg0);
            return;
        }
        arg0->unk2BC = (s16) (temp_v0_3 - 1);
        return;
    }
...
void func_808956B8(Actor *arg0) {
    arg0->unk2BC = 0x190;
    arg0->unk3C0 = 0xC;
    arg0->unk3BD = (u8) (arg0->unk3BD | 4);
    arg0->unk2B4 = func_80895738;
...
void func_80895738(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0_2 == -1) {
        ...
        arg0->unk2BC = (s16) (temp_v0_2 - 1);
        Math_StepToF(&arg0->speedXZ, 10.0f, 0.3f);
        arg0->flags |= 0x1000000;
        CollisionCheck_SetAT(arg1, &arg1->colChkCtx, arg0 + 0x3AC);
...
void func_80895AC0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_a0_2 == 1) || (temp_a0_2 == -1)) {
        ...
        if ((arg0->bgCheckFlags & 8) != 0) {
            ...
            if (phi_v0 >= 0x3001) {
                arg0->unk2BC = (s16) ((phi_v0 >> 9) * temp_a0_2);
            }
        } else {
            sp24 = (SkelAnime *) temp_a1;
            if (Actor_XZDistanceToPoint(arg0, &temp_a1->pos) < 200.0f) {
                temp_v1_2 = arg0->shape.rot.y - Actor_YawToPoint(arg0, &temp_a1->pos);
                phi_v0_2 = (s32) temp_v1_2;
                if ((s32) temp_v1_2 < 0) {
                    phi_v0_2 = -(s32) temp_v1_2;
                }
                if (phi_v0_2 >= 0x2001) {
                    arg0->unk2BC = (s16) ((phi_v0_2 >> 9) * arg0->unk2BC);
                }
            }
        }
    }
    ...
    temp_a0_3 = arg0->unk2BC;
    if ((s32) temp_a0_3 > 0) {
        arg0->unk2BC = (s16) (temp_a0_3 - 1);
...
void func_80895CB0(Actor *arg0) {
    ...
    arg0->world.rot.y = arg0->shape.rot.y;
    arg0 = arg0;
    arg0->unk2BC = Rand_S16Offset(0x14, 0x14);
    arg0->unk2B4 = func_80895D08;
}
...
void func_80895FF8(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk3BD;
    if ((temp_v0 & 2) != 0) {
        arg0->unk3BD = (u8) (temp_v0 & 0xFFFD);
        arg0->unk3BC = (u8) (arg0->unk3BC & 0xFFFD);
        if (arg0->unk3C0 == 0xC) {
            func_808956FC(arg0);
            func_800BE568(arg0, arg0 + 0x3AC);
            return;
        }
        func_800BE258(arg0, arg0 + 0x3C4);
        if ((arg0->unk2BB != 0xA) || ((*arg0->unk3E8 & 0xDB0B3) == 0)) {
...
void func_808963B4(EnTite *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 & 0x40) != 0) {
        do {
            Math_Vec3f_Copy(&sp48, phi_s1);
            sp48.y = arg0->actor.world.pos.y + arg0->actor.yDistToWater;
            EffectSsGRipple_Spawn(arg1, &sp48, 0, 0xDC, (s16) 0);
            temp_s0 = phi_s0 + 0xC;
            phi_s1 += 0xC;
            phi_s0 = temp_s0;
        } while (temp_s0 != 0x6C);
    ...
    if ((temp_v0 & 0x20) != 0) {
        ...
        if (((temp_v0_2 & 1) == 0) && (arg0->actor.yDistToWater < 10.0f)) {
            Math_Vec3f_Copy(&sp48, arg0 + ((temp_v0_2 >> 1) * 0xC) + 0x30C);
            sp48.y = arg0->actor.world.pos.y + arg0->actor.yDistToWater;
            EffectSsGRipple_Spawn(arg1, &sp48, 0, 0xDC, (s16) 0);
        }
    }
...
void EnTite_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80895FF8(&this->actor, globalCtx);
    this->actionFunc(this, globalCtx);
    if (func_808951B8 != this->actionFunc) {
        Actor_SetVelocityAndMoveYRotationAndGravity(&this->actor);
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 25.0f, 40.0f, 20.0f, this->unk2C0);
        ...
        this->unk3AC.dim.worldSphere.center.y = (s32) this->actor.world.pos.y + 0xF;
        this->unk3AC.dim.worldSphere.center.x = (s16) (s32) this->actor.world.pos.x;
        this->unk3AC.dim.worldSphere.center.z = (s16) (s32) this->actor.world.pos.z;
        if ((this->unk3AC.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, &this->unk3AC.base);
        }
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &this->unk3AC.base);
        if (this->unk2C4 > 0.0f) {
            if (this->unk2BB != 0xA) {
                Math_StepToF(&this->unk2C4, 0.0f, 0.05f);
                temp_f0_2 = (this->unk2C4 + 1.0f) * 0.25f;
            ...
            if (Math_StepToF(&this->unk2CC, 0.5f, 0.0125f) == 0) {
...
void func_80896788(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (*temp_v1_2 != -1) {
        ...
        temp_v0_4->mf[3][0] = (arg4 + (*temp_v1_2 * 0xC))->unk2D0;
        temp_v0_4->mf[3][1] = (arg4 + (*temp_v1_2 * 0xC))->unk2D4;
        temp_v0_4->mf[3][2] = (arg4 + (*temp_v1_2 * 0xC))->unk2D8;
        ...
        sp38->polyOpa.p = temp_v0_6 + 8;
        temp_v0_6->words.w0 = 0xDE000000;
        temp_v0_6->words.w1 = arg4->unk3A8;
    }
}
...
void EnTite_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.params == -2) {
        temp_v0->unk8 = 0xDB060020;
        temp_v0->unkC = (void *) D_80896B24.unk0;
        temp_v0->unk10 = 0xDB060024;
        temp_v0->unk14 = (s32) D_80896B24.unk4;
        temp_v0->unk18 = 0xDB060028;
        temp_v0->unk1C = (s32) D_80896B24.unk8;
    } else {
        temp_v0->unk8 = 0xDB060020;
        temp_v0->unkC = (void *) D_80896B24.unkC;
        temp_v0->unk10 = 0xDB060024;
        temp_v0->unk14 = (s32) D_80896B24.unk10;
        temp_v0->unk18 = 0xDB060028;
        temp_v0->unk1C = (s32) D_80896B24.unk14;
    }
    temp_t0->polyOpa.p = temp_v0 + 0x20;
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80896750, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80896788, &this->actor);
    func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk2D0, 9, this->unk2C8, this->unk2CC, this->unk2C4, (u8) (s32) this->unk2BB);
}
