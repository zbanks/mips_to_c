typedef struct EnTite {
    ...
    /* 0x18E */ char pad18E[0x90];                  /* maybe part of unk188[25]? */
    /* 0x21E */ Vec3s unk21E;                       /* inferred */
    /* 0x224 */ char pad224[0x90];                  /* maybe part of unk21E[25]? */
    /* 0x2B4 */ void (*actionFunc)(EnTite *, GlobalContext *);
    /* 0x2B8 */ char pad2B8[0x1];
    /* 0x2B9 */ u8 unk2B9;                          /* inferred */
    /* 0x2BA */ char pad2BA[0x1];
    /* 0x2BB */ u8 unk2BB;                          /* inferred */
    /* 0x2BC */ char pad2BC[0x2];                   /* maybe part of unk2BB[3]? */
    ...
    /* 0x2DC */ char pad2DC[0xD0];                  /* maybe part of unk2D0[18]? */
    /* 0x3AC */ ColliderSphere unk3AC;              /* inferred */
} EnTite;                                           /* size = 0x404 */
...
struct _mips2c_stack_func_80893BCC {
    ...
    /* 0x68 */ char pad68[0x14];                    /* maybe part of sp64[6]? */
...
void EnTite_Init(EnTite *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk3AC, (Actor *) this, &D_80896AD0);
    this->unk2C0 = 0x1D;
...
void func_80895020(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        phi_s0->unk0 = (f32) (sp74 * phi_f2);
        phi_s0->unk8 = (f32) (sp7C * phi_f2);
        temp_s1 = phi_s1 + 0xC;
        temp_s0 = phi_s0 + 0xC;
...
void EnTite_Update(EnTite *this, GlobalContext *globalCtx) {
    ...
    if (func_808951B8 != this->actionFunc) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 25.0f, 40.0f, 20.0f, this->unk2C0);
        ...
        if ((this->unk3AC.base.acFlags & 1) != 0) {
            CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk3AC);
        }
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk3AC);
        if (this->unk2C4 > 0.0f) {
            if (this->unk2BB != 0xA) {
...
void EnTite_Draw(EnTite *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_Draw(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, func_80896750, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80896788, (Actor *) this);
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2D0, 9, this->unk2C8, this->unk2CC, this->unk2C4, (u8) (s32) this->unk2BB);
}
