...
void EnZot_Init(EnZot *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
    s16 temp_v1;
    s16 temp_v1_2;
    ...
    this->unk2F0 = 0;
    Collider_InitAndSetCylinder(globalCtx, &this->unk188, (Actor *) this, &D_80B998E0);
...
void EnZot_Destroy(EnZot *this, GlobalContext *globalCtx) {
    EnZot *this = (EnZot *) thisx;
...
void EnZot_Update(EnZot *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 & 8) == 0) {
        if (((temp_v0 & 4) == 0) && (func_80B96DF0((Actor *) this, globalCtx) != 0)) {
            func_800E9250(globalCtx, (Actor *) this, &this->unk2C4, &this->unk2CA, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        } else {
            Math_SmoothStepToS((s16 *) &this->unk2C4, 0, 6, 0x1838, (s16) 0x64);
            Math_SmoothStepToS(&this->unk2C4.y, 0, 6, 0x1838, (s16) 0x64);
            Math_SmoothStepToS((s16 *) &this->unk2CA, 0, 6, 0x1838, (s16) 0x64);
...
void EnZot_Draw(EnZot *this, GlobalContext *globalCtx) {
    ? sp4C;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B995A4, func_80B99758, (Actor *) this);
}
