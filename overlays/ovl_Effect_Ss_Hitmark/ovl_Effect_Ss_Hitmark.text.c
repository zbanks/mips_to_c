...
void EffectSsHitmark_Update(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    if (this->regs[0] != 0) {
        ...
        this->regs[3] = func_800B096C(this->regs[3], (s16) temp_s1->unk_1, this->life + 1);
        this->regs[4] = func_800B096C(this->regs[4], (s16) temp_s1->unk_2, this->life + 1);
        this->regs[5] = func_800B096C(this->regs[5], (s16) temp_s1->unk_3, this->life + 1);
        this->regs[6] = func_800B096C(this->regs[6], (s16) temp_s1->unk_4, this->life + 1);
        this->regs[7] = func_800B096C(this->regs[7], (s16) temp_s1->unk_5, this->life + 1);
    }
}
