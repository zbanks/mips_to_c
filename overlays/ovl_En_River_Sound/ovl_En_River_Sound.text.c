...
void EnRiverSound_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this = this;
    sp1C = temp_a1;
    this->unk_148 = Lib_SegmentedToVirtual((void *) temp_a1->points);
    this->unk_146 = temp_a1->count;
}
...
void EnRiverSound_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) this->actor.params < 0xFD) {
        func_800BCCDC((Vec3s *) this->unk_148, this->unk_146, (Vec3f *) &sp34, (Vec3f *) &this->actor.world, 1);
        return;
    }
    sp2C = temp_a3;
    func_800BCCDC((Vec3s *) this->unk_148, this->unk_146, (Vec3f *) &sp34, (Vec3f *) temp_a3, 0);
    temp_a0 = &globalCtx->colCtx;
    sp28 = temp_a0;
    if (func_800C411C(temp_a0, &this->actor.floorPoly, &sp30, (Actor *) this, (Vec3f *) sp2C) != -32000.0f) {
        this->unk_145 = func_800C9E18(temp_a0, this->actor.floorPoly, sp30);
    } else {
        this->unk_145 = 0;
    }
    temp_v0 = this->unk_145;
    if (temp_v0 == 0) {
        this->unk_145 = this->actor.params - 0xFD;
    } else {
        this->unk_145 = temp_v0 - 1;
    }
    temp_v0_2 = this->unk_145;
    if ((s32) temp_v0_2 >= 3) {
        this->unk_145 = 2;
        return;
    }
    this->unk_145 = temp_v0_2;
}
...
void EnRiverSound_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_8019FF9C(&this->actor.projectedPos, *(&D_808A8060 + (this->unk_145 * 4)), this);
}
