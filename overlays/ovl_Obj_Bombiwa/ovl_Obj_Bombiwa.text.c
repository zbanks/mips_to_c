...
static InitChainEntry D_8093A9C0;                   /* unable to generate initializer */
static s16 D_8093A9D0 = {0x11, 0xE, 0xA, 8, 7, 5, 3, 2};
...
typedef struct ObjBombiwa {
    ...
    /* 0x0190 */ char pad190[0x1A];
    /* 0x01AA */ s16 unk1AA;                        /* inferred */
    /* 0x01AC */ char pad1AC[0x54];                 /* maybe part of unk1AA[43]? */
    /* 0x0200 */ s8 unk200;                         /* inferred */
    /* 0x0201 */ s8 unk201;                         /* inferred */
    /* 0x0202 */ s8 unk202;                         /* inferred */
    /* 0x0203 */ u8 unk203;                         /* inferred */
    /* 0x0204 */ void (*actionFunc)(ObjBombiwa *, GlobalContext *);
...
? func_80939470(void *arg0) {
    ...
    if (((arg0->unk155 & 2) != 0) && (temp_v0 = arg0->unk14C, (temp_v0 != 0))) {
        temp_v1 = *arg0->unk180;
...
void ObjBombiwa_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_8093A9C0);
    temp_a1 = &this->unk144;
    sp24 = temp_a1;
    ...
    sp28 = temp_v0;
    Collider_SetCylinder(globalCtx, sp24, &this->actor, *temp_v0);
    ...
    if (sp28 == &D_8093A998) {
        ...
        func_80939594(&this->actor, globalCtx);
    }
    ActorShape_Init(&this->actor.shape, -200.0f, sp28->unk4, 9.8f);
    this->actor.world.pos.y = this->actor.home.pos.y + 20.0f;
    this->actor.draw = sp28->unk8;
...
void func_80939EF4(ObjBombiwa *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1->colAT[2](this) != 0) {
        ...
        sp24 = temp_a1;
        Audio_PlaySoundAtPosition(globalCtx, &temp_a1->pos, 0x50, 0x2810U);
        ...
        func_80939994(globalCtx, &sp24->pos);
...
void func_8093A080(ObjBombiwa *arg0) {
    ...
    phi_s4 = 0;
    do {
        phi_s0->unk0 = (f32) ((Rand_ZeroOne() * 0.1f) + 0.05f);
        temp_s3 = phi_s4 + 1;
        phi_s0->unk4 = (f32) ((Math_SinS(phi_s2) * 50.0f) + arg0->actor.world.pos.x);
        phi_s0->unk8 = (f32) (((f32) temp_s3 * 31.0f) + arg0->actor.world.pos.y);
        temp_f16 = Math_CosS(phi_s2) * 50.0f;
        phi_s0->unk14 = phi_s2;
        phi_s0->unkC = (f32) (temp_f16 + arg0->actor.world.pos.z);
        phi_s0->unk10 = (f32) ((f32) phi_s4 + 3.0f);
        phi_s0->unk16 = (s16) (Rand_Next() >> 0x10);
        phi_s0->unk18 = 0;
        phi_s0->unk1A = 0;
        phi_s0 += 0x1C;
...
void func_8093A1F0(ObjBombiwa *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if ((phi_s2->unk1AA == 0) && ((temp_s3 = &globalCtx->colCtx, temp_s0->unk10 = (f32) (temp_s0->unk10 - 3.0f), temp_f16 = temp_s0->unk4 + (Math_SinS(phi_s1) * 1.5f), temp_s0->unk8 = (f32) (temp_s0->unk8 + temp_s0->unk10), temp_s0->unk4 = temp_f16, temp_f10 = Math_CosS(phi_s1) * 1.5f, temp_t9 = &sp9C, temp_s0->unk14 = (s16) (temp_s0->unk14 + 0x5DC), temp_s0->unkC = (f32) (temp_s0->unkC + temp_f10), sp9C = temp_s0->unk4, spA0 = temp_s0->unk8 + 30.0f, spA4 = temp_s0->unkC, temp_f0 = func_800C411C(temp_s3, &sp94, &sp90, &this->actor, (Vec3f *) temp_t9), (temp_f0 <= -31990.0f)) || ((temp_s0->unk8 - (200.0f * temp_s0->unk0)) < temp_f0))) {
            this->unk200 += 1;
            temp_s0->unk1A = 1;
    ...
    this->unk201 += -1;
    if (((s32) this->unk200 >= 4) || ((s32) this->unk201 <= 0)) {
        Actor_MarkForDeath(&this->actor);
    }
}
...
void func_8093A418(void *arg0, GlobalContext *arg1) {
    ...
    temp_f0 = arg0->unkF4;
    if ((temp_f0 <= 2200.0f) || (((arg0->unk203 & 1) != 0) && (temp_f0 < 2300.0f))) {
        arg0->unkD0 = 0xA0;
...
void func_8093A608(void *arg0, GraphicsContext **arg1) {
    ...
    do {
        ...
        if (phi_s1->unk1AA == 0) {
            SysMatrix_SetStateRotationAndTranslation(temp_s0_2->unk4, temp_s0_2->unk8, temp_s0_2->unkC, temp_s0_2 + 0x14);
            temp_f12 = temp_s0_2->unk0;
