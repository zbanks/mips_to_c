typedef struct BgHakuginSwitch {
    ...
    /* 0x1A8 */ Gfx *unk1A8;                        /* inferred */
    /* 0x1AC */ void (*actionFunc)(BgHakuginSwitch *, GlobalContext *);
    /* 0x1B0 */ char pad1B0[0x2];
    /* 0x1B2 */ s8 unk1B2;                          /* inferred */
    /* 0x1B3 */ char pad1B3[0x5];                   /* maybe part of unk1B2[6]? */
    /* 0x1B8 */ s16 unk1B8;                         /* inferred */
    /* 0x1BA */ s16 unk1BA;                         /* inferred */
    /* 0x1BC */ s16 unk1BC;                         /* inferred */
    /* 0x1BE */ char pad1BE[0x1];
    /* 0x1BF */ s8 unk1BF;                          /* inferred */
    /* 0x1C0 */ s8 unk1C0;                          /* inferred */
...
void BgHakuginSwitch_Init(BgHakuginSwitch *this, GlobalContext *globalCtx) {
    s32 sp34;
    s32 sp30;
    s32 sp28;
...
void BgHakuginSwitch_Destroy(BgHakuginSwitch *this, GlobalContext *globalCtx) {
...
void BgHakuginSwitch_Update(BgHakuginSwitch *this, GlobalContext *globalCtx) {
    f32 sp24;
    f32 temp_f0;
    f32 temp_f2;
    s8 temp_v0;
...
void BgHakuginSwitch_Draw(BgHakuginSwitch *this, GlobalContext *globalCtx) {
    BgHakuginSwitch *this = (BgHakuginSwitch *) thisx;
