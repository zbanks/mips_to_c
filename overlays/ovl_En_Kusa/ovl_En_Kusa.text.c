...
typedef struct EnKusa {
    ...
    /* 0x195 */ s8 unk195;                          /* inferred */
    /* 0x196 */ s8 unk196;                          /* inferred */
    /* 0x197 */ u8 unk197;                          /* inferred */
    /* 0x198 */ u8 unk198;                          /* inferred */
    /* 0x199 */ char pad199[0x3];                   /* maybe part of unk198[4]? */
} EnKusa;                                           /* size = 0x19C */
...
struct _mips2c_stack_func_80934AB4 {
    ...
    /* 0x5C */ char pad5C[0x20];                    /* maybe part of sp58[9]? */
    ...
    /* 0x9C */ char pad9C[0x14];                    /* maybe part of sp98[6]? */
