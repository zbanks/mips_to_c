...
static InitChainEntry D_80936754;                   /* unable to generate initializer */
...
typedef struct EnKusa {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnKusa *, GlobalContext *);
    ...
    /* 0x0199 */ char pad199[0x3];                  /* maybe part of unk198[4]? */
} EnKusa;                                           /* size 0x19C */
...
void func_80934AB4(void) {
    ...
    do {
        ...
        temp_v0->unk-BC = temp_f14_2;
        temp_v0->unk-F8 = temp_f14_2;
...
void func_8093517C(void *arg0) {
    ...
    arg0->unk60 = 0.120000005f;
    arg0->unk5C = 0.16000001f;
}
...
void func_809351A0(EnKusa *arg0, GlobalContext *arg1) {
    ...
    phi_s1 = &D_80936714;
    do {
        spB8 = arg0->actor.world.pos.x + (phi_s1->unk0 * arg0->actor.scale.x * 20.0f);
        spBC = arg0->actor.world.pos.y + (phi_s1->unk4 * arg0->actor.scale.y * 20.0f) + 10.0f;
        spC0 = arg0->actor.world.pos.z + (phi_s1->unk8 * arg0->actor.scale.z * 20.0f);
        ...
        spB8 = arg0->actor.world.pos.x + (phi_s1->unk0 * arg0->actor.scale.x * 40.0f);
        spBC = arg0->actor.world.pos.y + (phi_s1->unk4 * arg0->actor.scale.y * 40.0f) + 10.0f;
        spC0 = arg0->actor.world.pos.z + (phi_s1->unk8 * arg0->actor.scale.z * 40.0f);
...
void EnKusa_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_80934F58(&this->actor, globalCtx, 0.0f) == 0) {
    ...
    this->unk195 = Object_GetIndex(&globalCtx->objectCtx, *(&D_809366D8 + ((this->actor.params & 3) * 2)));
    if ((s32) this->unk195 < 0) {
        Actor_MarkForDeath(&this->actor);
        return;
    }
    func_809358C4(this);
...
void func_809358D8(EnKusa *this, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->unk195) != 0) {
        ...
        this->actor.objBankIndex = this->unk195;
    }
}
...
void func_809359AC(EnKusa *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 & 2) != 0) {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x14, 0x284EU);
    ...
    temp_v0_3 = this->unk148.base.ocFlags1;
    temp_a1 = &this->unk148;
    if (((temp_v0_3 & 8) == 0) && (this->actor.xzDistToPlayer > 12.0f)) {
        this->unk148.base.ocFlags1 = temp_v0_3 | 8;
    }
...
void func_80935D64(EnKusa *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->unk148.base.atFlags;
    temp_v0 = (temp_v1 & 2) != 0;
    if (temp_v0 != 0) {
        this->unk148.base.atFlags = temp_v1 & 0xFFFD;
    }
    temp_v1_2 = this->actor.bgCheckFlags;
    temp_t8 = this->unk194 + 1;
    this->unk194 = temp_t8;
...
void func_809361B4(EnKusa *arg0) {
    ...
    arg0->unkBC = (unaligned s32) arg0->unk14;
...
void func_80936220(EnKusa *this, GlobalContext *globalCtx) {
    ...
    temp_t7 = this->unk194 + 1;
    this->unk194 = temp_t7;
    if ((temp_t7 & 0xFF) >= 0x79) {
        temp_a1 = this->actor.home.pos.y;
        this = this;
        if ((Math_StepToF(temp_a0, temp_a1, 0.6f) != 0) && ((s32) this->unk194 >= 0xAA)) {
            func_80936290(this);
        }
    }
}
...
void func_809362D8(EnKusa *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v1 & Math_StepToF(&this->actor.scale.x, 0.4f, 0.011f)) != 0) {
        Actor_SetScale(&this->actor, 0.4f);
        func_80935988(this);
        this->unk148.base.ocFlags1 &= 0xFFF7;
    }
}
...
void func_80936414(Actor *this, GlobalContext *globalCtx) {
    ...
    phi_a3 = temp_a3;
    if ((temp_f0 <= 1200.0f) || (((this->unk198 & 1) != 0) && (temp_f0 < 1300.0f))) {
        if ((temp_a3->roomCtx.currRoom.unk3 == 0) && (func_809359AC == this->unk144) && (temp_f0 > -150.0f) && (temp_f0 < 400.0f)) {
            globalCtx = temp_a3;
            func_809349E0((this->unk196 << 6) + &D_80936AD8, this, temp_a3);
            phi_a3 = globalCtx;
        }
...
void func_809365CC(Actor *this, GlobalContext *globalCtx) {
    ...
    if ((temp_a3->roomCtx.currRoom.unk3 == 0) && (func_809359AC == this->unk144)) {
        temp_f0 = this->projectedPos.z;
