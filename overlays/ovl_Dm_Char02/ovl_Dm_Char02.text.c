typedef struct DmChar02 {
    ...
    /* 0x294 */ char pad294[0x4C];                  /* maybe part of actionFunc[20]? */
    /* 0x2E0 */ s16 unk2E0;                         /* inferred */
    /* 0x2E2 */ char pad2E2[0xE];                   /* maybe part of unk2E0[8]? */
...
void DmChar02_Init(DmChar02 *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
...
void DmChar02_Destroy(DmChar02 *this, GlobalContext *globalCtx) {
    DmChar02 *this = (DmChar02 *) thisx;
...
void DmChar02_Update(DmChar02 *this, GlobalContext *globalCtx) {
    DmChar02 *this = (DmChar02 *) thisx;
...
void DmChar02_Draw(DmChar02 *this, GlobalContext *globalCtx) {
    s32 sp30;
    u16 temp_v1;
    s32 phi_a2;
    DmChar02 *this = (DmChar02 *) thisx;
...
block_7:
    ...
    if (phi_a2 != 0) {
        ...
        func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80AAB23C, func_80AAB258, func_80AAB270, (Actor *) this);
    }
}
