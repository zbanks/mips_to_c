...
void EnKujiya_Init(EnKujiya *this, GlobalContext *globalCtx) {
    u16 temp_v0;
...
void EnKujiya_Destroy(EnKujiya *this, GlobalContext *globalCtx) {
    EnKujiya *this = (EnKujiya *) thisx;
...
void EnKujiya_Update(EnKujiya *this, GlobalContext *globalCtx) {
    EnKujiya *this = (EnKujiya *) thisx;
    this->actionFunc(this, globalCtx);
}

void EnKujiya_Draw(EnKujiya *this, GlobalContext *globalCtx) {
