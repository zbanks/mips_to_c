...
typedef struct EnKujiya {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnKujiya *, GlobalContext *);
...
void func_80BB09BC(EnKujiya *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, temp_a1) != 0) {
        ...
        if (((s32) temp_v0 >= 0x4000) && ((s32) temp_v0 < 0xC000)) {
            globalCtx = globalCtx;
            if (func_80BB0FF8() != 0) {
                func_801518B0(globalCtx, 0x2B61U, &this->actor);
                this->unk14A = 0x2B61;
            } else {
                func_801518B0(globalCtx, 0x2B5CU, &this->actor);
                this->unk14A = 0x2B5C;
            }
        } else {
            globalCtx = globalCtx;
            if (func_80BB0FF8() != 0) {
                func_801518B0(globalCtx, 0x2B64U, &this->actor);
                this->unk14A = 0x2B64;
            } else {
                func_801518B0(globalCtx, 0x2B63U, &this->actor);
                this->unk14A = 0x2B63;
            }
        }
        func_80BB0E44(this);
...
void func_80BB0BF8(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = arg1;
    if ((arg0->unk14A == 0x2B65) && (temp_v0 = arg0->unk148, (temp_v0 != 0))) {
        arg0->unk148 = (s16) (temp_v0 - 1);
        return;
    }
    arg1 = arg1;
    if (func_80147624(temp_a0) != 0) {
        ...
        case 11109:
            ...
            if (((&gSaveContext + ((temp_v1 % 5) * 3))->unkFE9 == ((u32) (temp_a1 & 0xF00) >> 8)) && ((&gSaveContext + ((temp_v1 % 5) * 3))->unkFEA == ((u32) (temp_a1 & 0xF0) >> 4)) && ((&gSaveContext + ((temp_v1 % 5) * 3))->unkFEB == (temp_a1 & 0xF))) {
...
void func_80BB0E58(EnKujiya *this, GlobalContext *globalCtx) {
    ...
    switch (temp_v0) {
    case 4:
        func_80BB0B28(&this->actor, globalCtx);
        return;
    case 5:
        func_80BB0BF8(&this->actor, globalCtx);
        return;
    case 6:
    ...
    case 17:
        if (func_80147624(globalCtx) != 0) {
            ...
            func_801518B0(globalCtx, 0x2B60U, &this->actor);
            this->unk14A = 0x2B60;
        }
...
void func_80BB1180(EnKujiya *this, GlobalContext *globalCtx) {
    ...
    func_800B9010(&this->actor, 0x2085U);
}

void func_80BB1250(Actor *arg0) {
    arg0->unk148 = 0;
    arg0->unk144 = func_80BB1268;
}
