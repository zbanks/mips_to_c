typedef struct ArrowLight {
    ...
    /* 0x160 */ void (*actionFunc)(ArrowLight *, GlobalContext *);
} ArrowLight;                                       /* size = 0x164 */

struct _mips2c_stack_ArrowLight_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ArrowLight_Draw {
    /* 0x00 */ char pad_0[0x40];
    /* 0x40 */ Gfx *sp40;                           /* inferred */
    /* 0x44 */ char pad_44[0x4];
    /* 0x48 */ Gfx *sp48;                           /* inferred */
    /* 0x4C */ char pad_4C[0x20];                   /* maybe part of sp48[9]? */
    /* 0x6C */ ArrowLight *sp6C;                    /* inferred */
    /* 0x70 */ char pad_70[0x4];
    /* 0x74 */ u32 sp74;                            /* inferred */
    /* 0x78 */ char pad_78[0x8];
};                                                  /* size = 0x80 */

struct _mips2c_stack_ArrowLight_Init {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_ArrowLight_SetupAction {};     /* size 0x0 */

struct _mips2c_stack_ArrowLight_Update {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_809243AC {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ PosRot *sp18;                        /* inferred */
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809244A0 {};              /* size 0x0 */

struct _mips2c_stack_func_809244F8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_809246C4 {
...
void func_809244A0(void *arg0, f32 *arg1, f32 arg2, ?); /* static */
extern ? D_0E0002E0;
static ? D_80925F10;                                /* unable to generate initializer */
static ? D_80925FC0;                                /* unable to generate initializer */
static InitChainEntry D_809260A0;                   /* unable to generate initializer */

void ArrowLight_SetupAction(ArrowLight *this, void (*actionFunc)(ArrowLight *, GlobalContext *)) {
    this->actionFunc = actionFunc;
}

void ArrowLight_Init(Actor *thisx, GlobalContext *globalCtx) {
    ArrowLight *this = (ArrowLight *) thisx;
    Actor_ProcessInitChain((Actor *) this, &D_809260A0);
    this->unk_144 = 0;
    this->unk_158 = 1.0f;
...
void func_809243AC(ArrowLight *this, GlobalContext *globalCtx) {
    ...
    sp18 = temp_v1_2;
    sp1C = temp_v0;
    func_800B9010((Actor *) this, 0x7FU);
    temp_a0 = this;
    if (temp_v0->parent == 0) {
        temp_a0->unk_14C = temp_v1_2->pos.x;
        temp_a0->unk_150 = temp_v1_2->pos.y;
        temp_a0->unk_144 = 0xA;
        temp_a0->unk_154 = temp_v1_2->pos.z;
        this = temp_a0;
        ArrowLight_SetupAction(temp_a0, func_809246C4);
        this->unk_148 = 0xFF;
    }
}

void func_809244A0(void *arg0, f32 *arg1, f32 arg2) {
    f32 temp_f0;
    f32 temp_f14;
    f32 temp_f2;
...
void func_809244F8(ArrowLight *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->unk_146;
    temp_t6 = temp_v1 - 1;
    phi_v1 = (s32) temp_v1;
    if (temp_v1 != 0) {
        temp_v1_2 = temp_t6 & 0xFFFF;
        this->unk_146 = temp_t6;
        phi_v1 = temp_v1_2;
        if (temp_v1_2 >= 8) {
            temp_f0_2 = (f32) (temp_v1_2 - 8) * 0.041666668f;
            temp_f2 = this->unk_158;
            this->unk_144 = (s16) (s32) (((1.0f - (temp_f0_2 * temp_f0_2)) * phi_f12) + 10.0f);
            this->unk_158 = temp_f2 + ((2.0f - temp_f2) * 0.1f);
            if (temp_v1_2 < 0x10) {
                this->unk_148 = (temp_v1_2 * 0x23) - 0x118;
            }
        }
    }
    phi_v0 = phi_v1;
    if (phi_v1 >= 9) {
        temp_f0_3 = this->unk_15C;
        if (temp_f0_3 < 1.0f) {
            this->unk_15C = temp_f0_3 + 0.25f;
            phi_v0 = (s32) this->unk_146;
        }
    } else {
        temp_f0_4 = this->unk_15C;
        if (temp_f0_4 > 0.0f) {
            this->unk_15C = temp_f0_4 - 0.125f;
            phi_v0 = (s32) this->unk_146;
        }
    }
    phi_v0_2 = phi_v0;
...
void func_809246C4(ArrowLight *this, GlobalContext *globalCtx) {
    ...
    sp34 = temp_v0;
    func_809244A0((bitwise void *) 1.0f, temp_a0, (bitwise f32) temp_a1, 0x3D4CCCCD);
    if ((temp_v0[1].isDrawn & 1) != 0) {
        Audio_PlayActorSound2((Actor *) this, 0x183CU);
        ArrowLight_SetupAction(this, func_809244F8);
        this->unk_146 = 0x20;
        this->unk_148 = 0xFF;
        return;
    }
...
void ArrowLight_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v1 != 0) && (temp_v1->update != 0) && ((s32) this->unk_146 < 0xFF)) {
        if ((temp_v1[1].isDrawn & 2) != 0) {
            phi_v0 = this;
        } else {
            phi_v0 = (ArrowLight *) temp_v1;
        }
        ...
        if (this->unk_15C > 0.0f) {
            ...
            temp_v0->words.w1 = ((s32) (temp_f0 * 30.0f) << 0x18) | (((s32) (40.0f * temp_f0) & 0xFF) << 0x10) | ((s32) (150.0f * temp_f0) & 0xFF);
        ...
        temp_v0_5->words.w1 = this->unk_148 | ~0x55FF;
        temp_v0_6 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_6[1];
        temp_v0_6->words.w1 = 0xFFFF0080;
        ...
        temp_f12 = (f32) this->unk_144 * 0.2f;
        Matrix_Scale(temp_f12, this->unk_158 * 4.0f, temp_f12, 1);
        ...
        temp_v0_8->words.w1 = (u32) &D_80925F10;
        temp_v0_8->words.w0 = 0xDE000000;
        temp_v0_9 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_9[1];
        temp_v0_9->words.w0 = 0xDE000000;
        sp40 = temp_v0_9;
        sp40->words.w1 = Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0x1FF - ((sp74 * 5) & 0x1FF), 0U, 4, 0x20, 1, 0x1FF - ((sp74 * 0xA) & 0x1FF), 0x1FF - ((sp74 * 0x1E) & 0x1FF), 8, 0x10);
        temp_v0_10 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_10[1];
        temp_v0_10->words.w1 = (u32) &D_80925FC0;
