typedef struct EnTab {
    ...
    /* 0x1E4 */ char pad1E4[0x28];                  /* maybe part of unk1E0[11]? */
    /* 0x20C */ Vec3s unk20C;                       /* inferred */
    /* 0x212 */ char pad212[0x72];                  /* maybe part of unk20C[20]? */
    /* 0x284 */ Vec3s unk284;                       /* inferred */
    /* 0x28A */ char pad28A[0x72];                  /* maybe part of unk284[20]? */
    /* 0x2FC */ u16 unk2FC;                         /* inferred */
    /* 0x2FE */ char pad2FE[0xE];                   /* maybe part of unk2FC[8]? */
    /* 0x30C */ s16 unk30C;                         /* inferred */
    /* 0x30E */ char pad30E[0xC];                   /* maybe part of unk30C[7]? */
    /* 0x31A */ s16 unk31A;                         /* inferred */
    /* 0x31C */ char pad31C[0x2];
    /* 0x31E */ s16 unk31E;                         /* inferred */
    /* 0x320 */ char pad320[0x4];                   /* maybe part of unk31E[3]? */
    /* 0x324 */ s16 unk324;                         /* inferred */
    /* 0x326 */ char pad326[0x2];
    /* 0x328 */ void *unk328;                       /* inferred */
    /* 0x32C */ s32 unk32C;                         /* inferred */
    /* 0x330 */ char pad330[0xC];                   /* maybe part of unk32C[4]? */
} EnTab;                                            /* size = 0x33C */
...
void func_80BE07A0(EnTab *arg0) {
    ...
    Math_ApproachS(arg0 + 0x312, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk316), 4, 0x2AA8);
    ...
    Math_ApproachS(arg0 + 0x316, (s16) (Math_Vec3f_Pitch((Vec3f *) &sp34, (Vec3f *) &sp40) - arg0->unk312), 4, 0x2AA8);
...
void func_80BE127C(EnTab *this, GlobalContext *globalCtx) {
    ...
    phi_a3 = temp_a3;
    phi_a3_2 = temp_a3;
    if ((func_80133038(globalCtx, &D_80BE18D0, (struct_80133038_arg2 *) &sp18) == 0) || ((temp_a0 = temp_a3, (sp18 != temp_a3->unk1D8)) && (this = temp_a3, phi_a3 = this, phi_a3_2 = this, (func_80BE1060(temp_a0, (u8 *) globalCtx, &sp18, temp_a3) == 0)))) {
...
void func_80BE1348(EnTab *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58((Actor *) this, globalCtx, func_80BE0E04(this, globalCtx), this->unk328, &this->unk1DC) != 0) {
...
void EnTab_Init(EnTab *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk18C, (Actor *) this, &D_80BE1A98);
...
void EnTab_Destroy(EnTab *this, GlobalContext *globalCtx) {
    EnTab *this = (EnTab *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk18C);
}

void EnTab_Update(EnTab *this, GlobalContext *globalCtx) {
    EnTab *this = (EnTab *) thisx;
    ...
    if (this->unk1D8 != 0) {
        ...
        func_8013C964((Actor *) this, globalCtx, (f32) (this->unk18C.dim.radius + this->unk30C), (f32) (this->unk18C.dim.height + 0xA), 0, (s16) (this->unk2FC & 7));
...
void EnTab_Draw(EnTab *this, GlobalContext *globalCtx) {
    ...
    if (this->unk1D8 != 0) {
        ...
        func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BE1648, func_80BE16B4, func_80BE1704, (Actor *) this);
    }
}
