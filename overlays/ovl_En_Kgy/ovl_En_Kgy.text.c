...
static s16 D_80B432CA = {0, 0x80, 0xFF00, 0x12C, 0, 0, 0};
...
void func_80B40EE8(EnKgy *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_2E0 != -1) && (ActorCutscene_GetCurrentIndex() != arg0->unk_2D4[arg0->unk_2E0])) {
        if (ActorCutscene_GetCurrentIndex() == 0x7C) {
            ...
            ActorCutscene_StartAndSetUnkLinkFields(arg0->unk_2D4[arg0->unk_2E0], &arg0->actor);
        } else {
            ActorCutscene_SetIntentToPlay(arg0->unk_2D4[arg0->unk_2E0]);
        }
    }
    if ((arg0->unk_29C & 2) != 0) {
        func_800B4EDC(arg1, &arg0->unk_2B4, &sp38, &sp34);
...
void func_80B4163C(EnKgy *arg0, GlobalContext *arg1) {
    ...
    case 25:
        ...
        Audio_PlayActorSound2(&arg0->actor, 0x29C2U);
        break;
    }
...
void func_80B41858(EnKgy *arg0) {
    ...
    if (ActorCutscene_GetCanPlayNext(arg0->unk_2D4[5]) != 0) {
        ActorCutscene_StartAndSetUnkLinkFields(arg0->unk_2D4[5], &arg0->actor);
        arg0->actionFunc = func_80B419B0;
        func_80B40E18(arg0, 7U);
        return;
    }
...
void func_80B419B0(EnKgy *arg0, GlobalContext *globalCtx) {
    ...
    func_80B4163C(arg0);
    if ((func_800B84D0(&arg0->actor, globalCtx) != 0) || (arg0 == sp20->unkA88)) {
        ...
        if (temp_v0 != 4) {
            if (temp_v0 != 5) {
                ...
                case 3152:
                    ...
                    func_80B413C8(this);
                    func_800B8A1C(&this->actor, globalCtx, (s32) this->unk_2EA, 2000.0f, 1000.0f);
                    break;
                case 3153:
                case 3155:
                    globalCtx->msgCtx.unk11F10 = 0;
...
void func_80B42508(EnKgy *this, GlobalContext *globalCtx) {
    ...
    if ((func_800B84D0(&this->actor, globalCtx) != 0) || (this == sp20->unkA88)) {
...
void func_80B4296C(EnKgy *arg0, GlobalContext *arg1) {
    ...
    func_800B8500(&arg0->actor, arg1, 1000.0f, 1000.0f, 0);
}
...
void EnKgy_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_2D2 == 2) {
        ...
        sp32 = 0;
        sp30 = 0;
        func_800E9250(globalCtx, &this->actor, &this->unk_2CC, (Vec3s *) &sp30, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        return;
    }
    Math_SmoothStepToS(&this->unk_2CC.x, 0, 6, 0x1838, (s16) 0x64);
...
void EnKgy_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((this->unk_29C & 1) != 0) {
        func_80B43074(&this->actor, globalCtx);
    }
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_80B42FA0, func_80B43008, &this->actor);
}
