...
void func_80B40C74(GlobalContext *arg0) {
    ...
    if (((s32) gSaveContext.day % 5) == 1) {
        ...
        temp_v0_2->unk_10C = (s32) (temp_v0_2->unk_10C | 2);
        return;
    }
    temp_v0_3 = &gSaveContext + (arg0->sceneNum * 0x1C);
    temp_v0_3->unk_10C = (s32) (temp_v0_3->unk_10C & ~2);
}
...
void func_80B40D00(GlobalContext *arg0) {
    ...
    temp_v0->unk_10C = (s32) (temp_v0->unk_10C | 4);
}
...
s32 func_80B40DB4(GlobalContext *globalCtx) {
    ...
    if ((temp_hi == 3) || ((temp_hi == 2) && (((&gSaveContext + (globalCtx->sceneNum * 0x1C))->unk_10C & 2) != 0))) {
        return 1;
    }
    return 0;
}
...
void func_80B411DC(EnKgy *arg0, GlobalContext *arg1, u32 arg2) {
    ...
    case 0:
        ...
        arg0->unk_2B4.x = temp_v0_2->unk_0;
        arg0->unk_2B4.y = temp_v0_2->unk_4;
        arg0->unk_2B4.z = temp_v0_2->unk_8;
        arg0->actor.focus.pos.x = temp_v0_2->unk_0;
        arg0->actor.focus.pos.y = temp_v0_2->unk_4;
        arg0->unk_2E0 = 0;
        arg0->actor.focus.pos.z = temp_v0_2->unk_8;
        return;
    case 1:
        temp_v1 = arg0->zubora;
        if (temp_v1 != 0) {
...
void func_80B41368(EnKgy *arg0, GlobalContext *arg1, u32 arg2) {
    ...
    temp_a0 = (arg0 + (arg0->unk_2E0 * 2))->unk_2D4;
    arg0 = arg0;
...
void func_80B413C8(EnKgy *arg0) {
    ...
    sp1C.unk_0 = (s32) arg0->unk_2A8.x;
    sp1C.unk_4 = (s32) arg0->unk_2A8.y;
    sp1C.unk_8 = (s32) arg0->unk_2A8.z;
    arg0->unk_2B4.x = sp1C.unk_0;
    arg0->unk_2B4.y = sp1C.unk_4;
    arg0->unk_2B4.z = sp1C.unk_8;
    arg0->actor.focus.pos.x = sp1C.unk_0;
    arg0->actor.focus.pos.y = sp1C.unk_4;
    arg0->actor.focus.pos.z = sp1C.unk_8;
    temp_a0 = (arg0 + (arg0->unk_2E0 * 2))->unk_2D4;
    arg0 = arg0;
    ActorCutscene_Stop(temp_a0);
    arg0->unk_2E0 = -1;
...
u16 func_80B41460(void) {
    ...
    if (temp_v0 == 4) {
        ...
        if ((&gSaveContext + (phi_v1 * 4))->unk_4C != 0x4D) {
            phi_v1_2 = temp_v0;
            if (temp_v0 == 4) {
                phi_v1_2 = 0U;
            }
            if ((&gSaveContext + (phi_v1_2 * 4))->unk_4C != 0x4E) {
                phi_v1_3 = temp_v0;
                if (temp_v0 == 4) {
                    phi_v1_3 = 0U;
                }
                if ((&gSaveContext + (phi_v1_3 * 4))->unk_4C != 0x4F) {
...
s32 func_80B41528(GlobalContext *arg0) {
    ...
    if ((&gSaveContext + (phi_v1 * 4))->unk_4C == 0x4F) {
        return 0xC4C;
    }
    phi_v1_2 = temp_v0;
    if (temp_v0 == 4) {
...
void func_80B41C30(void *arg0, void *arg1) {
    if (arg0 != arg1->unk_1CCC->unk_A88) {
        arg0->unk_304 = func_80B42508;
    }
}
...
void func_80B41D64(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Actor_HasParent(arg0, arg1) != 0) {
        ...
        func_800B8A1C(arg0, arg1, (s32) arg0->unk_2EA, 2000.0f, 1000.0f);
    }
        ...
        if (temp_v0 != 4) {
            if (temp_v0 != 5) {
                ...
                case 3138:
                    ...
                    (&gSaveContext + (phi_v0 * 4))->unk_4C = 0xFF;
                ...
                case 3157:
                    ...
                    if ((this->unk_29C & 0x10) != 0) {
                        ...
                        func_801159EC(globalCtx->unk_16976);
                    } else {
