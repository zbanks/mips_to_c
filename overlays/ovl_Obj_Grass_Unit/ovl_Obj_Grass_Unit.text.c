struct _mips2c_stack_ObjGrassUnit_Init {
    /* 0x00 */ char pad_0[0x73];
    /* 0x73 */ s8 sp73;                             /* inferred */
    /* 0x74 */ char pad_74[0x8];                    /* maybe part of sp73[9]? */
...
void ObjGrassUnit_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_s6->unk_0 > 0) {
        ...
        phi_s5 = 0;
        do {
            temp_s1 = temp_s6->unk_4 + phi_s5;
            temp_s0 = temp_s2_2 + (temp_s2_2->unk_FC * 0x14) + 0xC;
            temp_s0->x = (Math_CosS((s16) (this->actor.home.rot.y + temp_s1->unk_4)) * temp_s1->unk_0) + this->actor.home.pos.x;
            temp_s0->y = this->actor.home.pos.y + 100.0f;
            temp_s0->z = (Math_SinS((s16) (this->actor.home.rot.y + temp_s1->unk_4)) * temp_s1->unk_0) + this->actor.home.pos.z;
            ...
            if ((fabsf(temp_f0 - this->actor.home.pos.y) < 80.0f) && (temp_s0->y > -32000.0f)) {
                temp_s2_2->unk_FC = (s16) (temp_s2_2->unk_FC + 1);
                temp_s0->unk_C = (s16) (Rand_Next() >> 0x10);
                temp_s0->unk_E = sp73;
                if (func_809ABF38(globalCtx, temp_s0) != 0) {
                    temp_s0->unk_F = (u8) (temp_s0->unk_F | 8);
                }
            ...
            phi_f20 = phi_f20_2;
            phi_f20_3 = phi_f20_2;
        } while (temp_s4 < temp_s6->unk_0);
        phi_a1 = sp94;
    }
    if ((s32) temp_s2_2->unk_FC > 0) {
        phi_a1->unk_2944 = (s16) (phi_a1->unk_2944 + 1);
        temp_s2_2->unk_0 = (f32) this->actor.home.pos.x;
        temp_s2_2->unk_4 = (f32) (phi_f20 / (f32) temp_s2_2->unk_FC);
        temp_s2_2->unk_8 = (f32) this->actor.home.pos.z;
    }
    Actor_MarkForDeath((Actor *) this);
}
