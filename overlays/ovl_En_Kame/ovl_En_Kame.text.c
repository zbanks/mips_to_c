typedef struct EnKame {
    ...
    /* 0x2C8 */ Vec3f unk2C8;                       /* inferred */
    /* 0x2D4 */ char pad2D4[0x6C];                  /* maybe part of unk2C8[10]? */
    /* 0x340 */ ColliderCylinder unk340;            /* inferred */
} EnKame;                                           /* size = 0x38C */
...
void EnKame_Init(EnKame *this, GlobalContext *globalCtx) {
    void **temp_s0;
    void **phi_s0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk340, (Actor *) this, &D_80AD8DE0);
...
void EnKame_Destroy(EnKame *this, GlobalContext *globalCtx) {
    EnKame *this = (EnKame *) thisx;
...
void func_80AD76CC(Actor *arg0) {
    ...
    if (EnKame_Draw == arg0->draw) {
        ...
        Math_Vec3f_Copy(arg0 + 0x2BC, (Vec3f *) temp_a1);
        arg0->unk29E = 0;
    }
    arg0->flags |= 0x10;
...
void EnKame_Update(EnKame *this, GlobalContext *globalCtx) {
    ...
    if (((temp_v0_2 & 2) != 0) && ((temp_v0_2 & 4) != 0)) {
        ...
        func_80AD76CC(this);
        if (Actor_XZDistanceToPoint((Actor *) this, (Vec3f *) &this->unk2BC) < 50.0f) {
            this->unk340.base.atFlags &= 0xFFFE;
        }
        this->unk2A6 = 0x3B00;
        func_80AD7568((Actor *) this);
    ...
    if (this->actor.shape.shadowDraw != 0) {
        ...
        Collider_UpdateCylinder((Actor *) this, &this->unk340);
    }
    temp_t5 = &this->unk340;
    sp28 = temp_t5;
...
void EnKame_Draw(EnKame *this, GlobalContext *globalCtx) {
    ? sp40;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80AD8A48, func_80AD8AF8, (Actor *) this);
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk2C8, 0xA, this->unk2B4, this->unk2B8, this->unk2B0, (u8) (s32) this->unk29D);
    if (this->actor.shape.shadowDraw == 0) {
