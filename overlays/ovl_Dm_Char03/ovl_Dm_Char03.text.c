...
void DmChar03_Init(DmChar03 *this, GlobalContext *globalCtx) {
    SkelAnime *sp30;
    SkelAnime *temp_a1;
...
void DmChar03_Destroy(DmChar03 *this, GlobalContext *globalCtx) {
    DmChar03 *this = (DmChar03 *) thisx;
...
void DmChar03_Update(DmChar03 *this, GlobalContext *globalCtx) {
    DmChar03 *this = (DmChar03 *) thisx;
...
void DmChar03_Draw(DmChar03 *this, GlobalContext *globalCtx) {
    DmChar03 *this = (DmChar03 *) thisx;
    if (this->unk18E == 0) {
        if ((func_800EE29C(globalCtx, 0x88U) != 0) && (globalCtx->csCtx.npcActions[func_800EE200(globalCtx, 0x88U)]->unk0 != 1)) {
            func_8012C28C(globalCtx->state.gfxCtx);
            func_801343C0(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80AAB974, func_80AAB990, func_80AAB9A8, (Actor *) this);
            return;
        }
