...
void EnCha_Init(EnCha *this, GlobalContext *globalCtx) {
...
void EnCha_Destroy(EnCha *this, GlobalContext *globalCtx) {
    EnCha *this = (EnCha *) thisx;
...
void EnCha_Update(EnCha *this, GlobalContext *globalCtx) {
...
void EnCha_Draw(EnCha *this, GlobalContext *globalCtx) {
    EnCha *this = (EnCha *) thisx;
