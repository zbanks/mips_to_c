typedef struct BgSinkaiKabe {
    ...
    /* 0x160 */ Actor *unk160;                      /* inferred */
    /* 0x164 */ s16 unk164;                         /* inferred */
    /* 0x166 */ s16 unk166;                         /* inferred */
    /* 0x168 */ char pad168[0x4];                   /* maybe part of unk166[3]? */
...
struct _mips2c_stack_BgSinkaiKabe_Init {
    ...
    /* 0x58 */ char pad58[0x18];                    /* maybe part of sp54[7]? */
...
void BgSinkaiKabe_Init(BgSinkaiKabe *this, GlobalContext *globalCtx) {
...
void BgSinkaiKabe_Destroy(BgSinkaiKabe *this, GlobalContext *globalCtx) {
    BgSinkaiKabe *this = (BgSinkaiKabe *) thisx;
...
void BgSinkaiKabe_Update(BgSinkaiKabe *this, GlobalContext *globalCtx) {
    BgSinkaiKabe *this = (BgSinkaiKabe *) thisx;
