typedef struct ObjChan {
    ...
    /* 0x195 */ char pad195[0x1];
    /* 0x196 */ s16 unk196;                         /* inferred */
    /* 0x198 */ char pad198[0x12];                  /* maybe part of unk196[10]? */
    /* 0x1AA */ u8 unk1AA;                          /* inferred */
    /* 0x1AB */ char pad1AB[0x1];
    /* 0x1AC */ void *unk1AC;                       /* inferred */
    /* 0x1B0 */ char pad1B0[0x10];                  /* maybe part of unk1AC[5]? */
    /* 0x1C0 */ Vec3f unk1C0;                       /* inferred */
    /* 0x1CC */ f32 unk1CC;                         /* inferred */
    /* 0x1D0 */ f32 unk1D0;                         /* inferred */
    /* 0x1D4 */ s16 unk1D4;                         /* inferred */
    /* 0x1D6 */ char pad1D6[0x2];
...
struct _mips2c_stack_func_80BBA488 {
    ...
    /* 0xA4 */ f32 spA4;                            /* inferred */
    /* 0xA8 */ f32 spA8;                            /* inferred */
    /* 0xAC */ char padAC[0x24];                    /* maybe part of spA8[10]? */
...
void ObjChan_Init(ObjChan *this, GlobalContext *globalCtx) {
...
block_4:
    ...
    func_8013E3B8((Actor *) this, (s16 []) &this->unk1E0, 2);
...
void ObjChan_Destroy(ObjChan *this, GlobalContext *globalCtx) {
    ObjChan *this = (ObjChan *) thisx;
...
void func_80BB9B40(f32 *arg0, Vec3s *arg1, Vec3f *arg2, Vec3s *arg3, s16 arg4) {
    ...
    arg0->unk0 = arg2->x + sp1C;
    arg0->unk4 = (f32) (arg2->y + sp20);
    arg0->unk8 = (f32) (arg2->z + sp24);
...
void func_80BB9C08(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800C55C4(arg1 + 0x830, temp_s4, (Vec3f *) &sp84, temp_s0, &sp94, 0U, 0U, 1U, 1U, &sp90) != 0) {
        ...
        do {
            func_80BB9B40(&spA0, (Vec3s *) &sp98, temp_s4, arg0 + 0xBC, (s16) ((s32) ((((f32) phi_s0 * 360.0f) / 5.0f) * 182.04445f) + arg0->unk1DE));
...
void func_80BB9F24(ObjChan *this, GlobalContext *globalCtx) {
    ...
    if (((this->unk1AA & 4) != 0) && (func_8013E2D4((Actor *) this, this->unk1E0, -1, 0) != 0)) {
    ...
    sp48 = temp_a1;
    SysMatrix_GetStateTranslationAndScaledY(this->unk1CC, (Vec3f *) temp_a1);
    Math_Vec3f_Sum((Vec3f *) sp48, &this->unk1C0, (Vec3f *) sp48);
    Collider_UpdateCylinder((Actor *) this, &this->unk148);
    phi_s1 = this;
    phi_s2 = 0;
    do {
        ...
        if (temp_s0 != 0) {
            ...
            func_80BB9B40(&sp60, (Vec3s *) &sp58, (Vec3f *) sp48, (Vec3s *) temp_s4, (s16) ((s32) ((((f32) phi_s2 * 360.0f) / 5.0f) * 182.04445f) + this->unk1DE));
...
void ObjChan_Update(ObjChan *this, GlobalContext *globalCtx) {
    ObjChan *temp_a3;
    ObjChan *this = (ObjChan *) thisx;
...
void ObjChan_Draw(ObjChan *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *sp20;
    Gfx *temp_v1;
    Gfx *temp_v1_2;
