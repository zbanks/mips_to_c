...
void EnToto_Init(EnToto *this, GlobalContext *globalCtx) {
    u16 temp_v0;
...
void EnToto_Destroy(EnToto *this, GlobalContext *globalCtx) {
    EnToto *this = (EnToto *) thisx;
...
void EnToto_Update(EnToto *this, GlobalContext *globalCtx) {
...
void EnToto_Draw(EnToto *this, GlobalContext *globalCtx) {
    ? sp4C;
