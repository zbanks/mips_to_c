void func_80BA36C0(EnToto *arg0, u8 arg2, u8);      /* static */
...
static EnTotoText D_80BA50BC = {{5, 0, 0}, {6, 0x14, 0}, {8, 5, 0}, {0xC, 0, 0}, {0xD, 0, 0}}; /* extra bytes: 2 */
...
void func_80BA3DBC(EnToto *this, GlobalContext *globalCtx) {
    ...
    if (((temp_v0->unkA6C & 0x400) != 0) && (temp_v0->unkAE7 != 0)) {
...
s32 func_80BA44D4(? *arg0, Actor *arg1) {
    ...
    Math_Vec3s_ToVec3f(&sp1C, arg0 + 6);
    phi_v0 = 0;
    if (Math_Vec3f_DistXZ(arg1 + 0x24, &sp1C) < 10.0f) {
        phi_v0 = 1;
    }
    return phi_v0;
}
...
s32 func_80BA4530(EnToto *this, GlobalContext *globalCtx) {
    ...
    if ((temp_s2->bgCheckFlags & 1) != 0) {
        ...
        if (func_80BA44D4(temp_s0, temp_s2) != 0) {
            Math_Vec3s_ToVec3f(&temp_s2->world.pos, temp_s0 + 6);
...
s32 func_80BA47E0(EnToto *this, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if ((temp_s1 != gSaveContext.playerForm) && ((*(&D_80BA5128 + phi_s0) & this->unk2B3) != 0)) {
            ...
            Math_Vec3s_ToVec3f(&sp64, &D_80BA50DC + (phi_s0 * 0xC) + 6);
            Actor_Spawn(temp_s2, globalCtx, 0, sp64.x, sp64.y, sp64.z, (s16) (phi_s0 + 2), (s16) 0, (s16) 0, (s16) -1);
        }
        phi_s0 = temp_s1;
    } while (temp_s1 != 4);
...
void func_80BA4CB4(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_a0 != arg0->unk2B5) {
        arg0->unk2B5 = (u8) temp_a0;
        if (temp_v0 != 4) {
            if (temp_v0 == 3) {
                ...
                if ((arg0->unk2B5 == 2) && (arg0->unk2B3 != 0xF)) {
    ...
    if ((arg0->unk2B5 == 4) && (Actor_HasParent(arg0, arg1) == 0)) {
...
void EnToto_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x20DU) != 0) {
        func_80BA4CB4(&this->actor, globalCtx);
    } else {
        *(&D_80BA51B8 + (this->actionFuncIndex * 4))(this, globalCtx);
    }
    temp_s0 = &this->collider;
    Collider_ResetCylinderAC(globalCtx, &temp_s0->base);
...
void EnToto_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp4C.unk0 = (s32) D_80BA51C4.unk0;
    sp4C.unk4 = (s32) D_80BA51C4.unk4;
    sp4C.unk8 = (s32) D_80BA51C4.unk8;
    ...
    sp38 = temp_v0;
    sp38->words.w1 = Lib_SegmentedToVirtual((sp + (this->unk260 * 4))->unk4C);
