...
typedef struct EnGe3 {
    ...
    /* 0x02FC */ u8 *unk2FC;                        /* inferred */
    /* 0x0300 */ s32 unk300;                        /* inferred */
    /* 0x0304 */ char pad304[0xC];                  /* maybe part of unk300[4]? */
    ...
    /* 0x031C */ void (*actionFunc)(EnGe3 *, GlobalContext *);
} EnGe3;                                            /* size 0x320 */
...
void EnGe3_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a1 = &this->unk194;
    sp34 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_0600A808, NULL, &this->unk1D8, &this->unk268, 0x18);
    SkelAnime_ChangeAnimDefaultRepeat(sp34, &D_06001EFC);
    Collider_InitAndSetCylinder(globalCtx, &this->unk148, &this->actor, &D_809A0DA0);
    this->actor.colChkInfo.mass = 0xFF;
    Actor_SetScale(&this->actor, 0.01f);
    this->unk312 = -1;
    this->unk314 = -1;
    this->unk144 = func_809A096C;
...
void func_809A020C(EnGe3 *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 0x3F) {
        arg0->unk2FC = arg1->setupPathList + (temp_v0 * 8);
        return;
    }
    arg0->unk2FC = 0;
}
...
s32 func_809A024C(EnGe3 *arg0) {
    ...
    sp34 = temp_v0;
    temp_v1 = Lib_SegmentedToVirtual(temp_v0->unk4) + (arg0->unk300 * 6);
...
void func_809A04D0(EnGe3 *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = &arg0->unk194;
    sp24 = temp_a0;
    if ((SkelAnime_FrameUpdateMatrix(temp_a0) != 0) && (arg0->unk314 == 3)) {
    ...
    if (func_800EE29C(arg1, 0x6CU) != 0) {
        ...
        if (arg0->unk314 != 7) {
            ...
            func_800EDF24(&arg0->actor, arg1, func_800EE200(arg1, 0x6CU));
        }
        if ((s16) temp_t9->unk0 != arg0->unk314) {
            arg0->unk314 = (s16) temp_t9->unk0;
            temp_t0 = arg0->unk314;
            switch (temp_t0) {
            case 1:
            ...
            case 7:
                ...
                arg0->unk318 = (s16) (s32) (Rand_ZeroFloat(10.0f) + 20.0f);
                break;
            case 8:
        ...
        func_800B7298(arg1, &arg0->actor, 0x1AU);
        func_801000A4(0x482CU);
        if (Player_GetMask(arg1) == 0x10) {
            func_801518B0(arg1, 0x11AFU, &arg0->actor);
        } else {
            func_801518B0(arg1, 0x11AEU, &arg0->actor);
        }
    ...
    if (arg0->unk314 == 7) {
        ...
        temp_v0 = arg0->unk318;
        if ((s32) temp_v0 > 0) {
            arg0->unk318 = temp_v0 - 1;
            return;
        }
        arg0->unk318 = (s16) (s32) (Rand_ZeroFloat(10.0f) + 20.0f);
        func_809A0350(&arg0->actor);
...
void EnGe3_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnGe3 *this = (EnGe3 *) thisx;
    func_809A0820(&this->actor, globalCtx);
...
block_7:
        ...
        if ((arg5->unk312 == 2) && ((arg1 == 8) || (arg1 == 0xD) || (arg1 == 2))) {
            temp_v0_8 = arg1 * 0x32;
...
void func_809A0C60(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.x = D_809A0DF0.unk0;
    sp18.y = D_809A0DF0.unk4;
    sp18.z = D_809A0DF0.unk8;
    if (arg1 == 6) {
...
void EnGe3_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34 = temp_v0;
    sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_809A0DFC + (this->unk2F8 * 4)));
    func_800B8050(&this->actor, globalCtx, 0);
    SkelAnime_DrawSV(globalCtx, this->unk194.skeleton, this->unk194.limbDrawTbl, (s32) this->unk194.dListCount, func_809A0A14, func_809A0C60, &this->actor);
}
