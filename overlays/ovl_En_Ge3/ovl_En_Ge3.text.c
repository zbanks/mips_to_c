typedef struct EnGe3 {
    ...
    /* 0x2FA */ char pad2FA[0x16];                  /* maybe part of unk2F8[12]? */
...
void EnGe3_Init(EnGe3 *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk148, (Actor *) this, &D_809A0DA0);
...
void func_809A0C60(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.unk0 = (s32) D_809A0DF0.unk0;
    sp18.unk4 = (s32) D_809A0DF0.unk4;
    sp18.unk8 = (s32) D_809A0DF0.unk8;
    if (arg1 == 6) {
...
void EnGe3_Draw(EnGe3 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk194.skeleton, this->unk194.limbDrawTbl, (s32) this->unk194.dListCount, func_809A0A14, func_809A0C60, (Actor *) this);
}
