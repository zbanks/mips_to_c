typedef struct ObjDora {
    /* 0x000 */ Actor actor;
    /* 0x144 */ ColliderTris unk144;                /* inferred */
    /* 0x164 */ ColliderTrisElement unk164;         /* inferred */
    /* 0x1C0 */ char pad1C0[0x1CC];                 /* maybe part of unk164[6]? */
    ...
    /* 0x3A6 */ s16 unk3A6;                         /* inferred */
    /* 0x3A8 */ s16 unk3A8;                         /* inferred */
    /* 0x3AA */ s16 unk3AA;                         /* inferred */
} ObjDora;                                          /* size = 0x3AC */
...
void ObjDora_Init(ObjDora *this, GlobalContext *globalCtx) {
    ? sp84;
    ? sp78;
    ? sp6C;
    ? sp60;
    ...
    Collider_SetTris(globalCtx, temp_a1, (Actor *) this, &D_80B61478, &this->unk164);
...
void ObjDora_Destroy(ObjDora *this, GlobalContext *globalCtx) {
    ObjDora *this = (ObjDora *) thisx;
...
void ObjDora_Update(ObjDora *this, GlobalContext *globalCtx) {
    ObjDora *this = (ObjDora *) thisx;
    this->actionFunc(this, globalCtx);
    func_80B60EE8((Actor *) this, globalCtx);
}

void ObjDora_Draw(ObjDora *this, GlobalContext *globalCtx) {
    f32 sp40;
    Gfx *sp34;
    Gfx *sp2C;
    Gfx *sp24;
