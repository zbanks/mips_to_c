typedef struct BgFireWall {
    ...
    /* 0x14E */ char pad14E[0xA];                   /* maybe part of unk14C[6]? */
...
void BgFireWall_Init(BgFireWall *this, GlobalContext *globalCtx) {
...
void BgFireWall_Destroy(BgFireWall *this, GlobalContext *globalCtx) {
    BgFireWall *this = (BgFireWall *) thisx;
...
void func_809AC6C0(BgFireWall *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = this;
    phi_a3 = this;
    if ((this->unk14C != 0) || (this = this, temp_a3 = this, phi_a3 = temp_a3, (func_809AC5C0((Actor *) temp_a0) != 0))) {
        phi_a3->unk15C = 0.09f;
...
void func_809AC7F8(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0->unk1AA = (s16) (s32) (arg0->world.pos.x + (sp38 * temp_f0_2) + (sp40 * sp30));
    arg0->unk1AE = (s16) (s32) ((arg0->world.pos.z - (sp38 * sp30)) + (sp40 * temp_f0_2));
}
...
void BgFireWall_Update(BgFireWall *this, GlobalContext *globalCtx) {
    ...
    if ((func_809AC6C0 == this->actionFunc) && ((func_800B9010((Actor *) this, 0x2034U), temp_v0_3 = this->unk14C, (temp_v0_3 == 0)) || ((temp_v0_3 != 0) && (this->actor.xzDistToPlayer < 240.0f)))) {
