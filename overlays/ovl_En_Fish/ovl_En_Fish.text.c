typedef struct EnFish {
    ...
    /* 0x1EE */ char pad1EE[0x24];                  /* maybe part of unk1E8[7]? */
    /* 0x212 */ Vec3s unk212;                       /* inferred */
    /* 0x218 */ char pad218[0x24];                  /* maybe part of unk212[7]? */
    /* 0x23C */ void (*unk23C)(EnFish *, void *);   /* inferred */
    /* 0x240 */ s16 unk240;                         /* inferred */
    /* 0x242 */ s16 unk242;                         /* inferred */
    ...
    /* 0x268 */ char pad268[0x2];
    /* 0x26A */ s16 unk26A;                         /* inferred */
    /* 0x26C */ char pad26C[0x4];                   /* maybe part of unk26A[3]? */
    /* 0x270 */ s16 unk270;                         /* inferred */
    /* 0x272 */ char pad272[0x2];
    /* 0x274 */ s16 unk274;                         /* inferred */
    /* 0x276 */ s8 unk276;                          /* inferred */
    /* 0x277 */ char pad277[0x1];
    /* 0x278 */ s8 unk278;                          /* inferred */
    /* 0x279 */ char pad279[0x3];                   /* maybe part of unk278[4]? */
} EnFish;                                           /* size = 0x27C */
...
void EnFish_Init(EnFish *this, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, sp30, (Actor *) this, &D_8091FA84, &this->unk164);
...
void func_8091E128(EnFish *arg0, void *arg1) {
    ...
    sp28 = temp_a1;
    sp2C = temp_a0;
    if ((func_8091D630((f32 *) temp_a0, temp_a1) > 6400.0f) || ((s32) arg0->unk240 < 4)) {
        arg0->unk270 = arg0->unk264;
        arg0->unk26A = Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) temp_a1);
        arg0->unk24C = 1.0f;
    } else {
        temp_v0 = arg0->actor.child;
        if ((temp_v0 != 0) && (arg0 != temp_v0)) {
            arg0->unk270 = arg0->unk264;
            arg0->unk26A = Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) &arg0->actor.child->world);
            arg0->unk24C = 1.2f;
        } else {
...
void func_8091E658(EnFish *arg0, void *arg1) {
    ...
    if (func_8091D630((f32 *) temp_a0, temp_a1) > 6400.0f) {
        arg0->unk270 = arg0->unk264;
        arg0->unk26A = Math_Vec3f_Yaw((Vec3f *) sp2C, (Vec3f *) temp_a1);
        arg0->unk24C = 1.0f;
    } else {
        ...
        arg0->unk270 = arg0->unk264;
        arg0->unk26A = Math_Vec3f_Yaw((Vec3f *) sp2C, (Vec3f *) &sp38);
        arg0->unk24C = 1.2f;
    }
    temp_f0 = (arg0->actor.speedXZ * 1.5f) + 0.8f;
    if (temp_f0 > 4.0f) {
...
block_15:
    ...
    arg0->unk268 = Math_Vec3f_Pitch((Vec3f *) &arg0->world, (Vec3f *) &arg0->home);
    arg0->unk26C = 0;
