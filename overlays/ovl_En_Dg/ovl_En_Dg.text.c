struct _mips2c_stack_EnDg_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnDg_Draw {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ GraphicsContext *sp30;               /* inferred */
    /* 0x34 */ char pad_34[0x4];
};                                                  /* size = 0x38 */

struct _mips2c_stack_EnDg_Init {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ ColliderCylinder *sp34;              /* inferred */
    /* 0x38 */ char pad_38[0x8];
};                                                  /* size = 0x40 */

struct _mips2c_stack_EnDg_Update {
...
struct _mips2c_stack_func_80989140 {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_80989204 {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ void *sp34;                          /* inferred */
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_8098933C {
...
struct _mips2c_stack_func_80989418 {
...
struct _mips2c_stack_func_809895B4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80989674 {
...
struct _mips2c_stack_func_80989864 {
...
struct _mips2c_stack_func_80989974 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ SkelAnime *sp1C;                     /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809899C8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80989A08 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80989A48 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ SkelAnime *sp1C;                     /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80989A9C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80989ADC {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80989BF8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80989D38 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80989E18 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80989FC8 {};              /* size 0x0 */

struct _mips2c_stack_func_8098A064 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8098A1B4 {};              /* size 0x0 */

struct _mips2c_stack_func_8098A234 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8098A468 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_8098A55C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8098A618 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_8098A70C {
    /* 0x00 */ char pad_0[0x2C];
...
struct _mips2c_stack_func_8098A89C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8098A938 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ SkelAnime *sp24;                     /* inferred */
...
struct _mips2c_stack_func_8098AAAC {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8098AB48 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8098AC34 {
    /* 0x00 */ char pad_0[0x26];
    /* 0x26 */ s16 sp26;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_8098AE58 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8098AF44 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8098AF98 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8098B004 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_8098B198 {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ void (*sp2C)(EnDg *, GlobalContext *); /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_8098B28C {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_8098B390 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8098B464 {
    /* 0x00 */ char pad_0[0x2C];
...
struct _mips2c_stack_func_8098B560 {
    /* 0x00 */ char pad_0[0x2C];
...
struct _mips2c_stack_func_8098B88C {
    /* 0x00 */ char pad_0[0x34];
    /* 0x34 */ f32 sp34;                            /* inferred */
    /* 0x38 */ f32 sp38;                            /* inferred */
    /* 0x3C */ f32 sp3C;                            /* inferred */
...
struct _mips2c_stack_func_8098BA64 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8098BB10 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_8098BBEC {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8098BC54 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8098BFB8 {};              /* size 0x0 */

struct _mips2c_stack_func_8098BFD4 {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ f32 sp20;                            /* inferred */
...
static s16 D_8098C2FE[3] = {0xFFFF, 0x353E, 0};
...
static f32 D_8098C440[7] = {1.2f, 9.1834e-41f, 9.403955e-38f, 2.4098943e-35f, 0.5f, 9.1834e-41f, 0.0f};
...
void func_80989204(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((sp34->unk_14B == 3) && (func_8098AC34 == arg0->unk_144)) {
        CollisionCheck_SetAT(arg1, arg1 + 0x18884, (Collider *) temp_s2);
    } else {
        Collider_ResetCylinderAT(arg1, (Collider *) temp_s2);
    }
    if ((arg0->unk_290 != 1) && ((arg0->unk_280 & 2) == 0)) {
        CollisionCheck_SetOC(arg1, &arg1->colChkCtx, (Collider *) temp_s2);
    } else {
        Collider_ResetCylinderOC(arg1, (Collider *) temp_s2);
    }
...
void func_80989674(Actor *arg0, void *arg1) {
    ...
    if (temp_t6 != 0) {
        ...
        if ((temp_v0_2 == 0x15) || ((temp_v0_2 == 0x14) && (arg1->unk_A4 == 0x10))) {
...
void func_80989864(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((s32) (arg0->unk_286 + (s16) (s32) arg0->unk_164) % phi_v0) == 0) {
...
void func_80989BF8(Actor *arg0) {
    ...
    temp_v1 = (arg0->unk_286 * 6) + &D_8098C2A8;
    temp_v0_2 = temp_v1->unk_4;
    phi_v0 = temp_v0_2;
    phi_v1 = temp_v1;
    if (((s32) temp_v0_2 >= 0x3547) || ((s32) temp_v0_2 < 0x3538)) {
        temp_v1->unk_4 = 0x353E;
        temp_v1_2 = (arg0->unk_286 * 6) + &D_8098C2A8;
        phi_v0 = temp_v1_2->unk_4;
        phi_v1 = temp_v1_2;
    }
    if (phi_v0 == 0x353D) {
        phi_v1->unk_4 = 0x3538;
...
void func_80989E18(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v1 = D_8098C2A0;
    if ((temp_v1 != 0) && (temp_v0 = arg0->unk_280, ((temp_v0 & 1) == 0))) {
        arg0->unk_280 = (u16) (temp_v0 | 1);
        arg0->flags |= 0x8000000;
    } else if (temp_v1 == 0) {
        temp_v0_2 = arg0->unk_280;
        if ((temp_v0_2 & 1) != 0) {
            arg0->unk_280 = (u16) (temp_v0_2 & 0xFFFE);
    ...
    if (Actor_HasParent(arg0, arg1) != 0) {
        Audio_PlayActorSound2(arg0, 0x28D8U);
        arg0->unk_290 = 1;
        temp_t9 = (arg0->unk_286 * 6) + &D_8098C2A8;
        D_8098C2FC.unk_0 = (s32) (unaligned s32) temp_t9->unk_0;
        D_8098C2FC.unk_4 = (u16) temp_t9->unk_4;
        if (D_8098C2A0 == 0) {
            arg0->flags |= 0x8000000;
            D_8098C2A0 = 1;
        ...
        if (Player_GetMask(arg1) == 1) {
            ...
            arg0->unk_144 = func_8098BBEC;
            return;
        }
        arg0->unk_144 = func_8098BA64;
        return;
    }
...
void func_8098A064(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg1->actorCtx.actorList[2].first->unk_A74 * 4) < 0) {
        ...
        if (phi_v0 == phi_a3->unk_286) {
            temp_v0_2 = phi_a3->unk_280;
            if ((temp_v0_2 & 0x20) == 0) {
                phi_a3->unk_280 = (u16) (temp_v0_2 | 0x20);
                arg0 = phi_a3;
                func_80989140(phi_a3 + 0x14C, &D_8098C35C, 1, phi_a3);
                phi_t1 = func_8098AF44;
                goto block_15;
            }
            temp_v0_3 = phi_a3->unk_144;
            if ((func_8098B004 == temp_v0_3) || (func_8098AB48 == temp_v0_3)) {
                temp_v0_4 = phi_a3->unk_292;
                if (temp_v0_4 == 0) {
                    phi_v1 = 0;
                } else {
                    phi_a3->unk_292 = (s16) (temp_v0_4 - 1);
                    phi_v1 = phi_a3->unk_292;
                }
                if (phi_v1 == 0) {
                    phi_a3->unk_292 = 0xA;
    ...
    if (D_8098C2A4 == temp_a3->unk_286) {
        temp_a3->unk_280 = (u16) (temp_a3->unk_280 & 0xFFDF);
        D_8098C2A4 = 0x63;
        arg0 = temp_a3;
...
void func_8098A234(Actor *arg0, Actor *arg1) {
    ...
    if ((temp_a3->bgCheckFlags & 0x20) == 0) {
        ...
        if (temp_v0 != 1) {
            if (temp_v0 != 2) {
                if (temp_v0 != 3) {
                    if ((temp_v0 == 4) && (temp_a3->unk_28C != 1)) {
                        temp_a3->unk_28C = 1;
...
void func_8098A468(EnDg *this, GlobalContext *globalCtx) {
    ...
    func_80989674((Actor *) this);
    Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) this);
    if (sp24->unk_14B == 4) {
        func_80989E18((Actor *) this, globalCtx);
    }
    func_8098A064((Actor *) this, globalCtx);
    func_80989974((Actor *) this);
...
void func_8098A55C(EnDg *this, GlobalContext *globalCtx) {
    ...
    if (globalCtx->actorCtx.actorList[2].first->unk_14B == 4) {
        func_80989E18((Actor *) this, globalCtx);
    }
    func_809899C8((Actor *) this, 13.0f);
    func_809899C8((Actor *) this, 19.0f);
    if ((this->actor.bgCheckFlags & 1) == 0) {
        this->actionFunc = func_8098AF98;
    }
    temp_v0 = this->unk_282;
    ...
    if (phi_v1 == 0) {
        ...
        func_80989ADC((Actor *) this, (Actor *) globalCtx);
    }
}
...
void func_8098A70C(EnDg *this, GlobalContext *globalCtx) {
    ...
    if (func_801378B8(sp2C, 3.0f) != 0) {
        Audio_PlayActorSound2((Actor *) this, 0x290AU);
        return;
    }
    if (func_801378B8(sp2C, 6.0f) != 0) {
        Audio_PlayActorSound2((Actor *) this, 0x28EFU);
    }
}
...
void func_8098A89C(EnDg *this, GlobalContext *globalCtx) {
    ...
    func_80989A08((Actor *) this, 13.0f);
    func_80989A08((Actor *) this, 19.0f);
}
...
void func_8098AC34(EnDg *this, GlobalContext *globalCtx) {
    ...
    if ((s32) sp26 < 9) {
        ...
        func_80989864((Actor *) this, globalCtx);
    } else {
        this->unk_280 |= 2;
    ...
    func_80989A9C((Actor *) this, 10.0f);
}
...
void func_8098AF44(EnDg *this, GlobalContext *globalCtx) {
    if (func_801A46F8() == 1) {
        this->unk_292 = 0xA;
        Audio_PlayActorSound2((Actor *) this, 0x28D8U);
        this->actionFunc = func_8098B004;
    }
}
...
void func_8098AF98(EnDg *this, GlobalContext *globalCtx) {
    ...
    if ((temp_a3->actor.bgCheckFlags & 1) != 0) {
        this = temp_a3;
        func_80989140(temp_a0, &D_8098C35C, 2, (Actor *) temp_a3);
        this->actionFunc = func_8098A468;
        phi_a3 = this;
    }
    this = phi_a3;
    Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) phi_a3);
    func_809899C8((Actor *) this, 3.0f);
}
...
void func_8098B390(EnDg *this, GlobalContext *globalCtx) {
    ...
    func_80989A9C((Actor *) this, 0.0f);
    func_80989A9C((Actor *) this, 1.0f);
    func_80989A9C((Actor *) this, 2.0f);
    func_80989A9C((Actor *) this, 3.0f);
    func_809899C8((Actor *) this, 5.0f);
}
...
void func_8098BA64(EnDg *this, GlobalContext *globalCtx) {
    ...
    if (Actor_HasNoParent((Actor *) this, globalCtx) != 0) {
        ...
        *D_8098C2FE = temp_a0->unk_288;
        ...
        this = temp_a0;
        Actor_SetVelocityAndMoveYRotationAndGravity((Actor *) temp_a0);
...
void func_8098BBEC(EnDg *this, GlobalContext *globalCtx) {
    ...
    func_800B8614((Actor *) temp_a0, globalCtx, 100.0f);
}
...
void EnDg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, (Actor *) this, &D_8098C304);
    CollisionCheck_SetInfo2(&this->actor.colChkInfo, &D_8098C33C, &D_8098C330);
    Actor_ProcessInitChain((Actor *) this, &D_8098C45C);
...
void EnDg_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (((globalCtx->actorCtx.actorList[2].first->unk_A6C & 0x20) == 0) || (globalCtx->sceneNum != 0x6F)) {
        if (func_8098A1B4(this, globalCtx) != 0) {
            func_8098A234((Actor *) this, (Actor *) globalCtx);
        } else if (this->unk_28C != 8) {
            this->unk_28C = 8;
            func_80989ADC((Actor *) this, (Actor *) globalCtx);
        }
        if (((this->actor.bgCheckFlags & 0x40) != 0) && (Actor_HasNoParent((Actor *) this, globalCtx) != 0)) {
            func_80989140(&this->skelAnime, &D_8098C35C, 0xF);
            this->actionFunc = (void (*)(EnDg *, GlobalContext *)) func_8098B464;
        }
        sp24 = &this->skelAnime;
        this->actionFunc(this, globalCtx);
        func_80989204((Actor *) this, globalCtx);
        func_8098933C(this, &sp28);
        Math_ApproachF((f32 *) &this->unk_294, sp28, 0.2f, 0.1f);
...
void EnDg_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, func_8098BFB8, func_8098BFD4, (Actor *) this);
}
