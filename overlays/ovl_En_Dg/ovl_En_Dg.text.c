...
void EnDg_Init(EnDg *this, GlobalContext *globalCtx) {
...
void EnDg_Destroy(EnDg *this, GlobalContext *globalCtx) {
    EnDg *this = (EnDg *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->collider);
}

void EnDg_Update(EnDg *this, GlobalContext *globalCtx) {
    f32 sp28;
    SkelAnime *sp24;
    EnDg *this = (EnDg *) thisx;
...
void EnDg_Draw(EnDg *this, GlobalContext *globalCtx) {
