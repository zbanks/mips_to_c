typedef struct EnArrow {
    ...
    /* 0x18E */ char pad_18E[0x1A];                 /* maybe part of unk_188[5]? */
    /* 0x1A8 */ ColliderQuad unk_1A8;               /* inferred */
    /* 0x1C0 */ s32 unk_1C0;                        /* overlap */
    /* 0x228 */ Vec3f unk_228;                      /* inferred */
    /* 0x234 */ Vec3f unk_234;                      /* inferred */
    /* 0x240 */ s32 unk_240;                        /* inferred */
    /* 0x244 */ char pad_244[0x1C];                 /* maybe part of unk_240[8]? */
    /* 0x260 */ u8 unk_260;                         /* inferred */
    /* 0x261 */ u8 unk_261;                         /* inferred */
    /* 0x262 */ u8 unk_262;                         /* inferred */
    /* 0x263 */ u8 unk_263;                         /* inferred */
    /* 0x264 */ Actor *unk_264;                     /* inferred */
    /* 0x268 */ Vec3f unk_268;                      /* inferred */
...
struct _mips2c_stack_EnArrow_Draw {
    ...
    /* 0x40 */ char pad_40[0x18];                   /* maybe part of sp3C[7]? */
    /* 0x58 */ GraphicsContext *sp58;               /* inferred */
    /* 0x5C */ f32 sp5C;                            /* inferred */
    /* 0x60 */ char pad_60[0x3];
    /* 0x63 */ u8 sp63;                             /* inferred */
    /* 0x64 */ char pad_64[0x4];                    /* maybe part of sp63[5]? */
    /* 0x68 */ Gfx *sp68;                           /* inferred */
    /* 0x6C */ char pad_6C[0x14];                   /* maybe part of sp68[6]? */
    /* 0x80 */ Gfx *sp80;                           /* inferred */
    /* 0x84 */ char pad_84[0x14];                   /* maybe part of sp80[6]? */
...
void EnArrow_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) this->actor.params < 6) {
        ...
        SkelAnime_Init(globalCtx, &this->unk_144, &D_04014560, (AnimationHeader *) &D_040128BC, temp_v0, temp_v0, 5);
        ...
        if ((s32) temp_a0 < 3) {
            ...
            Effect_Add(globalCtx, &this->unk_240, 2, 0U, (u8) 0, &D_8088C234);
        } else if (temp_a0 == 3) {
            Effect_Add(globalCtx, &this->unk_240, 2, 0U, (u8) 0, &D_8088C258);
        } else if (temp_a0 == 4) {
            Effect_Add(globalCtx, &this->unk_240, 2, 0U, (u8) 0, &D_8088C27C);
        } else if (temp_a0 == 5) {
            Effect_Add(globalCtx, &this->unk_240, 2, 0U, (u8) 0, &D_8088C2A0);
        }
    }
    temp_a1 = &this->unk_1A8;
    sp30 = temp_a1;
    Collider_InitQuad(globalCtx, temp_a1);
    Collider_SetQuad(globalCtx, temp_a1, (Actor *) this, &D_8088C1E0);
    if ((s32) this->actor.params < 6) {
        temp_t7 = this->unk_1A8.info.toucherFlags & 0xFFE7;
        this->unk_1A8.info.toucherFlags = temp_t7;
        this->unk_1A8.info.toucherFlags = temp_t7;
    }
    if ((s32) this->actor.params < 0) {
        this->unk_1A8.base.atFlags = 0x11;
    } else {
        this->unk_1A8.info.toucher.dmgFlags = func_800BC188((s32) this->actor.params);
        if (this->actor.params == 8) {
            this->unk_1A8.info.toucher.damage = 1;
        }
...
void func_8088A594(EnArrow *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.parent != 0) {
        if (this->actor.params == 7) {
            ...
            temp_t0 = this->unk_148 + 1;
            this->unk_148 = temp_t0;
    ...
    if ((temp_v0 != 8) && (temp_a2->unk_D57 == 0)) {
        if (temp_v0 == 7) {
    ...
    temp_v0_2 = this->actor.params;
    if (temp_v0_2 == 7) {
        temp_f0 = this->unk_144;
        if (temp_f0 < 3.5f) {
            this->unk_144 = 3.5f;
        } else {
            this->unk_144 = temp_f0;
        }
...
void func_8088A894(EnArrow *arg0, GlobalContext *arg1) {
    ...
    if (!(temp_f12 < 0.0f) && (sp4C = temp_f12, temp_f0 = Math3D_LengthSquared((Vec3f *) &sp68), !(temp_f0 < 1.0f))) {
        ...
        Math_Vec3f_Sum(arg0->unk_264 + 0x24, (Vec3f *) &sp68, (Vec3f *) &sp5C);
        if (func_800C55C4(arg1 + 0x830, arg0->unk_264 + 0x24, (Vec3f *) &sp5C, (Vec3f *) &sp50, &sp74, 1U, 1U, 1U, 1U, &sp44) != 0) {
            if (sp5C <= sp50) {
                phi_f0 = 1.0f;
            } else {
                phi_f0 = -1.0f;
            }
            arg0->unk_264->world.pos.x = phi_f0 + sp50;
            if (sp60 <= sp54) {
                phi_f0_2 = 1.0f;
            } else {
                phi_f0_2 = -1.0f;
            }
            arg0->unk_264->world.pos.y = phi_f0_2 + sp54;
            if (sp64 <= sp58) {
                phi_f0_3 = 1.0f;
            } else {
                phi_f0_3 = -1.0f;
            }
            arg0->unk_264->world.pos.z = phi_f0_3 + sp58;
            return;
        }
        Math_Vec3f_Copy(arg0->unk_264 + 0x24, (Vec3f *) &sp5C);
...
void func_8088AA98(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((func_800CA1AC(arg1, arg1 + 0x830, arg0->world.pos.x, arg0->world.pos.z, temp_t6, &sp54) != 0) && (arg0->world.pos.y < sp50) && (temp_v0 = arg0->bgCheckFlags, ((temp_v0 & 0x20) == 0))) {
        ...
        if ((temp_v0_2 == 4) || (temp_v0_2 == 3)) {
            if ((temp_v0_2 == 4) && (arg0[1].init != func_8088B6B0)) {
            ...
            temp_a0 = arg0->child;
            arg0->params = 2;
            arg0[1].wallPoly = (CollisionPoly *)0x20;
            if (temp_a0 != 0) {
...
block_20:
    ...
    if ((phi_v0_2 != 0) || (this->unk_262 != 0)) {
        ...
        if (this->actor.params == 7) {
            ...
            if (Math_StepToF((f32 *) &this->unk_144, 1.0f, 0.4f) != 0) {
                ...
                this->unk_14A = (s16) (this->unk_14A + (s32) (this->unk_144 * (500.0f + Rand_ZeroFloat(1400.0f))));
                this->actor.world.rot.x += (s32) (500.0f * Math_SinS(this->unk_14A));
                this->actor.shape.rot.x = this->actor.world.rot.x;
                this->unk_14C = (s16) (this->unk_14C + (s32) (this->unk_144 * (500.0f + Rand_ZeroFloat(1400.0f))));
                this->actor.world.rot.y += (s32) (500.0f * Math_SinS(this->unk_14C));
                this->actor.shape.rot.y = this->actor.world.rot.y;
                func_8088A514((Actor *) this);
            }
            func_800B9010((Actor *) this, 0x105AU);
        } else if ((s32) this->unk_260 < 7) {
            this->actor.gravity = -0.4f;
        }
        temp_a1 = &this->actor.world;
        sp40 = temp_a1;
        Math_Vec3f_Copy(&this->unk_228, (Vec3f *) temp_a1);
        if (this->actor.speedXZ == 0.0f) {
    ...
    temp_v0_5 = this->unk_264;
    if (temp_v0_5 != 0) {
        temp_a1_3 = &this->unk_268;
        if (temp_v0_5->update != 0) {
            sp3C = &globalCtx->colCtx;
            sp44 = temp_a1_3;
            Math_Vec3f_Sum(&this->unk_228, temp_a1_3, (Vec3f *) &sp60);
            ...
            if (func_800C55C4(sp3C, (Vec3f *) &sp60, (Vec3f *) &sp54, (Vec3f *) &sp9C, &spAC, 1U, 1U, 1U, 1U, &spA8) != 0) {
                ...
                this->unk_264->world.pos.x = phi_f0 + sp9C;
                if (sp58 <= spA0) {
                    phi_f0_2 = 1.0f;
                } else {
                    phi_f0_2 = -1.0f;
                }
                this->unk_264->world.pos.y = phi_f0_2 + spA0;
                if (sp5C <= spA4) {
                    phi_f0_3 = 1.0f;
                } else {
                    phi_f0_3 = -1.0f;
                }
                this->unk_264->world.pos.z = phi_f0_3 + spA4;
                Math_Vec3f_Diff((Vec3f *) &this->unk_264->world, (Vec3f *) sp40, sp44);
                temp_v0_6 = this->unk_264;
                temp_v0_6->flags &= 0xFFFF7FFF;
                this->unk_264 = NULL;
            } else {
                Math_Vec3f_Sum((Vec3f *) sp40, sp44, (Vec3f *) &this->unk_264->world);
            }
            if ((this->unk_262 != 0) && (temp_v0_7 = this->unk_264, (temp_v0_7 != 0))) {
...
void func_8088B630(EnArrow *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = phi_a2[1].colorFilterTimer;
    temp_t6 = temp_v0 - 1;
    if (temp_v0 == 0) {
        phi_v1 = 0;
    } else {
        phi_a2[1].colorFilterTimer = temp_t6;
        phi_v1 = temp_t6 & 0xFF;
    }
    if (phi_v1 == 0) {
...
void EnArrow_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a2 = globalCtx->actorCtx.actorList[2].first;
    if ((this->unk_263 != 0) || ((temp_v0 = this->actor.params, ((s32) temp_v0 >= 0)) && ((temp_v0 == 7) || (temp_a2->unk_D57 != 0))) || (func_80123358(globalCtx, (Player *) temp_a2) == 0)) {
        this->actionFunc(this, globalCtx);
    }
    temp_v0_2 = this->actor.params;
    if (((s32) temp_v0_2 >= 3) && ((s32) temp_v0_2 < 6)) {
        sp44.unk_0 = (s32) D_8088C2C4.unk_0;
        sp44.unk_4 = (u16) D_8088C2C4.unk_4;
        if (this->actor.child == 0) {
            Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, (&sp44 + (this->actor.params * 2))->unk_-6, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, 0);
        }
    } else if (temp_v0_2 == 0) {
        func_800B0EB0(globalCtx, &this->unk_234, &D_8088C2CC, &D_8088C2D8, &D_8088C2E4, &D_8088C2E8, (s16) 0x64, (s16) 0, (s16) 8);
    }
...
void func_8088B88C(GlobalContext *arg0, EnArrow *arg1, Vec3f *arg2) {
    ...
    if (arg1->actionFunc == func_8088ACE0) {
        ...
        SysMatrix_MultiplyVector3fByState(&phi_a2[1], (Vec3f *) &sp34);
        ...
        if ((s32) temp_v0 < 8) {
            ...
            } else if ((temp_v1 != 0) && (sp40 == arg1->unk_248) && (sp44 == arg1->unk_24C) && (sp48 == arg1->unk_250) && (sp34 == arg1->unk_254) && (sp38 == arg1->unk_258) && (sp3C == arg1->unk_25C)) {
                phi_v1 = 0;
            }
            if (phi_v1 != 0) {
                func_800A81F0(Effect_GetParams(arg1->unk_240), (Vec3f *) &sp40, (Vec3f *) &sp34);
            }
        }
    }
}
...
void EnArrow_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 < 6) {
        ...
        SkelAnime_LodDraw(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, NULL, NULL, (Actor *) this, phi_v0);
        goto block_21;
    }
    if (temp_v0 == 7) {
        spA4 = 0xFF - (s32) (temp_a3->unk_144 * 4.0f);
        temp_f2 = (temp_a3->actor.speedXZ * 0.1f) + 1.0f;
        temp_f16 = 1.0f / temp_f2;
        temp_t0 = globalCtx->state.gfxCtx;
        if ((s32) temp_a3->unk_149 >= 0) {
            temp_a1 = temp_a3;
            this = temp_a3;
            sp98 = temp_t0;
            spA0 = temp_f2;
            ...
            spA0 = temp_f2;
            sp9C = temp_f16;
            Collider_ResetQuadAT(globalCtx, (Collider *) &temp_a3->unk_1A8);
        }
        temp_f0 = this->unk_144;
        ...
        if (this->actor.speedXZ == 0.0f) {
            ...
            globalCtx->state.gfxCtx->polyXlu.p = &temp_v0_2[1];
            temp_v0_2->words.w0 = 0xDE000000;
            temp_v0_2->words.w1 = (u32) &D_0406F380;
            temp_v0_3 = globalCtx->state.gfxCtx->polyXlu.p;
            globalCtx->state.gfxCtx->polyXlu.p = &temp_v0_3[1];
        ...
        globalCtx->state.gfxCtx->polyOpa.p = &temp_v0_9[1];
        ...
        globalCtx->state.gfxCtx->polyOpa.p = &temp_v0_11[1];
        ...
        globalCtx->state.gfxCtx->polyOpa.p = &temp_v0_13[1];
    ...
    if (temp_a3->actor.speedXZ != 0.0f) {
        this = temp_a3;
        temp_a1_2 = (u32) ((Math_CosS((s16) (temp_a3->unk_260 * 0x1388)) * 127.5f) + 127.5f) & 0xFF;
