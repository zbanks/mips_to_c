typedef struct EnSyatekiWf {
    ...
    /* 0x212 */ char pad_212[0x82];                 /* maybe part of unk_20C[22]? */
    ...
    /* 0x2B4 */ ColliderCylinder unk_2B4;           /* inferred */
    /* 0x300 */ ColliderCylinder unk_300;           /* inferred */
    /* 0x34C */ ColliderCylinder unk_34C;           /* inferred */
    /* 0x398 */ char pad_398[0x34];
...
void EnSyatekiWf_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->actor.parent->unk_18C;
    phi_v1 = temp_v1;
    phi_v1_3 = temp_v1;
    if (temp_v1->unk2 != 2) {
        do {
    ...
    sp3C = phi_v1_2;
    this->unk_2A0 = Lib_SegmentedToVirtual(phi_v1_2->points);
    this->unk_2A4 = 1;
    this->unk_2A6 = (s16) phi_v1_2->count;
    ...
    temp_a1_2 = &this->unk_300;
    sp30 = temp_a1_2;
    Collider_InitCylinder(globalCtx, temp_a1_2);
    Collider_SetCylinder(globalCtx, temp_a1_2, (Actor *) this, &D_80A20EB0);
    temp_a1_3 = &this->unk_34C;
    sp30 = temp_a1_3;
    Collider_InitJntSph(globalCtx, (ColliderJntSph *) temp_a1_3);
    Collider_SetJntSph(globalCtx, (ColliderJntSph *) temp_a1_3, (Actor *) this, &D_80A20EA0, (ColliderJntSphElement *) &this->unk_34C.info.bumper);
    this->unk_368->unk_36 = (s16) D_80A20EAC->unk_20;
...
void func_80A200E0(void *arg0) {
    ...
    temp_a0 = arg0 + 0x24;
    temp_a1 = &sp24;
    arg0->unk_24 = (f32) temp_v0->unk_0;
    arg0->unk_28 = (f32) temp_v0->unk_2;
    arg0->unk_2C = (f32) temp_v0->unk_4;
    sp24 = (f32) *(temp_v0 + (arg0->unk_2A4 * 6));
    sp28 = (f32) (arg0->unk_2A0 + (arg0->unk_2A4 * 6))->unk_2;
    temp_t2 = (arg0->unk_2A0 + (arg0->unk_2A4 * 6))->unk_4;
    arg0 = arg0;
    sp2C = (f32) temp_t2;
    temp_v0_2 = Math_Vec3f_Yaw(temp_a0, (Vec3f *) temp_a1);
    arg0->unk_BE = temp_v0_2;
    arg0->unk_32 = temp_v0_2;
}
...
void func_80A201CC(EnSyatekiWf *arg0) {
    ...
    arg0->actor.world.pos.x = temp_v1->unk_0;
    arg0->actor.world.pos.y = temp_v1->unk_4;
    arg0->actor.world.pos.z = temp_v1->unk_8;
    arg0->unk_30 = (s32) temp_v1->unk_C;
    arg0->unk_34 = (s32) temp_v1->unk_10;
    arg0->actor.prevPos.x = temp_v1->unk_0;
    arg0->actor.prevPos.y = temp_v1->unk_4;
    arg0->unk_BC = (unaligned s32) arg0->unk_30;
    arg0->actor.colChkInfo.health = 2;
    arg0->actor.draw = NULL;
    arg0->unk_2A4 = 1;
    arg0->unk_298 = 0;
    arg0->actor.prevPos.z = temp_v1->unk_8;
    arg0->actor.shape.rot.z = (u16) arg0->actor.world.rot.z;
    temp_v0->unk_276 = (s16) (temp_v0->unk_276 & ~(1 << ((s32) (arg0->actor.params & 0xFF00) >> 8)));
...
void func_80A20284(EnSyatekiWf *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        if ((temp_v0->unk_26A == (void *)1) && (this->unk_298 == (void *)1)) {
            func_80A200E0((void *)1);
            func_80A2030C(this);
            return;
        }
        if ((temp_v0->unk_276 & (1 << ((s32) (this->actor.params & 0xFF00) >> 8))) != 0) {
            this->unk_298 = (s16) (void *)1;
        }
...
void func_80A203DC(EnSyatekiWf *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.parent->unk_26A != 1) {
        func_80A201CC(this);
    }
    sp54 = (f32) *(this->unk_2A0 + (this->unk_2A4 * 6));
    sp58 = (f32) (this->unk_2A0 + (this->unk_2A4 * 6))->unk_2;
    sp5C = (f32) (this->unk_2A0 + (this->unk_2A4 * 6))->unk_4;
...
block_9:
        ...
        this->unk_2A8 = Math_Vec3f_Yaw((Vec3f *) temp_a0_2, (Vec3f *) &sp54);
        if (sp50 > 15.0f) {
            Math_SmoothStepToS(&this->actor.world.rot.y, this->unk_2A8, 5, 0x3000, (s16) 0x100);
            ...
            temp_v0_2 = this->unk_2A4;
            if ((s32) temp_v0_2 < (this->unk_2A6 - 1)) {
...
void func_80A2075C(EnSyatekiWf *this, GlobalContext *globalCtx) {
    ...
    temp_a2 = this;
    temp_a1 = temp_a2->unk_144.animFrameCount;
    this = temp_a2;
    if (func_801378B8(&temp_a2->unk_144, temp_a1) != 0) {
        func_80A20378(this);
    }
}
...
void func_80A208F8(EnSyatekiWf *this, GlobalContext *globalCtx) {
    ...
    sp5C.unk_0 = (s32) D_80A20FC4.unk_0;
    sp5C.unk_4 = (s32) D_80A20FC4.unk_4;
    sp5C.unk_8 = (s32) D_80A20FC4.unk_8;
    temp_s0 = (s32) this->unk_144.totalFrames - (s32) this->unk_144.animCurrentFrame;
    phi_s0 = temp_s0;
    if (temp_s0 >= 0) {
        temp_s3 = &sp68;
        do {
...
void EnSyatekiWf_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v1 = this->unk_2B4.base.acFlags;
    if (((temp_v1 & 2) != 0) || ((this->unk_300.base.acFlags & 2) != 0) || ((this->unk_34C.base.acFlags & 2) != 0)) {
        temp_t3 = this->actor.colChkInfo.health - 2;
        this->unk_2B4.base.acFlags = temp_v1 & 0xFFFD;
        this->unk_300.base.acFlags &= 0xFFFD;
        this->unk_34C.base.acFlags &= 0xFFFD;
    ...
    if ((sp34 != temp_v0) && (func_80A208F8 != temp_v0) && (this->actor.draw != 0)) {
        ...
        sp30 = temp_a1_2;
        CollisionCheck_SetAC(globalCtx, temp_a1_2, (Collider *) &this->unk_300);
        CollisionCheck_SetAC(globalCtx, temp_a1_2, (Collider *) sp2C);
        CollisionCheck_SetAC(globalCtx, temp_a1_2, (Collider *) &this->unk_34C);
        this->actor.focus.pos.x = sp34->unk_0;
        this->actor.focus.pos.y = sp34->unk_4;
        this->actor.focus.pos.z = sp34->unk_8;
...
void EnSyatekiWf_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80A20CF4, func_80A20D10, (Actor *) this);
}
