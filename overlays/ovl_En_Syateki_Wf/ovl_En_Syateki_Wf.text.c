...
static ActorAnimationEntry D_80A20F14 = {
...
static InitChainEntry D_80A20FBC;                   /* unable to generate initializer */
...
typedef struct EnSyatekiWf {
    ...
    /* 0x0212 */ char pad212[0x82];
    /* 0x0294 */ void (*actionFunc)(EnSyatekiWf *, GlobalContext *);
    ...
    /* 0x02A0 */ void *unk2A0;                      /* inferred */
    /* 0x02A4 */ s16 unk2A4;                        /* inferred */
    /* 0x02A6 */ s16 unk2A6;                        /* inferred */
    /* 0x02A8 */ s16 unk2A8;                        /* inferred */
    /* 0x02AA */ char pad2AA[0x2];                  /* maybe part of unk2A8[2]? */
    /* 0x02AC */ f32 unk2AC;                        /* inferred */
    /* 0x02B0 */ u8 unk2B0;                         /* inferred */
    /* 0x02B1 */ char pad2B1[0x3];                  /* maybe part of unk2B0[4]? */
    /* 0x02B4 */ ColliderCylinder unk2B4;           /* inferred */
    /* 0x0300 */ ColliderCylinder unk300;           /* inferred */
    /* 0x034C */ ColliderCylinder unk34C;           /* inferred */
    /* 0x0368 */ void *unk368;                      /* overlap; inferred */
    /* 0x036C */ char pad36C[0x60];                 /* maybe part of unk368[25]? */
...
void EnSyatekiWf_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80A20E74);
    temp_a1_2 = &this->unk300;
    sp30 = temp_a1_2;
    Collider_InitCylinder(globalCtx, temp_a1_2);
    Collider_SetCylinder(globalCtx, temp_a1_2, &this->actor, &D_80A20EB0);
    temp_a1_3 = &this->unk34C;
    sp30 = temp_a1_3;
    Collider_InitJntSph(globalCtx, (ColliderJntSph *) temp_a1_3);
    Collider_SetJntSph(globalCtx, (ColliderJntSph *) temp_a1_3, &this->actor, &D_80A20EA0, (ColliderJntSphElement *) &this->unk34C.info.bumper);
...
block_9:
        ...
        sp3C = temp_a0_2;
        sp50 = Math_Vec3f_DistXZ(&temp_a0_2->pos, (Vec3f *) &sp54);
        this->unk2A8 = Math_Vec3f_Yaw(&temp_a0_2->pos, (Vec3f *) &sp54);
        if (sp50 > 15.0f) {
        ...
        if (func_801378B8(&this->unk144, this->unk144.animFrameCount) != 0) {
            func_800BBDAC(globalCtx, &this->actor, &sp3C->pos, 10.0f, 3, 2.0f, (s16) 0, (s16) 0, (u8) 0);
        }
...
void func_80A208F8(EnSyatekiWf *this, GlobalContext *globalCtx) {
    ...
    sp5C.x = D_80A20FC4.unk0;
    sp5C.y = D_80A20FC4.unk4;
    sp5C.z = D_80A20FC4.unk8;
    ...
    if (temp_s0 >= 0) {
        ...
        do {
            ...
            func_800B3030(globalCtx, (Vec3f *) temp_s3, &sp5C, &sp5C, (s16) 0x64, (s16) 0, 2);
            temp_s0_2 = phi_s0 - 1;
            phi_s0 = temp_s0_2;
        } while (temp_s0_2 >= 0);
    }
...
void EnSyatekiWf_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 32.0f, 30.0f, 60.0f, 5U);
    this->actionFunc(this, globalCtx);
    if ((this->actor.bgCheckFlags & 3) != 0) {
        func_800BE3D0(this, this->actor.shape.rot.y, &this->actor.shape);
    } else {
        Math_SmoothStepToS(&this->actor.shape.rot.x, 0, 1, 0x3E8, (s16) 0);
    ...
    if (((temp_v1 & 2) != 0) || ((this->unk300.base.acFlags & 2) != 0) || ((this->unk34C.base.acFlags & 2) != 0)) {
        ...
        if ((temp_t3 & 0xFF) == 0) {
            ...
            func_80A20858(&this->actor, globalCtx);
        } else {
            play_sound(0x4807U);
    ...
    if ((sp34 != temp_v0) && (func_80A208F8 != temp_v0) && (this->actor.draw != 0)) {
        ...
        sp30 = temp_a1_2;
        CollisionCheck_SetAC(globalCtx, temp_a1_2, &this->unk300.base);
        CollisionCheck_SetAC(globalCtx, temp_a1_2, &sp2C->base);
        CollisionCheck_SetAC(globalCtx, temp_a1_2, &this->unk34C.base);
...
void func_80A20D10(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 6) {
        SysMatrix_MultiplyVector3fByState(&D_80A20FD0, &sp18);
        arg4->unk346 = (s16) (s32) sp18.x;
        arg4->unk348 = (s16) (s32) sp18.y;
        arg4->unk34A = (s16) (s32) sp18.z;
    }
}
...
void EnSyatekiWf_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A20CF4, func_80A20D10, &this->actor);
}
