struct _mips2c_stack_ElfMsg_Destroy {};             /* size 0x0 */

struct _mips2c_stack_ElfMsg_Init {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_ElfMsg_SetupAction {};         /* size 0x0 */

struct _mips2c_stack_ElfMsg_Update {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_8092DF9C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8092E1D0 {};              /* size 0x0 */

struct _mips2c_stack_func_8092E1FC {};              /* size 0x0 */
...
static InitChainEntry D_8092E470[4];                /* unable to generate initializer */
...
void ElfMsg_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_8092DF9C((Actor *) this) == 0) {
        Actor_ProcessInitChain((Actor *) this, D_8092E470);
...
void func_8092E284(ElfMsg *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v0 != 0) && (sp24 = temp_v1, (func_8092E1FC(arg0) != 0))) {
        ...
        if (((s32) sp24->unk_A84 < 0) && ((s32) arg0->actor.home.rot.x < 0)) {
...
void ElfMsg_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_8092DF9C((Actor *) this, globalCtx) == 0) {
