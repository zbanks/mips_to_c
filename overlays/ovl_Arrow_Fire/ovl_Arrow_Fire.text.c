typedef struct ArrowFire {
    ...
    /* 0x25E */ u16 unk25E;                         /* inferred */
    /* 0x260 */ u8 unk260;                          /* inferred */
    /* 0x261 */ char pad261[0x3];                   /* maybe part of unk260[4]? */
...
void ArrowFire_Init(ArrowFire *this, GlobalContext *globalCtx) {
    ...
    this->unk25E = 0;
    this->unk254 = 0.0f;
    Collider_InitAndSetQuad(globalCtx, &this->unk144, (Actor *) this, &D_80922230);
    Collider_InitAndSetQuad(globalCtx, &this->unk1C4, (Actor *) this, &D_80922230);
}
...
void func_8092058C(ArrowFire *this, GlobalContext *globalCtx) {
    ...
    if (phi_v0_2 >= 0xD) {
        ...
        CollisionCheck_SetAT(globalCtx, temp_a1, (Collider *) &this->unk1C4);
    }
}
