...
typedef struct EnEndingHero6 {
    ...
    /* 0x0278 */ void (*actionFunc)(EnEndingHero6 *, GlobalContext *);
    /* 0x027C */ char pad27C[0x4];                  /* maybe part of actionFunc[2]? */
    /* 0x0280 */ s32 unk280;                        /* inferred */
    /* 0x0284 */ s8 unk284;                         /* inferred */
    /* 0x0285 */ char pad285[0x1];                  /* maybe part of unk284[2]? */
...
block_10:
                ...
                SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80C23F14, &this->actor);
            }
        }
    }
}
