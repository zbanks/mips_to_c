typedef struct DemoMoonend {
    ...
    /* 0x154 */ char pad154[0x8];                   /* maybe part of unk150[3]? */
...
void DemoMoonend_Init(DemoMoonend *this, GlobalContext *globalCtx) {
    ? *sp28;
    ? *temp_a0;
...
void DemoMoonend_Destroy(DemoMoonend *this, GlobalContext *globalCtx) {
    DemoMoonend *this = (DemoMoonend *) thisx;
    if ((this->actor.params & 0xF) != 1) {
...
void func_80C17B60(DemoMoonend *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, (u32) arg0->unk2DC) != 0) {
        ...
        func_800EDF24((Actor *) arg0, arg1, func_800EE200(arg1, (u32) arg0->unk2DC));
        temp_v0 = arg0->unk2DE;
        phi_v0 = temp_v0;
        if (sp26 != temp_v0) {
...
void DemoMoonend_Update(DemoMoonend *this, GlobalContext *globalCtx) {
    DemoMoonend *this = (DemoMoonend *) thisx;
...
void DemoMoonend_Draw(DemoMoonend *this, GlobalContext *globalCtx) {
    Gfx *sp2C;
    Gfx *temp_a2;
