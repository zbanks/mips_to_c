struct _mips2c_stack_EffectSsBubble_Draw {
...
struct _mips2c_stack_EffectSsBubble_Init {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EffectSsBubble_Update {
...
s32 EffectSsBubble_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    this->pos.x = ((Rand_ZeroOne() - 0.5f) * initParamsx->unk_14) + initParamsx->unk_0;
    this->pos.y = ((Rand_ZeroOne() - 0.5f) * initParamsx->unk_10) + initParamsx->unk_C + initParamsx->unk_4;
    this->pos.z = ((Rand_ZeroOne() - 0.5f) * initParamsx->unk_14) + initParamsx->unk_8;
    Math_Vec3f_Copy(&this->vec, (Vec3f *) this);
    this->life = 1;
    temp_f4 = (Rand_ZeroOne() * 0.5f) + 1.0f;
    this->draw = EffectSsBubble_Draw;
    this->update = EffectSsBubble_Update;
    this->regs[0] = (s16) (s32) (temp_f4 * initParamsx->unk_18 * 100.0f);
    return 1;
}
