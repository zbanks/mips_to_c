...
typedef struct EnRz {
    ...
    /* 0x03B8 */ u8 *unk3B8;                        /* inferred */
    /* 0x03BC */ s32 unk3BC;                        /* inferred */
    /* 0x03C0 */ ColliderCylinder unk3C0;           /* inferred */
    /* 0x040C */ EnRz *unk40C;                      /* inferred */
    /* 0x0410 */ s16 unk410;                        /* inferred */
    /* 0x0412 */ s16 unk412;                        /* inferred */
    /* 0x0414 */ char pad414[0xC];                  /* maybe part of unk412[7]? */
    /* 0x0420 */ u16 unk420;                        /* inferred */
    /* 0x0422 */ s16 unk422;                        /* inferred */
    /* 0x0424 */ s16 unk424;                        /* inferred */
    /* 0x0426 */ s16 unk426;                        /* inferred */
    /* 0x0428 */ s16 unk428;                        /* inferred */
    /* 0x042A */ s16 unk42A;                        /* inferred */
    /* 0x042C */ s16 unk42C;                        /* inferred */
    /* 0x042E */ char pad42E[0x2];                  /* maybe part of unk42C[2]? */
    /* 0x0430 */ void (*actionFunc)(EnRz *, GlobalContext *);
} EnRz;                                             /* size 0x434 */
...
void EnRz_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_s0 = &this->unk144;
    SkelAnime_InitSV(globalCtx, temp_s0, &D_0600D8D8, &D_06003A20, (Vec3s *) ((s32) &this->unk188 & ~0xF), (Vec3s *) ((s32) &this->unk2A0 & ~0xF), 0x16);
    SkelAnime_ChangeAnimDefaultRepeat(temp_s0, &D_06003A20);
    Collider_InitAndSetCylinder(globalCtx, &this->unk3C0, &this->actor, &D_80BFCCF4);
    ...
    if (temp_v1 != 1) {
        ...
        this->unk40C = func_80BFBDA0(this, globalCtx);
...
void func_80BFB780(Actor *actor, Lights *mapper, GlobalContext *globalCtx) {
    ...
    temp_a1 = &actor->world;
    if (actor->unk422 == 8) {
        actor->scale.x = (((27.0f - actor->unk418) + actor->world.pos.y) * 0.00044444448f) + 0.01f;
    }
    sp28 = temp_a1;
    Math_Vec3f_Copy(&sp34, &temp_a1->pos);
    Math_Vec3f_Copy(&sp28->pos, actor + 0x414);
...
void func_80BFB864(GlobalContext *arg0, EnRz *arg1, s16 arg2, u8 arg3, f32 arg4) {
    ...
    if (((s32) arg2 >= 0) && ((s32) arg2 < 9) && ((arg2 != arg1->unk422) || (temp_a3 != 0))) {
        if ((s32) arg2 >= 7) {
            temp_v1 = (arg2 * 4) + &D_80BFCD58;
            sp34 = temp_v1;
            sp38 = temp_a3;
            temp_f0 = (f32) SkelAnime_GetFrameCount(temp_v1->unk-1C);
            if (sp38 == 0) {
                SkelAnime_ChangeLinkAnim(arg0, arg1 + 0x144, (LinkAnimationHeader *) temp_v1->unk-1C, 0.6666667f, 0.0f, temp_f0, (u8) 0, arg4);
            } else {
                SkelAnime_ChangeLinkAnim(arg0, arg1 + 0x144, (LinkAnimationHeader *) temp_v1->unk-1C, 0.6666667f, 0.0f, temp_f0, (u8) 0, arg4);
            }
        } else {
...
s32 func_80BFBB44(EnRz *arg0) {
    ...
    sp34 = temp_v0;
    temp_v1 = Lib_SegmentedToVirtual(temp_v0->unk4) + (arg0->unk3BC * 6);
...
s32 func_80BFBCEC(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->xzDistToPlayer < 100.0f) && (sp18 = temp_v1, (Actor_IsActorFacingLink(arg0, 0x3000) != 0)) && (temp_v1->unkA70 & 0x2000000)) {
        return 1;
    }
    return 0;
}
...
void EnRz_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnRz *this = (EnRz *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk3C0);
}
...
s32 func_80BFBE70(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((arg0->params & 0x8000) == 0) && (arg0->unk422 == 4)) {
        func_800B9010(arg0, 0x2198U);
    }
    if (func_800EE29C(arg1, (u32) arg0->unk426) != 0) {
        func_800EDF24(arg0, arg1, func_800EE200(arg1, (u32) arg0->unk426));
        temp_v1 = arg1->csCtx.npcActions[func_800EE200(arg1, (u32) arg0->unk426)]->unk0;
        temp_v0 = temp_v1 & 0xFFFF;
        if (temp_v1 != arg0->unk428) {
            arg0->unk428 = temp_v1;
            if (temp_v0 != 1) {
                if (temp_v0 != 2) {
                    if (temp_v0 != 3) {
...
void func_80BFC19C(EnRz *this, GlobalContext *globalCtx) {
    ...
    func_80BFBD54(this, globalCtx);
    if (func_80BFBE70(&this->actor, globalCtx) == 0) {
        this->actionFunc = func_80BFC3F8;
        func_80BFBA1C((s16) globalCtx, &this->actor, 8);
        temp_a1 = this->unk40C;
        if (temp_a1 != 0) {
            func_80BFBA1C((s16) globalCtx, &temp_a1->actor, 8);
        }
    }
}
...
void func_80BFC214(EnRz *this, GlobalContext *globalCtx) {
    func_80BFBD54(this, globalCtx);
    if ((func_80BFBE70(&this->actor, globalCtx) == 0) && (func_80BFBFAC(&this->actor, globalCtx) != 0)) {
...
void func_80BFC270(EnRz *this, GlobalContext *globalCtx) {
    ...
    func_800B8A1C(&this->actor, globalCtx, 0xC, 2000.0f, 1000.0f);
}
...
void func_80BFC36C(EnRz *this, GlobalContext *globalCtx) {
    ...
    if (func_80BFBFAC(&this->actor, globalCtx) != 0) {
        gSaveContext.weekEventReg[77] |= 4;
        if ((gSaveContext.weekEventReg[75] & 0x80) != 0) {
            this->actionFunc = func_80BFC214;
        } else {
        ...
        this->actor.cutscene = (s8) this->unk42C;
    }
}
    ...
    if (func_80BFBE70(&this->actor, globalCtx) == 0) {
        if (func_800B84D0(&this->actor, globalCtx) != 0) {
            ...
            if ((temp_v0 & 0x10000) == 0x10000) {
                ...
                this->actor.cutscene = (s8) this->unk42A;
            } else if (Player_GetMask(globalCtx) == 0xE) {
                if ((gSaveContext.weekEventReg[77] & 4) != 0) {
                    func_801518B0(globalCtx, 0x2925U, &this->actor);
                    func_80BFBDFC(globalCtx);
                } else {
                    func_801518B0(globalCtx, 0x2926U, &this->actor);
                    func_80BFBDFC(globalCtx);
                }
            } else {
                func_801518B0(globalCtx, 0x2926U, &this->actor);
        ...
        } else if (func_80BFBC78(&this->actor, globalCtx) != 0) {
            if ((func_80BFBCEC(&this->actor, globalCtx) != 0) && ((gSaveContext.weekEventReg[77] & 4) == 0) && (this->unk40C != 0)) {
...
void func_80BFC674(EnRz *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        ...
        func_801518B0(globalCtx, 0x2924U, &this->actor);
        return;
    }
    if (func_80BFBC78(&this->actor, globalCtx) != 0) {
        func_800B8614(&this->actor, globalCtx, 120.0f);
    }
}
...
void EnRz_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk422 == 4) {
        ...
        sp30 = temp_v0_3;
        sp30->words.w1 = Lib_SegmentedToVirtual(*(&D_80BFCCE0 + (this->unk410 * 4)));
    }
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80BFCAD0, &this->actor);
}
