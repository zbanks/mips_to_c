typedef struct EnRz {
    ...
    /* 0x188 */ ? unk188;                           /* inferred */
    /* 0x188 */ char pad188[0x118];
    /* 0x2A0 */ ? unk2A0;                           /* inferred */
    /* 0x2A0 */ char pad2A0[0x120];
    /* 0x3C0 */ ColliderCylinder unk3C0;            /* inferred */
    /* 0x40C */ EnRz *unk40C;                       /* inferred */
    /* 0x410 */ s16 unk410;                         /* inferred */
    /* 0x412 */ s16 unk412;                         /* inferred */
    /* 0x414 */ char pad414[0xC];                   /* maybe part of unk412[7]? */
    /* 0x420 */ u16 unk420;                         /* inferred */
    /* 0x422 */ s16 unk422;                         /* inferred */
    /* 0x424 */ s16 unk424;                         /* inferred */
    /* 0x426 */ s16 unk426;                         /* inferred */
    /* 0x428 */ s16 unk428;                         /* inferred */
    /* 0x42A */ s16 unk42A;                         /* inferred */
    /* 0x42C */ s16 unk42C;                         /* inferred */
    /* 0x42E */ char pad42E[0x2];
...
void EnRz_Init(EnRz *this, GlobalContext *globalCtx) {
    SkelAnime *temp_s0;
    s32 temp_s1;
    s32 temp_v1;
    s16 phi_s0;
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk3C0, (Actor *) this, &D_80BFCCF4);
...
void EnRz_Destroy(EnRz *this, GlobalContext *globalCtx) {
    EnRz *this = (EnRz *) thisx;
...
void func_80BFC3F8(EnRz *this, GlobalContext *globalCtx) {
    ...
    if (func_80BFBE70((Actor *) this, globalCtx) == 0) {
        if (func_800B84D0((Actor *) this, globalCtx) != 0) {
            ...
            if ((func_80BFBCEC((Actor *) this, globalCtx) != 0) && ((gSaveContext.weekEventReg[77] & 4) == 0) && (this->unk40C != 0)) {
...
void EnRz_Update(EnRz *this, GlobalContext *globalCtx) {
...
void EnRz_Draw(EnRz *this, GlobalContext *globalCtx) {
    Gfx *sp38;
    Gfx *sp34;
    Gfx *sp30;
    Gfx *temp_v0;
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80BFCAD0, (Actor *) this);
}
