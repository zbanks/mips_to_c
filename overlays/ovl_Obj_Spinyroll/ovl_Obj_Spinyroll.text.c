typedef struct ObjSpinyroll {
    ...
    /* 0x1D8 */ char pad1D8[0x2C4];                 /* maybe part of unk17C[8]? */
    /* 0x49C */ s32 unk49C;                         /* inferred */
    /* 0x4A0 */ void (*actionFunc)(ObjSpinyroll *, GlobalContext *);
    /* 0x4A4 */ f32 unk4A4;                         /* inferred */
    /* 0x4A8 */ char pad4A8[0x4];
    /* 0x4AC */ ColliderTris unk4AC;                /* inferred */
    /* 0x4CC */ char pad4CC[0x4];
    /* 0x4D0 */ f32 unk4D0;                         /* inferred */
    /* 0x4D4 */ char pad4D4[0x6];                   /* maybe part of unk4D0[2]? */
    /* 0x4DA */ s16 unk4DA;                         /* inferred */
    /* 0x4DC */ char pad4DC[0x2];
    /* 0x4DE */ s16 unk4DE;                         /* inferred */
...
void ObjSpinyroll_Init(ObjSpinyroll *this, GlobalContext *globalCtx) {
    f32 sp44;
    void *sp34;
    Vec3s *sp30;
    ColliderTris *sp2C;
    ...
    Collider_SetTris(globalCtx, temp_a1, (Actor *) this, &D_80A1F1A8, &this->unk17C);
...
void ObjSpinyroll_Destroy(ObjSpinyroll *this, GlobalContext *globalCtx) {
...
void ObjSpinyroll_Update(ObjSpinyroll *this, GlobalContext *globalCtx) {
...
void ObjSpinyroll_Draw(ObjSpinyroll *this, GlobalContext *globalCtx) {
    s16 sp88;
    s16 sp86;
    s16 sp84;
    Gfx *temp_v0;
