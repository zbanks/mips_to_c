...
void EnJcMato_Init(EnJcMato *this, GlobalContext *globalCtx) {
    ColliderSphere *sp20;
...
void EnJcMato_Destroy(EnJcMato *this, GlobalContext *globalCtx) {
    EnJcMato *this = (EnJcMato *) thisx;
    Collider_DestroySphere(globalCtx, &this->collider);
}

void EnJcMato_Update(EnJcMato *this, GlobalContext *globalCtx) {
    EnJcMato *this = (EnJcMato *) thisx;
...
void EnJcMato_Draw(EnJcMato *this, GlobalContext *globalCtx) {
