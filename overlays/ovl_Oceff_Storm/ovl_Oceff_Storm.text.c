...
static s8 D_809831D7 = {0x7E, 0, 0x23, 1, 0xF4, 0, 0x23, 0, 0, 3, 0, 0, 0, 0xFF, 0xFF, 0xFF, 0};
...
void OceffStorm_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80981BB8(&this->actor, globalCtx);
}
