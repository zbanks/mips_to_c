...
void OceffStorm_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->actor.world.pos.x = temp_v0[9].floorHeight;
    this->actor.world.pos.z = temp_v0->unk_BF4;
...
void func_80981928(OceffStorm *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_a2 < 0xA) {
        ...
        this->unk_146 = (u8) (s32) (phi_f6 * 10.0f);
    } else if ((s32) temp_a2 >= 0x3D) {
        this->unk_146 = (u8) (s32) ((f32) (0x46 - temp_a2) * 10.0f);
    } else {
        this->unk_146 = 0x64;
    }
    phi_v0 = (s32) this->unk_144;
    phi_a2 = this->unk_144;
    if (((s32) this->unk_144 < 0xA) || ((s32) this->unk_144 >= 0x3C)) {
        temp_a2_4 = this->unk_144;
        this->unk_147 = 0;
        phi_v0 = (s32) temp_a2_4;
        phi_a2 = temp_a2_4;
    } else if ((s32) this->unk_144 < 0x29) {
        temp_v0_2 = this->unk_147;
        if ((s32) temp_v0_2 < 0xC9) {
            this->unk_147 = temp_v0_2 + 0xA;
        }
        temp_a2_2 = this->unk_144;
        temp_f0 = 0.4f * phi_f2;
        ...
        this->unk_147 = ((s32) this->unk_144 * -0xA) + 0x258;
    } else {
        temp_a2_3 = this->unk_144;
    ...
    if (phi_v0 >= 0x29) {
        ...
        temp_a1 = this->unk_14A;
        temp_f10 = (f32) temp_v1;
        temp_a2_5 = this->unk_144;
        this->unk_148 = temp_v1 + temp_a1;
        this->unk_14A = temp_a1 + 0xA;
        this->actor.world.pos.y += temp_f10 * 0.01f;
        phi_v0_2 = (s32) temp_a2_5;
        phi_a2 = temp_a2_5;
    }
    if (phi_v0_2 < 0x46) {
        this->unk_144 = phi_a2 + 1;
        return;
    }
