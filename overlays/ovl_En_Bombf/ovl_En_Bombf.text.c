...
void EnBombf_Init(EnBombf *this, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, temp_a1_2, (Actor *) this, &D_808AFB70, &this->unk1B0);
...
void func_808AEAE0(EnBombf *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0 >= 1.0f) {
        ...
        temp_a0 = this->unk144.base.acFlags;
        temp_a1 = &this->actor.world;
        if (((temp_a0 & 2) != 0) && ((temp_v0_2 = this->unk144.info.acHitInfo->toucher.dmgFlags, ((temp_v0_2 & 0x13828) != 0)) || (((temp_v0_2 & 0x200) != 0) && (temp_v1->unk14B == 1) && (temp_v1->speedXZ > 15.0f)))) {
            this->unk144.base.acFlags = temp_a0 & 0xFFFD;
            if ((this->unk144.base.ac->category != 9) && (temp_v0_3 = Actor_Spawn(&globalCtx->actorCtx, globalCtx, 0x2F, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, (s16) 0), (temp_v0_3 != 0))) {
                temp_v0_3->unk1F8 = 1;
                temp_v0_3->unk1F0 = 0;
                this->timer = 0xB4;
                this->actor.flags &= -2;
...
void func_808AEFD4(EnBombf *this, GlobalContext *globalCtx) {
    ...
    if (this->unk190.elements->dim.modelSphere.radius == 0) {
        this->actor.flags |= 0x20;
        func_8013ECE0(this->actor.xzDistToPlayer, 0xFFU, 0x14U, 0x96U);
    }
    this->unk190.elements->dim.modelSphere.radius = 0x64;
    this->unk190.elements->dim.worldSphere.radius = 0x64;
    if (this->actor.params == 1) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk190);
    }
...
void EnBombf_Update(EnBombf *this, GlobalContext *globalCtx) {
    ...
    sp8C.unk0 = (s32) D_808AFB80.unk0;
    sp8C.unk4 = (s32) D_808AFB80.unk4;
    sp8C.unk8 = (s32) D_808AFB80.unk8;
    ...
    sp5C.unk0 = (s32) D_808AFBA4.unk0;
    sp5C.unk4 = (s32) D_808AFBA4.unk4;
    sp5C.unk8 = (s32) D_808AFBA4.unk8;
    sp58 = D_808AFBB0;
    if (this->unk1F8 != 0) {
        temp_v0 = this->timer;
        if (temp_v0 != 0) {
    ...
    if ((this->unk1FC == 0) && (Actor_HasParent((Actor *) this, globalCtx) == 0) && ((this->actor.xzDistToPlayer >= 20.0f) || (fabsf(this->actor.yDistToPlayer) >= 80.0f))) {
        this->unk1FC = 1;
    }
    ...
    if (this->actor.params == 0) {
        ...
        if (((this->unk144.base.acFlags & 2) != 0) || (((this->unk144.base.ocFlags1 & 2) != 0) && (this->unk144.base.oc->category == 5))) {
            this->unk1F8 = 1;
            this->timer = 0;
        ...
        if (this->unk1F8 != 0) {
            ...
            sp40 = temp_t3;
            sp60 = 0.2f;
            sp68.unk0 = temp_t3->pos.x;
            sp68.unk4 = (f32) temp_t3->pos.y;
            sp68.unk8 = (f32) temp_t3->pos.z;
            sp6C += 25.0f;
            ...
            if ((phi_v0 < 0x64) && (temp_v1 = this->unk1FE, ((phi_v0 & (temp_v1 + 1)) != 0))) {
                Math_SmoothStepToF(&this->unk200, 150.0f, 1.0f, 150.0f / (f32) temp_v1, 0.0f);
            } else {
                Math_SmoothStepToF(&this->unk200, 0.0f, 1.0f, 150.0f / (f32) this->unk1FE, 0.0f);
            }
            if ((s32) this->timer < 3) {
                Actor_SetScale((Actor *) this, this->actor.scale.x + 0.002f);
            }
            if (this->timer == 0) {
                sp68.unk0 = sp40->pos.x;
                sp68.unk4 = (f32) sp40->pos.y;
                sp68.unk8 = (f32) sp40->pos.z;
                sp6C += 10.0f;
                if (Actor_HasParent((Actor *) this, globalCtx) != 0) {
                    sp6C += 30.0f;
                }
    ...
    if ((s32) this->actor.params <= 0) {
        ...
        if ((this->unk204 >= 1.0f) && (this->unk1FC != 0)) {
