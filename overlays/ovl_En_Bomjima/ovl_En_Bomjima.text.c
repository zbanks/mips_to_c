...
typedef struct EnBomjima {
    ...
    /* 0x296 */ char pad_296[0x4];                  /* maybe part of unk_294[3]? */
    /* 0x29A */ s16 unk_29A;                        /* inferred */
    /* 0x29C */ char pad_29C[0x4];                  /* maybe part of unk_29A[3]? */
    /* 0x2A0 */ s16 unk_2A0;                        /* inferred */
    /* 0x2A2 */ s16 unk_2A2;                        /* inferred */
    /* 0x2A4 */ Vec3f unk_2A4;                      /* inferred */
    /* 0x2B0 */ Vec3f unk_2B0;                      /* inferred */
...
void EnBomjima_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk_2F8, (Actor *) this, &D_80C00A18);
    gSaveContext.weekEventReg[83] &= 0xFB;
    temp_v1 = this->actor.params;
    this->actor.targetMode = 0;
    this->unk_2E6 = ((s32) temp_v1 >> 4) & 0xF;
    this->unk_2E4 = temp_v1 & 0xF;
    Actor_SetScale((Actor *) this, 0.01f);
    temp_v0 = this->unk_2E6;
    if (temp_v0 == 0) {
...
void EnBomjima_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnBomjima *this = (EnBomjima *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_2F8);
}
...
void func_80BFE67C(EnBomjima *arg0, GlobalContext *arg1) {
    ...
    sp3C = temp_a1;
    sp40 = temp_a0;
    sp84 = arg0->unk_144.animCurrentFrame;
    arg0->unk_2DC = Math_Vec3f_Yaw(temp_a0, temp_a1);
    temp_a0_2 = arg0 + 0x32;
    sp38 = temp_a0_2;
    Math_SmoothStepToS(temp_a0_2, arg0->unk_2DC, 1, 0x1388, (s16) 0);
    temp_v1 = arg0->unk_2A2;
    if (temp_v1 != 0) {
        if (temp_v1 != 1) {
            return;
        }
        if (sp84 >= 0.0f) {
            arg0->unk_2DC = Math_Vec3f_Yaw(sp40, sp3C);
            Math_SmoothStepToS(sp38, arg0->unk_2DC, 0xA, 0x7D0, (s16) 0x14);
        }
        temp_v0 = arg0->actor.world.rot.y - arg0->unk_2DC;
        phi_v1 = temp_v0;
        if ((s32) temp_v0 < 0) {
        ...
        temp_f12 = arg0->unk_2A4.x;
        temp_f2 = temp_f12 - arg0->actor.world.pos.x;
        temp_f14 = arg0->unk_2A4.z - arg0->actor.world.pos.z;
        if ((arg0->unk_2BE == 0) || (sqrtf((temp_f2 * temp_f2) + (temp_f14 * temp_f14)) < 4.0f)) {
            arg0->unk_2C0 = Rand_S16Offset(0x14, 0x14);
            if ((arg0->unk_2C0 & 1) == 0) {
                func_80BFE494(arg0, 0x13, 1.0f);
            } else {
                func_80BFE494(arg0, 0, 1.0f);
        ...
        if (sp84 >= 0.0f) {
            Math_ApproachF((f32 *) sp40, temp_f12, 0.3f, arg0->unk_2D0);
            Math_ApproachF(arg0 + 0x2C, arg0->unk_2A4.z, 0.3f, arg0->unk_2D0);
    ...
    if (arg0->unk_2C0 == 0) {
        ...
        if (((phi_v1_2 >> 0x10) < 0x4000) && (func_800C55C4(arg1 + 0x830, sp40, (Vec3f *) &sp54, (Vec3f *) &sp6C, &sp50, 1U, 0U, 0U, 1U, &sp4C) == 0)) {
            ...
            arg0->unk_2BE = Rand_S16Offset(0x1E, 0x32);
            arg0->unk_2A2 += 1;
            return;
        }
        /* Duplicate return node #28. Try simplifying control flow for better match */
...
loop_1:
        ...
        if (this->unk_2F4 == 0) {
            this->unk_2F4 = (s16) this->unk_2F0->cutscene;
        }
        func_80BFEB1C(this);
    }
}
...
void func_80BFEB64(EnBomjima *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 != 0) {
        ...
        if (temp_v1 != 1) {
            ...
            if (temp_v1 != 2) {
                ...
                sp2C = temp_a0_2;
                this->unk_2DC = Math_Vec3f_Yaw((Vec3f *) temp_a0_2, &this->unk_2A4);
                Math_ApproachF((f32 *) temp_a0_2, this->unk_2A4.x, 0.3f, 2.0f);
                Math_ApproachF(&this->actor.world.pos.z, this->unk_2A4.z, 0.3f, 2.0f);
                temp_f2 = this->actor.world.pos.x - this->unk_2A4.x;
                temp_f12 = this->actor.world.pos.z - this->unk_2A4.z;
            ...
            sp2C = temp_a0;
            this->unk_2DC = Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) &temp_v0_2->world);
            if (func_801378B8(&this->unk_144, 19.0f) != 0) {
                this->unk_2C0 = 5;
                Audio_PlayActorSound2((Actor *) this, 0x292EU);
            }
            if (this->unk_2C0 == 1) {
                sp3E = Math_Vec3f_Yaw((Vec3f *) sp2C, (Vec3f *) &this->unk_2F0->world);
                if (Rand_ZeroOne() < 0.5f) {
                ...
                sp40 = ((Rand_ZeroFloat(20.0f) + 40.0f) * sp34) + this->unk_2F0->world.pos.x;
                sp44 = this->unk_2F0->world.pos.y - randPlusMinusPoint5Scaled(40.0f);
                sp34 = Math_CosS((s16) temp_a0_3);
                sp48 = ((Rand_ZeroFloat(20.0f) + 40.0f) * sp34) + this->unk_2F0->world.pos.z;
                Audio_PlaySoundAtPosition(globalCtx, (Vec3f *) &sp40, 0x32, 0x292FU);
                EffectSsHitMark_SpawnFixedScale(globalCtx, 0, (Vec3f *) &sp40);
                this->unk_2BC += 1;
                if (((s16) (s32) Rand_ZeroFloat(2.0f) + 3) < (s32) this->unk_2BC) {
                    func_80BFE494(this, 5, 1.0f);
                    this->unk_29A = 0;
                    Math_Vec3f_Copy(&this->unk_2A4, (Vec3f *) &this->actor.home);
                    this->unk_2A4.x += randPlusMinusPoint5Scaled(150.0f);
                    temp_f4 = this->unk_2A4.z + randPlusMinusPoint5Scaled(150.0f);
                    this->unk_2A2 += 1;
                    this->unk_2A4.z = temp_f4;
                }
            }
        }
    } else {
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, this->unk_2DC, 1, 0x1388, (s16) 0);
}
...
void func_80BFF03C(EnBomjima *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCurrentIndex() == 0x7C) {
        ...
        ActorCutscene_SetIntentToPlay(this->unk_2D4);
        return;
    }
    if (ActorCutscene_GetCanPlayNext(this->unk_2D4) == 0) {
        ActorCutscene_SetIntentToPlay(this->unk_2D4);
        return;
    }
    ...
    this->unk_2DC = func_800DFCDC(globalCtx->cameraPtrs[globalCtx->activeCamera]);
    ActorCutscene_StartAndSetUnkLinkFields(this->unk_2D4, (Actor *) this);
    func_80BFF120(this);
}
...
void func_80BFF174(EnBomjima *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_2C4 == 1) {
        ActorCutscene_Stop(this->unk_2D4);
        this->unk_2DE = 1;
    }
    if (Text_GetFaceReaction(globalCtx, 0x11U) != 0) {
        this->actor.textId = Text_GetFaceReaction(globalCtx, 0x11U);
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, this->unk_2DC, 1, 0x1388, (s16) 0);
    if (this->unk_2CC <= sp2C) {
        temp_v0 = this->unk_2BC;
        if ((s32) temp_v0 < 5) {
            this->unk_2BC = temp_v0 + 1;
            if (this->unk_2EC != 0x13) {
                func_80BFE494(this, 0x13, 1.0f);
            }
        }
    }
    temp_v0_2 = sp28->unk_14B;
    if (temp_v0_2 == 3) {
        if ((gSaveContext.weekEventReg[73] & 0x20) != 0) {
            this->unk_2C8 = 3;
            func_80BFE32C(this, globalCtx, 3);
...
void func_80BFF52C(EnBomjima *this, GlobalContext *globalCtx) {
    ...
    if ((func_80152498(&globalCtx->msgCtx) == 4) && (func_80147624(globalCtx) != 0)) {
        ...
        if (globalCtx->msgCtx.choiceIndex == 0) {
            ...
            this->unk_2C8 = 8;
            if (sp24->unk_14B == 3) {
                this->actor.textId = *(&D_80C00A54 + (this->unk_2C8 * 2));
            } else {
                this->actor.textId = *(&D_80C00A70 + (this->unk_2C8 * 2));
            }
...
void func_80BFFBC4(EnBomjima *this, GlobalContext *globalCtx) {
    if ((this->unk_2EC != 1) && (this->unk_2CC <= this->unk_144.animCurrentFrame)) {
        func_80BFE494(this, 1, 1.0f);
    }
    ...
    Math_SmoothStepToS(&this->unk_290, this->unk_2DC, 1, 0x1388, (s16) 0);
    if (D_80C009F0 >= 0x68) {
        D_80C009F0 = 0;
        func_801477B4(globalCtx);
...
void func_80BFFD48(EnBomjima *this, GlobalContext *globalCtx) {
    ...
    temp_a0 = &this->actor.world;
    sp2C = temp_a0;
    this->unk_2DC = Math_Vec3f_Yaw((Vec3f *) temp_a0, &this->unk_2A4);
    Math_SmoothStepToS(&this->actor.world.rot.y, this->unk_2DC, 1, 0x1388, (s16) 0);
    Math_ApproachF((f32 *) temp_a0, this->unk_2A4.x, 0.3f, 4.0f);
...
void func_80BFFE48(EnBomjima *this, GlobalContext *globalCtx) {
    Math_SmoothStepToS(&this->actor.world.rot.y, this->unk_2DC, 1, 0x1388, (s16) 0);
    Math_ApproachF((f32 *) &this->actor.world, this->unk_2A4.x, 0.3f, 4.0f);
    Math_ApproachF(&this->actor.world.pos.z, this->unk_2A4.z, 0.3f, 4.0f);
    if (D_80C009F0 >= 0x64) {
        if (this->unk_2E4 != 4) {
            func_80BFE494(this, 0xF, 1.0f);
        ...
        Math_SmoothStepToS(&this->unk_290, 0x2710, 1, 0x1388, (s16) 0);
        if (D_80C009F0 >= 0x67) {
            this->unk_2DC = 0;
            func_80BFE494(this, 0xF, 1.0f);
            func_80BFE65C(this);
...
void func_80BFFF54(EnBomjima *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_2E4 != 4) {
        if ((this->unk_2EC != 0) && (this->unk_2CC <= sp2C)) {
            D_80C009F0 += 1;
            func_80BFE494(this, 0, 1.0f);
            goto block_12;
        }
    } else if ((this->unk_2EC != 8) && (this->unk_2CC <= sp2C)) {
        func_80BFE494(this, 8, 1.0f);
        D_80C009F4 = 1;
block_12:
    }
    if (this->unk_2EC == 8) {
        if ((D_80C009F4 == 1) && (func_801378B8(&this->unk_144, 7.0f) != 0)) {
            Audio_PlayActorSound2((Actor *) this, 0x2896U);
            D_80C009F4 = 2;
        }
        if ((this->unk_2CC <= sp2C) && (this->unk_2C0 == 0)) {
            this->unk_2C0 = 0xA;
        }
        if (this->unk_2C0 == 1) {
...
void func_80C00234(EnBomjima *arg0) {
    ...
    arg0->unk_2F8.dim.radius = 0xF;
    arg0->unk_2F8.dim.height = 0x28;
    func_80BFE65C(arg0);
...
void func_80C00284(EnBomjima *this, GlobalContext *globalCtx) {
    ...
    sp28 = this->unk_144.animCurrentFrame;
    Math_SmoothStepToS(&this->actor.world.rot.y, this->unk_2DC, 1, 0x1388, (s16) 0);
    if (((this->unk_2A0 == 0) || (temp_v0 = this->unk_2C8, (temp_v0 == 0xA)) || (temp_v0 == 0xB) || (this->unk_2CA == 1)) && (this->unk_2CC <= sp28)) {
        if ((this->unk_2BC & 1) == 0) {
    ...
    if ((func_80152498(&globalCtx->msgCtx) == 5) && (func_80147624(globalCtx) != 0)) {
        this->unk_2F8.dim.radius = 0xA;
        this->unk_2F8.dim.height = 0x1E;
        if ((this->unk_2A0 == 4) || (temp_v0_3 = this->unk_2CA, (temp_v0_3 == 1)) || ((temp_v0_3 == 3) && ((s32) this->unk_2C8 >= 2))) {
            this->unk_28E = 0;
            temp_v0_7 = sp2C->unk_A6C;
            if ((temp_v0_7 & 0x20) != 0) {
                sp2C->unk_A6C = (s32) (temp_v0_7 & ~0x20);
            }
            temp_v0_8 = this->unk_2F0;
...
void EnBomjima_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_2BE;
    if (temp_v0 != 0) {
        this->unk_2BE = temp_v0 - 1;
    }
    temp_v0_2 = this->unk_2C2;
    if (temp_v0_2 != 0) {
        this->unk_2C2 = temp_v0_2 - 1;
    }
    temp_v0_3 = this->unk_2C0;
    if (temp_v0_3 != 0) {
        this->unk_2C0 = temp_v0_3 - 1;
    }
    temp_v0_4 = this->unk_2C6;
    if (temp_v0_4 != 0) {
        this->unk_2C6 = temp_v0_4 - 1;
    }
    temp_v0_5 = this->unk_2C4;
    if (temp_v0_5 != 0) {
        this->unk_2C4 = temp_v0_5 - 1;
    }
    ...
    Math_SmoothStepToS(&this->unk_294, this->unk_29A, 1, 0x3E8, (s16) 0);
    if (this->unk_2E2 == 0) {
        this->unk_2E0 += 1;
        if ((s32) this->unk_2E0 >= 3) {
            this->unk_2E0 = 0;
            this->unk_2E2 = (s32) Rand_ZeroFloat(60.0f) + 0x14;
        }
    }
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) this, 20.0f, 20.0f, 50.0f, 0x1DU);
    temp_a2 = &this->unk_2F8;
...
void EnBomjima_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_80C007F4, NULL, (Actor *) this);
}
