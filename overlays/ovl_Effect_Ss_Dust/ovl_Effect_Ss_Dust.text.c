struct _mips2c_stack_EffectSsDust_Draw {
    ...
    /* 0x054 */ char pad54[0x14];                   /* maybe part of sp50[6]? */
    /* 0x068 */ f32 sp68;                           /* inferred */
    /* 0x06C */ char pad6C[0x8];                    /* maybe part of sp68[3]? */
    /* 0x074 */ ? sp74;                             /* inferred */
    /* 0x074 */ char pad74[0x40];
    /* 0x0B4 */ ? spB4;                             /* inferred */
    /* 0x0B4 */ char padB4[0x40];
    /* 0x0F4 */ ? spF4;                             /* inferred */
    /* 0x0F4 */ char padF4[0x40];
    /* 0x134 */ ? sp134;                            /* inferred */
    /* 0x134 */ char pad134[0x44];
};                                                  /* size = 0x178 */
