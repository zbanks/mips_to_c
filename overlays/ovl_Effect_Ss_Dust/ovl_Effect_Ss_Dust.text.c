...
s32 EffectSsDust_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    this->life = initParamsx->unk30;
    this->draw = EffectSsDust_Draw;
    this->update = *(&effectDustUpdateFuncs + (initParamsx->unk34 * 4));
    if ((initParamsx->unk32 & 4) != 0) {
        temp_v0 = (s32) ((Rand_ZeroOne() * 20.0f) - 10.0f);
        this->regs[0] = initParamsx->unk24 + temp_v0;
        this->regs[1] = initParamsx->unk25 + temp_v0;
        this->regs[2] = initParamsx->unk26 + temp_v0;
        this->regs[4] = initParamsx->unk28 + temp_v0;
        this->regs[5] = initParamsx->unk29 + temp_v0;
        this->regs[6] = initParamsx->unk2A + temp_v0;
    } else {
    ...
    this->regs[12] = initParamsx->unk30;
    this->regs[11] = (s16) initParamsx->unk32;
    return 1;
}
...
void EffectSsDust_Draw(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    sp68 = temp_f0;
    SkinMatrix_SetTranslate(&sp134, this->pos.x, this->pos.y, this->pos.z);
    SkinMatrix_SetScale(&spF4, temp_f0, temp_f0, 1.0f);
    SkinMatrix_MtxFMtxFMult(&sp134, &globalCtx->mf_187FC, &sp74);
    SkinMatrix_MtxFMtxFMult(&sp74, &spF4, &spB4);
    temp_v1 = temp_s0->polyXlu.p;
    temp_s0->polyXlu.p = temp_v1 + 8;
    temp_v1->words.w0 = 0xDA380003;
    temp_v1->words.w1 = (u32) &D_801D1DE0;
    temp_v0 = SkinMatrix_MtxFToNewMtx(temp_s0, &spB4);
    if (temp_v0 != 0) {
        ...
        temp_s0->polyXlu.p = temp_v1_14 + 8;
        ...
        temp_s0->polyXlu.p = temp_v1_15 + 8;
