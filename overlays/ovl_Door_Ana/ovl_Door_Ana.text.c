...
void func_808E03B8(DoorAna *arg0, GlobalContext *arg1) {
    ...
    if (Math_StepToF(arg0 + 0x58, 0.01f, 0.001f) != 0) {
        if ((arg0->actor.targetMode != 0) && (arg1->sceneLoadFlag == 0) && (arg1->unk_18B4A == 0) && (temp_t0->unk_A6C & 0x80000000) && (temp_t0->unk_AE7 == 0)) {
            temp_a0 = arg1;
            if (sp28 == 0x300) {
            ...
            sp2C = temp_t0;
            if ((func_801690CC(arg1) == 0) && (temp_v0_2 = temp_t0->unk_A6C, ((temp_v0_2 & 0x8800000) == 0)) && (arg0->actor.xzDistToPlayer <= 20.0f) && (temp_f0 = arg0->actor.yDistToPlayer, (temp_f0 >= -50.0f)) && (temp_f0 <= 15.0f)) {
                temp_t0->unk_A6C = (s32) (temp_v0_2 | 0x80000000);
