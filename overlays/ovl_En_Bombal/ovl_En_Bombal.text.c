...
void func_80C05F90(EnBombal *arg0, Vec3f *arg1, s16 arg2); /* static */
...
void EnBombal_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk158, &this->actor, &D_80C06460);
...
void func_80C05C44(EnBombal *this, GlobalContext *globalCtx) {
    ...
    if (((gSaveContext.weekEventReg[75] & 0x40) == 0) && ((gSaveContext.weekEventReg[73] & 0x10) == 0) && ((gSaveContext.weekEventReg[85] & 2) == 0)) {
        ...
        if (ActorCutscene_GetCanPlayNext(this->unk14C) == 0) {
            ...
            ActorCutscene_StartAndSetUnkLinkFields(this->unk14C, &this->actor);
            phi_s0 = 1;
        }
        goto block_9;
    }
...
block_9:
    if (phi_s0 != 0) {
        ...
        temp_f0 = sp44.y + 60.0f;
        sp44.y = temp_f0;
        Actor_Spawn(&globalCtx->actorCtx, globalCtx, 0xA2, sp44.x, temp_f0, sp44.z, (s16) 0xFF, (s16) 0xFF, (s16) 0xC8, (s16) 1);
        do {
        ...
        Audio_PlayActorSound2(&this->actor, 0x2949U);
        this->unk148 = 0x1E;
        this->unk14A = 1;
...
void func_80C05F90(EnBombal *arg0, Vec3f *arg1, s16 arg2) {
    s16 temp_v0;
    void *phi_s0;
    s16 phi_v0;
