typedef struct EnWaterEffect {
    ...
    /* 0x144 */ char pad_144[0xC80];
    /* 0xDC4 */ s16 unk_DC4;                        /* inferred */
    /* 0xDC6 */ s16 unk_DC6;                        /* inferred */
    /* 0xDC8 */ char pad_DC8[0x10];                 /* maybe part of unk_DC6[9]? */
    /* 0xDD8 */ f32 unk_DD8;                        /* inferred */
    /* 0xDDC */ char pad_DDC[0x8];                  /* maybe part of unk_DD8[3]? */
    /* 0xDE4 */ f32 unk_DE4;                        /* inferred */
    /* 0xDE8 */ char pad_DE8[0x8];                  /* maybe part of unk_DE4[3]? */
    /* 0xDF0 */ f32 unk_DF0;                        /* inferred */
    /* 0xDF4 */ char pad_DF4[0x18];                 /* maybe part of unk_DF0[7]? */
    /* 0xE0C */ f32 unk_E0C;                        /* inferred */
    /* 0xE10 */ f32 unk_E10;                        /* inferred */
    /* 0xE14 */ f32 unk_E14;                        /* inferred */
    /* 0xE18 */ char pad_E18[0x4];
    /* 0xE1C */ f32 unk_E1C;                        /* inferred */
    /* 0xE20 */ f32 unk_E20;                        /* inferred */
    /* 0xE24 */ f32 unk_E24;                        /* inferred */
    /* 0xE28 */ char pad_E28[0x4];
    /* 0xE2C */ f32 unk_E2C;                        /* inferred */
    /* 0xE30 */ f32 unk_E30;                        /* inferred */
    /* 0xE34 */ f32 unk_E34;                        /* inferred */
    /* 0xE38 */ f32 unk_E38;                        /* inferred */
...
struct _mips2c_stack_EnWaterEffect_Update {
    ...
    /* 0xAC */ char pad_AC[0x10];                   /* maybe part of spA8[5]? */
...
loop_1:
    ...
    if (phi_v1->unk_0 == 0) {
        phi_v1->unk_0 = 1U;
        phi_v1->unk_4 = (s32) arg1->unk_0;
        phi_v1->unk_8 = (s32) arg1[1];
        phi_v1->unk_C = (s32) arg1[2];
        phi_v1->unk_10 = (s32) D_80A5AFB0.unk_0;
        phi_v1->unk_14 = (s32) D_80A5AFB0.unk_4;
        phi_v1->unk_18 = (s32) D_80A5AFB0.unk_8;
        phi_v1->unk_1C = (s32) D_80A5AFB0.unk_0;
        phi_v1->unk_20 = (s32) D_80A5AFB0.unk_4;
        phi_v1->unk_24 = (s32) D_80A5AFB0.unk_8;
        phi_v1->unk_30 = 0.0f;
        phi_v1->unk_2C = 0.1f;
        sp18 = phi_v1;
        phi_v1->unk_34 = Rand_ZeroFloat(6.2831855f);
        phi_v1->unk_1 = (s8) (u32) Rand_ZeroFloat(100.0f);
        phi_v1->unk_2A = arg2;
        return;
    }
    phi_v1 += 0x40;
...
void func_80A58908(EnWaterEffect *arg0, Vec3f *arg1, ? *arg2, u8 arg3) {
    ...
    sp2C.unk_0 = (s32) D_80A5AFBC.unk_0;
    sp2C.unk_4 = (s32) D_80A5AFBC.unk_4;
    sp2C.unk_8 = (s32) D_80A5AFBC.unk_8;
    phi_s0 = arg0 + 0x144;
    phi_v0 = 0;
loop_1:
    temp_v0 = phi_v0 + 1;
    ...
    if (phi_s0->unk_0 == 0) {
        ...
        phi_s0->unk_1C = (s32) sp2C.unk_0;
        phi_s0->unk_20 = (s32) sp2C.unk_4;
        phi_s0->unk_24 = (s32) sp2C.unk_8;
        temp_f2 = Rand_ZeroFloat(0.02f) + 0.02f;
        phi_s0->unk_30 = temp_f2;
        phi_s0->unk_2C = temp_f2;
        phi_s0->unk_34 = Rand_ZeroFloat(6.2831855f);
...
void EnWaterEffect_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_DC4 = (s16) (s32) Rand_ZeroFloat(100.0f);
    if (temp_v0 == 1) {
        this->actor.update = func_80A59C04;
        this->actor.draw = func_80A5A184;
        this->unk_DC6 = (s16) (s32) (Rand_ZeroFloat(100.0f) + 60.0f);
        return;
    }
...
void EnWaterEffect_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Flags_GetSwitch(globalCtx, (s32) this->actor.params) == 0) {
        this->unk_DC4 += 1;
        if (((this->unk_DC4 & 0x1F) == 0) && (Rand_ZeroOne() < 0.5f)) {
    ...
    do {
        if (phi_s1->unk_0 != 0) {
            ...
            temp_t5 = phi_s1->unk_1 + 1;
            temp_t6 = temp_t5 & 6;
            phi_s1->unk_1 = temp_t5;
            ...
            if (temp_v0 == 1) {
                phi_s1->unk_34 = (f32) (phi_s1->unk_34 + 0.15f);
                Math_ApproachF(phi_s1 + 0x2C, 0.03f, 0.5f, 0.005f);
                Math_ApproachF(phi_s1 + 0x30, 0.5f, 0.5f, 0.02f);
                phi_v0 = 0;
                if (phi_s1->unk_30 > 0.15f) {
                    phi_s1->unk_20 = -1.0f;
                    if (phi_s1->unk_14 < -20.0f) {
                        phi_s1->unk_14 = -20.0f;
                    }
                }
                if ((fabsf(phi_s1->unk_4 - spBC->world.pos.x) < 15.0f) && (fabsf(phi_s1->unk_C - spBC->world.pos.z) < 15.0f) && (temp_f2_2 = spBC->world.pos.y, temp_f0 = phi_s1->unk_8, (temp_f2_2 < temp_f0)) && ((temp_f0 - temp_f2_2) < 40.0f)) {
                    phi_v0 = 1;
                }
                temp_f2_3 = this->actor.floorHeight;
                if ((phi_s1->unk_8 <= temp_f2_3) || (phi_v0 != 0)) {
                    if (phi_v0 != 0) {
                        temp_s2 = phi_s1 + 4;
                        phi_s1->unk_0 = 0U;
                        ...
                        if (phi_s1->unk_2A == 0) {
                            ...
                            phi_s1->unk_2C = 0.1f;
                            phi_s1->unk_30 = 0.6f;
                            phi_s1->unk_10 = (f32) D_80A5AFB0.unk_0;
                            phi_s1->unk_14 = (f32) D_80A5AFB0.unk_4;
                            phi_s1->unk_18 = (f32) D_80A5AFB0.unk_8;
                            phi_s1->unk_1C = (f32) D_80A5AFB0.unk_0;
                            phi_s1->unk_20 = (f32) D_80A5AFB0.unk_4;
                            phi_s1->unk_3C = 0xC8;
                            phi_s1->unk_28 = 9;
                            phi_s1->unk_24 = (f32) D_80A5AFB0.unk_8;
                    ...
                    do {
                        ...
                        func_80A58908(this, phi_s2, &spA4, phi_s1->unk_2A);
                        temp_s0 = phi_s0 + 1;
                        phi_s0 = temp_s0;
                ...
                if (phi_s1->unk_14 < 0.0f) {
                    temp_f2_4 = this->actor.floorHeight;
                    if (phi_s1->unk_8 <= temp_f2_4) {
                        phi_s1->unk_8 = temp_f2_4;
                        if (phi_s1->unk_2A == 0) {
                            phi_s1->unk_0 = 3U;
                            phi_s1->unk_2C = 0.05f;
                            phi_s1->unk_30 = 0.2f;
                            ...
                            phi_s1->unk_3C = 0x96;
                            phi_s1->unk_24 = (f32) D_80A5AFB0.unk_8;
                            phi_s1->unk_28 = (s16) (s32) (Rand_ZeroFloat(5.0f) + 7.0f);
                        } else {
                ...
                Math_ApproachF(phi_s1 + 0x2C, phi_s1->unk_30, 0.1f, 0.6f);
                phi_s1->unk_3C = (s16) (phi_s1->unk_3C - phi_s1->unk_28);
                if ((s32) phi_s1->unk_3C <= 0) {
                    phi_s1->unk_3C = 0;
block_43:
                    phi_s1->unk_0 = 0U;
                }
...
void EnWaterEffect_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    do {
        ...
        if ((temp_v0_2 == 1) || (temp_v0_2 == 2)) {
            ...
            Matrix_Scale(phi_s2->unk_2C, phi_s2->unk_30, 1.0f, 1);
            SysMatrix_InsertZRotation_f(phi_s2->unk_34, 1);
    ...
    do {
        if (phi_s2_2->unk_0 == 3) {
            ...
            temp_f0_2 = phi_s2_2->unk_38;
            temp_v1_2->words.w1 = (((u32) (temp_f0_2 + 55.0f) & 0xFF) << 0x10) | ((u32) temp_f0_2 << 0x18) | 0xE100 | (phi_s2_2->unk_3C & 0xFF);
            SysMatrix_InsertTranslation(phi_s2_2->unk_4, phi_s2_2->unk_8, phi_s2_2->unk_C, 0);
            temp_f12 = phi_s2_2->unk_2C;
            Matrix_Scale(temp_f12, 1.0f, temp_f12, 1);
            SysMatrix_InsertYRotation_f(phi_s2_2->unk_34, 1);
...
loop_1:
    ...
    if (phi_s0->unk_0 == 0) {
        ...
        phi_s0->unk_1C = (f32) D_80A5AFB0.unk_0;
        phi_s0->unk_20 = (f32) D_80A5AFB0.unk_4;
        phi_s0->unk_24 = (f32) D_80A5AFB0.unk_8;
        phi_s0->unk_10 = (f32) D_80A5AFB0.unk_0;
        phi_s0->unk_14 = (f32) D_80A5AFB0.unk_4;
        phi_s0->unk_18 = (f32) D_80A5AFB0.unk_8;
        if ((arg2 == 0) || (arg2 == 2)) {
            phi_s0->unk_20 = -1.0f;
        }
        if ((s32) arg2 >= 2) {
            if (arg2 == 2) {
                phi_s0->unk_10 = randPlusMinusPoint5Scaled(10.0f);
                phi_s0->unk_14 = (f32) (Rand_ZeroFloat(3.0f) + 5.0f);
                phi_s0->unk_18 = randPlusMinusPoint5Scaled(10.0f);
            }
            phi_s0->unk_2C = 0.003f;
            phi_s0->unk_34 = 0.0017f;
            phi_s0->unk_30 = 0.0018f;
        } else {
            phi_s0->unk_34 = 0.003f;
            phi_s0->unk_2C = 0.003f;
            phi_s0->unk_30 = 0.003f;
        }
        phi_s0->unk_38 = 255.0f;
        temp_t5 = (s32) Rand_ZeroFloat(65536.0f);
        phi_s0->unk_3C = 0xFF;
        phi_s0->unk_28 = (s16) temp_t5;
        phi_s0->unk_1 = (s8) (u32) Rand_ZeroFloat(200.0f);
        phi_s0->unk_2A = arg2;
        return;
    }
    phi_s0 += 0x40;
...
loop_1:
    ...
    temp_v1 = this->unk_DC6;
    if (temp_v1 != 0) {
        this->unk_DC6 = (s16) (temp_v1 - 1);
    }
    if ((phi_v0_2 != 0) && (Flags_GetSwitch(globalCtx, ((s32) phi_v0_2->params >> 1) & 0x7F) != 0)) {
        this->unk_DC6 = (s16) (s32) (Rand_ZeroFloat(150.0f) + 100.0f);
    } else if (func_801690CC(globalCtx) == 0) {
        this->unk_DC4 = (s16) (this->unk_DC4 + 1);
        if (this->unk_DC6 == 0) {
            this->unk_DC6 = (s16) (s32) (Rand_ZeroFloat(150.0f) + 100.0f);
    ...
    phi_s7 = 0;
    do {
        temp_v0_3 = phi_s1->unk_0;
        phi_s5 = 0;
        if (temp_v0_3 != 0) {
            temp_f0 = phi_s1->unk_14;
            phi_s1->flags += phi_s1->home.pos.z;
            phi_s1->home.pos.x += temp_f0;
            phi_s1->unk_1 = (u8) (phi_s1->unk_1 + 1);
            phi_s1->home.pos.y += phi_s1->unk_18;
            phi_s1->unk_14 = (f32) (temp_f0 + phi_s1->unk_20);
            if (temp_v0_3 == 4) {
                temp_v0_4 = phi_s1->unk_2A;
                phi_v0_3 = temp_v0_4;
                if ((s32) temp_v0_4 > 0) {
                    if (temp_v0_4 == 1) {
                        Math_ApproachF(phi_s1 + 0x2C, 0.001f, 0.5f, 0.0002f);
                    }
                    phi_v0_3 = phi_s1->unk_2A;
                    if ((phi_s1->unk_2A & 1) != 0) {
                        Math_ApproachZeroF(phi_s1 + 0x38, 1.0f, 30.0f);
                        if (phi_s1->unk_2A == 1) {
                            phi_s1->unk_3C = (s16) (phi_s1->unk_3C - 0x14);
                        } else {
                            phi_s1->unk_3C = (s16) (phi_s1->unk_3C - 0xA);
                        }
                        if ((s32) phi_s1->unk_3C <= 0) {
                            phi_s1->unk_0 = 0U;
                        }
                ...
                if ((phi_v0_3 & 1) == 0) {
                    ...
                    phi_s1->unk_28 = (s16) (phi_s1->unk_28 + 0x800);
                    if ((fabsf(phi_s1->flags - temp_s3->world.pos.x) < 20.0f) && (fabsf(phi_s1->home.pos.y - temp_s3->world.pos.z) < 20.0f) && (fabsf(phi_s1->home.pos.x - (temp_s3->world.pos.y + 25.0f)) < 30.0f)) {
                        phi_s5 = 1;
                        if ((temp_s3->unk_14B != 1) && (temp_s3->unk_D44 == 0)) {
                    ...
                    if ((phi_s1->home.pos.x <= temp_f0_2) || (phi_s5 != 0)) {
                        ...
                        phi_s1->unk_2A = (u8) (phi_s1->unk_2A + 1);
                    }
                }
            }
        }
...
block_7:
            ...
            temp_v1->words.w1 = (phi_t7 << 0x18) | phi_s1->unk_3D;
            temp_v0_3 = temp_s0->polyXlu.p;
            temp_s0->polyXlu.p = &temp_v0_3[1];
            temp_v0_3->words.w0 = 0xDB060020;
            temp_v0_3->words.w1 = Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0U, 0U, 0x20, 0x40, 1, 0U, ((s32) phi_s1->unk_1 * -0x14) & 0x1FF, 0x20, 0x80);
            SysMatrix_InsertTranslation(phi_s1->flags, phi_s1->home.pos.x, phi_s1->home.pos.y, 0);
            if ((s32) phi_s1->unk_2A >= 2) {
                SysMatrix_NormalizeXYZ(&globalCtx->mf_187FC);
            } else {
                Matrix_RotateY(func_800DFC68(globalCtx->cameraPtrs[globalCtx->activeCamera]), 1U);
            }
            Matrix_Scale(phi_s1->world.pos.z, phi_s1->unk_30, 1.0f, 1);
            if ((phi_s5 & 1) != 0) {
            ...
            if ((phi_s1->unk_2A & 1) == 0) {
                ...
                SysMatrix_InsertXRotation_s(phi_s1->unk_28, 1);
                temp_f12 = phi_s1->unk_34;
                Matrix_Scale(temp_f12, temp_f12, temp_f12, 1);
                temp_s2 = temp_s0->polyOpa.p;
                temp_s0->polyOpa.p = &temp_s2[1];
...
void func_80A5A534(Actor *this, GlobalContext *globalCtx) {
    ...
    phi_v0 = &this->flags;
    phi_a0 = 4;
    if ((s32) this->unk_DC4 >= 0) {
        do {
            temp_a0 = phi_a0 + 4;
            phi_v1[884] += phi_v0[898];
            phi_v0[898] += phi_v0[902];
            phi_a0 = temp_a0;
            if (phi_v1[884] <= 0.0f) {
                phi_v1[884] = 0.0f;
                phi_v0[898] = 0.0f;
        ...
        Math_ApproachF((f32 *) &this[10].init, 20.0f, 1.0f, 0.025f);
        Math_ApproachF((f32 *) &this[10].draw, 20.0f, 1.0f, 0.075f);
        Math_ApproachF((f32 *) &this[11].flags, 20.0f, 1.0f, 0.1f);
        if ((s32) this->unk_DC4 >= 0x18) {
            Math_ApproachF(&this[11].home.pos.z, 2.0f, 0.1f, 0.2f);
            Math_ApproachZeroF(&this[11].focus.pos.y, 1.0f, 26.0f);
            Math_ApproachZeroF(&this[11].focus.pos.z, 1.0f, 26.0f);
            Math_ApproachZeroF((f32 *) &this[11].focus.rot, 1.0f, 24.0f);
            if ((s32) this->unk_DC4 >= 0x32) {
                Math_ApproachZeroF((f32 *) &this[11].focus.rot.z, 1.0f, 3.75f);
            }
        }
    }
}
...
void func_80A5A6B8(Actor *this, GlobalContext *globalCtx) {
    ...
    s16 temp_s1;
    u32 temp_f12_3;
    void (*temp_f12)(Actor *, GlobalContext *);
    void (*temp_f12_2)(Actor *, GlobalContext *);
    Actor *phi_s2;
    s32 phi_s4;
    s16 phi_s1;
    ...
    if ((temp_a0 == 0x309) || (temp_a0 == 0x30A)) {
        if (this[11].focus.pos.y > 1.0f) {
            func_8012C2DC(globalCtx->state.gfxCtx);
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06000DE0));
            temp_f12 = this[10].init;
            Matrix_Scale((bitwise f32) temp_f12, (bitwise f32) this[10].destroy, (bitwise f32) temp_f12, 1);
            temp_v0_2 = temp_s0->polyXlu.p;
            temp_s0->polyXlu.p = &temp_v0_2[1];
            ...
            temp_s0->polyXlu.p = &temp_v1[1];
            temp_v1->words.w0 = 0xFA000000;
            temp_v1->words.w1 = ((u32) this[11].focus.pos.y & 0xFF) | ~0xFF;
            temp_v0_3 = temp_s0->polyXlu.p;
            temp_s0->polyXlu.p = &temp_v0_3[1];
        ...
        SysMatrix_StatePop();
        if (this[11].focus.pos.z > 1.0f) {
            func_8012C2DC(globalCtx->state.gfxCtx);
            AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06000E0C));
            temp_f12_2 = this[10].draw;
            Matrix_Scale((bitwise f32) temp_f12_2, (bitwise f32) this[10].overlayEntry, (bitwise f32) temp_f12_2, 1);
            temp_v0_4 = temp_s0->polyXlu.p;
            temp_s0->polyXlu.p = &temp_v0_4[1];
            temp_v0_4->words.w0 = 0xDA380003;
            sp74 = temp_v0_4;
            ...
            temp_s0->polyXlu.p = &temp_v1_2[1];
            temp_v1_2->words.w0 = 0xFA000000;
            temp_v1_2->words.w1 = ((u32) this[11].focus.pos.z & 0xFF) | ~0xFF;
            temp_v0_5 = temp_s0->polyXlu.p;
            temp_s0->polyXlu.p = &temp_v0_5[1];
    ...
    if ((this->unk_E34 > 1.0f) && (this->params != 0x30C)) {
        func_8012C2DC(globalCtx->state.gfxCtx);
        AnimatedMat_Draw(globalCtx, Lib_SegmentedToVirtual(&D_06000E40));
        temp_f12_3 = this[11].flags;
        Matrix_Scale((bitwise f32) temp_f12_3, this[11].home.pos.x, (bitwise f32) temp_f12_3, 1);
        temp_v0_6 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_6[1];
        temp_v0_6->words.w0 = 0xDA380003;
        sp68 = temp_v0_6;
        ...
        temp_v1_3->words.w1 = ((u32) this->unk_E34 & 0xFF) | ~0xFF;
        temp_v0_7 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_7[1];
    ...
    if ((temp_a0_2 == 0x309) || (temp_a0_2 == 0x30C)) {
        ...
        temp_f12_4 = this[11].home.pos.z;
        Matrix_Scale(temp_f12_4, this->unk_E00, temp_f12_4, 1);
        temp_v0_8 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_8[1];
        ...
        temp_v1_4->words.w1 = ((u32) this->unk_E38 & 0xFF) | ~0xFF;
        temp_v0_9 = temp_s0->polyXlu.p;
        temp_s0->polyXlu.p = &temp_v0_9[1];
    ...
    if (this->params == 0x309) {
        ...
        do {
            if (phi_s2->unk_0 == 3) {
                ...
                temp_f0 = phi_s2->unk_38;
                temp_v1_5->words.w1 = (((u32) (temp_f0 + 55.0f) & 0xFF) << 0x10) | ((u32) temp_f0 << 0x18) | 0xE100 | (phi_s2->unk_3C & 0xFF);
                ...
                SysMatrix_InsertYRotation_f(phi_s2->unk_34, 1);
