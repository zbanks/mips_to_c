...
void func_80A58908(EnWaterEffect *arg0, Vec3f *arg1, Vec3f *arg2, u8 arg3); /* static */
...
typedef struct EnWaterEffect {
    ...
    /* 0x0145 */ char pad145[0xC7F];
    /* 0x0DC4 */ s16 unkDC4;                        /* inferred */
    /* 0x0DC6 */ s16 unkDC6;                        /* inferred */
    /* 0x0DC8 */ char padDC8[0x10];                 /* maybe part of unkDC6[9]? */
    /* 0x0DD8 */ f32 unkDD8;                        /* inferred */
    /* 0x0DDC */ char padDDC[0x8];                  /* maybe part of unkDD8[3]? */
    /* 0x0DE4 */ f32 unkDE4;                        /* inferred */
    /* 0x0DE8 */ char padDE8[0x8];                  /* maybe part of unkDE4[3]? */
    /* 0x0DF0 */ f32 unkDF0;                        /* inferred */
    /* 0x0DF4 */ char padDF4[0x18];                 /* maybe part of unkDF0[7]? */
    /* 0x0E0C */ f32 unkE0C;                        /* inferred */
    /* 0x0E10 */ f32 unkE10;                        /* inferred */
    /* 0x0E14 */ f32 unkE14;                        /* inferred */
    /* 0x0E18 */ char padE18[0x4];                  /* maybe part of unkE14[2]? */
    /* 0x0E1C */ f32 unkE1C;                        /* inferred */
    /* 0x0E20 */ f32 unkE20;                        /* inferred */
    /* 0x0E24 */ f32 unkE24;                        /* inferred */
    /* 0x0E28 */ char padE28[0x4];                  /* maybe part of unkE24[2]? */
    /* 0x0E2C */ f32 unkE2C;                        /* inferred */
    /* 0x0E30 */ f32 unkE30;                        /* inferred */
    /* 0x0E34 */ f32 unkE34;                        /* inferred */
    /* 0x0E38 */ f32 unkE38;                        /* inferred */
...
void func_80A58908(EnWaterEffect *arg0, Vec3f *arg1, Vec3f *arg2, u8 arg3) {
    ? sp2C;
    f32 temp_f2;
    s16 temp_v0;
    void *phi_s0;
...
loop_1:
    ...
    if (phi_s0->unk0 == 0) {
        ...
        phi_s0->unk10 = (s32) arg2->x;
        phi_s0->unk14 = (s32) arg2->y;
        phi_s0->unk18 = (s32) arg2->z;
...
void EnWaterEffect_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 0x309) || (temp_v0 == 0x30A) || (temp_v0 == 0x30B) || (temp_v0 == 0x30C)) {
        ...
        Actor_SetScale(&this->actor, (f32) this->actor.shape.rot.z * 0.0002f);
...
void EnWaterEffect_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Flags_GetSwitch(globalCtx, (s32) this->actor.params) == 0) {
        ...
        if (((this->unkDC4 & 0x1F) == 0) && (Rand_ZeroOne() < 0.5f)) {
            Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 10.0f, 40.0f, 4U);
                ...
                if ((phi_s1->unk8 <= temp_f2_3) || (phi_v0 != 0)) {
                    if (phi_v0 != 0) {
                        ...
                        if (phi_s1->unk2A == 0) {
                            ...
                            Math_Vec3f_Copy(&sp98, temp_s2_3);
                            sp98.y += 3.0f;
                            EffectSsGSplash_Spawn(globalCtx, &sp98, NULL, NULL, (s16) 1, (s16) 0x64);
                            phi_s2 = temp_s2_3;
                        } else {
                            phi_s1->unk0 = 0U;
                            ...
                            Math_Vec3f_Copy(&sp98, temp_s2_2);
                            sp98.y += 10.0f;
                            EffectSsGSplash_Spawn(globalCtx, &sp98, NULL, NULL, (s16) 1, (s16) 0x12C);
                        }
                    }
                    phi_s0 = 0;
                    do {
                        SysMatrix_InsertYRotation_f((2.0f * ((f32) phi_s0 * 3.1415927f)) / 5.5f, 0);
                        SysMatrix_GetStateTranslationAndScaledZ(Rand_ZeroFloat(1.5f) + 1.5f, &spA4);
            ...
            if (temp_v0_3 == 4) {
                ...
                if ((phi_v0_3 & 1) == 0) {
                    ...
                    if ((phi_s1->home.pos.x <= temp_f0_2) || (phi_s5 != 0)) {
                        ...
                        if (phi_s1->unk2A == 0) {
                            do {
                                func_80A599E8(this, &temp_s2->x, 2U);
