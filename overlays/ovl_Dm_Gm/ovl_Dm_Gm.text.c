...
static ActorAnimationEntryS D_80C25110 = {
...
static s32 D_80C251F0 = {0, 0, 0xC, 2, 4, 6, 8, 0xA, 0xB, 3};
...
static void *D_80C25238 = {(void *)0x600E6E0, (void *)0x600F7A0, (void *)0x60101A0};
static ? D_80C25244;                                /* unable to generate initializer */

typedef struct DmGm {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ SkelAnime unk144;                  /* inferred */
    /* 0x0188 */ void (*actionFunc)(DmGm *, GlobalContext *);
