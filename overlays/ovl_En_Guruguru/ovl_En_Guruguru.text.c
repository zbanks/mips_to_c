...
void EnGuruguru_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->actor.params != 2) {
        Collider_InitAndSetCylinder(globalCtx, &this->collider, &this->actor, &D_80BC79A0);
    }
...
void EnGuruguru_DoNothing(EnGuruguru *this, GlobalContext *globalCtx) {
    EnGuruguru *self = (EnGuruguru *) this;
...
void func_80BC6F14(EnGuruguru *this, GlobalContext *globalCtx) {
    ...
    sp1E = (s16) temp_v1;
    this = this;
    if (func_800B84D0(&temp_a0_2->actor, globalCtx) != 0) {
...
void func_80BC701C(EnGuruguru *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk268 != 0) && ((temp_v1 = globalCtx->actorCtx.actorList[2].first->unk14B, (temp_v1 == 4)) || (temp_v1 == 3))) {
...
void func_80BC7440(EnGuruguru *this, GlobalContext *globalCtx) {
    ...
    func_800B8A1C(&this->actor, globalCtx, 0x8C, 300.0f, 300.0f);
}
...
void EnGuruguru_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, EnGuruguru_OverrideLimbDraw, NULL, &this->actor);
}
