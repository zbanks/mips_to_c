...
void EnGuruguru_Init(EnGuruguru *this, GlobalContext *globalCtx) {
    u32 temp_t2;
...
void EnGuruguru_Destroy(EnGuruguru *this, GlobalContext *globalCtx) {
    EnGuruguru *this = (EnGuruguru *) thisx;
    if (this->actor.params != 2) {
...
void EnGuruguru_Update(EnGuruguru *this, GlobalContext *globalCtx) {
    Actor *sp34;
...
void EnGuruguru_Draw(EnGuruguru *this, GlobalContext *globalCtx) {
