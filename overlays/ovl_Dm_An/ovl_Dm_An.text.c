...
void func_80C1D0B0(Actor *this, GlobalContext *globalCtx) {
    ...
    sp40 = sp40;
    sp38 = temp_v0;
    sp38->words.w1 = Lib_SegmentedToVirtual(*(&D_80C1D2F4 + (this[2].world.rot.x * 4)));
    temp_v0_2 = sp40->polyOpa.p;
    sp40->polyOpa.p = &temp_v0_2[1];
    temp_v0_2->words.w0 = 0xDB060024;
    sp34 = temp_v0_2;
    sp34->words.w1 = Lib_SegmentedToVirtual(*D_80C1D2E8);
    func_801343C0(globalCtx, (void **) this[1].flags, this->unk_164, (s32) this[1].category, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80C1CD80, func_80C1CEFC, this);
}
