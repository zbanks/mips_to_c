...
typedef struct BgCraceMovebg {
    ...
    /* 0x160 */ char pad160[0x10];                  /* maybe part of actionFunc[5]? */
    /* 0x170 */ s32 unk_170;
    /* 0x174 */ char pad174[0x14];                  /* maybe part of unk_170[6]? */
    /* 0x188 */ Vec3f unk188;                       /* inferred */
...
void BgCraceMovebg_Update(BgCraceMovebg *this, GlobalContext *globalCtx) {
    Actor *sp1C;
    Actor *temp_a3;
    ...
    Math_Vec3f_Copy(&this->unk188, temp_a3 + 0xBEC);
}
...
void BgCraceMovebg_Draw(BgCraceMovebg *this, GlobalContext *globalCtx) {
    BgCraceMovebg *this = (BgCraceMovebg *) thisx;
