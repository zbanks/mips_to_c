...
void func_80A70A08(Actor *arg0, s32 arg1) {
    ...
    Math_SmoothStepToF(arg0 + 0x160, arg0->unk164, 2.0f, arg0->unk16C, 0.01f);
    temp_f0 = arg0->unk160;
    arg0->world.pos.y = arg0->home.pos.y + temp_f0;
    if (arg0->unk164 == temp_f0) {
        func_80A70A84(arg0, arg1);
    }
}

void func_80A70A84(Actor *arg0, s32 arg1) {
    arg0->unk15C = func_80A70A9C;
}
...
void BgCraceMovebg_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Math_Vec3f_Copy((Vec3f *) &this->unk_174[20], temp_a3 + 0xBEC);
}
...
void func_80A70C04(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((arg0->params & 0xF) != 2) && (temp_a0 = arg0 + 8, temp_v1 = arg1->actorCtx.actorList[2].first + 0xBEC, sp28 = temp_v1, sp2C = temp_a0, (func_8013E5CC(temp_a0, arg0 + 0x14, &D_80A710AC, arg0 + 0x188, temp_v1, &sp3C) != 0)) && (Matrix_RotateY((s16) ((s32) arg0->home.rot.y * -1), 0U), Math_Vec3f_Diff(sp28, sp2C, &sp30), SysMatrix_MultiplyVector3fByState(&sp30, arg0 + 0x178), (fabsf(arg0->unk178) < 100.0f)) && (temp_f0 = arg0->unk17C, (temp_f0 >= -10.0f)) && (temp_f0 <= 180.0f)) {
        if (arg0->unk180 < 0.0f) {
            Actor_SetSwitchFlag(arg1, (((s32) arg0->params >> 4) & 0x7F) + 1);
            arg0->unk170 = (s32) (arg0->unk170 | 2);
            return;
        }
...
void func_80A70D74(void *arg0, ? arg1) {
    arg0->unk164 = 180.0f;
    arg0->unk160 = 180.0f;
    arg0->unk15C = func_80A70DA8;
    arg0->unk28 = (f32) (arg0->unkC + 180.0f);
}
...
void func_80A70E2C(Actor *arg0, GlobalContext *arg1) {
    arg0->unk174 = (s32) ((((s32) arg0->params >> 0xB) & 0x1F) * 0xA);
    arg0->unk164 = 180.0f;
    arg0->unk160 = 180.0f;
    arg0->unk15C = func_80A70E70;
}
...
void func_80A70E70(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg0;
    temp_v0 = temp_a2->unk174;
    if (temp_v0 > 0) {
        temp_a2->unk174 = (s32) (temp_v0 - 1);
    }
    temp_a0 = temp_a2;
    temp_a2->world.pos.y = temp_a2->home.pos.y + temp_a2->unk160;
    arg0 = temp_a2;
...
void func_80A70F2C(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Math_StepToF(arg0 + 0x160, 0.0f, 1.0f) != 0) {
        if (((arg0->unk170 & 2) == 0) && (Flags_GetSwitch(arg1, (((s32) arg0->params >> 4) & 0x7F) + 1) == 0)) {
            arg1->unk_18845 = 1;
            func_80169FDC(arg1);
            play_sound(0x5801U);
        }
