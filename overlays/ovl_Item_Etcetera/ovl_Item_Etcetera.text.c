typedef struct ItemEtcetera {
    /* 0x000 */ Actor actor;
    /* 0x144 */ void (*unk_144)(ItemEtcetera *, GlobalContext *); /* inferred */
    ...
    /* 0x150 */ void (*unk_150)(Actor *, GlobalContext *); /* inferred */
...
void ItemEtcetera_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v0_2 >= 0) {
        this->unk_14C = (u8) temp_v0_2;
    }
    this->unk_148 = *(&D_8092024C + temp_v1);
    this->unk_144 = func_8092009C;
    this->unk_150 = func_809201BC;
    this->unk_14A = *(&D_80920268 + temp_v1);
    ...
    case 13:
        Actor_SetScale((Actor *) this, 0.5f);
        this->unk_144 = func_809200F8;
        this->unk_150 = func_80920164;
...
void func_80920044(ItemEtcetera *this, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) temp_a1) != 0) {
        this->actor.objBankIndex = (s8) this->unk_14C;
        this->actor.draw = this->unk_150;
        this->actionFunc = this->unk_144;
    }
}
...
void func_8092009C(ItemEtcetera *this, GlobalContext *globalCtx) {
    ...
    func_800B8A1C((Actor *) this, globalCtx, (s32) this->unk_14A, 30.0f, 50.0f);
}
