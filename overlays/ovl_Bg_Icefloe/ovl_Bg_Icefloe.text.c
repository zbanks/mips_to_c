...
void BgIcefloe_Init(BgIcefloe *this, GlobalContext *globalCtx) {
    Actor **temp_v0;
    Actor *temp_a0;
    s32 temp_a2;
    Actor **phi_v0;
...
void BgIcefloe_Destroy(BgIcefloe *this, GlobalContext *globalCtx) {
    Actor **temp_v0;
    s32 temp_a2;
    Actor **phi_v0;
    BgIcefloe *this = (BgIcefloe *) thisx;
...
void BgIcefloe_Update(BgIcefloe *this, GlobalContext *globalCtx) {
    BgIcefloe *this = (BgIcefloe *) thisx;
...
void BgIcefloe_Draw(BgIcefloe *this, GlobalContext *globalCtx) {
    BgIcefloe *this = (BgIcefloe *) thisx;
