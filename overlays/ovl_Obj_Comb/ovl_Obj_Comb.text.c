...
static InitChainEntry D_8098E474;                   /* unable to generate initializer */

typedef struct ObjComb {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(ObjComb *, GlobalContext *);
    ...
    /* 0x01B3 */ s8 unk1B3;                         /* inferred */
    /* 0x01B4 */ s8 unk1B4;                         /* inferred */
    /* 0x01B5 */ s8 unk1B5;                         /* inferred */
    /* 0x01B6 */ s8 unk1B6;                         /* inferred */
    /* 0x01B7 */ s8 unk1B7;                         /* inferred */
    /* 0x01B8 */ s8 unk1B8;                         /* inferred */
...
void func_8098CEAC(ObjComb *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        Math_Vec3f_Sum((Vec3f *) temp_s6, spA8, temp_s5);
        ...
        EffectSsKakera_Spawn(arg1, temp_s5, (Vec3f *) temp_s7, temp_s5, (s16) phi_s0, (s16) phi_v0, (s16) phi_s1, (s16) 4, (s16) 0, (s16) (s32) (s16) temp_f10, (s16) 0, (s16) 0, 0x3C, (s16) -1, (s16) 0x1B9, &D_06001040);
        temp_s3 = phi_s3 + 1;
        phi_s3 = temp_s3;
    } while (temp_s3 != 0x1F);
    spD0.x = arg0->actor.world.pos.x;
    spD0.y = arg0->actor.world.pos.y - 10.0f;
    spD0.z = arg0->actor.world.pos.z;
    func_800BBFB0(arg1, temp_s5, 40.0f, 6, (s16) 0x46, (s16) 0x3C, (u8) 1);
}
...
void func_8098D19C(ObjComb *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        EffectSsKakera_Spawn(arg1, temp_s5, (Vec3f *) temp_s7, temp_s5, (s16) phi_s0, (s16) phi_v0, (s16) phi_s1, (s16) 4, (s16) 0, (s16) (s32) (s16) temp_f8, (s16) 0, (s16) 0, 0x3C, (s16) -1, (s16) 0x1B9, &D_06001040);
        temp_s3 = phi_s3 + 1;
        phi_s3 = temp_s3;
    } while (temp_s3 != 0x1F);
    spD0.x = arg0->actor.world.pos.x;
    spD0.y = arg0->actor.world.pos.y + 20.0f;
    spD0.z = arg0->actor.world.pos.z;
    func_800BBFB0(arg1, temp_s5, 40.0f, 6, (s16) 0x46, (s16) 0x3C, (u8) 1);
}
...
void func_8098D47C(ObjComb *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        Math_Vec3f_Sum((Vec3f *) temp_s7, arg0 + 0x24, &spC8);
        ...
        EffectSsKakera_Spawn(arg1, &spC8, (Vec3f *) temp_fp, &spC8, (s16) phi_s0, (s16) phi_v0, (s16) 0x28, (s16) 0, (s16) 0, (s16) (s32) (s16) temp_f10_2, (s16) 0, (s16) 0, 0x50, (s16) -1, (s16) 0x1B9, &D_06001040);
        temp_s2 = phi_s2 + 1;
        phi_s2 = temp_s2;
    } while (temp_s2 != 0x15);
}
...
void ObjComb_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_8098E474);
    temp_a1 = &this->unk148;
    sp28 = temp_a1;
    ...
    Collider_SetJntSph(globalCtx, temp_a1, &this->actor, &D_8098E464, &this->unk168);
    if (sp2C == 0) {
    ...
    if ((sp2C != 2) || (func_8098CE40(&this->actor, globalCtx) == 0)) {
        this->unk1B8 = -1;
    }
    func_8098DC44(this);
}
...
void func_8098DC60(ObjComb *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.update != 0) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &this->unk148.base);
    }
...
void func_8098DEA0(ObjComb *this, GlobalContext *globalCtx) {
    ...
    if (((temp_v0 & 1) != 0) || ((s32) this->unk1B4 <= 0)) {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.world.pos, 0x28, 0x293CU);
        func_8098E098(this);
        return;
    }
    if ((temp_v0 & 0x40) != 0) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, 12.0f, 0.0f, 5U);
    CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &this->unk148.base);
}
