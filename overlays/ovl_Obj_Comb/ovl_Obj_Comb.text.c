typedef struct ObjComb {
    ...
    /* 0x1B3 */ s8 unk_1B3;                         /* inferred */
    /* 0x1B4 */ s8 unk_1B4;                         /* inferred */
    /* 0x1B5 */ s8 unk_1B5;                         /* inferred */
    /* 0x1B6 */ s8 unk_1B6;                         /* inferred */
    /* 0x1B7 */ s8 unk_1B7;                         /* inferred */
    /* 0x1B8 */ s8 unk_1B8;                         /* inferred */
    /* 0x1B9 */ char pad_1B9[0x3];                  /* maybe part of unk_1B8[4]? */
} ObjComb;                                          /* size = 0x1BC */
...
struct _mips2c_stack_func_8098CEAC {
    ...
    /* 0xAC */ char pad_AC[0x18];                   /* maybe part of spA8[7]? */
...
void func_8098D8C8(void *arg0, GlobalContext *arg1) {
    ...
    temp_s4 = arg0->unk_1C & 0xF;
    if (func_8098DC60 == arg0->unk_144) {
        phi_s5 = 2;
    } else {
        phi_s5 = 1;
    }
    ...
    if (temp_s4 > 0) {
        do {
            temp_s1 = phi_s1 + 1;
            phi_s1 = temp_s1;
            if (Actor_Spawn(arg1 + 0x1CA0, arg1, 0x204, arg0->unk_24, arg0->unk_28, arg0->unk_2C, (s16) 0, (s16) 0, (s16) 0, (s16) phi_s5) != 0) {
                arg0->unk_1B6 = 1;
            }
...
void ObjComb_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_8098E464, &this->unk_168);
    if (sp2C == 0) {
...
void func_8098DC60(ObjComb *this, GlobalContext *globalCtx) {
    ...
    this->unk_1A8 += -0x32;
    if ((s32) this->unk_1A8 < 0) {
        this->unk_1A8 = 0;
    }
    if (this->unk_1B3 != 0) {
        temp_v1 = this->unk_148.elements->info.acHitInfo->toucher.dmgFlags;
        if ((temp_v1 & 0x182C29C) != 0) {
            ...
            if (((s32) this->unk_1B2 <= 0) && (temp_a0 != 0)) {
                if (this->unk_1B5 == 0) {
                    this->unk_1B5 = 1;
                    this->actor.flags |= 0x10;
                }
        ...
        temp_v0 = this->unk_1B8;
        if ((s32) temp_v0 >= 0) {
            if (temp_v0 == 0) {
                Audio_PlayActorSound2((Actor *) this, 0x39DAU);
                if (Rand_ZeroOne() < 0.1f) {
                    this->unk_1B8 = Rand_S16Offset(0x28, 0x50);
                } else {
                    this->unk_1B8 = 8;
                }
            } else {
                this->unk_1B8 = temp_v0 - 1;
            }
        }
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_148);
    }
    if (this->actor.update != 0) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk_148);
    }
    this->actor.shape.rot.x = (s32) (Math_SinS(this->unk_1AA) * (f32) this->unk_1A8) + this->actor.home.rot.x;
}
...
void func_8098DEA0(ObjComb *this, GlobalContext *globalCtx) {
    ...
    this->unk_1B4 += -1;
    if (((temp_v0 & 1) != 0) || ((s32) this->unk_1B4 <= 0)) {
        func_8098DA74(this, globalCtx);
    ...
    if ((this->actor.bgCheckFlags & 0x20) != 0) {
        ...
        this->unk_1AE = (s16) ((s32) this->unk_1AE >> 1);
        this->unk_1B0 = (s16) ((s32) this->unk_1B0 >> 1);
        this->actor.velocity.y *= 0.8f;
    } else {
        this->actor.gravity = -1.5f;
        this->unk_1AE += 0x1F4;
        this->actor.velocity.y *= 0.96f;
        if ((s32) this->unk_1AE >= 0x7D1) {
            this->unk_1AE = 0x7D0;
        }
        this->unk_1B0 += 0xC8;
        if ((s32) this->unk_1B0 >= 0x259) {
            this->unk_1B0 = 0x258;
        }
...
void func_8098E0B8(ObjComb *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 == 0xA) && (this->unk_1B6 != 0) && (this->unk_1B5 == 2) && ((s32) this->actor.cutscene >= 0)) {
        this = this;
...
void ObjComb_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_1B3 = (temp_v0 & 2) != 0;
    if (this->unk_1B3 != 0) {
        this->unk_148.base.acFlags = temp_v0 & 0xFFFD;
    }
    temp_v0_2 = this->unk_1B2;
    if ((s32) temp_v0_2 > 0) {
        this->unk_1B2 = temp_v0_2 - 1;
        if (this->unk_1B2 == 0) {
            func_8098DE58(this);
        }
    }
