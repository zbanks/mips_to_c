...
void func_8088D660(Actor *arg0, PosRot *arg1, f32 arg2, Vec3f *); /* static */
void func_8088D7F8(Actor *arg0, Actor *arg1);       /* static */
void func_8088D864(Actor *arg0, Actor *arg1);       /* static */
void func_8088D8D0(EnElf *arg0, s8 *arg1);          /* static */
void func_8088D9BC(Actor *arg0, GlobalContext *arg1); /* static */
void func_8088DB4C(Actor *arg0, Actor *arg1, f32 arg2, f32 arg3, f32 arg4); /* static */
...
void func_808908D0(Actor *arg0, GlobalContext *arg1, u32 arg2); /* static */
...
typedef struct ActorContext {
    /* 0x0000 */ LightContext unk0;                 /* inferred */
...
void func_8088C9CC(EnElf *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        if (temp_f2 < 50.0f) {
            if (Rand_ZeroOne() < 0.2f) {
                ...
                arg0->unk25C = (s16) ((s32) Rand_ZeroFloat(8.0f) + 4);
            } else {
                arg0->unk25C = 0xA;
            }
        } else {
            ...
            if (Rand_ZeroOne() < temp_f2_2) {
                ...
                arg0->unk254 = (f32) ((2.0f * temp_f2_2) + 1.0f);
                arg0->unk25C = (s16) ((s32) Rand_ZeroFloat(16.0f) + 0x10);
            } else {
                arg0->unk25C = 0xA;
            }
        }
    ...
    if (Rand_ZeroOne() < 0.1f) {
        arg0->unk244 = 1;
        arg0->unk248 = 0x80;
        arg0->unk254 = (f32) (Rand_ZeroFloat(0.5f) + 0.5f);
...
void func_8088CC48(EnElf *arg0, GlobalContext *arg1) {
    ...
    arg0->unk224 = (f32) arg0->actor.world.pos.x;
    arg0->unk24A = (s16) (temp_t7 + 0x200);
    arg0->unk228 = (f32) arg0->actor.world.pos.y;
    arg0->unk22C = (f32) arg0->actor.world.pos.z;
...
void EnElf_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_808909E0);
    SkelAnime_Init(globalCtx, (SkelAnime *) this->unk_144, &D_0402AF58, (AnimationHeader *) &D_04029140, (Vec3s *) &this->unk_144[68], (Vec3s *) &this->unk_144[110], 7);
    ActorShape_Init(&this->actor.shape, 0.0f, NULL, 15.0f);
    this->actor.shape.shadowAlpha = 0xFF;
    temp_a0 = &this->unk_144[184];
    sp38 = temp_a0;
    Lights_PointGlowSetInfo((LightInfo *) temp_a0, (s16) (s32) this->actor.world.pos.x, (s16) (s32) this->actor.world.pos.y, (s16) (s32) this->actor.world.pos.z, (u8) 0xFF, (u8) 0xFF, (u8) 0xFF, (s16) 0);
    temp_a1 = &globalCtx->lightCtx;
    sp3C = temp_a1;
    this->unk20C = LightContext_InsertLight(globalCtx, temp_a1, (LightInfo *) sp38);
    temp_a0_2 = &this->unk_144[204];
    sp38 = temp_a0_2;
    Lights_PointNoGlowSetInfo((LightInfo *) temp_a0_2, (s16) (s32) this->actor.world.pos.x, (s16) (s32) this->actor.world.pos.y, (s16) (s32) this->actor.world.pos.z, (u8) 0xFF, (u8) 0xFF, (u8) 0xFF, (s16) 0);
    this->unk220 = LightContext_InsertLight(globalCtx, temp_a1, (LightInfo *) sp38);
    this->unk262 = 0U;
    this->unk25E = 0x258;
    this->unk240 = 0.0f;
    sp48 = 0;
    ...
    if ((this->actor.params & 0x100) != 0) {
        this->unk262 = (u16) (this->unk262 | 0x400);
    }
...
block_19:
        ...
        this->unk1EC = (f32) temp_t6_2->unk0;
        this->unk1F0 = (f32) temp_t6_2->unk4;
        this->unk1F4 = (f32) temp_t6_2->unk8;
        this->unk1F8 = (?32) temp_t6_2->unkC;
        return;
    case 1:
        sp48 = -1;
        gSaveContext.unk_1016 = 0;
        EnElf_SetupAction(this, func_8088E0F0);
        this->unk254 = Math_Vec3f_DistXZ(&this->actor.world.pos, &sp4C->world.pos);
        this->unk24C = -0x1000;
        this->unk248 = (s16) sp4C->shape.rot.y;
        this->unk246 = 0;
        this->unk250 = 0.0f;
        this->unk228 = (f32) (this->actor.world.pos.y - sp4C->world.pos.y);
        goto block_19;
    case 5:
        sp48 = -1;
    ...
    case 7:
        ...
        this->unk262 = (u16) (temp_t6 | 0x100);
        sp48 = -1;
        temp_t1 = this->unk262 | 0x800;
        this->unk262 = temp_t1;
        this->unk262 = (u16) (temp_t1 | 0x1000);
        func_8088CC48(this, globalCtx);
        goto block_19;
    case 2:
        this->unk262 = (u16) (this->unk262 | 0x100);
        sp48 = -1;
        temp_t8 = this->unk262 | 0x800;
        temp_t0 = temp_t8 | 0x2000;
        this->unk262 = temp_t8;
        this->unk262 = temp_t0;
        this->unk262 = (u16) (temp_t0 | 0x1000);
        func_8088CC48(this, globalCtx);
        goto block_19;
    case 6:
        sp48 = -1;
        ...
        this->unk262 = temp_t5;
        this->unk262 = temp_t7;
        this->unk262 = (u16) (temp_t7 | 0x1000);
        func_8088CC48(this, globalCtx);
        goto block_19;
    case 9:
        this->unk262 = (u16) (this->unk262 | 0x1000);
        // fallthrough
    case 10:
        sp48 = -2;
        func_8088CC48(this, globalCtx);
    ...
    case 4:
        ...
        this->unk262 = (u16) (this->unk262 | 8);
        sp3C = &globalCtx->actorCtx.unk0;
        phi_v1 = 0;
        do {
            sp40 = phi_v1;
...
void func_8088D3EC(EnElf *arg0, GlobalContext *arg1) {
    ...
    arg0->unk224 = (f32) (Math_SinS(arg0->unk248) * arg0->unk254);
    arg0->unk228 = (f32) (Math_SinS(arg0->unk246) * arg0->unk250);
    temp_f18 = Math_CosS(arg0->unk248) * arg0->unk254;
    arg0->unk248 = (s16) (arg0->unk248 + arg0->unk24C);
    arg0->unk246 = (s16) (arg0->unk246 + arg0->unk24A);
...
void func_8088D504(EnElf *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = arg0->unk248;
    arg0->unk246 = (s16) (temp_a0 * 2);
    arg0->unk224 = (f32) (Math_SinS(temp_a0) * arg0->unk254);
    arg0->unk228 = (f32) (Math_SinS(arg0->unk246) * arg0->unk250);
    arg0->unk22C = (f32) (-Math_SinS(sp24->shape.rot.y) * arg0->unk224);
...
void func_8088D660(Actor *arg0, PosRot *arg1, f32 arg2) {
    f32 sp34;
    f32 sp28;
    f32 sp24;
    f32 temp_f0;
    ...
    temp_f14 = ((arg1->pos.x + arg0->unk224) - arg0->world.pos.x) * arg2;
    temp_f2 = ((arg1->pos.z + arg0->unk22C) - arg0->world.pos.z) * arg2;
...
void func_8088D8D0(EnElf *arg0, s8 *arg1) {
    f32 temp_f0;
    f32 temp_f2;
    s16 temp_a0;
    f32 phi_f0;
...
void func_8088DB4C(Actor *arg0, Actor *arg1, f32 arg2, f32 arg3, f32 arg4) {
    f32 sp24;
    f32 sp20;
    f32 temp_f0;
    f32 temp_f12;
    ...
    sp24 = temp_f16;
    temp_f18 = ((arg1->home.pos.x + arg0->unk22C) - arg0->world.pos.z) * arg4;
    temp_f12 = arg4 + 0.3f;
    temp_f14 = arg3 + 30.0f;
    sp20 = temp_f18;
    arg3 = temp_f14;
...
void func_8088DD34(EnElf *this, GlobalContext *globalCtx) {
    ...
    if (Rand_ZeroOne() < 0.05f) {
        this->unk250 = (f32) (Rand_ZeroFloat(10.0f) + 10.0f);
        this->unk24A = (s16) ((s32) Rand_ZeroFloat(1024.0f) + 0x200);
    }
    func_8088CBAC(this, globalCtx);
    if ((this->unk262 & 0x800) != 0) {
        this->unk228 = (f32) sp2C->unkBF0;
    }
    func_8088D8D0(this, &this->unk_144[224]);
    func_8088D9BC(&this->actor, globalCtx);
    ...
    if (func_801233E4(globalCtx) != 0) {
        ...
        if (((temp_v0_2 & 0x4000) != 0) && ((temp_v0_2 & 0x100) != 0) && (func_8088DCA4(&this->actor) != 0)) {
            return;
        }
    ...
    if (((this->unk262 & 0x1000) != 0) && (temp_f0 > 0.0f) && (temp_f0 < 60.0f) && (func_8088C804(&this->actor.world, &sp34->world, 10.0f) == 0)) {
        ...
        this->unk228 = 30.0f;
        this->unk250 = 0.0f;
        this->unk248 = (s16) sp34->shape.rot.y;
        EnElf_SetupAction(this, func_8088E0F0);
        if ((this->unk262 & 0x400) != 0) {
            Actor_SetCollectibleFlag(globalCtx, (s32) this->unk260);
            return;
    ...
    if ((this->unk262 & 0x100) != 0) {
        if (func_8088DCA4(&this->actor, 0x3C030000) != 0) {
            return;
        }
        goto block_25;
    }
...
void func_8088E018(EnElf *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v1 != 0) && (temp_v1->update != 0)) {
        sp2C.pos.x = temp_v1->world.pos.x;
        sp2C.pos.y = temp_v1->world.pos.y;
        sp2C.pos.z = temp_v1->world.pos.z;
        sp30 += (1500.0f * this->actor.scale.y) + 40.0f;
        func_8088D660(&this->actor, &sp2C, 0.2f);
    } else {
        Actor_MarkForDeath(&this->actor);
    }
...
void func_8088E0F0(EnElf *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_FrameUpdateMatrix((SkelAnime *) this->unk_144);
    Math_SmoothStepToF((f32 *) &this->unk_144[272], 30.0f, 0.1f, 4.0f, 1.0f);
    temp_f2 = this->unk250;
    temp_f8 = Math_CosS(this->unk248) * this->unk254;
    temp_v0 = this->unk246;
    this->unk228 = (f32) (this->unk228 + temp_f2);
    this->unk224 = temp_f8;
    if (temp_v0 != 0) {
        if (temp_v0 != 1) {

        } else if (temp_f2 > -1.0f) {
            this->unk250 = (f32) (temp_f2 - 0.2f);
        }
    } else if (temp_f2 < 2.0f) {
        this->unk250 = (f32) (temp_f2 + 0.1f);
    } else {
        gSaveContext.healthAccumulator = 0xA0;
        this->unk246 = (s16) (this->unk246 + 1);
    }
    temp_f6 = Math_SinS(this->unk248) * -this->unk254;
    this->unk248 = (s16) (this->unk248 + this->unk24C);
    this->unk22C = temp_f6;
    func_8088D660(&this->actor, &sp2C->world, 0.2f);
    if (this->unk250 < 0.0f) {
        temp_f0 = this->unk228;
        if ((temp_f0 < 20.0f) && (temp_f0 > 0.0f)) {
            Actor_SetScale(&this->actor, temp_f0 * 0.008f * 0.05f);
        }
    }
    ...
    Audio_PlayActorSound2(&this->actor, 0x20A8U);
}
...
void func_8088E484(EnElf *this, GlobalContext *globalCtx) {
    ...
    this->unk22C = 0.0f;
    this->unk224 = 0.0f;
    this->unk228 = (f32) (this->unk228 + temp_f0);
    this->unk250 = (f32) (temp_f0 - 0.35f);
    if (this->unk250 <= 0.0f) {
    ...
    func_8088D7F8(&this->actor, sp24 + 0xBEC);
    temp_f0_2 = this->unk250;
    Actor_SetScale(&this->actor, (1.0f - (temp_f0_2 * temp_f0_2 * 0.012345679f)) * 0.008f);
    this->unk258 = Math_FAtan2F(this->actor.velocity.z, this->actor.velocity.x);
    func_8088F5F4(this, globalCtx, 0x20);
    Audio_PlayActorSound2(&this->actor, 0x20A8U);
}
...
void func_8088E850(EnElf *this, GlobalContext *globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0xC9U) != 0) {
        ...
        if (this->unk244 == 8) {
            func_8088D864(&this->actor, &sp4C);
        } else {
            func_8088D660(&this->actor, (PosRot *) &sp4C, 0.2f);
        }
        ...
        if ((temp_v1 == 0x6F) && (gSaveContext.sceneSetupIndex == 0) && (globalCtx->csCtx.unk_12 == 0) && ((temp_v0_2 = globalCtx->csCtx.frames, (temp_v0_2 == 0x95)) || (temp_v0_2 == 0x17D) || (temp_v0_2 == 0x24F))) {
            Audio_PlayActorSound2(&this->actor, 0x281BU);
        ...
        temp_a3 = sp48 + 0xC4C;
        sp30 = temp_a3;
        sp3C = Math_Vec3f_DistXYZ(temp_a3, &temp_a1->pos);
        ...
        if (temp_v0_3 != 5) {
                ...
                if (temp_v0_3 != 9) {
                    if (temp_v0_3 != 0xA) {
                        ...
                        if (((sp48->unkA6C & 0x40) != 0) && (temp_v0_4 = sp48->unkA88, (temp_v0_4 != 0))) {
                            ...
                            Math_Vec3f_Copy((Vec3f *) &sp4C, &globalCtx->actorCtx.targetContext.unk0);
                        }
                        sp4C.flags = (bitwise u32) ((bitwise f32) sp4C.flags + (1500.0f * this->actor.scale.y));
                        if (sp44 != 0) {
                            func_8088DB4C(&this->actor, &sp4C, 0.0f, 30.0f, 0.2f);
                            if (this->actor.speedXZ >= 5.0f) {
                                func_8088F5F4(this, globalCtx, 0x10);
                            }
                        } else {
                            if ((this->unk25A & 0x1F) == 0) {
                                this->unk23C = (f32) (Rand_ZeroFloat(7.0f) + 3.0f);
                            }
                            temp_v0_5 = this->unk262;
                            if ((temp_v0_5 & 2) != 0) {
                                if (sp3C < 30.0f) {
                                    this->unk262 = (u16) (temp_v0_5 ^ 2);
                                }
                                func_8088DB4C(&this->actor, &sp4C, 0.0f, 30.0f, 0.2f);
                                func_8088F5F4(this, globalCtx, 0x10);
                            } else {
                                if (sp3C > 100.0f) {
                                    this->unk262 = (u16) (temp_v0_5 | 2);
                                    if ((u8) this->unk_266[3] == 0) {
                                        Audio_PlayActorSound2(&this->actor, 0x299FU);
                                    }
                                    this->unk25C = 0x64;
                                }
                                func_8088DB4C(&this->actor, &sp4C, 0.0f, this->unk23C, 0.2f);
                            }
                        }
                    } else {
                        temp_t8 = globalCtx->cameraPtrs[globalCtx->activeCamera];
                        sp4C.unk0 = (f32) temp_t8->eye.x;
                        sp4C.flags = (bitwise u32) temp_t8->eye.y;
                        sp4C.home.pos.x = temp_t8->eye.z;
                        sp4C.flags = (bitwise u32) ((bitwise f32) sp4C.flags + (-2000.0f * this->actor.scale.y));
                        func_8088DB4C(&this->actor, &sp4C, 0.0f, 30.0f, 0.2f);
                    }
                } else {
                    sp4C.unk0 = (f32) temp_a3->x;
                    sp4C.flags = (bitwise u32) temp_a3->y;
                    sp4C.home.pos.x = temp_a3->z;
                    sp4C.flags = (bitwise u32) ((bitwise f32) sp4C.flags + (1500.0f * this->actor.scale.y));
                    func_8088D7F8(&this->actor, &sp4C);
                    func_8088F5F4(this, globalCtx, 0x10);
                    temp_f0 = this->unk254;
                    if (temp_f0 <= 19.0f) {
                        this->unk254 = (f32) (temp_f0 + 1.0f);
                    }
                    if (this->unk254 >= 21.0f) {
                        this->unk254 = (f32) (this->unk254 - 1.0f);
                    }
                    temp_v0_6 = this->unk25C;
                    if ((s32) temp_v0_6 < 0x20) {
                        this->unk24C = (s16) ((temp_v0_6 * 0xF0) + 0x200);
                    }
                }
            } else {
                sp30 = temp_a3;
                func_8088D660(&this->actor, (PosRot *) temp_a3, 0.2f, temp_a3);
            ...
            sp30 = temp_a3;
            func_8088D660(&this->actor, (PosRot *) temp_a3, 1.0f - ((f32) this->unk24A * 0.033333335f), temp_a3);
            if (sp3C < 7.0f) {
                this->unk25C = 0;
                sp40 = 0.0f;
            } else if (sp3C < 25.0f) {
                temp_f12 = 1.0f - ((Math_Vec3f_DistXYZ(sp30, &sp2C->pos) - 5.0f) * 0.05f);
    ...
    func_8088E60C(&this->actor, globalCtx);
    if (func_800EE29C(globalCtx, 0xC9U) == 0) {
...
void func_8088EFA4(Actor *arg0, GlobalContext *arg1) {
    ...
    if (phi_v1 != 0) {
        ...
        if ((sp2C == 0) || (Math_Vec3f_DistXYZ(&arg0->world.pos, arg1 + 0x1DC0) < 50.0f)) {
            arg0->unk268 = 1U;
        }
...
void func_8088F214(Actor *arg0, GlobalContext *arg1) {
    ...
    if (phi_a2_2 != phi_a3_2->unk244) {
        ...
        if (phi_a2_2 == 9) {
            ...
            sp20 = temp_a2;
            arg0 = arg0;
            arg0->unk254 = Math_Vec3f_DistXZ(temp_a2, &temp_a1_2->pos);
            arg0->unk248 = Math_Vec3f_Yaw(&sp1C->pos, sp20);
        }
    }
}
...
void func_8088FA38(EnElf *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk262 & 0x10) != 0) {
        ...
        arg0->unk262 = (u16) (arg0->unk262 & 0xFFEF);
    ...
    func_8088DB4C(&arg0->actor, (Actor *) &sp34, 0.0f, 30.0f, 0.2f);
    if (arg0->actor.speedXZ >= 5.0f) {
        func_8088F5F4(arg0, arg1, 0x10);
    }
    Math_SmoothStepToF(&arg0->actor.scale.x, 0.008f, 0.3f, 0.00080000004f, 0.000080000005f);
    func_8088E60C(&arg0->actor, arg1);
}
...
void func_8088FDCC(EnElf *arg0) {
    ...
    arg0->unk262 = (u16) (arg0->unk262 & 0xFFDF);
    arg0->unk234 = 0;
...
s32 func_80890494(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg5) {
    ...
    if (arg1 == 6) {
        ...
        SysMatrix_InsertTranslation(sp34.x, sp34.y, sp34.z, 0);
...
void EnElf_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v1->unk153 != 0x14) {
        ...
        if (((this->unk262 & 8) == 0) && ((sp70 = temp_v1, globalCtx = globalCtx, (func_800EE29C(temp_a0, 0xC9U) == 0)) || (sp70 = temp_v1, (globalCtx->csCtx.npcActions[func_800EE200(globalCtx, 0xC9U)]->unk0 != 6))) && (!(globalCtx->actorCtx.actorList[2].first->unkA6C & 0x100000) || ((f32) gGameInfo->data[2682] < this->actor.projectedPos.z))) {
            ...
            sp58 = sp58;
            sp58->polyXlu.p = SkelAnime_Draw2(globalCtx, this->unk148, this->unk164, func_80890494, NULL, &this->actor, temp_t3);
        }
    }
}

void func_808908D0(Actor *arg0, GlobalContext *arg1, u32 arg2) {
    f32 sp2C;
    f32 sp28;
    f32 sp24;
    f32 sp20;
    ...
    arg0->unk0 = (f32) (((sp18 - temp_f2) * temp_f0) + temp_f2);
    arg0->flags = ((sp1C - temp_f12) * temp_f0) + temp_f12;
    arg0->home.pos.x = ((sp20 - temp_f14) * temp_f0) + temp_f14;
}
