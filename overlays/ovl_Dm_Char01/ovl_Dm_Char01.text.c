typedef struct DmChar01 {
    ...
    /* 0x148 */ char pad148[0x58];                  /* maybe part of unk144[23]? */
    /* 0x1A0 */ void (*actionFunc)(DmChar01 *, GlobalContext *);
    /* 0x1A4 */ char pad1A4[0x8];                   /* maybe part of actionFunc[3]? */
    /* 0x1AC */ s16 unk1AC;                         /* inferred */
    /* 0x1AE */ char pad1AE[0x198];                 /* maybe part of unk1AC[205]? */
    /* 0x346 */ s16 unk346;                         /* inferred */
    /* 0x348 */ f32 unk348;                         /* inferred */
    /* 0x34C */ u8 unk34C;                          /* inferred */
    /* 0x34D */ u8 unk34D;                          /* inferred */
    /* 0x34E */ char pad34E[0x2];                   /* maybe part of unk34D[3]? */
} DmChar01;                                         /* size = 0x350 */
...
void DmChar01_Init(DmChar01 *this, GlobalContext *globalCtx) {
    s16 temp_t7;
    s16 temp_t7_2;
    s16 temp_v0;
    u8 *temp_v1;
...
void DmChar01_Destroy(DmChar01 *this, GlobalContext *globalCtx) {
    DmChar01 *this = (DmChar01 *) thisx;
    if (this->unk34D != 0) {
...
void DmChar01_Update(DmChar01 *this, GlobalContext *globalCtx) {
...
void DmChar01_Draw(DmChar01 *this, GlobalContext *globalCtx) {
    f32 spBC;
    s32 spB8;
    u8 spB7;
