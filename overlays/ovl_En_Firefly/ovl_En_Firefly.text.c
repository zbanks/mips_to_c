...
void EnFirefly_DiveAttack(EnFirefly *this, GlobalContext *globalCtx) {
    ...
    if ((this->timer == 0) || (Player_GetMask(globalCtx) == 0x10) || ((sp44->unkA70 & 0x80) != 0) || ((s32) sp44->freezeTimer > 0)) {
    ...
    if ((arg4->unk18D != 0) && (arg1 == 0x1B)) {
        ...
        *arg5 = temp_v1 + 8;
        ...
        if (EnFirefly_Die != arg4->unk188) {
            ...
            if (arg1 == 0xF) {
                sp5C = (Math_SinS((s16) (arg4->unk190 * 0x238C)) * (f32) arg4->unk190) + arg4->world.pos.x;
                sp64 = (Math_CosS((s16) (arg4->unk190 * 0x238C)) * (f32) arg4->unk190) + arg4->world.pos.z;
            } else {
                sp5C = arg4->world.pos.x - (Math_SinS((s16) (arg4->unk190 * 0x238C)) * (f32) arg4->unk190);
                sp64 = arg4->world.pos.z - (Math_CosS((s16) (arg4->unk190 * 0x238C)) * (f32) arg4->unk190);
            }
            sp60 = arg4->world.pos.y + ((f32) (0xF - arg4->unk190) * 1.5f);
            phi_t0 = -5;
            phi_t1 = 0xA;
        }
        if (arg4->unk18C == 1) {
