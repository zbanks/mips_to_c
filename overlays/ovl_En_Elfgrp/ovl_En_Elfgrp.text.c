...
void EnElfgrp_Init(EnElfgrp *this, GlobalContext *globalCtx) {
    s32 sp24;
    s16 temp_a1;
    s32 temp_a2;
    s32 temp_a2_2;
...
void EnElfgrp_Destroy(EnElfgrp *this, GlobalContext *globalCtx) {
    EnElfgrp *this = (EnElfgrp *) thisx;
...
void EnElfgrp_Update(EnElfgrp *this, GlobalContext *globalCtx) {
    EnElfgrp *temp_a0;
    s16 temp_v0;
    EnElfgrp *phi_a0;
    EnElfgrp *this = (EnElfgrp *) thisx;
