typedef struct OceffSpot {
    /* 0x000 */ Actor actor;
    /* 0x144 */ LightNode *unk_144;                 /* inferred */
    /* 0x148 */ LightInfo unk_148;                  /* inferred */
    /* 0x156 */ char pad_156[0x2];
    /* 0x158 */ LightNode *unk_158;                 /* inferred */
    /* 0x15C */ LightInfo unk_15C;                  /* inferred */
    /* 0x16A */ char pad_16A[0x2];
...
void OceffSpot_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp38 = temp_a1;
    this->unk_144 = LightContext_InsertLight(globalCtx, temp_a1, sp34);
    ...
    this->unk_158 = LightContext_InsertLight(globalCtx, temp_a1, sp34);
...
void OceffSpot_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    globalCtx = globalCtx;
    sp1C = temp_a1;
    LightContext_RemoveLight(temp_a0, temp_a1, this->unk_144);
    LightContext_RemoveLight(globalCtx, temp_a1, this->unk_158);
...
void func_80972844(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((gGameInfo->data[15] != 0x190) && (arg1->msgCtx.unk_12046 == 0)) {
        if ((arg1->msgCtx.unk_1202C != 0x39) || (arg1->msgCtx.unk1202A != 0xA)) {
...
void func_809728F8(OceffSpot *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = this->unk_170;
    if ((s32) temp_v0 > 0) {
        this->unk_170 = temp_v0 - 1;
        return;
    }
...
void OceffSpot_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_f14 = (1.0f - __cosf(this->unk_16C * 3.1415927f)) * 0.5f;
    sp50 = temp_f14;
    ...
    sp38 = temp_v1;
    Lights_PointNoGlowSetInfo(&this->unk_148, (s16) (s32) this->actor.world.pos.x, (s16) (s32) (this->actor.world.pos.y + 55.0f), (s16) (s32) this->actor.world.pos.z, (u8) temp_v0_2, (u8) temp_v0_2, (u8) temp_v1, (s16) (s32) (s16) temp_f6);
    sp40 = Math_SinS(sp54->shape.rot.y);
    Lights_PointNoGlowSetInfo(&this->unk_15C, (s16) (s32) ((sp40 * 20.0f) + this->actor.world.pos.x), (s16) (s32) (this->actor.world.pos.y + 20.0f), (s16) (s32) ((Math_CosS(sp54->shape.rot.y) * 20.0f) + this->actor.world.pos.z), (u8) temp_v0_2, (u8) temp_v0_2, (u8) sp38, (s16) sp34);
}
