typedef struct EnGakufu {
    ...
    /* 0x149 */ char pad149[0x7];                   /* maybe part of unk148[8]? */
...
struct _mips2c_stack_EnGakufu_Draw {
    /* 0x00 */ char pad0[0x40];
    /* 0x40 */ ? *sp40;                             /* inferred */
    /* 0x44 */ char pad44[0x48];                    /* maybe part of sp40[19]? */
...
void func_80AFC960(EnGakufu *arg0) {
    ...
    func_8019D26C();
    func_8019C300(1);
    func_8019B544((1 << arg0->unk144) | 0x80000000);
...
block_5:
            ...
            do {
                ...
                temp_v1_2->unk144 = (u8) phi_v0_2->unk1;
                temp_v0_2 = phi_v0_2 + 4;
                temp_v1_2->unk145 = (u8) phi_v0_2->unk2;
                temp_v1_2->unk146 = (u8) temp_v0_2->unk-1;
                temp_v1_2->unk147 = (u8) temp_v0_2->unk0;
                phi_v0_2 = temp_v0_2;
                phi_v1_2 = temp_v1_2;
                phi_a0_2 = temp_a0_2;
                phi_a0_3 = temp_a0_2;
...
void EnGakufu_Init(EnGakufu *this, GlobalContext *globalCtx) {
...
void EnGakufu_Destroy(EnGakufu *this, GlobalContext *globalCtx) {
    EnGakufu *this = (EnGakufu *) thisx;
    if ((this->actor.params & 0xF) != 1) {
        gSaveContext.eventInf[3] &= 0xFD;
    }
...
void EnGakufu_Update(EnGakufu *this, GlobalContext *globalCtx) {
    EnGakufu *this = (EnGakufu *) thisx;
    this->actionFunc(this, globalCtx);
}

void EnGakufu_Draw(EnGakufu *this, GlobalContext *globalCtx) {
    EnGakufu *sp8C;
    ? *sp40;
    Gfx *temp_v0;
    Gfx *temp_v0_10;
...
loop_2:
        SysMatrix_StatePush();
        SysMatrix_InsertTranslation((f32) phi_s4, *(&D_80AFD204 + (phi_s2->unk148 * 4)) * 7.5f, 1.0f, 1);
        ...
        temp_v0_5->words.w1 = *(&D_80AFD218 + (phi_s2->unk148 * 4));
        ...
        phi_s2 += 1;
        phi_s3 = temp_s3;
        if ((temp_s3 < 8) && ((sp8C + temp_s3)->unk148 != 0xFF)) {
            goto loop_2;
        }
    }
