...
typedef struct EnGakufu {
    ...
    /* 0x0147 */ u8 unk147;                         /* overlap; inferred */
    /* 0x0148 */ u8 unk148;                         /* inferred */
    /* 0x0149 */ char pad149[0x7];                  /* maybe part of unk148[8]? */
    /* 0x0150 */ void (*actionFunc)(EnGakufu *, GlobalContext *);
} EnGakufu;                                         /* size 0x154 */
...
void func_80AFCD44(EnGakufu *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext((s16) temp_a3) != 0) {
        ...
        this = temp_a2;
        ActorCutscene_StartAndSetUnkLinkFields((s16) temp_a0, &temp_a2->actor);
