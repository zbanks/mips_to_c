...
void ObjWind_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (D_80B245CC != temp_a3) {
        if (((s32) temp_a3 >= 0) && ((s32) temp_a3 < 0x20)) {
            ...
            temp_v0_2 = gGameInfo;
            temp_v0_2->data[753] = (&D_80B2448C + (temp_v0_2->data[757] * 0xA))->unk_2;
            temp_v0_3 = gGameInfo;
            temp_v0_3->data[754] = (&D_80B2448C + (temp_v0_3->data[757] * 0xA))->unk_4;
            temp_v0_4 = gGameInfo;
            temp_v0_4->data[755] = (&D_80B2448C + (temp_v0_4->data[757] * 0xA))->unk_6;
            temp_v0_5 = gGameInfo;
            temp_v0_5->data[756] = (&D_80B2448C + (temp_v0_5->data[757] * 0xA))->unk_8;
            D_80B245CC = (s32) gGameInfo->data[757];
            goto block_5;
        }
    } else {
        *(&D_80B2448C + (temp_a3 * 0xA)) = temp_v0->data[752];
        (&D_80B2448C + (temp_v0->data[757] * 0xA))->unk_2 = (s16) temp_v0->data[753];
        (&D_80B2448C + (temp_v0->data[757] * 0xA))->unk_4 = (s16) temp_v0->data[754];
        (&D_80B2448C + (temp_v0->data[757] * 0xA))->unk_6 = (s16) temp_v0->data[755];
        (&D_80B2448C + (temp_v0->data[757] * 0xA))->unk_8 = (s16) temp_v0->data[756];
block_5:
    }
    ...
    if ((temp_a1 == 0x7F) || (Flags_GetSwitch(globalCtx, temp_a1) == 0)) {
        ...
        sp4C = temp_f0;
        if ((temp_f0 >= 0.0f) && (temp_f0 < (f32) temp_s1->unk_0)) {
            temp_f0_2 = Math_Vec3f_DistXYZAndStoreDiff((Vec3f *) temp_a3_2, (Vec3f *) &sp60, (Vec3f *) &sp54);
            sp50 = temp_f0_2;
            temp_f14 = (f32) temp_s1->unk_2;
            if (temp_f0_2 < temp_f14) {
                temp_f16 = temp_f0_2 / temp_f14;
                temp_f2 = sp4C / (f32) temp_s1->unk_0;
                temp_f12 = 1.0f - temp_f2;
                sp40 = ((f32) temp_s1->unk_4 / 100.0f) * ((temp_f12 * (1.0f - temp_f16)) + ((f32) temp_s1->unk_8 / 100.0f));
                phi_f12 = temp_f12;
                if (temp_f2 > 0.8f) {
                    phi_f12 = 1.0f - 1.0f;
                }
                sp3C = ((f32) temp_s1->unk_6 / 100.0f) * (temp_f16 * phi_f12);
                if (temp_f0_2 != 0.0f) {
                    sp50 = 1.0f / temp_f0_2;
                }
                temp_f4 = sp3C * sp50;
                ...
                sp84->unk_B30 = Math_FAtan2F(sqrtf((sp38 * sp38) + (sp30 * sp30)), sp34);
            }
        }
    }
    this->actor.scale.x = (f32) temp_s1->unk_2 / 50.0f;
    this->actor.scale.z = (f32) temp_s1->unk_2 / 50.0f;
    this->actor.scale.y = (f32) temp_s1->unk_0 / 400.0f;
}
