...
struct _mips2c_stack_func_80ABBFC0 {
    ...
    /* 0x0B0 */ char padB0[0x1C];                   /* maybe part of spAC[8]? */
...
void BgHakuginBombwall_Init(BgHakuginBombwall *this, GlobalContext *globalCtx) {
    ...
    Actor_SetHeight((Actor *) this, temp_s1->unk8);
    this->actor.uncullZoneScale = temp_s1->unkC;
    this->actionFunc = func_80ABCCE4;
    this->actor.uncullZoneDownward = temp_s1->unk10;
}

void BgHakuginBombwall_Destroy(BgHakuginBombwall *this, GlobalContext *globalCtx) {
...
void BgHakuginBombwall_Update(BgHakuginBombwall *this, GlobalContext *globalCtx) {
    BgHakuginBombwall *this = (BgHakuginBombwall *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgHakuginBombwall_Draw(BgHakuginBombwall *this, GlobalContext *globalCtx) {
    BgHakuginBombwall *this = (BgHakuginBombwall *) thisx;
