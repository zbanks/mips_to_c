...
void EnSnowwd_Init(EnSnowwd *this, GlobalContext *globalCtx) {
    EnSnowwd *temp_a2;
    ...
    this = temp_a2;
    Collider_InitAndSetCylinder(globalCtx, &temp_a2->unk144, (Actor *) temp_a2, &D_80AF7A90);
    Actor_SetScale((Actor *) this, 1.0f);
    this->actionFunc = func_80AF76F0;
}

void EnSnowwd_Destroy(EnSnowwd *this, GlobalContext *globalCtx) {
    EnSnowwd *this = (EnSnowwd *) thisx;
...
void func_80AF76F0(EnSnowwd *this, GlobalContext *globalCtx) {
    ...
    if (this->actor.home.rot.y != 0) {
        ...
        if (this->actor.home.rot.z == 0) {
            if (((s32) (this->actor.params & 0xF80) >> 7) < 0x10) {
                sp48.unk0 = this->actor.world.pos.x;
                sp48.unk4 = (f32) this->actor.world.pos.y;
                sp48.unk8 = (f32) this->actor.world.pos.z;
                sp4C += 200.0f;
    ...
    if ((s32) temp_v0_2 > 0) {
        ...
        sp48.unk0 = temp_t9->pos.x;
        sp48.unk4 = (f32) temp_t9->pos.y;
        sp48.unk8 = (f32) temp_t9->pos.z;
...
void EnSnowwd_Update(EnSnowwd *this, GlobalContext *globalCtx) {
    EnSnowwd *this = (EnSnowwd *) thisx;
    this->actionFunc(this, globalCtx);
}

void EnSnowwd_Draw(EnSnowwd *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *sp20;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
