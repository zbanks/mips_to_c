typedef struct EnSth {
    ...
    /* 0x23A */ char pad_23A[0x60];                 /* maybe part of unk_234[17]? */
    /* 0x29A */ s16 unk_29A;                        /* inferred */
    /* 0x29C */ u16 unk_29C;                        /* inferred */
    /* 0x29E */ u8 unk_29E;                         /* inferred */
    /* 0x29F */ s8 unk_29F;                         /* inferred */
...
void EnSth_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    this->unk_29E = phi_v0;
    this->unk_29F = Object_GetIndex(phi_a0, 0x1DE);
    Actor_SetScale((Actor *) this, 0.01f);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_144, (Actor *) this, &D_80B6D19C);
...
void func_80B670A4(Actor *arg0, s16 arg1) {
    ...
    if (((s32) arg1 >= 0) && ((s32) arg1 < 8) && (arg1 != arg0->unk_29A)) {
...
void EnSth_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->unk_29E) != 0) {
        this->actor.objBankIndex = (s8) this->unk_29E;
        Actor_SetObjectSegment(globalCtx, (Actor *) this);
        temp_a1 = &this->unk_190;
        if ((this->actor.params & 0x100) != 0) {
            temp_a1_2 = &this->unk_190;
            sp30 = temp_a1_2;
            SkelAnime_InitSV(globalCtx, temp_a1_2, &D_06005998, &D_80B6B2E4, &this->unk_1D4, &this->unk_234, 0x10);
            ...
            sp30 = temp_a1;
            SkelAnime_InitSV(globalCtx, temp_a1, &D_060031F8, &D_80B6AC80, &this->unk_1D4, &this->unk_234, 0x10);
