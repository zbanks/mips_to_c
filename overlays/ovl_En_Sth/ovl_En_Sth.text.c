...
typedef struct EnSth {
    ...
    /* 0x023A */ char pad23A[0x60];                 /* maybe part of unk234[17]? */
    /* 0x029A */ s16 unk29A;                        /* inferred */
    /* 0x029C */ u16 unk29C;                        /* inferred */
    /* 0x029E */ u8 unk29E;                         /* inferred */
    /* 0x029F */ s8 unk29F;                         /* inferred */
    /* 0x02A0 */ void (*unk2A0)(Actor *, GlobalContext *); /* inferred */
} EnSth;                                            /* size 0x2A4 */
...
void EnSth_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, &this->actor, &D_80B6D19C);
        ...
        if (temp_v1 != 3) {
            if (temp_v1 != 4) {
                if (temp_v1 != 5) {
                    ...
                    func_80B670A4(&this->actor, 7);
                    goto block_18;
                }
            } else {
                if ((gSaveContext.weekEventReg[13] & 0x80) != 0) {
                    func_80B670A4(&this->actor, 5);
                } else {
                    func_80B670A4(&this->actor, 5);
                }
                goto block_18;
