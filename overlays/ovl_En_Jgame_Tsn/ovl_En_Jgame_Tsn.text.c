...
static ActorAnimationEntry D_80C15030 = {
...
typedef struct EnJgameTsn {
    ...
    /* 0x01D4 */ void (*actionFunc)(EnJgameTsn *, GlobalContext *);
    /* 0x01D8 */ char pad1D8[0x44];                 /* maybe part of actionFunc[18]? */
    /* 0x021C */ s32 unk21C;                        /* inferred */
    /* 0x0220 */ Vec3s unk220;                      /* inferred */
    /* 0x0226 */ char pad226[0x60];                 /* maybe part of unk220[17]? */
    /* 0x0286 */ Vec3s unk286;                      /* inferred */
    /* 0x028C */ char pad28C[0x6C];                 /* maybe part of unk286[19]? */
    /* 0x02F8 */ s16 unk2F8;                        /* inferred */
    /* 0x02FA */ s16 unk2FA;                        /* inferred */
    /* 0x02FC */ char pad2FC[0x2];                  /* maybe part of unk2FA[2]? */
    /* 0x02FE */ s16 unk2FE;                        /* inferred */
    /* 0x0300 */ char pad300[0x4];                  /* maybe part of unk2FE[3]? */
...
void EnJgameTsn_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, &this->actor, &D_80C15078);
...
void EnJgameTsn_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80C14D14(&this->actor, globalCtx);
    func_80C14D58(&this->actor, globalCtx);
}
...
void EnJgameTsn_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80C14E64, func_80C14EE4, &this->actor);
}
