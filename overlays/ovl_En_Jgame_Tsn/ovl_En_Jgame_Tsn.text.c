typedef struct EnJgameTsn {
    ...
    /* 0x1D8 */ char pad1D8[0x44];                  /* maybe part of actionFunc[18]? */
    /* 0x21C */ s32 unk21C;                         /* inferred */
    /* 0x220 */ Vec3s unk220;                       /* inferred */
    /* 0x226 */ char pad226[0x60];                  /* maybe part of unk220[17]? */
    /* 0x286 */ Vec3s unk286;                       /* inferred */
    /* 0x28C */ char pad28C[0x6C];                  /* maybe part of unk286[19]? */
    /* 0x2F8 */ s16 unk2F8;                         /* inferred */
    /* 0x2FA */ s16 unk2FA;                         /* inferred */
    /* 0x2FC */ char pad2FC[0x2];
    /* 0x2FE */ s16 unk2FE;                         /* inferred */
    /* 0x300 */ char pad300[0x4];                   /* maybe part of unk2FE[3]? */
...
void EnJgameTsn_Init(EnJgameTsn *this, GlobalContext *globalCtx) {
    ColliderCylinder *sp34;
    ColliderCylinder *temp_a1;
    EnJgameTsn *this = (EnJgameTsn *) thisx;

    ActorShape_Init(&this->actor.shape, 0.0f, func_800B3FC0, 36.0f);
    SkelAnime_InitSV(globalCtx, &this->unk190, &D_06008AB8, &D_060092FC, &this->unk220, &this->unk286, 0x11);
    temp_a1 = &this->unk144;
    sp34 = temp_a1;
...
void func_80C13A2C(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s2 = 0;
    do {
        phi_s0->unk1D8 = Lib_SegmentedToVirtual(phi_s1->unk4);
        phi_s0->unk1DC = (s32) phi_s1->unk0;
        temp_s1_2 = arg1->setupPathList + (phi_s1->unk1 * 8);
        phi_s1 = temp_s1_2;
        if (temp_s1_2 == 0) {
            Actor_MarkForDeath(arg0);
        }
    ...
    arg0->unk1F8 = Lib_SegmentedToVirtual(temp_s1_2->unk4);
    arg0->unk1FC = (s32) temp_s1_2->unk0;
    temp_s1_3 = arg1->setupPathList + (temp_s1_2->unk1 * 8);
    if (temp_s1_3 == 0) {
        Actor_MarkForDeath(arg0);
    }
    arg0->unk200 = Lib_SegmentedToVirtual(temp_s1_3->unk4);
    arg0->unk204 = (s32) temp_s1_3->unk0;
}

void EnJgameTsn_Destroy(EnJgameTsn *this, GlobalContext *globalCtx) {
    EnJgameTsn *this = (EnJgameTsn *) thisx;
...
void func_80C13BB8(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((sp2C->bgCheckFlags & 1) != 0) && ((sp2C->unkA6C & 0x2000) == 0) && (arg0->unk2FE == 0) && (gSaveContext.playerForm == 4) && (func_80C149B0(arg1, arg0 + 0x1F8) != 0)) {
        arg0->unk2FE = 1;
        func_80C13E6C(arg0);
...
void func_80C141DC(void *arg0) {
    ...
    arg0->unk218 = temp_v1;
    arg0->unk2FC = 0;
    temp_a0 = (arg0 + temp_t6)->unk208;
    *temp_a0 |= 1;
    arg0->unk1D4 = func_80C14230;
}
...
void func_80C14230(Actor *arg0, GlobalContext *arg1) {
    ...
    if (((s32) arg0->unk2FC >= 0x65) || (func_80C14BCC(arg0, arg1) != 0)) {
        temp_v1 = Rand_Next() % 3U;
        arg0->unk2FC = 0;
        phi_a0 = 0;
        if ((s32) temp_v1 < arg0->unk218) {
            arg0->unk218 = (s32) temp_v1;
        } else {
            arg0->unk218 = (s32) (temp_v1 + 1);
        }
        phi_v1 = arg0;
        do {
            if (phi_a0 == arg0->unk218) {
                temp_v0 = phi_v1->unk208;
                *temp_v0 |= 1;
                temp_v0_2 = phi_v1->unk208;
                *temp_v0_2 &= -9;
            } else {
                temp_v0_3 = phi_v1->unk208;
                *temp_v0_3 |= 8;
            }
            temp_a0 = phi_a0 + 2;
            phi_a0 = temp_a0;
            if ((phi_a0 + 1) == arg0->unk218) {
                temp_v0_4 = phi_v1->unk20C;
                *temp_v0_4 |= 1;
                temp_v0_5 = phi_v1->unk20C;
                *temp_v0_5 &= -9;
            } else {
                temp_v0_6 = phi_v1->unk20C;
                *temp_v0_6 |= 8;
            }
            phi_v1 += 8;
        } while (temp_a0 != 4);
    }
    arg0->unk2FC = (s16) (arg0->unk2FC + 1);
    if (((sp24->bgCheckFlags & 2) != 0) && (func_80C149B0(arg1, arg0 + 0x200) != 0)) {
        func_800BDC5C(arg0 + 0x190, (ActorAnimationEntry []) D_80C15030, 2);
        func_801518B0(arg1, 0x109FU, arg0);
        arg0->unk300 = 0x109F;
        sp24->unkA6C = (s32) (sp24->unkA6C | 0x20);
        temp_v0_7 = (arg0 + (arg0->unk218 * 4))->unk208;
        *temp_v0_7 &= 0xFFFE;
        func_801A2C20();
        func_80C14030(arg0);
    } else {
        ...
        if (((temp_v0_8 & 0x40) != 0) || ((temp_v0_8 & 0x20) != 0)) {
            ...
            arg0->unk300 = 0x10A0;
            sp24->unkA6C = (s32) (sp24->unkA6C | 0x20);
            temp_v0_9 = (arg0 + (arg0->unk218 * 4))->unk208;
            *temp_v0_9 &= 0xFFFE;
            func_801A2C20();
            func_80C14030(arg0);
        }
    ...
    if ((gSaveContext.unk_3DE0[4] == 0) && (*(&gSaveContext + 0x3E04) == 0)) {
        ...
        arg0->unk300 = 0x10A1;
        sp24->unkA6C = (s32) (sp24->unkA6C | 0x20);
        temp_v0_10 = (arg0 + (arg0->unk218 * 4))->unk208;
        *temp_v0_10 &= 0xFFFE;
        func_801A2C20();
        func_80C14030(arg0);
    }
...
void func_80C144E4(Actor *arg0) {
    arg0->unk1D4 = func_80C144F8;
}

void func_80C144F8(s32 arg0, void *arg1) {
    arg1->unk1887A = 0x68D0;
    arg1->unk18875 = 0x14;
    arg1->unk1887F = 0x50;
...
void func_80C1476C(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 0) {
        do {
            if (phi_v0->id == 0x293) {
                (arg0 + ((phi_v0->params & 0x7F) * 4))->unk208 = (void *) (phi_v0 + 0xB7);
            }
...
s32 func_80C149B0(GlobalContext *arg0, void *arg1) {
    ...
    sp64 = (f32) arg1->unk0->unk4 - temp_f20;
    sp68 = (f32) arg1->unk0->unk0 - temp_f22;
    sp5C = (f32) arg1->unk0->unkA - temp_f20;
    sp60 = (f32) arg1->unk0->unk6 - temp_f22;
    temp_s3 = func_80C14960((bitwise s32) temp_s4->unk0, temp_s4->unk4, temp_s5->unk0, temp_s5->unk4);
    phi_s0 = 1;
    phi_s2 = sp50 * 6;
loop_1:
    temp_s2 = phi_s2 + 6;
    ...
    phi_v0 = 0;
    phi_s0_2 = temp_s0;
    if (phi_s0 < (arg1->unk4 - 1)) {
        phi_v0 = temp_s0 * 6;
    } else {
        phi_s0_2 = 0;
    }
    sp64 = (f32) (arg1->unk0 + temp_s2)->unk4 - temp_f20;
    sp68 = (f32) *(arg1->unk0 + temp_s2) - temp_f22;
    sp5C = (f32) (arg1->unk0 + phi_v0)->unk4 - temp_f20;
    sp60 = (f32) *(arg1->unk0 + phi_v0) - temp_f22;
    phi_s0 = phi_s0_2;
    if (func_80C14960((bitwise s32) temp_s4->unk0, temp_s4->unk4, temp_s5->unk0, temp_s5->unk4) != temp_s3) {
        sp58 = 0;
    } else if (phi_s0_2 != 0) {
        goto loop_1;
    }
...
s32 func_80C14BCC(Actor *arg0, GlobalContext *arg1) {
    ...
    phi_s0 = 0;
    phi_s3 = -1;
    if ((arg1->actorCtx.actorList[2].first->unk90 & 2) != 0) {
        do {
        ...
        if (phi_s3 == arg0->unk218) {
            Audio_PlayActorSound2(arg0, 0x4807U);
            temp_v1 = (arg0 + (phi_s3 * 4))->unk208;
            *temp_v1 |= 2;
            arg1->interfaceCtx.unk_25C = 1;
            return 1;
        }
        temp_v1_2 = temp_s0_2->unk208;
        temp_v0 = *temp_v1_2;
        if ((temp_v0 & 1) != 0) {
            Audio_PlayActorSound2(arg0, 0x4807U);
            temp_v1_3 = temp_s0_2->unk208;
            *temp_v1_3 |= 2;
            arg1->interfaceCtx.unk_25C = 1;
        } else {
            *temp_v1_2 = temp_v0 | 4;
...
void func_80C14D58(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v1 == 0) {
        ...
        arg0->unk2FA = (s16) (temp_v1 - 1);
        phi_v0 = arg0->unk2FA;
    }
    phi_v1 = arg0->unk2FA;
    if (phi_v0 == 0) {
        arg0->unk2FA = Rand_S16Offset(0x3C, 0x3C);
        phi_v1 = arg0->unk2FA;
    }
...
void EnJgameTsn_Update(EnJgameTsn *this, GlobalContext *globalCtx) {
    EnJgameTsn *this = (EnJgameTsn *) thisx;
...
void EnJgameTsn_Draw(EnJgameTsn *this, GlobalContext *globalCtx) {
    ...
    sp40 = sp40;
    sp38 = temp_v0;
    sp38->words.w1 = Lib_SegmentedToVirtual(*(&D_80C150A4 + (this->unk21C * 4)));
    temp_v0_2 = sp40->polyOpa.p;
    sp40->polyOpa.p = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xDB060024;
    sp34 = temp_v0_2;
    sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_80C150A4 + (this->unk21C * 4)));
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80C14E64, func_80C14EE4, (Actor *) this);
}
