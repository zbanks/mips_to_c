typedef struct BgDblueElevator {
    ...
    /* 0x160 */ char pad_160[0x8];                  /* maybe part of actionFunc[3]? */
    /* 0x168 */ s8 unk_168;                         /* inferred */
    /* 0x169 */ s8 unk_169;                         /* inferred */
    /* 0x16A */ char pad_16A[0x6];                  /* maybe part of unk_169[7]? */
...
void func_80B91F20(BgDblueElevator *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_16B = func_800C9EBC(arg1, arg1 + 0x830, arg0->actor.world.pos.x, arg0->actor.world.pos.z, arg0 + 0x16C, &sp30, &sp2C);
}
...
void func_80B91F74(void *arg0, GlobalContext *arg1) {
    ...
    phi_s7 = &D_80B929D0;
    do {
        temp_v1 = phi_s6->unk_0;
        temp_v0 = phi_s7->unk_0;
        sp98 = (f32) (phi_s6->unk_2 - temp_v1);
        phi_s0 = 0;
loop_2:
        temp_f0 = (f32) phi_s0;
        spB0 = (temp_f0 * (f32) (phi_s7->unk_2 - temp_v0) * 0.14285715f) + (f32) temp_v0;
        spB4 = arg0->unk_16C;
    ...
    phi_s0_2 = D_80B929E0;
    do {
        spB0 = ((Rand_ZeroOne() - 0.5f) * 60.0f) + arg0->unk_24;
        spB4 = arg0->unk_16C;
        spB8 = ((Rand_ZeroOne() - 0.5f) * 60.0f) + arg0->unk_2C;
    ...
    do {
        ...
        spB0 = (phi_f20 * 100.0f) + arg0->unk_24;
        spB4 = arg0->unk_16C;
        ...
        spB8 = (phi_f20_2 * 100.0f) + arg0->unk_2C;
...
? func_80B922C0(void *arg0, GlobalContext *arg1) {
    if (Flags_GetSwitch(arg1, arg0->unk_1C & 0x7F) != 0) {
        return 0;
    }
    return 1;
}
...
s32 func_80B922FC(void *arg0, GlobalContext *arg1) {
    ...
    phi_s0 = phi_s0_2;
    if ((Flags_GetSwitch(arg1, (arg0->unk_1C + 1) & 0x7F) != 0) && (Flags_GetSwitch(arg1, (arg0->unk_1C + 2) & 0x7F) != 0) && (Flags_GetSwitch(arg1, (arg0->unk_1C + 3) & 0x7F) != 0)) {
        phi_s0 = phi_s0_2 + 2;
    }
    return phi_s0;
}
...
void BgDblueElevator_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp20 = temp_v1;
    temp_v0 = temp_v1->unk_4(this, globalCtx);
    if (temp_v0 == 2) {
        this->unk_168 = (s8) -(s32) temp_v1->unk_D;
    } else {
        this->unk_168 = temp_v1->unk_D;
    }
    sp24 = temp_v0;
...
void func_80B9257C(GlobalContext *arg0) {
    ...
    arg0->unk_16A = (s8) *(&D_80B9296C + ((((s32) arg0->unk_1C >> 8) & 3) * 0x1C));
}
...
void func_80B92660(GlobalContext *arg0, GlobalContext *arg1) {
    ...
    temp_t6 = (((s32) arg0->unk_1C >> 8) & 3) * 0x1C;
    temp_v1 = temp_t6 + &D_80B92960;
    sp30 = temp_v1;
    temp_v0 = temp_v1->unk_4(arg0, arg1);
    if ((temp_v0 == 0) || (temp_v0 == 3)) {
        sp30 = temp_v1;
        sp58 = Math_StepToF(arg0 + 0x160, 0.0f, temp_v1->unk_14);
    } else {
        sp58 = 0;
        sp30 = temp_v1;
        Math_StepToF(arg0 + 0x160, temp_v1->unk_18, temp_v1->unk_10);
    }
    if ((s32) arg0->unk_168 > 0) {
        phi_f12 = (temp_t6 + &D_80B92960)->unk_8;
    } else {
        phi_f12 = -(temp_t6 + &D_80B92960)->unk_8;
    }
    ...
    if ((temp_t6 + &D_80B92960)->unk_0 == 0) {
        arg0->unk_28 = (f32) (arg0->view.viewing.m[0][3] + arg0->state.nextGameStateInit);
        if (((arg0->state.main & 0x40) == 0x40) && (arg0->unk_16B != 0)) {
            if ((s32) arg0->unk_168 > 0) {
                temp_f0_2 = arg0->view.viewing.m[1][1];
                phi_f2_2 = ((arg0->unk_28 + -10.0f) - temp_f0_2) * ((arg0->unk_10C + -10.0f) - temp_f0_2);
                phi_f12_2 = (bitwise void *) -10.0f;
            } else {
                temp_f0_3 = arg0->view.viewing.m[1][1];
                phi_f2_2 = ((arg0->unk_28 + -30.0f) - temp_f0_3) * ((arg0->unk_10C + -30.0f) - temp_f0_3);
    ...
    if (sp5C != 0) {
        arg0->unk_168 = (s8) -(s32) arg0->unk_168;
        func_80B9257C(arg0);
    }
}
