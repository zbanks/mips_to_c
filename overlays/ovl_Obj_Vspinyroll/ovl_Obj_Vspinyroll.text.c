typedef struct ObjVspinyroll {
    ...
    /* 0x1A8 */ char pad_1A8[0x1E8];                /* maybe part of unk_15C[7]? */
    /* 0x390 */ void (*actionFunc)(ObjVspinyroll *, GlobalContext *);
    /* 0x394 */ f32 unk_394;                        /* inferred */
    /* 0x398 */ char pad_398[0x4];
    /* 0x39C */ Vec3f unk_39C;                      /* inferred */
    /* 0x3A8 */ Vec3f unk_3A8;                      /* inferred */
    /* 0x3B4 */ char pad_3B4[0xC];
...
struct _mips2c_stack_func_80A3D2C0 {
    ...
    /* 0x24 */ char pad_24[0x18];                   /* maybe part of sp20[7]? */
...
void func_80A3C560(ObjVspinyroll *arg0) {
    ...
    temp_a2 = temp_s0;
    temp_a0 = temp_a3 + ((temp_a3->unk_398 ^ 1) * 0xC) + 0x39C;
    sp20 = temp_a0;
    arg0 = temp_a3;
    Math_Vec3f_Diff(temp_a0, temp_a3 + 0x24, temp_a2);
    temp_f0 = Math3D_Vec3fMagnitude(temp_s0);
    phi_f2 = temp_f0;
    if ((temp_f0 < 0.01f) && (Math_Vec3f_Diff(sp20, arg0 + (arg0->unk_398 * 0xC) + 0x39C, temp_s0), temp_f0_2 = Math3D_Vec3fMagnitude(temp_s0), phi_f2 = temp_f0_2, (temp_f0_2 < 0.01f))) {
...
void func_80A3C658(void *arg0) {
    ...
    temp_a2 = arg0;
    temp_t6 = temp_a2->unk_398;
    arg0 = temp_a2;
    arg0->unk_32 = Math_Vec3f_Yaw(temp_a2 + 0x24, temp_a2 + ((temp_t6 ^ 1) * 0xC) + 0x39C);
}
...
s32 func_80A3C700(ObjVspinyroll *arg0) {
    ...
    sp30 = arg0->unk_398 ^ 1;
    temp_f0 = arg0->unk_394;
    Math_StepToF(arg0 + 0x70, temp_f0, temp_f0 * 0.2f);
    temp_f2 = arg0->actor.speedXZ;
    arg0->actor.world.pos.x += temp_f2 * arg0->unk_3B4;
    arg0->actor.world.pos.y += temp_f2 * arg0->unk_3B8;
    arg0->actor.world.pos.z += temp_f2 * arg0->unk_3BC;
...
void func_80A3C7E8(ObjVspinyroll *arg0) {
    ...
    if (temp_a1 > 0) {
        do {
            temp_v1_2 = phi_a3 * 4;
            phi_v0->unk_1AC = phi_f2;
            phi_v0->unk_1A8 = *(&D_80A3D4C4 + temp_v1_2);
            temp_a3 = phi_a3 + 1;
            phi_v0->unk_1B0 = *(&D_80A3D4B4 + temp_v1_2);
            phi_a3 = temp_a3;
            if (temp_a3 >= 4) {
...
DynaPolyActor *func_80A3CBF0(ObjVspinyroll *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 0) {
        return BgCheck_GetActorOfMesh(arg1 + 0x830, temp_v0->unk_10);
    }
    return NULL;
}
...
void func_80A3CF10(ObjVspinyroll *arg0) {
    ...
    arg0->unk_3C8 = *(&D_80A3D478 + ((((s32) arg0->actor.params >> 0xA) & 7) * 2));
    arg0->actor.speedXZ = 0.0f;
}
...
void func_80A3CF4C(ObjVspinyroll *this, GlobalContext *globalCtx) {
    ...
    temp_a3 = this;
    temp_a2 = temp_a3->unk_3C4;
    this = temp_a3;
    if (Math_ScaledStepToS(&temp_a3->unk_3C0, 0, temp_a2) != 0) {
        temp_v0 = this->unk_3C8;
        if ((s32) temp_v0 > 0) {
            this->unk_3C8 = temp_v0 - 1;
            if ((s32) this->unk_3C8 <= 0) {
                func_80A3CFAC(this);
            }
        }
    }
...
void func_80A3CFAC(ObjVspinyroll *arg0) {
    ...
    arg0->unk_3C2 = *(&D_80A3D4DC + (arg0->unk_398 * 2));
    arg0->actor.speedXZ = 0.0f;
}
...
void func_80A3CFE0(ObjVspinyroll *this, GlobalContext *globalCtx) {
    ...
    temp_a3 = this;
    temp_a1 = temp_a3->unk_3C2;
    this = temp_a3;
    if (Math_ScaledStepToS(&temp_a3->unk_3C0, temp_a1, 0x6E) != 0) {
        func_80A3D024(this);
    }
}
...
void ObjVspinyroll_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SysMatrix_InsertXRotation_s((s16) (this->actor.shape.rot.x + this->unk_3C6), 1);
...
void func_80A3D2C0(Actor *this, GlobalContext *globalCtx) {
    ...
    sp3C = this->shape.rot.x + this->unk_3C6;
    temp_s1 = temp_a0;
