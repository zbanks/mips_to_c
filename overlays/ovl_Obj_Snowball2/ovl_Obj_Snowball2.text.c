typedef struct ObjSnowball2 {
    ...
    /* 0x1A4 */ void (*actionFunc)(ObjSnowball2 *, GlobalContext *);
    /* 0x1A8 */ char pad_1A8[0x7];                  /* maybe part of actionFunc[2]? */
    /* 0x1AF */ s8 unk_1AF;                         /* inferred */
    /* 0x1B0 */ char pad_1B0[0x4];                  /* maybe part of unk_1AF[5]? */
} ObjSnowball2;                                     /* size = 0x1B4 */

struct _mips2c_stack_ObjSnowball2_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjSnowball2_Draw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_ObjSnowball2_Init {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ ColliderJntSph *sp28;                /* inferred */
    /* 0x2C */ char pad_2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_ObjSnowball2_Update {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B38E20 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B38E88 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B38EFC {
...
struct _mips2c_stack_func_80B39108 {
    /* 0x000 */ char pad_0[0xC8];
    ...
    /* 0x0E8 */ char pad_E8[0x18];
};                                                  /* size = 0x100 */

struct _mips2c_stack_func_80B39470 {
...
struct _mips2c_stack_func_80B395C4 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80B395EC {
    /* 0x00 */ char pad_0[0x18];
...
struct _mips2c_stack_func_80B39638 {
...
struct _mips2c_stack_func_80B39834 {
    /* 0x00 */ char pad_0[0x60];
};                                                  /* size = 0x60 */

struct _mips2c_stack_func_80B39908 {
...
struct _mips2c_stack_func_80B39B28 {};              /* size 0x0 */

struct _mips2c_stack_func_80B39B5C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B39C78 {};              /* size 0x0 */

struct _mips2c_stack_func_80B39C9C {
    /* 0x00 */ char pad_0[0x28];
...
struct _mips2c_stack_func_80B39F60 {};              /* size 0x0 */

struct _mips2c_stack_func_80B39FA8 {
...
struct _mips2c_stack_func_80B3A0D8 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80B3A13C {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ Actor *sp28;                         /* inferred */
    /* 0x2C */ CollisionCheckContext *sp2C;         /* inferred */
...
struct _mips2c_stack_func_80B3A498 {};              /* size 0x0 */

struct _mips2c_stack_func_80B3A500 {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ f32 sp20;                            /* inferred */
...
static InitChainEntry D_80B3A93C[9];                /* unable to generate initializer */
...
void func_80B39638(GlobalContext *arg0, void *arg1) {
    ...
    do {
        ...
        sp98 = arg1->unk_0 + (temp_f22 * 5.0f);
        sp9C = arg1->unk_4 + (temp_f24 * 25.0f);
        sp8C = temp_f22 * 1.55f;
        temp_f6 = temp_f2 * 1.55f;
        sp90 = temp_f24 * -0.7f;
        spA0 = arg1->unk_8 + (temp_f2 * 5.0f);
        sp94 = temp_f6;
        sp80 = sp8C * -0.02f;
        sp84 = sp90 * -0.025f;
        sp88 = temp_f6 * -0.02f;
...
void func_80B39B28(Actor *arg0, GlobalContext *arg1) {
    if ((arg0->unk_1AE == 0) && (arg0->unk_1AF != arg1->roomCtx.currRoom.num)) {
        arg0->unk_1AE = 1;
    }
}
...
void ObjSnowball2_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain((Actor *) this, D_80B3A93C);
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80B3A904, &this->unk_164);
    func_80B38E20(this);
...
void func_80B39C9C(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v1 != 0) && ((*arg0->unk_160->unk_24 & 0x583FFBC) != 0)) {
        func_80B38E88(arg0, arg1);
    ...
    if ((temp_v1 != 0) && ((*arg0->unk_160->unk_24 & 2) != 0)) {
...
void func_80B3A13C(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_154;
    temp_v1 = (temp_v0 & 2) != 0;
    temp_a2 = (arg0->unk_156 & 2) != 0;
    if (temp_v1 != 0) {
        arg0->unk_154 = (u8) (temp_v0 & 0xFFFD);
    }
    if (temp_a2 != 0) {
        arg0->unk_156 = (u8) (arg0->unk_156 & 0xFFFD);
    }
    temp_v0_2 = arg0->unk_1AC;
    if ((s32) temp_v0_2 > 0) {
        arg0->unk_1AC = (s8) (temp_v0_2 - 1);
    }
    sp38 = temp_v1;
    sp34 = temp_a2;
    func_80B39B28(arg0, arg1, temp_a2);
    temp_v0_3 = arg0->bgCheckFlags;
    if (((((temp_v0_3 & 9) != 0) || (temp_v1 != 0)) && ((temp_v0_3 & 0x20) == 0)) || ((s32) arg0->unk_1AC <= 0)) {
        func_80B38E88(arg0, arg1);
        func_80B39108(arg0, arg1);
        func_80B39B5C(arg0, arg1);
        Actor_MarkForDeath(arg0);
    ...
    if ((temp_v0_3 & 0x60) != 0) {
        ...
        arg0->unk_1A8 = (s16) ((s32) arg0->unk_1A8 >> 1);
        arg0->unk_1AA = (s16) ((s32) arg0->unk_1AA >> 1);
        if (sp34 != 0) {
            arg0->speedXZ *= 0.8f;
        } else {
            arg0->speedXZ *= 0.65f;
...
void func_80B3A500(Actor *arg0, Actor *arg1) {
    ...
    if ((s32) temp_v0 < 0x14) {
        ...
        if (((s32) arg0->unk_1AC >= 6) && (phi_f14 < phi_f12)) {
