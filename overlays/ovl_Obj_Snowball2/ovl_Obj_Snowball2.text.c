typedef struct ObjSnowball2 {
    ...
    /* 0x1A8 */ char pad1A8[0x7];                   /* maybe part of actionFunc[2]? */
    /* 0x1AF */ s8 unk1AF;                          /* inferred */
    /* 0x1B0 */ char pad1B0[0x4];                   /* maybe part of unk1AF[5]? */
...
void ObjSnowball2_Init(ObjSnowball2 *this, GlobalContext *globalCtx) {
    ColliderJntSph *sp28;
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_80B3A904, &this->unk164);
    func_80B38E20(this);
...
void ObjSnowball2_Destroy(ObjSnowball2 *this, GlobalContext *globalCtx) {
    ObjSnowball2 *this = (ObjSnowball2 *) thisx;
...
void ObjSnowball2_Update(ObjSnowball2 *this, GlobalContext *globalCtx) {
    f32 temp_f0;
    ObjSnowball2 *this = (ObjSnowball2 *) thisx;
...
void ObjSnowball2_Draw(ObjSnowball2 *this, GlobalContext *globalCtx) {
    ObjSnowball2 *this = (ObjSnowball2 *) thisx;
