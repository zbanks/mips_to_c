...
typedef struct EnTanron3 {
    ...
    /* 0x0248 */ char pad248[0x8];                  /* maybe part of unk244[3]? */
    /* 0x0250 */ s32 unk250;                        /* inferred */
    /* 0x0254 */ char pad254[0xC];                  /* maybe part of unk250[4]? */
    /* 0x0260 */ ColliderCylinder unk260;           /* inferred */
    /* 0x02AC */ ColliderCylinder unk2AC;           /* inferred */
    /* 0x02F8 */ void (*actionFunc)(EnTanron3 *, GlobalContext *);
...
void EnTanron3_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk260, &this->actor, &D_80BB9750);
    Collider_InitAndSetCylinder(globalCtx, &this->unk2AC, &this->actor, &D_80BB9750);
...
void func_80BB87D4(Actor *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        EffectSsDtBubble_SpawnCustomColor(arg1, arg0 + 0x24, &sp98, (Vec3f *) temp_s4, &D_80BB97A8, &D_80BB97AC, (s16) (s32) (temp_f20 + 70.0f), (s16) (s32) (Rand_ZeroFloat(5.0f) + 15.0f), (s16) 0);
        temp_s0 = phi_s0 + 1;
        phi_s0 = temp_s0;
    } while (temp_s0 != 0x14);
}
...
void func_80BB8A48(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->world.pos.y < temp_f0) {
        ...
        Math_ApproachS(&arg0->world.rot.x, Math_FAtan2F(sqrtf((temp_f18 * temp_f18) + (sp50 * sp50)), -sp54), arg0->unk238, arg0->unk234);
        ...
        if (temp_v0_2 != 0) {
            if (temp_v0_2 != 1) {
                ...
                Math_ApproachS(&arg0->shape.rot.x, arg0->unk248, 3, 0xC00);
            ...
            Math_ApproachS(&arg0->world.rot.x, 0x3000, 5, 0xBD0);
...
void func_80BB9288(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk204 == 0) {
        ...
        if (Rand_ZeroOne() < 0.3f) {
            Item_DropCollectibleRandom(arg1, NULL, &arg0->world.pos, 0x60);
        }
    }
}
...
void EnTanron3_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (gGameInfo->data[1311] == 0) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 10.0f, 10.0f, 20.0f, 5U);
    ...
    func_80BB9308(&this->actor, globalCtx);
    temp_a1 = &this->unk260;
    sp2C = temp_a1;
    ...
    if (((s32) (s8) D_80BB972C->colChkInfo.health <= 0) && (func_80BB9288 != this->actionFunc)) {
        func_80BB91D4(&this->actor, globalCtx);
        this->unk204 = 0;
    }
}
...
void EnTanron3_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BB95FC, NULL, &this->actor);
