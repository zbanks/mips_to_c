...
typedef struct EnCow {
    ...
    /* 0x01DC */ SkelAnime unk1DC;                  /* inferred */
    /* 0x0220 */ Vec3s unk220;                      /* inferred */
    /* 0x0226 */ char pad226[0x1E];                 /* maybe part of unk220[6]? */
    /* 0x0244 */ Vec3s unk244;                      /* inferred */
    /* 0x024A */ char pad24A[0x1E];                 /* maybe part of unk244[6]? */
    /* 0x0268 */ s16 unk268;                        /* inferred */
    /* 0x026A */ s16 unk26A;                        /* inferred */
    /* 0x026C */ char pad26C[0x2];                  /* maybe part of unk26A[2]? */
    /* 0x026E */ u16 unk26E;                        /* inferred */
    /* 0x0270 */ u16 unk270;                        /* inferred */
    /* 0x0272 */ u16 unk272;                        /* inferred */
    /* 0x0274 */ void (*actionFunc)(EnCow *, GlobalContext *);
} EnCow;                                            /* size 0x278 */
...
void func_8099C290(f32 *arg0, s16 arg1) {
    ...
    sp20 = Math_CosS(arg1);
    sp24 = (Math_SinS(arg1) * arg0->unk8) + (sp20 * arg0->unk0);
    sp20 = Math_SinS(arg1);
    arg0->unk8 = (f32) ((Math_CosS(arg1) * arg0->unk8) + (-sp20 * arg0->unk0));
    arg0->unk0 = sp24;
}
...
void func_8099C328(EnCow *arg0) {
    ...
    arg0->unk144.dim.pos.x = (s16) (s32) (arg0->actor.world.pos.x + sp1C);
    arg0->unk144.dim.pos.z = (s16) (s32) (arg0->actor.world.pos.z + sp24);
    sp1C = 0.0f;
    sp20 = 0.0f;
    sp24 = -20.0f;
    func_8099C290(temp_a0, arg0->actor.shape.rot.y, arg0);
    arg0->unk190.dim.pos.y = (s16) (s32) arg0->actor.world.pos.y;
    arg0->unk190.dim.pos.x = (s16) (s32) (arg0->actor.world.pos.x + sp1C);
    arg0->unk190.dim.pos.z = (s16) (s32) (arg0->actor.world.pos.z + sp24);
}
...
void EnCow_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        ...
        temp_a1_2 = &this->unk1DC;
        sp40 = temp_a1_2;
        SkelAnime_InitSV(globalCtx, temp_a1_2, &D_06004C30, NULL, &this->unk220, &this->unk244, 6);
        ...
        func_8099C41C(this);
        this->actor.flags &= -2;
        this->unk270 = (u16) (u32) (Rand_ZeroFloat(1000.0f) + 40.0f);
        goto block_9;
    }
block_3:
    sp40 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_06004010, NULL, &this->unk220, &this->unk244, 6);
    SkelAnime_ChangeAnimDefaultRepeat(sp40, &D_060001CC);
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, &this->actor, &D_8099D610);
    Collider_InitAndSetCylinder(globalCtx, &this->unk190, &this->actor, &D_8099D610);
    func_8099C328(this);
    ...
    Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, 0xF3, this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z, (s16) 0, (s16) (s32) this->actor.shape.rot.y, (s16) 0, 1);
    this->unk270 = (u16) (u32) (Rand_ZeroFloat(1000.0f) + 40.0f);
    this->unk272 = 0;
...
void func_8099C880(EnCow *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk270;
    if ((s32) temp_v0 > 0) {
        arg0->unk270 = temp_v0 - 1;
    } else {
        arg0->unk270 = (u16) (u32) (Rand_ZeroFloat(500.0f) + 40.0f);
        SkelAnime_ChangeAnim(arg0 + 0x1DC, &D_060001CC, 1.0f, arg0->unk1DC.animCurrentFrame, (f32) SkelAnime_GetFrameCount(&D_060001CC.common), (u8) 2, 1.0f);
    }
    if (arg0->actor.xzDistToPlayer < 150.0f) {
        temp_v0_2 = arg0->unk26E;
        if ((temp_v0_2 & 2) == 0) {
            arg0->unk26E = temp_v0_2 | 2;
            if (&D_060001CC == arg0->unk1DC.animCurrentSeg) {
                arg0->unk270 = 0;
            }
        }
    }
    temp_t5 = arg0->unk272 + 1;
...
void func_8099CB68(EnCow *this, GlobalContext *globalCtx) {
    ...
    func_800B8A1C(&this->actor, globalCtx, 0x92, 10000.0f, 100.0f);
}
...
void func_8099CCF8(EnCow *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        ...
        this = temp_a0;
        func_800B8614(&temp_a0->actor, globalCtx, 170.0f);
...
void func_8099CFAC(EnCow *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        this->unk270 = (u16) (u32) (Rand_ZeroFloat(200.0f) + 40.0f);
        SkelAnime_ChangeAnim(&this->unk1DC, &D_06004348, 1.0f, this->unk1DC.animCurrentFrame, (f32) SkelAnime_GetFrameCount(&D_06004348.common), (u8) 2, 1.0f);
    }
    if (this->actor.xzDistToPlayer < 150.0f) {
        temp_v0_2 = this->actor.yawTowardsPlayer - this->actor.shape.rot.y;
        phi_v1 = (s32) temp_v0_2;
        ...
        if (phi_v1 >= 0x61A9) {
            ...
            if ((temp_v0_3 & 2) == 0) {
                this->unk26E = temp_v0_3 | 2;
                if (&D_06004348 == this->unk1DC.animCurrentSeg) {
                    this->unk270 = 0;
                }
            }
        }
...
void EnCow_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    globalCtx = temp_a3;
    sp40 = temp_t6;
    CollisionCheck_SetOC(temp_a3, temp_a1, &this->unk144.base);
    CollisionCheck_SetOC(globalCtx, temp_a1, &this->unk190.base);
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        if (&D_060001CC == this->unk1DC.animCurrentSeg) {
            Audio_PlayActorSound2(&this->actor, 0x28DFU);
            ...
            SkelAnime_ChangeAnim((SkelAnime *) sp34, &D_060001CC, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(&D_060001CC.common), (u8) 0, 1.0f);
        }
    }
    ...
    if (this->actor.xzDistToPlayer < 150.0f) {
        ...
        sp30 = temp_a1_2;
        if (Math_Vec3f_Yaw(&temp_a0_2->pos, &temp_a1_2->pos) < 0) {
            phi_v1 = -Math_Vec3f_Yaw(&temp_a0_2->pos, &temp_a1_2->pos);
        } else {
            phi_v1 = Math_Vec3f_Yaw(&temp_a0_2->pos, &temp_a1_2->pos);
        }
        if (phi_v1 < 0xC000) {
            ...
            sp46 = Math_Vec3f_Pitch(&temp_a0_3->pos, &temp_a1_3->pos);
            temp_v1 = Math_Vec3f_Yaw(&temp_a0_3->pos, &temp_a1_3->pos) - this->actor.shape.rot.y;
            phi_v1_2 = temp_v1;
            phi_a1 = sp46;
            if ((s32) sp46 >= 0x1001) {
                phi_a1 = 0x1000;
...
block_18:
    ...
    Math_SmoothStepToS(&this->unk268, phi_a1, 0xA, 0xC8, (s16) 0xA);
    Math_SmoothStepToS(&this->unk26A, sp44, 0xA, 0xC8, (s16) 0xA);
}
...
void func_8099D3C0(Actor *this, GlobalContext *globalCtx) {
    ...
    sp30 = temp_a0;
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        if (&D_06004348 == this->unk1E4) {
            SkelAnime_ChangeAnim(sp30, (AnimationHeader *) &D_06004E98, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(&D_06004E98), (u8) 2, 1.0f);
            this->unk274(this, globalCtx);
            return;
        }
        SkelAnime_ChangeAnim(sp30, &D_06004348, 1.0f, 0.0f, (f32) SkelAnime_GetFrameCount(&D_06004348.common), (u8) 0, 1.0f);
...
void EnCow_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk1DC.skeleton, this->unk1DC.limbDrawTbl, (s32) this->unk1DC.dListCount, func_8099D4AC, func_8099D4FC, &this->actor);
}

void func_8099D59C(Actor *this, GlobalContext *globalCtx) {
    func_8012C5B0(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk1E0, this->unk1FC, (s32) this->unk1DE, NULL, NULL, this);
}
