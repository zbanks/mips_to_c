typedef struct EnCow {
    ...
    /* 0x226 */ char pad226[0x1E];                  /* maybe part of unk220[6]? */
    /* 0x244 */ Vec3s unk244;                       /* inferred */
    /* 0x24A */ char pad24A[0x1E];                  /* maybe part of unk244[6]? */
    /* 0x268 */ s16 unk268;                         /* inferred */
    /* 0x26A */ s16 unk26A;                         /* inferred */
    /* 0x26C */ char pad26C[0x2];
    /* 0x26E */ u16 unk26E;                         /* inferred */
    /* 0x270 */ u16 unk270;                         /* inferred */
...
block_3:
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, (Actor *) this, &D_8099D610);
    Collider_InitAndSetCylinder(globalCtx, &this->unk190, (Actor *) this, &D_8099D610);
    func_8099C328(this);
...
void func_8099C880(EnCow *arg0, GlobalContext *arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        SkelAnime_ChangeAnim(arg0 + 0x1DC, &D_060001CC, 1.0f, arg0->unk1DC.animCurrentFrame, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_060001CC), (u8) 2, 1.0f);
    }
...
void func_8099CFAC(EnCow *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 > 0) {
        ...
        SkelAnime_ChangeAnim(&this->unk1DC, &D_06004348, 1.0f, this->unk1DC.animCurrentFrame, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_06004348), (u8) 2, 1.0f);
    }
    if (this->actor.xzDistToPlayer < 150.0f) {
        temp_v0_2 = this->actor.yawTowardsPlayer - this->actor.shape.rot.y;
        phi_v1 = (s32) temp_v0_2;
...
void EnCow_Update(EnCow *this, GlobalContext *globalCtx) {
    ...
    globalCtx = temp_a3;
    sp40 = temp_t6;
    CollisionCheck_SetOC(temp_a3, temp_a1, (Collider *) &this->unk144);
    CollisionCheck_SetOC(globalCtx, temp_a1, (Collider *) &this->unk190);
...
void EnCow_Draw(EnCow *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk1DC.skeleton, this->unk1DC.limbDrawTbl, (s32) this->unk1DC.dListCount, func_8099D4AC, func_8099D4FC, (Actor *) this);
}
