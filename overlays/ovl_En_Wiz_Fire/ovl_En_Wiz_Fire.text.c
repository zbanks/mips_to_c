...
void func_80A4A11C(EnWizFire *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_16A != 0) {
        ...
        if (this->unk_166 == 1) {
            ...
            sp40.unk_4 = (s32) D_80A4C228.unk_4;
            sp40.unk_8 = (s32) D_80A4C228.unk_8;
...
void EnWizFire_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    do {
        ...
        temp_v1_5->unk_C = (s32) phi_a0->unk_0;
        temp_a0_4 = phi_a0 - 0xC;
        temp_v1_5->unk_10 = (s32) phi_a0->unk_4;
        temp_v1_5->unk_14 = (s32) temp_a0_4->unk_14;
        phi_a0 = temp_a0_4;
        phi_v1 = temp_v1_5;
        phi_v0 = temp_v0_3;
    } while (temp_v0_3 >= 0);
...
void func_80A4BAB4(Actor *this, GlobalContext *globalCtx) {
    ...
    temp_f0 = this->unk_14C;
    Matrix_Scale(temp_f0 + this->unk_154, temp_f0 + this->unk_158, temp_f0 + this->unk_15C, 1);
...
loop_1:
    ...
    if (phi_s0->unk_0 == 0) {
        ...
        phi_s0->unk_14 = (s32) arg1->unk_4;
        phi_s0->unk_18 = (s32) arg1->unk_8;
        phi_s0->unk_28 = (s32) arg2->unk_0;
        phi_s0->unk_2C = (s32) arg2->unk_4;
        phi_s0->unk_30 = (s32) arg2->unk_8;
