typedef struct EnWizFire {
    ...
    /* 0x0254 */ char pad254[0x28A0];               /* maybe part of unk208[137]? */
...
void EnWizFire_Init(EnWizFire *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    EnWizFire *this = (EnWizFire *) thisx;

    Collider_InitAndSetCylinder(globalCtx, &this->unk208, (Actor *) this, &D_80A4C1E4);
...
void EnWizFire_Destroy(EnWizFire *this, GlobalContext *globalCtx) {
    s16 temp_v1;
    EnWizFire *this = (EnWizFire *) thisx;
...
void func_80A4984C(EnWizFire *this, GlobalContext *globalCtx) {
    ...
    sp44.unk0 = (s32) D_80A4C210.unk0;
    temp_v0 = &this->actor.world;
    sp44.unk4 = (s32) D_80A4C210.unk4;
    sp44.unk8 = (s32) D_80A4C210.unk8;
...
void func_80A49A44(EnWizFire *this, GlobalContext *globalCtx) {
    ...
    sp54.unk0 = (s32) D_80A4C21C.unk0;
    sp54.unk4 = (s32) D_80A4C21C.unk4;
    sp54.unk8 = (s32) D_80A4C21C.unk8;
...
void EnWizFire_Update(EnWizFire *this, GlobalContext *globalCtx) {
    Actor *sp8C;
    f32 sp78;
    f32 sp74;
    f32 sp70;
...
void EnWizFire_Draw(EnWizFire *this, GlobalContext *globalCtx) {
    EnWizFire *sp58;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
...
loop_1:
    ...
    if (phi_s0->unk0 == 0) {
        ...
        phi_s0->unk10 = (s32) arg1->unk0;
        phi_s0->unk14 = (s32) arg1->unk4;
        phi_s0->unk18 = (s32) arg1->unk8;
