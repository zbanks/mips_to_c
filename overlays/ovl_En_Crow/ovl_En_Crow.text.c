typedef struct EnCrow {
    ...
    /* 0x200 */ ColliderJntSph unk200;              /* inferred */
    /* 0x220 */ ColliderJntSphElement unk220;       /* inferred */
    /* 0x260 */ Vec3f unk260;                       /* inferred */
    /* 0x26C */ char pad26C[0x24];                  /* maybe part of unk260[4]? */
...
void EnCrow_Init(EnCrow *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk200, (Actor *) this, &D_8099C094, &this->unk220);
...
void func_8099AC8C(EnCrow *this, GlobalContext *globalCtx) {
    ...
    if ((Math_SmoothStepToS((s16 *) temp_a0_2, this->unk190, 0xA, 0x100, (s16) 8) == 0) && (sp34 != 0) && (Rand_ZeroOne() < 0.1f)) {
...
void EnCrow_Update(EnCrow *this, GlobalContext *globalCtx) {
    ...
    if (func_8099B0CC == this->actionFunc) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk200);
    }
    if ((this->unk200.base.acFlags & 1) != 0) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk200);
    }
    if (sp2C != this->actionFunc) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk200);
    }
...
void EnCrow_Draw(EnCrow *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_8099BE48, func_8099BF20, (Actor *) this);
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk260, 4, this->actor.scale.x * 100.0f * this->unk294, this->unk298, this->unk290, (u8) (s32) this->unk18C);
}
