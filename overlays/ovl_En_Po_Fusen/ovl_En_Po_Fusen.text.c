...
void func_80AC158C(EnPoFusen *arg0, GlobalContext *arg1); /* static */
...
void func_80AC19DC(EnPoFusen *arg0, GlobalContext *arg1); /* static */
...
void EnPoFusen_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetSphere(globalCtx, temp_a1, &this->actor, &D_80AC1DA0);
...
void EnPoFusen_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->anime.skeleton, this->anime.limbDrawTbl, (s32) this->anime.dListCount, func_80AC1A68, func_80AC1CE8, func_80AC1D00, &this->actor);
}
