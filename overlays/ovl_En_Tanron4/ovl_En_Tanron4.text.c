typedef struct EnTanron4 {
    ...
    /* 0x146 */ char pad_146[0x14];                 /* maybe part of unk_144[11]? */
    /* 0x15A */ s16 unk_15A;                        /* inferred */
    /* 0x15C */ char pad_15C[0x4];                  /* maybe part of unk_15A[3]? */
    /* 0x160 */ f32 unk_160;                        /* inferred */
    /* 0x164 */ SkelAnime unk_164;                  /* inferred */
    /* 0x1A8 */ Vec3s unk_1A8;                      /* inferred */
    /* 0x1AE */ char pad_1AE[0x3C];                 /* maybe part of unk_1A8[11]? */
    /* 0x1EA */ Vec3s unk_1EA;                      /* inferred */
    /* 0x1F0 */ char pad_1F0[0x3C];                 /* maybe part of unk_1EA[11]? */
...
void EnTanron4_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_164, &D_06000E68, &D_06000168, &this->unk_1A8, &this->unk_1EA, 0xB);
    this->actor.flags &= -2;
    this->actor.speedXZ = (f32) gGameInfo->data[1296] + 3.0f;
    this->actor.uncullZoneForward = (f32) gGameInfo->data[1318] + 10000.0f;
    this->unk_144 = (s16) (s32) Rand_ZeroFloat(10.0f);
...
void func_80BE3DFC(EnTanron4 *arg0, GlobalContext *arg1) {
    ...
    sp44 = arg0->unk_14C - arg0->actor.world.pos.x;
    sp40 = (arg0->unk_150 + arg0->unk_160) - arg0->actor.world.pos.y;
    temp_f10 = arg0->actor.world.pos.z;
    temp_f8 = arg0->unk_154;
    temp_f14 = temp_f8 - temp_f10;
    temp_f0 = sqrtf((sp44 * sp44) + (temp_f14 * temp_f14));
    sp38 = temp_f0;
    if ((arg0->unk_148 == 0) || (temp_f0 < 100.0f)) {
        sp3C = temp_f14;
        arg0->unk_14C = randPlusMinusPoint5Scaled(500.0f) + arg0->actor.home.pos.x;
        arg0->unk_150 = randPlusMinusPoint5Scaled(100.0f) + arg0->actor.home.pos.y;
        arg0->unk_154 = randPlusMinusPoint5Scaled(500.0f) + arg0->actor.home.pos.z;
        temp_f0_2 = Rand_ZeroFloat(100.0f);
        arg0->unk_158 = 0;
        arg0->unk_148 = (s16) (s32) (temp_f0_2 + 60.0f);
    }
    sp34 = Math_Atan2S(sp44, temp_f8 - temp_f10);
    sp36 = Math_Atan2S(sp40, sp38);
    temp_v0_2 = Math_SmoothStepToS(arg0 + 0x32, sp34, 0xA, arg0->unk_158, (s16) 0);
    ...
    sp32 = phi_v1;
    Math_ApproachS(arg0 + 0x30, sp36, 0xA, arg0->unk_158);
    Math_ApproachS(arg0 + 0x34, (s16) ((s32) phi_v1 * -1), 0xA, arg0->unk_158);
    Math_ApproachS(arg0 + 0x158, 0x200, 1, 0x10);
    temp_a0 = arg0 + 0x164;
    sp28 = temp_a0;
    SkelAnime_FrameUpdateMatrix(temp_a0);
    temp_v1 = arg0->unk_14A;
    if (temp_v1 != 0) {
        if (temp_v1 != 1) {

        } else {
            if (((arg0->unk_144 & 7) == 0) && (Rand_ZeroOne() < 0.5f)) {
                arg0->unk_15C = (s16) (s32) randPlusMinusPoint5Scaled((f32) gGameInfo->data[1292] + 3000.0f);
            }
            if (arg0->unk_146 == 0) {
                arg0->unk_14A = 0;
                arg0->unk_146 = (s16) (s32) (Rand_ZeroFloat(50.0f) + 70.0f);
                SkelAnime_ChangeAnimTransitionRepeat(sp28, &D_06000168, (f32) gGameInfo->data[1291] + -10.0f);
                arg0->unk_164.animCurrentFrame = (f32) gGameInfo->data[1290] + 2.0f;
            }
        }
    } else if ((arg0->unk_146 == 0) && (func_801378B8(sp28, (f32) gGameInfo->data[1290] + 2.0f) != 0)) {
        arg0->unk_14A = 1;
        arg0->unk_146 = (s16) (s32) (Rand_ZeroFloat(50.0f) + 50.0f);
        SkelAnime_ChangeAnimTransitionRepeat(sp28, &D_06000168, (f32) gGameInfo->data[1291] + -15.0f);
        arg0->unk_164.animPlaybackSpeed = 0.0f;
        arg0->unk_164.animCurrentFrame = (f32) gGameInfo->data[1290] + 2.0f;
    }
    ...
    Math_ApproachS(arg0 + 0x15A, arg0->unk_15C, 3, (s16) (gGameInfo->data[1293] + 0x3E8));
}
...
void func_80BE42A4(EnTanron4 *arg0, GlobalContext *arg1) {
    ...
    temp_f8 = arg0->unk_14C - arg0->actor.world.pos.x;
    sp4C = temp_f8;
    sp48 = arg0->unk_150 - arg0->actor.world.pos.y;
    temp_f6 = arg0->actor.world.pos.z;
    temp_f4 = arg0->unk_154;
    temp_f14 = temp_f4 - temp_f6;
    temp_f0 = sqrtf((temp_f8 * temp_f8) + (temp_f14 * temp_f14));
    sp40 = temp_f0;
    if ((arg0->unk_148 == 0) || (temp_f0 < 100.0f)) {
        sp44 = temp_f14;
        arg0->unk_14C = randPlusMinusPoint5Scaled((f32) gGameInfo->data[1330] + 200.0f) + sp34->world.pos.x;
        arg0->unk_150 = randPlusMinusPoint5Scaled((f32) gGameInfo->data[1329] + 100.0f) + (sp34->world.pos.y + (f32) gGameInfo->data[1328] + 100.0f);
        arg0->unk_154 = randPlusMinusPoint5Scaled((f32) gGameInfo->data[1330] + 200.0f) + sp34->world.pos.z;
        temp_f0_2 = Rand_ZeroFloat(100.0f);
        arg0->unk_158 = 0;
        arg0->unk_148 = (s16) (s32) (temp_f0_2 + 60.0f);
    }
    ...
    temp_v0 = Math_SmoothStepToS(arg0 + 0x32, sp3C, 0xA, arg0->unk_158, (s16) 0);
    phi_v1 = (s16) temp_v0;
    if (temp_v0 >= 0x1001) {
        phi_v1 = 0x1000;
    ...
    sp3A = phi_v1;
    Math_ApproachS(arg0 + 0x30, sp3E, 0xA, arg0->unk_158);
    Math_ApproachS(arg0 + 0x34, (s16) ((s32) phi_v1 * -1), 0xA, arg0->unk_158);
    Math_ApproachS(arg0 + 0x158, 0x200, 1, 0x10);
    temp_a0 = arg0 + 0x164;
    sp2C = temp_a0;
    ...
    } else if ((arg0->unk_146 == 0) && (func_801378B8(sp2C, (f32) gGameInfo->data[1290] + 2.0f) != 0)) {
        arg0->unk_14A = 1;
        arg0->unk_146 = (s16) (s32) (Rand_ZeroFloat(50.0f) + 50.0f);
...
void EnTanron4_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (gGameInfo->data[1311] == 0) {
        ...
        phi_v0 = this;
        do {
            temp_a0 = phi_v0->unk_146;
            temp_v1 = phi_v1 + 2;
            phi_v1 = temp_v1;
            if (temp_a0 != 0) {
                phi_v0->unk_146 = temp_a0 - 1;
            }
            phi_v0 += 2;
        } while (temp_v1 != 4);
...
void EnTanron4_Draw(Actor *thisx, GlobalContext *globalCtx) {
    EnTanron4 *this = (EnTanron4 *) thisx;
    if (this->unk_160 < 1400.0f) {
        SysMatrix_InsertZRotation_s(this->unk_15A, 1);
        SkelAnime_DrawSV(globalCtx, this->unk_164.skeleton, this->unk_164.limbDrawTbl, (s32) this->unk_164.dListCount, NULL, NULL, (Actor *) this);
    }
}
