struct _mips2c_stack_EnSyatekiMan_Destroy {};       /* size 0x0 */

struct _mips2c_stack_EnSyatekiMan_Draw {
...
struct _mips2c_stack_EnSyatekiMan_Init {
    /* 0x00 */ char pad_0[0x30];
...
struct _mips2c_stack_EnSyatekiMan_OverrideLimbDraw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnSyatekiMan_PostLimbDraw {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ ? sp18;                              /* inferred */
    /* 0x18 */ char pad_18[0x10];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnSyatekiMan_Update {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_809C64C0 {
    /* 0x00 */ char pad_0[0x50];
};                                                  /* size = 0x50 */

struct _mips2c_stack_func_809C6720 {
...
struct _mips2c_stack_func_809C6810 {};              /* size 0x0 */

struct _mips2c_stack_func_809C6848 {
    /* 0x00 */ char pad_0[0x22];
    /* 0x22 */ u16 sp22;                            /* inferred */
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C6A04 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ void *sp24;                          /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C6C2C {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ void *sp24;                          /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C6E30 {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ SkelAnime *sp18;                     /* inferred */
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809C6F98 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809C72D8 {
    /* 0x00 */ char pad_0[0x26];
    /* 0x26 */ u16 sp26;                            /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C7380 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ void *sp24;                          /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C7620 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ void *sp24;                          /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C7990 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809C7A90 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C7C14 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C7D14 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C7EB4 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C7FFC {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ Actor *sp24;                         /* inferred */
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_809C80C0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_809C81D0 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809C8488 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809C8610 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_809C8710 {
    /* 0x00 */ char pad_0[0x24];
    /* 0x24 */ ? sp24;                              /* inferred */
    /* 0x24 */ char pad_24[0xC];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_809C8808 {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ Actor *sp1C;                         /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809C898C {
    /* 0x00 */ char pad_0[0x20];
...
struct _mips2c_stack_func_809C8BF0 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_809C8DE8 {};              /* size 0x0 */
...
extern ? D_0600FB90;
extern ? D_06010390;
static ActorAnimationEntry D_809C9180[3] = {
...
void func_809C64C0(Actor *arg0, GlobalContext *arg1, void *arg2, s32 arg3) {
    ...
    if (arg3 > 0) {
        do {
            Actor_SpawnAsChild(arg1 + 0x1CA0, arg0, arg1, phi_s0->unk_0, phi_s0->unk_4, phi_s0->unk_8, phi_s0->unk_C, (s16) 0, (s16) 0, (s16) 0, phi_s0->unk_10);
            temp_s0 = phi_s0 + 0x14;
            phi_s0 = temp_s0;
...
void EnSyatekiMan_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (globalCtx->sceneNum == 0x24) {
        this->path = sp34;
        func_809C64C0((Actor *) this, globalCtx, *(&D_809C9464 + (0 * 4)), sp30);
    }
}
...
void func_809C6848(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0((Actor *) this, temp_a3) != 0) {
        ...
        } else if (sp24->unk_14B == 4) {
            if (this->unk_282 == 0) {
                this->unk_282 = 1;
                func_801518B0(globalCtx, 0xA28U, (Actor *) this);
                this->unk_284 = 0xA28;
            } else {
                func_801518B0(globalCtx, 0xA29U, (Actor *) this);
                this->unk_284 = 0xA29;
            }
        } else {
            ...
            if (temp_hi != 1) {
                if (temp_hi != 2) {
                    if (temp_hi != 3) {
                        ...
                        func_801518B0(globalCtx, 0xA3AU, (Actor *) this);
                        this->unk_284 = 0xA3A;
                    }
                } else {
                    func_801518B0(globalCtx, 0xA39U, (Actor *) this);
                    this->unk_284 = 0xA39;
                }
            } else {
                func_801518B0(globalCtx, 0xA38U, (Actor *) this);
                this->unk_284 = 0xA38;
            }
        }
...
void func_809C6E30(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = temp_v1->unk_A6C;
    if ((temp_v0 & 0x20) != 0) {
        temp_v1->unk_A6C = (s32) (temp_v0 | 0x20);
    }
    sp1C = temp_v1;
    this = this;
...
block_9:
    ...
    case 4:
        temp_a0 = temp_a2;
        this = temp_a2;
        func_809C6A04((Actor *) temp_a0, globalCtx, temp_a2);
        phi_a2_2 = this;
        break;
    case 5:
        this = temp_a2;
        func_809C6C2C((Actor *) temp_a2, globalCtx, temp_a2);
        phi_a2_2 = this;
        break;
    case 6:
        temp_a0_2 = globalCtx;
...
void func_809C6F98(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 1) {
        if (temp_v0 != 2) {
            ...
            temp_v0_5 = arg0->unk_282;
            if ((temp_v0_5 & 2) == 0) {
                arg0->unk_282 = (s16) (temp_v0_5 | 2);
        ...
        if (((s32) gSaveContext.day % 5) != 3) {
            temp_v0_6 = arg0->unk_282;
            if ((temp_v0_6 & 8) == 0) {
                arg0->unk_282 = (s16) (temp_v0_6 | 8);
        ...
        temp_v0_7 = arg0->unk_282;
        if ((temp_v0_7 & 8) == 0) {
            arg0->unk_282 = (s16) (temp_v0_7 | 8);
    ...
    if (((s32) gSaveContext.day % 5) != 3) {
        temp_v0_8 = arg0->unk_282;
        if ((temp_v0_8 & 4) == 0) {
            arg0->unk_282 = (s16) (temp_v0_8 | 4);
    ...
    temp_v0_9 = arg0->unk_282;
    if ((temp_v0_9 & 4) == 0) {
        arg0->unk_282 = (s16) (temp_v0_9 | 4);
        func_801518B0(arg1, 0x3F4U, arg0);
        arg0->unk_284 = 0x3F4;
        return;
    }
...
void func_809C72D8(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0((Actor *) this, temp_a1) != 0) {
        ...
        if (temp_v0 != 0) {
            sp26 = temp_a1_2;
            func_801518B0(globalCtx, temp_a1_2, (Actor *) this);
            this->unk_284 = (s16) temp_a1_2;
        } else {
            func_809C6F98((Actor *) this, globalCtx);
        }
...
void func_809C7380(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_80147624(temp_a3) != 0) {
        if (arg1->msgCtx.choiceIndex == 0) {
            ...
            func_8019F208();
            func_801159EC(-0x14);
            temp_v0 = arg0->unk_282;
            arg0->unk_26A = 2;
            if ((temp_v0 & 0x10) == 0) {
                arg0->unk_282 = (s16) (temp_v0 | 0x10);
...
block_9:
    ...
    default:
        return;
    case 4:
        func_809C7380((Actor *) this, globalCtx, this);
        return;
    case 5:
        func_809C7620((Actor *) this, globalCtx, this);
        return;
    case 6:
        sp1C = temp_v1;
        this = this;
...
void func_809C7A90(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v1_3 < 3U) && ((gSaveContext.weekEventReg[59] & 0x10) == 0)) {
        func_800B8A1C((Actor *) this, globalCtx, temp_v1_3 + 0x22, 500.0f, 100.0f);
    } else if ((s32) this->unk_280 < 0x884) {
        func_800B8A1C((Actor *) this, globalCtx, 4, 500.0f, 100.0f);
...
void func_809C7C14(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0((Actor *) this, globalCtx) != 0) {
        if ((((s32) gSaveContext.day % 5) == 3) && ((s32) gSaveContext.time >= 0x8001)) {
            func_801518B0(globalCtx, 0xA36U, (Actor *) this);
            this->unk_284 = 0xA36;
        } else {
            func_801518B0(globalCtx, 0xA37U, (Actor *) this);
            this->unk_284 = 0xA37;
        }
        sp24->unk_A6C = (s32) (sp24->unk_A6C & ~0x20);
...
void func_809C7D14(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_284 == 0x407) {
        ...
        if ((temp_v0_2 < 3U) && ((gSaveContext.weekEventReg[59] & 0x20) == 0)) {
            func_800B8A1C((Actor *) this, globalCtx, temp_v0_2 + 0x22, 500.0f, 100.0f);
        } else {
            func_800B8A1C((Actor *) this, globalCtx, 5, 500.0f, 100.0f);
        }
...
void func_809C7EB4(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (((s32) gSaveContext.day % 5) != 3) {
        ...
        if ((func_80152498(&globalCtx->msgCtx) == 6) && (sp24 = temp_a3, (func_80147624(globalCtx) != 0))) {
            temp_a3->unk_A6C = (s32) (temp_a3->unk_A6C & ~0x20);
            this->unk_280 = 0;
            this->unk_26A = 0;
            temp_t2 = gSaveContext.weekEventReg[63] & 0xFE;
            gSaveContext.weekEventReg[63] = temp_t2;
    ...
    if (func_800B84D0((Actor *) this, globalCtx) != 0) {
        sp24 = temp_a3;
        func_801518B0(globalCtx, 0x408U, (Actor *) this);
        this->unk_284 = 0x408;
        temp_a3->unk_A6C = (s32) (temp_a3->unk_A6C & ~0x20);
        this->actor.flags &= 0xFFFEFFFF;
        this->unk_280 = 0;
...
void func_809C7FFC(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    temp_v1 = globalCtx->actorCtx.actorList[2].first;
    sp24 = temp_v1;
    if (func_809C6720(globalCtx, subroutine_arg1, D_809C9474.unk_4, D_809C9474.unk_8) != 0) {
        temp_v1->unk_A6C = (s32) (temp_v1->unk_A6C | 0x20);
        this->unk_26A = 2;
        if (this->unk_282 != 2) {
            this->unk_282 = 2;
            func_801518B0(globalCtx, 0xA2BU, (Actor *) this);
            this->unk_284 = 0xA2B;
        } else {
            func_801518B0(globalCtx, 0xA2CU, (Actor *) this);
            this->unk_284 = 0xA2C;
        }
        this->actionFunc = func_809C6E30;
    }
...
void func_809C80C0(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if ((s32) D_809C9498 > 0) {
        temp_v0->world.pos.x = D_809C9474.unk_0;
        temp_v0->world.pos.y = D_809C9474.unk_4;
        temp_v0->shape.rot.y = -0x8000;
        temp_v0->world.pos.z = D_809C9474.unk_8;
        temp_v0->world.rot.y = temp_v0->shape.rot.y;
        globalCtx->unk_18790(globalCtx, -0x8000, (Actor *) this);
    ...
    this = this;
    Audio_PlayActorSound2((Actor *) temp_a0, 0x482CU);
    this->unk_272 = 0x1F;
    this->unk_274 = 0;
    this->unk_276 = 0;
    this->unk_26C = 0;
...
void func_809C81D0(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.unk_3DE8 == 0) && (gSaveContext.unk_3DEC == 0)) {
        ...
        this->unk_27E = 0;
        this->unk_27C = 0;
        globalCtx->actorCtx.actorList[2].first->unk_A6C = (s32) (globalCtx->actorCtx.actorList[2].first->unk_A6C | 0x20);
        D_809C949C = 0;
        this = this;
        func_801A2C20();
    ...
    if ((temp_v0 == 1) || (temp_v0 == 5)) {
        ...
        if ((s32) temp_v0_2 <= 0) {
            ...
            if ((s32) this->unk_280 >= 0x848) {
                func_801518B0(globalCtx, 0xA34U, (Actor *) this);
                this->unk_284 = 0xA34;
                goto block_12;
            }
            if ((s32) this->unk_280 >= 0x7D0) {
                ...
                func_801518B0(globalCtx, 0xA35U, (Actor *) this);
                this->unk_284 = 0xA35;
                this->unk_26A = 4;
                this->unk_280 = 0;
                goto block_13;
            }
            func_801518B0(globalCtx, 0xA32U, (Actor *) this);
            this->unk_284 = 0xA32;
block_12:
            this->unk_26A = 6;
block_13:
...
void func_809C8610(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (globalCtx->interfaceCtx.unk_286 == 0) {
        ...
        temp_a1 = D_809C94A0;
        if (temp_a1 >= 0xB) {
            temp_t9 = gSaveContext.unk_3E94 + 0x64;
            gSaveContext.unk_3E90 = (s32) (gSaveContext.unk_3E90 + (temp_t9 < 0x64U));
            gSaveContext.unk_3E94 = temp_t9;
...
void func_809C8710(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (gSaveContext.playerForm == 0) {
        sp24.unk_0 = (s32) D_809C9480.unk_0;
        sp24.unk_4 = (s32) D_809C9480.unk_4;
        sp24.unk_8 = (s32) D_809C9480.unk_8;
    } else {
        sp24.unk_0 = (s32) D_809C948C.unk_0;
        sp24.unk_4 = (s32) D_809C948C.unk_4;
        sp24.unk_8 = (s32) D_809C948C.unk_8;
    }
    if (func_809C6720(globalCtx, subroutine_arg1, sp24.unk_4, sp24.unk_8) != 0) {
        if (this->unk_284 == 0x3FD) {
            func_801518B0(globalCtx, 0x3FEU, (Actor *) this);
            this->unk_284 = 0x3FE;
        } else {
            func_801518B0(globalCtx, 0x400U, (Actor *) this);
            this->unk_284 = 0x400;
        }
        this->unk_26A = 2;
        this->actionFunc = func_809C7990;
...
void func_809C8808(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (temp_v1 == 0x1E) {
        if (temp_v0->unk_14B == 0) {
            ...
            temp_v1_2->pos.x = D_809C9480.unk_0;
            temp_v1_2->pos.y = D_809C9480.unk_4;
            temp_v1_2->pos.z = D_809C9480.unk_8;
        } else {
            temp_v1_3 = &temp_v0->world;
            temp_v1_3->pos.x = D_809C948C.unk_0;
            temp_v1_3->pos.y = D_809C948C.unk_4;
            temp_v1_3->pos.z = D_809C948C.unk_8;
        }
...
void func_809C898C(EnSyatekiMan *this, GlobalContext *globalCtx) {
    ...
    if (temp_f16 < 0x2EF) {
        if (D_809C94A8 == 0) {
            temp_a0_2 = gSaveContext.unk_3DE8;
            temp_a1_2 = gSaveContext.unk_3DEC;
            sp20 = temp_a0_2;
            sp24 = temp_a1_2;
            phi_v1 = (s32) (u32) __ull_rem((u64) temp_a0_2, (u64) temp_a1_2, 0U, 0x1F4U);
        } else {
            temp_t7 = gSaveContext.unk_3DEC;
            temp_t6 = gSaveContext.unk_3DE8;
        ...
        if (temp_v0 != 0) {
            if (temp_v0 == 2) {
                temp_t3 = gSaveContext.unk_3E24;
                gSaveContext.unk_3E20 = (s32) (gSaveContext.unk_3E20 - (temp_t3 < 0xFAU));
                gSaveContext.unk_3E24 = (u32) (temp_t3 - 0xFA);
        ...
        if ((D_809C94A8 == (sp30 % 0x32)) && ((s32) this->unk_26C >= 0x46)) {
            ...
            if ((s32) temp_v0_3 < 0xF) {
                ...
                Audio_PlayActorSound2((Actor *) this, 0x482CU);
                this->unk_26C = 0;
                phi_t0 = &gSaveContext;
            }
        }
        if ((phi_t0->unk_3DE8 == 0) && (phi_t0->unk_3DEC == 0)) {
            this->unk_27E = 0;
            this->unk_26C = 0x50;
            phi_t0->unk_3DEC = 0;
            phi_t0->unk_3DE8 = 0;
            ...
            if ((temp_a0 < (s32) temp_v0_2) || (temp_v0_2 == 0x32)) {
                if (temp_a0 < (s32) temp_v0_2) {
                    if ((gSaveContext.weekEventReg[59] & 0x20) == 0) {
                        func_801518B0(globalCtx, 0x407U, (Actor *) this);
                        this->unk_284 = 0x407;
                    } else if (temp_v0_2 == 0x32) {
                        func_801518B0(globalCtx, 0x405U, (Actor *) this);
                        this->unk_284 = 0x405;
                    } else {
                        func_801518B0(globalCtx, 0x407U, (Actor *) this);
                        this->unk_284 = 0x407;
                ...
                if (temp_v0_2 == 0x32) {
                    func_801518B0(globalCtx, 0x406U, (Actor *) this);
                    this->unk_284 = 0x406;
                    phi_v1 = gSaveContext.roomInf[127][6];
block_14:
                    phi_a3 = &gSaveContext;
                ...
                if (((s32) gSaveContext.day % 5) != 3) {
                    func_801518B0(globalCtx, 0x401U, (Actor *) this);
                    this->unk_284 = 0x401;
                } else {
                    func_801518B0(globalCtx, 0x403U, (Actor *) this);
                    this->unk_284 = 0x403;
                }
                this->unk_26A = 4;
            }
...
void EnSyatekiMan_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_SetHeight((Actor *) this, 70.0f);
    if (this->unk_26A != 1) {
        SkelAnime_FrameUpdateMatrix(&this->skelAnime);
        func_800E9250(globalCtx, (Actor *) this, &this->unk_258, &this->unk_25E, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    }
}
...
void EnSyatekiMan_PostLimbDraw(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.unk_0 = (s32) D_809C94AC.unk_0;
    sp18.unk_4 = (s32) D_809C94AC.unk_4;
    sp18.unk_8 = (s32) D_809C94AC.unk_8;
    if (arg1 == 0xF) {
...
void EnSyatekiMan_Draw(Actor *this, GlobalContext *globalCtx) {
    ...
    if (globalCtx->sceneNum == 0x20) {
        D_809C94B8.unk_0 = &D_0600FB90;
        D_809C94B8.unk_4 = &D_06010390;
        phi_v0 = &D_06010390;
    } else {
        D_809C94B8.unk_0 = &D_06005AC8;
        D_809C94B8.unk_4 = &D_060062C8;
    }
    D_809C94B8.unk_8 = phi_v0;
    ...
    SkelAnime_DrawSV(globalCtx, self->skelAnime.skeleton, self->skelAnime.limbDrawTbl, (s32) self->skelAnime.dListCount, EnSyatekiMan_OverrideLimbDraw, EnSyatekiMan_PostLimbDraw, (Actor *) self);
}
