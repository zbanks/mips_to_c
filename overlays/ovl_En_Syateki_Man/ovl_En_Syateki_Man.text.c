...
void EnSyatekiMan_PostLimbDraw(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.unk0 = (s32) D_809C94AC.unk0;
    sp18.unk4 = (s32) D_809C94AC.unk4;
    sp18.unk8 = (s32) D_809C94AC.unk8;
    if (arg1 == 0xF) {
        SysMatrix_MultiplyVector3fByState((Vec3f *) &sp18, arg4 + 0x3C);
    }
}

void EnSyatekiMan_Draw(EnSyatekiMan *self, GlobalContext *globalCtx) {
