typedef struct EnRd {
    ...
    /* 0x18C */ void (*unk18C)(EnRd *);             /* inferred */
    ...
    /* 0x29C */ Vec3s unk29C;                       /* inferred */
    /* 0x2A2 */ char pad2A2[0x96];                  /* maybe part of unk29C[26]? */
    /* 0x338 */ Vec3s unk338;                       /* inferred */
    /* 0x33E */ char pad33E[0x96];                  /* maybe part of unk338[26]? */
    ...
    /* 0x3E2 */ char pad3E2[0x2];
    /* 0x3E4 */ s16 unk3E4;                         /* inferred */
    /* 0x3E6 */ s16 unk3E6;                         /* inferred */
    /* 0x3E8 */ u8 unk3E8;                          /* inferred */
    /* 0x3E9 */ u8 unk3E9;                          /* inferred */
    /* 0x3EA */ u8 unk3EA;                          /* inferred */
    /* 0x3EB */ u8 unk3EB;                          /* inferred */
    /* 0x3EC */ u8 unk3EC;                          /* inferred */
    /* 0x3ED */ u8 unk3ED;                          /* inferred */
    /* 0x3EE */ u8 unk3EE;                          /* inferred */
    /* 0x3EF */ u8 unk3EF;                          /* inferred */
    /* 0x3F0 */ u8 unk3F0;                          /* inferred */
    /* 0x3F1 */ s8 unk3F1;                          /* inferred */
    /* 0x3F2 */ char pad3F2[0x2];                   /* maybe part of unk3F1[3]? */
} EnRd;                                             /* size = 0x3F4 */
...
void func_808D5440(EnRd *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_a0;
    SkelAnime_FrameUpdateMatrix(temp_a0);
    if (((sp3C->unkA6C & 0x2C6080) == 0) && ((sp3C->unkA70 & 0x4080) == 0) && (temp_v0 = sp3C->unk14B, (temp_v0 != 1)) && (temp_v0 != 3) && (Actor_DistanceToPoint(sp3C, (Vec3f *) sp30) < 150.0f)) {
        this->actor.targetMode = 0;
...
void func_808D56E4(EnRd *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        sp2C.unk0 = (f32) temp_v0->world.pos.x;
        sp2C.unk4 = (f32) temp_v0->world.pos.y;
        sp2C.unk8 = (f32) temp_v0->world.pos.z;
...
void func_808D6A94(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->colChkInfo.health > 0) {
        temp_a0 = arg0;
        temp_a1 = arg0 + 0x190;
        if ((arg0->unk3EF != 0xA) && ((sp24 = temp_v0, sp20 = temp_a1, arg0 = arg0, Collider_UpdateCylinder(temp_a0, temp_a1), temp_a1_2 = arg1 + 0x18884, sp1C = temp_a1_2, CollisionCheck_SetOC(arg1, temp_a1_2, (Collider *) sp20), (arg0->unk3EF != 0xB)) || ((temp_v0->unkADC != 0) && (arg0->unk3F1 != temp_v0->unkADD))) && ((func_808D65BC != arg0->unk188) || (arg0->unk3D6 == 0))) {
...
void EnRd_Draw(EnRd *this, GlobalContext *globalCtx) {
    ...
    sp54.unk0 = (f32) this->actor.world.pos.x;
    sp54.unk4 = (f32) this->actor.world.pos.y;
    sp54.unk8 = (f32) this->actor.world.pos.z;
    ...
    if (this->unk3DE == 0xFF) {
        ...
        temp_s1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_808D6DA0, func_808D6DFC, (Actor *) this, temp_s1->polyOpa.p);
        ...
        temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_808D6DA0, NULL, (Actor *) this, temp_s1->polyXlu.p);
        func_800BC620((Vec3f *) &sp54, &D_808D7138, (s32) this->unk3DF, globalCtx);
    }
    if ((s32) this->unk3E6 > 0) {
        func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk1DC, 0xF, this->unk298, 0.5f, this->unk294, (u8) (s32) this->unk3E8);
    }
}
