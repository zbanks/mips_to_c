...
s32 EffectSsGSplash_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    if (initParamsx->unk_E == 0) {
        initParamsx->unk_E = 0x258;
    }
    this->gfx = (void *) D_0403A0F0;
    this->life = 8;
    this->regs[0] = 0;
    this->regs[2] = 0x64;
    this->regs[1] = initParamsx->unk_E;
    if (initParamsx->unk_D != 0) {
        this->regs[3] = (s16) initParamsx->unk_10;
        this->regs[4] = (s16) initParamsx->unk_11;
        this->regs[5] = (s16) initParamsx->unk_12;
        this->regs[6] = (s16) initParamsx->unk_13;
        this->regs[7] = (s16) initParamsx->unk_14;
        this->regs[8] = (s16) initParamsx->unk_15;
        this->regs[9] = (s16) initParamsx->unk_16;
        this->regs[10] = (s16) initParamsx->unk_17;
        this->regs[11] = (s16) initParamsx->unk_C;
    } else {
        temp_v0 = initParamsx->unk_C;
        if (temp_v0 != 0) {
            if (temp_v0 != 1) {
                if (temp_v0 != 2) {
...
void EffectSsGSplash_Update(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    if ((this->regs[11] == 1) && (this->life == 5)) {
        sp2C.unk_0 = (f32) this->pos.x;
        sp2C.unk_4 = (f32) this->pos.y;
        sp2C.unk_8 = (f32) this->pos.z;
