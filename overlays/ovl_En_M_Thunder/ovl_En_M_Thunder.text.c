typedef struct EnMThunder {
    ...
    /* 0x190 */ LightNode *unk_190;                 /* inferred */
    /* 0x194 */ ColliderCylinder unk_194;           /* inferred */
    /* 0x1B8 */ void (*actionFunc)(EnMThunder *, GlobalContext *); /* overlap */
    /* 0x1BF */ u8 unk_1BF;                         /* overlap; inferred */
} EnMThunder;                                       /* size = 0x1C4 */

struct _mips2c_stack_EnMThunder_Destroy {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnMThunder_Draw {
    ...
    /* 0x50 */ char pad_50[0x40];                   /* maybe part of sp4C[17]? */
    ...
    /* 0xAC */ Actor *spAC;                         /* inferred */
    /* 0xB0 */ char pad_B0[0x8];
};                                                  /* size = 0xB8 */

struct _mips2c_stack_EnMThunder_Init {
...
struct _mips2c_stack_EnMThunder_Update {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_808B53C0 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_808B5890 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_808B58CC {
    /* 0x00 */ char pad_0[0x20];
    /* 0x20 */ Vec3f *sp20;                         /* inferred */
    /* 0x24 */ char pad_24[0x4];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_808B5984 {
...
struct _mips2c_stack_func_808B5EEC {};              /* size 0x0 */

struct _mips2c_stack_func_808B5F68 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ ColliderCylinder *sp28;              /* inferred */
    /* 0x2C */ Actor *sp2C;                         /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_func_808B60D4 {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ f32 sp2C;                            /* inferred */
    /* 0x30 */ char pad_30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_808B6310 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_808B65BC {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */
...
void func_808B65BC(void *arg0);                     /* static */
extern ? D_04025970;
extern ? D_04025EF0;
extern ? D_040268F0;
extern ? D_04027CA0;
...
void func_808B53C0(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    arg0->unk_194.info.bumperFlags = 0;
    arg0->unk_1BE = 1;
    arg0->unk_194.info.toucherFlags = 2;
    arg0->actionFunc = func_808B6310;
    arg0->unk_194.info.bumper.hitPos.y = 8;
    arg0->unk_1A4 = 1.0f;
...
void EnMThunder_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1, (Actor *) this, &D_808B7120);
    temp_a0 = &this->unk_194;
    this->unk_1BF = (u8) this->actor.params;
    sp30 = temp_a0;
    ...
    this->unk_190 = LightContext_InsertLight(globalCtx, &globalCtx->lightCtx, (LightInfo *) sp30);
    if (this->unk_1BF == 0x80) {
        func_808B53C0(this, globalCtx);
        return;
    }
    this->unk_144.dim.radius = 0;
    this->unk_144.dim.height = 0x28;
    ...
    if (temp_t0->unk_A70 & 0x20000) {
        ...
        if ((gSaveContext.weekEventReg[23] & 2) != 0) {
            ...
            if (temp_v0_2 == 3) {
                this->unk_194.info.toucherFlags = 6;
            } else if (temp_v0_2 == 2) {
                this->unk_194.info.toucherFlags = 4;
            } else {
        ...
        if ((s32) temp_t0->unk_ADA < 0x1E) {
            ...
            this->unk_194.info.toucherFlags = 0xC;
            this->unk_144.info.toucher.dmgFlags = 0x2000000;
            this->unk_144.info.toucher.damage = 3;
        } else {
            this->actionFunc = func_808B5F68;
            this->unk_194.info.bumper.hitPos.y = 8;
        }
        func_801A5CFC(0x182EU, temp_t0 + 0xEC, 4U, &D_801DB4B0, &D_801DB4B0, &D_801DB4B8);
        this->unk_1A4 = 0x3F800000U;
        goto block_24;
    }
...
void EnMThunder_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnMThunder *this = (EnMThunder *) thisx;
    if (this->unk_194.info.bumperFlags != 0) {
        func_80115D5C(globalCtx);
    }
    Collider_DestroyCylinder(globalCtx, &this->unk_144);
    func_808B5890(globalCtx, 0U);
    LightContext_RemoveLight(globalCtx, &globalCtx->lightCtx, this->unk_190);
}
...
void func_808B5984(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk_194.info.bumperFlags == 0) && (temp_t0->unk_B08 >= 0.1f)) {
        if ((gSaveContext.unk_3F28 != 0) || ((temp_v0 = (s32) (arg0->actor.params & 0xFF00) >> 8, (temp_v0 != 0)) && (sp48 = temp_v1, sp4C = temp_t0, (func_80115DB4(arg1, (s16) temp_v0, 4) == 0)))) {
            ...
            arg0->unk_194.info.bumper.dmgFlags = 0;
            arg0->unk_1A4 = 0U;
            return;
        }
        arg0->unk_194.info.bumperFlags = 1;
...
block_7:
    ...
    if (phi_t0->unk_A70 & 0x20000) {
        ...
        phi_t0->unk_A70 = (s32) (phi_t0->unk_A70 & 0xFFFDFFFF);
        ...
        if (phi_t0->unk_B08 < 0.85f) {
            ...
            if (temp_v0_2 == 3) {
                arg0->unk_194.info.toucherFlags = 4;
            } else if (temp_v0_2 == 2) {
            ...
            temp_v0_3 = arg0->unk_1BF;
            arg0->unk_1BE = 0U;
            arg0->unk_144.info.toucher.damage = *(&D_808B7150 + temp_v0_3);
            if (temp_v0_3 == 3) {
                arg0->unk_194.info.toucherFlags = 6;
            } else if (temp_v0_3 == 2) {
                arg0->unk_194.info.toucherFlags = 4;
            } else {
                arg0->unk_194.info.toucherFlags = 3;
        ...
        func_801A5CFC(*(&D_808B7154 + (arg0->unk_1BE * 2)), phi_t0 + 0xEC, 4U, &D_801DB4B0, &D_801DB4B0, &D_801DB4B8);
        arg0->unk_1A4 = 0x3F800000U;
        return;
    }
    if ((phi_t0->unk_A6C & 0x1000) == 0) {
...
void func_808B5EEC(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    if ((s32) arg0->unk_194.info.bumper.hitPos.y < 2) {
        temp_v0 = arg0->unk_194.info.elemType;
        if ((s32) temp_v0 < 0x28) {
            arg0->unk_194.info.elemType = 0;
        } else {
            arg0->unk_194.info.elemType = temp_v0 - 0x28;
        }
    }
    temp_f2 = arg0->unk_194.info.bumper.dmgFlags;
    temp_f12 = arg0->unk_1A4;
    arg0->unk_194.info.toucher.dmgFlags += 2.0f * arg0->unk_1A8;
    if (temp_f2 < temp_f12) {
        arg0->unk_194.info.bumper.dmgFlags = temp_f2 + ((temp_f12 - temp_f2) * 0.1f);
        return;
    }
    arg0->unk_194.info.bumper.dmgFlags = temp_f12;
}
...
void func_808B5F68(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    if (Math_StepToF((f32 *) &arg0->unk_194.base.atFlags, 0.0f, 0.0625f) != 0) {
        Actor_MarkForDeath((Actor *) arg0);
    } else {
        Math_SmoothStepToF((f32 *) &arg0->actor.scale, (f32) arg0->unk_194.info.toucherFlags, 0.6f, 0.8f, 0.0f);
        Actor_SetScale((Actor *) arg0, arg0->actor.scale.x);
        temp_a2 = &arg0->unk_144;
        arg0->unk_144.dim.radius = (s16) (s32) (arg0->actor.scale.x * 30.0f);
        sp28 = temp_a2;
        Collider_UpdateCylinder((Actor *) arg0, temp_a2);
...
void func_808B60D4(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    if (temp_f0 > 0.9f) {
        ...
        arg0->unk_1A8 = (f32) (temp_f0 * 1.1111112f);
    }
    if (Math_StepToF((f32 *) &arg0->unk_194.base.atFlags, 0.0f, 0.05f) != 0) {
        Actor_MarkForDeath((Actor *) arg0);
    } else {
        ...
        temp_t6 = arg0->unk_194.info.toucherFlags;
        temp_f6 = (f32) temp_t6;
        ...
        Math_SmoothStepToF((f32 *) &arg0->actor.scale, phi_f6, 0.6f, 2.0f, 0.0f);
        Actor_SetScale((Actor *) arg0, arg0->actor.scale.x);
        arg0->unk_144.dim.pos.x = (s16) (s32) arg0->actor.world.pos.x;
        arg0->unk_144.dim.radius = (s16) (s32) (arg0->actor.scale.x * 5.0f);
        ...
        arg0->unk_144.dim.pos.y = (s16) (s32) arg0->actor.world.pos.y;
        arg0->unk_144.dim.pos.x = (s16) temp_f4;
        arg0->unk_144.dim.pos.z = (s16) (s32) ((Math_CosS(arg0->actor.shape.rot.y) * -5.0f * arg0->actor.scale.z) + arg0->actor.world.pos.z);
...
void EnMThunder_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_808B5890(globalCtx, this->unk_194.info.bumper.dmgFlags);
    temp_f0 = this->unk_1A4;
    temp_v0 = (u32) (temp_f0 * 255.0f) & 0xFF;
    Lights_PointNoGlowSetInfo((LightInfo *) &this->unk_194, (s16) (s32) this->actor.world.pos.x, (s16) (s32) this->actor.world.pos.y, (s16) (s32) this->actor.world.pos.z, (u8) temp_v0, (u8) temp_v0, (u8) (u32) (temp_f0 * 100.0f), (s16) (s32) (temp_f0 * 800.0f));
}
...
void EnMThunder_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((temp_v0_2 != 0) && (temp_v0_2 != 1)) {
        if ((temp_v0_2 != 2) && (temp_v0_2 != 3)) {
            ...
            spA0 = spA0;
            sp90 = temp_v0_3;
            sp90->words.w1 = Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0U, 0U, 0x10, 0x40, 1, 0U, 0x1FF - ((s32) ((bitwise f32) this->unk_194.info.toucher.dmgFlags * 10.0f) & 0x1FF), 0x20, 0x80);
            goto block_7;
        }
    } else {
...
block_7:
    ...
    if (phi_v0 != 0) {
        if (phi_v0 != 1) {
            if (phi_v0 != 2) {
                if (phi_v0 != 3) {
                    ...
                    temp_v1->words.w1 = ((u32) (phi_t2->unk_1A8 * 255.0f) & 0xFF) | 0xAAFFFF00;
                ...
                temp_v1_2->words.w1 = ((u32) (phi_t2->unk_1A8 * 255.0f) & 0xFF) | 0xFFFF00;
            ...
            temp_v1_3->words.w1 = ((u32) (phi_t2->unk_1A8 * 255.0f) & 0xFF) | 0xAAFFFF00;
        ...
        temp_v1_4->words.w1 = ((u32) (phi_t2->unk_1A8 * 255.0f) & 0xFF) | ~0x55FF;
