typedef struct EnMThunder {
    ...
    /* 0x190 */ LightNode *unk190;                  /* inferred */
    /* 0x194 */ ColliderCylinder unk194;            /* inferred */
    /* 0x1B8 */ void (*actionFunc)(EnMThunder *, GlobalContext *); /* overlap */
    /* 0x1BC */ char pad1BC[0x3];
    /* 0x1BF */ u8 unk1BF;                          /* inferred */
    /* 0x1C0 */ char pad1C0[0x4];                   /* maybe part of unk1BF[5]? */
...
struct _mips2c_stack_EnMThunder_Draw {
    ...
    /* 0x50 */ char pad50[0x40];                    /* maybe part of sp4C[17]? */
...
void func_808B5984(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    arg0->unk1B0 = (f32) temp_t0->unkB08;
...
void func_808B5F68(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    if (Math_StepToF((f32 *) &arg0->unk194.base.atFlags, 0.0f, 0.0625f) != 0) {
        ...
        Math_SmoothStepToF((f32 *) &arg0->actor.scale, (f32) arg0->unk194.info.toucherFlags, 0.6f, 0.8f, 0.0f);
...
void func_808B60D4(EnMThunder *arg0, GlobalContext *arg1) {
    ...
    if (temp_f0 > 0.9f) {
        ...
        arg0->unk1A8 = (f32) (temp_f0 * 1.1111112f);
    }
...
void func_808B6310(Actor *arg0, GlobalContext *arg1) {
    ...
    if (Math_StepToF(arg0 + 0x1A4, 0.0f, 0.0625f) != 0) {
        ...
        Math_SmoothStepToF((f32 *) &arg0->scale, (f32) arg0->unk1C1, 0.6f, 0.8f, 0.0f);
...
void EnMThunder_Update(EnMThunder *this, GlobalContext *globalCtx) {
    ...
    Lights_PointNoGlowSetInfo((LightInfo *) &this->unk194, (s16) (s32) this->actor.world.pos.x, (s16) (s32) this->actor.world.pos.y, (s16) (s32) this->actor.world.pos.z, (u8) temp_v0, (u8) temp_v0, (u8) (u32) (temp_f0 * 100.0f), (s16) (s32) (temp_f0 * 800.0f));
}
