...
void EnGirlA_InitalUpdate(EnGirlA *this, GlobalContext *globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->objIndex) != 0) {
        ...
        this->actor.textId = temp_v1->unkA;
        this->choiceTextId = temp_v1->unkC;
        sp24 = temp_v1;
        ...
        this->getItemId = (temp_t1 + &D_80864A50)->unk10;
        this->canBuyFunc = (temp_t1 + &D_80864A50)->unk14;
        this->buyFunc = (temp_t1 + &D_80864A50)->unk18;
        this->unk1C0 = 0;
        this->buyFanfareFunc = (temp_t1 + &D_80864A50)->unk1C;
        this->itemParams = (temp_t1 + &D_80864A50)->unk8;
        this->drawFunc = (temp_t1 + &D_80864A50)->unk4;
        this->actor.flags &= -2;
        this->getItemDrawId = (temp_t1 + &D_80864A50)->unk2;
...
void EnGirlA_Draw(EnGirlA *this, GlobalContext *globalCtx) {
    EnGirlA *temp_a0_2;
    s16 temp_a0;
