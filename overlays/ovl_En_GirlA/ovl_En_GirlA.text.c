struct _mips2c_stack_EnGirlA_Bought {};             /* size 0x0 */

struct _mips2c_stack_EnGirlA_BuyArrows {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyBombBag {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyBombchus {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyBombs {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnGirlA_BuyBottle {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyBottleItem {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyFanfare {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyMaskAllNight {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyNuts {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyShieldHero {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyShieldMirror {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuyStick {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_BuySword {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnGirlA_CanBuyArrows {};       /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyBombBag20BombShop {}; /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyBombBag30BombShop {}; /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyBombBagCuriosityShop {}; /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyBombchus {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_CanBuyBombs {};        /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyBottle {};       /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyFairy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_CanBuyMaskAllNight {}; /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyNuts {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_CanBuyPotionBlue {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_CanBuyPotionGreen {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_CanBuyPotionRed {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_CanBuyShieldHero {};   /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyShieldMirror {}; /* size 0x0 */

struct _mips2c_stack_EnGirlA_CanBuyStick {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_CanBuySword {};        /* size 0x0 */

struct _mips2c_stack_EnGirlA_Destroy {};            /* size 0x0 */

struct _mips2c_stack_EnGirlA_DoNothing {};          /* size 0x0 */

struct _mips2c_stack_EnGirlA_Draw {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_Init {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_InitItem {};           /* size 0x0 */

struct _mips2c_stack_EnGirlA_InitObjIndex {
    /* 0x00 */ char pad_0[0x1E];
    /* 0x1E */ s16 sp1E;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_EnGirlA_InitalUpdate {
...
struct _mips2c_stack_EnGirlA_Restock {};            /* size 0x0 */

struct _mips2c_stack_EnGirlA_SetupAction {};        /* size 0x0 */

struct _mips2c_stack_EnGirlA_TrySetMaskItemDescription {}; /* size 0x0 */

struct _mips2c_stack_EnGirlA_Update {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnGirlA_Update2 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

void EnGirlA_Bought(GlobalContext *arg0, EnGirlA *arg1); /* static */
void EnGirlA_DoNothing(s32 arg0, ? arg1);           /* static */
...
void EnGirlA_SetupAction(EnGirlA *arg0, void (*arg1)(s32, ?)); /* static */
...
void EnGirlA_InitObjIndex(Actor *arg0, s32 arg1) {
    ...
    sp1E = temp_v1;
    arg0 = arg0;
    arg0->unk_18C = Object_GetIndex(arg1 + 0x17D88, *(&D_80864A50 + (temp_v1 << 5)));
    if ((s32) arg0->unk_18C < 0) {
        Actor_MarkForDeath(arg0);
        return;
    }
    arg0->params = temp_v1;
    arg0->unk_190 = EnGirlA_InitalUpdate;
}
...
void EnGirlA_BuyBottleItem(GlobalContext *globalCtx, EnGirlA *this) {
    ...
    case 32:
    case 35:
        Item_Give(globalCtx, 0x13U);
        break;
    case 1:
    case 5:
    case 14:
        Item_Give(globalCtx, 0x14U);
        break;
    case 2:
        Item_Give(globalCtx, 0x15U);
        break;
    case 3:
    case 11:
        Item_Give(globalCtx, 0x16U);
        break;
    }
    ...
    if (temp_v0 != 0x14) {
        if (temp_v0 != 0x15) {
            if (temp_v0 != 0x16) {
                ...
                Item_Give(globalCtx, 0x58U);
            }
        } else {
            Item_Give(globalCtx, 0x57U);
        }
    } else {
        Item_Give(globalCtx, 0x56U);
    }
    func_801159EC((s16) ((s32) globalCtx->msgCtx.unk1206C * -1));
}
        ...
        if (temp_v0 != 0xA) {
            if (temp_v0 != 0x14) {
                if (temp_v0 != 0x1E) {
                    ...
                    Item_Give(globalCtx, 0x92U);
                }
            } else {
                Item_Give(globalCtx, 0x91U);
            }
        } else {
            Item_Give(globalCtx, 0x90U);
        }
    } else {
        ...
        if (temp_v0 != 2) {
            if (temp_v0 != 3) {
                if (temp_v0 != 4) {
                    ...
                    Item_Give(globalCtx, 0x10U);
                }
            } else {
                Item_Give(globalCtx, 0x4FU);
            }
        } else {
            Item_Give(globalCtx, 0x4EU);
        }
    } else {
        Item_Give(globalCtx, 0x4DU);
    }
    func_801159EC((s16) ((s32) globalCtx->msgCtx.unk1206C * -1));
}

void EnGirlA_BuyShieldMirror(GlobalContext *globalCtx, EnGirlA *this) {
    Item_Give(globalCtx, 0x52U);
    func_801159EC((s16) ((s32) globalCtx->msgCtx.unk1206C * -1));
}
...
void EnGirlA_InitItem(GlobalContext *arg0, EnGirlA *arg1) {
    ...
    arg1->actor.textId = ((arg1->actor.params << 5) + &D_80864A50)->unk_A;
}
...
void EnGirlA_InitalUpdate(EnGirlA *this, GlobalContext *globalCtx) {
    ...
    sp2E = this->actor.params;
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32) this->objIndex) != 0) {
        this->actor.flags &= -0x11;
        this->actor.objBankIndex = this->objIndex;
        temp_t1 = sp2E << 5;
        temp_v1 = temp_t1 + &D_80864A50;
        this->actor.textId = temp_v1->unk_A;
        this->choiceTextId = temp_v1->unk_C;
        sp24 = temp_v1;
        ...
        this->getItemId = (temp_t1 + &D_80864A50)->unk_10;
        this->canBuyFunc = (temp_t1 + &D_80864A50)->unk_14;
        this->buyFunc = (temp_t1 + &D_80864A50)->unk_18;
        this->unk1C0 = 0;
        this->buyFanfareFunc = (temp_t1 + &D_80864A50)->unk_1C;
        this->itemParams = (temp_t1 + &D_80864A50)->unk_8;
        this->drawFunc = (temp_t1 + &D_80864A50)->unk_4;
        this->actor.flags &= -2;
        this->getItemDrawId = (temp_t1 + &D_80864A50)->unk_2;
...
void EnGirlA_Update2(EnGirlA *this, GlobalContext *globalCtx) {
    ...
    Actor_SetHeight((Actor *) this, 5.0f);
    this->actor.shape.rot.x = 0;
    if (this->isSelected != 0) {
        this->rotY += 0x1F4;
        return;
    }
    Math_SmoothStepToS(&this->rotY, 0, 0xA, 0x7D0, (s16) 0);
}
...
void EnGirlA_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v0 != 0) {
        this = this;
        temp_v0((Actor *) temp_a0_2, globalCtx, 0);
    }
