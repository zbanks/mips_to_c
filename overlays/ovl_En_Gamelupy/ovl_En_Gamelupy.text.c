...
void EnGamelupy_Init(EnGamelupy *this, GlobalContext *globalCtx) {
...
void EnGamelupy_Destroy(EnGamelupy *this, GlobalContext *globalCtx) {
    EnGamelupy *this = (EnGamelupy *) thisx;
...
void func_80AF6854(EnGamelupy *arg0, GlobalContext *arg1) {
    ...
    sp4C.unk0 = (s32) arg0->actor.world.pos.x;
    sp4C.unk4 = (s32) arg0->actor.world.pos.y;
    sp4C.unk8 = (s32) arg0->actor.world.pos.z;
...
void func_80AF6A78(EnGamelupy *this, GlobalContext *globalCtx) {
    ...
    if ((s32) temp_v0 >= 0x1F) {
        ...
        globalCtx = globalCtx;
        Actor_SetScale((Actor *) this, (30.0f - (f32) this->unk19C) * 0.001f);
...
void EnGamelupy_Update(EnGamelupy *this, GlobalContext *globalCtx) {
    EnGamelupy *this = (EnGamelupy *) thisx;
...
void EnGamelupy_Draw(EnGamelupy *this, GlobalContext *globalCtx) {
    Gfx *sp24;
    Gfx *sp20;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
