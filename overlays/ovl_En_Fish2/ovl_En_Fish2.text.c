typedef struct EnFish2 {
    ...
    /* 0x02C4 */ char pad2C4[0x6];                  /* maybe part of unk2C0[2]? */
...
void EnFish2_Init(EnFish2 *this, GlobalContext *globalCtx) {
    s16 temp_v0_3;
    s16 temp_v1;
    s8 temp_s0;
    u8 temp_v0;
    ...
    Math_Vec3f_Copy(&this->unk324, (Vec3f *) &this->actor.home);
    ...
    if (temp_v1 == 0) {
        ...
        Collider_InitAndSetJntSph(globalCtx, &this->unk358, (Actor *) this, &D_80B2B360, &this->unk378);
...
void EnFish2_Destroy(EnFish2 *this, GlobalContext *globalCtx) {
    EnFish2 *this = (EnFish2 *) thisx;
...
void func_80B287F4(Actor *arg0, s32 arg1) {
    ...
    Math_Vec3f_Copy((Vec3f *) &sp2C, arg0->unk350 + 0x24);
    temp_a0 = arg0 + 0x24;
    sp28 = temp_a0;
    arg0->unk34A = Math_Vec3f_Yaw(temp_a0, (Vec3f *) &sp2C);
    arg0->unk348 = Math_Vec3f_Pitch(temp_a0, (Vec3f *) &sp2C);
}
    ...
    if (arg0->unk2B6 == 0) {
        ...
        if (temp_v0 == 0) {
            ...
            if ((arg0->unk348 == 0) || (sp54 = arg1->actorCtx.actorList[7].first, (Rand_ZeroOne() < 0.6f))) {
                ...
                sp54 = arg1->actorCtx.actorList[7].first;
                arg0->unk348 = Math_Vec3f_Pitch((Vec3f *) &arg0->world, arg0 + 0x324);
                phi_v1 = arg1->actorCtx.actorList[7].first;
...
void func_80B295A4(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk2B4 != 0) {
        ...
        phi_s0 = 0;
        do {
            EffectSsBubble_Spawn(arg1, (Vec3f *) temp_s3, 0.0f, 5.0f, 5.0f, Rand_ZeroFloat(arg0->unk330 * 4.0f) + 0.1f);
            temp_s0 = phi_s0 + 1;
            phi_s0 = temp_s0;
        } while (temp_s0 != 2);
        return;
...
void func_80B297FC(Actor *arg0, GlobalContext *arg1) {
    ...
    case 0:
        ...
        sp2C = temp_a0;
        sp4C = arg0->unk2D4;
        arg0->unk348 = Math_Vec3f_Pitch(temp_a0, (Vec3f *) &sp48);
        ...
        func_80B289DC(arg0, arg1);
        Math_ApproachF((f32 *) sp2C, arg0->unk324, 0.3f, 3.0f);
...
void func_80B29EE4(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_a0 = &arg0->world;
    sp28 = temp_a0;
    arg0->unk34A = Math_Vec3f_Yaw((Vec3f *) temp_a0, (Vec3f *) &sp2C);
    arg0->unk348 = Math_Vec3f_Pitch((Vec3f *) temp_a0, (Vec3f *) &sp2C);
...
void func_80B2A094(EnFish2 *arg0, GlobalContext *arg1) {
    ...
    if ((temp_v1_2 != 0) && (temp_v1_2->unk138 != 0)) {
        ...
        Math_Vec3f_Copy(&arg0->unk2DC, (Vec3f *) &sp2C);
        Math_Vec3f_Copy((Vec3f *) &sp2C, arg0->unk350 + 0x24);
        sp2C += Math_SinS(-0x3A98) * 10.0f;
        sp34 += Math_CosS(-0x3A98) * 10.0f;
        Math_Vec3f_Copy(&arg0->unk2E8, (Vec3f *) &sp2C);
    }
...
void EnFish2_Update(EnFish2 *this, GlobalContext *globalCtx) {
    WaterBox *sp6C;
    f32 sp64;
    f32 sp60;
    f32 sp5C;
    ...
    if (temp_v0_3 != 1) {
        if (temp_v0_3 == 0) {
            Math_SmoothStepToS((s16 *) &this->actor.world.rot, this->unk348, 1, (s16) (this->unk34C + 0xC8), (s16) 0);
        ...
        if ((globalCtx->gameplayFrames & 7) == 0) {
            Math_Vec3f_Copy((Vec3f *) &sp5C, &this->unk324);
            ...
            if (((s32) randPlusMinusPoint5Scaled(5.0f) + 0xA) > 0) {
                do {
                    EffectSsBubble_Spawn(globalCtx, (Vec3f *) &sp5C, 0.0f, 5.0f, 5.0f, Rand_ZeroFloat(this->unk330 * 4.0f) + 0.1f);
                    temp_s0 = phi_s0 + 1;
                    phi_s0 = temp_s0;
        ...
        Math_Vec3f_Copy(&this->unk2F4, (Vec3f *) &this->actor.world);
        ...
        if (this->actor.params != 2) {
            ...
            if (phi_v0 == 0) {
                CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk358);
            }
        }
    }
}
...
void EnFish2_Draw(EnFish2 *this, GlobalContext *globalCtx) {
    EnFish2 *this = (EnFish2 *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    func_8012C2DC(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80B2ABF4, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80B2AC20, (Actor *) this);
...
loop_1:
    if (phi_s0->unk0 == 0) {
        ...
        temp_t8 = 1U & 0xFF;
        phi_s0->unk4 = (f32) arg1->unk0;
        temp_f18 = (f32) temp_t8;
        phi_s0->unk8 = (f32) arg1->unk4;
        phi_s0->unkC = (f32) arg1->unk8;
        phi_f18 = temp_f18;
        if (temp_t8 < 0) {
