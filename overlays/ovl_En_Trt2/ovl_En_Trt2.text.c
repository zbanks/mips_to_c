typedef struct EnTrt2 {
    ...
    /* 0x148 */ char pad148[0x8];                   /* maybe part of actionFunc[3]? */
    /* 0x150 */ SkelAnime unk150;                   /* inferred */
    /* 0x194 */ ColliderCylinder unk194;            /* inferred */
    /* 0x1E0 */ Path *unk1E0;                       /* inferred */
    /* 0x1E4 */ char pad1E4[0x1C4];                 /* maybe part of unk1E0[114]? */
    ...
    /* 0x3B4 */ char pad3B4[0x2];
    /* 0x3B6 */ s16 unk3B6;                         /* inferred */
    /* 0x3B8 */ s16 unk3B8;                         /* inferred */
    /* 0x3BA */ char pad3BA[0x2];
    /* 0x3BC */ void (*unk3BC)(EnTrt2 *);           /* inferred */
    /* 0x3C0 */ s16 unk3C0;                         /* inferred */
    /* 0x3C2 */ char pad3C2[0x16];                  /* maybe part of unk3C0[12]? */
    /* 0x3D8 */ s8 unk3D8;                          /* inferred */
    /* 0x3D9 */ char pad3D9[0x1];
...
void func_80AD38B8(Actor *arg0, ? arg1) {
    ...
    if (temp_a0 != 0) {
        ...
        if (func_80AD475C(arg0, (u8 *) arg0->unk1E0, arg0->unk1E4) != 0) {
            temp_v0 = arg0->unk1E4;
...
void func_80AD434C(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_f0 > 200.0f) {
        if (func_801378B8(arg0 + 0x150, arg0->unk160) != 0) {
            ...
            sp5C.unk0 = (s32) D_80AD58F8.unk0;
            sp5C.unk4 = (s32) D_80AD58F8.unk4;
            sp5C.unk8 = (s32) D_80AD58F8.unk8;
...
void EnTrt2_Init(EnTrt2 *this, GlobalContext *globalCtx) {
...
void EnTrt2_Destroy(EnTrt2 *this, GlobalContext *globalCtx) {
    EnTrt2 *this = (EnTrt2 *) thisx;
    SkelAnime_Free(&this->unk150, globalCtx);
    Collider_DestroyCylinder(globalCtx, &this->unk194);
}

void EnTrt2_Update(EnTrt2 *this, GlobalContext *globalCtx) {
    s16 temp_v0;
    s16 temp_v0_2;
    EnTrt2 *this = (EnTrt2 *) thisx;
...
void func_80AD5584(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp30.unk0 = (s32) D_80AD596C.unk0;
    sp30.unk4 = (s32) D_80AD596C.unk4;
    sp30.unk8 = (s32) D_80AD596C.unk8;
    phi_v0 = 0;
