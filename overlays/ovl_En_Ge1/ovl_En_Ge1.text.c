typedef struct EnGe1 {
    ...
    /* 0x24A */ char pad24A[0x60];                  /* maybe part of unk244[17]? */
    ...
    /* 0x2C4 */ s8 unk2C4;                          /* inferred */
    /* 0x2C5 */ char pad2C5[0x3];                   /* maybe part of unk2C4[4]? */
...
void EnGe1_Init(EnGe1 *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk148, (Actor *) this, &D_809464D0);
...
s32 func_80945B60(Actor *arg0) {
    ...
    Math_Vec3s_ToVec3f((Vec3f *) &sp30, Lib_SegmentedToVirtual(temp_v1->unk4) + (arg0->unk2B4 * 6));
    temp_a0 = arg0 + 0x24;
    sp28 = temp_a0;
...
void func_80945CE4(EnGe1 *arg0, GlobalContext *arg1) {
    ...
    if (arg0->unk2C0 == 9) {
        if ((arg0->unk2B4 < (s32) *arg0->unk2B0) && (func_80945B60((Actor *) arg0) != 0)) {
            arg0->unk2B4 += 1;
        }
        temp_v0 = arg0->unk2C2;
...
void EnGe1_Draw(EnGe1 *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk194.skeleton, this->unk194.limbDrawTbl, (s32) this->unk194.dListCount, func_80946238, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80946368, (Actor *) this);
}
