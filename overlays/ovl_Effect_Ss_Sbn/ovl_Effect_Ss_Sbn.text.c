struct _mips2c_stack_EffectSsSbn_Init {
    ...
    /* 0x64 */ char pad_64[0x14];                   /* maybe part of sp60[6]? */
...
s32 EffectSsSbn_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    this->regs[4] = 0xFA;
    this->regs[5] = 0x1E;
    this->gfx = initParamsx->unk_C;
    this->regs[7] = (s16) (s32) (randPlusMinusPoint5Scaled(100.0f) + (initParamsx->unk_10 * 120.0f));
    temp_v0 = this->regs[7];
    ...
    if (temp_v0_2 != 0) {
        ...
        temp_f2 = (f32) sp98->unk_8 * 0.00003051851f;
        temp_f12 = (f32) sp98->unk_A * 0.00003051851f;
        temp_f14 = (f32) sp98->unk_C * 0.00003051851f;
