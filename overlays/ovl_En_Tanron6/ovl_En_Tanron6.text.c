...
void EnTanron6_Init(EnTanron6 *this, GlobalContext *globalCtx) {
...
void EnTanron6_Destroy(EnTanron6 *this, GlobalContext *globalCtx) {
    EnTanron6 *this = (EnTanron6 *) thisx;
...
void EnTanron6_Update(EnTanron6 *this, GlobalContext *globalCtx) {
    EnTanron6 *this = (EnTanron6 *) thisx;
...
void EnTanron6_Draw(EnTanron6 *this, GlobalContext *globalCtx) {
    EnTanron6 *this = (EnTanron6 *) thisx;
