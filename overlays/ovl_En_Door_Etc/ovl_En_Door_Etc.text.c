...
void EnDoorEtc_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnDoorEtc *this = (EnDoorEtc *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_1A8);
}
...
s32 func_80AC2044(void *arg0, PosRot *arg1, f32 arg2) {
    ...
    temp_f0 = arg1->pos.x - arg0->unk_0;
    temp_f2 = arg1->pos.y - arg0->unk_4;
    temp_f12 = arg1->pos.z - arg0->unk_8;
    phi_v0 = 0;
...
void func_80AC2118(void *arg0, ? arg1) {
    ...
    if ((s32) temp_v0 < 0) {
        arg0->unk_1A4 = (s16) (temp_v0 + 0x100);
        return;
    }
    arg0->unk_1A4 = 0;
    arg0->unk_1F8 = func_80AC21A0;
    arg0->unk_1F4 = (u8) (arg0->unk_1F4 & 0xFFFE);
}
...
void func_80AC2154(void *arg0, ? arg1) {
    ...
    if ((s32) temp_v0 > 0) {
        arg0->unk_1A6 = (s16) (temp_v0 - 1);
        return;
    }
    temp_v0_2 = arg0->unk_1A4;
    if ((s32) temp_v0_2 >= -0x3FFF) {
        arg0->unk_1A4 = (s16) (temp_v0_2 - 0x800);
        return;
    }
    arg0->unk_1A4 = -0x4000;
    arg0->unk_1F8 = func_80AC2118;
}
...
void func_80AC21A0(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->textId == 0x239B) && (Flags_GetSwitch(arg1, arg0->params & 0x7F) != 0)) {
        ...
        arg0->unk_1F8 = func_80AC2154;
        arg0->textId = 0x1800;
        arg0->unk_1F4 = (u8) (arg0->unk_1F4 | 1);
        arg0->unk_1A6 = 0x5A;
    }
}
