typedef struct DemoKankyo {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ char pad144[0x1500];               /* maybe part of actor[17]? */
...
struct _mips2c_stack_func_808CF0CC {
    ...
    /* 0xB0 */ char padB0[0x24];                    /* maybe part of spAC[10]? */
...
struct _mips2c_stack_func_808CF970 {
    ...
    /* 0x68 */ char pad68[0x30];                    /* maybe part of sp64[13]? */
...
struct _mips2c_stack_func_808CFE04 {
    ...
    /* 0x6C */ char pad6C[0x3C];                    /* maybe part of sp68[16]? */
    /* 0xA8 */ f32 spA8;                            /* inferred */
    /* 0xAC */ f32 spAC;                            /* inferred */
    /* 0xB0 */ char padB0[0x4];
    /* 0xB4 */ f32 spB4;                            /* inferred */
