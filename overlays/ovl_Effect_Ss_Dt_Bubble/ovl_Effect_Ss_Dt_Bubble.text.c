...
s32 EffectSsDtBubble_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    this->life = initParamsx->unk_2E;
    if (initParamsx->unk_34 == 0) {
        this->regs[0] = (s16) *(&D_8097B1E0 + (initParamsx->unk_30 * 4));
        this->regs[1] = (s16) (&D_8097B1E0 + (initParamsx->unk_30 * 4))->unk_1;
        this->regs[2] = (s16) (&D_8097B1E0 + (initParamsx->unk_30 * 4))->unk_2;
        this->regs[3] = (s16) (&D_8097B1E0 + (initParamsx->unk_30 * 4))->unk_3;
        this->regs[4] = (s16) *(&D_8097B1F0 + (initParamsx->unk_30 * 4));
        this->regs[5] = (s16) (&D_8097B1F0 + (initParamsx->unk_30 * 4))->unk_1;
        this->regs[6] = (s16) (&D_8097B1F0 + (initParamsx->unk_30 * 4))->unk_2;
        this->regs[7] = (s16) (&D_8097B1F0 + (initParamsx->unk_30 * 4))->unk_3;
    } else {
    ...
    this->regs[8] = initParamsx->unk_32;
