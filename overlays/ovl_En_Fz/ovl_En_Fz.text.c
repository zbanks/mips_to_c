...
void func_809331F8(EnFz *arg0, GlobalContext *arg1); /* static */
void func_80933248(void *arg0);                     /* static */
void func_80933274(EnFz *arg0, GlobalContext *arg1); /* static */
void func_80933324(EnFz *arg0);                     /* static */
void func_80933368(EnFz *arg0, GlobalContext *arg1); /* static */
void func_809333A4(EnFz *arg0);                     /* static */
void func_809333D8(EnFz *arg0, GlobalContext *arg1); /* static */
...
void func_80933B38(EnFz *arg0, GlobalContext *arg1); /* static */
void func_80933B48(EnFz *arg0, GlobalContext *arg1); /* static */
void func_80934018(void *arg0, f32 *arg1, ?32 *arg2, ?32 *arg3, f32 arg4); /* static */
void func_809340BC(Actor *arg0, f32 *arg1, Vec3f *arg2, f32 *arg3, Vec3f *arg4, f32 *arg5, ?32 arg6, ?32 arg7, s32, s32); /* static */
...
typedef struct EnFz {
    ...
    /* 0x023C */ char pad23C[0x960];                /* maybe part of unk238[601]? */
    /* 0x0B9C */ f32 unkB9C;                        /* inferred */
    /* 0x0BA0 */ f32 unkBA0;                        /* inferred */
    /* 0x0BA4 */ s16 unkBA4;                        /* inferred */
    /* 0x0BA6 */ char padBA6[0x2];                  /* maybe part of unkBA4[2]? */
    /* 0x0BA8 */ f32 unkBA8;                        /* inferred */
    /* 0x0BAC */ f32 unkBAC;                        /* inferred */
    /* 0x0BB0 */ f32 unkBB0;                        /* inferred */
    /* 0x0BB4 */ f32 unkBB4;                        /* inferred */
    /* 0x0BB8 */ f32 unkBB8;                        /* inferred */
    /* 0x0BBC */ f32 unkBBC;                        /* inferred */
    /* 0x0BC0 */ u32 unkBC0;                        /* inferred */
    /* 0x0BC4 */ s16 unkBC4;                        /* inferred */
    /* 0x0BC6 */ s16 unkBC6;                        /* inferred */
    /* 0x0BC8 */ s16 unkBC8;                        /* inferred */
    /* 0x0BCA */ s16 unkBCA;                        /* inferred */
    /* 0x0BCC */ u8 unkBCC;                         /* inferred */
    /* 0x0BCD */ u8 unkBCD;                         /* inferred */
    /* 0x0BCE */ u8 unkBCE;                         /* inferred */
    /* 0x0BCF */ s8 unkBCF;                         /* inferred */
    /* 0x0BD0 */ s16 unkBD0;                        /* inferred */
    /* 0x0BD2 */ s16 unkBD2;                        /* inferred */
    /* 0x0BD4 */ char padBD4[0x2];                  /* maybe part of unkBD2[2]? */
    /* 0x0BD6 */ u8 unkBD6;                         /* inferred */
    /* 0x0BD7 */ u8 unkBD7;                         /* inferred */
    /* 0x0BD8 */ u8 unkBD8;                         /* inferred */
    /* 0x0BD9 */ u8 unkBD9;                         /* inferred */
    /* 0x0BDA */ char padBDA[0x2];                  /* maybe part of unkBD9[3]? */
} EnFz;                                             /* size 0xBDC */
...
void EnFz_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_8093479C);
    this->actor.colChkInfo.damageTable = &D_8093477C;
    this->actor.colChkInfo.health = 3;
    temp_a1 = &this->unk148;
    sp20 = temp_a1;
    Collider_InitCylinder(globalCtx, temp_a1);
    Collider_SetCylinderType1(globalCtx, temp_a1, &this->actor, &D_809346F8);
    temp_a1_2 = &this->unk194;
    sp20 = temp_a1_2;
    Collider_InitCylinder(globalCtx, temp_a1_2);
    Collider_SetCylinderType1(globalCtx, temp_a1_2, &this->actor, &D_80934724);
    temp_a1_3 = &this->unk1E0;
    sp20 = temp_a1_3;
    Collider_InitCylinder(globalCtx, temp_a1_3);
    Collider_SetCylinderType1(globalCtx, temp_a1_3, &this->actor, &D_80934750);
...
void func_80932784(EnFz *arg0, GlobalContext *arg1) {
    ...
    if (func_800C55C4(arg1 + 0x830, (Vec3f *) &sp5C, sp38, &sp50, &sp3C, 1U, 0U, 0U, 1U, &sp40) != 0) {
        Math_Vec3f_Copy(sp38, &sp50);
    }
...
void func_809334B8(Actor *arg0, ? arg1) {
    ...
    if ((s32) temp_v0 >= 0xB) {
        ...
        sp6C = phi_f0 + 20.0f;
        SysMatrix_MultiplyVector3fByState((Vec3f *) &sp64, &sp4C);
        if ((arg0->unkBCA & 7) == 0) {
            sp3F = 1;
        }
        func_809340BC(arg0, &sp58, &sp4C, &sp40, (Vec3f *)0x40000000, (f32 *)0x41C80000, (?32) sp3C, (?32) sp3F);
        temp_f12 = sp58;
        temp_a1 = &sp58;
        sp58 = temp_f12 + (sp4C.x * 0.5f);
        sp5C += sp4C.y * 0.5f;
        sp60 += sp4C.z * 0.5f;
        func_809340BC((bitwise Actor *) temp_f12, (bitwise f32 *) sp4C.z, (Vec3f *) arg0, temp_a1, &sp4C, &sp40, 0x40000000, 0x41C80000, (s32) sp3C, 0);
    }
}
...
void func_809336C0(Actor *arg0, GlobalContext *arg1) {
    ...
    Item_DropCollectibleRandom(arg1, arg0, &arg0->world.pos, 0xA0);
...
void func_809338E0(EnFz *arg0, GlobalContext *arg1) {
    ...
    sp3F = 0;
    sp3C = 0x96;
    func_800B9010(&arg0->actor, 0x31A4U);
    ...
    func_809340BC(&arg0->actor, &sp58, &sp4C, &sp40, (Vec3f *)0x40000000, (f32 *)0x41C80000, (?32) sp3C, (?32) sp3F);
    temp_f12 = sp58;
    temp_a1 = &sp58;
    sp58 = temp_f12 + (sp4C.x * 0.5f);
    sp5C += sp4C.y * 0.5f;
...
void EnFz_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80932C98(&this->actor, globalCtx);
    ...
    if (this->unkBD8 == 0) {
        ...
        if (this->unkBCE != 0) {
            ...
            CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &sp30->base);
        }
    }
...
void EnFz_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) this->unkBA4 > 0) {
        sp4C.x = temp_v0_8->pos.x;
        sp4C.y = temp_v0_8->pos.y;
        sp4C.z = temp_v0_8->pos.z;
        sp58.unk0 = (f32) temp_v0_8->pos.x;
        sp58.unk4 = (f32) temp_v0_8->pos.y;
        sp58.unk8 = (f32) temp_v0_8->pos.z;
        sp50 += 20.0f;
        sp5C += 40.0f;
        func_800BE680(globalCtx, NULL, (Vec3f []) &sp4C, 2, this->unkBA0 * 4.0f, 0.5f, this->unkB9C, (u8) 0x14);
    }
}
...
void func_809340BC(Actor *arg0, f32 *arg1, Vec3f *arg2, f32 *arg3, f32 arg4, f32 arg5, s16 arg6, u8 arg7) {
    s16 temp_v1;
    void *phi_v0;
    s16 phi_v1;
...
loop_1:
    ...
    if (phi_v0->unk0 == 0) {
        ...
        phi_v0->unk8 = (s32) arg1->unk4;
        phi_v0->unkC = (s32) arg1->unk8;
        phi_v0->unk10 = (s32) arg2->x;
        phi_v0->unk14 = (s32) arg2->y;
        phi_v0->unk18 = (s32) arg2->z;
        phi_v0->unk1C = (s32) arg3->unk0;
        phi_v0->unk20 = (s32) arg3->unk4;
        phi_v0->unk2E = 0;
        phi_v0->unk24 = (s32) arg3->unk8;
