struct _mips2c_stack_EnDno_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnDno_Draw {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_EnDno_Init {
    /* 0x00 */ char pad_0[0x38];
    /* 0x38 */ SkelAnime *sp38;                     /* inferred */
    /* 0x3C */ char pad_3C[0x14];
};                                                  /* size = 0x50 */

struct _mips2c_stack_EnDno_Update {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ ColliderCylinder *sp2C;              /* inferred */
    /* 0x30 */ char pad_30[0x8];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80A711D0 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A71424 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A714B4 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A7153C {
    /* 0x00 */ char pad_0[0x1C];
    /* 0x1C */ f32 sp1C;                            /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A715DC {
...
struct _mips2c_stack_func_80A71788 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A71B04 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A71B58 {};              /* size 0x0 */

struct _mips2c_stack_func_80A71B68 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A71C3C {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A71E54 {};              /* size 0x0 */

struct _mips2c_stack_func_80A71F18 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A72438 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A724B8 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_80A7256C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A72598 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A725E0 {};              /* size 0x0 */

struct _mips2c_stack_func_80A725F8 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ SkelAnime *sp28;                     /* inferred */
    /* 0x2C */ char pad_2C[0xC];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80A72AE4 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A72B3C {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A72B84 {};              /* size 0x0 */

struct _mips2c_stack_func_80A72BA4 {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80A72C04 {
    /* 0x00 */ char pad_0[0x38];
    /* 0x38 */ EnDno_ActorUnkStruct *sp38;          /* inferred */
    /* 0x3C */ Vec3f *sp3C;                         /* inferred */
};                                                  /* size = 0x40 */

struct _mips2c_stack_func_80A72CF8 {
    /* 0x00 */ char pad_0[0x38];
};                                                  /* size = 0x38 */

struct _mips2c_stack_func_80A72D8C {
    /* 0x00 */ char pad_0[0x2C];
...
struct _mips2c_stack_func_80A72FAC {
    /* 0x00 */ char pad_0[0x20];
...
struct _mips2c_stack_func_80A730A0 {
    /* 0x00 */ char pad_0[0x2C];
...
struct _mips2c_stack_func_80A73244 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80A732C8 {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ SkelAnime *sp28;                     /* inferred */
...
struct _mips2c_stack_func_80A7361C {};              /* size 0x0 */

struct _mips2c_stack_func_80A73654 {
...
void func_80A711D0(Actor *arg0, GlobalContext *arg1, ? *arg2); /* static */
...
static struct_80B8E1A8 D_80A739A0[20] = {
...
static InitChainEntry D_80A73B38[2];                /* unable to generate initializer */
static Vec3f D_80A73B40 = {0.0f, 0.0f, 0.0f};

void func_80A711D0(Actor *arg0, GlobalContext *arg1, ? *arg2) {
    f32 temp_f2;

    temp_f2 = Rand_ZeroOne() * 0.5f;
    Lights_PointGlowSetInfo(arg0 + 0x440, (s16) (s32) arg2->unk_0, (s16) (s32) arg2->unk_4, (s16) (s32) arg2->unk_8, (u8) (u32) ((127.5f * temp_f2) + 127.5f), (u8) (u32) ((100.0f * temp_f2) + 100.0f), (u8) (u32) ((40.0f * temp_f2) + 40.0f), (s16) 0x140);
}
...
void func_80A7153C(void *arg0, void *arg1, void *arg2) {
    ...
    temp_f0 = Math_SinS(arg0->unk_16);
    temp_f2 = arg2->unk_0 - arg0->unk_8;
    temp_f12 = arg2->unk_8 - arg0->unk_10;
    temp_f8 = temp_f2 * temp_f0;
    arg1->unk_0 = (f32) ((temp_f2 * sp1C) - (temp_f12 * temp_f0));
    arg1->unk_8 = (f32) ((temp_f12 * sp1C) + temp_f8);
    arg1->unk_4 = (f32) (arg2->unk_4 - arg0->unk_C);
}
...
block_5:
    phi_s0 = phi_s0_2;
    if (phi_s0_2 == 0) {
        Actor_ProcessInitChain((Actor *) this, D_80A73B38);
    ...
    if ((*(gBitFlags + 0x18) & gSaveContext.inventory.questItems) != 0) {
        if ((gSaveContext.weekEventReg[27] & 1) != 0) {
            if ((this->unk_3B0 & 0x20) == 0) {
                ...
                this->actor.shape.rot.y = Actor_YawBetweenActors((Actor *) this, this->unk_460);
            }
        } else {
...
block_9:
    ...
    case 15:
        ...
        /* fallthrough */
    case 6:
        Math_SmoothStepToS(&this->actor.shape.rot.y, Actor_YawBetweenActors((Actor *) this, this->unk_460), 2, 0xE38, (s16) 0x222);
        goto block_9;
    }
        ...
        if (((this->unk_3B0 & 0x10) == 0) || (Math_ScaledStepToS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 0xE38) != 0)) {
            ...
            if (temp_a1 != 0x80B) {
                ...
                if ((temp_v0_2 == 4) && (this->skelAnime.animFrameCount == this->skelAnime.animCurrentFrame)) {
                    ...
                    func_801518B0(globalCtx, this->unk_464, (Actor *) this);
                    return;
                }
        ...
        if (globalCtx->msgCtx.unk11F04 == 0x80B) {
            ...
            if (temp_v0_3 != 0xA) {
                if (temp_v0_3 == 0x10) {
                    ...
                    Math_ScaledStepToS(&this->actor.shape.rot.y, Actor_YawBetweenActors((Actor *) this, this->unk_460), 0x71C);
                    return;
                }
                /* Duplicate return node #59. Try simplifying control flow for better match */
                return;
...
void func_80A725F8(EnDno *this, GlobalContext *globalCtx) {
    ...
    case 0:                                         /* switch 1 */
        ...
        if ((temp_v0_3 == 5) && (sp28 = temp_a0, (func_801378B8(temp_a0, this->skelAnime.animFrameCount) != 0))) {
            if (Flags_GetSwitch(globalCtx, ((s32) this->actor.params >> 7) & 0x7F) != 0) {
                func_801518B0(globalCtx, 0x801U, (Actor *) this);
            } else if (Player_GetMask(globalCtx) == 0x13) {
                func_801518B0(globalCtx, 0x806U, (Actor *) this);
            } else {
                func_801518B0(globalCtx, 0x800U, (Actor *) this);
            }
        ...
        if (((temp_v0_4 == 0x800) || (temp_v0_4 == 0x801)) && (this->unk_32C == 8)) {
            ...
            if (temp_f0 <= 23.0f) {
                ...
                if (func_801378B8(&this->skelAnime, 23.0f) != 0) {
                    Audio_PlayActorSound2((Actor *) this, 0x2952U);
                }
            ...
            if (func_801378B8(temp_a0_2, this->skelAnime.animFrameCount) != 0) {
                ...
                func_801518B0(globalCtx, 0x803U, (Actor *) this);
                return;
            }
            /* Duplicate return node #53. Try simplifying control flow for better match */
            return;
    ...
    case 6:                                         /* switch 1 */
        ...
        case 2050:                                  /* switch 2 */
            if (func_80147624(globalCtx) != 0) {
                ...
                func_800B8A1C((Actor *) this, globalCtx, this->unk_458, 60.0f, 60.0f);
                func_801477B4(globalCtx);
...
void func_80A72C04(EnDno *this, GlobalContext *globalCtx) {
    ...
    sp3C = temp_a0;
    Math_Vec3f_Copy(temp_a0, (Vec3f *) &this->actor.world);
    temp_a3 = &this->unk_340;
    sp38 = temp_a3;
    func_8013DCE0(globalCtx, sp3C, (Actor *) this, temp_a3, globalCtx->setupPathList, this->actor.params & 0x7F, 1, 0, 1, 0);
...
void func_80A72CF8(EnDno *this, GlobalContext *globalCtx) {
    ...
    temp_a1 = this;
    this = temp_a1;
    Actor_UpdateBgCheckInfo(globalCtx, (Actor *) temp_a1, 0.0f, 0.0f, 0.0f, 4U);
    Actor_SpawnAsChild(&globalCtx->actorCtx, (Actor *) this, globalCtx, 0x38, this->actor.world.pos.x + 80.0f, this->actor.floorHeight, this->actor.world.pos.z, (s16) 0, (s16) 0, (s16) 0, 0x201);
}
...
void func_80A730A0(EnDno *this, GlobalContext *globalCtx) {
    ...
    Math_Vec3f_Copy((Vec3f *) temp_a0_2, &this->unk_334);
    ...
    func_800B9010((Actor *) this, 0x2153U);
    if ((this->unk_340.unk_1C & 0x20) != 0) {
        Math_Vec3f_Copy((Vec3f *) temp_a0_2, &this->unk_340.unk_20);
        ...
        if (temp_v0 == 3) {
            ...
            if (func_801378B8(temp_a0, this->skelAnime.animFrameCount) != 0) {
                ...
                if (func_801378B8(sp28, 4.0f) != 0) {
                    Audio_PlayActorSound2((Actor *) this, 0x295EU);
                    this->unk_452 = 4;
...
void func_80A73408(Actor *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x1DBU) != 0) {
        ...
        temp_t8 = temp_v0 * 4;
        sp2C = temp_v0;
        temp_v1 = *(arg1 + temp_t8)->unk_1F4C;
        if (arg0->unk_468 != temp_v1) {
            if (temp_v1 != 1) {
                phi_a2 = 0x11;
                if (temp_v1 != 2) {
                    sp33 = 0;
...
void EnDno_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80A73408((Actor *) this, globalCtx);
    ...
    Actor_SetHeight((Actor *) this, 51.0f);
}

void EnDno_Draw(Actor *thisx, GlobalContext *globalCtx) {
    EnDno *this = (EnDno *) thisx;
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, func_80A7361C, func_80A73654, (Actor *) this);
}
...
block_24:
    ...
    if (((actor->unk_3B0 & 1) != 0) && (limbIndex == 0x1A)) {
        ...
        SysMatrix_MultiplyVector3fByState(&D_80A73B40, (Vec3f *) &sp84);
