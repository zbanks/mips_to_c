...
void func_80A711D0(Actor *arg0, GlobalContext *arg1, ? *arg2) {
    ...
    Lights_PointGlowSetInfo(arg0 + 0x440, (s16) (s32) arg2->unk0, (s16) (s32) arg2->unk4, (s16) (s32) arg2->unk8, (u8) (u32) ((127.5f * temp_f2) + 127.5f), (u8) (u32) ((100.0f * temp_f2) + 100.0f), (u8) (u32) ((40.0f * temp_f2) + 40.0f), (s16) 0x140);
}
...
void EnDno_Init(EnDno *this, GlobalContext *globalCtx) {
    SkelAnime *sp38;
    Actor *temp_v0;
    Actor *temp_v0_3;
...
void EnDno_Destroy(EnDno *this, GlobalContext *globalCtx) {
...
void EnDno_Update(EnDno *this, GlobalContext *globalCtx) {
...
void EnDno_Draw(EnDno *this, GlobalContext *globalCtx) {
    EnDno *this = (EnDno *) thisx;
