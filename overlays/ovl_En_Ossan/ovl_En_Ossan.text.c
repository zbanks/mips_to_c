...
struct _mips2c_stack_EnOssan_Hello {
    ...
    /* 0x2C */ char pad2C[0x7];                     /* maybe part of sp28[2]? */
...
block_11:
        if ((sp24 == 0xA) && (this->actor.params == 1) && (sp28->unk14B == 2) && (func_80147624(globalCtx) != 0)) {
            this->animationIdx = 9;
...
block_14:
        if ((this->actor.params == 1) && (sp2C->unk14B != 2)) {
            Math_SmoothStepToS(&this->headRotPartTimeWorker.y, 0x1F40, 3, 0x7D0, (s16) 0);
        }
    }
}
...
void EnOssan_DrawCuriosityShopMan(EnOssan *this, GlobalContext *globalCtx) {
...
void EnOssan_DrawPartTimeWorker(EnOssan *this, GlobalContext *globalCtx) {
    GraphicsContext *sp3C;
    Gfx *sp34;
    Gfx *temp_v0;
    GraphicsContext *temp_a0;
