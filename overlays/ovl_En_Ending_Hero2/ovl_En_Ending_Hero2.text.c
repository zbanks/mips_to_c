...
void EnEndingHero2_Init(EnEndingHero2 *this, GlobalContext *globalCtx) {
...
void EnEndingHero2_Destroy(EnEndingHero2 *this, GlobalContext *globalCtx) {
    EnEndingHero2 *this = (EnEndingHero2 *) thisx;
...
void EnEndingHero2_Update(EnEndingHero2 *this, GlobalContext *globalCtx) {
    EnEndingHero2 *this = (EnEndingHero2 *) thisx;
...
void EnEndingHero2_Draw(EnEndingHero2 *this, GlobalContext *globalCtx) {
    EnEndingHero2 *this = (EnEndingHero2 *) thisx;
