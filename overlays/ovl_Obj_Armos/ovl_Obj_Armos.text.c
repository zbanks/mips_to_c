typedef struct ObjArmos {
    ...
    /* 0x1A6 */ char pad1A6[0x4E];                  /* maybe part of unk1A0[14]? */
    /* 0x1F4 */ Vec3s unk1F4;                       /* inferred */
    /* 0x1FA */ char pad1FA[0x4E];                  /* maybe part of unk1F4[14]? */
    /* 0x248 */ void (*actionFunc)(ObjArmos *, GlobalContext *);
    /* 0x24C */ u32 unk24C;                         /* inferred */
    ...
    /* 0x266 */ char pad266[0xE];                   /* maybe part of unk264[8]? */
} ObjArmos;                                         /* size = 0x274 */
...
void ObjArmos_Init(ObjArmos *this, GlobalContext *globalCtx) {
    s32 sp44;
    s32 sp40;
    f32 sp3C;
    SkelAnime *sp30;
...
void ObjArmos_Destroy(ObjArmos *this, GlobalContext *globalCtx) {
    ObjArmos *this = (ObjArmos *) thisx;
...
void ObjArmos_Update(ObjArmos *this, GlobalContext *globalCtx) {
    s32 sp2C;
    ...
    if (temp_v0 != 0) {
        ...
        this->actor.floorHeight = func_800C411C(sp28, &this->actor.floorPoly, &sp2C, (Actor *) this, (Vec3f *) &this->unk250);
    }
}
...
void func_809A5A3C(ObjArmos *arg0, GraphicsContext **arg1) {
    ...
    if (arg0->actor.floorPoly != 0) {
        ...
        func_800C0094(arg0->actor.floorPoly, arg0->unk250, arg0->actor.floorHeight, arg0->unk258, (MtxF *) &sp48);
...
void ObjArmos_Draw(ObjArmos *this, GlobalContext *globalCtx) {
    ObjArmos *this = (ObjArmos *) thisx;
