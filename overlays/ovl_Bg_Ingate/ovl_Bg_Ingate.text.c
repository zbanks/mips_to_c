typedef struct BgIngate {
    ...
    /* 0x164 */ Path *unk164;                       /* inferred */
    /* 0x168 */ char pad168[0x4];
    /* 0x16C */ s16 unk16C;                         /* inferred */
    /* 0x16E */ char pad16E[0x22];                  /* maybe part of unk16C[18]? */
} BgIngate;                                         /* size = 0x190 */
...
? func_80953BEC(Actor *arg0) {
    ...
    func_8013AF00((void *) &sp74, 3, arg0->unk164->count + 3);
    temp_v1 = arg0 + 0x170;
    phi_v1 = temp_v1;
    if ((arg0->unk160 & 1) == 0) {
        temp_t0 = arg0 + 0x188;
        sp50.unk0 = D_801D15B0.x;
        temp_a1 = arg0 + 0x17C;
        sp50.unk4 = (f32) D_801D15B0.y;
        temp_a2 = arg0 + 0x18C;
        sp50.unk8 = (f32) D_801D15B0.z;
        sp40 = temp_t0;
        sp44 = temp_a2;
        sp48 = temp_a1;
        func_8013B6B0(arg0->unk164, temp_a1, temp_a2, arg0->unk184, arg0->unk180, temp_t0, (void *) &sp74, (Vec3f *) &sp50, (s16) (s32) arg0->unk168);
        ...
        sp50.unk0 = temp_v1->x;
        sp50.unk4 = (f32) temp_v1->y;
        sp50.unk8 = (f32) temp_v1->z;
        phi_a1 = arg0 + 0x17C;
        phi_a2 = arg0 + 0x18C;
        phi_t0 = arg0 + 0x188;
    }
    ...
    sp3C = phi_v1;
    if (func_8013B6B0(arg0->unk164, phi_a1, phi_a2, arg0->unk184, arg0->unk180, phi_t0, (void *) &sp74, phi_v1, (s16) (s32) arg0->unk168) != 0) {
        arg0->unk160 = (u16) (arg0->unk160 | 2);
    } else {
        sp68.unk0 = (f32) arg0->world.pos.x;
        sp68.unk4 = (s32) arg0->world.pos.y;
        sp68.unk8 = (f32) arg0->world.pos.z;
        sp5C.unk0 = (f32) phi_v1->x;
        sp5C.unk4 = (f32) phi_v1->y;
        sp5C.unk8 = (f32) phi_v1->z;
