...
void EnWizBrock_Init(EnWizBrock *this, GlobalContext *globalCtx) {
...
void EnWizBrock_Destroy(EnWizBrock *this, GlobalContext *globalCtx) {
    EnWizBrock *this = (EnWizBrock *) thisx;
...
void EnWizBrock_Update(EnWizBrock *this, GlobalContext *globalCtx) {
    EnWizBrock *this = (EnWizBrock *) thisx;
    this->actionFunc(this, globalCtx);
}

void EnWizBrock_Draw(EnWizBrock *this, GlobalContext *globalCtx) {
