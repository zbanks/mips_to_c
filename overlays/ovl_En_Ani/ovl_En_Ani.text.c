...
void func_809680B0(EnAni *arg0, GlobalContext *arg1); /* static */
...
static InitChainEntry D_8096869C;                   /* unable to generate initializer */
...
typedef struct EnAni {
    ...
    /* 0x0226 */ char pad226[0x5A];                 /* maybe part of unk220[16]? */
    /* 0x0280 */ Vec3s unk280;                      /* inferred */
    /* 0x0286 */ char pad286[0x5A];                 /* maybe part of unk280[16]? */
    /* 0x02E0 */ Vec3s unk2E0;                      /* inferred */
    /* 0x02E6 */ Vec3s unk2E6;                      /* inferred */
    /* 0x02EC */ u16 unk2EC;                        /* inferred */
    /* 0x02EE */ s16 unk2EE;                        /* inferred */
    /* 0x02F0 */ s16 unk2F0;                        /* inferred */
    /* 0x02F2 */ char pad2F2[0x2];                  /* maybe part of unk2F0[2]? */
    /* 0x02F4 */ void (*actionFunc)(EnAni *, GlobalContext *);
    /* 0x02F8 */ s16 unk2F8;                        /* inferred */
    /* 0x02FA */ s16 unk2FA;                        /* inferred */
    /* 0x02FC */ void (*unk2FC)(EnAni *, GlobalContext *); /* inferred */
} EnAni;                                            /* size 0x300 */
...
void func_80967A48(void *arg0) {
    ...
    arg0->unk2F4 = func_80967AB4;
    arg0 = arg0;
    arg0->unk2FA = Rand_S16Offset(0x14, 0x14);
}
...
void func_80967AB4(void *arg0) {
    ...
    arg0->unk2F4 = func_80967A48;
    arg0 = arg0;
    arg0->unk2FA = Rand_S16Offset(0xA, 0xA);
}
...
void EnAni_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    temp_a1 = &this->unk1DC;
    sp40 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_060028A0, &D_06009D34, &this->unk220, &this->unk280, 0x10);
    ...
    sp3C = temp_a1_2;
    Collider_InitAndSetCylinder(globalCtx, temp_a1_2, &this->actor, &D_80968670);
...
void func_80967DCC(void *arg0, void *arg1) {
    SkelAnime_FrameUpdateMatrix(arg0 + 0x1DC);
    if ((func_80152498(arg1 + 0x4908) == 2) && (arg1->unk1680C == 0x6DE)) {
        arg0->unk2FC = func_80967E34;
    }
}
...
void EnAni_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp38 = temp_a1_3;
    CollisionCheck_SetOC(globalCtx, temp_a1_3, &sp3C->base);
    if ((this->unk2EC & 1) == 0) {
        CollisionCheck_SetOC(globalCtx, temp_a1_3, &sp34->base);
    }
    ...
    if ((this->actor.xzDistToPlayer < 100.0f) && ((this->unk2EC & 4) == 0)) {
        func_800E9250(globalCtx, &this->actor, &this->unk2E0, &this->unk2E6, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        this->unk2E6.z = 0;
        temp_v1 = this->unk2E6.z;
        this->unk2E6.y = temp_v1;
        this->unk2E6.x = temp_v1;
    } else {
    ...
    if ((temp_v0 & 8) != 0) {
        ...
        if (ActorCutscene_GetCanPlayNext((s16) temp_a0) != 0) {
            ...
            func_800E02AC(Play_GetCamera(globalCtx, ActorCutscene_GetCurrentCamera((s16) this->actor.cutscene)), &this->actor);
            return;
        }
...
void EnAni_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp34 = temp_v0;
    sp34->words.w1 = Lib_SegmentedToVirtual(*(&D_809686B0 + (this->unk2F8 * 4)));
    SkelAnime_DrawSV(globalCtx, this->unk1DC.skeleton, this->unk1DC.limbDrawTbl, (s32) this->unk1DC.dListCount, func_80968504, func_8096854C, &this->actor);
}
