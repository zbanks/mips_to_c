typedef struct EnAni {
    ...
    /* 0x226 */ char pad226[0x5A];                  /* maybe part of unk220[16]? */
...
void EnAni_Init(EnAni *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, (Actor *) this, &D_80968670);
...
void EnAni_Update(EnAni *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.xzDistToPlayer < 100.0f) && ((this->unk2EC & 4) == 0)) {
        func_800E9250(globalCtx, (Actor *) this, &this->unk2E0, &this->unk2E6, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        this->unk2E6.z = 0;
        temp_v1 = this->unk2E6.z;
        this->unk2E6.y = temp_v1;
        this->unk2E6.x = temp_v1;
    } else {
        Math_SmoothStepToS((s16 *) &this->unk2E0, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS(&this->unk2E0.y, 0, 6, 0x1838, (s16) 0x64);
        Math_SmoothStepToS((s16 *) &this->unk2E6, 0, 6, 0x1838, (s16) 0x64);
...
void EnAni_Draw(EnAni *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk1DC.skeleton, this->unk1DC.limbDrawTbl, (s32) this->unk1DC.dListCount, func_80968504, func_8096854C, (Actor *) this);
}
