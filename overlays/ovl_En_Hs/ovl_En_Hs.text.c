typedef struct EnHs {
    ...
    /* 0x23A */ char pad23A[0x5A];                  /* maybe part of unk234[16]? */
    ...
    /* 0x2A0 */ u16 unk2A0;                         /* inferred */
    /* 0x2A2 */ s16 unk2A2;                         /* inferred */
    /* 0x2A4 */ char pad2A4[0xF0];                  /* maybe part of unk2A2[121]? */
...
void EnHs_Init(EnHs *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk144, (Actor *) this, &D_80953910);
...
void EnHs_Update(EnHs *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 & 1) != 0) {
        func_800E9250(globalCtx, (Actor *) this, (Vec3s *) &this->unk294, (Vec3s *) &this->unk29A, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
        return;
    }
...
void EnHs_Draw(EnHs *this, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_8095376C, func_80953848, (Actor *) this);
}
