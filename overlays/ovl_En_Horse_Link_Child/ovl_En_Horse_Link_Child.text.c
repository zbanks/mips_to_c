typedef struct EnHorseLinkChild {
    ...
    /* 0x14C */ ? unk14C;                           /* inferred */
    /* 0x14C */ char pad14C[0x4C];
    /* 0x198 */ SkelAnime unk198;                   /* inferred */
    /* 0x1DC */ char pad1DC[0x8];
    /* 0x1E4 */ u8 unk1E4;                          /* inferred */
    /* 0x1E5 */ char pad1E5[0x3];                   /* maybe part of unk1E4[4]? */
    /* 0x1E8 */ s32 unk1E8;                         /* inferred */
    /* 0x1EC */ ColliderCylinder unk1EC;            /* inferred */
    /* 0x238 */ ColliderJntSph unk238;              /* inferred */
    /* 0x258 */ ColliderJntSphElement unk258;       /* inferred */
    /* 0x298 */ char pad298[0x4];
...
void EnHorseLinkChild_Init(EnHorseLinkChild *this, GlobalContext *globalCtx) {
    ...
    Collider_SetJntSph(globalCtx, temp_a1, (Actor *) this, &D_808DFEF8, &this->unk258);
...
void func_808DEA54(Actor *arg0, s32 arg1) {
    ...
    if (phi_a1 != arg0->unk148) {
        ...
        SkelAnime_ChangeAnim(arg0 + 0x198, D_808DFEC0[arg0->unk148], sp30, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, -5.0f);
    }
}
...
void func_808DEB14(Actor *arg0, void *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        ...
        if (phi_v0 != temp_v1) {
            ...
            SkelAnime_ChangeAnim(sp34, D_808DFEC0[arg0->unk148], sp38, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, -5.0f);
            return;
        }
        sp38 = func_808DE728(arg0);
        SkelAnime_ChangeAnim(sp34, D_808DFEC0[arg0->unk148], sp38, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, 0.0f);
...
block_22:
            if (phi_v0 != arg0->unk148) {
                ...
                SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk148], sp34, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, -5.0f);
                return;
            }
            sp34 = func_808DE728(arg0);
            SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk148], sp34, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, 0.0f);
...
void func_808DF194(Actor *arg0, void *arg1) {
    ...
    if ((phi_v1 != arg0->unk148) || (temp_a3 == 1)) {
        arg0->unk148 = phi_v1;
        sp38 = func_808DE728(arg0);
        SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk148], sp38, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, -5.0f);
        return;
    }
    sp38 = func_808DE728(arg0);
    SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk148], sp38, arg0->unk1B0, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, 0.0f);
}
...
void func_808DF560(Actor *arg0) {
    ...
    D_801BDAA4 = 0;
    sp30 = func_808DE728(arg0);
    SkelAnime_ChangeAnim(arg0 + 0x198, D_808DFEC0[arg0->unk148], sp30, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk148]), (u8) 2, 0.0f);
}
