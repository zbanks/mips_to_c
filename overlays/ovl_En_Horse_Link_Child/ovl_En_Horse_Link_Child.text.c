...
void func_808DE9A8(Actor *arg0) {
    ...
    arg0->unk_144 = 0;
    temp_a0 = arg0 + 0x198;
    temp_v0 = arg0->unk_148 + 1;
    arg0->unk_148 = temp_v0;
    phi_v0 = temp_v0;
    if (temp_v0 >= 5) {
        arg0->unk_148 = 0;
        phi_v0 = 0;
    ...
    arg0->unk_1B4 = func_808DE728(arg0);
}
...
void func_808DEA54(Actor *arg0, s32 arg1) {
    ...
    if (phi_a1 != arg0->unk_148) {
        arg0->unk_148 = phi_a1;
        sp30 = func_808DE728(arg0, phi_a1);
        SkelAnime_ChangeAnim(arg0 + 0x198, D_808DFEC0[arg0->unk_148], sp30, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, -5.0f);
    }
}
...
void func_808DEB14(Actor *arg0, void *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        ...
        if (phi_v0 != temp_v1) {
            ...
            SkelAnime_ChangeAnim(sp34, D_808DFEC0[arg0->unk_148], sp38, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, -5.0f);
            return;
        }
        sp38 = func_808DE728(arg0);
        SkelAnime_ChangeAnim(sp34, D_808DFEC0[arg0->unk_148], sp38, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, 0.0f);
...
void func_808DED40(Actor *arg0, void *arg1) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0_2) != 0) {
        ...
        if ((temp_f0 < 150.0f) && (phi_v0 = 2, (temp_f0 >= 70.0f))) {
            ...
            arg0->speedXZ = 2.0f;
block_22:
            if (phi_v0 != arg0->unk_148) {
                arg0->unk_148 = phi_v0;
                sp34 = func_808DE728(arg0);
                SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk_148], sp34, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, -5.0f);
                return;
            }
            sp34 = func_808DE728(arg0);
            SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk_148], sp34, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, 0.0f);
...
void func_808DF194(Actor *arg0, void *arg1) {
    ...
    temp_a3 = temp_v0;
    phi_v1 = temp_v1;
    if ((temp_v0 != 0) || (temp_a0_2 = arg0->unk_148, (temp_a0_2 == 1)) || (temp_a0_2 == 0)) {
        temp_a1_2 = &arg0->home;
    ...
    if ((phi_v1 != arg0->unk_148) || (temp_a3 == 1)) {
        arg0->unk_148 = phi_v1;
        sp38 = func_808DE728(arg0);
        SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk_148], sp38, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, -5.0f);
        return;
    }
    sp38 = func_808DE728(arg0);
    SkelAnime_ChangeAnim(sp30, D_808DFEC0[arg0->unk_148], sp38, arg0->unk_1B0, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, 0.0f);
}
...
void func_808DF560(Actor *arg0) {
    ...
    D_801BDAA4 = 0;
    sp30 = func_808DE728(arg0);
    SkelAnime_ChangeAnim(arg0 + 0x198, D_808DFEC0[arg0->unk_148], sp30, 0.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_808DFEC0[arg0->unk_148]), (u8) 2, 0.0f);
}
...
void func_808DF620(Actor *arg0, void *arg1) {
    ...
    sp36 = temp_a0;
    if ((Math_CosS(temp_a0) < 0.7071f) && (arg0->unk_148 == 2)) {
...
? func_808DFDC8(void *arg0, void **arg1, s32 arg2, ? arg3) {
    ...
    if (arg2 == 0xD) {
        ...
        *temp_v0 = 0xDB060020;
        sp1C = temp_v0;
        sp1C->unk_4 = Lib_SegmentedToVirtual(*(&D_808DFF48 + (*(&D_808DFF54 + arg0->unk_1E4) * 4)));
    }
    return 1;
}
