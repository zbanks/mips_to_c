typedef struct BgLastBwall {
    ...
    /* 0x238 */ u8 unk238;                          /* inferred */
    /* 0x239 */ char pad239[0x1];
...
void func_80C18240(ColliderTrisInit *arg0, Vec3f *arg1, ActorShape *arg2, ColliderTris *arg3, void *arg4) {
    ...
    if (arg0->count > 0) {
        do {
            ...
            phi_s0 = (Vec3f *) &sp6C;
loop_3:
            Math_Vec3s_ToVec3f((Vec3f *) &sp60, (*(arg4->unk4 + phi_s1) * 6) + arg4->unk0);
...
void BgLastBwall_Init(BgLastBwall *this, GlobalContext *globalCtx) {
    ColliderTris *sp2C;
    ...
    if (Collider_SetTris(globalCtx, sp2C, (Actor *) this, &D_80C18A38, &this->unk180) == 0) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    func_80C18240(&D_80C18A38, (Vec3f *) &this->actor.world, &this->actor.shape, sp2C, *(&D_80C18AC0 + (this->unk238 * 4)));
    func_8013E3B8((Actor *) this, (s16 []) &this->unk23A, 1);
    func_80C187E4(this);
}

void BgLastBwall_Destroy(BgLastBwall *this, GlobalContext *globalCtx) {
    BgLastBwall *this = (BgLastBwall *) thisx;
...
void BgLastBwall_Update(BgLastBwall *this, GlobalContext *globalCtx) {
    BgLastBwall *this = (BgLastBwall *) thisx;
    this->actionFunc(this, globalCtx);
}

void BgLastBwall_Draw(BgLastBwall *this, GlobalContext *globalCtx) {
    BgLastBwall *this = (BgLastBwall *) thisx;
