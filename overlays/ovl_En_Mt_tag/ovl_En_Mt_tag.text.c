typedef struct EnMttag {
    ...
    /* 0x148 */ char pad148[0x10];                  /* maybe part of actionFunc[5]? */
    /* 0x158 */ u16 unk158;                         /* inferred */
    /* 0x15A */ s16 unk15A;                         /* inferred */
    /* 0x15C */ char pad15C[0x8];                   /* maybe part of unk15A[5]? */
...
struct _mips2c_stack_func_809CF67C {
    ...
    /* 0x6C */ f32 sp6C;                            /* inferred */
    /* 0x70 */ char pad70[0xC];                     /* maybe part of sp6C[4]? */
    /* 0x7C */ f32 sp7C;                            /* inferred */
    /* 0x80 */ f32 sp80;                            /* inferred */
    /* 0x84 */ char pad84[0xC];                     /* maybe part of sp80[4]? */
    ...
    /* 0xAC */ char padAC[0xC];                     /* maybe part of spA8[4]? */
    /* 0xB8 */ ? spB8;                              /* inferred */
    /* 0xB8 */ char padB8[0x4];
...
void EnMttag_Init(EnMttag *this, GlobalContext *globalCtx) {
    Actor *temp_v1;
    u8 temp_t2;
    u8 temp_t4;
    u8 temp_t6;
...
void EnMttag_Destroy(EnMttag *this, GlobalContext *globalCtx) {
    EnMttag *this = (EnMttag *) thisx;
...
void EnMttag_Update(EnMttag *this, GlobalContext *globalCtx) {
    EnMttag *this = (EnMttag *) thisx;
