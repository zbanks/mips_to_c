...
s32 EffectSsBomb2_Init(GlobalContext *globalCtx, u32 index, EffectSs *this, void *initParamsx) {
    ...
    this->draw = *(&D_809787F8 + (initParamsx->unk28 * 4));
...
void func_80978304(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    SkinMatrix_SetTranslate(&sp1BC, this->pos.x, this->pos.y, this->pos.z);
    SkinMatrix_SetScale(&sp17C, temp_f20, temp_f20, 1.0f);
    SkinMatrix_MtxFMtxFMult(&sp1BC, &globalCtx->mf_187FC, &spFC);
    SkinMatrix_MtxFMtxFMult(&spFC, &sp17C, &sp13C);
    temp_v0 = SkinMatrix_MtxFToNewMtx(temp_s2, &sp13C);
    phi_f22 = 0.925f;
    if (temp_v0 != 0) {
        ...
        temp_v1->words.w1 = (u32) temp_v0;
        temp_v1->words.w0 = 0xDA380003;
        temp_v0_2 = SkinMatrix_MtxFToNewMtx(temp_s2, &sp13C);
        temp_s1 = temp_v0_2;
        if (temp_v0_2 != 0) {
            ...
            temp_v1_5->words.w0 = 0xDE000000;
            SysMatrix_FromRSPMatrix((RSPMatrix *) temp_s1, &spBC);
            SysMatrix_SetCurrentState(&spBC);
            phi_s1 = 1;
            do {
