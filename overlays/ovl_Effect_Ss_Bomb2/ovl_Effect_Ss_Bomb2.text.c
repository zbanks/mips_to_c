...
struct _mips2c_stack_func_80978138 {
    ...
    /* 0x02C */ char pad2C[0x14];                   /* maybe part of sp28[6]? */
    /* 0x040 */ f32 sp40;                           /* inferred */
    /* 0x044 */ char pad44[0x8];                    /* maybe part of sp40[3]? */
    /* 0x04C */ ? sp4C;                             /* inferred */
    /* 0x04C */ char pad4C[0x40];
    /* 0x08C */ ? sp8C;                             /* inferred */
    /* 0x08C */ char pad8C[0x40];
    /* 0x0CC */ ? spCC;                             /* inferred */
    /* 0x0CC */ char padCC[0x40];
    /* 0x10C */ ? sp10C;                            /* inferred */
    /* 0x10C */ char pad10C[0x44];
};                                                  /* size = 0x150 */

struct _mips2c_stack_func_80978304 {
    /* 0x000 */ char pad0[0xBC];
    /* 0x0BC */ ? spBC;                             /* inferred */
    /* 0x0BC */ char padBC[0x40];
    /* 0x0FC */ ? spFC;                             /* inferred */
    /* 0x0FC */ char padFC[0x40];
    /* 0x13C */ ? sp13C;                            /* inferred */
    /* 0x13C */ char pad13C[0x40];
    /* 0x17C */ ? sp17C;                            /* inferred */
    /* 0x17C */ char pad17C[0x40];
    /* 0x1BC */ ? sp1BC;                            /* inferred */
    /* 0x1BC */ char pad1BC[0x44];
};                                                  /* size = 0x200 */
