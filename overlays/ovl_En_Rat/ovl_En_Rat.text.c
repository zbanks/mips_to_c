typedef struct EnRat {
    ...
    /* 0x188 */ void (*unk188)(EnRat *, GlobalContext *); /* inferred */
    /* 0x18C */ u8 unk18C;                          /* inferred */
    /* 0x18D */ u8 unk18D;                          /* inferred */
    /* 0x18E */ char pad18E[0x2];                   /* maybe part of unk18D[3]? */
    /* 0x190 */ s16 unk190;                         /* inferred */
    /* 0x192 */ s16 unk192;                         /* inferred */
    /* 0x194 */ Vec3s unk194;                       /* inferred */
    /* 0x19A */ char pad19A[0x36];                  /* maybe part of unk194[10]? */
...
void EnRat_Init(EnRat *this, GlobalContext *globalCtx) {
    s16 temp_v1;
    s32 temp_s1;
    void **temp_s0;
    f32 phi_f4;
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk268, (Actor *) this, &D_80A58400);
...
void EnRat_Destroy(EnRat *this, GlobalContext *globalCtx) {
    EnRat *this = (EnRat *) thisx;
    if (this->actor.params == 0) {
...
void func_80A56EB8(Actor *arg0, ? *arg1, ? *arg2) {
    ...
    arg2->unk0 = (f32) (arg0->world.pos.x + (arg0->unk224 * temp_f0) + (arg0->unk218 * arg1->unk4) + (arg0->unk20C * arg1->unk8));
    arg2->unk4 = (f32) (arg0->world.pos.y + (arg0->unk228 * temp_f0) + (arg0->unk21C * arg1->unk4) + (arg0->unk210 * arg1->unk8));
    arg2->unk8 = (f32) (arg0->world.pos.z + (arg0->unk22C * temp_f0) + (arg0->unk220 * arg1->unk4) + (arg0->unk214 * arg1->unk8));
}
...
void func_80A5764C(Actor *arg0, GlobalContext *arg1) {
    ...
    if (arg0->params == 0) {
        ...
        func_800A81F0(Effect_GetParams(arg0->unk260), (Vec3f *) &sp48, (Vec3f *) &sp3C);
        func_80A56EB8(arg0, &D_80A584C0, &sp3C);
        func_800A81F0(Effect_GetParams(arg0->unk264), (Vec3f *) &sp48, (Vec3f *) &sp3C);
        goto block_22;
    }
...
void EnRat_Update(EnRat *this, GlobalContext *globalCtx) {
...
block_23:
    ...
    if ((func_80A57A9C != temp_v1_2) && (sp28 = func_80A5723C, (func_80A5723C != temp_v1_2))) {
        ...
        if (func_80A57984 != temp_v1_2) {
            ...
            if ((func_80A574E8 != this->unk188) && (func_80A56AFC((Actor *) this, (Vec3f *) globalCtx) == 0)) {
                func_80A57A08((Actor *) this, (Vec3f *) globalCtx);
                return;
            }
            if (this->unk18D != 0) {
...
block_44:
        ...
        if (sp28 != this->unk188) {
            if (this->unk192 == 0) {
                CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk268);
            }
...
void EnRat_Draw(EnRat *this, GlobalContext *globalCtx) {
    EnRat *this = (EnRat *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    func_8012C974(globalCtx->state.gfxCtx);
    func_800B8050((Actor *) this, globalCtx, 0);
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80A57F10, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80A57F4C, (Actor *) this);
}
