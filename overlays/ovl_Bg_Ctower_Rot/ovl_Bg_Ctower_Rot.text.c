...
void func_808E22EC(Actor *arg0, ? arg1) {
    if (Math_SmoothStepToF(arg0 + 0x164, 0.0f, 0.1f, 15.0f, 0.1f) == 0.0f) {
        ...
        arg0->unk_15C = func_808E22DC;
    } else if (arg0->params == 1) {
        func_800B9010(arg0, 0x201EU);
    }
    arg0->world.pos.x = (Math_SinS(arg0->world.rot.y) * arg0->unk_164) + arg0->home.pos.x;
    arg0->world.pos.z = (Math_CosS(arg0->world.rot.y) * arg0->unk_164) + arg0->home.pos.z;
}
