typedef struct EnDoor {
    ...
    /* 0x1A0 */ u8 unk_1A0;                         /* inferred */
    /* 0x1A1 */ u8 unk_1A1;                         /* inferred */
    /* 0x1A2 */ s8 unk_1A2;                         /* inferred */
    /* 0x1A3 */ u8 unk_1A3;                         /* inferred */
    /* 0x1A4 */ u8 unk_1A4;                         /* inferred */
    /* 0x1A5 */ u8 unk_1A5;                         /* inferred */
    /* 0x1A6 */ u8 unk_1A6;                         /* inferred */
    /* 0x1A7 */ s8 unk1A7;
    /* 0x1A8 */ Vec3s unk_1A8;                      /* inferred */
    /* 0x1AE */ char pad_1AE[0x1A];                 /* maybe part of unk_1A8[5]? */
    /* 0x1C8 */ void (*actionFunc)(EnDoor *, GlobalContext *);
} EnDoor;                                           /* size = 0x1CC */

struct _mips2c_stack_EnDoor_Destroy {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_EnDoor_Draw {
    /* 0x00 */ char pad_0[0x28];
    /* 0x28 */ GraphicsContext *sp28;               /* inferred */
    /* 0x2C */ char pad_2C[0x4];
};                                                  /* size = 0x30 */

struct _mips2c_stack_EnDoor_Init {
    /* 0x00 */ char pad_0[0x38];
    /* 0x38 */ ObjectContext *sp38;                 /* inferred */
    /* 0x3C */ char pad_3C[0x14];
};                                                  /* size = 0x50 */

struct _mips2c_stack_EnDoor_Update {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80866A5C {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_func_80866B20 {
    /* 0x00 */ char pad_0[0x30];
    /* 0x30 */ u8 sp30;                             /* inferred */
    /* 0x31 */ char pad_31[0x27];                   /* maybe part of sp30[40]? */
...
struct _mips2c_stack_func_80866F94 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8086704C {};              /* size 0x0 */

struct _mips2c_stack_func_80867080 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_808670F0 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_80867144 {
    /* 0x00 */ char pad_0[0x58];
};                                                  /* size = 0x58 */

struct _mips2c_stack_func_80867350 {
...
static InitChainEntry D_80867954[4];                /* unable to generate initializer */
...
void EnDoor_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain((Actor *) this, D_80867954);
    temp_t8 = ((s32) this->actor.params >> 7) & 7;
    temp_t0 = this->actor.params & 0x7F;
    this->unk_1A4 = temp_t8;
    this->unk_1A5 = temp_t0;
    phi_s0 = D_8086782C;
    ...
    SkelAnime_Init(globalCtx, &this->unk_15C, &D_04022B28, &D_04020658, temp_v0, temp_v0, 5);
    phi_v0 = 0;
    if (this->unk_1A4 == 5) {
        phi_s0_2 = (this->unk_1A5 * 6) + 0x66 + D_8086782C;
    } else {
loop_6:
        phi_v0_2 = phi_v0;
        phi_s0_4 = phi_s0;
    ...
    this->unk_1A2 = phi_v0_3;
    this->unk_1A3 = phi_s0_3->unk_2;
    if (this->unk_1A2 == this->actor.objBankIndex) {
        func_80866A5C(this, globalCtx);
    } else {
        this->actionFunc = func_80866A5C;
    }
    Actor_SetHeight((Actor *) this, 35.0f);
}
...
void func_80866A5C(EnDoor *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg1;
    arg1 = temp_a2;
    if (Object_IsLoaded(&temp_a2->objectCtx, (s32) arg0->unk_1A2) != 0) {
        temp_v0 = arg0->unk_1A4;
        arg0->actionFunc = func_80866B20;
        arg0->actor.world.rot.y = 0;
        arg0->actor.objBankIndex = arg0->unk_1A2;
        if (temp_v0 == 1) {
            if (Flags_GetSwitch(arg1, (s32) arg0->unk_1A5) == 0) {
                arg0->unk_1A6 = 0xA;
                return;
            }
        ...
        if ((temp_v0 == 4) && (Actor_XZDistanceBetweenActors((Actor *) arg0, arg1->actorCtx.actorList[2].first) > 120.0f)) {
...
void func_80866B20(EnDoor *arg0, GlobalContext *arg1) {
    ...
    if ((func_800B84D0((Actor *) temp_a3, arg1) != 0) && (arg0->actor.textId == 0x1821)) {
        D_80867BC0 = 1;
    }
    temp_a0 = &arg0->unk_15C;
    if (arg0->unk_1A1 != 0) {
        arg0->actionFunc = func_80867144;
        if ((sp64->unk_A6C * 0x10) < 0) {
            phi_f0 = 0.75f;
        } else {
            phi_f0 = 1.5f;
        }
        temp_t8 = arg0->unk_1A0;
        arg0 = arg0;
        SkelAnime_ChangeAnimPlaybackStop(temp_a0, *(&D_80867964 + (temp_t8 * 4)), phi_f0);
        if (arg0->unk_1A6 != 0) {
            temp_t5 = gSaveContext.mapIndex;
            gSaveContext.inventory.dungeonKeys[temp_t5] += -1;
            temp_a1 = arg0->unk_1A5;
            arg0 = arg0;
    ...
    if (arg0->unk1A7 != 0) {
        ...
        Audio_PlayActorSound2((Actor *) arg0, 0x2800U);
        return;
    }
    arg0 = arg0;
    if (func_801233E4(arg1) == 0) {
        temp_a0_2 = arg0;
        arg0 = arg0;
        Actor_CalcOffsetOrientedToDrawRotation((Actor *) temp_a0_2, (Vec3f *) &sp58, (Vec3f *) &sp64->world);
        if ((D_80867BC0 != 0) || ((fabsf(sp5C) < 20.0f) && (fabsf(sp58) < 20.0f) && (fabsf(sp60) < 50.0f))) {
            ...
            if (phi_v1 < 0x3000) {
                ...
                if (arg0->unk_1A6 != 0) {
                    ...
                    } else if ((temp_a0_4 == 5) && (sp60 > 0.0f)) {
                        temp_t9 = arg0->unk_1A5;
                        arg0 = arg0;
                        if (func_80133038(arg1, *(&D_8086778C + (temp_t9 * 4)), (struct_80133038_arg2 *) &sp30) != 0) {
                            temp_t6 = sp30 + 0x1800;
        ...
        if (arg0->unk_1A4 == 4) {
            ...
            if (arg0->actor.xzDistToPlayer > 240.0f) {
                arg0 = arg0;
                Audio_PlayActorSound2((Actor *) temp_a0_3, 0x2800U);
...
void func_80866F94(EnDoor *arg0, GlobalContext *arg1) {
    ...
    if (Math_ScaledStepToS(temp_a0, 0, 0x7D0) != 0) {
        arg0->actionFunc = func_80866B20;
        Audio_PlayActorSound2((Actor *) arg0, 0x2878U);
    }
}
...
void func_808670F0(EnDoor *arg0, GlobalContext *arg1) {
    if (Math_ScaledStepToS(&arg0->actor.world.rot.y, 0, 0x700) != 0) {
        Audio_PlayActorSound2((Actor *) arg0, 0x2801U);
        arg0->actionFunc = func_80866B20;
    }
}
...
void func_80867144(EnDoor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_1A6;
    temp_s0 = &arg0->unk_15C;
    temp_t6 = temp_v0 - 1;
    if (temp_v0 == 0) {
        phi_v1 = 0;
    } else {
        arg0->unk_1A6 = temp_t6;
        phi_v1 = temp_t6 & 0xFF;
    }
    if (phi_v1 == 0) {
        ...
        temp_t9 = *(&D_8086798C + arg0->unk_1A0);
        temp_f4 = (f32) temp_t9;
        phi_f4 = temp_f4;
        if ((s32) temp_t9 < 0) {
            phi_f4 = temp_f4 + 4294967296.0f;
        }
        if (func_801378B8(temp_s0, phi_f4) != 0) {
            Audio_PlayActorSound2((Actor *) arg0, 0x5802U);
            if ((arg0->unk_15C.animPlaybackSpeed < 1.5f) && (temp_s1 = (s32) (Rand_ZeroOne() * 30.0f) + 0x32, phi_s0 = 0, (temp_s1 > 0))) {
                do {
                    EffectSsBubble_Spawn(arg1, (Vec3f *) &arg0->actor.world, 60.0f, 100.0f, 50.0f, 0.15f);
                    temp_s0_2 = phi_s0 + 1;
                    phi_s0 = temp_s0_2;
        ...
        temp_t2 = *(&D_80867998 + arg0->unk_1A0);
        temp_f6 = (f32) temp_t2;
        phi_f6 = temp_f6;
        if ((s32) temp_t2 < 0) {
            phi_f6 = temp_f6 + 4294967296.0f;
        }
        if (func_801378B8(temp_s0, phi_f6) != 0) {
            Audio_PlayActorSound2((Actor *) arg0, 0x2801U);
        }
        /* Duplicate return node #18. Try simplifying control flow for better match */
    }
...
s32 func_80867350(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    if (arg1 == 4) {
        temp_a2 = (arg5->unk_1A3 * 8) + &D_808679A4;
        phi_v0 = NULL;
        phi_v0_2 = (s32) NULL;
        if (arg5->unk_1A4 != 7) {
        ...
        if ((arg5->unk_1A4 == 7) || ((s32) arg0->roomCtx.prevRoom.num >= 0) || (temp_a0 = phi_v0->unk_0, (temp_a0 == phi_v0->unk_2))) {
            sp1C = temp_a2;
            temp_a0_2 = (arg5->shape.rot.y + arg5->unk_17C->unk_16 + arg4->z) - Math_Vec3f_Yaw(arg0 + 0xE0, arg5 + 0x24);
...
void EnDoor_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_1A2 == this->actor.objBankIndex) {
        ...
        if ((this->unk_1A4 == 7) && (this->unk_1A5 == 0)) {
            sp28 = temp_a0;
        ...
        sp28 = sp28;
        SkelAnime_Draw(globalCtx, this->unk_15C.skeleton, this->unk_15C.limbDrawTbl, func_80867350, NULL, (Actor *) this);
