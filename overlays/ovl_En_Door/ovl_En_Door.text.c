...
struct _mips2c_stack_func_80866B20 {
    ...
    /* 0x31 */ char pad31[0x27];                    /* maybe part of sp30[40]? */
...
void EnDoor_Init(EnDoor *this, GlobalContext *globalCtx) {
    ...
    temp_v0 = &this->unk1A8;
    SkelAnime_Init(globalCtx, &this->unk15C, &D_04022B28, &D_04020658, temp_v0, temp_v0, 5);
    phi_v0 = 0;
    if (this->unk1A4 == 5) {
        phi_s0_2 = (this->unk1A5 * 6) + 0x66 + D_8086782C;
    } else {
loop_6:
        phi_v0_2 = phi_v0;
        phi_s0_4 = phi_s0;
    ...
    this->unk1A2 = phi_v0_3;
    this->unk1A3 = phi_s0_3->unk2;
...
void func_80866A5C(EnDoor *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg1;
    arg1 = temp_a2;
    if (Object_IsLoaded(&temp_a2->objectCtx, (s32) arg0->unk1A2) != 0) {
        temp_v0 = arg0->unk1A4;
        arg0->actionFunc = func_80866B20;
        arg0->actor.world.rot.y = 0;
        arg0->actor.objBankIndex = arg0->unk1A2;
        if (temp_v0 == 1) {
            if (Flags_GetSwitch(arg1, (s32) arg0->unk1A5) == 0) {
                arg0->unk1A6 = 0xA;
                return;
            }
...
void func_80867144(EnDoor *arg0, GlobalContext *arg1) {
    ...
    if (phi_v1 == 0) {
        ...
        temp_t9 = *(&D_8086798C + arg0->unk1A0);
        temp_f4 = (f32) temp_t9;
        phi_f4 = temp_f4;
        if ((s32) temp_t9 < 0) {
        ...
        if (func_801378B8(temp_s0, phi_f4) != 0) {
            ...
            if ((arg0->unk15C.animPlaybackSpeed < 1.5f) && (temp_s1 = (s32) (Rand_ZeroOne() * 30.0f) + 0x32, phi_s0 = 0, (temp_s1 > 0))) {
                do {
        ...
        temp_t2 = *(&D_80867998 + arg0->unk1A0);
        temp_f6 = (f32) temp_t2;
        phi_f6 = temp_f6;
        if ((s32) temp_t2 < 0) {
...
void EnDoor_Draw(EnDoor *this, GlobalContext *globalCtx) {
    ...
    if (this->unk1A2 == this->actor.objBankIndex) {
        ...
        if ((this->unk1A4 == 7) && (this->unk1A5 == 0)) {
            sp28 = temp_a0;
        ...
        sp28 = sp28;
        SkelAnime_Draw(globalCtx, this->unk15C.skeleton, this->unk15C.limbDrawTbl, func_80867350, NULL, (Actor *) this);
