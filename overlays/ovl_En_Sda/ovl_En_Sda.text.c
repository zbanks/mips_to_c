    ...
    do {
        if ((arg2 == 0.0f) || (temp_t3 = *(&D_80947ACC + (phi_s3 * 2)), phi_t3 = temp_t3, phi_t3_7 = temp_t3, ((s32) temp_t3 >= 0))) {
            ...
            if (arg2 > 0.0f) {
                ...
                sp88 = (((temp_v0->unk0 - temp_f0) * arg2) + temp_f0) - arg0->unk24;
                sp8C = (((f32) temp_a0->data[2448] + ((((temp_v0->unk4 - temp_f2) * arg2) + temp_f2) - arg0->unk28) + 76.0f + 30.0f) - 105.0f) + 15.0f;
                sp90 = (((temp_v0->unk8 - temp_f12) * arg2) + temp_f12) - arg0->unk2C;
            } else {
                temp_v1_2 = &D_80947EA0 + (phi_s3 * 0xC);
                sp88 = temp_v1_2->unk0 - arg0->unk24;
                sp8C = (((f32) temp_a0->data[2448] + (temp_v1_2->unk4 - arg0->unk28) + 76.0f + 30.0f) - 105.0f) + 15.0f;
                sp90 = temp_v1_2->unk8 - arg0->unk2C;
            }
            SysMatrix_MultiplyVector3fByState((Vec3f *) &sp88, &sp7C);
            temp_a0_2 = gGameInfo;
            temp_v0_2 = *(&D_80947AEC + phi_s3);
            temp_f8 = sp7C.x * (1.0f + ((f32) temp_a0_2->data[2449] / 100.0f));
            sp7C.x = temp_f8;
            temp_f10 = sp7C.y * (1.0f + ((f32) temp_a0_2->data[2449] / 100.0f));
            sp7C.y = temp_f10;
...
void func_8094702C(Gfx *arg0, Actor *arg1, GlobalContext *arg2, ? arg3) {
    ...
    do {
        ...
        if ((s32) temp_v0_2 >= 0) {
            ...
            temp_t6->unk0 = (s32) temp_t8->unkBEC;
            temp_t6->unk4 = (s32) temp_t8->unkBF0;
            temp_t6->unk8 = (s32) temp_t8->unkBF4;
        }
        temp_s3_3 = phi_s3_3 + 1;
        phi_s3_3 = temp_s3_3;
    } while ((s32) temp_s3_3 < 0x12);
    temp_f2 = D_80947EA0.unk0;
    temp_f12 = D_80947EA0.unk8;
    D_80947EA0.unk4 = (f32) (D_80947EA0.unk4 + 3.0f);
    temp_f0 = D_80947EA0.unk4;
    D_80947EA0.unkB4 = (f32) (((D_80947EA0.unkB4 - temp_f2) * 1.2f) + temp_f2);
    D_80947EA0.unkB8 = (f32) (((D_80947EA0.unkB8 - temp_f0) * -1.2f) + temp_f0);
    D_80947EA0.unkBC = (f32) (((D_80947EA0.unkBC - temp_f12) * 1.2f) + temp_f12);
    do {
    ...
    temp_s2 = arg2 + 0xD04;
    if (arg0->unk1C != 1) {
        func_8018219C(temp_s2, &sp178, 0);
        temp_v1_2 = gGameInfo;
        sp178.y = sp178.y + (temp_v1_2->data[1335] << 0xF) + 0x8000;
        sp178.x *= temp_v1_2->data[1336] - 1;
        SysMatrix_InsertMatrix(temp_s2, 0);
        SysMatrix_MultiplyVector3fByState(&D_80947A60, &sp16C);
        Matrix_RotateY(sp178.y, 0U);
        SysMatrix_InsertXRotation_s(sp178.x, 1);
        do {
            temp_lo = phi_s3_5 * 0xC;
            SysMatrix_MultiplyVector3fByState(temp_lo + &D_80947B10, &sp188);
            temp_v1_3 = gGameInfo;
            temp_v0_3 = &sp64 + temp_lo;
            temp_s3_5 = phi_s3_5 + 1;
            temp_v0_3->unk0 = (f32) (((((f32) temp_v1_3->data[1330] / 100.0f) + 4.0f) * sp188.x) + sp16C.x);
            temp_v0_3->unk4 = (f32) (((((f32) temp_v1_3->data[1330] / 100.0f) + 4.0f) * sp188.y) + sp16C.y);
            temp_v0_3->unk8 = (f32) (((((f32) temp_v1_3->data[1330] / 100.0f) + 4.0f) * sp188.z) + sp16C.z);
            phi_s3_5 = temp_s3_5;
        ...
        do {
            ...
            sp194 = temp_v0_4->unk0 - arg2->unk24;
            sp198 = (f32) gGameInfo->data[1328] + (temp_v0_4->unk4 - arg2->unk28) + 16.0f;
            sp19C = temp_v0_4->unk8 - arg2->unk2C;
            SysMatrix_MultiplyVector3fByState((Vec3f *) temp_a0, &sp188);
            temp_v1_4 = gGameInfo;
            temp_s3_6 = phi_s3_6 + 1;
            temp_f16 = sp188.x * (1.0f + ((f32) temp_v1_4->data[1338] / 100.0f));
            sp188.x = temp_f16;
            temp_f10 = sp188.y * (1.0f + ((f32) temp_v1_4->data[1338] / 100.0f));
...
void func_80947668(u32 arg0, Actor *arg1, GlobalContext *arg2) {
    ...
    if ((s32) gGameInfo->data[1326] > 0) {
        do {
            ...
            temp_s2->polyXlu.p = temp_v1_12 + 8;
