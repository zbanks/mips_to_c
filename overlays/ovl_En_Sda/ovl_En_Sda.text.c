...
void func_8094702C(Gfx *arg0, Actor *arg1, GlobalContext *arg2, ? arg3) {
    ...
    if (arg0->unk1C != 1) {
        ...
        do {
            ...
            temp_v0_3->unk0 = (f32) (((((f32) temp_v1_3->data[1330] / 100.0f) + 4.0f) * sp188) + sp16C);
            temp_v0_3->unk4 = (f32) (((((f32) temp_v1_3->data[1330] / 100.0f) + 4.0f) * sp18C) + sp170);
            temp_v0_3->unk8 = (f32) (((((f32) temp_v1_3->data[1330] / 100.0f) + 4.0f) * sp190) + sp174);
            phi_s3_5 = temp_s3_5;
