typedef struct EnZow {
    ...
    /* 0x31C */ char pad31C[0x2FC];                 /* maybe part of unk2D0[11]? */
...
void EnZow_Init(EnZow *this, GlobalContext *globalCtx) {
    SkelAnime *sp34;
    SkelAnime *temp_a1;
    ...
    this->unk2C8 = 1;
    Collider_InitAndSetCylinder(globalCtx, &this->unk188, (Actor *) this, &D_80BDDCF0);
...
void EnZow_Destroy(EnZow *this, GlobalContext *globalCtx) {
    EnZow *this = (EnZow *) thisx;
...
void EnZow_Update(EnZow *this, GlobalContext *globalCtx) {
    f32 sp3C;
    f32 sp38;
    f32 sp34;
...
void EnZow_Draw(EnZow *this, GlobalContext *globalCtx) {
    ? sp54;
    ...
    if (temp_v0 != 0) {
        ...
        if ((s32) temp_v0 >= 0xFF) {
            ...
            SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, NULL, func_80BDDAA0, (Actor *) this);
            return;
        }
