typedef struct EnDeath {
    ...
    /* 0x18F */ u8 unk18F;                          /* inferred */
    /* 0x190 */ s8 unk190;                          /* inferred */
    /* 0x191 */ u8 unk191;                          /* inferred */
    /* 0x192 */ s8 unk192;                          /* inferred */
    /* 0x193 */ char pad193[0x16];                  /* maybe part of unk192[23]? */
    /* 0x1A9 */ u8 unk1A9;                          /* inferred */
    /* 0x1AA */ char pad1AA[0x38];                  /* maybe part of unk1A9[57]? */
    /* 0x1E2 */ Vec3s unk1E2;                       /* inferred */
    /* 0x1E8 */ char pad1E8[0x7E];                  /* maybe part of unk1E2[22]? */
    /* 0x266 */ Vec3s unk266;                       /* inferred */
    /* 0x26C */ char pad26C[0x82];                  /* maybe part of unk266[22]? */
    /* 0x2EE */ s16 unk2EE;                         /* inferred */
    /* 0x2F0 */ char pad2F0[0x2];
    ...
    /* 0x320 */ char pad320[0xC];                   /* maybe part of unk31C[4]? */
    /* 0x32C */ Vec3f unk32C;                       /* inferred */
    /* 0x338 */ Vec3f unk338;                       /* inferred */
    /* 0x344 */ Vec3f unk344;                       /* inferred */
    /* 0x350 */ Vec3f unk350;                       /* inferred */
    /* 0x35C */ Vec3f unk35C;                       /* inferred */
    /* 0x368 */ char pad368[0x9C];                  /* maybe part of unk35C[14]? */
    /* 0x404 */ ? unk404;                           /* inferred */
    /* 0x404 */ char pad404[0x2A0];
    /* 0x6A4 */ SkelAnime unk6A4;                   /* inferred */
    /* 0x6E4 */ void *unk6E4;                       /* overlap; inferred */
    /* 0x6E8 */ void *unk6E8;                       /* inferred */
    /* 0x6EC */ void *unk6EC;                       /* inferred */
    /* 0x6F0 */ s32 unk6F0;                         /* inferred */
    /* 0x6F4 */ char pad6F4[0x40];                  /* maybe part of unk6F0[17]? */
    /* 0x734 */ void *unk734;                       /* inferred */
    /* 0x738 */ void *unk738;                       /* inferred */
    /* 0x73C */ ColliderCylinder unk73C;            /* inferred */
    /* 0x788 */ ColliderQuad unk788;                /* inferred */
    /* 0x808 */ ColliderSphere unk808;              /* inferred */
    /* 0x860 */ ColliderTris unk860;                /* inferred */
    /* 0x880 */ ColliderTrisElement unk880;         /* inferred */
    /* 0x8DC */ char pad8DC[0x5C];
} EnDeath;                                          /* size = 0x938 */
...
struct _mips2c_stack_func_808C72AC {
    ...
    /* 0x28 */ char pad28[0x4];                     /* maybe part of sp26[3]? */
    /* 0x2C */ f32 sp2C;                            /* inferred */
};                                                  /* size = 0x30 */
...
struct _mips2c_stack_func_808C84A4 {
    ...
    /* 0x5C */ ? *sp5C;                             /* inferred */
    /* 0x60 */ char pad60[0x4];
    /* 0x64 */ MtxF *sp64;                          /* inferred */
    /* 0x68 */ char pad68[0x20];                    /* maybe part of sp64[9]? */
...
struct _mips2c_stack_func_808C8D18 {
    ...
    /* 0x78 */ char pad78[0x33];                    /* maybe part of sp74[13]? */
    /* 0xAB */ u8 spAB;                             /* inferred */
    /* 0xAC */ char padAC[0x14];                    /* maybe part of spAB[21]? */
...
void EnDeath_Init(EnDeath *this, GlobalContext *globalCtx) {
    Actor *temp_v0;
    f32 *temp_s0;
    s32 temp_s1;
    s32 temp_s1_2;
    ...
    Collider_InitAndSetSphere(globalCtx, &this->unk808, (Actor *) this, &D_808C98E0);
    Collider_InitAndSetCylinder(globalCtx, &this->unk73C, (Actor *) this, &D_808C990C);
    Collider_InitAndSetQuad(globalCtx, &this->unk788, (Actor *) this, &D_808C99C0);
    Collider_InitAndSetTris(globalCtx, &this->unk860, (Actor *) this, &D_808C99B0, &this->unk880);
...
void EnDeath_Destroy(EnDeath *this, GlobalContext *globalCtx) {
    EnDeath *this = (EnDeath *) thisx;
...
void func_808C6F6C(EnDeath *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(temp_a0) != 0) {
        ...
        if (this->unk144.animCurrentFrame > 3.0f) {
            ...
            this->unk18E = 0;
            this->unk6D8 = (f32) (this->unk6D8 + 18.0f);
...
void EnDeath_Update(EnDeath *this, GlobalContext *globalCtx) {
    ...
    if (func_808C7AAC != this->actionFunc) {
        CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk73C);
    }
    if ((this->unk808.base.acFlags & 1) != 0) {
        CollisionCheck_SetAC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk808);
    }
    if ((this->unk788.base.atFlags & 1) != 0) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk788);
    }
    ...
    do {
        ...
        if ((sp68 == phi_t0->actionFunc) || ((phi_v0->unk6E4->unk4 & 0x40) == 0x40)) {
            ...
            do {
                phi_s3_7 = phi_s3;
                if (phi_s0->unk1 == 0) {
                    temp_s5->mf[3][0] = phi_s0->unk4 + sp9C;
                    temp_s5->mf[3][1] = phi_s0->unk8 + spA0;
                    temp_s5->mf[3][2] = phi_s0->unkC + spA4;
            ...
            do {
                ...
                if (phi_s0_2->unk1 == 1) {
                    ...
                    temp_s5->mf[3][0] = phi_s0_2->unk4 + sp9C;
                    temp_s5->mf[3][1] = phi_s0_2->unk8 + spA0;
                    temp_s5->mf[3][2] = phi_s0_2->unkC + spA4;
...
loop_24:
    ...
    if (phi_t0_3->unk18D != 0) {
        ...
        Matrix_Scale(phi_f22, phi_f22, phi_f22, 1);
        temp_s5->mf[3][0] = arg0->unk320 + sp9C;
        temp_s5->mf[3][1] = arg0->unk324 + spA0;
        temp_s5->mf[3][2] = arg0->unk328 + spA4;
...
void func_808C9340(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    if (arg1 == 0x15) {
        ...
        if (((arg4->unk798 & 1) != 0) && (arg4->unk2EE != arg4->unk2EC)) {
            ...
            func_800A81F0(Effect_GetParams(arg4->unk300), (Vec3f *) &sp54, (Vec3f *) &sp48);
...
void EnDeath_Draw(EnDeath *this, GlobalContext *globalCtx) {
    GraphicsContext *sp44;
    ...
    if ((func_808C7AAC != temp_v0) && (func_808C7888 != temp_v0)) {
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_808C9220, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_808C9340, (Actor *) this);
    }
    sp34 = func_808C7888;
    ...
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk35C, 0xE, this->unk314, this->unk318, this->unk31C, (u8) (s32) this->unk18F);
