...
void ObjMoonStone_Init(ObjMoonStone *this, GlobalContext *globalCtx) {
    u8 temp_v0;
...
void ObjMoonStone_Destroy(ObjMoonStone *this, GlobalContext *globalCtx) {
    ObjMoonStone *this = (ObjMoonStone *) thisx;
...
void ObjMoonStone_Update(ObjMoonStone *this, GlobalContext *globalCtx) {
    ObjMoonStone *this = (ObjMoonStone *) thisx;
...
void ObjMoonStone_Draw(ObjMoonStone *this, GlobalContext *globalCtx) {
    Gfx *sp28;
    Gfx *sp20;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
