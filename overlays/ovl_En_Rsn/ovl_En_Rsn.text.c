...
void EnRsn_Init(EnRsn *this, GlobalContext *globalCtx) {
...
void EnRsn_Destroy(EnRsn *this, GlobalContext *globalCtx) {
    EnRsn *this = (EnRsn *) thisx;
    SkelAnime_Free(&this->skelAnime, globalCtx);
}

void EnRsn_Update(EnRsn *this, GlobalContext *globalCtx) {
    EnRsn *this = (EnRsn *) thisx;
...
void EnRsn_PostLimbDraw(GlobalContext *arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4) {
    ...
    sp18.unk0 = (s32) D_80C26028.unk0;
    sp18.unk4 = (s32) D_80C26028.unk4;
    sp18.unk8 = (s32) D_80C26028.unk8;
    if (arg1 == 0xE) {
        SysMatrix_MultiplyVector3fByState((Vec3f *) &sp18, arg4 + 0x3C);
    }
}

void EnRsn_Draw(EnRsn *this, GlobalContext *globalCtx) {
