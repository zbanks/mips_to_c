typedef struct EnThiefbird {
    ...
    /* 0x196 */ char pad196[0xC];                   /* maybe part of unk194[7]? */
    /* 0x1A2 */ Vec3s unk1A2;                       /* inferred */
    /* 0x1A8 */ char pad1A8[0x60];                  /* maybe part of unk1A2[17]? */
    /* 0x208 */ Vec3s unk208;                       /* inferred */
    /* 0x20E */ char pad20E[0x62];                  /* maybe part of unk208[17]? */
    /* 0x270 */ ColliderJntSph unk270;              /* inferred */
    /* 0x290 */ ColliderJntSphElement unk290;       /* inferred */
    /* 0x2D0 */ char pad2D0[0x80];                  /* maybe part of unk290[3]? */
    /* 0x350 */ Vec3f unk350;                       /* inferred */
    /* 0x35C */ char pad35C[0x60];                  /* maybe part of unk350[9]? */
    /* 0x3BC */ Vec3f unk3BC;                       /* inferred */
    /* 0x3C8 */ char pad3C8[0xC];
    /* 0x3D4 */ f32 unk3D4;                         /* inferred */
    /* 0x3D8 */ f32 unk3D8;                         /* inferred */
    /* 0x3DC */ f32 unk3DC;                         /* inferred */
    /* 0x3E0 */ f32 unk3E0;                         /* inferred */
    /* 0x3E4 */ char pad3E4[0x4];
    /* 0x3E8 */ s32 unk3E8;                         /* inferred */
    /* 0x3EC */ Actor *unk3EC;                      /* inferred */
    /* 0x3F0 */ char pad3F0[0x5A0];                 /* maybe part of unk3EC[361]? */
...
struct _mips2c_stack_func_80C10E98 {
    ...
    /* 0x7C */ char pad7C[0xC];                     /* maybe part of sp78[4]? */
...
void EnThiefbird_Init(EnThiefbird *this, GlobalContext *globalCtx) {
    s32 temp_v1;
    void *temp_v0;
    void *temp_v0_2;
    void *temp_v0_3;
    ...
    Collider_InitAndSetJntSph(globalCtx, &this->unk270, (Actor *) this, &D_80C1362C, &this->unk290);
    phi_v1 = 0;
    phi_v1_2 = 0;
    if (0 != 0x80) {
        do {
...
void EnThiefbird_Destroy(EnThiefbird *this, GlobalContext *globalCtx) {
    EnThiefbird *this = (EnThiefbird *) thisx;
...
void func_80C11590(EnThiefbird *this, GlobalContext *globalCtx) {
    ...
    if ((Math_SmoothStepToS((s16 *) &this->actor.shape, this->unk190, 0xA, 0x100, (s16) 8) == 0) && (sp38 != 0) && (Rand_ZeroOne() < 0.1f)) {
...
block_5:
    ...
    if ((this->actor.bgCheckFlags & 8) != 0) {
        ...
        this->unk192 = Actor_YawToPoint((Actor *) this, &D_80C13920);
        this->unk190 = Actor_PitchToPoint((Actor *) this, &D_80C13920);
    }
    Math_SmoothStepToS(&this->actor.shape.rot.y, this->unk192, 6, 0x1000, (s16) 0x100);
    Math_SmoothStepToS((s16 *) &this->actor.shape, this->unk190, 5, 0x100, (s16) 0x10);
...
void func_80C127F4(EnThiefbird *this, GlobalContext *globalCtx) {
    ...
    if (this->unk3EC != 0) {
        if ((this->actor.bgCheckFlags & 8) != 0) {
            ...
            Math_SmoothStepToS(&this->actor.shape.rot.y, Actor_YawBetweenActors((Actor *) this, this->unk3EC), 3, 0x2000, (s16) 0x100);
        }
        temp_a0 = &this->unk3BC;
        sp2C = temp_a0;
        temp_v0 = Math_Vec3f_Pitch(temp_a0, (Vec3f *) &this->unk3EC->world);
        if (temp_v0 < -0x3000) {
            phi_a1 = -0x3000;
        } else {
...
void EnThiefbird_Update(EnThiefbird *this, GlobalContext *globalCtx) {
    ...
    if (func_80C1193C == this->actionFunc) {
        CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk270);
    }
    temp_a2 = &this->unk270;
    ...
    CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, (Collider *) &this->unk270);
    if (this->unk3D4 > 0.0f) {
        if (this->unk18C != 0xA) {
...
void EnThiefbird_Draw(EnThiefbird *this, GlobalContext *globalCtx) {
    EnThiefbird *this = (EnThiefbird *) thisx;
    func_8012C28C(globalCtx->state.gfxCtx);
    SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80C130EC, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) func_80C1315C, (Actor *) this);
    if ((s32) this->actor.colorFilterTimer > 0) {
        func_800AE5A0(globalCtx);
    }
    func_80C13354(this, (GraphicsContext **) globalCtx);
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk350, 0xB, this->unk3D8, this->unk3DC, this->unk3D4, (u8) (s32) this->unk18C);
    Math_Vec3s_ToVec3f((Vec3f *) &this->actor.focus, this->unk270.elements + 0x70);
}
