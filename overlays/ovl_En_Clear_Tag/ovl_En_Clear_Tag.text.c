...
struct _mips2c_stack_EnClearTag_DrawEffects {
    ...
    /* 0x094 */ char pad_94[0xC8];                  /* maybe part of sp90[51]? */
    /* 0x15C */ ? sp15C;                            /* inferred */
    /* 0x15C */ char pad_15C[0x40];
    ...
    /* 0x1B0 */ char pad_1B0[0x4];
    /* 0x1B4 */ s16 sp1B4;                          /* inferred */
    /* 0x1B6 */ char pad_1B6[0x1];
...
loop_1:
    ...
    if (phi_s0->unk_0 == 0) {
        ...
        phi_s0->unk_48 = 0;
        phi_s0->unk_5C = temp_f0;
        phi_s0->unk_4A = (s16) phi_s0->unk_48;
        phi_s0->unk_60 = arg5;
        phi_s0->unk_1 = (s8) (u32) Rand_ZeroFloat(10.0f);
        return;
    }
    phi_s0 += 0x70;
    if ((s32) temp_v0 >= 0x66) {
...
block_5:
        ...
        phi_v0->unk_10 = (s32) D_8094AD60.unk_0;
        phi_v0->unk_14 = (s32) D_8094AD60.unk_4;
        phi_v0->unk_18 = (s32) D_8094AD60.unk_8;
        phi_v0->unk_1C = (s32) D_8094AD60.unk_0;
        phi_v0->unk_20 = (s32) D_8094AD60.unk_4;
        phi_v0->unk_50 = arg2;
        phi_v0->unk_54 = (f32) (2.0f * arg2);
        phi_v0->unk_6C = 1.0f;
        phi_v0->unk_68 = 1.0f;
        phi_v0->unk_34 = 255.0f;
        phi_v0->unk_38 = 255.0f;
        phi_v0->unk_40 = 255.0f;
        phi_v0->unk_28 = 200.0f;
        phi_v0->unk_2C = 20.0f;
        phi_v0->unk_30 = 0.0f;
        phi_v0->unk_3C = 215.0f;
        phi_v0->unk_24 = (s32) D_8094AD60.unk_8;
        return;
    }
    phi_v0 += 0x70;
    if ((s32) temp_v1 >= 0x67) {
...
block_5:
        ...
        phi_v0->unk_24 = (s32) D_8094AD60.unk_8;
        if (arg2 <= 1.1f) {
            phi_v0->unk_50 = (f32) ((((f32) gGameInfo->data[1271] * 0.1f) + 1.0f) * arg2);
            phi_v0->unk_34 = (f32) ((f32) gGameInfo->data[1264] + 150.0f);
            phi_v0->unk_28 = (f32) gGameInfo->data[1265];
            phi_v0->unk_2C = (f32) gGameInfo->data[1266];
            phi_v0->unk_30 = (f32) gGameInfo->data[1267];
            phi_v0->unk_38 = (f32) gGameInfo->data[1268];
            phi_v0->unk_3C = (f32) gGameInfo->data[1269];
            phi_v0->unk_40 = (f32) gGameInfo->data[1270];
            return;
        }
        phi_v0->unk_40 = 0.0f;
        phi_v0->unk_3C = 0.0f;
...
loop_1:
    if (phi_s0->unk_0 == 0) {
        ...
        phi_s0->unk_64 = arg5;
        phi_s0->unk_4C = (s16) (s32) (Rand_ZeroFloat(100.0f) + 200.0f);
        phi_s0->unk_4E = arg6;
        phi_s0->unk_1 = (s8) (u32) Rand_ZeroFloat(10.0f);
        temp_f16 = phi_s0->unk_10;
        temp_f2 = phi_s0->unk_18;
        phi_s0->unk_58 = Math_Acot2F(phi_s0->unk_18, phi_s0->unk_10);
        temp_f6 = -Math_Acot2F(sqrtf((temp_f16 * temp_f16) + (temp_f2 * temp_f2)), phi_s0->unk_14);
        phi_s0->unk_38 = 255.0f;
        phi_s0->unk_5C = temp_f6;
        phi_s0->unk_3C = 255.0f;
        phi_s0->unk_28 = 255.0f;
        phi_s0->unk_2C = 255.0f;
        phi_s0->unk_30 = 255.0f;
        phi_s0->unk_40 = 0.0f;
        return;
    }
    temp_v0 = phi_v0 + 1;
...
loop_1:
    if (phi_s0->unk_0 == 0) {
        ...
        temp_f2 = phi_s0->unk_18;
        phi_s0->unk_58 = Math_Acot2F(phi_s0->unk_18, phi_s0->unk_10);
        phi_s0->unk_5C = (f32) -Math_Acot2F(sqrtf((temp_f16 * temp_f16) + (temp_f2 * temp_f2)), phi_s0->unk_14);
        temp_a0 = arg6 * 0xC;
        temp_v0 = temp_a0 + &D_8094AD6C;
        temp_v1 = temp_a0 + &D_8094AD9C;
        phi_s0->unk_38 = (f32) temp_v0->unk_0;
        phi_s0->unk_3C = (f32) temp_v0->unk_4;
        phi_s0->unk_40 = (f32) temp_v0->unk_8;
        phi_s0->unk_28 = (f32) temp_v1->unk_0;
        phi_s0->unk_2C = (f32) temp_v1->unk_4;
        phi_s0->unk_30 = (f32) temp_v1->unk_8;
        return;
    }
    temp_v0_2 = phi_v0 + 1;
    phi_s0 += 0x70;
...
loop_1:
    if (phi_v0->unk_0 == 0) {
        ...
        phi_v0->unk_20 = (s32) D_8094AD60.unk_4;
        phi_v0->unk_54 = arg2;
        phi_v0->unk_1 = (s8) arg3;
        phi_v0->unk_50 = 0.0f;
        phi_v0->unk_34 = 200.0f;
        phi_v0->unk_24 = (s32) D_8094AD60.unk_8;
        return;
    }
    temp_v1 = phi_v1 + 1;
...
void EnClearTag_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) this->actor.params >= 0) {
        ...
        if (temp_s0 != 0x23) {
            ...
            spA4.unk_0 = (f32) temp_s3->pos.x;
            spA4.unk_4 = (f32) temp_s3->pos.y;
            spA4.unk_8 = (f32) temp_s3->pos.z;
...
void EnClearTag_UpdateCamera(Actor *arg0, GlobalContext *arg1) {
    ...
    if (temp_v0 != 0) {
        if (temp_v0 != 1) {
            ...
            arg0->unk_2E64 = func_801694DC(arg1);
        ...
        if (phi_s0->type != 0) {
            ...
            if (temp_v0 == 1) {
                ...
                if (phi_s0->velocity.y < 0.0f) {
                    sp60.unk_0 = (f32) phi_s0->position.x;
                    sp60.unk_4 = (f32) phi_s0->position.y;
                    sp60.unk_8 = (f32) phi_s0->position.z;
                    sp6C = temp_f16;
                    sp64 += 5.0f;
