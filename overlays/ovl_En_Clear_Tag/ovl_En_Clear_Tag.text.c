void EnClearTag_CreateDebrisEffect(EnClearTag *arg0, Vec3f *arg1, f32 *arg2, f32 *arg3, f32 arg4, f32 arg5); /* static */
void EnClearTag_CreateFlashEffect(EnClearTag *arg0, Vec3f *arg1, f32 arg2, f32 arg3); /* static */
void EnClearTag_CreateIsolatedLightRayEffect(EnClearTag *arg0, Vec3f *arg1, f32 *arg2, f32 *arg3, f32 arg4, f32 arg5, s16 arg6, s16 arg7); /* static */
void EnClearTag_CreateIsolatedSmokeEffect(EnClearTag *arg0, Vec3f *arg1, f32 arg2); /* static */
void EnClearTag_CreateLightRayEffect(EnClearTag *arg0, Vec3f *arg1, f32 *arg2, f32 *arg3, f32 arg4, f32 arg5, s16 arg6); /* static */
void EnClearTag_CreateShockwaveEffect(EnClearTag *arg0, Vec3f *arg1, ?32 arg2, s16 arg3); /* static */
void EnClearTag_CreateSmokeEffect(EnClearTag *arg0, Vec3f *arg1, f32 arg2); /* static */
void EnClearTag_CreateSplashEffect(EnClearTag *arg0, Vec3f *arg1, s16 arg2); /* static */
...
void EnClearTag_CreateDebrisEffect(EnClearTag *arg0, Vec3f *arg1, f32 *arg2, f32 *arg3, f32 arg4, f32 arg5) {
    f32 temp_f0;
    s16 temp_v0;
    void *phi_s0;
    s16 phi_v0;
...
void EnClearTag_CreateSmokeEffect(EnClearTag *arg0, Vec3f *arg1, f32 arg2) {
    void *sp18;
    f32 temp_f0;
    s16 temp_v1;
    s32 temp_f4;
...
block_5:
        ...
        phi_v0->unk1 = phi_t8;
        phi_v0->unk0 = 3U;
        phi_v0->unk4 = (s32) arg1->x;
        phi_v0->unk8 = (s32) arg1->y;
        phi_v0->unkC = (s32) arg1->z;
...
void EnClearTag_CreateIsolatedSmokeEffect(EnClearTag *arg0, Vec3f *arg1, f32 arg2) {
    void *sp18;
    f32 temp_f0;
    s16 temp_v1;
    s32 temp_f4;
...
void EnClearTag_CreateFlashEffect(EnClearTag *arg0, Vec3f *arg1, f32 arg2, f32 arg3) {
    s16 temp_v1;
    void *phi_v0;
    s16 phi_v1;
...
void EnClearTag_CreateLightRayEffect(EnClearTag *arg0, Vec3f *arg1, f32 *arg2, f32 *arg3, f32 arg4, f32 arg5, s16 arg6) {
    f32 temp_f16;
    f32 temp_f2;
    f32 temp_f6;
    s16 temp_v0;
...
void EnClearTag_CreateIsolatedLightRayEffect(EnClearTag *arg0, Vec3f *arg1, f32 *arg2, f32 *arg3, f32 arg4, f32 arg5, s16 arg6, s16 arg7) {
    f32 temp_f16;
    f32 temp_f2;
    s16 temp_v0_2;
    s32 temp_a0;
...
void EnClearTag_CreateShockwaveEffect(EnClearTag *arg0, Vec3f *arg1, ?32 arg2, s16 arg3) {
    s16 temp_v1;
    void *phi_v0;
    s16 phi_v1;
...
void EnClearTag_CreateSplashEffect(EnClearTag *arg0, Vec3f *arg1, s16 arg2) {
    void *sp18;
    f32 temp_f0;
    s16 temp_v1;
    s32 temp_f4;
...
void EnClearTag_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((s32) this->actor.params >= 0) {
        ...
        Math_Vec3f_Copy(&spA4, &temp_s3->pos);
        ...
        if (temp_s0 != 0x23) {
            ...
            Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 50.0f, 30.0f, 100.0f, 4U);
            spA4.x = temp_s3->pos.x;
            spA4.y = temp_s3->pos.y;
            spA4.z = temp_s3->pos.z;
...
void EnClearTag_Draw(Actor *thisx, GlobalContext *globalCtx) {
    EnClearTag *this = (EnClearTag *) thisx;
    EnClearTag_DrawEffects(&this->actor, globalCtx);
}

void EnClearTag_UpdateEffects(EnClearTag *this, GlobalContext *globalCtx) {
    EnClearTag *self = (EnClearTag *) this;
    f32 sp6C;
    f32 sp64;
    Vec3f sp60;
    f32 temp_f0;
        ...
        if (phi_s0->type != 0) {
            ...
            if (temp_v0 == 1) {
                ...
                if (phi_s0->velocity.y < 0.0f) {
                    sp60.x = phi_s0->position.x;
                    sp60.y = phi_s0->position.y;
                    sp60.z = phi_s0->position.z;
                    sp6C = temp_f16;
                    sp64 += 5.0f;
    ...
    if (this->actor.floorPoly != 0) {
        do {
            if (phi_s3_2->type == 6) {
                ...
                sp1B4 = phi_t0;
                func_800C0094(this->actor.floorPoly, phi_s3_2->position.x, phi_s3_2->position.y, phi_s3_2->position.z, &sp15C);
    ...
    if (this->actor.floorPoly != 0) {
        do {
            if (phi_s3_3->type == 4) {
                ...
                sp1B4 = phi_t0_2;
                func_800C0094(this->actor.floorPoly, phi_s3_3->position.x, this->actor.floorHeight, phi_s3_3->position.z, &sp15C);
                SysMatrix_SetCurrentState(&sp15C);
    ...
    do {
        ...
        if (phi_s3_8->type == 7) {
            ...
            do {
                ...
                SysMatrix_GetStateTranslationAndScaledZ(phi_s3_8->maxScale, &sp1A4);
                sp19C = phi_s3_8->position.y;
                if ((func_800CA1AC(globalCtx, temp_s5, phi_s3_8->position.x + sp1A4.x, phi_s3_8->position.z + sp1A4.z, temp_s7, &sp1A0) != 0) && ((phi_s3_8->position.y - sp19C) < 200.0f)) {
                    SysMatrix_InsertTranslation(phi_s3_8->position.x + sp1A4.x, sp19C, phi_s3_8->position.z + sp1A4.z, 0);
