...
void func_80A52C6C(EnDnq *arg0, GlobalContext *arg1) {
    ...
    sp34.unk0 = (s32) D_80A535F0.unk0;
    sp34.unk8 = (s32) D_80A535F0.unk8;
    sp34.unk4 = (s32) D_80A535F0.unk4;
...
void EnDnq_Init(EnDnq *this, GlobalContext *globalCtx) {
...
void EnDnq_Destroy(EnDnq *this, GlobalContext *globalCtx) {
    EnDnq *this = (EnDnq *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->collider);
}

void EnDnq_Update(EnDnq *this, GlobalContext *globalCtx) {
    EnDnq *this = (EnDnq *) thisx;
...
void EnDnq_Draw(EnDnq *this, GlobalContext *globalCtx) {
    EnDnq *this = (EnDnq *) thisx;
