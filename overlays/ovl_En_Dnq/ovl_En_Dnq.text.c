...
? func_80A52B68(EnDnq *arg0, GlobalContext *arg1) {
    ...
    if (((temp_v0->unkA6C & 0x40) != 0) && (arg0 == temp_v0->unkA88)) {
        switch (temp_v1) {
        case 2203:
...
void func_80A52C6C(EnDnq *arg0, GlobalContext *arg1) {
    ...
    sp34.x = D_80A535F0.unk0;
    sp34.z = D_80A535F0.unk8;
    sp34.y = D_80A535F0.unk4;
    Math_Vec3f_Copy(&sp1C, arg1->actorCtx.actorList[2].first + 0x24);
    Lib_Vec3f_TranslateAndRotateY(arg0 + 0x24, arg0->actor.world.rot.y, &sp34, &sp28);
    Math_Vec3f_Copy(arg0 + 0x370, &sp28);
    arg0->actor.xzDistToPlayer = Math_Vec3f_DistXZ(&sp28, &sp1C);
}
...
s32 func_80A52D44(Actor *arg0, GlobalContext *arg1) {
    ...
    if ((arg0->unk37C & 7) != 0) {
        ...
        if (func_800B84D0(arg0, arg1) != 0) {
            func_8013AED4(arg0 + 0x37C, 0U, 7U);
            arg0->unk380 = func_80A52CF8(arg0, arg1);
            arg0->unk18C = func_80A52FB8;
            phi_v1 = 1;
        }
    }
    return phi_v1;
...
void func_80A52FB8(EnDnq *this, GlobalContext *globalCtx) {
    ...
    if (func_8010BF58(&this->actor, globalCtx, this->unk_380, NULL, &this->unk_1E0) != 0) {
...
void func_80A53038(EnDnq *arg0, GlobalContext *arg1) {
    ...
    if (func_800EE29C(arg1, 0x69U) != 0) {
        ...
        if ((arg0->unk_398 == 4) && (func_801378B8(&arg0->skelAnime, 2.0f) != 0)) {
            Audio_PlayActorSound2(&arg0->actor, 0x39F6U);
        }
        ...
        func_800EDF24(&arg0->actor, arg1, sp24);
    }
}
...
void EnDnq_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->collider, &this->actor, &D_80A53464);
...
void EnDnq_Update(Actor *thisx, GlobalContext *globalCtx) {
    EnDnq *this = (EnDnq *) thisx;
    if ((func_80A52D44(&this->actor, globalCtx) == 0) && (func_80A52648(this, globalCtx) != 0)) {
    ...
    func_8013C964(&this->actor, globalCtx, this->unk_390, fabsf(this->actor.yDistToPlayer) + 1.0f, 0, (s16) (this->unk_37C & 7));
    this->actor.xzDistToPlayer = this->unk_394;
    Actor_SetHeight(&this->actor, 46.0f);
    func_80A52604(&this->actor, globalCtx);
}
