...
void BgAstrBombwall_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (Collider_SetTris(globalCtx, sp2C, (Actor *) this, &D_80C0A698, &this->unk_180) == 0) {
        Actor_MarkForDeath((Actor *) this);
        return;
    }
    func_80C09ED0(&D_80C0A698, (Vec3f *) &this->actor.world, &this->actor.shape, sp2C);
    func_8013E3B8((Actor *) this, (s16 []) &this->unk_238, 1);
    func_80C0A378(this);
}
...
void func_80C0A418(Actor *arg0, GlobalContext *arg1) {
    if (func_8013E2D4(arg0, arg0->unk_238, -1, 0) != 0) {
