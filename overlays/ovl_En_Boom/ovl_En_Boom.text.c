typedef struct EnBoom {
    ...
    /* 0x1C4 */ Actor *unk_1C4;                     /* inferred */
    /* 0x1C8 */ Actor *unk_1C8;                     /* inferred */
    /* 0x1CC */ u8 unk_1CC;                         /* inferred */
    /* 0x1CD */ u8 unk_1CD;                         /* inferred */
    /* 0x1CE */ u8 unk_1CE;                         /* inferred */
    /* 0x1CF */ s8 unk_1CF;                         /* inferred */
    /* 0x1D0 */ s32 unk_1D0;                        /* inferred */
    /* 0x1D4 */ s32 unk_1D4;                        /* inferred */
    /* 0x1D8 */ char pad_1D8[0x18];                 /* maybe part of unk_1D4[7]? */
...
struct _mips2c_stack_EnBoom_Init {
    ...
    /* 0x02C */ char pad_2C[0x4];
    /* 0x030 */ ? sp30;                             /* inferred */
    /* 0x030 */ char pad_30[0x184];
...
void EnBoom_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp1B7 = D_808A306B;
    sp1BB = D_808A306F;
    Effect_Add(globalCtx, &this->unk_1D0, 1, 0U, (u8) 0, (void *) &sp30);
...
void EnBoom_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (temp_v1 != 0) {
        globalCtx = temp_a2;
        sp18 = temp_v1;
        Effect_Destroy(temp_a2, this->unk_1D0);
...
block_10:
            temp_v0_3 = this->unk_1CE;
            if (temp_v0_3 != 0) {
                this->unk_1CE = temp_v0_3 - 1;
                phi_v0_2 = -0x190;
                ...
                temp_v0_4 = this->unk_1CF;
                if ((s32) temp_v0_4 > 0) {
                    this->unk_1CF = temp_v0_4 - 1;
                } else {
                    this->unk_1CF = -1;
                }
                if ((s32) this->unk_1CF > 0) {
    ...
    if (((this->unk_144.base.atFlags & 2) != 0) && (((temp_v0_5 = this->unk_144.base.at, temp_v1_2 = temp_v0_5->id, (temp_v1_2 == 0xE)) && (temp_a0 = temp_v0_5->params, (temp_a0 != 7)) && (temp_a0 != 6)) || (temp_v1_2 == 0xE3))) {
        this->unk_1C8 = temp_v0_5;
        if (temp_v0_5->id == 0xE3) {
            temp_v0_5->flags |= 0x2000;
        }
    }
    temp_a0_2 = this->unk_1CC;
    ...
    if (phi_v0_5 != 0) {
        ...
        phi_v1_2 = (s32) this->unk_1CC;
    }
    if (phi_v1_2 < 0x11) {
        temp_v0_7 = this->unk_1C4;
        if (sp78 != temp_v0_7) {
            if (temp_v0_7 == 0) {
                this->unk_1CE = 8;
            }
...
void EnBoom_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if ((globalCtx->actorCtx.actorList[2].first->unk_A6C * 4) >= 0) {
...
void EnBoom_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_80126440(globalCtx, (Collider *) &this->unk_144, &this->unk_1D4, (Vec3f *) &sp4C, (Vec3f *) &sp40);
    if (MIPS2C_ERROR(Read from unset register $v0) != 0) {
        func_800A81F0(Effect_GetParams(this->unk_1D0), (Vec3f *) &sp4C, (Vec3f *) &sp40);
    }
