...
void EnStoneheishi_Init(EnStoneheishi *this, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk278, (Actor *) this, &D_80BCA3A0);
...
void EnStoneheishi_Destroy(EnStoneheishi *this, GlobalContext *globalCtx) {
    EnStoneheishi *this = (EnStoneheishi *) thisx;
...
void EnStoneheishi_Update(EnStoneheishi *this, GlobalContext *globalCtx) {
    Actor *sp2C;
...
void EnStoneheishi_Draw(EnStoneheishi *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.weekEventReg[41] & 0x40) == 0) {
        ...
        temp_s1->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BCA0AC, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80BCA104, (Actor *) this, temp_s1->polyXlu.p);
        return;
    }
    func_8012C28C(temp_a2);
    temp_s1->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BCA0AC, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80BCA104, (Actor *) this, temp_s1->polyOpa.p);
}
