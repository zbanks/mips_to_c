...
void func_80B9D508(ObjHunsui *, GlobalContext *);   /* static */
...
static InitChainEntry D_80B9DCAC;                   /* unable to generate initializer */
...
typedef struct ObjHunsui {
    ...
    /* 0x015C */ void (*actionFunc)(ObjHunsui *, GlobalContext *);
    ...
    /* 0x016C */ s8 unk16C;                         /* inferred */
    /* 0x016D */ s8 unk16D;                         /* inferred */
    /* 0x016E */ s8 unk16E;                         /* inferred */
    /* 0x016F */ char pad16F[0x1];                  /* maybe part of unk16E[2]? */
    ...
    /* 0x017E */ char pad17E[0x2];                  /* maybe part of unk17C[2]? */
    ...
    /* 0x019C */ char pad19C[0x10];                 /* maybe part of unk198[5]? */
    ...
    if ((arg0->actor.xzDistToPlayer < (45.0f * arg0->actor.scale.x * 10.0f)) && (arg0->actor.yDistToPlayer < -21.0f)) {
        if (func_800CAF70(arg0) != 0) {
            ...
            if ((s32) arg0->unk18C >= 3) {
                arg0->unk18C = 0;
                Math_Vec3f_Copy(&sp40, temp_s1 + 0x24);
                sp40.x += randPlusMinusPoint5Scaled(10.0f);
                sp40.z += randPlusMinusPoint5Scaled(10.0f);
                sp40.y += Rand_ZeroFloat(2.0f);
                EffectSsGSplash_Spawn(arg1, &sp40, NULL, NULL, (s16) (s32) (2.0f * Rand_ZeroOne()), (s16) 1);
                return;
            }
        ...
        if ((s32) arg0->unk18C >= 3) {
            ...
            EffectSsGSplash_Spawn(arg1, &sp40, NULL, NULL, (s16) 1, (s16) 1);
        }
...
void ObjHunsui_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_80B9DCAC);
    ...
    func_8013E3B8(&this->actor, (s16 []) &this->unk170, 1);
    ...
    if (arg0->unk1B4 != 0) {
        ...
        do {
            ...
            if ((phi_s2 + 1) == (temp_v0_2 + (phi_s2 * 8) + phi_s0)->unk300) {
                Math_Vec3f_Copy(&sp74, temp_v0_2 + (phi_s2 * 0x60) + (phi_s0 * 0xC) + 0x238);
                arg0->unk174 = sp74.y - arg0->actor.home.pos.y;
                phi_s3 = 1;
        ...
        if (Flags_GetSwitch(temp_a3, arg0->unk168) != 0) {
            ...
            if (temp_v0_2 == 0) {
                if (((s32) temp_a0_2 >= 0) && (sp2E = (s16) temp_a0_2, (ActorCutscene_GetCanPlayNext((s16) temp_a0_2) == 0))) {
                    ...
                    ActorCutscene_StartAndSetUnkLinkFields((s16) (s32) arg0->actor.cutscene, &arg0->actor);
                    arg0->unk16E = -1;
                } else {
                    arg0->unk16E = 0x28;
                }
            } else if ((s32) temp_v0_2 < 0) {
                if (func_800F22C4((s16) temp_a0_2, &arg0->actor) != 0) {
                    arg0->unk16E = 0x28;
                }
            } else {
