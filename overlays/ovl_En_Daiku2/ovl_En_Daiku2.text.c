...
void EnDaiku2_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->collider, &this->actor, &D_80BE7900);
...
void func_80BE66E4(EnDaiku2 *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk_28A != 5) && (sp98 != 2) && (func_80BE64C0(&this->actor, globalCtx) != 0)) {
        func_80BE6CFC(this);
        return;
    }
    ...
    if ((this->unk_276 == 8) && (func_801378B8(&this->skelAnime, 6.0f) != 0)) {
        ...
        phi_s0 = 0;
        do {
            Math_Vec3f_Copy(temp_s1, &sp5C->pos);
            temp_f4 = sp70.y + 40.0f;
            ...
            sp70.y = temp_f4 + randPlusMinusPoint5Scaled(5.0f);
            temp_f10 = sp70.z + randPlusMinusPoint5Scaled(5.0f);
            sp8C = -1.0f;
            sp70.z = temp_f10;
            sp7C = (Rand_ZeroOne() - 0.5f) * 4.0f;
            sp80 = (Rand_ZeroOne() * 10.0f) + 4.0f;
            sp84 = (Rand_ZeroOne() - 0.5f) * 4.0f;
            func_80BE7504(this, temp_s1, (Vec3f *) &sp7C, &sp88, 0.01f - (Rand_ZeroFloat(1.0f) * 0.005f), (s16) 0x28);
            temp_s0 = phi_s0 + 1;
            phi_s0 = temp_s0;
        } while (temp_s0 != 0xA);
    }
...
void func_80BE6D40(EnDaiku2 *this, GlobalContext *globalCtx) {
    ...
    sp2C = temp_a0;
    sp3A = Math_Vec3f_Yaw(&temp_a0->pos, &this->unk_268);
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        this->actionFunc = func_80BE6BC0;
        return;
    }
    Math_SmoothStepToS(&this->actor.world.rot.y, sp3A, 1, 0x7D0, (s16) 0xA);
    Math_ApproachF(&sp2C->pos.x, this->unk_268.x, 0.5f, fabsf(Math_SinS(this->actor.world.rot.y) * 6.0f));
...
void func_80BE6EF0(EnDaiku2 *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_274 != 0) {
        sp2C = temp_a0_2;
        sp28 = temp_a1;
        Math_SmoothStepToS(sp30, Math_Vec3f_Yaw(&temp_a0_2->pos, temp_a1), 1, 0x7D0, (s16) 0xA);
        Math_ApproachF(&temp_a0_2->pos.x, this->unk_268.x, 0.5f, fabsf(Math_SinS(this->actor.world.rot.y) * 4.0f));
...
void EnDaiku2_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_DrawSV(globalCtx, this->skelAnime.skeleton, this->skelAnime.limbDrawTbl, (s32) this->skelAnime.dListCount, NULL, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *)) EnDaiku2_PostLimbDraw, &this->actor);
