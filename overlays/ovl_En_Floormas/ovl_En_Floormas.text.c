typedef struct EnFloormas {
    ...
    /* 0x19C */ char pad_19C[0x90];                 /* maybe part of unk_196[25]? */
    /* 0x22C */ Vec3s unk_22C;                      /* inferred */
    /* 0x232 */ char pad_232[0x92];                 /* maybe part of unk_22C[25]? */
    /* 0x2C4 */ f32 unk_2C4;                        /* inferred */
    /* 0x2C8 */ f32 unk_2C8;                        /* inferred */
    /* 0x2CC */ f32 unk_2CC;                        /* inferred */
    /* 0x2D0 */ Vec3f unk_2D0;                      /* inferred */
    /* 0x2DC */ char pad_2DC[0x78];                 /* maybe part of unk_2D0[11]? */
    /* 0x354 */ ColliderCylinder unk_354;           /* inferred */
...
void EnFloormas_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->unk_144, &D_06008FB0, &D_06009DB0, &this->unk_196, &this->unk_22C, 0x19);
    Collider_InitAndSetCylinder(globalCtx, &this->unk_354, (Actor *) this, &D_808D38A0);
...
void EnFloormas_Destroy(Actor *thisx, GlobalContext *globalCtx) {
    EnFloormas *this = (EnFloormas *) thisx;
    Collider_DestroyCylinder(globalCtx, &this->unk_354);
}

void func_808D08D0(Actor *arg0) {
    arg0->unk_368 = 0xC;
    arg0->unk_365 = (u8) (arg0->unk_365 | 4);
    arg0[2].projectedPos.x &= 0xFFFF7FFF;
    arg0[1].focus.rot.z = 0x28;
}

void func_808D0908(EnFloormas *arg0) {
    arg0->unk_354.base.colType = 0;
    arg0->unk_354.base.acFlags &= 0xFFFB;
    arg0->unk_354.info.bumper.dmgFlags |= 0x8000;
    arg0->unk_190 = 0;
}
...
void func_808D09CC(Actor *arg0) {
    arg0->unk_18C = 0xA;
    arg0[2].focus.pos.y = 0.55f;
    arg0->unk_368 = 3;
    arg0[1].focus.rot.y = 0x50;
    arg0->flags &= -0x601;
    arg0[2].focus.pos.z = 0.82500005f;
...
void func_808D0CE4(EnFloormas *arg0) {
    ...
    arg0 = arg0;
    arg0->unk_18E = Rand_S16Offset(2, 4);
...
void func_808D108C(EnFloormas *arg0) {
    ...
    temp_v1 = arg0->unk_190 - arg0->actor.shape.rot.y;
    arg0->actor.speedXZ = 0.0f;
    if ((s32) temp_v1 > 0) {
        sp36 = temp_v1;
    ...
    if (arg0->actor.scale.x > 0.009f) {
        arg0->unk_190 = (s16) (s32) ((f32) sp36 * 0.06666667f);
    } else {
        arg0->unk_144.animPlaybackSpeed *= 2.0f;
        arg0->unk_190 = (s16) (s32) ((f32) sp36 * 0.13333334f);
    }
...
block_5:
    if ((this->unk_144.animPlaybackSpeed < 0.0f) && (func_801378B8(sp24, 6.0f) != 0)) {
block_7:
        if (this->actor.scale.x > 0.009f) {
            Audio_PlayActorSound2((Actor *) this, 0x3894U);
        } else {
...
void func_808D1380(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0[1].focus.pos.z = (bitwise f32) func_808D1458;
}
...
void func_808D1458(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    Math_StepToS(&this->unk_192, 0x4B0, 0x64);
}
...
void func_808D1650(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if (((this->actor.bgCheckFlags & 8) != 0) || (this->unk_18E == 0)) {
        func_808D1740(this);
    }
}
...
void func_808D17EC(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->unk_144) != 0) {
        ...
        if ((this->unk_18E == 0) && (sp24 != 0)) {
            if (this->unk_144.animFrameCount < 45.0f) {
                this->unk_144.animFrameCount = (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_060019CC);
    ...
    Math_StepToS(&this->unk_192, -0x640, 0x64);
}
...
void func_808D19D4(Actor *arg0) {
    ...
    SkelAnime_ChangeAnim((SkelAnime *) &arg0[1], &D_060019CC, 1.0f, 41.0f, (f32) SkelAnime_GetFrameCount((AnimationHeaderCommon *) &D_060019CC), (u8) 2, 0.0f);
    temp_t5 = arg0->flags & ~0x400;
    temp_t7_2 = temp_t5 | 0x200;
    arg0->unk_394 = (s16) (s32) ((f32) D_808D38A0.dim.radius * 0.6f);
    arg0->flags = temp_t5;
    arg0->flags = temp_t7_2;
    arg0->colChkInfo.health = 1;
    arg0[1].focus.pos.z = (bitwise f32) func_808D1B44;
    arg0->speedXZ = 4.0f;
    arg0->velocity.y = 7.0f;
    arg0->unk_396 = (s16) (s32) ((f32) D_808D38A0.dim.height * 0.6f);
}
...
void func_808D1C1C(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    sp24 = temp_a0;
    SkelAnime_FrameUpdateMatrix(temp_a0);
    temp_v1 = this->unk_194;
    if (temp_v1 != 0) {
        this->unk_194 = temp_v1 - 1;
    }
...
void func_808D1ED4(Actor *arg0, GlobalContext *arg1) {
    ...
    arg0[1].focus.pos.z = func_808D1F7C;
}
...
void func_808D2040(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.yDistToPlayer < -10.0f) && ((this->unk_354.base.ocFlags1 & 2) != 0) && (sp24 == this->unk_354.base.oc)) {
...
void func_808D217C(Actor *arg0, Actor *arg1) {
    ...
    arg0->home.pos.x = Math_SinS(arg0->shape.rot.y) * temp_v0->unk_8;
    temp_f12 = temp_v0->unk_0;
    if (temp_f2 < temp_f12) {
        arg0->home.pos.y = temp_f12;
    } else {
        temp_f12_2 = temp_v0->unk_4;
    ...
    sp30 = temp_v0;
    arg0->home.pos.z = Math_CosS(arg0->shape.rot.y) * temp_v0->unk_8;
    Math_Vec3f_Sum(arg1 + 0x24, (Vec3f *) &arg0->home, (Vec3f *) &arg0->world);
    arg0->shape.rot.x = -0x4CE0;
    arg0[1].focus.pos.z = (bitwise f32) func_808D22C8;
}
...
void func_808D22C8(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->unk_144) != 0) {
        if (this->unk_144.animPlaybackSpeed > 0.0f) {
            ...
            this->unk_144.animFrameCount = 36.0f;
            this->unk_144.initialFrame = 45.0f;
        } else {
            this->unk_144.animPlaybackSpeed = 1.0f;
            this->unk_144.animFrameCount = 45.0f;
            this->unk_144.initialFrame = 36.0f;
        }
    }
    sp24 = temp_a3;
    Math_Vec3f_Sum((Vec3f *) &temp_a3->world, (Vec3f *) &this->actor.home, (Vec3f *) &this->actor.world);
    if (((temp_a3->unk_A70 & 0x80) == 0) || ((s32) temp_a3->unk_D5C < 0)) {
        temp_a0 = this->actor.parent;
        temp_v1 = temp_a0[1].focus.pos.z;
        temp_a1 = this->actor.child;
        if (((func_808D22C8 == (bitwise s32) temp_v1) || (func_808D2AA8 == (bitwise s32) temp_v1)) && ((temp_v1_2 = temp_a1[1].focus.pos.z, (func_808D22C8 == (bitwise s32) temp_v1_2)) || (func_808D2AA8 == (bitwise s32) temp_v1_2))) {
            temp_a0->params = 0x20;
            temp_a1->params = 0x20;
    ...
    } else if (((s32) this->unk_190 % 0x14) == 0) {
        func_800B8E58(temp_a3, (temp_a3->unk_A68->unk_92 + 0x6805) & 0xFFFF);
...
block_6:
        if (func_801378B8(temp_a0, 20.0f) != 0) {
            this->actor.speedXZ = 5.0f;
            this->actor.velocity.y = 7.0f;
        } else if (this->unk_144.animCurrentFrame < 20.0f) {
...
void func_808D2700(Actor *arg0) {
    ...
    arg0->speedXZ = 0.0f;
    func_808D08D0(arg0);
    arg0[1].focus.pos.z = (bitwise f32) func_808D2764;
}
...
void func_808D2764(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if (this->unk_194 == 0) {
        if (func_808D2AA8 != (bitwise s32) temp_a0[1].focus.pos.z) {
            sp28 = func_808D2AA8;
            sp34 = 0;
            sp38 = temp_a3;
        ...
        phi_a2 = 0;
        if (func_808D2AA8 != this->actor.child[1].focus.pos.z) {
            sp34 = 0;
        ...
        temp_v1 = temp_a0[1].focus.pos.z;
        if ((func_808D2AA8 != (bitwise s32) temp_v1) && (func_808D1F7C != (bitwise s32) temp_v1)) {
            phi_a2_2 = 1;
        }
        temp_v1_2 = temp_a3[1].focus.pos.z;
        phi_a2 = phi_a2_2;
        if ((func_808D2AA8 != (bitwise s32) temp_v1_2) && (func_808D1F7C != (bitwise s32) temp_v1_2)) {
            phi_a2 = phi_a2_2 + 1;
        }
    }
...
block_17:
    ...
    this->unk_354.dim.radius = (s16) (s32) ((f32) D_808D38A0.dim.radius * 100.0f * phi_f2);
    this->unk_354.dim.height = (s16) (s32) ((f32) D_808D38A0.dim.height * 100.0f * phi_f2);
    sp24 = temp_a0_2;
...
void func_808D2A20(Actor *arg0) {
    ...
    temp_a1[2].focus.pos.x = 0.0f;
    temp_a3 = temp_a1->child;
    if ((func_808D2AA8 == temp_a2[1].focus.pos.z) && (temp_a0 = temp_a2, (func_808D2AA8 == temp_a3[1].focus.pos.z))) {
        arg0 = temp_a1;
        sp18 = temp_a3;
    ...
    temp_a1->draw = NULL;
    temp_a1[1].focus.pos.z = (bitwise f32) func_808D2AA8;
    temp_a1->flags &= -0x12;
}
...
void func_808D2AB8(Actor *arg0) {
    arg0->unk_364 = (u8) (arg0->unk_364 & ~3);
    arg0->unk_365 = (u8) (arg0->unk_365 & ~3);
    arg0->unk_366 = (u8) (arg0->unk_366 & ~3);
    arg0[1].focus.pos.z = func_808D2AF4;
}
...
void func_808D2B18(Actor *arg0) {
    ...
    if (arg0->params == 0x40) {
        temp_a0 = arg0->parent;
        if ((func_808D2AA8 != (bitwise s32) temp_a0[1].focus.pos.z) && ((s32) temp_a0->colChkInfo.health > 0)) {
            func_808D2700((EnFloormas *) temp_a0);
        } else {
            temp_a0_2 = arg0->child;
            if ((func_808D2AA8 != (bitwise s32) temp_a0_2[1].focus.pos.z) && ((s32) temp_a0_2->colChkInfo.health > 0)) {
                func_808D2700((EnFloormas *) temp_a0_2);
            }
        }
        arg0->params = 0x20;
    }
    arg0[1].focus.pos.z = (bitwise f32) func_808D2C08;
}
...
void func_808D2D6C(Actor *arg0) {
    ...
    func_800BE504(arg0, arg0 + 0x354);
    arg0[1].focus.pos.z = (bitwise f32) func_808D2DC0;
}
...
void func_808D2E34(Actor *arg0, GlobalContext *arg1) {
    ...
    temp_v0 = arg0->unk_365;
    if (((temp_v0 & 2) != 0) && ((arg0->unk_365 = (u8) (temp_v0 & 0xFFFD), func_800BE258(arg0, arg0 + 0x36C), (arg0->unk_18C != 0xA)) || ((*arg0[2].prevPos.x & 0xDB0B3) == 0))) {
        if (arg0->colChkInfo.damageEffect == 0xE) {
            func_808D0908((EnFloormas *) arg0);
            arg0->colorFilterTimer = 0;
            arg0->colChkInfo.damage = 4;
            arg0[1].focus.unk_12 = -0x640;
            arg0->gravity = -1.0f;
            ...
            if (temp_v0_2 != 0xF) {
                if (temp_v0_2 == 3) {
                    ...
                    if (arg0->colChkInfo.health == 0) {
                        ...
                        arg0->unk_365 = (u8) (arg0->unk_365 & 0xFFFE);
                    }
                    func_808D2D6C(arg0);
                    return;
                }
                ...
                if (temp_v0_2 == 2) {
                    ...
                    Actor_Spawn(&arg1->actorCtx, arg1, 0xA2, (f32) arg0->unk_37A, (f32) arg0->unk_37C, (f32) arg0->unk_37E, (s16) 0, (s16) 0, (s16) 0, (s16) phi_v0);
                }
                func_808D2B18(arg0);
...
void EnFloormas_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808D2AA8 != this->actionFunc) {
        temp_v0 = this->unk_354.base.atFlags;
        if ((temp_v0 & 2) != 0) {
            this->unk_354.base.atFlags = temp_v0 & 0xFFFD;
        ...
        if (func_808D2AF4 != temp_v1) {
            ...
            if (this->unk_2C4 > 0.0f) {
                if (this->unk_18C != 0xA) {
                    ...
                    temp_f0_2 = (this->unk_2C4 + 1.0f) * 0.275f;
                ...
                if (Math_StepToF(&this->unk_2CC, 0.55f, 0.01375f) == 0) {
...
void func_808D34C4(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4, s32 **arg5) {
    ...
    if ((arg1 + &D_808D393C) == &D_808D393E) {
        ...
        *temp_v0_2 = 0xDA380003;
        sp20 = temp_v0_2;
        sp20[1] = Matrix_NewMtx(*arg0);
        temp_v0_3 = *arg5;
        *arg5 = temp_v0_3 + 8;
        temp_v0_3[1] = &D_06008688;
...
void EnFloormas_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_354.base.colType == 0xC) {
        func_800AE2A0(globalCtx, &D_808D3958, (s16) ((s32) this->unk_190 % 0x28), 0x28);
    }
    sp30->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk_144.skeleton, this->unk_144.limbDrawTbl, (s32) this->unk_144.dListCount, func_808D3488, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_808D34C4, (Actor *) this, sp30->polyOpa.p);
    if (this->unk_354.base.colType == 0xC) {
        func_800AE5A0(globalCtx);
    }
    temp_f0 = this->actor.scale.x;
    func_800BE680(globalCtx, (Actor *) this, (Vec3f []) &this->unk_2D0, 0xB, this->unk_2C8 * temp_f0 * 100.0f, this->unk_2CC * temp_f0 * 100.0f, this->unk_2C4, (u8) (s32) this->unk_18C);
}
...
void func_808D3754(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (thisx->unk_368 == 0xC) {
        func_800AE5E4(globalCtx, &D_808D3958, (s16) ((s32) thisx[1].focus.rot.z % 0x28), 0x28);
    }
    sp30->polyXlu.p = SkelAnime_DrawSV2(globalCtx, (void **) thisx[1].flags, thisx->unk_164, (s32) thisx[1].category, func_808D3488, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_808D34C4, thisx, sp30->polyXlu.p);
    if (thisx->unk_368 == 0xC) {
        func_800AE8EC(globalCtx);
    }
    temp_f0 = thisx->scale.x;
    func_800BE680(globalCtx, thisx, (Vec3f []) (Vec3f *) &thisx[2].focus.rot, 0xB, thisx[2].focus.pos.y * temp_f0 * 100.0f, thisx[2].focus.pos.z * temp_f0 * 100.0f, thisx[2].focus.pos.x, (u8) (s32) thisx->unk_18C);
}
