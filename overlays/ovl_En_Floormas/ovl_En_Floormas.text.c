...
void func_808D2AB8(Actor *arg0, Actor *, Actor *, Actor *); /* static */
...
static InitChainEntry D_808D38F4;                   /* unable to generate initializer */
...
typedef struct EnFloormas {
    ...
    /* 0x0188 */ void (*actionFunc)(EnFloormas *, GlobalContext *);
    ...
    /* 0x019C */ char pad19C[0x90];                 /* maybe part of unk196[25]? */
    /* 0x022C */ Vec3s unk22C;                      /* inferred */
    /* 0x0232 */ char pad232[0x92];
    /* 0x02C4 */ f32 unk2C4;                        /* inferred */
    /* 0x02C8 */ f32 unk2C8;                        /* inferred */
    /* 0x02CC */ f32 unk2CC;                        /* inferred */
    /* 0x02D0 */ Vec3f unk2D0;                      /* inferred */
    /* 0x02DC */ char pad2DC[0x78];                 /* maybe part of unk2D0[11]? */
    /* 0x0354 */ ColliderCylinder unk354;           /* inferred */
...
void EnFloormas_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, &D_808D38F4);
    ...
    Collider_InitAndSetCylinder(globalCtx, &this->unk354, &this->actor, &D_808D38A0);
...
void func_808D0B50(EnFloormas *this, GlobalContext *globalCtx) {
    if (SkelAnime_FrameUpdateMatrix(&this->unk144) != 0) {
        if ((this->actor.xzDistToPlayer < 400.0f) && (Actor_IsActorFacingLink(&this->actor, 0x4000) == 0)) {
            this->unk190 = this->actor.yawTowardsPlayer;
            func_808D108C(this);
            return;
        }
        if ((this->actor.xzDistToPlayer < 280.0f) && (Actor_IsActorFacingLink(&this->actor, 0x2000) != 0)) {
...
void func_808D0D70(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.xzDistToPlayer < 320.0f) && (Actor_IsActorFacingLink(&this->actor, 0x4000) != 0)) {
        func_808D0F50(this);
        return;
    }
...
void func_808D0F80(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if ((this->actor.xzDistToPlayer < 280.0f) && (Actor_IsActorFacingLink(&this->actor, 0x2000) != 0) && ((this->actor.bgCheckFlags & 8) == 0)) {
        func_808D1380(this, globalCtx);
        return;
    }
...
void func_808D108C(EnFloormas *arg0) {
    ...
    if ((s32) temp_v1 > 0) {
        ...
        sp36 = temp_v1;
        SkelAnime_ChangeAnim(arg0 + 0x144, &D_06002158, -1.0f, (f32) SkelAnime_GetFrameCount(&D_06002158.common), 0.0f, (u8) 2, -3.0f);
    }
...
block_7:
        if (this->actor.scale.x > 0.009f) {
            ...
            Audio_PlayActorSound2(&this->actor, 0x3931U);
        }
    }
...
void func_808D1650(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if (temp_f0_2 < 12.0f) {
        func_808D14DC(&this->actor, globalCtx);
    }
...
void func_808D17EC(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if ((temp_v0 & 2) != 0) {
        ...
        if (this->actor.velocity.y < -4.0f) {
            if (this->actor.scale.x > 0.009f) {
                Audio_PlayActorSound2(&this->actor, 0x3893U);
            } else {
                Audio_PlayActorSound2(&this->actor, 0x3937U);
            }
        }
    }
    if ((this->actor.bgCheckFlags & 8) != 0) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->unk144) != 0) {
        ...
        if ((this->unk18E == 0) && (sp24 != 0)) {
            if (this->unk144.animFrameCount < 45.0f) {
                this->unk144.animFrameCount = (f32) SkelAnime_GetFrameCount(&D_060019CC.common);
...
void func_808D19D4(Actor *arg0) {
    ...
    SkelAnime_ChangeAnim((SkelAnime *) (arg0 + 0x144), &D_060019CC, 1.0f, 41.0f, (f32) SkelAnime_GetFrameCount(&D_060019CC.common), (u8) 2, 0.0f);
...
block_11:
            sp2C = phi_a3;
            Math_ScaledStepToS(&this->actor.shape.rot.y, Actor_YawBetweenActors(&this->actor, phi_a3), 0x38E);
...
void func_808D1F7C(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    this = this;
    if (Math_StepToF(&temp_a0->x, 0.0f, 0.0015f) != 0) {
        temp_a0_2 = this;
        this = this;
...
void func_808D217C(Actor *arg0, Actor *arg1) {
    ...
    Math_Vec3f_Sum(arg1 + 0x24, &arg0->home.pos, &arg0->world.pos);
...
void func_808D22C8(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    sp24 = temp_a3;
    Math_Vec3f_Sum(&temp_a3->world.pos, &this->actor.home.pos, &this->actor.world.pos);
    ...
    Audio_PlayActorSound2(&this->actor, 0x3136U);
}
...
block_17:
    ...
    if (((phi_f12 == 0.007f) || (phi_f12 == 0.004f)) && (phi_f12 != this->actor.scale.x)) {
        Audio_PlayActorSound2(&this->actor, 0x3934U);
        phi_f2 = this->actor.scale.x;
    }
    ...
    func_800B9010(&this->actor, 0x3133U);
}
...
void func_808D2C08(EnFloormas *this, GlobalContext *globalCtx) {
    ...
    if ((SkelAnime_FrameUpdateMatrix(temp_a0) != 0) && ((this->actor.bgCheckFlags & 1) != 0)) {
        if (this->actor.colChkInfo.health == 0) {
            func_808D0930(&this->actor, globalCtx);
        } else {
            func_808D2CDC(this);
        }
    }
...
void EnFloormas_Update(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (func_808D2AA8 != this->actionFunc) {
        ...
        func_808D2E34(&this->actor, globalCtx);
        ...
        if (func_808D2AF4 != temp_v1) {
            ...
            Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 20.0f, this->actor.scale.x * 3000.0f, 0.0f, 0x1DU);
            temp_a1 = &this->unk354;
            sp28 = temp_a1;
...
void EnFloormas_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp30->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_808D3488, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_808D34C4, &this->actor, sp30->polyOpa.p);
    if (this->unk354.base.colType == 0xC) {
        func_800AE5A0(globalCtx);
    }
    temp_f0 = this->actor.scale.x;
    func_800BE680(globalCtx, &this->actor, (Vec3f []) &this->unk2D0, 0xB, this->unk2C8 * temp_f0 * 100.0f, this->unk2CC * temp_f0 * 100.0f, this->unk2C4, (u8) (s32) this->unk18C);
}
