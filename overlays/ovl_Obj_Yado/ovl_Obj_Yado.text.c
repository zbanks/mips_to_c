...
void ObjYado_Init(ObjYado *this, GlobalContext *globalCtx) {
...
void ObjYado_Destroy(ObjYado *this, GlobalContext *globalCtx) {
    ObjYado *this = (ObjYado *) thisx;

}

void ObjYado_Update(ObjYado *this, GlobalContext *globalCtx) {
    ObjYado *this = (ObjYado *) thisx;
    this->unk144 = (u8) gSaveContext.isNight;
}

void ObjYado_Draw(ObjYado *this, GlobalContext *globalCtx) {
