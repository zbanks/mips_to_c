typedef struct EnOsn {
    ...
    /* 0x1E4 */ char pad1E4[0x6];
    /* 0x1EA */ u16 unk1EA;                         /* inferred */
    /* 0x1EC */ u8 unk1EC;                          /* inferred */
    /* 0x1ED */ char pad1ED[0x3];                   /* maybe part of unk1EC[4]? */
    /* 0x1F0 */ s8 unk1F0;                          /* inferred */
    /* 0x1F1 */ char pad1F1[0xB];                   /* maybe part of unk1F0[12]? */
...
void func_80AD0A24(Actor *arg0) {
    ...
    temp_t8 = arg0->unk1EC;
    arg0 = arg0;
    if ((arg0->unk1EC == 0x15) && (sp1E == SkelAnime_GetFrameCount((AnimationHeaderCommon *) D_80AD22C0[temp_t8].animation))) {
        arg0->unk1EC = 0x16U;
...
void EnOsn_Init(EnOsn *this, GlobalContext *globalCtx) {
    SkelAnime *sp38;
...
void EnOsn_Destroy(EnOsn *this, GlobalContext *globalCtx) {
    EnOsn *this = (EnOsn *) thisx;
    SkelAnime_Free(&this->unk190, globalCtx);
    Collider_DestroyCylinder(globalCtx, &this->unk144);
}

void EnOsn_Update(EnOsn *this, GlobalContext *globalCtx) {
    u32 sp34;
    EnOsn *this = (EnOsn *) thisx;
...
void func_80AD1E28(GraphicsContext **arg0, s32 arg1, Gfx **arg2, Vec3s *arg3, Actor *arg4, s32 **arg5) {
    ...
    sp30.unk0 = (s32) D_80AD2574.unk0;
    sp30.unk4 = (s32) D_80AD2574.unk4;
    sp30.unk8 = (s32) D_80AD2574.unk8;
...
void EnOsn_Draw(EnOsn *this, GlobalContext *globalCtx) {
    Gfx *sp54;
    Gfx *sp50;
    Gfx *sp4C;
    Gfx *sp48;
    ...
    if (this->unk1FC == 0xFF) {
        ...
        temp_s0->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80AD1DA8, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80AD1E28, (Actor *) this, temp_s0->polyOpa.p);
        return;
    }
    ...
    temp_s0->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->unk190.skeleton, this->unk190.limbDrawTbl, (s32) this->unk190.dListCount, func_80AD1DA8, (void (*)(GlobalContext *, s32, Gfx **, Vec3s *, Actor *, Gfx **)) func_80AD1E28, (Actor *) this, temp_s0->polyXlu.p);
}
