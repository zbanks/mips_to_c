...
void BgIcicle_Init(BgIcicle *this, GlobalContext *globalCtx) {
...
void BgIcicle_Destroy(BgIcicle *this, GlobalContext *globalCtx) {
...
void BgIcicle_Update(BgIcicle *this, GlobalContext *globalCtx) {
    ColliderCylinder *sp24;
...
void BgIcicle_Draw(BgIcicle *this, GlobalContext *globalCtx) {
    BgIcicle *this = (BgIcicle *) thisx;
