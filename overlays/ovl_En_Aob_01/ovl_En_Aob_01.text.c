...
static ActorAnimationEntry D_809C3790 = {
...
static s16 D_809C392C = {0xFA0, 4, 1, 3, 0x1770, 4, 1, 6, 0xFA0, 4, 1, 3, 0x1770, 4, 1, 6};
...
typedef struct EnAob01 {
    /* 0x0000 */ Actor actor;
    /* 0x0144 */ void (*actionFunc)(EnAob01 *, GlobalContext *);
    /* 0x0148 */ SkelAnime unk148;                  /* inferred */
    /* 0x018C */ ColliderCylinder unk18C;           /* inferred */
    /* 0x019F */ u8 unk19F;                         /* overlap; inferred */
    /* 0x01A0 */ char pad1A0[0x70];                 /* maybe part of unk19F[113]? */
    /* 0x0210 */ u16 unk210;                        /* inferred */
    /* 0x0212 */ Vec3s unk212;                      /* inferred */
    /* 0x0218 */ char pad218[0x5A];                 /* maybe part of unk212[16]? */
    /* 0x0272 */ Vec3s unk272;                      /* inferred */
    /* 0x0278 */ char pad278[0x5A];                 /* maybe part of unk272[16]? */
    /* 0x02D2 */ u16 unk2D2;                        /* inferred */
    /* 0x02D4 */ ? unk2D4;                          /* inferred */
    /* 0x02D5 */ char pad2D5[0x3];
    /* 0x02D8 */ u16 unk2D8;                        /* inferred */
    /* 0x02DA */ ? unk2DA;                          /* inferred */
    /* 0x02DB */ char pad2DB[0x3];
    /* 0x02DE */ u16 unk2DE;                        /* inferred */
    /* 0x02E0 */ ? unk2E0;                          /* inferred */
    /* 0x02E1 */ char pad2E1[0x3];
    /* 0x02E4 */ u16 unk2E4;                        /* inferred */
    /* 0x02E6 */ ? unk2E6;                          /* inferred */
    /* 0x02E7 */ char pad2E7[0x3];
    /* 0x02EA */ u16 unk2EA;                        /* inferred */
    /* 0x02EC */ ? unk2EC;                          /* inferred */
    /* 0x02ED */ char pad2ED[0x3];
    /* 0x02F0 */ u16 unk2F0;                        /* inferred */
    /* 0x02F2 */ ? unk2F2;                          /* inferred */
    /* 0x02F3 */ char pad2F3[0x3];
    /* 0x02F6 */ u16 unk2F6;                        /* inferred */
    /* 0x02F8 */ char pad2F8[0xF6];                 /* maybe part of unk2F6[124]? */
    /* 0x03EE */ s16 unk3EE;                        /* inferred */
    /* 0x03F0 */ s16 unk3F0;                        /* inferred */
    /* 0x03F2 */ char pad3F2[0x2];                  /* maybe part of unk3F0[2]? */
    /* 0x03F4 */ Actor *unk3F4;                     /* inferred */
    /* 0x03F8 */ char pad3F8[0x38];                 /* maybe part of unk3F4[15]? */
    /* 0x0430 */ s16 unk430;                        /* inferred */
    /* 0x0432 */ s16 unk432;                        /* inferred */
    /* 0x0434 */ s32 unk434;                        /* inferred */
    /* 0x0436 */ s16 unk436;                        /* overlap; inferred */
    /* 0x0438 */ char pad438[0x4];                  /* maybe part of unk436[3]? */
    /* 0x043C */ s32 unk43C;                        /* inferred */
    /* 0x0440 */ s16 unk440;                        /* inferred */
    /* 0x0442 */ char pad442[0x2];                  /* maybe part of unk440[2]? */
} EnAob01;                                          /* size 0x444 */
...
s32 func_809C15BC(EnAob01 *arg0) {
    ...
    temp_v1 = arg0->unk43C;
    if ((temp_v1 != 0) && (temp_v1 != 5)) {
        if (sp1E == SkelAnime_GetFrameCount(&(&D_809C3790)[temp_t8].animation->common)) {
            arg0->unk43C = 5;
...
block_67:
    ...
    default:
block_68:
        func_801518B0(arg1, sp1E, phi_a3);
    }
}
    ...
    if (temp_v0 == 4) {
        if (func_80147624(globalCtx) != 0) {
            ...
            if (temp_v0_2 != 0) {
                ...
                func_8019F230();
                this->unk210 = 0x3535;
                func_801518B0(globalCtx, 0x3535U & 0xFFFF, &this->actor);
                return;
            }
            if ((s32) gSaveContext.rupees < 0xA) {
                play_sound(0x4806U);
                this->unk210 = 0x3524;
                func_801518B0(globalCtx, 0x3524U & 0xFFFF, &this->actor);
                return;
            }
            func_8019F208();
            this->unk210 = 0x3522;
            ...
            func_801518B0(globalCtx, 0x3522U & 0xFFFF, &this->actor);
...
void func_809C2060(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (func_809C15BC(this) != 0) {
        ...
        if ((func_800B84D0(&this->actor, globalCtx) != 0) && (temp_v0 = this->unk2D2, ((temp_v0 & 0x100) != 0))) {
            ...
            func_809C16DC(&this->actor, globalCtx);
            this->actionFunc = func_809C21E0;
            return;
        }
        ...
        if ((this->unk2D2 & 8) != 0) {
            if (func_800B84D0(&this->actor, globalCtx) != 0) {
                ...
                if ((temp_v0_2 & 4) != 0) {
                    ...
                    func_801518B0(globalCtx, 0x354BU, &this->actor);
                }
                this->unk2D2 &= 0xFFF7;
                return;
            }
...
void func_809C28B8(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0(&this->actor, globalCtx) != 0) {
        ...
        func_801518B0(globalCtx, this->unk210, &this->actor);
...
void func_809C2A64(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (func_809C15BC(this) != 0) {
        ...
        func_800B8A1C(&this->actor, globalCtx, 0xC, 300.0f, 300.0f);
        // Duplicate return node #11. Try simplifying control flow for better match
    }
}
...
block_5:
        if ((sp2F == 5) && (func_80147624(globalCtx) != 0)) {
            ...
            if (this->unk434 >= 0x96) {
                this->unk210 = 0x352E;
                func_801518B0(globalCtx, 0x352EU & 0xFFFF, &this->actor);
            ...
            this->unk210 = 0x354C;
            func_801518B0(globalCtx, 0x354CU & 0xFFFF, &this->actor);
            this->actionFunc = func_809C1D64;
            gSaveContext.eventInf[0] &= 0xF8;
...
void EnAob01_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Collider_SetCylinder(globalCtx, temp_a1_2, &this->actor, &D_809C3820);
    this->unk43C = 0;
...
void EnAob01_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    func_801343C0(globalCtx, this->unk148.skeleton, this->unk148.limbDrawTbl, (s32) this->unk148.dListCount, (s32 (*)(GlobalContext *, s32, Gfx **, Vec3f *, Vec3s *, Actor *)) func_809C33D8, func_809C35B4, func_809C35F4, &this->actor);
