typedef struct EnAob01 {
    ...
    /* 0x19F */ u8 unk_19F;                         /* overlap; inferred */
    /* 0x1D8 */ char pad_1D8[0x38];                 /* maybe part of unk_19F[57]? */
    /* 0x210 */ u16 unk_210;                        /* inferred */
    /* 0x212 */ Vec3s unk_212;                      /* inferred */
    /* 0x218 */ char pad_218[0x5A];                 /* maybe part of unk_212[16]? */
    /* 0x272 */ Vec3s unk_272;                      /* inferred */
    /* 0x278 */ char pad_278[0x5A];                 /* maybe part of unk_272[16]? */
    /* 0x2D2 */ u16 unk_2D2;                        /* inferred */
    /* 0x2D4 */ ? unk_2D4;                          /* inferred */
    /* 0x2D4 */ char pad_2D4[0x4];
    /* 0x2D8 */ u16 unk_2D8;                        /* inferred */
    /* 0x2DA */ ? unk_2DA;                          /* inferred */
    /* 0x2DA */ char pad_2DA[0x4];
    /* 0x2DE */ u16 unk_2DE;                        /* inferred */
    /* 0x2E0 */ ? unk_2E0;                          /* inferred */
    /* 0x2E0 */ char pad_2E0[0x4];
    /* 0x2E4 */ u16 unk_2E4;                        /* inferred */
    /* 0x2E6 */ ? unk_2E6;                          /* inferred */
    /* 0x2E6 */ char pad_2E6[0x4];
    /* 0x2EA */ u16 unk_2EA;                        /* inferred */
    /* 0x2EC */ ? unk_2EC;                          /* inferred */
    /* 0x2EC */ char pad_2EC[0x4];
    /* 0x2F0 */ u16 unk_2F0;                        /* inferred */
    /* 0x2F2 */ ? unk_2F2;                          /* inferred */
    /* 0x2F2 */ char pad_2F2[0x4];
    /* 0x2F6 */ u16 unk_2F6;                        /* inferred */
    /* 0x2F8 */ char pad_2F8[0xFC];                 /* maybe part of unk_2F6[127]? */
    /* 0x3F4 */ Actor *unk_3F4;                     /* inferred */
    /* 0x3F8 */ char pad_3F8[0x38];                 /* maybe part of unk_3F4[15]? */
    /* 0x430 */ s16 unk_430;                        /* inferred */
    /* 0x432 */ s16 unk_432;                        /* inferred */
    /* 0x434 */ s32 unk_434;                        /* inferred */
    /* 0x438 */ char pad_438[0x4];
    /* 0x43C */ s32 unk_43C;                        /* inferred */
    /* 0x440 */ s16 unk_440;                        /* inferred */
    /* 0x442 */ char pad_442[0x2];
} EnAob01;                                          /* size = 0x444 */
...
void func_809C11EC(EnAob01 *arg0, GlobalContext *arg1) {
    ...
    do {
        ...
        temp_s0 = phi_s0 + 1;
        (arg0 + (phi_s0 * 4))->unk_3F8 = Actor_SpawnAsChildAndCutscene(&arg1->actorCtx, arg1, 0xE2, temp_v0->unk_0, temp_v0->unk_4, temp_v0->unk_8, (s16) 0, (s16) (s32) ((f32) temp_v0->unk_C * 182.04445f), (s16) 0, ((arg0 + (temp_v0->unk_E * 4))->unk_1D8->unk_1 << 0xA) | (phi_s0 << 5), 0xFFFFU, (s32) arg0->actor.unk20, NULL);
        phi_s0 = temp_s0;
...
void func_809C1304(EnAob01 *arg0, GlobalContext *arg1) {
    ...
    do {
        temp_f0 = (f32) phi_s0;
        temp_s0 = phi_s0 + 1;
        (arg0 + (phi_s0 * 4))->unk_3F8 = Actor_SpawnAsChildAndCutscene(arg1 + 0x1CA0, arg1, 0x1EE, (temp_f0 * 15.0f) + -3897.0f, 130.0f, 1290.0f - (temp_f0 * 10.0f), (s16) 0, (s16) 0x1555, (s16) 0, (phi_s0 << 5) | (arg0->actor.params & 0x7E00), 0xFFFFU, (s32) arg0->actor.unk20, NULL);
        phi_s0 = temp_s0;
    } while ((s32) temp_s0 < 0xE);
}
...
s32 func_809C1424(EnAob01 *arg0) {
    ...
    sp1E = (s16) (s32) arg0->unk_148.animCurrentFrame;
    temp_t8 = arg0->unk_43C;
    arg0 = arg0;
    temp_v1 = arg0->unk_43C;
    if (temp_v1 == 1) {
...
s32 func_809C14D0(EnAob01 *arg0) {
    ...
    temp_f6 = (s32) arg0->unk_148.animCurrentFrame;
    temp_a0 = D_809C3790[arg0->unk_43C].animation;
    sp1E = (s16) temp_f6;
    arg0 = arg0;
...
void func_809C165C(EnAob01 *arg0, GlobalContext *arg1) {
    ...
    temp_a2 = arg0 + 0x18C;
    arg0->unk_18C.dim.pos.x = (s16) (s32) arg0->actor.world.pos.x;
    arg0->unk_18C.dim.pos.y = (s16) (s32) arg0->actor.world.pos.y;
    arg0->unk_18C.dim.pos.z = (s16) (s32) arg0->actor.world.pos.z;
    sp18 = temp_a2;
...
void func_809C1C9C(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (gSaveContext.rupeeAccumulator == 0) {
        ...
        gSaveContext.eventInf[0] = (temp_t7 & 7) | (this->unk_432 * 8);
...
void func_809C1D64(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (temp_v0 == 4) {
        if (func_80147624(globalCtx) != 0) {
            ...
            func_8019F208();
            this->unk_210 = 0x3522;
            temp_t0 = this->unk_2D2 | 4;
            this->unk_2D2 = temp_t0;
            this->unk_2D2 = temp_t0 | 0x10;
...
void func_809C2060(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (func_809C15BC(this) != 0) {
        if ((func_809C2EC4(this, globalCtx) != 0) && ((this->unk_2D2 & 0x100) == 0)) {
            if ((this->unk_19F & 1) != 0) {
        ...
        if ((func_800B84D0((Actor *) this, globalCtx) != 0) && (temp_v0 = this->unk_2D2, ((temp_v0 & 0x100) != 0))) {
            this->unk_2E6 = (unaligned s32) this->unk_2D4;
            this->unk_2EC = (unaligned s32) this->unk_2DA;
            this->unk_2F2 = (unaligned s32) this->unk_2E0;
            this->unk_2D2 = temp_v0 & 0xFEFF;
            this->unk_2EA = this->unk_2D8;
            this->unk_2F0 = this->unk_2DE;
            this->unk_2F6 = this->unk_2E4;
            func_809C16DC((Actor *) this, globalCtx);
            this->actionFunc = func_809C21E0;
            return;
        }
        temp_t5 = this->unk_2D2 & ~0x100;
        this->unk_2D2 = temp_t5;
        if ((this->actor.xzDistToPlayer < 100.0f) && ((this->unk_19F & 1) == 0)) {
            this->unk_2D2 = temp_t5 | 0x100;
            func_800B8614((Actor *) this, globalCtx, 100.0f);
        }
        /* Duplicate return node #11. Try simplifying control flow for better match */
    }
...
void func_809C21E0(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (((this->unk_2D2 & 8) != 0) && (func_809C2EC4(this, globalCtx) == 0)) {
...
block_14:
        if ((this->unk_2D2 & 8) != 0) {
            if (func_800B84D0((Actor *) this, globalCtx) != 0) {
                ...
                if ((temp_v0_2 & 4) != 0) {
                    ...
                    this->unk_2D2 = temp_t5;
                    this->unk_2D2 = temp_t5 | 0x40;
                    this->unk_43C = 1;
                    func_800BDC5C(&this->unk_148, (ActorAnimationEntry []) D_809C3790, 1);
        ...
        if (sp2F == 5) {
            if (func_80147624(globalCtx) != 0) {
                temp_t5_2 = this->unk_2D2 & 0xFFBF;
                temp_v0_4 = temp_t5_2 & 0xFFFF;
                this->unk_2D2 = temp_t5_2;
                if ((temp_v0_4 & 0x10) != 0) {
                    this->unk_2D2 = temp_v0_4 & 0xFFEF;
                    globalCtx->msgCtx.unk11F22 = 0x43;
                    globalCtx->msgCtx.unk12023 = 4;
                    this->actionFunc = func_809C2060;
                    return;
...
s32 func_809C2504(EnAob01 *arg0, void *arg1) {
    ...
    temp_s0 = arg1->unk_1CE4;
    phi_s0 = temp_s0;
    if (temp_s0 != 0) {
loop_1:
        if ((phi_s0->unk_0 == 0x1EE) && (func_800F2178(arg0->unk_430) == phi_s0->unk_1E8)) {
            ActorCutscene_Stop(arg0->unk_430);
            arg0->unk_3F4 = phi_s0;
            arg0->unk_430 = ActorCutscene_GetAdditionalCutscene(arg0->unk_430);
            return 1;
        }
...
? func_809C2594(EnAob01 *arg0, GlobalContext *arg1) {
    ...
    if (temp_v1 != 0) {
loop_1:
        if ((phi_v1->id == 0x1EE) && (phi_v1->unk_292 == phi_v1->unk_290)) {
            arg0->unk_3F4 = phi_v1;
            return 1;
        }
...
s32 func_809C25E4(void *arg0, void *arg1) {
    ...
    if (temp_v0 != 0) {
        do {
            phi_v1_3 = phi_v1_4;
            if ((phi_v0->unk_0 == 0x1EE) && (phi_v0->unk_29C == 3)) {
    ...
    if (phi_v1 >= 0xA) {
        temp_v0_3 = arg0->unk_440;
        if (temp_v0_3 == 0) {

        } else {
            arg0->unk_440 = (s16) (temp_v0_3 - 1);
            phi_v1_2 = arg0->unk_440;
        }
        if (phi_v1_2 == 0) {
            return 1;
        }
...
s32 func_809C2680(EnAob01 *arg0) {
    ...
    if ((ActorCutscene_GetLength(arg0->unk_430) > 0) && (temp_a0 = arg0->unk_430, (ActorCutscene_GetCurrentIndex() != temp_a0))) {
        arg0->unk_430 = ActorCutscene_GetAdditionalCutscene(temp_a0);
        return 1;
    }
    return 0;
}
...
void func_809C2824(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->unk_430) != 0) {
        ActorCutscene_Start(this->unk_430, this->unk_3F4);
        temp_v0 = func_800F2178(this->unk_430);
        if (temp_v0 != 0x63) {
            if (temp_v0 == 0xFF) {
...
void func_809C28B8(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (func_800B84D0((Actor *) this, globalCtx) != 0) {
        ...
        func_801518B0(globalCtx, this->unk_210, (Actor *) this);
...
void func_809C2A64(EnAob01 *this, GlobalContext *globalCtx) {
    ...
    if (func_809C15BC(this) != 0) {
        ...
        if (Actor_HasParent((Actor *) this, globalCtx) != 0) {
            this->unk_2D4 = (unaligned s32) this->unk_2E6;
            this->unk_2DA = (unaligned s32) this->unk_2EC;
            this->unk_2E0 = (unaligned s32) this->unk_2F2;
            this->actor.parent = NULL;
            this->unk_2D8 = this->unk_2EA;
            this->unk_2DE = this->unk_2F0;
            this->unk_2E4 = this->unk_2F6;
...
block_5:
        if ((sp2F == 5) && (func_80147624(globalCtx) != 0)) {
            temp_t2 = this->unk_2D2 & 0xFFBF;
            this->unk_2D2 = temp_t2;
            this->unk_2D2 = temp_t2 & 0xFF7F;
            if (this->unk_434 >= 0x96) {
                this->unk_210 = 0x352E;
...
void func_809C2FA0(void) {
    ...
    sp34.unk_0 = (s32) D_809C394C.unk_0;
    sp34.unk_4 = (s32) D_809C394C.unk_4;
    sp34.unk_8 = (s32) D_809C394C.unk_8;
    sp34.unk_C = (u16) D_809C394C.unk_C;
    phi_s0 = 0;
    phi_s0_2 = 0;
    phi_s0_3 = 0;
    do {
    ...
    do {
        ...
        if ((phi_a1_2 % 2) != 0) {
            ...
            temp_t5 = temp_t4 | temp_a0_2->unk_F22;
            *temp_v0_2 = temp_t4;
            temp_a0_2->unk_F22 = temp_t5;
        } else {
...
void EnAob01_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    sp38 = temp_a1;
    SkelAnime_InitSV(globalCtx, temp_a1, &D_06000180, NULL, &this->unk_212, &this->unk_272, 0x10);
    ...
    if (temp_v0 != 0) {
        ...
        this->unk_430 = (s16) this->actor.cutscene;
...
s32 func_809C33D8(void **arg0, s32 arg1, Gfx **arg2, Vec3f *arg3, Vec3s *arg4, Actor *arg5) {
    ...
    sp38.unk_0 = (s32) D_809C395C.unk_0;
    sp38.unk_4 = (s32) D_809C395C.unk_4;
    sp38.unk_8 = (s32) D_809C395C.unk_8;
    if (arg1 == 0xF) {
        temp_v1 = *arg0;
        *arg2 = &D_06003D18;
    ...
    if (arg1 == 8) {
        SysMatrix_InsertXRotation_s((s16) ((s32) arg5->unk_2E2 * -1), 1);
        SysMatrix_InsertZRotation_s((s16) ((s32) arg5->unk_2E0 * -1), 1);
    }
    if ((arg1 == 8) || (arg1 == 9) || (arg1 == 0xC)) {
        temp_v1_2 = arg5 + (arg1 * 2);
        sp24 = temp_v1_2;
        arg4->y += (s16) (s32) Math_SinS(temp_v1_2->unk_2F8) * 0xC8;
        arg4->z += (s16) (s32) Math_CosS(temp_v1_2->unk_318) * 0xC8;
    }
    return 0;
}
