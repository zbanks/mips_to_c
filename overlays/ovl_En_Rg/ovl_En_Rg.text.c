typedef struct EnRg {
    ...
    /* 0x18C */ void *unk18C;                       /* inferred */
    /* 0x190 */ ColliderCylinder unk190;            /* inferred */
    /* 0x1DC */ ColliderSphere unk1DC;              /* inferred */
    /* 0x234 */ s32 unk234;                         /* inferred */
    /* 0x238 */ Vec3s unk238;                       /* inferred */
    /* 0x23E */ char pad23E[0x66];                  /* maybe part of unk238[18]? */
    /* 0x2A4 */ Vec3s unk2A4;                       /* inferred */
    /* 0x2AA */ char pad2AA[0x66];                  /* maybe part of unk2A4[18]? */
    /* 0x310 */ u16 unk310;                         /* inferred */
    /* 0x312 */ char pad312[0x6];                   /* maybe part of unk310[4]? */
    /* 0x318 */ s16 unk318;                         /* inferred */
    /* 0x31A */ char pad31A[0x2];
    /* 0x31C */ s16 unk31C;                         /* inferred */
    /* 0x31E */ s16 unk31E;                         /* inferred */
    /* 0x320 */ s16 unk320;                         /* inferred */
    /* 0x322 */ char pad322[0x2];
    /* 0x324 */ s16 unk324;                         /* inferred */
    /* 0x326 */ char pad326[0x2];
    /* 0x328 */ s16 unk328;                         /* inferred */
    /* 0x32A */ char pad32A[0x4];                   /* maybe part of unk328[3]? */
    /* 0x32E */ s16 unk32E;                         /* inferred */
    /* 0x330 */ char pad330[0x4];                   /* maybe part of unk32E[3]? */
    /* 0x334 */ s32 unk334;                         /* inferred */
    /* 0x338 */ char pad338[0x4];
    /* 0x33C */ s32 unk33C;                         /* inferred */
    /* 0x340 */ s32 unk340;                         /* inferred */
    /* 0x344 */ s32 unk344;                         /* inferred */
    /* 0x348 */ char pad348[0x784];                 /* maybe part of unk344[482]? */
} EnRg;                                             /* size = 0xACC */
...
? func_80BF416C(Actor *arg0, GlobalContext *arg1) {
    if (((arg0->bgCheckFlags & 1) != 0) && (arg0->speedXZ >= 0.01f)) {
        ...
        func_800AE930(arg1 + 0x830, Effect_GetParams(arg0->unk340), (f32 *) &arg0->world, 18.0f, (s16) (s32) arg0->shape.rot.y, arg0->floorPoly, (s32) arg0->floorBgId);
    } else {
...
? func_80BF42BC(void *arg0, f32 arg1) {
    ...
    arg0->unk5C = (f32) ((Math_SinS(unksp26) * 0.01f) + 0.01f);
    arg0->unk60 = (f32) ((Math_SinS(unksp26) * 0.01f) + 0.01f);
...
void func_80BF4964(EnRg *arg0) {
    ...
    if (temp_v0 != 0) {
        ...
        if (((temp_v0_6 & 0x400) == 0) && ((temp_v0_6 & 0x1000) == 0) && (arg0->unk322 == 0) && (arg0->unk324 == 0) && ((arg0->actor.bgCheckFlags & 1) != 0)) {
            ...
            if (temp_v0_7 == 0) {
                Math_Vec3s_ToVec3f((Vec3f *) &sp30, (arg0->unk33C * 6) + sp3C);
            } else {
    ...
    if (func_801690CC(globalCtx) == 0) {
        ...
        if ((gSaveContext.eventInf[1] & 1) != 0) {
            ...
            if (phi_v1 == 0) {
                ...
                if ((this->unk324 == 0) && (func_80BF4DA8((Actor *) this) == 0)) {
...
void EnRg_Init(EnRg *this, GlobalContext *globalCtx) {
    void *temp_v0;
    ...
    if (gSaveContext.entranceIndex == 0xD010) {
        ...
        Collider_InitAndSetSphere(globalCtx, &this->unk1DC, (Actor *) this, &D_80BF5760);
        Collider_InitAndSetCylinder(globalCtx, &this->unk190, (Actor *) this, &D_80BF578C);
...
void EnRg_Destroy(EnRg *this, GlobalContext *globalCtx) {
    EnRg *this = (EnRg *) thisx;
...
void EnRg_Update(EnRg *this, GlobalContext *globalCtx) {
    EnRg *this = (EnRg *) thisx;
...
void EnRg_Draw(EnRg *this, GlobalContext *globalCtx) {
    ...
    if ((this->unk310 & 0x10) == 0) {
        ...
        SkelAnime_DrawSV(globalCtx, this->unk144.skeleton, this->unk144.limbDrawTbl, (s32) this->unk144.dListCount, func_80BF5588, NULL, (Actor *) this);
    } else {
