...
void Fault_SleepImpl(u32 duration) {
    ...
    do {
        temp_t8 = phi_t8 - 8;
        temp_t8->unk0 = 0xFFFA5A5A;
        temp_t8->unk4 = 0xFFFA5A5A;
        phi_t8 = temp_t8;
    } while (temp_t8 != sp);
...
void Fault_AddClient(FaultClient *client, void (*callback)(void *, void *), void *param0, void *param1) {
    ...
    do {
        temp_t6 = phi_t6 - 8;
        temp_t6->unk0 = 0xFFFA5A5A;
        temp_t6->unk4 = 0xFFFA5A5A;
        phi_t6 = temp_t6;
    } while (temp_t6 != sp);
    sp20 = 0;
...
void Fault_RemoveClient(FaultClient *client) {
    ...
    do {
        temp_t4 = phi_t4 - 8;
        temp_t4->unk0 = 0xFFFA5A5A;
        temp_t4->unk4 = 0xFFFA5A5A;
        phi_t4 = temp_t4;
    } while (temp_t4 != sp);
    temp_v1 = sFaultContext->clients;
    sp18 = 0;
...
void Fault_AddAddrConvClient(FaultAddrConvClient *client, void *(*callback)(void *, void *), void *param) {
    ...
    do {
        temp_t5 = phi_t5 - 8;
        temp_t5->unk0 = 0xFFFA5A5A;
        temp_t5->unk4 = 0xFFFA5A5A;
        phi_t5 = temp_t5;
    } while (temp_t5 != sp);
    sp18 = 0;
    client = client;
...
void Fault_Sleep(u32 duration) {
    ...
    do {
        temp_t7 = phi_t7 - 8;
        temp_t7->unk0 = 0xFFFA5A5A;
        temp_t7->unk4 = 0xFFFA5A5A;
        phi_t7 = temp_t7;
    } while (temp_t7 != sp);
...
u32 Fault_WaitForInputImpl(void) {
    ...
    do {
        temp_t2 = phi_t2 - 8;
        temp_t2->unk0 = 0xFFFA5A5A;
        temp_t2->unk4 = 0xFFFA5A5A;
        phi_t2 = temp_t2;
    } while (temp_t2 != sp);
...
void Fault_DrawRec(s32 x, s32 y, s32 w, s32 h, u16 color) {
    ...
    do {
        temp_t0 = phi_t0 - 8;
        temp_t0->unk0 = 0xFFFA5A5A;
        temp_t0->unk4 = 0xFFFA5A5A;
        phi_t0 = temp_t0;
    } while (temp_t0 != sp);
    sp10 = (s32) color;
...
void Fault_PrintFReg(s32 idx, f32 *value) {
    ...
    do {
        temp_t9 = phi_t9 - 8;
        temp_t9->unk0 = 0xFFFA5A5A;
        temp_t9->unk4 = 0xFFFA5A5A;
        phi_t9 = temp_t9;
    } while (temp_t9 != sp);
    temp_a2 = *value;
...
void Fault_PrintThreadContext(OSThread *t) {
    ...
    do {
        temp_t1 = phi_t1 - 8;
        temp_t1->unk0 = 0xFFFA5A5A;
        temp_t1->unk4 = 0xFFFA5A5A;
        phi_t1 = temp_t1;
    } while (temp_t1 != sp);
    ...
    FaultDrawer_Printf("AT:%08xH V0:%08xH V1:%08xH\n", temp_s0_2->unk4, temp_s0_2->unkC, temp_s0_2->unk14);
    FaultDrawer_Printf("A0:%08xH A1:%08xH A2:%08xH\n", temp_s0_2->unk1C, temp_s0_2->unk24, temp_s0_2->unk2C);
    FaultDrawer_Printf("A3:%08xH T0:%08xH T1:%08xH\n", temp_s0_2->unk34, temp_s0_2->unk3C, temp_s0_2->unk44);
    FaultDrawer_Printf("T2:%08xH T3:%08xH T4:%08xH\n", temp_s0_2->unk4C, temp_s0_2->unk54, temp_s0_2->unk5C);
    FaultDrawer_Printf("T5:%08xH T6:%08xH T7:%08xH\n", temp_s0_2->unk64, temp_s0_2->unk6C, temp_s0_2->unk74);
    FaultDrawer_Printf("S0:%08xH S1:%08xH S2:%08xH\n", temp_s0_2->unk7C, temp_s0_2->unk84, temp_s0_2->unk8C);
    FaultDrawer_Printf("S3:%08xH S4:%08xH S5:%08xH\n", temp_s0_2->unk94, temp_s0_2->unk9C, temp_s0_2->unkA4);
    FaultDrawer_Printf("S6:%08xH S7:%08xH T8:%08xH\n", temp_s0_2->unkAC, temp_s0_2->unkB4, temp_s0_2->unkBC);
    FaultDrawer_Printf("T9:%08xH GP:%08xH SP:%08xH\n", temp_s0_2->unkC4, temp_s0_2->unkCC, temp_s0_2->unkD4);
    FaultDrawer_Printf("S8:%08xH RA:%08xH LO:%08xH\n\n", temp_s0_2->unkDC, temp_s0_2->unkE4, temp_s0_2->unkEC);
...
void Fault_Wait5Seconds(void) {
    ...
    do {
        temp_t3 = phi_t3 - 8;
        temp_t3->unk0 = 0xFFFA5A5A;
        temp_t3->unk4 = 0xFFFA5A5A;
        phi_t3 = temp_t3;
    } while (temp_t3 != sp);
    temp_ret = osGetTime();
...
void Fault_SetOptionsFromController3(void) {
    ...
    if (faultCustomOptions != 0) {
        ...
        sp28 = graphOSThread.unk104;
        sp24 = graphOSThread.unkF4;
...
block_10:
    ...
    do {
        ...
        Fault_DrawMemDump(phi_s0->context.pc - 0x100, phi_s0->unkF4, 0U, 0U);
...
void Fault_Start(void) {
    ...
    osCreateThread(&sFaultContext->thread, 2, (void *) Fault_ThreadEntry, NULL);
...
void Fault_AddHungupAndCrashImpl(s8 *arg0, s8 *arg1) {
    ...
    Fault_AddClient(&sp20, (void (*)(void *, void *)) Fault_HangupFaultClient, (void *) arg0, (void *) arg1);
