...
loop_4:
    if (temp_a0 == phi_a0->unk20) {
        return phi_v1;
    }
    if (temp_a0 == phi_a0->unk22) {
        return phi_v1 + 1;
    }
    if (temp_a0 == phi_a0->unk24) {
        return phi_v1 + 2;
    }
    if (temp_a0 == phi_a0->unk26) {
        return phi_v1 + 3;
    }
    temp_v1 = phi_v1 + 4;
    phi_a0 += 8;
        ...
        do {
            ...
            if (temp_v0->escCode != 0) {
                ...
                if (((s32) temp_a1 >= 0x31) && ((s32) temp_a1 < 0x3A)) {
                    FaultDrawer_SetForeColor((sFaultDrawContext + (temp_a1 * 2))->unk-40);
                }
            } else {
                temp_a0 = *phi_s1;
                if (temp_a0 != 0xA) {
