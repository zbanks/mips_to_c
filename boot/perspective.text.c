...
void guPerspectiveF(f32 (*mf)[4], u16 *perspNorm, f32 fovy, f32 aspect, f32 near, f32 far, f32 scale) {
    ...
    mf->unk_2C = -1.0f;
    mf->unk_14 = temp_f2;
    mf->unk_28 = (f32) (temp_f18 / temp_f12_2);
    mf[0][0] = temp_f2 / aspect;
    mf->unk_3C = 0.0f;
    mf->unk_38 = (f32) ((2.0f * near * far) / temp_f12_2);
    temp_f16 = mf[0][1];
    ...
    if (1 != 4) {
        do {
            temp_f16_2 = phi_v0->unk_14;
            temp_f12_4 = phi_v0->unk_18;
            temp_v1 = phi_v1 + 1;
            temp_f14_2 = phi_v0->unk_1C;
            phi_v0[0][0] = phi_f10;
            temp_f10_2 = phi_v0->unk_10 * scale;
