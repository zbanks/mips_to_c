struct _mips2c_stack___osPfsCheckRamArea {
    ...
    /* 0x31 */ char pad31[0x1F];                    /* maybe part of sp30[32]? */
    /* 0x50 */ u8 sp50;                             /* inferred */
    /* 0x51 */ char pad51[0x1F];                    /* maybe part of sp50[32]? */
    /* 0x70 */ u8 sp70;                             /* inferred */
    /* 0x71 */ char pad71[0x27];
};                                                  /* size = 0x98 */

struct _mips2c_stack_osPfsInitPak {
    /* 0x00 */ char pad0[0x20];
    /* 0x20 */ u8 sp20;                             /* inferred */
    /* 0x21 */ char pad21[0x17];                    /* maybe part of sp20[24]? */
    /* 0x38 */ u16 sp38;                            /* inferred */
    /* 0x3A */ char pad3A[0xA];                     /* maybe part of sp38[6]? */
    /* 0x44 */ u8 *sp44;                            /* inferred */
    /* 0x48 */ u8 sp48;                             /* inferred */
    /* 0x49 */ char pad49[0x17];                    /* maybe part of sp48[24]? */
