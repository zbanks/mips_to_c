struct _mips2c_stack_osVoiceSetWord {
    ...
    /* 0x34 */ ? sp34;                              /* inferred */
    /* 0x34 */ char pad_34[0x13];
    /* 0x47 */ ? sp47;                              /* inferred */
    /* 0x47 */ char pad_47[0x4];
    /* 0x4B */ u8 sp4B;                             /* inferred */
    /* 0x4C */ char pad_4C[0x4];                    /* maybe part of sp4B[5]? */
...
s32 osVoiceSetWord(void *arg0, u8 *arg1) {
    ...
    (sp + -phi_a0_2)->unk_42 = 3;
    if ((phi_a2 >= 0xF) && (temp_v0_2 = __osVoiceContWrite20(arg0->unk_0, arg0->unk_4, 0, &sp20), (temp_v0_2 != 0))) {
        return temp_v0_2;
    }
    temp_v0 = __osVoiceContWrite20(arg0->unk_0, arg0->unk_4, 0, &sp34);
    if (temp_v0 != 0) {
        return temp_v0;
    }
