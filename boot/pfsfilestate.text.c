struct _mips2c_stack_osPfsFileState {
    ...
    /* 0x036 */ char pad_36[0x2];
    /* 0x038 */ u8 sp38;                            /* inferred */
    /* 0x039 */ char pad_39[0x3];                   /* maybe part of sp38[4]? */
    /* 0x03C */ u16 sp3C;                           /* inferred */
    /* 0x03E */ u16 sp3E;                           /* inferred */
    /* 0x040 */ char pad_40[0x4];                   /* maybe part of sp3E[3]? */
    /* 0x044 */ ? sp44;                             /* inferred */
    /* 0x044 */ char pad_44[0x4];
    /* 0x048 */ ? sp48;                             /* inferred */
    /* 0x048 */ char pad_48[0x10];
    /* 0x058 */ ? sp58;                             /* inferred */
    /* 0x058 */ char pad_58[0x108];
};                                                  /* size = 0x160 */
...
s32 osPfsFileState(void *arg0, s32 arg1, void *arg2) {
    ...
    temp_v0_2 = __osContRamRead(arg0->unk_4, arg0->unk_8, (arg0->unk_5C + arg1) & 0xFFFF, &sp38);
    if (temp_v0_2 != 0) {
        return temp_v0_2;
    }
...
loop_16:
    ...
    arg2->unk_0 = (s32) (phi_s2 << 8);
    arg2->unk_8 = sp3C;
    arg2->unk_4 = (s32) sp38;
    bcopy((void *) &sp48, arg2 + 0xE, 0x10U);
    bcopy((void *) &sp44, arg2 + 0xA, 4U);
    return __osPfsGetStatus(arg0->unk_4, arg0->unk_8);
}
