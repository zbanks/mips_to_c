struct _mips2c_stack_IrqMgr_AddClient {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_IrqMgr_CheckStack {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_IrqMgr_HandlePRENMI450 {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_IrqMgr_HandlePRENMI480 {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_IrqMgr_HandlePRENMI500 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_IrqMgr_HandlePreNMI {
    /* 0x00 */ char pad_0[0x30];
};                                                  /* size = 0x30 */

struct _mips2c_stack_IrqMgr_HandleRetrace {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_IrqMgr_Init {
    /* 0x00 */ char pad_0[0x2C];
    /* 0x2C */ OSMesgQueue *sp2C;                   /* inferred */
};                                                  /* size = 0x30 */

struct _mips2c_stack_IrqMgr_JamMesgForClient {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_IrqMgr_RemoveClient {
    /* 0x00 */ char pad_0[0x18];
    /* 0x18 */ IrqMgrClient *sp18;                  /* inferred */
    /* 0x1C */ IrqMgrClient *sp1C;                  /* inferred */
};                                                  /* size = 0x20 */

struct _mips2c_stack_IrqMgr_SendMesgForClient {
    /* 0x00 */ char pad_0[0x20];
};                                                  /* size = 0x20 */

struct _mips2c_stack_IrqMgr_ThreadEntry {
...
void IrqMgr_HandlePreNMI(IrqMgr *irqmgr) {
    ...
    irqmgr->unk_250 = temp_v0;
    irqmgr->unk_254 = temp_v1;
    sIrqMgrResetTime.unk_0 = temp_v0;
    sIrqMgrResetTime.unk_4 = temp_v1;
...
void IrqMgr_HandleRetrace(IrqMgr *irqmgr) {
    ...
    if ((sIrqMgrRetraceTime.unk_0 == 0) && (sIrqMgrRetraceTime.unk_4 == 0)) {
        if ((irqmgr->unk_278 == 0) && (irqmgr->unk_27C == 0)) {
            temp_ret = osGetTime();
            temp_v1 = (u32) temp_ret;
            irqmgr->unk_278 = temp_ret;
            irqmgr->unk_27C = temp_v1;
        } else {
            temp_ret_2 = osGetTime();
            temp_v1_2 = (u32) temp_ret_2;
            temp_t3 = irqmgr->unk_27C;
            sIrqMgrRetraceTime.unk_0 = (s32) ((temp_ret_2 - irqmgr->unk_278) - (temp_v1_2 < temp_t3));
            sIrqMgrRetraceTime.unk_4 = (s32) (temp_v1_2 - temp_t3);
        }
    }
