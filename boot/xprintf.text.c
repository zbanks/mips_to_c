struct _mips2c_stack__Printf {
    ...
    /* 0x75 */ char pad_75[0x2B];                   /* maybe part of sp74[44]? */
    /* 0xA0 */ ? spA0;                              /* inferred */
...
void _Putfld(_Pft *px, s8 **pap, u8 code, u8 *ac) {
    ...
    if (temp_t6 >= 0x26) {
        ...
        case 105:
            ...
            if (px->qual == 0x68) {
                temp_t3 = px->unk_4;
                px->unk_0 = (s32) ((s32) (s16) temp_t3 >> 0x1F);
                px->unk_4 = (s32) (s16) temp_t3;
            }
            temp_t0 = px->unk_0;
            if (temp_t0 <= 0) {
                if (temp_t0 >= 0) {
...
block_17:
        ...
        case 120:
            ...
            if (temp_v0_4 == 0x68) {
                px->unk_0 = 0;
                px->unk_4 = (s32) (px->unk_4 & 0xFFFF);
            } else if (temp_v0_4 == 0) {
                px->unk_0 = 0;
                px->unk_4 = (s32) px->unk_4;
            }
        ...
        case 103:
            if (px->qual == 0x4C) {
                ...
                px->v.ll = phi_v0_2->unk_-8;
            }
            if (((u16) px->unk_0 & 0x8000) != 0) {
                ac[px->n0] = 0x2D;
                px->n0 += 1;
            } else {
                temp_v0_7 = px->flags;
