struct _mips2c_stack___osPfsReleasePages {
    ...
    /* 0x0A */ char padA[0x2];                      /* maybe part of sp9[3]? */
...
struct _mips2c_stack_osPfsDeleteFile {
    ...
    /* 0x046 */ char pad46[0x2];
    /* 0x048 */ u8 sp48;                            /* inferred */
    /* 0x049 */ char pad49[0x5];                    /* maybe part of sp48[6]? */
    /* 0x04E */ u8 sp4E;                            /* inferred */
    /* 0x04F */ u8 sp4F;                            /* inferred */
    /* 0x050 */ char pad50[0x18];                   /* maybe part of sp4F[25]? */
    /* 0x068 */ ? sp68;                             /* inferred */
    /* 0x068 */ char pad68[0x104];
