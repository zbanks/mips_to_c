struct _mips2c_stack___osPfsReleasePages {
    /* 0x00 */ char pad_0[0x8];
    /* 0x08 */ u16 sp8;                             /* inferred */
    /* 0x09 */ u8 sp9;                              /* overlap; inferred */
    /* 0x0A */ char pad_A[0x2];                     /* maybe part of sp9[3]? */
    /* 0x0C */ u16 spC;                             /* inferred */
    /* 0x0E */ char pad_E[0x2];
};                                                  /* size = 0x10 */

struct _mips2c_stack_osPfsDeleteFile {
    /* 0x000 */ char pad_0[0x44];
    /* 0x044 */ u16 sp44;                           /* inferred */
    /* 0x046 */ char pad_46[0x2];
    /* 0x048 */ u8 sp48;                            /* inferred */
    /* 0x049 */ char pad_49[0x5];                   /* maybe part of sp48[6]? */
    /* 0x04E */ u8 sp4E;                            /* inferred */
    /* 0x04F */ u8 sp4F;                            /* inferred */
    /* 0x050 */ char pad_50[0x18];                  /* maybe part of sp4F[25]? */
    /* 0x068 */ ? sp68;                             /* inferred */
    /* 0x068 */ char pad_68[0x104];
    /* 0x16C */ s32 sp16C;                          /* inferred */
};                                                  /* size = 0x170 */
...
s32 osPfsDeleteFile(void *arg0, s32 arg1, s32 arg2, s32 arg4) {
    ...
    temp_v0_4 = __osContRamRead(arg0->unk_4, arg0->unk_8, (arg0->unk_5C + sp16C) & 0xFFFF, &sp48);
    phi_s0 = sp4E;
    phi_s0_2 = (s32) sp4E;
    if (temp_v0_4 != 0) {
        return temp_v0_4;
...
loop_12:
        ...
        if ((s32) (u8) sp44 >= (s32) arg0->unk_64) {
            goto block_21;
        }
        goto loop_12;
    }
block_21:
    if (phi_s0_2 >= (s32) arg0->unk_64) {
        return 3;
    }
    bzero((void *) &sp48, 0x20);
    return __osContRamWrite(arg0->unk_4, arg0->unk_8, (arg0->unk_5C + sp16C) & 0xFFFF, &sp48, 0);
}
