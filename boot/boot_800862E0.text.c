...
struct _mips2c_stack_SystemArena_FreeNull {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_SystemArena_Init {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_SystemArena_MallocMin1 {
    /* 0x00 */ char pad_0[0x18];
};                                                  /* size = 0x18 */

struct _mips2c_stack_func_8008633C {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_800863AC {
    /* 0x00 */ char pad_0[0x28];
};                                                  /* size = 0x28 */

struct _mips2c_stack_func_8008641C {
    /* 0x00 */ char pad_0[0x48];
};                                                  /* size = 0x48 */

struct _mips2c_stack_func_80086588 {
...
void func_80086588(void) {
    ...
    if (temp_v0 != 0) {
        do {
            ...
            temp_v0_2 = temp_s0->unk_0;
            temp_s0->unk_0 = phi_s1;
            phi_v0 = temp_v0_2;
            phi_s1 = temp_s0;
            phi_s1_2 = temp_s0;
        } while (temp_v0_2 != 0);
