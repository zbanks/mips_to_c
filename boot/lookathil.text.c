struct _mips2c_stack_guLookAtHilite {
    /* 0x00 */ char pad_0[0x58];
    /* 0x58 */ ? sp58;                              /* inferred */
    /* 0x58 */ char pad_58[0x40];
};                                                  /* size = 0x98 */

struct _mips2c_stack_guLookAtHiliteF {
    ...
    /* 0x58 */ char pad_58[0x28];                   /* maybe part of sp54[11]? */
...
void guLookAtHilite(Mtx *m, LookAt *l, Hilite *h, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 xUp, f32 yUp, f32 zUp, f32 xl1, f32 yl1, f32 zl1, f32 xl2, f32 yl2, f32 zl2, s32 twidth, s32 theight) {
    ...
    guLookAtHiliteF((f32 [4][4]) (f32 (*)[4]) &sp58, l, h, xEye, yEye, zEye, xAt, yAt, zAt, xUp, yUp, zUp, xl1, yl1, zl1, xl2, yl2, zl2, twidth, theight);
    guMtxF2L((f32 [4][4]) (f32 (*)[4]) &sp58, m);
}
