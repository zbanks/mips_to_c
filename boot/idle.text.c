...
void Idle_InitCodeAndMemory(void) {
    ...
    sp28 = temp_t6;
    DmaMgr_SendRequestImpl(&sp48, (void *) EnAObj_Init, (u32) _codeSegmentRomStart, _ovl_titleSegmentRomStart - _codeSegmentRomStart, 0, &sp30, NULL);
    Idle_InitScreen();
    Idle_InitMemory();
...
void Idle_InitVideo(void) {
    ...
    if (temp_v0 != 0) {
        if (temp_v0 != 1) {
            if (temp_v0 != 2) {
                ...
                do {
                    temp_t5 = phi_t5 + 0xC;
                    temp_t4 = phi_t4 + 0xC;
                    temp_t4->unk-C = (s32) *phi_t5;
                    temp_t4->unk-8 = (s32) temp_t5->unk-8;
                    temp_t4->unk-4 = (s32) temp_t5->unk-4;
                    phi_t5 = temp_t5;
                    phi_t4 = temp_t4;
                } while (temp_t5 != &osViModeMpalLan1.fldRegs[1].vBurst);
                temp_t4->unk0 = (s32) temp_t5->unk0;
        ...
        do {
            ...
            temp_t8_2->unk-C = (s32) *phi_t0;
            temp_t8_2->unk-8 = (s32) temp_t0->unk-8;
            temp_t8_2->unk-4 = (s32) temp_t0->unk-4;
            phi_t0 = temp_t0;
            phi_t8_2 = temp_t8_2;
        } while (temp_t0 != &osViModeFpalLan1.fldRegs[1].vBurst);
        temp_t8_2->unk0 = (s32) temp_t0->unk0;
