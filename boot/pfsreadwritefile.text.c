...
struct _mips2c_stack_osPfsReadWriteFile {
    ...
    /* 0x038 */ char pad_38[0x3];
    /* 0x03B */ s8 sp3B;                            /* inferred */
    /* 0x03C */ char pad_3C[0xC];                   /* maybe part of sp3B[13]? */
    /* 0x048 */ u16 sp48;                           /* inferred */
    /* 0x04A */ char pad_4A[0x2];
    /* 0x04C */ ? sp4C;                             /* inferred */
    /* 0x04C */ char pad_4C[0x100];
    /* 0x14C */ u8 sp14C;                           /* inferred */
    /* 0x14D */ char pad_14D[0x3];                  /* maybe part of sp14C[4]? */
    /* 0x150 */ u16 sp150;                          /* inferred */
    /* 0x152 */ u16 sp152;                          /* inferred */
    /* 0x154 */ u8 sp154;                           /* inferred */
    /* 0x155 */ char pad_155[0x1B];
};                                                  /* size = 0x170 */
...
s32 __osPfsGetNextPage(OSPfs *param_1, __OSInode *param_2, u8 param_3, u8 param_4) {
    ...
    temp_at = *((s32) param_3 + (param_4->unk_1 * 2));
    param_4->unk_0 = temp_at;
    temp_v1 = temp_at & 0xFFFF;
    if ((temp_v1 < param_1->inodeStartPage) || ((s32) param_4->unk_0 >= (s32) param_1->banks) || (temp_v0_3 = param_4->unk_1, ((s32) temp_v0_3 <= 0)) || (phi_v0 = 0, (((s32) temp_v0_3 < 0x80) == 0))) {
        if (temp_v1 == 1) {
            return 5;
        }
        phi_v0 = 3;
