...
void osContGetReadData(OSContPad *data) {
    ...
    if ((s32) __osMaxControllers > 0) {
        do {
            sp4.unk_0 = (s32) (unaligned s32) phi_v0->unk_0;
            sp4.unk_4 = (s32) (unaligned s32) phi_v0->unk_4;
...
void __osPackReadData(void) {
    ...
    if ((s32) __osMaxControllers > 0) {
        do {
            temp_v1 = phi_v1 + 1;
            temp_v0 = phi_v0 + 8;
            temp_v0->unk_-8 = (unaligned s32) spC.unk_0;
            temp_v0->unk_-4 = (unaligned s32) spC.unk_4;
            phi_v0 = temp_v0;
            phi_v1 = temp_v1;
            phi_v0_2 = temp_v0;
        } while (temp_v1 < (s32) __osMaxControllers);
