...
struct _mips2c_stack_osPfsAllocateFile {
    ...
    /* 0x052 */ char pad_52[0x2];                   /* maybe part of sp51[3]? */
    /* 0x054 */ s32 sp54;                           /* inferred */
    /* 0x058 */ char pad_58[0x8];                   /* maybe part of sp54[3]? */
    /* 0x060 */ s32 sp60;                           /* inferred */
    /* 0x064 */ u16 sp64;                           /* inferred */
    /* 0x066 */ u16 sp66;                           /* inferred */
    /* 0x068 */ char pad_68[0x2];
    /* 0x06A */ s16 sp6A;                           /* inferred */
    /* 0x06C */ ? sp6C;                             /* inferred */
    /* 0x06C */ char pad_6C[0x4];
    /* 0x070 */ ? sp70;                             /* inferred */
    /* 0x070 */ char pad_70[0x10];
    /* 0x080 */ ? sp80;                             /* inferred */
    /* 0x080 */ char pad_80[0x100];
    /* 0x180 */ ? sp180;                            /* inferred */
    /* 0x180 */ char pad_180[0x10C];
...
loop_18:
        ...
        if (sp294 != -1) {
            ...
            temp_v0_7->unk_0 = (s8) phi_s0;
            temp_v0_7->unk_1 = (s8) sp294;
...
block_32:
    ...
    return __osContRamWrite(arg0->unk_4, arg0->unk_8, (*arg6 + arg0->unk_5C) & 0xFFFF, (u8 *) &sp60, 0);
}
