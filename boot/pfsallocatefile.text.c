s32 __osPfsRWInode(void *, void *, ?, s32);         /* extern */
s32 osPfsFindFile(void *, u16, void *, void *, s32 *, s32 *); /* extern */
? osPfsFreeBlocks(void *, s32 *);                   /* extern */
s32 __osPfsDeclearPage(void *arg0, void *arg1, s32 arg2, s32 *arg3, s32 arg4, s32 *arg5, s32 *arg6); /* static */
...
block_32:
    ...
    sp64 = arg1;
    sp60 = arg2;
    bcopy(arg3, &sp70, 0x10U);
    bcopy(arg4, &sp6C, 4U);
    return __osContRamWrite(arg0->unk4, arg0->unk8, (*arg6 + arg0->unk5C) & 0xFFFF, (u8 *) &sp60, 0);
}

s32 __osPfsDeclearPage(void *arg0, void *arg1, s32 arg2, s32 *arg3, u8 arg4, s32 *arg5, s32 *arg6) {
    s32 temp_v1;
    s32 temp_v1_2;
    s32 temp_v1_3;
    void *temp_t1;
