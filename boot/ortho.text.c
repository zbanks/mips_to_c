...
void guOrthoF(f32 (*mf)[4], f32 l, f32 r, f32 b, f32 t, f32 n, f32 f, f32 scale) {
    ...
    mf[0][0] = 2.0f / temp_f0;
    temp_f2 = t - b;
    mf->unk28 = (f32) (-2.0f / temp_f12);
    mf->unk14 = (f32) (2.0f / temp_f2);
    mf->unk30 = (f32) (-(r + l) / temp_f0);
    mf->unk34 = (f32) (-(t + b) / temp_f2);
    mf->unk3C = 1.0f;
    mf->unk38 = (f32) (-(f + n) / temp_f12);
    temp_f18 = mf[0][1];
    ...
    if (1 != 4) {
        do {
            ...
            phi_v0[0][0] = phi_f12;
            temp_f12_3 = phi_v0->unk10 * scale;
            phi_v0[0][1] = phi_f18 * scale;
            phi_v0[0][2] = phi_f14 * scale;
            temp_v0 = phi_v0 + 0x10;
            temp_v0->unk-4 = (f32) (phi_f16 * scale);
            phi_f12 = temp_f12_3;
            phi_v0 = temp_v0;
            phi_f18 = temp_f18_2;
            phi_f14 = temp_f14_2;
    ...
    temp_v0_2->unk-10 = phi_f12_2;
    temp_v0_2->unk-C = (f32) (phi_f18_2 * scale);
    temp_v0_2->unk-8 = (f32) (phi_f14_2 * scale);
    temp_v0_2->unk-4 = (f32) (phi_f16_2 * scale);
}

void guOrtho(Mtx *m, f32 l, f32 r, f32 b, f32 t, f32 n, f32 f, f32 scale) {
    f32 sp28[4];

    guOrthoF((f32 [4][4]) sp28, l, r, b, t, n, f, scale);
