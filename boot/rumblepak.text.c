...
struct _mips2c_stack_osProbeRumblePak {
    ...
    /* 0x25 */ char pad25[0x1E];                    /* maybe part of sp24[31]? */
...
s32 osSetRumble(void *arg0, s32 arg1) {
    ...
    temp_t0 = (arg0->unk8 << 6) + &D_8009CDB0;
    if ((arg0->unk0 & 8) == 0) {
        return 5;
    }
    arg1 = arg1;
    sp24 = temp_t0;
    __osSiGetAccess();
    (&D_8009CDB0 + (arg0->unk8 << 6))->unk3C = 1;
    ...
    sp24 = temp_t0_2;
    arg1 = arg1;
    __osSiRawStartDma(1, &D_8009CDB0 + (arg0->unk8 << 6));
    osRecvMesg(arg0->unk4, NULL, 1);
    __osSiRawStartDma(0, (arg0->unk8 << 6) + &D_8009CDB0);
    osRecvMesg(arg0->unk4, NULL, 1);
