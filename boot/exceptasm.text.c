...
struct _mips2c_stack___osDispatchThread {};         /* size 0x0 */

struct _mips2c_stack___osEnqueueThread {};          /* size 0x0 */

struct _mips2c_stack___osNop {};                    /* size 0x0 */

struct _mips2c_stack___osPopThread {};              /* size 0x0 */
