struct _mips2c_stack_Rand_Centered {};              /* size 0x0 */

struct _mips2c_stack_Rand_Centered_Variable {};     /* size 0x0 */

struct _mips2c_stack_Rand_Next {};                  /* size 0x0 */

struct _mips2c_stack_Rand_Next_Variable {};         /* size 0x0 */

struct _mips2c_stack_Rand_Seed {};                  /* size 0x0 */

struct _mips2c_stack_Rand_Seed_Variable {};         /* size 0x0 */

struct _mips2c_stack_Rand_ZeroOne {};               /* size 0x0 */

struct _mips2c_stack_Rand_ZeroOne_Variable {};      /* size 0x0 */
