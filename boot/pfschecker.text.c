...
loop_7:
        ...
        if ((sp2A0 != 0) || ((s32) sp29C != 0)) {
            ...
            phi_s0 = 0;
            phi_a0 = 0;
            if (((s32) sp4BC >= arg0->unk60) && ((s32) (u8) sp4BC < (s32) arg0->unk64) && ((s32) unksp4BD > 0) && (phi_s1 = 0xFFU, (((s32) unksp4BD < 0x80) != 0))) {
loop_18:
                phi_s7 = phi_s7_3;
                phi_fp_3 = phi_fp;
                phi_fp_3 = phi_fp;
...
block_24:
                ...
                phi_a0 = temp_a0;
                phi_fp_2 = phi_fp_3;
                if ((temp_a0 != 0) || (sp4BC = *(&sp2BC + (unksp4BD * 2)), phi_s0 = 1, (((s32) sp4BC < arg0->unk60) != 0)) || ((s32) (u8) sp4BC >= (s32) arg0->unk64) || ((s32) unksp4BD <= 0) || ((s32) unksp4BD >= 0x80)) {
                    goto block_29;
                }
                goto loop_18;
            }
