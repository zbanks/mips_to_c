...
void osInitialize(void) {
    ...
    D_8000000C = __osExceptionPreamble.unk0;
    D_8000000C = __osExceptionPreamble.unk4;
    D_8000000C = __osExceptionPreamble.unk8;
    D_8000000C = __osExceptionPreamble.unkC;
    (void *)0x80000080->unk0 = (s32) __osExceptionPreamble.unk0;
    (void *)0x80000080->unk4 = (s32) __osExceptionPreamble.unk4;
    (void *)0x80000080->unk8 = (s32) __osExceptionPreamble.unk8;
    (void *)0x80000080->unkC = (s32) __osExceptionPreamble.unkC;
    (void *)0x80000100->unk0 = (s32) __osExceptionPreamble.unk0;
    (void *)0x80000100->unk4 = (s32) __osExceptionPreamble.unk4;
    (void *)0x80000100->unk8 = (s32) __osExceptionPreamble.unk8;
    (void *)0x80000100->unkC = (s32) __osExceptionPreamble.unkC;
    (void *)0x80000180->unk0 = (s32) __osExceptionPreamble.unk0;
    (void *)0x80000180->unk4 = (s32) __osExceptionPreamble.unk4;
    (void *)0x80000180->unk8 = (s32) __osExceptionPreamble.unk8;
    (void *)0x80000180->unkC = (s32) __osExceptionPreamble.unkC;
