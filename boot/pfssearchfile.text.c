struct _mips2c_stack_osPfsFindFile {
    ...
    /* 0x51 */ char pad_51[0x3];                    /* maybe part of sp50[4]? */
    /* 0x54 */ u16 sp54;                            /* inferred */
    /* 0x56 */ char pad_56[0xA];                    /* maybe part of sp54[6]? */
    /* 0x60 */ ? sp60;                              /* inferred */
...
s32 osPfsFindFile(void *arg0, s32 arg1, s32 arg2, u8 *arg3, u8 *arg4, s32 *arg5) {
    ...
    if (arg0->unk_50 > 0) {
loop_6:
        temp_v0_3 = __osContRamRead(arg0->unk_4, arg0->unk_8, (arg0->unk_5C + phi_s3) & 0xFFFF, &sp50);
        if (temp_v0_3 != 0) {
            return temp_v0_3;
        }
        temp_v0_2 = __osPfsGetStatus(arg0->unk_4, arg0->unk_8);
        if (temp_v0_2 != 0) {
            return temp_v0_2;
        }
