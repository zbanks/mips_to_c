...
struct _mips2c_stack___osCheckPackId {
    ...
    /* 0x54 */ char pad54[0x4];                     /* maybe part of sp52[3]? */
...
struct _mips2c_stack___osGetId {
    /* 0x00 */ char pad0[0x28];
    /* 0x28 */ u8 sp28;                             /* inferred */
    /* 0x29 */ char pad29[0x17];                    /* maybe part of sp28[24]? */
    /* 0x40 */ u16 sp40;                            /* inferred */
    /* 0x42 */ char pad42[0xA];                     /* maybe part of sp40[6]? */
    /* 0x4C */ u8 sp4C;                             /* inferred */
    /* 0x4D */ char pad4D[0x1B];                    /* maybe part of sp4C[28]? */
...
struct _mips2c_stack___osRepairPackId {
    ...
    /* 0x5D */ char pad5D[0x1F];                    /* maybe part of sp5C[32]? */
    /* 0x7C */ u8 sp7C;                             /* inferred */
    /* 0x7D */ u8 sp7D;                             /* inferred */
    /* 0x7E */ char pad7E[0x1E];                    /* maybe part of sp7D[31]? */
    /* 0x9C */ ? sp9C;                              /* inferred */
    /* 0x9C */ char pad9C[0x4];
};                                                  /* size = 0xA0 */
