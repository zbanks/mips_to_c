...
s32 osSetTimer(OSTimer *t, u64 value, u64 value_unk4, u64 interval, u64 interval_unk4, OSMesgQueue *mq, void *msg) {
    ...
    t->next = NULL;
    t->prev = NULL;
    t->unkC = (s32) interval_unk4;
    t->unk8 = (s32) interval;
    if (((s32) value != 0) || ((s32) value_unk4 != 0)) {
        t->unk10 = (s32) value;
        t->unk14 = (s32) value_unk4;
    } else {
        t->unk10 = (s32) interval;
        t->unk14 = (s32) interval_unk4;
    }
    t->mq = mq;
    t->msg = msg;
    ...
    if (temp_t2->next != temp_t2) {
        ...
        sp24 = temp_t7;
        temp_t2_2 = sp2C->unk10;
        if ((temp_t2_2 >= 0U) && ((temp_t2_2 > 0U) || (temp_t7 < (u32) sp2C->unk14))) {
            sp1C = &sp2C->value;
            temp_t5 = sp2C->unk14;
            temp_t6 = (sp2C->unk10 - 0U) - (temp_t5 < temp_t7);
            sp2C->unk14 = (u32) (temp_t5 - temp_t7);
            sp2C->unk10 = temp_t6;
        } else {
            sp2C->unk14 = 1U;
            sp2C->unk10 = 0U;
    ...
    __osSetTimerIntr((u64) temp_t5_2->unk10, (u64) temp_t5_2->unk14);
    __osRestoreInt(sp20);
    return 0;
}
