...
void __osMallocAddBlock(Arena *heap, void *start, s32 size) {
    ...
    if (start != 0) {
        ...
        if (temp_v0 >= 0x11) {
            temp_v1->unk_8 = 0;
            temp_v1->unk_C = NULL;
            temp_v1->unk_4 = (s32) (temp_v0 - 0x10);
            temp_v1->unk_2 = 1;
            temp_v1->unk_0 = 0x7373;
            sp1C = temp_v1;
            ArenaImpl_Lock(heap);
...
void __osFree(Arena *heap, void *ptr) {
    ...
    ArenaImpl_Lock(heap);
    temp_v0 = ptr - 0x10;
    if ((ptr != 0) && (temp_v0->unk_0 == 0x7373) && (temp_v0->unk_2 == 0)) {
        temp_a0 = temp_v0->unk_8;
        temp_a1 = temp_v0->unk_C;
        temp_v0->unk_2 = 1;
        phi_a0 = temp_a0;
        if ((temp_a0 == (temp_v0 + temp_v0->unk_4 + 0x10)) && (temp_a0->unk_2 != 0)) {
            temp_v1 = temp_a0->unk_8;
            if (temp_v1 != 0) {
                temp_v1->unk_C = temp_v0;
            }
            temp_v0->unk_8 = temp_v1;
            temp_v0->unk_4 = (s32) (temp_v0->unk_4 + temp_a0->unk_4 + 0x10);
            phi_a0 = temp_v1;
        }
        if ((temp_a1 != 0) && (temp_a1->unk_2 != 0) && (temp_v0 == (temp_a1 + temp_a1->unk_4 + 0x10))) {
            if (phi_a0 != 0) {
                phi_a0->unk_C = temp_a1;
            }
            temp_a1->unk_8 = phi_a0;
            temp_a1->unk_4 = (s32) (temp_a1->unk_4 + temp_v0->unk_4 + 0x10);
        }
    }
    ArenaImpl_Unlock(heap);
}
...
void *__osRealloc(Arena *heap, void *oldPtr, u32 newSize) {
    ...
    if (oldPtr == 0) {
        ...
        if ((temp_a3 != temp_v0) && (temp_v0 < temp_a3)) {
            temp_a1 = temp_v1->unk_8;
            temp_t0 = temp_a3 - temp_v0;
            if ((temp_a1 == (temp_v1 + temp_v0 + 0x10)) && (temp_a1->unk_2 != 0) && (temp_v0_2 = temp_a1->unk_4, ((temp_v0_2 < temp_t0) == 0))) {
                temp_a0 = temp_a1->unk_8;
                temp_a1->unk_4 = (u32) (temp_v0_2 - temp_t0);
                if (temp_a0 != 0) {
                    temp_a0->unk_C = (void *) (temp_a1 + temp_t0);
                }
                temp_a0_2 = temp_a1 + temp_t0;
                temp_v1->unk_8 = temp_a0_2;
                temp_v1->unk_4 = temp_a3;
                ...
                sp30 = temp_v0_3;
                if (temp_v0_3 != 0) {
                    bcopy(temp_v0_3, oldPtr, temp_v1->unk_4);
                    __osFree(heap, oldPtr);
                }
                phi_s0 = sp30;
            }
