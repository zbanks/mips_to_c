struct _mips2c_stack_Yaz0_Decompress {
    ...
    /* 0x31 */ char pad_31[0x4F];                   /* maybe part of sp30[80]? */
    /* 0x80 */ s8 sp80;                             /* inferred */
    /* 0x81 */ char pad_81[0x57];
};                                                  /* size = 0xD8 */
...
s32 Yaz0_DecompressImpl(u8 *hdr, u8 *dst) {
    ...
    do {
        ...
        if ((phi_a3 & 0x80) != 0) {
            temp_s0 = phi_s0 + 1;
            temp_s0->unk_-1 = (u8) phi_s1_2->unk_0;
            phi_s0_4 = temp_s0;
            ...
            temp_v0 = phi_s0 - (phi_s1_2->unk_1 | ((temp_v1 & 0xF) << 8));
            phi_v0 = temp_v0;
            phi_v0_2 = temp_v0;
            phi_s1 = (u32) temp_s1;
            if (temp_a1 == 0) {
            ...
            if (temp_a1_2 != 0) {
                do {
                    ...
                    temp_v0_2 = phi_v0 + 1;
                    temp_s0_2->unk_-1 = (u8) phi_v0->unk_-1;
                    phi_v0 = temp_v0_2;
                    phi_s0_2 = temp_s0_2;
                    phi_v1_2 = temp_v1_2;
                    phi_v0_2 = temp_v0_2;
...
loop_16:
                    ...
                    temp_s0_3->unk_-4 = (u8) phi_v0_2->unk_-1;
                    temp_v0_3 = phi_v0_2 + 4;
                    temp_s0_3->unk_-3 = (u8) phi_v0_2->unk_0;
                    temp_s0_3->unk_-2 = (u8) temp_v0_3->unk_-3;
                    temp_s0_3->unk_-1 = (u8) temp_v0_3->unk_-2;
                    phi_v0_2 = temp_v0_3;
                    phi_s0_3 = temp_s0_3;
                    phi_v1_3 = temp_v1_3;
                    phi_s0_4 = temp_s0_3;
