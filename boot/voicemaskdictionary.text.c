struct _mips2c_stack_osVoiceMaskDictionary {
    ...
    /* 0x24 */ ? sp24;                              /* inferred */
    /* 0x24 */ char pad_24[0x13];
    /* 0x37 */ s8 sp37;                             /* inferred */
    /* 0x38 */ char pad_38[0x3];                    /* maybe part of sp37[4]? */
...
s32 osVoiceMaskDictionary(void *arg0, void *arg1, s32 arg2) {
    ...
    if (phi_a2 > 0) {
        ...
        do {
            temp_a0_2 = phi_a0 + 2;
            phi_v0->unk_14 = (u8) phi_v1->unk_0;
            temp_v0_2 = phi_v0 + 2;
            temp_v0_2->unk_13 = (u8) phi_v1->unk_1;
            phi_v1 += 2;
            phi_v0 = temp_v0_2;
            phi_a0 = temp_a0_2;
    ...
    temp_v0_3 = __osVoiceContWrite20(arg0->unk_0, arg0->unk_4, 0, &sp24);
    phi_v1_2 = temp_v0_3;
    if (temp_v0_3 == 0) {
